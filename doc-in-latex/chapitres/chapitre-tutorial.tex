...
\begin{figure}[t]
  ...
  \small
  \begin{tikzpicture}
    \node[right] at (-5cm, 2cm) {\bf Propriétés stockées} ;
    \node[right] at (-5cm, 0cm) {\bf Propriétés transitoires} ;
    \node[right] at (-5cm, -2cm) {\bf Items graphiques} ;
    ...
    \ItemGraphique{fullNameTF}{myFullNameTF}{3cm}{-2cm}
    \ItemGraphique{uppercaseFullNameTF}{myUppercaseFullNameTF}{6.5cm}{-2cm}
    \ItemGraphique{lastNameTF}{myLastNameTF}{10cm}{-2cm}

    \Fleche{o->}{lastName}{mFullName}{}
    \Fleche{o->}{lastName}{mUppercaseFullName}{}

    \Fleche{o->}{firstName}{mFullName}{}
    \Fleche{o->}{firstName}{mUppercaseFullName}{}
  ...
  \end{tikzpicture}
  \caption{Bindings du deuxième tutorial}
