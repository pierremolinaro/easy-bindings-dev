...
class EBVersionShouldChangeObserver : EBTransientProperty <Bool>, EBSignatureObserverProtocol {
...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//   Protocol StoredPropertyProtocol
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

protocol StoredPropertyProtocol : Comparable {
...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//   EBReadOnlyProperty <T : StoredPropertyProtocol>
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

class EBReadOnlyProperty <T : StoredPropertyProtocol> : EBAbstractProperty {
  var prop : EBProperty <T> { get { return .noSelection } } // Abstract method

  //····················································································································

  func compare (other : EBReadOnlyProperty <T>) -> NSComparisonResult {
    switch prop {
    case .noSelection :
      switch other.prop {
      case .noSelection :
...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//   EBReadWriteProperty <T : StoredPropertyProtocol> (abstract class)
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

class EBReadWriteProperty <T : StoredPropertyProtocol> : EBReadOnlyProperty <T> {
...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//   EBPropertyProxy <T : StoredPropertyProtocol>
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

final class EBPropertyProxy <T : StoredPropertyProtocol> : EBReadWriteProperty <T> {
...
final class EBStoredProperty <T : StoredPropertyProtocol> : EBReadWriteProperty <T> {
...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//   EBTransientProperty <T : StoredPropertyProtocol>
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————

class EBTransientProperty <T : StoredPropertyProtocol> : EBReadOnlyProperty <T> {
...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//    extension String : StoredPropertyProtocol
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//    extension Int : StoredPropertyProtocol
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//    extension Double : StoredPropertyProtocol
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
...
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
//    extension Bool : StoredPropertyProtocol
//——————————————————————————————————————————————————————————————————————————————————————————————————————————————————————
