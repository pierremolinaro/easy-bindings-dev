...
@objc(Preferences) class Preferences : PMObject {
  ...
  override init () {
    super.init ()
    g_Preferences = self ;
    myString.readInPreferencesWithKey ("myString")
    mColor.readInPreferencesWithKey ("mColor")
    mIntegerValue.readInPreferencesWithKey ("mIntegerValue")
  ...
  func applicationWillTerminateAction (NSNotification) {
    myString.storeInPreferencesWithKey ("myString")
    mColor.storeInPreferencesWithKey ("mColor")
    mDate.storeInPreferencesWithKey ("mDate")
  }
