...
fileprivate let gPopUpData_0_easyBindings_5F_lexique : [[UInt16]] = [
...
class SWIFT_Tokenizer_0_easyBindings_lexique : SWIFT_Lexique_easyBindings_lexique, SWIFT_Tokenizer_Protocol {
...
@MainActor func tokenizerFor (extension inExtension : String) -> (any SWIFT_Tokenizer_Protocol)? {
  ...
  if inExtension == "eb" {
    result = SWIFT_Tokenizer_0_easyBindings_lexique ()
  }
  return result
}
...
@MainActor func tokenizers () -> [any SWIFT_Tokenizer_Protocol] {
  return [
    SWIFT_Tokenizer_0_easyBindings_lexique ()
  ]
}
