...
fileprivate let outputDeclarationDependencyGraph_PREFKEY = "easyBindings_options:outputDeclarationDependencyGraph"
...
struct OptionView : View {
  ...
  @AppStorage(outputDeclarationDependencyGraph_PREFKEY) private var outputDeclarationDependencyGraph : Bool = false
    ...
    VStack {
      ...
      ScrollView {
        VStack (alignment: .leading) {
          Toggle ("Output a declaration dependancy graph graphviz file", isOn: self.$outputDeclarationDependencyGraph)
        }.padding ()
      }.background (.white)
...
func commandLineToolInvocation () -> CommandLineToolInvocation {
  ...
  if ud.bool (forKey: outputDeclarationDependencyGraph_PREFKEY) {
    arguments.append ("--output-declaration-graph")
  }
