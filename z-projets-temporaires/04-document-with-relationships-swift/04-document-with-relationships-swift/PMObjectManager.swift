...
@objc(PMObjectManager) class PMObjectManager : NSObject {
  ...
  func registerObject (object : PMManagedObject) {
    mManagedObjectSet.addObject (object)
    mUndoManager.registerUndoWithTarget (self,
      selector:"unregisterObject:",
      object:object
    )
  }
  ...
  func unregisterObject (object : PMManagedObject) {
    mManagedObjectSet.removeObject (object)
    mUndoManager.registerUndoWithTarget (self,
