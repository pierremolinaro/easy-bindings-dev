...
//--- check myTextMinField' outlet not nil
  if (nil == myTextMinField) {
    [self presentOutletErrorOnLine:__LINE__ message:@"the 'myTextMinField' outlet is nil"] ;
  }
...
//--- check myTextConcatField' outlet not nil
  if (nil == myTextConcatField) {
    [self presentOutletErrorOnLine:__LINE__ message:@"the 'myTextConcatField' outlet is nil"] ;
  }
