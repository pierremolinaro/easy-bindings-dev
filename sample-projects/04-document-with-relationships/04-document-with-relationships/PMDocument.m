...
//--- Outlet namesTableView
  ...
  if (nil == [namesTableView tableColumnWithIdentifier:@"firstName"]) {
    presentErrorWindow (__FILE__, __LINE__, @"the 'namesTableView' NSTableView outlet has no formatter has no column with the firstName identifier") ;
  }
  [[namesTableView tableColumnWithIdentifier:@"firstName"]
    bind:@"value"
    toObject:nameController
    withKeyPath:@"arrangedObjects.firstName"
    options:nil
  ] ;
