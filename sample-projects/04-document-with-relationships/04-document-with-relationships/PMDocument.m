...
- (void) observeValueForKeyPath:(NSString *) inKeyPath
  ...
  if ((inObject == mRootObject) && [inKeyPath isEqualToString:@"mNames.@count"]) {
  ...
  }else if ((inObject == nameController) && [inKeyPath isEqualToString:@"canRemove"]) {
