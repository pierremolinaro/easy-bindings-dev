...
- (void) addObserverOf_name: (NSObject *) inObserver {
  ...
  [name_observers addObject:inObserver] ;
    ...
    const BOOL ok =
  #endif
  [NSApp tryToPerform:@selector (entity_2E_NameEntity_2E_name_didChange) with:inObserver] ;
...
- (void) addObserverOf_aValue: (NSObject *) inObserver {
  ...
  [aValue_observers addObject:inObserver] ;
    ...
    const BOOL ok =
  #endif
  [NSApp tryToPerform:@selector (entity_2E_NameEntity_2E_aValue_didChange) with:inObserver] ;
  macroAssert (ok, @"NSApp tryToPerform fail", 0, 0) ;
