...
- (void) addObserverOf_name: (NSObject *) inObserver {
  ...
  [name_observers addObject:inObserver] ;
    ...
    const BOOL ok =
  #endif
  [NSApp sendAction:@selector (entity_2E_NameEntity_2E_name_didChange) to:inObserver from:self] ;
...
- (void) addObserverOf_aValue: (NSObject *) inObserver {
  ...
  [aValue_observers addObject:inObserver] ;
    ...
    const BOOL ok =
  #endif
  [NSApp sendAction:@selector (entity_2E_NameEntity_2E_aValue_didChange) to:inObserver from:self] ;
  macroAssert (ok, @"NSApp sendAction fail", 0, 0) ;
