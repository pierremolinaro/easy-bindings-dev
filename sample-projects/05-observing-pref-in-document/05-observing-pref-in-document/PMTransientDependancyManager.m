...
- (instancetype) init {
  ...
  if (self) {
    ...
    mTriggeredPropertyArray = [NSArray arrayWithObjects:
      @"prefTransientString", // preference.MyPrefs.prefTransientString
      @"otherTransientConcatString", // entity.MyRootEntity.otherTransientConcatString
      @"transientConcatString", // entity.MyRootEntity.transientConcatString
      nil
    ] ;
