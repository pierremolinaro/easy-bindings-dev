...
- (id) init {
  ...
  if (self) {
    ...
    gTriggeredPropertyArray = @[      @"prefTransientString", // preferences/PMPrefs/self.prefTransientString
      @"transientConcatString", // document/PMDocument/self.transientConcatString
] ;
  }
  return self ;
}
