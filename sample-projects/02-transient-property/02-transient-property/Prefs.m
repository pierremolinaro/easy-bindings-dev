...
- (void) addObserverOf_mName: (id) inObserver {
  ...
  [mName_observers addObject:inObserver] ;
    ...
    const BOOL ok =
  #endif
   [NSApp tryToPerform:@selector (preference_2E_Prefs_2E_mName_didChange) with:inObserver] ;
...
- (void) addObserverOf_mFirstName: (id) inObserver {
  ...
  [mFirstName_observers addObject:inObserver] ;
    ...
    const BOOL ok =
  #endif
   [NSApp tryToPerform:@selector (preference_2E_Prefs_2E_mFirstName_didChange) with:inObserver] ;
  macroAssert (ok, @"NSApp tryToPerform fail", 0, 0) ;
