...
- (void) addObserver_mName: (id) inObserver {
...
- (void) removeObserver_mName: (id) inObserver {
...
- (void) addObserver_mFirstName: (id) inObserver {
...
- (void) removeObserver_mFirstName: (id) inObserver {
