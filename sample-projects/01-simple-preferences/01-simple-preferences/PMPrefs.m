...
- (void) addObserverOf_myString: (id) inObserver {
  ...
  [myString_observers addObject:inObserver] ;
    ...
    const BOOL ok =
  #endif
   [NSApp tryToPerform:@selector (preference_2E_PMPrefs_2E_myString_didChange) with:inObserver] ;
...
- (void) addObserverOf_mColor: (id) inObserver {
  ...
  [mColor_observers addObject:inObserver] ;
    ...
    const BOOL ok =
  #endif
   [NSApp tryToPerform:@selector (preference_2E_PMPrefs_2E_mColor_didChange) with:inObserver] ;
  macroAssert (ok, @"NSApp tryToPerform fail", 0, 0) ;
...
- (void) addObserverOf_mDate: (id) inObserver {
  ...
  [mDate_observers addObject:inObserver] ;
    ...
    const BOOL ok =
  #endif
   [NSApp tryToPerform:@selector (preference_2E_PMPrefs_2E_mDate_didChange) with:inObserver] ;
  macroAssert (ok, @"NSApp tryToPerform fail", 0, 0) ;
...
- (void) setMIntegerValue_swizzle: (NSInteger) inObject {
  if (! (self.mIntegerValue == inObject)) {
...
- (void) addObserverOf_mIntegerValue: (id) inObserver {
  ...
  [mIntegerValue_observers addObject:inObserver] ;
    ...
    const BOOL ok =
  #endif
   [NSApp tryToPerform:@selector (preference_2E_PMPrefs_2E_mIntegerValue_didChange) with:inObserver] ;
  macroAssert (ok, @"NSApp tryToPerform fail", 0, 0) ;
