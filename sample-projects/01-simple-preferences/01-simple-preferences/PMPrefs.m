...
- (void) addObserverOf_myString: (id) inObserver {
  ...
  [NSApp sendAction:@selector (preference_2E_PMPrefs_2E_myString_didChange) to:inObserver from:self] ;
...
- (void) addObserverOf_mColor: (id) inObserver {
  ...
  [NSApp sendAction:@selector (preference_2E_PMPrefs_2E_mColor_didChange) to:inObserver from:self] ;
...
- (void) addObserverOf_mDate: (id) inObserver {
  ...
  [NSApp sendAction:@selector (preference_2E_PMPrefs_2E_mDate_didChange) to:inObserver from:self] ;
...
- (void) addObserverOf_mIntegerValue: (id) inObserver {
  ...
  [NSApp sendAction:@selector (preference_2E_PMPrefs_2E_mIntegerValue_didChange) to:inObserver from:self] ;
