...
- (void) addObserver_myString: (id) inObserver {
  if (nil == myString_observers) {
    myString_observers = [NSMutableSet new] ;
  }
  [myString_observers addObject:inObserver] ;
  [inObserver performSelector:@selector (PMPrefs_myString_didChange)] ;
}

//----------------------------------------------------------------------------*

- (void) removeObserver_myString: (id) inObserver {
...
- (void) addObserver_mColor: (id) inObserver {
  if (nil == mColor_observers) {
    mColor_observers = [NSMutableSet new] ;
  }
  [mColor_observers addObject:inObserver] ;
  [inObserver performSelector:@selector (PMPrefs_mColor_didChange)] ;
}

//----------------------------------------------------------------------------*

- (void) removeObserver_mColor: (id) inObserver {
...
- (void) addObserver_mDate: (id) inObserver {
  if (nil == mDate_observers) {
    mDate_observers = [NSMutableSet new] ;
  }
  [mDate_observers addObject:inObserver] ;
  [inObserver performSelector:@selector (PMPrefs_mDate_didChange)] ;
}

//----------------------------------------------------------------------------*

- (void) removeObserver_mDate: (id) inObserver {
...
- (void) addObserver_mInteger32Value: (id) inObserver {
  if (nil == mInteger32Value_observers) {
    mInteger32Value_observers = [NSMutableSet new] ;
  }
  [mInteger32Value_observers addObject:inObserver] ;
  [inObserver performSelector:@selector (PMPrefs_mInteger32Value_didChange)] ;
}

//----------------------------------------------------------------------------*

- (void) removeObserver_mInteger32Value: (id) inObserver {
