...
- (void) addObserverOf_myString: (NSObject *) inObserver {
  ...
  [myString_observers addObject:inObserver] ;
    ...
    const BOOL ok =
  #endif
  [NSApp tryToPerform:@selector (entity_2E_MyRootEntity_2E_myString_didChange) with:inObserver] ;
...
- (void) addObserverOf_myEnumeration: (NSObject *) inObserver {
  ...
  [myEnumeration_observers addObject:inObserver] ;
    ...
    const BOOL ok =
  #endif
  [NSApp tryToPerform:@selector (entity_2E_MyRootEntity_2E_myEnumeration_didChange) with:inObserver] ;
  macroAssert (ok, @"NSApp tryToPerform fail", 0, 0) ;
...
- (void) addObserverOf_myColor: (NSObject *) inObserver {
  ...
  [myColor_observers addObject:inObserver] ;
    ...
    const BOOL ok =
  #endif
  [NSApp tryToPerform:@selector (entity_2E_MyRootEntity_2E_myColor_didChange) with:inObserver] ;
  macroAssert (ok, @"NSApp tryToPerform fail", 0, 0) ;
