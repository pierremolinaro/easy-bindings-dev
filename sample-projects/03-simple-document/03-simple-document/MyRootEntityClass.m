...
+ (MyRootEntityClass *) newInstanceWithManager: (PMEntityManager *) inManager
  ...
  return [inManager newInstanceOfEntity:[MyRootEntityClass class] withDefaultValues:inFlag] ;
}
