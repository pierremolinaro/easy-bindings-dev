...
- (id) init {
  ...
  if (self) {
    ...
    gTriggeredPropertyArray = [NSArray arrayWithObjects:
      @"myStringMaj", // entity/MyRootEntity/self.myStringMaj
      @"myStringMin", // entity/MyRootEntity/self.myStringMin
      @"myStringConcat", // entity/MyRootEntity/self.myStringConcat
      nil
    ] ;
  }
  return self ;
