...
GALGAS_lstring GALGAS_autoLayoutTableViewControllerAttributListAST_2D_element::getter_mAttributeName (UNUSED_LOCATION_ARGS) const {
  return mProperty_mAttributeName ;
}

//----------------------------------------------------------------------------------------------------------------------

GALGAS_abstractDefaultValue GALGAS_autoLayoutTableViewControllerAttributListAST_2D_element::getter_mAttributeValue (UNUSED_LOCATION_ARGS) const {
  return mProperty_mAttributeValue ;
}
...
GALGAS_ldouble GALGAS_doubleAsDefaultValue_2D_weak::getter_mValue (C_Compiler * inCompiler COMMA_LOCATION_ARGS) const {
  GALGAS_ldouble result ;
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    const cPtr_doubleAsDefaultValue * objectPtr = (cPtr_doubleAsDefaultValue *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_doubleAsDefaultValue) ;
...
void GALGAS_doubleAsDefaultValue_2D_weak::setter_setMValue (const GALGAS_ldouble inValue,
                                                            C_Compiler * inCompiler COMMA_LOCATION_ARGS) {
  if (NULL != mObjectPtr) {
    cPtr_weakReference_class * ptr = (cPtr_weakReference_class *) mObjectPtr ;
    cPtr_doubleAsDefaultValue * objectPtr = (cPtr_doubleAsDefaultValue *) ptr->strongObject () ;
    if (objectPtr == NULL) {
      inCompiler->onTheFlySemanticError ("weak reference is nil" COMMA_THERE) ;
    }else{
      macroValidSharedObject (objectPtr, cPtr_doubleAsDefaultValue) ;
...
GALGAS_bool extensionGetter_isAbstract (const GALGAS_propertyMap_2D_element & inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_typeKind var_unused_0_6342 ;
    GALGAS_propertyAccessibility var_accessibility_6398 ;
    const bool optionalResult6338 = temp_1.getter_mKind (HERE).optional_property (var_unused_0_6342, var_accessibility_6398) ;
    if (!optionalResult6338) {
      test_0 = kBoolFalse ;
    }
    if (kBoolTrue == test_0) {
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        test_2 = var_accessibility_6398.getter_isTransient (SOURCE_FILE ("semantic-analysis.galgas", 148)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_bool var_ab_6495 ;
          var_accessibility_6398.method_transient (var_ab_6495, inCompiler COMMA_SOURCE_FILE ("semantic-analysis.galgas", 149)) ;
          result_result = var_ab_6495 ;
        }
      }
    }
  }
...
void routine_sortProperties (const GALGAS_string constinArgument_inSourceFile,
  ...
  GALGAS_declarationPrecedenceGraph var_declarationPrecedenceGraph_2645 = GALGAS_declarationPrecedenceGraph::constructor_emptyGraph (SOURCE_FILE ("declaration-graph.galgas", 67)) ;
  ...
  while (enumerator_2703.hasCurrentObject ()) {
    callExtensionMethod_enterInPrecedenceGraph ((const cPtr_abstractDeclarationAST *) enumerator_2703.current_mPropertyDeclaration (HERE).ptr (), var_declarationPrecedenceGraph_2645, inCompiler COMMA_SOURCE_FILE ("declaration-graph.galgas", 69)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_string var_s_2907 = var_declarationPrecedenceGraph_2645.getter_graphviz (SOURCE_FILE ("declaration-graph.galgas", 73)) ;
      GALGAS_string var_path_2960 = constinArgument_inSourceFile.add_operation (GALGAS_string (".declarationDependancy.dot"), inCompiler COMMA_SOURCE_FILE ("declaration-graph.galgas", 74)) ;
      GALGAS_bool joker_3054 ; // Joker input parameter
      var_s_2907.method_writeToFileWhenDifferentContents (var_path_2960, joker_3054, inCompiler COMMA_SOURCE_FILE ("declaration-graph.galgas", 75)) ;
    }
  }
  ...
  if (kBoolTrue == test_1) {
    test_1 = GALGAS_bool (kIsStrictSup, var_declarationPrecedenceGraph_2645.getter_undefinedNodeCount (SOURCE_FILE ("declaration-graph.galgas", 79)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_1) {
      cEnumerator_lstringlist enumerator_3286 (var_declarationPrecedenceGraph_2645.getter_undefinedNodeReferenceList (SOURCE_FILE ("declaration-graph.galgas", 80)), kENUMERATION_UP) ;
      while (enumerator_3286.hasCurrentObject ()) {
        TC_Array <C_FixItDescription> fixItArray2 ;
        inCompiler->emitSemanticError (enumerator_3286.current_mValue (HERE).getter_location (SOURCE_FILE ("declaration-graph.galgas", 81)), GALGAS_string ("the property ").add_operation (enumerator_3286.current_mValue (HERE).getter_string (HERE), inCompiler COMMA_SOURCE_FILE ("declaration-graph.galgas", 81)).add_operation (GALGAS_string (" is not defined"), inCompiler COMMA_SOURCE_FILE ("declaration-graph.galgas", 81)), fixItArray2  COMMA_SOURCE_FILE ("declaration-graph.galgas", 81)) ;
        enumerator_3286.gotoNextObject () ;
      }
    }
  }
  if (kBoolFalse == test_1) {
    GALGAS_declarationListAST var_unsortedSemanticDeclarationListAST_3515 ;
    GALGAS_lstringlist joker_3468 ; // Joker input parameter
    GALGAS_lstringlist joker_3523 ; // Joker input parameter
    var_declarationPrecedenceGraph_2645.method_topologicalSort (outArgument_outSortedDeclarationListAST, joker_3468, var_unsortedSemanticDeclarationListAST_3515, joker_3523, inCompiler COMMA_SOURCE_FILE ("declaration-graph.galgas", 84)) ;
    enumGalgasBool test_3 = kBoolTrue ;
    if (kBoolTrue == test_3) {
      test_3 = GALGAS_bool (kIsStrictSup, var_unsortedSemanticDeclarationListAST_3515.getter_length (SOURCE_FILE ("declaration-graph.galgas", 90)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_string var_s_3602 = GALGAS_string ("semantic analysis not performed, ").add_operation (var_unsortedSemanticDeclarationListAST_3515.getter_length (SOURCE_FILE ("declaration-graph.galgas", 92)).getter_string (SOURCE_FILE ("declaration-graph.galgas", 91)), inCompiler COMMA_SOURCE_FILE ("declaration-graph.galgas", 91)).add_operation (GALGAS_string (" declarations are involved in circular definition:"), inCompiler COMMA_SOURCE_FILE ("declaration-graph.galgas", 92)) ;
        cEnumerator_declarationListAST enumerator_3828 (var_unsortedSemanticDeclarationListAST_3515, kENUMERATION_UP) ;
        while (enumerator_3828.hasCurrentObject ()) {
          var_s_3602.plusAssign_operation(GALGAS_string ("\n"
            "-  ").add_operation (callExtensionGetter_nodeKey ((const cPtr_abstractDeclarationAST *) enumerator_3828.current_mPropertyDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("declaration-graph.galgas", 95)).getter_string (SOURCE_FILE ("declaration-graph.galgas", 95)), inCompiler COMMA_SOURCE_FILE ("declaration-graph.galgas", 95)), inCompiler  COMMA_SOURCE_FILE ("declaration-graph.galgas", 95)) ;
          enumerator_3828.gotoNextObject () ;
        }
        TC_Array <C_FixItDescription> fixItArray4 ;
        inCompiler->emitSemanticError (GALGAS_location::constructor_nowhere (SOURCE_FILE ("declaration-graph.galgas", 97)), var_s_3602, fixItArray4  COMMA_SOURCE_FILE ("declaration-graph.galgas", 97)) ;
        cEnumerator_declarationListAST enumerator_3974 (var_unsortedSemanticDeclarationListAST_3515, kENUMERATION_UP) ;
        while (enumerator_3974.hasCurrentObject ()) {
          TC_Array <C_FixItDescription> fixItArray5 ;
          inCompiler->emitSemanticError (callExtensionGetter_nodeKey ((const cPtr_abstractDeclarationAST *) enumerator_3974.current_mPropertyDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("declaration-graph.galgas", 99)).getter_location (SOURCE_FILE ("declaration-graph.galgas", 99)), GALGAS_string ("the ").add_operation (callExtensionGetter_nodeKey ((const cPtr_abstractDeclarationAST *) enumerator_3974.current_mPropertyDeclaration (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("declaration-graph.galgas", 99)).getter_string (SOURCE_FILE ("declaration-graph.galgas", 99)), inCompiler COMMA_SOURCE_FILE ("declaration-graph.galgas", 99)).add_operation (GALGAS_string (" property is declared here"), inCompiler COMMA_SOURCE_FILE ("declaration-graph.galgas", 99)), fixItArray5  COMMA_SOURCE_FILE ("declaration-graph.galgas", 99)) ;
...
static void extensionMethod_enumerationDeclarationAST_firstAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_enumerationDeclarationAST * object = (const cPtr_enumerationDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_enumerationDeclarationAST) ;
  GALGAS_enumConstantMap var_enumConstantMap_4070 = GALGAS_enumConstantMap::constructor_emptyMap (SOURCE_FILE ("enumeration.galgas", 111)) ;
  const GALGAS_enumerationDeclarationAST temp_0 = object ;
  cEnumerator_lstringlist enumerator_4115 (temp_0.getter_mEnumConstantNameList (HERE), kENUMERATION_UP) ;
  while (enumerator_4115.hasCurrentObject ()) {
    {
    var_enumConstantMap_4070.setter_insertKey (enumerator_4115.current_mValue (HERE), var_enumConstantMap_4070.getter_count (SOURCE_FILE ("enumeration.galgas", 113)), inCompiler COMMA_SOURCE_FILE ("enumeration.galgas", 113)) ;
    }
    enumerator_4115.gotoNextObject () ;
  }
  GALGAS_enumFuncMap var_enumFuncMap_4213 = GALGAS_enumFuncMap::constructor_emptyMap (SOURCE_FILE ("enumeration.galgas", 115)) ;
  cEnumerator_enumerationFunctionListAST enumerator_4313 (ioArgument_ioSemanticContext.getter_mEnumerationFunctionListAST (HERE), kENUMERATION_UP) ;
  while (enumerator_4313.hasCurrentObject ()) {
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      const GALGAS_enumerationDeclarationAST temp_2 = object ;
      test_1 = GALGAS_bool (kIsEqual, enumerator_4313.current_mEnumName (HERE).getter_string (HERE).objectCompare (temp_2.getter_mClassName (HERE).getter_string (HERE))).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_stringset var_definedConstantNameSet_4414 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("enumeration.galgas", 118)) ;
        GALGAS_enumFunAssociationSortedList var_associationSortedList_4477 = GALGAS_enumFunAssociationSortedList::constructor_emptySortedList (SOURCE_FILE ("enumeration.galgas", 119)) ;
        cEnumerator__32_lstringlist enumerator_4543 (enumerator_4313.current_mAssociationList (HERE), kENUMERATION_UP) ;
        while (enumerator_4543.hasCurrentObject ()) {
          GALGAS_uint var_idx_4604 ;
          var_enumConstantMap_4070.method_searchKey (enumerator_4543.current_mValue_30_ (HERE), var_idx_4604, inCompiler COMMA_SOURCE_FILE ("enumeration.galgas", 121)) ;
          var_associationSortedList_4477.addAssign_operation (var_idx_4604, enumerator_4543.current_mValue_31_ (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("enumeration.galgas", 122)) ;
          enumGalgasBool test_3 = kBoolTrue ;
          if (kBoolTrue == test_3) {
            test_3 = var_definedConstantNameSet_4414.getter_hasKey (enumerator_4543.current_mValue_30_ (HERE).getter_string (SOURCE_FILE ("enumeration.galgas", 123)) COMMA_SOURCE_FILE ("enumeration.galgas", 123)).boolEnum () ;
            if (kBoolTrue == test_3) {
              TC_Array <C_FixItDescription> fixItArray4 ;
              inCompiler->emitSemanticError (enumerator_4543.current_mValue_30_ (HERE).getter_location (SOURCE_FILE ("enumeration.galgas", 124)), GALGAS_string ("Duplicated constant"), fixItArray4  COMMA_SOURCE_FILE ("enumeration.galgas", 124)) ;
            }
          }
          var_definedConstantNameSet_4414.addAssign_operation (enumerator_4543.current_mValue_30_ (HERE).getter_string (SOURCE_FILE ("enumeration.galgas", 126))  COMMA_SOURCE_FILE ("enumeration.galgas", 126)) ;
          enumerator_4543.gotoNextObject () ;
        }
        const GALGAS_enumerationDeclarationAST temp_5 = object ;
        cEnumerator_lstringlist enumerator_4897 (temp_5.getter_mEnumConstantNameList (HERE), kENUMERATION_UP) ;
        while (enumerator_4897.hasCurrentObject ()) {
          enumGalgasBool test_6 = kBoolTrue ;
          if (kBoolTrue == test_6) {
            test_6 = var_definedConstantNameSet_4414.getter_hasKey (enumerator_4897.current_mValue (HERE).getter_string (SOURCE_FILE ("enumeration.galgas", 129)) COMMA_SOURCE_FILE ("enumeration.galgas", 129)).operator_not (SOURCE_FILE ("enumeration.galgas", 129)).boolEnum () ;
            if (kBoolTrue == test_6) {
              TC_Array <C_FixItDescription> fixItArray7 ;
              inCompiler->emitSemanticError (enumerator_4313.current_mFunctionName (HERE).getter_location (SOURCE_FILE ("enumeration.galgas", 130)), GALGAS_string ("No association for '").add_operation (enumerator_4897.current_mValue (HERE).getter_string (SOURCE_FILE ("enumeration.galgas", 130)), inCompiler COMMA_SOURCE_FILE ("enumeration.galgas", 130)).add_operation (GALGAS_string ("' constant"), inCompiler COMMA_SOURCE_FILE ("enumeration.galgas", 130)), fixItArray7  COMMA_SOURCE_FILE ("enumeration.galgas", 130)) ;
            }
          }
          enumerator_4897.gotoNextObject () ;
        }
        {
        var_enumFuncMap_4213.setter_insertKey (enumerator_4313.current_mFunctionName (HERE), var_associationSortedList_4477, inCompiler COMMA_SOURCE_FILE ("enumeration.galgas", 133)) ;
        }
      }
    }
  ...
  ioArgument_ioSemanticContext.mProperty_mClassMap.setter_insertKey (temp_8.getter_mClassName (HERE), GALGAS_classKind::constructor_atomic (GALGAS_typeKind::constructor_enumType (temp_9.getter_mClassName (HERE).getter_string (SOURCE_FILE ("enumeration.galgas", 138)), var_enumConstantMap_4070, var_enumFuncMap_4213  COMMA_SOURCE_FILE ("enumeration.galgas", 138))  COMMA_SOURCE_FILE ("enumeration.galgas", 138)), GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE ("enumeration.galgas", 139)), GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE ("enumeration.galgas", 140)), GALGAS_propertyGenerationList::constructor_emptyList (SOURCE_FILE ("enumeration.galgas", 141)), inCompiler COMMA_SOURCE_FILE ("enumeration.galgas", 136)) ;
  }
  const GALGAS_enumerationDeclarationAST temp_10 = object ;
  const GALGAS_enumerationDeclarationAST temp_11 = object ;
  ioArgument_ioGeneration.mProperty_mFileGenerationList.addAssign_operation (GALGAS_enumForGeneration::constructor_new (temp_10.getter_mClassName (HERE).getter_string (SOURCE_FILE ("enumeration.galgas", 145)), temp_11.getter_mEnumConstantNameList (HERE), var_enumFuncMap_4213  COMMA_SOURCE_FILE ("enumeration.galgas", 144))  COMMA_SOURCE_FILE ("enumeration.galgas", 144)) ;
}
...
static void extensionMethod_enumForGeneration_generateCode (const cPtr_abstractFileGeneration * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_s_6592 = GALGAS_string (filewrapperTemplate_enumGenerationTemplate_enumGenerationInSwift (inCompiler, temp_2.getter_mEnumName (HERE), temp_3.getter_mEnumConstantList (HERE), temp_4.getter_mEnumFuncMap (HERE) COMMA_SOURCE_FILE ("enumeration.galgas", 179))) ;
      const GALGAS_enumForGeneration temp_5 = object ;
      GALGAS_string var_fileName_6752 = GALGAS_string ("enum-").add_operation (temp_5.getter_mEnumName (HERE), inCompiler COMMA_SOURCE_FILE ("enumeration.galgas", 184)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("enumeration.galgas", 184)) ;
      ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_6752  COMMA_SOURCE_FILE ("enumeration.galgas", 185)) ;
      {
      GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_6752, var_s_6592, inCompiler COMMA_SOURCE_FILE ("enumeration.galgas", 186)) ;
      }
    }
  }
}
...
static void extensionMethod_entityDeclarationAST_enterInPrecedenceGraph (const cPtr_abstractDeclarationAST * inObject,
  ...
  ioArgument_ioGraph.setter_addNode (temp_0.getter_mClassName (HERE), temp_1, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 20)) ;
  }
  enumGalgasBool test_2 = kBoolTrue ;
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_2) {
      ...
      ioArgument_ioGraph.setter_addEdge (temp_4.getter_mClassName (HERE), temp_5.getter_mSuperEntityName (HERE) COMMA_SOURCE_FILE ("entity.galgas", 22)) ;
      }
    }
  }
}
...
static void extensionMethod_entityDeclarationAST_firstAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_entityDeclarationAST * object = (const cPtr_entityDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_entityDeclarationAST) ;
  GALGAS_actionMap var_actionMap_5022 ;
  {
  const GALGAS_entityDeclarationAST temp_0 = object ;
  routine_buildActionMap (temp_0.getter_mActionDeclarationList (HERE), var_actionMap_5022, inCompiler  COMMA_SOURCE_FILE ("entity.galgas", 152)) ;
  }
  {
  const GALGAS_entityDeclarationAST temp_1 = object ;
...
static void extensionMethod_entityDeclarationAST_secondAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_propertyMap var_inheritedPropertyMap_5733 ;
      const GALGAS_entityDeclarationAST temp_2 = object ;
      GALGAS_classKind joker_5687 ; // Joker input parameter
      GALGAS_actionMap joker_5741_2 ; // Joker input parameter
      GALGAS_propertyGenerationList joker_5741_1 ; // Joker input parameter
      ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_2.getter_mSuperEntityName (HERE), joker_5687, var_inheritedPropertyMap_5733, joker_5741_2, joker_5741_1, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 170)) ;
      GALGAS_propertyMap var_propertyMap_5908 ;
      const GALGAS_entityDeclarationAST temp_3 = object ;
      GALGAS_classKind joker_5871 ; // Joker input parameter
      GALGAS_actionMap joker_5916_2 ; // Joker input parameter
      GALGAS_propertyGenerationList joker_5916_1 ; // Joker input parameter
      ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_3.getter_mClassName (HERE), joker_5871, var_propertyMap_5908, joker_5916_2, joker_5916_1, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 177)) ;
      GALGAS_propertyMap var_newPropertyMap_5971 = var_inheritedPropertyMap_5733 ;
      cEnumerator_propertyMap enumerator_6153 (var_propertyMap_5908, kENUMERATION_UP) ;
      while (enumerator_6153.hasCurrentObject ()) {
        enumGalgasBool test_4 = kBoolTrue ;
        if (kBoolTrue == test_4) {
          test_4 = enumerator_6153.current_mIsOverriding (HERE).boolEnum () ;
          if (kBoolTrue == test_4) {
            GALGAS_propertyKind joker_6231_3 ; // Joker input parameter
            GALGAS_actionMap joker_6231_2 ; // Joker input parameter
            GALGAS_bool joker_6231_1 ; // Joker input parameter
            var_inheritedPropertyMap_5733.method_searchKey (enumerator_6153.current_lkey (HERE), joker_6231_3, joker_6231_2, joker_6231_1, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 190)) ;
          }
        }
        if (kBoolFalse == test_4) {
          {
          var_newPropertyMap_5971.setter_insertKey (enumerator_6153.current_lkey (HERE), enumerator_6153.current_mKind (HERE), enumerator_6153.current_mActionMap (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 193)) ;
          }
        }
        enumerator_6153.gotoNextObject () ;
      }
      const GALGAS_entityDeclarationAST temp_5 = object ;
      cMapElement_classMap * objectArray_6412 = (cMapElement_classMap *) ioArgument_ioSemanticContext.mProperty_mClassMap.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, temp_5.getter_mClassName (HERE), kSearchErrorMessage_classMap_searchKey  COMMA_SOURCE_FILE ("entity.galgas", 197)) ;
      if (NULL != objectArray_6412) {
        macroValidSharedObject (objectArray_6412, cMapElement_classMap) ;
        objectArray_6412->mProperty_mPropertyMap = var_newPropertyMap_5971 ;
      }
    }
  }
}
...
static void extensionMethod_entityDeclarationAST_fourthAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_entityDeclarationAST * object = (const cPtr_entityDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_entityDeclarationAST) ;
  GALGAS_propertyMap var_propertyMap_6921 ;
  GALGAS_propertyGenerationList var_propertyGenerationList_6984 ;
  const GALGAS_entityDeclarationAST temp_0 = object ;
  GALGAS_classKind joker_6886 ; // Joker input parameter
  GALGAS_actionMap joker_6927 ; // Joker input parameter
  ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_0.getter_mClassName (HERE), joker_6886, var_propertyMap_6921, joker_6927, var_propertyGenerationList_6984, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 211)) ;
  GALGAS_stringset var_overridenTransients_7122 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("entity.galgas", 219)) ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    const GALGAS_entityDeclarationAST temp_2 = object ;
    const GALGAS_entityDeclarationAST temp_3 = object ;
    test_1 = GALGAS_bool (kIsNotEqual, temp_2.getter_mSuperEntityName (HERE).getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).operator_and (temp_3.getter_mIsAbstract (HERE).operator_not (SOURCE_FILE ("entity.galgas", 220)) COMMA_SOURCE_FILE ("entity.galgas", 220)).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_classKind var_superClassKind_7306 ;
      GALGAS_propertyMap var_superPropertyMap_7347 ;
      const GALGAS_entityDeclarationAST temp_4 = object ;
      GALGAS_actionMap joker_7355_2 ; // Joker input parameter
      GALGAS_propertyGenerationList joker_7355_1 ; // Joker input parameter
      ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_4.getter_mSuperEntityName (HERE), var_superClassKind_7306, var_superPropertyMap_7347, joker_7355_2, joker_7355_1, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 221)) ;
      switch (var_superClassKind_7306.enumValue ()) {
      ...
      case GALGAS_classKind::kEnum_prefs:
        {
          ...
          inCompiler->emitSemanticError (temp_5.getter_mSuperEntityName (HERE).getter_location (SOURCE_FILE ("entity.galgas", 229)), GALGAS_string ("prefs cannot be a super entity"), fixItArray6  COMMA_SOURCE_FILE ("entity.galgas", 229)) ;
        }
        break ;
      case GALGAS_classKind::kEnum_atomic:
        {
          ...
          inCompiler->emitSemanticError (temp_7.getter_mSuperEntityName (HERE).getter_location (SOURCE_FILE ("entity.galgas", 231)), GALGAS_string ("an atomic class cannot be a super entity"), fixItArray8  COMMA_SOURCE_FILE ("entity.galgas", 231)) ;
        }
        break ;
      case GALGAS_classKind::kEnum_document:
        {
          ...
          inCompiler->emitSemanticError (temp_9.getter_mSuperEntityName (HERE).getter_location (SOURCE_FILE ("entity.galgas", 233)), GALGAS_string ("a document cannot be a super entity"), fixItArray10  COMMA_SOURCE_FILE ("entity.galgas", 233)) ;
        }
        break ;
      case GALGAS_classKind::kEnum_entity:
        {
          const cEnumAssociatedValues_classKind_entity * extractPtr_8883 = (const cEnumAssociatedValues_classKind_entity *) (var_superClassKind_7306.unsafePointer ()) ;
          const GALGAS_bool extractedValue_isGraphic = extractPtr_8883->mAssociatedValue1 ;
          const GALGAS_bool extractedValue_isAbstract = extractPtr_8883->mAssociatedValue2 ;
          enumGalgasBool test_11 = kBoolTrue ;
          if (kBoolTrue == test_11) {
            const GALGAS_entityDeclarationAST temp_12 = object ;
            test_11 = extractedValue_isGraphic.operator_and (temp_12.getter_mIsGraphicEntity (HERE).operator_not (SOURCE_FILE ("entity.galgas", 235)) COMMA_SOURCE_FILE ("entity.galgas", 235)).boolEnum () ;
            if (kBoolTrue == test_11) {
              const GALGAS_entityDeclarationAST temp_13 = object ;
              TC_Array <C_FixItDescription> fixItArray14 ;
              inCompiler->emitSemanticError (temp_13.getter_mClassName (HERE).getter_location (SOURCE_FILE ("entity.galgas", 236)), GALGAS_string ("this entity should be declared with 'graphic', as super entity is graphic"), fixItArray14  COMMA_SOURCE_FILE ("entity.galgas", 236)) ;
            }
          }
          enumGalgasBool test_15 = kBoolTrue ;
          if (kBoolTrue == test_15) {
            const GALGAS_entityDeclarationAST temp_16 = object ;
            test_15 = extractedValue_isAbstract.operator_and (temp_16.getter_mIsAbstract (HERE).operator_not (SOURCE_FILE ("entity.galgas", 238)) COMMA_SOURCE_FILE ("entity.galgas", 238)).boolEnum () ;
            if (kBoolTrue == test_15) {
              cEnumerator_propertyMap enumerator_8037 (var_superPropertyMap_7347, kENUMERATION_UP) ;
              while (enumerator_8037.hasCurrentObject ()) {
                enumGalgasBool test_17 = kBoolTrue ;
                if (kBoolTrue == test_17) {
                  test_17 = extensionGetter_isAbstract (enumerator_8037.current (HERE), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 240)).boolEnum () ;
                  if (kBoolTrue == test_17) {
                    enumGalgasBool test_18 = kBoolTrue ;
                    if (kBoolTrue == test_18) {
                      test_18 = var_propertyMap_6921.getter_hasKey (enumerator_8037.current (HERE).getter_lkey (HERE).getter_string (HERE) COMMA_SOURCE_FILE ("entity.galgas", 241)).boolEnum () ;
                      if (kBoolTrue == test_18) {
                        var_overridenTransients_7122.addAssign_operation (enumerator_8037.current (HERE).getter_lkey (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("entity.galgas", 242)) ;
                        GALGAS_propertyKind var_propertyKind_8306 ;
                        GALGAS_actionMap joker_8308_2 ; // Joker input parameter
                        GALGAS_bool joker_8308_1 ; // Joker input parameter
                        var_propertyMap_6921.method_searchKey (enumerator_8037.current (HERE).getter_lkey (HERE), var_propertyKind_8306, joker_8308_2, joker_8308_1, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 243)) ;
                        GALGAS_string var_typeName_8338 = extensionGetter_typeName (var_propertyKind_8306, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 244)) ;
                        GALGAS_string var_superTypeName_8396 = extensionGetter_typeName (enumerator_8037.current (HERE).getter_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 245)) ;
                        enumGalgasBool test_19 = kBoolTrue ;
                        if (kBoolTrue == test_19) {
                          test_19 = GALGAS_bool (kIsNotEqual, var_typeName_8338.objectCompare (var_superTypeName_8396)).boolEnum () ;
                          if (kBoolTrue == test_19) {
                            TC_Array <C_FixItDescription> fixItArray20 ;
                            inCompiler->emitSemanticError (var_propertyMap_6921.getter_locationForKey (enumerator_8037.current (HERE).getter_lkey (HERE).getter_string (SOURCE_FILE ("entity.galgas", 247)), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 247)), GALGAS_string ("type '").add_operation (var_superTypeName_8396, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 248)).add_operation (GALGAS_string ("' is required by declaration in super entity"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 248)), fixItArray20  COMMA_SOURCE_FILE ("entity.galgas", 247)) ;
                          }
                        }
                      }
                    }
                    if (kBoolFalse == test_18) {
                      ...
                      inCompiler->emitSemanticError (temp_21.getter_mClassName (HERE).getter_location (SOURCE_FILE ("entity.galgas", 251)), GALGAS_string ("transient '").add_operation (enumerator_8037.current (HERE).getter_lkey (HERE).getter_string (SOURCE_FILE ("entity.galgas", 252)), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 252)).add_operation (GALGAS_string ("' should be defined, it is declared abstract in super entity"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 252)), fixItArray22  COMMA_SOURCE_FILE ("entity.galgas", 251)) ;
                    }
                  }
                }
  ...
  GALGAS_bool var_canCopyAndPaste_5F_option_8947 = GALGAS_bool (false) ;
  GALGAS_bool var_cannotBeDeleted_5F_option_8984 = GALGAS_bool (false) ;
  const GALGAS_entityDeclarationAST temp_23 = object ;
  cEnumerator_lstringlist enumerator_9045 (temp_23.getter_mGraphicOptionArray (HERE), kENUMERATION_UP) ;
  while (enumerator_9045.hasCurrentObject ()) {
    enumGalgasBool test_24 = kBoolTrue ;
    if (kBoolTrue == test_24) {
      test_24 = GALGAS_bool (kIsEqual, enumerator_9045.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("canCopyAndPaste"))).boolEnum () ;
      if (kBoolTrue == test_24) {
        enumGalgasBool test_25 = kBoolTrue ;
        if (kBoolTrue == test_25) {
          test_25 = var_canCopyAndPaste_5F_option_8947.boolEnum () ;
          if (kBoolTrue == test_25) {
            TC_Array <C_FixItDescription> fixItArray26 ;
            inCompiler->emitSemanticError (enumerator_9045.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 266)), GALGAS_string ("duplicated option"), fixItArray26  COMMA_SOURCE_FILE ("entity.galgas", 266)) ;
          }
        }
        var_canCopyAndPaste_5F_option_8947 = GALGAS_bool (true) ;
      }
    }
    if (kBoolFalse == test_24) {
      enumGalgasBool test_27 = kBoolTrue ;
      if (kBoolTrue == test_27) {
        test_27 = GALGAS_bool (kIsEqual, enumerator_9045.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("cannotBeDeleted"))).boolEnum () ;
        if (kBoolTrue == test_27) {
          enumGalgasBool test_28 = kBoolTrue ;
          if (kBoolTrue == test_28) {
            test_28 = var_cannotBeDeleted_5F_option_8984.boolEnum () ;
            if (kBoolTrue == test_28) {
              TC_Array <C_FixItDescription> fixItArray29 ;
              inCompiler->emitSemanticError (enumerator_9045.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 271)), GALGAS_string ("duplicated option"), fixItArray29  COMMA_SOURCE_FILE ("entity.galgas", 271)) ;
            }
          }
          var_cannotBeDeleted_5F_option_8984 = GALGAS_bool (true) ;
        }
      }
      if (kBoolFalse == test_27) {
        ...
        inCompiler->emitSemanticError (enumerator_9045.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 275)), GALGAS_string ("unkown graphic option"), fixItArray30  COMMA_SOURCE_FILE ("entity.galgas", 275)) ;
      }
    }
    enumerator_9045.gotoNextObject () ;
  }
  GALGAS_bool var_hasSubClass_9669 = GALGAS_bool (false) ;
  cEnumerator_classMap enumerator_9731 (ioArgument_ioSemanticContext.getter_mClassMap (HERE), kENUMERATION_UP) ;
  bool bool_31 = var_hasSubClass_9669.operator_not (SOURCE_FILE ("entity.galgas", 284)).isValidAndTrue () ;
  if (enumerator_9731.hasCurrentObject () && bool_31) {
    while (enumerator_9731.hasCurrentObject () && bool_31) {
      enumGalgasBool test_32 = kBoolTrue ;
      if (kBoolTrue == test_32) {
        test_32 = enumerator_9731.current (HERE).getter_mClassKind (HERE).getter_isEntity (SOURCE_FILE ("entity.galgas", 285)).boolEnum () ;
        if (kBoolTrue == test_32) {
          GALGAS_string var_superEntityName_9887 ;
          GALGAS_bool joker_9889_2 ; // Joker input parameter
          GALGAS_bool joker_9889_1 ; // Joker input parameter
          enumerator_9731.current (HERE).getter_mClassKind (HERE).method_entity (var_superEntityName_9887, joker_9889_2, joker_9889_1, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 286)) ;
          const GALGAS_entityDeclarationAST temp_33 = object ;
          var_hasSubClass_9669 = GALGAS_bool (kIsEqual, temp_33.getter_mClassName (HERE).getter_string (HERE).objectCompare (var_superEntityName_9887)) ;
        }
      }
      enumerator_9731.gotoNextObject () ;
      if (enumerator_9731.hasCurrentObject ()) {
        bool_31 = var_hasSubClass_9669.operator_not (SOURCE_FILE ("entity.galgas", 284)).isValidAndTrue () ;
      }
    }
  }
  const GALGAS_entityDeclarationAST temp_34 = object ;
  const GALGAS_entityDeclarationAST temp_35 = object ;
  ioArgument_ioGeneration.mProperty_mEntityListForGeneration.addAssign_operation (temp_34.getter_mClassName (HERE).getter_string (HERE), temp_35.getter_mObsoleteEntityNames (HERE)  COMMA_SOURCE_FILE ("entity.galgas", 291)) ;
  ...
  ioArgument_ioGeneration.mProperty_mFileGenerationList.addAssign_operation (GALGAS_entityForGeneration::constructor_new (temp_36.getter_mClassName (HERE).getter_string (HERE), temp_37.getter_mSuperEntityName (HERE).getter_string (HERE), var_propertyGenerationList_6984, temp_38.getter_mSignatureList (HERE), temp_39.getter_mIsGraphicEntity (HERE), temp_40.getter_mIsAbstract (HERE), var_overridenTransients_7122, temp_41.getter_mExternSwiftDelegateList (HERE), var_hasSubClass_9669, var_canCopyAndPaste_5F_option_8947, var_cannotBeDeleted_5F_option_8984  COMMA_SOURCE_FILE ("entity.galgas", 294))  COMMA_SOURCE_FILE ("entity.galgas", 294)) ;
}
...
static void extensionMethod_entityForGeneration_generateCode (const cPtr_abstractFileGeneration * inObject,
  ...
  GALGAS_atomicPropertyGenerationList var_atomicPropertyGenerationList_11666 = GALGAS_atomicPropertyGenerationList::constructor_emptyList (SOURCE_FILE ("entity.galgas", 340)) ;
  GALGAS_transientPropertyGenerationList var_transientPropertyGenerationList_11738 = GALGAS_transientPropertyGenerationList::constructor_emptyList (SOURCE_FILE ("entity.galgas", 341)) ;
  GALGAS_computedPropertyGenerationList var_computedPropertyGenerationList_11808 = GALGAS_computedPropertyGenerationList::constructor_emptyList (SOURCE_FILE ("entity.galgas", 342)) ;
  GALGAS_toOnePropertyGenerationList var_toOnePropertyGenerationList_11872 = GALGAS_toOnePropertyGenerationList::constructor_emptyList (SOURCE_FILE ("entity.galgas", 343)) ;
  GALGAS_toManyPropertyGenerationList var_toManyPropertyGenerationList_11938 = GALGAS_toManyPropertyGenerationList::constructor_emptyList (SOURCE_FILE ("entity.galgas", 344)) ;
  GALGAS_atomicProxyGenerationList var_proxyGenerationList_11992 = GALGAS_atomicProxyGenerationList::constructor_emptyList (SOURCE_FILE ("entity.galgas", 345)) ;
  GALGAS_toManyProxyGenerationList var_toManyProxyGenerationList_12052 = GALGAS_toManyProxyGenerationList::constructor_emptyList (SOURCE_FILE ("entity.galgas", 346)) ;
  const GALGAS_entityForGeneration temp_0 = object ;
  cEnumerator_propertyGenerationList enumerator_12106 (temp_0.getter_mPropertyGenerationList (HERE), kENUMERATION_UP) ;
  while (enumerator_12106.hasCurrentObject ()) {
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      GALGAS_atomicPropertyGeneration var_atomicProperty_12135 (dynamic_cast <const cPtr_atomicPropertyGeneration *> (enumerator_12106.current_mProperty (HERE).ptr ())) ;
      if (NULL == var_atomicProperty_12135.ptr ()) {
        test_1 = kBoolFalse ;
      }
      if (kBoolTrue == test_1) {
        var_atomicPropertyGenerationList_11666.addAssign_operation (var_atomicProperty_12135  COMMA_SOURCE_FILE ("entity.galgas", 349)) ;
      }
    }
    if (kBoolFalse == test_1) {
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        GALGAS_transientPropertyGeneration var_transientProperty_12266 (dynamic_cast <const cPtr_transientPropertyGeneration *> (enumerator_12106.current_mProperty (HERE).ptr ())) ;
        if (NULL == var_transientProperty_12266.ptr ()) {
          test_2 = kBoolFalse ;
        }
        if (kBoolTrue == test_2) {
          var_transientPropertyGenerationList_11738.addAssign_operation (var_transientProperty_12266  COMMA_SOURCE_FILE ("entity.galgas", 351)) ;
        }
      }
      if (kBoolFalse == test_2) {
        enumGalgasBool test_3 = kBoolTrue ;
        if (kBoolTrue == test_3) {
          GALGAS_computedPropertyGeneration var_computedProperty_12405 (dynamic_cast <const cPtr_computedPropertyGeneration *> (enumerator_12106.current_mProperty (HERE).ptr ())) ;
          if (NULL == var_computedProperty_12405.ptr ()) {
            test_3 = kBoolFalse ;
          }
          if (kBoolTrue == test_3) {
            var_computedPropertyGenerationList_11808.addAssign_operation (var_computedProperty_12405  COMMA_SOURCE_FILE ("entity.galgas", 353)) ;
          }
        }
        if (kBoolFalse == test_3) {
          enumGalgasBool test_4 = kBoolTrue ;
          if (kBoolTrue == test_4) {
            GALGAS_toManyProxyGeneration var_toManyProxy_12536 (dynamic_cast <const cPtr_toManyProxyGeneration *> (enumerator_12106.current_mProperty (HERE).ptr ())) ;
            if (NULL == var_toManyProxy_12536.ptr ()) {
              test_4 = kBoolFalse ;
            }
            if (kBoolTrue == test_4) {
              var_toManyProxyGenerationList_12052.addAssign_operation (var_toManyProxy_12536  COMMA_SOURCE_FILE ("entity.galgas", 355)) ;
            }
          }
          if (kBoolFalse == test_4) {
            enumGalgasBool test_5 = kBoolTrue ;
            if (kBoolTrue == test_5) {
              GALGAS_atomicProxyGeneration var_proxyProperty_12654 (dynamic_cast <const cPtr_atomicProxyGeneration *> (enumerator_12106.current_mProperty (HERE).ptr ())) ;
              if (NULL == var_proxyProperty_12654.ptr ()) {
                test_5 = kBoolFalse ;
              }
              if (kBoolTrue == test_5) {
                var_proxyGenerationList_11992.addAssign_operation (var_proxyProperty_12654  COMMA_SOURCE_FILE ("entity.galgas", 357)) ;
              }
            }
            if (kBoolFalse == test_5) {
              enumGalgasBool test_6 = kBoolTrue ;
              if (kBoolTrue == test_6) {
                GALGAS_toOnePropertyGeneration var_toOneProperty_12768 (dynamic_cast <const cPtr_toOnePropertyGeneration *> (enumerator_12106.current_mProperty (HERE).ptr ())) ;
                if (NULL == var_toOneProperty_12768.ptr ()) {
                  test_6 = kBoolFalse ;
                }
                if (kBoolTrue == test_6) {
                  var_toOnePropertyGenerationList_11872.addAssign_operation (var_toOneProperty_12768  COMMA_SOURCE_FILE ("entity.galgas", 359)) ;
                }
              }
              if (kBoolFalse == test_6) {
                enumGalgasBool test_7 = kBoolTrue ;
                if (kBoolTrue == test_7) {
                  GALGAS_toManyPropertyGeneration var_toOneProperty_12892 (dynamic_cast <const cPtr_toManyPropertyGeneration *> (enumerator_12106.current_mProperty (HERE).ptr ())) ;
                  if (NULL == var_toOneProperty_12892.ptr ()) {
                    test_7 = kBoolFalse ;
                  }
                  if (kBoolTrue == test_7) {
                    var_toManyPropertyGenerationList_11938.addAssign_operation (var_toOneProperty_12892  COMMA_SOURCE_FILE ("entity.galgas", 361)) ;
                  }
                }
              }
            }
  ...
  GALGAS_string var_superEntityName_13026 = GALGAS_string::makeEmptyString () ;
  ...
  if (kBoolTrue == test_8) {
    ...
    if (kBoolTrue == test_8) {
      ...
      var_superEntityName_13026 = temp_10.getter_mSuperEntityName (HERE) ;
    }
  }
  if (kBoolFalse == test_8) {
    ...
    if (kBoolTrue == test_11) {
      ...
      if (kBoolTrue == test_11) {
        var_superEntityName_13026 = GALGAS_string ("EBGraphicManagedObject") ;
      }
    }
    if (kBoolFalse == test_11) {
      var_superEntityName_13026 = GALGAS_string ("EBManagedObject") ;
    }
  }
  ...
  GALGAS_string var_s_13256 = GALGAS_string (filewrapperTemplate_entityGenerationTemplate_entityImplementationInSwift (inCompiler, temp_13.getter_mEntityName (HERE), var_superEntityName_13026, temp_14.getter_mPropertyGenerationList (HERE), var_proxyGenerationList_11992, var_toManyProxyGenerationList_12052, var_atomicPropertyGenerationList_11666, var_transientPropertyGenerationList_11738, var_computedPropertyGenerationList_11808, var_toOnePropertyGenerationList_11872, var_toManyPropertyGenerationList_11938, temp_15.getter_mSignatureSet (HERE), temp_16.getter_mIsGraphicEntity (HERE), temp_17.getter_mIsAbstract (HERE), temp_18.getter_mOverridenTransients (HERE), temp_19.getter_mExternSwiftDelegateList (HERE), temp_20.getter_mHasSubEntity (HERE), temp_21.getter_mCanCopyAndPaste_5F_option (HERE), temp_22.getter_mCannotBeDeleted_5F_option (HERE) COMMA_SOURCE_FILE ("entity.galgas", 372))) ;
  const GALGAS_entityForGeneration temp_23 = object ;
  GALGAS_string var_fileName_13881 = GALGAS_string ("entity-").add_operation (temp_23.getter_mEntityName (HERE), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 392)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 392)) ;
  ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_13881  COMMA_SOURCE_FILE ("entity.galgas", 393)) ;
  {
  GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_13881, var_s_13256, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 394)) ;
  }
  ...
  var_s_13256 = GALGAS_string (filewrapperTemplate_entityGenerationTemplate_entityToOneImplementationInSwift (inCompiler, temp_24.getter_mEntityName (HERE), var_superEntityName_13026, temp_25.getter_mPropertyGenerationList (HERE), var_proxyGenerationList_11992, var_toManyProxyGenerationList_12052, var_atomicPropertyGenerationList_11666, var_transientPropertyGenerationList_11738, var_computedPropertyGenerationList_11808, var_toOnePropertyGenerationList_11872, var_toManyPropertyGenerationList_11938, temp_26.getter_mSignatureSet (HERE), temp_27.getter_mIsGraphicEntity (HERE), temp_28.getter_mIsAbstract (HERE), temp_29.getter_mOverridenTransients (HERE), temp_30.getter_mExternSwiftDelegateList (HERE) COMMA_SOURCE_FILE ("entity.galgas", 399))) ;
  const GALGAS_entityForGeneration temp_31 = object ;
  var_fileName_13881 = GALGAS_string ("toone-").add_operation (temp_31.getter_mEntityName (HERE), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 417)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 417)) ;
  ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_13881  COMMA_SOURCE_FILE ("entity.galgas", 418)) ;
  {
  GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_13881, var_s_13256, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 419)) ;
  }
  ...
  var_s_13256 = GALGAS_string (filewrapperTemplate_entityGenerationTemplate_entityToManyImplementationInSwift (inCompiler, temp_32.getter_mEntityName (HERE), var_superEntityName_13026, temp_33.getter_mPropertyGenerationList (HERE), var_proxyGenerationList_11992, var_toManyProxyGenerationList_12052, var_atomicPropertyGenerationList_11666, var_transientPropertyGenerationList_11738, var_computedPropertyGenerationList_11808, var_toOnePropertyGenerationList_11872, var_toManyPropertyGenerationList_11938, temp_34.getter_mSignatureSet (HERE), temp_35.getter_mIsGraphicEntity (HERE), temp_36.getter_mIsAbstract (HERE), temp_37.getter_mOverridenTransients (HERE), temp_38.getter_mExternSwiftDelegateList (HERE) COMMA_SOURCE_FILE ("entity.galgas", 424))) ;
  const GALGAS_entityForGeneration temp_39 = object ;
  var_fileName_13881 = GALGAS_string ("tomany-").add_operation (temp_39.getter_mEntityName (HERE), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 442)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 442)) ;
  ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_13881  COMMA_SOURCE_FILE ("entity.galgas", 443)) ;
  {
  GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_13881, var_s_13256, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 444)) ;
  }
}
...
void routine_generateEBManagedObjectContext (const GALGAS_entityListForGeneratingEBManagedObjectContext constinArgument_inEntityListForGeneration,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_string var_fileName_15779 = GALGAS_string ("EBManagedObjectFactory.swift") ;
      ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_15779  COMMA_SOURCE_FILE ("entity.galgas", 460)) ;
      GALGAS_string var_s_15858 = GALGAS_string (filewrapperTemplate_entityGenerationTemplate_managedObjectFactory (inCompiler, constinArgument_inEntityListForGeneration COMMA_SOURCE_FILE ("entity.galgas", 461))) ;
      {
      GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_15779, var_s_15858, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 464)) ;
      }
    }
  }
}
