...
static void extensionMethod_transientRoutineGeneration_generateCode (const cPtr_abstractFileGeneration * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    test_0 = GALGAS_bool (kIsStrictSup, temp_1.getter_mDependencyList (HERE).getter_length (SOURCE_FILE ("transient-property.galgas", 632)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_s_29378 = GALGAS_string (filewrapperTemplate_transientManager_transientComputationFunctionFile (inCompiler, temp_2.getter_mOwnerName (HERE), temp_3.getter_mTransientName (HERE), temp_4.getter_mDependencyList (HERE), temp_5.getter_mTransientType (HERE), temp_6.getter_mGeneratedFunctionNamePrefix (HERE) COMMA_SOURCE_FILE ("transient-property.galgas", 633))) ;
      GALGAS_string var_header_29610 = GALGAS_string ("//").add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (45)), GALGAS_uint ((uint32_t) 118U)  COMMA_SOURCE_FILE ("transient-property.galgas", 640)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 640)).add_operation (GALGAS_string ("\n"
        "//  THIS FILE IS REGENERATED BY EASY BINDINGS, ONLY MODIFY IT WITHIN USER ZONES\n"
        "//"), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 640)).add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (45)), GALGAS_uint ((uint32_t) 118U)  COMMA_SOURCE_FILE ("transient-property.galgas", 642)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 642)).add_operation (GALGAS_string ("\n"
        "\n"), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 642)).add_operation (GALGAS_string ("import Cocoa\n"
        "\n"), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 642)).add_operation (GALGAS_string ("//"), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 643)).add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (45)), GALGAS_uint ((uint32_t) 118U)  COMMA_SOURCE_FILE ("transient-property.galgas", 644)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 644)).add_operation (GALGAS_string ("\n"
        "\n"), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 644)) ;
      ...
      GALGAS_string var_fileName_29958 = temp_7.getter_mGeneratedFunctionNamePrefix (HERE).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 645)).add_operation (temp_8.getter_mOwnerName (HERE), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 645)).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 645)).add_operation (temp_9.getter_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 645)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 645)) ;
      ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_29958  COMMA_SOURCE_FILE ("transient-property.galgas", 646)) ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_fileName_29958, GALGAS_string ("//"), var_header_29610, GALGAS_string ("\n"
        "\n"), var_s_29378, GALGAS_string ("\n"), GALGAS_string ("}\n"
        "\n"
        "//").add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (45)), GALGAS_uint ((uint32_t) 118U)  COMMA_SOURCE_FILE ("transient-property.galgas", 655)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 655)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 655)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 647)) ;
      }
    }
  }
}
