...
void routine_generateSwiftApplicationFiles (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  GALGAS_stringlist temp_0 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("code-generation.galgas", 182)) ;
  ...
  temp_0.addAssign_operation (GALGAS_string ("property-explorer")  COMMA_SOURCE_FILE ("code-generation.galgas", 126)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBSignatureObserverProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 127)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBWeakEventSet")  COMMA_SOURCE_FILE ("code-generation.galgas", 128)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBModelNotifierEvent")  COMMA_SOURCE_FILE ("code-generation.galgas", 129)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBAbstractProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 130)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBObserver")  COMMA_SOURCE_FILE ("code-generation.galgas", 131)) ;
  temp_0.addAssign_operation (GALGAS_string ("func-presentErrorWindow")  COMMA_SOURCE_FILE ("code-generation.galgas", 132)) ;
  temp_0.addAssign_operation (GALGAS_string ("func-checkOutletConnection")  COMMA_SOURCE_FILE ("code-generation.galgas", 133)) ;
  temp_0.addAssign_operation (GALGAS_string ("ReadOnlyAbstractGenericRelationshipProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 134)) ;
  temp_0.addAssign_operation (GALGAS_string ("ReadOnlyAbstractArrayProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 135)) ;
  temp_0.addAssign_operation (GALGAS_string ("ReadOnlyAbstractObjectProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 136)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBSimpleController")  COMMA_SOURCE_FILE ("code-generation.galgas", 137)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBTableCellView")  COMMA_SOURCE_FILE ("code-generation.galgas", 138)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBTransientClassProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 139)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBPreferencesClassProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 140)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBStoredClassProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 141)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBPropertyClassProxy")  COMMA_SOURCE_FILE ("code-generation.galgas", 142)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBReadWriteClassProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 143)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBReadOnlyClassProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 144)) ;
  temp_0.addAssign_operation (GALGAS_string ("ClassPropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 145)) ;
  temp_0.addAssign_operation (GALGAS_string ("BezierPathArray")  COMMA_SOURCE_FILE ("code-generation.galgas", 146)) ;
  temp_0.addAssign_operation (GALGAS_string ("extension-Data-ValuePropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 147)) ;
  temp_0.addAssign_operation (GALGAS_string ("extension-NSFont-ClassPropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 148)) ;
  temp_0.addAssign_operation (GALGAS_string ("extension-Date-ValuePropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 149)) ;
  temp_0.addAssign_operation (GALGAS_string ("extension-NSColor-ClassPropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 150)) ;
  temp_0.addAssign_operation (GALGAS_string ("extension-Bool-ValuePropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 151)) ;
  temp_0.addAssign_operation (GALGAS_string ("extension-Double-ValuePropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 152)) ;
  temp_0.addAssign_operation (GALGAS_string ("extension-NSBezierPath-ClassPropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 153)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBValidationResult")  COMMA_SOURCE_FILE ("code-generation.galgas", 154)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBUserClassNameProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 155)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBObject")  COMMA_SOURCE_FILE ("code-generation.galgas", 156)) ;
  temp_0.addAssign_operation (GALGAS_string ("extension-Int-ValuePropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 157)) ;
  temp_0.addAssign_operation (GALGAS_string ("extension-UInt32-ValuePropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 158)) ;
  temp_0.addAssign_operation (GALGAS_string ("extension-String-ValuePropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 159)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBTransientEnumProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 160)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBStoredEnumProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 161)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBPropertyEnumProxy")  COMMA_SOURCE_FILE ("code-generation.galgas", 162)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBReadWriteEnumProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 163)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBReadOnlyEnumProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 164)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBAbstractEnumProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 165)) ;
  temp_0.addAssign_operation (GALGAS_string ("EnumPropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 166)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBEnumProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 167)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBTransientValueProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 168)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBPreferencesValueProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 169)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBStoredValueProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 170)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBPropertyValueProxy")  COMMA_SOURCE_FILE ("code-generation.galgas", 171)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBReadWriteValueProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 172)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBReadOnlyValueProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 173)) ;
  temp_0.addAssign_operation (GALGAS_string ("ValuePropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 174)) ;
  temp_0.addAssign_operation (GALGAS_string ("extension-Data-Comparable")  COMMA_SOURCE_FILE ("code-generation.galgas", 175)) ;
  temp_0.addAssign_operation (GALGAS_string ("PropertyKind")  COMMA_SOURCE_FILE ("code-generation.galgas", 176)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBSelection")  COMMA_SOURCE_FILE ("code-generation.galgas", 177)) ;
  temp_0.addAssign_operation (GALGAS_string ("func-defaultValidationFunction")  COMMA_SOURCE_FILE ("code-generation.galgas", 178)) ;
  temp_0.addAssign_operation (GALGAS_string ("multiple-binding-controllers")  COMMA_SOURCE_FILE ("code-generation.galgas", 179)) ;
  temp_0.addAssign_operation (GALGAS_string ("Application")  COMMA_SOURCE_FILE ("code-generation.galgas", 180)) ;
  temp_0.addAssign_operation (GALGAS_string ("model-events")  COMMA_SOURCE_FILE ("code-generation.galgas", 181)) ;
  temp_0.addAssign_operation (GALGAS_string ("outlet-events")  COMMA_SOURCE_FILE ("code-generation.galgas", 182)) ;
  GALGAS_stringlist var_swiftFiles_4089 = temp_0 ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = constinArgument_inHasEntities.boolEnum () ;
    if (kBoolTrue == test_1) {
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBManagedObject")  COMMA_SOURCE_FILE ("code-generation.galgas", 185)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBDataScanner")  COMMA_SOURCE_FILE ("code-generation.galgas", 186)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicManagedObject")  COMMA_SOURCE_FILE ("code-generation.galgas", 187)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("buildPDFimage")  COMMA_SOURCE_FILE ("code-generation.galgas", 188)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBScrollView-dragging-destination")  COMMA_SOURCE_FILE ("code-generation.galgas", 190)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBScrollView-placards")  COMMA_SOURCE_FILE ("code-generation.galgas", 191)) ;
      ...
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-control-key-hilite-diameter")  COMMA_SOURCE_FILE ("code-generation.galgas", 195)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-arrowKeyMagnitude")  COMMA_SOURCE_FILE ("code-generation.galgas", 196)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-backColor")  COMMA_SOURCE_FILE ("code-generation.galgas", 197)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridCrossColor")  COMMA_SOURCE_FILE ("code-generation.galgas", 198)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridDisplayFactor")  COMMA_SOURCE_FILE ("code-generation.galgas", 199)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridLineColor")  COMMA_SOURCE_FILE ("code-generation.galgas", 200)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridStep")  COMMA_SOURCE_FILE ("code-generation.galgas", 201)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridStyle")  COMMA_SOURCE_FILE ("code-generation.galgas", 202)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-horizontalFlip")  COMMA_SOURCE_FILE ("code-generation.galgas", 203)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-mouseGrid")  COMMA_SOURCE_FILE ("code-generation.galgas", 204)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-overObjectsDisplay")  COMMA_SOURCE_FILE ("code-generation.galgas", 205)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-shiftArrowKeyMagnitude")  COMMA_SOURCE_FILE ("code-generation.galgas", 206)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-underObjectsDisplay")  COMMA_SOURCE_FILE ("code-generation.galgas", 207)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-verticalFlip")  COMMA_SOURCE_FILE ("code-generation.galgas", 208)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-xPlacardUnit")  COMMA_SOURCE_FILE ("code-generation.galgas", 209)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-yPlacardUnit")  COMMA_SOURCE_FILE ("code-generation.galgas", 210)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-binding-zoom")  COMMA_SOURCE_FILE ("code-generation.galgas", 211)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-dragging-source")  COMMA_SOURCE_FILE ("code-generation.galgas", 212)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-draw")  COMMA_SOURCE_FILE ("code-generation.galgas", 213)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-guide")  COMMA_SOURCE_FILE ("code-generation.galgas", 214)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-issue")  COMMA_SOURCE_FILE ("code-generation.galgas", 215)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-key-down")  COMMA_SOURCE_FILE ("code-generation.galgas", 216)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-magnify-and-zoom")  COMMA_SOURCE_FILE ("code-generation.galgas", 217)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-menu-actions")  COMMA_SOURCE_FILE ("code-generation.galgas", 218)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-mouse")  COMMA_SOURCE_FILE ("code-generation.galgas", 219)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-move-to-superview")  COMMA_SOURCE_FILE ("code-generation.galgas", 220)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-placards")  COMMA_SOURCE_FILE ("code-generation.galgas", 221)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-tool-tips")  COMMA_SOURCE_FILE ("code-generation.galgas", 222)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicView-tracking-areas")  COMMA_SOURCE_FILE ("code-generation.galgas", 223)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicViewControllerProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 224)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBGraphicViewScaleProvider")  COMMA_SOURCE_FILE ("code-generation.galgas", 225)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("NSControl-extension-enable-binding")  COMMA_SOURCE_FILE ("code-generation.galgas", 226)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("extension-CGPoint-NSPoint")  COMMA_SOURCE_FILE ("code-generation.galgas", 228)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("extension-CGRect-NSRect")  COMMA_SOURCE_FILE ("code-generation.galgas", 229)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("extension-CGSize-NSSize")  COMMA_SOURCE_FILE ("code-generation.galgas", 230)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("extension-Data")  COMMA_SOURCE_FILE ("code-generation.galgas", 231)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("extension-NSBezierPath")  COMMA_SOURCE_FILE ("code-generation.galgas", 232)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("extension-NSObject")  COMMA_SOURCE_FILE ("code-generation.galgas", 233)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("extension-NSTextView")  COMMA_SOURCE_FILE ("code-generation.galgas", 234)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("extension-String")  COMMA_SOURCE_FILE ("code-generation.galgas", 235)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("extension-UInt32")  COMMA_SOURCE_FILE ("code-generation.galgas", 236)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBBezierPath")  COMMA_SOURCE_FILE ("code-generation.galgas", 238)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBLinePath")  COMMA_SOURCE_FILE ("code-generation.galgas", 239)) ;
      var_swiftFiles_4089.addAssign_operation (GALGAS_string ("EBShape")  COMMA_SOURCE_FILE ("code-generation.galgas", 240)) ;
    }
  }
  GALGAS_stringlist temp_2 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("code-generation.galgas", 242)) ;
  temp_2.addAssign_operation (GALGAS_string ("EBAllocationDebug")  COMMA_SOURCE_FILE ("code-generation.galgas", 242)) ;
  GALGAS_stringlist var_xibFiles_8646 = temp_2 ;
  GALGAS_filewrapper var_fw_8680 = GALGAS_filewrapper (gWrapperDirectory_0_swift_5F_sources) ;
  cEnumerator_stringlist enumerator_8742 (var_swiftFiles_4089, kENUMERATION_UP) ;
  while (enumerator_8742.hasCurrentObject ()) {
    GALGAS_string var_fileName_8762 = enumerator_8742.current_mValue (HERE).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 245)) ;
    GALGAS_string var_contents_8794 = var_fw_8680.getter_textFileContentsAtPath (var_fileName_8762, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 246)) ;
    ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_8762  COMMA_SOURCE_FILE ("code-generation.galgas", 247)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_8762, var_contents_8794, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 248)) ;
    }
    enumerator_8742.gotoNextObject () ;
  }
  cEnumerator_stringlist enumerator_8995 (var_xibFiles_8646, kENUMERATION_UP) ;
  while (enumerator_8995.hasCurrentObject ()) {
    GALGAS_string var_contents_9015 = var_fw_8680.getter_textFileContentsAtPath (enumerator_8995.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 255)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 255)) ;
    GALGAS_string var_fileName_9074 = enumerator_8995.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 256)) ;
    ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_9074  COMMA_SOURCE_FILE ("code-generation.galgas", 257)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_9074, var_contents_9015, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 258)) ;
    }
...
void routine_generateStandardProperties (const GALGAS_string constinArgument_inOutputDirectory,
                                         ...
                                         C_Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_contents_10135 = GALGAS_string (filewrapperTemplate_standard_5F_properties_stub (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 292))) ;
  var_contents_10135.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("UInt32"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 294))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 294)) ;
  var_contents_10135.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Int"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 295))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 295)) ;
  var_contents_10135.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Bool"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 296))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 296)) ;
  var_contents_10135.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Double"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 297))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 297)) ;
  var_contents_10135.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("String"), GALGAS_bool (false), GALGAS_string ("localizedStandardCompare") COMMA_SOURCE_FILE ("code-generation.galgas", 298))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 298)) ;
  var_contents_10135.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Data"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 299))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 299)) ;
  var_contents_10135.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Date"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 300))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 300)) ;
  var_contents_10135.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("BezierPathArray"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 301))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 301)) ;
  cEnumerator_stringlist enumerator_10987 (constinArgument_inPropertyClassList, kENUMERATION_UP) ;
  while (enumerator_10987.hasCurrentObject ()) {
    var_contents_10135.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, enumerator_10987.current_mValue (HERE), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 304))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 304)) ;
    enumerator_10987.gotoNextObject () ;
  }
  cEnumerator_transientExternTypeList enumerator_11155 (constinArgument_inTransientPropertyExternTypeList, kENUMERATION_UP) ;
  while (enumerator_11155.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = enumerator_11155.current_mIsClass (HERE).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_contents_10135.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, enumerator_11155.current_mTypeName (HERE), GALGAS_bool (false), GALGAS_bool (true) COMMA_SOURCE_FILE ("code-generation.galgas", 308))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 308)) ;
      }
    }
    if (kBoolFalse == test_0) {
      var_contents_10135.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, enumerator_11155.current_mTypeName (HERE), GALGAS_bool (true), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 310))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 310)) ;
    }
    enumerator_11155.gotoNextObject () ;
  }
  var_contents_10135.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, GALGAS_string ("NSBezierPath"), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 313))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 313)) ;
  var_contents_10135.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, GALGAS_string ("NSFont"), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 314))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 314)) ;
  var_contents_10135.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, GALGAS_string ("NSColor"), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 315))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 315)) ;
  GALGAS_string var_fileName_11685 = GALGAS_string ("standard-properties.swift") ;
  ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_11685  COMMA_SOURCE_FILE ("code-generation.galgas", 318)) ;
  {
  GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_11685, var_contents_10135, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 319)) ;
  }
}
...
static void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  bool bool_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 39)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValidAndTrue () ;
  if (enumerator_1850.hasCurrentObject () && bool_0) {
    while (enumerator_1850.hasCurrentObject () && bool_0) {
      ...
      if (enumerator_1850.hasCurrentObject ()) {
        bool_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 39)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValidAndTrue () ;
      }
    }
  }
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 43)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
      routine_buildBindingSpecificationMap (var_semanticContext_1749, var_declarationStruct_734.getter_mBindingSpecificationListMap (HERE), inCompiler  COMMA_SOURCE_FILE ("program.galgas", 44)) ;
      }
    }
  }
  cEnumerator_declarationListAST enumerator_2310 (var_sortedDeclarationListAST_1639, kENUMERATION_UP) ;
  bool bool_2 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 50)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValidAndTrue () ;
  if (enumerator_2310.hasCurrentObject () && bool_2) {
    while (enumerator_2310.hasCurrentObject () && bool_2) {
      callExtensionMethod_secondAnalysisPhase ((const cPtr_abstractDeclarationAST *) enumerator_2310.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_1749, var_generation_1791, inCompiler COMMA_SOURCE_FILE ("program.galgas", 51)) ;
      enumerator_2310.gotoNextObject () ;
      if (enumerator_2310.hasCurrentObject ()) {
        bool_2 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 50)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValidAndTrue () ;
      }
    }
  }
  cEnumerator_declarationListAST enumerator_2538 (var_sortedDeclarationListAST_1639, kENUMERATION_UP) ;
  bool bool_3 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 54)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValidAndTrue () ;
  if (enumerator_2538.hasCurrentObject () && bool_3) {
    while (enumerator_2538.hasCurrentObject () && bool_3) {
      callExtensionMethod_thirdAnalysisPhase ((const cPtr_abstractDeclarationAST *) enumerator_2538.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_1749, var_generation_1791, inCompiler COMMA_SOURCE_FILE ("program.galgas", 55)) ;
      enumerator_2538.gotoNextObject () ;
      if (enumerator_2538.hasCurrentObject ()) {
        bool_3 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 54)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValidAndTrue () ;
      }
    }
  }
  cEnumerator_declarationListAST enumerator_2766 (var_sortedDeclarationListAST_1639, kENUMERATION_UP) ;
  bool bool_4 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 58)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValidAndTrue () ;
  if (enumerator_2766.hasCurrentObject () && bool_4) {
    while (enumerator_2766.hasCurrentObject () && bool_4) {
      callExtensionMethod_fourthAnalysisPhase ((const cPtr_abstractDeclarationAST *) enumerator_2766.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_1749, var_generation_1791, inCompiler COMMA_SOURCE_FILE ("program.galgas", 59)) ;
      enumerator_2766.gotoNextObject () ;
      if (enumerator_2766.hasCurrentObject ()) {
        bool_4 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 58)).objectCompare (GALGAS_uint ((uint32_t) 0U))).isValidAndTrue () ;
      }
    }
  }
  enumGalgasBool test_5 = kBoolTrue ;
  if (kBoolTrue == test_5) {
    test_5 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 62)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_5) {
      {
      routine_graphvizAnalysis (constinArgument_inSourceFile.getter_string (HERE).getter_stringByDeletingLastPathComponent (SOURCE_FILE ("program.galgas", 63)), var_semanticContext_1749, var_declarationStruct_734.getter_mGraphvizList (HERE), inCompiler  COMMA_SOURCE_FILE ("program.galgas", 63)) ;
      }
    }
  }
  enumGalgasBool test_6 = kBoolTrue ;
  if (kBoolTrue == test_6) {
    test_6 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 66)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_6) {
      {
      routine_generateCode (var_declarationStruct_734.getter_mXcodeProject (HERE).getter_string (HERE), var_generation_1791, constinArgument_inSourceFile.getter_string (HERE), inCompiler  COMMA_SOURCE_FILE ("program.galgas", 67)) ;
      }
    }
  }
}
