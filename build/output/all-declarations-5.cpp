...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_document_5F_declaration_i7_ (GALGAS_astDeclarationStruct & ioArgument_ioDeclarationAST,
  ...
  GALGAS_lstring var_documentName_1644 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_lstring var_rootEntityName_1701 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_outletDeclarationList var_outletDeclarationList_1762 = GALGAS_outletDeclarationList::constructor_emptyList (SOURCE_FILE ("document-xib.galgas", 39)) ;
  GALGAS_regularBindingList var_bindingList_1807 = GALGAS_regularBindingList::constructor_emptyList (SOURCE_FILE ("document-xib.galgas", 40)) ;
  GALGAS_lstringlist var_actionDeclarationList_1855 = GALGAS_lstringlist::constructor_emptyList (SOURCE_FILE ("document-xib.galgas", 41)) ;
  GALGAS_stringset var_signatureList_1893 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("document-xib.galgas", 42)) ;
  GALGAS_arrayControllerBindingListAST var_arrayControllerBindingListAST_1967 = GALGAS_arrayControllerBindingListAST::constructor_emptyList (SOURCE_FILE ("document-xib.galgas", 43)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    switch (select_easyBindings_5F_syntax_10 (inCompiler)) {
    case 2: {
      nt_action_5F_declaration_ (var_actionDeclarationList_1855, inCompiler) ;
    } break ;
    case 3: {
      nt_transient_5F_declaration_ (var_documentName_1644, var_rootEntityName_1701, ioArgument_ioDeclarationAST, inCompiler) ;
    } break ;
    case 4: {
      nt_outlet_5F_declaration_ (var_outletDeclarationList_1762, inCompiler) ;
    } break ;
    case 5: {
      nt_controller_5F_declaration_ (GALGAS_bool (false), var_documentName_1644, var_rootEntityName_1701, var_arrayControllerBindingListAST_1967, ioArgument_ioDeclarationAST, inCompiler) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  ioArgument_ioDeclarationAST.mProperty_mUnifiedDeclarationList.addAssign_operation (GALGAS_xibDocumentDeclarationAST::constructor_new (var_documentName_1644, var_rootEntityName_1701, var_outletDeclarationList_1762, var_actionDeclarationList_1855, var_arrayControllerBindingListAST_1967  COMMA_SOURCE_FILE ("document-xib.galgas", 55))  COMMA_SOURCE_FILE ("document-xib.galgas", 55)) ;
  ioArgument_ioDeclarationAST.mProperty_mUnifiedDeclarationList.addAssign_operation (GALGAS_transientDeclarationAST::constructor_new (var_documentName_1644, var_rootEntityName_1701, GALGAS_string ("String").getter_here (inCompiler COMMA_SOURCE_FILE ("document-xib.galgas", 65)), GALGAS_string ("documentFileName").getter_here (inCompiler COMMA_SOURCE_FILE ("document-xib.galgas", 66)), GALGAS_observablePropertyList::constructor_emptyList (SOURCE_FILE ("document-xib.galgas", 67)), GALGAS_bool (false)  COMMA_SOURCE_FILE ("document-xib.galgas", 62))  COMMA_SOURCE_FILE ("document-xib.galgas", 62)) ;
}
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_stack_5F_view_5F_declaration_i16_ (GALGAS_astViewDeclarationList & ioArgument_ioViewDeclarationList,
  ...
  GALGAS_lstring var_viewName_6985 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  case 1: {
    ...
    nt_auto_5F_layout_5F_func_5F_call_5F_list_ (var_functionCallList_7076, inCompiler) ;
    ioArgument_ioViewDeclarationList.addAssign_operation (var_viewName_6985, GALGAS_astHorizontalStackViewDeclaration::constructor_new (var_functionCallList_7076  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 162))  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 162)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken_vStack COMMA_SOURCE_FILE ("auto-layout-view.galgas", 164)) ;
    GALGAS_astAutoLayoutViewFunctionCallList var_functionCallList_7256 ;
    nt_auto_5F_layout_5F_func_5F_call_5F_list_ (var_functionCallList_7256, inCompiler) ;
    ioArgument_ioViewDeclarationList.addAssign_operation (var_viewName_6985, GALGAS_astVerticalStackViewDeclaration::constructor_new (var_functionCallList_7256  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 166))  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 166)) ;
  } break ;
  default:
    break ;
  }
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_stack_5F_view_5F_declaration_i17_ (GALGAS_astViewDeclarationList & ioArgument_ioViewDeclarationList,
  ...
  GALGAS_astAutoLayoutViewFunctionCallList var_functionCallList_7699 ;
  nt_auto_5F_layout_5F_func_5F_call_5F_list_ (var_functionCallList_7699, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("auto-layout-view.galgas", 178)) ;
  GALGAS_astViewInstructionList var_instructionList_7731 = GALGAS_astViewInstructionList::constructor_emptyList (SOURCE_FILE ("auto-layout-view.galgas", 179)) ;
  nt_view_5F_instruction_5F_list_ (GALGAS_bool (false), var_instructionList_7731, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("auto-layout-view.galgas", 181)) ;
  ioArgument_ioViewDeclarationList.addAssign_operation (var_viewName_7630, GALGAS_astComputedVerticalViewDeclaration::constructor_new (var_functionCallList_7699, var_instructionList_7731  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 184))  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 182)) ;
}
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_auto_5F_layout_5F_func_5F_call_5F_list_i18_ (GALGAS_astAutoLayoutViewFunctionCallList & outArgument_outFunctionCallList,
  ...
  while (repeatFlag_0) {
    ...
    case 2: {
      GALGAS_lstring var_functionName_8272 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_astAutoLayoutViewInstructionParameterList var_actualParameterList_8333 ;
      nt_view_5F_actual_5F_parameter_5F_list_ (var_actualParameterList_8333, inCompiler) ;
      outArgument_outFunctionCallList.addAssign_operation (var_functionName_8272, var_actualParameterList_8333  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 195)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_stack_5F_view_5F_declaration_i19_ (GALGAS_astViewDeclarationList & ioArgument_ioViewDeclarationList,
  ...
  GALGAS_lstring var_viewName_8667 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_astAutoLayoutViewFunctionCallList var_functionCallList_8735 ;
  nt_auto_5F_layout_5F_func_5F_call_5F_list_ (var_functionCallList_8735, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("auto-layout-view.galgas", 206)) ;
  GALGAS_astViewInstructionList var_instructionList_8767 = GALGAS_astViewInstructionList::constructor_emptyList (SOURCE_FILE ("auto-layout-view.galgas", 207)) ;
  nt_view_5F_instruction_5F_list_ (GALGAS_bool (true), var_instructionList_8767, inCompiler) ;
  inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("auto-layout-view.galgas", 209)) ;
  ioArgument_ioViewDeclarationList.addAssign_operation (var_viewName_8667, GALGAS_astComputedHorizontalViewDeclaration::constructor_new (var_functionCallList_8735, var_instructionList_8767  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 212))  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 210)) ;
}
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_view_5F_instruction_5F_list_i20_ (GALGAS_bool inArgument_inHorizontal,
  ...
  while (repeatFlag_0) {
    ...
    case 3: {
      GALGAS_astAbstractViewInstructionDeclaration var_instruction_9425 ;
      nt_view_5F_instruction_ (var_instruction_9425, inCompiler) ;
      ioArgument_ioInstructionList.addAssign_operation (var_instruction_9425  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 225)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_view_5F_instruction_i22_ (GALGAS_astAbstractViewInstructionDeclaration & outArgument_outInstruction,
  ...
  GALGAS_lstring var_localViewName_10008 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  outArgument_outInstruction = GALGAS_astLocalViewInstruction::constructor_new (var_localViewName_10008  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 241)) ;
}
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_view_5F_instruction_i23_ (GALGAS_astAbstractViewInstructionDeclaration & outArgument_outInstruction,
                                                                                           C_Lexique_easyBindings_5F_lexique * inCompiler) {
  outArgument_outInstruction.drop () ; // Release 'out' argument
  GALGAS_astComputedViewInstruction var_instruction_10336 ;
  nt_computed_5F_view_5F_instruction_ (var_instruction_10336, inCompiler) ;
  outArgument_outInstruction = var_instruction_10336 ;
}
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_computed_5F_view_5F_instruction_i24_ (GALGAS_astComputedViewInstruction & outArgument_outInstruction,
                                                                                                       C_Lexique_easyBindings_5F_lexique * inCompiler) {
  outArgument_outInstruction.drop () ; // Release 'out' argument
  GALGAS_lstring var_viewClassName_10617 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_astAutoLayoutViewInstructionParameterList var_instanciationParameterList_10695 ;
  switch (select_easyBindings_5F_syntax_32 (inCompiler)) {
  case 1: {
    var_instanciationParameterList_10695 = GALGAS_astAutoLayoutViewInstructionParameterList::constructor_emptyList (SOURCE_FILE ("auto-layout-view.galgas", 257)) ;
  } break ;
  case 2: {
    nt_view_5F_actual_5F_parameter_5F_list_ (var_instanciationParameterList_10695, inCompiler) ;
  } break ;
  default:
    break ;
  }
  GALGAS_lstring var_configuratorName_10856 ;
  GALGAS_lstring var_outletName_10884 ;
  switch (select_easyBindings_5F_syntax_33 (inCompiler)) {
  case 1: {
    var_outletName_10884 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("auto-layout-view.galgas", 264)) ;
    var_configuratorName_10856 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("auto-layout-view.galgas", 265)) ;
  } break ;
  case 2: {
    ...
    case 1: {
      var_outletName_10884 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("auto-layout-view.galgas", 269)) ;
    } break ;
    case 2: {
      inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken_outlet COMMA_SOURCE_FILE ("auto-layout-view.galgas", 271)) ;
      var_outletName_10884 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    case 1: {
      var_configuratorName_10856 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("auto-layout-view.galgas", 275)) ;
    } break ;
    case 2: {
      ...
      var_configuratorName_10856 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_tableValueBinding var_tableValueBinding_11295 ;
  GALGAS_runActionDescriptor var_runActionDescriptor_11344 ;
  GALGAS_multipleBindingDescriptor var_enabledBindingDescriptor_11404 ;
  GALGAS_multipleBindingDescriptor var_hiddenBindingDescriptor_11463 ;
  GALGAS_graphicController var_graphicController_11508 ;
  GALGAS_regularBindingList var_regularBindingList_11555 ;
  GALGAS_astAutoLayoutViewFunctionCallList var_autoLayoutViewFunctionCallList_11629 ;
  switch (select_easyBindings_5F_syntax_36 (inCompiler)) {
  case 1: {
    var_tableValueBinding_11295 = GALGAS_tableValueBinding::constructor_noTableValueBinding (SOURCE_FILE ("auto-layout-view.galgas", 290)) ;
    var_runActionDescriptor_11344 = GALGAS_runActionDescriptor::constructor_noAction (SOURCE_FILE ("auto-layout-view.galgas", 291)) ;
    var_enabledBindingDescriptor_11404 = GALGAS_multipleBindingDescriptor::constructor_noBinding (SOURCE_FILE ("auto-layout-view.galgas", 292)) ;
    var_hiddenBindingDescriptor_11463 = GALGAS_multipleBindingDescriptor::constructor_noBinding (SOURCE_FILE ("auto-layout-view.galgas", 293)) ;
    var_graphicController_11508 = GALGAS_graphicController::constructor_none (SOURCE_FILE ("auto-layout-view.galgas", 294)) ;
    var_regularBindingList_11555 = GALGAS_regularBindingList::constructor_emptyList (SOURCE_FILE ("auto-layout-view.galgas", 295)) ;
    var_autoLayoutViewFunctionCallList_11629 = GALGAS_astAutoLayoutViewFunctionCallList::constructor_emptyList (SOURCE_FILE ("auto-layout-view.galgas", 296)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("auto-layout-view.galgas", 298)) ;
    nt_auto_5F_layout_5F_func_5F_call_5F_list_ (var_autoLayoutViewFunctionCallList_11629, inCompiler) ;
    nt_outlet_5F_binding_ (var_tableValueBinding_11295, var_runActionDescriptor_11344, var_enabledBindingDescriptor_11404, var_hiddenBindingDescriptor_11463, var_graphicController_11508, var_regularBindingList_11555, inCompiler) ;
    inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken__7D_ COMMA_SOURCE_FILE ("auto-layout-view.galgas", 306)) ;
  } break ;
  default:
    break ;
  }
  outArgument_outInstruction = GALGAS_astComputedViewInstruction::constructor_new (var_viewClassName_10617, var_instanciationParameterList_10695, var_autoLayoutViewFunctionCallList_11629, var_tableValueBinding_11295, var_runActionDescriptor_11344, var_enabledBindingDescriptor_11404, var_hiddenBindingDescriptor_11463, var_graphicController_11508, var_regularBindingList_11555, var_configuratorName_10856, var_outletName_10884  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 308)) ;
}
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_view_5F_actual_5F_parameter_5F_list_i25_ (GALGAS_astAutoLayoutViewInstructionParameterList & outArgument_outParameterList,
  ...
  case 2: {
    bool repeatFlag_0 = true ;
    while (repeatFlag_0) {
      GALGAS_lstring var_parameterName_12981 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      case 1: {
        GALGAS_astAbstractViewInstructionDeclaration var_instruction_13093 ;
        nt_view_5F_instruction_ (var_instruction_13093, inCompiler) ;
        outArgument_outParameterList.addAssign_operation (var_parameterName_12981, GALGAS_autoLayoutClassParameterType::constructor_typeView (SOURCE_FILE ("auto-layout-view.galgas", 335)), GALGAS_astAutoLayoutViewInstructionParameterValue::constructor_viewFunc (var_instruction_13093  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 335))  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 335)) ;
      } break ;
      case 2: {
        inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken_entity COMMA_SOURCE_FILE ("auto-layout-view.galgas", 337)) ;
        GALGAS_lstring var_entityName_13257 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      case 3: {
        ...
        GALGAS_lstring var_menuItemTitle_13423 = inCompiler->synthetizedAttribute_tokenString () ;
        ...
        GALGAS_runActionDescriptor var_runActionDescriptor_13478 ;
        switch (select_easyBindings_5F_syntax_40 (inCompiler)) {
        case 1: {
          var_runActionDescriptor_13478 = GALGAS_runActionDescriptor::constructor_noAction (SOURCE_FILE ("auto-layout-view.galgas", 345)) ;
        } break ;
        case 2: {
          inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken_run COMMA_SOURCE_FILE ("auto-layout-view.galgas", 347)) ;
          GALGAS_lstring var_runTargetName_13609 ;
          switch (select_easyBindings_5F_syntax_41 (inCompiler)) {
          case 1: {
            var_runTargetName_13609 = GALGAS_lstring::constructor_new (GALGAS_string ("self"), GALGAS_location::constructor_here (inCompiler  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 350))  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 350)) ;
          } break ;
          case 2: {
            var_runTargetName_13609 = inCompiler->synthetizedAttribute_tokenString () ;
          ...
          GALGAS_lstring var_runActionName_13836 = inCompiler->synthetizedAttribute_tokenString () ;
          ...
          var_runActionDescriptor_13478 = GALGAS_runActionDescriptor::constructor_action (var_runTargetName_13609, var_runActionName_13836  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 356)) ;
        } break ;
        default:
          break ;
        }
        GALGAS_multipleBindingDescriptor var_enabledBindingDescriptor_14004 = GALGAS_multipleBindingDescriptor::constructor_noBinding (SOURCE_FILE ("auto-layout-view.galgas", 358)) ;
        switch (select_easyBindings_5F_syntax_42 (inCompiler)) {
        case 1: {
          var_enabledBindingDescriptor_14004 = GALGAS_multipleBindingDescriptor::constructor_noBinding (SOURCE_FILE ("auto-layout-view.galgas", 360)) ;
        } break ;
        case 2: {
          inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken_enabled COMMA_SOURCE_FILE ("auto-layout-view.galgas", 362)) ;
          GALGAS_abstractBooleanMultipleBindingExpressionAST var_bindingExpression_14234 ;
          nt_booleanMultipleBindingExpression_ (var_bindingExpression_14234, inCompiler) ;
          var_enabledBindingDescriptor_14004 = GALGAS_multipleBindingDescriptor::constructor_binding (var_bindingExpression_14234  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 364)) ;
        } break ;
        default:
          break ;
        }
        outArgument_outParameterList.addAssign_operation (var_parameterName_12981, GALGAS_autoLayoutClassParameterType::constructor_menuItem (SOURCE_FILE ("auto-layout-view.galgas", 368)), GALGAS_astAutoLayoutViewInstructionParameterValue::constructor_menuItem (var_menuItemTitle_13423.readProperty_string (), var_runActionDescriptor_13478, var_enabledBindingDescriptor_14004  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 369))  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 366)) ;
      } break ;
      case 4: {
        ...
        GALGAS_lstring var_viewName_14583 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      case 7: {
        GALGAS_luint var_uint_33__32__14953 = inCompiler->synthetizedAttribute_uint_33__32_value () ;
      ...
      case 8: {
        ...
        outArgument_outParameterList.addAssign_operation (var_parameterName_12981, GALGAS_autoLayoutClassParameterType::constructor_typeInt (SOURCE_FILE ("auto-layout-view.galgas", 386)), GALGAS_astAutoLayoutViewInstructionParameterValue::constructor_string (GALGAS_string ("-").add_operation (var_uint_33__32__15113.readProperty_uint ().getter_string (SOURCE_FILE ("auto-layout-view.galgas", 386)), inCompiler COMMA_SOURCE_FILE ("auto-layout-view.galgas", 386))  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 386))  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 386)) ;
      } break ;
      case 9: {
        GALGAS_lstring var_literalString_15271 = inCompiler->synthetizedAttribute_tokenString () ;
        ...
        outArgument_outParameterList.addAssign_operation (var_parameterName_12981, GALGAS_autoLayoutClassParameterType::constructor_typeString (SOURCE_FILE ("auto-layout-view.galgas", 389)), GALGAS_astAutoLayoutViewInstructionParameterValue::constructor_string (var_literalString_15271.readProperty_string ().getter_cStringRepresentation (SOURCE_FILE ("auto-layout-view.galgas", 389))  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 389))  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 389)) ;
      } break ;
      case 10: {
        inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken__2E_ COMMA_SOURCE_FILE ("auto-layout-view.galgas", 391)) ;
        GALGAS_lstring var_enumConstantName_15463 = inCompiler->synthetizedAttribute_tokenString () ;
        ...
        outArgument_outParameterList.addAssign_operation (var_parameterName_12981, GALGAS_autoLayoutClassParameterType::constructor_typeEnum (var_enumConstantName_15463  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 393)), GALGAS_astAutoLayoutViewInstructionParameterValue::constructor_string (GALGAS_string (".").add_operation (var_enumConstantName_15463.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("auto-layout-view.galgas", 393))  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 393))  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 393)) ;
      } break ;
      case 11: {
        inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken_enum COMMA_SOURCE_FILE ("auto-layout-view.galgas", 395)) ;
        GALGAS_lstring var_enumTypeName_15656 = inCompiler->synthetizedAttribute_tokenString () ;
        ...
        GALGAS_lstring var_enumFuncName_15711 = inCompiler->synthetizedAttribute_tokenString () ;
        ...
        outArgument_outParameterList.addAssign_operation (var_parameterName_12981, GALGAS_autoLayoutClassParameterType::constructor_typeStringArray (SOURCE_FILE ("auto-layout-view.galgas", 401)), GALGAS_astAutoLayoutViewInstructionParameterValue::constructor_enumFunc (var_enumTypeName_15656, var_enumFuncName_15711  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 401))  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 399)) ;
      } break ;
      default:
        break ;
      }
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_view_5F_instruction_i26_ (GALGAS_astAbstractViewInstructionDeclaration & outArgument_outInstruction,
  ...
  GALGAS_lstring var_stackViewName_16198 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  outArgument_outInstruction = GALGAS_astStackViewReferenceInstructionDeclaration::constructor_new (var_stackViewName_16198  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 415)) ;
}
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_view_5F_instruction_i27_ (GALGAS_astAbstractViewInstructionDeclaration & outArgument_outInstruction,
  ...
  GALGAS_astAutoLayoutViewFunctionCallList var_functionCallList_16566 ;
  nt_auto_5F_layout_5F_func_5F_call_5F_list_ (var_functionCallList_16566, inCompiler) ;
  GALGAS_optionalHiddenBinding var_optionalHiddenBinding_16619 ;
  switch (select_easyBindings_5F_syntax_43 (inCompiler)) {
  case 1: {
    var_optionalHiddenBinding_16619 = GALGAS_optionalHiddenBinding::constructor_noBinding (SOURCE_FILE ("auto-layout-view.galgas", 425)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken_hidden COMMA_SOURCE_FILE ("auto-layout-view.galgas", 427)) ;
    GALGAS_abstractBooleanMultipleBindingExpressionAST var_bindingExpression_16802 ;
    nt_booleanMultipleBindingExpression_ (var_bindingExpression_16802, inCompiler) ;
    var_optionalHiddenBinding_16619 = GALGAS_optionalHiddenBinding::constructor_binding (var_bindingExpression_16802  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 429)) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("auto-layout-view.galgas", 431)) ;
  GALGAS_astViewInstructionList var_instructionList_16910 = GALGAS_astViewInstructionList::constructor_emptyList (SOURCE_FILE ("auto-layout-view.galgas", 432)) ;
  nt_view_5F_instruction_5F_list_ (GALGAS_bool (false), var_instructionList_16910, inCompiler) ;
  outArgument_outInstruction = GALGAS_astVStackViewInstructionDeclaration::constructor_new (var_functionCallList_16566, var_instructionList_16910, var_optionalHiddenBinding_16619  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 434)) ;
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_view_5F_instruction_i28_ (GALGAS_astAbstractViewInstructionDeclaration & outArgument_outInstruction,
  ...
  GALGAS_astAutoLayoutViewFunctionCallList var_functionCallList_17415 ;
  nt_auto_5F_layout_5F_func_5F_call_5F_list_ (var_functionCallList_17415, inCompiler) ;
  GALGAS_optionalHiddenBinding var_optionalHiddenBinding_17468 ;
  switch (select_easyBindings_5F_syntax_44 (inCompiler)) {
  case 1: {
    var_optionalHiddenBinding_17468 = GALGAS_optionalHiddenBinding::constructor_noBinding (SOURCE_FILE ("auto-layout-view.galgas", 445)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken_hidden COMMA_SOURCE_FILE ("auto-layout-view.galgas", 447)) ;
    GALGAS_abstractBooleanMultipleBindingExpressionAST var_bindingExpression_17651 ;
    nt_booleanMultipleBindingExpression_ (var_bindingExpression_17651, inCompiler) ;
    var_optionalHiddenBinding_17468 = GALGAS_optionalHiddenBinding::constructor_binding (var_bindingExpression_17651  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 449)) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("auto-layout-view.galgas", 451)) ;
  GALGAS_astViewInstructionList var_instructionList_17759 = GALGAS_astViewInstructionList::constructor_emptyList (SOURCE_FILE ("auto-layout-view.galgas", 452)) ;
  nt_view_5F_instruction_5F_list_ (GALGAS_bool (true), var_instructionList_17759, inCompiler) ;
  outArgument_outInstruction = GALGAS_astHStackViewInstructionDeclaration::constructor_new (var_functionCallList_17415, var_instructionList_17759, var_optionalHiddenBinding_17468  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 454)) ;
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_view_5F_instruction_i29_ (GALGAS_astAbstractViewInstructionDeclaration & outArgument_outInstruction,
  ...
  GALGAS_astAutoLayoutViewFunctionCallList var_functionCallList_18263 ;
  nt_auto_5F_layout_5F_func_5F_call_5F_list_ (var_functionCallList_18263, inCompiler) ;
  GALGAS_optionalHiddenBinding var_optionalHiddenBinding_18316 ;
  switch (select_easyBindings_5F_syntax_45 (inCompiler)) {
  case 1: {
    var_optionalHiddenBinding_18316 = GALGAS_optionalHiddenBinding::constructor_noBinding (SOURCE_FILE ("auto-layout-view.galgas", 465)) ;
  } break ;
  case 2: {
    inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken_hidden COMMA_SOURCE_FILE ("auto-layout-view.galgas", 467)) ;
    GALGAS_abstractBooleanMultipleBindingExpressionAST var_bindingExpression_18499 ;
    nt_booleanMultipleBindingExpression_ (var_bindingExpression_18499, inCompiler) ;
    var_optionalHiddenBinding_18316 = GALGAS_optionalHiddenBinding::constructor_binding (var_bindingExpression_18499  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 469)) ;
  } break ;
  default:
    break ;
  }
  inCompiler->acceptTerminal (C_Lexique_easyBindings_5F_lexique::kToken__7B_ COMMA_SOURCE_FILE ("auto-layout-view.galgas", 471)) ;
  GALGAS_astViewInstructionList var_instructionList_18607 = GALGAS_astViewInstructionList::constructor_emptyList (SOURCE_FILE ("auto-layout-view.galgas", 472)) ;
  nt_view_5F_instruction_5F_list_ (GALGAS_bool (true), var_instructionList_18607, inCompiler) ;
  outArgument_outInstruction = GALGAS_astHSplitViewInstructionDeclaration::constructor_new (var_functionCallList_18263, var_instructionList_18607, var_optionalHiddenBinding_18316  COMMA_SOURCE_FILE ("auto-layout-view.galgas", 474)) ;
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_controller_5F_declaration_i52_ (GALGAS_bool inArgument_inAutoLayout,
  ...
  GALGAS_lstring var_controllerName_3642 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_tableViewControllerAttributListAST var_arrayControllerAttributListAST_3717 = GALGAS_tableViewControllerAttributListAST::constructor_emptyList (SOURCE_FILE ("table-view-controller.galgas", 78)) ;
  ...
  while (repeatFlag_2) {
    GALGAS_lstring var_attributeName_3788 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    GALGAS_abstractDefaultValue var_attributeValue_3863 ;
    nt_explicit_5F_value_ (var_attributeValue_3863, inCompiler) ;
    var_arrayControllerAttributListAST_3717.addAssign_operation (var_attributeName_3788, var_attributeValue_3863  COMMA_SOURCE_FILE ("table-view-controller.galgas", 84)) ;
  ...
  case 1: {
    ...
    var_isRoot_4004 = GALGAS_bool (true) ;
  } break ;
  case 2: {
    ...
    var_isRoot_4004 = GALGAS_bool (false) ;
  } break ;
  default:
    break ;
  }
  ...
  GALGAS_lstring var_relationshipName_4153 = inCompiler->synthetizedAttribute_tokenString () ;
  ...
  GALGAS_tableViewControllerBoundColumnListAST var_arrayControllerBoundColumnListAST_4234 = GALGAS_tableViewControllerBoundColumnListAST::constructor_emptyList (SOURCE_FILE ("table-view-controller.galgas", 100)) ;
  ...
  case 2: {
    ...
    while (repeatFlag_3) {
      ...
      case 2: {
        ...
        GALGAS_lstring var_columnName_4360 = inCompiler->synthetizedAttribute_tokenString () ;
        ...
        GALGAS_lstring var_sortPropertyName_4398 ;
        switch (select_easyBindings_5F_syntax_88 (inCompiler)) {
        case 1: {
          var_sortPropertyName_4398 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("table-view-controller.galgas", 111)) ;
        } break ;
        case 2: {
          ...
          var_sortPropertyName_4398 = inCompiler->synthetizedAttribute_tokenString () ;
        ...
        GALGAS_lstring var_columnOutletTypeName_4586 = inCompiler->synthetizedAttribute_tokenString () ;
        ...
        GALGAS_tableViewColumnBindingAST var_columnBindingAST_4661 ;
        nt_column_5F_bindings_ (var_columnBindingAST_4661, inCompiler) ;
        var_arrayControllerBoundColumnListAST_4234.addAssign_operation (var_columnName_4360, var_columnOutletTypeName_4586, var_columnBindingAST_4661, var_sortPropertyName_4398  COMMA_SOURCE_FILE ("table-view-controller.galgas", 118)) ;
      } break ;
      default:
        repeatFlag_3 = false ;
        break ;
  ...
  ioArgument_ioDeclarationAST.mProperty_mUnifiedDeclarationList.addAssign_operation (GALGAS_tableViewControllerDeclarationAST::constructor_new (constinArgument_inCurrentEntity, var_controllerName_3642, var_isRoot_4004, constinArgument_inRootEntity, var_relationshipName_4153, var_arrayControllerBoundColumnListAST_4234, var_arrayControllerAttributListAST_3717  COMMA_SOURCE_FILE ("table-view-controller.galgas", 126))  COMMA_SOURCE_FILE ("table-view-controller.galgas", 126)) ;
}
...
void cParser_easyBindings_5F_syntax::rule_easyBindings_5F_syntax_column_5F_bindings_i53_ (GALGAS_tableViewColumnBindingAST & outArgument_outColumnBindingAST,
  ...
  GALGAS_lstring var_runActionDescriptor_5361 = GALGAS_string::makeEmptyString ().getter_nowhere (SOURCE_FILE ("table-view-controller.galgas", 140)) ;
  GALGAS_multipleBindingDescriptor var_enabledBindingDescriptor_5409 = GALGAS_multipleBindingDescriptor::constructor_noBinding (SOURCE_FILE ("table-view-controller.galgas", 141)) ;
  GALGAS_multipleBindingDescriptor var_hiddenBindingDescriptor_5480 = GALGAS_multipleBindingDescriptor::constructor_noBinding (SOURCE_FILE ("table-view-controller.galgas", 142)) ;
  GALGAS_regularBindingList var_regularBindingList_5566 = GALGAS_regularBindingList::constructor_emptyList (SOURCE_FILE ("table-view-controller.galgas", 143)) ;
  bool repeatFlag_0 = true ;
  while (repeatFlag_0) {
    ...
    case 2: {
      ...
      enumGalgasBool test_1 = kBoolTrue ;
      if (kBoolTrue == test_1) {
        test_1 = GALGAS_bool (kIsNotEqual, var_runActionDescriptor_5361.readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_1) {
          TC_Array <C_FixItDescription> fixItArray2 ;
      ...
      var_runActionDescriptor_5361 = inCompiler->synthetizedAttribute_tokenString () ;
    ...
    case 3: {
      ...
      enumGalgasBool test_3 = kBoolTrue ;
      if (kBoolTrue == test_3) {
        test_3 = GALGAS_bool (kIsNotEqual, var_enabledBindingDescriptor_5409.objectCompare (GALGAS_multipleBindingDescriptor::constructor_noBinding (SOURCE_FILE ("table-view-controller.galgas", 154)))).boolEnum () ;
        if (kBoolTrue == test_3) {
          TC_Array <C_FixItDescription> fixItArray4 ;
      ...
      GALGAS_abstractBooleanMultipleBindingExpressionAST var_bindingExpression_6014 ;
      nt_booleanMultipleBindingExpression_ (var_bindingExpression_6014, inCompiler) ;
      var_enabledBindingDescriptor_5409 = GALGAS_multipleBindingDescriptor::constructor_binding (var_bindingExpression_6014  COMMA_SOURCE_FILE ("table-view-controller.galgas", 158)) ;
    } break ;
    case 4: {
      ...
      enumGalgasBool test_5 = kBoolTrue ;
      if (kBoolTrue == test_5) {
        test_5 = GALGAS_bool (kIsNotEqual, var_hiddenBindingDescriptor_5480.objectCompare (GALGAS_multipleBindingDescriptor::constructor_noBinding (SOURCE_FILE ("table-view-controller.galgas", 162)))).boolEnum () ;
        if (kBoolTrue == test_5) {
          TC_Array <C_FixItDescription> fixItArray6 ;
      ...
      GALGAS_abstractBooleanMultipleBindingExpressionAST var_bindingExpression_6349 ;
      nt_booleanMultipleBindingExpression_ (var_bindingExpression_6349, inCompiler) ;
      var_hiddenBindingDescriptor_5480 = GALGAS_multipleBindingDescriptor::constructor_binding (var_bindingExpression_6349  COMMA_SOURCE_FILE ("table-view-controller.galgas", 166)) ;
    } break ;
    case 5: {
      GALGAS_lstring var_bindingName_6501 = inCompiler->synthetizedAttribute_tokenString () ;
      ...
      GALGAS_observablePropertyList var_observablePropertyList_6558 = GALGAS_observablePropertyList::constructor_emptyList (SOURCE_FILE ("table-view-controller.galgas", 170)) ;
      bool repeatFlag_7 = true ;
      while (repeatFlag_7) {
        GALGAS_observablePropertyAST var_observableProperty_6653 ;
        nt_observable_5F_property_ (var_observableProperty_6653, inCompiler) ;
        var_observablePropertyList_6558.addAssign_operation (var_observableProperty_6653  COMMA_SOURCE_FILE ("table-view-controller.galgas", 173)) ;
      ...
      GALGAS_bindingOptionList var_bindingOptions_6789 ;
      nt_binding_5F_option_5F_list_ (var_bindingOptions_6789, inCompiler) ;
      var_regularBindingList_5566.addAssign_operation (var_bindingName_6501, var_observablePropertyList_6558, var_bindingOptions_6789  COMMA_SOURCE_FILE ("table-view-controller.galgas", 178)) ;
    } break ;
    default:
      repeatFlag_0 = false ;
      break ;
  ...
  outArgument_outColumnBindingAST = GALGAS_tableViewColumnBindingAST::constructor_new (var_runActionDescriptor_5361, var_enabledBindingDescriptor_5409, var_hiddenBindingDescriptor_5480, var_regularBindingList_5566  COMMA_SOURCE_FILE ("table-view-controller.galgas", 184)) ;
}
