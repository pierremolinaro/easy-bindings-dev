...
void routine_generateTestFile (const GALGAS_string constinArgument_inBundleIdentifier,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_stringlist var_outlet_5F_identifier_5F_list_5343 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("main-xib.ggs", 136)) ;
      cEnumerator_mainXibDescriptorList enumerator_5363 (constinArgument_inMainXibDescriptorList, kENUMERATION_UP) ;
      while (enumerator_5363.hasCurrentObject ()) {
        cEnumerator_mainXibLineDescriptorList enumerator_5414 (enumerator_5363.current_mLine (HERE), kENUMERATION_UP) ;
        while (enumerator_5414.hasCurrentObject ()) {
          switch (enumerator_5414.current_mElement (HERE).enumValue ()) {
          ...
          case GALGAS_mainXibElement::kEnum_outlet:
            {
              const cEnumAssociatedValues_mainXibElement_outlet * extractPtr_5567 = (const cEnumAssociatedValues_mainXibElement_outlet *) (enumerator_5414.current_mElement (HERE).unsafePointer ()) ;
              const GALGAS_lstring extractedValue_5509_outletName = extractPtr_5567->mAssociatedValue1 ;
              var_outlet_5F_identifier_5F_list_5343.addAssign_operation (extractedValue_5509_outletName.readProperty_string ()  COMMA_SOURCE_FILE ("main-xib.ggs", 142)) ;
            }
            break ;
          }
      ...
      GALGAS_string var_s_5607 = GALGAS_string (filewrapperTemplate_testFiles_test_5F_py (inCompiler, constinArgument_inBundleIdentifier, constinArgument_inProjectName, var_outlet_5F_identifier_5F_list_5343 COMMA_SOURCE_FILE ("main-xib.ggs", 146))) ;
      GALGAS_string var_header_5738 = GALGAS_string ("#!/usr/bin/python\n"
        "# coding=utf-8\n"
        "\n"
        ...
        "\n") ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("test.py"), GALGAS_string ("#"), var_header_5738, GALGAS_string::makeEmptyString (), var_s_5607, GALGAS_string ("#    ENTER USER CODE HERE\n"), GALGAS_string ("\n"
        "quitApplication ()\n"
        "\n"
...
static void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                         C_Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_astDeclarationStruct var_declarationStruct_1128 = GALGAS_astDeclarationStruct::constructor_default (SOURCE_FILE ("program.ggs", 23)) ;
  GALGAS_location joker_1267 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE ("program.ggs", 25))), GALGAS_string::makeEmptyString (), var_declarationStruct_1128, joker_1267  COMMA_SOURCE_FILE ("program.ggs", 25)) ;
  GALGAS_location var_endOfSourceFile_1475 ;
  var_endOfSourceFile_1475.drop () ;
  cGrammar_easyBindings_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, var_declarationStruct_1128, var_endOfSourceFile_1475  COMMA_SOURCE_FILE ("program.ggs", 27)) ;
  var_declarationStruct_1128.mProperty_mUnifiedDeclarationList.addAssign_operation (GALGAS_prefsDeclarationAST::constructor_new (GALGAS_lstring::constructor_new (function_preferencesName (inCompiler COMMA_SOURCE_FILE ("program.ggs", 30)), GALGAS_location::constructor_nowhere (SOURCE_FILE ("program.ggs", 30))  COMMA_SOURCE_FILE ("program.ggs", 30)), var_declarationStruct_1128.readProperty_mPreferences ()  COMMA_SOURCE_FILE ("program.ggs", 29))  COMMA_SOURCE_FILE ("program.ggs", 29)) ;
  {
  routine_enterAtomicClassesIn (var_declarationStruct_1128.mProperty_mUnifiedDeclarationList, inCompiler  COMMA_SOURCE_FILE ("program.ggs", 34)) ;
  }
  GALGAS_declarationListAST var_sortedDeclarationListAST_2025 ;
  {
  routine_sortProperties (constinArgument_inSourceFile.readProperty_string (), var_declarationStruct_1128.readProperty_mUnifiedDeclarationList (), var_sortedDeclarationListAST_2025, inCompiler  COMMA_SOURCE_FILE ("program.ggs", 36)) ;
  }
  GALGAS_semanticContext var_semanticContext_2139 = GALGAS_semanticContext::constructor_default (SOURCE_FILE ("program.ggs", 38)) ;
  var_semanticContext_2139.setter_setMAutoLayoutVStackFunctionMap (var_declarationStruct_1128.readProperty_mAutoLayoutVStackFunctionMap () COMMA_SOURCE_FILE ("program.ggs", 39)) ;
  var_semanticContext_2139.setter_setMAutoLayoutHStackFunctionMap (var_declarationStruct_1128.readProperty_mAutoLayoutHStackFunctionMap () COMMA_SOURCE_FILE ("program.ggs", 40)) ;
  var_semanticContext_2139.setter_setMEnumerationFunctionListAST (var_declarationStruct_1128.readProperty_mEnumerationFunctionListAST () COMMA_SOURCE_FILE ("program.ggs", 41)) ;
  GALGAS_generationStruct var_generation_2471 = GALGAS_generationStruct::constructor_default (SOURCE_FILE ("program.ggs", 42)) ;
  ...
  if (enumerator_2501.hasCurrentObject () && bool_0) {
    while (enumerator_2501.hasCurrentObject () && bool_0) {
      callExtensionMethod_firstAnalysisPhase ((cPtr_abstractDeclarationAST *) enumerator_2501.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_2139, var_generation_2471, inCompiler COMMA_SOURCE_FILE ("program.ggs", 44)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_1) {
      {
      routine_buildBindingSpecificationMap (var_semanticContext_2139, var_declarationStruct_1128.readProperty_mBindingSpecificationListMap (), inCompiler  COMMA_SOURCE_FILE ("program.ggs", 48)) ;
      }
    }
  }
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_2) {
      {
      routine_buildAutoLayoutBindingSpecificationMap (var_semanticContext_2139, var_declarationStruct_1128.readProperty_mAutoLayoutBindingSpecificationList (), inCompiler  COMMA_SOURCE_FILE ("program.ggs", 54)) ;
      }
    }
  }
  ...
  if (enumerator_3135.hasCurrentObject () && bool_3) {
    while (enumerator_3135.hasCurrentObject () && bool_3) {
      callExtensionMethod_secondAnalysisPhase ((cPtr_abstractDeclarationAST *) enumerator_3135.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_2139, var_generation_2471, inCompiler COMMA_SOURCE_FILE ("program.ggs", 61)) ;
  ...
  if (enumerator_3363.hasCurrentObject () && bool_4) {
    while (enumerator_3363.hasCurrentObject () && bool_4) {
      callExtensionMethod_thirdAnalysisPhase ((cPtr_abstractDeclarationAST *) enumerator_3363.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_2139, var_generation_2471, inCompiler COMMA_SOURCE_FILE ("program.ggs", 65)) ;
  ...
  if (enumerator_3591.hasCurrentObject () && bool_5) {
    while (enumerator_3591.hasCurrentObject () && bool_5) {
      callExtensionMethod_fourthAnalysisPhase ((cPtr_abstractDeclarationAST *) enumerator_3591.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_2139, var_generation_2471, inCompiler COMMA_SOURCE_FILE ("program.ggs", 69)) ;
  ...
  if (kBoolTrue == test_6) {
    ...
    if (kBoolTrue == test_6) {
      ...
      while (enumerator_3879.hasCurrentObject ()) {
        ...
        var_semanticContext_2139.readProperty_mClassMap ().method_searchKey (enumerator_3879.current_mEnumName (HERE), var_type_3997, joker_3999_3, joker_3999_2, joker_3999_1, inCompiler COMMA_SOURCE_FILE ("program.ggs", 74)) ;
        enumGalgasBool test_7 = kBoolTrue ;
        if (kBoolTrue == test_7) {
          test_7 = var_type_3997.getter_isAtomic (SOURCE_FILE ("program.ggs", 75)).operator_not (SOURCE_FILE ("program.ggs", 75)).boolEnum () ;
          if (kBoolTrue == test_7) {
            TC_Array <C_FixItDescription> fixItArray8 ;
            inCompiler->emitSemanticError (enumerator_3879.current_mEnumName (HERE).readProperty_location (), GALGAS_string ("this type should be an enum type"), fixItArray8  COMMA_SOURCE_FILE ("program.ggs", 76)) ;
          }
        }
        if (kBoolFalse == test_7) {
          GALGAS_typeKind var_typeKind_4151 ;
          var_type_3997.method_atomic (var_typeKind_4151, inCompiler COMMA_SOURCE_FILE ("program.ggs", 78)) ;
          enumGalgasBool test_9 = kBoolTrue ;
          if (kBoolTrue == test_9) {
            test_9 = var_typeKind_4151.getter_isEnumType (SOURCE_FILE ("program.ggs", 79)).operator_not (SOURCE_FILE ("program.ggs", 79)).boolEnum () ;
            if (kBoolTrue == test_9) {
              TC_Array <C_FixItDescription> fixItArray10 ;
              inCompiler->emitSemanticError (enumerator_3879.current_mEnumName (HERE).readProperty_location (), GALGAS_string ("this type should be an enum type"), fixItArray10  COMMA_SOURCE_FILE ("program.ggs", 80)) ;
            }
          }
        }
  ...
  if (kBoolTrue == test_11) {
    ...
    if (kBoolTrue == test_11) {
      {
      routine_graphvizAnalysis (constinArgument_inSourceFile.readProperty_string ().getter_stringByDeletingLastPathComponent (SOURCE_FILE ("program.ggs", 87)), var_semanticContext_2139, var_declarationStruct_1128.readProperty_mGraphvizList (), inCompiler  COMMA_SOURCE_FILE ("program.ggs", 87)) ;
      }
    }
  }
  ...
  if (kBoolTrue == test_12) {
    ...
    if (kBoolTrue == test_12) {
      {
      routine_generateCode (var_declarationStruct_1128.readProperty_mXcodeProject ().readProperty_string (), var_generation_2471, constinArgument_inSourceFile.readProperty_string (), inCompiler  COMMA_SOURCE_FILE ("program.ggs", 91)) ;
      }
    }
  }
}
