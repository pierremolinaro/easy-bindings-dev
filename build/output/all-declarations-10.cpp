...
void routine_generateTestFile (const GALGAS_string constinArgument_inBundleIdentifier,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_bool test_1 = GALGAS_bool (kIsStrictSup, constinArgument_inMainXibDescriptorList.getter_length (SOURCE_FILE ("main-xib.galgas", 135)).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("main-xib.galgas", 135)).getter_uint (inCompiler COMMA_SOURCE_FILE ("main-xib.galgas", 135)))) ;
...
static void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  bool bool_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 43)).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("program.galgas", 43)).getter_uint (inCompiler COMMA_SOURCE_FILE ("program.galgas", 43)))).isValidAndTrue () ;
  if (enumerator_2501.hasCurrentObject () && bool_0) {
    while (enumerator_2501.hasCurrentObject () && bool_0) {
      callExtensionMethod_firstAnalysisPhase ((cPtr_abstractDeclarationAST *) enumerator_2501.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_2139, var_generation_2471, inCompiler COMMA_SOURCE_FILE ("program.galgas", 44)) ;
      enumerator_2501.gotoNextObject () ;
      if (enumerator_2501.hasCurrentObject ()) {
        bool_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 43)).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("program.galgas", 43)).getter_uint (inCompiler COMMA_SOURCE_FILE ("program.galgas", 43)))).isValidAndTrue () ;
      }
    }
  }
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 47)).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("program.galgas", 47)).getter_uint (inCompiler COMMA_SOURCE_FILE ("program.galgas", 47)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      {
  ...
  if (kBoolTrue == test_2) {
    test_2 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 53)).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("program.galgas", 53)).getter_uint (inCompiler COMMA_SOURCE_FILE ("program.galgas", 53)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      {
  ...
  bool bool_3 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 60)).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("program.galgas", 60)).getter_uint (inCompiler COMMA_SOURCE_FILE ("program.galgas", 60)))).isValidAndTrue () ;
  if (enumerator_3135.hasCurrentObject () && bool_3) {
    while (enumerator_3135.hasCurrentObject () && bool_3) {
      callExtensionMethod_secondAnalysisPhase ((cPtr_abstractDeclarationAST *) enumerator_3135.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_2139, var_generation_2471, inCompiler COMMA_SOURCE_FILE ("program.galgas", 61)) ;
      enumerator_3135.gotoNextObject () ;
      if (enumerator_3135.hasCurrentObject ()) {
        bool_3 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 60)).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("program.galgas", 60)).getter_uint (inCompiler COMMA_SOURCE_FILE ("program.galgas", 60)))).isValidAndTrue () ;
      }
    }
  }
  cEnumerator_declarationListAST enumerator_3363 (var_sortedDeclarationListAST_2025, kENUMERATION_UP) ;
  bool bool_4 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 64)).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("program.galgas", 64)).getter_uint (inCompiler COMMA_SOURCE_FILE ("program.galgas", 64)))).isValidAndTrue () ;
  if (enumerator_3363.hasCurrentObject () && bool_4) {
    while (enumerator_3363.hasCurrentObject () && bool_4) {
      callExtensionMethod_thirdAnalysisPhase ((cPtr_abstractDeclarationAST *) enumerator_3363.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_2139, var_generation_2471, inCompiler COMMA_SOURCE_FILE ("program.galgas", 65)) ;
      enumerator_3363.gotoNextObject () ;
      if (enumerator_3363.hasCurrentObject ()) {
        bool_4 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 64)).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("program.galgas", 64)).getter_uint (inCompiler COMMA_SOURCE_FILE ("program.galgas", 64)))).isValidAndTrue () ;
      }
    }
  }
  cEnumerator_declarationListAST enumerator_3591 (var_sortedDeclarationListAST_2025, kENUMERATION_UP) ;
  bool bool_5 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 68)).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("program.galgas", 68)).getter_uint (inCompiler COMMA_SOURCE_FILE ("program.galgas", 68)))).isValidAndTrue () ;
  if (enumerator_3591.hasCurrentObject () && bool_5) {
    while (enumerator_3591.hasCurrentObject () && bool_5) {
      callExtensionMethod_fourthAnalysisPhase ((cPtr_abstractDeclarationAST *) enumerator_3591.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_2139, var_generation_2471, inCompiler COMMA_SOURCE_FILE ("program.galgas", 69)) ;
      enumerator_3591.gotoNextObject () ;
      if (enumerator_3591.hasCurrentObject ()) {
        bool_5 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 68)).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("program.galgas", 68)).getter_uint (inCompiler COMMA_SOURCE_FILE ("program.galgas", 68)))).isValidAndTrue () ;
      }
    }
  }
  enumGalgasBool test_6 = kBoolTrue ;
  if (kBoolTrue == test_6) {
    test_6 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 72)).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("program.galgas", 72)).getter_uint (inCompiler COMMA_SOURCE_FILE ("program.galgas", 72)))).boolEnum () ;
    if (kBoolTrue == test_6) {
  ...
  if (kBoolTrue == test_11) {
    test_11 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 86)).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("program.galgas", 86)).getter_uint (inCompiler COMMA_SOURCE_FILE ("program.galgas", 86)))).boolEnum () ;
    if (kBoolTrue == test_11) {
      {
  ...
  if (kBoolTrue == test_12) {
    test_12 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("program.galgas", 90)).objectCompare (GALGAS_bigint ("0", inCompiler  COMMA_SOURCE_FILE ("program.galgas", 90)).getter_uint (inCompiler COMMA_SOURCE_FILE ("program.galgas", 90)))).boolEnum () ;
    if (kBoolTrue == test_12) {
      {
