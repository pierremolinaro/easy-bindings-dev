...
static void extensionMethod_entityForGeneration_generateCode (const cPtr_abstractFileGeneration * inObject,
  ...
  GALGAS_string var_header_12922 = GALGAS_string ("//").add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (45)), GALGAS_uint ((uint32_t) 118U)  COMMA_SOURCE_FILE ("entity.galgas", 361)), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 361)).add_operation (GALGAS_string ("\n"
    "//  THIS FILE IS REGENERATED BY EASY BINDINGS, ONLY MODIFY IT WITHIN USER ZONES\n"
    "//"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 361)).add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (45)), GALGAS_uint ((uint32_t) 118U)  COMMA_SOURCE_FILE ("entity.galgas", 363)), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 363)).add_operation (GALGAS_string ("\n"
    "\n"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 363)).add_operation (GALGAS_string ("import Cocoa\n"
    "\n"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 363)).add_operation (GALGAS_string ("//"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 364)).add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (45)), GALGAS_uint ((uint32_t) 118U)  COMMA_SOURCE_FILE ("entity.galgas", 365)), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 365)).add_operation (GALGAS_string ("\n"
    "\n"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 365)) ;
  {
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_fileName_12756, GALGAS_string ("//"), var_header_12922, GALGAS_string ("\n"
    "\n"), var_s_12199, GALGAS_string ("\n"), GALGAS_string ("}\n"
    "\n"
    "//").add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (45)), GALGAS_uint ((uint32_t) 118U)  COMMA_SOURCE_FILE ("entity.galgas", 374)), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 374)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 374)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 366)) ;
  }
  ...
  var_s_12199 = GALGAS_string (filewrapperTemplate_entityGenerationTemplate_entityToOneImplementationInSwift (inCompiler, temp_22.getter_mEntityName (HERE), var_superEntityName_11969, temp_23.getter_mPropertyGenerationList (HERE), var_proxyGenerationList_10935, var_toManyProxyGenerationList_10995, var_atomicPropertyGenerationList_10609, var_transientPropertyGenerationList_10681, var_computedPropertyGenerationList_10751, var_toOnePropertyGenerationList_10815, var_toManyPropertyGenerationList_10881, temp_24.getter_mSignatureSet (HERE), temp_25.getter_mIsGraphicEntity (HERE), temp_26.getter_mIsAbstract (HERE), temp_27.getter_mOverridenTransients (HERE), temp_28.getter_mExternSwiftDelegateList (HERE) COMMA_SOURCE_FILE ("entity.galgas", 378))) ;
  const GALGAS_entityForGeneration temp_29 = object ;
  var_fileName_12756 = GALGAS_string ("toone-").add_operation (temp_29.getter_mEntityName (HERE), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 396)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 396)) ;
  ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_12756  COMMA_SOURCE_FILE ("entity.galgas", 397)) ;
  {
  GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_12756, var_s_12199, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 398)) ;
  }
  ...
  var_s_12199 = GALGAS_string (filewrapperTemplate_entityGenerationTemplate_entityToManyImplementationInSwift (inCompiler, temp_30.getter_mEntityName (HERE), var_superEntityName_11969, temp_31.getter_mPropertyGenerationList (HERE), var_proxyGenerationList_10935, var_toManyProxyGenerationList_10995, var_atomicPropertyGenerationList_10609, var_transientPropertyGenerationList_10681, var_computedPropertyGenerationList_10751, var_toOnePropertyGenerationList_10815, var_toManyPropertyGenerationList_10881, temp_32.getter_mSignatureSet (HERE), temp_33.getter_mIsGraphicEntity (HERE), temp_34.getter_mIsAbstract (HERE), temp_35.getter_mOverridenTransients (HERE), temp_36.getter_mExternSwiftDelegateList (HERE) COMMA_SOURCE_FILE ("entity.galgas", 403))) ;
  const GALGAS_entityForGeneration temp_37 = object ;
  var_fileName_12756 = GALGAS_string ("tomany-").add_operation (temp_37.getter_mEntityName (HERE), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 421)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 421)) ;
  ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_12756  COMMA_SOURCE_FILE ("entity.galgas", 422)) ;
  {
  GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_12756, var_s_12199, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 423)) ;
  }
}
...
void routine_generateEBManagedObjectContext (const GALGAS_entityListForGeneratingEBManagedObjectContext constinArgument_inEntityListForGeneration,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inEntityListForGeneration.getter_length (SOURCE_FILE ("entity.galgas", 437)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_fileName_15367 = GALGAS_string ("EBManagedObjectFactory.swift") ;
      ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_15367  COMMA_SOURCE_FILE ("entity.galgas", 439)) ;
      GALGAS_string var_s_15446 = GALGAS_string (filewrapperTemplate_entityGenerationTemplate_managedObjectFactory (inCompiler, constinArgument_inEntityListForGeneration COMMA_SOURCE_FILE ("entity.galgas", 440))) ;
      {
      GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_15367, var_s_15446, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 443)) ;
      }
    }
  }
}
