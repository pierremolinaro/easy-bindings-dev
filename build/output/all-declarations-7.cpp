...
GALGAS_string filewrapperTemplate_entityGenerationTemplate_entityToManyImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (kBoolTrue == test_8) {
    ...
    result << "\n"
      ...
      "      self.setProp (objectArray)\n"
      "    }\n" ;
    GALGAS_uint index_43508_ (0) ;
    if (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
      cEnumerator_atomicPropertyGenerationList enumerator_43508 (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
      while (enumerator_43508.hasCurrentObject ()) {
        result << "    self.addEBObserverOf_" ;
        result << enumerator_43508.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
        result << " (self.mObserverForWritingPreferences)\n" ;
        index_43508_.increment () ;
