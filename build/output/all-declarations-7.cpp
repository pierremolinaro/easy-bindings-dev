...
static void extensionMethod_entityDeclarationAST_firstAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_entityDeclarationAST * object = (const cPtr_entityDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_entityDeclarationAST) ;
  GALGAS_actionMap var_actionMap_5019 ;
  {
  const GALGAS_entityDeclarationAST temp_0 = object ;
  routine_buildActionMap (temp_0.getter_mActionDeclarationList (HERE), var_actionMap_5019, inCompiler  COMMA_SOURCE_FILE ("entity.galgas", 152)) ;
  }
  {
  const GALGAS_entityDeclarationAST temp_1 = object ;
...
static void extensionMethod_entityDeclarationAST_secondAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_propertyMap var_inheritedPropertyMap_5730 ;
      const GALGAS_entityDeclarationAST temp_2 = object ;
      GALGAS_classKind joker_5684 ; // Joker input parameter
      GALGAS_actionMap joker_5738_2 ; // Joker input parameter
      GALGAS_propertyGenerationList joker_5738_1 ; // Joker input parameter
      ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_2.getter_mSuperEntityName (HERE), joker_5684, var_inheritedPropertyMap_5730, joker_5738_2, joker_5738_1, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 170)) ;
      GALGAS_propertyMap var_propertyMap_5905 ;
      const GALGAS_entityDeclarationAST temp_3 = object ;
      GALGAS_classKind joker_5868 ; // Joker input parameter
      GALGAS_actionMap joker_5913_2 ; // Joker input parameter
      GALGAS_propertyGenerationList joker_5913_1 ; // Joker input parameter
      ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_3.getter_mClassName (HERE), joker_5868, var_propertyMap_5905, joker_5913_2, joker_5913_1, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 177)) ;
      GALGAS_propertyMap var_newPropertyMap_5968 = var_inheritedPropertyMap_5730 ;
      cEnumerator_propertyMap enumerator_6150 (var_propertyMap_5905, kENUMERATION_UP) ;
      while (enumerator_6150.hasCurrentObject ()) {
        enumGalgasBool test_4 = kBoolTrue ;
        if (kBoolTrue == test_4) {
          test_4 = enumerator_6150.current_mIsOverriding (HERE).boolEnum () ;
          if (kBoolTrue == test_4) {
            GALGAS_propertyKind joker_6228_3 ; // Joker input parameter
            GALGAS_actionMap joker_6228_2 ; // Joker input parameter
            GALGAS_bool joker_6228_1 ; // Joker input parameter
            var_inheritedPropertyMap_5730.method_searchKey (enumerator_6150.current_lkey (HERE), joker_6228_3, joker_6228_2, joker_6228_1, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 190)) ;
          }
        }
        if (kBoolFalse == test_4) {
          {
          var_newPropertyMap_5968.setter_insertKey (enumerator_6150.current_lkey (HERE), enumerator_6150.current_mKind (HERE), enumerator_6150.current_mActionMap (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 193)) ;
          }
        }
        enumerator_6150.gotoNextObject () ;
      }
      const GALGAS_entityDeclarationAST temp_5 = object ;
      cMapElement_classMap * objectArray_6409 = (cMapElement_classMap *) ioArgument_ioSemanticContext.mProperty_mClassMap.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, temp_5.getter_mClassName (HERE), kSearchErrorMessage_classMap_searchKey  COMMA_SOURCE_FILE ("entity.galgas", 197)) ;
      if (NULL != objectArray_6409) {
        macroValidSharedObject (objectArray_6409, cMapElement_classMap) ;
        objectArray_6409->mProperty_mPropertyMap = var_newPropertyMap_5968 ;
      }
    }
  }
}
...
static void extensionMethod_entityDeclarationAST_fourthAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_entityDeclarationAST * object = (const cPtr_entityDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_entityDeclarationAST) ;
  GALGAS_propertyMap var_propertyMap_6918 ;
  GALGAS_propertyGenerationList var_propertyGenerationList_6981 ;
  const GALGAS_entityDeclarationAST temp_0 = object ;
  GALGAS_classKind joker_6883 ; // Joker input parameter
  GALGAS_actionMap joker_6924 ; // Joker input parameter
  ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_0.getter_mClassName (HERE), joker_6883, var_propertyMap_6918, joker_6924, var_propertyGenerationList_6981, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 211)) ;
  GALGAS_stringset var_overridenTransients_7119 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("entity.galgas", 219)) ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    const GALGAS_entityDeclarationAST temp_2 = object ;
    const GALGAS_entityDeclarationAST temp_3 = object ;
    ...
    if (kBoolTrue == test_1) {
      GALGAS_classKind var_superClassKind_7303 ;
      GALGAS_propertyMap var_superPropertyMap_7344 ;
      const GALGAS_entityDeclarationAST temp_4 = object ;
      GALGAS_actionMap joker_7352_2 ; // Joker input parameter
      GALGAS_propertyGenerationList joker_7352_1 ; // Joker input parameter
      ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_4.getter_mSuperEntityName (HERE), var_superClassKind_7303, var_superPropertyMap_7344, joker_7352_2, joker_7352_1, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 221)) ;
      switch (var_superClassKind_7303.enumValue ()) {
      ...
      case GALGAS_classKind::kEnum_entity:
        {
          const cEnumAssociatedValues_classKind_entity * extractPtr_8880 = (const cEnumAssociatedValues_classKind_entity *) (var_superClassKind_7303.unsafePointer ()) ;
          const GALGAS_bool extractedValue_isGraphic = extractPtr_8880->mAssociatedValue1 ;
          const GALGAS_bool extractedValue_isAbstract = extractPtr_8880->mAssociatedValue2 ;
          ...
          if (kBoolTrue == test_15) {
            ...
            if (kBoolTrue == test_15) {
              cEnumerator_propertyMap enumerator_8034 (var_superPropertyMap_7344, kENUMERATION_UP) ;
              while (enumerator_8034.hasCurrentObject ()) {
                enumGalgasBool test_17 = kBoolTrue ;
                if (kBoolTrue == test_17) {
                  test_17 = extensionGetter_isAbstract (enumerator_8034.current (HERE), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 240)).boolEnum () ;
                  if (kBoolTrue == test_17) {
                    enumGalgasBool test_18 = kBoolTrue ;
                    if (kBoolTrue == test_18) {
                      test_18 = var_propertyMap_6918.getter_hasKey (enumerator_8034.current (HERE).getter_lkey (HERE).getter_string (HERE) COMMA_SOURCE_FILE ("entity.galgas", 241)).boolEnum () ;
                      if (kBoolTrue == test_18) {
                        var_overridenTransients_7119.addAssign_operation (enumerator_8034.current (HERE).getter_lkey (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("entity.galgas", 242)) ;
                        GALGAS_propertyKind var_propertyKind_8303 ;
                        GALGAS_actionMap joker_8305_2 ; // Joker input parameter
                        GALGAS_bool joker_8305_1 ; // Joker input parameter
                        var_propertyMap_6918.method_searchKey (enumerator_8034.current (HERE).getter_lkey (HERE), var_propertyKind_8303, joker_8305_2, joker_8305_1, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 243)) ;
                        GALGAS_string var_typeName_8335 = extensionGetter_typeName (var_propertyKind_8303, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 244)) ;
                        GALGAS_string var_superTypeName_8393 = extensionGetter_typeName (enumerator_8034.current (HERE).getter_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 245)) ;
                        enumGalgasBool test_19 = kBoolTrue ;
                        if (kBoolTrue == test_19) {
                          test_19 = GALGAS_bool (kIsNotEqual, var_typeName_8335.objectCompare (var_superTypeName_8393)).boolEnum () ;
                          if (kBoolTrue == test_19) {
                            TC_Array <C_FixItDescription> fixItArray20 ;
                            inCompiler->emitSemanticError (var_propertyMap_6918.getter_locationForKey (enumerator_8034.current (HERE).getter_lkey (HERE).getter_string (SOURCE_FILE ("entity.galgas", 247)), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 247)), GALGAS_string ("type '").add_operation (var_superTypeName_8393, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 248)).add_operation (GALGAS_string ("' is required by declaration in super entity"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 248)), fixItArray20  COMMA_SOURCE_FILE ("entity.galgas", 247)) ;
                          }
                        }
                      }
                    }
                    if (kBoolFalse == test_18) {
                      ...
                      inCompiler->emitSemanticError (temp_21.getter_mClassName (HERE).getter_location (SOURCE_FILE ("entity.galgas", 251)), GALGAS_string ("transient '").add_operation (enumerator_8034.current (HERE).getter_lkey (HERE).getter_string (SOURCE_FILE ("entity.galgas", 252)), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 252)).add_operation (GALGAS_string ("' should be defined, it is declared abstract in super entity"), inCompiler COMMA_SOURCE_FILE ("entity.galgas", 252)), fixItArray22  COMMA_SOURCE_FILE ("entity.galgas", 251)) ;
                    }
                  }
                }
  ...
  GALGAS_bool var_cursorForKnob_5F_option_8942 = GALGAS_bool (false) ;
  GALGAS_bool var_translate_5F_option_8973 = GALGAS_bool (false) ;
  GALGAS_bool var_acceptedTranslation_5F_option_9014 = GALGAS_bool (false) ;
  GALGAS_bool var_move_5F_option_9040 = GALGAS_bool (false) ;
  GALGAS_bool var_snapToGrid_5F_option_9072 = GALGAS_bool (false) ;
  GALGAS_bool var_flipHorizontally_5F_option_9110 = GALGAS_bool (false) ;
  GALGAS_bool var_flipVertically_5F_option_9146 = GALGAS_bool (false) ;
  GALGAS_bool var_rotate_5F_option_9174 = GALGAS_bool (false) ;
  GALGAS_bool var_saveIntoAdditionalDictionary_5F_option_9224 = GALGAS_bool (false) ;
  GALGAS_bool var_canCopyAndPaste_5F_option_9261 = GALGAS_bool (false) ;
  GALGAS_bool var_operationAfterPasting_5F_option_9304 = GALGAS_bool (false) ;
  GALGAS_bool var_cannotBeDeleted_5F_option_9341 = GALGAS_bool (false) ;
  const GALGAS_entityDeclarationAST temp_23 = object ;
  cEnumerator_lstringlist enumerator_9402 (temp_23.getter_mGraphicOptionArray (HERE), kENUMERATION_UP) ;
  while (enumerator_9402.hasCurrentObject ()) {
    enumGalgasBool test_24 = kBoolTrue ;
    if (kBoolTrue == test_24) {
      test_24 = GALGAS_bool (kIsEqual, enumerator_9402.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("cursorForKnob"))).boolEnum () ;
      if (kBoolTrue == test_24) {
        enumGalgasBool test_25 = kBoolTrue ;
        if (kBoolTrue == test_25) {
          test_25 = var_cursorForKnob_5F_option_8942.boolEnum () ;
          if (kBoolTrue == test_25) {
            TC_Array <C_FixItDescription> fixItArray26 ;
            inCompiler->emitSemanticError (enumerator_9402.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 276)), GALGAS_string ("duplicated option"), fixItArray26  COMMA_SOURCE_FILE ("entity.galgas", 276)) ;
          }
        }
        var_cursorForKnob_5F_option_8942 = GALGAS_bool (true) ;
      }
    }
    if (kBoolFalse == test_24) {
      enumGalgasBool test_27 = kBoolTrue ;
      if (kBoolTrue == test_27) {
        test_27 = GALGAS_bool (kIsEqual, enumerator_9402.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("acceptedTranslation"))).boolEnum () ;
        if (kBoolTrue == test_27) {
          enumGalgasBool test_28 = kBoolTrue ;
          if (kBoolTrue == test_28) {
            test_28 = var_acceptedTranslation_5F_option_9014.boolEnum () ;
            if (kBoolTrue == test_28) {
              TC_Array <C_FixItDescription> fixItArray29 ;
              inCompiler->emitSemanticError (enumerator_9402.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 281)), GALGAS_string ("duplicated option"), fixItArray29  COMMA_SOURCE_FILE ("entity.galgas", 281)) ;
            }
          }
          var_acceptedTranslation_5F_option_9014 = GALGAS_bool (true) ;
        }
      }
      if (kBoolFalse == test_27) {
        enumGalgasBool test_30 = kBoolTrue ;
        if (kBoolTrue == test_30) {
          test_30 = GALGAS_bool (kIsEqual, enumerator_9402.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("translate"))).boolEnum () ;
          if (kBoolTrue == test_30) {
            enumGalgasBool test_31 = kBoolTrue ;
            if (kBoolTrue == test_31) {
              test_31 = var_translate_5F_option_8973.boolEnum () ;
              if (kBoolTrue == test_31) {
                TC_Array <C_FixItDescription> fixItArray32 ;
                inCompiler->emitSemanticError (enumerator_9402.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 286)), GALGAS_string ("duplicated option"), fixItArray32  COMMA_SOURCE_FILE ("entity.galgas", 286)) ;
              }
            }
            var_translate_5F_option_8973 = GALGAS_bool (true) ;
          }
        }
        if (kBoolFalse == test_30) {
          enumGalgasBool test_33 = kBoolTrue ;
          if (kBoolTrue == test_33) {
            test_33 = GALGAS_bool (kIsEqual, enumerator_9402.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("move"))).boolEnum () ;
            if (kBoolTrue == test_33) {
              enumGalgasBool test_34 = kBoolTrue ;
              if (kBoolTrue == test_34) {
                test_34 = var_move_5F_option_9040.boolEnum () ;
                if (kBoolTrue == test_34) {
                  TC_Array <C_FixItDescription> fixItArray35 ;
                  inCompiler->emitSemanticError (enumerator_9402.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 291)), GALGAS_string ("duplicated option"), fixItArray35  COMMA_SOURCE_FILE ("entity.galgas", 291)) ;
                }
              }
              var_move_5F_option_9040 = GALGAS_bool (true) ;
            }
          }
          if (kBoolFalse == test_33) {
            enumGalgasBool test_36 = kBoolTrue ;
            if (kBoolTrue == test_36) {
              test_36 = GALGAS_bool (kIsEqual, enumerator_9402.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("snapToGrid"))).boolEnum () ;
              if (kBoolTrue == test_36) {
                enumGalgasBool test_37 = kBoolTrue ;
                if (kBoolTrue == test_37) {
                  test_37 = var_snapToGrid_5F_option_9072.boolEnum () ;
                  if (kBoolTrue == test_37) {
                    TC_Array <C_FixItDescription> fixItArray38 ;
                    inCompiler->emitSemanticError (enumerator_9402.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 296)), GALGAS_string ("duplicated option"), fixItArray38  COMMA_SOURCE_FILE ("entity.galgas", 296)) ;
                  }
                }
                var_snapToGrid_5F_option_9072 = GALGAS_bool (true) ;
              }
            }
            if (kBoolFalse == test_36) {
              enumGalgasBool test_39 = kBoolTrue ;
              if (kBoolTrue == test_39) {
                test_39 = GALGAS_bool (kIsEqual, enumerator_9402.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("flipHorizontally"))).boolEnum () ;
                if (kBoolTrue == test_39) {
                  enumGalgasBool test_40 = kBoolTrue ;
                  if (kBoolTrue == test_40) {
                    test_40 = var_flipHorizontally_5F_option_9110.boolEnum () ;
                    if (kBoolTrue == test_40) {
                      TC_Array <C_FixItDescription> fixItArray41 ;
                      inCompiler->emitSemanticError (enumerator_9402.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 301)), GALGAS_string ("duplicated option"), fixItArray41  COMMA_SOURCE_FILE ("entity.galgas", 301)) ;
                    }
                  }
                  var_flipHorizontally_5F_option_9110 = GALGAS_bool (true) ;
                }
              }
              if (kBoolFalse == test_39) {
                enumGalgasBool test_42 = kBoolTrue ;
                if (kBoolTrue == test_42) {
                  test_42 = GALGAS_bool (kIsEqual, enumerator_9402.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("flipVertically"))).boolEnum () ;
                  if (kBoolTrue == test_42) {
                    enumGalgasBool test_43 = kBoolTrue ;
                    if (kBoolTrue == test_43) {
                      test_43 = var_flipVertically_5F_option_9146.boolEnum () ;
                      if (kBoolTrue == test_43) {
                        TC_Array <C_FixItDescription> fixItArray44 ;
                        inCompiler->emitSemanticError (enumerator_9402.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 306)), GALGAS_string ("duplicated option"), fixItArray44  COMMA_SOURCE_FILE ("entity.galgas", 306)) ;
                      }
                    }
                    var_flipVertically_5F_option_9146 = GALGAS_bool (true) ;
                  }
                }
                if (kBoolFalse == test_42) {
                  enumGalgasBool test_45 = kBoolTrue ;
                  if (kBoolTrue == test_45) {
                    test_45 = GALGAS_bool (kIsEqual, enumerator_9402.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("rotate"))).boolEnum () ;
                    if (kBoolTrue == test_45) {
                      enumGalgasBool test_46 = kBoolTrue ;
                      if (kBoolTrue == test_46) {
                        test_46 = var_rotate_5F_option_9174.boolEnum () ;
                        if (kBoolTrue == test_46) {
                          TC_Array <C_FixItDescription> fixItArray47 ;
                          inCompiler->emitSemanticError (enumerator_9402.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 311)), GALGAS_string ("duplicated option"), fixItArray47  COMMA_SOURCE_FILE ("entity.galgas", 311)) ;
                        }
                      }
                      var_rotate_5F_option_9174 = GALGAS_bool (true) ;
                    }
                  }
                  if (kBoolFalse == test_45) {
                    enumGalgasBool test_48 = kBoolTrue ;
                    if (kBoolTrue == test_48) {
                      test_48 = GALGAS_bool (kIsEqual, enumerator_9402.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("saveIntoAdditionalDictionary"))).boolEnum () ;
                      if (kBoolTrue == test_48) {
                        enumGalgasBool test_49 = kBoolTrue ;
                        if (kBoolTrue == test_49) {
                          test_49 = var_saveIntoAdditionalDictionary_5F_option_9224.boolEnum () ;
                          if (kBoolTrue == test_49) {
                            TC_Array <C_FixItDescription> fixItArray50 ;
                            inCompiler->emitSemanticError (enumerator_9402.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 316)), GALGAS_string ("duplicated option"), fixItArray50  COMMA_SOURCE_FILE ("entity.galgas", 316)) ;
                          }
                        }
                        var_saveIntoAdditionalDictionary_5F_option_9224 = GALGAS_bool (true) ;
                      }
                    }
                    if (kBoolFalse == test_48) {
                      enumGalgasBool test_51 = kBoolTrue ;
                      if (kBoolTrue == test_51) {
                        test_51 = GALGAS_bool (kIsEqual, enumerator_9402.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("canCopyAndPaste"))).boolEnum () ;
                        if (kBoolTrue == test_51) {
                          enumGalgasBool test_52 = kBoolTrue ;
                          if (kBoolTrue == test_52) {
                            test_52 = var_canCopyAndPaste_5F_option_9261.boolEnum () ;
                            if (kBoolTrue == test_52) {
                              TC_Array <C_FixItDescription> fixItArray53 ;
                              inCompiler->emitSemanticError (enumerator_9402.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 321)), GALGAS_string ("duplicated option"), fixItArray53  COMMA_SOURCE_FILE ("entity.galgas", 321)) ;
                            }
                          }
                          var_canCopyAndPaste_5F_option_9261 = GALGAS_bool (true) ;
                        }
                      }
                      if (kBoolFalse == test_51) {
                        enumGalgasBool test_54 = kBoolTrue ;
                        if (kBoolTrue == test_54) {
                          test_54 = GALGAS_bool (kIsEqual, enumerator_9402.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("operationAfterPasting"))).boolEnum () ;
                          if (kBoolTrue == test_54) {
                            enumGalgasBool test_55 = kBoolTrue ;
                            if (kBoolTrue == test_55) {
                              test_55 = var_operationAfterPasting_5F_option_9304.boolEnum () ;
                              if (kBoolTrue == test_55) {
                                TC_Array <C_FixItDescription> fixItArray56 ;
                                inCompiler->emitSemanticError (enumerator_9402.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 326)), GALGAS_string ("duplicated option"), fixItArray56  COMMA_SOURCE_FILE ("entity.galgas", 326)) ;
                              }
                            }
                            var_operationAfterPasting_5F_option_9304 = GALGAS_bool (true) ;
                          }
                        }
                        if (kBoolFalse == test_54) {
                          enumGalgasBool test_57 = kBoolTrue ;
                          if (kBoolTrue == test_57) {
                            test_57 = GALGAS_bool (kIsEqual, enumerator_9402.current_mValue (HERE).getter_string (HERE).objectCompare (GALGAS_string ("cannotBeDeleted"))).boolEnum () ;
                            if (kBoolTrue == test_57) {
                              enumGalgasBool test_58 = kBoolTrue ;
                              if (kBoolTrue == test_58) {
                                test_58 = var_cannotBeDeleted_5F_option_9341.boolEnum () ;
                                if (kBoolTrue == test_58) {
                                  TC_Array <C_FixItDescription> fixItArray59 ;
                                  inCompiler->emitSemanticError (enumerator_9402.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 331)), GALGAS_string ("duplicated option"), fixItArray59  COMMA_SOURCE_FILE ("entity.galgas", 331)) ;
                                }
                              }
                              var_cannotBeDeleted_5F_option_9341 = GALGAS_bool (true) ;
                            }
                          }
                          if (kBoolFalse == test_57) {
                            TC_Array <C_FixItDescription> fixItArray60 ;
                            appendFixItActions (fixItArray60, kFixItReplace, GALGAS_string ("cursorForKnob")) ;
                            appendFixItActions (fixItArray60, kFixItReplace, GALGAS_string ("acceptedTranslation")) ;
                            appendFixItActions (fixItArray60, kFixItReplace, GALGAS_string ("translate")) ;
                            appendFixItActions (fixItArray60, kFixItReplace, GALGAS_string ("move")) ;
                            appendFixItActions (fixItArray60, kFixItReplace, GALGAS_string ("flipHorizontally")) ;
                            appendFixItActions (fixItArray60, kFixItReplace, GALGAS_string ("flipVertically")) ;
                            appendFixItActions (fixItArray60, kFixItReplace, GALGAS_string ("rotate")) ;
                            appendFixItActions (fixItArray60, kFixItReplace, GALGAS_string ("snapToGrid")) ;
                            appendFixItActions (fixItArray60, kFixItReplace, GALGAS_string ("saveIntoAdditionalDictionary")) ;
                            appendFixItActions (fixItArray60, kFixItReplace, GALGAS_string ("canCopyAndPaste")) ;
                            appendFixItActions (fixItArray60, kFixItReplace, GALGAS_string ("operationAfterPasting")) ;
                            appendFixItActions (fixItArray60, kFixItReplace, GALGAS_string ("cannotBeDeleted")) ;
                            inCompiler->emitSemanticError (enumerator_9402.current_mValue (HERE).getter_location (SOURCE_FILE ("entity.galgas", 335)), GALGAS_string ("unkown graphic option"), fixItArray60  COMMA_SOURCE_FILE ("entity.galgas", 335)) ;
                          }
                        }
                      }
                    }
  ...
  GALGAS_bool var_hasSubClass_12125 = GALGAS_bool (false) ;
  cEnumerator_classMap enumerator_12187 (ioArgument_ioSemanticContext.getter_mClassMap (HERE), kENUMERATION_UP) ;
  bool bool_61 = var_hasSubClass_12125.operator_not (SOURCE_FILE ("entity.galgas", 345)).isValidAndTrue () ;
  if (enumerator_12187.hasCurrentObject () && bool_61) {
    while (enumerator_12187.hasCurrentObject () && bool_61) {
      enumGalgasBool test_62 = kBoolTrue ;
      if (kBoolTrue == test_62) {
        test_62 = enumerator_12187.current (HERE).getter_mClassKind (HERE).getter_isEntity (SOURCE_FILE ("entity.galgas", 346)).boolEnum () ;
        if (kBoolTrue == test_62) {
          GALGAS_string var_superEntityName_12343 ;
          GALGAS_bool joker_12345_2 ; // Joker input parameter
          GALGAS_bool joker_12345_1 ; // Joker input parameter
          enumerator_12187.current (HERE).getter_mClassKind (HERE).method_entity (var_superEntityName_12343, joker_12345_2, joker_12345_1, inCompiler COMMA_SOURCE_FILE ("entity.galgas", 347)) ;
          const GALGAS_entityDeclarationAST temp_63 = object ;
          var_hasSubClass_12125 = GALGAS_bool (kIsEqual, temp_63.getter_mClassName (HERE).getter_string (HERE).objectCompare (var_superEntityName_12343)) ;
        }
      }
      enumerator_12187.gotoNextObject () ;
      if (enumerator_12187.hasCurrentObject ()) {
        bool_61 = var_hasSubClass_12125.operator_not (SOURCE_FILE ("entity.galgas", 345)).isValidAndTrue () ;
      }
    }
  }
  const GALGAS_entityDeclarationAST temp_64 = object ;
  const GALGAS_entityDeclarationAST temp_65 = object ;
  ioArgument_ioGeneration.mProperty_mEntityListForGeneration.addAssign_operation (temp_64.getter_mClassName (HERE).getter_string (HERE), temp_65.getter_mObsoleteEntityNames (HERE)  COMMA_SOURCE_FILE ("entity.galgas", 352)) ;
  const GALGAS_entityDeclarationAST temp_66 = object ;
  const GALGAS_entityDeclarationAST temp_67 = object ;
  const GALGAS_entityDeclarationAST temp_68 = object ;
  const GALGAS_entityDeclarationAST temp_69 = object ;
  const GALGAS_entityDeclarationAST temp_70 = object ;
  const GALGAS_entityDeclarationAST temp_71 = object ;
  ioArgument_ioGeneration.mProperty_mFileGenerationList.addAssign_operation (GALGAS_entityForGeneration::constructor_new (temp_66.getter_mClassName (HERE).getter_string (HERE), temp_67.getter_mSuperEntityName (HERE).getter_string (HERE), var_propertyGenerationList_6981, temp_68.getter_mSignatureList (HERE), temp_69.getter_mIsGraphicEntity (HERE), temp_70.getter_mIsAbstract (HERE), var_overridenTransients_7119, temp_71.getter_mExternSwiftDelegateList (HERE), var_hasSubClass_12125, var_cursorForKnob_5F_option_8942, var_acceptedTranslation_5F_option_9014, var_translate_5F_option_8973, var_move_5F_option_9040, var_snapToGrid_5F_option_9072, var_flipHorizontally_5F_option_9110, var_flipVertically_5F_option_9146, var_rotate_5F_option_9174, var_saveIntoAdditionalDictionary_5F_option_9224, var_canCopyAndPaste_5F_option_9261, var_operationAfterPasting_5F_option_9304, var_cannotBeDeleted_5F_option_9341  COMMA_SOURCE_FILE ("entity.galgas", 355))  COMMA_SOURCE_FILE ("entity.galgas", 355)) ;
}
