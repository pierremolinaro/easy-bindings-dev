...
GALGAS_bool extensionGetter_isAbstract (const GALGAS_propertyMap_2D_element & inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_typeKind var_unused_0_6303 ;
    GALGAS_propertyAccessibility var_accessibility_6359 ;
    const bool optionalResult6299 = temp_1.readProperty_mKind ().optional_property (var_unused_0_6303, var_accessibility_6359) ;
    if (!optionalResult6299) {
      test_0 = kBoolFalse ;
    }
    if (kBoolTrue == test_0) {
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        test_2 = var_accessibility_6359.getter_isTransient (SOURCE_FILE ("semantic-analysis.ggs", 148)).boolEnum () ;
        if (kBoolTrue == test_2) {
          GALGAS_bool var_ab_6456 ;
          var_accessibility_6359.method_transient (var_ab_6456, inCompiler COMMA_SOURCE_FILE ("semantic-analysis.ggs", 149)) ;
          result_result = var_ab_6456 ;
        }
      }
    }
  }
...
void cPtr_entityForGeneration::method_generateCode (const GALGAS_string constinArgument_inOutputDirectory,
                                                    ...
                                                    C_Compiler * inCompiler
                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_atomicPropertyGenerationList var_atomicPropertyGenerationList_12628 = GALGAS_atomicPropertyGenerationList::constructor_emptyList (SOURCE_FILE ("entity.ggs", 350)) ;
  GALGAS_transientPropertyGenerationList var_transientPropertyGenerationList_12704 = GALGAS_transientPropertyGenerationList::constructor_emptyList (SOURCE_FILE ("entity.ggs", 351)) ;
  GALGAS_computedPropertyGenerationList var_computedPropertyGenerationList_12778 = GALGAS_computedPropertyGenerationList::constructor_emptyList (SOURCE_FILE ("entity.ggs", 352)) ;
  GALGAS_toOnePropertyGenerationList var_toOnePropertyGenerationList_12846 = GALGAS_toOnePropertyGenerationList::constructor_emptyList (SOURCE_FILE ("entity.ggs", 353)) ;
  GALGAS_toManyPropertyGenerationList var_toManyPropertyGenerationList_12916 = GALGAS_toManyPropertyGenerationList::constructor_emptyList (SOURCE_FILE ("entity.ggs", 354)) ;
  GALGAS_atomicProxyGenerationList var_proxyGenerationList_12974 = GALGAS_atomicProxyGenerationList::constructor_emptyList (SOURCE_FILE ("entity.ggs", 355)) ;
  GALGAS_toManyProxyGenerationList var_toManyProxyGenerationList_13038 = GALGAS_toManyProxyGenerationList::constructor_emptyList (SOURCE_FILE ("entity.ggs", 356)) ;
  const GALGAS_entityForGeneration temp_0 = this ;
  cEnumerator_propertyGenerationList enumerator_13059 (temp_0.readProperty_mPropertyGenerationList (), kENUMERATION_UP) ;
  while (enumerator_13059.hasCurrentObject ()) {
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      GALGAS_atomicPropertyGeneration var_atomicProperty_13121 (dynamic_cast <const cPtr_atomicPropertyGeneration *> (enumerator_13059.current_mProperty (HERE).ptr ())) ;
      if (NULL == var_atomicProperty_13121.ptr ()) {
        test_1 = kBoolFalse ;
      }
      if (kBoolTrue == test_1) {
        var_atomicPropertyGenerationList_12628.addAssign_operation (var_atomicProperty_13121  COMMA_SOURCE_FILE ("entity.ggs", 359)) ;
      }
    }
    if (kBoolFalse == test_1) {
      enumGalgasBool test_2 = kBoolTrue ;
      if (kBoolTrue == test_2) {
        GALGAS_transientPropertyGeneration var_transientProperty_13252 (dynamic_cast <const cPtr_transientPropertyGeneration *> (enumerator_13059.current_mProperty (HERE).ptr ())) ;
        if (NULL == var_transientProperty_13252.ptr ()) {
          test_2 = kBoolFalse ;
        }
        if (kBoolTrue == test_2) {
          var_transientPropertyGenerationList_12704.addAssign_operation (var_transientProperty_13252  COMMA_SOURCE_FILE ("entity.ggs", 361)) ;
        }
      }
      if (kBoolFalse == test_2) {
        enumGalgasBool test_3 = kBoolTrue ;
        if (kBoolTrue == test_3) {
          GALGAS_computedPropertyGeneration var_computedProperty_13391 (dynamic_cast <const cPtr_computedPropertyGeneration *> (enumerator_13059.current_mProperty (HERE).ptr ())) ;
          if (NULL == var_computedProperty_13391.ptr ()) {
            test_3 = kBoolFalse ;
          }
          if (kBoolTrue == test_3) {
            var_computedPropertyGenerationList_12778.addAssign_operation (var_computedProperty_13391  COMMA_SOURCE_FILE ("entity.ggs", 363)) ;
          }
        }
        if (kBoolFalse == test_3) {
          enumGalgasBool test_4 = kBoolTrue ;
          if (kBoolTrue == test_4) {
            GALGAS_toManyProxyGeneration var_toManyProxy_13522 (dynamic_cast <const cPtr_toManyProxyGeneration *> (enumerator_13059.current_mProperty (HERE).ptr ())) ;
            if (NULL == var_toManyProxy_13522.ptr ()) {
              test_4 = kBoolFalse ;
            }
            if (kBoolTrue == test_4) {
              var_toManyProxyGenerationList_13038.addAssign_operation (var_toManyProxy_13522  COMMA_SOURCE_FILE ("entity.ggs", 365)) ;
            }
          }
          if (kBoolFalse == test_4) {
            enumGalgasBool test_5 = kBoolTrue ;
            if (kBoolTrue == test_5) {
              GALGAS_atomicProxyGeneration var_proxyProperty_13640 (dynamic_cast <const cPtr_atomicProxyGeneration *> (enumerator_13059.current_mProperty (HERE).ptr ())) ;
              if (NULL == var_proxyProperty_13640.ptr ()) {
                test_5 = kBoolFalse ;
              }
              if (kBoolTrue == test_5) {
                var_proxyGenerationList_12974.addAssign_operation (var_proxyProperty_13640  COMMA_SOURCE_FILE ("entity.ggs", 367)) ;
              }
            }
            if (kBoolFalse == test_5) {
              enumGalgasBool test_6 = kBoolTrue ;
              if (kBoolTrue == test_6) {
                GALGAS_toOnePropertyGeneration var_toOneProperty_13754 (dynamic_cast <const cPtr_toOnePropertyGeneration *> (enumerator_13059.current_mProperty (HERE).ptr ())) ;
                if (NULL == var_toOneProperty_13754.ptr ()) {
                  test_6 = kBoolFalse ;
                }
                if (kBoolTrue == test_6) {
                  var_toOnePropertyGenerationList_12846.addAssign_operation (var_toOneProperty_13754  COMMA_SOURCE_FILE ("entity.ggs", 369)) ;
                }
              }
              if (kBoolFalse == test_6) {
                enumGalgasBool test_7 = kBoolTrue ;
                if (kBoolTrue == test_7) {
                  GALGAS_toManyPropertyGeneration var_toOneProperty_13878 (dynamic_cast <const cPtr_toManyPropertyGeneration *> (enumerator_13059.current_mProperty (HERE).ptr ())) ;
                  if (NULL == var_toOneProperty_13878.ptr ()) {
                    test_7 = kBoolFalse ;
                  }
                  if (kBoolTrue == test_7) {
                    var_toManyPropertyGenerationList_12916.addAssign_operation (var_toOneProperty_13878  COMMA_SOURCE_FILE ("entity.ggs", 371)) ;
                  }
                }
              }
            }
  ...
  GALGAS_string var_superEntityName_14012 = GALGAS_string::makeEmptyString () ;
  ...
  if (kBoolTrue == test_8) {
    ...
    if (kBoolTrue == test_8) {
      ...
      var_superEntityName_14012 = temp_10.readProperty_mSuperEntityName () ;
    }
  }
  if (kBoolFalse == test_8) {
    ...
    if (kBoolTrue == test_11) {
      ...
      if (kBoolTrue == test_11) {
        var_superEntityName_14012 = GALGAS_string ("EBGraphicManagedObject") ;
      }
    }
    if (kBoolFalse == test_11) {
      var_superEntityName_14012 = GALGAS_string ("EBManagedObject") ;
    }
  }
  ...
  GALGAS_string var_s_14242 = GALGAS_string (filewrapperTemplate_entityGenerationTemplate_entityImplementationInSwift (inCompiler, temp_13.readProperty_mEntityName (), var_superEntityName_14012, temp_14.readProperty_mPropertyGenerationList (), var_proxyGenerationList_12974, var_toManyProxyGenerationList_13038, var_atomicPropertyGenerationList_12628, var_transientPropertyGenerationList_12704, var_computedPropertyGenerationList_12778, var_toOnePropertyGenerationList_12846, var_toManyPropertyGenerationList_12916, temp_15.readProperty_mSignatureSet (), temp_16.readProperty_mIsGraphicEntity (), temp_17.readProperty_mIsAbstract (), temp_18.readProperty_mOverridenTransients (), temp_19.readProperty_mExternSwiftDelegateList (), temp_20.readProperty_mHasSubEntity (), temp_21.readProperty_mCanCopyAndPaste_5F_option (), temp_22.readProperty_mCannotBeDeleted_5F_option () COMMA_SOURCE_FILE ("entity.ggs", 382))) ;
  const GALGAS_entityForGeneration temp_23 = this ;
  GALGAS_string var_fileName_14867 = GALGAS_string ("entity-").add_operation (temp_23.readProperty_mEntityName (), inCompiler COMMA_SOURCE_FILE ("entity.ggs", 402)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("entity.ggs", 402)) ;
  ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_14867  COMMA_SOURCE_FILE ("entity.ggs", 403)) ;
  {
  GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_14867, var_s_14242, inCompiler COMMA_SOURCE_FILE ("entity.ggs", 404)) ;
  }
  enumGalgasBool test_24 = kBoolTrue ;
  if (kBoolTrue == test_24) {
    const GALGAS_entityForGeneration temp_25 = this ;
    test_24 = inArgument_inToOneEntities.getter_hasKey (temp_25.readProperty_mEntityName () COMMA_SOURCE_FILE ("entity.ggs", 409)).boolEnum () ;
    if (kBoolTrue == test_24) {
      ...
      var_s_14242 = GALGAS_string (filewrapperTemplate_entityGenerationTemplate_entityToOneImplementationInSwift (inCompiler, temp_26.readProperty_mEntityName (), var_superEntityName_14012, temp_27.readProperty_mHandlingOpposite (), temp_28.readProperty_mPropertyGenerationList (), var_proxyGenerationList_12974, var_toManyProxyGenerationList_13038, var_atomicPropertyGenerationList_12628, var_transientPropertyGenerationList_12704, var_computedPropertyGenerationList_12778, var_toOnePropertyGenerationList_12846, var_toManyPropertyGenerationList_12916, temp_29.readProperty_mSignatureSet (), temp_30.readProperty_mIsGraphicEntity (), temp_31.readProperty_mIsAbstract (), temp_32.readProperty_mOverridenTransients (), temp_33.readProperty_mExternSwiftDelegateList () COMMA_SOURCE_FILE ("entity.ggs", 410))) ;
    }
  }
  if (kBoolFalse == test_24) {
    var_s_14242 = GALGAS_string ("// Unused code, not generated by EasyBinding compiler\n") ;
  }
  const GALGAS_entityForGeneration temp_34 = this ;
  var_fileName_14867 = GALGAS_string ("toone-").add_operation (temp_34.readProperty_mEntityName (), inCompiler COMMA_SOURCE_FILE ("entity.ggs", 432)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("entity.ggs", 432)) ;
  ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_14867  COMMA_SOURCE_FILE ("entity.ggs", 433)) ;
  {
  GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_14867, var_s_14242, inCompiler COMMA_SOURCE_FILE ("entity.ggs", 434)) ;
  }
  enumGalgasBool test_35 = kBoolTrue ;
  if (kBoolTrue == test_35) {
    const GALGAS_entityForGeneration temp_36 = this ;
    test_35 = inArgument_inToManyEntities.getter_hasKey (temp_36.readProperty_mEntityName () COMMA_SOURCE_FILE ("entity.ggs", 439)).boolEnum () ;
    if (kBoolTrue == test_35) {
      ...
      var_s_14242 = GALGAS_string (filewrapperTemplate_entityGenerationTemplate_entityToManyImplementationInSwift (inCompiler, temp_37.readProperty_mEntityName (), var_superEntityName_14012, temp_38.readProperty_mHandlingOpposite (), temp_39.readProperty_mPropertyGenerationList (), var_proxyGenerationList_12974, var_toManyProxyGenerationList_13038, var_atomicPropertyGenerationList_12628, var_transientPropertyGenerationList_12704, var_computedPropertyGenerationList_12778, var_toOnePropertyGenerationList_12846, var_toManyPropertyGenerationList_12916, temp_40.readProperty_mSignatureSet (), temp_41.readProperty_mIsGraphicEntity (), temp_42.readProperty_mIsAbstract (), temp_43.readProperty_mOverridenTransients (), temp_44.readProperty_mExternSwiftDelegateList () COMMA_SOURCE_FILE ("entity.ggs", 440))) ;
    }
  }
  ...
  var_fileName_14867 = GALGAS_string ("tomany-").add_operation (temp_45.readProperty_mEntityName (), inCompiler COMMA_SOURCE_FILE ("entity.ggs", 461)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("entity.ggs", 461)) ;
  ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_14867  COMMA_SOURCE_FILE ("entity.ggs", 462)) ;
  {
  GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_14867, var_s_14242, inCompiler COMMA_SOURCE_FILE ("entity.ggs", 463)) ;
  }
}
//----------------------------------------------------------------------------------------------------------------------
//
...
void routine_generateEBManagedObjectContext (const GALGAS_entityListForGeneratingEBManagedObjectContext constinArgument_inEntityListForGeneration,
  ...
  enumGalgasBool test_0 = kBoolTrue ;
  if (kBoolTrue == test_0) {
    test_0 = GALGAS_bool (kIsStrictSup, constinArgument_inEntityListForGeneration.getter_length (SOURCE_FILE ("entity.ggs", 477)).objectCompare (GALGAS_uint (uint32_t (0U)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_fileName_17177 = GALGAS_string ("EBManagedObjectFactory.swift") ;
      ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_17177  COMMA_SOURCE_FILE ("entity.ggs", 479)) ;
      GALGAS_string var_s_17256 = GALGAS_string (filewrapperTemplate_entityGenerationTemplate_managedObjectFactory (inCompiler, constinArgument_inEntityListForGeneration COMMA_SOURCE_FILE ("entity.ggs", 480))) ;
      {
      GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_17177, var_s_17256, inCompiler COMMA_SOURCE_FILE ("entity.ggs", 483)) ;
      }
    }
  }
}
...
GALGAS_string filewrapperTemplate_entityGenerationTemplate_entityImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (in_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_propertyGenerationList enumerator_3005 (in_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_3005.hasCurrentObject ()) {
      result << callExtensionGetter_configurationCode ((const cPtr_propertyGeneration *) enumerator_3005.current_mProperty (HERE).ptr (), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("entity.swift.galgasTemplate", 78)).stringValue () ;
  ...
  if (in_TO_5F_MANY_5F_RELATIONSHIP_5F_LIST.isValid ()) {
    cEnumerator_toManyPropertyGenerationList enumerator_3194 (in_TO_5F_MANY_5F_RELATIONSHIP_5F_LIST, kENUMERATION_UP) ;
    while (enumerator_3194.hasCurrentObject ()) {
      switch (enumerator_3194.current_mProperty (HERE).readProperty_mOption ().enumValue ()) {
      ...
      case GALGAS_toManyRelationshipOptionGeneration::kEnum_hasDependance :
        {
          const cEnumAssociatedValues_toManyRelationshipOptionGeneration_hasDependance * extractPtr_3383 = (const cEnumAssociatedValues_toManyRelationshipOptionGeneration_hasDependance *) (enumerator_3194.current_mProperty (HERE).readProperty_mOption ().unsafePointer ()) ;
          const GALGAS_string extractedValue_3285_masterPropertyName = extractPtr_3383->mAssociatedValue0 ;
          result << "    self." ;
          result << enumerator_3194.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
          result << "_property.setDataProvider (self." ;
          result << extractedValue_3285_masterPropertyName.stringValue () ;
          result << "_property)\n" ;
        }
        break ;
      case GALGAS_toManyRelationshipOptionGeneration::kEnum_hasOpposite :
        {
          const cEnumAssociatedValues_toManyRelationshipOptionGeneration_hasOpposite * extractPtr_3707 = (const cEnumAssociatedValues_toManyRelationshipOptionGeneration_hasOpposite *) (enumerator_3194.current_mProperty (HERE).readProperty_mOption ().unsafePointer ()) ;
          const GALGAS_string extractedValue_3438_oppositeName = extractPtr_3707->mAssociatedValue0 ;
          result << "    self." ;
          result << enumerator_3194.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
          result << "_property.setOppositeRelationShipFunctions (\n"
            "      setter: { [weak self] inObject in if let me = self { inObject." ;
          result << extractedValue_3438_oppositeName.stringValue () ;
  ...
  if (in_SIGNATURE_5F_SET.isValid ()) {
    cEnumerator_stringset enumerator_3844 (in_SIGNATURE_5F_SET, kENUMERATION_UP) ;
    while (enumerator_3844.hasCurrentObject ()) {
      result << "    self." ;
      result << enumerator_3844.current_key (HERE).stringValue () ;
  ...
  GALGAS_uint index_4029_idx (0) ;
  if (in_EXTERN_5F_DELEGATE_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_externSwiftDelegateList enumerator_4029 (in_EXTERN_5F_DELEGATE_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kENUMERATION_UP) ;
    while (enumerator_4029.hasCurrentObject ()) {
      result << "    self.mExternDelegate" ;
      result << index_4029_idx.getter_string (SOURCE_FILE ("entity.swift.galgasTemplate", 104)).stringValue () ;
      result << " = " ;
      result << enumerator_4029.current_mExternSwiftDelegateName (HERE).readProperty_string ().stringValue () ;
      result << " (object: self)\n" ;
      index_4029_idx.increment () ;
  ...
  result << "   }\n"
    ...
    "  //\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\n"
    "\n" ;
  GALGAS_uint index_4499_idx (0) ;
  if (in_EXTERN_5F_DELEGATE_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_externSwiftDelegateList enumerator_4499 (in_EXTERN_5F_DELEGATE_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kENUMERATION_UP) ;
    while (enumerator_4499.hasCurrentObject ()) {
      result << "  final var mExternDelegate" ;
      result << index_4499_idx.getter_string (SOURCE_FILE ("entity.swift.galgasTemplate", 114)).stringValue () ;
      result << " : " ;
      result << enumerator_4499.current_mExternSwiftDelegateName (HERE).readProperty_string ().stringValue () ;
      result << "\? = nil\n" ;
      index_4499_idx.increment () ;
  ...
  if (kBoolTrue == test_2) {
    ...
    GALGAS_uint index_5030_ (0) ;
    if (in_TO_5F_MANY_5F_RELATIONSHIP_5F_LIST.isValid ()) {
      cEnumerator_toManyPropertyGenerationList enumerator_5030 (in_TO_5F_MANY_5F_RELATIONSHIP_5F_LIST, kENUMERATION_UP) ;
      while (enumerator_5030.hasCurrentObject ()) {
        const enumGalgasBool test_3 = enumerator_5030.current_mProperty (HERE).readProperty_mOption ().getter_isHasDependance (SOURCE_FILE ("entity.swift.galgasTemplate", 125)).operator_not (SOURCE_FILE ("entity.swift.galgasTemplate", 125)).boolEnum () ;
        if (kBoolTrue == test_3) {
          result << "    self." ;
          result << enumerator_5030.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
          result << ".removeAll ()\n" ;
        }else if (kBoolFalse == test_3) {
        }
        index_5030_.increment () ;
  ...
  if (kBoolTrue == test_4) {
    ...
    GALGAS_uint index_5623_ (0) ;
    if (in_TO_5F_ONE_5F_RELATIONSHIP_5F_LIST.isValid ()) {
      cEnumerator_toOnePropertyGenerationList enumerator_5623 (in_TO_5F_ONE_5F_RELATIONSHIP_5F_LIST, kENUMERATION_UP) ;
      while (enumerator_5623.hasCurrentObject ()) {
        result << "    self." ;
        result << enumerator_5623.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
        result << " = nil\n" ;
        index_5623_.increment () ;
  ...
  GALGAS_uint index_6172_ (0) ;
  if (in_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_propertyGenerationList enumerator_6172 (in_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_6172.hasCurrentObject ()) {
      result << callExtensionGetter_saveIntoDictionaryCode ((const cPtr_propertyGeneration *) enumerator_6172.current_mProperty (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("entity.swift.galgasTemplate", 155)).stringValue () ;
      index_6172_.increment () ;
  ...
  GALGAS_uint index_6783_ (0) ;
  if (in_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_propertyGenerationList enumerator_6783 (in_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_6783.hasCurrentObject ()) {
      result << callExtensionGetter_setupRelationshipFromDictionaryCode ((const cPtr_propertyGeneration *) enumerator_6783.current_mProperty (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("entity.swift.galgasTemplate", 168)).stringValue () ;
      index_6783_.increment () ;
  ...
  GALGAS_uint index_7331_ (0) ;
  if (in_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_propertyGenerationList enumerator_7331 (in_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_7331.hasCurrentObject ()) {
      result << callExtensionGetter_setupAtomicPropertyFromDictionaryCode ((const cPtr_propertyGeneration *) enumerator_7331.current_mProperty (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("entity.swift.galgasTemplate", 180)).stringValue () ;
  ...
  if (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_atomicPropertyGenerationList enumerator_7872 (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_7872.hasCurrentObject ()) {
      result << "    ioString += \"" ;
      result << enumerator_7872.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
      result << "\\n\"\n" ;
  ...
  GALGAS_uint index_8008_ (0) ;
  if (in_TO_5F_ONE_5F_RELATIONSHIP_5F_LIST.isValid ()) {
    cEnumerator_toOnePropertyGenerationList enumerator_8008 (in_TO_5F_ONE_5F_RELATIONSHIP_5F_LIST, kENUMERATION_UP) ;
    while (enumerator_8008.hasCurrentObject ()) {
      result << "    ioString += \"" ;
      result << enumerator_8008.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
      result << "\\n\"\n" ;
      index_8008_.increment () ;
  ...
  result << "  }\n"
    ...
    "  //--- Atomic properties\n" ;
  GALGAS_uint index_8684_ (0) ;
  if (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_atomicPropertyGenerationList enumerator_8684 (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_8684.hasCurrentObject ()) {
      result << "    self." ;
      result << enumerator_8684.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
      result << ".appendPropertyValueTo (&ioData)\n"
        "    ioData.append (ascii: .lineFeed)\n" ;
      index_8684_.increment () ;
  ...
  if (in_TO_5F_ONE_5F_RELATIONSHIP_5F_LIST.isValid ()) {
    cEnumerator_toOnePropertyGenerationList enumerator_8883 (in_TO_5F_ONE_5F_RELATIONSHIP_5F_LIST, kENUMERATION_UP) ;
    while (enumerator_8883.hasCurrentObject ()) {
      result << "    if let object = self." ;
      result << enumerator_8883.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
      result << " {\n"
  ...
  if (in_TO_5F_MANY_5F_RELATIONSHIP_5F_LIST.isValid ()) {
    cEnumerator_toManyPropertyGenerationList enumerator_9144 (in_TO_5F_MANY_5F_RELATIONSHIP_5F_LIST, kENUMERATION_UP) ;
    while (enumerator_9144.hasCurrentObject ()) {
      const enumGalgasBool test_5 = enumerator_9144.current_mProperty (HERE).readProperty_mOption ().getter_isHasDependance (SOURCE_FILE ("entity.swift.galgasTemplate", 227)).operator_not (SOURCE_FILE ("entity.swift.galgasTemplate", 227)).boolEnum () ;
      if (kBoolTrue == test_5) {
        result << "    do{\n"
          "      var optionalFirstIndex : Int\? = nil\n"
          "      var rangeCount = 0\n"
          "      for object in self." ;
        result << enumerator_9144.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
        result << ".values {\n"
  ...
  if (kBoolTrue == test_6) {
    ...
    GALGAS_uint index_11468_ (0) ;
    if (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
      cEnumerator_atomicPropertyGenerationList enumerator_11468 (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
      while (enumerator_11468.hasCurrentObject ()) {
        result << "      if let range = inDictionary [\"" ;
        result << enumerator_11468.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
        result << "\"], let value = " ;
        result << extensionGetter_swiftTypeName (enumerator_11468.current_mProperty (HERE).readProperty_mType (), inCompiler COMMA_SOURCE_FILE ("entity.swift.galgasTemplate", 276)).stringValue () ;
        result << ".unarchiveFromDataRange (inData, range) {\n"
          "        self." ;
        result << enumerator_11468.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
        result << " = value\n"
          "      }\n" ;
        index_11468_.increment () ;
  ...
  if (kBoolTrue == test_7) {
    ...
    GALGAS_uint index_12504_ (0) ;
    if (in_TO_5F_ONE_5F_RELATIONSHIP_5F_LIST.isValid ()) {
      cEnumerator_toOnePropertyGenerationList enumerator_12504 (in_TO_5F_ONE_5F_RELATIONSHIP_5F_LIST, kENUMERATION_UP) ;
      while (enumerator_12504.hasCurrentObject ()) {
        result << "    if let range = inDictionary [\"" ;
        result << enumerator_12504.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
        result << "\"], let objectIndex = inData.base62EncodedInt (range: range) {\n"
          "      let object = inRawObjectArray [objectIndex].object as! " ;
        result << extensionGetter_swiftTypeName (enumerator_12504.current_mProperty (HERE).readProperty_mRelationshipType (), inCompiler COMMA_SOURCE_FILE ("entity.swift.galgasTemplate", 297)).stringValue () ;
        result << "\n"
          "      self." ;
        result << enumerator_12504.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
        result << " = object\n"
          "    }\n" ;
        index_12504_.increment () ;
  ...
  if (kBoolTrue == test_8) {
    ...
    GALGAS_uint index_13583_ (0) ;
    if (in_TO_5F_MANY_5F_RELATIONSHIP_5F_LIST.isValid ()) {
      cEnumerator_toManyPropertyGenerationList enumerator_13583 (in_TO_5F_MANY_5F_RELATIONSHIP_5F_LIST, kENUMERATION_UP) ;
      while (enumerator_13583.hasCurrentObject ()) {
        const enumGalgasBool test_9 = enumerator_13583.current_mProperty (HERE).readProperty_mOption ().getter_isHasDependance (SOURCE_FILE ("entity.swift.galgasTemplate", 315)).operator_not (SOURCE_FILE ("entity.swift.galgasTemplate", 315)).boolEnum () ;
        if (kBoolTrue == test_9) {
          result << "      if let range = inDictionary [\"" ;
          result << enumerator_13583.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
          result << "\"], range.length > 0 {\n"
            "        var relationshipArray = EBReferenceArray <" ;
          result << extensionGetter_swiftTypeName (enumerator_13583.current_mProperty (HERE).readProperty_mRelationshipType (), inCompiler COMMA_SOURCE_FILE ("entity.swift.galgasTemplate", 317)).stringValue () ;
          result << "> ()\n"
            "        let indexArray = inData.base62EncodedIntArray (fromRange: range)\n"
            "        for idx in indexArray {\n"
            "          relationshipArray.append (inRawObjectArray [idx].object as! " ;
          result << extensionGetter_swiftTypeName (enumerator_13583.current_mProperty (HERE).readProperty_mRelationshipType (), inCompiler COMMA_SOURCE_FILE ("entity.swift.galgasTemplate", 320)).stringValue () ;
          result << ")\n"
            "        }\n"
            "        self." ;
          result << enumerator_13583.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
  ...
  if (in_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_propertyGenerationList enumerator_14650 (in_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_14650.hasCurrentObject ()) {
      result << callExtensionGetter_objectAccessibilityCode ((const cPtr_propertyGeneration *) enumerator_14650.current_mProperty (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("entity.swift.galgasTemplate", 338)).stringValue () ;
  ...
  if (in_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_propertyGenerationList enumerator_15191 (in_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_15191.hasCurrentObject ()) {
      result << callExtensionGetter_objectAccessibilityCodeForSaveOperation ((const cPtr_propertyGeneration *) enumerator_15191.current_mProperty (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("entity.swift.galgasTemplate", 350)).stringValue () ;
  ...
  if (kBoolTrue == test_10) {
    ...
    GALGAS_uint index_15680_ (0) ;
    if (in_SIGNATURE_5F_SET.isValid ()) {
      cEnumerator_stringset enumerator_15680 (in_SIGNATURE_5F_SET, kENUMERATION_UP) ;
      while (enumerator_15680.hasCurrentObject ()) {
        result << "    crc.accumulateUInt32 (self." ;
        result << enumerator_15680.current_key (HERE).stringValue () ;
        result << "_property.signature ())\n" ;
        index_15680_.increment () ;
...
GALGAS_string filewrapperTemplate_entityGenerationTemplate_entityToManyImplementationInSwift (C_Compiler * inCompiler,
  ...
  result << " {\n"
    ...
    "    }\n" ;
  GALGAS_uint index_40313_ (0) ;
  if (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_atomicPropertyGenerationList enumerator_40313 (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_40313.hasCurrentObject ()) {
      result << "    self.addEBObserverOf_" ;
      result << enumerator_40313.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
      result << " (self.mObserverForWritingPreferences)\n" ;
      index_40313_.increment () ;
      enumerator_40313.gotoNextObject () ;
    }
  }
