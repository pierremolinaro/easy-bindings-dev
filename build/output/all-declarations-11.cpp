...
static void extensionMethod_autoLayoutTableViewControllerGeneration_generateCode (const cPtr_abstractFileGeneration * inObject,
  ...
  GALGAS_stringset var_observedProperties_22468 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("auto-layout-table-view-controller.galgas", 535)) ;
  const GALGAS_autoLayoutTableViewControllerGeneration temp_0 = object ;
  cEnumerator_autoLayoutTableViewControllerSortedColumnListForGeneration enumerator_22514 (temp_0.readProperty_mTableViewControllerSortedColumnListForGeneration (), kENUMERATION_UP) ;
  while (enumerator_22514.hasCurrentObject ()) {
    var_observedProperties_22468.addAssign_operation (enumerator_22514.current_mObservablePropertyForSorting (HERE)  COMMA_SOURCE_FILE ("auto-layout-table-view-controller.galgas", 537)) ;
    enumerator_22514.gotoNextObject () ;
  }
  ...
  GALGAS_string var_s_22647 = GALGAS_string (filewrapperTemplate_autoLayoutTableViewControllerGenerationTemplate_autoLayoutTableViewControllerImplementation (inCompiler, temp_1.readProperty_mOwnerName (), temp_2.readProperty_mControllerName ().readProperty_string (), temp_3.readProperty_mModelString (), temp_4.readProperty_mTableViewControllerModelKind (), temp_5.readProperty_mModelTypeName (), temp_6.readProperty_mTableViewControllerBoundColumnListForGeneration (), temp_7.readProperty_mTableViewControllerSortedColumnListForGeneration (), temp_8.readProperty_mElementTypeName (), var_observedProperties_22468, temp_9.readProperty_mAttributeListForGeneration () COMMA_SOURCE_FILE ("auto-layout-table-view-controller.galgas", 539))) ;
  {
  ...
  GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, GALGAS_string ("controller-table-view-").add_operation (temp_10.readProperty_mOwnerName (), inCompiler COMMA_SOURCE_FILE ("auto-layout-table-view-controller.galgas", 553)).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("auto-layout-table-view-controller.galgas", 553)).add_operation (temp_11.readProperty_mControllerName ().readProperty_string (), inCompiler COMMA_SOURCE_FILE ("auto-layout-table-view-controller.galgas", 553)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("auto-layout-table-view-controller.galgas", 553)), var_s_22647, inCompiler COMMA_SOURCE_FILE ("auto-layout-table-view-controller.galgas", 551)) ;
  }
}
...
static void extensionMethod_selectionControllerDeclarationAST_firstAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_selectionControllerDeclarationAST) ;
  const GALGAS_selectionControllerDeclarationAST temp_0 = object ;
  cMapElement_classMap * objectArray_3162 = (cMapElement_classMap *) ioArgument_ioSemanticContext.mProperty_mClassMap.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, temp_0.readProperty_mClassName (), kSearchErrorMessage_classMap_searchKey  COMMA_SOURCE_FILE ("selection-controller.galgas", 70)) ;
  if (NULL != objectArray_3162) {
    macroValidSharedObject (objectArray_3162, cMapElement_classMap) ;
    GALGAS_propertyKind var_propertyKind_3318 ;
    const GALGAS_selectionControllerDeclarationAST temp_1 = object ;
    GALGAS_actionMap joker_3320_2 ; // Joker input parameter
    GALGAS_bool joker_3320_1 ; // Joker input parameter
    objectArray_3162->mProperty_mPropertyMap.method_searchKey (temp_1.readProperty_mModelControllerName (), var_propertyKind_3318, joker_3320_2, joker_3320_1, inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 73)) ;
    switch (var_propertyKind_3318.enumValue ()) {
    ...
    case GALGAS_propertyKind::kEnum_property:
      {
        ...
        inCompiler->emitSemanticError (temp_2.readProperty_mModelControllerName ().readProperty_location (), GALGAS_string ("an array controller is required here"), fixItArray3  COMMA_SOURCE_FILE ("selection-controller.galgas", 76)) ;
      }
      break ;
    case GALGAS_propertyKind::kEnum_toMany:
      {
        ...
        inCompiler->emitSemanticError (temp_4.readProperty_mModelControllerName ().readProperty_location (), GALGAS_string ("an array controller is required here"), fixItArray5  COMMA_SOURCE_FILE ("selection-controller.galgas", 78)) ;
      }
      break ;
    case GALGAS_propertyKind::kEnum_toOne:
      {
        ...
        inCompiler->emitSemanticError (temp_6.readProperty_mModelControllerName ().readProperty_location (), GALGAS_string ("an array controller is required here"), fixItArray7  COMMA_SOURCE_FILE ("selection-controller.galgas", 80)) ;
      }
      break ;
    case GALGAS_propertyKind::kEnum_selectionController:
      {
        ...
        inCompiler->emitSemanticError (temp_8.readProperty_mModelControllerName ().readProperty_location (), GALGAS_string ("an array controller is required here"), fixItArray9  COMMA_SOURCE_FILE ("selection-controller.galgas", 82)) ;
      }
      break ;
    case GALGAS_propertyKind::kEnum_arrayController:
      {
        ...
        if (kBoolTrue == test_10) {
          ...
          if (kBoolTrue == test_10) {
            ...
            inCompiler->emitSemanticError (temp_12.readProperty_mModelControllerPropertyName ().readProperty_location (), GALGAS_string ("'selectedArray' is required here"), fixItArray13  COMMA_SOURCE_FILE ("selection-controller.galgas", 85)) ;
          }
        }
        const GALGAS_selectionControllerDeclarationAST temp_14 = object ;
        GALGAS_propertyKind var_kind_3984 = GALGAS_propertyKind::constructor_selectionController (temp_14.readProperty_mSelectionEntityName ().readProperty_string ()  COMMA_SOURCE_FILE ("selection-controller.galgas", 87)) ;
        {
        const GALGAS_selectionControllerDeclarationAST temp_15 = object ;
        objectArray_3162->mProperty_mPropertyMap.setter_insertKey (temp_15.readProperty_mSelectionControllerName (), var_kind_3984, GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE ("selection-controller.galgas", 88)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 88)) ;
        }
        ...
        objectArray_3162->mProperty_mPropertyGenerationList.addAssign_operation (GALGAS_selectionControllerPropertyGeneration::constructor_new (temp_16.readProperty_mSelectionControllerName ().readProperty_string (), temp_17.readProperty_mClassName ().readProperty_string (), temp_18.readProperty_mModelControllerName ().readProperty_string (), temp_19.readProperty_mModelControllerPropertyName ().readProperty_string ()  COMMA_SOURCE_FILE ("selection-controller.galgas", 89))  COMMA_SOURCE_FILE ("selection-controller.galgas", 89)) ;
      }
      break ;
    }
  }
...
static void extensionMethod_selectionControllerDeclarationAST_fourthAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_selectionControllerDeclarationAST * object = (const cPtr_selectionControllerDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_selectionControllerDeclarationAST) ;
  GALGAS_classKind var_superClassKind_4764 ;
  GALGAS_propertyMap var_propertyMap_4781 ;
  const GALGAS_selectionControllerDeclarationAST temp_0 = object ;
  GALGAS_actionMap joker_4783_2 ; // Joker input parameter
  GALGAS_propertyGenerationList joker_4783_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.readProperty_mClassMap ().method_searchKey (temp_0.readProperty_mClassName (), var_superClassKind_4764, var_propertyMap_4781, joker_4783_2, joker_4783_1, inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 105)) ;
  GALGAS_propertyKind var_propertyKind_4856 ;
  const GALGAS_selectionControllerDeclarationAST temp_1 = object ;
  GALGAS_actionMap joker_4858_2 ; // Joker input parameter
  GALGAS_bool joker_4858_1 ; // Joker input parameter
  var_propertyMap_4781.method_searchKey (temp_1.readProperty_mModelControllerName (), var_propertyKind_4856, joker_4858_2, joker_4858_1, inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 106)) ;
  switch (var_propertyKind_4856.enumValue ()) {
  case GALGAS_propertyKind::kNotBuilt:
    break ;
  case GALGAS_propertyKind::kEnum_property:
    {
  ...
  case GALGAS_propertyKind::kEnum_arrayController:
    {
      const cEnumAssociatedValues_propertyKind_arrayController * extractPtr_6262 = (const cEnumAssociatedValues_propertyKind_arrayController *) (var_propertyKind_4856.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_5019_typeName = extractPtr_6262->mAssociatedValue0 ;
      GALGAS_propertyMap var_selectionObservablePropertyMap_5155 ;
      GALGAS_propertyGenerationList var_selectionGenerationList_5201 ;
      const GALGAS_selectionControllerDeclarationAST temp_2 = object ;
      GALGAS_classKind joker_5111 ; // Joker input parameter
      GALGAS_actionMap joker_5164 ; // Joker input parameter
      ioArgument_ioSemanticContext.readProperty_mClassMap ().method_searchKey (temp_2.readProperty_mSelectionEntityName (), joker_5111, var_selectionObservablePropertyMap_5155, joker_5164, var_selectionGenerationList_5201, inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 113)) ;
      const GALGAS_selectionControllerDeclarationAST temp_3 = object ;
      const GALGAS_selectionControllerDeclarationAST temp_4 = object ;
      const GALGAS_selectionControllerDeclarationAST temp_5 = object ;
      const GALGAS_selectionControllerDeclarationAST temp_6 = object ;
      const GALGAS_selectionControllerDeclarationAST temp_7 = object ;
      ioArgument_ioGeneration.mProperty_mSelectionControllerListForGeneration.addAssign_operation (temp_3.readProperty_mClassName ().readProperty_string (), temp_4.readProperty_mSelectionControllerName ().readProperty_string (), temp_5.readProperty_mModelControllerName ().readProperty_string (), temp_6.readProperty_mModelControllerPropertyName ().readProperty_string (), extractedValue_5019_typeName.readProperty_string (), temp_7.readProperty_mSelectionEntityName ().readProperty_string (), var_selectionObservablePropertyMap_5155, var_selectionGenerationList_5201  COMMA_SOURCE_FILE ("selection-controller.galgas", 120)) ;
      const GALGAS_selectionControllerDeclarationAST temp_8 = object ;
      GALGAS_string var_testedTypeName_5579 = temp_8.readProperty_mSelectionEntityName ().readProperty_string () ;
      if (GALGAS_uint::constructor_max (SOURCE_FILE ("selection-controller.galgas", 130)).isValid ()) {
        uint32_t variant_5624 = GALGAS_uint::constructor_max (SOURCE_FILE ("selection-controller.galgas", 130)).uintValue () ;
        bool loop_5624 = true ;
        while (loop_5624) {
          loop_5624 = GALGAS_bool (kIsNotEqual, extractedValue_5019_typeName.readProperty_string ().objectCompare (var_testedTypeName_5579)).operator_and (GALGAS_bool (kIsNotEqual, var_testedTypeName_5579.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("selection-controller.galgas", 130)).isValid () ;
          if (loop_5624) {
            loop_5624 = GALGAS_bool (kIsNotEqual, extractedValue_5019_typeName.readProperty_string ().objectCompare (var_testedTypeName_5579)).operator_and (GALGAS_bool (kIsNotEqual, var_testedTypeName_5579.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("selection-controller.galgas", 130)).boolValue () ;
          }
          if (loop_5624 && (0 == variant_5624)) {
            loop_5624 = false ;
            inCompiler->loopRunTimeVariantError (SOURCE_FILE ("selection-controller.galgas", 130)) ;
          }
          if (loop_5624) {
            variant_5624 -- ;
            enumGalgasBool test_9 = kBoolTrue ;
            if (kBoolTrue == test_9) {
              const GALGAS_selectionControllerDeclarationAST temp_10 = object ;
              test_9 = GALGAS_bool (kIsNotEqual, extractedValue_5019_typeName.readProperty_string ().objectCompare (temp_10.readProperty_mSelectionEntityName ().readProperty_string ())).boolEnum () ;
              if (kBoolTrue == test_9) {
                switch (var_superClassKind_4764.enumValue ()) {
                case GALGAS_classKind::kNotBuilt:
                  break ;
                case GALGAS_classKind::kEnum_prefs:
                  {
                    var_testedTypeName_5579 = GALGAS_string::makeEmptyString () ;
                  }
                  break ;
                ...
                case GALGAS_classKind::kEnum_entity:
                  {
                    const cEnumAssociatedValues_classKind_entity * extractPtr_6230 = (const cEnumAssociatedValues_classKind_entity *) (var_superClassKind_4764.unsafePointer ()) ;
                    const GALGAS_string extractedValue_6024_superOfSuperEntity = extractPtr_6230->mAssociatedValue0 ;
                    var_testedTypeName_5579 = extractedValue_6024_superOfSuperEntity ;
                    enumGalgasBool test_11 = kBoolTrue ;
                    if (kBoolTrue == test_11) {
                      test_11 = GALGAS_bool (kIsEqual, var_testedTypeName_5579.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                      if (kBoolTrue == test_11) {
                        const GALGAS_selectionControllerDeclarationAST temp_12 = object ;
                        TC_Array <C_FixItDescription> fixItArray13 ;
                        inCompiler->emitSemanticError (temp_12.readProperty_mSelectionEntityName ().readProperty_location (), GALGAS_string ("This entity is not descendant of ").add_operation (extractedValue_5019_typeName.readProperty_string (), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 142)), fixItArray13  COMMA_SOURCE_FILE ("selection-controller.galgas", 142)) ;
                      }
                    }
                  }
                  break ;
...
static GALGAS_string extensionGetter_selectionControllerPropertyGeneration_propertyDeclarationCode (const cPtr_propertyGeneration * inObject,
  ...
  result_result = GALGAS_string ("  //").add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (183)), GALGAS_uint ((uint32_t) 116U)  COMMA_SOURCE_FILE ("selection-controller.galgas", 166)), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 166)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 166)) ;
  const GALGAS_selectionControllerPropertyGeneration temp_0 = object ;
  result_result.plusAssign_operation(GALGAS_string ("  //   Selection controller: ").add_operation (temp_0.readProperty_mPropertyName (), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 167)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 167)), inCompiler  COMMA_SOURCE_FILE ("selection-controller.galgas", 167)) ;
  result_result.plusAssign_operation(GALGAS_string ("  //").add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (183)), GALGAS_uint ((uint32_t) 116U)  COMMA_SOURCE_FILE ("selection-controller.galgas", 168)), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 168)).add_operation (GALGAS_string ("\n"
  ...
  result_result.plusAssign_operation(GALGAS_string ("  var ").add_operation (temp_1.readProperty_mPropertyName (), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 169)).add_operation (GALGAS_string (" = SelectionController_"), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 169)).add_operation (temp_2.readProperty_mOwnerName (), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 169)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 169)).add_operation (temp_3.readProperty_mPropertyName (), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 169)).add_operation (GALGAS_string (" ()\n"
...
static GALGAS_string extensionGetter_selectionControllerPropertyGeneration_configurationCode (const cPtr_propertyGeneration * inObject,
  ...
  macroValidSharedObject (object, cPtr_selectionControllerPropertyGeneration) ;
  const GALGAS_selectionControllerPropertyGeneration temp_0 = object ;
  result_result = GALGAS_string ("  //--- Selection controller property: ").add_operation (temp_0.readProperty_mPropertyName (), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 175)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 175)) ;
  const GALGAS_selectionControllerPropertyGeneration temp_1 = object ;
  const GALGAS_selectionControllerPropertyGeneration temp_2 = object ;
  const GALGAS_selectionControllerPropertyGeneration temp_3 = object ;
  result_result.plusAssign_operation(GALGAS_string ("    self.").add_operation (temp_1.readProperty_mPropertyName (), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 176)).add_operation (GALGAS_string (".bind_selection (model: self."), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 176)).add_operation (temp_2.readProperty_mModelControllerName (), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 176)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 176)).add_operation (temp_3.readProperty_mModelControllerPropertyName (), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 177)).add_operation (GALGAS_string ("_property)\n"), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 177)), inCompiler  COMMA_SOURCE_FILE ("selection-controller.galgas", 176)) ;
//---
  return result_result ;
}
...
static GALGAS_string extensionGetter_selectionControllerPropertyGeneration_populateExplorerWindowCode (const cPtr_propertyGeneration * inObject,
  ...
  macroValidSharedObject (object, cPtr_selectionControllerPropertyGeneration) ;
  const GALGAS_selectionControllerPropertyGeneration temp_0 = object ;
  result_result = GALGAS_string ("    //--- Selection controller property: ").add_operation (temp_0.readProperty_mPropertyName (), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 189)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 189)) ;
  const GALGAS_selectionControllerPropertyGeneration temp_1 = object ;
  const GALGAS_selectionControllerPropertyGeneration temp_2 = object ;
  result_result.plusAssign_operation(GALGAS_string ("      self.").add_operation (temp_1.readProperty_mPropertyName (), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 190)).add_operation (GALGAS_string (".addExplorer (name: \""), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 190)).add_operation (temp_2.readProperty_mPropertyName (), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 190)).add_operation (GALGAS_string ("\", y:&y, view:view)\n"), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 190)), inCompiler  COMMA_SOURCE_FILE ("selection-controller.galgas", 190)) ;
//---
  return result_result ;
}
...
static GALGAS_string extensionGetter_selectionControllerPropertyGeneration_terminationCode (const cPtr_propertyGeneration * inObject,
  ...
  macroValidSharedObject (object, cPtr_selectionControllerPropertyGeneration) ;
  const GALGAS_selectionControllerPropertyGeneration temp_0 = object ;
  result_result = GALGAS_string ("  //--- Selection controller property: ").add_operation (temp_0.readProperty_mPropertyName (), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 196)).add_operation (GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 196)) ;
  const GALGAS_selectionControllerPropertyGeneration temp_1 = object ;
  result_result.plusAssign_operation(GALGAS_string ("    self.").add_operation (temp_1.readProperty_mPropertyName (), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 197)).add_operation (GALGAS_string (".unbind_selection ()\n"), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 197)), inCompiler  COMMA_SOURCE_FILE ("selection-controller.galgas", 197)) ;
//---
  return result_result ;
}
...
GALGAS_string filewrapperTemplate_selectionControllerGenerationTemplate_baseSelectionControllerImplementation (C_Compiler * inCompiler,
      ...
      if (kBoolTrue == test_3) {
        ...
        if (kBoolTrue == test_4) {
          ...
          result << "_property.mWriteModelFunction = nil \n"
            "    self." ;
          result << enumerator_2539.current_lkey (HERE).readProperty_string ().stringValue () ;
          result << "_property.mValidateAndWriteModelFunction = nil \n" ;
  ...
  if (in_SELECTION_5F_OBSERVABLE_5F_PROPERTY_5F_MAP.isValid ()) {
    cEnumerator_propertyMap enumerator_5050 (in_SELECTION_5F_OBSERVABLE_5F_PROPERTY_5F_MAP, kENUMERATION_UP) ;
    while (enumerator_5050.hasCurrentObject ()) {
      const enumGalgasBool test_5 = extensionGetter_isEntityType (enumerator_5050.current_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("base-selection-controller.swift.galgasTemplate", 105)).operator_not (SOURCE_FILE ("base-selection-controller.swift.galgasTemplate", 105)).operator_and (extensionGetter_isTransient (enumerator_5050.current_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("base-selection-controller.swift.galgasTemplate", 105)).operator_not (SOURCE_FILE ("base-selection-controller.swift.galgasTemplate", 105)) COMMA_SOURCE_FILE ("base-selection-controller.swift.galgasTemplate", 105)).boolEnum () ;
      if (kBoolTrue == test_5) {
        result << "      createEntryForPropertyNamed (\n"
          "        \"" ;
        result << enumerator_5050.current_lkey (HERE).readProperty_string ().stringValue () ;
        result << "\",\n"
          "        object: self." ;
        result << enumerator_5050.current_lkey (HERE).readProperty_string ().stringValue () ;
        result << "_property,\n"
  ...
  if (in_SELECTION_5F_OBSERVABLE_5F_PROPERTY_5F_MAP.isValid ()) {
    cEnumerator_propertyMap enumerator_8099 (in_SELECTION_5F_OBSERVABLE_5F_PROPERTY_5F_MAP, kENUMERATION_UP) ;
    while (enumerator_8099.hasCurrentObject ()) {
      const enumGalgasBool test_6 = extensionGetter_isEntityType (enumerator_8099.current_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("base-selection-controller.swift.galgasTemplate", 174)).operator_not (SOURCE_FILE ("base-selection-controller.swift.galgasTemplate", 174)).boolEnum () ;
      if (kBoolTrue == test_6) {
        ...
        result << enumerator_8099.current_lkey (HERE).readProperty_string ().stringValue () ;
        ...
        result << "_property.mReadModelFunction = { [weak self] in\n"
          ...
          "        case .single (let v) :\n"
          "          var s = Set <" ;
        result << extensionGetter_swiftTypeName (enumerator_8099.current_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("base-selection-controller.swift.galgasTemplate", 186)).stringValue () ;
        result << "> ()\n"
        ...
        result << "_property.selection {\n"
          ...
          "      }\n"
          "    }\n" ;
        const enumGalgasBool test_7 = extensionGetter_isTransient (enumerator_8099.current_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("base-selection-controller.swift.galgasTemplate", 212)).operator_not (SOURCE_FILE ("base-selection-controller.swift.galgasTemplate", 212)).boolEnum () ;
        if (kBoolTrue == test_7) {
          result << "    self." ;
          result << enumerator_8099.current_lkey (HERE).readProperty_string ().stringValue () ;
          result << "_property.mWriteModelFunction = { [weak self] (inValue : " ;
          result << extensionGetter_swiftTypeName (enumerator_8099.current_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("base-selection-controller.swift.galgasTemplate", 213)).stringValue () ;
          result << ") in\n"
            "      if let model = self\?.mModel {\n"
            "        switch model.selection {\n"
            "        case .empty, .multiple :\n"
          ...
          result << extensionGetter_swiftTypeName (enumerator_8099.current_mKind (HERE), inCompiler COMMA_SOURCE_FILE ("base-selection-controller.swift.galgasTemplate", 225)).stringValue () ;
...
GALGAS_string filewrapperTemplate_selectionControllerGenerationTemplate_derivedSelectionControllerImplementation (C_Compiler * inCompiler,
  ...
  GALGAS_uint index_5459_ (0) ;
  if (in_PROPERTY_5F_GENERATION_5F_LIST.isValid ()) {
    cEnumerator_propertyGenerationList enumerator_5459 (in_PROPERTY_5F_GENERATION_5F_LIST, kENUMERATION_UP) ;
    while (enumerator_5459.hasCurrentObject ()) {
      const enumGalgasBool test_4 = GALGAS_bool (enumerator_5459.current_mProperty (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_atomicPropertyGeneration).boolEnum () ;
      if (kBoolTrue == test_4) {
        result << "      createEntryForPropertyNamed (\n"
          "        \"" ;
        result << enumerator_5459.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
        result << "\",\n"
          "        object: self." ;
        result << enumerator_5459.current_mProperty (HERE).readProperty_mPropertyName ().stringValue () ;
        result << "_property,\n"
  ...
  if (in_PROPERTY_5F_GENERATION_5F_LIST.isValid ()) {
    cEnumerator_propertyGenerationList enumerator_8618 (in_PROPERTY_5F_GENERATION_5F_LIST, kENUMERATION_UP) ;
    while (enumerator_8618.hasCurrentObject ()) {
      result << callExtensionGetter_bindPropertyInSelectionController ((const cPtr_propertyGeneration *) enumerator_8618.current_mProperty (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("derived-selection-controller.swift.galgasTemplate", 183)).stringValue () ;
...
void routine_generateSelectionControllers (const GALGAS_selectionControllerForGeneration constinArgument_inArrayControllerListForGeneration,
                                           ...
                                           C_Compiler * inCompiler
                                           COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_selectionControllerForGeneration enumerator_11085 (constinArgument_inArrayControllerListForGeneration, kENUMERATION_UP) ;
  while (enumerator_11085.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = GALGAS_bool (kIsEqual, enumerator_11085.current_mBaseTypeName (HERE).objectCompare (enumerator_11085.current_mSelectionTypeName (HERE))).boolEnum () ;
      if (kBoolTrue == test_0) {
        GALGAS_string var_s_11187 = GALGAS_string (filewrapperTemplate_selectionControllerGenerationTemplate_baseSelectionControllerImplementation (inCompiler, enumerator_11085.current_mOwnerName (HERE), enumerator_11085.current_mSelectionControllerName (HERE), enumerator_11085.current_mBaseTypeName (HERE), enumerator_11085.current_mSelectionObservablePropertyMap (HERE) COMMA_SOURCE_FILE ("selection-controller.galgas", 246))) ;
        GALGAS_string var_fileName_11423 = GALGAS_string ("selectionController-").add_operation (enumerator_11085.current_mOwnerName (HERE), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 252)).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 252)).add_operation (enumerator_11085.current_mSelectionControllerName (HERE), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 252)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 252)) ;
        ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_11423  COMMA_SOURCE_FILE ("selection-controller.galgas", 253)) ;
        {
        GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_11423, var_s_11187, inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 254)) ;
        }
      }
    }
    if (kBoolFalse == test_0) {
      GALGAS_bool var_hasAtomicStoredProperties_11681 = GALGAS_bool (false) ;
      cEnumerator_propertyGenerationList enumerator_11709 (enumerator_11085.current_mPropertyGenerationList (HERE), kENUMERATION_UP) ;
      bool bool_1 = var_hasAtomicStoredProperties_11681.operator_not (SOURCE_FILE ("selection-controller.galgas", 261)).isValidAndTrue () ;
      if (enumerator_11709.hasCurrentObject () && bool_1) {
        while (enumerator_11709.hasCurrentObject () && bool_1) {
          var_hasAtomicStoredProperties_11681 = GALGAS_bool (enumerator_11709.current_mProperty (HERE).dynamicTypeDescriptor () == & kTypeDescriptor_GALGAS_atomicPropertyGeneration) ;
          enumerator_11709.gotoNextObject () ;
          if (enumerator_11709.hasCurrentObject ()) {
            bool_1 = var_hasAtomicStoredProperties_11681.operator_not (SOURCE_FILE ("selection-controller.galgas", 261)).isValidAndTrue () ;
          }
        }
      }
      GALGAS_string var_s_11875 = GALGAS_string (filewrapperTemplate_selectionControllerGenerationTemplate_derivedSelectionControllerImplementation (inCompiler, enumerator_11085.current_mOwnerName (HERE), enumerator_11085.current_mSelectionControllerName (HERE), enumerator_11085.current_mBaseTypeName (HERE), enumerator_11085.current_mSelectionTypeName (HERE), enumerator_11085.current_mPropertyGenerationList (HERE), var_hasAtomicStoredProperties_11681 COMMA_SOURCE_FILE ("selection-controller.galgas", 264))) ;
      GALGAS_string var_fileName_12169 = GALGAS_string ("selectionController-").add_operation (enumerator_11085.current_mOwnerName (HERE), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 272)).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 272)).add_operation (enumerator_11085.current_mSelectionControllerName (HERE), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 272)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 272)) ;
      ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_12169  COMMA_SOURCE_FILE ("selection-controller.galgas", 273)) ;
      {
      GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_12169, var_s_11875, inCompiler COMMA_SOURCE_FILE ("selection-controller.galgas", 274)) ;
      }
    }
...
void routine_generateCode (const GALGAS_string constinArgument_inXcodeProjectString,
                           ...
                           C_Compiler * inCompiler
                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_outputDirectory_2180 = constinArgument_inSourceFile.getter_stringByDeletingLastPathComponent (SOURCE_FILE ("code-generation.galgas", 53)) ;
  GALGAS_string var_projectName_2249 = constinArgument_inSourceFile.getter_lastPathComponent (SOURCE_FILE ("code-generation.galgas", 54)).getter_stringByDeletingPathExtension (SOURCE_FILE ("code-generation.galgas", 54)) ;
  GALGAS_string var_fileOutputDirectory_2342 = var_outputDirectory_2180.add_operation (GALGAS_string ("/"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 55)).add_operation (var_projectName_2249, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 55)) ;
  GALGAS_stringset var_generatedFileSet_2414 = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("code-generation.galgas", 56)) ;
  cEnumerator_fileGenerationList enumerator_2441 (constinArgument_inGeneration.readProperty_mFileGenerationList (), kENUMERATION_UP) ;
  while (enumerator_2441.hasCurrentObject ()) {
    callExtensionMethod_generateCode ((const cPtr_abstractFileGeneration *) enumerator_2441.current_mFileGeneration (HERE).ptr (), var_fileOutputDirectory_2342, var_generatedFileSet_2414, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 58)) ;
    enumerator_2441.gotoNextObject () ;
  }
  {
  routine_generateEBManagedObjectContext (constinArgument_inGeneration.readProperty_mEntityListForGeneration (), var_fileOutputDirectory_2342, var_generatedFileSet_2414, inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 65)) ;
  }
  {
  routine_generateSelectionControllers (constinArgument_inGeneration.readProperty_mSelectionControllerListForGeneration (), var_fileOutputDirectory_2342, var_generatedFileSet_2414, inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 79)) ;
  }
  {
  routine_generateValidationRoutineStubs (var_fileOutputDirectory_2342, constinArgument_inGeneration.readProperty_mValidationStubRoutineListForGeneration (), var_generatedFileSet_2414, inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 89)) ;
  }
  {
  routine_generateStandardProperties (var_fileOutputDirectory_2342, constinArgument_inGeneration.readProperty_mPropertyClassList (), constinArgument_inGeneration.readProperty_mTransientPropertyTypeList (), var_generatedFileSet_2414, inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 94)) ;
  }
  {
  routine_generateXcodeProject (var_outputDirectory_2180, constinArgument_inXcodeProjectString, var_generatedFileSet_2414, var_projectName_2249, inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 100)) ;
  }
  {
  routine_generateTestFile (constinArgument_inXcodeProjectString, var_projectName_2249, constinArgument_inGeneration.readProperty_mMainXibDescriptorList (), var_outputDirectory_2180, inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 106)) ;
  }
}
...
void routine_generateStandardProperties (const GALGAS_string constinArgument_inOutputDirectory,
                                         ...
                                         C_Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_contents_10956 = GALGAS_string (filewrapperTemplate_standard_5F_properties_stub (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 300))) ;
  var_contents_10956.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("UInt32"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 302))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 302)) ;
  var_contents_10956.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Int"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 303))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 303)) ;
  var_contents_10956.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Bool"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 304))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 304)) ;
  var_contents_10956.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Double"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 305))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 305)) ;
  var_contents_10956.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("String"), GALGAS_bool (false), GALGAS_string ("localizedStandardCompare") COMMA_SOURCE_FILE ("code-generation.galgas", 306))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 306)) ;
  var_contents_10956.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Data"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 307))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 307)) ;
  var_contents_10956.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Date"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 308))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 308)) ;
  ...
  cEnumerator_stringlist enumerator_11784 (constinArgument_inPropertyClassList, kENUMERATION_UP) ;
  while (enumerator_11784.hasCurrentObject ()) {
    var_contents_10956.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, enumerator_11784.current_mValue (HERE), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 312))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 312)) ;
    enumerator_11784.gotoNextObject () ;
  }
  cEnumerator_transientExternTypeList enumerator_11938 (constinArgument_inTransientPropertyExternTypeList, kENUMERATION_UP) ;
  while (enumerator_11938.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = enumerator_11938.current_mIsClass (HERE).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_contents_10956.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, enumerator_11938.current_mTypeName (HERE), GALGAS_bool (false), GALGAS_bool (true) COMMA_SOURCE_FILE ("code-generation.galgas", 316))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 316)) ;
      }
    }
    if (kBoolFalse == test_0) {
      var_contents_10956.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, enumerator_11938.current_mTypeName (HERE), GALGAS_bool (true), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 318))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 318)) ;
    }
    enumerator_11938.gotoNextObject () ;
  }
  var_contents_10956.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, GALGAS_string ("NSBezierPath"), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 321))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 321)) ;
  var_contents_10956.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, GALGAS_string ("NSFont"), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 322))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 322)) ;
  var_contents_10956.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, GALGAS_string ("NSColor"), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 323))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 323)) ;
  GALGAS_string var_fileName_12506 = GALGAS_string ("standard-properties.swift") ;
  ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_12506  COMMA_SOURCE_FILE ("code-generation.galgas", 326)) ;
  {
  GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_12506, var_contents_10956, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 327)) ;
  }
}
...
void routine_generateTestFile (const GALGAS_string constinArgument_inBundleIdentifier,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      GALGAS_stringlist var_outlet_5F_identifier_5F_list_5318 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("main-xib.galgas", 136)) ;
      cEnumerator_mainXibDescriptorList enumerator_5338 (constinArgument_inMainXibDescriptorList, kENUMERATION_UP) ;
      while (enumerator_5338.hasCurrentObject ()) {
        cEnumerator_mainXibLineDescriptorList enumerator_5389 (enumerator_5338.current_mLine (HERE), kENUMERATION_UP) ;
        while (enumerator_5389.hasCurrentObject ()) {
          switch (enumerator_5389.current_mElement (HERE).enumValue ()) {
          ...
          case GALGAS_mainXibElement::kEnum_outlet:
            {
              const cEnumAssociatedValues_mainXibElement_outlet * extractPtr_5542 = (const cEnumAssociatedValues_mainXibElement_outlet *) (enumerator_5389.current_mElement (HERE).unsafePointer ()) ;
              const GALGAS_lstring extractedValue_5484_outletName = extractPtr_5542->mAssociatedValue1 ;
              var_outlet_5F_identifier_5F_list_5318.addAssign_operation (extractedValue_5484_outletName.readProperty_string ()  COMMA_SOURCE_FILE ("main-xib.galgas", 142)) ;
            }
            break ;
          }
      ...
      GALGAS_string var_s_5582 = GALGAS_string (filewrapperTemplate_testFiles_test_5F_py (inCompiler, constinArgument_inBundleIdentifier, constinArgument_inProjectName, var_outlet_5F_identifier_5F_list_5318 COMMA_SOURCE_FILE ("main-xib.galgas", 146))) ;
      GALGAS_string var_header_5713 = GALGAS_string ("#!/usr/bin/python\n"
        "# coding=utf-8\n"
        "\n"
        ...
        "\n") ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("test.py"), GALGAS_string ("#"), var_header_5713, GALGAS_string::makeEmptyString (), var_s_5582, GALGAS_string ("#    ENTER USER CODE HERE\n"), GALGAS_string ("\n"
        "quitApplication ()\n"
        "\n"
...
static void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  GALGAS_location joker_1332 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE ("program.galgas", 25))), GALGAS_string::makeEmptyString (), var_declarationStruct_1128, joker_1332  COMMA_SOURCE_FILE ("program.galgas", 25)) ;
  GALGAS_location var_endOfSourceFile_1500 ;
  var_endOfSourceFile_1500.drop () ;
  cGrammar_easyBindings_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, var_declarationStruct_1128, var_endOfSourceFile_1500  COMMA_SOURCE_FILE ("program.galgas", 29)) ;
  var_declarationStruct_1128.mProperty_mUnifiedDeclarationList.addAssign_operation (GALGAS_prefsDeclarationAST::constructor_new (GALGAS_lstring::constructor_new (function_preferencesName (inCompiler COMMA_SOURCE_FILE ("program.galgas", 34)), GALGAS_location::constructor_nowhere (SOURCE_FILE ("program.galgas", 34))  COMMA_SOURCE_FILE ("program.galgas", 34)), var_declarationStruct_1128.readProperty_mPreferences ()  COMMA_SOURCE_FILE ("program.galgas", 33))  COMMA_SOURCE_FILE ("program.galgas", 33)) ;
  {
  routine_enterAtomicClassesIn (var_declarationStruct_1128.mProperty_mUnifiedDeclarationList, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 38)) ;
  }
  GALGAS_declarationListAST var_sortedDeclarationListAST_2033 ;
  {
  routine_sortProperties (constinArgument_inSourceFile.readProperty_string (), var_declarationStruct_1128.readProperty_mUnifiedDeclarationList (), var_sortedDeclarationListAST_2033, inCompiler  COMMA_SOURCE_FILE ("program.galgas", 40)) ;
  }
  GALGAS_semanticContext var_semanticContext_2147 = GALGAS_semanticContext::constructor_default (SOURCE_FILE ("program.galgas", 42)) ;
  var_semanticContext_2147.setter_setMAutoLayoutVStackFunctionMap (var_declarationStruct_1128.readProperty_mAutoLayoutVStackFunctionMap () COMMA_SOURCE_FILE ("program.galgas", 43)) ;
  var_semanticContext_2147.setter_setMAutoLayoutHStackFunctionMap (var_declarationStruct_1128.readProperty_mAutoLayoutHStackFunctionMap () COMMA_SOURCE_FILE ("program.galgas", 44)) ;
  var_semanticContext_2147.setter_setMEnumerationFunctionListAST (var_declarationStruct_1128.readProperty_mEnumerationFunctionListAST () COMMA_SOURCE_FILE ("program.galgas", 45)) ;
  GALGAS_generationStruct var_generation_2479 = GALGAS_generationStruct::constructor_default (SOURCE_FILE ("program.galgas", 46)) ;
  cEnumerator_declarationListAST enumerator_2509 (var_sortedDeclarationListAST_2033, kENUMERATION_UP) ;
  ...
  if (enumerator_2509.hasCurrentObject () && bool_0) {
    while (enumerator_2509.hasCurrentObject () && bool_0) {
      callExtensionMethod_firstAnalysisPhase ((const cPtr_abstractDeclarationAST *) enumerator_2509.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_2147, var_generation_2479, inCompiler COMMA_SOURCE_FILE ("program.galgas", 48)) ;
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_1) {
      {
      routine_buildBindingSpecificationMap (var_semanticContext_2147, var_declarationStruct_1128.readProperty_mBindingSpecificationListMap (), inCompiler  COMMA_SOURCE_FILE ("program.galgas", 52)) ;
      }
    }
  }
  enumGalgasBool test_2 = kBoolTrue ;
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_2) {
      {
      routine_buildAutoLayoutBindingSpecificationMap (var_semanticContext_2147, var_declarationStruct_1128.readProperty_mAutoLayoutBindingSpecificationList (), inCompiler  COMMA_SOURCE_FILE ("program.galgas", 58)) ;
      }
    }
  }
  cEnumerator_declarationListAST enumerator_3143 (var_sortedDeclarationListAST_2033, kENUMERATION_UP) ;
  ...
  if (enumerator_3143.hasCurrentObject () && bool_3) {
    while (enumerator_3143.hasCurrentObject () && bool_3) {
      callExtensionMethod_secondAnalysisPhase ((const cPtr_abstractDeclarationAST *) enumerator_3143.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_2147, var_generation_2479, inCompiler COMMA_SOURCE_FILE ("program.galgas", 65)) ;
      enumerator_3143.gotoNextObject () ;
      if (enumerator_3143.hasCurrentObject ()) {
  ...
  cEnumerator_declarationListAST enumerator_3371 (var_sortedDeclarationListAST_2033, kENUMERATION_UP) ;
  ...
  if (enumerator_3371.hasCurrentObject () && bool_4) {
    while (enumerator_3371.hasCurrentObject () && bool_4) {
      callExtensionMethod_thirdAnalysisPhase ((const cPtr_abstractDeclarationAST *) enumerator_3371.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_2147, var_generation_2479, inCompiler COMMA_SOURCE_FILE ("program.galgas", 69)) ;
      enumerator_3371.gotoNextObject () ;
      if (enumerator_3371.hasCurrentObject ()) {
  ...
  cEnumerator_declarationListAST enumerator_3599 (var_sortedDeclarationListAST_2033, kENUMERATION_UP) ;
  ...
  if (enumerator_3599.hasCurrentObject () && bool_5) {
    while (enumerator_3599.hasCurrentObject () && bool_5) {
      callExtensionMethod_fourthAnalysisPhase ((const cPtr_abstractDeclarationAST *) enumerator_3599.current_mPropertyDeclaration (HERE).ptr (), var_semanticContext_2147, var_generation_2479, inCompiler COMMA_SOURCE_FILE ("program.galgas", 73)) ;
      enumerator_3599.gotoNextObject () ;
      if (enumerator_3599.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_6) {
    ...
    if (kBoolTrue == test_6) {
      cEnumerator_enumerationFunctionListAST enumerator_3887 (var_semanticContext_2147.readProperty_mEnumerationFunctionListAST (), kENUMERATION_UP) ;
      while (enumerator_3887.hasCurrentObject ()) {
        GALGAS_classKind var_type_4005 ;
        GALGAS_propertyMap joker_4007_3 ; // Joker input parameter
        GALGAS_actionMap joker_4007_2 ; // Joker input parameter
        GALGAS_propertyGenerationList joker_4007_1 ; // Joker input parameter
        var_semanticContext_2147.readProperty_mClassMap ().method_searchKey (enumerator_3887.current_mEnumName (HERE), var_type_4005, joker_4007_3, joker_4007_2, joker_4007_1, inCompiler COMMA_SOURCE_FILE ("program.galgas", 78)) ;
        enumGalgasBool test_7 = kBoolTrue ;
        if (kBoolTrue == test_7) {
          test_7 = var_type_4005.getter_isAtomic (SOURCE_FILE ("program.galgas", 79)).operator_not (SOURCE_FILE ("program.galgas", 79)).boolEnum () ;
          if (kBoolTrue == test_7) {
            TC_Array <C_FixItDescription> fixItArray8 ;
            inCompiler->emitSemanticError (enumerator_3887.current_mEnumName (HERE).readProperty_location (), GALGAS_string ("this type should be an enum type"), fixItArray8  COMMA_SOURCE_FILE ("program.galgas", 80)) ;
          }
        }
        if (kBoolFalse == test_7) {
          GALGAS_typeKind var_typeKind_4159 ;
          var_type_4005.method_atomic (var_typeKind_4159, inCompiler COMMA_SOURCE_FILE ("program.galgas", 82)) ;
          enumGalgasBool test_9 = kBoolTrue ;
          if (kBoolTrue == test_9) {
            test_9 = var_typeKind_4159.getter_isEnumType (SOURCE_FILE ("program.galgas", 83)).operator_not (SOURCE_FILE ("program.galgas", 83)).boolEnum () ;
            if (kBoolTrue == test_9) {
              TC_Array <C_FixItDescription> fixItArray10 ;
              inCompiler->emitSemanticError (enumerator_3887.current_mEnumName (HERE).readProperty_location (), GALGAS_string ("this type should be an enum type"), fixItArray10  COMMA_SOURCE_FILE ("program.galgas", 84)) ;
            }
          }
        }
  ...
  if (kBoolTrue == test_11) {
    ...
    if (kBoolTrue == test_11) {
      {
      routine_graphvizAnalysis (constinArgument_inSourceFile.readProperty_string ().getter_stringByDeletingLastPathComponent (SOURCE_FILE ("program.galgas", 91)), var_semanticContext_2147, var_declarationStruct_1128.readProperty_mGraphvizList (), inCompiler  COMMA_SOURCE_FILE ("program.galgas", 91)) ;
      }
    }
  }
  ...
  if (kBoolTrue == test_12) {
    ...
    if (kBoolTrue == test_12) {
      {
      routine_generateCode (var_declarationStruct_1128.readProperty_mXcodeProject ().readProperty_string (), var_generation_2479, constinArgument_inSourceFile.readProperty_string (), inCompiler  COMMA_SOURCE_FILE ("program.galgas", 95)) ;
      }
    }
  }
}
