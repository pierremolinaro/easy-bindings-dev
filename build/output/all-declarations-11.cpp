...
void routine_generateOutletClasses (const GALGAS_stringset constinArgument_inNeededOutletClasses,
  ...
  GALGAS_filewrapper var_w_6322 = GALGAS_filewrapper (gWrapperDirectory_0_outletClassGeneration) ;
  cEnumerator_stringset enumerator_6395 (constinArgument_inNeededOutletClasses, kENUMERATION_UP) ;
  while (enumerator_6395.hasCurrentObject ()) {
    GALGAS_string var_s_6408 = var_w_6322.getter_textFileContentsAtPath (GALGAS_string ("/").add_operation (enumerator_6395.current (HERE), inCompiler COMMA_SOURCE_FILE ("outlet-class.galgas", 188)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("outlet-class.galgas", 188)), inCompiler COMMA_SOURCE_FILE ("outlet-class.galgas", 188)) ;
    GALGAS_string var_fileName_6476 = enumerator_6395.current (HERE).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("outlet-class.galgas", 189)) ;
    ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_6476  COMMA_SOURCE_FILE ("outlet-class.galgas", 190)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_6476, var_s_6408, inCompiler COMMA_SOURCE_FILE ("outlet-class.galgas", 191)) ;
    }
...
static void extensionMethod_computedPropertyDeclarationAST_enterInPrecedenceGraph (const cPtr_abstractDeclarationAST * inObject,
  ...
  GALGAS_lstring var_node_730 = GALGAS_lstring::constructor_new (temp_0.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 16)).add_operation (temp_1.getter_mComputedPropertyName (HERE).getter_string (SOURCE_FILE ("computed-property.galgas", 16)), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 16)), temp_2.getter_mComputedPropertyName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("computed-property.galgas", 16)) ;
  {
  const GALGAS_computedPropertyDeclarationAST temp_3 = object ;
  ioArgument_ioGraph.setter_addNode (var_node_730, temp_3, inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 17)) ;
  }
  {
  const GALGAS_computedPropertyDeclarationAST temp_4 = object ;
  ioArgument_ioGraph.setter_addEdge (var_node_730, temp_4.getter_mClassName (HERE) COMMA_SOURCE_FILE ("computed-property.galgas", 18)) ;
  }
  {
  const GALGAS_computedPropertyDeclarationAST temp_5 = object ;
  ioArgument_ioGraph.setter_addEdge (var_node_730, temp_5.getter_mComputedPropertyTypeName (HERE) COMMA_SOURCE_FILE ("computed-property.galgas", 19)) ;
  }
  const GALGAS_computedPropertyDeclarationAST temp_6 = object ;
  cEnumerator_observablePropertyList enumerator_1023 (temp_6.getter_mDependencyList (HERE), kENUMERATION_UP) ;
  while (enumerator_1023.hasCurrentObject ()) {
    switch (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).enumValue ()) {
    case GALGAS_observablePropertyAST::kNotBuilt:
      break ;
    case GALGAS_observablePropertyAST::kEnum_rootProperty:
      {
        const cEnumAssociatedValues_observablePropertyAST_rootProperty * extractPtr_1280 = (const cEnumAssociatedValues_observablePropertyAST_rootProperty *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_1280->mAssociatedValue0 ;
        enumGalgasBool test_7 = kBoolTrue ;
        if (kBoolTrue == test_7) {
    ...
    case GALGAS_observablePropertyAST::kEnum_rootPropertyWithOption:
      {
        const cEnumAssociatedValues_observablePropertyAST_rootPropertyWithOption * extractPtr_1504 = (const cEnumAssociatedValues_observablePropertyAST_rootPropertyWithOption *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_1504->mAssociatedValue0 ;
        enumGalgasBool test_10 = kBoolTrue ;
        if (kBoolTrue == test_10) {
    ...
    case GALGAS_observablePropertyAST::kEnum_rootPropertyRelationship:
      {
        const cEnumAssociatedValues_observablePropertyAST_rootPropertyRelationship * extractPtr_1742 = (const cEnumAssociatedValues_observablePropertyAST_rootPropertyRelationship *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_relationshipName = extractPtr_1742->mAssociatedValue0 ;
    ...
    case GALGAS_observablePropertyAST::kEnum_rootPropertyNone:
      {
        const cEnumAssociatedValues_observablePropertyAST_rootPropertyNone * extractPtr_1970 = (const cEnumAssociatedValues_observablePropertyAST_rootPropertyNone *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_relationshipName = extractPtr_1970->mAssociatedValue0 ;
        enumGalgasBool test_16 = kBoolTrue ;
        if (kBoolTrue == test_16) {
    ...
    case GALGAS_observablePropertyAST::kEnum_selfProperty:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfProperty * extractPtr_2152 = (const cEnumAssociatedValues_observablePropertyAST_selfProperty *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_2152->mAssociatedValue0 ;
        {
        const GALGAS_computedPropertyDeclarationAST temp_19 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_730, GALGAS_lstring::constructor_new (temp_19.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 40)).add_operation (extractedValue_propertyName.getter_string (SOURCE_FILE ("computed-property.galgas", 40)), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 40)), extractedValue_propertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("computed-property.galgas", 40)) COMMA_SOURCE_FILE ("computed-property.galgas", 40)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfPropertyWithOption:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfPropertyWithOption * extractPtr_2320 = (const cEnumAssociatedValues_observablePropertyAST_selfPropertyWithOption *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        ...
        ioArgument_ioGraph.setter_addEdge (var_node_730, GALGAS_lstring::constructor_new (temp_20.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 42)).add_operation (extractedValue_propertyName.getter_string (SOURCE_FILE ("computed-property.galgas", 42)), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 42)), extractedValue_propertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("computed-property.galgas", 42)) COMMA_SOURCE_FILE ("computed-property.galgas", 42)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfPropertyArray:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfPropertyArray * extractPtr_2483 = (const cEnumAssociatedValues_observablePropertyAST_selfPropertyArray *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_2483->mAssociatedValue0 ;
        {
        const GALGAS_computedPropertyDeclarationAST temp_21 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_730, GALGAS_lstring::constructor_new (temp_21.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 44)).add_operation (extractedValue_propertyName.getter_string (SOURCE_FILE ("computed-property.galgas", 44)), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 44)), extractedValue_propertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("computed-property.galgas", 44)) COMMA_SOURCE_FILE ("computed-property.galgas", 44)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfPropertyObject:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfPropertyObject * extractPtr_2647 = (const cEnumAssociatedValues_observablePropertyAST_selfPropertyObject *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_2647->mAssociatedValue0 ;
        {
        const GALGAS_computedPropertyDeclarationAST temp_22 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_730, GALGAS_lstring::constructor_new (temp_22.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 46)).add_operation (extractedValue_propertyName.getter_string (SOURCE_FILE ("computed-property.galgas", 46)), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 46)), extractedValue_propertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("computed-property.galgas", 46)) COMMA_SOURCE_FILE ("computed-property.galgas", 46)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfPropertyNone:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfPropertyNone * extractPtr_2807 = (const cEnumAssociatedValues_observablePropertyAST_selfPropertyNone *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_2807->mAssociatedValue0 ;
        {
        const GALGAS_computedPropertyDeclarationAST temp_23 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_730, GALGAS_lstring::constructor_new (temp_23.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 48)).add_operation (extractedValue_propertyName.getter_string (SOURCE_FILE ("computed-property.galgas", 48)), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 48)), extractedValue_propertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("computed-property.galgas", 48)) COMMA_SOURCE_FILE ("computed-property.galgas", 48)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_prefsProperty:
      {
        const cEnumAssociatedValues_observablePropertyAST_prefsProperty * extractPtr_2960 = (const cEnumAssociatedValues_observablePropertyAST_prefsProperty *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_2960->mAssociatedValue0 ;
        {
        ioArgument_ioGraph.setter_addEdge (var_node_730, GALGAS_lstring::constructor_new (function_preferencesName (inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 50)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 50)).add_operation (extractedValue_propertyName.getter_string (SOURCE_FILE ("computed-property.galgas", 50)), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 50)), extractedValue_propertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("computed-property.galgas", 50)) COMMA_SOURCE_FILE ("computed-property.galgas", 50)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_prefsPropertyWithOption:
      {
        const cEnumAssociatedValues_observablePropertyAST_prefsPropertyWithOption * extractPtr_3125 = (const cEnumAssociatedValues_observablePropertyAST_prefsPropertyWithOption *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_3125->mAssociatedValue0 ;
        {
        ioArgument_ioGraph.setter_addEdge (var_node_730, GALGAS_lstring::constructor_new (function_preferencesName (inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 52)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 52)).add_operation (extractedValue_propertyName.getter_string (SOURCE_FILE ("computed-property.galgas", 52)), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 52)), extractedValue_propertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("computed-property.galgas", 52)) COMMA_SOURCE_FILE ("computed-property.galgas", 52)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfControllerProperty:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfControllerProperty * extractPtr_3318 = (const cEnumAssociatedValues_observablePropertyAST_selfControllerProperty *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_controllerName = extractPtr_3318->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_3318->mAssociatedValue1 ;
        {
        const GALGAS_computedPropertyDeclarationAST temp_24 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_730, GALGAS_lstring::constructor_new (temp_24.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 54)).add_operation (extractedValue_controllerName.getter_string (SOURCE_FILE ("computed-property.galgas", 54)), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 54)), extractedValue_controllerName.getter_location (HERE)  COMMA_SOURCE_FILE ("computed-property.galgas", 54)) COMMA_SOURCE_FILE ("computed-property.galgas", 54)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfControllerSecondaryProperty:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfControllerSecondaryProperty * extractPtr_3549 = (const cEnumAssociatedValues_observablePropertyAST_selfControllerSecondaryProperty *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_controllerName = extractPtr_3549->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_3549->mAssociatedValue1 ;
        const GALGAS_lstring extractedValue_secondaryPropertyName = extractPtr_3549->mAssociatedValue2 ;
        {
        const GALGAS_computedPropertyDeclarationAST temp_25 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_730, GALGAS_lstring::constructor_new (temp_25.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 56)).add_operation (extractedValue_controllerName.getter_string (SOURCE_FILE ("computed-property.galgas", 56)), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 56)), extractedValue_controllerName.getter_location (HERE)  COMMA_SOURCE_FILE ("computed-property.galgas", 56)) COMMA_SOURCE_FILE ("computed-property.galgas", 56)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfControllerAllProperties:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfControllerAllProperties * extractPtr_3776 = (const cEnumAssociatedValues_observablePropertyAST_selfControllerAllProperties *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_controllerName = extractPtr_3776->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_3776->mAssociatedValue1 ;
        const GALGAS_lstring extractedValue_secondaryPropertyName = extractPtr_3776->mAssociatedValue2 ;
        {
        const GALGAS_computedPropertyDeclarationAST temp_26 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_730, GALGAS_lstring::constructor_new (temp_26.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 58)).add_operation (extractedValue_controllerName.getter_string (SOURCE_FILE ("computed-property.galgas", 58)), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 58)), extractedValue_controllerName.getter_location (HERE)  COMMA_SOURCE_FILE ("computed-property.galgas", 58)) COMMA_SOURCE_FILE ("computed-property.galgas", 58)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfControllerOneProperty:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfControllerOneProperty * extractPtr_3972 = (const cEnumAssociatedValues_observablePropertyAST_selfControllerOneProperty *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_controllerName = extractPtr_3972->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_3972->mAssociatedValue1 ;
        {
        const GALGAS_computedPropertyDeclarationAST temp_27 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_730, GALGAS_lstring::constructor_new (temp_27.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 60)).add_operation (extractedValue_controllerName.getter_string (SOURCE_FILE ("computed-property.galgas", 60)), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 60)), extractedValue_controllerName.getter_location (HERE)  COMMA_SOURCE_FILE ("computed-property.galgas", 60)) COMMA_SOURCE_FILE ("computed-property.galgas", 60)) ;
        }
      }
      break ;
    ...
    case GALGAS_observablePropertyAST::kEnum_superProperty:
      {
        const cEnumAssociatedValues_observablePropertyAST_superProperty * extractPtr_4261 = (const cEnumAssociatedValues_observablePropertyAST_superProperty *) (enumerator_1023.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_superEntityName = extractPtr_4261->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_4261->mAssociatedValue1 ;
        {
...
static void extensionMethod_computedPropertyDeclarationAST_firstAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_computedPropertyDeclarationAST) ;
  const GALGAS_computedPropertyDeclarationAST temp_0 = object ;
  cMapElement_classMap * objectArray_6988 = (cMapElement_classMap *) ioArgument_ioSemanticContext.mProperty_mClassMap.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, temp_0.getter_mClassName (HERE), kSearchErrorMessage_classMap_searchKey  COMMA_SOURCE_FILE ("computed-property.galgas", 149)) ;
  if (NULL != objectArray_6988) {
    macroValidSharedObject (objectArray_6988, cMapElement_classMap) ;
    GALGAS_classKind var_classKind_7161 ;
    const GALGAS_computedPropertyDeclarationAST temp_1 = object ;
    GALGAS_propertyMap joker_7163_3 ; // Joker input parameter
    GALGAS_actionMap joker_7163_2 ; // Joker input parameter
    GALGAS_propertyGenerationList joker_7163_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_1.getter_mComputedPropertyTypeName (HERE), var_classKind_7161, joker_7163_3, joker_7163_2, joker_7163_1, inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 152)) ;
    switch (var_classKind_7161.enumValue ()) {
    case GALGAS_classKind::kNotBuilt:
      break ;
    case GALGAS_classKind::kEnum_prefs:
      {
...
static void extensionMethod_computedPropertyDeclarationAST_thirdAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_computedPropertyDeclarationAST * object = (const cPtr_computedPropertyDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_computedPropertyDeclarationAST) ;
  GALGAS_classKind var_classKind_8224 ;
  const GALGAS_computedPropertyDeclarationAST temp_0 = object ;
  GALGAS_propertyMap joker_8226_3 ; // Joker input parameter
  GALGAS_actionMap joker_8226_2 ; // Joker input parameter
  GALGAS_propertyGenerationList joker_8226_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_0.getter_mComputedPropertyTypeName (HERE), var_classKind_8224, joker_8226_3, joker_8226_2, joker_8226_1, inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 180)) ;
  GALGAS_typeKind var_typeKind_8266 ;
  switch (var_classKind_8224.enumValue ()) {
  case GALGAS_classKind::kNotBuilt:
    break ;
  case GALGAS_classKind::kEnum_prefs:
    {
      ...
      var_typeKind_8266.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_classKind::kEnum_atomic:
    {
      const cEnumAssociatedValues_classKind_atomic * extractPtr_8441 = (const cEnumAssociatedValues_classKind_atomic *) (var_classKind_8224.unsafePointer ()) ;
      const GALGAS_typeKind extractedValue_kind = extractPtr_8441->mAssociatedValue0 ;
      var_typeKind_8266 = extractedValue_kind ;
    }
    break ;
  case GALGAS_classKind::kEnum_document:
    {
  ...
  GALGAS_propertyMap var_rootProperties_8717 ;
  enumGalgasBool test_7 = kBoolTrue ;
  if (kBoolTrue == test_7) {
    const GALGAS_computedPropertyDeclarationAST temp_8 = object ;
    ...
    if (kBoolTrue == test_7) {
      var_rootProperties_8717 = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE ("computed-property.galgas", 196)) ;
    }
  }
  if (kBoolFalse == test_7) {
    const GALGAS_computedPropertyDeclarationAST temp_9 = object ;
    GALGAS_classKind joker_8859 ; // Joker input parameter
    GALGAS_actionMap joker_8878_2 ; // Joker input parameter
    GALGAS_propertyGenerationList joker_8878_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_9.getter_mRootEntityName (HERE), joker_8859, var_rootProperties_8717, joker_8878_2, joker_8878_1, inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 198)) ;
  }
  GALGAS_classKind var_currentClassKind_8997 ;
  GALGAS_propertyMap var_properties_9013 ;
  ...
  ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_10.getter_mClassName (HERE), var_currentClassKind_8997, var_properties_9013, joker_9015_2, joker_9015_1, inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 201)) ;
  GALGAS_transientDependencyListForGeneration var_dependencies_9102 = GALGAS_transientDependencyListForGeneration::constructor_emptyList (SOURCE_FILE ("computed-property.galgas", 203)) ;
  const GALGAS_computedPropertyDeclarationAST temp_11 = object ;
  cEnumerator_observablePropertyList enumerator_9140 (temp_11.getter_mDependencyList (HERE), kENUMERATION_UP) ;
  while (enumerator_9140.hasCurrentObject ()) {
    GALGAS_propertyKind var_dependencyKind_9299 ;
    GALGAS_string var_swiftTypeStringForTransientFunctionArgument_9362 ;
    extensionMethod_analyzeObservableProperty (enumerator_9140.current_mObservableProperty (HERE), var_rootProperties_8717, ioArgument_ioSemanticContext, var_properties_9013, var_dependencyKind_9299, var_swiftTypeStringForTransientFunctionArgument_9362, inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 205)) ;
    switch (var_dependencyKind_9299.enumValue ()) {
    case GALGAS_propertyKind::kNotBuilt:
      break ;
    case GALGAS_propertyKind::kEnum_property:
      {
    ...
    case GALGAS_propertyKind::kEnum_arrayController:
      {
        TC_Array <C_FixItDescription> fixItArray12 ;
        inCompiler->emitSemanticError (extensionGetter_location (enumerator_9140.current_mObservableProperty (HERE), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 217)), GALGAS_string ("only an atomic property can be observed"), fixItArray12  COMMA_SOURCE_FILE ("computed-property.galgas", 217)) ;
      }
      break ;
    case GALGAS_propertyKind::kEnum_selectionController:
      {
        TC_Array <C_FixItDescription> fixItArray13 ;
        inCompiler->emitSemanticError (extensionGetter_location (enumerator_9140.current_mObservableProperty (HERE), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 219)), GALGAS_string ("only an atomic property can be observed"), fixItArray13  COMMA_SOURCE_FILE ("computed-property.galgas", 219)) ;
      }
      break ;
    }
    var_dependencies_9102.addAssign_operation (enumerator_9140.current_mObservableProperty (HERE), extensionGetter_modelStringFunctionArgument (enumerator_9140.current_mObservableProperty (HERE), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 223)), var_swiftTypeStringForTransientFunctionArgument_9362  COMMA_SOURCE_FILE ("computed-property.galgas", 221)) ;
    enumerator_9140.gotoNextObject () ;
  }
  const GALGAS_computedPropertyDeclarationAST temp_14 = object ;
  const GALGAS_computedPropertyDeclarationAST temp_15 = object ;
  ioArgument_ioGeneration.mProperty_mFileGenerationList.addAssign_operation (GALGAS_transientRoutineGeneration::constructor_new (temp_14.getter_mClassName (HERE).getter_string (SOURCE_FILE ("computed-property.galgas", 227)), temp_15.getter_mComputedPropertyName (HERE).getter_string (HERE), var_typeKind_8266, GALGAS_string ("computed"), var_dependencies_9102  COMMA_SOURCE_FILE ("computed-property.galgas", 226))  COMMA_SOURCE_FILE ("computed-property.galgas", 226)) ;
  const GALGAS_computedPropertyDeclarationAST temp_16 = object ;
  const GALGAS_computedPropertyDeclarationAST temp_17 = object ;
  ioArgument_ioGeneration.mProperty_mFileGenerationList.addAssign_operation (GALGAS_computeRoutineGeneration::constructor_new (temp_16.getter_mClassName (HERE).getter_string (SOURCE_FILE ("computed-property.galgas", 234)), temp_17.getter_mComputedPropertyName (HERE).getter_string (HERE), var_typeKind_8266, var_dependencies_9102  COMMA_SOURCE_FILE ("computed-property.galgas", 233))  COMMA_SOURCE_FILE ("computed-property.galgas", 233)) ;
  const GALGAS_computedPropertyDeclarationAST temp_18 = object ;
  cMapElement_classMap * objectArray_10234 = (cMapElement_classMap *) ioArgument_ioSemanticContext.mProperty_mClassMap.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, temp_18.getter_mClassName (HERE), kSearchErrorMessage_classMap_searchKey  COMMA_SOURCE_FILE ("computed-property.galgas", 239)) ;
  if (NULL != objectArray_10234) {
    macroValidSharedObject (objectArray_10234, cMapElement_classMap) ;
    GALGAS_bool var_generate_10336 ;
    switch (var_currentClassKind_8997.enumValue ()) {
    case GALGAS_classKind::kNotBuilt:
      break ;
    case GALGAS_classKind::kEnum_prefs:
      {
        var_generate_10336 = GALGAS_bool (true) ;
      }
      break ;
    case GALGAS_classKind::kEnum_document:
      {
    ...
    case GALGAS_classKind::kEnum_entity:
      {
        const cEnumAssociatedValues_classKind_entity * extractPtr_10725 = (const cEnumAssociatedValues_classKind_entity *) (var_currentClassKind_8997.unsafePointer ()) ;
        const GALGAS_bool extractedValue_graphic = extractPtr_10725->mAssociatedValue1 ;
        enumGalgasBool test_19 = kBoolTrue ;
        if (kBoolTrue == test_19) {
    ...
    const GALGAS_computedPropertyDeclarationAST temp_22 = object ;
    const GALGAS_computedPropertyDeclarationAST temp_23 = object ;
    objectArray_10234->mProperty_mPropertyGenerationList.addAssign_operation (GALGAS_computedPropertyGeneration::constructor_new (temp_22.getter_mComputedPropertyName (HERE).getter_string (HERE), temp_23.getter_mClassName (HERE).getter_string (HERE), var_typeKind_8266, var_dependencies_9102, var_generate_10336  COMMA_SOURCE_FILE ("computed-property.galgas", 257))  COMMA_SOURCE_FILE ("computed-property.galgas", 257)) ;
  }
}
...
static GALGAS_string extensionGetter_computedPropertyGeneration_configurationCode (const cPtr_propertyGeneration * inObject,
  ...
  GALGAS_string var_prefix_18486 = temp_0 ;
  result_result = GALGAS_string::makeEmptyString () ;
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_2) {
      const GALGAS_computedPropertyGeneration temp_4 = object ;
      GALGAS_bool var_needs_5F_unwSelf_18623 = extensionGetter_needs_5F_unwSelf (temp_4.getter_mDependencyList (HERE), constinArgument_inPreferences, inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 419)) ;
      const GALGAS_computedPropertyGeneration temp_5 = object ;
      ...
      enumGalgasBool test_6 = kBoolTrue ;
      if (kBoolTrue == test_6) {
        test_6 = var_needs_5F_unwSelf_18623.boolEnum () ;
        if (kBoolTrue == test_6) {
          const GALGAS_computedPropertyGeneration temp_7 = object ;
          result_result.plusAssign_operation(GALGAS_string ("    ").add_operation (var_prefix_18486, inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 422)).add_operation (temp_7.getter_mPropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 422)).add_operation (GALGAS_string ("_property.mReadModelFunction = { [weak self] in\n"), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 422)), inCompiler  COMMA_SOURCE_FILE ("computed-property.galgas", 422)) ;
      ...
      if (kBoolFalse == test_6) {
        const GALGAS_computedPropertyGeneration temp_11 = object ;
        result_result.plusAssign_operation(GALGAS_string ("    ").add_operation (var_prefix_18486, inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 429)).add_operation (temp_11.getter_mPropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 429)).add_operation (GALGAS_string ("_property.mReadModelFunction = {\n"), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 429)), inCompiler  COMMA_SOURCE_FILE ("computed-property.galgas", 429)) ;
        const GALGAS_computedPropertyGeneration temp_12 = object ;
        const GALGAS_computedPropertyGeneration temp_13 = object ;
        const GALGAS_computedPropertyGeneration temp_14 = object ;
      ...
      result_result.plusAssign_operation(GALGAS_string ("    ").add_operation (var_prefix_18486, inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 433)).add_operation (temp_15.getter_mPropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 433)).add_operation (GALGAS_string ("_property.mStoreFunction = { [weak self] in self\?.compute_"), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 433)).add_operation (temp_16.getter_mPropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 433)).add_operation (GALGAS_string ("_property ($0, $1) \?\? false }\n"), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 433)), inCompiler  COMMA_SOURCE_FILE ("computed-property.galgas", 433)) ;
      const GALGAS_computedPropertyGeneration temp_17 = object ;
      cEnumerator_transientDependencyListForGeneration enumerator_19638 (temp_17.getter_mDependencyList (HERE), kENUMERATION_UP) ;
      while (enumerator_19638.hasCurrentObject ()) {
        GALGAS_string var_s_19653 = extensionGetter_generateAddObserverCall (enumerator_19638.current_mDependency (HERE), constinArgument_inPreferences, inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 435)) ;
        enumGalgasBool test_18 = kBoolTrue ;
        if (kBoolTrue == test_18) {
          test_18 = GALGAS_bool (kIsNotEqual, var_s_19653.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_18) {
            const GALGAS_computedPropertyGeneration temp_19 = object ;
            result_result.plusAssign_operation(GALGAS_string ("    ").add_operation (var_s_19653, inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 437)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 437)).add_operation (var_prefix_18486, inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 437)).add_operation (temp_19.getter_mPropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 437)).add_operation (GALGAS_string ("_property)\n"), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 437)), inCompiler  COMMA_SOURCE_FILE ("computed-property.galgas", 437)) ;
          }
        }
...
static GALGAS_string extensionGetter_computedPropertyGeneration_terminationCode (const cPtr_propertyGeneration * inObject,
  ...
  result_result = GALGAS_string::makeEmptyString () ;
  const GALGAS_computedPropertyGeneration temp_0 = object ;
  cEnumerator_transientDependencyListForGeneration enumerator_20114 (temp_0.getter_mDependencyList (HERE), kENUMERATION_UP) ;
  while (enumerator_20114.hasCurrentObject ()) {
    GALGAS_string var_s_20127 = extensionGetter_generateRemoveObserverCall (enumerator_20114.current_mDependency (HERE), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 448)) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (kIsNotEqual, var_s_20127.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_1) {
        const GALGAS_computedPropertyGeneration temp_2 = object ;
        result_result.plusAssign_operation(GALGAS_string ("    // ").add_operation (var_s_20127, inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 450)).add_operation (GALGAS_string (" (self."), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 450)).add_operation (temp_2.getter_mPropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 450)).add_operation (GALGAS_string ("_property)\n"), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 450)), inCompiler  COMMA_SOURCE_FILE ("computed-property.galgas", 450)) ;
      }
    }
...
static void extensionMethod_computeRoutineGeneration_generateCode (const cPtr_abstractFileGeneration * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_generatedZone_33__21745 = GALGAS_string ("  }\n"
        "\n") ;
      var_generatedZone_33__21745.plusAssign_operation(GALGAS_string ("  //").add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (183)), GALGAS_uint ((uint32_t) 116U)  COMMA_SOURCE_FILE ("computed-property.galgas", 486)), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 486)).add_operation (GALGAS_string ("\n"
        "\n"), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 486)), inCompiler  COMMA_SOURCE_FILE ("computed-property.galgas", 486)) ;
      var_generatedZone_33__21745.plusAssign_operation(GALGAS_string ("}\n"
        "\n"), inCompiler  COMMA_SOURCE_FILE ("computed-property.galgas", 487)) ;
      var_generatedZone_33__21745.plusAssign_operation(GALGAS_string ("//").add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (8212)), GALGAS_uint ((uint32_t) 118U)  COMMA_SOURCE_FILE ("computed-property.galgas", 488)), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 488)).add_operation (GALGAS_string ("\n"
        "\n"), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 488)), inCompiler  COMMA_SOURCE_FILE ("computed-property.galgas", 488)) ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_fileName_21241, GALGAS_string ("//"), var_header_21362, GALGAS_string ("\n"
        "\n"), var_s_21070, GALGAS_string ("\n"), var_generatedZone_33__21745, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("computed-property.galgas", 489)) ;
      }
    }
  }
}
...
static void extensionMethod_transientDeclarationAST_enterInPrecedenceGraph (const cPtr_abstractDeclarationAST * inObject,
  ...
  GALGAS_lstring var_node_701 = GALGAS_lstring::constructor_new (temp_0.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 16)).add_operation (temp_1.getter_mTransientName (HERE).getter_string (SOURCE_FILE ("transient-property.galgas", 16)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 16)), temp_2.getter_mTransientName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("transient-property.galgas", 16)) ;
  {
  const GALGAS_transientDeclarationAST temp_3 = object ;
  ioArgument_ioGraph.setter_addNode (var_node_701, temp_3, inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 17)) ;
  }
  {
  const GALGAS_transientDeclarationAST temp_4 = object ;
  ioArgument_ioGraph.setter_addEdge (var_node_701, temp_4.getter_mClassName (HERE) COMMA_SOURCE_FILE ("transient-property.galgas", 18)) ;
  }
  {
  const GALGAS_transientDeclarationAST temp_5 = object ;
  ioArgument_ioGraph.setter_addEdge (var_node_701, temp_5.getter_mTransientTypeName (HERE) COMMA_SOURCE_FILE ("transient-property.galgas", 19)) ;
  }
  const GALGAS_transientDeclarationAST temp_6 = object ;
  cEnumerator_observablePropertyList enumerator_973 (temp_6.getter_mDependencyList (HERE), kENUMERATION_UP) ;
  while (enumerator_973.hasCurrentObject ()) {
    switch (enumerator_973.current (HERE).getter_mObservableProperty (HERE).enumValue ()) {
    case GALGAS_observablePropertyAST::kNotBuilt:
      break ;
    case GALGAS_observablePropertyAST::kEnum_rootProperty:
      {
        const cEnumAssociatedValues_observablePropertyAST_rootProperty * extractPtr_1230 = (const cEnumAssociatedValues_observablePropertyAST_rootProperty *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_1230->mAssociatedValue0 ;
        enumGalgasBool test_7 = kBoolTrue ;
        if (kBoolTrue == test_7) {
    ...
    case GALGAS_observablePropertyAST::kEnum_rootPropertyWithOption:
      {
        const cEnumAssociatedValues_observablePropertyAST_rootPropertyWithOption * extractPtr_1454 = (const cEnumAssociatedValues_observablePropertyAST_rootPropertyWithOption *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_1454->mAssociatedValue0 ;
        enumGalgasBool test_10 = kBoolTrue ;
        if (kBoolTrue == test_10) {
    ...
    case GALGAS_observablePropertyAST::kEnum_rootPropertyRelationship:
      {
        const cEnumAssociatedValues_observablePropertyAST_rootPropertyRelationship * extractPtr_1692 = (const cEnumAssociatedValues_observablePropertyAST_rootPropertyRelationship *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_relationshipName = extractPtr_1692->mAssociatedValue0 ;
        enumGalgasBool test_13 = kBoolTrue ;
        if (kBoolTrue == test_13) {
    ...
    case GALGAS_observablePropertyAST::kEnum_rootPropertyNone:
      {
        const cEnumAssociatedValues_observablePropertyAST_rootPropertyNone * extractPtr_1920 = (const cEnumAssociatedValues_observablePropertyAST_rootPropertyNone *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_relationshipName = extractPtr_1920->mAssociatedValue0 ;
        enumGalgasBool test_16 = kBoolTrue ;
        if (kBoolTrue == test_16) {
    ...
    case GALGAS_observablePropertyAST::kEnum_selfProperty:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfProperty * extractPtr_2102 = (const cEnumAssociatedValues_observablePropertyAST_selfProperty *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_2102->mAssociatedValue0 ;
        {
        const GALGAS_transientDeclarationAST temp_19 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_701, GALGAS_lstring::constructor_new (temp_19.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 40)).add_operation (extractedValue_propertyName.getter_string (SOURCE_FILE ("transient-property.galgas", 40)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 40)), extractedValue_propertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("transient-property.galgas", 40)) COMMA_SOURCE_FILE ("transient-property.galgas", 40)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfPropertyWithOption:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfPropertyWithOption * extractPtr_2270 = (const cEnumAssociatedValues_observablePropertyAST_selfPropertyWithOption *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_2270->mAssociatedValue0 ;
        {
        const GALGAS_transientDeclarationAST temp_20 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_701, GALGAS_lstring::constructor_new (temp_20.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 42)).add_operation (extractedValue_propertyName.getter_string (SOURCE_FILE ("transient-property.galgas", 42)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 42)), extractedValue_propertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("transient-property.galgas", 42)) COMMA_SOURCE_FILE ("transient-property.galgas", 42)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfPropertyArray:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfPropertyArray * extractPtr_2433 = (const cEnumAssociatedValues_observablePropertyAST_selfPropertyArray *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_2433->mAssociatedValue0 ;
        {
        const GALGAS_transientDeclarationAST temp_21 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_701, GALGAS_lstring::constructor_new (temp_21.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 44)).add_operation (extractedValue_propertyName.getter_string (SOURCE_FILE ("transient-property.galgas", 44)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 44)), extractedValue_propertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("transient-property.galgas", 44)) COMMA_SOURCE_FILE ("transient-property.galgas", 44)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfPropertyObject:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfPropertyObject * extractPtr_2597 = (const cEnumAssociatedValues_observablePropertyAST_selfPropertyObject *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_2597->mAssociatedValue0 ;
        {
        const GALGAS_transientDeclarationAST temp_22 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_701, GALGAS_lstring::constructor_new (temp_22.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 46)).add_operation (extractedValue_propertyName.getter_string (SOURCE_FILE ("transient-property.galgas", 46)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 46)), extractedValue_propertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("transient-property.galgas", 46)) COMMA_SOURCE_FILE ("transient-property.galgas", 46)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfPropertyNone:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfPropertyNone * extractPtr_2757 = (const cEnumAssociatedValues_observablePropertyAST_selfPropertyNone *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_2757->mAssociatedValue0 ;
        {
        const GALGAS_transientDeclarationAST temp_23 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_701, GALGAS_lstring::constructor_new (temp_23.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 48)).add_operation (extractedValue_propertyName.getter_string (SOURCE_FILE ("transient-property.galgas", 48)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 48)), extractedValue_propertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("transient-property.galgas", 48)) COMMA_SOURCE_FILE ("transient-property.galgas", 48)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_prefsProperty:
      {
        const cEnumAssociatedValues_observablePropertyAST_prefsProperty * extractPtr_2910 = (const cEnumAssociatedValues_observablePropertyAST_prefsProperty *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_2910->mAssociatedValue0 ;
        {
        ioArgument_ioGraph.setter_addEdge (var_node_701, GALGAS_lstring::constructor_new (function_preferencesName (inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 50)).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 50)).add_operation (extractedValue_propertyName.getter_string (SOURCE_FILE ("transient-property.galgas", 50)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 50)), extractedValue_propertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("transient-property.galgas", 50)) COMMA_SOURCE_FILE ("transient-property.galgas", 50)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_prefsPropertyWithOption:
      {
        const cEnumAssociatedValues_observablePropertyAST_prefsPropertyWithOption * extractPtr_3075 = (const cEnumAssociatedValues_observablePropertyAST_prefsPropertyWithOption *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_3075->mAssociatedValue0 ;
        {
    ...
    case GALGAS_observablePropertyAST::kEnum_selfControllerProperty:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfControllerProperty * extractPtr_3268 = (const cEnumAssociatedValues_observablePropertyAST_selfControllerProperty *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_controllerName = extractPtr_3268->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_3268->mAssociatedValue1 ;
        {
        const GALGAS_transientDeclarationAST temp_24 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_701, GALGAS_lstring::constructor_new (temp_24.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 54)).add_operation (extractedValue_controllerName.getter_string (SOURCE_FILE ("transient-property.galgas", 54)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 54)), extractedValue_controllerName.getter_location (HERE)  COMMA_SOURCE_FILE ("transient-property.galgas", 54)) COMMA_SOURCE_FILE ("transient-property.galgas", 54)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfControllerSecondaryProperty:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfControllerSecondaryProperty * extractPtr_3499 = (const cEnumAssociatedValues_observablePropertyAST_selfControllerSecondaryProperty *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_controllerName = extractPtr_3499->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_3499->mAssociatedValue1 ;
        const GALGAS_lstring extractedValue_secondaryPropertyName = extractPtr_3499->mAssociatedValue2 ;
        {
        const GALGAS_transientDeclarationAST temp_25 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_701, GALGAS_lstring::constructor_new (temp_25.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 56)).add_operation (extractedValue_controllerName.getter_string (SOURCE_FILE ("transient-property.galgas", 56)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 56)), extractedValue_controllerName.getter_location (HERE)  COMMA_SOURCE_FILE ("transient-property.galgas", 56)) COMMA_SOURCE_FILE ("transient-property.galgas", 56)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfControllerAllProperties:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfControllerAllProperties * extractPtr_3726 = (const cEnumAssociatedValues_observablePropertyAST_selfControllerAllProperties *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_controllerName = extractPtr_3726->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_3726->mAssociatedValue1 ;
        const GALGAS_lstring extractedValue_secondaryPropertyName = extractPtr_3726->mAssociatedValue2 ;
        {
        const GALGAS_transientDeclarationAST temp_26 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_701, GALGAS_lstring::constructor_new (temp_26.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 58)).add_operation (extractedValue_controllerName.getter_string (SOURCE_FILE ("transient-property.galgas", 58)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 58)), extractedValue_controllerName.getter_location (HERE)  COMMA_SOURCE_FILE ("transient-property.galgas", 58)) COMMA_SOURCE_FILE ("transient-property.galgas", 58)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_selfControllerOneProperty:
      {
        const cEnumAssociatedValues_observablePropertyAST_selfControllerOneProperty * extractPtr_3922 = (const cEnumAssociatedValues_observablePropertyAST_selfControllerOneProperty *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_controllerName = extractPtr_3922->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_3922->mAssociatedValue1 ;
        {
        const GALGAS_transientDeclarationAST temp_27 = object ;
        ioArgument_ioGraph.setter_addEdge (var_node_701, GALGAS_lstring::constructor_new (temp_27.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 60)).add_operation (extractedValue_controllerName.getter_string (SOURCE_FILE ("transient-property.galgas", 60)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 60)), extractedValue_controllerName.getter_location (HERE)  COMMA_SOURCE_FILE ("transient-property.galgas", 60)) COMMA_SOURCE_FILE ("transient-property.galgas", 60)) ;
        }
      }
      break ;
    case GALGAS_observablePropertyAST::kEnum_signatureProperty:
    ...
    case GALGAS_observablePropertyAST::kEnum_superProperty:
      {
        const cEnumAssociatedValues_observablePropertyAST_superProperty * extractPtr_4211 = (const cEnumAssociatedValues_observablePropertyAST_superProperty *) (enumerator_973.current (HERE).getter_mObservableProperty (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_superEntityName = extractPtr_4211->mAssociatedValue0 ;
        const GALGAS_lstring extractedValue_propertyName = extractPtr_4211->mAssociatedValue1 ;
        {
        ioArgument_ioGraph.setter_addEdge (var_node_701, GALGAS_lstring::constructor_new (extractedValue_superEntityName.getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 65)).add_operation (extractedValue_propertyName.getter_string (SOURCE_FILE ("transient-property.galgas", 65)), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 65)), extractedValue_propertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("transient-property.galgas", 65)) COMMA_SOURCE_FILE ("transient-property.galgas", 65)) ;
        }
      }
      break ;
    }
    enumerator_973.gotoNextObject () ;
  }
}
...
static void extensionMethod_transientDeclarationAST_firstAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_transientDeclarationAST) ;
  const GALGAS_transientDeclarationAST temp_0 = object ;
  cMapElement_classMap * objectArray_6880 = (cMapElement_classMap *) ioArgument_ioSemanticContext.mProperty_mClassMap.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, temp_0.getter_mClassName (HERE), kSearchErrorMessage_classMap_searchKey  COMMA_SOURCE_FILE ("transient-property.galgas", 149)) ;
  if (NULL != objectArray_6880) {
    macroValidSharedObject (objectArray_6880, cMapElement_classMap) ;
    GALGAS_classKind var_classKind_7046 ;
    const GALGAS_transientDeclarationAST temp_1 = object ;
    GALGAS_propertyMap joker_7048_3 ; // Joker input parameter
    GALGAS_actionMap joker_7048_2 ; // Joker input parameter
    GALGAS_propertyGenerationList joker_7048_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_1.getter_mTransientTypeName (HERE), var_classKind_7046, joker_7048_3, joker_7048_2, joker_7048_1, inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 152)) ;
    switch (var_classKind_7046.enumValue ()) {
    case GALGAS_classKind::kNotBuilt:
      break ;
    case GALGAS_classKind::kEnum_prefs:
      {
...
static void extensionMethod_transientDeclarationAST_thirdAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_transientDeclarationAST * object = (const cPtr_transientDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_transientDeclarationAST) ;
  GALGAS_classKind var_classKind_8130 ;
  const GALGAS_transientDeclarationAST temp_0 = object ;
  GALGAS_propertyMap joker_8132_3 ; // Joker input parameter
  GALGAS_actionMap joker_8132_2 ; // Joker input parameter
  GALGAS_propertyGenerationList joker_8132_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_0.getter_mTransientTypeName (HERE), var_classKind_8130, joker_8132_3, joker_8132_2, joker_8132_1, inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 180)) ;
  GALGAS_typeKind var_typeKind_8172 ;
  switch (var_classKind_8130.enumValue ()) {
  case GALGAS_classKind::kNotBuilt:
    break ;
  case GALGAS_classKind::kEnum_prefs:
    {
      ...
      var_typeKind_8172.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_classKind::kEnum_atomic:
    {
      const cEnumAssociatedValues_classKind_atomic * extractPtr_8340 = (const cEnumAssociatedValues_classKind_atomic *) (var_classKind_8130.unsafePointer ()) ;
      const GALGAS_typeKind extractedValue_kind = extractPtr_8340->mAssociatedValue0 ;
      var_typeKind_8172 = extractedValue_kind ;
    }
    break ;
  case GALGAS_classKind::kEnum_document:
    {
  ...
  GALGAS_propertyMap var_rootProperties_8602 ;
  enumGalgasBool test_7 = kBoolTrue ;
  if (kBoolTrue == test_7) {
    const GALGAS_transientDeclarationAST temp_8 = object ;
    test_7 = GALGAS_bool (kIsEqual, temp_8.getter_mRootEntityName (HERE).getter_string (HERE).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_7) {
      var_rootProperties_8602 = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE ("transient-property.galgas", 196)) ;
    }
  }
  if (kBoolFalse == test_7) {
    const GALGAS_transientDeclarationAST temp_9 = object ;
    GALGAS_classKind joker_8744 ; // Joker input parameter
    GALGAS_actionMap joker_8763_2 ; // Joker input parameter
    GALGAS_propertyGenerationList joker_8763_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_9.getter_mRootEntityName (HERE), joker_8744, var_rootProperties_8602, joker_8763_2, joker_8763_1, inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 198)) ;
  }
  GALGAS_classKind var_currentClassKind_8882 ;
  GALGAS_propertyMap var_properties_8898 ;
  const GALGAS_transientDeclarationAST temp_10 = object ;
  GALGAS_actionMap joker_8900_2 ; // Joker input parameter
  GALGAS_propertyGenerationList joker_8900_1 ; // Joker input parameter
  ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_10.getter_mClassName (HERE), var_currentClassKind_8882, var_properties_8898, joker_8900_2, joker_8900_1, inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 201)) ;
  GALGAS_transientDependencyListForGeneration var_dependencies_8987 = GALGAS_transientDependencyListForGeneration::constructor_emptyList (SOURCE_FILE ("transient-property.galgas", 203)) ;
  const GALGAS_transientDeclarationAST temp_11 = object ;
  cEnumerator_observablePropertyList enumerator_9025 (temp_11.getter_mDependencyList (HERE), kENUMERATION_UP) ;
  while (enumerator_9025.hasCurrentObject ()) {
    ...
    extensionMethod_analyzeObservableProperty (enumerator_9025.current_mObservableProperty (HERE), var_rootProperties_8602, ioArgument_ioSemanticContext, var_properties_8898, var_dependencyKind_9184, var_swiftTypeStringForTransientFunctionArgument_9247, inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 205)) ;
    ...
    case GALGAS_propertyKind::kEnum_arrayController:
      {
        TC_Array <C_FixItDescription> fixItArray12 ;
        inCompiler->emitSemanticError (extensionGetter_location (enumerator_9025.current_mObservableProperty (HERE), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 217)), GALGAS_string ("only an atomic property can be observed"), fixItArray12  COMMA_SOURCE_FILE ("transient-property.galgas", 217)) ;
      }
      break ;
    case GALGAS_propertyKind::kEnum_selectionController:
      {
        TC_Array <C_FixItDescription> fixItArray13 ;
        inCompiler->emitSemanticError (extensionGetter_location (enumerator_9025.current_mObservableProperty (HERE), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 219)), GALGAS_string ("only an atomic property can be observed"), fixItArray13  COMMA_SOURCE_FILE ("transient-property.galgas", 219)) ;
      }
      break ;
    }
    var_dependencies_8987.addAssign_operation (enumerator_9025.current_mObservableProperty (HERE), extensionGetter_modelStringFunctionArgument (enumerator_9025.current_mObservableProperty (HERE), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 223)), var_swiftTypeStringForTransientFunctionArgument_9247  COMMA_SOURCE_FILE ("transient-property.galgas", 221)) ;
    enumerator_9025.gotoNextObject () ;
  }
  const GALGAS_transientDeclarationAST temp_14 = object ;
  const GALGAS_transientDeclarationAST temp_15 = object ;
  ioArgument_ioGeneration.mProperty_mFileGenerationList.addAssign_operation (GALGAS_transientRoutineGeneration::constructor_new (temp_14.getter_mClassName (HERE).getter_string (SOURCE_FILE ("transient-property.galgas", 227)), temp_15.getter_mTransientName (HERE).getter_string (HERE), var_typeKind_8172, GALGAS_string ("transient"), var_dependencies_8987  COMMA_SOURCE_FILE ("transient-property.galgas", 226))  COMMA_SOURCE_FILE ("transient-property.galgas", 226)) ;
  const GALGAS_transientDeclarationAST temp_16 = object ;
  cMapElement_classMap * objectArray_9946 = (cMapElement_classMap *) ioArgument_ioSemanticContext.mProperty_mClassMap.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, temp_16.getter_mClassName (HERE), kSearchErrorMessage_classMap_searchKey  COMMA_SOURCE_FILE ("transient-property.galgas", 233)) ;
  if (NULL != objectArray_9946) {
    macroValidSharedObject (objectArray_9946, cMapElement_classMap) ;
    GALGAS_bool var_generate_10048 ;
    switch (var_currentClassKind_8882.enumValue ()) {
    case GALGAS_classKind::kNotBuilt:
      break ;
    case GALGAS_classKind::kEnum_prefs:
      {
    ...
    case GALGAS_classKind::kEnum_entity:
      {
        const cEnumAssociatedValues_classKind_entity * extractPtr_10423 = (const cEnumAssociatedValues_classKind_entity *) (var_currentClassKind_8882.unsafePointer ()) ;
        const GALGAS_bool extractedValue_graphic = extractPtr_10423->mAssociatedValue1 ;
        enumGalgasBool test_17 = kBoolTrue ;
        if (kBoolTrue == test_17) {
    ...
    const GALGAS_transientDeclarationAST temp_20 = object ;
    const GALGAS_transientDeclarationAST temp_21 = object ;
    objectArray_9946->mProperty_mPropertyGenerationList.addAssign_operation (GALGAS_transientPropertyGeneration::constructor_new (temp_20.getter_mTransientName (HERE).getter_string (HERE), temp_21.getter_mClassName (HERE).getter_string (HERE), var_typeKind_8172, var_dependencies_8987, var_generate_10048  COMMA_SOURCE_FILE ("transient-property.galgas", 251))  COMMA_SOURCE_FILE ("transient-property.galgas", 251)) ;
  }
}
...
static GALGAS_string extensionGetter_transientPropertyGeneration_configurationCode (const cPtr_propertyGeneration * inObject,
  ...
  GALGAS_string var_prefix_16602 = temp_0 ;
  result_result = GALGAS_string::makeEmptyString () ;
  enumGalgasBool test_2 = kBoolTrue ;
  if (kBoolTrue == test_2) {
    const GALGAS_transientPropertyGeneration temp_3 = object ;
    ...
    if (kBoolTrue == test_2) {
      const GALGAS_transientPropertyGeneration temp_4 = object ;
      GALGAS_bool var_needs_5F_unwSelf_16739 = extensionGetter_needs_5F_unwSelf (temp_4.getter_mDependencyList (HERE), constinArgument_inPreferences, inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 382)) ;
      const GALGAS_transientPropertyGeneration temp_5 = object ;
      ...
      const GALGAS_transientPropertyGeneration temp_15 = object ;
      cEnumerator_transientDependencyListForGeneration enumerator_17583 (temp_15.getter_mDependencyList (HERE), kENUMERATION_UP) ;
      while (enumerator_17583.hasCurrentObject ()) {
        GALGAS_string var_s_17598 = extensionGetter_generateAddObserverCall (enumerator_17583.current_mDependency (HERE), constinArgument_inPreferences, inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 397)) ;
        enumGalgasBool test_16 = kBoolTrue ;
        if (kBoolTrue == test_16) {
          test_16 = GALGAS_bool (kIsNotEqual, var_s_17598.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
          if (kBoolTrue == test_16) {
            const GALGAS_transientPropertyGeneration temp_17 = object ;
            result_result.plusAssign_operation(GALGAS_string ("    ").add_operation (var_s_17598, inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 399)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 399)).add_operation (var_prefix_16602, inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 399)).add_operation (temp_17.getter_mPropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 399)).add_operation (GALGAS_string ("_property)\n"), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 399)), inCompiler  COMMA_SOURCE_FILE ("transient-property.galgas", 399)) ;
          }
        }
...
static GALGAS_string extensionGetter_transientPropertyGeneration_terminationCode (const cPtr_propertyGeneration * inObject,
  ...
  result_result = GALGAS_string::makeEmptyString () ;
  const GALGAS_transientPropertyGeneration temp_0 = object ;
  cEnumerator_transientDependencyListForGeneration enumerator_18060 (temp_0.getter_mDependencyList (HERE), kENUMERATION_UP) ;
  while (enumerator_18060.hasCurrentObject ()) {
    GALGAS_string var_s_18073 = extensionGetter_generateRemoveObserverCall (enumerator_18060.current_mDependency (HERE), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 410)) ;
    enumGalgasBool test_1 = kBoolTrue ;
    if (kBoolTrue == test_1) {
      test_1 = GALGAS_bool (kIsNotEqual, var_s_18073.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_1) {
        const GALGAS_transientPropertyGeneration temp_2 = object ;
        result_result.plusAssign_operation(GALGAS_string ("    // ").add_operation (var_s_18073, inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 412)).add_operation (GALGAS_string (" (self."), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 412)).add_operation (temp_2.getter_mPropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 412)).add_operation (GALGAS_string ("_property)\n"), inCompiler COMMA_SOURCE_FILE ("transient-property.galgas", 412)), inCompiler  COMMA_SOURCE_FILE ("transient-property.galgas", 412)) ;
      }
    }
...
static void extensionMethod_proxyDeclarationAST_enterInPrecedenceGraph (const cPtr_abstractDeclarationAST * inObject,
  ...
  GALGAS_lstring var_node_857 = GALGAS_lstring::constructor_new (temp_0.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("proxy.galgas", 23)).add_operation (temp_1.getter_mProxyName (HERE).getter_string (SOURCE_FILE ("proxy.galgas", 23)), inCompiler COMMA_SOURCE_FILE ("proxy.galgas", 23)), temp_2.getter_mProxyName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("proxy.galgas", 23)) ;
  {
  const GALGAS_proxyDeclarationAST temp_3 = object ;
  ioArgument_ioGraph.setter_addNode (var_node_857, temp_3, inCompiler COMMA_SOURCE_FILE ("proxy.galgas", 24)) ;
  }
  {
  const GALGAS_proxyDeclarationAST temp_4 = object ;
  ioArgument_ioGraph.setter_addEdge (var_node_857, temp_4.getter_mClassName (HERE) COMMA_SOURCE_FILE ("proxy.galgas", 25)) ;
  }
  {
  const GALGAS_proxyDeclarationAST temp_5 = object ;
  ioArgument_ioGraph.setter_addEdge (var_node_857, temp_5.getter_mProxyTypeName (HERE) COMMA_SOURCE_FILE ("proxy.galgas", 26)) ;
  }
}
...
static void extensionMethod_proxyDeclarationAST_firstAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_proxyDeclarationAST) ;
  const GALGAS_proxyDeclarationAST temp_0 = object ;
  cMapElement_classMap * objectArray_3253 = (cMapElement_classMap *) ioArgument_ioSemanticContext.mProperty_mClassMap.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, temp_0.getter_mClassName (HERE), kSearchErrorMessage_classMap_searchKey  COMMA_SOURCE_FILE ("proxy.galgas", 88)) ;
  if (NULL != objectArray_3253) {
    macroValidSharedObject (objectArray_3253, cMapElement_classMap) ;
    GALGAS_classKind var_proxyKind_3415 ;
    const GALGAS_proxyDeclarationAST temp_1 = object ;
    GALGAS_propertyMap joker_3417_3 ; // Joker input parameter
    GALGAS_actionMap joker_3417_2 ; // Joker input parameter
    GALGAS_propertyGenerationList joker_3417_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_1.getter_mProxyTypeName (HERE), var_proxyKind_3415, joker_3417_3, joker_3417_2, joker_3417_1, inCompiler COMMA_SOURCE_FILE ("proxy.galgas", 91)) ;
    switch (var_proxyKind_3415.enumValue ()) {
    case GALGAS_classKind::kNotBuilt:
      break ;
    case GALGAS_classKind::kEnum_prefs:
      {
    ...
    case GALGAS_classKind::kEnum_entity:
      {
        const cEnumAssociatedValues_classKind_entity * extractPtr_3961 = (const cEnumAssociatedValues_classKind_entity *) (var_proxyKind_3415.unsafePointer ()) ;
        const GALGAS_bool extractedValue_isGraphic = extractPtr_3961->mAssociatedValue1 ;
        const GALGAS_proxyDeclarationAST temp_4 = object ;
        ...
        case GALGAS_proxyKind::kEnum_toManyProxy:
          {
            const GALGAS_proxyDeclarationAST temp_5 = object ;
            GALGAS_propertyKind var_k_3633 = GALGAS_propertyKind::constructor_toMany (temp_5.getter_mProxyTypeName (HERE), GALGAS_propertyAccessibility::constructor_stored (SOURCE_FILE ("proxy.galgas", 100)), extractedValue_isGraphic, GALGAS_toManyRelationshipOptionAST::constructor_none (SOURCE_FILE ("proxy.galgas", 102))  COMMA_SOURCE_FILE ("proxy.galgas", 98)) ;
            {
            const GALGAS_proxyDeclarationAST temp_6 = object ;
            objectArray_3253->mProperty_mPropertyMap.setter_insertKey (temp_6.getter_mProxyName (HERE), var_k_3633, GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE ("proxy.galgas", 104)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("proxy.galgas", 104)) ;
            }
          }
          break ;
...
static void extensionMethod_proxyDeclarationAST_secondAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_proxyDeclarationAST) ;
  const GALGAS_proxyDeclarationAST temp_0 = object ;
  cMapElement_classMap * objectArray_4484 = (cMapElement_classMap *) ioArgument_ioSemanticContext.mProperty_mClassMap.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, temp_0.getter_mClassName (HERE), kSearchErrorMessage_classMap_searchKey  COMMA_SOURCE_FILE ("proxy.galgas", 122)) ;
  if (NULL != objectArray_4484) {
    macroValidSharedObject (objectArray_4484, cMapElement_classMap) ;
    GALGAS_propertyKind var_relationshipKind_4646 ;
    const GALGAS_proxyDeclarationAST temp_1 = object ;
    GALGAS_actionMap joker_4648_2 ; // Joker input parameter
    GALGAS_bool joker_4648_1 ; // Joker input parameter
    objectArray_4484->mProperty_mPropertyMap.method_searchKey (temp_1.getter_mToOneRelationshipName (HERE), var_relationshipKind_4646, joker_4648_2, joker_4648_1, inCompiler COMMA_SOURCE_FILE ("proxy.galgas", 125)) ;
    switch (var_relationshipKind_4646.enumValue ()) {
    case GALGAS_propertyKind::kNotBuilt:
      break ;
    case GALGAS_propertyKind::kEnum_arrayController:
      {
    ...
    case GALGAS_propertyKind::kEnum_toOne:
      {
        const cEnumAssociatedValues_propertyKind_toOne * extractPtr_7082 = (const cEnumAssociatedValues_propertyKind_toOne *) (var_relationshipKind_4646.unsafePointer ()) ;
        const GALGAS_lstring extractedValue_toOneTypeName = extractPtr_7082->mAssociatedValue0 ;
        GALGAS_propertyMap var_propertyMap_5238 ;
        GALGAS_classKind joker_5220 ; // Joker input parameter
        GALGAS_actionMap joker_5240_2 ; // Joker input parameter
        GALGAS_propertyGenerationList joker_5240_1 ; // Joker input parameter
        ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (extractedValue_toOneTypeName, joker_5220, var_propertyMap_5238, joker_5240_2, joker_5240_1, inCompiler COMMA_SOURCE_FILE ("proxy.galgas", 136)) ;
        GALGAS_propertyKind var_propertyKind_5310 ;
        ...
        var_propertyMap_5238.method_searchKey (temp_10.getter_mPropertyName (HERE), var_propertyKind_5310, joker_5312_2, joker_5312_1, inCompiler COMMA_SOURCE_FILE ("proxy.galgas", 137)) ;
        switch (var_propertyKind_5310.enumValue ()) {
        case GALGAS_propertyKind::kNotBuilt:
          break ;
        case GALGAS_propertyKind::kEnum_property:
          {
            const cEnumAssociatedValues_propertyKind_property * extractPtr_5753 = (const cEnumAssociatedValues_propertyKind_property *) (var_propertyKind_5310.unsafePointer ()) ;
            const GALGAS_typeKind extractedValue_propertyType = extractPtr_5753->mAssociatedValue0 ;
            const GALGAS_proxyDeclarationAST temp_11 = object ;
        ...
        case GALGAS_propertyKind::kEnum_toMany:
          {
            const cEnumAssociatedValues_propertyKind_toMany * extractPtr_6233 = (const cEnumAssociatedValues_propertyKind_toMany *) (var_propertyKind_5310.unsafePointer ()) ;
            const GALGAS_lstring extractedValue_toManyTypeName = extractPtr_6233->mAssociatedValue0 ;
            GALGAS_classKind joker_5858_4 ; // Joker input parameter
            GALGAS_propertyMap joker_5858_3 ; // Joker input parameter
            GALGAS_actionMap joker_5858_2 ; // Joker input parameter
            GALGAS_propertyGenerationList joker_5858_1 ; // Joker input parameter
            ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (extractedValue_toManyTypeName, joker_5858_4, joker_5858_3, joker_5858_2, joker_5858_1, inCompiler COMMA_SOURCE_FILE ("proxy.galgas", 151)) ;
...
static void extensionMethod_atomicPropertyDeclarationAST_firstAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_atomicPropertyDeclarationAST) ;
  const GALGAS_atomicPropertyDeclarationAST temp_0 = object ;
  cMapElement_classMap * objectArray_4006 = (cMapElement_classMap *) ioArgument_ioSemanticContext.mProperty_mClassMap.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, temp_0.getter_mClassName (HERE), kSearchErrorMessage_classMap_searchKey  COMMA_SOURCE_FILE ("simple-stored-property.galgas", 106)) ;
  if (NULL != objectArray_4006) {
    macroValidSharedObject (objectArray_4006, cMapElement_classMap) ;
    GALGAS_classKind var_classKind_4171 ;
    const GALGAS_atomicPropertyDeclarationAST temp_1 = object ;
    GALGAS_propertyMap joker_4173_3 ; // Joker input parameter
    GALGAS_actionMap joker_4173_2 ; // Joker input parameter
    GALGAS_propertyGenerationList joker_4173_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_1.getter_mPropertyTypeName (HERE), var_classKind_4171, joker_4173_3, joker_4173_2, joker_4173_1, inCompiler COMMA_SOURCE_FILE ("simple-stored-property.galgas", 109)) ;
    GALGAS_propertyMap var_preferencesPropertyMap_4306 ;
    GALGAS_classKind joker_4271 ; // Joker input parameter
    GALGAS_actionMap joker_4314_2 ; // Joker input parameter
    GALGAS_propertyGenerationList joker_4314_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (GALGAS_lstring::constructor_new (function_preferencesName (inCompiler COMMA_SOURCE_FILE ("simple-stored-property.galgas", 111)), GALGAS_location::constructor_nowhere (SOURCE_FILE ("simple-stored-property.galgas", 111))  COMMA_SOURCE_FILE ("simple-stored-property.galgas", 111)), joker_4271, var_preferencesPropertyMap_4306, joker_4314_2, joker_4314_1, inCompiler COMMA_SOURCE_FILE ("simple-stored-property.galgas", 110)) ;
    switch (var_classKind_4171.enumValue ()) {
    case GALGAS_classKind::kNotBuilt:
      break ;
    case GALGAS_classKind::kEnum_prefs:
      {
    ...
    case GALGAS_classKind::kEnum_atomic:
      {
        const cEnumAssociatedValues_classKind_atomic * extractPtr_5241 = (const cEnumAssociatedValues_classKind_atomic *) (var_classKind_4171.unsafePointer ()) ;
        const GALGAS_typeKind extractedValue_kind = extractPtr_5241->mAssociatedValue0 ;
        {
        const GALGAS_atomicPropertyDeclarationAST temp_4 = object ;
        objectArray_4006->mProperty_mPropertyMap.setter_insertKey (temp_4.getter_mPropertyName (HERE), GALGAS_propertyKind::constructor_property (extractedValue_kind, GALGAS_propertyAccessibility::constructor_stored (SOURCE_FILE ("simple-stored-property.galgas", 120))  COMMA_SOURCE_FILE ("simple-stored-property.galgas", 120)), GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE ("simple-stored-property.galgas", 120)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("simple-stored-property.galgas", 120)) ;
        }
        GALGAS_string var_swiftDefaultValueAsString_4723 ;
        const GALGAS_atomicPropertyDeclarationAST temp_5 = object ;
        ...
        callExtensionMethod_analyzeDefaultValueType ((const cPtr_abstractDefaultValue *) temp_5.getter_mDefaultValue (HERE).ptr (), temp_6, var_preferencesPropertyMap_4306, var_swiftDefaultValueAsString_4723, inCompiler COMMA_SOURCE_FILE ("simple-stored-property.galgas", 122)) ;
        ...
        objectArray_4006->mProperty_mPropertyGenerationList.addAssign_operation (GALGAS_atomicPropertyGeneration::constructor_new (temp_7.getter_mPropertyName (HERE).getter_string (HERE), temp_8.getter_mNeedsValidation (HERE), extractedValue_kind, GALGAS_bool (false), var_swiftDefaultValueAsString_4723, GALGAS_bool (kIsEqual, temp_9.getter_mClassName (HERE).getter_string (HERE).objectCompare (function_preferencesName (inCompiler COMMA_SOURCE_FILE ("simple-stored-property.galgas", 130))))  COMMA_SOURCE_FILE ("simple-stored-property.galgas", 124))  COMMA_SOURCE_FILE ("simple-stored-property.galgas", 124)) ;
        enumGalgasBool test_10 = kBoolTrue ;
        if (kBoolTrue == test_10) {
...
static void extensionMethod_toOneRelationshipAST_enterInPrecedenceGraph (const cPtr_abstractDeclarationAST * inObject,
  ...
  GALGAS_lstring var_node_971 = GALGAS_lstring::constructor_new (temp_0.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("to-one-relationship.galgas", 23)).add_operation (temp_1.getter_mToOneRelationshipName (HERE).getter_string (SOURCE_FILE ("to-one-relationship.galgas", 23)), inCompiler COMMA_SOURCE_FILE ("to-one-relationship.galgas", 23)), temp_2.getter_mToOneRelationshipName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("to-one-relationship.galgas", 23)) ;
  {
  const GALGAS_toOneRelationshipAST temp_3 = object ;
  ioArgument_ioGraph.setter_addNode (var_node_971, temp_3, inCompiler COMMA_SOURCE_FILE ("to-one-relationship.galgas", 24)) ;
  }
  {
  const GALGAS_toOneRelationshipAST temp_4 = object ;
  ioArgument_ioGraph.setter_addEdge (var_node_971, temp_4.getter_mClassName (HERE) COMMA_SOURCE_FILE ("to-one-relationship.galgas", 25)) ;
  }
  {
  const GALGAS_toOneRelationshipAST temp_5 = object ;
  ioArgument_ioGraph.setter_addEdge (var_node_971, temp_5.getter_mDestinationEntityName (HERE) COMMA_SOURCE_FILE ("to-one-relationship.galgas", 26)) ;
  }
}
...
static void extensionMethod_toOneRelationshipAST_firstAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_toOneRelationshipAST) ;
  const GALGAS_toOneRelationshipAST temp_0 = object ;
  cMapElement_classMap * objectArray_3800 = (cMapElement_classMap *) ioArgument_ioSemanticContext.mProperty_mClassMap.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, temp_0.getter_mClassName (HERE), kSearchErrorMessage_classMap_searchKey  COMMA_SOURCE_FILE ("to-one-relationship.galgas", 97)) ;
  if (NULL != objectArray_3800) {
    macroValidSharedObject (objectArray_3800, cMapElement_classMap) ;
    GALGAS_classKind var_classKind_3970 ;
    const GALGAS_toOneRelationshipAST temp_1 = object ;
    GALGAS_propertyMap joker_3972_3 ; // Joker input parameter
    GALGAS_actionMap joker_3972_2 ; // Joker input parameter
    GALGAS_propertyGenerationList joker_3972_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_1.getter_mDestinationEntityName (HERE), var_classKind_3970, joker_3972_3, joker_3972_2, joker_3972_1, inCompiler COMMA_SOURCE_FILE ("to-one-relationship.galgas", 100)) ;
    switch (var_classKind_3970.enumValue ()) {
    case GALGAS_classKind::kNotBuilt:
      break ;
    case GALGAS_classKind::kEnum_prefs:
      {
    ...
    case GALGAS_classKind::kEnum_entity:
      {
        const cEnumAssociatedValues_classKind_entity * extractPtr_4569 = (const cEnumAssociatedValues_classKind_entity *) (var_classKind_3970.unsafePointer ()) ;
        const GALGAS_bool extractedValue_graphic = extractPtr_4569->mAssociatedValue1 ;
        const GALGAS_toOneRelationshipAST temp_8 = object ;
        const GALGAS_toOneRelationshipAST temp_9 = object ;
        GALGAS_propertyKind var_kind_4319 = GALGAS_propertyKind::constructor_toOne (temp_8.getter_mDestinationEntityName (HERE), GALGAS_propertyAccessibility::constructor_stored (SOURCE_FILE ("to-one-relationship.galgas", 111)), extractedValue_graphic, temp_9.getter_mOpposite (HERE)  COMMA_SOURCE_FILE ("to-one-relationship.galgas", 109)) ;
        {
        const GALGAS_toOneRelationshipAST temp_10 = object ;
        objectArray_3800->mProperty_mPropertyMap.setter_insertKey (temp_10.getter_mToOneRelationshipName (HERE), var_kind_4319, GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE ("to-one-relationship.galgas", 115)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("to-one-relationship.galgas", 115)) ;
        }
      }
      break ;
    }
...
static void extensionMethod_toOneRelationshipAST_thirdAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_toOneRelationshipAST) ;
  const GALGAS_toOneRelationshipAST temp_0 = object ;
  cMapElement_classMap * objectArray_4866 = (cMapElement_classMap *) ioArgument_ioSemanticContext.mProperty_mClassMap.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, temp_0.getter_mClassName (HERE), kSearchErrorMessage_classMap_searchKey  COMMA_SOURCE_FILE ("to-one-relationship.galgas", 126)) ;
  if (NULL != objectArray_4866) {
    macroValidSharedObject (objectArray_4866, cMapElement_classMap) ;
    GALGAS_classKind var_classKind_5036 ;
    GALGAS_propertyMap var_destinationEntityPropertyMap_5070 ;
    const GALGAS_toOneRelationshipAST temp_1 = object ;
    GALGAS_actionMap joker_5072_2 ; // Joker input parameter
    GALGAS_propertyGenerationList joker_5072_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_1.getter_mDestinationEntityName (HERE), var_classKind_5036, var_destinationEntityPropertyMap_5070, joker_5072_2, joker_5072_1, inCompiler COMMA_SOURCE_FILE ("to-one-relationship.galgas", 129)) ;
    switch (var_classKind_5036.enumValue ()) {
    case GALGAS_classKind::kNotBuilt:
      break ;
    case GALGAS_classKind::kEnum_prefs:
      {
    ...
    case GALGAS_classKind::kEnum_entity:
      {
        const cEnumAssociatedValues_classKind_entity * extractPtr_5652 = (const cEnumAssociatedValues_classKind_entity *) (var_classKind_5036.unsafePointer ()) ;
        const GALGAS_bool extractedValue_graphic = extractPtr_5652->mAssociatedValue1 ;
        const GALGAS_toOneRelationshipAST temp_2 = object ;
        const GALGAS_toOneRelationshipAST temp_3 = object ;
        GALGAS_propertyKind var_kind_5206 = GALGAS_propertyKind::constructor_toOne (temp_2.getter_mDestinationEntityName (HERE), GALGAS_propertyAccessibility::constructor_stored (SOURCE_FILE ("to-one-relationship.galgas", 137)), extractedValue_graphic, temp_3.getter_mOpposite (HERE)  COMMA_SOURCE_FILE ("to-one-relationship.galgas", 135)) ;
        const GALGAS_toOneRelationshipAST temp_4 = object ;
        const GALGAS_toOneRelationshipAST temp_5 = object ;
        const GALGAS_toOneRelationshipAST temp_6 = object ;
        const GALGAS_toOneRelationshipAST temp_7 = object ;
        objectArray_4866->mProperty_mPropertyGenerationList.addAssign_operation (GALGAS_toOnePropertyGeneration::constructor_new (temp_4.getter_mToOneRelationshipName (HERE).getter_string (HERE), temp_5.getter_mClassName (HERE).getter_string (SOURCE_FILE ("to-one-relationship.galgas", 144)), var_kind_5206, temp_6.getter_mOpposite (HERE), var_destinationEntityPropertyMap_5070, temp_7.getter_mUsedForSignature (HERE)  COMMA_SOURCE_FILE ("to-one-relationship.galgas", 142))  COMMA_SOURCE_FILE ("to-one-relationship.galgas", 142)) ;
      }
      break ;
    }
  }
...
static GALGAS_string extensionGetter_toOnePropertyGeneration_configurationCode (const cPtr_propertyGeneration * inObject,
  ...
  case GALGAS_toOneOppositeRelationship::kEnum_oppositeIsToMany:
    {
      const cEnumAssociatedValues_toOneOppositeRelationship_oppositeIsToMany * extractPtr_9120 = (const cEnumAssociatedValues_toOneOppositeRelationship_oppositeIsToMany *) (temp_0.getter_mOpposite (HERE).unsafePointer ()) ;
      const GALGAS_lstring extractedValue_oppositeName = extractPtr_9120->mAssociatedValue0 ;
      const GALGAS_toOnePropertyGeneration temp_1 = object ;
  ...
  case GALGAS_toOneOppositeRelationship::kEnum_oppositeIsToOne:
    {
      const cEnumAssociatedValues_toOneOppositeRelationship_oppositeIsToOne * extractPtr_9926 = (const cEnumAssociatedValues_toOneOppositeRelationship_oppositeIsToOne *) (temp_0.getter_mOpposite (HERE).unsafePointer ()) ;
      const GALGAS_lstring extractedValue_oppositeName = extractPtr_9926->mAssociatedValue0 ;
      const GALGAS_toOnePropertyGeneration temp_6 = object ;
...
static GALGAS_string extensionGetter_toOnePropertyGeneration_saveIntoDictionaryCode (const cPtr_propertyGeneration * inObject,
  ...
  case GALGAS_toOneOppositeRelationship::kEnum_oppositeIsToOne:
    {
      const cEnumAssociatedValues_toOneOppositeRelationship_oppositeIsToOne * extractPtr_11811 = (const cEnumAssociatedValues_toOneOppositeRelationship_oppositeIsToOne *) (temp_0.getter_mOpposite (HERE).unsafePointer ()) ;
      const GALGAS_lstring extractedValue_oppositeName = extractPtr_11811->mAssociatedValue0 ;
      const GALGAS_toOnePropertyGeneration temp_4 = object ;
...
static void extensionMethod_toManyRelationshipAST_enterInPrecedenceGraph (const cPtr_abstractDeclarationAST * inObject,
  ...
  GALGAS_lstring var_node_972 = GALGAS_lstring::constructor_new (temp_0.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 24)).add_operation (temp_1.getter_mToManyRelationshipName (HERE).getter_string (SOURCE_FILE ("to-many-relationship.galgas", 24)), inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 24)), temp_2.getter_mToManyRelationshipName (HERE).getter_location (HERE)  COMMA_SOURCE_FILE ("to-many-relationship.galgas", 24)) ;
  {
  const GALGAS_toManyRelationshipAST temp_3 = object ;
  ioArgument_ioGraph.setter_addNode (var_node_972, temp_3, inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 25)) ;
  }
  {
  const GALGAS_toManyRelationshipAST temp_4 = object ;
  ioArgument_ioGraph.setter_addEdge (var_node_972, temp_4.getter_mClassName (HERE) COMMA_SOURCE_FILE ("to-many-relationship.galgas", 26)) ;
  }
  {
  const GALGAS_toManyRelationshipAST temp_5 = object ;
  ioArgument_ioGraph.setter_addEdge (var_node_972, temp_5.getter_mDestinationEntityName (HERE) COMMA_SOURCE_FILE ("to-many-relationship.galgas", 27)) ;
  }
  ...
  case GALGAS_toManyRelationshipOptionAST::kEnum_hasDependance:
    {
      const cEnumAssociatedValues_toManyRelationshipOptionAST_hasDependance * extractPtr_1457 = (const cEnumAssociatedValues_toManyRelationshipOptionAST_hasDependance *) (temp_6.getter_mOption (HERE).unsafePointer ()) ;
      const GALGAS_lstring extractedValue_masterPropertyName = extractPtr_1457->mAssociatedValue0 ;
      const GALGAS_toManyRelationshipAST temp_7 = object ;
      GALGAS_lstring var_dependanceNode_1314 = GALGAS_lstring::constructor_new (temp_7.getter_mClassName (HERE).getter_string (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 30)).add_operation (extractedValue_masterPropertyName.getter_string (SOURCE_FILE ("to-many-relationship.galgas", 30)), inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 30)), extractedValue_masterPropertyName.getter_location (HERE)  COMMA_SOURCE_FILE ("to-many-relationship.galgas", 30)) ;
      {
      ioArgument_ioGraph.setter_addEdge (var_node_972, var_dependanceNode_1314 COMMA_SOURCE_FILE ("to-many-relationship.galgas", 31)) ;
      }
    }
    break ;
...
static void extensionMethod_toManyRelationshipAST_firstAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_toManyRelationshipAST) ;
  const GALGAS_toManyRelationshipAST temp_0 = object ;
  cMapElement_classMap * objectArray_4546 = (cMapElement_classMap *) ioArgument_ioSemanticContext.mProperty_mClassMap.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, temp_0.getter_mClassName (HERE), kSearchErrorMessage_classMap_searchKey  COMMA_SOURCE_FILE ("to-many-relationship.galgas", 119)) ;
  if (NULL != objectArray_4546) {
    macroValidSharedObject (objectArray_4546, cMapElement_classMap) ;
    GALGAS_classKind var_classKind_4716 ;
    const GALGAS_toManyRelationshipAST temp_1 = object ;
    GALGAS_propertyMap joker_4718_3 ; // Joker input parameter
    GALGAS_actionMap joker_4718_2 ; // Joker input parameter
    GALGAS_propertyGenerationList joker_4718_1 ; // Joker input parameter
    ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_1.getter_mDestinationEntityName (HERE), var_classKind_4716, joker_4718_3, joker_4718_2, joker_4718_1, inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 122)) ;
    switch (var_classKind_4716.enumValue ()) {
    case GALGAS_classKind::kNotBuilt:
      break ;
    case GALGAS_classKind::kEnum_prefs:
      {
    ...
    case GALGAS_classKind::kEnum_entity:
      {
        const cEnumAssociatedValues_classKind_entity * extractPtr_6291 = (const cEnumAssociatedValues_classKind_entity *) (var_classKind_4716.unsafePointer ()) ;
        const GALGAS_bool extractedValue_graphic = extractPtr_6291->mAssociatedValue1 ;
        const GALGAS_toManyRelationshipAST temp_8 = object ;
        const GALGAS_toManyRelationshipAST temp_9 = object ;
        GALGAS_propertyKind var_kind_5065 = GALGAS_propertyKind::constructor_toMany (temp_8.getter_mDestinationEntityName (HERE), GALGAS_propertyAccessibility::constructor_stored (SOURCE_FILE ("to-many-relationship.galgas", 133)), extractedValue_graphic, temp_9.getter_mOption (HERE)  COMMA_SOURCE_FILE ("to-many-relationship.galgas", 131)) ;
        {
        const GALGAS_toManyRelationshipAST temp_10 = object ;
        objectArray_4546->mProperty_mPropertyMap.setter_insertKey (temp_10.getter_mToManyRelationshipName (HERE), var_kind_5065, GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE ("to-many-relationship.galgas", 137)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 137)) ;
        }
        const GALGAS_toManyRelationshipAST temp_11 = object ;
        GALGAS_bool var_inPrefs_5375 = GALGAS_bool (kIsEqual, temp_11.getter_mClassName (HERE).getter_string (HERE).objectCompare (function_preferencesName (inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 139)))) ;
        GALGAS_toManyRelationshipOptionGeneration var_optionForGeneration_5500 ;
        ...
        case GALGAS_toManyRelationshipOptionAST::kEnum_hasDependance:
          {
            const cEnumAssociatedValues_toManyRelationshipOptionAST_hasDependance * extractPtr_5844 = (const cEnumAssociatedValues_toManyRelationshipOptionAST_hasDependance *) (temp_12.getter_mOption (HERE).unsafePointer ()) ;
            const GALGAS_lstring extractedValue_masterPropertyName = extractPtr_5844->mAssociatedValue0 ;
            GALGAS_propertyKind var_masterPropertyKind_5650 ;
            GALGAS_actionMap joker_5652_2 ; // Joker input parameter
            GALGAS_bool joker_5652_1 ; // Joker input parameter
            objectArray_4546->mProperty_mPropertyMap.method_searchKey (extractedValue_masterPropertyName, var_masterPropertyKind_5650, joker_5652_2, joker_5652_1, inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 144)) ;
            var_optionForGeneration_5500 = GALGAS_toManyRelationshipOptionGeneration::constructor_hasDependance (extractedValue_masterPropertyName.getter_string (HERE), extensionGetter_swiftTypeName (var_masterPropertyKind_5650, inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 147))  COMMA_SOURCE_FILE ("to-many-relationship.galgas", 145)) ;
          }
          break ;
        case GALGAS_toManyRelationshipOptionAST::kEnum_hasOpposite:
          {
            const cEnumAssociatedValues_toManyRelationshipOptionAST_hasOpposite * extractPtr_5964 = (const cEnumAssociatedValues_toManyRelationshipOptionAST_hasOpposite *) (temp_12.getter_mOption (HERE).unsafePointer ()) ;
            const GALGAS_lstring extractedValue_oppositeName = extractPtr_5964->mAssociatedValue0 ;
            var_optionForGeneration_5500 = GALGAS_toManyRelationshipOptionGeneration::constructor_hasOpposite (extractedValue_oppositeName.getter_string (HERE)  COMMA_SOURCE_FILE ("to-many-relationship.galgas", 150)) ;
          }
          break ;
        case GALGAS_toManyRelationshipOptionAST::kEnum_none:
          {
            var_optionForGeneration_5500 = GALGAS_toManyRelationshipOptionGeneration::constructor_none (SOURCE_FILE ("to-many-relationship.galgas", 152)) ;
          }
          break ;
        }
        ...
        objectArray_4546->mProperty_mPropertyGenerationList.addAssign_operation (GALGAS_toManyPropertyGeneration::constructor_new (temp_13.getter_mToManyRelationshipName (HERE).getter_string (HERE), var_kind_5065, var_optionForGeneration_5500, var_inPrefs_5375, temp_14.getter_mCustomStore (HERE), temp_15.getter_mUsedForSignature (HERE)  COMMA_SOURCE_FILE ("to-many-relationship.galgas", 155))  COMMA_SOURCE_FILE ("to-many-relationship.galgas", 155)) ;
      }
      break ;
    }
  }
...
static GALGAS_string extensionGetter_toManyPropertyGeneration_propertyDeclarationCode (const cPtr_propertyGeneration * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string var_masterPropertyTypeName_7805 ;
      const GALGAS_toManyPropertyGeneration temp_3 = object ;
      GALGAS_string joker_7746_1 ; // Joker input parameter
      temp_3.getter_mOption (HERE).method_hasDependance (joker_7746_1, var_masterPropertyTypeName_7805, inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 201)) ;
      const GALGAS_toManyPropertyGeneration temp_4 = object ;
      const GALGAS_toManyPropertyGeneration temp_5 = object ;
      result_result.plusAssign_operation(GALGAS_string ("  final let ").add_operation (temp_4.getter_mPropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 202)).add_operation (GALGAS_string ("_property = TransientArrayOfSuperOf_"), inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 202)).add_operation (extensionGetter_swiftTypeName (temp_5.getter_mRelationshipType (HERE), inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 202)), inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 202)).add_operation (GALGAS_string (" <"), inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 202)).add_operation (var_masterPropertyTypeName_7805, inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 203)).add_operation (GALGAS_string ("> ()\n"
...
static GALGAS_string extensionGetter_toManyPropertyGeneration_configurationCode (const cPtr_propertyGeneration * inObject,
  ...
  GALGAS_string var_prefix_11163 = temp_0 ;
  const GALGAS_toManyPropertyGeneration temp_2 = object ;
  ...
  case GALGAS_toManyRelationshipOptionGeneration::kEnum_none:
    {
      ...
      const GALGAS_toManyPropertyGeneration temp_4 = object ;
      result_result.plusAssign_operation(GALGAS_string ("    ").add_operation (var_prefix_11163, inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 260)).add_operation (temp_4.getter_mPropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 260)).add_operation (GALGAS_string ("_property.ebUndoManager = self.ebUndoManager\n"), inCompiler COMMA_SOURCE_FILE ("to-many-relationship.galgas", 260)), inCompiler  COMMA_SOURCE_FILE ("to-many-relationship.galgas", 260)) ;
    }
    break ;
  ...
  case GALGAS_toManyRelationshipOptionGeneration::kEnum_hasOpposite:
    {
      const cEnumAssociatedValues_toManyRelationshipOptionGeneration_hasOpposite * extractPtr_12092 = (const cEnumAssociatedValues_toManyRelationshipOptionGeneration_hasOpposite *) (temp_2.getter_mOption (HERE).unsafePointer ()) ;
      const GALGAS_string extractedValue_oppositeName = extractPtr_12092->mAssociatedValue0 ;
      const GALGAS_toManyPropertyGeneration temp_5 = object ;
...
static GALGAS_string extensionGetter_toManyPropertyGeneration_terminationCode (const cPtr_propertyGeneration * inObject,
  ...
  case GALGAS_toManyRelationshipOptionGeneration::kEnum_hasDependance:
    {
      const cEnumAssociatedValues_toManyRelationshipOptionGeneration_hasDependance * extractPtr_17155 = (const cEnumAssociatedValues_toManyRelationshipOptionGeneration_hasDependance *) (temp_0.getter_mOption (HERE).unsafePointer ()) ;
      const GALGAS_string extractedValue_masterPropertyName = extractPtr_17155->mAssociatedValue0 ;
      const GALGAS_toManyPropertyGeneration temp_1 = object ;
...
static void extensionMethod_actionFileGeneration_generateCode (const cPtr_abstractFileGeneration * inObject,
  ...
  GALGAS_string var_s_2634 = GALGAS_string (filewrapperTemplate_actionGenerationTemplate_actionGeneration (inCompiler, temp_0.getter_mClassName (HERE), temp_1.getter_mActionName (HERE) COMMA_SOURCE_FILE ("run-action.galgas", 67))) ;
  const GALGAS_actionFileGeneration temp_2 = object ;
  const GALGAS_actionFileGeneration temp_3 = object ;
  GALGAS_string var_fileName_2753 = GALGAS_string ("action-").add_operation (temp_2.getter_mClassName (HERE), inCompiler COMMA_SOURCE_FILE ("run-action.galgas", 71)).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("run-action.galgas", 71)).add_operation (temp_3.getter_mActionName (HERE), inCompiler COMMA_SOURCE_FILE ("run-action.galgas", 71)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("run-action.galgas", 71)) ;
  ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_2753  COMMA_SOURCE_FILE ("run-action.galgas", 72)) ;
  {
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, var_fileName_2753, GALGAS_string ("//"), GALGAS_string::makeEmptyString (), GALGAS_string ("\n"
    "\n"), var_s_2634, GALGAS_string ("    ENTER USER CODE HERE\n"), GALGAS_string ("  }\n"
    "}\n"
    "\n"
...
static void extensionMethod_observablePropertyInMultipleBindingExpressionAST_analyzeExpressionForMultipleBinding (const cPtr_abstractBooleanMultipleBindingExpressionAST * inObject,
  ...
  GALGAS_propertyKind var_kind_12638 ;
  GALGAS_string var_swiftTypeStringForTransientFunctionArgument_12706 ;
  const GALGAS_observablePropertyInMultipleBindingExpressionAST temp_0 = object ;
  extensionMethod_analyzeObservableProperty (temp_0.getter_mProperty (HERE), constinArgument_inRootObservablePropertyMap, constinArgument_inSemanticContext, constinArgument_inCurrentObservablePropertyMap, var_kind_12638, var_swiftTypeStringForTransientFunctionArgument_12706, inCompiler COMMA_SOURCE_FILE ("multiple-binding.galgas", 287)) ;
  switch (var_kind_12638.enumValue ()) {
  case GALGAS_propertyKind::kNotBuilt:
    break ;
  case GALGAS_propertyKind::kEnum_property:
    {
      const cEnumAssociatedValues_propertyKind_property * extractPtr_12770 = (const cEnumAssociatedValues_propertyKind_property *) (var_kind_12638.unsafePointer ()) ;
      const GALGAS_typeKind extractedValue_type = extractPtr_12770->mAssociatedValue0 ;
...
static void extensionMethod_negateBooleanMultipleBindingExpressionAST_analyzeExpressionForMultipleBinding (const cPtr_abstractBooleanMultipleBindingExpressionAST * inObject,
  ...
  outArgument_outEnableExpression = GALGAS_negateBooleanMultipleBindingExpressionForGeneration::constructor_new (var_expression_14242  COMMA_SOURCE_FILE ("multiple-binding.galgas", 335)) ;
}
...
static void extensionMethod_orBooleanMultipleBindingExpressionAST_analyzeExpressionForMultipleBinding (const cPtr_abstractBooleanMultipleBindingExpressionAST * inObject,
  ...
  GALGAS_abstractBooleanMultipleBindingExpressionForGeneration var_leftExpression_15256 ;
  GALGAS_typeKind var_outLeftType_15277 ;
  GALGAS_location var_outLeftLocation_15302 ;
  const GALGAS_orBooleanMultipleBindingExpressionAST temp_0 = object ;
  callExtensionMethod_analyzeExpressionForMultipleBinding ((const cPtr_abstractBooleanMultipleBindingExpressionAST *) temp_0.getter_mLeftBinding (HERE).ptr (), constinArgument_inPreferences, constinArgument_inRootObservablePropertyMap, constinArgument_inSemanticContext, constinArgument_inCurrentObservablePropertyMap, var_leftExpression_15256, var_outLeftType_15277, var_outLeftLocation_15302, inCompiler COMMA_SOURCE_FILE ("multiple-binding.galgas", 349)) ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = var_outLeftType_15277.getter_isBoolType (SOURCE_FILE ("multiple-binding.galgas", 358)).operator_not (SOURCE_FILE ("multiple-binding.galgas", 358)).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (var_outLeftLocation_15302, GALGAS_string ("cannot apply 'or': left operand is not boolean"), fixItArray2  COMMA_SOURCE_FILE ("multiple-binding.galgas", 359)) ;
    }
  }
  GALGAS_abstractBooleanMultipleBindingExpressionForGeneration var_rightExpression_15677 ;
  GALGAS_typeKind var_outRightType_15699 ;
  GALGAS_location var_outRightLocation_15725 ;
  const GALGAS_orBooleanMultipleBindingExpressionAST temp_3 = object ;
  callExtensionMethod_analyzeExpressionForMultipleBinding ((const cPtr_abstractBooleanMultipleBindingExpressionAST *) temp_3.getter_mRightBinding (HERE).ptr (), constinArgument_inPreferences, constinArgument_inRootObservablePropertyMap, constinArgument_inSemanticContext, constinArgument_inCurrentObservablePropertyMap, var_rightExpression_15677, var_outRightType_15699, var_outRightLocation_15725, inCompiler COMMA_SOURCE_FILE ("multiple-binding.galgas", 361)) ;
  enumGalgasBool test_4 = kBoolTrue ;
  if (kBoolTrue == test_4) {
    test_4 = var_outRightType_15699.getter_isBoolType (SOURCE_FILE ("multiple-binding.galgas", 370)).operator_not (SOURCE_FILE ("multiple-binding.galgas", 370)).boolEnum () ;
    if (kBoolTrue == test_4) {
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (var_outRightLocation_15725, GALGAS_string ("cannot apply 'or': right operand is not boolean"), fixItArray5  COMMA_SOURCE_FILE ("multiple-binding.galgas", 371)) ;
    }
  }
  outArgument_outType = GALGAS_typeKind::constructor_boolType (SOURCE_FILE ("multiple-binding.galgas", 373)) ;
  outArgument_outErrorLocation = var_outRightLocation_15725 ;
  outArgument_outEnableExpression = GALGAS_orBooleanMultipleBindingExpressionForGeneration::constructor_new (var_leftExpression_15256, var_rightExpression_15677  COMMA_SOURCE_FILE ("multiple-binding.galgas", 375)) ;
}
...
static void extensionMethod_xorBooleanMultipleBindingExpressionAST_analyzeExpressionForMultipleBinding (const cPtr_abstractBooleanMultipleBindingExpressionAST * inObject,
  ...
  GALGAS_abstractBooleanMultipleBindingExpressionForGeneration var_leftExpression_16790 ;
  GALGAS_typeKind var_outLeftType_16811 ;
  GALGAS_location var_outLeftLocation_16836 ;
  const GALGAS_xorBooleanMultipleBindingExpressionAST temp_0 = object ;
  callExtensionMethod_analyzeExpressionForMultipleBinding ((const cPtr_abstractBooleanMultipleBindingExpressionAST *) temp_0.getter_mLeftBinding (HERE).ptr (), constinArgument_inPreferences, constinArgument_inRootObservablePropertyMap, constinArgument_inSemanticContext, constinArgument_inCurrentObservablePropertyMap, var_leftExpression_16790, var_outLeftType_16811, var_outLeftLocation_16836, inCompiler COMMA_SOURCE_FILE ("multiple-binding.galgas", 389)) ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = var_outLeftType_16811.getter_isBoolType (SOURCE_FILE ("multiple-binding.galgas", 398)).operator_not (SOURCE_FILE ("multiple-binding.galgas", 398)).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (var_outLeftLocation_16836, GALGAS_string ("cannot apply 'or': left operand is not boolean"), fixItArray2  COMMA_SOURCE_FILE ("multiple-binding.galgas", 399)) ;
    }
  }
  GALGAS_abstractBooleanMultipleBindingExpressionForGeneration var_rightExpression_17211 ;
  GALGAS_typeKind var_outRightType_17233 ;
  GALGAS_location var_outRightLocation_17259 ;
  const GALGAS_xorBooleanMultipleBindingExpressionAST temp_3 = object ;
  callExtensionMethod_analyzeExpressionForMultipleBinding ((const cPtr_abstractBooleanMultipleBindingExpressionAST *) temp_3.getter_mRightBinding (HERE).ptr (), constinArgument_inPreferences, constinArgument_inRootObservablePropertyMap, constinArgument_inSemanticContext, constinArgument_inCurrentObservablePropertyMap, var_rightExpression_17211, var_outRightType_17233, var_outRightLocation_17259, inCompiler COMMA_SOURCE_FILE ("multiple-binding.galgas", 401)) ;
  enumGalgasBool test_4 = kBoolTrue ;
  if (kBoolTrue == test_4) {
    test_4 = var_outRightType_17233.getter_isBoolType (SOURCE_FILE ("multiple-binding.galgas", 410)).operator_not (SOURCE_FILE ("multiple-binding.galgas", 410)).boolEnum () ;
    if (kBoolTrue == test_4) {
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (var_outRightLocation_17259, GALGAS_string ("cannot apply 'or': right operand is not boolean"), fixItArray5  COMMA_SOURCE_FILE ("multiple-binding.galgas", 411)) ;
    }
  }
  outArgument_outType = GALGAS_typeKind::constructor_boolType (SOURCE_FILE ("multiple-binding.galgas", 413)) ;
  outArgument_outErrorLocation = var_outRightLocation_17259 ;
  outArgument_outEnableExpression = GALGAS_xorBooleanMultipleBindingExpressionForGeneration::constructor_new (var_leftExpression_16790, var_rightExpression_17211  COMMA_SOURCE_FILE ("multiple-binding.galgas", 415)) ;
}
...
static void extensionMethod_andBooleanMultipleBindingExpressionAST_analyzeExpressionForMultipleBinding (const cPtr_abstractBooleanMultipleBindingExpressionAST * inObject,
  ...
  GALGAS_abstractBooleanMultipleBindingExpressionForGeneration var_leftExpression_18325 ;
  GALGAS_typeKind var_outLeftType_18346 ;
  GALGAS_location var_outLeftLocation_18371 ;
  const GALGAS_andBooleanMultipleBindingExpressionAST temp_0 = object ;
  callExtensionMethod_analyzeExpressionForMultipleBinding ((const cPtr_abstractBooleanMultipleBindingExpressionAST *) temp_0.getter_mLeftBinding (HERE).ptr (), constinArgument_inPreferences, constinArgument_inRootObservablePropertyMap, constinArgument_inSemanticContext, constinArgument_inCurrentObservablePropertyMap, var_leftExpression_18325, var_outLeftType_18346, var_outLeftLocation_18371, inCompiler COMMA_SOURCE_FILE ("multiple-binding.galgas", 429)) ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = var_outLeftType_18346.getter_isBoolType (SOURCE_FILE ("multiple-binding.galgas", 438)).operator_not (SOURCE_FILE ("multiple-binding.galgas", 438)).boolEnum () ;
    if (kBoolTrue == test_1) {
      TC_Array <C_FixItDescription> fixItArray2 ;
      inCompiler->emitSemanticError (var_outLeftLocation_18371, GALGAS_string ("cannot apply 'and': left operand is not boolean"), fixItArray2  COMMA_SOURCE_FILE ("multiple-binding.galgas", 439)) ;
    }
  }
  GALGAS_abstractBooleanMultipleBindingExpressionForGeneration var_rightExpression_18747 ;
  GALGAS_typeKind var_outRightType_18769 ;
  GALGAS_location var_outRightLocation_18795 ;
  const GALGAS_andBooleanMultipleBindingExpressionAST temp_3 = object ;
  callExtensionMethod_analyzeExpressionForMultipleBinding ((const cPtr_abstractBooleanMultipleBindingExpressionAST *) temp_3.getter_mRightBinding (HERE).ptr (), constinArgument_inPreferences, constinArgument_inRootObservablePropertyMap, constinArgument_inSemanticContext, constinArgument_inCurrentObservablePropertyMap, var_rightExpression_18747, var_outRightType_18769, var_outRightLocation_18795, inCompiler COMMA_SOURCE_FILE ("multiple-binding.galgas", 441)) ;
  enumGalgasBool test_4 = kBoolTrue ;
  if (kBoolTrue == test_4) {
    test_4 = var_outRightType_18769.getter_isBoolType (SOURCE_FILE ("multiple-binding.galgas", 450)).operator_not (SOURCE_FILE ("multiple-binding.galgas", 450)).boolEnum () ;
    if (kBoolTrue == test_4) {
      TC_Array <C_FixItDescription> fixItArray5 ;
      inCompiler->emitSemanticError (var_outRightLocation_18795, GALGAS_string ("cannot apply 'and': right operand is not boolean"), fixItArray5  COMMA_SOURCE_FILE ("multiple-binding.galgas", 451)) ;
    }
  }
  outArgument_outType = GALGAS_typeKind::constructor_boolType (SOURCE_FILE ("multiple-binding.galgas", 453)) ;
  outArgument_outErrorLocation = var_outRightLocation_18795 ;
  outArgument_outEnableExpression = GALGAS_andBooleanMultipleBindingExpressionForGeneration::constructor_new (var_leftExpression_18325, var_rightExpression_18747  COMMA_SOURCE_FILE ("multiple-binding.galgas", 455)) ;
}
...
static void extensionMethod_comparisonMultipleBindingExpressionAST_analyzeExpressionForMultipleBinding (const cPtr_abstractBooleanMultipleBindingExpressionAST * inObject,
  ...
  GALGAS_abstractBooleanMultipleBindingExpressionForGeneration var_leftExpression_19862 ;
  GALGAS_typeKind var_outLeftType_19883 ;
  GALGAS_location var_outLeftLocation_19908 ;
  const GALGAS_comparisonMultipleBindingExpressionAST temp_0 = object ;
  callExtensionMethod_analyzeExpressionForMultipleBinding ((const cPtr_abstractBooleanMultipleBindingExpressionAST *) temp_0.getter_mLeftBinding (HERE).ptr (), constinArgument_inPreferences, constinArgument_inRootObservablePropertyMap, constinArgument_inSemanticContext, constinArgument_inCurrentObservablePropertyMap, var_leftExpression_19862, var_outLeftType_19883, var_outLeftLocation_19908, inCompiler COMMA_SOURCE_FILE ("multiple-binding.galgas", 469)) ;
  GALGAS_abstractBooleanMultipleBindingExpressionForGeneration var_rightExpression_20161 ;
  GALGAS_typeKind var_outRightType_20183 ;
  GALGAS_location var_outRightLocation_20209 ;
  const GALGAS_comparisonMultipleBindingExpressionAST temp_1 = object ;
  callExtensionMethod_analyzeExpressionForMultipleBinding ((const cPtr_abstractBooleanMultipleBindingExpressionAST *) temp_1.getter_mRightBinding (HERE).ptr (), constinArgument_inPreferences, constinArgument_inRootObservablePropertyMap, constinArgument_inSemanticContext, constinArgument_inCurrentObservablePropertyMap, var_rightExpression_20161, var_outRightType_20183, var_outRightLocation_20209, inCompiler COMMA_SOURCE_FILE ("multiple-binding.galgas", 478)) ;
  enumGalgasBool test_2 = kBoolTrue ;
  if (kBoolTrue == test_2) {
    GALGAS_bool test_3 = var_outLeftType_19883.getter_isBoolType (SOURCE_FILE ("multiple-binding.galgas", 487)) ;
    if (kBoolTrue != test_3.boolEnum ()) {
      test_3 = var_outLeftType_19883.getter_isIntegerType (SOURCE_FILE ("multiple-binding.galgas", 487)) ;
    }
    test_2 = test_3.operator_not (SOURCE_FILE ("multiple-binding.galgas", 487)).boolEnum () ;
    if (kBoolTrue == test_2) {
      TC_Array <C_FixItDescription> fixItArray4 ;
      inCompiler->emitSemanticError (var_outLeftLocation_19908, GALGAS_string ("cannot compare: left operand is neither boolean nor integer"), fixItArray4  COMMA_SOURCE_FILE ("multiple-binding.galgas", 488)) ;
    }
  }
  enumGalgasBool test_5 = kBoolTrue ;
  if (kBoolTrue == test_5) {
    test_5 = GALGAS_bool (kIsNotEqual, var_outRightType_20183.objectCompare (var_outLeftType_19883)).boolEnum () ;
    if (kBoolTrue == test_5) {
      TC_Array <C_FixItDescription> fixItArray6 ;
      inCompiler->emitSemanticError (var_outRightLocation_20209, GALGAS_string ("cannot compare: right operand type is different than left operand type"), fixItArray6  COMMA_SOURCE_FILE ("multiple-binding.galgas", 491)) ;
    }
  }
  outArgument_outType = GALGAS_typeKind::constructor_boolType (SOURCE_FILE ("multiple-binding.galgas", 493)) ;
  outArgument_outErrorLocation = var_outRightLocation_20209 ;
  const GALGAS_comparisonMultipleBindingExpressionAST temp_7 = object ;
  outArgument_outEnableExpression = GALGAS_comparisonMultipleBindingExpressionForGeneration::constructor_new (var_leftExpression_19862, temp_7.getter_mOperator (HERE), var_rightExpression_20161  COMMA_SOURCE_FILE ("multiple-binding.galgas", 495)) ;
}
...
static void extensionMethod_arrayControllerDeclarationAST_enterInPrecedenceGraph (const cPtr_abstractDeclarationAST * inObject,
  ...
  case GALGAS_arrayControllerBoundModelAST::kEnum_rootToManyRelationship:
    {
      const cEnumAssociatedValues_arrayControllerBoundModelAST_rootToManyRelationship * extractPtr_1604 = (const cEnumAssociatedValues_arrayControllerBoundModelAST_rootToManyRelationship *) (temp_5.getter_mModel (HERE).unsafePointer ()) ;
      const GALGAS_lstring extractedValue_rootEntityName = extractPtr_1604->mAssociatedValue0 ;
      enumGalgasBool test_6 = kBoolTrue ;
      if (kBoolTrue == test_6) {
...
static void extensionMethod_arrayControllerDeclarationAST_firstAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  macroValidSharedObject (object, cPtr_arrayControllerDeclarationAST) ;
  const GALGAS_arrayControllerDeclarationAST temp_0 = object ;
  cMapElement_classMap * objectArray_4335 = (cMapElement_classMap *) ioArgument_ioSemanticContext.mProperty_mClassMap.readWriteAccessForWithInstructionWithErrorMessage (inCompiler, temp_0.getter_mClassName (HERE), kSearchErrorMessage_classMap_searchKey  COMMA_SOURCE_FILE ("array-controller.galgas", 107)) ;
  if (NULL != objectArray_4335) {
    macroValidSharedObject (objectArray_4335, cMapElement_classMap) ;
    ...
    GALGAS_actionMap var_controllerActions_4455 = temp_1 ;
    const GALGAS_arrayControllerDeclarationAST temp_2 = object ;
    ...
    case GALGAS_arrayControllerBoundModelAST::kEnum_rootToManyRelationship:
      {
        const cEnumAssociatedValues_arrayControllerBoundModelAST_rootToManyRelationship * extractPtr_5662 = (const cEnumAssociatedValues_arrayControllerBoundModelAST_rootToManyRelationship *) (temp_2.getter_mModel (HERE).unsafePointer ()) ;
        const GALGAS_lstring extractedValue_rootEntityName = extractPtr_5662->mAssociatedValue0 ;
        GALGAS_propertyMap var_rootProperties_4665 ;
        GALGAS_classKind joker_4644 ; // Joker input parameter
        GALGAS_actionMap joker_4667_2 ; // Joker input parameter
        GALGAS_propertyGenerationList joker_4667_1 ; // Joker input parameter
        ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (extractedValue_rootEntityName, joker_4644, var_rootProperties_4665, joker_4667_2, joker_4667_1, inCompiler COMMA_SOURCE_FILE ("array-controller.galgas", 113)) ;
        GALGAS_propertyKind var_classKind_4743 ;
        const GALGAS_arrayControllerDeclarationAST temp_3 = object ;
        GALGAS_actionMap joker_4745_2 ; // Joker input parameter
        GALGAS_bool joker_4745_1 ; // Joker input parameter
        var_rootProperties_4665.method_searchKey (temp_3.getter_mToManyPropertyName (HERE), var_classKind_4743, joker_4745_2, joker_4745_1, inCompiler COMMA_SOURCE_FILE ("array-controller.galgas", 114)) ;
        switch (var_classKind_4743.enumValue ()) {
        case GALGAS_propertyKind::kNotBuilt:
          break ;
        case GALGAS_propertyKind::kEnum_property:
          {
        ...
        case GALGAS_propertyKind::kEnum_toMany:
          {
            const cEnumAssociatedValues_propertyKind_toMany * extractPtr_5341 = (const cEnumAssociatedValues_propertyKind_toMany *) (var_classKind_4743.unsafePointer ()) ;
            const GALGAS_lstring extractedValue_typeName = extractPtr_5341->mAssociatedValue0 ;
            const GALGAS_bool extractedValue_graphic = extractPtr_5341->mAssociatedValue2 ;
            GALGAS_propertyKind var_kind_4930 = GALGAS_propertyKind::constructor_arrayController (extractedValue_typeName, extractedValue_graphic  COMMA_SOURCE_FILE ("array-controller.galgas", 119)) ;
            {
            const GALGAS_arrayControllerDeclarationAST temp_5 = object ;
            objectArray_4335->mProperty_mPropertyMap.setter_insertKey (temp_5.getter_mControllerName (HERE), var_kind_4930, var_controllerActions_4455, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("array-controller.galgas", 123)) ;
            }
            const GALGAS_arrayControllerDeclarationAST temp_6 = object ;
            const GALGAS_arrayControllerDeclarationAST temp_7 = object ;
            const GALGAS_arrayControllerDeclarationAST temp_8 = object ;
            objectArray_4335->mProperty_mPropertyGenerationList.addAssign_operation (GALGAS_arrayControllerPropertyGeneration::constructor_new (temp_6.getter_mControllerName (HERE).getter_string (HERE), GALGAS_string ("rootObject.").add_operation (temp_7.getter_mToManyPropertyName (HERE).getter_string (SOURCE_FILE ("array-controller.galgas", 127)), inCompiler COMMA_SOURCE_FILE ("array-controller.galgas", 127)), temp_8.getter_mClassName (HERE).getter_string (SOURCE_FILE ("array-controller.galgas", 128))  COMMA_SOURCE_FILE ("array-controller.galgas", 125))  COMMA_SOURCE_FILE ("array-controller.galgas", 125)) ;
          }
          break ;
        case GALGAS_propertyKind::kEnum_toOne:
          {
    ...
    case GALGAS_arrayControllerBoundModelAST::kEnum_selfToManyRelationship:
      {
        GALGAS_propertyKind var_classKind_5767 ;
        const GALGAS_arrayControllerDeclarationAST temp_12 = object ;
        GALGAS_actionMap joker_5769_2 ; // Joker input parameter
        GALGAS_bool joker_5769_1 ; // Joker input parameter
        objectArray_4335->mProperty_mPropertyMap.method_searchKey (temp_12.getter_mToManyPropertyName (HERE), var_classKind_5767, joker_5769_2, joker_5769_1, inCompiler COMMA_SOURCE_FILE ("array-controller.galgas", 138)) ;
        switch (var_classKind_5767.enumValue ()) {
        case GALGAS_propertyKind::kNotBuilt:
          break ;
        case GALGAS_propertyKind::kEnum_property:
          {
        ...
        case GALGAS_propertyKind::kEnum_toMany:
          {
            const cEnumAssociatedValues_propertyKind_toMany * extractPtr_6359 = (const cEnumAssociatedValues_propertyKind_toMany *) (var_classKind_5767.unsafePointer ()) ;
            const GALGAS_lstring extractedValue_typeName = extractPtr_6359->mAssociatedValue0 ;
            const GALGAS_bool extractedValue_graphic = extractPtr_6359->mAssociatedValue2 ;
            GALGAS_propertyKind var_kind_5964 = GALGAS_propertyKind::constructor_arrayController (extractedValue_typeName, extractedValue_graphic  COMMA_SOURCE_FILE ("array-controller.galgas", 143)) ;
            {
            const GALGAS_arrayControllerDeclarationAST temp_15 = object ;
            objectArray_4335->mProperty_mPropertyMap.setter_insertKey (temp_15.getter_mControllerName (HERE), var_kind_5964, var_controllerActions_4455, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE ("array-controller.galgas", 147)) ;
            }
...
static void extensionMethod_arrayControllerDeclarationAST_thirdAnalysisPhase (const cPtr_abstractDeclarationAST * inObject,
  ...
  const cPtr_arrayControllerDeclarationAST * object = (const cPtr_arrayControllerDeclarationAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayControllerDeclarationAST) ;
  GALGAS_propertyMap var_boundModelPropertyMap_7185 ;
  const GALGAS_arrayControllerDeclarationAST temp_0 = object ;
  ...
  case GALGAS_arrayControllerBoundModelAST::kEnum_rootToManyRelationship:
    {
      const cEnumAssociatedValues_arrayControllerBoundModelAST_rootToManyRelationship * extractPtr_7388 = (const cEnumAssociatedValues_arrayControllerBoundModelAST_rootToManyRelationship *) (temp_0.getter_mModel (HERE).unsafePointer ()) ;
      const GALGAS_lstring extractedValue_rootEntityName = extractPtr_7388->mAssociatedValue0 ;
      GALGAS_classKind joker_7339 ; // Joker input parameter
      GALGAS_actionMap joker_7380_2 ; // Joker input parameter
      GALGAS_propertyGenerationList joker_7380_1 ; // Joker input parameter
      ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (extractedValue_rootEntityName, joker_7339, var_boundModelPropertyMap_7185, joker_7380_2, joker_7380_1, inCompiler COMMA_SOURCE_FILE ("array-controller.galgas", 176)) ;
    }
    break ;
  case GALGAS_arrayControllerBoundModelAST::kEnum_selfToManyRelationship:
    {
      const GALGAS_arrayControllerDeclarationAST temp_1 = object ;
      GALGAS_classKind joker_7496 ; // Joker input parameter
      GALGAS_actionMap joker_7537_2 ; // Joker input parameter
      GALGAS_propertyGenerationList joker_7537_1 ; // Joker input parameter
      ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (temp_1.getter_mClassName (HERE), joker_7496, var_boundModelPropertyMap_7185, joker_7537_2, joker_7537_1, inCompiler COMMA_SOURCE_FILE ("array-controller.galgas", 183)) ;
    }
    break ;
  }
  GALGAS_propertyKind var_boundModelClassKind_7650 ;
  const GALGAS_arrayControllerDeclarationAST temp_2 = object ;
  GALGAS_actionMap joker_7657_2 ; // Joker input parameter
  GALGAS_bool joker_7657_1 ; // Joker input parameter
  var_boundModelPropertyMap_7185.method_searchKey (temp_2.getter_mToManyPropertyName (HERE), var_boundModelClassKind_7650, joker_7657_2, joker_7657_1, inCompiler COMMA_SOURCE_FILE ("array-controller.galgas", 190)) ;
  GALGAS_actionMap var_actionMap_7773 ;
  GALGAS_propertyMap var_propertyMap_7800 ;
  GALGAS_arrayControllerModelKind var_arrayControllerModelKind_7853 ;
  GALGAS_bool var_graphic_7869 ;
  GALGAS_string var_elementTypeName_7895 ;
  switch (var_boundModelClassKind_7650.enumValue ()) {
  case GALGAS_propertyKind::kNotBuilt:
    break ;
  case GALGAS_propertyKind::kEnum_property:
    {
      ...
      var_graphic_7869.drop () ; // Release error dropped variable
      var_arrayControllerModelKind_7853.drop () ; // Release error dropped variable
      var_propertyMap_7800.drop () ; // Release error dropped variable
      var_actionMap_7773.drop () ; // Release error dropped variable
      var_elementTypeName_7895.drop () ; // Release error dropped variable
    }
    break ;
  case GALGAS_propertyKind::kEnum_toMany:
    {
      const cEnumAssociatedValues_propertyKind_toMany * extractPtr_8423 = (const cEnumAssociatedValues_propertyKind_toMany *) (var_boundModelClassKind_7650.unsafePointer ()) ;
      const GALGAS_lstring extractedValue_typeName = extractPtr_8423->mAssociatedValue0 ;
      const GALGAS_propertyAccessibility extractedValue_accessibility = extractPtr_8423->mAssociatedValue1 ;
      const GALGAS_bool extractedValue_isGraphic = extractPtr_8423->mAssociatedValue2 ;
      var_elementTypeName_7895 = extractedValue_typeName.getter_string (SOURCE_FILE ("array-controller.galgas", 207)) ;
      var_graphic_7869 = extractedValue_isGraphic ;
      ...
      var_arrayControllerModelKind_7853 = temp_5 ;
      GALGAS_classKind joker_8394 ; // Joker input parameter
      GALGAS_propertyGenerationList joker_8421 ; // Joker input parameter
      ioArgument_ioSemanticContext.getter_mClassMap (HERE).method_searchKey (extractedValue_typeName, joker_8394, var_propertyMap_7800, var_actionMap_7773, joker_8421, inCompiler COMMA_SOURCE_FILE ("array-controller.galgas", 213)) ;
    }
    break ;
  case GALGAS_propertyKind::kEnum_toOne:
    {
  ...
  ioArgument_ioGeneration.mProperty_mFileGenerationList.addAssign_operation (GALGAS_arrayControllerGeneration::constructor_new (temp_13.getter_mClassName (HERE).getter_string (SOURCE_FILE ("array-controller.galgas", 229)), temp_14.getter_mControllerName (HERE), GALGAS_string ("ReadWriteArrayOf_").add_operation (var_elementTypeName_7895, inCompiler COMMA_SOURCE_FILE ("array-controller.galgas", 231)), var_arrayControllerModelKind_7853, var_elementTypeName_7895, var_graphic_7869  COMMA_SOURCE_FILE ("array-controller.galgas", 228))  COMMA_SOURCE_FILE ("array-controller.galgas", 228)) ;
}
...
static GALGAS_string extensionGetter_arrayControllerPropertyGeneration_terminationCode (const cPtr_propertyGeneration * inObject,
  ...
  GALGAS_string var_prefix_11998 = temp_0 ;
  const GALGAS_arrayControllerPropertyGeneration temp_2 = object ;
  ...
  const GALGAS_arrayControllerPropertyGeneration temp_3 = object ;
  result_result.plusAssign_operation(GALGAS_string ("    ").add_operation (var_prefix_11998, inCompiler COMMA_SOURCE_FILE ("array-controller.galgas", 292)).add_operation (temp_3.getter_mPropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("array-controller.galgas", 292)).add_operation (GALGAS_string (".unbind_model ()\n"), inCompiler COMMA_SOURCE_FILE ("array-controller.galgas", 292)), inCompiler  COMMA_SOURCE_FILE ("array-controller.galgas", 292)) ;
//---
  return result_result ;
}
