...
void routine_generateSwiftApplicationFiles (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  GALGAS_stringlist temp_0 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("code-generation.galgas", 209)) ;
  ...
  temp_0.addAssign_operation (GALGAS_string ("EBObserver")  COMMA_SOURCE_FILE ("code-generation.galgas", 156)) ;
  temp_0.addAssign_operation (GALGAS_string ("func-presentErrorWindow")  COMMA_SOURCE_FILE ("code-generation.galgas", 157)) ;
  temp_0.addAssign_operation (GALGAS_string ("func-checkOutletConnection")  COMMA_SOURCE_FILE ("code-generation.galgas", 158)) ;
  temp_0.addAssign_operation (GALGAS_string ("ReadOnlyAbstractGenericRelationshipProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 159)) ;
  temp_0.addAssign_operation (GALGAS_string ("ReadOnlyAbstractArrayProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 160)) ;
  temp_0.addAssign_operation (GALGAS_string ("ReadOnlyAbstractObjectProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 161)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBReadOnlyPropertyController")  COMMA_SOURCE_FILE ("code-generation.galgas", 162)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBGenericReadWritePropertyController")  COMMA_SOURCE_FILE ("code-generation.galgas", 163)) ;
  ...
  temp_0.addAssign_operation (GALGAS_string ("extension-Int-EBPropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 175)) ;
  temp_0.addAssign_operation (GALGAS_string ("extension-UInt32-EBPropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 176)) ;
  temp_0.addAssign_operation (GALGAS_string ("extension-String-EBPropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 177)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBEnumTransientProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 178)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBEnumStoredProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 179)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBEnumPropertyProxy")  COMMA_SOURCE_FILE ("code-generation.galgas", 180)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBEnumReadWriteProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 181)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBEnumReadOnlyProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 182)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBObservableObjectProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 183)) ;
  temp_0.addAssign_operation (GALGAS_string ("EnumPropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 184)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBEnumProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 185)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBGenericTransientProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 186)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBGenericPreferenceProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 187)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBGenericComputedProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 188)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBGenericStoredProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 189)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBGenericPropertyProxy")  COMMA_SOURCE_FILE ("code-generation.galgas", 190)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBGenericReadWriteProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 191)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBGenericReadOnlyProperty")  COMMA_SOURCE_FILE ("code-generation.galgas", 192)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBPropertyProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 193)) ;
  temp_0.addAssign_operation (GALGAS_string ("extension-Data-Comparable")  COMMA_SOURCE_FILE ("code-generation.galgas", 194)) ;
  temp_0.addAssign_operation (GALGAS_string ("PropertyKind")  COMMA_SOURCE_FILE ("code-generation.galgas", 195)) ;
  temp_0.addAssign_operation (GALGAS_string ("EBSelection")  COMMA_SOURCE_FILE ("code-generation.galgas", 196)) ;
  temp_0.addAssign_operation (GALGAS_string ("func-defaultValidationFunction")  COMMA_SOURCE_FILE ("code-generation.galgas", 197)) ;
  temp_0.addAssign_operation (GALGAS_string ("multiple-binding-controllers")  COMMA_SOURCE_FILE ("code-generation.galgas", 198)) ;
  temp_0.addAssign_operation (GALGAS_string ("Application")  COMMA_SOURCE_FILE ("code-generation.galgas", 199)) ;
  temp_0.addAssign_operation (GALGAS_string ("model-events")  COMMA_SOURCE_FILE ("code-generation.galgas", 200)) ;
  temp_0.addAssign_operation (GALGAS_string ("outlet-events")  COMMA_SOURCE_FILE ("code-generation.galgas", 201)) ;
  temp_0.addAssign_operation (GALGAS_string ("file-format-binary")  COMMA_SOURCE_FILE ("code-generation.galgas", 202)) ;
  temp_0.addAssign_operation (GALGAS_string ("file-metadata-binary-format")  COMMA_SOURCE_FILE ("code-generation.galgas", 203)) ;
  temp_0.addAssign_operation (GALGAS_string ("file-format-text-utilities")  COMMA_SOURCE_FILE ("code-generation.galgas", 204)) ;
  temp_0.addAssign_operation (GALGAS_string ("file-metadata-get")  COMMA_SOURCE_FILE ("code-generation.galgas", 205)) ;
  temp_0.addAssign_operation (GALGAS_string ("file-format-text")  COMMA_SOURCE_FILE ("code-generation.galgas", 206)) ;
  temp_0.addAssign_operation (GALGAS_string ("file-metadata-text-format")  COMMA_SOURCE_FILE ("code-generation.galgas", 207)) ;
  temp_0.addAssign_operation (GALGAS_string ("file-format-utilities")  COMMA_SOURCE_FILE ("code-generation.galgas", 208)) ;
  temp_0.addAssign_operation (GALGAS_string ("file-operations-facade")  COMMA_SOURCE_FILE ("code-generation.galgas", 209)) ;
  GALGAS_stringlist var_swiftFiles_4983 = temp_0 ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = constinArgument_inHasEntities.boolEnum () ;
    if (kBoolTrue == test_1) {
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBManagedObject")  COMMA_SOURCE_FILE ("code-generation.galgas", 212)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBDataScanner")  COMMA_SOURCE_FILE ("code-generation.galgas", 213)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicManagedObject")  COMMA_SOURCE_FILE ("code-generation.galgas", 214)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("buildPDFimage")  COMMA_SOURCE_FILE ("code-generation.galgas", 215)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBScrollView")  COMMA_SOURCE_FILE ("code-generation.galgas", 217)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBFocusRingView")  COMMA_SOURCE_FILE ("code-generation.galgas", 218)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView")  COMMA_SOURCE_FILE ("code-generation.galgas", 219)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-arrowKeyMagnitude")  COMMA_SOURCE_FILE ("code-generation.galgas", 220)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-backColor")  COMMA_SOURCE_FILE ("code-generation.galgas", 221)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-backgroundImage")  COMMA_SOURCE_FILE ("code-generation.galgas", 222)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-foregroundImage")  COMMA_SOURCE_FILE ("code-generation.galgas", 223)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridCrossColor")  COMMA_SOURCE_FILE ("code-generation.galgas", 224)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridDisplayFactor")  COMMA_SOURCE_FILE ("code-generation.galgas", 225)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridLineColor")  COMMA_SOURCE_FILE ("code-generation.galgas", 226)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridStep")  COMMA_SOURCE_FILE ("code-generation.galgas", 227)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridStyle")  COMMA_SOURCE_FILE ("code-generation.galgas", 228)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-horizontalFlip")  COMMA_SOURCE_FILE ("code-generation.galgas", 229)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-mouseGrid")  COMMA_SOURCE_FILE ("code-generation.galgas", 230)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-overObjectsDisplay")  COMMA_SOURCE_FILE ("code-generation.galgas", 231)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-shiftArrowKeyMagnitude")  COMMA_SOURCE_FILE ("code-generation.galgas", 232)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-underObjectsDisplay")  COMMA_SOURCE_FILE ("code-generation.galgas", 233)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-verticalFlip")  COMMA_SOURCE_FILE ("code-generation.galgas", 234)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-xPlacardUnit")  COMMA_SOURCE_FILE ("code-generation.galgas", 235)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-yPlacardUnit")  COMMA_SOURCE_FILE ("code-generation.galgas", 236)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-binding-zoom")  COMMA_SOURCE_FILE ("code-generation.galgas", 237)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-dragging-source")  COMMA_SOURCE_FILE ("code-generation.galgas", 238)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-draw")  COMMA_SOURCE_FILE ("code-generation.galgas", 239)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-guide")  COMMA_SOURCE_FILE ("code-generation.galgas", 240)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-issue")  COMMA_SOURCE_FILE ("code-generation.galgas", 241)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-key-down")  COMMA_SOURCE_FILE ("code-generation.galgas", 242)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-magnify-and-zoom")  COMMA_SOURCE_FILE ("code-generation.galgas", 243)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-menu-actions")  COMMA_SOURCE_FILE ("code-generation.galgas", 244)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-mouse-down-behaviours")  COMMA_SOURCE_FILE ("code-generation.galgas", 245)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-mouse-moved-exited")  COMMA_SOURCE_FILE ("code-generation.galgas", 246)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-mouse")  COMMA_SOURCE_FILE ("code-generation.galgas", 247)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-helpers")  COMMA_SOURCE_FILE ("code-generation.galgas", 248)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-tool-tips")  COMMA_SOURCE_FILE ("code-generation.galgas", 249)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicView-tracking-areas")  COMMA_SOURCE_FILE ("code-generation.galgas", 250)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicViewControllerProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 251)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBGraphicViewScaleProvider")  COMMA_SOURCE_FILE ("code-generation.galgas", 252)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBEnclosingGraphicView")  COMMA_SOURCE_FILE ("code-generation.galgas", 253)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("NSControl-extension-enable-binding")  COMMA_SOURCE_FILE ("code-generation.galgas", 254)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("extension-CGPoint-NSPoint")  COMMA_SOURCE_FILE ("code-generation.galgas", 256)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("extension-CGRect-NSRect")  COMMA_SOURCE_FILE ("code-generation.galgas", 257)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("extension-CGSize-NSSize")  COMMA_SOURCE_FILE ("code-generation.galgas", 258)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("extension-Data")  COMMA_SOURCE_FILE ("code-generation.galgas", 259)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("extension-NSBezierPath")  COMMA_SOURCE_FILE ("code-generation.galgas", 260)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("extension-NSObject")  COMMA_SOURCE_FILE ("code-generation.galgas", 261)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("extension-NSTextView")  COMMA_SOURCE_FILE ("code-generation.galgas", 262)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("extension-String")  COMMA_SOURCE_FILE ("code-generation.galgas", 263)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("extension-UInt32")  COMMA_SOURCE_FILE ("code-generation.galgas", 264)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBBezierPath")  COMMA_SOURCE_FILE ("code-generation.galgas", 266)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBLinePath")  COMMA_SOURCE_FILE ("code-generation.galgas", 267)) ;
      var_swiftFiles_4983.addAssign_operation (GALGAS_string ("EBShape")  COMMA_SOURCE_FILE ("code-generation.galgas", 268)) ;
    }
  }
  GALGAS_stringlist temp_2 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("code-generation.galgas", 270)) ;
  temp_2.addAssign_operation (GALGAS_string ("EBAllocationDebug")  COMMA_SOURCE_FILE ("code-generation.galgas", 270)) ;
  GALGAS_stringlist var_xibFiles_9691 = temp_2 ;
  GALGAS_filewrapper var_fw_9725 = GALGAS_filewrapper (gWrapperDirectory_0_swift_5F_sources) ;
  cEnumerator_stringlist enumerator_9787 (var_swiftFiles_4983, kENUMERATION_UP) ;
  while (enumerator_9787.hasCurrentObject ()) {
    GALGAS_string var_fileName_9807 = enumerator_9787.current_mValue (HERE).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 273)) ;
    GALGAS_string var_contents_9839 = var_fw_9725.getter_textFileContentsAtPath (var_fileName_9807, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 274)) ;
    ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_9807  COMMA_SOURCE_FILE ("code-generation.galgas", 275)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_9807, var_contents_9839, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 276)) ;
    }
    enumerator_9787.gotoNextObject () ;
  }
  cEnumerator_stringlist enumerator_10040 (var_xibFiles_9691, kENUMERATION_UP) ;
  while (enumerator_10040.hasCurrentObject ()) {
    GALGAS_string var_contents_10060 = var_fw_9725.getter_textFileContentsAtPath (enumerator_10040.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 283)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 283)) ;
    GALGAS_string var_fileName_10119 = enumerator_10040.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 284)) ;
    ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_10119  COMMA_SOURCE_FILE ("code-generation.galgas", 285)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_10119, var_contents_10060, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 286)) ;
    }
...
void routine_generateStandardProperties (const GALGAS_string constinArgument_inOutputDirectory,
                                         ...
                                         C_Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_contents_11180 = GALGAS_string (filewrapperTemplate_standard_5F_properties_stub (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 320))) ;
  var_contents_11180.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("UInt32"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 322))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 322)) ;
  var_contents_11180.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Int"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 323))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 323)) ;
  var_contents_11180.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Bool"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 324))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 324)) ;
  var_contents_11180.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Double"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 325))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 325)) ;
  var_contents_11180.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("String"), GALGAS_bool (false), GALGAS_string ("localizedStandardCompare") COMMA_SOURCE_FILE ("code-generation.galgas", 326))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 326)) ;
  var_contents_11180.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Data"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 327))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 327)) ;
  var_contents_11180.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Date"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 328))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 328)) ;
  var_contents_11180.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("BezierPathArray"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 329))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 329)) ;
  cEnumerator_stringlist enumerator_12032 (constinArgument_inPropertyClassList, kENUMERATION_UP) ;
  while (enumerator_12032.hasCurrentObject ()) {
    var_contents_11180.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, enumerator_12032.current_mValue (HERE), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 332))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 332)) ;
    enumerator_12032.gotoNextObject () ;
  }
  cEnumerator_transientExternTypeList enumerator_12200 (constinArgument_inTransientPropertyExternTypeList, kENUMERATION_UP) ;
  while (enumerator_12200.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = enumerator_12200.current_mIsClass (HERE).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_contents_11180.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, enumerator_12200.current_mTypeName (HERE), GALGAS_bool (false), GALGAS_bool (true) COMMA_SOURCE_FILE ("code-generation.galgas", 336))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 336)) ;
      }
    }
    if (kBoolFalse == test_0) {
      var_contents_11180.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, enumerator_12200.current_mTypeName (HERE), GALGAS_bool (true), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 338))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 338)) ;
    }
    enumerator_12200.gotoNextObject () ;
  }
  var_contents_11180.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, GALGAS_string ("NSBezierPath"), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 341))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 341)) ;
  var_contents_11180.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, GALGAS_string ("NSFont"), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 342))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 342)) ;
  var_contents_11180.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, GALGAS_string ("NSColor"), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 343))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 343)) ;
  GALGAS_string var_fileName_12730 = GALGAS_string ("standard-properties.swift") ;
  ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_12730  COMMA_SOURCE_FILE ("code-generation.galgas", 346)) ;
  {
  GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_12730, var_contents_11180, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 347)) ;
  }
}
