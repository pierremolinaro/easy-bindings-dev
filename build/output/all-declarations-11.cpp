...
void routine_generateSwiftApplicationFiles (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  GALGAS_stringlist var_swiftFiles_4990 = temp_0 ;
  enumGalgasBool test_1 = kBoolTrue ;
  if (kBoolTrue == test_1) {
    test_1 = constinArgument_inHasEntities.boolEnum () ;
    if (kBoolTrue == test_1) {
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBManagedObject")  COMMA_SOURCE_FILE ("code-generation.galgas", 215)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBDataScanner")  COMMA_SOURCE_FILE ("code-generation.galgas", 216)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicManagedObject")  COMMA_SOURCE_FILE ("code-generation.galgas", 217)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("buildPDFimage")  COMMA_SOURCE_FILE ("code-generation.galgas", 218)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBScrollView")  COMMA_SOURCE_FILE ("code-generation.galgas", 220)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBFocusRingView")  COMMA_SOURCE_FILE ("code-generation.galgas", 221)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView")  COMMA_SOURCE_FILE ("code-generation.galgas", 222)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-arrowKeyMagnitude")  COMMA_SOURCE_FILE ("code-generation.galgas", 223)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-backColor")  COMMA_SOURCE_FILE ("code-generation.galgas", 224)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-backgroundImage")  COMMA_SOURCE_FILE ("code-generation.galgas", 225)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-foregroundImage")  COMMA_SOURCE_FILE ("code-generation.galgas", 226)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridCrossColor")  COMMA_SOURCE_FILE ("code-generation.galgas", 227)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridDisplayFactor")  COMMA_SOURCE_FILE ("code-generation.galgas", 228)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridLineColor")  COMMA_SOURCE_FILE ("code-generation.galgas", 229)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridStep")  COMMA_SOURCE_FILE ("code-generation.galgas", 230)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-gridStyle")  COMMA_SOURCE_FILE ("code-generation.galgas", 231)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-horizontalFlip")  COMMA_SOURCE_FILE ("code-generation.galgas", 232)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-mouseGrid")  COMMA_SOURCE_FILE ("code-generation.galgas", 233)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-overObjectsDisplay")  COMMA_SOURCE_FILE ("code-generation.galgas", 234)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-shiftArrowKeyMagnitude")  COMMA_SOURCE_FILE ("code-generation.galgas", 235)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-underObjectsDisplay")  COMMA_SOURCE_FILE ("code-generation.galgas", 236)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-verticalFlip")  COMMA_SOURCE_FILE ("code-generation.galgas", 237)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-xPlacardUnit")  COMMA_SOURCE_FILE ("code-generation.galgas", 238)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-yPlacardUnit")  COMMA_SOURCE_FILE ("code-generation.galgas", 239)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-binding-zoom")  COMMA_SOURCE_FILE ("code-generation.galgas", 240)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-dragging-source")  COMMA_SOURCE_FILE ("code-generation.galgas", 241)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-draw")  COMMA_SOURCE_FILE ("code-generation.galgas", 242)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-guide")  COMMA_SOURCE_FILE ("code-generation.galgas", 243)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-issue")  COMMA_SOURCE_FILE ("code-generation.galgas", 244)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-key-down")  COMMA_SOURCE_FILE ("code-generation.galgas", 245)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-magnify-and-zoom")  COMMA_SOURCE_FILE ("code-generation.galgas", 246)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-menu-actions")  COMMA_SOURCE_FILE ("code-generation.galgas", 247)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-mouse-down-behaviours")  COMMA_SOURCE_FILE ("code-generation.galgas", 248)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-mouse-moved-exited")  COMMA_SOURCE_FILE ("code-generation.galgas", 249)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-mouse")  COMMA_SOURCE_FILE ("code-generation.galgas", 250)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-helpers")  COMMA_SOURCE_FILE ("code-generation.galgas", 251)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-tool-tips")  COMMA_SOURCE_FILE ("code-generation.galgas", 252)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicView-tracking-areas")  COMMA_SOURCE_FILE ("code-generation.galgas", 253)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicViewControllerProtocol")  COMMA_SOURCE_FILE ("code-generation.galgas", 254)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBGraphicViewScaleProvider")  COMMA_SOURCE_FILE ("code-generation.galgas", 255)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBEnclosingGraphicView")  COMMA_SOURCE_FILE ("code-generation.galgas", 256)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("NSControl-extension-enable-binding")  COMMA_SOURCE_FILE ("code-generation.galgas", 257)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("extension-CGPoint-NSPoint")  COMMA_SOURCE_FILE ("code-generation.galgas", 259)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("extension-CGRect-NSRect")  COMMA_SOURCE_FILE ("code-generation.galgas", 260)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("extension-CGSize-NSSize")  COMMA_SOURCE_FILE ("code-generation.galgas", 261)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("extension-Data")  COMMA_SOURCE_FILE ("code-generation.galgas", 262)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("extension-NSBezierPath")  COMMA_SOURCE_FILE ("code-generation.galgas", 263)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("extension-NSObject")  COMMA_SOURCE_FILE ("code-generation.galgas", 264)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("extension-NSTextView")  COMMA_SOURCE_FILE ("code-generation.galgas", 265)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("extension-String")  COMMA_SOURCE_FILE ("code-generation.galgas", 266)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("extension-UInt32")  COMMA_SOURCE_FILE ("code-generation.galgas", 267)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBBezierPath")  COMMA_SOURCE_FILE ("code-generation.galgas", 269)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBLinePath")  COMMA_SOURCE_FILE ("code-generation.galgas", 270)) ;
      var_swiftFiles_4990.addAssign_operation (GALGAS_string ("EBShape")  COMMA_SOURCE_FILE ("code-generation.galgas", 271)) ;
    }
  }
  GALGAS_stringlist var_xibFiles_9787 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("code-generation.galgas", 273)) ;
  GALGAS_filewrapper var_fw_9801 = GALGAS_filewrapper (gWrapperDirectory_0_swift_5F_sources) ;
  cEnumerator_stringlist enumerator_9863 (var_swiftFiles_4990, kENUMERATION_UP) ;
  while (enumerator_9863.hasCurrentObject ()) {
    GALGAS_string var_fileName_9883 = enumerator_9863.current_mValue (HERE).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 276)) ;
    GALGAS_string var_contents_9915 = var_fw_9801.getter_textFileContentsAtPath (var_fileName_9883, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 277)) ;
    ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_9883  COMMA_SOURCE_FILE ("code-generation.galgas", 278)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_9883, var_contents_9915, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 279)) ;
    }
    enumerator_9863.gotoNextObject () ;
  }
  cEnumerator_stringlist enumerator_10116 (var_xibFiles_9787, kENUMERATION_UP) ;
  while (enumerator_10116.hasCurrentObject ()) {
    GALGAS_string var_contents_10136 = var_fw_9801.getter_textFileContentsAtPath (enumerator_10116.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 286)), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 286)) ;
    GALGAS_string var_fileName_10195 = enumerator_10116.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 287)) ;
    ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_10195  COMMA_SOURCE_FILE ("code-generation.galgas", 288)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_10195, var_contents_10136, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 289)) ;
    }
...
void routine_generateStandardProperties (const GALGAS_string constinArgument_inOutputDirectory,
                                         ...
                                         C_Compiler * inCompiler
                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_contents_11256 = GALGAS_string (filewrapperTemplate_standard_5F_properties_stub (inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 323))) ;
  var_contents_11256.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("UInt32"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 325))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 325)) ;
  var_contents_11256.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Int"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 326))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 326)) ;
  var_contents_11256.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Bool"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 327))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 327)) ;
  var_contents_11256.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Double"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 328))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 328)) ;
  var_contents_11256.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("String"), GALGAS_bool (false), GALGAS_string ("localizedStandardCompare") COMMA_SOURCE_FILE ("code-generation.galgas", 329))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 329)) ;
  var_contents_11256.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Data"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 330))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 330)) ;
  var_contents_11256.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, GALGAS_string ("Date"), GALGAS_bool (false), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 331))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 331)) ;
  ...
  cEnumerator_stringlist enumerator_12108 (constinArgument_inPropertyClassList, kENUMERATION_UP) ;
  while (enumerator_12108.hasCurrentObject ()) {
    var_contents_11256.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, enumerator_12108.current_mValue (HERE), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 335))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 335)) ;
    enumerator_12108.gotoNextObject () ;
  }
  cEnumerator_transientExternTypeList enumerator_12276 (constinArgument_inTransientPropertyExternTypeList, kENUMERATION_UP) ;
  while (enumerator_12276.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = enumerator_12276.current_mIsClass (HERE).boolEnum () ;
      if (kBoolTrue == test_0) {
        var_contents_11256.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, enumerator_12276.current_mTypeName (HERE), GALGAS_bool (false), GALGAS_bool (true) COMMA_SOURCE_FILE ("code-generation.galgas", 339))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 339)) ;
      }
    }
    if (kBoolFalse == test_0) {
      var_contents_11256.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_scalarProperty (inCompiler, enumerator_12276.current_mTypeName (HERE), GALGAS_bool (true), GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE ("code-generation.galgas", 341))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 341)) ;
    }
    enumerator_12276.gotoNextObject () ;
  }
  var_contents_11256.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, GALGAS_string ("NSBezierPath"), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 344))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 344)) ;
  var_contents_11256.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, GALGAS_string ("NSFont"), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 345))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 345)) ;
  var_contents_11256.plusAssign_operation(GALGAS_string (filewrapperTemplate_standard_5F_properties_classProperty (inCompiler, GALGAS_string ("NSColor"), GALGAS_bool (false), GALGAS_bool (false) COMMA_SOURCE_FILE ("code-generation.galgas", 346))), inCompiler  COMMA_SOURCE_FILE ("code-generation.galgas", 346)) ;
  GALGAS_string var_fileName_12806 = GALGAS_string ("standard-properties.swift") ;
  ioArgument_ioGeneratedFileSet.addAssign_operation (var_fileName_12806  COMMA_SOURCE_FILE ("code-generation.galgas", 349)) ;
  {
  GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, var_fileName_12806, var_contents_11256, inCompiler COMMA_SOURCE_FILE ("code-generation.galgas", 350)) ;
  }
}
