...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//         Overriding category reader '@transientControllerDependencyForGeneration generateObserverReference'          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

static GALGAS_string categoryReader_transientControllerDependencyForGeneration_generateObserverReference (const cPtr_abstractTransientDependencyForGeneration * inObject,
                                                                                                          C_Compiler * inCompiler
                                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_transientControllerDependencyForGeneration * object = (const cPtr_transientControllerDependencyForGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_transientControllerDependencyForGeneration) ;
  result_outResult = object->mAttribute_mControllerName.mAttribute_string.add_operation (GALGAS_string ("\?."), inCompiler COMMA_SOURCE_FILE ("transientGeneration.galgas", 256)).add_operation (object->mAttribute_mMasterName.reader_string (SOURCE_FILE ("transientGeneration.galgas", 256)), inCompiler COMMA_SOURCE_FILE ("transientGeneration.galgas", 256)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_transientControllerDependencyForGeneration_generateObserverReference (void) {
  enterCategoryReader_generateObserverReference (kTypeDescriptor_GALGAS_transientControllerDependencyForGeneration.mSlotID,
                                                 categoryReader_transientControllerDependencyForGeneration_generateObserverReference) ;
}

//---------------------------------------------------------------------------------------------------------------------*

C_PrologueEpilogue gReader_transientControllerDependencyForGeneration_generateObserverReference (defineCategoryReader_transientControllerDependencyForGeneration_generateObserverReference, NULL) ;

//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//          Overriding category reader '@transientRootSignDependencyForGeneration generateObserverReference'           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

static GALGAS_string categoryReader_transientRootSignDependencyForGeneration_generateObserverReference (const cPtr_abstractTransientDependencyForGeneration * /* inObject */,
                                                                                                        C_Compiler * /* inCompiler */
                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("\?\?@@transientRootSignDependency\?\?") ;
...
static void defineCategoryReader_transientRootSignDependencyForGeneration_generateObserverReference (void) {
  enterCategoryReader_generateObserverReference (kTypeDescriptor_GALGAS_transientRootSignDependencyForGeneration.mSlotID,
                                                 categoryReader_transientRootSignDependencyForGeneration_generateObserverReference) ;
}

//---------------------------------------------------------------------------------------------------------------------*

C_PrologueEpilogue gReader_transientRootSignDependencyForGeneration_generateObserverReference (defineCategoryReader_transientRootSignDependencyForGeneration_generateObserverReference, NULL) ;

//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//            Overriding category reader '@transientLocalDependencyForGeneration generateObserverReference'            *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

static GALGAS_string categoryReader_transientLocalDependencyForGeneration_generateObserverReference (const cPtr_abstractTransientDependencyForGeneration * inObject,
                                                                                                     C_Compiler * /* inCompiler */
                                                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_transientLocalDependencyForGeneration * object = (const cPtr_transientLocalDependencyForGeneration *) inObject ;
...
static void defineCategoryReader_transientLocalDependencyForGeneration_generateObserverReference (void) {
  enterCategoryReader_generateObserverReference (kTypeDescriptor_GALGAS_transientLocalDependencyForGeneration.mSlotID,
                                                 categoryReader_transientLocalDependencyForGeneration_generateObserverReference) ;
}

//---------------------------------------------------------------------------------------------------------------------*

C_PrologueEpilogue gReader_transientLocalDependencyForGeneration_generateObserverReference (defineCategoryReader_transientLocalDependencyForGeneration_generateObserverReference, NULL) ;

//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//         Overriding category reader '@transientPreferenceDependencyForGeneration generateObserverReference'          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

static GALGAS_string categoryReader_transientPreferenceDependencyForGeneration_generateObserverReference (const cPtr_abstractTransientDependencyForGeneration * inObject,
                                                                                                          C_Compiler * inCompiler
                                                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_transientPreferenceDependencyForGeneration * object = (const cPtr_transientPreferenceDependencyForGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_transientPreferenceDependencyForGeneration) ;
  result_outResult = GALGAS_string ("g_").add_operation (object->mAttribute_mPreferencesName.mAttribute_string, inCompiler COMMA_SOURCE_FILE ("transientGeneration.galgas", 274)).add_operation (GALGAS_string ("\?."), inCompiler COMMA_SOURCE_FILE ("transientGeneration.galgas", 274)).add_operation (object->mAttribute_mMasterName.reader_string (SOURCE_FILE ("transientGeneration.galgas", 274)), inCompiler COMMA_SOURCE_FILE ("transientGeneration.galgas", 274)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_transientPreferenceDependencyForGeneration_generateObserverReference (void) {
  enterCategoryReader_generateObserverReference (kTypeDescriptor_GALGAS_transientPreferenceDependencyForGeneration.mSlotID,
                                                 categoryReader_transientPreferenceDependencyForGeneration_generateObserverReference) ;
}

//---------------------------------------------------------------------------------------------------------------------*

C_PrologueEpilogue gReader_transientPreferenceDependencyForGeneration_generateObserverReference (defineCategoryReader_transientPreferenceDependencyForGeneration_generateObserverReference, NULL) ;

//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//            Overriding category reader '@transientRootDependencyForGeneration generateObserverReference'             *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

static GALGAS_string categoryReader_transientRootDependencyForGeneration_generateObserverReference (const cPtr_abstractTransientDependencyForGeneration * inObject,
                                                                                                    C_Compiler * inCompiler
                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_transientRootDependencyForGeneration * object = (const cPtr_transientRootDependencyForGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_transientRootDependencyForGeneration) ;
  result_outResult = GALGAS_string ("rootObject.").add_operation (object->mAttribute_mMasterName.reader_string (SOURCE_FILE ("transientGeneration.galgas", 280)), inCompiler COMMA_SOURCE_FILE ("transientGeneration.galgas", 280)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_transientRootDependencyForGeneration_generateObserverReference (void) {
  enterCategoryReader_generateObserverReference (kTypeDescriptor_GALGAS_transientRootDependencyForGeneration.mSlotID,
                                                 categoryReader_transientRootDependencyForGeneration_generateObserverReference) ;
}

//---------------------------------------------------------------------------------------------------------------------*

C_PrologueEpilogue gReader_transientRootDependencyForGeneration_generateObserverReference (defineCategoryReader_transientRootDependencyForGeneration_generateObserverReference, NULL) ;

//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//      Overriding category reader '@transientRootRelationshipDependencyForGeneration generateObserverReference'       *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

static GALGAS_string categoryReader_transientRootRelationshipDependencyForGeneration_generateObserverReference (const cPtr_abstractTransientDependencyForGeneration * inObject,
                                                                                                                C_Compiler * inCompiler
                                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_transientRootRelationshipDependencyForGeneration * object = (const cPtr_transientRootRelationshipDependencyForGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_transientRootRelationshipDependencyForGeneration) ;
  result_outResult = GALGAS_string ("rootObject.").add_operation (object->mAttribute_mRelationshipName.reader_string (SOURCE_FILE ("transientGeneration.galgas", 286)), inCompiler COMMA_SOURCE_FILE ("transientGeneration.galgas", 286)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("transientGeneration.galgas", 286)).add_operation (object->mAttribute_mMasterName.reader_string (SOURCE_FILE ("transientGeneration.galgas", 286)), inCompiler COMMA_SOURCE_FILE ("transientGeneration.galgas", 286)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_transientRootRelationshipDependencyForGeneration_generateObserverReference (void) {
  enterCategoryReader_generateObserverReference (kTypeDescriptor_GALGAS_transientRootRelationshipDependencyForGeneration.mSlotID,
                                                 categoryReader_transientRootRelationshipDependencyForGeneration_generateObserverReference) ;
}

//---------------------------------------------------------------------------------------------------------------------*

C_PrologueEpilogue gReader_transientRootRelationshipDependencyForGeneration_generateObserverReference (defineCategoryReader_transientRootRelationshipDependencyForGeneration_generateObserverReference, NULL) ;
