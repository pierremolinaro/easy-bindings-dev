...
void extensionMethod_semanticAnalysis (const GALGAS_prefDeclaration inObject,
  ...
  GALGAS_regularBindingsGenerationList var_regularBindingsGenerationList_7413 ;
  GALGAS_multipleBindingGenerationList var_multipleBindingGenerationList_7483 ;
  GALGAS_actionBindingListForGeneration var_actionBindingListForGeneration_7555 ;
  GALGAS_decoratedOutletMap var_outletMap_7594 ;
  GALGAS_tableViewBindingGenerationList var_tableViewBindingGenerationList_7666 ;
  GALGAS_graphicArrayControllerGenerationList var_graphicArrayControllerGenerationList_7750 ;
  {
  routine_analyzeOutlets (GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE ("preferences.galgas", 175)), GALGAS_string::makeEmptyString (), constinArgument_inSemanticContext, inObject.mProperty_mOutletDeclarationList, constinArgument_inSemanticContext.getter_mPreferencesObservablePropertyMap (HERE), var_actionMap_6952, function_preferencesName (inCompiler COMMA_SOURCE_FILE ("preferences.galgas", 181)), ioArgument_ioGeneration, var_regularBindingsGenerationList_7413, var_multipleBindingGenerationList_7483, var_actionBindingListForGeneration_7555, var_outletMap_7594, var_tableViewBindingGenerationList_7666, var_graphicArrayControllerGenerationList_7750, inCompiler  COMMA_SOURCE_FILE ("preferences.galgas", 174)) ;
  }
  ...
  ioArgument_ioGeneration.mProperty_mPreferencesForGeneration.mProperty_mRegularBindingsGenerationList = var_regularBindingsGenerationList_7413 ;
  ioArgument_ioGeneration.mProperty_mPreferencesForGeneration.mProperty_mActionBindingListForGeneration = var_actionBindingListForGeneration_7555 ;
  ioArgument_ioGeneration.mProperty_mPreferencesForGeneration.mProperty_mMultipleBindingGenerationList = var_multipleBindingGenerationList_7483 ;
  ioArgument_ioGeneration.mProperty_mPreferencesForGeneration.mProperty_mOutletMap = var_outletMap_7594 ;
  ...
  ioArgument_ioGeneration.mProperty_mPreferencesForGeneration.mProperty_mTableViewBindingGenerationList = var_tableViewBindingGenerationList_7666 ;
  ioArgument_ioGeneration.mProperty_mGraphicArrayControllerGenerationList.plusAssign_operation(var_graphicArrayControllerGenerationList_7750, inCompiler  COMMA_SOURCE_FILE ("preferences.galgas", 202)) ;
}
...
mProperty_mGraphicArrayControllerGenerationList () {
}
...
GALGAS_structForGeneration::GALGAS_structForGeneration (const GALGAS_transientDefinitionListForGeneration & inOperand0,
                                                        ...
                                                        const GALGAS_objectControllerForGeneration & inOperand12,
                                                        const GALGAS_stringlist & inOperand13,
                                                        const GALGAS_transientExternTypeList & inOperand14,
                                                        const GALGAS_graphicArrayControllerGenerationList & inOperand15) :
...
mProperty_mObjectControllerListForGeneration (inOperand12),
mProperty_mPropertyClassList (inOperand13),
mProperty_mTransientPropertyTypeList (inOperand14),
mProperty_mGraphicArrayControllerGenerationList (inOperand15) {
}
...
GALGAS_structForGeneration GALGAS_structForGeneration::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_structForGeneration (GALGAS_transientDefinitionListForGeneration::constructor_emptyList (HERE),
                                     ...
                                     GALGAS_graphicArrayControllerGenerationList::constructor_emptyList (HERE)) ;
}
...
GALGAS_structForGeneration GALGAS_structForGeneration::constructor_new (const GALGAS_transientDefinitionListForGeneration & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid () && inOperand10.isValid () && inOperand11.isValid () && inOperand12.isValid () && inOperand13.isValid () && inOperand14.isValid () && inOperand15.isValid ()) {
    result = GALGAS_structForGeneration (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9, inOperand10, inOperand11, inOperand12, inOperand13, inOperand14, inOperand15) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_structForGeneration::objectCompare (const GALGAS_structForGeneration & inOperand) const {
  ...
  if (result == kOperandEqual) {
    result = mProperty_mGraphicArrayControllerGenerationList.objectCompare (inOperand.mProperty_mGraphicArrayControllerGenerationList) ;
  }
  return result ;
}
...
void GALGAS_structForGeneration::drop (void) {
  ...
  mProperty_mGraphicArrayControllerGenerationList.drop () ;
}
...
void GALGAS_structForGeneration::description (C_String & ioString,
  ...
  if (! isValid ()) {
    ...
    ioString << ", " ;
    mProperty_mGraphicArrayControllerGenerationList.description (ioString, inIndentation+1) ;
  }
  ioString << ">" ;
}
...
GALGAS_graphicArrayControllerGenerationList GALGAS_structForGeneration::getter_mGraphicArrayControllerGenerationList (UNUSED_LOCATION_ARGS) const {
  return mProperty_mGraphicArrayControllerGenerationList ;
}
...
static void extensionMethod_classDeclaration_semanticAnalysis (const cPtr_astDeclaration * inObject,
  ...
  while (enumerator_6855.hasCurrentObject ()) {
    ...
    GALGAS_customObjectControllerForGeneration joker_7162 = GALGAS_customObjectControllerForGeneration::constructor_emptyList (SOURCE_FILE ("class.galgas", 178)) ;
    GALGAS_objectControllerForGeneration joker_7202 = GALGAS_objectControllerForGeneration::constructor_emptyList (SOURCE_FILE ("class.galgas", 179)) ;
    callExtensionMethod_secondaryPropertySemanticAnalysis ((const cPtr_abstractSecondaryProperty *) enumerator_6855.current_mSecondaryProperty (HERE).ptr (), object->mProperty_mClassName.getter_string (HERE), GALGAS_string::makeEmptyString (), GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE ("class.galgas", 172)), constinArgument_inSemanticContext, var_observablePropertyMap_6333, var_transientDefinitionListForGeneration_6811, joker_7094, joker_7126, joker_7162, joker_7202, ioArgument_ioGeneration.mProperty_mNeededOutletClasses, inCompiler COMMA_SOURCE_FILE ("class.galgas", 169)) ;
    enumerator_6855.gotoNextObject () ;
  }
  ioArgument_ioGeneration.mProperty_mTransientListForGeneration.plusAssign_operation(var_transientDefinitionListForGeneration_6811, inCompiler  COMMA_SOURCE_FILE ("class.galgas", 183)) ;
  cEnumerator_externSwiftFunctionList enumerator_7431 (object->mProperty_mExternSwiftFunctionList, kENUMERATION_UP) ;
  while (enumerator_7431.hasCurrentObject ()) {
    const enumGalgasBool test_0 = function_externSwiftFunctionCallerSet (inCompiler COMMA_SOURCE_FILE ("class.galgas", 186)).getter_hasKey (enumerator_7431.current_mCallerName (HERE).getter_string (HERE) COMMA_SOURCE_FILE ("class.galgas", 186)).operator_not (SOURCE_FILE ("class.galgas", 186)).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_m_7523 = GALGAS_string ("allowed here:") ;
      cEnumerator_stringset enumerator_7588 (function_externSwiftFunctionCallerSet (inCompiler COMMA_SOURCE_FILE ("class.galgas", 188)), kENUMERATION_UP) ;
      while (enumerator_7588.hasCurrentObject ()) {
        var_m_7523.plusAssign_operation(GALGAS_string (" '").add_operation (enumerator_7588.current (HERE), inCompiler COMMA_SOURCE_FILE ("class.galgas", 189)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("class.galgas", 189)), inCompiler  COMMA_SOURCE_FILE ("class.galgas", 189)) ;
        if (enumerator_7588.hasNextObject ()) {
          var_m_7523.plusAssign_operation(GALGAS_string (","), inCompiler  COMMA_SOURCE_FILE ("class.galgas", 190)) ;
        }
        enumerator_7588.gotoNextObject () ;
      }
      TC_Array <C_FixItDescription> fixItArray1 ;
      inCompiler->emitSemanticError (enumerator_7431.current_mCallerName (HERE).getter_location (SOURCE_FILE ("class.galgas", 192)), var_m_7523, fixItArray1  COMMA_SOURCE_FILE ("class.galgas", 192)) ;
    }
    enumerator_7431.gotoNextObject () ;
  }
  GALGAS_actionMap var_actionMap_7758 = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE ("class.galgas", 196)) ;
  cEnumerator_lstringlist enumerator_7808 (object->mProperty_mActionDeclarationList, kENUMERATION_UP) ;
  while (enumerator_7808.hasCurrentObject ()) {
    {
    var_actionMap_7758.setter_insertKey (enumerator_7808.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("class.galgas", 198)) ;
    }
    ioArgument_ioGeneration.mProperty_mActionListForGeneration.addAssign_operation (object->mProperty_mClassName.getter_string (HERE), enumerator_7808.current_mValue (HERE).getter_string (HERE)  COMMA_SOURCE_FILE ("class.galgas", 199)) ;
    enumerator_7808.gotoNextObject () ;
  }
  ioArgument_ioGeneration.mProperty_mClassListForGeneration.addAssign_operation (object->mProperty_mClassName.getter_string (HERE), var_simpleStoredPropertyListForGeneration_6706, var_transientDefinitionListForGeneration_6811, object->mProperty_mExternSwiftFunctionList, object->mProperty_mExternSwiftDelegateList  COMMA_SOURCE_FILE ("class.galgas", 202)) ;
}
...
GALGAS_string filewrapperTemplate_classGenerationTemplate_classImplementationInSwift (C_Compiler * inCompiler,
    ...
    while (enumerator_4499.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_2) {
        ...
        result << "_property.readModelFunction = { [weak self] in\n"
          "      if let unwSelf = self {\n" ;
        result << extensionGetter_transientComputeFunctionCall (enumerator_4499.current_mDependencyList (HERE), in_CLASS_5F_NAME, enumerator_4499.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("class.swift.galgasTemplate", 100)).stringValue () ;
        result << "      }else{\n"
          "        return .empty\n"
          "      }\n"
          "    }\n" ;
        ...
        result << extensionGetter_transientComputeFunctionCall (enumerator_4499.current_mDependencyList (HERE), in_CLASS_5F_NAME, enumerator_4499.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("class.swift.galgasTemplate", 107)).stringValue () ;
        result << "    }\n" ;
      }
  ...
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_5088 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kENUMERATION_UP) ;
    while (enumerator_5088.hasCurrentObject ()) {
      GALGAS_uint index_5119_ (0) ;
      if (enumerator_5088.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_transientDependencyListForGeneration enumerator_5119 (enumerator_5088.current_mDependencyList (HERE), kENUMERATION_UP) ;
        while (enumerator_5119.hasCurrentObject ()) {
          result << "    " ;
          result << extensionGetter_generateAddObserverCall (enumerator_5119.current_mDependency (HERE), inCompiler COMMA_SOURCE_FILE ("class.swift.galgasTemplate", 115)).stringValue () ;
          result << " (" ;
          result << enumerator_5088.current_mTransientName (HERE).stringValue () ;
          result << "_property)\n" ;
  ...
  GALGAS_uint index_5294_ (0) ;
  if (in_EXTERN_5F_FUNCTION_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_externSwiftFunctionList enumerator_5294 (in_EXTERN_5F_FUNCTION_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kENUMERATION_UP) ;
    while (enumerator_5294.hasCurrentObject ()) {
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_5294.current_mCallerName (HERE).getter_string (HERE).objectCompare (GALGAS_string ("init"))).boolEnum () ;
      if (kBoolTrue == test_3) {
        result << "    " ;
        result << enumerator_5294.current_mExternSwiftFunctionName (HERE).getter_string (HERE).stringValue () ;
        result << " ()\n" ;
      }else if (kBoolFalse == test_3) {
      }
      index_5294_.increment () ;
      enumerator_5294.gotoNextObject () ;
    }
  }
  result << "  //--- Extern delegates\n" ;
  GALGAS_uint index_5494_idx (0) ;
  if (in_EXTERN_5F_DELEGATE_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_externSwiftDelegateList enumerator_5494 (in_EXTERN_5F_DELEGATE_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kENUMERATION_UP) ;
    while (enumerator_5494.hasCurrentObject ()) {
      result << "    mExternDelegate" ;
      result << index_5494_idx.getter_string (SOURCE_FILE ("class.swift.galgasTemplate", 128)).stringValue () ;
      result << " = " ;
      result << enumerator_5494.current_mExternSwiftDelegateName (HERE).getter_string (HERE).stringValue () ;
      result << " (object:self)\n" ;
      index_5494_idx.increment () ;
  ...
  GALGAS_uint index_6059_ (0) ;
  if (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_simpleStoredPropertyListForGeneration enumerator_6059 (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_6059.hasCurrentObject ()) {
      result << "    createEntryForPropertyNamed (\n"
        "      \"" ;
      result << enumerator_6059.current_mStoredPropertyName (HERE).stringValue () ;
      result << "\",\n"
        "      idx:self." ;
      result << enumerator_6059.current_mStoredPropertyName (HERE).stringValue () ;
  ...
  GALGAS_uint index_6813_ (0) ;
  if (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_simpleStoredPropertyListForGeneration enumerator_6813 (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_6813.hasCurrentObject ()) {
      result << "    self." ;
      result << enumerator_6813.current_mStoredPropertyName (HERE).stringValue () ;
      result << "_property.mObserverExplorer = nil\n"
        "    self." ;
      result << enumerator_6813.current_mStoredPropertyName (HERE).stringValue () ;
      result << "_property.mValueExplorer = nil\n" ;
      index_6813_.increment () ;
  ...
  if (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_simpleStoredPropertyListForGeneration enumerator_7424 (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_7424.hasCurrentObject ()) {
      result << "    self." ;
      result << enumerator_7424.current_mStoredPropertyName (HERE).stringValue () ;
  ...
  if (in_EXTERN_5F_FUNCTION_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_externSwiftFunctionList enumerator_7595 (in_EXTERN_5F_FUNCTION_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kENUMERATION_UP) ;
    while (enumerator_7595.hasCurrentObject ()) {
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_7595.current_mCallerName (HERE).getter_string (HERE).objectCompare (GALGAS_string ("saveIntoDictionary"))).boolEnum () ;
      if (kBoolTrue == test_4) {
        result << "    " ;
        result << enumerator_7595.current_mExternSwiftFunctionName (HERE).getter_string (HERE).stringValue () ;
        result << " ()\n" ;
      }else if (kBoolFalse == test_4) {
      }
  ...
  if (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_simpleStoredPropertyListForGeneration enumerator_8162 (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_8162.hasCurrentObject ()) {
      result << "    self." ;
      result << enumerator_8162.current_mStoredPropertyName (HERE).stringValue () ;
  ...
  if (in_EXTERN_5F_FUNCTION_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_externSwiftFunctionList enumerator_8333 (in_EXTERN_5F_FUNCTION_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kENUMERATION_UP) ;
    while (enumerator_8333.hasCurrentObject ()) {
      const enumGalgasBool test_5 = GALGAS_bool (kIsEqual, enumerator_8333.current_mCallerName (HERE).getter_string (HERE).objectCompare (GALGAS_string ("setUpWithDictionary"))).boolEnum () ;
      if (kBoolTrue == test_5) {
        result << "    " ;
        result << enumerator_8333.current_mExternSwiftFunctionName (HERE).getter_string (HERE).stringValue () ;
        result << " ()\n" ;
      }else if (kBoolFalse == test_5) {
      }
  ...
  result << "> {\n"
    "\n" ;
  GALGAS_uint index_9464_ (0) ;
  if (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_simpleStoredPropertyListForGeneration enumerator_9464 (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_9464.hasCurrentObject ()) {
      result << "  //\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\n"
        "  // Stored property '" ;
      result << enumerator_9464.current_mStoredPropertyName (HERE).stringValue () ;
      result << "'\n"
        "  //\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\n"
        "\n"
      ...
      result << "_property.removeEBObserver (observer)\n"
        ...
        "  }\n"
        "\n" ;
      index_9464_.increment () ;
      enumerator_9464.gotoNextObject () ;
    }
  }
  GALGAS_uint index_11218_ (0) ;
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_11218 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kENUMERATION_UP) ;
    while (enumerator_11218.hasCurrentObject ()) {
      result << "  //\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\n"
        "  // Transient property '" ;
      result << enumerator_11218.current_mTransientName (HERE).stringValue () ;
      result << "'\n"
        "  //\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\xC2""\xB7""\n"
        "\n"
        "  private var mObserversOf_" ;
  ...
  result << "] > {\n"
    ...
    "}\n"
    "\n" ;
  GALGAS_uint index_14967_ (0) ;
  if (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_simpleStoredPropertyListForGeneration enumerator_14967 (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_14967.hasCurrentObject ()) {
      ...
      result << in_CLASS_5F_NAME.stringValue () ;
      result << "_" ;
      result << enumerator_14967.current_mStoredPropertyName (HERE).stringValue () ;
      result << " : class {\n"
        "  var " ;
      result << enumerator_14967.current_mStoredPropertyName (HERE).stringValue () ;
      result << " : " ;
      result << extensionGetter_swiftTypeName (enumerator_14967.current_mType (HERE), inCompiler COMMA_SOURCE_FILE ("class.swift.galgasTemplate", 380)).stringValue () ;
      result << " { get }\n"
        "}\n"
        "\n" ;
      index_14967_.increment () ;
  ...
  GALGAS_uint index_17145_ (0) ;
  if (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_simpleStoredPropertyListForGeneration enumerator_17145 (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_17145.hasCurrentObject ()) {
      result << "        removeEBObserversOf_" ;
      result << enumerator_17145.current_mStoredPropertyName (HERE).stringValue () ;
      result << "_fromElementsOfSet (removedSet)\n" ;
      index_17145_.increment () ;
  ...
  if (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_simpleStoredPropertyListForGeneration enumerator_17374 (in_SIMPLE_5F_STORED_5F_PROPERTY_5F_LIST_5F_FOR_5F_GENERATION, kENUMERATION_UP) ;
    while (enumerator_17374.hasCurrentObject ()) {
      result << "        addEBObserversOf_" ;
      result << enumerator_17374.current_mStoredPropertyName (HERE).stringValue () ;
