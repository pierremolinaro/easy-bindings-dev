...
GALGAS_string filewrapperTemplate_enumGenerationTemplate_enumDeclaration (class C_Compiler * inCompiler,
...
GALGAS_string filewrapperTemplate_enumGenerationTemplate_enumGeneration (class C_Compiler * inCompiler,
                                                                         const class GALGAS_string & in_ENUM_5F_TYPE_5F_NAME,
                                                                         const class GALGAS_lstringlist & in_CONSTANT_5F_ORDERED_5F_LIST
                                                                         COMMA_LOCATION_ARGS) ;
