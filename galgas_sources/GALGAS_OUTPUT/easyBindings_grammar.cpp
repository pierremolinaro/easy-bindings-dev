...
, C_Lexique_easyBindings_5F_lexique::kToken_bind, SHIFT (53)
...
, END
// State S81 (index = 631)
, C_Lexique_easyBindings_5F_lexique::kToken_to, SHIFT (117)
, END
// State S82 (index = 634)
...
, C_Lexique_easyBindings_5F_lexique::kToken_default, SHIFT (147)
, END
// State S119 (index = 851)
, C_Lexique_easyBindings_5F_lexique::kToken_dependsFrom, SHIFT (148)
, END
...
, END
// State S145 (index = 1085)
, C_Lexique_easyBindings_5F_lexique::kToken__2E_, SHIFT (165)
, END
// State S146 (index = 1088)
, C_Lexique_easyBindings_5F_lexique::kToken_binding, SHIFT (166)
, END
// State S147 (index = 1091)
...
, C_Lexique_easyBindings_5F_lexique::kToken_yes, SHIFT (169)
, C_Lexique_easyBindings_5F_lexique::kToken_no, SHIFT (170)
, C_Lexique_easyBindings_5F_lexique::kToken_literal_5F_integer, SHIFT (171)
, C_Lexique_easyBindings_5F_lexique::kToken_literal_5F_double, SHIFT (172)
, C_Lexique_easyBindings_5F_lexique::kToken__28_, SHIFT (173)
, END
// State S148 (index = 1106)
...
, C_Lexique_easyBindings_5F_lexique::kToken_bind, SHIFT (181)
, END
// State S150 (index = 1118)
, C_Lexique_easyBindings_5F_lexique::kToken__7D_, REDUCE (62)
, END
// State S151 (index = 1121)
...
, C_Lexique_easyBindings_5F_lexique::kToken__2E_, SHIFT (194)
, END
// State S177 (index = 1293)
, C_Lexique_easyBindings_5F_lexique::kToken__2E_, SHIFT (195)
, END
// State S178 (index = 1296)
, C_Lexique_easyBindings_5F_lexique::kToken__2E_, SHIFT (196)
, END
...
, C_Lexique_easyBindings_5F_lexique::kToken_to, SHIFT (218)
, END
...
, C_Lexique_easyBindings_5F_lexique::kToken__28_, SHIFT (173)
, END
// State S223 (index = 1555)
, C_Lexique_easyBindings_5F_lexique::kToken__2C_, SHIFT (209)
, C_Lexique_easyBindings_5F_lexique::kToken__29_, REDUCE (72)
, END
// State S224 (index = 1560)
...
, END
// State S225 (index = 1569)
, C_Lexique_easyBindings_5F_lexique::kToken_count, SHIFT (236)
, END
// State S226 (index = 1572)
...
, END
// State S229 (index = 1587)
, C_Lexique_easyBindings_5F_lexique::kToken__3B_, REDUCE (81)
, END
// State S230 (index = 1590)
, C_Lexique_easyBindings_5F_lexique::kToken_column, SHIFT (237)
, END
// State S231 (index = 1593)
, C_Lexique_easyBindings_5F_lexique::kToken__7D_, REDUCE (89)
, C_Lexique_easyBindings_5F_lexique::kToken_property, SHIFT (54)
, C_Lexique_easyBindings_5F_lexique::kToken_transient, SHIFT (55)
, C_Lexique_easyBindings_5F_lexique::kToken_signature, SHIFT (103)
...
, C_Lexique_easyBindings_5F_lexique::kToken_column, REDUCE (54)
, END
// State S259 (index = 1731)
, C_Lexique_easyBindings_5F_lexique::kToken__3B_, REDUCE (52)
, C_Lexique_easyBindings_5F_lexique::kToken_column, SHIFT (253)
, END
// State S260 (index = 1736)
, C_Lexique_easyBindings_5F_lexique::kToken__3B_, REDUCE (53)
, END} ;

static const uint32_t gActionTableIndex [261] = {
  0  // S0
, 21  // S1
, 24  // S2
, 27  // S3
...
static const int16_t gSuccessorTable25 [3] = {32, 43, -1} ;

static const int16_t gSuccessorTable26 [3] = {36, 45, -1} ;
...
static const int16_t gSuccessorTable53 [3] = {15, 81, -1} ;
...
static const int16_t gSuccessorTable74 [9] = {13, 106,
  14, 107,
  37, 108,
  39, 109, -1} ;

static const int16_t gSuccessorTable75 [3] = {41, 111, -1} ;

static const int16_t gSuccessorTable98 [15] = {3, 121,
  4, 122,
  8, 123,
  13, 124,
  14, 125,
...
static const int16_t gSuccessorTable106 [9] = {13, 106,
  14, 107,
  37, 133,
  39, 109, -1} ;

static const int16_t gSuccessorTable107 [9] = {13, 106,
  14, 107,
  37, 134,
  39, 109, -1} ;

static const int16_t gSuccessorTable112 [3] = {21, 140, -1} ;
...
static const int16_t gSuccessorTable132 [3] = {38, 158, -1} ;

static const int16_t gSuccessorTable137 [3] = {41, 160, -1} ;

static const int16_t gSuccessorTable147 [5] = {11, 174,
  30, 175, -1} ;

static const int16_t gSuccessorTable148 [3] = {35, 180, -1} ;

static const int16_t gSuccessorTable166 [5] = {9, 190,
  27, 191, -1} ;

static const int16_t gSuccessorTable173 [5] = {11, 192,
  30, 175, -1} ;

static const int16_t gSuccessorTable180 [3] = {34, 199, -1} ;

static const int16_t gSuccessorTable181 [3] = {15, 200, -1} ;

static const int16_t gSuccessorTable182 [3] = {38, 201, -1} ;

static const int16_t gSuccessorTable183 [9] = {13, 106,
  14, 107,
  37, 202,
  39, 109, -1} ;

static const int16_t gSuccessorTable184 [3] = {40, 205, -1} ;

static const int16_t gSuccessorTable192 [3] = {31, 210, -1} ;

static const int16_t gSuccessorTable198 [3] = {35, 216, -1} ;

static const int16_t gSuccessorTable206 [3] = {22, 221, -1} ;

static const int16_t gSuccessorTable209 [5] = {11, 223,
  30, 175, -1} ;

static const int16_t gSuccessorTable213 [5] = {2, 226,
  23, 227, -1} ;

static const int16_t gSuccessorTable215 [5] = {2, 228,
  23, 227, -1} ;

static const int16_t gSuccessorTable216 [3] = {34, 229, -1} ;

static const int16_t gSuccessorTable222 [5] = {11, 234,
  30, 175, -1} ;

static const int16_t gSuccessorTable223 [3] = {31, 235, -1} ;

static const int16_t gSuccessorTable231 [9] = {13, 106,
  14, 107,
  37, 238,
  39, 109, -1} ;

static const int16_t gSuccessorTable234 [3] = {28, 241, -1} ;

static const int16_t gSuccessorTable243 [3] = {22, 247, -1} ;

static const int16_t gSuccessorTable248 [5] = {11, 250,
  30, 175, -1} ;

static const int16_t gSuccessorTable249 [5] = {9, 251,
  27, 191, -1} ;

static const int16_t gSuccessorTable250 [3] = {28, 252, -1} ;

static const int16_t gSuccessorTable251 [3] = {26, 254, -1} ;

static const int16_t gSuccessorTable258 [5] = {9, 259,
  27, 191, -1} ;

static const int16_t gSuccessorTable259 [3] = {26, 260, -1} ;

static const int16_t * gSuccessorTable [261] = {
...
static const int16_t gProductionsTable [103 * 2] = {
  0, 1,
  1, 8,
  2, 1,
  3, 4,
