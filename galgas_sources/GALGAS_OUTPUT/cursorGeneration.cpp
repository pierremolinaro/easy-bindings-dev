...
GALGAS_string filewrapperTemplate_cursorsGenerationTemplate_cursorsImplementation (C_Compiler * /* inCompiler */,
  ...
  if (in_CURSOR_5F_MAP.isValid ()) {
    ...
    while (enumerator_201.hasCurrentObject ()) {
      ...
      result << enumerator_201.current_mHotSpotX (HERE).reader_string (SOURCE_FILE ("cursors.m.gTemplate", 16)).stringValue () ;
      result << ", " ;
      result << enumerator_201.current_mHotSpotY (HERE).reader_string (SOURCE_FILE ("cursors.m.gTemplate", 16)).stringValue () ;
      result << ")\n"
        "    ] ;\n"
        "  }\n"
        "  return cursor ;\n"
...
void routine_generateCursorCode (const GALGAS_userCursorMap constinArgument_inUserCursorMap,
                                 ...
                                 COMMA_UNUSED_LOCATION_ARGS) {
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("cursorGeneration.gSemantics", 28)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (kIsStrictSup, constinArgument_inUserCursorMap.reader_count (SOURCE_FILE ("cursorGeneration.gSemantics", 28)).objectCompare (GALGAS_uint ((uint32_t) 0U))) COMMA_SOURCE_FILE ("cursorGeneration.gSemantics", 28)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_string var_s = GALGAS_string (filewrapperTemplate_cursorsGenerationTemplate_cursorsDeclaration (inCompiler, constinArgument_inUserCursorMap, constinArgument_inPredefinedCursorList COMMA_SOURCE_FILE ("cursorGeneration.gSemantics", 30))) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("cursors.h"), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_s, GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("cursorGeneration.gSemantics", 34)) ;
    }
    var_s = GALGAS_string (filewrapperTemplate_cursorsGenerationTemplate_cursorsImplementation (inCompiler, constinArgument_inUserCursorMap, constinArgument_inPredefinedCursorList COMMA_SOURCE_FILE ("cursorGeneration.gSemantics", 44))) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, GALGAS_string ("cursors.m"), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_s, GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("cursorGeneration.gSemantics", 48)) ;
    }
  }
}
