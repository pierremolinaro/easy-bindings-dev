...
GALGAS_string filewrapperTemplate_cursorsGenerationTemplate_cursorsDeclaration (C_Compiler * /* inCompiler */,
  ...
  if (in_PREDEFINED_5F_CURSOR_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_615 (in_PREDEFINED_5F_CURSOR_5F_LIST, kEnumeration_up) ;
    while (enumerator_615.hasCurrentObject ()) {
      result << "\n"
        "NSCursor * " ;
      result << enumerator_615.current_mValue (HERE).stringValue () ;
      result << "_cursor (void) ;\n" ;
...
GALGAS_string filewrapperTemplate_cursorsGenerationTemplate_cursorsImplementation (C_Compiler * /* inCompiler */,
  ...
  if (in_PREDEFINED_5F_CURSOR_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_842 (in_PREDEFINED_5F_CURSOR_5F_LIST, kEnumeration_up) ;
    while (enumerator_842.hasCurrentObject ()) {
      result << "//---------------------------------------------------------------------------*\n"
        "\n"
        "NSCursor * " ;
      result << enumerator_842.current_mValue (HERE).stringValue () ;
      result << "_cursor (void) {\n"
        "  return [NSCursor " ;
      result << enumerator_842.current_mValue (HERE).stringValue () ;
      result << "] ;\n"
