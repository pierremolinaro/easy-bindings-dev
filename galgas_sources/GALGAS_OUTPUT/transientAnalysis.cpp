...
void routine_analyzeTransientProperties (const GALGAS_transientList constinArgument_inTransientList,
  ...
  outArgument_outTransientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (276)) ;
  ...
  while (enumerator_10135.hasCurrentObject ()) {
    ...
    constinArgument_inSelfObjectObservablePropertyMap.method_searchKey (enumerator_10135.current_mTransientName (HERE), var_type, joker_10237_0, var_transientPropertySignature, joker_10289_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (278)) ;
    GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (286)) ;
    GALGAS_stringlist var_rootSignDependencyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (287)) ;
...
static void categoryMethod_transientRootSignDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mDeclarationLocation, GALGAS_string ("no root object in this context") COMMA_SOURCE_FILE_AT_LINE (32)) ;
  }
  {
  ioArgument_ioContextAnalysisStruct.mAttribute_mTransientDependencyGraph.modifier_addEdge (GALGAS_lstring::constructor_new (GALGAS_string ("entity.").operator_concat (constinArgument_inRootEntityName COMMA_SOURCE_FILE_AT_LINE (36)).operator_concat (GALGAS_string (".sign") COMMA_SOURCE_FILE_AT_LINE (36)), object->mAttribute_mDeclarationLocation COMMA_SOURCE_FILE_AT_LINE (36)), constinArgument_inTransientPropertySignature COMMA_SOURCE_FILE_AT_LINE (35)) ;
  }
  ioArgument_ioRootSignDependencyList.addAssign_operation (constinArgument_inTransientPropertySignature.mAttribute_string.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (40)) COMMA_SOURCE_FILE_AT_LINE (40)) COMMA_SOURCE_FILE_AT_LINE (40)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_transientLocalDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  constinArgument_inLocalObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_2348_0, var_masterPropertySignature, var_isCollection, inCompiler COMMA_SOURCE_FILE_AT_LINE (60)) ;
  const enumGalgasBool test_0 = object->mAttribute_mNamesCountOption.operator_and (var_isCollection.operator_not (SOURCE_FILE_AT_LINE (67)) COMMA_SOURCE_FILE_AT_LINE (67)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mMasterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the 'count' option is only allowed for to-many relationships") COMMA_SOURCE_FILE_AT_LINE (68)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = var_isCollection.operator_and (object->mAttribute_mNamesCountOption.operator_not (SOURCE_FILE_AT_LINE (69)) COMMA_SOURCE_FILE_AT_LINE (69)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mMasterName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("to-many relationships requires the 'count' option") COMMA_SOURCE_FILE_AT_LINE (70)) ;
    }
  }
  {
  ioArgument_ioContextAnalysisStruct.mAttribute_mTransientDependencyGraph.modifier_addEdge (var_masterPropertySignature, constinArgument_inTransientPropertySignature COMMA_SOURCE_FILE_AT_LINE (73)) ;
  }
  ioArgument_ioDirectDependancyList.addAssign_operation (GALGAS_transientDependencyFromSelfForImplementation::constructor_new (var_masterType, object->mAttribute_mMasterName.mAttribute_string, object->mAttribute_mNamesCountOption COMMA_SOURCE_FILE_AT_LINE (78)) COMMA_SOURCE_FILE_AT_LINE (78)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_transientControllerDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  constinArgument_inLocalObservablePropertyMap.method_searchKey (object->mAttribute_mControllerName, var_type, joker_3704_3, joker_3704_2, joker_3704_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (95)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_type.mAttribute_mKind.objectCompare (GALGAS_typeKind::constructor_controllerClassType (SOURCE_FILE_AT_LINE (100)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mControllerName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("'").operator_concat (object->mAttribute_mControllerName.reader_string (SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (101)).operator_concat (GALGAS_string ("' is not a controller") COMMA_SOURCE_FILE_AT_LINE (101)) COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }
  GALGAS_typeKind var_typeKind ;
  GALGAS_observablePropertyMap var_controllerObservablePropertyMap ;
  ioArgument_ioContextAnalysisStruct.mAttribute_mObservablePropertyMapMap.method_searchKey (var_type.mAttribute_mTypeName, var_typeKind, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (104)) ;
  GALGAS_ebType var_masterType ;
  GALGAS_lstring var_masterPropertySignature ;
  GALGAS_bool joker_4215_0 ; // Joker input parameter
  GALGAS_bool joker_4260_0 ; // Joker input parameter
  var_controllerObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_4215_0, var_masterPropertySignature, joker_4260_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (110)) ;
  {
  ioArgument_ioContextAnalysisStruct.mAttribute_mTransientDependencyGraph.modifier_addEdge (var_masterPropertySignature, constinArgument_inTransientPropertySignature COMMA_SOURCE_FILE_AT_LINE (118)) ;
  }
  ioArgument_ioDirectDependancyList.addAssign_operation (GALGAS_transientDependencyFromControllerForImplementation::constructor_new (var_masterType, object->mAttribute_mControllerName.mAttribute_string, object->mAttribute_mMasterName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (123)) COMMA_SOURCE_FILE_AT_LINE (123)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_transientRootDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  constinArgument_inRootObjectObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_5249_0, var_masterDependencyKey, var_isCollection, inCompiler COMMA_SOURCE_FILE_AT_LINE (139)) ;
  const enumGalgasBool test_0 = object->mAttribute_mNamesCountOption.operator_and (var_isCollection.operator_not (SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mMasterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the 'count' option is only allowed for to-many relationships") COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }
  {
  ioArgument_ioContextAnalysisStruct.mAttribute_mTransientDependencyGraph.modifier_addEdge (var_masterDependencyKey, constinArgument_inTransientPropertySignature COMMA_SOURCE_FILE_AT_LINE (151)) ;
  }
  ioArgument_ioDirectDependancyList.addAssign_operation (GALGAS_transientDependencyFromRootForImplementation::constructor_new (var_masterType, object->mAttribute_mMasterName.mAttribute_string, object->mAttribute_mNamesCountOption, var_masterDependencyKey.mAttribute_string.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (160)) COMMA_SOURCE_FILE_AT_LINE (156)) COMMA_SOURCE_FILE_AT_LINE (156)) ;
}
//-----------------------------------------------------------------------------*
...
static void categoryMethod_transientPreferenceDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  ioArgument_ioContextAnalysisStruct.mAttribute_mObservablePropertyMapMap.method_searchKey (object->mAttribute_mPreferencesName, var_kind, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (178)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_kind.objectCompare (GALGAS_typeKind::constructor_preferencesType (SOURCE_FILE_AT_LINE (184)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mPreferencesName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("'").operator_concat (object->mAttribute_mPreferencesName.reader_string (SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string ("' is not a preference") COMMA_SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)) ;
  }
  GALGAS_ebType var_masterType ;
  GALGAS_bool var_isTransient ;
  GALGAS_lstring var_masterPropertySignature ;
  GALGAS_bool joker_6932_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, var_isTransient, var_masterPropertySignature, joker_6932_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (188)) ;
  {
  ioArgument_ioContextAnalysisStruct.mAttribute_mTransientDependencyGraph.modifier_addEdge (var_masterPropertySignature, constinArgument_inTransientPropertySignature COMMA_SOURCE_FILE_AT_LINE (196)) ;
  }
  ioArgument_ioFileInclusionSet.mAttribute_mImplementationFileInclusionSet.addAssign_operation (object->mAttribute_mPreferencesName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (201)) ;
  ioArgument_ioDirectDependancyList.addAssign_operation (GALGAS_transientDependencyFromPreferenceForImplementation::constructor_new (var_masterType, object->mAttribute_mPreferencesName.mAttribute_string, object->mAttribute_mMasterName.mAttribute_string, var_isTransient COMMA_SOURCE_FILE_AT_LINE (203)) COMMA_SOURCE_FILE_AT_LINE (203)) ;
}
//-----------------------------------------------------------------------------*
