...
void routine_analyzeTransientProperties (const GALGAS_transientList constinArgument_inTransientList,
  ...
  cEnumerator_transientList enumerator_10133 (constinArgument_inTransientList, kEnumeration_up) ;
  while (enumerator_10133.hasCurrentObject ()) {
    GALGAS_ebType var_type ;
    GALGAS_lstring var_transientPropertySignature ;
    GALGAS_bool joker_10233_0 ; // Joker input parameter
    GALGAS_bool joker_10285_0 ; // Joker input parameter
    constinArgument_inSelfObjectObservablePropertyMap.method_searchKey (enumerator_10133.current_mTransientName (HERE), var_type, joker_10233_0, var_transientPropertySignature, joker_10285_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (278)) ;
...
static void categoryMethod_transientLocalDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  {
  ioArgument_ioContextAnalysisStruct.mAttribute_mTransientDependencyGraph.modifier_addArc (var_masterPropertySignature, constinArgument_inTransientPropertySignature COMMA_SOURCE_FILE_AT_LINE (73)) ;
  }
...
static void categoryMethod_transientControllerDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  GALGAS_ebType var_type ;
  GALGAS_bool joker_3703_3 ; // Joker input parameter
  GALGAS_lstring joker_3703_2 ; // Joker input parameter
  GALGAS_bool joker_3703_1 ; // Joker input parameter
  constinArgument_inLocalObservablePropertyMap.method_searchKey (object->mAttribute_mControllerName, var_type, joker_3703_3, joker_3703_2, joker_3703_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (95)) ;
  ...
  GALGAS_bool joker_4259_0 ; // Joker input parameter
  var_controllerObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_4214_0, var_masterPropertySignature, joker_4259_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (110)) ;
  {
  ioArgument_ioContextAnalysisStruct.mAttribute_mTransientDependencyGraph.modifier_addArc (var_masterPropertySignature, constinArgument_inTransientPropertySignature COMMA_SOURCE_FILE_AT_LINE (118)) ;
  }
...
static void categoryMethod_transientRootDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_5247_0 ; // Joker input parameter
  constinArgument_inRootObjectObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_5247_0, var_masterDependencyKey, var_isCollection, inCompiler COMMA_SOURCE_FILE_AT_LINE (139)) ;
  ...
  {
  ioArgument_ioContextAnalysisStruct.mAttribute_mTransientDependencyGraph.modifier_addArc (var_masterDependencyKey, constinArgument_inTransientPropertySignature COMMA_SOURCE_FILE_AT_LINE (151)) ;
  }
...
static void categoryMethod_transientPreferenceDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  GALGAS_lstring var_masterPropertySignature ;
  GALGAS_bool joker_6929_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, var_isTransient, var_masterPropertySignature, joker_6929_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (188)) ;
  {
  ioArgument_ioContextAnalysisStruct.mAttribute_mTransientDependencyGraph.modifier_addArc (var_masterPropertySignature, constinArgument_inTransientPropertySignature COMMA_SOURCE_FILE_AT_LINE (196)) ;
  }
