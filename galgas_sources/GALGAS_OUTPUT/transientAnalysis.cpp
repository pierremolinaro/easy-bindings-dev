...
void routine_buildTransientDependencyGraph (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  while (enumerator_5451.hasCurrentObject ()) {
    ...
    cEnumerator_arrayControllerMap enumerator_5989 (enumerator_5451.current_mArrayControllerMap (HERE), kEnumeration_up) ;
    while (enumerator_5989.hasCurrentObject ()) {
      {
      var_transientDependencyGraph.modifier_addNode (enumerator_5989.current_mPropertySignature (HERE), enumerator_5989.current_mPropertySignature (HERE).mAttribute_string, GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 181)) ;
      }
      {
      var_transientDependencyGraph.modifier_addEdge (callCategoryReader_propertySignature ((const cPtr_abstractObservablePropertyAST *) enumerator_5989.current_mBoundModel (HERE).ptr (), categoryReader_kindName (enumerator_5451.current_mTypeKind (HERE), inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 189)), enumerator_5451.current_lkey (HERE).mAttribute_string, enumerator_5451.current_mRootEntityType (HERE), inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 188)), enumerator_5989.current_mPropertySignature (HERE) COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 187)) ;
      }
      enumerator_5989.gotoNextObject () ;
    }
    cEnumerator_decoratedTransientMap enumerator_6559 (enumerator_5451.current_mDecoratedTransientMap (HERE), kEnumeration_up) ;
    while (enumerator_6559.hasCurrentObject ()) {
      ...
      if (constinArgument_inUnifiedTypeMap.reader_count (SOURCE_FILE ("transientAnalysis.gSemantics", 199)).isValid ()) {
        uint32_t variant_6715 = constinArgument_inUnifiedTypeMap.reader_count (SOURCE_FILE ("transientAnalysis.gSemantics", 199)).uintValue () ;
        bool loop_6715 = true ;
        while (loop_6715) {
          loop_6715 = var_t.reader_isNull (SOURCE_FILE ("transientAnalysis.gSemantics", 199)).operator_not (SOURCE_FILE ("transientAnalysis.gSemantics", 199)).isValid () ;
          if (loop_6715) {
            loop_6715 = var_t.reader_isNull (SOURCE_FILE ("transientAnalysis.gSemantics", 199)).operator_not (SOURCE_FILE ("transientAnalysis.gSemantics", 199)).boolValue () ;
          }
          if (loop_6715 && (0 == variant_6715)) {
            loop_6715 = false ;
            inCompiler->loopRunTimeVariantError (SOURCE_FILE ("transientAnalysis.gSemantics", 199)) ;
          }
          if (loop_6715) {
            variant_6715 -- ;
            cEnumerator_decoratedObservablePropertyMap enumerator_6818 (var_t.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 200)), kEnumeration_up) ;
            while (enumerator_6818.hasCurrentObject ()) {
              {
              var_allObservableProperties.modifier_insertKey (enumerator_6818.current_lkey (HERE), enumerator_6818.current_mPropertyType (HERE), enumerator_6818.current_mIsTransient (HERE), enumerator_6818.current_mPropertySignature (HERE), enumerator_6818.current_mIsCollection (HERE), inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 201)) ;
              }
              enumerator_6818.gotoNextObject () ;
            }
            var_t = var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 209)) ;
          }
        }
      }
      cEnumerator_dependanceList enumerator_7149 (enumerator_6559.current_mDependencyList (HERE), kEnumeration_up) ;
      while (enumerator_7149.hasCurrentObject ()) {
        callCategoryMethod_buildTransientDependencyGraph ((const cPtr_abstractTransientDependency *) enumerator_7149.current_mDependency (HERE).ptr (), constinArgument_inUnifiedTypeMap, var_transientDependencyGraph, enumerator_6559.current_lkey (HERE), var_allObservableProperties, enumerator_5451.current_mRootEntityType (HERE), enumerator_6559.current_mTransientSignature (HERE), inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 212)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bool joker_7797_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_7797_0, inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 227)) ;
  }
  ...
  if (kBoolTrue == test_1) {
    ...
    GALGAS_lstringlist joker_8042_0 ; // Joker input parameter
    GALGAS_lstringlist joker_8110_0 ; // Joker input parameter
    var_transientDependencyGraph.method_topologicalSort (outArgument_outSortedTransientNodes, joker_8042_0, var_unsortedNodes, joker_8110_0, inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 233)) ;
    ...
    if (kBoolTrue == test_2) {
      ...
      cEnumerator_transientDependencyGraphNodeInfoList enumerator_8300 (var_unsortedNodes, kEnumeration_up) ;
      while (enumerator_8300.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_8300.current_mSignature (HERE)  COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 242))  COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 242)) ;
...
static void categoryMethod_transientLocalDependency_transientDependencySemanticAnalysis (const cPtr_abstractTransientDependency * inObject,
  ...
  GALGAS_unifiedTypeProxy var_masterType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_9625_0 ; // Joker input parameter
  GALGAS_lstring joker_9632_0 ; // Joker input parameter
  constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_9625_0, joker_9632_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 273)) ;
  const enumGalgasBool test_0 = object->mAttribute_mNamesCountOption.operator_and (var_isCollection.operator_not (SOURCE_FILE ("transientAnalysis.gSemantics", 280)) COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 280)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mMasterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the 'count' option is only allowed for to-many relationships")  COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 281)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = var_isCollection.operator_and (object->mAttribute_mNamesCountOption.operator_not (SOURCE_FILE ("transientAnalysis.gSemantics", 282)) COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 282)).boolEnum () ;
    if (kBoolTrue == test_2) {
      GALGAS_location location_3 (object->mAttribute_mMasterName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("to-many relationships requires the 'count' option")  COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 283)) ;
    }
  }
  ioArgument_ioTransientDependencyListForGeneration.addAssign_operation (var_masterType, object->mAttribute_mMasterName.mAttribute_string  COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 285)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_transientControllerDependency_transientDependencySemanticAnalysis (const cPtr_abstractTransientDependency * inObject,
  ...
  macroValidSharedObject (object, cPtr_transientControllerDependency) ;
  GALGAS_unifiedTypeProxy var_controllerType ;
  GALGAS_bool joker_10653_0 ; // Joker input parameter
  GALGAS_lstring joker_10660_0 ; // Joker input parameter
  GALGAS_bool joker_10667_0 ; // Joker input parameter
  constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mControllerName, var_controllerType, joker_10653_0, joker_10660_0, joker_10667_0, inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 298)) ;
  GALGAS_decoratedObservablePropertyMap var_controllerObservablePropertyMap = var_controllerType.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 305)) ;
  GALGAS_unifiedTypeProxy var_masterType ;
  GALGAS_bool joker_10862_0 ; // Joker input parameter
  GALGAS_lstring joker_10869_0 ; // Joker input parameter
  GALGAS_bool joker_10876_0 ; // Joker input parameter
  var_controllerObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_10862_0, joker_10869_0, joker_10876_0, inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 306)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_controllerType.reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 313)).objectCompare (GALGAS_typeKind::constructor_controllerClassType (SOURCE_FILE ("transientAnalysis.gSemantics", 313)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mControllerName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mControllerName.reader_string (SOURCE_FILE ("transientAnalysis.gSemantics", 314))  COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 314)).operator_concat (GALGAS_string ("' attribute is not a controller")  COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 314))  COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 314)) ;
  }
  ioArgument_ioTransientDependencyListForGeneration.addAssign_operation (var_masterType, object->mAttribute_mMasterName.mAttribute_string  COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 317)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_transientRootDependency_transientDependencySemanticAnalysis (const cPtr_abstractTransientDependency * inObject,
  ...
  const cPtr_transientRootDependency * object = (const cPtr_transientRootDependency *) inObject ;
  macroValidSharedObject (object, cPtr_transientRootDependency) ;
  GALGAS_decoratedObservablePropertyMap var_allObservablePropertyMap = constinArgument_inRootEntityType.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 331)) ;
  GALGAS_unifiedTypeProxy var_t = constinArgument_inRootEntityType.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 332)) ;
  if (constinArgument_inUnifiedTypeMap.reader_count (SOURCE_FILE ("transientAnalysis.gSemantics", 333)).isValid ()) {
    uint32_t variant_11827 = constinArgument_inUnifiedTypeMap.reader_count (SOURCE_FILE ("transientAnalysis.gSemantics", 333)).uintValue () ;
    bool loop_11827 = true ;
    while (loop_11827) {
      loop_11827 = var_t.reader_isNull (SOURCE_FILE ("transientAnalysis.gSemantics", 333)).operator_not (SOURCE_FILE ("transientAnalysis.gSemantics", 333)).isValid () ;
      if (loop_11827) {
        loop_11827 = var_t.reader_isNull (SOURCE_FILE ("transientAnalysis.gSemantics", 333)).operator_not (SOURCE_FILE ("transientAnalysis.gSemantics", 333)).boolValue () ;
      }
      if (loop_11827 && (0 == variant_11827)) {
        loop_11827 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE ("transientAnalysis.gSemantics", 333)) ;
      }
      if (loop_11827) {
        variant_11827 -- ;
        cEnumerator_decoratedObservablePropertyMap enumerator_11926 (var_t.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 334)), kEnumeration_up) ;
        while (enumerator_11926.hasCurrentObject ()) {
          {
          var_allObservablePropertyMap.modifier_insertKey (enumerator_11926.current_lkey (HERE), enumerator_11926.current_mPropertyType (HERE), enumerator_11926.current_mIsTransient (HERE), enumerator_11926.current_mPropertySignature (HERE), enumerator_11926.current_mIsCollection (HERE), inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 335)) ;
          }
          enumerator_11926.gotoNextObject () ;
        }
        var_t = var_t.reader_mSuperType (inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 343)) ;
      }
    }
  }
  GALGAS_unifiedTypeProxy var_masterType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_12272_0 ; // Joker input parameter
  GALGAS_lstring joker_12279_0 ; // Joker input parameter
  var_allObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_12272_0, joker_12279_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 345)) ;
  const enumGalgasBool test_0 = object->mAttribute_mNamesCountOption.operator_and (var_isCollection.operator_not (SOURCE_FILE ("transientAnalysis.gSemantics", 353)) COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 353)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mMasterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the 'count' option is only allowed for to-many relationships")  COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 354)) ;
  }
  ioArgument_ioTransientDependencyListForGeneration.addAssign_operation (var_masterType, object->mAttribute_mMasterName.mAttribute_string  COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 357)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_transientPreferenceDependency_transientDependencySemanticAnalysis (const cPtr_abstractTransientDependency * inObject,
  ...
  GALGAS_decoratedObservablePropertyMap var_observablePropertyMap ;
  GALGAS_unifiedTypeProxy joker_13187_5 ; // Joker input parameter
  GALGAS_unifiedTypeProxy joker_13187_4 ; // Joker input parameter
  GALGAS_decoratedAttributeMap joker_13187_3 ; // Joker input parameter
  GALGAS_decoratedTransientMap joker_13187_2 ; // Joker input parameter
  GALGAS_decoratedOutletMap joker_13187_1 ; // Joker input parameter
  GALGAS_decoratedEntityRelationshipMap joker_13255_6 ; // Joker input parameter
  GALGAS_actionMap joker_13255_5 ; // Joker input parameter
  GALGAS_bindingList joker_13255_4 ; // Joker input parameter
  GALGAS_lstringlist joker_13255_3 ; // Joker input parameter
  GALGAS_enumConstantMap joker_13255_2 ; // Joker input parameter
  GALGAS_arrayControllerMap joker_13255_1 ; // Joker input parameter
  constinArgument_inUnifiedTypeMap.method_searchKey (object->mAttribute_mPreferencesName, var_kind, joker_13187_5, joker_13187_4, joker_13187_3, joker_13187_2, joker_13187_1, var_observablePropertyMap, joker_13255_6, joker_13255_5, joker_13255_4, joker_13255_3, joker_13255_2, joker_13255_1, inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 371)) ;
  ...
  GALGAS_unifiedTypeProxy var_masterType ;
  GALGAS_bool joker_13509_0 ; // Joker input parameter
  GALGAS_lstring joker_13516_0 ; // Joker input parameter
  GALGAS_bool joker_13559_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_13509_0, joker_13516_0, joker_13559_0, inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 383)) ;
