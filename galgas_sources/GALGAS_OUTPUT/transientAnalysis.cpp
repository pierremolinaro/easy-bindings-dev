...
void routine_analyzeTransientProperties (const GALGAS_transientList constinArgument_inTransientList,
  ...
  cEnumerator_transientList enumerator_10138 (constinArgument_inTransientList, kEnumeration_up) ;
  while (enumerator_10138.hasCurrentObject ()) {
    ...
    GALGAS_bool joker_10290_0 ; // Joker input parameter
    constinArgument_inSelfObjectObservablePropertyMap.method_searchKey (enumerator_10138.current_mTransientName (HERE), var_type, joker_10238_0, var_transientPropertySignature, joker_10290_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (278)) ;
    ...
    cEnumerator_dependanceList enumerator_10471 (enumerator_10138.current_mDependencyList (HERE), kEnumeration_up) ;
    while (enumerator_10471.hasCurrentObject ()) {
      callCategoryMethod_analyze ((const cPtr_abstractTransientDependency *) enumerator_10471.current_mDependency (HERE).ptr (), enumerator_10138.current_mTransientName (HERE), constinArgument_inSelfObjectObservablePropertyMap, constinArgument_inRootObjectObservablePropertyMap, constinArgument_inRootEntityName, var_transientPropertySignature, ioArgument_ioFileInclusionSet, ioArgument_ioContextAnalysisStruct, var_directDependancyList, var_rootSignDependencyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (289)) ;
      enumerator_10471.gotoNextObject () ;
    }
    outArgument_outTransientListForImplementation.addAssign_operation (var_type, enumerator_10138.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (302)), var_directDependancyList, var_rootSignDependencyList COMMA_SOURCE_FILE_AT_LINE (302)) ;
...
static void categoryMethod_transientLocalDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  GALGAS_bool joker_2349_0 ; // Joker input parameter
  constinArgument_inLocalObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_2349_0, var_masterPropertySignature, var_isCollection, inCompiler COMMA_SOURCE_FILE_AT_LINE (60)) ;
...
static void categoryMethod_transientControllerDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  GALGAS_ebType var_type ;
  GALGAS_bool joker_3705_3 ; // Joker input parameter
  GALGAS_lstring joker_3705_2 ; // Joker input parameter
  GALGAS_bool joker_3705_1 ; // Joker input parameter
  constinArgument_inLocalObservablePropertyMap.method_searchKey (object->mAttribute_mControllerName, var_type, joker_3705_3, joker_3705_2, joker_3705_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (95)) ;
  ...
  GALGAS_ebType var_masterType ;
  GALGAS_lstring var_masterPropertySignature ;
  GALGAS_bool joker_4216_0 ; // Joker input parameter
  GALGAS_bool joker_4261_0 ; // Joker input parameter
  var_controllerObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_4216_0, var_masterPropertySignature, joker_4261_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (110)) ;
  {
...
static void categoryMethod_transientRootDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_5250_0 ; // Joker input parameter
  constinArgument_inRootObjectObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_5250_0, var_masterDependencyKey, var_isCollection, inCompiler COMMA_SOURCE_FILE_AT_LINE (139)) ;
...
static void categoryMethod_transientPreferenceDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  GALGAS_lstring var_masterPropertySignature ;
  GALGAS_bool joker_6933_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, var_isTransient, var_masterPropertySignature, joker_6933_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (188)) ;
  {
