...
static void categoryMethod_transientPreferenceDependency_buildTransientDependencyGraph (const cPtr_abstractTransientDependency * inObject,
  ...
  GALGAS_decoratedEntityRelationshipMap joker_4744_3 ; // Joker input parameter
  GALGAS_actionMap joker_4744_2 ; // Joker input parameter
  GALGAS_bindingList joker_4744_1 ; // Joker input parameter
  constinArgument_inUnifiedTypeMap.method_searchKey (object->mAttribute_mPreferencesName, joker_4652_0, joker_4676_5, joker_4676_4, joker_4676_3, joker_4676_2, joker_4676_1, var_observablePropertyMap, joker_4744_3, joker_4744_2, joker_4744_1, inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 137)) ;
  GALGAS_lstring var_masterPropertySignature ;
...
static void categoryMethod_transientPreferenceDependency_transientDependencySemanticAnalysis (const cPtr_abstractTransientDependency * inObject,
  ...
  GALGAS_decoratedEntityRelationshipMap joker_12437_3 ; // Joker input parameter
  GALGAS_actionMap joker_12437_2 ; // Joker input parameter
  GALGAS_bindingList joker_12437_1 ; // Joker input parameter
  constinArgument_inUnifiedTypeMap.method_searchKey (object->mAttribute_mPreferencesName, var_kind, joker_12369_5, joker_12369_4, joker_12369_3, joker_12369_2, joker_12369_1, var_observablePropertyMap, joker_12437_3, joker_12437_2, joker_12437_1, inCompiler COMMA_SOURCE_FILE ("transientAnalysis.gSemantics", 350)) ;
