...
//                                         september 12th, 2014, at 21h39'18"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_transientManager_applicationInSwift (C_Compiler * inCompiler,
  ...
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    ...
    while (enumerator_2646.hasCurrentObject ()) {
      ...
      result << enumerator_2646.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 59)).stringValue () ;
      result << " } }\n"
        "  \n"
        "  init (object : " ;
      result << enumerator_2646.current_mValue (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE ("PMApplication.swift.gTemplate", 61)).reader_pathExtension (SOURCE_FILE ("PMApplication.swift.gTemplate", 61)).stringValue () ;
      result << ") {\n"
        ...
        "  func noteTransientDidChange () {\n"
        "    mTriggerObject\?." ;
      result << enumerator_2646.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 68)).stringValue () ;
      result << "_noteDidChange ()\n"
        ...
        "  func trigger () {\n"
        "    mTriggerObject\?." ;
      result << enumerator_2646.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 79)).stringValue () ;
      result << "_trigger ()\n"
        "  }\n"
        "}\n" ;
  ...
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    ...
    while (enumerator_5938.hasCurrentObject ()) {
      ...
      result << enumerator_5938.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 121)).stringValue () ;
      result << " = NSMutableSet () // " ;
      result << index_5938_idx.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 121)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 121)).stringValue () ;
      result << "\n" ;
  ...
  GALGAS_uint index_6488_idx (0) ;
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_6488 (in_TRANSIENT_5F_LIST, kEnumeration_up) ;
    while (enumerator_6488.hasCurrentObject ()) {
      result << "    case k_" ;
      result << enumerator_6488.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 133)).stringValue () ;
      result << " :\n"
        "      mTriggerSet_" ;
      result << enumerator_6488.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 134)).stringValue () ;
      result << ".addObject (inObject)\n"
        "      if TRACE_TRANSIENT_TRIGGER {\n"
        "        NSLog (\"Trigger " ;
      result << enumerator_6488.current_mValue (HERE).stringValue () ;
      result << ", %d objects\", mTriggerSet_" ;
      result << enumerator_6488.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 136)).stringValue () ;
      result << ".count)\n"
        "      }\n" ;
      index_6488_idx.increment () ;
  ...
  GALGAS_uint index_7923_idx (0) ;
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_7923 (in_TRANSIENT_5F_LIST, kEnumeration_down) ;
    while (enumerator_7923.hasCurrentObject ()) {
      result << "    if mTriggerSet_" ;
      result << enumerator_7923.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 176)).stringValue () ;
      result << ".count > 0 { // " ;
      result << in_TRANSIENT_5F_LIST.reader_length (SOURCE_FILE ("PMApplication.swift.gTemplate", 176)).substract_operation (index_7923_idx, inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 176)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 176)).stringValue () ;
      result << "\n"
        "      for anyObject in mTriggerSet_" ;
      result << enumerator_7923.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 177)).stringValue () ;
      result << " {\n"
        "        let object = anyObject as PMTriggerProtocol\n"
        "        object.trigger ()\n"
        "      }\n"
        "      mTriggerSet_" ;
      result << enumerator_7923.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 181)).stringValue () ;
      result << " = NSMutableSet ()\n"
        "    }    \n" ;
      index_7923_idx.increment () ;
