...
//                                         september 13th, 2014, at 13h15'7"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_transientManager_applicationInSwift (C_Compiler * inCompiler,
  ...
  result << "}\n"
    ...
    "}\n"
    "\n" ;
  GALGAS_uint index_2581_idx (0) ;
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_2581 (in_TRANSIENT_5F_LIST, kEnumeration_up) ;
    while (enumerator_2581.hasCurrentObject ()) {
      result << "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "class PMTrigger_" ;
      result << enumerator_2581.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 56)).stringValue () ;
      result << " : PMTriggerProtocol, PMUserClassName {\n"
        "  weak var mTriggerObject : " ;
      result << enumerator_2581.current_mValue (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE ("PMApplication.swift.gTemplate", 57)).reader_pathExtension (SOURCE_FILE ("PMApplication.swift.gTemplate", 57)).stringValue () ;
      result << "\? = nil\n"
        "\n"
        "  func userClassName () -> String { return \"PMTrigger_" ;
      result << enumerator_2581.current_mValue (HERE).stringValue () ;
      result << "\" }\n"
        "\n"
        "  var mTransientIndex : PMTransientIndex { get { return PMTransientIndex.k_" ;
      result << enumerator_2581.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 61)).stringValue () ;
      result << " } }\n"
        "\n"
        ...
        "  \n"
        "  init (object : " ;
      result << enumerator_2581.current_mValue (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE ("PMApplication.swift.gTemplate", 66)).reader_pathExtension (SOURCE_FILE ("PMApplication.swift.gTemplate", 66)).stringValue () ;
      result << ") {\n"
        ...
        "  func noteTransientDidChange () {\n"
        "    mTriggerObject\?." ;
      result << enumerator_2581.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 73)).stringValue () ;
      result << "_noteDidChange ()\n"
        ...
        "  func trigger () {\n"
        "    mTriggerObject\?." ;
      result << enumerator_2581.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 84)).stringValue () ;
      result << "_trigger ()\n"
        "  }\n"
        "}\n" ;
      index_2581_idx.increment () ;
