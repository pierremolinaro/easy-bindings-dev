...
void routine_generateTransients (const GALGAS_string constinArgument_inSourceFile,
  ...
  cEnumerator_transientListForGeneration enumerator_3037 (constinArgument_inTransientListForGeneration, kEnumeration_up) ;
  while (enumerator_3037.hasCurrentObject ()) {
    GALGAS_stringlist var_decomposedTransientSignature = enumerator_3037.current_mTransientSignature (HERE).reader_componentsSeparatedByString (GALGAS_string (".") COMMA_SOURCE_FILE ("transientGeneration.gSemantics", 80)) ;
    GALGAS_string var_s = GALGAS_string (filewrapperTemplate_transientManager_transientComputationFunctionFile (inCompiler, var_decomposedTransientSignature.reader_mValueAtIndex (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("transientGeneration.gSemantics", 82)), var_decomposedTransientSignature.reader_mValueAtIndex (GALGAS_uint ((uint32_t) 2U), inCompiler COMMA_SOURCE_FILE ("transientGeneration.gSemantics", 83)), enumerator_3037.current_mTransientDependencyListForGeneration (HERE), enumerator_3037.current_mTransientType (HERE) COMMA_SOURCE_FILE ("transientGeneration.gSemantics", 81))) ;
