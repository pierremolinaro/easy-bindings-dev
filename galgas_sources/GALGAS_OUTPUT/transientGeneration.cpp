...
//                                         september 13th, 2014, at 10h39'53"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_transientManager_applicationInSwift (C_Compiler * inCompiler,
  ...
  result << "\n"
    ...
    "}\n"
    "\n" ;
  GALGAS_uint index_2646_idx (0) ;
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_2646 (in_TRANSIENT_5F_LIST, kEnumeration_up) ;
    while (enumerator_2646.hasCurrentObject ()) {
      result << "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "@objc(PMTrigger_" ;
      result << enumerator_2646.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 55)).stringValue () ;
      result << ")\n"
        "class PMTrigger_" ;
      result << enumerator_2646.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 56)).stringValue () ;
      result << " : NSObject, PMTriggerProtocol, PMUserClassName {\n"
        "  weak var mTriggerObject : " ;
      result << enumerator_2646.current_mValue (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE ("PMApplication.swift.gTemplate", 57)).reader_pathExtension (SOURCE_FILE ("PMApplication.swift.gTemplate", 57)).stringValue () ;
      result << "\? = nil\n"
        "\n"
        "  func userClassName () -> String { return \"PMTrigger_" ;
      result << enumerator_2646.current_mValue (HERE).stringValue () ;
      result << "\" }\n"
        "\n"
        "  var mTransientIndex : Int { get { return k_" ;
      result << enumerator_2646.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 61)).stringValue () ;
      result << " } }\n"
        "  \n"
        "  init (object : " ;
      result << enumerator_2646.current_mValue (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE ("PMApplication.swift.gTemplate", 63)).reader_pathExtension (SOURCE_FILE ("PMApplication.swift.gTemplate", 63)).stringValue () ;
      result << ") {\n"
        ...
        "  func noteTransientDidChange () {\n"
        "    mTriggerObject\?." ;
      result << enumerator_2646.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 70)).stringValue () ;
      result << "_noteDidChange ()\n"
        ...
        "  func trigger () {\n"
        "    mTriggerObject\?." ;
      result << enumerator_2646.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 81)).stringValue () ;
      result << "_trigger ()\n"
        "  }\n"
        "}\n" ;
      index_2646_idx.increment () ;
  ...
  result << "\n"
    ...
    "  //-------------------------------------------------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_6021_idx (0) ;
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_6021 (in_TRANSIENT_5F_LIST, kEnumeration_up) ;
    while (enumerator_6021.hasCurrentObject ()) {
      result << "  private var mTriggerSet_" ;
      result << enumerator_6021.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 123)).stringValue () ;
      result << " = NSMutableSet () // " ;
      result << index_6021_idx.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 123)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 123)).stringValue () ;
      result << "\n" ;
      index_6021_idx.increment () ;
  ...
  GALGAS_uint index_6571_idx (0) ;
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_6571 (in_TRANSIENT_5F_LIST, kEnumeration_up) ;
    while (enumerator_6571.hasCurrentObject ()) {
      result << "    case k_" ;
      result << enumerator_6571.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 135)).stringValue () ;
      result << " :\n"
        "      mTriggerSet_" ;
      result << enumerator_6571.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 136)).stringValue () ;
      result << ".addObject (inObject)\n"
        "      if TRACE_TRANSIENT_TRIGGER {\n"
        "        NSLog (\"Trigger " ;
      result << enumerator_6571.current_mValue (HERE).stringValue () ;
      result << ", %d objects\", mTriggerSet_" ;
      result << enumerator_6571.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 138)).stringValue () ;
      result << ".count)\n"
        "      }\n" ;
      index_6571_idx.increment () ;
  ...
  GALGAS_uint index_8006_idx (0) ;
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_8006 (in_TRANSIENT_5F_LIST, kEnumeration_down) ;
    while (enumerator_8006.hasCurrentObject ()) {
      result << "    if mTriggerSet_" ;
      result << enumerator_8006.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 178)).stringValue () ;
      result << ".count > 0 { // " ;
      result << in_TRANSIENT_5F_LIST.reader_length (SOURCE_FILE ("PMApplication.swift.gTemplate", 178)).substract_operation (index_8006_idx, inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 178)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 178)).stringValue () ;
      result << "\n"
        "      for anyObject in mTriggerSet_" ;
      result << enumerator_8006.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 179)).stringValue () ;
      result << " {\n"
        "        let object = anyObject as PMTriggerProtocol\n"
        "        object.trigger ()\n"
        "      }\n"
        "      mTriggerSet_" ;
      result << enumerator_8006.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 183)).stringValue () ;
      result << " = NSMutableSet ()\n"
        "    }    \n" ;
      index_8006_idx.increment () ;
...
static GALGAS_string categoryReader_transientRootRelationshipDependencyForGeneration_generateActualParameterForComputeFunction (const cPtr_abstractTransientDependencyForGeneration * inObject,
  ...
  result_outResult = GALGAS_string ("(rootObject.").add_operation (object->mAttribute_mRelationshipName.mAttribute_string, inCompiler COMMA_SOURCE_FILE ("transientGeneration.gSemantics", 164)).add_operation (GALGAS_string (" as NSArray) as ["), inCompiler COMMA_SOURCE_FILE ("transientGeneration.gSemantics", 164)).add_operation (object->mAttribute_mElementType.reader_key (inCompiler COMMA_SOURCE_FILE ("transientGeneration.gSemantics", 164)), inCompiler COMMA_SOURCE_FILE ("transientGeneration.gSemantics", 164)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("transientGeneration.gSemantics", 164)).add_operation (object->mAttribute_mMasterName.reader_string (SOURCE_FILE ("transientGeneration.gSemantics", 164)), inCompiler COMMA_SOURCE_FILE ("transientGeneration.gSemantics", 164)).add_operation (GALGAS_string ("]"), inCompiler COMMA_SOURCE_FILE ("transientGeneration.gSemantics", 164)) ;
//---
  return result_outResult ;
}
