...
//                                         september 16th, 2014, at 22h45'56"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_transientManager_applicationInSwift (C_Compiler * inCompiler,
  ...
  GALGAS_uint index_8524_idx (0) ;
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_8524 (in_TRANSIENT_5F_LIST, kEnumeration_up) ;
    while (enumerator_8524.hasCurrentObject ()) {
      result << "    case PMTransientIndex.k_" ;
      result << enumerator_8524.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 175)).stringValue () ;
      result << " :\n"
        "      if logEvents () {\n"
        "        let str = NSString (format:\"+level %d, #%d:%@\\n\", transientIndex.rawValue, inObject.uniqueIndex, inObject.userClassName())\n"
        "        if transientIndex.rawValue >= mFlushLevel {\n"
      ...
      result << enumerator_8524.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 180)).stringValue () ;
      result << " [inObject.uniqueIndex] == nil {\n"
        ...
        "      }\n"
        "      mTriggerSet_" ;
      result << enumerator_8524.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 186)).stringValue () ;
      result << " [inObject.uniqueIndex] = inObject\n"
        "      if TRACE_TRANSIENT_TRIGGER {\n"
        "        NSLog (\"Trigger " ;
      result << enumerator_8524.current_mValue (HERE).stringValue () ;
      result << ", %d objects\", mTriggerSet_" ;
      result << enumerator_8524.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 188)).stringValue () ;
      result << ".count)\n"
        "      }\n" ;
      index_8524_idx.increment () ;
  ...
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_10625 (in_TRANSIENT_5F_LIST, kEnumeration_down) ;
    while (enumerator_10625.hasCurrentObject ()) {
      result << "    if mTriggerSet_" ;
      result << enumerator_10625.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 228)).stringValue () ;
      result << ".count > 0 { // " ;
      result << in_TRANSIENT_5F_LIST.reader_length (SOURCE_FILE ("PMApplication.swift.gTemplate", 228)).substract_operation (index_10625_idx, inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 228)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 228)).stringValue () ;
      result << "\n"
        "      emptyFlush = false\n"
        "      if logEvents () {\n"
        "        mTransientEventExplorerTextView\?.appendMessageString (\"-Flush level " ;
      result << in_TRANSIENT_5F_LIST.reader_length (SOURCE_FILE ("PMApplication.swift.gTemplate", 231)).substract_operation (index_10625_idx, inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 231)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 231)).stringValue () ;
      result << ": " ;
      result << enumerator_10625.current_mValue (HERE).stringValue () ;
      result << "\\n\")\n"
        "      }\n"
        "      mFlushLevel = " ;
      result << in_TRANSIENT_5F_LIST.reader_length (SOURCE_FILE ("PMApplication.swift.gTemplate", 233)).substract_operation (index_10625_idx, inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 233)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 233)).stringValue () ;
      result << "\n"
        "      for object in mTriggerSet_" ;
      result << enumerator_10625.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 234)).stringValue () ;
      result << ".values {\n"
        "        if logEvents () {\n"
        ...
        "      }\n"
        "      mTriggerSet_" ;
      result << enumerator_10625.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 240)).stringValue () ;
      result << " = [:]\n"
        "    }    \n" ;
  ...
  result << "    if mTriggerOutletDisplaySet.count > 0 {\n"
    ...
    "    }\n"
    "    mFlushLevel = " ;
  result << in_TRANSIENT_5F_LIST.reader_length (SOURCE_FILE ("PMApplication.swift.gTemplate", 257)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 257)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 257)).stringValue () ;
  result << "\n"
