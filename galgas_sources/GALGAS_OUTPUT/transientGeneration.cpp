...
//                                         september 16th, 2014, at 20h15'40"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_transientManager_applicationInSwift (C_Compiler * inCompiler,
  ...
  result << "\n"
    ...
    "  //-------------------------------------------------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_7288_idx (0) ;
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_7288 (in_TRANSIENT_5F_LIST, kEnumeration_up) ;
    while (enumerator_7288.hasCurrentObject ()) {
      result << "  private var mTriggerSet_" ;
      result << enumerator_7288.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 152)).stringValue () ;
      result << " : [Int : PMTriggerProtocol] = [:] // " ;
      result << index_7288_idx.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 152)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 152)).stringValue () ;
      result << "\n" ;
      index_7288_idx.increment () ;
  ...
  GALGAS_uint index_8106_idx (0) ;
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_8106 (in_TRANSIENT_5F_LIST, kEnumeration_up) ;
    while (enumerator_8106.hasCurrentObject ()) {
      result << "    case PMTransientIndex.k_" ;
      result << enumerator_8106.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 168)).stringValue () ;
      result << " :\n"
        "      mTriggerSet_" ;
      result << enumerator_8106.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 169)).stringValue () ;
      result << " [inObject.uniqueIndex] = inObject\n"
        "      if TRACE_TRANSIENT_TRIGGER {\n"
        "        NSLog (\"Trigger " ;
      result << enumerator_8106.current_mValue (HERE).stringValue () ;
      result << ", %d objects\", mTriggerSet_" ;
      result << enumerator_8106.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 171)).stringValue () ;
      result << ".count)\n"
        "      }\n" ;
      index_8106_idx.increment () ;
  ...
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_9579 (in_TRANSIENT_5F_LIST, kEnumeration_down) ;
    while (enumerator_9579.hasCurrentObject ()) {
      result << "    if mTriggerSet_" ;
      result << enumerator_9579.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 210)).stringValue () ;
      result << ".count > 0 { // " ;
      result << in_TRANSIENT_5F_LIST.reader_length (SOURCE_FILE ("PMApplication.swift.gTemplate", 210)).substract_operation (index_9579_idx, inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 210)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 210)).stringValue () ;
      result << "\n"
        "      if logEvents () {\n"
        "        mTransientEventExplorerTextView\?.appendMessageString (\"-Flush level " ;
      result << in_TRANSIENT_5F_LIST.reader_length (SOURCE_FILE ("PMApplication.swift.gTemplate", 212)).substract_operation (index_9579_idx, inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 212)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 212)).stringValue () ;
      result << ": " ;
      result << enumerator_9579.current_mValue (HERE).stringValue () ;
      result << "\\n\")\n"
        "      }\n"
        "      for object in mTriggerSet_" ;
      result << enumerator_9579.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 214)).stringValue () ;
      result << ".values {\n"
        "        if logEvents () {\n"
        ...
        "      }\n"
        "      mTriggerSet_" ;
      result << enumerator_9579.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 220)).stringValue () ;
      result << " = [:]\n"
        "    }    \n" ;
