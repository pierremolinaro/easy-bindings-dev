...
GALGAS_string filewrapperTemplate_transientManager_applicationInSwift (C_Compiler * inCompiler,
  ...
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    ...
    while (enumerator_1516.hasCurrentObject ()) {
      result << "  case k_" ;
      result << enumerator_1516.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 28)).stringValue () ;
      result << " // " ;
      result << index_1516_idx.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 28)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 28)).stringValue () ;
      result << "\n" ;
  ...
  result << "}\n"
    ...
    "//                                                                                                                     *\n"
    "//---------------------------------------------------------------------------------------------------------------------*\n" ;
  GALGAS_uint index_2242_idx (0) ;
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_2242 (in_TRANSIENT_5F_LIST, kEnumeration_up) ;
    while (enumerator_2242.hasCurrentObject ()) {
      result << "\n"
        "//---------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "class PMEvent_" ;
      result << enumerator_2242.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 43)).stringValue () ;
      result << " : PMTransientEventProtocol {\n"
        "  weak private var mObserver : " ;
      result << enumerator_2242.current_mValue (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE ("PMApplication.swift.gTemplate", 44)).reader_pathExtension (SOURCE_FILE ("PMApplication.swift.gTemplate", 44)).stringValue () ;
      result << "\? = nil\n"
        "\n"
        "  func userClassName () -> String { return \"PMEvent_" ;
      result << enumerator_2242.current_mValue (HERE).stringValue () ;
      result << "\" }\n"
        "\n"
        "  var transientEventIndex : PMTransientIndex { get { return PMTransientIndex.k_" ;
      result << enumerator_2242.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 48)).stringValue () ;
      result << " } }\n"
        "\n"
        ...
        "  \n"
        "  init (object : " ;
      result << enumerator_2242.current_mValue (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE ("PMApplication.swift.gTemplate", 53)).reader_pathExtension (SOURCE_FILE ("PMApplication.swift.gTemplate", 53)).stringValue () ;
      result << ") {\n"
        ...
        "    mObserver\?." ;
      result << enumerator_2242.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 60)).stringValue () ;
      result << "_noteDidChange ()\n"
        ...
        "  func trigger () {\n"
        "    mObserver\?." ;
      result << enumerator_2242.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 71)).stringValue () ;
      result << "_trigger ()\n"
        "  }\n"
        "}\n" ;
      index_2242_idx.increment () ;
  ...
  result << in_TRANSIENT_5F_LIST.reader_length (SOURCE_FILE ("PMApplication.swift.gTemplate", 107)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 107)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 107)).stringValue () ;
  result << "\n"
    ...
    "  //-------------------------------------------------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_7202_idx (0) ;
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_7202 (in_TRANSIENT_5F_LIST, kEnumeration_up) ;
    while (enumerator_7202.hasCurrentObject ()) {
      result << "  private var mTriggerSet_" ;
      result << enumerator_7202.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 149)).stringValue () ;
      result << " : [Int : PMTransientEventProtocol] = [:] // " ;
      result << index_7202_idx.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 149)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 149)).stringValue () ;
      result << "\n" ;
      index_7202_idx.increment () ;
  ...
  GALGAS_uint index_8388_idx (0) ;
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_8388 (in_TRANSIENT_5F_LIST, kEnumeration_up) ;
    while (enumerator_8388.hasCurrentObject ()) {
      result << "    case PMTransientIndex.k_" ;
      result << enumerator_8388.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 171)).stringValue () ;
      result << " :\n"
        "      if logEvents () {\n"
        "        let str = NSString (format:\"+level %d, #%d:%@\\n\", transientIndex.rawValue, inObject.uniqueIndex, inObject.userClassName())\n"
        "        if transientIndex.rawValue >= mFlushLevel {\n"
      ...
      result << enumerator_8388.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 176)).stringValue () ;
      result << " [inObject.uniqueIndex] == nil {\n"
        ...
        "      }\n"
        "      mTriggerSet_" ;
      result << enumerator_8388.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 182)).stringValue () ;
      result << " [inObject.uniqueIndex] = inObject\n" ;
      index_8388_idx.increment () ;
  ...
  if (in_TRANSIENT_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_10341 (in_TRANSIENT_5F_LIST, kEnumeration_down) ;
    while (enumerator_10341.hasCurrentObject ()) {
      result << "    if mTriggerSet_" ;
      result << enumerator_10341.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 221)).stringValue () ;
      result << ".count > 0 { // " ;
      result << in_TRANSIENT_5F_LIST.reader_length (SOURCE_FILE ("PMApplication.swift.gTemplate", 221)).substract_operation (index_10341_idx, inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 221)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 221)).stringValue () ;
      result << "\n"
        "      emptyFlush = false\n"
        "      if logEvents () {\n"
        "        mTransientEventExplorerTextView\?.appendMessageString (\"-Flush level " ;
      result << in_TRANSIENT_5F_LIST.reader_length (SOURCE_FILE ("PMApplication.swift.gTemplate", 224)).substract_operation (index_10341_idx, inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 224)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 224)).stringValue () ;
      result << ": " ;
      result << enumerator_10341.current_mValue (HERE).stringValue () ;
      result << "\\n\")\n"
        "      }\n"
        "      mFlushLevel = " ;
      result << in_TRANSIENT_5F_LIST.reader_length (SOURCE_FILE ("PMApplication.swift.gTemplate", 226)).substract_operation (index_10341_idx, inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 226)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 226)).stringValue () ;
      result << "\n"
        "      for object in mTriggerSet_" ;
      result << enumerator_10341.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 227)).stringValue () ;
      result << ".values {\n"
        "        if logEvents () {\n"
        ...
        "      }\n"
        "      mTriggerSet_" ;
      result << enumerator_10341.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE ("PMApplication.swift.gTemplate", 233)).stringValue () ;
      result << " = [:]\n"
        "    }    \n" ;
  ...
  result << "    if mTriggerOutletDisplaySet.count > 0 {\n"
    ...
    "    }\n"
    "    mFlushLevel = " ;
  result << in_TRANSIENT_5F_LIST.reader_length (SOURCE_FILE ("PMApplication.swift.gTemplate", 250)).add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("PMApplication.swift.gTemplate", 250)).reader_string (SOURCE_FILE ("PMApplication.swift.gTemplate", 250)).stringValue () ;
  result << "\n"
