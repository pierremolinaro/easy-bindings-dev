...
//                                         september 15th, 2014, at 18h15'59"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
//--- File '/PMButton.enabled.Bool.model.txt'

const char * gWrapperFileContent_0_controllerTemplates = "@objc(Controller_$OBJECTCLASS$_$MODEL$_PMButton_enabled)\n"
  "class Controller_$OBJECTCLASS$_$MODEL$_PMButton_enabled : NSObject, PMTriggerProtocol, PMUserClassName {\n"
  "\n"
  ...
  "  //-------------------------------------------------------------------------------------------------------------------*\n"
  " \n"
  "  func userClassName () -> String { return \"Controller.$OBJECTCLASS$.$MODEL$.PMButton.enabled\" }\n"
  "\n"
  "  //-------------------------------------------------------------------------------------------------------------------*\n"
  "\n"
...
const cRegularFileWrapper gWrapperFile_0_controllerTemplates (
  "PMButton.enabled.Bool.model.txt",
  "txt",
  true, // Text file
  2650, // Text length
...
const char * gWrapperFileContent_1_controllerTemplates = "@objc(Controller_$OBJECTCLASS$_$MODEL$_PMColorWell_color)\n"
  "class Controller_$OBJECTCLASS$_$MODEL$_PMColorWell_color : NSObject, PMTriggerProtocol, PMUserClassName {\n"
  "\n"
  "  weak var mObject : $OBJECTCLASS$\? = nil\n"
...
const char * gWrapperFileContent_3_controllerTemplates = "@objc(Controller_$OBJECTCLASS$_$MODEL$_PMMatrix_selectedIndex)\n"
  "class Controller_$OBJECTCLASS$_$MODEL$_PMMatrix_selectedIndex : NSObject, PMTriggerProtocol, PMUserClassName {\n"
  "\n"
  "  weak var mObject : $OBJECTCLASS$\? = nil\n"
...
const char * gWrapperFileContent_4_controllerTemplates = "@objc(Controller_$OBJECTCLASS$_$MODEL$_PMNumberField_rvalue)\n"
  "class Controller_$OBJECTCLASS$_$MODEL$_PMNumberField_rvalue : NSObject, PMTriggerProtocol, NSTextFieldDelegate, PMUserClassName {\n"
  "\n"
  "  weak var mObject : $OBJECTCLASS$\? = nil\n"
...
const char * gWrapperFileContent_5_controllerTemplates = "@objc(Controller_$OBJECTCLASS$_$MODEL$_PMNumberField_value)\n"
...
const char * gWrapperFileContent_6_controllerTemplates = "@objc(Controller_$OBJECTCLASS$_$MODEL$_PMTextField_rvalue)\n"
  "class Controller_$OBJECTCLASS$_$MODEL$_PMTextField_rvalue : NSObject, PMTriggerProtocol, PMUserClassName {\n"
  "\n"
  "  weak var mObject : $OBJECTCLASS$\? = nil\n"
...
const char * gWrapperFileContent_7_controllerTemplates = "@objc(Controller_$OBJECTCLASS$_$MODEL$_PMTextField_value)\n"
  "class Controller_$OBJECTCLASS$_$MODEL$_PMTextField_value : NSObject, PMTriggerProtocol, PMUserClassName {\n"
  "\n"
  "  weak var mObject : $OBJECTCLASS$\? = nil\n"
  "  weak var mOutlet: PMTextField\? = nil\n"
  "\n"
...
void routine_buildControllerTemplateMap (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  outArgument_outTemplateControllerMap = GALGAS_templateControllerMap::constructor_emptyMap (SOURCE_FILE ("controllerClassAnalysis.gSemantics", 38)) ;
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_controllerTemplates) ;
  cEnumerator_controllerTemplateList enumerator_1334 (constinArgument_inControllerTemplateList, kEnumeration_up) ;
  while (enumerator_1334.hasCurrentObject ()) {
    GALGAS_lstring var_templateName = GALGAS_lstring::constructor_new (enumerator_1334.current_mOutletClassName (HERE).mAttribute_string.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 42)).add_operation (enumerator_1334.current_mBindingName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 42)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 42)).add_operation (enumerator_1334.current_mModelTypeName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 42)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 42)).add_operation (enumerator_1334.current_mModelSelector (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 42)), enumerator_1334.current_mBindingName (HERE).mAttribute_location  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 41)) ;
    GALGAS_string var_templateText = var_fw.reader_textFileContentsAtPath (GALGAS_string ("/").add_operation (var_templateName.reader_string (SOURCE_FILE ("controllerClassAnalysis.gSemantics", 45)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 45)).add_operation (GALGAS_string (".txt"), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 45)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 45)) ;
    GALGAS_unifiedTypeProxy var_modelTypeProxy = GALGAS_unifiedTypeProxy::constructor_searchKey (constinArgument_inUnifiedTypeMap, enumerator_1334.current_mModelTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 46)) ;
    GALGAS_controllerBindingOptionDecoratedList var_controllerBindingOptionDecoratedList = GALGAS_controllerBindingOptionDecoratedList::constructor_emptyList (SOURCE_FILE ("controllerClassAnalysis.gSemantics", 47)) ;
    cEnumerator_controllerBindingOptionList enumerator_1837 (enumerator_1334.current_mBindingOptionList (HERE), kEnumeration_up) ;
    while (enumerator_1837.hasCurrentObject ()) {
      GALGAS_unifiedTypeProxy var_bindingOptionTypeProxy = GALGAS_unifiedTypeProxy::constructor_searchKey (constinArgument_inUnifiedTypeMap, enumerator_1837.current_mOptionTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 49)) ;
      var_controllerBindingOptionDecoratedList.addAssign_operation (enumerator_1837.current_mOptionName (HERE), var_bindingOptionTypeProxy  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 50)) ;
      enumerator_1837.gotoNextObject () ;
    }
    {
    outArgument_outTemplateControllerMap.modifier_insertKey (var_templateName, var_templateText, var_modelTypeProxy, enumerator_1334.current_mModelSelector (HERE), enumerator_1334.current_mModelShouldBeWritableProperty (HERE), var_controllerBindingOptionDecoratedList, inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 52)) ;
    }
