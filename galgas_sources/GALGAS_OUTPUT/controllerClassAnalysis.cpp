...
static void categoryMethod_controllerClassDeclaration_semanticAnalysis (const cPtr_astDeclaration * inObject,
  ...
  cEnumerator_lstringlist enumerator_3275 (object->mAttribute_mActionDeclarationList, kEnumeration_up) ;
  while (enumerator_3275.hasCurrentObject ()) {
    {
    var_actionMap.modifier_insertKey (enumerator_3275.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (99)) ;
    }
    enumerator_3275.gotoNextObject () ;
  }
  GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (102)) ;
  cEnumerator_outletClassBindingList enumerator_3417 (object->mAttribute_mBindingList, kEnumeration_up) ;
  while (enumerator_3417.hasCurrentObject ()) {
    ...
    cEnumerator_bindingOptionList enumerator_3525 (enumerator_3417.current_mBindingOptionList (HERE), kEnumeration_up) ;
    while (enumerator_3525.hasCurrentObject ()) {
      ...
      cEnumerator_lstringlist enumerator_3613 (enumerator_3525.current_mAcceptableTypeList (HERE), kEnumeration_up) ;
      while (enumerator_3613.hasCurrentObject ()) {
        GALGAS_ebType var_type ;
        GALGAS_astDeclaration joker_3674_0 ; // Joker input parameter
        constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_3613.current_mValue (HERE), var_type, joker_3674_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) ;
        var_acceptableTypeList.addAssign_operation (var_type COMMA_SOURCE_FILE_AT_LINE (109)) ;
        enumerator_3613.gotoNextObject () ;
      }
      {
      var_outletClassBindingOptionMap.modifier_insertKey (enumerator_3525.current_mBindingOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (111)) ;
      }
    ...
    cEnumerator_attributeASTTypeAndFormatterList enumerator_3957 (enumerator_3417.current_mAcceptableTypeFormatterList (HERE), kEnumeration_up) ;
    while (enumerator_3957.hasCurrentObject ()) {
      GALGAS_ebType var_type ;
      GALGAS_astDeclaration joker_4019_0 ; // Joker input parameter
      constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_3957.current_mTypeName (HERE), var_type, joker_4019_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) ;
      var_acceptableTypeFormatterList.addAssign_operation (var_type, enumerator_3957.current_mRequiredFormatter (HERE) COMMA_SOURCE_FILE_AT_LINE (116)) ;
      enumerator_3957.gotoNextObject () ;
    }
    {
    var_bindingMap.modifier_insertKey (enumerator_3417.current_mBindingName (HERE), var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (118)) ;
    }
    enumerator_3417.gotoNextObject () ;
  }
  ...
  cEnumerator_bindingOptionList enumerator_4363 (object->mAttribute_mControlledObjectBindingOptionList, kEnumeration_up) ;
  while (enumerator_4363.hasCurrentObject ()) {
    ...
    cEnumerator_lstringlist enumerator_4447 (enumerator_4363.current_mAcceptableTypeList (HERE), kEnumeration_up) ;
    while (enumerator_4447.hasCurrentObject ()) {
      GALGAS_ebType var_type ;
      GALGAS_astDeclaration joker_4506_0 ; // Joker input parameter
      constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_4447.current_mValue (HERE), var_type, joker_4506_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (125)) ;
      var_acceptableTypeList.addAssign_operation (var_type COMMA_SOURCE_FILE_AT_LINE (126)) ;
      enumerator_4447.gotoNextObject () ;
    }
    {
    var_controlledObjectAvailableBindingOptionMap.modifier_insertKey (enumerator_4363.current_mBindingOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (128)) ;
    }
    enumerator_4363.gotoNextObject () ;
  }
  GALGAS_observablePropertyMap var_observablePropertyMap ;
  GALGAS_typeKind joker_4783_0 ; // Joker input parameter
  ioArgument_ioContextAnalysisStruct.mAttribute_mObservablePropertyMapMap.method_searchKey (object->mAttribute_mControllerClassName, joker_4783_0, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (131)) ;
  {
