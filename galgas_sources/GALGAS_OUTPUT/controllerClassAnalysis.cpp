...
GALGAS_string filewrapperTemplate_controllerTemplates_enabledBindingGeneration (C_Compiler * /* inCompiler */,
                                                                                ...
                                                                                const GALGAS_string & in_OBJECT_5F_CLASS,
                                                                                const GALGAS_string & in_MODEL
  ...
  result << " : NSObject, PMTransientEventProtocol, PMUserClassName {\n"
    "\n"
    "  weak var mObject : " ;
  result << in_OBJECT_5F_CLASS.stringValue () ;
  result << "\? = nil\n"
  ...
  result << "\?, outlet : PMEnableProtocol\?, file : String, line : Int) {\n"
    ...
    "      mOutlet = unwrappedOutlet\n"
    "    }\n"
    "    mObject\?.addObserverOf_" ;
  result << in_MODEL.stringValue () ;
  ...
  result << " (self, inTrigger:false)\n"
    ...
    "    if let outlet = mOutlet {\n"
    "      if let object = mObject {\n"
    "        outlet.setEnableFromBinding (object." ;
  result << in_MODEL.stringValue () ;
  result << ")\n"
    "      }\n"
    "    }\n"
...
void routine_buildControllerTemplateMap (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  outArgument_outTemplateControllerMap = GALGAS_templateControllerMap::constructor_emptyMap (SOURCE_FILE ("controllerClassAnalysis.gSemantics", 44)) ;
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_controllerTemplates) ;
  cEnumerator_controllerTemplateList enumerator_1515 (constinArgument_inControllerTemplateList, kEnumeration_up) ;
  while (enumerator_1515.hasCurrentObject ()) {
    GALGAS_lstring var_templateName = GALGAS_lstring::constructor_new (enumerator_1515.current_mOutletClassName (HERE).mAttribute_string.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 48)).add_operation (enumerator_1515.current_mBindingName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 48)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 48)).add_operation (enumerator_1515.current_mModelTypeName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 48)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 48)).add_operation (enumerator_1515.current_mModelSelector (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 48)), enumerator_1515.current_mBindingName (HERE).mAttribute_location  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 47)) ;
    GALGAS_string var_templateText = var_fw.reader_textFileContentsAtPath (GALGAS_string ("/").add_operation (var_templateName.reader_string (SOURCE_FILE ("controllerClassAnalysis.gSemantics", 51)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 51)).add_operation (GALGAS_string (".txt"), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 51)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 51)) ;
    GALGAS_unifiedTypeProxy var_modelTypeProxy = GALGAS_unifiedTypeProxy::constructor_searchKey (constinArgument_inUnifiedTypeMap, enumerator_1515.current_mModelTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 52)) ;
    GALGAS_controllerBindingOptionDecoratedList var_controllerBindingOptionDecoratedList = GALGAS_controllerBindingOptionDecoratedList::constructor_emptyList (SOURCE_FILE ("controllerClassAnalysis.gSemantics", 53)) ;
    cEnumerator_controllerBindingOptionList enumerator_2018 (enumerator_1515.current_mBindingOptionList (HERE), kEnumeration_up) ;
    while (enumerator_2018.hasCurrentObject ()) {
      GALGAS_unifiedTypeProxy var_bindingOptionTypeProxy = GALGAS_unifiedTypeProxy::constructor_searchKey (constinArgument_inUnifiedTypeMap, enumerator_2018.current_mOptionTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 55)) ;
      var_controllerBindingOptionDecoratedList.addAssign_operation (enumerator_2018.current_mOptionName (HERE), var_bindingOptionTypeProxy  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 56)) ;
      enumerator_2018.gotoNextObject () ;
    }
    {
    outArgument_outTemplateControllerMap.modifier_insertKey (var_templateName, var_templateText, var_modelTypeProxy, enumerator_1515.current_mModelSelector (HERE), enumerator_1515.current_mModelShouldBeWritableProperty (HERE), var_controllerBindingOptionDecoratedList, inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 58)) ;
    }
    enumerator_1515.gotoNextObject () ;
  }
}
