...
const char * gWrapperFileContent_4_controllerTemplates = "@objc(Controller_$OBJECTCLASS$_$MODEL$_PMMatrix_selectedIndex)\n"
  ...
  "  func action (sender : AnyObject!) {\n"
  "    if (mOutlet != nil) && (mObject != nil) && (mOutlet!.selectedRow != mObject!.$MODEL$.toRaw ()) {\n"
  "      mObject!.$MODEL$ = mOutlet!.selectedRow\n"
  "    }\n"
  "  }\n"
  "\n"
  "  //-------------------------------------------------------------------------------------------------------------------*\n"
