...
//--- File '/PMTextField.rvalue.Integer.model.txt'

const char * gWrapperFileContent_4_controllerTemplates = "@objc(Controller_$OBJECTCLASS$_$MODEL$_PMTextField_rvalue)\n"
  "class Controller_$OBJECTCLASS$_$MODEL$_PMTextField_rvalue : NSObject, PMTriggerProtocol, NSTextFieldDelegate, PMUserClassName {\n"
  "\n"
  "  weak var mObject : $OBJECTCLASS$\? = nil\n"
...
const cRegularFileWrapper gWrapperFile_4_controllerTemplates (
  "PMTextField.rvalue.Integer.model.txt",
  "txt",
  true, // Text file
  2765, // Text length
...
const char * gWrapperFileContent_6_controllerTemplates = "@objc(Controller_$OBJECTCLASS$_$MODEL$_PMTextField_value)\n"
  "class Controller_$OBJECTCLASS$_$MODEL$_PMTextField_value : NSObject, PMTriggerProtocol, NSTextFieldDelegate, PMUserClassName {\n"
  "\n"
  "  weak var mObject : $OBJECTCLASS$\? = nil\n"
  "  weak var mOutlet: PMTextField\? = nil\n"
  "\n"
  ...
  "\n"
  "  func action (sender : AnyObject!) {\n"
  "    if (mOutlet != nil) && (mObject != nil) && (mOutlet!.integerValue != mObject!.$MODEL$) {\n"
  "      mObject!.$MODEL$ = mOutlet!.integerValue\n"
  "    }\n"
  "  }\n"
  "\n"
  "  //-------------------------------------------------------------------------------------------------------------------*\n"
