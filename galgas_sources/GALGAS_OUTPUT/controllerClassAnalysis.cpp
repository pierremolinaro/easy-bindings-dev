...
//                                         september 29th, 2014, at 20h17'27"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
const char * gWrapperFileContent_5_controllerTemplates = "@objc(Controller_$OBJECTCLASS$_$MODEL$_PMTextField_rvalue)\n"
...
const char * gWrapperFileContent_6_controllerTemplates = "@objc(Controller_$OBJECTCLASS$_$MODEL$_PMTextField_value)\n"
...
static const cRegularFileWrapper * gWrapperAllFiles_controllerTemplates_0 [8] = {
...
GALGAS_string filewrapperTemplate_controllerTemplates_enabledBindingGeneration (C_Compiler * inCompiler,
                                                                                ...
                                                                                const GALGAS_abstractEnableBindingExpressionForGeneration & in_ENABLE_5F_EXPRESSION
  ...
  if (callCategoryReader_observedObjectTypeNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 4)).isValid ()) {
    cEnumerator_stringlist enumerator_269 (callCategoryReader_observedObjectTypeNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 4)), kEnumeration_up) ;
  ...
  if (callCategoryReader_observedObjectTypeNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 21)).isValid ()) {
    cEnumerator_stringlist enumerator_1045 (callCategoryReader_observedObjectTypeNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 21)), kEnumeration_up) ;
  ...
  if (callCategoryReader_observedObjectTypeNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 27)).isValid ()) {
    cEnumerator_stringlist enumerator_1266 (callCategoryReader_observedObjectTypeNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 27)), kEnumeration_up) ;
  ...
  if (callCategoryReader_observedModelNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 36)).isValid ()) {
    cEnumerator_stringlist enumerator_1523 (callCategoryReader_observedModelNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 36)), kEnumeration_up) ;
  ...
  if (callCategoryReader_observedModelNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 45)).isValid ()) {
    cEnumerator_stringlist enumerator_1830 (callCategoryReader_observedModelNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 45)), kEnumeration_up) ;
  ...
  if (callCategoryReader_observedModelNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 66)).isValid ()) {
    cEnumerator_stringlist enumerator_2503 (callCategoryReader_observedModelNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 66)), kEnumeration_up) ;
  ...
  result << callCategoryReader_enableExpressionString ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 69)).stringValue () ;
  result << ")\n" ;
  GALGAS_uint index_2728_idx (0) ;
  if (callCategoryReader_observedModelNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 70)).isValid ()) {
    cEnumerator_stringlist enumerator_2728 (callCategoryReader_observedModelNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) in_ENABLE_5F_EXPRESSION.ptr (), inCompiler COMMA_SOURCE_FILE ("enabled-binding.swift.gTemplate", 70)), kEnumeration_up) ;
...
void routine_buildControllerTemplateMap (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  cEnumerator_controllerTemplateList enumerator_7173 (constinArgument_inControllerTemplateList, kEnumeration_up) ;
  while (enumerator_7173.hasCurrentObject ()) {
    GALGAS_lstring var_templateName = GALGAS_lstring::constructor_new (enumerator_7173.current_mOutletClassName (HERE).mAttribute_string.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 187)).add_operation (enumerator_7173.current_mBindingName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 187)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 187)).add_operation (enumerator_7173.current_mModelTypeName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 187)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 187)).add_operation (enumerator_7173.current_mModelSelector (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 187)), enumerator_7173.current_mBindingName (HERE).mAttribute_location  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 186)) ;
    ...
    GALGAS_unifiedTypeProxy var_modelTypeProxy = GALGAS_unifiedTypeProxy::constructor_searchKey (constinArgument_inUnifiedTypeMap, enumerator_7173.current_mModelTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 191)) ;
    ...
    cEnumerator_controllerBindingOptionList enumerator_7676 (enumerator_7173.current_mBindingOptionList (HERE), kEnumeration_up) ;
    while (enumerator_7676.hasCurrentObject ()) {
      GALGAS_unifiedTypeProxy var_bindingOptionTypeProxy = GALGAS_unifiedTypeProxy::constructor_searchKey (constinArgument_inUnifiedTypeMap, enumerator_7676.current_mOptionTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 194)) ;
      var_controllerBindingOptionDecoratedList.addAssign_operation (enumerator_7676.current_mOptionName (HERE), var_bindingOptionTypeProxy  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 195)) ;
      enumerator_7676.gotoNextObject () ;
    }
    {
    outArgument_outTemplateControllerMap.modifier_insertKey (var_templateName, var_templateText, var_modelTypeProxy, enumerator_7173.current_mModelSelector (HERE), enumerator_7173.current_mModelShouldBeWritableProperty (HERE), var_controllerBindingOptionDecoratedList, inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 197)) ;
    }
...
static TC_UniqueArray <categoryReaderSignature_abstractEnableBindingExpressionForGeneration_observedObjectTypeNameList> gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedObjectTypeNameList ;

//---------------------------------------------------------------------------------------------------------------------*

void enterCategoryReader_observedObjectTypeNameList (const int32_t inClassIndex,
                                                     categoryReaderSignature_abstractEnableBindingExpressionForGeneration_observedObjectTypeNameList inReader) {
  gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedObjectTypeNameList.forceObjectAtIndex (inClassIndex, inReader, NULL COMMA_HERE) ;
}

//---------------------------------------------------------------------------------------------------------------------*

static void freeCategoryReader_abstractEnableBindingExpressionForGeneration_observedObjectTypeNameList (void) {
  gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedObjectTypeNameList.free () ;
}

//---------------------------------------------------------------------------------------------------------------------*

C_PrologueEpilogue gReader_abstractEnableBindingExpressionForGeneration_observedObjectTypeNameList (NULL,
                                                                                                    freeCategoryReader_abstractEnableBindingExpressionForGeneration_observedObjectTypeNameList) ;

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_stringlist callCategoryReader_observedObjectTypeNameList (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                                 C_Compiler * inCompiler
                                                                 COMMA_LOCATION_ARGS) {
...
//--- Find Reader
  if (NULL != inObject) {
    ...
    categoryReaderSignature_abstractEnableBindingExpressionForGeneration_observedObjectTypeNameList f = NULL ;
    if (classIndex < gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedObjectTypeNameList.count ()) {
      f = gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedObjectTypeNameList (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedObjectTypeNameList.count ()) {
           f = gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedObjectTypeNameList (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedObjectTypeNameList.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//  Overriding category reader '@observablePropertyAsEnableBindingExpressionForGeneration observedObjectTypeNameList'  *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

static GALGAS_stringlist categoryReader_observablePropertyAsEnableBindingExpressionForGeneration_observedObjectTypeNameList (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                                                                                             C_Compiler * /* inCompiler */
                                                                                                                             COMMA_UNUSED_LOCATION_ARGS) {
...
static void defineCategoryReader_observablePropertyAsEnableBindingExpressionForGeneration_observedObjectTypeNameList (void) {
  enterCategoryReader_observedObjectTypeNameList (kTypeDescriptor_GALGAS_observablePropertyAsEnableBindingExpressionForGeneration.mSlotID,
                                                  categoryReader_observablePropertyAsEnableBindingExpressionForGeneration_observedObjectTypeNameList) ;
}

//---------------------------------------------------------------------------------------------------------------------*

C_PrologueEpilogue gReader_observablePropertyAsEnableBindingExpressionForGeneration_observedObjectTypeNameList (defineCategoryReader_observablePropertyAsEnableBindingExpressionForGeneration_observedObjectTypeNameList, NULL) ;
...
static GALGAS_stringlist categoryReader_negateBooleanMultipleBindingExpressionForGeneration_observedObjectTypeNameList (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                                                                                        C_Compiler * inCompiler
                                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  ...
  result_outObservedModelNameList = callCategoryReader_observedObjectTypeNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 29)) ;
//---
...
static GALGAS_stringlist categoryReader_orBooleanMultipleBindingExpressionForGeneration_observedObjectTypeNameList (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                                                                                    C_Compiler * inCompiler
                                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringlist result_outObservedModelNameList ; // Returned variable
  ...
  result_outObservedModelNameList = callCategoryReader_observedObjectTypeNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mLeftBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 37)).add_operation (callCategoryReader_observedObjectTypeNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mRightBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 37)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 37)) ;
//---
  return result_outObservedModelNameList ;
}
...
static GALGAS_stringlist categoryReader_andBooleanMultipleBindingExpressionForGeneration_observedObjectTypeNameList (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                                                                                     C_Compiler * inCompiler
                                                                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringlist result_outObservedModelNameList ; // Returned variable
  ...
  result_outObservedModelNameList = callCategoryReader_observedObjectTypeNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mLeftBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 45)).add_operation (callCategoryReader_observedObjectTypeNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mRightBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 45)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 45)) ;
//---
  return result_outObservedModelNameList ;
}
...
static TC_UniqueArray <categoryReaderSignature_abstractEnableBindingExpressionForGeneration_enableExpressionString> gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_enableExpressionString ;

//---------------------------------------------------------------------------------------------------------------------*

void enterCategoryReader_enableExpressionString (const int32_t inClassIndex,
                                                 categoryReaderSignature_abstractEnableBindingExpressionForGeneration_enableExpressionString inReader) {
  gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_enableExpressionString.forceObjectAtIndex (inClassIndex, inReader, NULL COMMA_HERE) ;
}

//---------------------------------------------------------------------------------------------------------------------*

static void freeCategoryReader_abstractEnableBindingExpressionForGeneration_enableExpressionString (void) {
  gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_enableExpressionString.free () ;
}

//---------------------------------------------------------------------------------------------------------------------*

C_PrologueEpilogue gReader_abstractEnableBindingExpressionForGeneration_enableExpressionString (NULL,
                                                                                                freeCategoryReader_abstractEnableBindingExpressionForGeneration_enableExpressionString) ;

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_string callCategoryReader_enableExpressionString (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                         C_Compiler * inCompiler
                                                         COMMA_LOCATION_ARGS) {
  GALGAS_string result ;
//--- Find Reader
  if (NULL != inObject) {
    ...
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const int32_t classIndex = info->mSlotID ;
    categoryReaderSignature_abstractEnableBindingExpressionForGeneration_enableExpressionString f = NULL ;
    if (classIndex < gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_enableExpressionString.count ()) {
      f = gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_enableExpressionString (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_enableExpressionString.count ()) {
           f = gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_enableExpressionString (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_enableExpressionString.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY READER CALL ERROR", __FILE__, __LINE__) ;
    }else{
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//    Overriding category reader '@observablePropertyAsEnableBindingExpressionForGeneration enableExpressionString'    *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

static GALGAS_string categoryReader_observablePropertyAsEnableBindingExpressionForGeneration_enableExpressionString (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                                                                                     C_Compiler * inCompiler
                                                                                                                     COMMA_UNUSED_LOCATION_ARGS) {
...
static void defineCategoryReader_observablePropertyAsEnableBindingExpressionForGeneration_enableExpressionString (void) {
  enterCategoryReader_enableExpressionString (kTypeDescriptor_GALGAS_observablePropertyAsEnableBindingExpressionForGeneration.mSlotID,
                                              categoryReader_observablePropertyAsEnableBindingExpressionForGeneration_enableExpressionString) ;
}

//---------------------------------------------------------------------------------------------------------------------*

C_PrologueEpilogue gReader_observablePropertyAsEnableBindingExpressionForGeneration_enableExpressionString (defineCategoryReader_observablePropertyAsEnableBindingExpressionForGeneration_enableExpressionString, NULL) ;
...
static GALGAS_string categoryReader_negateBooleanMultipleBindingExpressionForGeneration_enableExpressionString (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                                                                                C_Compiler * inCompiler
                                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outEnableExpressionString ; // Returned variable
  const cPtr_negateBooleanMultipleBindingExpressionForGeneration * object = (const cPtr_negateBooleanMultipleBindingExpressionForGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_negateBooleanMultipleBindingExpressionForGeneration) ;
  result_outEnableExpressionString = GALGAS_string ("!(").add_operation (callCategoryReader_enableExpressionString ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 73)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 73)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 73)) ;
//---
  return result_outEnableExpressionString ;
}
...
static GALGAS_string categoryReader_orBooleanMultipleBindingExpressionForGeneration_enableExpressionString (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                                                                            C_Compiler * inCompiler
                                                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outEnableExpressionString ; // Returned variable
  const cPtr_orBooleanMultipleBindingExpressionForGeneration * object = (const cPtr_orBooleanMultipleBindingExpressionForGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_orBooleanMultipleBindingExpressionForGeneration) ;
  result_outEnableExpressionString = GALGAS_string ("(").add_operation (callCategoryReader_enableExpressionString ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mLeftBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 81)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 81)).add_operation (GALGAS_string (" || "), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 81)).add_operation (callCategoryReader_enableExpressionString ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mRightBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 81)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 81)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 81)) ;
//---
  return result_outEnableExpressionString ;
}
...
static GALGAS_string categoryReader_andBooleanMultipleBindingExpressionForGeneration_enableExpressionString (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                                                                             C_Compiler * inCompiler
                                                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outEnableExpressionString ; // Returned variable
  const cPtr_andBooleanMultipleBindingExpressionForGeneration * object = (const cPtr_andBooleanMultipleBindingExpressionForGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_andBooleanMultipleBindingExpressionForGeneration) ;
  result_outEnableExpressionString = GALGAS_string ("(").add_operation (callCategoryReader_enableExpressionString ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mLeftBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 89)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 89)).add_operation (GALGAS_string (" && "), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 89)).add_operation (callCategoryReader_enableExpressionString ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mRightBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 89)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 89)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 89)) ;
//---
  return result_outEnableExpressionString ;
}
...
static TC_UniqueArray <categoryReaderSignature_abstractEnableBindingExpressionForGeneration_observedModelNameList> gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedModelNameList ;

//---------------------------------------------------------------------------------------------------------------------*

void enterCategoryReader_observedModelNameList (const int32_t inClassIndex,
                                                categoryReaderSignature_abstractEnableBindingExpressionForGeneration_observedModelNameList inReader) {
  gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedModelNameList.forceObjectAtIndex (inClassIndex, inReader, NULL COMMA_HERE) ;
}

//---------------------------------------------------------------------------------------------------------------------*

static void freeCategoryReader_abstractEnableBindingExpressionForGeneration_observedModelNameList (void) {
  gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedModelNameList.free () ;
}

//---------------------------------------------------------------------------------------------------------------------*

C_PrologueEpilogue gReader_abstractEnableBindingExpressionForGeneration_observedModelNameList (NULL,
                                                                                               freeCategoryReader_abstractEnableBindingExpressionForGeneration_observedModelNameList) ;

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_stringlist callCategoryReader_observedModelNameList (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                            C_Compiler * inCompiler
                                                            COMMA_LOCATION_ARGS) {
  GALGAS_stringlist result ;
//--- Find Reader
  if (NULL != inObject) {
    ...
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const int32_t classIndex = info->mSlotID ;
    categoryReaderSignature_abstractEnableBindingExpressionForGeneration_observedModelNameList f = NULL ;
    if (classIndex < gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedModelNameList.count ()) {
      f = gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedModelNameList (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedModelNameList.count ()) {
           f = gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedModelNameList (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryReaderTable_abstractEnableBindingExpressionForGeneration_observedModelNameList.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY READER CALL ERROR", __FILE__, __LINE__) ;
    }else{
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//    Overriding category reader '@observablePropertyAsEnableBindingExpressionForGeneration observedModelNameList'     *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

static GALGAS_stringlist categoryReader_observablePropertyAsEnableBindingExpressionForGeneration_observedModelNameList (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                                                                                        C_Compiler * /* inCompiler */
                                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringlist result_outObservedModelNameList ; // Returned variable
  const cPtr_observablePropertyAsEnableBindingExpressionForGeneration * object = (const cPtr_observablePropertyAsEnableBindingExpressionForGeneration *) inObject ;
...
static void defineCategoryReader_observablePropertyAsEnableBindingExpressionForGeneration_observedModelNameList (void) {
  enterCategoryReader_observedModelNameList (kTypeDescriptor_GALGAS_observablePropertyAsEnableBindingExpressionForGeneration.mSlotID,
                                             categoryReader_observablePropertyAsEnableBindingExpressionForGeneration_observedModelNameList) ;
}

//---------------------------------------------------------------------------------------------------------------------*

C_PrologueEpilogue gReader_observablePropertyAsEnableBindingExpressionForGeneration_observedModelNameList (defineCategoryReader_observablePropertyAsEnableBindingExpressionForGeneration_observedModelNameList, NULL) ;
...
static GALGAS_stringlist categoryReader_negateBooleanMultipleBindingExpressionForGeneration_observedModelNameList (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                                                                                   C_Compiler * inCompiler
                                                                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringlist result_outObservedModelNameList ; // Returned variable
  const cPtr_negateBooleanMultipleBindingExpressionForGeneration * object = (const cPtr_negateBooleanMultipleBindingExpressionForGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_negateBooleanMultipleBindingExpressionForGeneration) ;
  result_outObservedModelNameList = callCategoryReader_observedModelNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 117)) ;
//---
  return result_outObservedModelNameList ;
}
...
static GALGAS_stringlist categoryReader_orBooleanMultipleBindingExpressionForGeneration_observedModelNameList (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                                                                               C_Compiler * inCompiler
                                                                                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringlist result_outObservedModelNameList ; // Returned variable
  const cPtr_orBooleanMultipleBindingExpressionForGeneration * object = (const cPtr_orBooleanMultipleBindingExpressionForGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_orBooleanMultipleBindingExpressionForGeneration) ;
  result_outObservedModelNameList = callCategoryReader_observedModelNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mLeftBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 125)).add_operation (callCategoryReader_observedModelNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mRightBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 125)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 125)) ;
//---
  return result_outObservedModelNameList ;
}
...
static GALGAS_stringlist categoryReader_andBooleanMultipleBindingExpressionForGeneration_observedModelNameList (const cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                                                                                C_Compiler * inCompiler
                                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringlist result_outObservedModelNameList ; // Returned variable
  const cPtr_andBooleanMultipleBindingExpressionForGeneration * object = (const cPtr_andBooleanMultipleBindingExpressionForGeneration *) inObject ;
  macroValidSharedObject (object, cPtr_andBooleanMultipleBindingExpressionForGeneration) ;
  result_outObservedModelNameList = callCategoryReader_observedModelNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mLeftBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 133)).add_operation (callCategoryReader_observedModelNameList ((const cPtr_abstractEnableBindingExpressionForGeneration *) object->mAttribute_mRightBinding.ptr (), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 133)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 133)) ;
//---
  return result_outObservedModelNameList ;
}
