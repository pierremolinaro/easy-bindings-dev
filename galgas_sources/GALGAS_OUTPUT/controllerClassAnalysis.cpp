...
static void categoryMethod_controllerClassDeclaration_semanticAnalysis (const cPtr_astDeclaration * inObject,
  ...
  cEnumerator_lstringlist enumerator_3268 (object->mAttribute_mActionDeclarationList, kEnumeration_up) ;
  while (enumerator_3268.hasCurrentObject ()) {
    {
    var_actionMap.modifier_insertKey (enumerator_3268.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (99)) ;
    }
  ...
  cEnumerator_outletClassBindingList enumerator_3410 (object->mAttribute_mBindingList, kEnumeration_up) ;
  while (enumerator_3410.hasCurrentObject ()) {
    ...
    cEnumerator_bindingOptionList enumerator_3518 (enumerator_3410.current_mBindingOptionList (HERE), kEnumeration_up) ;
    while (enumerator_3518.hasCurrentObject ()) {
      ...
      cEnumerator_lstringlist enumerator_3606 (enumerator_3518.current_mAcceptableTypeList (HERE), kEnumeration_up) ;
      while (enumerator_3606.hasCurrentObject ()) {
        GALGAS_ebType var_type ;
        GALGAS_astDeclaration joker_3667_0 ; // Joker input parameter
        constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_3606.current_mValue (HERE), var_type, joker_3667_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) ;
        var_acceptableTypeList.addAssign_operation (var_type COMMA_SOURCE_FILE_AT_LINE (109)) ;
        enumerator_3606.gotoNextObject () ;
      }
      {
      var_outletClassBindingOptionMap.modifier_insertKey (enumerator_3518.current_mBindingOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (111)) ;
      }
    ...
    cEnumerator_attributeASTTypeAndFormatterList enumerator_3950 (enumerator_3410.current_mAcceptableTypeFormatterList (HERE), kEnumeration_up) ;
    while (enumerator_3950.hasCurrentObject ()) {
      GALGAS_ebType var_type ;
      GALGAS_astDeclaration joker_4012_0 ; // Joker input parameter
      constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_3950.current_mTypeName (HERE), var_type, joker_4012_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) ;
      var_acceptableTypeFormatterList.addAssign_operation (var_type, enumerator_3950.current_mRequiredFormatter (HERE) COMMA_SOURCE_FILE_AT_LINE (116)) ;
      enumerator_3950.gotoNextObject () ;
    }
    {
    var_bindingMap.modifier_insertKey (enumerator_3410.current_mBindingName (HERE), var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (118)) ;
    }
  ...
  cEnumerator_bindingOptionList enumerator_4356 (object->mAttribute_mControlledObjectBindingOptionList, kEnumeration_up) ;
  while (enumerator_4356.hasCurrentObject ()) {
    ...
    cEnumerator_lstringlist enumerator_4440 (enumerator_4356.current_mAcceptableTypeList (HERE), kEnumeration_up) ;
    while (enumerator_4440.hasCurrentObject ()) {
      GALGAS_ebType var_type ;
      GALGAS_astDeclaration joker_4499_0 ; // Joker input parameter
      constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_4440.current_mValue (HERE), var_type, joker_4499_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (125)) ;
      var_acceptableTypeList.addAssign_operation (var_type COMMA_SOURCE_FILE_AT_LINE (126)) ;
      enumerator_4440.gotoNextObject () ;
    }
    {
    var_controlledObjectAvailableBindingOptionMap.modifier_insertKey (enumerator_4356.current_mBindingOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (128)) ;
    }
    enumerator_4356.gotoNextObject () ;
  }
  GALGAS_observablePropertyMap var_observablePropertyMap ;
  GALGAS_typeKind joker_4776_0 ; // Joker input parameter
  ioArgument_ioContextAnalysisStruct.mAttribute_mObservablePropertyMapMap.method_searchKey (object->mAttribute_mControllerClassName, joker_4776_0, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (131)) ;
  {
