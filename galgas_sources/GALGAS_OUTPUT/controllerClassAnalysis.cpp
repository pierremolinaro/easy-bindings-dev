...
static void categoryMethod_controllerClassDeclaration_semanticAnalysis (const cPtr_astDeclaration * inObject,
  ...
  cEnumerator_lstringlist enumerator_3263 (object->mAttribute_mActionDeclarationList, kEnumeration_up) ;
  while (enumerator_3263.hasCurrentObject ()) {
    {
    var_actionMap.modifier_insertKey (enumerator_3263.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (99)) ;
    }
  ...
  cEnumerator_outletClassBindingList enumerator_3405 (object->mAttribute_mBindingList, kEnumeration_up) ;
  while (enumerator_3405.hasCurrentObject ()) {
    ...
    cEnumerator_bindingOptionList enumerator_3513 (enumerator_3405.current_mBindingOptionList (HERE), kEnumeration_up) ;
    while (enumerator_3513.hasCurrentObject ()) {
      ...
      cEnumerator_lstringlist enumerator_3601 (enumerator_3513.current_mAcceptableTypeList (HERE), kEnumeration_up) ;
      while (enumerator_3601.hasCurrentObject ()) {
        GALGAS_ebType var_type ;
        GALGAS_astDeclaration joker_3662_0 ; // Joker input parameter
        constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_3601.current_mValue (HERE), var_type, joker_3662_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) ;
        var_acceptableTypeList.addAssign_operation (var_type COMMA_SOURCE_FILE_AT_LINE (109)) ;
        enumerator_3601.gotoNextObject () ;
      }
      {
      var_outletClassBindingOptionMap.modifier_insertKey (enumerator_3513.current_mBindingOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (111)) ;
      }
    ...
    cEnumerator_attributeASTTypeAndFormatterList enumerator_3945 (enumerator_3405.current_mAcceptableTypeFormatterList (HERE), kEnumeration_up) ;
    while (enumerator_3945.hasCurrentObject ()) {
      GALGAS_ebType var_type ;
      GALGAS_astDeclaration joker_4007_0 ; // Joker input parameter
      constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_3945.current_mTypeName (HERE), var_type, joker_4007_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) ;
      var_acceptableTypeFormatterList.addAssign_operation (var_type, enumerator_3945.current_mRequiredFormatter (HERE) COMMA_SOURCE_FILE_AT_LINE (116)) ;
      enumerator_3945.gotoNextObject () ;
    }
    {
    var_bindingMap.modifier_insertKey (enumerator_3405.current_mBindingName (HERE), var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (118)) ;
    }
  ...
  cEnumerator_bindingOptionList enumerator_4351 (object->mAttribute_mControlledObjectBindingOptionList, kEnumeration_up) ;
  while (enumerator_4351.hasCurrentObject ()) {
    ...
    cEnumerator_lstringlist enumerator_4435 (enumerator_4351.current_mAcceptableTypeList (HERE), kEnumeration_up) ;
    while (enumerator_4435.hasCurrentObject ()) {
      GALGAS_ebType var_type ;
      GALGAS_astDeclaration joker_4494_0 ; // Joker input parameter
      constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_4435.current_mValue (HERE), var_type, joker_4494_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (125)) ;
      var_acceptableTypeList.addAssign_operation (var_type COMMA_SOURCE_FILE_AT_LINE (126)) ;
      enumerator_4435.gotoNextObject () ;
    }
    {
    var_controlledObjectAvailableBindingOptionMap.modifier_insertKey (enumerator_4351.current_mBindingOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (128)) ;
    }
    enumerator_4351.gotoNextObject () ;
  }
  GALGAS_observablePropertyMap var_observablePropertyMap ;
  GALGAS_typeKind joker_4771_0 ; // Joker input parameter
  ioArgument_ioContextAnalysisStruct.mAttribute_mObservablePropertyMapMap.method_searchKey (object->mAttribute_mControllerClassName, joker_4771_0, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (131)) ;
  {
