...
//--- File '/PMTextField.int.txt'

const char * gWrapperFileContent_2_controllerTemplates = "@objc(Controller_$OBJECTCLASS$_$MODEL$_PMTextField_int)\n"
  ...
  "      if response == 1001 { // Discard Change\n"
...
const char * gWrapperFileContent_3_controllerTemplates = "@objc(Controller_$OBJECTCLASS$_$MODEL$_PMTextField_string)\n"
  "class Controller_$OBJECTCLASS$_$MODEL$_PMTextField_string : NSObject, PMTriggerProtocol {\n"
  "\n"
  "  weak var mObject : $OBJECTCLASS$\? = nil\n"
  "  weak var mOutlet: PMTextField\? = nil\n"
  "  var mSendContinously : Bool\n"
...
static const cRegularFileWrapper * gWrapperAllFiles_controllerTemplates_0 [5] = {
...
bool cMapElement_templateControllerMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mTemplateString.isValid () && mAttribute_mModelTypeProxy.isValid () && mAttribute_mControllerBindingOptionDecoratedList.isValid () ;
}
...
cMapElement * cMapElement_templateControllerMap::copy (void) {
  ...
  macroMyNew (result, cMapElement_templateControllerMap (mAttribute_lkey, mAttribute_mTemplateString, mAttribute_mModelTypeProxy, mAttribute_mControllerBindingOptionDecoratedList COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_templateControllerMap::addAssign_operation (const GALGAS_lstring & inKey,
  ...
  macroMyNew (p, cMapElement_templateControllerMap (inKey, inArgument0, inArgument1, inArgument2 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
GALGAS_templateControllerMap_2D_element cEnumerator_templateControllerMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, cMapElement_templateControllerMap) ;
  return GALGAS_templateControllerMap_2D_element (p->mAttribute_lkey, p->mAttribute_mTemplateString, p->mAttribute_mModelTypeProxy, p->mAttribute_mControllerBindingOptionDecoratedList) ;
}
...
void routine_buildControllerTemplateMap (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  outArgument_outTemplateControllerMap = GALGAS_templateControllerMap::constructor_emptyMap (SOURCE_FILE ("controllerClassAnalysis.gSemantics", 36)) ;
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_controllerTemplates) ;
  cEnumerator_controllerTemplateList enumerator_1265 (constinArgument_inControllerTemplateList, kEnumeration_up) ;
  while (enumerator_1265.hasCurrentObject ()) {
    GALGAS_lstring var_templateName = GALGAS_lstring::constructor_new (enumerator_1265.current_mOutletClassName (HERE).mAttribute_string.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 39)).add_operation (enumerator_1265.current_mBindingName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 39)), enumerator_1265.current_mBindingName (HERE).mAttribute_location  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 39)) ;
    GALGAS_string var_templateText = var_fw.reader_textFileContentsAtPath (GALGAS_string ("/").add_operation (var_templateName.reader_string (SOURCE_FILE ("controllerClassAnalysis.gSemantics", 40)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 40)).add_operation (GALGAS_string (".txt"), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 40)), inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 40)) ;
    GALGAS_unifiedTypeProxy var_modelTypeProxy = GALGAS_unifiedTypeProxy::constructor_searchKey (constinArgument_inUnifiedTypeMap, enumerator_1265.current_mModelTypeName (HERE), inCompiler  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 41)) ;
    GALGAS_controllerBindingOptionDecoratedList var_controllerBindingOptionDecoratedList = GALGAS_controllerBindingOptionDecoratedList::constructor_emptyList (SOURCE_FILE ("controllerClassAnalysis.gSemantics", 42)) ;
    cEnumerator_controllerBindingOptionList enumerator_1689 (enumerator_1265.current_mBindingOptionList (HERE), kEnumeration_up) ;
    while (enumerator_1689.hasCurrentObject ()) {
      GALGAS_unifiedTypeProxy var_bindingOptionTypeProxy = GALGAS_unifiedTypeProxy::constructor_searchKey (constinArgument_inUnifiedTypeMap, enumerator_1689.current_mOptionType (HERE), inCompiler  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 44)) ;
      var_controllerBindingOptionDecoratedList.addAssign_operation (enumerator_1689.current_mOptionName (HERE), var_bindingOptionTypeProxy  COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 45)) ;
      enumerator_1689.gotoNextObject () ;
    }
    {
    outArgument_outTemplateControllerMap.modifier_insertKey (var_templateName, var_templateText, var_modelTypeProxy, var_controllerBindingOptionDecoratedList, inCompiler COMMA_SOURCE_FILE ("controllerClassAnalysis.gSemantics", 47)) ;
    }
...
GALGAS_templateControllerMap_2D_element::GALGAS_templateControllerMap_2D_element (const GALGAS_lstring & inOperand0,
                                                                                  ...
                                                                                  const GALGAS_controllerBindingOptionDecoratedList & inOperand3) :
mAttribute_lkey (inOperand0),
mAttribute_mTemplateString (inOperand1),
mAttribute_mModelTypeProxy (inOperand2),
mAttribute_mControllerBindingOptionDecoratedList (inOperand3) {
}
...
GALGAS_templateControllerMap_2D_element GALGAS_templateControllerMap_2D_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_templateControllerMap_2D_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
