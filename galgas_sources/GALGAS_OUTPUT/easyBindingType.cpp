...
//                    december 22th, 2012, at 14h44'35"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
GALGAS_arrayType GALGAS_arrayType::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_arrayType *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "arrayType", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_bezierPathType GALGAS_bezierPathType::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_bezierPathType *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "bezierPathType", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_enumType GALGAS_enumType::constructor_new (const GALGAS_string & inAttribute_mEnumTypeName
                                                  COMMA_LOCATION_ARGS) {
...
GALGAS_string GALGAS_enumType::reader_mEnumTypeName (UNUSED_LOCATION_ARGS) const {
...
GALGAS_string cPtr_enumType::reader_mEnumTypeName (UNUSED_LOCATION_ARGS) const {
...
cPtr_enumType::cPtr_enumType (const GALGAS_string & in_mEnumTypeName
                              COMMA_LOCATION_ARGS) :
cPtr_easyBindingType (THERE),
...
GALGAS_enumType GALGAS_enumType::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_enumType *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "enumType", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_integerType GALGAS_integerType::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_integerType *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "integerType", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_menuType GALGAS_menuType::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_menuType *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "menuType", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_objectArrayType GALGAS_objectArrayType::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_objectArrayType *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "objectArrayType", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_toManyEntitiesType GALGAS_toManyEntitiesType::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_toManyEntitiesType *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "toManyEntitiesType", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_toOneObjectType::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_toOneObjectType * p = (const cPtr_toOneObjectType *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_toOneObjectType) ;
  if (kOperandEqual == result) {
    result = mAttribute_mEntityOrClassName.objectCompare (p->mAttribute_mEntityOrClassName) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_toOneObjectType::objectCompare (const GALGAS_toOneObjectType & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_toOneObjectType::GALGAS_toOneObjectType (void) :
GALGAS_easyBindingType () {
}

//---------------------------------------------------------------------------*

GALGAS_toOneObjectType::GALGAS_toOneObjectType (const cPtr_toOneObjectType * inSourcePtr) :
GALGAS_easyBindingType (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_toOneObjectType) ;
}

//---------------------------------------------------------------------------*

GALGAS_toOneObjectType GALGAS_toOneObjectType::constructor_new (const GALGAS_string & inAttribute_mEntityOrClassName
                                                                COMMA_LOCATION_ARGS) {
  GALGAS_toOneObjectType result ;
  if (inAttribute_mEntityOrClassName.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_toOneObjectType (inAttribute_mEntityOrClassName COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_toOneObjectType::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_toOneObjectType * p = (cPtr_toOneObjectType *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_toOneObjectType) ;
    cPtr_toOneObjectType * r = NULL ;
    macroMyNew (r, cPtr_toOneObjectType (p->mAttribute_mEntityOrClassName COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_string GALGAS_toOneObjectType::reader_mEntityOrClassName (UNUSED_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    const cPtr_toOneObjectType * p = (const cPtr_toOneObjectType *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_toOneObjectType) ;
    result = p->mAttribute_mEntityOrClassName ;
  }
  return result ;
}
...
GALGAS_string cPtr_toOneObjectType::reader_mEntityOrClassName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mEntityOrClassName ;
}

//---------------------------------------------------------------------------*
//                 Pointer class for @toOneObjectType class                  *
//---------------------------------------------------------------------------*

cPtr_toOneObjectType::cPtr_toOneObjectType (const GALGAS_string & in_mEntityOrClassName
                                            COMMA_LOCATION_ARGS) :
cPtr_easyBindingType (THERE),
mAttribute_mEntityOrClassName (in_mEntityOrClassName) {
}

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * cPtr_toOneObjectType::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_toOneObjectType ;
}

void cPtr_toOneObjectType::description (C_String & ioString,
                                        const PMSInt32 inIndentation) const {
  ioString << "[@toOneObjectType:" ;
  mAttribute_mEntityOrClassName.description (ioString, inIndentation+1) ;
  ioString << "]" ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//                           @toOneObjectType type                           *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_toOneObjectType ("toOneObjectType",
                                        & kTypeDescriptor_GALGAS_easyBindingType) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_toOneObjectType::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_toOneObjectType ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_toOneObjectType::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_toOneObjectType (*this)) ;
  }
  return result ;
}
...
GALGAS_toOneObjectType GALGAS_toOneObjectType::extractObject (const GALGAS_object & inObject,
                                                              C_Compiler * inCompiler,
                                                              const GALGAS_location & inErrorLocation
                                                              COMMA_LOCATION_ARGS) {
  GALGAS_toOneObjectType result ;
  const GALGAS_toOneObjectType * p = (const GALGAS_toOneObjectType *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_toOneObjectType *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "toOneObjectType", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_uintegerType GALGAS_uintegerType::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_uintegerType *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "uintegerType", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_valueType GALGAS_valueType::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_valueType *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "valueType", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
static GALGAS_string categoryReader_enumType_ebTypeName (const cPtr_easyBindingType * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = object->mAttribute_mEnumTypeName ;
//---
  return result_outResult ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//         Overriding category reader '@toOneObjectType ebTypeName'          *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_toOneObjectType_ebTypeName (const cPtr_easyBindingType * inObject,
                                                                C_Compiler * /* inCompiler */
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_toOneObjectType * object = (const cPtr_toOneObjectType *) inObject ;
  macroValidSharedObject (object, const cPtr_toOneObjectType) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = object->mAttribute_mEntityOrClassName ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_toOneObjectType_ebTypeName (void) {
  enterCategoryReader_ebTypeName (kTypeDescriptor_GALGAS_toOneObjectType.mSlotID,
                                  categoryReader_toOneObjectType_ebTypeName) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_toOneObjectType_ebTypeName (defineCategoryReader_toOneObjectType_ebTypeName, NULL) ;
...
static GALGAS_string categoryReader_easyBindingType_customGetterMethod (const cPtr_easyBindingType * /* inObject */,
                                                                        C_Compiler * /* inCompiler */
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_easyBindingType_customGetterMethod (void) {
  enterCategoryReader_customGetterMethod (kTypeDescriptor_GALGAS_easyBindingType.mSlotID,
                                          categoryReader_easyBindingType_customGetterMethod) ;
}
...
C_PrologueEpilogue gReader_easyBindingType_customGetterMethod (defineCategoryReader_easyBindingType_customGetterMethod,
...
//---------------------------------------------------------------------------*
//                                                                           *
//       Overriding category reader '@integerType customGetterMethod'        *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_integerType_customGetterMethod (const cPtr_easyBindingType * /* inObject */,
                                                                    C_Compiler * /* inCompiler */
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_integerType_customGetterMethod (void) {
  enterCategoryReader_customGetterMethod (kTypeDescriptor_GALGAS_integerType.mSlotID,
                                          categoryReader_integerType_customGetterMethod) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_integerType_customGetterMethod (defineCategoryReader_integerType_customGetterMethod, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//       Overriding category reader '@uintegerType customGetterMethod'       *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_uintegerType_customGetterMethod (const cPtr_easyBindingType * /* inObject */,
                                                                     C_Compiler * /* inCompiler */
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_uintegerType_customGetterMethod (void) {
  enterCategoryReader_customGetterMethod (kTypeDescriptor_GALGAS_uintegerType.mSlotID,
                                          categoryReader_uintegerType_customGetterMethod) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_uintegerType_customGetterMethod (defineCategoryReader_uintegerType_customGetterMethod, NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//         Overriding category reader '@enumType customGetterMethod'         *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_enumType_customGetterMethod (const cPtr_easyBindingType * /* inObject */,
                                                                 C_Compiler * /* inCompiler */
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_enumType_customGetterMethod (void) {
  enterCategoryReader_customGetterMethod (kTypeDescriptor_GALGAS_enumType.mSlotID,
                                          categoryReader_enumType_customGetterMethod) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_enumType_customGetterMethod (defineCategoryReader_enumType_customGetterMethod, NULL) ;
...
static GALGAS_string categoryReader_easyBindingType_customSetterTransformer (const cPtr_easyBindingType * /* inObject */,
                                                                             C_Compiler * /* inCompiler */
                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_easyBindingType_customSetterTransformer (void) {
  enterCategoryReader_customSetterTransformer (kTypeDescriptor_GALGAS_easyBindingType.mSlotID,
                                               categoryReader_easyBindingType_customSetterTransformer) ;
}
...
C_PrologueEpilogue gReader_easyBindingType_customSetterTransformer (defineCategoryReader_easyBindingType_customSetterTransformer,
...
//---------------------------------------------------------------------------*
//                                                                           *
//     Overriding category reader '@integerType customSetterTransformer'     *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_integerType_customSetterTransformer (const cPtr_easyBindingType * /* inObject */,
                                                                         C_Compiler * /* inCompiler */
                                                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_integerType_customSetterTransformer (void) {
  enterCategoryReader_customSetterTransformer (kTypeDescriptor_GALGAS_integerType.mSlotID,
                                               categoryReader_integerType_customSetterTransformer) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_integerType_customSetterTransformer (defineCategoryReader_integerType_customSetterTransformer, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//      Overriding category reader '@enumType customSetterTransformer'       *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_enumType_customSetterTransformer (const cPtr_easyBindingType * /* inObject */,
                                                                      C_Compiler * /* inCompiler */
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_enumType_customSetterTransformer (void) {
  enterCategoryReader_customSetterTransformer (kTypeDescriptor_GALGAS_enumType.mSlotID,
                                               categoryReader_enumType_customSetterTransformer) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_enumType_customSetterTransformer (defineCategoryReader_enumType_customSetterTransformer, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//    Overriding category reader '@uintegerType customSetterTransformer'     *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_uintegerType_customSetterTransformer (const cPtr_easyBindingType * /* inObject */,
                                                                          C_Compiler * /* inCompiler */
                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_uintegerType_customSetterTransformer (void) {
  enterCategoryReader_customSetterTransformer (kTypeDescriptor_GALGAS_uintegerType.mSlotID,
                                               categoryReader_uintegerType_customSetterTransformer) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_uintegerType_customSetterTransformer (defineCategoryReader_uintegerType_customSetterTransformer, NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//           Overriding category reader '@toOneObjectType isClass'           *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_bool categoryReader_toOneObjectType_isClass (const cPtr_easyBindingType * /* inObject */,
                                                           C_Compiler * /* inCompiler */
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_toOneObjectType_isClass (void) {
  enterCategoryReader_isClass (kTypeDescriptor_GALGAS_toOneObjectType.mSlotID,
                               categoryReader_toOneObjectType_isClass) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_toOneObjectType_isClass (defineCategoryReader_toOneObjectType_isClass, NULL) ;
...
static GALGAS_string categoryReader_easyBindingType_typeForEntityDescription (const cPtr_easyBindingType * /* inObject */,
                                                                              C_Compiler * /* inCompiler */
                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_easyBindingType_typeForEntityDescription (void) {
  enterCategoryReader_typeForEntityDescription (kTypeDescriptor_GALGAS_easyBindingType.mSlotID,
                                                categoryReader_easyBindingType_typeForEntityDescription) ;
}
...
C_PrologueEpilogue gReader_easyBindingType_typeForEntityDescription (defineCategoryReader_easyBindingType_typeForEntityDescription,
...
//---------------------------------------------------------------------------*
//                                                                           *
//      Overriding category reader '@enumType typeForEntityDescription'      *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_enumType_typeForEntityDescription (const cPtr_easyBindingType * /* inObject */,
                                                                       C_Compiler * /* inCompiler */
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_enumType_typeForEntityDescription (void) {
  enterCategoryReader_typeForEntityDescription (kTypeDescriptor_GALGAS_enumType.mSlotID,
                                                categoryReader_enumType_typeForEntityDescription) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_enumType_typeForEntityDescription (defineCategoryReader_enumType_typeForEntityDescription, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//    Overriding category reader '@integerType typeForEntityDescription'     *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_integerType_typeForEntityDescription (const cPtr_easyBindingType * /* inObject */,
                                                                          C_Compiler * /* inCompiler */
                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_integerType_typeForEntityDescription (void) {
  enterCategoryReader_typeForEntityDescription (kTypeDescriptor_GALGAS_integerType.mSlotID,
                                                categoryReader_integerType_typeForEntityDescription) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_integerType_typeForEntityDescription (defineCategoryReader_integerType_typeForEntityDescription, NULL) ;
...
static TC_UniqueArray <categoryReaderSignature_easyBindingType_valueTransformerName> gCategoryReaderTable_easyBindingType_valueTransformerName ;
...
void enterCategoryReader_valueTransformerName (const PMSInt32 inClassIndex,
  ...
  gCategoryReaderTable_easyBindingType_valueTransformerName.forceObjectAtIndex (inClassIndex, inReader, NULL COMMA_HERE) ;
}
...
//--- Find Reader
  if (NULL != inObject) {
    ...
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const PMSInt32 classIndex = info->mSlotID ;
    categoryReaderSignature_easyBindingType_valueTransformerName f = NULL ;
    if (classIndex < gCategoryReaderTable_easyBindingType_valueTransformerName.count ()) {
      f = gCategoryReaderTable_easyBindingType_valueTransformerName (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryReaderTable_easyBindingType_valueTransformerName.count ()) {
           f = gCategoryReaderTable_easyBindingType_valueTransformerName (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryReaderTable_easyBindingType_valueTransformerName.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY READER CALL ERROR", __FILE__, __LINE__) ;
    }else{
...
static GALGAS_string categoryReader_easyBindingType_valueTransformerName (const cPtr_easyBindingType * /* inObject */,
                                                                          C_Compiler * /* inCompiler */
                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_easyBindingType_valueTransformerName (void) {
  enterCategoryReader_valueTransformerName (kTypeDescriptor_GALGAS_easyBindingType.mSlotID,
                                            categoryReader_easyBindingType_valueTransformerName) ;
}

//---------------------------------------------------------------------------*

static void freeCategoryReader_easyBindingType_valueTransformerName (void) {
  gCategoryReaderTable_easyBindingType_valueTransformerName.free () ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_easyBindingType_valueTransformerName (defineCategoryReader_easyBindingType_valueTransformerName,
                                                                 freeCategoryReader_easyBindingType_valueTransformerName) ;

//---------------------------------------------------------------------------*
//                                                                           *
//       Overriding category reader '@colorType valueTransformerName'        *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_colorType_valueTransformerName (const cPtr_easyBindingType * /* inObject */,
                                                                    C_Compiler * /* inCompiler */
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("NSUnarchiveFromDataTransformerName") ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_colorType_valueTransformerName (void) {
  enterCategoryReader_valueTransformerName (kTypeDescriptor_GALGAS_colorType.mSlotID,
                                            categoryReader_colorType_valueTransformerName) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_colorType_valueTransformerName (defineCategoryReader_colorType_valueTransformerName, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//       Overriding category reader '@arrayType valueTransformerName'        *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_arrayType_valueTransformerName (const cPtr_easyBindingType * /* inObject */,
                                                                    C_Compiler * /* inCompiler */
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_arrayType_valueTransformerName (void) {
  enterCategoryReader_valueTransformerName (kTypeDescriptor_GALGAS_arrayType.mSlotID,
                                            categoryReader_arrayType_valueTransformerName) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_arrayType_valueTransformerName (defineCategoryReader_arrayType_valueTransformerName, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//       Overriding category reader '@valueType valueTransformerName'        *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_valueType_valueTransformerName (const cPtr_easyBindingType * /* inObject */,
                                                                    C_Compiler * /* inCompiler */
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_valueType_valueTransformerName (void) {
  enterCategoryReader_valueTransformerName (kTypeDescriptor_GALGAS_valueType.mSlotID,
                                            categoryReader_valueType_valueTransformerName) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_valueType_valueTransformerName (defineCategoryReader_valueType_valueTransformerName, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//     Overriding category reader '@bezierPathType valueTransformerName'     *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_bezierPathType_valueTransformerName (const cPtr_easyBindingType * /* inObject */,
                                                                         C_Compiler * /* inCompiler */
                                                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_bezierPathType_valueTransformerName (void) {
  enterCategoryReader_valueTransformerName (kTypeDescriptor_GALGAS_bezierPathType.mSlotID,
                                            categoryReader_bezierPathType_valueTransformerName) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_bezierPathType_valueTransformerName (defineCategoryReader_bezierPathType_valueTransformerName, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//        Overriding category reader '@menuType valueTransformerName'        *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_menuType_valueTransformerName (const cPtr_easyBindingType * /* inObject */,
                                                                   C_Compiler * /* inCompiler */
                                                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
...
static void defineCategoryReader_menuType_valueTransformerName (void) {
  enterCategoryReader_valueTransformerName (kTypeDescriptor_GALGAS_menuType.mSlotID,
                                            categoryReader_menuType_valueTransformerName) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_menuType_valueTransformerName (defineCategoryReader_menuType_valueTransformerName, NULL) ;
...
static GALGAS_string categoryReader_enumType_preferencesGetterTransformerFunctionName (const cPtr_easyBindingType * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumType) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("(").operator_concat (object->mAttribute_mEnumTypeName COMMA_SOURCE_FILE_AT_LINE (141)).operator_concat (GALGAS_string (") NSIntegerFromNSNumber") COMMA_SOURCE_FILE_AT_LINE (141)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_toManyEntitiesType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("toMany[").operator_concat (object->mAttribute_mEntityName COMMA_SOURCE_FILE_AT_LINE (227)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (227)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_objectArrayType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("array[").operator_concat (object->mAttribute_mClassName COMMA_SOURCE_FILE_AT_LINE (228)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (228)) ;
//---
  return result_outResult ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//      Overriding category reader '@toOneObjectType ebTypeIdentifier'       *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_toOneObjectType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
                                                                      C_Compiler * /* inCompiler */
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_toOneObjectType * object = (const cPtr_toOneObjectType *) inObject ;
  macroValidSharedObject (object, const cPtr_toOneObjectType) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("object[").operator_concat (object->mAttribute_mEntityOrClassName COMMA_SOURCE_FILE_AT_LINE (229)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (229)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_toOneObjectType_ebTypeIdentifier (void) {
  enterCategoryReader_ebTypeIdentifier (kTypeDescriptor_GALGAS_toOneObjectType.mSlotID,
                                        categoryReader_toOneObjectType_ebTypeIdentifier) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_toOneObjectType_ebTypeIdentifier (defineCategoryReader_toOneObjectType_ebTypeIdentifier, NULL) ;
...
static GALGAS_string categoryReader_enumType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumType) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("enum[").operator_concat (object->mAttribute_mEnumTypeName COMMA_SOURCE_FILE_AT_LINE (231)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (231)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_easyBindingType_ebGenericTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  result_outResult = callCategoryReader_ebTypeIdentifier ((const cPtr_easyBindingType *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (237)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_toManyEntitiesType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (244)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (244)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_objectArrayType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("array[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (251)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_enumType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("enum[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (258)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (258)) ;
//---
  return result_outResult ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//         Overriding category reader '@toOneObjectType ocTypeName'          *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_toOneObjectType_ocTypeName (const cPtr_easyBindingType * inObject,
                                                                C_Compiler * /* inCompiler */
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_toOneObjectType * object = (const cPtr_toOneObjectType *) inObject ;
  macroValidSharedObject (object, const cPtr_toOneObjectType) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = object->mAttribute_mEntityOrClassName.operator_concat (GALGAS_string (" *") COMMA_SOURCE_FILE_AT_LINE (282)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_toOneObjectType_ocTypeName (void) {
  enterCategoryReader_ocTypeName (kTypeDescriptor_GALGAS_toOneObjectType.mSlotID,
                                  categoryReader_toOneObjectType_ocTypeName) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_toOneObjectType_ocTypeName (defineCategoryReader_toOneObjectType_ocTypeName, NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//         Overriding category reader '@toOneObjectType ocClassName'         *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_toOneObjectType_ocClassName (const cPtr_easyBindingType * inObject,
                                                                 C_Compiler * /* inCompiler */
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_toOneObjectType * object = (const cPtr_toOneObjectType *) inObject ;
...
static void defineCategoryReader_toOneObjectType_ocClassName (void) {
  enterCategoryReader_ocClassName (kTypeDescriptor_GALGAS_toOneObjectType.mSlotID,
                                   categoryReader_toOneObjectType_ocClassName) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_toOneObjectType_ocClassName (defineCategoryReader_toOneObjectType_ocClassName, NULL) ;
...
static TC_UniqueArray <categoryMethodSignature_easyBindingType_addFileInclusion> gCategoryMethodTable_easyBindingType_addFileInclusion ;
...
void enterCategoryMethod_addFileInclusion (const PMSInt32 inClassIndex,
  ...
  gCategoryMethodTable_easyBindingType_addFileInclusion.forceObjectAtIndex (inClassIndex, inMethod, NULL COMMA_HERE) ;
}
...
void callCategoryMethod_addFileInclusion (const cPtr_easyBindingType * inObject,
  ...
  if (NULL != inObject) {
    ...
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const PMSInt32 classIndex = info->mSlotID ;
    categoryMethodSignature_easyBindingType_addFileInclusion f = NULL ;
    if (classIndex < gCategoryMethodTable_easyBindingType_addFileInclusion.count ()) {
      f = gCategoryMethodTable_easyBindingType_addFileInclusion (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryMethodTable_easyBindingType_addFileInclusion.count ()) {
           f = gCategoryMethodTable_easyBindingType_addFileInclusion (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryMethodTable_easyBindingType_addFileInclusion.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY METHOD CALL ERROR", __FILE__, __LINE__) ;
    }else{
      f (inObject, io_ioFileInclusionSet, inCompiler COMMA_THERE) ;
    }
  }
}
...
static void categoryMethod_easyBindingType_addFileInclusion (const cPtr_easyBindingType * /* inObject */,
                                                             GALGAS_stringset & /* ioArgument_ioFileInclusionSet */,
                                                             C_Compiler * /* inCompiler */
                                                             COMMA_UNUSED_LOCATION_ARGS) {
}
//---------------------------------------------------------------------------*

static void defineCategoryMethod_easyBindingType_addFileInclusion (void) {
  enterCategoryMethod_addFileInclusion (kTypeDescriptor_GALGAS_easyBindingType.mSlotID,
                                        categoryMethod_easyBindingType_addFileInclusion) ;
}

//---------------------------------------------------------------------------*

static void freeCategoryMethod_easyBindingType_addFileInclusion (void) {
  gCategoryMethodTable_easyBindingType_addFileInclusion.free () ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_easyBindingType_addFileInclusion (defineCategoryMethod_easyBindingType_addFileInclusion,
                                                             freeCategoryMethod_easyBindingType_addFileInclusion) ;

//---------------------------------------------------------------------------*
//                                                                           *
//          Overriding category method '@enumType addFileInclusion'          *
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_enumType_addFileInclusion (const cPtr_easyBindingType * inObject,
                                                      GALGAS_stringset & ioArgument_ioFileInclusionSet,
                                                      C_Compiler * /* inCompiler */
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  const cPtr_enumType * object = (const cPtr_enumType *) inObject ;
  ...
  ioArgument_ioFileInclusionSet.addAssign_operation (object->mAttribute_mEnumTypeName COMMA_SOURCE_FILE_AT_LINE (386)) ;
}
//---------------------------------------------------------------------------*

static void defineCategoryMethod_enumType_addFileInclusion (void) {
  enterCategoryMethod_addFileInclusion (kTypeDescriptor_GALGAS_enumType.mSlotID,
                                        categoryMethod_enumType_addFileInclusion) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_enumType_addFileInclusion (defineCategoryMethod_enumType_addFileInclusion, NULL) ;
