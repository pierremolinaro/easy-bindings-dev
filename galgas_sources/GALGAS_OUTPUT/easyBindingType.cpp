...
//                    december 16th, 2012, at 15h13'28"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
static GALGAS_string categoryReader_enumType_preferencesGetterTransformerFunctionName (const cPtr_easyBindingType * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumType) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("(").operator_concat (object->mAttribute_mEnumTypeName COMMA_SOURCE_FILE_AT_LINE (133)).operator_concat (GALGAS_string (") NSIntegerFromNSNumber") COMMA_SOURCE_FILE_AT_LINE (133)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_toManyEntitiesType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("toMany[").operator_concat (object->mAttribute_mEntityName COMMA_SOURCE_FILE_AT_LINE (219)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (219)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_objectArrayType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("array[").operator_concat (object->mAttribute_mClassName COMMA_SOURCE_FILE_AT_LINE (220)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (220)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_enumType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumType) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("enum[").operator_concat (object->mAttribute_mEnumTypeName COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (221)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_easyBindingType_ebGenericTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  result_outResult = callCategoryReader_ebTypeIdentifier ((const cPtr_easyBindingType *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (227)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_toManyEntitiesType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (234)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (234)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_objectArrayType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("array[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (241)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_enumType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("enum[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (248)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (248)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_enumType_addFileInclusion (const cPtr_easyBindingType * inObject,
  ...
  ioArgument_ioFileInclusionSet.addAssign_operation (object->mAttribute_mEnumTypeName COMMA_SOURCE_FILE_AT_LINE (374)) ;
}
//---------------------------------------------------------------------------*
