...
GALGAS_toOneEntityType GALGAS_toOneEntityType::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_toOneEntityType *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "toOneEntityType", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
static GALGAS_string categoryReader_toOneEntityType_ebTypeName (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("PMManagedObject") ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_enumType_preferencesGetterTransformerFunctionName (const cPtr_easyBindingType * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumType) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("(").operator_concat (object->mAttribute_mEnumTypeName COMMA_SOURCE_FILE_AT_LINE (135)).operator_concat (GALGAS_string (") NSIntegerFromNSNumber") COMMA_SOURCE_FILE_AT_LINE (135)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_toOneEntityType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("toOne[").operator_concat (object->mAttribute_mEntityName COMMA_SOURCE_FILE_AT_LINE (223)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (223)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_toManyEntitiesType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("toMany[").operator_concat (object->mAttribute_mEntityName COMMA_SOURCE_FILE_AT_LINE (224)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (224)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_objectArrayType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("array[").operator_concat (object->mAttribute_mClassName COMMA_SOURCE_FILE_AT_LINE (225)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (225)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_enumType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumType) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("enum[").operator_concat (object->mAttribute_mEnumTypeName COMMA_SOURCE_FILE_AT_LINE (227)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (227)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_easyBindingType_ebGenericTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  result_outResult = callCategoryReader_ebTypeIdentifier ((const cPtr_easyBindingType *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (233)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_toManyEntitiesType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (240)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (240)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_objectArrayType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("array[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (247)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (247)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_enumType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("enum[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (254)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_enumType_addFileInclusion (const cPtr_easyBindingType * inObject,
  ...
  ioArgument_ioFileInclusionSet.addAssign_operation (object->mAttribute_mEnumTypeName COMMA_SOURCE_FILE_AT_LINE (380)) ;
}
//---------------------------------------------------------------------------*
...
static GALGAS_string categoryReader_easyBindingType_functionForComputingSignature (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("computeIntSignature") ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_stringType_functionForComputingSignature (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("computeStringSignature") ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_toOneEntityType_functionForComputingSignature (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("computeToOnePropertySignature") ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_toManyEntitiesType_functionForComputingSignature (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("computeToManyPropertySignature") ;
//---
  return result_outResult ;
}
