...
class cCollectionElement_structFieldList : public cCollectionElement {
  public : GALGAS_structFieldList_2E_element mObject ;

//--- Constructor
  public : cCollectionElement_structFieldList (const GALGAS_easyBindingType & in_mFieldType,
...
cCollectionElement_structFieldList::cCollectionElement_structFieldList (const GALGAS_easyBindingType & in_mFieldType,
                                                                        const GALGAS_string & in_mFieldName
                                                                        COMMA_LOCATION_ARGS) :
...
void cCollectionElement_structFieldList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
...
GALGAS_structFieldList GALGAS_structFieldList::constructor_listWithValue (const GALGAS_easyBindingType & inOperand0,
...
void GALGAS_structFieldList::addAssign_operation (const GALGAS_easyBindingType & inOperand0,
                                                  const GALGAS_string & inOperand1
                                                  COMMA_LOCATION_ARGS) {
...
void GALGAS_structFieldList::modifier_prependValue (GALGAS_easyBindingType inOperand0,
...
void GALGAS_structFieldList::modifier_popFirst (GALGAS_easyBindingType & outOperand0,
...
void GALGAS_structFieldList::modifier_popLast (GALGAS_easyBindingType & outOperand0,
                                               GALGAS_string & outOperand1,
                                               C_Compiler * inCompiler
                                               COMMA_LOCATION_ARGS) {
  capCollectionElement attributes ;
...
void GALGAS_structFieldList::method_first (GALGAS_easyBindingType & outOperand0,
                                           GALGAS_string & outOperand1,
                                           C_Compiler * inCompiler
...
void GALGAS_structFieldList::method_last (GALGAS_easyBindingType & outOperand0,
                                          GALGAS_string & outOperand1,
                                          C_Compiler * inCompiler
                                          COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes ;
...
GALGAS_easyBindingType GALGAS_structFieldList::reader_mFieldTypeAtIndex (const GALGAS_uint & inIndex,
                                                                         C_Compiler * inCompiler
                                                                         COMMA_LOCATION_ARGS) const {
...
GALGAS_structFieldList_2E_element cEnumerator_structFieldList::current (LOCATION_ARGS) const {
  const cCollectionElement_structFieldList * p = (const cCollectionElement_structFieldList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_structFieldList) ;
  return p->mObject ;
}
...
GALGAS_easyBindingType cEnumerator_structFieldList::current_mFieldType (LOCATION_ARGS) const {
  const cCollectionElement_structFieldList * p = (const cCollectionElement_structFieldList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_structFieldList) ;
...
typeComparisonResult cPtr_structType::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_structType * p = (const cPtr_structType *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_structType) ;
  if (kOperandEqual == result) {
...
typeComparisonResult GALGAS_structType::objectCompare (const GALGAS_structType & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_structType::GALGAS_structType (void) :
GALGAS_easyBindingType () {
}

//---------------------------------------------------------------------------*

GALGAS_structType GALGAS_structType::constructor_default (LOCATION_ARGS) {
  return GALGAS_structType::constructor_new (GALGAS_lstring::constructor_default (HERE),
...
GALGAS_structType::GALGAS_structType (const cPtr_structType * inSourcePtr) :
GALGAS_easyBindingType (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_structType) ;
}

//---------------------------------------------------------------------------*

GALGAS_structType GALGAS_structType::constructor_new (const GALGAS_lstring & inAttribute_mStructTypeName,
                                                      const GALGAS_structFieldList & inAttribute_mFieldList
                                                      COMMA_LOCATION_ARGS) {
  GALGAS_structType result ;
  if (inAttribute_mStructTypeName.isValid () && inAttribute_mFieldList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_structType (inAttribute_mStructTypeName, inAttribute_mFieldList COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_structType::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_structType * p = (cPtr_structType *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_structType) ;
    cPtr_structType * r = NULL ;
    macroMyNew (r, cPtr_structType (p->mAttribute_mStructTypeName, p->mAttribute_mFieldList COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_lstring GALGAS_structType::reader_mStructTypeName (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    const cPtr_structType * p = (const cPtr_structType *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_structType) ;
...
GALGAS_lstring cPtr_structType::reader_mStructTypeName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mStructTypeName ;
}

//---------------------------------------------------------------------------*

GALGAS_structFieldList GALGAS_structType::reader_mFieldList (UNUSED_LOCATION_ARGS) const {
  GALGAS_structFieldList result ;
  if (NULL != mObjectPtr) {
    const cPtr_structType * p = (const cPtr_structType *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_structType) ;
...
GALGAS_structFieldList cPtr_structType::reader_mFieldList (UNUSED_LOCATION_ARGS) const {
...
cPtr_structType::cPtr_structType (const GALGAS_lstring & in_mStructTypeName,
...
const C_galgas_type_descriptor * cPtr_structType::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_structType ;
}

void cPtr_structType::description (C_String & ioString,
                                   const PMSInt32 inIndentation) const {
  ioString << "[@structType:" ;
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_structType ("structType",
                                   & kTypeDescriptor_GALGAS_easyBindingType) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_structType::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_structType ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_structType::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_structType (*this)) ;
  }
  return result ;
}
...
GALGAS_structType GALGAS_structType::extractObject (const GALGAS_object & inObject,
                                                    C_Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) {
  GALGAS_structType result ;
  const GALGAS_structType * p = (const GALGAS_structType *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_structType *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("structType", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//            Overriding category reader '@structType ebTypeName'            *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_structType_ebTypeName (const cPtr_easyBindingType * inObject,
                                                           C_Compiler * /* inCompiler */
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_structType * object = (const cPtr_structType *) inObject ;
  macroValidSharedObject (object, const cPtr_structType) ;
  result_outResult = object->mAttribute_mStructTypeName.mAttribute_string ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_structType_ebTypeName (void) {
  enterCategoryReader_ebTypeName (kTypeDescriptor_GALGAS_structType.mSlotID,
                                  categoryReader_structType_ebTypeName) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_structType_ebTypeName (defineCategoryReader_structType_ebTypeName, NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//             Overriding category reader '@structType isClass'              *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_bool categoryReader_structType_isClass (const cPtr_easyBindingType * /* inObject */,
                                                      C_Compiler * /* inCompiler */
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_bool result_outResult ; // Returned variable
  result_outResult = GALGAS_bool (false) ;
...
static void defineCategoryReader_structType_isClass (void) {
  enterCategoryReader_isClass (kTypeDescriptor_GALGAS_structType.mSlotID,
                               categoryReader_structType_isClass) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_structType_isClass (defineCategoryReader_structType_isClass, NULL) ;
...
static GALGAS_string categoryReader_enumType_preferencesGetterTransformerFunctionName (const cPtr_easyBindingType * inObject,
  ...
  const cPtr_enumType * object = (const cPtr_enumType *) inObject ;
  macroValidSharedObject (object, const cPtr_enumType) ;
  result_outResult = GALGAS_string ("(").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)).operator_concat (GALGAS_string (") NSIntegerFromNSNumber") COMMA_SOURCE_FILE_AT_LINE (108)) ;
//---
  return result_outResult ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category reader '@structType preferencesGetterTransformerFunctionName'*
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_structType_preferencesGetterTransformerFunctionName (const cPtr_easyBindingType * inObject,
                                                                                         C_Compiler * /* inCompiler */
                                                                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_structType * object = (const cPtr_structType *) inObject ;
  macroValidSharedObject (object, const cPtr_structType) ;
  result_outResult = object->mAttribute_mStructTypeName.mAttribute_string.operator_concat (GALGAS_string ("FromData") COMMA_SOURCE_FILE_AT_LINE (115)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_structType_preferencesGetterTransformerFunctionName (void) {
  enterCategoryReader_preferencesGetterTransformerFunctionName (kTypeDescriptor_GALGAS_structType.mSlotID,
                                                                categoryReader_structType_preferencesGetterTransformerFunctionName) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_structType_preferencesGetterTransformerFunctionName (defineCategoryReader_structType_preferencesGetterTransformerFunctionName, NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category reader '@structType preferencesSetterTransformerFunctionName'*
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_structType_preferencesSetterTransformerFunctionName (const cPtr_easyBindingType * inObject,
                                                                                         C_Compiler * /* inCompiler */
                                                                                         COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_structType * object = (const cPtr_structType *) inObject ;
  macroValidSharedObject (object, const cPtr_structType) ;
  result_outResult = GALGAS_string ("dataEncoded").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (131)) COMMA_SOURCE_FILE_AT_LINE (131)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_structType_preferencesSetterTransformerFunctionName (void) {
  enterCategoryReader_preferencesSetterTransformerFunctionName (kTypeDescriptor_GALGAS_structType.mSlotID,
                                                                categoryReader_structType_preferencesSetterTransformerFunctionName) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_structType_preferencesSetterTransformerFunctionName (defineCategoryReader_structType_preferencesSetterTransformerFunctionName, NULL) ;
...
static TC_UniqueArray <categoryReaderSignature_easyBindingType_equalExpression> gCategoryReaderTable_easyBindingType_equalExpression ;

//---------------------------------------------------------------------------*

void enterCategoryReader_equalExpression (const PMSInt32 inClassIndex,
                                          categoryReaderSignature_easyBindingType_equalExpression inReader) {
  gCategoryReaderTable_easyBindingType_equalExpression.forceObjectAtIndex (inClassIndex, inReader, NULL COMMA_HERE) ;
}

//---------------------------------------------------------------------------*

static void freeCategoryReader_easyBindingType_equalExpression (void) {
  gCategoryReaderTable_easyBindingType_equalExpression.free () ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_easyBindingType_equalExpression (NULL,
                                                            freeCategoryReader_easyBindingType_equalExpression) ;
...
//--- Find Reader
  if (NULL != inObject) {
    ...
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const PMSInt32 classIndex = info->mSlotID ;
    categoryReaderSignature_easyBindingType_equalExpression f = NULL ;
    if (classIndex < gCategoryReaderTable_easyBindingType_equalExpression.count ()) {
      f = gCategoryReaderTable_easyBindingType_equalExpression (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryReaderTable_easyBindingType_equalExpression.count ()) {
           f = gCategoryReaderTable_easyBindingType_equalExpression (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryReaderTable_easyBindingType_equalExpression.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY READER CALL ERROR", __FILE__, __LINE__) ;
    }else{
...
//---------------------------------------------------------------------------*
//                                                                           *
//         Overriding category reader '@integerType equalExpression'         *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_integerType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                                 const GALGAS_string & constinArgument_inExp_31_,
                                                                 const GALGAS_string & constinArgument_inExp_32_,
                                                                 C_Compiler * /* inCompiler */
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = constinArgument_inExp_31_.operator_concat (GALGAS_string (" == ") COMMA_SOURCE_FILE_AT_LINE (179)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (179)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_integerType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_integerType.mSlotID,
                                       categoryReader_integerType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_integerType_equalExpression (defineCategoryReader_integerType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//        Overriding category reader '@uintegerType equalExpression'         *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_uintegerType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                                  const GALGAS_string & constinArgument_inExp_31_,
                                                                  const GALGAS_string & constinArgument_inExp_32_,
                                                                  C_Compiler * /* inCompiler */
                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = constinArgument_inExp_31_.operator_concat (GALGAS_string (" == ") COMMA_SOURCE_FILE_AT_LINE (189)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (189)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_uintegerType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_uintegerType.mSlotID,
                                       categoryReader_uintegerType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_uintegerType_equalExpression (defineCategoryReader_uintegerType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//          Overriding category reader '@boolType equalExpression'           *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_boolType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                              const GALGAS_string & constinArgument_inExp_31_,
                                                              const GALGAS_string & constinArgument_inExp_32_,
                                                              C_Compiler * /* inCompiler */
                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = constinArgument_inExp_31_.operator_concat (GALGAS_string (" == ") COMMA_SOURCE_FILE_AT_LINE (199)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (199)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_boolType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_boolType.mSlotID,
                                       categoryReader_boolType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_boolType_equalExpression (defineCategoryReader_boolType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//         Overriding category reader '@doubleType equalExpression'          *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_doubleType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                                const GALGAS_string & constinArgument_inExp_31_,
                                                                const GALGAS_string & constinArgument_inExp_32_,
                                                                C_Compiler * /* inCompiler */
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = constinArgument_inExp_31_.operator_concat (GALGAS_string (" == ") COMMA_SOURCE_FILE_AT_LINE (209)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (209)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_doubleType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_doubleType.mSlotID,
                                       categoryReader_doubleType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_doubleType_equalExpression (defineCategoryReader_doubleType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//          Overriding category reader '@enumType equalExpression'           *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_enumType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                              const GALGAS_string & constinArgument_inExp_31_,
                                                              const GALGAS_string & constinArgument_inExp_32_,
                                                              C_Compiler * /* inCompiler */
                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = constinArgument_inExp_31_.operator_concat (GALGAS_string (" == ") COMMA_SOURCE_FILE_AT_LINE (219)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (219)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_enumType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_enumType.mSlotID,
                                       categoryReader_enumType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_enumType_equalExpression (defineCategoryReader_enumType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//         Overriding category reader '@structType equalExpression'          *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_structType_equalExpression (const cPtr_easyBindingType * inObject,
                                                                const GALGAS_string & constinArgument_inExp_31_,
                                                                const GALGAS_string & constinArgument_inExp_32_,
                                                                C_Compiler * /* inCompiler */
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  ...
  const cPtr_structType * object = (const cPtr_structType *) inObject ;
  macroValidSharedObject (object, const cPtr_structType) ;
  result_outResult = GALGAS_string ("equal").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (229)) COMMA_SOURCE_FILE_AT_LINE (229)).operator_concat (GALGAS_string ("s (") COMMA_SOURCE_FILE_AT_LINE (229)).operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (229)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (229)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (229)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (229)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_structType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_structType.mSlotID,
                                       categoryReader_structType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_structType_equalExpression (defineCategoryReader_structType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//       Overriding category reader '@toOneEntityType equalExpression'       *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_toOneEntityType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                                     const GALGAS_string & constinArgument_inExp_31_,
                                                                     const GALGAS_string & constinArgument_inExp_32_,
                                                                     C_Compiler * /* inCompiler */
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = constinArgument_inExp_31_.operator_concat (GALGAS_string (" == ") COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (239)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_toOneEntityType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_toOneEntityType.mSlotID,
                                       categoryReader_toOneEntityType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_toOneEntityType_equalExpression (defineCategoryReader_toOneEntityType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//         Overriding category reader '@decimalType equalExpression'         *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_decimalType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                                 const GALGAS_string & constinArgument_inExp_31_,
                                                                 const GALGAS_string & constinArgument_inExp_32_,
                                                                 C_Compiler * /* inCompiler */
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (249)).operator_concat (GALGAS_string (" isEqual:") COMMA_SOURCE_FILE_AT_LINE (249)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (249)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (249)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_decimalType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_decimalType.mSlotID,
                                       categoryReader_decimalType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_decimalType_equalExpression (defineCategoryReader_decimalType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//     Overriding category reader '@toManyEntitiesType equalExpression'      *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_toManyEntitiesType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                                        const GALGAS_string & constinArgument_inExp_31_,
                                                                        const GALGAS_string & constinArgument_inExp_32_,
                                                                        C_Compiler * /* inCompiler */
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (259)).operator_concat (GALGAS_string (" isEqual:") COMMA_SOURCE_FILE_AT_LINE (259)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (259)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (259)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_toManyEntitiesType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_toManyEntitiesType.mSlotID,
                                       categoryReader_toManyEntitiesType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_toManyEntitiesType_equalExpression (defineCategoryReader_toManyEntitiesType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//         Overriding category reader '@stringType equalExpression'          *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_stringType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                                const GALGAS_string & constinArgument_inExp_31_,
                                                                const GALGAS_string & constinArgument_inExp_32_,
                                                                C_Compiler * /* inCompiler */
                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (269)).operator_concat (GALGAS_string (" isEqualToString:") COMMA_SOURCE_FILE_AT_LINE (269)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (269)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (269)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_stringType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_stringType.mSlotID,
                                       categoryReader_stringType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_stringType_equalExpression (defineCategoryReader_stringType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//          Overriding category reader '@dataType equalExpression'           *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_dataType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                              const GALGAS_string & constinArgument_inExp_31_,
                                                              const GALGAS_string & constinArgument_inExp_32_,
                                                              C_Compiler * /* inCompiler */
                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (279)).operator_concat (GALGAS_string (" isEqual:") COMMA_SOURCE_FILE_AT_LINE (279)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (279)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (279)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_dataType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_dataType.mSlotID,
                                       categoryReader_dataType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_dataType_equalExpression (defineCategoryReader_dataType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//          Overriding category reader '@dateType equalExpression'           *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_dateType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                              const GALGAS_string & constinArgument_inExp_31_,
                                                              const GALGAS_string & constinArgument_inExp_32_,
                                                              C_Compiler * /* inCompiler */
                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (289)).operator_concat (GALGAS_string (" isEqual:") COMMA_SOURCE_FILE_AT_LINE (289)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (289)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (289)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_dateType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_dateType.mSlotID,
                                       categoryReader_dateType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_dateType_equalExpression (defineCategoryReader_dateType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//          Overriding category reader '@fontType equalExpression'           *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_fontType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                              const GALGAS_string & constinArgument_inExp_31_,
                                                              const GALGAS_string & constinArgument_inExp_32_,
                                                              C_Compiler * /* inCompiler */
                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (299)).operator_concat (GALGAS_string (" isEqual:") COMMA_SOURCE_FILE_AT_LINE (299)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (299)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (299)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_fontType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_fontType.mSlotID,
                                       categoryReader_fontType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_fontType_equalExpression (defineCategoryReader_fontType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//          Overriding category reader '@imageType equalExpression'          *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_imageType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                               const GALGAS_string & constinArgument_inExp_31_,
                                                               const GALGAS_string & constinArgument_inExp_32_,
                                                               C_Compiler * /* inCompiler */
                                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (309)).operator_concat (GALGAS_string (" isEqual:") COMMA_SOURCE_FILE_AT_LINE (309)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (309)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (309)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_imageType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_imageType.mSlotID,
                                       categoryReader_imageType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_imageType_equalExpression (defineCategoryReader_imageType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//          Overriding category reader '@colorType equalExpression'          *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_colorType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                               const GALGAS_string & constinArgument_inExp_31_,
                                                               const GALGAS_string & constinArgument_inExp_32_,
                                                               C_Compiler * /* inCompiler */
                                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (319)).operator_concat (GALGAS_string (" isEqual:") COMMA_SOURCE_FILE_AT_LINE (319)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (319)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (319)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_colorType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_colorType.mSlotID,
                                       categoryReader_colorType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_colorType_equalExpression (defineCategoryReader_colorType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//          Overriding category reader '@arrayType equalExpression'          *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_arrayType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                               const GALGAS_string & constinArgument_inExp_31_,
                                                               const GALGAS_string & constinArgument_inExp_32_,
                                                               C_Compiler * /* inCompiler */
                                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (329)).operator_concat (GALGAS_string (" isEqual:") COMMA_SOURCE_FILE_AT_LINE (329)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (329)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (329)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_arrayType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_arrayType.mSlotID,
                                       categoryReader_arrayType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_arrayType_equalExpression (defineCategoryReader_arrayType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//          Overriding category reader '@valueType equalExpression'          *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_valueType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                               const GALGAS_string & constinArgument_inExp_31_,
                                                               const GALGAS_string & constinArgument_inExp_32_,
                                                               C_Compiler * /* inCompiler */
                                                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (339)).operator_concat (GALGAS_string (" isEqual:") COMMA_SOURCE_FILE_AT_LINE (339)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (339)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (339)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_valueType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_valueType.mSlotID,
                                       categoryReader_valueType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_valueType_equalExpression (defineCategoryReader_valueType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//       Overriding category reader '@objectArrayType equalExpression'       *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_objectArrayType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                                     const GALGAS_string & constinArgument_inExp_31_,
                                                                     const GALGAS_string & constinArgument_inExp_32_,
                                                                     C_Compiler * /* inCompiler */
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (349)).operator_concat (GALGAS_string (" isEqual:") COMMA_SOURCE_FILE_AT_LINE (349)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (349)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (349)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_objectArrayType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_objectArrayType.mSlotID,
                                       categoryReader_objectArrayType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_objectArrayType_equalExpression (defineCategoryReader_objectArrayType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//       Overriding category reader '@bezierPathType equalExpression'        *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_bezierPathType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                                    const GALGAS_string & constinArgument_inExp_31_,
                                                                    const GALGAS_string & constinArgument_inExp_32_,
                                                                    C_Compiler * /* inCompiler */
                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (359)).operator_concat (GALGAS_string (" isEqual:") COMMA_SOURCE_FILE_AT_LINE (359)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (359)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (359)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_bezierPathType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_bezierPathType.mSlotID,
                                       categoryReader_bezierPathType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_bezierPathType_equalExpression (defineCategoryReader_bezierPathType_equalExpression, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//          Overriding category reader '@menuType equalExpression'           *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_menuType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                              const GALGAS_string & constinArgument_inExp_31_,
                                                              const GALGAS_string & constinArgument_inExp_32_,
                                                              C_Compiler * /* inCompiler */
                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (369)).operator_concat (GALGAS_string (" isEqual:") COMMA_SOURCE_FILE_AT_LINE (369)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (369)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (369)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_menuType_equalExpression (void) {
  enterCategoryReader_equalExpression (kTypeDescriptor_GALGAS_menuType.mSlotID,
                                       categoryReader_menuType_equalExpression) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_menuType_equalExpression (defineCategoryReader_menuType_equalExpression, NULL) ;
...
static GALGAS_string categoryReader_toOneEntityType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  result_outResult = GALGAS_string ("toOne[").operator_concat (object->mAttribute_mEntityName COMMA_SOURCE_FILE_AT_LINE (393)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (393)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_toManyEntitiesType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  result_outResult = GALGAS_string ("toMany[").operator_concat (object->mAttribute_mEntityName COMMA_SOURCE_FILE_AT_LINE (394)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (394)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_objectArrayType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  result_outResult = GALGAS_string ("array[").operator_concat (object->mAttribute_mClassName COMMA_SOURCE_FILE_AT_LINE (395)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (395)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_enumType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  const cPtr_enumType * object = (const cPtr_enumType *) inObject ;
  macroValidSharedObject (object, const cPtr_enumType) ;
  result_outResult = GALGAS_string ("enum[").operator_concat (object->mAttribute_mEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (397)) COMMA_SOURCE_FILE_AT_LINE (397)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (397)) ;
//---
  return result_outResult ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//         Overriding category reader '@structType ebTypeIdentifier'         *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_structType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
                                                                 C_Compiler * /* inCompiler */
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_structType * object = (const cPtr_structType *) inObject ;
  macroValidSharedObject (object, const cPtr_structType) ;
  result_outResult = GALGAS_string ("struct[").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (398)) COMMA_SOURCE_FILE_AT_LINE (398)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (398)) ;
//---
  return result_outResult ;
}
...
static void defineCategoryReader_structType_ebTypeIdentifier (void) {
  enterCategoryReader_ebTypeIdentifier (kTypeDescriptor_GALGAS_structType.mSlotID,
                                        categoryReader_structType_ebTypeIdentifier) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_structType_ebTypeIdentifier (defineCategoryReader_structType_ebTypeIdentifier, NULL) ;
...
static GALGAS_string categoryReader_easyBindingType_ebGenericTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  result_outResult = callCategoryReader_ebTypeIdentifier ((const cPtr_easyBindingType *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (404)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_toManyEntitiesType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
                                                                                ...
                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (411)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (411)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_objectArrayType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
                                                                             ...
                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("array[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (418)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (418)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_enumType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
                                                                      ...
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("enum[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (425)) ;
//---
  return result_outResult ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//            Overriding category reader '@structType ocTypeName'            *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_structType_ocTypeName (const cPtr_easyBindingType * inObject,
                                                           C_Compiler * /* inCompiler */
                                                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_structType * object = (const cPtr_structType *) inObject ;
...
static void defineCategoryReader_structType_ocTypeName (void) {
  enterCategoryReader_ocTypeName (kTypeDescriptor_GALGAS_structType.mSlotID,
                                  categoryReader_structType_ocTypeName) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_structType_ocTypeName (defineCategoryReader_structType_ocTypeName, NULL) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//           Overriding category reader '@structType ocClassName'            *
//                                                                           *
//---------------------------------------------------------------------------*

static GALGAS_string categoryReader_structType_ocClassName (const cPtr_easyBindingType * inObject,
                                                            C_Compiler * /* inCompiler */
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const cPtr_structType * object = (const cPtr_structType *) inObject ;
...
static void defineCategoryReader_structType_ocClassName (void) {
  enterCategoryReader_ocClassName (kTypeDescriptor_GALGAS_structType.mSlotID,
                                   categoryReader_structType_ocClassName) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gReader_structType_ocClassName (defineCategoryReader_structType_ocClassName, NULL) ;
...
static TC_UniqueArray <categoryMethodSignature_easyBindingType_addEnumAndStructType> gCategoryMethodTable_easyBindingType_addEnumAndStructType ;
...
void enterCategoryMethod_addEnumAndStructType (const PMSInt32 inClassIndex,
  ...
  gCategoryMethodTable_easyBindingType_addEnumAndStructType.forceObjectAtIndex (inClassIndex, inMethod, NULL COMMA_HERE) ;
}
...
void callCategoryMethod_addEnumAndStructType (const cPtr_easyBindingType * inObject,
  ...
  if (NULL != inObject) {
    ...
    const C_galgas_type_descriptor * info = inObject->classDescriptor () ;
    const PMSInt32 classIndex = info->mSlotID ;
    categoryMethodSignature_easyBindingType_addEnumAndStructType f = NULL ;
    if (classIndex < gCategoryMethodTable_easyBindingType_addEnumAndStructType.count ()) {
      f = gCategoryMethodTable_easyBindingType_addEnumAndStructType (classIndex COMMA_HERE) ;
    }
    if (NULL == f) {
       const C_galgas_type_descriptor * p = info->mSuperclassDescriptor ;
       while ((NULL == f) && (NULL != p)) {
         if (p->mSlotID < gCategoryMethodTable_easyBindingType_addEnumAndStructType.count ()) {
           f = gCategoryMethodTable_easyBindingType_addEnumAndStructType (p->mSlotID COMMA_HERE) ;
         }
         p = p->mSuperclassDescriptor ;
       }
       gCategoryMethodTable_easyBindingType_addEnumAndStructType.forceObjectAtIndex (classIndex, f, NULL COMMA_HERE) ;
    }
    if (NULL == f) {
      fatalError ("FATAL CATEGORY METHOD CALL ERROR", __FILE__, __LINE__) ;
    }else{
      f (inObject, io_ioSet, inCompiler COMMA_THERE) ;
    }
  }
}
...
static void categoryMethod_easyBindingType_addEnumAndStructType (const cPtr_easyBindingType * /* inObject */,
                                                                 GALGAS_stringset & /* ioArgument_ioSet */,
                                                                 C_Compiler * /* inCompiler */
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
}
//---------------------------------------------------------------------------*

static void defineCategoryMethod_easyBindingType_addEnumAndStructType (void) {
  enterCategoryMethod_addEnumAndStructType (kTypeDescriptor_GALGAS_easyBindingType.mSlotID,
                                            categoryMethod_easyBindingType_addEnumAndStructType) ;
}

//---------------------------------------------------------------------------*

static void freeCategoryMethod_easyBindingType_addEnumAndStructType (void) {
  gCategoryMethodTable_easyBindingType_addEnumAndStructType.free () ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_easyBindingType_addEnumAndStructType (defineCategoryMethod_easyBindingType_addEnumAndStructType,
                                                                 freeCategoryMethod_easyBindingType_addEnumAndStructType) ;

//---------------------------------------------------------------------------*
//                                                                           *
//        Overriding category method '@enumType addEnumAndStructType'        *
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_enumType_addEnumAndStructType (const cPtr_easyBindingType * inObject,
                                                          GALGAS_stringset & ioArgument_ioSet,
                                                          C_Compiler * /* inCompiler */
                                                          COMMA_UNUSED_LOCATION_ARGS) {
  const cPtr_enumType * object = (const cPtr_enumType *) inObject ;
  macroValidSharedObject (object, const cPtr_enumType) ;
  ioArgument_ioSet.addAssign_operation (object->mAttribute_mEnumTypeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (500)) ;
}
//---------------------------------------------------------------------------*

static void defineCategoryMethod_enumType_addEnumAndStructType (void) {
  enterCategoryMethod_addEnumAndStructType (kTypeDescriptor_GALGAS_enumType.mSlotID,
                                            categoryMethod_enumType_addEnumAndStructType) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_enumType_addEnumAndStructType (defineCategoryMethod_enumType_addEnumAndStructType, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//       Overriding category method '@structType addEnumAndStructType'       *
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_structType_addEnumAndStructType (const cPtr_easyBindingType * inObject,
                                                            GALGAS_stringset & ioArgument_ioSet,
                                                            C_Compiler * /* inCompiler */
                                                            COMMA_UNUSED_LOCATION_ARGS) {
  const cPtr_structType * object = (const cPtr_structType *) inObject ;
  macroValidSharedObject (object, const cPtr_structType) ;
  ioArgument_ioSet.addAssign_operation (object->mAttribute_mStructTypeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (506)) ;
}
//---------------------------------------------------------------------------*

static void defineCategoryMethod_structType_addEnumAndStructType (void) {
  enterCategoryMethod_addEnumAndStructType (kTypeDescriptor_GALGAS_structType.mSlotID,
                                            categoryMethod_structType_addEnumAndStructType) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_structType_addEnumAndStructType (defineCategoryMethod_structType_addEnumAndStructType, NULL) ;
...
GALGAS_structFieldList_2E_element::GALGAS_structFieldList_2E_element (void) :
...
GALGAS_structFieldList_2E_element::GALGAS_structFieldList_2E_element (const GALGAS_easyBindingType & inOperand0,
                                                                      const GALGAS_string & inOperand1) :
...
GALGAS_structFieldList_2E_element GALGAS_structFieldList_2E_element::constructor_new (const GALGAS_easyBindingType & inOperand0,
                                                                                      const GALGAS_string & inOperand1 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_structFieldList_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_structFieldList_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_structFieldList_2E_element::objectCompare (const GALGAS_structFieldList_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
...
bool GALGAS_structFieldList_2E_element::isValid (void) const {
  return mAttribute_mFieldType.isValid () && mAttribute_mFieldName.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_structFieldList_2E_element::drop (void) {
...
void GALGAS_structFieldList_2E_element::description (C_String & ioString,
                                                     const PMSInt32 inIndentation) const {
...
GALGAS_easyBindingType GALGAS_structFieldList_2E_element::reader_mFieldType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mFieldType ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_structFieldList_2E_element::reader_mFieldName (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_structFieldList_2E_element ("structFieldList.element",
                                                   NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_structFieldList_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_structFieldList_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_structFieldList_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_structFieldList_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_structFieldList_2E_element GALGAS_structFieldList_2E_element::extractObject (const GALGAS_object & inObject,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_structFieldList_2E_element result ;
  const GALGAS_structFieldList_2E_element * p = (const GALGAS_structFieldList_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_structFieldList_2E_element *> (p)) {
      result = *p ;
    }else{
