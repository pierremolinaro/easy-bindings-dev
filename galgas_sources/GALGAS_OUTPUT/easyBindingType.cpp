...
static GALGAS_string categoryReader_enumType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumType) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("enum[").operator_concat (object->mAttribute_mEnumTypeName COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (222)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_easyBindingType_ebGenericTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  result_outResult = callCategoryReader_ebTypeIdentifier ((const cPtr_easyBindingType *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (228)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_toManyEntitiesType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (235)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (235)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_objectArrayType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("array[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (242)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (242)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_enumType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("enum[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (249)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (249)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_enumType_addFileInclusion (const cPtr_easyBindingType * inObject,
  ...
  ioArgument_ioFileInclusionSet.addAssign_operation (object->mAttribute_mEnumTypeName COMMA_SOURCE_FILE_AT_LINE (375)) ;
}
//---------------------------------------------------------------------------*
