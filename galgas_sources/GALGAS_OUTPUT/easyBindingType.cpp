...
static GALGAS_string categoryReader_integerType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                                 ...
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = constinArgument_inExp_31_.operator_concat (GALGAS_string (" == ") COMMA_SOURCE_FILE_AT_LINE (194)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (194)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_structType_equalExpression (const cPtr_easyBindingType * inObject,
  ...
  const cPtr_structType * object = (const cPtr_structType *) inObject ;
  macroValidSharedObject (object, const cPtr_structType) ;
  result_outResult = GALGAS_string ("equal").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (244)).operator_concat (GALGAS_string ("s (") COMMA_SOURCE_FILE_AT_LINE (244)).operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (244)).operator_concat (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (244)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (244)).operator_concat (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (244)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_decimalType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                                 ...
                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (264)).operator_concat (GALGAS_string (" isEqual:") COMMA_SOURCE_FILE_AT_LINE (264)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (264)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (264)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_toManyEntitiesType_equalExpression (const cPtr_easyBindingType * /* inObject */,
                                                                        ...
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("[").operator_concat (constinArgument_inExp_31_ COMMA_SOURCE_FILE_AT_LINE (274)).operator_concat (GALGAS_string (" isEqual:") COMMA_SOURCE_FILE_AT_LINE (274)).operator_concat (constinArgument_inExp_32_ COMMA_SOURCE_FILE_AT_LINE (274)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (274)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_structType_ebTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  const cPtr_structType * object = (const cPtr_structType *) inObject ;
  macroValidSharedObject (object, const cPtr_structType) ;
  result_outResult = GALGAS_string ("struct[").operator_concat (object->mAttribute_mStructTypeName.reader_string (SOURCE_FILE_AT_LINE (413)) COMMA_SOURCE_FILE_AT_LINE (413)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (413)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_easyBindingType_ebGenericTypeIdentifier (const cPtr_easyBindingType * inObject,
  ...
  result_outResult = callCategoryReader_ebTypeIdentifier ((const cPtr_easyBindingType *) temp_0.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (419)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_toManyEntitiesType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
                                                                                ...
                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (426)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (426)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_objectArrayType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
                                                                             ...
                                                                             COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("array[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (433)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (433)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_enumType_ebGenericTypeIdentifier (const cPtr_easyBindingType * /* inObject */,
                                                                      ...
                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  result_outResult = GALGAS_string ("enum[").operator_concat (constinArgument_inTypeName COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (440)) ;
//---
  return result_outResult ;
}
