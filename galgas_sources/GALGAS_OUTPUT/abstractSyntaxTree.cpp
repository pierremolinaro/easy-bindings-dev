...
typeComparisonResult cPtr_floatType::dynamicObjectCompare (const acPtr_class * /* inOperandPtr */) const {
  return kOperandEqual ;
}
...
typeComparisonResult cPtr_integer_31__36_Type::dynamicObjectCompare (const acPtr_class * /* inOperandPtr */) const {
  return kOperandEqual ;
}
...
typeComparisonResult cPtr_integer_33__32_Type::dynamicObjectCompare (const acPtr_class * /* inOperandPtr */) const {
  return kOperandEqual ;
}
...
typeComparisonResult cPtr_integer_36__34_Type::dynamicObjectCompare (const acPtr_class * /* inOperandPtr */) const {
  return kOperandEqual ;
}
