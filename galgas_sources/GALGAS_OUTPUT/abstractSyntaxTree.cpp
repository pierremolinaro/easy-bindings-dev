...
static const char * gEnumNameArrayFor_easyBindingType [16] = {
  "(not built)",
  "boolType",
  "integer16Type",
  "integer32Type",
...
//--- Constructor
  public : cCollectionElement_dependanceList (const GALGAS_lstring & in_mObjectName,
...
cCollectionElement_dependanceList::cCollectionElement_dependanceList (const GALGAS_lstring & in_mObjectName,
                                                                      const GALGAS_lstring & in_mPropertyName,
                                                                      const GALGAS_bool & in_mNamesCountOption
                                                                      COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mObjectName, in_mPropertyName, in_mNamesCountOption) {
}
...
cCollectionElement * cCollectionElement_dependanceList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_dependanceList (mObject.mAttribute_mObjectName, mObject.mAttribute_mPropertyName, mObject.mAttribute_mNamesCountOption COMMA_HERE)) ;
  return result ;
}
...
void cCollectionElement_dependanceList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mObjectName" ":" ;
  mObject.mAttribute_mObjectName.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mNamesCountOption" ":" ;
  mObject.mAttribute_mNamesCountOption.description (ioString, inIndentation) ;
}
...
GALGAS_dependanceList GALGAS_dependanceList::constructor_listWithValue (const GALGAS_lstring & inOperand0,
                                                                        const GALGAS_lstring & inOperand1,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_dependanceList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_dependanceList::makeAttributesFromObjects (capCollectionElement & outAttributes,
  ...
  macroMyNew (p, cCollectionElement_dependanceList (in_mObjectName,
                                                    in_mPropertyName,
                                                    in_mNamesCountOption COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
void GALGAS_dependanceList::addAssign_operation (const GALGAS_lstring & inOperand0,
                                                 const GALGAS_lstring & inOperand1,
                                                 const GALGAS_bool & inOperand2
                                                 COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_dependanceList (inOperand0, inOperand1, inOperand2 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_dependanceList::modifier_prependValue (GALGAS_lstring inOperand0,
                                                   GALGAS_lstring inOperand1,
...
void GALGAS_dependanceList::modifier_popFirst (GALGAS_lstring & outOperand0,
                                               GALGAS_lstring & outOperand1,
  ...
  if (NULL == p) {
    ...
    outOperand0 = p->mObject.mAttribute_mObjectName ;
    outOperand1 = p->mObject.mAttribute_mPropertyName ;
    outOperand2 = p->mObject.mAttribute_mNamesCountOption ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_dependanceList::modifier_popLast (GALGAS_lstring & outOperand0,
                                              GALGAS_lstring & outOperand1,
                                              GALGAS_bool & outOperand2,
                                              C_Compiler * inCompiler
                                              COMMA_LOCATION_ARGS) {
...
void GALGAS_dependanceList::method_first (GALGAS_lstring & outOperand0,
                                          GALGAS_lstring & outOperand1,
                                          GALGAS_bool & outOperand2,
                                          C_Compiler * inCompiler
                                          COMMA_LOCATION_ARGS) const {
...
void GALGAS_dependanceList::method_last (GALGAS_lstring & outOperand0,
                                         GALGAS_lstring & outOperand1,
                                         GALGAS_bool & outOperand2,
                                         C_Compiler * inCompiler
                                         COMMA_LOCATION_ARGS) const {
...
GALGAS_lstring GALGAS_dependanceList::reader_mObjectNameAtIndex (const GALGAS_uint & inIndex,
                                                                 C_Compiler * inCompiler
                                                                 COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_dependanceList * p = (cCollectionElement_dependanceList *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_dependanceList) ;
    result = p->mObject.mAttribute_mObjectName ;
  }
  return result ;
}
...
GALGAS_lstring GALGAS_dependanceList::reader_mPropertyNameAtIndex (const GALGAS_uint & inIndex,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_dependanceList * p = (cCollectionElement_dependanceList *) attributes.ptr () ;
...
GALGAS_bool GALGAS_dependanceList::reader_mNamesCountOptionAtIndex (const GALGAS_uint & inIndex,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_dependanceList * p = (cCollectionElement_dependanceList *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_dependanceList) ;
    result = p->mObject.mAttribute_mNamesCountOption ;
  }
  return result ;
}
...
GALGAS_lstring cEnumerator_dependanceList::current_mObjectName (LOCATION_ARGS) const {
  const cCollectionElement_dependanceList * p = (const cCollectionElement_dependanceList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_dependanceList) ;
  return p->mObject.mAttribute_mObjectName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring cEnumerator_dependanceList::current_mPropertyName (LOCATION_ARGS) const {
  const cCollectionElement_dependanceList * p = (const cCollectionElement_dependanceList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_dependanceList) ;
...
GALGAS_bool cEnumerator_dependanceList::current_mNamesCountOption (LOCATION_ARGS) const {
  const cCollectionElement_dependanceList * p = (const cCollectionElement_dependanceList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_dependanceList) ;
  return p->mObject.mAttribute_mNamesCountOption ;
}
...
cCollectionElement_multiValuedBindingList::cCollectionElement_multiValuedBindingList (const GALGAS_bool & in_mNegate,
                                                                                      ...
                                                                                      COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mNegate, in_mBoundObjectName, in_mBoundPropertyName, in_mOutletBindingOptionList) {
}
...
cCollectionElement * cCollectionElement_multiValuedBindingList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_multiValuedBindingList (mObject.mAttribute_mNegate, mObject.mAttribute_mBoundObjectName, mObject.mAttribute_mBoundPropertyName, mObject.mAttribute_mOutletBindingOptionList COMMA_HERE)) ;
  return result ;
}
...
void cCollectionElement_multiValuedBindingList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mBoundObjectName" ":" ;
  mObject.mAttribute_mBoundObjectName.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
GALGAS_multiValuedBindingList GALGAS_multiValuedBindingList::constructor_listWithValue (const GALGAS_bool & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_multiValuedBindingList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_multiValuedBindingList::addAssign_operation (const GALGAS_bool & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_multiValuedBindingList (inOperand0, inOperand1, inOperand2, inOperand3 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_multiValuedBindingList::modifier_popFirst (GALGAS_bool & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand1 = p->mObject.mAttribute_mBoundObjectName ;
...
GALGAS_lstring GALGAS_multiValuedBindingList::reader_mBoundObjectNameAtIndex (const GALGAS_uint & inIndex,
                                                                              C_Compiler * inCompiler
                                                                              COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_multiValuedBindingList * p = (cCollectionElement_multiValuedBindingList *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_multiValuedBindingList) ;
    result = p->mObject.mAttribute_mBoundObjectName ;
  }
  return result ;
}
...
GALGAS_lstring GALGAS_multiValuedBindingList::reader_mBoundPropertyNameAtIndex (const GALGAS_uint & inIndex,
                                                                                C_Compiler * inCompiler
                                                                                COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_multiValuedBindingList * p = (cCollectionElement_multiValuedBindingList *) attributes.ptr () ;
...
GALGAS_lstring cEnumerator_multiValuedBindingList::current_mBoundObjectName (LOCATION_ARGS) const {
  const cCollectionElement_multiValuedBindingList * p = (const cCollectionElement_multiValuedBindingList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_multiValuedBindingList) ;
  return p->mObject.mAttribute_mBoundObjectName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring cEnumerator_multiValuedBindingList::current_mBoundPropertyName (LOCATION_ARGS) const {
  const cCollectionElement_multiValuedBindingList * p = (const cCollectionElement_multiValuedBindingList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_multiValuedBindingList) ;
...
cCollectionElement_controllerClassList::cCollectionElement_controllerClassList (const GALGAS_lstring & in_mOutletClassName,
                                                                                ...
                                                                                COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mOutletClassName, in_mGenerateCode, in_mBindingList, in_mActionDeclarationList, in_mControllerObservablePropertyList) {
}
...
cCollectionElement * cCollectionElement_controllerClassList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_controllerClassList (mObject.mAttribute_mOutletClassName, mObject.mAttribute_mGenerateCode, mObject.mAttribute_mBindingList, mObject.mAttribute_mActionDeclarationList, mObject.mAttribute_mControllerObservablePropertyList COMMA_HERE)) ;
  return result ;
}
...
typeComparisonResult cPtr_regularBinding::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_regularBinding * p = (const cPtr_regularBinding *) inOperandPtr ;
  macroValidSharedObject (p, const cPtr_regularBinding) ;
  if (kOperandEqual == result) {
    result = mAttribute_mBindingName.objectCompare (p->mAttribute_mBindingName) ;
  }
  if (kOperandEqual == result) {
...
typeComparisonResult GALGAS_regularBinding::objectCompare (const GALGAS_regularBinding & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const PMSInt32 mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const PMSInt32 operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_regularBinding::GALGAS_regularBinding (void) :
GALGAS_abstractBinding () {
}

//---------------------------------------------------------------------------*

GALGAS_regularBinding::GALGAS_regularBinding (const cPtr_regularBinding * inSourcePtr) :
GALGAS_abstractBinding (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_regularBinding) ;
}

//---------------------------------------------------------------------------*

GALGAS_regularBinding GALGAS_regularBinding::constructor_new (const GALGAS_lstring & inAttribute_mBindingName,
                                                              const GALGAS_lstring & inAttribute_mObservedObjectName,
                                                              ...
                                                              COMMA_LOCATION_ARGS) {
  GALGAS_regularBinding result ;
  if (inAttribute_mBindingName.isValid () && inAttribute_mObservedObjectName.isValid () && inAttribute_mObservableAttributeName.isValid () && inAttribute_mOutletBindingOptionList.isValid () && inAttribute_mNamesCountOption.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_regularBinding (inAttribute_mBindingName, inAttribute_mObservedObjectName, inAttribute_mObservableAttributeName, inAttribute_mOutletBindingOptionList, inAttribute_mNamesCountOption COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_regularBinding::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_regularBinding * p = (cPtr_regularBinding *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_regularBinding) ;
    cPtr_regularBinding * r = NULL ;
    macroMyNew (r, cPtr_regularBinding (p->mAttribute_mBindingName, p->mAttribute_mObservedObjectName, p->mAttribute_mObservableAttributeName, p->mAttribute_mOutletBindingOptionList, p->mAttribute_mNamesCountOption COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_lstring GALGAS_regularBinding::reader_mBindingName (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    const cPtr_regularBinding * p = (const cPtr_regularBinding *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_regularBinding) ;
    result = p->mAttribute_mBindingName ;
  }
  return result ;
...
GALGAS_lstring cPtr_regularBinding::reader_mBindingName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mBindingName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_regularBinding::reader_mObservedObjectName (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    const cPtr_regularBinding * p = (const cPtr_regularBinding *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_regularBinding) ;
...
GALGAS_lstring cPtr_regularBinding::reader_mObservedObjectName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mObservedObjectName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_regularBinding::reader_mObservableAttributeName (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
    const cPtr_regularBinding * p = (const cPtr_regularBinding *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_regularBinding) ;
...
GALGAS_lstring cPtr_regularBinding::reader_mObservableAttributeName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mObservableAttributeName ;
}

//---------------------------------------------------------------------------*

GALGAS_outletBindingOptionList GALGAS_regularBinding::reader_mOutletBindingOptionList (UNUSED_LOCATION_ARGS) const {
  GALGAS_outletBindingOptionList result ;
  if (NULL != mObjectPtr) {
    const cPtr_regularBinding * p = (const cPtr_regularBinding *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_regularBinding) ;
...
GALGAS_outletBindingOptionList cPtr_regularBinding::reader_mOutletBindingOptionList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOutletBindingOptionList ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_regularBinding::reader_mNamesCountOption (UNUSED_LOCATION_ARGS) const {
  GALGAS_bool result ;
  if (NULL != mObjectPtr) {
    const cPtr_regularBinding * p = (const cPtr_regularBinding *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_regularBinding) ;
...
GALGAS_bool cPtr_regularBinding::reader_mNamesCountOption (UNUSED_LOCATION_ARGS) const {
...
cPtr_regularBinding::cPtr_regularBinding (const GALGAS_lstring & in_mBindingName,
...
const C_galgas_type_descriptor * cPtr_regularBinding::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_regularBinding ;
}

void cPtr_regularBinding::description (C_String & ioString,
                                       const PMSInt32 inIndentation) const {
  ioString << "[@regularBinding:" ;
  mAttribute_mBindingName.description (ioString, inIndentation+1) ;
  ioString << ", " ;
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_regularBinding ("regularBinding",
                                       & kTypeDescriptor_GALGAS_abstractBinding) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_regularBinding::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_regularBinding ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_regularBinding::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_regularBinding (*this)) ;
  }
  return result ;
}
...
GALGAS_regularBinding GALGAS_regularBinding::extractObject (const GALGAS_object & inObject,
                                                            C_Compiler * inCompiler,
                                                            const GALGAS_location & inErrorLocation
                                                            COMMA_LOCATION_ARGS) {
  GALGAS_regularBinding result ;
  const GALGAS_regularBinding * p = (const GALGAS_regularBinding *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_regularBinding *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "regularBinding", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
mAttribute_mObjectName (),
mAttribute_mPropertyName (),
mAttribute_mNamesCountOption () {
}
...
GALGAS_dependanceList_2E_element::GALGAS_dependanceList_2E_element (const GALGAS_lstring & inOperand0,
                                                                    const GALGAS_lstring & inOperand1,
                                                                    const GALGAS_bool & inOperand2) :
mAttribute_mObjectName (inOperand0),
mAttribute_mPropertyName (inOperand1),
mAttribute_mNamesCountOption (inOperand2) {
}

//---------------------------------------------------------------------------*

GALGAS_dependanceList_2E_element GALGAS_dependanceList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                    const GALGAS_lstring & inOperand1,
                                                                                    const GALGAS_bool & inOperand2 
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_dependanceList_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_dependanceList_2E_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_dependanceList_2E_element::objectCompare (const GALGAS_dependanceList_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mObjectName.objectCompare (inOperand.mAttribute_mObjectName) ;
  }
  if (result == kOperandEqual) {
    result = mAttribute_mPropertyName.objectCompare (inOperand.mAttribute_mPropertyName) ;
  }
  if (result == kOperandEqual) {
    result = mAttribute_mNamesCountOption.objectCompare (inOperand.mAttribute_mNamesCountOption) ;
  }
  return result ;
}
...
bool GALGAS_dependanceList_2E_element::isValid (void) const {
  return mAttribute_mObjectName.isValid () && mAttribute_mPropertyName.isValid () && mAttribute_mNamesCountOption.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_dependanceList_2E_element::drop (void) {
  mAttribute_mObjectName.drop () ;
  mAttribute_mPropertyName.drop () ;
  mAttribute_mNamesCountOption.drop () ;
}
...
GALGAS_lstring GALGAS_dependanceList_2E_element::reader_mObjectName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mObjectName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_dependanceList_2E_element::reader_mPropertyName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPropertyName ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_dependanceList_2E_element::reader_mNamesCountOption (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mNamesCountOption ;
}
...
mAttribute_mBoundObjectName (inOperand1),
...
GALGAS_multiValuedBindingList_2E_element GALGAS_multiValuedBindingList_2E_element::constructor_new (const GALGAS_bool & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_multiValuedBindingList_2E_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_multiValuedBindingList_2E_element::objectCompare (const GALGAS_multiValuedBindingList_2E_element & inOperand) const {
  ...
  if (result == kOperandEqual) {
    result = mAttribute_mBoundObjectName.objectCompare (inOperand.mAttribute_mBoundObjectName) ;
  }
  if (result == kOperandEqual) {
...
bool GALGAS_multiValuedBindingList_2E_element::isValid (void) const {
  return mAttribute_mNegate.isValid () && mAttribute_mBoundObjectName.isValid () && mAttribute_mBoundPropertyName.isValid () && mAttribute_mOutletBindingOptionList.isValid () ;
}
...
void GALGAS_multiValuedBindingList_2E_element::drop (void) {
  ...
  mAttribute_mBoundObjectName.drop () ;
...
void GALGAS_multiValuedBindingList_2E_element::description (C_String & ioString,
  ...
  if (! isValid ()) {
    ...
    ioString << ", " ;
    mAttribute_mBoundObjectName.description (ioString, inIndentation+1) ;
    ioString << ", " ;
...
GALGAS_lstring GALGAS_multiValuedBindingList_2E_element::reader_mBoundObjectName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mBoundObjectName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_multiValuedBindingList_2E_element::reader_mBoundPropertyName (UNUSED_LOCATION_ARGS) const {
...
bool GALGAS_controllerClassList_2E_element::isValid (void) const {
  return mAttribute_mOutletClassName.isValid () && mAttribute_mGenerateCode.isValid () && mAttribute_mBindingList.isValid () && mAttribute_mActionDeclarationList.isValid () && mAttribute_mControllerObservablePropertyList.isValid () ;
}
...
GALGAS_lstring GALGAS_controllerClassList_2E_element::reader_mOutletClassName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOutletClassName ;
}
