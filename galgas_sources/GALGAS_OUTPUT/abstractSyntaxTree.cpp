...
//---------------------------------------------------------------------------*
//                                                                           *
//              Class for element of '@classPropertyList' list               *
//                                                                           *
//---------------------------------------------------------------------------*

class cCollectionElement_classPropertyList : public cCollectionElement {
//--- List attributes
...
//--- Constructor
  public : cCollectionElement_classPropertyList (const GALGAS_easyBindingType & in_mType,
...
cCollectionElement_classPropertyList::cCollectionElement_classPropertyList (const GALGAS_easyBindingType & in_mType,
                                                                            const GALGAS_lstring & in_mPropertyName,
                                                                            const GALGAS_easyBindingTypeList & in_mDefaultValueCorrespondingAcceptableTypes,
                                                                            const GALGAS_string & in_mDefaultValueObjectiveCObject
                                                                            COMMA_LOCATION_ARGS) :
...
bool cCollectionElement_classPropertyList::isValid (void) const {
...
cCollectionElement * cCollectionElement_classPropertyList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_classPropertyList (mAttribute_mType, mAttribute_mPropertyName, mAttribute_mDefaultValueCorrespondingAcceptableTypes, mAttribute_mDefaultValueObjectiveCObject COMMA_HERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

void cCollectionElement_classPropertyList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
...
typeComparisonResult cCollectionElement_classPropertyList::compare (const cCollectionElement * inOperand) const {
  cCollectionElement_classPropertyList * operand = (cCollectionElement_classPropertyList *) inOperand ;
...
GALGAS_classPropertyList::GALGAS_classPropertyList (void) :
AC_GALGAS_list () {
}

//---------------------------------------------------------------------------*

GALGAS_classPropertyList::GALGAS_classPropertyList (cSharedList * inSharedListPtr) :
...
GALGAS_classPropertyList GALGAS_classPropertyList::constructor_emptyList (LOCATION_ARGS) {
  GALGAS_classPropertyList result ;
...
GALGAS_classPropertyList GALGAS_classPropertyList::constructor_listWithValue (const GALGAS_easyBindingType & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    ...
    GALGAS_classPropertyList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3 COMMA_THERE) ;
...
void GALGAS_classPropertyList::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                          const GALGAS_easyBindingType & in_mType,
                                                          const GALGAS_lstring & in_mPropertyName,
                                                          const GALGAS_easyBindingTypeList & in_mDefaultValueCorrespondingAcceptableTypes,
                                                          const GALGAS_string & in_mDefaultValueObjectiveCObject
                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_classPropertyList * p = NULL ;
  macroMyNew (p, cCollectionElement_classPropertyList (in_mType,
                                                          in_mPropertyName,
...
void GALGAS_classPropertyList::addAssign_operation (const GALGAS_easyBindingType & inOperand0,
                                                    const GALGAS_lstring & inOperand1,
                                                    const GALGAS_easyBindingTypeList & inOperand2,
                                                    const GALGAS_string & inOperand3
                                                    COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    ...
    macroMyNew (p, cCollectionElement_classPropertyList (inOperand0, inOperand1, inOperand2, inOperand3 COMMA_THERE)) ;
    capCollectionElement attributes ;
...
void GALGAS_classPropertyList::modifier_prependValue (GALGAS_easyBindingType inOperand0,
...
void GALGAS_classPropertyList::modifier_popFirst (GALGAS_easyBindingType & outOperand0,
  ...
  cCollectionElement_classPropertyList * p = (cCollectionElement_classPropertyList *) attributes.ptr () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
    outOperand2.drop () ;
    ...
    macroValidSharedObject (p, cCollectionElement_classPropertyList) ;
...
void GALGAS_classPropertyList::modifier_popLast (GALGAS_easyBindingType & outOperand0,
                                                 GALGAS_lstring & outOperand1,
                                                 GALGAS_easyBindingTypeList & outOperand2,
                                                 GALGAS_string & outOperand3,
                                                 C_Compiler * inCompiler
...
void GALGAS_classPropertyList::method_first (GALGAS_easyBindingType & outOperand0,
                                             GALGAS_lstring & outOperand1,
                                             GALGAS_easyBindingTypeList & outOperand2,
                                             GALGAS_string & outOperand3,
                                             C_Compiler * inCompiler
...
void GALGAS_classPropertyList::method_last (GALGAS_easyBindingType & outOperand0,
                                            GALGAS_lstring & outOperand1,
                                            GALGAS_easyBindingTypeList & outOperand2,
                                            GALGAS_string & outOperand3,
                                            C_Compiler * inCompiler
...
GALGAS_classPropertyList GALGAS_classPropertyList::operator_concat (const GALGAS_classPropertyList & inOperand
...
GALGAS_classPropertyList GALGAS_classPropertyList::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                            const GALGAS_uint & inLength,
                                                                            C_Compiler * inCompiler
                                                                            COMMA_LOCATION_ARGS) const {
  GALGAS_classPropertyList result = GALGAS_classPropertyList::constructor_emptyList (THERE) ;
...
GALGAS_classPropertyList GALGAS_classPropertyList::reader_subListFromIndex (const GALGAS_uint & inIndex,
                                                                            C_Compiler * inCompiler
                                                                            COMMA_LOCATION_ARGS) const {
  GALGAS_classPropertyList result = GALGAS_classPropertyList::constructor_emptyList (THERE) ;
...
void GALGAS_classPropertyList::dotAssign_operation (const GALGAS_classPropertyList inOperand
...
void GALGAS_classPropertyList::modifier_setMTypeAtIndex (GALGAS_easyBindingType inOperand,
                                                         GALGAS_uint inIndex,
                                                         C_Compiler * inCompiler
                                                         COMMA_LOCATION_ARGS) {
  cCollectionElement_classPropertyList * p = (cCollectionElement_classPropertyList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_classPropertyList) ;
...
void GALGAS_classPropertyList::modifier_setMPropertyNameAtIndex (GALGAS_lstring inOperand,
                                                                 GALGAS_uint inIndex,
                                                                 C_Compiler * inCompiler
                                                                 COMMA_LOCATION_ARGS) {
  cCollectionElement_classPropertyList * p = (cCollectionElement_classPropertyList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_classPropertyList::modifier_setMDefaultValueCorrespondingAcceptableTypesAtIndex (GALGAS_easyBindingTypeList inOperand,
                                                                                             GALGAS_uint inIndex,
                                                                                             C_Compiler * inCompiler
                                                                                             COMMA_LOCATION_ARGS) {
  cCollectionElement_classPropertyList * p = (cCollectionElement_classPropertyList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_classPropertyList) ;
    p->mAttribute_mDefaultValueCorrespondingAcceptableTypes = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_classPropertyList::modifier_setMDefaultValueObjectiveCObjectAtIndex (GALGAS_string inOperand,
                                                                                 GALGAS_uint inIndex,
                                                                                 C_Compiler * inCompiler
                                                                                 COMMA_LOCATION_ARGS) {
  cCollectionElement_classPropertyList * p = (cCollectionElement_classPropertyList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_classPropertyList) ;
    p->mAttribute_mDefaultValueObjectiveCObject = inOperand ;
  }
}
...
GALGAS_easyBindingType GALGAS_classPropertyList::reader_mTypeAtIndex (const GALGAS_uint & inIndex,
                                                                      C_Compiler * inCompiler
                                                                      COMMA_LOCATION_ARGS) const {
...
GALGAS_lstring GALGAS_classPropertyList::reader_mPropertyNameAtIndex (const GALGAS_uint & inIndex,
                                                                      C_Compiler * inCompiler
                                                                      COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_classPropertyList * p = (cCollectionElement_classPropertyList *) attributes.ptr () ;
...
GALGAS_easyBindingTypeList GALGAS_classPropertyList::reader_mDefaultValueCorrespondingAcceptableTypesAtIndex (const GALGAS_uint & inIndex,
                                                                                                              C_Compiler * inCompiler
                                                                                                              COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_classPropertyList * p = (cCollectionElement_classPropertyList *) attributes.ptr () ;
...
GALGAS_string GALGAS_classPropertyList::reader_mDefaultValueObjectiveCObjectAtIndex (const GALGAS_uint & inIndex,
                                                                                     C_Compiler * inCompiler
                                                                                     COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_classPropertyList * p = (cCollectionElement_classPropertyList *) attributes.ptr () ;
...
cEnumerator_classPropertyList::cEnumerator_classPropertyList (const GALGAS_classPropertyList & inEnumeratedObject,
...
GALGAS_easyBindingType cEnumerator_classPropertyList::current_mType (LOCATION_ARGS) const {
  const cCollectionElement_classPropertyList * p = (const cCollectionElement_classPropertyList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_classPropertyList) ;
  return p->mAttribute_mType ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring cEnumerator_classPropertyList::current_mPropertyName (LOCATION_ARGS) const {
  const cCollectionElement_classPropertyList * p = (const cCollectionElement_classPropertyList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_classPropertyList) ;
...
GALGAS_easyBindingTypeList cEnumerator_classPropertyList::current_mDefaultValueCorrespondingAcceptableTypes (LOCATION_ARGS) const {
  const cCollectionElement_classPropertyList * p = (const cCollectionElement_classPropertyList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_classPropertyList) ;
...
GALGAS_string cEnumerator_classPropertyList::current_mDefaultValueObjectiveCObject (LOCATION_ARGS) const {
  const cCollectionElement_classPropertyList * p = (const cCollectionElement_classPropertyList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_classPropertyList) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                          @classPropertyList type                          *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_classPropertyList ("classPropertyList",
                                          NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_classPropertyList::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_classPropertyList ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_classPropertyList::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_classPropertyList (*this)) ;
  }
  return result ;
}
...
GALGAS_classPropertyList GALGAS_classPropertyList::extractObject (const GALGAS_object & inObject,
                                                                  C_Compiler * inCompiler,
                                                                  const GALGAS_location & inErrorLocation
                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_classPropertyList result ;
  const GALGAS_classPropertyList * p = (const GALGAS_classPropertyList *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_classPropertyList *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "classPropertyList", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//              Class for element of '@classTransientList' list              *
//                                                                           *
//---------------------------------------------------------------------------*

class cCollectionElement_classTransientList : public cCollectionElement {
//--- List attributes
  public : GALGAS_easyBindingType mAttribute_mType ;
...
//--- Constructor
  public : cCollectionElement_classTransientList (const GALGAS_easyBindingType & in_mType,
...
cCollectionElement_classTransientList::cCollectionElement_classTransientList (const GALGAS_easyBindingType & in_mType,
                                                                              const GALGAS_lstring & in_mTransientName,
                                                                              const GALGAS_lstringlist & in_mDependencyList
                                                                              COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
...
bool cCollectionElement_classTransientList::isValid (void) const {
  return mAttribute_mType.isValid () && mAttribute_mTransientName.isValid () && mAttribute_mDependencyList.isValid () ;
}

//---------------------------------------------------------------------------*

cCollectionElement * cCollectionElement_classTransientList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_classTransientList (mAttribute_mType, mAttribute_mTransientName, mAttribute_mDependencyList COMMA_HERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

void cCollectionElement_classTransientList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mType" ":" ;
  mAttribute_mType.description (ioString, inIndentation) ;
...
typeComparisonResult cCollectionElement_classTransientList::compare (const cCollectionElement * inOperand) const {
  cCollectionElement_classTransientList * operand = (cCollectionElement_classTransientList *) inOperand ;
  typeComparisonResult result = kOperandEqual ;
  if (kOperandEqual == result) {
    result = mAttribute_mType.objectCompare (operand->mAttribute_mType) ;
  }
...
GALGAS_classTransientList::GALGAS_classTransientList (void) :
AC_GALGAS_list () {
}

//---------------------------------------------------------------------------*

GALGAS_classTransientList::GALGAS_classTransientList (cSharedList * inSharedListPtr) :
AC_GALGAS_list (inSharedListPtr) {
  if (NULL == inSharedListPtr) {
    createNewEmptyList (HERE) ;
  }
...
GALGAS_classTransientList GALGAS_classTransientList::constructor_emptyList (LOCATION_ARGS) {
  GALGAS_classTransientList result ;
  result.createNewEmptyList (THERE) ;
  return result ;
}
...
GALGAS_classTransientList GALGAS_classTransientList::constructor_listWithValue (const GALGAS_easyBindingType & inOperand0,
                                                                                const GALGAS_lstring & inOperand1,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_classTransientList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_classTransientList::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                           const GALGAS_easyBindingType & in_mType,
                                                           const GALGAS_lstring & in_mTransientName,
                                                           const GALGAS_lstringlist & in_mDependencyList
                                                           COMMA_LOCATION_ARGS) {
  cCollectionElement_classTransientList * p = NULL ;
  macroMyNew (p, cCollectionElement_classTransientList (in_mType,
                                                           in_mTransientName,
...
void GALGAS_classTransientList::addAssign_operation (const GALGAS_easyBindingType & inOperand0,
                                                     const GALGAS_lstring & inOperand1,
                                                     const GALGAS_lstringlist & inOperand2
                                                     COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_classTransientList (inOperand0, inOperand1, inOperand2 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_classTransientList::modifier_prependValue (GALGAS_easyBindingType inOperand0,
                                                       GALGAS_lstring inOperand1,
...
void GALGAS_classTransientList::modifier_popFirst (GALGAS_easyBindingType & outOperand0,
                                                   GALGAS_lstring & outOperand1,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_classTransientList * p = (cCollectionElement_classTransientList *) attributes.ptr () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
    outOperand2.drop () ;
  }else{
    macroValidSharedObject (p, cCollectionElement_classTransientList) ;
    outOperand0 = p->mAttribute_mType ;
...
void GALGAS_classTransientList::modifier_popLast (GALGAS_easyBindingType & outOperand0,
                                                  GALGAS_lstring & outOperand1,
                                                  GALGAS_lstringlist & outOperand2,
                                                  C_Compiler * inCompiler
                                                  COMMA_LOCATION_ARGS) {
...
void GALGAS_classTransientList::method_first (GALGAS_easyBindingType & outOperand0,
                                              GALGAS_lstring & outOperand1,
                                              GALGAS_lstringlist & outOperand2,
                                              C_Compiler * inCompiler
                                              COMMA_LOCATION_ARGS) const {
...
void GALGAS_classTransientList::method_last (GALGAS_easyBindingType & outOperand0,
                                             GALGAS_lstring & outOperand1,
                                             GALGAS_lstringlist & outOperand2,
                                             C_Compiler * inCompiler
                                             COMMA_LOCATION_ARGS) const {
...
GALGAS_classTransientList GALGAS_classTransientList::operator_concat (const GALGAS_classTransientList & inOperand
                                                                      COMMA_UNUSED_LOCATION_ARGS) const {
  GALGAS_classTransientList result ;
  if (isValid () && inOperand.isValid ()) {
    result = *this ;
...
GALGAS_classTransientList GALGAS_classTransientList::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                              const GALGAS_uint & inLength,
                                                                              C_Compiler * inCompiler
                                                                              COMMA_LOCATION_ARGS) const {
  GALGAS_classTransientList result = GALGAS_classTransientList::constructor_emptyList (THERE) ;
  subListWithRange (result, inIndex, inLength, inCompiler COMMA_THERE) ;
  return result ;
}
...
GALGAS_classTransientList GALGAS_classTransientList::reader_subListFromIndex (const GALGAS_uint & inIndex,
                                                                              C_Compiler * inCompiler
                                                                              COMMA_LOCATION_ARGS) const {
  GALGAS_classTransientList result = GALGAS_classTransientList::constructor_emptyList (THERE) ;
  subListFromIndex (result, inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_classTransientList::dotAssign_operation (const GALGAS_classTransientList inOperand
                                                     COMMA_UNUSED_LOCATION_ARGS) {
  appendList (inOperand) ;
}
...
void GALGAS_classTransientList::modifier_setMTypeAtIndex (GALGAS_easyBindingType inOperand,
                                                          GALGAS_uint inIndex,
                                                          C_Compiler * inCompiler
                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_classTransientList * p = (cCollectionElement_classTransientList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_classTransientList) ;
    p->mAttribute_mType = inOperand ;
  }
...
void GALGAS_classTransientList::modifier_setMTransientNameAtIndex (GALGAS_lstring inOperand,
                                                                   GALGAS_uint inIndex,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) {
  cCollectionElement_classTransientList * p = (cCollectionElement_classTransientList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_classTransientList::modifier_setMDependencyListAtIndex (GALGAS_lstringlist inOperand,
                                                                    GALGAS_uint inIndex,
                                                                    C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) {
  cCollectionElement_classTransientList * p = (cCollectionElement_classTransientList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_easyBindingType GALGAS_classTransientList::reader_mTypeAtIndex (const GALGAS_uint & inIndex,
                                                                       C_Compiler * inCompiler
                                                                       COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_classTransientList * p = (cCollectionElement_classTransientList *) attributes.ptr () ;
...
GALGAS_lstring GALGAS_classTransientList::reader_mTransientNameAtIndex (const GALGAS_uint & inIndex,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_classTransientList * p = (cCollectionElement_classTransientList *) attributes.ptr () ;
...
GALGAS_lstringlist GALGAS_classTransientList::reader_mDependencyListAtIndex (const GALGAS_uint & inIndex,
                                                                             C_Compiler * inCompiler
                                                                             COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_classTransientList * p = (cCollectionElement_classTransientList *) attributes.ptr () ;
...
cEnumerator_classTransientList::cEnumerator_classTransientList (const GALGAS_classTransientList & inEnumeratedObject,
                                                                const typeEnumerationOrder inOrder) :
cGenericAbstractEnumerator () {
  inEnumeratedObject.populateEnumerationArray (mEnumerationArray, inOrder) ;
}
...
GALGAS_easyBindingType cEnumerator_classTransientList::current_mType (LOCATION_ARGS) const {
  const cCollectionElement_classTransientList * p = (const cCollectionElement_classTransientList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_classTransientList) ;
  return p->mAttribute_mType ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring cEnumerator_classTransientList::current_mTransientName (LOCATION_ARGS) const {
  const cCollectionElement_classTransientList * p = (const cCollectionElement_classTransientList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_classTransientList) ;
...
GALGAS_lstringlist cEnumerator_classTransientList::current_mDependencyList (LOCATION_ARGS) const {
  const cCollectionElement_classTransientList * p = (const cCollectionElement_classTransientList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_classTransientList) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                         @classTransientList type                          *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_classTransientList ("classTransientList",
                                           NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_classTransientList::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_classTransientList ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_classTransientList::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_classTransientList (*this)) ;
  }
  return result ;
}
...
GALGAS_classTransientList GALGAS_classTransientList::extractObject (const GALGAS_object & inObject,
                                                                    C_Compiler * inCompiler,
                                                                    const GALGAS_location & inErrorLocation
                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_classTransientList result ;
  const GALGAS_classTransientList * p = (const GALGAS_classTransientList *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_classTransientList *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "classTransientList", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
//--- List attributes
  ...
  public : GALGAS_classPropertyList mAttribute_mPropertyList ;
  public : GALGAS_classTransientList mAttribute_mClassTransientList ;
...
void GALGAS_classList::modifier_prependValue (GALGAS_lstring inOperand0,
                                              GALGAS_lstring inOperand1,
                                              GALGAS_classPropertyList inOperand2,
                                              GALGAS_classTransientList inOperand3
                                              COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_classList (inOperand0, inOperand1, inOperand2, inOperand3 COMMA_THERE)) ;
...
void GALGAS_classList::modifier_popFirst (GALGAS_lstring & outOperand0,
                                          GALGAS_lstring & outOperand1,
                                          GALGAS_classPropertyList & outOperand2,
                                          GALGAS_classTransientList & outOperand3,
                                          C_Compiler * inCompiler
                                          COMMA_LOCATION_ARGS) {
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
...
void GALGAS_classList::modifier_setMClassNameAtIndex (GALGAS_lstring inOperand,
                                                      GALGAS_uint inIndex,
                                                      C_Compiler * inCompiler
                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement_classList * p = (cCollectionElement_classList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_classList) ;
...
void GALGAS_classList::modifier_setMSuperClassNameAtIndex (GALGAS_lstring inOperand,
                                                           GALGAS_uint inIndex,
                                                           C_Compiler * inCompiler
                                                           COMMA_LOCATION_ARGS) {
  cCollectionElement_classList * p = (cCollectionElement_classList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_classList) ;
    p->mAttribute_mSuperClassName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_classList::modifier_setMPropertyListAtIndex (GALGAS_classPropertyList inOperand,
                                                         GALGAS_uint inIndex,
                                                         C_Compiler * inCompiler
                                                         COMMA_LOCATION_ARGS) {
  cCollectionElement_classList * p = (cCollectionElement_classList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_classList) ;
    p->mAttribute_mPropertyList = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_classList::modifier_setMClassTransientListAtIndex (GALGAS_classTransientList inOperand,
                                                               GALGAS_uint inIndex,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) {
  cCollectionElement_classList * p = (cCollectionElement_classList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_classList) ;
    p->mAttribute_mClassTransientList = inOperand ;
  }
}
...
GALGAS_classPropertyList GALGAS_classList::reader_mPropertyListAtIndex (const GALGAS_uint & inIndex,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_classList * p = (cCollectionElement_classList *) attributes.ptr () ;
...
GALGAS_classTransientList GALGAS_classList::reader_mClassTransientListAtIndex (const GALGAS_uint & inIndex,
                                                                               C_Compiler * inCompiler
                                                                               COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_classList * p = (cCollectionElement_classList *) attributes.ptr () ;
...
GALGAS_classPropertyList cEnumerator_classList::current_mPropertyList (LOCATION_ARGS) const {
  const cCollectionElement_classList * p = (const cCollectionElement_classList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_classList) ;
...
GALGAS_classTransientList cEnumerator_classList::current_mClassTransientList (LOCATION_ARGS) const {
  const cCollectionElement_classList * p = (const cCollectionElement_classList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_classList) ;
...
void GALGAS_entityList::modifier_prependValue (GALGAS_lstring inOperand0,
                                               ...
                                               GALGAS_classPropertyList inOperand3,
                                               GALGAS_classTransientList inOperand4
                                               COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_entityList (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4 COMMA_THERE)) ;
...
void GALGAS_entityList::modifier_popFirst (GALGAS_lstring & outOperand0,
                                           ...
                                           GALGAS_classPropertyList & outOperand3,
                                           GALGAS_classTransientList & outOperand4,
                                           C_Compiler * inCompiler
                                           COMMA_LOCATION_ARGS) {
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
...
void GALGAS_entityList::modifier_setMEntityNameAtIndex (GALGAS_lstring inOperand,
                                                        GALGAS_uint inIndex,
                                                        C_Compiler * inCompiler
                                                        COMMA_LOCATION_ARGS) {
  cCollectionElement_entityList * p = (cCollectionElement_entityList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_entityList) ;
    p->mAttribute_mEntityName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_entityList::modifier_setMSuperEntityNameAtIndex (GALGAS_lstring inOperand,
                                                             GALGAS_uint inIndex,
                                                             C_Compiler * inCompiler
                                                             COMMA_LOCATION_ARGS) {
  cCollectionElement_entityList * p = (cCollectionElement_entityList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_entityList) ;
    p->mAttribute_mSuperEntityName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_entityList::modifier_setMImplementationClassNameAtIndex (GALGAS_lstring inOperand,
                                                                     GALGAS_uint inIndex,
                                                                     C_Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) {
  cCollectionElement_entityList * p = (cCollectionElement_entityList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_entityList) ;
    p->mAttribute_mImplementationClassName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_entityList::modifier_setMPropertyListAtIndex (GALGAS_classPropertyList inOperand,
                                                          GALGAS_uint inIndex,
                                                          C_Compiler * inCompiler
                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_entityList * p = (cCollectionElement_entityList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_entityList::modifier_setMClassTransientListAtIndex (GALGAS_classTransientList inOperand,
                                                                GALGAS_uint inIndex,
                                                                C_Compiler * inCompiler
                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement_entityList * p = (cCollectionElement_entityList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_classPropertyList GALGAS_entityList::reader_mPropertyListAtIndex (const GALGAS_uint & inIndex,
                                                                         C_Compiler * inCompiler
                                                                         COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_entityList * p = (cCollectionElement_entityList *) attributes.ptr () ;
...
GALGAS_classTransientList GALGAS_entityList::reader_mClassTransientListAtIndex (const GALGAS_uint & inIndex,
                                                                                C_Compiler * inCompiler
                                                                                COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_entityList * p = (cCollectionElement_entityList *) attributes.ptr () ;
...
GALGAS_classPropertyList cEnumerator_entityList::current_mPropertyList (LOCATION_ARGS) const {
  const cCollectionElement_entityList * p = (const cCollectionElement_entityList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_entityList) ;
  return p->mAttribute_mPropertyList ;
}
...
GALGAS_classTransientList cEnumerator_entityList::current_mClassTransientList (LOCATION_ARGS) const {
  const cCollectionElement_entityList * p = (const cCollectionElement_entityList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_entityList) ;
  return p->mAttribute_mClassTransientList ;
}
...
void GALGAS_outletBindingOptionList::modifier_setMOptionNameAtIndex (GALGAS_lstring inOperand,
                                                                     GALGAS_uint inIndex,
                                                                     C_Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) {
  cCollectionElement_outletBindingOptionList * p = (cCollectionElement_outletBindingOptionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_outletBindingOptionList) ;
    p->mAttribute_mOptionName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_outletBindingOptionList::modifier_setMOptionValuePossibleTypesAtIndex (GALGAS_easyBindingTypeList inOperand,
                                                                                   GALGAS_uint inIndex,
                                                                                   C_Compiler * inCompiler
                                                                                   COMMA_LOCATION_ARGS) {
  cCollectionElement_outletBindingOptionList * p = (cCollectionElement_outletBindingOptionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_outletBindingOptionList) ;
    p->mAttribute_mOptionValuePossibleTypes = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_outletBindingOptionList::modifier_setMOptionValueObjectiveCObjectAtIndex (GALGAS_string inOperand,
                                                                                      GALGAS_uint inIndex,
                                                                                      C_Compiler * inCompiler
                                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement_outletBindingOptionList * p = (cCollectionElement_outletBindingOptionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_outletBindingOptionList) ;
    p->mAttribute_mOptionValueObjectiveCObject = inOperand ;
  }
}
...
cCollectionElement * cCollectionElement_outletBindingList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_outletBindingList (mAttribute_mBindingName, mAttribute_mRootObservablePropertyName, mAttribute_mOutletBindingOptionList COMMA_HERE)) ;
  return result ;
}
...
GALGAS_outletBindingList GALGAS_outletBindingList::constructor_listWithValue (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_outletBindingList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_outletBindingList::addAssign_operation (const GALGAS_lstring & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_outletBindingList (inOperand0, inOperand1, inOperand2 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_outletBindingList::modifier_setMBindingNameAtIndex (GALGAS_lstring inOperand,
                                                                GALGAS_uint inIndex,
                                                                C_Compiler * inCompiler
                                                                COMMA_LOCATION_ARGS) {
  cCollectionElement_outletBindingList * p = (cCollectionElement_outletBindingList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_outletBindingList) ;
...
void GALGAS_outletBindingList::modifier_setMRootObservablePropertyNameAtIndex (GALGAS_lstring inOperand,
                                                                               GALGAS_uint inIndex,
                                                                               C_Compiler * inCompiler
                                                                               COMMA_LOCATION_ARGS) {
  cCollectionElement_outletBindingList * p = (cCollectionElement_outletBindingList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_outletBindingList::modifier_setMOutletBindingOptionListAtIndex (GALGAS_outletBindingOptionList inOperand,
                                                                            GALGAS_uint inIndex,
                                                                            C_Compiler * inCompiler
                                                                            COMMA_LOCATION_ARGS) {
  cCollectionElement_outletBindingList * p = (cCollectionElement_outletBindingList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
GALGAS_lstring GALGAS_outletBindingList::reader_mRootObservablePropertyNameAtIndex (const GALGAS_uint & inIndex,
                                                                                    C_Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_outletBindingList * p = (cCollectionElement_outletBindingList *) attributes.ptr () ;
...
GALGAS_lstring cEnumerator_outletBindingList::current_mRootObservablePropertyName (LOCATION_ARGS) const {
  const cCollectionElement_outletBindingList * p = (const cCollectionElement_outletBindingList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_outletBindingList) ;
...
void GALGAS_outletDeclarationList::modifier_setMOutletTypeAtIndex (GALGAS_lstring inOperand,
                                                                   GALGAS_uint inIndex,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) {
  cCollectionElement_outletDeclarationList * p = (cCollectionElement_outletDeclarationList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_outletDeclarationList) ;
...
void GALGAS_outletDeclarationList::modifier_setMOutletNameAtIndex (GALGAS_lstring inOperand,
                                                                   GALGAS_uint inIndex,
                                                                   C_Compiler * inCompiler
                                                                   COMMA_LOCATION_ARGS) {
  cCollectionElement_outletDeclarationList * p = (cCollectionElement_outletDeclarationList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_outletDeclarationList::modifier_setMOutletBindingListAtIndex (GALGAS_outletBindingList inOperand,
                                                                          GALGAS_uint inIndex,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement_outletDeclarationList * p = (cCollectionElement_outletDeclarationList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//               Class for element of '@preferencesList' list                *
//                                                                           *
//---------------------------------------------------------------------------*

class cCollectionElement_preferencesList : public cCollectionElement {
//--- List attributes
...
//--- Constructor
  public : cCollectionElement_preferencesList (const GALGAS_lstring & in_mPreferencesName,
...
cCollectionElement_preferencesList::cCollectionElement_preferencesList (const GALGAS_lstring & in_mPreferencesName,
                                                                        const GALGAS_lstring & in_mRootEntityName,
                                                                        const GALGAS_outletDeclarationList & in_mOutletDeclarationList
                                                                        COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
...
bool cCollectionElement_preferencesList::isValid (void) const {
  return mAttribute_mPreferencesName.isValid () && mAttribute_mRootEntityName.isValid () && mAttribute_mOutletDeclarationList.isValid () ;
}

//---------------------------------------------------------------------------*

cCollectionElement * cCollectionElement_preferencesList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_preferencesList (mAttribute_mPreferencesName, mAttribute_mRootEntityName, mAttribute_mOutletDeclarationList COMMA_HERE)) ;
  return result ;
}

//---------------------------------------------------------------------------*

void cCollectionElement_preferencesList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
typeComparisonResult cCollectionElement_preferencesList::compare (const cCollectionElement * inOperand) const {
  cCollectionElement_preferencesList * operand = (cCollectionElement_preferencesList *) inOperand ;
  typeComparisonResult result = kOperandEqual ;
  if (kOperandEqual == result) {
...
GALGAS_preferencesList::GALGAS_preferencesList (void) :
AC_GALGAS_list () {
}

//---------------------------------------------------------------------------*

GALGAS_preferencesList::GALGAS_preferencesList (cSharedList * inSharedListPtr) :
AC_GALGAS_list (inSharedListPtr) {
  if (NULL == inSharedListPtr) {
    createNewEmptyList (HERE) ;
  }
...
GALGAS_preferencesList GALGAS_preferencesList::constructor_emptyList (LOCATION_ARGS) {
  GALGAS_preferencesList result ;
  result.createNewEmptyList (THERE) ;
  return result ;
}
...
GALGAS_preferencesList GALGAS_preferencesList::constructor_listWithValue (const GALGAS_lstring & inOperand0,
                                                                          const GALGAS_lstring & inOperand1,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_preferencesList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_preferencesList::makeAttributesFromObjects (capCollectionElement & outAttributes,
                                                        const GALGAS_lstring & in_mPreferencesName,
                                                        const GALGAS_lstring & in_mRootEntityName,
                                                        const GALGAS_outletDeclarationList & in_mOutletDeclarationList
                                                        COMMA_LOCATION_ARGS) {
  cCollectionElement_preferencesList * p = NULL ;
  macroMyNew (p, cCollectionElement_preferencesList (in_mPreferencesName,
                                                        in_mRootEntityName,
...
void GALGAS_preferencesList::addAssign_operation (const GALGAS_lstring & inOperand0,
                                                  const GALGAS_lstring & inOperand1,
                                                  const GALGAS_outletDeclarationList & inOperand2
                                                  COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_preferencesList (inOperand0, inOperand1, inOperand2 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_preferencesList::modifier_prependValue (GALGAS_lstring inOperand0,
                                                    GALGAS_lstring inOperand1,
...
void GALGAS_preferencesList::modifier_popFirst (GALGAS_lstring & outOperand0,
                                                GALGAS_lstring & outOperand1,
  ...
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  cCollectionElement_preferencesList * p = (cCollectionElement_preferencesList *) attributes.ptr () ;
  if (NULL == p) {
    outOperand0.drop () ;
    outOperand1.drop () ;
    outOperand2.drop () ;
  }else{
    macroValidSharedObject (p, cCollectionElement_preferencesList) ;
...
void GALGAS_preferencesList::modifier_popLast (GALGAS_lstring & outOperand0,
                                               GALGAS_lstring & outOperand1,
                                               GALGAS_outletDeclarationList & outOperand2,
                                               C_Compiler * inCompiler
                                               COMMA_LOCATION_ARGS) {
...
void GALGAS_preferencesList::method_first (GALGAS_lstring & outOperand0,
                                           GALGAS_lstring & outOperand1,
                                           GALGAS_outletDeclarationList & outOperand2,
                                           C_Compiler * inCompiler
                                           COMMA_LOCATION_ARGS) const {
...
void GALGAS_preferencesList::method_last (GALGAS_lstring & outOperand0,
                                          GALGAS_lstring & outOperand1,
                                          GALGAS_outletDeclarationList & outOperand2,
                                          C_Compiler * inCompiler
                                          COMMA_LOCATION_ARGS) const {
...
GALGAS_preferencesList GALGAS_preferencesList::operator_concat (const GALGAS_preferencesList & inOperand
                                                                COMMA_UNUSED_LOCATION_ARGS) const {
  GALGAS_preferencesList result ;
  if (isValid () && inOperand.isValid ()) {
    result = *this ;
...
GALGAS_preferencesList GALGAS_preferencesList::reader_subListWithRange (const GALGAS_uint & inIndex,
                                                                        const GALGAS_uint & inLength,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) const {
  GALGAS_preferencesList result = GALGAS_preferencesList::constructor_emptyList (THERE) ;
  subListWithRange (result, inIndex, inLength, inCompiler COMMA_THERE) ;
  return result ;
}
...
GALGAS_preferencesList GALGAS_preferencesList::reader_subListFromIndex (const GALGAS_uint & inIndex,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) const {
  GALGAS_preferencesList result = GALGAS_preferencesList::constructor_emptyList (THERE) ;
  subListFromIndex (result, inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_preferencesList::dotAssign_operation (const GALGAS_preferencesList inOperand
                                                  COMMA_UNUSED_LOCATION_ARGS) {
  appendList (inOperand) ;
}
...
void GALGAS_preferencesList::modifier_setMPreferencesNameAtIndex (GALGAS_lstring inOperand,
                                                                  GALGAS_uint inIndex,
                                                                  C_Compiler * inCompiler
                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement_preferencesList * p = (cCollectionElement_preferencesList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_preferencesList) ;
    p->mAttribute_mPreferencesName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_preferencesList::modifier_setMRootEntityNameAtIndex (GALGAS_lstring inOperand,
                                                                 GALGAS_uint inIndex,
                                                                 C_Compiler * inCompiler
                                                                 COMMA_LOCATION_ARGS) {
  cCollectionElement_preferencesList * p = (cCollectionElement_preferencesList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_preferencesList) ;
    p->mAttribute_mRootEntityName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_preferencesList::modifier_setMOutletDeclarationListAtIndex (GALGAS_outletDeclarationList inOperand,
                                                                        GALGAS_uint inIndex,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) {
  cCollectionElement_preferencesList * p = (cCollectionElement_preferencesList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_preferencesList) ;
    p->mAttribute_mOutletDeclarationList = inOperand ;
  }
}
...
GALGAS_lstring GALGAS_preferencesList::reader_mPreferencesNameAtIndex (const GALGAS_uint & inIndex,
                                                                       C_Compiler * inCompiler
                                                                       COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_preferencesList * p = (cCollectionElement_preferencesList *) attributes.ptr () ;
...
GALGAS_lstring GALGAS_preferencesList::reader_mRootEntityNameAtIndex (const GALGAS_uint & inIndex,
                                                                      C_Compiler * inCompiler
                                                                      COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_preferencesList * p = (cCollectionElement_preferencesList *) attributes.ptr () ;
...
GALGAS_outletDeclarationList GALGAS_preferencesList::reader_mOutletDeclarationListAtIndex (const GALGAS_uint & inIndex,
                                                                                           C_Compiler * inCompiler
                                                                                           COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_preferencesList * p = (cCollectionElement_preferencesList *) attributes.ptr () ;
...
cEnumerator_preferencesList::cEnumerator_preferencesList (const GALGAS_preferencesList & inEnumeratedObject,
                                                          const typeEnumerationOrder inOrder) :
cGenericAbstractEnumerator () {
  inEnumeratedObject.populateEnumerationArray (mEnumerationArray, inOrder) ;
}
...
GALGAS_lstring cEnumerator_preferencesList::current_mPreferencesName (LOCATION_ARGS) const {
  const cCollectionElement_preferencesList * p = (const cCollectionElement_preferencesList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_preferencesList) ;
  return p->mAttribute_mPreferencesName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring cEnumerator_preferencesList::current_mRootEntityName (LOCATION_ARGS) const {
  const cCollectionElement_preferencesList * p = (const cCollectionElement_preferencesList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_preferencesList) ;
...
GALGAS_outletDeclarationList cEnumerator_preferencesList::current_mOutletDeclarationList (LOCATION_ARGS) const {
  const cCollectionElement_preferencesList * p = (const cCollectionElement_preferencesList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_preferencesList) ;
...
//---------------------------------------------------------------------------*
//                                                                           *
//                           @preferencesList type                           *
//                                                                           *
//---------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_preferencesList ("preferencesList",
                                        NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_preferencesList::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_preferencesList ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_preferencesList::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_preferencesList (*this)) ;
  }
  return result ;
}
...
GALGAS_preferencesList GALGAS_preferencesList::extractObject (const GALGAS_object & inObject,
                                                              C_Compiler * inCompiler,
                                                              const GALGAS_location & inErrorLocation
                                                              COMMA_LOCATION_ARGS) {
  GALGAS_preferencesList result ;
  const GALGAS_preferencesList * p = (const GALGAS_preferencesList *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_preferencesList *> (p)) {
      result = *p ;
    }else{
      inCompiler->extractObjectError (inErrorLocation, "preferencesList", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
void GALGAS_easyBindingTypeList::modifier_setMTypeAtIndex (GALGAS_easyBindingType inOperand,
                                                           GALGAS_uint inIndex,
                                                           C_Compiler * inCompiler
                                                           COMMA_LOCATION_ARGS) {
  cCollectionElement_easyBindingTypeList * p = (cCollectionElement_easyBindingTypeList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_easyBindingTypeList) ;
    p->mAttribute_mType = inOperand ;
  }
...
void GALGAS_outletClassBindingList::modifier_setMBindingNameAtIndex (GALGAS_lstring inOperand,
                                                                     GALGAS_uint inIndex,
                                                                     C_Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) {
  cCollectionElement_outletClassBindingList * p = (cCollectionElement_outletClassBindingList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_outletClassBindingList) ;
    p->mAttribute_mBindingName = inOperand ;
  }
...
void GALGAS_outletClassBindingList::modifier_setMAcceptableTypeListAtIndex (GALGAS_easyBindingTypeList inOperand,
                                                                            GALGAS_uint inIndex,
                                                                            C_Compiler * inCompiler
                                                                            COMMA_LOCATION_ARGS) {
  cCollectionElement_outletClassBindingList * p = (cCollectionElement_outletClassBindingList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_outletClassBindingList) ;
    p->mAttribute_mAcceptableTypeList = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_outletClassBindingList::modifier_setMBindingOptionListAtIndex (GALGAS_bindingOptionList inOperand,
                                                                           GALGAS_uint inIndex,
                                                                           C_Compiler * inCompiler
                                                                           COMMA_LOCATION_ARGS) {
  cCollectionElement_outletClassBindingList * p = (cCollectionElement_outletClassBindingList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_outletClassBindingList) ;
    p->mAttribute_mBindingOptionList = inOperand ;
  }
}
...
void GALGAS_bindingOptionList::modifier_setMBindingOptionNameAtIndex (GALGAS_lstring inOperand,
                                                                      GALGAS_uint inIndex,
                                                                      C_Compiler * inCompiler
                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement_bindingOptionList * p = (cCollectionElement_bindingOptionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_bindingOptionList) ;
    p->mAttribute_mBindingOptionName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_bindingOptionList::modifier_setMAcceptableTypeListAtIndex (GALGAS_easyBindingTypeList inOperand,
                                                                       GALGAS_uint inIndex,
                                                                       C_Compiler * inCompiler
                                                                       COMMA_LOCATION_ARGS) {
  cCollectionElement_bindingOptionList * p = (cCollectionElement_bindingOptionList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
...
void GALGAS_outletClassList::modifier_setMOutletClassNameAtIndex (GALGAS_lstring inOperand,
                                                                  GALGAS_uint inIndex,
                                                                  C_Compiler * inCompiler
                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement_outletClassList * p = (cCollectionElement_outletClassList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_outletClassList) ;
    p->mAttribute_mOutletClassName = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_outletClassList::modifier_setMGenerateCodeAtIndex (GALGAS_bool inOperand,
                                                               GALGAS_uint inIndex,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) {
  cCollectionElement_outletClassList * p = (cCollectionElement_outletClassList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_outletClassList) ;
    p->mAttribute_mGenerateCode = inOperand ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_outletClassList::modifier_setMOutletClassBindingListAtIndex (GALGAS_outletClassBindingList inOperand,
                                                                         GALGAS_uint inIndex,
                                                                         C_Compiler * inCompiler
                                                                         COMMA_LOCATION_ARGS) {
  cCollectionElement_outletClassList * p = (cCollectionElement_outletClassList *) objectPointerAtIndex (inIndex, inCompiler COMMA_THERE) ;
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_outletClassList) ;
    p->mAttribute_mOutletClassBindingList = inOperand ;
  }
}
...
GALGAS_ASTstruct GALGAS_ASTstruct::constructor_new (const GALGAS_classList & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_ASTstruct (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
bool GALGAS_ASTstruct::isValid (void) const {
  return mAttribute_mClassList.isValid () && mAttribute_mEntityList.isValid () && mAttribute_mPreferencesList.isValid () && mAttribute_mOutletClassList.isValid () ;
}
...
GALGAS_preferencesList GALGAS_ASTstruct::reader_mPreferencesList (UNUSED_LOCATION_ARGS) const {
