...
cCollectionElement_documentDeclarationList::cCollectionElement_documentDeclarationList (const GALGAS_lstring & in_mDocumentName,
                                                                                        ...
                                                                                        COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mDocumentName, in_mRootEntityName, in_mOutletDeclarationList, in_mControllerList, in_mActionDeclarationList) {
}
...
cCollectionElement * cCollectionElement_documentDeclarationList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_documentDeclarationList (mObject.mAttribute_mDocumentName, mObject.mAttribute_mRootEntityName, mObject.mAttribute_mOutletDeclarationList, mObject.mAttribute_mControllerList, mObject.mAttribute_mActionDeclarationList COMMA_HERE)) ;
  return result ;
}
...
GALGAS_documentDeclarationList GALGAS_documentDeclarationList::constructor_listWithValue (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_documentDeclarationList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3, inOperand4 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_documentDeclarationList::addAssign_operation (const GALGAS_lstring & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_documentDeclarationList (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
cCollectionElement_controllerClassList::cCollectionElement_controllerClassList (const GALGAS_lstring & in_mOutletClassName,
                                                                                ...
                                                                                COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mOutletClassName, in_mGenerateCode, in_mBindingList, in_mActionDeclarationList) {
}
...
cCollectionElement * cCollectionElement_controllerClassList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_controllerClassList (mObject.mAttribute_mOutletClassName, mObject.mAttribute_mGenerateCode, mObject.mAttribute_mBindingList, mObject.mAttribute_mActionDeclarationList COMMA_HERE)) ;
  return result ;
}
...
GALGAS_controllerClassList GALGAS_controllerClassList::constructor_listWithValue (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_controllerClassList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_controllerClassList::addAssign_operation (const GALGAS_lstring & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_controllerClassList (inOperand0, inOperand1, inOperand2, inOperand3 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
GALGAS_lstringlist GALGAS_transientList_2E_element::reader_mDependencyList (UNUSED_LOCATION_ARGS) const {
...
GALGAS_documentDeclarationList_2E_element GALGAS_documentDeclarationList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_documentDeclarationList_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
bool GALGAS_documentDeclarationList_2E_element::isValid (void) const {
  return mAttribute_mDocumentName.isValid () && mAttribute_mRootEntityName.isValid () && mAttribute_mOutletDeclarationList.isValid () && mAttribute_mControllerList.isValid () && mAttribute_mActionDeclarationList.isValid () ;
}
...
GALGAS_controllerClassList_2E_element GALGAS_controllerClassList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_controllerClassList_2E_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
bool GALGAS_controllerClassList_2E_element::isValid (void) const {
  return mAttribute_mOutletClassName.isValid () && mAttribute_mGenerateCode.isValid () && mAttribute_mBindingList.isValid () && mAttribute_mActionDeclarationList.isValid () ;
}
