...
cCollectionElement_dependanceList::cCollectionElement_dependanceList (const GALGAS_lstring & in_mObjectName,
                                                                      ...
                                                                      COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mObjectName, in_mPropertyName) {
}
...
cCollectionElement * cCollectionElement_dependanceList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_dependanceList (mObject.mAttribute_mObjectName, mObject.mAttribute_mPropertyName COMMA_HERE)) ;
  return result ;
}
...
GALGAS_dependanceList GALGAS_dependanceList::constructor_listWithValue (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_dependanceList::makeAttributesFromObjects (attributes, inOperand0, inOperand1 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_dependanceList::addAssign_operation (const GALGAS_lstring & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_dependanceList (inOperand0, inOperand1 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
GALGAS_regularBinding GALGAS_regularBinding::constructor_new (const GALGAS_lstring & inAttribute_mBindingName,
  ...
  if (inAttribute_mBindingName.isValid () && inAttribute_mObservedObjectName.isValid () && inAttribute_mObservableAttributeName.isValid () && inAttribute_mOutletBindingOptionList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_regularBinding (inAttribute_mBindingName, inAttribute_mObservedObjectName, inAttribute_mObservableAttributeName, inAttribute_mOutletBindingOptionList COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_regularBinding::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_regularBinding (p->mAttribute_mBindingName, p->mAttribute_mObservedObjectName, p->mAttribute_mObservableAttributeName, p->mAttribute_mOutletBindingOptionList COMMA_THERE)) ;
...
GALGAS_dependanceList_2E_element GALGAS_dependanceList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_dependanceList_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
bool GALGAS_dependanceList_2E_element::isValid (void) const {
  return mAttribute_mObjectName.isValid () && mAttribute_mPropertyName.isValid () ;
}
