...
cCollectionElement * cCollectionElement_attributeList::copy (void) {
  ...
  macroMyNew (result, cCollectionElement_attributeList (mAttribute_mType, mAttribute_mAttributeName, mAttribute_mDefaultValueCorrespondingAcceptableTypes, mAttribute_mDefaultValueObjectiveCObject, mAttribute_mDirectDefaultValue COMMA_HERE)) ;
  return result ;
}
...
cCollectionElement * cCollectionElement_outletClassList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_outletClassList (mAttribute_mOutletClassName, mAttribute_mSuperClassName, mAttribute_mGenerateCode, mAttribute_mOutletClassBindingList, mAttribute_mHasTableValueBinding COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_outletClassList::modifier_popFirst (GALGAS_lstring & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand1 = p->mAttribute_mSuperClassName ;
    outOperand2 = p->mAttribute_mGenerateCode ;
    outOperand3 = p->mAttribute_mOutletClassBindingList ;
    outOperand4 = p->mAttribute_mHasTableValueBinding ;
  }
}
