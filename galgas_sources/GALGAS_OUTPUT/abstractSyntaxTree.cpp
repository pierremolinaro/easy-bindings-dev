...
GALGAS_bindingList_2E_element::GALGAS_bindingList_2E_element (const GALGAS_lstring & inOperand0,
                                                              const GALGAS_lstring & inOperand1,
                                                              const GALGAS_lstring & inOperand2,
                                                              const GALGAS_outletBindingOptionList & inOperand3) :
...
GALGAS_bindingList_2E_element GALGAS_bindingList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                              const GALGAS_lstring & inOperand1,
                                                                              const GALGAS_lstring & inOperand2,
                                                                              const GALGAS_outletBindingOptionList & inOperand3 
                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_bindingList_2E_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
GALGAS_lstring GALGAS_bindingList_2E_element::reader_mBindingName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mBindingName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_bindingList_2E_element::reader_mObservedObjectName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mObservedObjectName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_bindingList_2E_element::reader_mObservableAttributeName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mObservableAttributeName ;
}

//---------------------------------------------------------------------------*

GALGAS_outletBindingOptionList GALGAS_bindingList_2E_element::reader_mOutletBindingOptionList (UNUSED_LOCATION_ARGS) const {
...
GALGAS_preferencesDeclarationList_2E_element GALGAS_preferencesDeclarationList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_preferencesDeclarationList_2E_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
GALGAS_documentDeclarationList_2E_element GALGAS_documentDeclarationList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_documentDeclarationList_2E_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
