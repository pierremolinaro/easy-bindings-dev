...
cCollectionElement_outletClassList::cCollectionElement_outletClassList (const GALGAS_lstring & in_mOutletClassName,
                                                                        ...
                                                                        COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mOutletClassName, in_mSuperClassName, in_mAdoptedProtocolList, in_mGenerateCode, in_mOutletClassBindingList, in_mHasTableValueBinding) {
}
...
cCollectionElement * cCollectionElement_outletClassList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_outletClassList (mObject.mAttribute_mOutletClassName, mObject.mAttribute_mSuperClassName, mObject.mAttribute_mAdoptedProtocolList, mObject.mAttribute_mGenerateCode, mObject.mAttribute_mOutletClassBindingList, mObject.mAttribute_mHasTableValueBinding COMMA_HERE)) ;
  return result ;
}
...
GALGAS_outletClassList GALGAS_outletClassList::constructor_listWithValue (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_outletClassList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_outletClassList::addAssign_operation (const GALGAS_lstring & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_outletClassList (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_outletClassList::modifier_popFirst (GALGAS_lstring & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand3 = p->mObject.mAttribute_mGenerateCode ;
...
//--- Constructor
  public : cCollectionElement_protocolList (const GALGAS_lstring & in_mProtocolName
                                            COMMA_LOCATION_ARGS) ;
...
cCollectionElement_protocolList::cCollectionElement_protocolList (const GALGAS_lstring & in_mProtocolName
                                                                  COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mProtocolName) {
}
...
cCollectionElement * cCollectionElement_protocolList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_protocolList (mObject.mAttribute_mProtocolName COMMA_HERE)) ;
  return result ;
}
...
GALGAS_protocolList GALGAS_protocolList::constructor_listWithValue (const GALGAS_lstring & inOperand0
                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_protocolList result ;
  if (inOperand0.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_protocolList::makeAttributesFromObjects (attributes, inOperand0 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_protocolList::makeAttributesFromObjects (capCollectionElement & outAttributes,
  ...
  macroMyNew (p, cCollectionElement_protocolList (in_mProtocolName COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
void GALGAS_protocolList::addAssign_operation (const GALGAS_lstring & inOperand0
                                               COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_protocolList (inOperand0 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_protocolList::modifier_prependValue (GALGAS_lstring inOperand0
                                                 COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_protocolList (inOperand0 COMMA_THERE)) ;
...
void GALGAS_protocolList::modifier_popFirst (GALGAS_lstring & outOperand0,
                                             C_Compiler * inCompiler
                                             COMMA_LOCATION_ARGS) {
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  ...
  if (NULL == p) {
    ...
    outOperand0 = p->mObject.mAttribute_mProtocolName ;
  }
}

//---------------------------------------------------------------------------*

void GALGAS_protocolList::modifier_popLast (GALGAS_lstring & outOperand0,
                                            C_Compiler * inCompiler
                                            COMMA_LOCATION_ARGS) {
  capCollectionElement attributes ;
  removeLastObject (attributes, inCompiler COMMA_THERE) ;
...
void GALGAS_protocolList::method_first (GALGAS_lstring & outOperand0,
                                        C_Compiler * inCompiler
                                        COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes ;
  readFirst (attributes, inCompiler COMMA_THERE) ;
...
void GALGAS_protocolList::method_last (GALGAS_lstring & outOperand0,
                                       C_Compiler * inCompiler
                                       COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes ;
  readLast (attributes, inCompiler COMMA_THERE) ;
...
mAttribute_mGenerateCode (inOperand3),
...
GALGAS_outletClassList_2E_element GALGAS_outletClassList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid ()) {
    result = GALGAS_outletClassList_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5) ;
  }
  return result ;
}
...
bool GALGAS_outletClassList_2E_element::isValid (void) const {
  return mAttribute_mOutletClassName.isValid () && mAttribute_mSuperClassName.isValid () && mAttribute_mAdoptedProtocolList.isValid () && mAttribute_mGenerateCode.isValid () && mAttribute_mOutletClassBindingList.isValid () && mAttribute_mHasTableValueBinding.isValid () ;
}
...
GALGAS_protocolList_2E_element::GALGAS_protocolList_2E_element (const GALGAS_lstring & inOperand0) :
mAttribute_mProtocolName (inOperand0) {
}

//---------------------------------------------------------------------------*

GALGAS_protocolList_2E_element GALGAS_protocolList_2E_element::constructor_new (const GALGAS_lstring & inOperand0 
                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_protocolList_2E_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_protocolList_2E_element (inOperand0) ;
  }
  return result ;
}
...
bool GALGAS_protocolList_2E_element::isValid (void) const {
  return mAttribute_mProtocolName.isValid () ;
}
