...
GALGAS_runBinding GALGAS_runBinding::constructor_new (const GALGAS_lstring & inAttribute_mTarget,
                                                      const GALGAS_lstring & inAttribute_mActionName
                                                      COMMA_LOCATION_ARGS) {
  GALGAS_runBinding result ;
  if (inAttribute_mTarget.isValid () && inAttribute_mActionName.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_runBinding (inAttribute_mTarget, inAttribute_mActionName COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_runBinding::insulate (LOCATION_ARGS) {
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_runBinding (p->mAttribute_mTarget, p->mAttribute_mActionName COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
}
...
GALGAS_lstring GALGAS_runBinding::reader_mTarget (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
...
GALGAS_lstring cPtr_runBinding::reader_mTarget (UNUSED_LOCATION_ARGS) const {
...
cPtr_runBinding::cPtr_runBinding (const GALGAS_lstring & in_mTarget,
...
GALGAS_controllerClassList_2E_element GALGAS_controllerClassList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_controllerClassList_2E_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
