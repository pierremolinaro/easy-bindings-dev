...
//                                         september 8th, 2014, at 14h25'13"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_collectionControllerGenerationTemplate_arrayControllerImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_10701 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_10701.hasCurrentObject ()) {
      result << " if columnIdentifier == \"" ;
      result << enumerator_10701.current_mColumnName (HERE).stringValue () ;
      result << "\" {\n" ;
      result << in_FILE_5F_WRAPPER.reader_textFileContentsAtPath (GALGAS_string ("/cell-").add_operation (enumerator_10701.current_mPropertyType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 243)), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 243)).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 243)).add_operation (enumerator_10701.current_mColumnOutletTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 243)).add_operation (GALGAS_string (".txt"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 243)), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 243)).reader_stringByReplacingStringByString (GALGAS_string ("$MODEL$"), enumerator_10701.current_mObservablePropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 243)).stringValue () ;
      result << "    }" ;
  ...
  result << "\n"
    ...
    "\n"
    " " ;
  GALGAS_uint index_11012_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_11012 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_11012.hasCurrentObject ()) {
      result << " //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  func set_" ;
      result << enumerator_11012.current_mObservablePropertyName (HERE).stringValue () ;
      result << "_Action (sender : " ;
      result << enumerator_11012.current_mColumnOutletTypeName (HERE).stringValue () ;
      result << ") {\n"
        "    if let tableView = mTableView {\n"
      ...
      result << enumerator_11012.current_mObservablePropertyName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_transformerForTableViewAction (enumerator_11012.current_mPropertyType (HERE), GALGAS_string ("sender"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 259)).stringValue () ;
      result << "\n"
        "    }\n"
        "  }\n"
        "\n" ;
      index_11012_.increment () ;
...
void routine_generateArrayControllers (const GALGAS_arrayControllerForGeneration constinArgument_inArrayControllerListForGeneration,
                                       ...
                                       C_Compiler * inCompiler
                                       COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_arrayControllerForGeneration enumerator_1604 (constinArgument_inArrayControllerListForGeneration, kEnumeration_up) ;
  while (enumerator_1604.hasCurrentObject ()) {
    GALGAS_string var_s = GALGAS_string (filewrapperTemplate_collectionControllerGenerationTemplate_arrayControllerImplementationInSwift (inCompiler, enumerator_1604.current_mObjectTypeName (HERE), enumerator_1604.current_mTomanyRelationshipName (HERE), enumerator_1604.current_mElementTypeName (HERE), enumerator_1604.current_mTableViewOutletName (HERE), enumerator_1604.current_mArrayControllerBoundColumnListForGeneration (HERE), GALGAS_filewrapper (gWrapperDirectory_0_collectionControllerGenerationTemplate) COMMA_SOURCE_FILE ("arrayControllerGeneration.gSemantics", 50))) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, GALGAS_string ("arrayController-").add_operation (enumerator_1604.current_mObjectTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("arrayControllerGeneration.gSemantics", 60)).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("arrayControllerGeneration.gSemantics", 60)).add_operation (enumerator_1604.current_mTomanyRelationshipName (HERE), inCompiler COMMA_SOURCE_FILE ("arrayControllerGeneration.gSemantics", 60)).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("arrayControllerGeneration.gSemantics", 60)).add_operation (enumerator_1604.current_mTableViewOutletName (HERE), inCompiler COMMA_SOURCE_FILE ("arrayControllerGeneration.gSemantics", 60)).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("arrayControllerGeneration.gSemantics", 60)), var_s, inCompiler COMMA_SOURCE_FILE ("arrayControllerGeneration.gSemantics", 58)) ;
    }
