...
//                                         september 16th, 2014, at 17h27'22"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_collectionControllerGenerationTemplate_arrayControllerImplementationInSwift (C_Compiler * inCompiler,
  ...
  result << ", tableView:PMTableView\?, file:String, line:Int) {\n"
    ...
    "      var ok = true\n" ;
  GALGAS_uint index_3711_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_3711 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_3711.hasCurrentObject ()) {
      result << "      if let anyObject: AnyObject = unwrappedTableView.makeViewWithIdentifier (\"" ;
      result << enumerator_3711.current_mColumnName (HERE).stringValue () ;
      result << "\", owner:self) {\n"
        "        if let unwrappedTableCellView = anyObject as\? NSTableCellView {\n"
        "          if !(unwrappedTableCellView.textField is " ;
      result << enumerator_3711.current_mColumnOutletTypeName (HERE).stringValue () ;
      result << ") {\n"
  ...
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_4684 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_4684.hasCurrentObject ()) {
      result << "        let col_" ;
      result << enumerator_4684.current_mObservablePropertyName (HERE).stringValue () ;
      result << " : NSTableColumn = unwrappedTableView.tableColumnWithIdentifier (\"" ;
      result << enumerator_4684.current_mColumnName (HERE).stringValue () ;
      result << "\")\n"
        "        col_" ;
      result << enumerator_4684.current_mObservablePropertyName (HERE).stringValue () ;
  ...
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_5794 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_5794.hasCurrentObject ()) {
      result << "      managedObject.removeObserverOf_" ;
      result << enumerator_5794.current_mObservablePropertyName (HERE).stringValue () ;
  ...
  result << in_ELEMENT_5F_TYPE_5F_NAME.stringValue () ;
  result << "\n" ;
  GALGAS_uint index_9870_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_9870 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_9870.hasCurrentObject ()) {
      result << "      managedObject.removeObserverOf_" ;
      result << enumerator_9870.current_mObservablePropertyName (HERE).stringValue () ;
      result << " (mTriggerObjectForModelChange, inTrigger:false)\n" ;
      index_9870_.increment () ;
  ...
  result << in_ELEMENT_5F_TYPE_5F_NAME.stringValue () ;
  result << "\n" ;
  GALGAS_uint index_10286_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_10286 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_10286.hasCurrentObject ()) {
      result << "      managedObject.addObserverOf_" ;
      result << enumerator_10286.current_mObservablePropertyName (HERE).stringValue () ;
      result << " (mTriggerObjectForModelChange, inTrigger:false)\n" ;
      index_10286_.increment () ;
      enumerator_10286.gotoNextObject () ;
    }
  }
  result << "    }\n"
    "    refreshDisplay ()\n"
  ...
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_13260 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_13260.hasCurrentObject ()) {
      result << " if columnIdentifier == \"" ;
      result << enumerator_13260.current_mColumnName (HERE).stringValue () ;
      result << "\" {\n" ;
      result << in_FILE_5F_WRAPPER.reader_textFileContentsAtPath (GALGAS_string ("/cell-").add_operation (enumerator_13260.current_mPropertyType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 290)), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 290)).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 290)).add_operation (enumerator_13260.current_mColumnOutletTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 290)).add_operation (GALGAS_string (".txt"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 290)), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 290)).reader_stringByReplacingStringByString (GALGAS_string ("$MODEL$"), enumerator_13260.current_mObservablePropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 290)).stringValue () ;
      result << "    }" ;
      if (enumerator_13260.hasNextObject ()) {
        result << "else" ;
      }
  ...
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_13571 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_13571.hasCurrentObject ()) {
      result << " //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  func set_" ;
      result << enumerator_13571.current_mObservablePropertyName (HERE).stringValue () ;
      result << "_Action (sender : " ;
      result << enumerator_13571.current_mColumnOutletTypeName (HERE).stringValue () ;
      result << ") {\n"
        "    if let tableView = mTableView {\n"
      ...
      result << enumerator_13571.current_mObservablePropertyName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_transformerForTableViewAction (enumerator_13571.current_mPropertyType (HERE), GALGAS_string ("sender"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 308)).stringValue () ;
      result << "\n"
