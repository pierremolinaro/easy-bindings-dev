...
GALGAS_string filewrapperTemplate_collectionControllerGenerationTemplate_arrayControllerImplementationInSwift (C_Compiler * inCompiler,
  ...
  result << ", tableView:PMTableView\?, file:String, line:Int) {\n"
    ...
    "      var ok = true\n" ;
  GALGAS_uint index_2654_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_2654 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_2654.hasCurrentObject ()) {
      result << "      if let anyObject: AnyObject = unwrappedTableView.makeViewWithIdentifier (\"" ;
      result << enumerator_2654.current_mColumnName (HERE).stringValue () ;
      result << "\", owner:self) {\n"
        "        if let unwrappedTableCellView = anyObject as\? NSTableCellView {\n"
        "          if !(unwrappedTableCellView.textField is " ;
      result << enumerator_2654.current_mColumnOutletTypeName (HERE).stringValue () ;
      result << ") {\n"
  ...
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_4159 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_4159.hasCurrentObject ()) {
      result << "      managedObject.removeObserverOf_" ;
      result << enumerator_4159.current_mObservablePropertyName (HERE).stringValue () ;
  ...
  result << in_ELEMENT_5F_TYPE_5F_NAME.stringValue () ;
  result << "\n" ;
  GALGAS_uint index_7311_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_7311 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_7311.hasCurrentObject ()) {
      result << "      managedObject.removeObserverOf_" ;
      result << enumerator_7311.current_mObservablePropertyName (HERE).stringValue () ;
      result << " (mTriggerObjectForModelChange)\n" ;
      index_7311_.increment () ;
  ...
  result << in_ELEMENT_5F_TYPE_5F_NAME.stringValue () ;
  result << "\n" ;
  GALGAS_uint index_7710_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_7710 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_7710.hasCurrentObject ()) {
      result << "      managedObject.addObserverOf_" ;
      result << enumerator_7710.current_mObservablePropertyName (HERE).stringValue () ;
      result << " (mTriggerObjectForModelChange)\n" ;
  ...
  result << "\n"
    "   " ;
  GALGAS_uint index_10408_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_10408 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_10408.hasCurrentObject ()) {
      result << " if columnIdentifier == \"" ;
      result << enumerator_10408.current_mColumnName (HERE).stringValue () ;
      result << "\" {\n" ;
      result << in_FILE_5F_WRAPPER.reader_textFileContentsAtPath (GALGAS_string ("/cell-").add_operation (enumerator_10408.current_mPropertyType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 230)), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 230)).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 230)).add_operation (enumerator_10408.current_mColumnOutletTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 230)).add_operation (GALGAS_string (".txt"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 230)), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 230)).reader_stringByReplacingStringByString (GALGAS_string ("$MODEL$"), enumerator_10408.current_mObservablePropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 230)).stringValue () ;
      result << "    }" ;
      if (enumerator_10408.hasNextObject ()) {
        result << "else" ;
      }
      index_10408_.increment () ;
  ...
  result << "\n"
    ...
    "\n"
    " " ;
  GALGAS_uint index_10719_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_10719 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_10719.hasCurrentObject ()) {
      result << " //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  func set_" ;
      result << enumerator_10719.current_mObservablePropertyName (HERE).stringValue () ;
      result << "_Action (sender : " ;
      result << enumerator_10719.current_mColumnOutletTypeName (HERE).stringValue () ;
      result << ") {\n"
        "    if let tableView = mTableView {\n"
      ...
      result << enumerator_10719.current_mObservablePropertyName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_transformerForTableViewAction (enumerator_10719.current_mPropertyType (HERE), GALGAS_string ("sender"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 246)).stringValue () ;
      result << "\n"
        "    }\n"
        "  }\n"
        "\n" ;
      index_10719_.increment () ;
