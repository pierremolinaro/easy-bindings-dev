...
//                                         september 22th, 2014, at 19h5'22"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_collectionControllerGenerationTemplate_arrayControllerImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_5569 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_5569.hasCurrentObject ()) {
      result << "      managedObject.removeObserverOf_" ;
      result << enumerator_5569.current_mObservablePropertyName (HERE).stringValue () ;
  ...
  result << in_ELEMENT_5F_TYPE_5F_NAME.stringValue () ;
  result << "\n" ;
  GALGAS_uint index_10448_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_10448 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_10448.hasCurrentObject ()) {
      result << "        managedObject.removeObserverOf_" ;
      result << enumerator_10448.current_mObservablePropertyName (HERE).stringValue () ;
      result << " (eventModelChange, inTrigger:false)\n" ;
      index_10448_.increment () ;
  ...
  result << in_ELEMENT_5F_TYPE_5F_NAME.stringValue () ;
  result << "\n" ;
  GALGAS_uint index_10868_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_10868 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_10868.hasCurrentObject ()) {
      result << "        managedObject.addObserverOf_" ;
      result << enumerator_10868.current_mObservablePropertyName (HERE).stringValue () ;
      result << " (eventModelChange, inTrigger:false)\n" ;
      index_10868_.increment () ;
  ...
  result << "\n"
    "   " ;
  GALGAS_uint index_13941_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_13941 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_13941.hasCurrentObject ()) {
      result << " if columnIdentifier == \"" ;
      result << enumerator_13941.current_mColumnName (HERE).stringValue () ;
      result << "\" {\n" ;
      result << in_FILE_5F_WRAPPER.reader_textFileContentsAtPath (GALGAS_string ("/cell-").add_operation (enumerator_13941.current_mPropertyType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 307)), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 307)).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 307)).add_operation (enumerator_13941.current_mColumnOutletTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 307)).add_operation (GALGAS_string (".txt"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 307)), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 307)).reader_stringByReplacingStringByString (GALGAS_string ("$MODEL$"), enumerator_13941.current_mObservablePropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 307)).stringValue () ;
      result << "    }" ;
      if (enumerator_13941.hasNextObject ()) {
        result << "else" ;
      }
      index_13941_.increment () ;
  ...
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_14252 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_14252.hasCurrentObject ()) {
      result << " //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  func set_" ;
      result << enumerator_14252.current_mObservablePropertyName (HERE).stringValue () ;
      result << "_Action (sender : " ;
      result << enumerator_14252.current_mColumnOutletTypeName (HERE).stringValue () ;
      result << ") {\n"
        "    if let tableView = mTableView {\n"
      ...
      result << enumerator_14252.current_mObservablePropertyName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_transformerForTableViewAction (enumerator_14252.current_mPropertyType (HERE), GALGAS_string ("sender"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 325)).stringValue () ;
      result << "\n"
