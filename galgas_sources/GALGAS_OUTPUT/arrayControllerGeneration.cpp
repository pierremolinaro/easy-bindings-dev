...
//                                         september 9th, 2014, at 20h28'31"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_collectionControllerGenerationTemplate_arrayControllerImplementationInSwift (C_Compiler * inCompiler,
  ...
  result << "\n" ;
  GALGAS_uint index_4278_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_4278 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_4278.hasCurrentObject ()) {
      result << "      managedObject.removeObserverOf_" ;
      result << enumerator_4278.current_mObservablePropertyName (HERE).stringValue () ;
      result << " (mTriggerObjectForModelChange)\n" ;
      index_4278_.increment () ;
  ...
  result << in_ELEMENT_5F_TYPE_5F_NAME.stringValue () ;
  result << "\n" ;
  GALGAS_uint index_7993_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_7993 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_7993.hasCurrentObject ()) {
      result << "      managedObject.removeObserverOf_" ;
      result << enumerator_7993.current_mObservablePropertyName (HERE).stringValue () ;
      result << " (mTriggerObjectForModelChange)\n" ;
  ...
  result << in_ELEMENT_5F_TYPE_5F_NAME.stringValue () ;
  result << "\n" ;
  GALGAS_uint index_8392_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_8392 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_8392.hasCurrentObject ()) {
      result << "      managedObject.addObserverOf_" ;
      result << enumerator_8392.current_mObservablePropertyName (HERE).stringValue () ;
      result << " (mTriggerObjectForModelChange)\n" ;
      index_8392_.increment () ;
  ...
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_10882 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_10882.hasCurrentObject ()) {
      result << " if columnIdentifier == \"" ;
      result << enumerator_10882.current_mColumnName (HERE).stringValue () ;
      result << "\" {\n" ;
      result << in_FILE_5F_WRAPPER.reader_textFileContentsAtPath (GALGAS_string ("/cell-").add_operation (enumerator_10882.current_mPropertyType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 238)), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 238)).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 238)).add_operation (enumerator_10882.current_mColumnOutletTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 238)).add_operation (GALGAS_string (".txt"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 238)), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 238)).reader_stringByReplacingStringByString (GALGAS_string ("$MODEL$"), enumerator_10882.current_mObservablePropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 238)).stringValue () ;
      result << "    }" ;
      if (enumerator_10882.hasNextObject ()) {
        result << "else" ;
      }
  ...
  result << "\n"
    ...
    "\n"
    " " ;
  GALGAS_uint index_11193_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_11193 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_11193.hasCurrentObject ()) {
      result << " //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  func set_" ;
      result << enumerator_11193.current_mObservablePropertyName (HERE).stringValue () ;
      result << "_Action (sender : " ;
      result << enumerator_11193.current_mColumnOutletTypeName (HERE).stringValue () ;
      result << ") {\n"
        "    if let tableView = mTableView {\n"
      ...
      result << enumerator_11193.current_mObservablePropertyName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_transformerForTableViewAction (enumerator_11193.current_mPropertyType (HERE), GALGAS_string ("sender"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 254)).stringValue () ;
      result << "\n"
        "    }\n"
        "  }\n"
        "\n" ;
      index_11193_.increment () ;
