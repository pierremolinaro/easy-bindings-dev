...
//                                         september 11th, 2014, at 18h19'52"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_collectionControllerGenerationTemplate_arrayControllerImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_8704 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_8704.hasCurrentObject ()) {
      result << "      managedObject.removeObserverOf_" ;
      result << enumerator_8704.current_mObservablePropertyName (HERE).stringValue () ;
      result << " (mTriggerObjectForModelChange)\n" ;
  ...
  result << in_ELEMENT_5F_TYPE_5F_NAME.stringValue () ;
  result << "\n" ;
  GALGAS_uint index_9103_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_9103 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_9103.hasCurrentObject ()) {
      result << "      managedObject.addObserverOf_" ;
      result << enumerator_9103.current_mObservablePropertyName (HERE).stringValue () ;
      result << " (mTriggerObjectForModelChange)\n" ;
      index_9103_.increment () ;
  ...
  result << "\n"
    "   " ;
  GALGAS_uint index_11593_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_11593 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_11593.hasCurrentObject ()) {
      result << " if columnIdentifier == \"" ;
      result << enumerator_11593.current_mColumnName (HERE).stringValue () ;
      result << "\" {\n" ;
      result << in_FILE_5F_WRAPPER.reader_textFileContentsAtPath (GALGAS_string ("/cell-").add_operation (enumerator_11593.current_mPropertyType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 251)), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 251)).add_operation (GALGAS_string ("-"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 251)).add_operation (enumerator_11593.current_mColumnOutletTypeName (HERE), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 251)).add_operation (GALGAS_string (".txt"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 251)), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 251)).reader_stringByReplacingStringByString (GALGAS_string ("$MODEL$"), enumerator_11593.current_mObservablePropertyName (HERE), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 251)).stringValue () ;
      result << "    }" ;
      if (enumerator_11593.hasNextObject ()) {
        result << "else" ;
      }
      index_11593_.increment () ;
  ...
  result << "\n"
    ...
    "\n"
    " " ;
  GALGAS_uint index_11904_ (0) ;
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    cEnumerator_arrayControllerBoundColumnListForGeneration enumerator_11904 (in_BOUND_5F_COLUMNS, kEnumeration_up) ;
    while (enumerator_11904.hasCurrentObject ()) {
      result << " //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  func set_" ;
      result << enumerator_11904.current_mObservablePropertyName (HERE).stringValue () ;
      result << "_Action (sender : " ;
      result << enumerator_11904.current_mColumnOutletTypeName (HERE).stringValue () ;
      result << ") {\n"
        "    if let tableView = mTableView {\n"
      ...
      result << enumerator_11904.current_mObservablePropertyName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_transformerForTableViewAction (enumerator_11904.current_mPropertyType (HERE), GALGAS_string ("sender"), inCompiler COMMA_SOURCE_FILE ("array-controller.swift.gTemplate", 267)).stringValue () ;
      result << "\n"
        "    }\n"
        "  }\n"
        "\n" ;
      index_11904_.increment () ;
