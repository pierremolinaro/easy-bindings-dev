...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
                               ...
                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_outputDirectory = constinArgument_inSourceFile.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 181)) ;
  GALGAS_transientDependencyGraph var_transientDependencyGraph ;
  {
  routine_buildTransientDependencyGraph (constinArgument_inUnifiedTypeMap, constinArgument_inSourceFile, var_transientDependencyGraph, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 183)) ;
  }
}
...
void routine_EXsemanticAnalysis (const GALGAS_EXunifiedTypeMap constinArgument_inUnifiedTypeMap,
                                 ...
                                 C_Compiler * inCompiler
                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_outputDirectory = constinArgument_inSourceFile.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 203)) ;
  GALGAS_EXobservablePropertyMapMap var_observablePropertyMapMap = GALGAS_EXobservablePropertyMapMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 205)) ;
  GALGAS_EXtransientDependencyGraph var_transientDependencyGraph = GALGAS_EXtransientDependencyGraph::constructor_emptyGraph (SOURCE_FILE ("easyBindings_program.gProgram", 206)) ;
  cEnumerator_lstringlist enumerator_9224 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_9224.hasCurrentObject ()) {
    GALGAS_EXastDeclaration var_declaration ;
    GALGAS_EXebType joker_9281_0 ; // Joker input parameter
    GALGAS_EXentityRelationshipMap joker_9327_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_9224.current_mValue (HERE), joker_9281_0, var_declaration, joker_9327_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 208)) ;
    callCategoryMethod_buildObservablePropertyMap ((const cPtr_EXastDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_observablePropertyMapMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 214)) ;
    enumerator_9224.gotoNextObject () ;
  }
  GALGAS_EXcontextAnalysisStruct var_contextAnalysisStruct = GALGAS_EXcontextAnalysisStruct::constructor_default (SOURCE_FILE ("easyBindings_program.gProgram", 220)) ;
  ...
  {
  routine_cursorAnalysis (constinArgument_inCursorList, var_contextAnalysisStruct, var_predefinedCursorList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 224)) ;
  }
  GALGAS_generationList var_generationList = GALGAS_generationList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 230)) ;
  cEnumerator_lstringlist enumerator_9931 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_9931.hasCurrentObject ()) {
    GALGAS_EXastDeclaration var_declaration ;
    GALGAS_EXebType joker_9988_0 ; // Joker input parameter
    GALGAS_EXentityRelationshipMap joker_10034_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_9931.current_mValue (HERE), joker_9988_0, var_declaration, joker_10034_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 232)) ;
    callCategoryMethod_semanticAnalysis ((const cPtr_EXastDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_contextAnalysisStruct, var_generationList, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 238)) ;
    enumerator_9931.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 245)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_entityMap enumerator_10311 (var_contextAnalysisStruct.mAttribute_mEntityMap, kEnumeration_up) ;
    while (enumerator_10311.hasCurrentObject ()) {
      cEnumerator_relationshipMap enumerator_10352 (enumerator_10311.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
      while (enumerator_10352.hasCurrentObject ()) {
        GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
        GALGAS_string joker_10454_9 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_10454_8 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_10454_7 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_10454_6 ; // Joker input parameter
        GALGAS_transientListForImplementation joker_10454_5 ; // Joker input parameter
        GALGAS_relationshipList joker_10454_4 ; // Joker input parameter
        GALGAS_relationshipList joker_10454_3 ; // Joker input parameter
        GALGAS_propertyMap joker_10454_2 ; // Joker input parameter
        GALGAS_relationshipMap joker_10454_1 ; // Joker input parameter
        GALGAS_fileInclusionSet joker_10529_2 ; // Joker input parameter
        GALGAS_signListForGeneration joker_10529_1 ; // Joker input parameter
        var_contextAnalysisStruct.mAttribute_mEntityMap.method_searchKey (enumerator_10352.current_mDestinationEntityName (HERE), joker_10454_9, joker_10454_8, joker_10454_7, joker_10454_6, joker_10454_5, joker_10454_4, joker_10454_3, joker_10454_2, joker_10454_1, var_destinationEntityRelationshipMap, joker_10529_2, joker_10529_1, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 248)) ;
        GALGAS_lstring var_inverseOfInverseRelationshipName ;
        GALGAS_bool var_inverseIsToMany ;
        GALGAS_bool joker_10643_2 ; // Joker input parameter
        GALGAS_lstring joker_10643_1 ; // Joker input parameter
        GALGAS_deleteRuleEnum joker_10743_0 ; // Joker input parameter
        var_destinationEntityRelationshipMap.method_searchKey (enumerator_10352.current_mInverseRelationshipName (HERE), joker_10643_2, joker_10643_1, var_inverseOfInverseRelationshipName, var_inverseIsToMany, joker_10743_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 254)) ;
        const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_10352.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_location location_2 (enumerator_10352.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_10352.current_lkey (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 262))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 262)).operator_concat (GALGAS_string ("' relationship as inverse")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 262))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 262)) ;
        }
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_10352.current_mIsToMany (HERE).objectCompare (var_inverseIsToMany)).boolEnum () ;
        if (kBoolTrue == test_3) {
          ...
          GALGAS_location location_6 (enumerator_10352.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_6, GALGAS_string ("the inverse relationship is ").operator_concat (temp_4  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 265))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 265)) ;
        }
  ...
  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 271)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_7) {
    cEnumerator_generationList enumerator_11289 (var_generationList, kEnumeration_up) ;
    while (enumerator_11289.hasCurrentObject ()) {
      callCategoryMethod_generate ((const cPtr_generation *) enumerator_11289.current_mGeneration (HERE).ptr (), var_outputDirectory, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 273)) ;
      enumerator_11289.gotoNextObject () ;
    }
    {
    routine_generateCursorCode (var_contextAnalysisStruct.mAttribute_mUserCursorMap, var_predefinedCursorList, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 275)) ;
    }
    {
    routine_generateEntityFactory (var_contextAnalysisStruct.mAttribute_mEntityMap, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 280)) ;
    }
  }
  ...
  if (kBoolTrue == test_8) {
    GALGAS_string var_s = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_graphviz (SOURCE_FILE ("easyBindings_program.gProgram", 284)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.operator_concat (GALGAS_string (".EXtransientDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 285)) ;
    GALGAS_bool joker_11917_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_11917_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 286)) ;
  }
  GALGAS__32_stringlist var_transientDependencyArcList = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_edges (SOURCE_FILE ("easyBindings_program.gProgram", 289)) ;
  GALGAS_stringlist var_sortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 290)) ;
  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 291)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_9) {
    const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE ("easyBindings_program.gProgram", 292)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_10) {
      cEnumerator_stringlist enumerator_12331 (var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE ("easyBindings_program.gProgram", 293)), kEnumeration_up) ;
      while (enumerator_12331.hasCurrentObject ()) {
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_12331.current_mValue (HERE)  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 294)).operator_concat (GALGAS_string ("' property is not defined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 294))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 294)) ;
        enumerator_12331.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_10) {
      GALGAS_stringlist var_unsortedTransientList ;
      GALGAS_lstringlist joker_12564_0 ; // Joker input parameter
      GALGAS_lstringlist joker_12618_0 ; // Joker input parameter
      var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.method_topologicalSort (var_sortedTransientOrderedList, joker_12564_0, var_unsortedTransientList, joker_12618_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 297)) ;
      const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 303)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_11) {
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 304)).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 304)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 304)) ;
        cEnumerator_stringlist enumerator_12846 (var_unsortedTransientList, kEnumeration_up) ;
        while (enumerator_12846.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_12846.current_mValue (HERE)  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 306))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 306)) ;
          enumerator_12846.gotoNextObject () ;
        }
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 308)) ;
      }
    }
  }
  {
  routine_generateTransientTrigersAndApplication (var_transientDependencyArcList, var_outputDirectory, var_sortedTransientOrderedList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 314)) ;
  }
  GALGAS_stringset var_extensionSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("xib") COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 320)) ;
  const enumGalgasBool test_12 = GALGAS_bool (gOption_easyBindings_5F_options_outputSwift.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("swift")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 322)) ;
  }else if (kBoolFalse == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("m")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 324)) ;
    var_extensionSet.addAssign_operation (GALGAS_string ("h")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 325)) ;
  }
  GALGAS_stringset var_generateSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("easyBindings_program.gProgram", 328)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("easy-bindings-utilities")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 329)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 330)) ;
  const enumGalgasBool test_13 = var_contextAnalysisStruct.mAttribute_mContainsDocument.boolEnum () ;
  if (kBoolTrue == test_13) {
    var_generateSet.addAssign_operation (GALGAS_string ("PMUndoManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 332)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedDocument")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 333)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 334)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 335)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+PMGZcompression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 336)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSMutableData+PMWrites")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 337)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 338)) ;
  }
  const enumGalgasBool test_14 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mEntityMap.reader_count (SOURCE_FILE ("easyBindings_program.gProgram", 340)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_14) {
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 341)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedObject")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 342)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMObjectManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 343)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMAttributeDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 344)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMRelationshipDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 345)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityArrayController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 346)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 347)) ;
  }
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  cEnumerator_stringlist enumerator_14444 (var_fw.reader_allTextFilePathes (SOURCE_FILE ("easyBindings_program.gProgram", 351)), kEnumeration_up) ;
  while (enumerator_14444.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_14444.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 352)) ;
    const enumGalgasBool test_15 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 353)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 353)).operator_and (var_extensionSet.reader_hasKey (var_sourceName.reader_pathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 353)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 353)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 353)).boolEnum () ;
    if (kBoolTrue == test_15) {
      {
      GALGAS_string::class_method_generateFile (var_outputDirectory.operator_concat (enumerator_14444.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 355))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 355)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_14444.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 357)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 354)) ;
      }
    }
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_3) {
      ...
      {
      routine_semanticAnalysis (var_unifiedTypeMap, var_sortedTypeNames, constinArgument_inSourceFile.mAttribute_string, var_cursorList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 98)) ;
      }
    }
  }
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSString"), GALGAS_EXTypeKind::constructor_stringType (SOURCE_FILE ("easyBindings_program.gProgram", 111)), GALGAS_typeKind::constructor_stringType (SOURCE_FILE ("easyBindings_program.gProgram", 111))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 111))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 111)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSColor"), GALGAS_EXTypeKind::constructor_colorType (SOURCE_FILE ("easyBindings_program.gProgram", 112)), GALGAS_typeKind::constructor_colorType (SOURCE_FILE ("easyBindings_program.gProgram", 112))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 112))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 112)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSData"), GALGAS_EXTypeKind::constructor_dataType (SOURCE_FILE ("easyBindings_program.gProgram", 113)), GALGAS_typeKind::constructor_dataType (SOURCE_FILE ("easyBindings_program.gProgram", 113))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 113))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 113)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSDate"), GALGAS_EXTypeKind::constructor_dateType (SOURCE_FILE ("easyBindings_program.gProgram", 114)), GALGAS_typeKind::constructor_dateType (SOURCE_FILE ("easyBindings_program.gProgram", 114))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 114))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 114)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSFont"), GALGAS_EXTypeKind::constructor_fontType (SOURCE_FILE ("easyBindings_program.gProgram", 115)), GALGAS_typeKind::constructor_fontType (SOURCE_FILE ("easyBindings_program.gProgram", 115))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 115))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 115)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSImage"), GALGAS_EXTypeKind::constructor_imageType (SOURCE_FILE ("easyBindings_program.gProgram", 116)), GALGAS_typeKind::constructor_imageType (SOURCE_FILE ("easyBindings_program.gProgram", 116))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 116))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 116)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSMenu"), GALGAS_EXTypeKind::constructor_menuType (SOURCE_FILE ("easyBindings_program.gProgram", 117)), GALGAS_typeKind::constructor_menuType (SOURCE_FILE ("easyBindings_program.gProgram", 117))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 117))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 117)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSBezierPath"), GALGAS_EXTypeKind::constructor_bezierPathType (SOURCE_FILE ("easyBindings_program.gProgram", 118)), GALGAS_typeKind::constructor_bezierPathType (SOURCE_FILE ("easyBindings_program.gProgram", 118))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 118))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 118)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("Integer"), GALGAS_EXTypeKind::constructor_integerType (SOURCE_FILE ("easyBindings_program.gProgram", 119)), GALGAS_typeKind::constructor_integerType (SOURCE_FILE ("easyBindings_program.gProgram", 119))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 119))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 119)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("UInteger"), GALGAS_EXTypeKind::constructor_uintegerType (SOURCE_FILE ("easyBindings_program.gProgram", 120)), GALGAS_typeKind::constructor_uintegerType (SOURCE_FILE ("easyBindings_program.gProgram", 120))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 120))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 120)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("Bool"), GALGAS_EXTypeKind::constructor_boolType (SOURCE_FILE ("easyBindings_program.gProgram", 121)), GALGAS_typeKind::constructor_boolType (SOURCE_FILE ("easyBindings_program.gProgram", 121))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 121))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 121)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("Double"), GALGAS_EXTypeKind::constructor_doubleType (SOURCE_FILE ("easyBindings_program.gProgram", 122)), GALGAS_typeKind::constructor_doubleType (SOURCE_FILE ("easyBindings_program.gProgram", 122))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 122))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 122)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("enum"), GALGAS_EXTypeKind::constructor_enumType (SOURCE_FILE ("easyBindings_program.gProgram", 123)), GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("easyBindings_program.gProgram", 123))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 123))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 123)) ;
  GALGAS_EXunifiedTypeMap var_EXunifiedTypeMap = GALGAS_EXunifiedTypeMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 125)) ;
  cEnumerator_EXastDeclarationList enumerator_6127 (var_EXdeclarationList, kEnumeration_up) ;
  while (enumerator_6127.hasCurrentObject ()) {
    callCategoryMethod_EXTypeInventory ((const cPtr_EXastDeclaration *) enumerator_6127.current_mDeclaration (HERE).ptr (), var_EXunifiedTypeMap, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 128)) ;
    enumerator_6127.gotoNextObject () ;
  }
  const enumGalgasBool test_4 = GALGAS_bool (gOption_easyBindings_5F_options_outputClassDependencyGraph.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_string var_s = var_EXunifiedTypeMap.reader_edgeGraphvizRepresentation (SOURCE_FILE ("easyBindings_program.gProgram", 131)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".EXclassDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 132)) ;
    GALGAS_bool joker_6459_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_6459_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 133)) ;
  }
  GALGAS_lstringlist var_EXunsolvedProxyList = var_EXunifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE ("easyBindings_program.gProgram", 136)) ;
  cEnumerator_lstringlist enumerator_6647 (var_EXunsolvedProxyList, kEnumeration_up) ;
  while (enumerator_6647.hasCurrentObject ()) {
    GALGAS_location location_5 (enumerator_6647.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_5, GALGAS_string ("type ").operator_concat (enumerator_6647.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 138))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 138)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 138))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 138)) ;
    enumerator_6647.gotoNextObject () ;
  }
  const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, var_EXunsolvedProxyList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 141)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_6) {
    GALGAS_lstringlist var_sortedTypeNames ;
    GALGAS_lstringlist var_unsortedTypeNames ;
    var_EXunifiedTypeMap.method_topologicalSort (var_sortedTypeNames, var_unsortedTypeNames, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 142)) ;
    const enumGalgasBool test_7 = GALGAS_bool (kIsStrictSup, var_unsortedTypeNames.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 146)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_7) {
      GALGAS_string var_s = GALGAS_string ("cannot sort types ; the following types are involved in circular dependence:") ;
      cEnumerator_lstringlist enumerator_7137 (var_unsortedTypeNames, kEnumeration_up) ;
      while (enumerator_7137.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_7137.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 149))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 149))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 149)) ;
        enumerator_7137.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (inCompiler->here (), var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 151)) ;
    }else if (kBoolFalse == test_7) {
      {
      routine_EXsemanticAnalysis (var_EXunifiedTypeMap, var_sortedTypeNames, constinArgument_inSourceFile.mAttribute_string, var_cursorList, var_endOfSourceFile, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 158)) ;
      }
    }
  }
}
