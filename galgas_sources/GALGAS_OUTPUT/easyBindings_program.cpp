...
static const cRegularFileWrapper * gWrapperAllFiles_objective_5F_c_5F_sources_0 [8] = {
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cGrammar_easyBindings_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, var_classList, var_entityList, var_preferencesList, var_outletClassList, var_documentDeclarationList, var_controllerClassList, var_protocolList, var_endOfSourceFile COMMA_SOURCE_FILE_AT_LINE (51)) ;
  ...
  routine_semanticAnalysis (var_classList, var_entityList, var_preferencesList, var_outletClassList, var_documentDeclarationList, var_controllerClassList, var_protocolList, var_endOfSourceFile, constinArgument_inSourceFile.mAttribute_string, var_outletClassMap, var_controllerClassMap, var_classMap, var_entityMap, var_preferencesMap, var_documentMap, var_sortedTransientOrderedList, var_transientDependencyArcList, inCompiler COMMA_SOURCE_FILE_AT_LINE (70)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_sourceDirectoryPath = constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (90)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_generateOutletClassCode (var_outletClassMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (91)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generateClassCode (var_transientDependencyArcList, var_classMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (92)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generateEntityCode (var_transientDependencyArcList, var_entityMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (93)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generatePreferencesCode (var_transientDependencyArcList, var_preferencesMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (94)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generateDocumentCode (var_transientDependencyArcList, var_documentMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (95)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generateTransientDependencyFiles (var_transientDependencyArcList, var_sourceDirectoryPath, var_sortedTransientOrderedList, inCompiler COMMA_SOURCE_FILE_AT_LINE (97)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_sources = GALGAS_stringset::constructor_setWithString (GALGAS_string ("easy-bindings-utilities") COMMA_SOURCE_FILE_AT_LINE (103)) ;
  //-------- @plusEqualnstructionForGeneration
  var_sources.addAssign_operation (GALGAS_string ("PMAllocationDebug") COMMA_SOURCE_FILE_AT_LINE (104)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  cEnumerator_stringlist enumerator_3480 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (106)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_3480.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_sourceName = enumerator_3480.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (107)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_sources.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (108)) COMMA_SOURCE_FILE_AT_LINE (108)).boolEnum () ;
    if (kBoolTrue == test_0) {
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_string::class_method_generateFile (var_sourceDirectoryPath.operator_concat (enumerator_3480.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (110)) COMMA_SOURCE_FILE_AT_LINE (110)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_3480.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (112)), inCompiler COMMA_SOURCE_FILE_AT_LINE (109)) ;
      } //-------- @routineCallInstructionForGeneration
    }
