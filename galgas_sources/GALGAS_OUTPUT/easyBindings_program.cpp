...
const char * gWrapperFileContent_10_objective_5F_c_5F_sources = "//-----------------------------------------------------------------------------*\n"
  ...
  "//---------------------------------------------------------------------------*\n"
  "\n"
  "@objc(protocol_document_2E_PMDocument_2E_countItemMessage) protocol protocol_document_2E_PMDocument_2E_countItemMessage : NSObjectProtocol {\n"
  "  func document_2E_PMDocument_2E_countItemMessage_didChange ()\n"
  "}\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
  "@objc(protocol_document_2E_PMDocument_2E_canRemoveString) protocol protocol_document_2E_PMDocument_2E_canRemoveString : NSObjectProtocol {\n"
  ...
  "      for object in mObserverObject_document_2E_PMDocument_2E_countItemMessage {\n"
  ...
  "      for object in mObserverObject_document_2E_PMDocument_2E_canRemoveString {\n"
...
const char * gWrapperFileContent_38_objective_5F_c_5F_sources = "//---------------------------------------------------------------------------*\n"
  "\n"
  "#import \"easy-bindings-utilities.h\"\n"
  "#import <objc/runtime.h>\n"
  "\n"
...
const char * gWrapperFileContent_39_objective_5F_c_5F_sources = "import Cocoa\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "//   presentErrorWindow                                                      *\n"
  "//---------------------------------------------------------------------------*\n"
...
const char * gWrapperFileContent_41_objective_5F_c_5F_sources = "//\n"
...
const cRegularFileWrapper gWrapperFile_41_objective_5F_c_5F_sources (
  "load-store-functions.m",
  "m",
  true, // Text file
  5169, // Text length
  gWrapperFileContent_41_objective_5F_c_5F_sources
) ;

//--- All files of '' directory

static const cRegularFileWrapper * gWrapperAllFiles_objective_5F_c_5F_sources_0 [43] = {
  ...
  & gWrapperFile_41_objective_5F_c_5F_sources,
  NULL
} ;
...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
                               ...
                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_outputDirectory = constinArgument_inSourceFile.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 115)) ;
  GALGAS_observablePropertyMapMap var_observablePropertyMapMap = GALGAS_observablePropertyMapMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 117)) ;
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE ("easyBindings_program.gProgram", 118)) ;
  cEnumerator_lstringlist enumerator_4865 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_4865.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    GALGAS_ebType joker_4922_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_4865.current_mValue (HERE), joker_4922_0, var_declaration, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 120)) ;
    callCategoryMethod_buildObservablePropertyMap ((const cPtr_astDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_observablePropertyMapMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 125)) ;
    enumerator_4865.gotoNextObject () ;
  }
  GALGAS_contextAnalysisStruct var_contextAnalysisStruct = GALGAS_contextAnalysisStruct::constructor_default (SOURCE_FILE ("easyBindings_program.gProgram", 131)) ;
  ...
  {
  routine_cursorAnalysis (constinArgument_inCursorList, var_contextAnalysisStruct, var_predefinedCursorList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 135)) ;
  }
  GALGAS_generationList var_generationList = GALGAS_generationList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 141)) ;
  cEnumerator_lstringlist enumerator_5559 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_5559.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    GALGAS_ebType joker_5616_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_5559.current_mValue (HERE), joker_5616_0, var_declaration, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 143)) ;
    callCategoryMethod_semanticAnalysis ((const cPtr_astDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_contextAnalysisStruct, var_generationList, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 148)) ;
    enumerator_5559.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 155)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_entityMap enumerator_5928 (var_contextAnalysisStruct.mAttribute_mEntityMap, kEnumeration_up) ;
    while (enumerator_5928.hasCurrentObject ()) {
      cEnumerator_relationshipMap enumerator_5969 (enumerator_5928.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
      while (enumerator_5969.hasCurrentObject ()) {
        GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
        GALGAS_string joker_6071_9 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6071_8 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6071_7 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6071_6 ; // Joker input parameter
        GALGAS_transientListForImplementation joker_6071_5 ; // Joker input parameter
        GALGAS_relationshipList joker_6071_4 ; // Joker input parameter
        GALGAS_relationshipList joker_6071_3 ; // Joker input parameter
        GALGAS_propertyMap joker_6071_2 ; // Joker input parameter
        GALGAS_relationshipMap joker_6071_1 ; // Joker input parameter
        GALGAS_fileInclusionSet joker_6146_2 ; // Joker input parameter
        GALGAS_signListForGeneration joker_6146_1 ; // Joker input parameter
        var_contextAnalysisStruct.mAttribute_mEntityMap.method_searchKey (enumerator_5969.current_mDestinationEntityName (HERE), joker_6071_9, joker_6071_8, joker_6071_7, joker_6071_6, joker_6071_5, joker_6071_4, joker_6071_3, joker_6071_2, joker_6071_1, var_destinationEntityRelationshipMap, joker_6146_2, joker_6146_1, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 158)) ;
        GALGAS_lstring var_inverseOfInverseRelationshipName ;
        GALGAS_bool var_inverseIsToMany ;
        GALGAS_bool joker_6260_2 ; // Joker input parameter
        GALGAS_lstring joker_6260_1 ; // Joker input parameter
        GALGAS_deleteRuleEnum joker_6360_0 ; // Joker input parameter
        var_destinationEntityRelationshipMap.method_searchKey (enumerator_5969.current_mInverseRelationshipName (HERE), joker_6260_2, joker_6260_1, var_inverseOfInverseRelationshipName, var_inverseIsToMany, joker_6360_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 164)) ;
        const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_5969.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_location location_2 (enumerator_5969.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_5969.current_lkey (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 172))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 172)).operator_concat (GALGAS_string ("' relationship as inverse")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 172))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 172)) ;
        }
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_5969.current_mIsToMany (HERE).objectCompare (var_inverseIsToMany)).boolEnum () ;
        if (kBoolTrue == test_3) {
          ...
          GALGAS_location location_6 (enumerator_5969.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_6, GALGAS_string ("the inverse relationship is ").operator_concat (temp_4  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 175))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 175)) ;
        }
  ...
  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 181)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_7) {
    cEnumerator_generationList enumerator_6906 (var_generationList, kEnumeration_up) ;
    while (enumerator_6906.hasCurrentObject ()) {
      callCategoryMethod_generate ((const cPtr_generation *) enumerator_6906.current_mGeneration (HERE).ptr (), var_outputDirectory, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 183)) ;
      enumerator_6906.gotoNextObject () ;
    }
    {
    routine_generateCursorCode (var_contextAnalysisStruct.mAttribute_mUserCursorMap, var_predefinedCursorList, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 185)) ;
    }
    {
    routine_generateEntityFactory (var_contextAnalysisStruct.mAttribute_mEntityMap, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 190)) ;
    }
  }
  const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 193)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 193)).boolEnum () ;
  if (kBoolTrue == test_8) {
    GALGAS_string var_s = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_graphviz (SOURCE_FILE ("easyBindings_program.gProgram", 194)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.operator_concat (GALGAS_string (".transientDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 195)) ;
    GALGAS_bool joker_7532_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_7532_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 196)) ;
  }
  GALGAS__32_stringlist var_transientDependencyArcList = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_edges (SOURCE_FILE ("easyBindings_program.gProgram", 199)) ;
  GALGAS_stringlist var_sortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 200)) ;
  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 201)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_9) {
    const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE ("easyBindings_program.gProgram", 202)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_10) {
      cEnumerator_stringlist enumerator_7946 (var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE ("easyBindings_program.gProgram", 203)), kEnumeration_up) ;
      while (enumerator_7946.hasCurrentObject ()) {
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_7946.current_mValue (HERE)  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 204)).operator_concat (GALGAS_string ("' property is not defined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 204))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 204)) ;
        enumerator_7946.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_10) {
      GALGAS_stringlist var_unsortedTransientList ;
      GALGAS_lstringlist joker_8179_0 ; // Joker input parameter
      GALGAS_lstringlist joker_8233_0 ; // Joker input parameter
      var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.method_topologicalSort (var_sortedTransientOrderedList, joker_8179_0, var_unsortedTransientList, joker_8233_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 207)) ;
      const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 213)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_11) {
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 214)).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 214)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 214)) ;
        cEnumerator_stringlist enumerator_8461 (var_unsortedTransientList, kEnumeration_up) ;
        while (enumerator_8461.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_8461.current_mValue (HERE)  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 216))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 216)) ;
          enumerator_8461.gotoNextObject () ;
        }
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 218)) ;
      }
    }
  }
  {
  routine_generateTransientDependencyFiles (var_transientDependencyArcList, var_outputDirectory, var_sortedTransientOrderedList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 224)) ;
  }
  GALGAS_stringset var_extensionSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("xib") COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 230)) ;
  const enumGalgasBool test_12 = GALGAS_bool (gOption_easyBindings_5F_options_outputSwift.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("swift")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 232)) ;
  }else if (kBoolFalse == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("m")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 234)) ;
    var_extensionSet.addAssign_operation (GALGAS_string ("h")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 235)) ;
  }
  GALGAS_stringset var_generateSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("easyBindings_program.gProgram", 238)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("easy-bindings-utilities")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 239)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 240)) ;
  const enumGalgasBool test_13 = var_contextAnalysisStruct.mAttribute_mContainsDocument.boolEnum () ;
  if (kBoolTrue == test_13) {
    var_generateSet.addAssign_operation (GALGAS_string ("PMUndoManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 242)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedDocument")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 243)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 244)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 245)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+PMGZcompression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 246)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSMutableData+PMWrites")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 247)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 248)) ;
  }
  const enumGalgasBool test_14 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mEntityMap.reader_count (SOURCE_FILE ("easyBindings_program.gProgram", 250)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_14) {
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 251)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedObject")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 252)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMObjectManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 253)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMAttributeDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 254)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMRelationshipDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 255)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityArrayController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 256)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 257)) ;
  }
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  cEnumerator_stringlist enumerator_10053 (var_fw.reader_allTextFilePathes (SOURCE_FILE ("easyBindings_program.gProgram", 261)), kEnumeration_up) ;
  while (enumerator_10053.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_10053.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 262)) ;
    const enumGalgasBool test_15 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 263)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 263)).operator_and (var_extensionSet.reader_hasKey (var_sourceName.reader_pathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 263)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 263)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 263)).boolEnum () ;
    if (kBoolTrue == test_15) {
      {
      GALGAS_string::class_method_generateFile (var_outputDirectory.operator_concat (enumerator_10053.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 265))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 265)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_10053.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 267)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 264)) ;
      }
    }
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  GALGAS_location joker_1153_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 35))), var_declarationList, var_cursorList, joker_1153_0  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 35)) ;
  GALGAS_location var_endOfSourceFile ;
  var_endOfSourceFile.drop () ;
  cGrammar_easyBindings_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, var_declarationList, var_cursorList, var_endOfSourceFile  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 41)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSString"), GALGAS_typeKind::constructor_stringType (SOURCE_FILE ("easyBindings_program.gProgram", 47))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 47))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 47)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSColor"), GALGAS_typeKind::constructor_colorType (SOURCE_FILE ("easyBindings_program.gProgram", 48))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 48))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 48)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSData"), GALGAS_typeKind::constructor_dataType (SOURCE_FILE ("easyBindings_program.gProgram", 49))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 49))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 49)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSDate"), GALGAS_typeKind::constructor_dateType (SOURCE_FILE ("easyBindings_program.gProgram", 50))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 50))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 50)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSFont"), GALGAS_typeKind::constructor_fontType (SOURCE_FILE ("easyBindings_program.gProgram", 51))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 51))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 51)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSImage"), GALGAS_typeKind::constructor_imageType (SOURCE_FILE ("easyBindings_program.gProgram", 52))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 52))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 52)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSMenu"), GALGAS_typeKind::constructor_menuType (SOURCE_FILE ("easyBindings_program.gProgram", 53))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 53))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 53)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSBezierPath"), GALGAS_typeKind::constructor_bezierPathType (SOURCE_FILE ("easyBindings_program.gProgram", 54))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 54))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 54)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("Integer"), GALGAS_typeKind::constructor_integerType (SOURCE_FILE ("easyBindings_program.gProgram", 55))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 55))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 55)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("UInteger"), GALGAS_typeKind::constructor_uintegerType (SOURCE_FILE ("easyBindings_program.gProgram", 56))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 56))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 56)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("Bool"), GALGAS_typeKind::constructor_boolType (SOURCE_FILE ("easyBindings_program.gProgram", 57))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 57))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 57)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("Double"), GALGAS_typeKind::constructor_doubleType (SOURCE_FILE ("easyBindings_program.gProgram", 58))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 58))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 58)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("enum"), GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("easyBindings_program.gProgram", 59))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 59))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 59)) ;
  GALGAS_unifiedTypeMap var_unifiedTypeMap = GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 61)) ;
  cEnumerator_astDeclarationList enumerator_2666 (var_declarationList, kEnumeration_up) ;
  while (enumerator_2666.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_2666.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 64)) ;
  ...
  if (kBoolTrue == test_0) {
    GALGAS_string var_s = var_unifiedTypeMap.reader_edgeGraphvizRepresentation (SOURCE_FILE ("easyBindings_program.gProgram", 67)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".classDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 68)) ;
    GALGAS_bool joker_2990_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_2990_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 69)) ;
  }
  GALGAS_lstringlist var_unsolvedProxyList = var_unifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE ("easyBindings_program.gProgram", 72)) ;
  cEnumerator_lstringlist enumerator_3172 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3172.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3172.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3172.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 74))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 74)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 74))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 74)) ;
    enumerator_3172.gotoNextObject () ;
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_unsolvedProxyList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 77)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_lstringlist var_sortedKeys ;
    GALGAS_lstringlist var_unsortedKeys ;
    var_unifiedTypeMap.method_topologicalSort (var_sortedKeys, var_unsortedKeys, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 78)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedKeys.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 79)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_s = GALGAS_string ("cannot sort types ; the following types are involved in circular dependence:") ;
      cEnumerator_lstringlist enumerator_3615 (var_unsortedKeys, kEnumeration_up) ;
      while (enumerator_3615.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_3615.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 82))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 82))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 82)) ;
        enumerator_3615.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (inCompiler->here (), var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 84)) ;
    }else if (kBoolFalse == test_3) {
      {
      routine_semanticAnalysis (var_unifiedTypeMap, var_sortedKeys, constinArgument_inSourceFile.mAttribute_string, var_cursorList, var_endOfSourceFile, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 91)) ;
      }
    }
  }
}
