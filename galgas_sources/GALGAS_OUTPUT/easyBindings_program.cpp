...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
                               ...
                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_outputDirectory = constinArgument_inSourceFile.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 165)) ;
  GALGAS_transientDependencyGraph var_transientDependencyGraph ;
  {
  routine_buildTransientDependencyGraph (constinArgument_inUnifiedTypeMap, constinArgument_inSourceFile, var_transientDependencyGraph, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 167)) ;
  }
}
...
void routine_EXsemanticAnalysis (const GALGAS_EXunifiedTypeMap constinArgument_inUnifiedTypeMap,
                                 ...
                                 C_Compiler * inCompiler
                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_outputDirectory = constinArgument_inSourceFile.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 187)) ;
  GALGAS_EXobservablePropertyMapMap var_observablePropertyMapMap = GALGAS_EXobservablePropertyMapMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 189)) ;
  GALGAS_EXtransientDependencyGraph var_transientDependencyGraph = GALGAS_EXtransientDependencyGraph::constructor_emptyGraph (SOURCE_FILE ("easyBindings_program.gProgram", 190)) ;
  cEnumerator_lstringlist enumerator_7768 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_7768.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    GALGAS_EXebType joker_7825_0 ; // Joker input parameter
    GALGAS_EXentityRelationshipMap joker_7869_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_7768.current_mValue (HERE), joker_7825_0, var_declaration, joker_7869_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 192)) ;
    callCategoryMethod_buildObservablePropertyMap ((const cPtr_astDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_observablePropertyMapMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 198)) ;
    enumerator_7768.gotoNextObject () ;
  }
  GALGAS_EXcontextAnalysisStruct var_contextAnalysisStruct = GALGAS_EXcontextAnalysisStruct::constructor_default (SOURCE_FILE ("easyBindings_program.gProgram", 204)) ;
  ...
  {
  routine_cursorAnalysis (constinArgument_inCursorList, var_contextAnalysisStruct, var_predefinedCursorList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 208)) ;
  }
  GALGAS_generationList var_generationList = GALGAS_generationList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 214)) ;
  cEnumerator_lstringlist enumerator_8473 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_8473.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    GALGAS_EXebType joker_8530_0 ; // Joker input parameter
    GALGAS_EXentityRelationshipMap joker_8574_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_8473.current_mValue (HERE), joker_8530_0, var_declaration, joker_8574_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 216)) ;
    callCategoryMethod_semanticAnalysis ((const cPtr_astDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_contextAnalysisStruct, var_generationList, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 222)) ;
    enumerator_8473.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 229)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_entityMap enumerator_8851 (var_contextAnalysisStruct.mAttribute_mEntityMap, kEnumeration_up) ;
    while (enumerator_8851.hasCurrentObject ()) {
      cEnumerator_relationshipMap enumerator_8892 (enumerator_8851.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
      while (enumerator_8892.hasCurrentObject ()) {
        GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
        GALGAS_string joker_8994_9 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_8994_8 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_8994_7 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_8994_6 ; // Joker input parameter
        GALGAS_transientListForImplementation joker_8994_5 ; // Joker input parameter
        GALGAS_relationshipList joker_8994_4 ; // Joker input parameter
        GALGAS_relationshipList joker_8994_3 ; // Joker input parameter
        GALGAS_propertyMap joker_8994_2 ; // Joker input parameter
        GALGAS_relationshipMap joker_8994_1 ; // Joker input parameter
        GALGAS_fileInclusionSet joker_9069_2 ; // Joker input parameter
        GALGAS_signListForGeneration joker_9069_1 ; // Joker input parameter
        var_contextAnalysisStruct.mAttribute_mEntityMap.method_searchKey (enumerator_8892.current_mDestinationEntityName (HERE), joker_8994_9, joker_8994_8, joker_8994_7, joker_8994_6, joker_8994_5, joker_8994_4, joker_8994_3, joker_8994_2, joker_8994_1, var_destinationEntityRelationshipMap, joker_9069_2, joker_9069_1, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 232)) ;
        GALGAS_lstring var_inverseOfInverseRelationshipName ;
        GALGAS_bool var_inverseIsToMany ;
        GALGAS_bool joker_9183_2 ; // Joker input parameter
        GALGAS_lstring joker_9183_1 ; // Joker input parameter
        GALGAS_deleteRuleEnum joker_9283_0 ; // Joker input parameter
        var_destinationEntityRelationshipMap.method_searchKey (enumerator_8892.current_mInverseRelationshipName (HERE), joker_9183_2, joker_9183_1, var_inverseOfInverseRelationshipName, var_inverseIsToMany, joker_9283_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 238)) ;
        const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_8892.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_location location_2 (enumerator_8892.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_8892.current_lkey (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 246))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 246)).operator_concat (GALGAS_string ("' relationship as inverse")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 246))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 246)) ;
        }
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_8892.current_mIsToMany (HERE).objectCompare (var_inverseIsToMany)).boolEnum () ;
        if (kBoolTrue == test_3) {
          ...
          GALGAS_location location_6 (enumerator_8892.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_6, GALGAS_string ("the inverse relationship is ").operator_concat (temp_4  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 249))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 249)) ;
        }
  ...
  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 255)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_7) {
    cEnumerator_generationList enumerator_9829 (var_generationList, kEnumeration_up) ;
    while (enumerator_9829.hasCurrentObject ()) {
      callCategoryMethod_generate ((const cPtr_generation *) enumerator_9829.current_mGeneration (HERE).ptr (), var_outputDirectory, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 257)) ;
      enumerator_9829.gotoNextObject () ;
    }
    {
    routine_generateCursorCode (var_contextAnalysisStruct.mAttribute_mUserCursorMap, var_predefinedCursorList, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 259)) ;
    }
    {
    routine_generateEntityFactory (var_contextAnalysisStruct.mAttribute_mEntityMap, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 264)) ;
    }
  }
  const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 267)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 267)).boolEnum () ;
  if (kBoolTrue == test_8) {
    GALGAS_string var_s = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_graphviz (SOURCE_FILE ("easyBindings_program.gProgram", 268)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.operator_concat (GALGAS_string (".EXtransientDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 269)) ;
    GALGAS_bool joker_10457_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_10457_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 270)) ;
  }
  GALGAS__32_stringlist var_transientDependencyArcList = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_edges (SOURCE_FILE ("easyBindings_program.gProgram", 273)) ;
  GALGAS_stringlist var_sortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 274)) ;
  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 275)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_9) {
    const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE ("easyBindings_program.gProgram", 276)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_10) {
      cEnumerator_stringlist enumerator_10871 (var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE ("easyBindings_program.gProgram", 277)), kEnumeration_up) ;
      while (enumerator_10871.hasCurrentObject ()) {
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_10871.current_mValue (HERE)  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 278)).operator_concat (GALGAS_string ("' property is not defined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 278))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 278)) ;
        enumerator_10871.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_10) {
      GALGAS_stringlist var_unsortedTransientList ;
      GALGAS_lstringlist joker_11104_0 ; // Joker input parameter
      GALGAS_lstringlist joker_11158_0 ; // Joker input parameter
      var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.method_topologicalSort (var_sortedTransientOrderedList, joker_11104_0, var_unsortedTransientList, joker_11158_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 281)) ;
      const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 287)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_11) {
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 288)).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 288)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 288)) ;
        cEnumerator_stringlist enumerator_11386 (var_unsortedTransientList, kEnumeration_up) ;
        while (enumerator_11386.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_11386.current_mValue (HERE)  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 290))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 290)) ;
          enumerator_11386.gotoNextObject () ;
        }
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 292)) ;
      }
    }
  }
  {
  routine_generateTransientTrigersAndApplication (var_transientDependencyArcList, var_outputDirectory, var_sortedTransientOrderedList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 298)) ;
  }
  GALGAS_stringset var_extensionSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("xib") COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 304)) ;
  const enumGalgasBool test_12 = GALGAS_bool (gOption_easyBindings_5F_options_outputSwift.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("swift")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 306)) ;
  }else if (kBoolFalse == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("m")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 308)) ;
    var_extensionSet.addAssign_operation (GALGAS_string ("h")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 309)) ;
  }
  GALGAS_stringset var_generateSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("easyBindings_program.gProgram", 312)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("easy-bindings-utilities")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 313)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 314)) ;
  const enumGalgasBool test_13 = var_contextAnalysisStruct.mAttribute_mContainsDocument.boolEnum () ;
  if (kBoolTrue == test_13) {
    var_generateSet.addAssign_operation (GALGAS_string ("PMUndoManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 316)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedDocument")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 317)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 318)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 319)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+PMGZcompression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 320)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSMutableData+PMWrites")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 321)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 322)) ;
  }
  const enumGalgasBool test_14 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mEntityMap.reader_count (SOURCE_FILE ("easyBindings_program.gProgram", 324)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_14) {
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 325)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedObject")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 326)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMObjectManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 327)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMAttributeDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 328)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMRelationshipDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 329)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityArrayController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 330)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 331)) ;
  }
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  cEnumerator_stringlist enumerator_12984 (var_fw.reader_allTextFilePathes (SOURCE_FILE ("easyBindings_program.gProgram", 335)), kEnumeration_up) ;
  while (enumerator_12984.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_12984.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 336)) ;
    const enumGalgasBool test_15 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 337)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 337)).operator_and (var_extensionSet.reader_hasKey (var_sourceName.reader_pathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 337)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 337)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 337)).boolEnum () ;
    if (kBoolTrue == test_15) {
      {
      GALGAS_string::class_method_generateFile (var_outputDirectory.operator_concat (enumerator_12984.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 339))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 339)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_12984.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 341)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 338)) ;
      }
    }
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  GALGAS_cursorList var_cursorList = GALGAS_cursorList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 34)) ;
  GALGAS_location joker_1176_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 35))), GALGAS_bool (false), var_declarationList, var_cursorList, joker_1176_0  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 35)) ;
  GALGAS_location var_endOfSourceFile ;
  var_endOfSourceFile.drop () ;
  cGrammar_easyBindings_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, GALGAS_bool (true), var_declarationList, var_cursorList, var_endOfSourceFile  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 42)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSString"), GALGAS_EXTypeKind::constructor_stringType (SOURCE_FILE ("easyBindings_program.gProgram", 49)), GALGAS_typeKind::constructor_stringType (SOURCE_FILE ("easyBindings_program.gProgram", 49))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 49))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 49)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSColor"), GALGAS_EXTypeKind::constructor_colorType (SOURCE_FILE ("easyBindings_program.gProgram", 50)), GALGAS_typeKind::constructor_colorType (SOURCE_FILE ("easyBindings_program.gProgram", 50))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 50))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 50)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSData"), GALGAS_EXTypeKind::constructor_dataType (SOURCE_FILE ("easyBindings_program.gProgram", 51)), GALGAS_typeKind::constructor_dataType (SOURCE_FILE ("easyBindings_program.gProgram", 51))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 51))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 51)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSDate"), GALGAS_EXTypeKind::constructor_dateType (SOURCE_FILE ("easyBindings_program.gProgram", 52)), GALGAS_typeKind::constructor_dateType (SOURCE_FILE ("easyBindings_program.gProgram", 52))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 52))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 52)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSFont"), GALGAS_EXTypeKind::constructor_fontType (SOURCE_FILE ("easyBindings_program.gProgram", 53)), GALGAS_typeKind::constructor_fontType (SOURCE_FILE ("easyBindings_program.gProgram", 53))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 53))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 53)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSImage"), GALGAS_EXTypeKind::constructor_imageType (SOURCE_FILE ("easyBindings_program.gProgram", 54)), GALGAS_typeKind::constructor_imageType (SOURCE_FILE ("easyBindings_program.gProgram", 54))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 54))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 54)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSMenu"), GALGAS_EXTypeKind::constructor_menuType (SOURCE_FILE ("easyBindings_program.gProgram", 55)), GALGAS_typeKind::constructor_menuType (SOURCE_FILE ("easyBindings_program.gProgram", 55))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 55))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 55)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSBezierPath"), GALGAS_EXTypeKind::constructor_bezierPathType (SOURCE_FILE ("easyBindings_program.gProgram", 56)), GALGAS_typeKind::constructor_bezierPathType (SOURCE_FILE ("easyBindings_program.gProgram", 56))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 56))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 56)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("Integer"), GALGAS_EXTypeKind::constructor_integerType (SOURCE_FILE ("easyBindings_program.gProgram", 57)), GALGAS_typeKind::constructor_integerType (SOURCE_FILE ("easyBindings_program.gProgram", 57))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 57))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 57)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("UInteger"), GALGAS_EXTypeKind::constructor_uintegerType (SOURCE_FILE ("easyBindings_program.gProgram", 58)), GALGAS_typeKind::constructor_uintegerType (SOURCE_FILE ("easyBindings_program.gProgram", 58))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 58))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 58)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("Bool"), GALGAS_EXTypeKind::constructor_boolType (SOURCE_FILE ("easyBindings_program.gProgram", 59)), GALGAS_typeKind::constructor_boolType (SOURCE_FILE ("easyBindings_program.gProgram", 59))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 59))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 59)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("Double"), GALGAS_EXTypeKind::constructor_doubleType (SOURCE_FILE ("easyBindings_program.gProgram", 60)), GALGAS_typeKind::constructor_doubleType (SOURCE_FILE ("easyBindings_program.gProgram", 60))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 60))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 60)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("enum"), GALGAS_EXTypeKind::constructor_enumType (SOURCE_FILE ("easyBindings_program.gProgram", 61)), GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("easyBindings_program.gProgram", 61))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 61))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 61)) ;
  GALGAS_unifiedTypeMap var_unifiedTypeMap = GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 63)) ;
  cEnumerator_astDeclarationList enumerator_3133 (var_declarationList, kEnumeration_up) ;
  while (enumerator_3133.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_3133.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 66)) ;
  ...
  if (kBoolTrue == test_0) {
    GALGAS_string var_s = var_unifiedTypeMap.reader_edgeGraphvizRepresentation (SOURCE_FILE ("easyBindings_program.gProgram", 69)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".classDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 70)) ;
    GALGAS_bool joker_3457_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3457_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 71)) ;
  }
  GALGAS_lstringlist var_unsolvedProxyList = var_unifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE ("easyBindings_program.gProgram", 74)) ;
  cEnumerator_lstringlist enumerator_3639 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3639.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3639.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3639.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 76))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 76)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 76))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 76)) ;
    enumerator_3639.gotoNextObject () ;
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_unsolvedProxyList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 79)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_lstringlist var_sortedTypeNames ;
    GALGAS_lstringlist var_unsortedTypeNames ;
    var_unifiedTypeMap.method_topologicalSort (var_sortedTypeNames, var_unsortedTypeNames, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 80)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTypeNames.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 84)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_s = GALGAS_string ("cannot sort types ; the following types are involved in circular dependence:") ;
      cEnumerator_lstringlist enumerator_4125 (var_unsortedTypeNames, kEnumeration_up) ;
      while (enumerator_4125.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_4125.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 87))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 87))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 87)) ;
        enumerator_4125.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (inCompiler->here (), var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 89)) ;
    }else if (kBoolFalse == test_3) {
      {
      routine_semanticAnalysis (var_unifiedTypeMap, var_sortedTypeNames, constinArgument_inSourceFile.mAttribute_string, var_cursorList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 96)) ;
      }
    }
  }
  GALGAS_EXunifiedTypeMap var_EXunifiedTypeMap = GALGAS_EXunifiedTypeMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 109)) ;
  cEnumerator_astDeclarationList enumerator_4671 (var_declarationList, kEnumeration_up) ;
  while (enumerator_4671.hasCurrentObject ()) {
    callCategoryMethod_EXTypeInventory ((const cPtr_astDeclaration *) enumerator_4671.current_mDeclaration (HERE).ptr (), var_EXunifiedTypeMap, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 112)) ;
  ...
  if (kBoolTrue == test_4) {
    GALGAS_string var_s = var_EXunifiedTypeMap.reader_edgeGraphvizRepresentation (SOURCE_FILE ("easyBindings_program.gProgram", 115)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".EXclassDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 116)) ;
    GALGAS_bool joker_5003_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_5003_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 117)) ;
  }
  GALGAS_lstringlist var_EXunsolvedProxyList = var_EXunifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE ("easyBindings_program.gProgram", 120)) ;
  cEnumerator_lstringlist enumerator_5191 (var_EXunsolvedProxyList, kEnumeration_up) ;
  while (enumerator_5191.hasCurrentObject ()) {
    GALGAS_location location_5 (enumerator_5191.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_5, GALGAS_string ("type ").operator_concat (enumerator_5191.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 122))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 122)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 122))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 122)) ;
    enumerator_5191.gotoNextObject () ;
  }
  const enumGalgasBool test_6 = GALGAS_bool (kIsEqual, var_EXunsolvedProxyList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 125)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_6) {
    GALGAS_lstringlist var_sortedTypeNames ;
    GALGAS_lstringlist var_unsortedTypeNames ;
    var_EXunifiedTypeMap.method_topologicalSort (var_sortedTypeNames, var_unsortedTypeNames, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 126)) ;
    const enumGalgasBool test_7 = GALGAS_bool (kIsStrictSup, var_unsortedTypeNames.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 130)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_7) {
      GALGAS_string var_s = GALGAS_string ("cannot sort types ; the following types are involved in circular dependence:") ;
      cEnumerator_lstringlist enumerator_5681 (var_unsortedTypeNames, kEnumeration_up) ;
      while (enumerator_5681.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_5681.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 133))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 133))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 133)) ;
        enumerator_5681.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (inCompiler->here (), var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 135)) ;
    }else if (kBoolFalse == test_7) {
      {
      routine_EXsemanticAnalysis (var_EXunifiedTypeMap, var_sortedTypeNames, constinArgument_inSourceFile.mAttribute_string, var_cursorList, var_endOfSourceFile, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 142)) ;
      }
    }
  }
}
