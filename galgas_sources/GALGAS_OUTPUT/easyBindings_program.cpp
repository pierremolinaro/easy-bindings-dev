...
static const char * gWrapperFileContent_10_objective_5F_c_5F_sources = "<\?xml version=\"1.0\" encoding=\"UTF-8\"\?>\n"
  ...
  "\t\t\t\t\t\t<string key=\"NSTitle\">Allocation Stats</string>\n"
  ...
  "\t\t\t\t\t\t\t\t\t\t\t<string key=\"NSFrameSize\">{521, 287}</string>\n"
  ...
  "\t\t\t\t\t\t\t\t\t\t</object>\n"
  "\t\t\t\t\t\t\t\t\t</array>\n"
  "\t\t\t\t\t\t\t\t\t<string key=\"NSFrame\">{{0, 17}, {521, 287}}</string>\n"
  "\t\t\t\t\t\t\t\t\t<reference key=\"NSSuperview\" ref=\"694864762\"/>\n"
  "\t\t\t\t\t\t\t\t\t<reference key=\"NSWindow\"/>\n"
  ...
  "\t\t\t\t\t\t\t\t\t<reference key=\"NSNextResponder\" ref=\"694864762\"/>\n"
  "\t\t\t\t\t\t\t\t\t<int key=\"NSvFlags\">256</int>\n"
  "\t\t\t\t\t\t\t\t\t<string key=\"NSFrame\">{{521, 17}, {11, 287}}</string>\n"
  "\t\t\t\t\t\t\t\t\t<reference key=\"NSSuperview\" ref=\"694864762\"/>\n"
  "\t\t\t\t\t\t\t\t\t<reference key=\"NSWindow\"/>\n"
  ...
  "\t\t\t\t\t\t\t\t\t<reference key=\"NSNextResponder\" ref=\"694864762\"/>\n"
  "\t\t\t\t\t\t\t\t\t<int key=\"NSvFlags\">256</int>\n"
  "\t\t\t\t\t\t\t\t\t<string key=\"NSFrame\">{{0, 304}, {521, 11}}</string>\n"
  "\t\t\t\t\t\t\t\t\t<reference key=\"NSSuperview\" ref=\"694864762\"/>\n"
  "\t\t\t\t\t\t\t\t\t<reference key=\"NSWindow\"/>\n"
  ...
  "\t\t\t\t\t\t\t</array>\n"
  "\t\t\t\t\t\t\t<string key=\"NSFrameSize\">{532, 315}</string>\n"
  ...
  "\t\t\t\t\t\t\t<string key=\"NSFrame\">{{252, 328}, {260, 14}}</string>\n"
  "\t\t\t\t\t\t\t<reference key=\"NSSuperview\" ref=\"211121235\"/>\n"
  "\t\t\t\t\t\t\t<reference key=\"NSWindow\"/>\n"
  ...
  "\t\t\t\t\t\t\t<reference key=\"NSNextResponder\" ref=\"211121235\"/>\n"
  "\t\t\t\t\t\t\t<int key=\"NSvFlags\">268</int>\n"
  "\t\t\t\t\t\t\t<string key=\"NSFrame\">{{78, 323}, {164, 22}}</string>\n"
  "\t\t\t\t\t\t\t<reference key=\"NSSuperview\" ref=\"211121235\"/>\n"
  "\t\t\t\t\t\t\t<reference key=\"NSWindow\"/>\n"
  ...
  "\t\t\t\t\t\t\t\t<object class=\"NSMenuItem\" key=\"NSMenuItem\" id=\"590354082\">\n"
  ...
  "\t\t\t\t\t\t\t\t\t<array class=\"NSMutableArray\" key=\"NSMenuItems\">\n"
  "\t\t\t\t\t\t\t\t\t\t<object class=\"NSMenuItem\" id=\"555303939\">\n"
  "\t\t\t\t\t\t\t\t\t\t\t<reference key=\"NSMenu\" ref=\"1027996105\"/>\n"
  ...
  "\t\t\t\t\t\t\t<reference key=\"NSNextResponder\" ref=\"211121235\"/>\n"
  "\t\t\t\t\t\t\t<int key=\"NSvFlags\">268</int>\n"
  "\t\t\t\t\t\t\t<string key=\"NSFrame\">{{17, 328}, {56, 14}}</string>\n"
  "\t\t\t\t\t\t\t<reference key=\"NSSuperview\" ref=\"211121235\"/>\n"
  "\t\t\t\t\t\t\t<reference key=\"NSWindow\"/>\n"
  ...
  "\t\t\t\t\t\t<string key=\"label\">allocationStatsAction:</string>\n"
  "\t\t\t\t\t\t<reference key=\"source\" ref=\"1001\"/>\n"
  ...
  "\t\t\t\t\t\t\t</object>\n"
  "\t\t\t\t\t\t\t<object class=\"IBNSLayoutConstraint\" id=\"765810867\">\n"
  ...
  "\t\t\t\t\t\t\t\t<reference key=\"containingView\" ref=\"211121235\"/>\n"
  "\t\t\t\t\t\t\t</object>\n"
  "\t\t\t\t\t\t\t<object class=\"IBNSLayoutConstraint\" id=\"207541500\">\n"
  ...
  "\t\t\t\t\t\t\t\t<reference key=\"containingView\" ref=\"211121235\"/>\n"
  "\t\t\t\t\t\t\t</object>\n"
  "\t\t\t\t\t\t\t<object class=\"IBNSLayoutConstraint\" id=\"770846188\">\n"
  ...
  "\t\t\t\t\t\t\t\t<reference key=\"containingView\" ref=\"211121235\"/>\n"
  "\t\t\t\t\t\t\t</object>\n"
  "\t\t\t\t\t\t\t<object class=\"IBNSLayoutConstraint\" id=\"604947564\">\n"
  "\t\t\t\t\t\t\t\t<reference key=\"firstItem\" ref=\"694864762\"/>\n"
  "\t\t\t\t\t\t\t\t<int key=\"firstAttribute\">3</int>\n"
  "\t\t\t\t\t\t\t\t<int key=\"relation\">0</int>\n"
  ...
  "\t\t\t\t\t\t\t</object>\n"
  "\t\t\t\t\t\t\t<object class=\"IBNSLayoutConstraint\" id=\"389186279\">\n"
  "\t\t\t\t\t\t\t\t<reference key=\"firstItem\" ref=\"518079538\"/>\n"
  ...
  "\t\t\t\t\t\t\t<object class=\"IBNSLayoutConstraint\" id=\"873255375\">\n"
  "\t\t\t\t\t\t\t\t<reference key=\"firstItem\" ref=\"381938415\"/>\n"
  "\t\t\t\t\t\t\t\t<int key=\"firstAttribute\">7</int>\n"
  "\t\t\t\t\t\t\t\t<int key=\"relation\">0</int>\n"
  "\t\t\t\t\t\t\t\t<nil key=\"secondItem\"/>\n"
  ...
  "\t\t\t\t\t\t\t\t<float key=\"scoringTypeFloat\">9</float>\n"
  "\t\t\t\t\t\t\t\t<int key=\"contentType\">1</int>\n"
  "\t\t\t\t\t\t\t\t<reference key=\"containingView\" ref=\"381938415\"/>\n"
  "\t\t\t\t\t\t\t</object>\n"
  "\t\t\t\t\t\t</array>\n"
  "\t\t\t\t\t\t<reference key=\"parent\" ref=\"211121235\"/>\n"
  "\t\t\t\t\t</object>\n"
  ...
  "\t\t\t\t\t\t<reference key=\"object\" ref=\"765810867\"/>\n"
  "\t\t\t\t\t\t<reference key=\"parent\" ref=\"211121235\"/>\n"
  "\t\t\t\t\t</object>\n"
  "\t\t\t\t\t<object class=\"IBObjectRecord\">\n"
  "\t\t\t\t\t\t<int key=\"objectID\">87</int>\n"
  "\t\t\t\t\t\t<reference key=\"object\" ref=\"207541500\"/>\n"
  "\t\t\t\t\t\t<reference key=\"parent\" ref=\"211121235\"/>\n"
  "\t\t\t\t\t</object>\n"
  "\t\t\t\t\t<object class=\"IBObjectRecord\">\n"
  "\t\t\t\t\t\t<int key=\"objectID\">88</int>\n"
  "\t\t\t\t\t\t<reference key=\"object\" ref=\"770846188\"/>\n"
  "\t\t\t\t\t\t<reference key=\"parent\" ref=\"211121235\"/>\n"
  "\t\t\t\t\t</object>\n"
  "\t\t\t\t\t<object class=\"IBObjectRecord\">\n"
  ...
  "\t\t\t\t\t\t<reference key=\"object\" ref=\"873255375\"/>\n"
  "\t\t\t\t\t\t<reference key=\"parent\" ref=\"381938415\"/>\n"
  "\t\t\t\t\t</object>\n"
  "\t\t\t\t\t<object class=\"IBObjectRecord\">\n"
  ...
  "\t\t\t\t\t\t<reference key=\"object\" ref=\"604947564\"/>\n"
  "\t\t\t\t\t\t<reference key=\"parent\" ref=\"211121235\"/>\n"
  "\t\t\t\t\t</object>\n"
  "\t\t\t\t\t<object class=\"IBObjectRecord\">\n"
  ...
  "\t\t\t\t\t\t<reference key=\"object\" ref=\"389186279\"/>\n"
  "\t\t\t\t\t\t<reference key=\"parent\" ref=\"518079538\"/>\n"
  "\t\t\t\t\t</object>\n"
  "\t\t\t\t\t<object class=\"IBObjectRecord\">\n"
  ...
  "\t\t\t\t\t<reference ref=\"765810867\"/>\n"
  "\t\t\t\t\t<reference ref=\"207541500\"/>\n"
  "\t\t\t\t\t<reference ref=\"770846188\"/>\n"
  "\t\t\t\t\t<reference ref=\"158668814\"/>\n"
  "\t\t\t\t\t<reference ref=\"630903395\"/>\n"
  "\t\t\t\t\t<reference ref=\"604947564\"/>\n"
  ...
  "\t\t\t\t\t\t<string key=\"NS.key.0\">allocationStatsAction:</string>\n"
  "\t\t\t\t\t\t<string key=\"NS.object.0\">id</string>\n"
  "\t\t\t\t\t</object>\n"
  "\t\t\t\t\t<object class=\"NSMutableDictionary\" key=\"actionInfosByName\">\n"
  "\t\t\t\t\t\t<string key=\"NS.key.0\">allocationStatsAction:</string>\n"
  "\t\t\t\t\t\t<object class=\"IBActionInfo\" key=\"NS.object.0\">\n"
  "\t\t\t\t\t\t\t<string key=\"name\">allocationStatsAction:</string>\n"
  "\t\t\t\t\t\t\t<string key=\"candidateClassName\">id</string>\n"
  "\t\t\t\t\t\t</object>\n"
  "\t\t\t\t\t</object>\n"
  "\t\t\t\t\t<dictionary class=\"NSMutableDictionary\" key=\"outlets\">\n"
  "\t\t\t\t\t\t<string key=\"mAllocatedObjectCountTextField\">NSTextField</string>\n"
  ...
  "\t\t\t\t\t\t<object class=\"IBToOneOutletInfo\" key=\"mAllocatedObjectCountTextField\">\n"
  "\t\t\t\t\t\t\t<string key=\"name\">mAllocatedObjectCountTextField</string>\n"
...
static const cRegularFileWrapper * gWrapperAllFiles_objective_5F_c_5F_sources_0 [14] = {
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  var_sources.addAssign_operation (GALGAS_string ("PMDebug") COMMA_SOURCE_FILE_AT_LINE (60)) ;
  //-------- @plusEqualnstructionForGeneration
  var_sources.addAssign_operation (GALGAS_string ("PMAppDelegate") COMMA_SOURCE_FILE_AT_LINE (61)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_preferencesMap.reader_count (SOURCE_FILE_AT_LINE (62)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    var_sources.addAssign_operation (GALGAS_string ("PMAbstractPreferences") COMMA_SOURCE_FILE_AT_LINE (63)) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, var_documentMap.reader_count (SOURCE_FILE_AT_LINE (65)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @plusEqualnstructionForGeneration
    var_sources.addAssign_operation (GALGAS_string ("PMAbstractPersistentDocument") COMMA_SOURCE_FILE_AT_LINE (66)) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_entityMap.reader_count (SOURCE_FILE_AT_LINE (68)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @plusEqualnstructionForGeneration
    var_sources.addAssign_operation (GALGAS_string ("PMAbstractManagedObject") COMMA_SOURCE_FILE_AT_LINE (69)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  cEnumerator_stringlist enumerator_2698 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (72)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_2698.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_sourceName = enumerator_2698.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (73)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = var_sources.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (74)) COMMA_SOURCE_FILE_AT_LINE (74)).boolEnum () ;
    if (kBoolTrue == test_3) {
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_string::class_method_generateFile (var_sourceDir.operator_concat (enumerator_2698.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (76)) COMMA_SOURCE_FILE_AT_LINE (76)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_2698.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (78)), inCompiler COMMA_SOURCE_FILE_AT_LINE (75)) ;
      } //-------- @routineCallInstructionForGeneration
    }
