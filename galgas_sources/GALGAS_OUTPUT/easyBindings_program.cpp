...
static const cRegularFileWrapper * gWrapperAllFiles_predefinedOutletClasses_13 [1] = {
  NULL
} ;

//--- All sub-directories of 'struct-generation' directory

static const cDirectoryWrapper * gWrapperAllDirectories_predefinedOutletClasses_13 [1] = {
  NULL
} ;

//--- Directory 'struct-generation'

const cDirectoryWrapper gWrapperDirectory_13_predefinedOutletClasses (
  "struct-generation",
  0,
  gWrapperAllFiles_predefinedOutletClasses_13,
  0,
  gWrapperAllDirectories_predefinedOutletClasses_13
) ;
...
static const cDirectoryWrapper * gWrapperAllDirectories_predefinedOutletClasses_0 [14] = {
  ...
  & gWrapperDirectory_13_predefinedOutletClasses,
  NULL
} ;
...
GALGAS_string filewrapperTemplate_predefinedOutletClasses_sourceFile (C_Compiler * /* inCompiler */
  ...
  result << "outletClass PMTextField ;\n"
    ...
    "controllerTemplate PMTextField $value : Integer model ;\n"
    "\n"
    "\n"
    "outletClass PMColorWell ;\n"
    "controllerTemplate PMColorWell $color : NSColor model {sendContinously : Bool} ;\n"
    "\n"
    "\n"
    "outletClass PMDatePicker ;\n"
    "controllerTemplate PMDatePicker $date : NSDate model ;\n"
    "\n" ;
...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  {
  routine_buildTransientDependencyGraph (constinArgument_inUnifiedTypeMap, constinArgument_inSourceFile, outArgument_outSortedTransientAndObservablePropertyNodes, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 124)) ;
  }
  GALGAS_templateControllerMap var_templateControllerMap ;
  {
  routine_buildControllerTemplateMap (constinArgument_inUnifiedTypeMap, constinArgument_inAstDeclarationStruct.mAttribute_mControllerTemplateList, var_templateControllerMap, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 130)) ;
  }
  ...
  cEnumerator_outletClassDeclarationList enumerator_5836 (constinArgument_inAstDeclarationStruct.mAttribute_mOutletClassDeclarationList, kEnumeration_up) ;
  while (enumerator_5836.hasCurrentObject ()) {
    {
    var_outletClassMap.modifier_insertKey (enumerator_5836.current_mOutletClassName (HERE), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 138)) ;
    }
  ...
  if (kBoolTrue == test_0) {
    {
    routine_typeAnalysis (constinArgument_inUnifiedTypeMap, var_outletClassMap, var_templateControllerMap, outArgument_outGeneration, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 142)) ;
    }
  }else if (kBoolFalse == test_0) {
    outArgument_outGeneration = GALGAS_structForGeneration::constructor_default (SOURCE_FILE ("easyBindings_program.gProgram", 149)) ;
  }
}
...
void routine_generateCode (const GALGAS_transientDependencyGraphNodeInfoList constinArgument_inSortedTransientAndObservablePropertyNodes,
                           ...
                           COMMA_UNUSED_LOCATION_ARGS) {
  {
  routine_generateTransients (constinArgument_inSourceFile, constinArgument_inSortedTransientAndObservablePropertyNodes, constinArgument_inGeneration.mAttribute_mTransientListForGeneration, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 164)) ;
  }
  {
  routine_generateActions (constinArgument_inSourceFile, constinArgument_inGeneration.mAttribute_mActionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 169)) ;
  }
  GALGAS_string var_outputDirectory = constinArgument_inSourceFile.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 173)) ;
  {
  routine_generatePreferences (constinArgument_inGeneration.mAttribute_mPreferenceListForGeneration, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 174)) ;
  }
  {
  routine_generateOutletClasses (constinArgument_inGeneration.mAttribute_mNeededOutletClasses, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 178)) ;
  }
  {
  routine_generateControllerClasses (constinArgument_inGeneration.mAttribute_mControllerGenerationStringSet, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 182)) ;
  }
}
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_astDeclarationStruct var_declarationStruct = GALGAS_astDeclarationStruct::constructor_default (SOURCE_FILE ("easyBindings_program.gProgram", 37)) ;
  GALGAS_location joker_1309_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 38))), GALGAS_bool (false), var_declarationStruct, joker_1309_0  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 38)) ;
  GALGAS_location var_endOfSourceFile ;
  var_endOfSourceFile.drop () ;
  cGrammar_easyBindings_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, GALGAS_bool (true), var_declarationStruct, var_endOfSourceFile  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 44)) ;
  ...
  var_declarationStruct.mAttribute_mDeclarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSColor"), GALGAS_typeKind::constructor_colorType (SOURCE_FILE ("easyBindings_program.gProgram", 51))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 51))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 51)) ;
  var_declarationStruct.mAttribute_mDeclarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSData"), GALGAS_typeKind::constructor_dataType (SOURCE_FILE ("easyBindings_program.gProgram", 52))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 52))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 52)) ;
  var_declarationStruct.mAttribute_mDeclarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSDate"), GALGAS_typeKind::constructor_dateType (SOURCE_FILE ("easyBindings_program.gProgram", 53))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 53))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 53)) ;
  var_declarationStruct.mAttribute_mDeclarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSFont"), GALGAS_typeKind::constructor_fontType (SOURCE_FILE ("easyBindings_program.gProgram", 54))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 54))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 54)) ;
  var_declarationStruct.mAttribute_mDeclarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSImage"), GALGAS_typeKind::constructor_imageType (SOURCE_FILE ("easyBindings_program.gProgram", 55))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 55))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 55)) ;
  var_declarationStruct.mAttribute_mDeclarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSMenu"), GALGAS_typeKind::constructor_menuType (SOURCE_FILE ("easyBindings_program.gProgram", 56))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 56))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 56)) ;
  var_declarationStruct.mAttribute_mDeclarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSBezierPath"), GALGAS_typeKind::constructor_bezierPathType (SOURCE_FILE ("easyBindings_program.gProgram", 57))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 57))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 57)) ;
  ...
  cEnumerator_astDeclarationList enumerator_3078 (var_declarationStruct.mAttribute_mDeclarationList, kEnumeration_up) ;
  while (enumerator_3078.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_3078.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 65)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bool joker_3402_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3402_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 70)) ;
  }
  ...
  cEnumerator_lstringlist enumerator_3584 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3584.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3584.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3584.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 75))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 75)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 75))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 75)) ;
  ...
  if (kBoolTrue == test_2) {
    ...
    var_unifiedTypeMap.method_topologicalSort (var_sortedTypeNames, var_unsortedTypeNames, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 79)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTypeNames.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 83)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_s = GALGAS_string ("cannot sort types ; the following types are involved in circular dependence:") ;
      cEnumerator_lstringlist enumerator_4070 (var_unsortedTypeNames, kEnumeration_up) ;
      while (enumerator_4070.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_4070.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 86))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 86))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 86)) ;
        enumerator_4070.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (inCompiler->here (), var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 88)) ;
      ...
      {
      routine_semanticAnalysis (var_unifiedTypeMap, var_sortedTypeNames, constinArgument_inSourceFile.mAttribute_string, var_declarationStruct, var_sortedTransientAndObservablePropertyNodes, var_generation, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 90)) ;
      }
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 98)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        {
        routine_generateCode (var_sortedTransientAndObservablePropertyNodes, var_generation, constinArgument_inSourceFile.mAttribute_string, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 99)) ;
        }
      }
    }
  }
