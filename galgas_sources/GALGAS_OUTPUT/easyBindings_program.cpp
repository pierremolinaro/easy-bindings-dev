...
//                    december 21th, 2012, at 19h41'31"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_6434 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (195)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_6434.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_sourceName = enumerator_6434.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (196)) ;
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_string::class_method_generateFile (var_sourceDirectoryPath.operator_concat (enumerator_6434.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (198)) COMMA_SOURCE_FILE_AT_LINE (198)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_6434.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (200)), inCompiler COMMA_SOURCE_FILE_AT_LINE (197)) ;
    } //-------- @routineCallInstructionForGeneration
