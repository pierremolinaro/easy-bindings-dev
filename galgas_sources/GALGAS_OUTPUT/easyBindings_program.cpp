...
//                                         september 3rd, 2014, at 21h54'52"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  cEnumerator_outletClassDeclarationList enumerator_5592 (constinArgument_inAstDeclarationStruct.mAttribute_mOutletClassDeclarationList, kEnumeration_up) ;
  while (enumerator_5592.hasCurrentObject ()) {
    {
    var_outletClassMap.modifier_insertKey (enumerator_5592.current_mOutletClassName (HERE), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 129)) ;
    }
...
void routine_generateSwiftApplicationFiles (const GALGAS_string constinArgument_inOutputDirectory,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringlist temp_0 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 201)) ;
  temp_0.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 201)) ;
  temp_0.addAssign_operation (GALGAS_string ("easy-bindings-utilities")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 201)) ;
  GALGAS_stringlist var_swiftFiles = temp_0 ;
  const enumGalgasBool test_1 = constinArgument_inHasEntities.boolEnum () ;
  if (kBoolTrue == test_1) {
    var_swiftFiles.addAssign_operation (GALGAS_string ("PMObjectManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 203)) ;
    var_swiftFiles.addAssign_operation (GALGAS_string ("PMManagedObject")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 204)) ;
    var_swiftFiles.addAssign_operation (GALGAS_string ("PMManagedDocument")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 205)) ;
    var_swiftFiles.addAssign_operation (GALGAS_string ("PMUndoManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 206)) ;
    var_swiftFiles.addAssign_operation (GALGAS_string ("PMDataScanner")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 207)) ;
  }
  GALGAS_stringlist temp_2 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 209)) ;
  temp_2.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 209)) ;
  GALGAS_stringlist var_xibFiles = temp_2 ;
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_swift_5F_sources) ;
  cEnumerator_stringlist enumerator_8089 (var_swiftFiles, kEnumeration_up) ;
  while (enumerator_8089.hasCurrentObject ()) {
    GALGAS_string var_contents = var_fw.reader_textFileContentsAtPath (enumerator_8089.current_mValue (HERE).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 212)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 212)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, enumerator_8089.current_mValue (HERE).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 215)), var_contents, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 213)) ;
    }
    enumerator_8089.gotoNextObject () ;
  }
  cEnumerator_stringlist enumerator_8295 (var_xibFiles, kEnumeration_up) ;
  while (enumerator_8295.hasCurrentObject ()) {
    GALGAS_string var_contents = var_fw.reader_textFileContentsAtPath (enumerator_8295.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 220)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 220)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, enumerator_8295.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 223)), var_contents, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 221)) ;
    }
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cEnumerator_astDeclarationList enumerator_2834 (var_declarationStruct.mAttribute_mDeclarationList, kEnumeration_up) ;
  while (enumerator_2834.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_2834.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 56)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bool joker_3158_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3158_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 61)) ;
  }
  ...
  cEnumerator_lstringlist enumerator_3340 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3340.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3340.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3340.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 66))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 66)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 66))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 66)) ;
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_3) {
      ...
      cEnumerator_lstringlist enumerator_3826 (var_unsortedTypeNames, kEnumeration_up) ;
      while (enumerator_3826.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_3826.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 77))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 77))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 77)) ;
