...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  GALGAS_contextAnalysisStruct var_contextAnalysisStruct = GALGAS_contextAnalysisStruct::constructor_new (GALGAS_structTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (89)), GALGAS_enumMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (90)), GALGAS_globalEnumConstantMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (91)), GALGAS_userCursorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (92)) COMMA_SOURCE_FILE_AT_LINE (88)) ;
  GALGAS_stringlist var_predefinedCursorList ;
  {
  routine_cursorAnalysis (var_cursorList, var_contextAnalysisStruct, var_predefinedCursorList, inCompiler COMMA_SOURCE_FILE_AT_LINE (95)) ;
  }
  {
  routine_enumAnalysis (var_enumList, var_contextAnalysisStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }
  {
  routine_structAnalysis (var_structTypeList, var_contextAnalysisStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (106)) ;
  }
  GALGAS_protocolMap var_protocolMap = GALGAS_protocolMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (111)) ;
  cEnumerator_protocolList enumerator_3341 (var_protocolList, kEnumeration_up) ;
  while (enumerator_3341.hasCurrentObject ()) {
    {
    var_protocolMap.modifier_insertKey (enumerator_3341.current_mProtocolName (HERE), enumerator_3341.current_mIsPredefined (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (113)) ;
    }
    enumerator_3341.gotoNextObject () ;
  }
  GALGAS_stringlist var_sortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (116)) ;
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (117)) ;
  GALGAS_outletClassMap var_outletClassMap ;
  {
  routine_analyzeOutletClasses (var_outletClassList, var_contextAnalysisStruct, var_protocolMap, var_outletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (118)) ;
  }
  GALGAS_controllerClassMap var_controllerClassMap ;
  {
  routine_analyzeControllerClasses (var_controllerClassList, var_contextAnalysisStruct, var_transientDependencyGraph, var_controllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (125)) ;
  }
  GALGAS_classMap var_classMap ;
  {
  routine_analyzeClasses (var_classList, var_contextAnalysisStruct, var_classMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (132)) ;
  }
  GALGAS_preferencesMap var_preferencesMap ;
  {
  routine_analyzePreferences (var_preferencesList, var_controllerClassMap, var_classMap, var_outletClassMap, var_contextAnalysisStruct, var_preferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (139)) ;
  }
  GALGAS_nibClassMap var_nibClassMap ;
  {
  routine_analyzeNibClasses (var_nibClassList, var_controllerClassMap, var_classMap, var_outletClassMap, var_contextAnalysisStruct, var_nibClassMap, var_preferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (149)) ;
  }
  GALGAS_entityMap var_entityMap ;
  GALGAS_entityListForGeneration var_entityListForGeneration ;
  {
  routine_analyzeEntities (var_entityList, var_contextAnalysisStruct, var_entityMap, var_entityListForGeneration, var_preferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (160)) ;
  }
  GALGAS_documentMap var_documentMap ;
  {
  routine_analyzeDocuments (var_documentDeclarationList, var_outletClassMap, var_controllerClassMap, var_entityMap, var_preferencesMap, var_contextAnalysisStruct, var_documentMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (169)) ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (180)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (180)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_string var_s = var_transientDependencyGraph.reader_graphviz (SOURCE_FILE_AT_LINE (181)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".transientDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (182)) ;
    GALGAS_bool joker_5207_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_5207_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (183)) ;
  }
  GALGAS__32_stringlist var_transientDependencyArcList = var_transientDependencyGraph.reader_arcs (SOURCE_FILE_AT_LINE (186)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (187)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_transientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (188)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      cEnumerator_stringlist enumerator_5497 (var_transientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (189)), kEnumeration_up) ;
      while (enumerator_5497.hasCurrentObject ()) {
        inCompiler->emitSemanticError (var_endOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_5497.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (190)) COMMA_SOURCE_FILE_AT_LINE (190)) ;
        enumerator_5497.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_2) {
      GALGAS_stringlist var_unsortedTransientList ;
      GALGAS_lstringlist joker_5744_0 ; // Joker input parameter
      GALGAS_lstringlist joker_5786_0 ; // Joker input parameter
      var_transientDependencyGraph.method_topologicalSort (var_sortedTransientOrderedList, joker_5744_0, var_unsortedTransientList, joker_5786_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (194)) ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (200)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (201)).reader_string (SOURCE_FILE_AT_LINE (201)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:") COMMA_SOURCE_FILE_AT_LINE (201)) ;
        cEnumerator_stringlist enumerator_6016 (var_unsortedTransientList, kEnumeration_up) ;
        while (enumerator_6016.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_6016.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (203)) COMMA_SOURCE_FILE_AT_LINE (203)) ;
          enumerator_6016.gotoNextObject () ;
        }
        inCompiler->emitSemanticError (var_endOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (205)) ;
      }
    }
  }
  GALGAS_string var_sourceDirectoryPath = constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (211)) ;
  {
  routine_generateEnumerations (var_contextAnalysisStruct.mAttribute_mEnumMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (212)) ;
  }
  {
  routine_generateStructures (var_contextAnalysisStruct.mAttribute_mStructTypeMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (213)) ;
  }
  {
  routine_generateOutletClassCode (var_outletClassMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (214)) ;
  }
  {
  routine_generateClassCode (var_transientDependencyArcList, var_classMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (215)) ;
  }
  {
  routine_generateEntityCode (var_transientDependencyArcList, var_entityListForGeneration, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (216)) ;
  }
  {
  routine_generatePreferencesCode (var_transientDependencyArcList, var_preferencesMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (217)) ;
  }
  {
  routine_generateNibClassCode (var_transientDependencyArcList, var_nibClassMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (218)) ;
  }
  {
  routine_generateDocumentCode (var_transientDependencyArcList, var_documentMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (219)) ;
  }
  {
  routine_generateCursorCode (var_contextAnalysisStruct.mAttribute_mUserCursorMap, var_predefinedCursorList, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (220)) ;
  }
  {
  routine_generateControllerCode (var_controllerClassMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (221)) ;
  }
  {
  routine_generateTransientDependencyFiles (var_transientDependencyArcList, var_sourceDirectoryPath, var_sortedTransientOrderedList, inCompiler COMMA_SOURCE_FILE_AT_LINE (223)) ;
  }
  GALGAS_stringset var_generateSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (229)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("easy-bindings-utilities") COMMA_SOURCE_FILE_AT_LINE (230)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("PMAllocationDebug") COMMA_SOURCE_FILE_AT_LINE (231)) ;
  const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, var_documentMap.reader_count (SOURCE_FILE_AT_LINE (232)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_4) {
    var_generateSet.addAssign_operation (GALGAS_string ("PMUndoManager") COMMA_SOURCE_FILE_AT_LINE (233)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedDocument") COMMA_SOURCE_FILE_AT_LINE (234)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression") COMMA_SOURCE_FILE_AT_LINE (235)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression") COMMA_SOURCE_FILE_AT_LINE (236)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+PMGZcompression") COMMA_SOURCE_FILE_AT_LINE (237)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSMutableData+PMWrites") COMMA_SOURCE_FILE_AT_LINE (238)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner") COMMA_SOURCE_FILE_AT_LINE (239)) ;
  }
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, var_entityListForGeneration.reader_length (SOURCE_FILE_AT_LINE (241)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions") COMMA_SOURCE_FILE_AT_LINE (242)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedEntity") COMMA_SOURCE_FILE_AT_LINE (243)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityManager") COMMA_SOURCE_FILE_AT_LINE (244)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMAttributeDescription") COMMA_SOURCE_FILE_AT_LINE (245)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMRelationshipDescription") COMMA_SOURCE_FILE_AT_LINE (246)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityArrayController") COMMA_SOURCE_FILE_AT_LINE (247)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityController") COMMA_SOURCE_FILE_AT_LINE (248)) ;
  }
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  cEnumerator_stringlist enumerator_8362 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (252)), kEnumeration_up) ;
  while (enumerator_8362.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_8362.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (253)) ;
    const enumGalgasBool test_6 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (254)) COMMA_SOURCE_FILE_AT_LINE (254)).boolEnum () ;
    if (kBoolTrue == test_6) {
      {
      GALGAS_string::class_method_generateFile (var_sourceDirectoryPath.operator_concat (enumerator_8362.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (256)) COMMA_SOURCE_FILE_AT_LINE (256)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_8362.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (258)), inCompiler COMMA_SOURCE_FILE_AT_LINE (255)) ;
      }
    }
