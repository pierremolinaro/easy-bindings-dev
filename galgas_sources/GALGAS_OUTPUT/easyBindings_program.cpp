...
GALGAS_string filewrapperTemplate_predefinedOutletClasses_sourceFile (C_Compiler * /* inCompiler */
  ...
  result << "predefined objectController NSObjectController {\n"
    ...
    "}\n"
    "\n"
    "predefined arrayController PMEntityArrayController {\n"
    "  NSAlwaysPresentsApplicationModalAlertsBindingOption : bool ;\n"
    "  NSConditionallySetsEditableBindingOption : bool ;\n"
    "  NSDeletesObjectsOnRemoveBindingsOption : bool ;\n"
    "  NSHandlesContentAsCompoundValueBindingOption : bool ;\n"
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_7255 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (216)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_7255.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_sourceName = enumerator_7255.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (217)) ;
    //-------- @ifInstructionForGeneration
    ...
    if (kBoolTrue == test_6) {
      ...
      GALGAS_string::class_method_generateFile (var_sourceDirectoryPath.operator_concat (enumerator_7255.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (220)) COMMA_SOURCE_FILE_AT_LINE (220)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_7255.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (222)), inCompiler COMMA_SOURCE_FILE_AT_LINE (219)) ;
      } //-------- @routineCallInstructionForGeneration
    }
