...
void routine_enterPredefinedType (GALGAS_astDeclarationList & ioArgument_ioDeclarationList,
                                  const GALGAS_string constinArgument_inTypeName,
                                  C_Compiler * /* inCompiler */
                                  COMMA_UNUSED_LOCATION_ARGS) {
  ioArgument_ioDeclarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (constinArgument_inTypeName.reader_nowhere (SOURCE_FILE_AT_LINE (41)) COMMA_SOURCE_FILE_AT_LINE (41)) COMMA_SOURCE_FILE_AT_LINE (41)) ;
}
...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
                               ...
                               C_Compiler * inCompiler
                               COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_lstringlist enumerator_4550 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_4550.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_4550.current_mValue (HERE), var_declaration, inCompiler COMMA_SOURCE_FILE_AT_LINE (124)) ;
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_astDeclarationList var_declarationList = GALGAS_astDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (50)) ;
  GALGAS_cursorList var_cursorList = GALGAS_cursorList::constructor_emptyList (SOURCE_FILE_AT_LINE (52)) ;
  {
  GALGAS_location joker_1774_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE_AT_LINE (53))), var_declarationList, var_cursorList, joker_1774_0 COMMA_SOURCE_FILE_AT_LINE (53)) ;
  }
  GALGAS_location var_endOfSourceFile ;
  {
  cGrammar_easyBindings_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, var_declarationList, var_cursorList, var_endOfSourceFile COMMA_SOURCE_FILE_AT_LINE (59)) ;
  }
  {
  routine_enterPredefinedType (var_declarationList, GALGAS_string ("NSString"), inCompiler COMMA_SOURCE_FILE_AT_LINE (65)) ;
  }
  {
  routine_enterPredefinedType (var_declarationList, GALGAS_string ("NSColor"), inCompiler COMMA_SOURCE_FILE_AT_LINE (66)) ;
  }
  {
  routine_enterPredefinedType (var_declarationList, GALGAS_string ("NSData"), inCompiler COMMA_SOURCE_FILE_AT_LINE (67)) ;
  }
  {
  routine_enterPredefinedType (var_declarationList, GALGAS_string ("NSDate"), inCompiler COMMA_SOURCE_FILE_AT_LINE (68)) ;
  }
  {
  routine_enterPredefinedType (var_declarationList, GALGAS_string ("NSFont"), inCompiler COMMA_SOURCE_FILE_AT_LINE (69)) ;
  }
  {
  routine_enterPredefinedType (var_declarationList, GALGAS_string ("NSImage"), inCompiler COMMA_SOURCE_FILE_AT_LINE (70)) ;
  }
  {
  routine_enterPredefinedType (var_declarationList, GALGAS_string ("NSMenu"), inCompiler COMMA_SOURCE_FILE_AT_LINE (71)) ;
  }
  {
  routine_enterPredefinedType (var_declarationList, GALGAS_string ("NSBezierPath"), inCompiler COMMA_SOURCE_FILE_AT_LINE (72)) ;
  }
  {
  routine_enterPredefinedType (var_declarationList, GALGAS_string ("Integer"), inCompiler COMMA_SOURCE_FILE_AT_LINE (73)) ;
  }
  {
  routine_enterPredefinedType (var_declarationList, GALGAS_string ("UInteger"), inCompiler COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  {
  routine_enterPredefinedType (var_declarationList, GALGAS_string ("Bool"), inCompiler COMMA_SOURCE_FILE_AT_LINE (75)) ;
  }
  {
  routine_enterPredefinedType (var_declarationList, GALGAS_string ("Double"), inCompiler COMMA_SOURCE_FILE_AT_LINE (76)) ;
  }
  {
  routine_enterPredefinedType (var_declarationList, GALGAS_string ("AnyScalar"), inCompiler COMMA_SOURCE_FILE_AT_LINE (77)) ;
  }
  {
  routine_enterPredefinedType (var_declarationList, GALGAS_string ("AnyNumber"), inCompiler COMMA_SOURCE_FILE_AT_LINE (78)) ;
  }
  GALGAS_unifiedTypeMap var_unifiedTypeMap = GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (81)) ;
  cEnumerator_astDeclarationList enumerator_2864 (var_declarationList, kEnumeration_up) ;
  while (enumerator_2864.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_2864.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (84)) ;
  ...
  if (kBoolTrue == test_0) {
    GALGAS_string var_s = var_unifiedTypeMap.reader_edgeGraphvizRepresentation (SOURCE_FILE_AT_LINE (87)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".classDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (88)) ;
    GALGAS_bool joker_3202_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3202_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (89)) ;
  }
  GALGAS_lstringlist var_unsolvedProxyList = var_unifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE_AT_LINE (92)) ;
  cEnumerator_lstringlist enumerator_3399 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3399.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3399.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3399.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (94)).operator_concat (GALGAS_string (" is undefined") COMMA_SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (94)) ;
    enumerator_3399.gotoNextObject () ;
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_unsolvedProxyList.reader_length (SOURCE_FILE_AT_LINE (97)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_lstringlist var_sortedKeys ;
    GALGAS_lstringlist var_unsortedKeys ;
    var_unifiedTypeMap.method_topologicalSort (var_sortedKeys, var_unsortedKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (98)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedKeys.reader_length (SOURCE_FILE_AT_LINE (99)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_s = GALGAS_string ("cannot sort types ; the following types are involved in circular dependence:") ;
      cEnumerator_lstringlist enumerator_3846 (var_unsortedKeys, kEnumeration_up) ;
      while (enumerator_3846.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_3846.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (102)) COMMA_SOURCE_FILE_AT_LINE (102)) COMMA_SOURCE_FILE_AT_LINE (102)) ;
        enumerator_3846.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (inCompiler->here (), var_s COMMA_SOURCE_FILE_AT_LINE (104)) ;
    }else if (kBoolFalse == test_3) {
      {
      routine_semanticAnalysis (var_unifiedTypeMap, var_sortedKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (106)) ;
      }
    }
  }
}
