...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  GALGAS_string var_sourceDirectoryPath = constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (89)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_generateOutletClassCode (var_outletClassMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (90)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generateClassCode (var_transientDependencyArcList, var_classMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (91)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generateEntityCode (var_transientDependencyArcList, var_entityMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (92)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generatePreferencesCode (var_transientDependencyArcList, var_preferencesMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (93)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generateDocumentCode (var_transientDependencyArcList, var_documentMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (94)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generateCursorCode (var_userCursorMap, var_predefinedCursorList, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (95)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  ...
  cEnumerator_stringlist enumerator_3597 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (106)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_3597.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_sourceName = enumerator_3597.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (107)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string::class_method_generateFile (var_sourceDirectoryPath.operator_concat (enumerator_3597.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (110)) COMMA_SOURCE_FILE_AT_LINE (110)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_3597.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (112)), inCompiler COMMA_SOURCE_FILE_AT_LINE (109)) ;
      } //-------- @routineCallInstructionForGeneration
    }
