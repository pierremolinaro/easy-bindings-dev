...
const char * gWrapperFileContent_4_objective_5F_c_5F_sources = "//\n"
...
const char * gWrapperFileContent_5_objective_5F_c_5F_sources = "//\n"
...
const char * gWrapperFileContent_7_objective_5F_c_5F_sources = "#ifdef PM_COCOA_DEBUG\n"
  "\n"
  "//----------------------------------------------------------------------------*\n"
  "\n"
...
const char * gWrapperFileContent_8_objective_5F_c_5F_sources = "import Cocoa\n"
  "\n"
  "//-----------------------------------------------------------------------------*\n"
  "\n"
...
const char * gWrapperFileContent_9_objective_5F_c_5F_sources = "<\?xml version=\"1.0\" encoding=\"UTF-8\"\?>\n"
...
const char * gWrapperFileContent_13_objective_5F_c_5F_sources = "//\n"
  "//  PMDataScanner.m\n"
  "//  canari\n"
  "//\n"
  "//  Created by Pierre Molinaro on 09/11/07.\n"
...
const char * gWrapperFileContent_14_objective_5F_c_5F_sources = "//\n"
  "//  PMDataScanner.m\n"
  "//  canari\n"
  "//\n"
  "//  Created by Pierre Molinaro on 09/11/07.\n"
...
const cRegularFileWrapper gWrapperFile_14_objective_5F_c_5F_sources (
  "PMDataScanner.swift",
  "swift",
  true, // Text file
  10196, // Text length
...
const char * gWrapperFileContent_15_objective_5F_c_5F_sources = "//-----------------------------------------------------------------------------*\n"
  "//                                                                             *\n"
  "//                          File 'PMDocument.swift'                            *\n"
...
const cRegularFileWrapper gWrapperFile_15_objective_5F_c_5F_sources (
  "PMDocument.swift",
  "swift",
  true, // Text file
  10160, // Text length
...
const char * gWrapperFileContent_16_objective_5F_c_5F_sources = "//\n"
...
const cRegularFileWrapper gWrapperFile_16_objective_5F_c_5F_sources (
  "PMEntityArrayController.h",
  "h",
  true, // Text file
  822, // Text length
...
const char * gWrapperFileContent_17_objective_5F_c_5F_sources = "//\n"
...
const cRegularFileWrapper gWrapperFile_17_objective_5F_c_5F_sources (
  "PMEntityArrayController.m",
  "m",
  true, // Text file
  6369, // Text length
...
const char * gWrapperFileContent_18_objective_5F_c_5F_sources = "//\n"
...
const cRegularFileWrapper gWrapperFile_18_objective_5F_c_5F_sources (
  "PMEntityArrayController.swift",
  "swift",
  true, // Text file
  14324, // Text length
...
const char * gWrapperFileContent_19_objective_5F_c_5F_sources = "//\n"
...
const cRegularFileWrapper gWrapperFile_19_objective_5F_c_5F_sources (
  "PMEntityController.h",
  "h",
  true, // Text file
  678, // Text length
...
const char * gWrapperFileContent_20_objective_5F_c_5F_sources = "//\n"
...
const cRegularFileWrapper gWrapperFile_20_objective_5F_c_5F_sources (
  "PMEntityController.m",
  "m",
  true, // Text file
  1941, // Text length
...
const char * gWrapperFileContent_21_objective_5F_c_5F_sources = "//\n"
...
const cRegularFileWrapper gWrapperFile_21_objective_5F_c_5F_sources (
  "PMEntityController.swift",
  "swift",
  true, // Text file
  3449, // Text length
...
const char * gWrapperFileContent_22_objective_5F_c_5F_sources = "//\n"
  "//  PMManagedDocument.h\n"
  "//  essai\n"
  "//\n"
...
const cRegularFileWrapper gWrapperFile_22_objective_5F_c_5F_sources (
  "PMManagedDocument.h",
  "h",
  true, // Text file
  2273, // Text length
...
const char * gWrapperFileContent_23_objective_5F_c_5F_sources = "//\n"
  "//  PMManagedDocument.m\n"
  "//  essai\n"
  "//\n"
  "//  Created by Pierre Molinaro on 28/06/13.\n"
...
const cRegularFileWrapper gWrapperFile_23_objective_5F_c_5F_sources (
  "PMManagedDocument.m",
  "m",
  true, // Text file
  32531, // Text length
...
const char * gWrapperFileContent_24_objective_5F_c_5F_sources = "//\n"
  "//  PMManagedDocument.m\n"
  "//  essai\n"
  "//\n"
  "//  Created by Pierre Molinaro on 28/06/13.\n"
...
const cRegularFileWrapper gWrapperFile_24_objective_5F_c_5F_sources (
...
const char * gWrapperFileContent_25_objective_5F_c_5F_sources = "//\n"
  "//  PMManagedObject.h\n"
  "//  essai\n"
  "//\n"
  "//  Created by Pierre Molinaro on 28/06/13.\n"
...
const cRegularFileWrapper gWrapperFile_25_objective_5F_c_5F_sources (
  "PMManagedObject.h",
  "h",
  true, // Text file
  4324, // Text length
...
const char * gWrapperFileContent_26_objective_5F_c_5F_sources = "//\n"
  "//  PMManagedObject.m\n"
  "//  essai\n"
  "//\n"
  "//  Created by Pierre Molinaro on 28/06/13.\n"
...
const cRegularFileWrapper gWrapperFile_26_objective_5F_c_5F_sources (
  "PMManagedObject.m",
  "m",
  true, // Text file
  23081, // Text length
...
const char * gWrapperFileContent_27_objective_5F_c_5F_sources = "//\n"
...
const cRegularFileWrapper gWrapperFile_27_objective_5F_c_5F_sources (
  "PMManagedObject.swift",
  "swift",
  true, // Text file
  27671, // Text length
...
const char * gWrapperFileContent_28_objective_5F_c_5F_sources = "//\n"
  "//  PMObjectManager.h\n"
  "//  essai\n"
  "//\n"
  "//  Created by Pierre Molinaro on 28/06/13.\n"
...
const cRegularFileWrapper gWrapperFile_28_objective_5F_c_5F_sources (
  "PMObjectManager.h",
  "h",
  true, // Text file
  1374, // Text length
...
const char * gWrapperFileContent_29_objective_5F_c_5F_sources = "//\n"
  "//  PMObjectManager.m\n"
  "//  essai\n"
  "//\n"
  "//  Created by Pierre Molinaro on 28/06/13.\n"
...
const cRegularFileWrapper gWrapperFile_29_objective_5F_c_5F_sources (
  "PMObjectManager.m",
  "m",
  true, // Text file
  8836, // Text length
...
const char * gWrapperFileContent_30_objective_5F_c_5F_sources = "//\n"
...
const cRegularFileWrapper gWrapperFile_30_objective_5F_c_5F_sources (
  "PMObjectManager.swift",
  "swift",
  true, // Text file
  8333, // Text length
...
const char * gWrapperFileContent_31_objective_5F_c_5F_sources = "//\n"
...
const cRegularFileWrapper gWrapperFile_31_objective_5F_c_5F_sources (
  "PMRelationshipDescription.h",
  "h",
  true, // Text file
  1187, // Text length
...
const char * gWrapperFileContent_32_objective_5F_c_5F_sources = "//\n"
...
const cRegularFileWrapper gWrapperFile_32_objective_5F_c_5F_sources (
  "PMRelationshipDescription.m",
  "m",
  true, // Text file
  2811, // Text length
...
const char * gWrapperFileContent_33_objective_5F_c_5F_sources = "//\n"
  "//  PMUndoManager.h\n"
  "//  essai\n"
  "//\n"
  "//  Created by Pierre Molinaro on 30/06/13.\n"
...
const cRegularFileWrapper gWrapperFile_33_objective_5F_c_5F_sources (
  "PMUndoManager.h",
  "h",
  true, // Text file
  463, // Text length
...
const char * gWrapperFileContent_34_objective_5F_c_5F_sources = "//\n"
  "//  PMUndoManager.m\n"
  "//  essai\n"
  "//\n"
  "//  Created by Pierre Molinaro on 30/06/13.\n"
...
const cRegularFileWrapper gWrapperFile_34_objective_5F_c_5F_sources (
  "PMUndoManager.m",
  "m",
  true, // Text file
  1024, // Text length
...
const char * gWrapperFileContent_35_objective_5F_c_5F_sources = "//\n"
  "//  PMUndoManager.swift\n"
  "//  essai\n"
  "//\n"
...
const cRegularFileWrapper gWrapperFile_35_objective_5F_c_5F_sources (
  "PMUndoManager.swift",
  "swift",
  true, // Text file
  3411, // Text length
...
const char * gWrapperFileContent_36_objective_5F_c_5F_sources = "\n"
  "#import <Cocoa/Cocoa.h>\n"
  "\n"
  "//-----------------------------------------------------------------------------*\n"
  "\n"
...
const cRegularFileWrapper gWrapperFile_36_objective_5F_c_5F_sources (
...
const char * gWrapperFileContent_37_objective_5F_c_5F_sources = "//---------------------------------------------------------------------------*\n"
  "\n"
  "#import \"easy-bindings-utilities.h\"\n"
  "#import <objc/runtime.h>\n"
  "\n"
...
const cRegularFileWrapper gWrapperFile_37_objective_5F_c_5F_sources (
...
const char * gWrapperFileContent_38_objective_5F_c_5F_sources = "import Cocoa\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "//   presentErrorWindow                                                      *\n"
  "//---------------------------------------------------------------------------*\n"
...
const cRegularFileWrapper gWrapperFile_38_objective_5F_c_5F_sources (
...
const char * gWrapperFileContent_39_objective_5F_c_5F_sources = "//\n"
...
const cRegularFileWrapper gWrapperFile_39_objective_5F_c_5F_sources (
...
const char * gWrapperFileContent_40_objective_5F_c_5F_sources = "//\n"
...
const cRegularFileWrapper gWrapperFile_40_objective_5F_c_5F_sources (
...
void routine_EXsemanticAnalysis (const GALGAS_EXunifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  GALGAS_stringset var_extensionSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("xib") COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 364)) ;
  const enumGalgasBool test_12 = GALGAS_bool (gOption_easyBindings_5F_options_outputSwift.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("swift")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 366)) ;
  }else if (kBoolFalse == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("m")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 368)) ;
    var_extensionSet.addAssign_operation (GALGAS_string ("h")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 369)) ;
  }
  GALGAS_stringset var_generateSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("easyBindings_program.gProgram", 372)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("easy-bindings-utilities")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 373)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 374)) ;
  const enumGalgasBool test_13 = var_contextAnalysisStruct.mAttribute_mContainsDocument.boolEnum () ;
  if (kBoolTrue == test_13) {
    var_generateSet.addAssign_operation (GALGAS_string ("PMUndoManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 376)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedDocument")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 377)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 378)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 379)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+PMGZcompression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 380)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSMutableData+PMWrites")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 381)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 382)) ;
  }
  const enumGalgasBool test_14 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mEntityMap.reader_count (SOURCE_FILE ("easyBindings_program.gProgram", 384)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_14) {
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 385)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedObject")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 386)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMObjectManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 387)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMAttributeDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 388)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMRelationshipDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 389)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityArrayController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 390)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 391)) ;
  }
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  cEnumerator_stringlist enumerator_16101 (var_fw.reader_allTextFilePathes (SOURCE_FILE ("easyBindings_program.gProgram", 395)), kEnumeration_up) ;
  while (enumerator_16101.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_16101.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 396)) ;
    const enumGalgasBool test_15 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 397)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 397)).operator_and (var_extensionSet.reader_hasKey (var_sourceName.reader_pathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 397)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 397)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 397)).boolEnum () ;
    if (kBoolTrue == test_15) {
      {
      GALGAS_string::class_method_generateFile (var_outputDirectory.operator_concat (enumerator_16101.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 399))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 399)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_16101.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 401)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 398)) ;
      }
    }
