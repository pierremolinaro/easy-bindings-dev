...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  {
  routine_generateTransientTrigersAndApplication (var_transientDependencyArcList, var_outputDirectory, var_sortedTransientOrderedList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 229)) ;
  }
  GALGAS_stringset var_extensionSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("xib") COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 235)) ;
  const enumGalgasBool test_12 = GALGAS_bool (gOption_easyBindings_5F_options_outputSwift.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("swift")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 237)) ;
  }else if (kBoolFalse == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("m")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 239)) ;
    var_extensionSet.addAssign_operation (GALGAS_string ("h")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 240)) ;
  }
  GALGAS_stringset var_generateSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("easyBindings_program.gProgram", 243)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("easy-bindings-utilities")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 244)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 245)) ;
  const enumGalgasBool test_13 = var_contextAnalysisStruct.mAttribute_mContainsDocument.boolEnum () ;
  if (kBoolTrue == test_13) {
    var_generateSet.addAssign_operation (GALGAS_string ("PMUndoManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 247)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedDocument")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 248)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 249)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 250)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+PMGZcompression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 251)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSMutableData+PMWrites")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 252)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 253)) ;
  }
  const enumGalgasBool test_14 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mEntityMap.reader_count (SOURCE_FILE ("easyBindings_program.gProgram", 255)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_14) {
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 256)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedObject")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 257)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMObjectManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 258)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMAttributeDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 259)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMRelationshipDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 260)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityArrayController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 261)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 262)) ;
  }
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  cEnumerator_stringlist enumerator_10249 (var_fw.reader_allTextFilePathes (SOURCE_FILE ("easyBindings_program.gProgram", 266)), kEnumeration_up) ;
  while (enumerator_10249.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_10249.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 267)) ;
    const enumGalgasBool test_15 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 268)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 268)).operator_and (var_extensionSet.reader_hasKey (var_sourceName.reader_pathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 268)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 268)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 268)).boolEnum () ;
    if (kBoolTrue == test_15) {
      {
      GALGAS_string::class_method_generateFile (var_outputDirectory.operator_concat (enumerator_10249.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 270))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 270)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_10249.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 272)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 269)) ;
      }
    }
