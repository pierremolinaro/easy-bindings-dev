...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_4) {
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMUndoManager") COMMA_SOURCE_FILE_AT_LINE (198)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedDocument") COMMA_SOURCE_FILE_AT_LINE (199)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression") COMMA_SOURCE_FILE_AT_LINE (200)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression") COMMA_SOURCE_FILE_AT_LINE (201)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+PMGZcompression") COMMA_SOURCE_FILE_AT_LINE (202)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("NSMutableData+PMWrites") COMMA_SOURCE_FILE_AT_LINE (203)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner") COMMA_SOURCE_FILE_AT_LINE (204)) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, var_entityListForGeneration.reader_length (SOURCE_FILE_AT_LINE (206)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions") COMMA_SOURCE_FILE_AT_LINE (207)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedEntity") COMMA_SOURCE_FILE_AT_LINE (208)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityManager") COMMA_SOURCE_FILE_AT_LINE (209)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMAttributeDescription") COMMA_SOURCE_FILE_AT_LINE (210)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMRelationshipDescription") COMMA_SOURCE_FILE_AT_LINE (211)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityArrayController") COMMA_SOURCE_FILE_AT_LINE (212)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityController") COMMA_SOURCE_FILE_AT_LINE (213)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_7298 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (217)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_7298.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_sourceName = enumerator_7298.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (218)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (219)).boolEnum () ;
    if (kBoolTrue == test_6) {
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_string::class_method_generateFile (var_sourceDirectoryPath.operator_concat (enumerator_7298.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (221)) COMMA_SOURCE_FILE_AT_LINE (221)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_7298.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (223)), inCompiler COMMA_SOURCE_FILE_AT_LINE (220)) ;
      } //-------- @routineCallInstructionForGeneration
    }
