...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  routine_semanticAnalysis (var_ast, var_outletClassMap, var_controllerClassMap, var_classMap, var_entityMap, var_preferencesMap, var_documentMap, var_sortedTransientOrderedList, inCompiler COMMA_SOURCE_FILE_AT_LINE (52)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_sourceDir = constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (63)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_generateClassCode (var_classMap, var_sourceDir, inCompiler COMMA_SOURCE_FILE_AT_LINE (64)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generateEntityCode (var_entityMap, var_sourceDir, inCompiler COMMA_SOURCE_FILE_AT_LINE (65)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generatePreferencesCode (var_preferencesMap, var_sourceDir, inCompiler COMMA_SOURCE_FILE_AT_LINE (66)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generateDocumentCode (var_documentMap, var_sourceDir, inCompiler COMMA_SOURCE_FILE_AT_LINE (67)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_dependencyDefinitionString = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_2419 (var_sortedTransientOrderedList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_2419.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_dependencyDefinitionString.dotAssign_operation (GALGAS_string ("// ").operator_concat (enumerator_2419.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (71)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (71)) COMMA_SOURCE_FILE_AT_LINE (71)) ;
    enumerator_2419.gotoNextObject () ;
  }
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_string::class_method_generateFile (var_sourceDir, GALGAS_string ("dependancy-order.h"), var_dependencyDefinitionString, inCompiler COMMA_SOURCE_FILE_AT_LINE (73)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_sources = GALGAS_stringset::constructor_setWithString (GALGAS_string ("easy-bindings-utilities") COMMA_SOURCE_FILE_AT_LINE (79)) ;
  //-------- @plusEqualnstructionForGeneration
  var_sources.addAssign_operation (GALGAS_string ("PMDebug") COMMA_SOURCE_FILE_AT_LINE (80)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, var_preferencesMap.reader_count (SOURCE_FILE_AT_LINE (81)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    var_sources.addAssign_operation (GALGAS_string ("PMAbstractPreferences") COMMA_SOURCE_FILE_AT_LINE (82)) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, var_documentMap.reader_count (SOURCE_FILE_AT_LINE (84)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @plusEqualnstructionForGeneration
    var_sources.addAssign_operation (GALGAS_string ("PMAbstractPersistentDocument") COMMA_SOURCE_FILE_AT_LINE (85)) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_entityMap.reader_count (SOURCE_FILE_AT_LINE (87)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @plusEqualnstructionForGeneration
    var_sources.addAssign_operation (GALGAS_string ("PMAbstractManagedObject") COMMA_SOURCE_FILE_AT_LINE (88)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_3079 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (91)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_3079.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_sourceName = enumerator_3079.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (92)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = var_sources.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (93)) COMMA_SOURCE_FILE_AT_LINE (93)).boolEnum () ;
    if (kBoolTrue == test_3) {
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_string::class_method_generateFile (var_sourceDir.operator_concat (enumerator_3079.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (95)) COMMA_SOURCE_FILE_AT_LINE (95)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_3079.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (97)), inCompiler COMMA_SOURCE_FILE_AT_LINE (94)) ;
      } //-------- @routineCallInstructionForGeneration
    }
    enumerator_3079.gotoNextObject () ;
  }
}
