...
static const cRegularFileWrapper * gWrapperAllFiles_predefinedOutletClasses_10 [1] = {
  NULL
} ;

//--- All sub-directories of 'outlet-classes' directory

static const cDirectoryWrapper * gWrapperAllDirectories_predefinedOutletClasses_10 [1] = {
  NULL
} ;

//--- Directory 'outlet-classes'

const cDirectoryWrapper gWrapperDirectory_10_predefinedOutletClasses (
  "outlet-classes",
  0,
  gWrapperAllFiles_predefinedOutletClasses_10,
  0,
  gWrapperAllDirectories_predefinedOutletClasses_10
) ;

//--- All files of 'predefined-outlet-classes' directory

static const cRegularFileWrapper * gWrapperAllFiles_predefinedOutletClasses_11 [1] = {
  NULL
} ;

//--- All sub-directories of 'predefined-outlet-classes' directory

static const cDirectoryWrapper * gWrapperAllDirectories_predefinedOutletClasses_11 [1] = {
  NULL
} ;

//--- Directory 'predefined-outlet-classes'

const cDirectoryWrapper gWrapperDirectory_11_predefinedOutletClasses (
  "predefined-outlet-classes",
  0,
  gWrapperAllFiles_predefinedOutletClasses_11,
  0,
  gWrapperAllDirectories_predefinedOutletClasses_11
) ;

//--- All files of 'struct-generation' directory

static const cRegularFileWrapper * gWrapperAllFiles_predefinedOutletClasses_12 [1] = {
  NULL
} ;

//--- All sub-directories of 'struct-generation' directory

static const cDirectoryWrapper * gWrapperAllDirectories_predefinedOutletClasses_12 [1] = {
  NULL
} ;

//--- Directory 'struct-generation'

const cDirectoryWrapper gWrapperDirectory_12_predefinedOutletClasses (
  "struct-generation",
  0,
  gWrapperAllFiles_predefinedOutletClasses_12,
  0,
  gWrapperAllDirectories_predefinedOutletClasses_12
) ;
...
static const cDirectoryWrapper * gWrapperAllDirectories_predefinedOutletClasses_0 [13] = {
  ...
  & gWrapperDirectory_10_predefinedOutletClasses,
  & gWrapperDirectory_11_predefinedOutletClasses,
  & gWrapperDirectory_12_predefinedOutletClasses,
  NULL
} ;
...
GALGAS_string filewrapperTemplate_predefinedOutletClasses_sourceFile (C_Compiler * /* inCompiler */
  ...
  C_String result ;
  result << "outletClass PMTextField ;\n"
    "\n"
...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
                               ...
                               const GALGAS_outletClassDeclarationList constinArgument_inOutletClassDeclarationList,
  ...
  {
  routine_buildTransientDependencyGraph (constinArgument_inUnifiedTypeMap, constinArgument_inSourceFile, outArgument_outSortedTransientAndObservablePropertyNodes, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 130)) ;
  }
  GALGAS_outletClassMap var_outletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 136)) ;
  cEnumerator_outletClassDeclarationList enumerator_5540 (constinArgument_inOutletClassDeclarationList, kEnumeration_up) ;
  while (enumerator_5540.hasCurrentObject ()) {
    {
    var_outletClassMap.modifier_insertKey (enumerator_5540.current_mOutletClassName (HERE), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 138)) ;
    }
    enumerator_5540.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 141)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
    routine_typeAnalysis (constinArgument_inUnifiedTypeMap, var_outletClassMap, outArgument_outGeneration, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 142)) ;
    }
  }else if (kBoolFalse == test_0) {
    outArgument_outGeneration = GALGAS_structForGeneration::constructor_default (SOURCE_FILE ("easyBindings_program.gProgram", 148)) ;
  }
}
...
void routine_generateCode (const GALGAS_transientDependencyGraphNodeInfoList constinArgument_inSortedTransientAndObservablePropertyNodes,
                           ...
                           COMMA_UNUSED_LOCATION_ARGS) {
  {
  routine_generateTransients (constinArgument_inSourceFile, constinArgument_inSortedTransientAndObservablePropertyNodes, constinArgument_inGeneration.mAttribute_mTransientListForGeneration, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 163)) ;
  }
  {
  routine_generateActions (constinArgument_inSourceFile, constinArgument_inGeneration.mAttribute_mActionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 168)) ;
  }
  GALGAS_string var_outputDirectory = constinArgument_inSourceFile.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 172)) ;
  {
  routine_generatePreferences (constinArgument_inGeneration.mAttribute_mPreferenceListForGeneration, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 173)) ;
  }
  {
  routine_generateOutletClasses (constinArgument_inGeneration.mAttribute_mNeededOutletClasses, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 177)) ;
  }
}
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_astDeclarationList var_declarationList = GALGAS_astDeclarationList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 35)) ;
  GALGAS_outletClassDeclarationList var_outletClassDeclarationList = GALGAS_outletClassDeclarationList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 36)) ;
  GALGAS_cursorList var_cursorList = GALGAS_cursorList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 37)) ;
  GALGAS_location joker_1365_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 38))), GALGAS_bool (false), var_declarationList, var_cursorList, var_outletClassDeclarationList, joker_1365_0  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 38)) ;
  GALGAS_location var_endOfSourceFile ;
  var_endOfSourceFile.drop () ;
  cGrammar_easyBindings_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, GALGAS_bool (true), var_declarationList, var_cursorList, var_outletClassDeclarationList, var_endOfSourceFile  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 46)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("String"), GALGAS_typeKind::constructor_stringType (SOURCE_FILE ("easyBindings_program.gProgram", 54))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 54))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 54)) ;
  ...
  cEnumerator_astDeclarationList enumerator_2922 (var_declarationList, kEnumeration_up) ;
  while (enumerator_2922.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_2922.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 69)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bool joker_3246_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3246_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 74)) ;
  }
  ...
  cEnumerator_lstringlist enumerator_3428 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3428.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3428.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3428.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 79))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 79)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 79))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 79)) ;
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_3) {
      ...
      cEnumerator_lstringlist enumerator_3914 (var_unsortedTypeNames, kEnumeration_up) ;
      while (enumerator_3914.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_3914.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 90))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 90))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 90)) ;
      ...
      {
      routine_semanticAnalysis (var_unifiedTypeMap, var_sortedTypeNames, constinArgument_inSourceFile.mAttribute_string, var_cursorList, var_outletClassDeclarationList, var_sortedTransientAndObservablePropertyNodes, var_generation, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 94)) ;
      }
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 103)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        {
        routine_generateCode (var_sortedTransientAndObservablePropertyNodes, var_generation, constinArgument_inSourceFile.mAttribute_string, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 104)) ;
        }
      }
    }
  }
