...
GALGAS_string filewrapperTemplate_predefinedOutletClasses_sourceFile (C_Compiler * /* inCompiler */
  ...
  C_String result ;
  result << "outletClass NSBox noGeneration {\n"
    "  $hidden : bool {\n"
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  routine_semanticAnalysis (var_ast, var_outletClassMap, var_classMap, var_entityMap, var_preferencesMap, var_documentMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (49)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_sourceDir = constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (51)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_generateClassCode (var_classMap, var_sourceDir, inCompiler COMMA_SOURCE_FILE_AT_LINE (52)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generateEntityCode (var_entityMap, var_sourceDir, inCompiler COMMA_SOURCE_FILE_AT_LINE (53)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generatePreferencesCode (var_preferencesMap, var_sourceDir, inCompiler COMMA_SOURCE_FILE_AT_LINE (54)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_generateDocumentCode (var_documentMap, var_sourceDir, inCompiler COMMA_SOURCE_FILE_AT_LINE (55)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  cEnumerator_stringlist enumerator_2168 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (58)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_2168.hasCurrentObject ()) {
    { //-------- @typeMethodInstructionForGeneration
    GALGAS_string::class_method_generateFile (var_sourceDir.operator_concat (enumerator_2168.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (60)) COMMA_SOURCE_FILE_AT_LINE (60)), enumerator_2168.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (61)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_fw.reader_textFileContentsAtPath (enumerator_2168.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (64)), GALGAS_string ("\n"
