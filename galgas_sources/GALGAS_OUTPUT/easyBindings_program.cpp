...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
                               ...
                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_observablePropertyMapMap var_observablePropertyMapMap = GALGAS_observablePropertyMapMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (123)) ;
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (124)) ;
  cEnumerator_lstringlist enumerator_5141 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_5141.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    GALGAS_ebType joker_5196_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_5141.current_mValue (HERE), joker_5196_0, var_declaration, inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) ;
    callCategoryMethod_buildObservablePropertyMap ((const cPtr_astDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_observablePropertyMapMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (131)) ;
    enumerator_5141.gotoNextObject () ;
  }
  GALGAS_contextAnalysisStruct var_contextAnalysisStruct = GALGAS_contextAnalysisStruct::constructor_default (SOURCE_FILE_AT_LINE (137)) ;
  ...
  {
  routine_cursorAnalysis (constinArgument_inCursorList, var_contextAnalysisStruct, var_predefinedCursorList, inCompiler COMMA_SOURCE_FILE_AT_LINE (141)) ;
  }
  GALGAS_generationList var_generationList = GALGAS_generationList::constructor_emptyList (SOURCE_FILE_AT_LINE (147)) ;
  cEnumerator_lstringlist enumerator_5835 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_5835.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    GALGAS_ebType joker_5890_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_5835.current_mValue (HERE), joker_5890_0, var_declaration, inCompiler COMMA_SOURCE_FILE_AT_LINE (149)) ;
    callCategoryMethod_semanticAnalysis ((const cPtr_astDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_contextAnalysisStruct, var_generationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (154)) ;
    enumerator_5835.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (161)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_generationList enumerator_6148 (var_generationList, kEnumeration_up) ;
    while (enumerator_6148.hasCurrentObject ()) {
      callCategoryMethod_generate ((const cPtr_generation *) enumerator_6148.current_mGeneration (HERE).ptr (), constinArgument_inOutputDirectory, inCompiler COMMA_SOURCE_FILE_AT_LINE (163)) ;
      enumerator_6148.gotoNextObject () ;
    }
    {
    routine_generateCursorCode (var_contextAnalysisStruct.mAttribute_mUserCursorMap, var_predefinedCursorList, constinArgument_inOutputDirectory, inCompiler COMMA_SOURCE_FILE_AT_LINE (165)) ;
    }
  }
}
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("enum"), GALGAS_typeKind::constructor_enumType (SOURCE_FILE_AT_LINE (68)) COMMA_SOURCE_FILE_AT_LINE (68)) COMMA_SOURCE_FILE_AT_LINE (68)) ;
  GALGAS_unifiedTypeMap var_unifiedTypeMap = GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (70)) ;
  cEnumerator_astDeclarationList enumerator_3011 (var_declarationList, kEnumeration_up) ;
  while (enumerator_3011.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_3011.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (73)) ;
  ...
  if (kBoolTrue == test_0) {
    GALGAS_string var_s = var_unifiedTypeMap.reader_edgeGraphvizRepresentation (SOURCE_FILE_AT_LINE (76)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".classDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (77)) ;
    GALGAS_bool joker_3349_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3349_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (78)) ;
  }
  GALGAS_lstringlist var_unsolvedProxyList = var_unifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE_AT_LINE (81)) ;
  cEnumerator_lstringlist enumerator_3546 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3546.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3546.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3546.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (83)) COMMA_SOURCE_FILE_AT_LINE (83)).operator_concat (GALGAS_string (" is undefined") COMMA_SOURCE_FILE_AT_LINE (83)) COMMA_SOURCE_FILE_AT_LINE (83)) ;
    enumerator_3546.gotoNextObject () ;
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_unsolvedProxyList.reader_length (SOURCE_FILE_AT_LINE (86)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_lstringlist var_sortedKeys ;
    GALGAS_lstringlist var_unsortedKeys ;
    var_unifiedTypeMap.method_topologicalSort (var_sortedKeys, var_unsortedKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (87)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedKeys.reader_length (SOURCE_FILE_AT_LINE (88)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_s = GALGAS_string ("cannot sort types ; the following types are involved in circular dependence:") ;
      cEnumerator_lstringlist enumerator_3993 (var_unsortedKeys, kEnumeration_up) ;
      while (enumerator_3993.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_3993.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)) COMMA_SOURCE_FILE_AT_LINE (91)) ;
        enumerator_3993.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (inCompiler->here (), var_s COMMA_SOURCE_FILE_AT_LINE (93)) ;
    }else if (kBoolFalse == test_3) {
      {
      routine_semanticAnalysis (var_unifiedTypeMap, var_sortedKeys, constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (103)), var_cursorList, inCompiler COMMA_SOURCE_FILE_AT_LINE (100)) ;
      }
    }
  }
}
