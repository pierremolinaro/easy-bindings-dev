...
//---------------------------------------------------------------------------*
//                                                                           *
//                       Routine 'enterPredefinedType'                       *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_enterPredefinedType (GALGAS_unifiedTypeMap & ioArgument_ioUnifiedTypeMap,
                                  const GALGAS_string constinArgument_inTypeName,
                                  const GALGAS_unifiedTypeKind constinArgument_inKind,
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  {
  ioArgument_ioUnifiedTypeMap.modifier_insertKey (constinArgument_inTypeName.reader_nowhere (SOURCE_FILE_AT_LINE (49)), constinArgument_inKind, GALGAS_unifiedTypeProxy::constructor_null (SOURCE_FILE_AT_LINE (51)), GALGAS_enumConstantMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (52)), GALGAS_unifiedTypeProxyList::constructor_emptyList (SOURCE_FILE_AT_LINE (53)), GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (54)), inCompiler COMMA_SOURCE_FILE_AT_LINE (48)) ;
  }
}
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_classList var_classList = GALGAS_classList::constructor_emptyList (SOURCE_FILE_AT_LINE (64)) ;
  GALGAS_entityList var_entityList = GALGAS_entityList::constructor_emptyList (SOURCE_FILE_AT_LINE (65)) ;
  GALGAS_preferencesDeclarationList var_preferencesList = GALGAS_preferencesDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (66)) ;
  GALGAS_nibClassDeclarationList var_nibClassList = GALGAS_nibClassDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (67)) ;
  GALGAS_outletClassList var_outletClassList = GALGAS_outletClassList::constructor_emptyList (SOURCE_FILE_AT_LINE (68)) ;
  GALGAS_documentDeclarationList var_documentDeclarationList = GALGAS_documentDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (69)) ;
  GALGAS_controllerClassList var_controllerClassList = GALGAS_controllerClassList::constructor_emptyList (SOURCE_FILE_AT_LINE (70)) ;
  GALGAS_protocolList var_protocolList = GALGAS_protocolList::constructor_emptyList (SOURCE_FILE_AT_LINE (71)) ;
  GALGAS_cursorList var_cursorList = GALGAS_cursorList::constructor_emptyList (SOURCE_FILE_AT_LINE (72)) ;
  GALGAS_structTypeList var_structTypeList = GALGAS_structTypeList::constructor_emptyList (SOURCE_FILE_AT_LINE (73)) ;
  GALGAS_enumList var_enumList = GALGAS_enumList::constructor_emptyList (SOURCE_FILE_AT_LINE (74)) ;
  {
  GALGAS_location joker_2814_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE_AT_LINE (75))), var_classList, var_entityList, var_preferencesList, var_nibClassList, var_outletClassList, var_documentDeclarationList, var_controllerClassList, var_protocolList, var_cursorList, var_enumList, var_structTypeList, joker_2814_0 COMMA_SOURCE_FILE_AT_LINE (75)) ;
  }
  GALGAS_location var_endOfSourceFile ;
  {
  cGrammar_easyBindings_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, var_classList, var_entityList, var_preferencesList, var_nibClassList, var_outletClassList, var_documentDeclarationList, var_controllerClassList, var_protocolList, var_cursorList, var_enumList, var_structTypeList, var_endOfSourceFile COMMA_SOURCE_FILE_AT_LINE (90)) ;
  }
  GALGAS_unifiedTypeMap var_unifiedTypeMap = GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (105)) ;
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSString"), GALGAS_unifiedTypeKind::constructor_stringType (SOURCE_FILE_AT_LINE (106)), inCompiler COMMA_SOURCE_FILE_AT_LINE (106)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSColor"), GALGAS_unifiedTypeKind::constructor_colorType (SOURCE_FILE_AT_LINE (107)), inCompiler COMMA_SOURCE_FILE_AT_LINE (107)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSData"), GALGAS_unifiedTypeKind::constructor_dataType (SOURCE_FILE_AT_LINE (108)), inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSDate"), GALGAS_unifiedTypeKind::constructor_dateType (SOURCE_FILE_AT_LINE (109)), inCompiler COMMA_SOURCE_FILE_AT_LINE (109)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSFont"), GALGAS_unifiedTypeKind::constructor_fontType (SOURCE_FILE_AT_LINE (110)), inCompiler COMMA_SOURCE_FILE_AT_LINE (110)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSImage"), GALGAS_unifiedTypeKind::constructor_imageType (SOURCE_FILE_AT_LINE (111)), inCompiler COMMA_SOURCE_FILE_AT_LINE (111)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSBezierPath"), GALGAS_unifiedTypeKind::constructor_bezierPathType (SOURCE_FILE_AT_LINE (112)), inCompiler COMMA_SOURCE_FILE_AT_LINE (112)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("integer"), GALGAS_unifiedTypeKind::constructor_integerType (SOURCE_FILE_AT_LINE (113)), inCompiler COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("uinteger"), GALGAS_unifiedTypeKind::constructor_uintegerType (SOURCE_FILE_AT_LINE (114)), inCompiler COMMA_SOURCE_FILE_AT_LINE (114)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("decimal"), GALGAS_unifiedTypeKind::constructor_decimalType (SOURCE_FILE_AT_LINE (115)), inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("bool"), GALGAS_unifiedTypeKind::constructor_boolType (SOURCE_FILE_AT_LINE (116)), inCompiler COMMA_SOURCE_FILE_AT_LINE (116)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("double"), GALGAS_unifiedTypeKind::constructor_doubleType (SOURCE_FILE_AT_LINE (117)), inCompiler COMMA_SOURCE_FILE_AT_LINE (117)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("*anyscalar*"), GALGAS_unifiedTypeKind::constructor_anyScalarType (SOURCE_FILE_AT_LINE (118)), inCompiler COMMA_SOURCE_FILE_AT_LINE (118)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("*anynumber*"), GALGAS_unifiedTypeKind::constructor_anyNumberType (SOURCE_FILE_AT_LINE (119)), inCompiler COMMA_SOURCE_FILE_AT_LINE (119)) ;
  }
  {
  routine_enumEnterType (var_enumList, var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (121)) ;
  }
  {
  routine_structEnterType (var_structTypeList, var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) ;
  }
  {
  routine_outletClassesEnterType (var_outletClassList, var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (131)) ;
  }
  cEnumerator_lstringlist enumerator_4777 (var_unifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE_AT_LINE (136)), kEnumeration_up) ;
  while (enumerator_4777.hasCurrentObject ()) {
    GALGAS_location location_0 (enumerator_4777.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("type ").operator_concat (enumerator_4777.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)).operator_concat (GALGAS_string (" is undefined") COMMA_SOURCE_FILE_AT_LINE (137)) COMMA_SOURCE_FILE_AT_LINE (137)) ;
    enumerator_4777.gotoNextObject () ;
  }
  GALGAS_contextAnalysisStruct var_contextAnalysisStruct = GALGAS_contextAnalysisStruct::constructor_default (SOURCE_FILE_AT_LINE (140)) ;
  GALGAS_stringlist var_predefinedCursorList ;
  {
  routine_cursorAnalysis (var_cursorList, var_contextAnalysisStruct, var_predefinedCursorList, inCompiler COMMA_SOURCE_FILE_AT_LINE (142)) ;
  }
  {
  routine_enumAnalysis (var_enumList, var_contextAnalysisStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }
  {
  routine_structAnalysis (var_structTypeList, var_contextAnalysisStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (153)) ;
  }
  GALGAS_protocolMap var_protocolMap = GALGAS_protocolMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (158)) ;
  cEnumerator_protocolList enumerator_5348 (var_protocolList, kEnumeration_up) ;
  while (enumerator_5348.hasCurrentObject ()) {
    {
    var_protocolMap.modifier_insertKey (enumerator_5348.current_mProtocolName (HERE), enumerator_5348.current_mIsPredefined (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (160)) ;
    }
    enumerator_5348.gotoNextObject () ;
  }
  GALGAS_stringlist var_sortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (163)) ;
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (164)) ;
  GALGAS_outletClassMap var_outletClassMap ;
  {
  routine_analyzeOutletClasses (var_outletClassList, var_contextAnalysisStruct, var_protocolMap, var_outletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (165)) ;
  }
  GALGAS_controllerClassMap var_controllerClassMap ;
  {
  routine_analyzeControllerClasses (var_controllerClassList, var_contextAnalysisStruct, var_transientDependencyGraph, var_controllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (172)) ;
  }
  GALGAS_classMap var_classMap ;
  {
  routine_analyzeClasses (var_classList, var_contextAnalysisStruct, var_classMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (179)) ;
  }
  GALGAS_preferencesMap var_preferencesMap ;
  {
  routine_analyzePreferences (var_preferencesList, var_controllerClassMap, var_classMap, var_outletClassMap, var_contextAnalysisStruct, var_preferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (186)) ;
  }
  GALGAS_nibClassMap var_nibClassMap ;
  {
  routine_analyzeNibClasses (var_nibClassList, var_controllerClassMap, var_classMap, var_outletClassMap, var_contextAnalysisStruct, var_nibClassMap, var_preferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (196)) ;
  }
  GALGAS_entityMap var_entityMap ;
  GALGAS_entityListForGeneration var_entityListForGeneration ;
  {
  routine_analyzeEntities (var_entityList, var_contextAnalysisStruct, var_entityMap, var_entityListForGeneration, var_preferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (207)) ;
  }
  GALGAS_documentMap var_documentMap ;
  {
  routine_analyzeDocuments (var_documentDeclarationList, var_outletClassMap, var_controllerClassMap, var_entityMap, var_preferencesMap, var_contextAnalysisStruct, var_documentMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (216)) ;
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (227)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (227)).boolEnum () ;
  if (kBoolTrue == test_1) {
    GALGAS_string var_s = var_transientDependencyGraph.reader_graphviz (SOURCE_FILE_AT_LINE (228)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".transientDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (229)) ;
    GALGAS_bool joker_7221_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_7221_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (230)) ;
  }
  GALGAS__32_stringlist var_transientDependencyArcList = var_transientDependencyGraph.reader_arcs (SOURCE_FILE_AT_LINE (233)) ;
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (234)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_transientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (235)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      cEnumerator_stringlist enumerator_7511 (var_transientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (236)), kEnumeration_up) ;
      while (enumerator_7511.hasCurrentObject ()) {
        inCompiler->emitSemanticError (var_endOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_7511.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (237)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (237)) COMMA_SOURCE_FILE_AT_LINE (237)) ;
        enumerator_7511.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_3) {
      GALGAS_stringlist var_unsortedTransientList ;
      GALGAS_lstringlist joker_7758_0 ; // Joker input parameter
      GALGAS_lstringlist joker_7800_0 ; // Joker input parameter
      var_transientDependencyGraph.method_topologicalSort (var_sortedTransientOrderedList, joker_7758_0, var_unsortedTransientList, joker_7800_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (241)) ;
      const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (247)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (248)).reader_string (SOURCE_FILE_AT_LINE (248)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:") COMMA_SOURCE_FILE_AT_LINE (248)) ;
        cEnumerator_stringlist enumerator_8030 (var_unsortedTransientList, kEnumeration_up) ;
        while (enumerator_8030.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_8030.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (250)) COMMA_SOURCE_FILE_AT_LINE (250)) ;
          enumerator_8030.gotoNextObject () ;
        }
        inCompiler->emitSemanticError (var_endOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (252)) ;
      }
    }
  }
  GALGAS_string var_sourceDirectoryPath = constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (258)) ;
  {
  routine_generateEnumerations (var_contextAnalysisStruct.mAttribute_mEnumMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (259)) ;
  }
  {
  routine_generateStructures (var_contextAnalysisStruct.mAttribute_mStructTypeMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (260)) ;
  }
  {
  routine_generateOutletClassCode (var_outletClassMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (261)) ;
  }
  {
  routine_generateClassCode (var_transientDependencyArcList, var_classMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (262)) ;
  }
  {
  routine_generateEntityCode (var_transientDependencyArcList, var_entityListForGeneration, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (263)) ;
  }
  {
  routine_generatePreferencesCode (var_transientDependencyArcList, var_preferencesMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (264)) ;
  }
  {
  routine_generateNibClassCode (var_transientDependencyArcList, var_nibClassMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (265)) ;
  }
  {
  routine_generateDocumentCode (var_transientDependencyArcList, var_documentMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (266)) ;
  }
  {
  routine_generateCursorCode (var_contextAnalysisStruct.mAttribute_mUserCursorMap, var_predefinedCursorList, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (267)) ;
  }
  {
  routine_generateControllerCode (var_controllerClassMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (268)) ;
  }
  {
  routine_generateTransientDependencyFiles (var_transientDependencyArcList, var_sourceDirectoryPath, var_sortedTransientOrderedList, inCompiler COMMA_SOURCE_FILE_AT_LINE (270)) ;
  }
  GALGAS_stringset var_generateSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (276)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("easy-bindings-utilities") COMMA_SOURCE_FILE_AT_LINE (277)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("PMAllocationDebug") COMMA_SOURCE_FILE_AT_LINE (278)) ;
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, var_documentMap.reader_count (SOURCE_FILE_AT_LINE (279)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    var_generateSet.addAssign_operation (GALGAS_string ("PMUndoManager") COMMA_SOURCE_FILE_AT_LINE (280)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedDocument") COMMA_SOURCE_FILE_AT_LINE (281)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression") COMMA_SOURCE_FILE_AT_LINE (282)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression") COMMA_SOURCE_FILE_AT_LINE (283)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+PMGZcompression") COMMA_SOURCE_FILE_AT_LINE (284)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSMutableData+PMWrites") COMMA_SOURCE_FILE_AT_LINE (285)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner") COMMA_SOURCE_FILE_AT_LINE (286)) ;
  }
  const enumGalgasBool test_6 = GALGAS_bool (kIsStrictSup, var_entityListForGeneration.reader_length (SOURCE_FILE_AT_LINE (288)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_6) {
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions") COMMA_SOURCE_FILE_AT_LINE (289)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedEntity") COMMA_SOURCE_FILE_AT_LINE (290)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityManager") COMMA_SOURCE_FILE_AT_LINE (291)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMAttributeDescription") COMMA_SOURCE_FILE_AT_LINE (292)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMRelationshipDescription") COMMA_SOURCE_FILE_AT_LINE (293)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityArrayController") COMMA_SOURCE_FILE_AT_LINE (294)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityController") COMMA_SOURCE_FILE_AT_LINE (295)) ;
  }
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  cEnumerator_stringlist enumerator_10376 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (299)), kEnumeration_up) ;
  while (enumerator_10376.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_10376.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (300)) ;
    const enumGalgasBool test_7 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (301)) COMMA_SOURCE_FILE_AT_LINE (301)).boolEnum () ;
    if (kBoolTrue == test_7) {
      {
      GALGAS_string::class_method_generateFile (var_sourceDirectoryPath.operator_concat (enumerator_10376.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (303)) COMMA_SOURCE_FILE_AT_LINE (303)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_10376.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (305)), inCompiler COMMA_SOURCE_FILE_AT_LINE (302)) ;
      }
    }
