...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
                               ...
                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_outputDirectory = constinArgument_inSourceFile.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 120)) ;
  GALGAS_observablePropertyMapMap var_observablePropertyMapMap = GALGAS_observablePropertyMapMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 122)) ;
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE ("easyBindings_program.gProgram", 123)) ;
  cEnumerator_lstringlist enumerator_5055 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_5055.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    GALGAS_ebType joker_5112_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_5055.current_mValue (HERE), joker_5112_0, var_declaration, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 125)) ;
    callCategoryMethod_buildObservablePropertyMap ((const cPtr_astDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_observablePropertyMapMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 130)) ;
    enumerator_5055.gotoNextObject () ;
  }
  GALGAS_contextAnalysisStruct var_contextAnalysisStruct = GALGAS_contextAnalysisStruct::constructor_default (SOURCE_FILE ("easyBindings_program.gProgram", 136)) ;
  ...
  {
  routine_cursorAnalysis (constinArgument_inCursorList, var_contextAnalysisStruct, var_predefinedCursorList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 140)) ;
  }
  GALGAS_generationList var_generationList = GALGAS_generationList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 146)) ;
  cEnumerator_lstringlist enumerator_5749 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_5749.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    GALGAS_ebType joker_5806_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_5749.current_mValue (HERE), joker_5806_0, var_declaration, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 148)) ;
    callCategoryMethod_semanticAnalysis ((const cPtr_astDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_contextAnalysisStruct, var_generationList, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 153)) ;
    enumerator_5749.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 160)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_entityMap enumerator_6118 (var_contextAnalysisStruct.mAttribute_mEntityMap, kEnumeration_up) ;
    while (enumerator_6118.hasCurrentObject ()) {
      cEnumerator_relationshipMap enumerator_6159 (enumerator_6118.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
      while (enumerator_6159.hasCurrentObject ()) {
        GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
        GALGAS_string joker_6261_9 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6261_8 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6261_7 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6261_6 ; // Joker input parameter
        GALGAS_transientListForImplementation joker_6261_5 ; // Joker input parameter
        GALGAS_relationshipList joker_6261_4 ; // Joker input parameter
        GALGAS_relationshipList joker_6261_3 ; // Joker input parameter
        GALGAS_propertyMap joker_6261_2 ; // Joker input parameter
        GALGAS_relationshipMap joker_6261_1 ; // Joker input parameter
        GALGAS_fileInclusionSet joker_6336_2 ; // Joker input parameter
        GALGAS_signListForGeneration joker_6336_1 ; // Joker input parameter
        var_contextAnalysisStruct.mAttribute_mEntityMap.method_searchKey (enumerator_6159.current_mDestinationEntityName (HERE), joker_6261_9, joker_6261_8, joker_6261_7, joker_6261_6, joker_6261_5, joker_6261_4, joker_6261_3, joker_6261_2, joker_6261_1, var_destinationEntityRelationshipMap, joker_6336_2, joker_6336_1, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 163)) ;
        GALGAS_lstring var_inverseOfInverseRelationshipName ;
        GALGAS_bool var_inverseIsToMany ;
        GALGAS_bool joker_6450_2 ; // Joker input parameter
        GALGAS_lstring joker_6450_1 ; // Joker input parameter
        GALGAS_deleteRuleEnum joker_6550_0 ; // Joker input parameter
        var_destinationEntityRelationshipMap.method_searchKey (enumerator_6159.current_mInverseRelationshipName (HERE), joker_6450_2, joker_6450_1, var_inverseOfInverseRelationshipName, var_inverseIsToMany, joker_6550_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 169)) ;
        const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_6159.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_location location_2 (enumerator_6159.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_6159.current_lkey (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 177))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 177)).operator_concat (GALGAS_string ("' relationship as inverse")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 177))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 177)) ;
        }
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_6159.current_mIsToMany (HERE).objectCompare (var_inverseIsToMany)).boolEnum () ;
        if (kBoolTrue == test_3) {
          ...
          GALGAS_location location_6 (enumerator_6159.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_6, GALGAS_string ("the inverse relationship is ").operator_concat (temp_4  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 180))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 180)) ;
        }
  ...
  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 186)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_7) {
    cEnumerator_generationList enumerator_7096 (var_generationList, kEnumeration_up) ;
    while (enumerator_7096.hasCurrentObject ()) {
      callCategoryMethod_generate ((const cPtr_generation *) enumerator_7096.current_mGeneration (HERE).ptr (), var_outputDirectory, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 188)) ;
      enumerator_7096.gotoNextObject () ;
    }
    {
    routine_generateCursorCode (var_contextAnalysisStruct.mAttribute_mUserCursorMap, var_predefinedCursorList, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 190)) ;
    }
    {
    routine_generateEntityFactory (var_contextAnalysisStruct.mAttribute_mEntityMap, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 195)) ;
    }
  }
  const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 198)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 198)).boolEnum () ;
  if (kBoolTrue == test_8) {
    GALGAS_string var_s = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_graphviz (SOURCE_FILE ("easyBindings_program.gProgram", 199)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.operator_concat (GALGAS_string (".transientDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 200)) ;
    GALGAS_bool joker_7722_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_7722_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 201)) ;
  }
  GALGAS__32_stringlist var_transientDependencyArcList = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_edges (SOURCE_FILE ("easyBindings_program.gProgram", 204)) ;
  GALGAS_stringlist var_sortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 205)) ;
  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 206)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_9) {
    const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE ("easyBindings_program.gProgram", 207)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_10) {
      cEnumerator_stringlist enumerator_8136 (var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE ("easyBindings_program.gProgram", 208)), kEnumeration_up) ;
      while (enumerator_8136.hasCurrentObject ()) {
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_8136.current_mValue (HERE)  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 209)).operator_concat (GALGAS_string ("' property is not defined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 209))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 209)) ;
        enumerator_8136.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_10) {
      GALGAS_stringlist var_unsortedTransientList ;
      GALGAS_lstringlist joker_8369_0 ; // Joker input parameter
      GALGAS_lstringlist joker_8423_0 ; // Joker input parameter
      var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.method_topologicalSort (var_sortedTransientOrderedList, joker_8369_0, var_unsortedTransientList, joker_8423_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 212)) ;
      const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 218)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_11) {
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 219)).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 219)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 219)) ;
        cEnumerator_stringlist enumerator_8651 (var_unsortedTransientList, kEnumeration_up) ;
        while (enumerator_8651.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_8651.current_mValue (HERE)  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 221))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 221)) ;
          enumerator_8651.gotoNextObject () ;
        }
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 223)) ;
      }
    }
  }
  {
  routine_generateObserverProtocols (var_observablePropertyMapMap, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 229)) ;
  }
  {
  routine_generateTransientTrigersAndApplication (var_transientDependencyArcList, var_outputDirectory, var_sortedTransientOrderedList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 234)) ;
  }
  GALGAS_stringset var_extensionSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("xib") COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 240)) ;
  const enumGalgasBool test_12 = GALGAS_bool (gOption_easyBindings_5F_options_outputSwift.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("swift")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 242)) ;
  }else if (kBoolFalse == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("m")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 244)) ;
    var_extensionSet.addAssign_operation (GALGAS_string ("h")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 245)) ;
  }
  GALGAS_stringset var_generateSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("easyBindings_program.gProgram", 248)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("easy-bindings-utilities")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 249)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 250)) ;
  const enumGalgasBool test_13 = var_contextAnalysisStruct.mAttribute_mContainsDocument.boolEnum () ;
  if (kBoolTrue == test_13) {
    var_generateSet.addAssign_operation (GALGAS_string ("PMUndoManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 252)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedDocument")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 253)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 254)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 255)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+PMGZcompression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 256)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSMutableData+PMWrites")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 257)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 258)) ;
  }
  const enumGalgasBool test_14 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mEntityMap.reader_count (SOURCE_FILE ("easyBindings_program.gProgram", 260)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_14) {
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 261)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedObject")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 262)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMObjectManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 263)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMAttributeDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 264)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMRelationshipDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 265)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityArrayController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 266)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 267)) ;
  }
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  cEnumerator_stringlist enumerator_10406 (var_fw.reader_allTextFilePathes (SOURCE_FILE ("easyBindings_program.gProgram", 271)), kEnumeration_up) ;
  while (enumerator_10406.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_10406.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 272)) ;
    const enumGalgasBool test_15 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 273)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 273)).operator_and (var_extensionSet.reader_hasKey (var_sourceName.reader_pathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 273)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 273)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 273)).boolEnum () ;
    if (kBoolTrue == test_15) {
      {
      GALGAS_string::class_method_generateFile (var_outputDirectory.operator_concat (enumerator_10406.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 275))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 275)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_10406.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 277)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 274)) ;
      }
    }
...
//-----------------------------------------------------------------------------*
//                                                                             *
//                     Routine 'generateObserverProtocols'                     *
//                                                                             *
//-----------------------------------------------------------------------------*

void routine_generateObserverProtocols (const GALGAS_observablePropertyMapMap constinArgument_inObservablePropertyMapMap,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_string var_contents = GALGAS_string::makeEmptyString () ;
    cEnumerator_observablePropertyMapMap enumerator_11231 (constinArgument_inObservablePropertyMapMap, kEnumeration_up) ;
    while (enumerator_11231.hasCurrentObject ()) {
      const enumGalgasBool test_1 = enumerator_11231.current_mUserDefined (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        cEnumerator_observablePropertyMap enumerator_11300 (enumerator_11231.current_mObservablePropertyMap (HERE), kEnumeration_up) ;
        while (enumerator_11300.hasCurrentObject ()) {
          GALGAS_string var_signature = enumerator_11300.current_mPropertySignature (HERE).mAttribute_string.reader_identifierRepresentation (SOURCE_FILE ("easyBindings_program.gProgram", 295)) ;
          var_contents.dotAssign_operation (GALGAS_string ("@objc(protocol_").add_operation (var_signature, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 296)).add_operation (GALGAS_string (") protocol protocol_"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 296)).add_operation (var_signature, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 296)).add_operation (GALGAS_string (" {\n"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 296)).add_operation (GALGAS_string ("  func "), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 296)).add_operation (var_signature, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 297)).add_operation (GALGAS_string ("_didChange ()\n"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 297)).add_operation (GALGAS_string ("}\n"
            "\n"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 297))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 296)) ;
    ...
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, GALGAS_string ("observer-protocols.swift"), var_contents, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 302)) ;
    }
  }
}
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cEnumerator_astDeclarationList enumerator_2802 (var_declarationList, kEnumeration_up) ;
  while (enumerator_2802.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_2802.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 66)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bool joker_3126_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3126_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 71)) ;
  }
  ...
  cEnumerator_lstringlist enumerator_3308 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3308.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3308.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3308.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 76))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 76)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 76))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 76)) ;
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_3) {
      ...
      cEnumerator_lstringlist enumerator_3794 (var_unsortedTypeNames, kEnumeration_up) ;
      while (enumerator_3794.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_3794.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 87))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 87))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 87)) ;
      ...
      {
      routine_semanticAnalysis (var_unifiedTypeMap, var_sortedTypeNames, constinArgument_inSourceFile.mAttribute_string, var_cursorList, var_endOfSourceFile, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 96)) ;
      }
    }
  }
}
