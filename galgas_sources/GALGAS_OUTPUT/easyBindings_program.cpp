...
//                    september 27th, 2012, at 20h17'8"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cEnumerator_stringlist enumerator_3201 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (90)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_3201.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_sourceName = enumerator_3201.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (91)) ;
    //-------- @ifInstructionForGeneration
