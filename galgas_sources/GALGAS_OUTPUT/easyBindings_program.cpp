...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  {
  routine_buildTransientDependencyGraph (constinArgument_inUnifiedTypeMap, constinArgument_inSourceFile, outArgument_outSortedTransientAndObservablePropertyNodes, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 185)) ;
  }
}
...
void routine_generateCode (const GALGAS_transientDependencyGraphNodeInfoList constinArgument_inSortedTransientAndObservablePropertyNodes,
                           ...
                           COMMA_UNUSED_LOCATION_ARGS) {
  {
  routine_generateTransients (constinArgument_inSourceFile, constinArgument_inSortedTransientAndObservablePropertyNodes, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 202)) ;
  }
}
...
void routine_EXsemanticAnalysis (const GALGAS_EXunifiedTypeMap constinArgument_inUnifiedTypeMap,
                                 ...
                                 C_Compiler * inCompiler
                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_outputDirectory = constinArgument_inSourceFile.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 221)) ;
  GALGAS_EXobservablePropertyMapMap var_observablePropertyMapMap = GALGAS_EXobservablePropertyMapMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 223)) ;
  GALGAS_EXtransientDependencyGraph var_transientDependencyGraph = GALGAS_EXtransientDependencyGraph::constructor_emptyGraph (SOURCE_FILE ("easyBindings_program.gProgram", 224)) ;
  cEnumerator_lstringlist enumerator_10001 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_10001.hasCurrentObject ()) {
    GALGAS_EXastDeclaration var_declaration ;
    GALGAS_EXebType joker_10058_0 ; // Joker input parameter
    GALGAS_EXentityRelationshipMap joker_10104_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_10001.current_mValue (HERE), joker_10058_0, var_declaration, joker_10104_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 226)) ;
    callCategoryMethod_buildObservablePropertyMap ((const cPtr_EXastDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_observablePropertyMapMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 232)) ;
    enumerator_10001.gotoNextObject () ;
  }
  GALGAS_EXcontextAnalysisStruct var_contextAnalysisStruct = GALGAS_EXcontextAnalysisStruct::constructor_default (SOURCE_FILE ("easyBindings_program.gProgram", 238)) ;
  ...
  {
  routine_cursorAnalysis (constinArgument_inCursorList, var_contextAnalysisStruct, var_predefinedCursorList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 242)) ;
  }
  GALGAS_generationList var_generationList = GALGAS_generationList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 248)) ;
  cEnumerator_lstringlist enumerator_10708 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_10708.hasCurrentObject ()) {
    GALGAS_EXastDeclaration var_declaration ;
    GALGAS_EXebType joker_10765_0 ; // Joker input parameter
    GALGAS_EXentityRelationshipMap joker_10811_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_10708.current_mValue (HERE), joker_10765_0, var_declaration, joker_10811_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 250)) ;
    callCategoryMethod_semanticAnalysis ((const cPtr_EXastDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_contextAnalysisStruct, var_generationList, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 256)) ;
    enumerator_10708.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 263)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_entityMap enumerator_11088 (var_contextAnalysisStruct.mAttribute_mEntityMap, kEnumeration_up) ;
    while (enumerator_11088.hasCurrentObject ()) {
      cEnumerator_relationshipMap enumerator_11129 (enumerator_11088.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
      while (enumerator_11129.hasCurrentObject ()) {
        GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
        GALGAS_string joker_11231_9 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_11231_8 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_11231_7 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_11231_6 ; // Joker input parameter
        GALGAS_transientListForImplementation joker_11231_5 ; // Joker input parameter
        GALGAS_relationshipList joker_11231_4 ; // Joker input parameter
        GALGAS_relationshipList joker_11231_3 ; // Joker input parameter
        GALGAS_propertyMap joker_11231_2 ; // Joker input parameter
        GALGAS_relationshipMap joker_11231_1 ; // Joker input parameter
        GALGAS_fileInclusionSet joker_11306_2 ; // Joker input parameter
        GALGAS_signListForGeneration joker_11306_1 ; // Joker input parameter
        var_contextAnalysisStruct.mAttribute_mEntityMap.method_searchKey (enumerator_11129.current_mDestinationEntityName (HERE), joker_11231_9, joker_11231_8, joker_11231_7, joker_11231_6, joker_11231_5, joker_11231_4, joker_11231_3, joker_11231_2, joker_11231_1, var_destinationEntityRelationshipMap, joker_11306_2, joker_11306_1, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 266)) ;
        GALGAS_lstring var_inverseOfInverseRelationshipName ;
        GALGAS_bool var_inverseIsToMany ;
        GALGAS_bool joker_11420_2 ; // Joker input parameter
        GALGAS_lstring joker_11420_1 ; // Joker input parameter
        GALGAS_deleteRuleEnum joker_11520_0 ; // Joker input parameter
        var_destinationEntityRelationshipMap.method_searchKey (enumerator_11129.current_mInverseRelationshipName (HERE), joker_11420_2, joker_11420_1, var_inverseOfInverseRelationshipName, var_inverseIsToMany, joker_11520_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 272)) ;
        const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_11129.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_location location_2 (enumerator_11129.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_11129.current_lkey (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 280))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 280)).operator_concat (GALGAS_string ("' relationship as inverse")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 280))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 280)) ;
        }
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_11129.current_mIsToMany (HERE).objectCompare (var_inverseIsToMany)).boolEnum () ;
        if (kBoolTrue == test_3) {
          ...
          GALGAS_location location_6 (enumerator_11129.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_6, GALGAS_string ("the inverse relationship is ").operator_concat (temp_4  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 283))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 283)) ;
        }
        enumerator_11129.gotoNextObject () ;
      }
      enumerator_11088.gotoNextObject () ;
    }
  }
  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 289)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_7) {
    cEnumerator_generationList enumerator_12066 (var_generationList, kEnumeration_up) ;
    while (enumerator_12066.hasCurrentObject ()) {
      callCategoryMethod_generate ((const cPtr_generation *) enumerator_12066.current_mGeneration (HERE).ptr (), var_outputDirectory, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 291)) ;
      enumerator_12066.gotoNextObject () ;
    }
    {
    routine_generateCursorCode (var_contextAnalysisStruct.mAttribute_mUserCursorMap, var_predefinedCursorList, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 293)) ;
    }
    {
    routine_generateEntityFactory (var_contextAnalysisStruct.mAttribute_mEntityMap, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 298)) ;
    }
  }
  const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 301)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 301)).boolEnum () ;
  if (kBoolTrue == test_8) {
    GALGAS_string var_s = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_graphviz (SOURCE_FILE ("easyBindings_program.gProgram", 302)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.operator_concat (GALGAS_string (".EXtransientDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 303)) ;
    GALGAS_bool joker_12694_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_12694_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 304)) ;
  }
  GALGAS__32_stringlist var_transientDependencyArcList = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_edges (SOURCE_FILE ("easyBindings_program.gProgram", 307)) ;
  GALGAS_stringlist var_sortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 308)) ;
  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 309)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_9) {
    const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE ("easyBindings_program.gProgram", 310)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_10) {
      cEnumerator_stringlist enumerator_13108 (var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE ("easyBindings_program.gProgram", 311)), kEnumeration_up) ;
      while (enumerator_13108.hasCurrentObject ()) {
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_13108.current_mValue (HERE)  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 312)).operator_concat (GALGAS_string ("' property is not defined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 312))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 312)) ;
        enumerator_13108.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_10) {
      GALGAS_stringlist var_unsortedTransientList ;
      GALGAS_lstringlist joker_13341_0 ; // Joker input parameter
      GALGAS_lstringlist joker_13395_0 ; // Joker input parameter
      var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.method_topologicalSort (var_sortedTransientOrderedList, joker_13341_0, var_unsortedTransientList, joker_13395_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 315)) ;
      const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 321)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_11) {
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 322)).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 322)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 322)) ;
        cEnumerator_stringlist enumerator_13623 (var_unsortedTransientList, kEnumeration_up) ;
        while (enumerator_13623.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_13623.current_mValue (HERE)  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 324))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 324)) ;
          enumerator_13623.gotoNextObject () ;
        }
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 326)) ;
      }
    }
  }
  {
  routine_generateTransientTrigersAndApplication (var_transientDependencyArcList, var_outputDirectory, var_sortedTransientOrderedList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 332)) ;
  }
  GALGAS_stringset var_extensionSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("xib") COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 338)) ;
  const enumGalgasBool test_12 = GALGAS_bool (gOption_easyBindings_5F_options_outputSwift.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("swift")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 340)) ;
  }else if (kBoolFalse == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("m")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 342)) ;
    var_extensionSet.addAssign_operation (GALGAS_string ("h")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 343)) ;
  }
  GALGAS_stringset var_generateSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("easyBindings_program.gProgram", 346)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("easy-bindings-utilities")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 347)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 348)) ;
  const enumGalgasBool test_13 = var_contextAnalysisStruct.mAttribute_mContainsDocument.boolEnum () ;
  if (kBoolTrue == test_13) {
    var_generateSet.addAssign_operation (GALGAS_string ("PMUndoManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 350)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedDocument")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 351)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 352)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 353)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+PMGZcompression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 354)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSMutableData+PMWrites")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 355)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 356)) ;
  }
  const enumGalgasBool test_14 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mEntityMap.reader_count (SOURCE_FILE ("easyBindings_program.gProgram", 358)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_14) {
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 359)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedObject")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 360)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMObjectManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 361)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMAttributeDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 362)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMRelationshipDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 363)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityArrayController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 364)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 365)) ;
  }
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  cEnumerator_stringlist enumerator_15221 (var_fw.reader_allTextFilePathes (SOURCE_FILE ("easyBindings_program.gProgram", 369)), kEnumeration_up) ;
  while (enumerator_15221.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_15221.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 370)) ;
    const enumGalgasBool test_15 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 371)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 371)).operator_and (var_extensionSet.reader_hasKey (var_sourceName.reader_pathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 371)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 371)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 371)).boolEnum () ;
    if (kBoolTrue == test_15) {
      {
      GALGAS_string::class_method_generateFile (var_outputDirectory.operator_concat (enumerator_15221.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 373))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 373)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_15221.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 375)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 372)) ;
      }
    }
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_astDeclarationList var_declarationList = GALGAS_astDeclarationList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 32)) ;
  GALGAS_EXastDeclarationList var_EXdeclarationList = GALGAS_EXastDeclarationList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 33)) ;
  GALGAS_cursorList var_cursorList = GALGAS_cursorList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 35)) ;
  GALGAS_location joker_1256_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 36))), GALGAS_bool (false), var_declarationList, var_EXdeclarationList, var_cursorList, joker_1256_0  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 36)) ;
  GALGAS_location var_endOfSourceFile ;
  var_endOfSourceFile.drop () ;
  cGrammar_easyBindings_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, GALGAS_bool (true), var_declarationList, var_EXdeclarationList, var_cursorList, var_endOfSourceFile  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 44)) ;
  ...
  GALGAS_unifiedTypeMap var_unifiedTypeMap = GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 66)) ;
  cEnumerator_astDeclarationList enumerator_2900 (var_declarationList, kEnumeration_up) ;
  while (enumerator_2900.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_2900.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 68)) ;
  ...
  if (kBoolTrue == test_0) {
    GALGAS_string var_s = var_unifiedTypeMap.reader_edgeGraphvizRepresentation (SOURCE_FILE ("easyBindings_program.gProgram", 71)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".classDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 72)) ;
    GALGAS_bool joker_3224_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3224_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 73)) ;
  }
  GALGAS_lstringlist var_unsolvedProxyList = var_unifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE ("easyBindings_program.gProgram", 76)) ;
  cEnumerator_lstringlist enumerator_3406 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3406.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3406.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3406.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 78))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 78)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 78))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 78)) ;
    enumerator_3406.gotoNextObject () ;
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_unsolvedProxyList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 81)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_lstringlist var_sortedTypeNames ;
    GALGAS_lstringlist var_unsortedTypeNames ;
    var_unifiedTypeMap.method_topologicalSort (var_sortedTypeNames, var_unsortedTypeNames, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 82)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTypeNames.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 86)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_s = GALGAS_string ("cannot sort types ; the following types are involved in circular dependence:") ;
      cEnumerator_lstringlist enumerator_3892 (var_unsortedTypeNames, kEnumeration_up) ;
      while (enumerator_3892.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_3892.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 89))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 89))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 89)) ;
        enumerator_3892.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (inCompiler->here (), var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 91)) ;
    }else if (kBoolFalse == test_3) {
      GALGAS_transientDependencyGraphNodeInfoList var_sortedTransientAndObservablePropertyNodes ;
      {
      routine_semanticAnalysis (var_unifiedTypeMap, var_sortedTypeNames, constinArgument_inSourceFile.mAttribute_string, var_cursorList, var_sortedTransientAndObservablePropertyNodes, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 93)) ;
      }
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 100)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        {
        routine_generateCode (var_sortedTransientAndObservablePropertyNodes, constinArgument_inSourceFile.mAttribute_string, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 101)) ;
        }
      }
    }
  }
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSString"), GALGAS_EXTypeKind::constructor_stringType (SOURCE_FILE ("easyBindings_program.gProgram", 113)), GALGAS_typeKind::constructor_stringType (SOURCE_FILE ("easyBindings_program.gProgram", 113))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 113))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 113)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSColor"), GALGAS_EXTypeKind::constructor_colorType (SOURCE_FILE ("easyBindings_program.gProgram", 114)), GALGAS_typeKind::constructor_colorType (SOURCE_FILE ("easyBindings_program.gProgram", 114))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 114))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 114)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSData"), GALGAS_EXTypeKind::constructor_dataType (SOURCE_FILE ("easyBindings_program.gProgram", 115)), GALGAS_typeKind::constructor_dataType (SOURCE_FILE ("easyBindings_program.gProgram", 115))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 115))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 115)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSDate"), GALGAS_EXTypeKind::constructor_dateType (SOURCE_FILE ("easyBindings_program.gProgram", 116)), GALGAS_typeKind::constructor_dateType (SOURCE_FILE ("easyBindings_program.gProgram", 116))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 116))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 116)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSFont"), GALGAS_EXTypeKind::constructor_fontType (SOURCE_FILE ("easyBindings_program.gProgram", 117)), GALGAS_typeKind::constructor_fontType (SOURCE_FILE ("easyBindings_program.gProgram", 117))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 117))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 117)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSImage"), GALGAS_EXTypeKind::constructor_imageType (SOURCE_FILE ("easyBindings_program.gProgram", 118)), GALGAS_typeKind::constructor_imageType (SOURCE_FILE ("easyBindings_program.gProgram", 118))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 118))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 118)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSMenu"), GALGAS_EXTypeKind::constructor_menuType (SOURCE_FILE ("easyBindings_program.gProgram", 119)), GALGAS_typeKind::constructor_menuType (SOURCE_FILE ("easyBindings_program.gProgram", 119))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 119))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 119)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSBezierPath"), GALGAS_EXTypeKind::constructor_bezierPathType (SOURCE_FILE ("easyBindings_program.gProgram", 120)), GALGAS_typeKind::constructor_bezierPathType (SOURCE_FILE ("easyBindings_program.gProgram", 120))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 120))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 120)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("Integer"), GALGAS_EXTypeKind::constructor_integerType (SOURCE_FILE ("easyBindings_program.gProgram", 121)), GALGAS_typeKind::constructor_integerType (SOURCE_FILE ("easyBindings_program.gProgram", 121))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 121))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 121)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("UInteger"), GALGAS_EXTypeKind::constructor_uintegerType (SOURCE_FILE ("easyBindings_program.gProgram", 122)), GALGAS_typeKind::constructor_uintegerType (SOURCE_FILE ("easyBindings_program.gProgram", 122))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 122))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 122)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("Bool"), GALGAS_EXTypeKind::constructor_boolType (SOURCE_FILE ("easyBindings_program.gProgram", 123)), GALGAS_typeKind::constructor_boolType (SOURCE_FILE ("easyBindings_program.gProgram", 123))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 123))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 123)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("Double"), GALGAS_EXTypeKind::constructor_doubleType (SOURCE_FILE ("easyBindings_program.gProgram", 124)), GALGAS_typeKind::constructor_doubleType (SOURCE_FILE ("easyBindings_program.gProgram", 124))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 124))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 124)) ;
  var_EXdeclarationList.addAssign_operation (GALGAS_EXpredefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("enum"), GALGAS_EXTypeKind::constructor_enumType (SOURCE_FILE ("easyBindings_program.gProgram", 125)), GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("easyBindings_program.gProgram", 125))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 125))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 125)) ;
  GALGAS_EXunifiedTypeMap var_EXunifiedTypeMap = GALGAS_EXunifiedTypeMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 127)) ;
  cEnumerator_EXastDeclarationList enumerator_6246 (var_EXdeclarationList, kEnumeration_up) ;
  while (enumerator_6246.hasCurrentObject ()) {
    callCategoryMethod_EXTypeInventory ((const cPtr_EXastDeclaration *) enumerator_6246.current_mDeclaration (HERE).ptr (), var_EXunifiedTypeMap, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 130)) ;
  ...
  if (kBoolTrue == test_5) {
    GALGAS_string var_s = var_EXunifiedTypeMap.reader_edgeGraphvizRepresentation (SOURCE_FILE ("easyBindings_program.gProgram", 133)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".EXclassDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 134)) ;
    GALGAS_bool joker_6578_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_6578_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 135)) ;
  }
  GALGAS_lstringlist var_EXunsolvedProxyList = var_EXunifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE ("easyBindings_program.gProgram", 138)) ;
  cEnumerator_lstringlist enumerator_6766 (var_EXunsolvedProxyList, kEnumeration_up) ;
  while (enumerator_6766.hasCurrentObject ()) {
    GALGAS_location location_6 (enumerator_6766.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_6, GALGAS_string ("type ").operator_concat (enumerator_6766.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 140))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 140)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 140))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 140)) ;
    enumerator_6766.gotoNextObject () ;
  }
  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_EXunsolvedProxyList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 143)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_7) {
    GALGAS_lstringlist var_sortedTypeNames ;
    GALGAS_lstringlist var_unsortedTypeNames ;
    var_EXunifiedTypeMap.method_topologicalSort (var_sortedTypeNames, var_unsortedTypeNames, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 144)) ;
    const enumGalgasBool test_8 = GALGAS_bool (kIsStrictSup, var_unsortedTypeNames.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 148)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_8) {
      GALGAS_string var_s = GALGAS_string ("cannot sort types ; the following types are involved in circular dependence:") ;
      cEnumerator_lstringlist enumerator_7256 (var_unsortedTypeNames, kEnumeration_up) ;
      while (enumerator_7256.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_7256.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 151))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 151))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 151)) ;
        enumerator_7256.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (inCompiler->here (), var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 153)) ;
    }else if (kBoolFalse == test_8) {
      {
      routine_EXsemanticAnalysis (var_EXunifiedTypeMap, var_sortedTypeNames, constinArgument_inSourceFile.mAttribute_string, var_cursorList, var_endOfSourceFile, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 160)) ;
      }
    }
  }
}
