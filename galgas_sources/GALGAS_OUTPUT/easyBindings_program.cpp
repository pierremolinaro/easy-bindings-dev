...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_sources = GALGAS_stringset::constructor_setWithString (GALGAS_string ("easy-bindings-utilities") COMMA_SOURCE_FILE_AT_LINE (102)) ;
  //-------- @plusEqualnstructionForGeneration
  var_sources.addAssign_operation (GALGAS_string ("PMAllocationDebug") COMMA_SOURCE_FILE_AT_LINE (103)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  cEnumerator_stringlist enumerator_3556 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (105)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_3556.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_sourceName = enumerator_3556.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (106)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_sources.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (107)) COMMA_SOURCE_FILE_AT_LINE (107)).boolEnum () ;
    if (kBoolTrue == test_0) {
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_string::class_method_generateFile (var_sourceDirectoryPath.operator_concat (enumerator_3556.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (109)) COMMA_SOURCE_FILE_AT_LINE (109)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_3556.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (111)), inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) ;
      } //-------- @routineCallInstructionForGeneration
    }
