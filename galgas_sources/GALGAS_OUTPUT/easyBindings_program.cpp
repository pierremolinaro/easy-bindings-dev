...
#ifndef DO_NOT_GENERATE_CHECKINGS
  static const char * kVersionString = "version " "1.0.0" " [debug]" ;
#else
  static const char * kVersionString = "version " "1.0.0" ;
#endif
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cEnumerator_stringlist enumerator_3208 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (90)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_3208.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_sourceName = enumerator_3208.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (91)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = var_sources.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (92)) COMMA_SOURCE_FILE_AT_LINE (92)).boolEnum () ;
    if (kBoolTrue == test_3) {
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_string::class_method_generateFile (var_sourceDirectoryPath.operator_concat (enumerator_3208.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (94)) COMMA_SOURCE_FILE_AT_LINE (94)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_3208.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (96)), inCompiler COMMA_SOURCE_FILE_AT_LINE (93)) ;
      } //-------- @routineCallInstructionForGeneration
    }
