...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  {
  routine_buildTransientDependencyGraph (constinArgument_inUnifiedTypeMap, constinArgument_inSourceFile, outArgument_outSortedTransientAndObservablePropertyNodes, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 116)) ;
  }
  GALGAS_templateControllerMap var_templateControllerMap ;
  {
  routine_buildControllerTemplateMap (constinArgument_inUnifiedTypeMap, constinArgument_inAstDeclarationStruct.mAttribute_mControllerTemplateList, var_templateControllerMap, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 122)) ;
  }
  GALGAS_outletClassMap var_outletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 128)) ;
  cEnumerator_outletClassDeclarationList enumerator_5637 (constinArgument_inAstDeclarationStruct.mAttribute_mOutletClassDeclarationList, kEnumeration_up) ;
  while (enumerator_5637.hasCurrentObject ()) {
    {
    var_outletClassMap.modifier_insertKey (enumerator_5637.current_mOutletClassName (HERE), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 130)) ;
    }
    enumerator_5637.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 133)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
    routine_typeAnalysis (constinArgument_inUnifiedTypeMap, var_outletClassMap, var_templateControllerMap, outArgument_outGeneration, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 134)) ;
    }
  }else if (kBoolFalse == test_0) {
    outArgument_outGeneration = GALGAS_structForGeneration::constructor_default (SOURCE_FILE ("easyBindings_program.gProgram", 141)) ;
  }
}
...
void routine_generateCode (const GALGAS_transientDependencyGraphNodeInfoList constinArgument_inSortedTransientAndObservablePropertyNodes,
                           ...
                           COMMA_UNUSED_LOCATION_ARGS) {
  {
  routine_generateTransients (constinArgument_inSourceFile, constinArgument_inSortedTransientAndObservablePropertyNodes, constinArgument_inGeneration.mAttribute_mTransientListForGeneration, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 156)) ;
  }
  {
  routine_generateActions (constinArgument_inSourceFile, constinArgument_inGeneration.mAttribute_mActionListForGeneration, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 161)) ;
  }
  ...
  {
  routine_generatePreferences (constinArgument_inGeneration.mAttribute_mPreferenceListForGeneration, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 166)) ;
  }
  {
  routine_generateOutletClasses (constinArgument_inGeneration.mAttribute_mNeededOutletClasses, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 170)) ;
  }
  {
  routine_generateControllerClasses (constinArgument_inGeneration.mAttribute_mControllerGenerationStringSet, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 174)) ;
  }
  {
  routine_generateSwiftApplicationFiles (var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 178)) ;
  }
}
...
void routine_generateSwiftApplicationFiles (const GALGAS_string constinArgument_inOutputDirectory,
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringlist temp_0 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 196)) ;
  temp_0.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 196)) ;
  temp_0.addAssign_operation (GALGAS_string ("easy-bindings-utilities")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 196)) ;
  GALGAS_stringlist var_swiftFiles = temp_0 ;
  GALGAS_stringlist temp_1 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 197)) ;
  temp_1.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 197)) ;
  GALGAS_stringlist var_xibFiles = temp_1 ;
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_swift_5F_sources) ;
  cEnumerator_stringlist enumerator_7737 (var_swiftFiles, kEnumeration_up) ;
  while (enumerator_7737.hasCurrentObject ()) {
    GALGAS_string var_contents = var_fw.reader_textFileContentsAtPath (enumerator_7737.current_mValue (HERE).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 200)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 200)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, enumerator_7737.current_mValue (HERE).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 203)), var_contents, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 201)) ;
    }
    enumerator_7737.gotoNextObject () ;
  }
  cEnumerator_stringlist enumerator_7943 (var_xibFiles, kEnumeration_up) ;
  while (enumerator_7943.hasCurrentObject ()) {
    GALGAS_string var_contents = var_fw.reader_textFileContentsAtPath (enumerator_7943.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 208)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 208)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, enumerator_7943.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 211)), var_contents, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 209)) ;
    }
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_astDeclarationStruct var_declarationStruct = GALGAS_astDeclarationStruct::constructor_default (SOURCE_FILE ("easyBindings_program.gProgram", 29)) ;
  GALGAS_location joker_1110_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 30))), GALGAS_bool (false), var_declarationStruct, joker_1110_0  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 30)) ;
  GALGAS_location var_endOfSourceFile ;
  var_endOfSourceFile.drop () ;
  cGrammar_easyBindings_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, GALGAS_bool (true), var_declarationStruct, var_endOfSourceFile  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 36)) ;
  ...
  GALGAS_unifiedTypeMap var_unifiedTypeMap = GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 55)) ;
  cEnumerator_astDeclarationList enumerator_2879 (var_declarationStruct.mAttribute_mDeclarationList, kEnumeration_up) ;
  while (enumerator_2879.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_2879.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 57)) ;
  ...
  if (kBoolTrue == test_0) {
    GALGAS_string var_s = var_unifiedTypeMap.reader_edgeGraphvizRepresentation (SOURCE_FILE ("easyBindings_program.gProgram", 60)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".classDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 61)) ;
    GALGAS_bool joker_3203_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3203_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 62)) ;
  }
  GALGAS_lstringlist var_unsolvedProxyList = var_unifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE ("easyBindings_program.gProgram", 65)) ;
  cEnumerator_lstringlist enumerator_3385 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3385.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3385.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3385.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 67))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 67)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 67))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 67)) ;
    enumerator_3385.gotoNextObject () ;
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_unsolvedProxyList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 70)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_lstringlist var_sortedTypeNames ;
    GALGAS_lstringlist var_unsortedTypeNames ;
    var_unifiedTypeMap.method_topologicalSort (var_sortedTypeNames, var_unsortedTypeNames, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 71)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTypeNames.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 75)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_s = GALGAS_string ("cannot sort types ; the following types are involved in circular dependence:") ;
      cEnumerator_lstringlist enumerator_3871 (var_unsortedTypeNames, kEnumeration_up) ;
      while (enumerator_3871.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_3871.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 78))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 78))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 78)) ;
        enumerator_3871.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (inCompiler->here (), var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 80)) ;
      ...
      {
      routine_semanticAnalysis (var_unifiedTypeMap, var_sortedTypeNames, constinArgument_inSourceFile.mAttribute_string, var_declarationStruct, var_sortedTransientAndObservablePropertyNodes, var_generation, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 82)) ;
      }
      const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 90)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_4) {
        {
        routine_generateCode (var_sortedTransientAndObservablePropertyNodes, var_generation, constinArgument_inSourceFile.mAttribute_string, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 91)) ;
        }
      }
    }
  }
