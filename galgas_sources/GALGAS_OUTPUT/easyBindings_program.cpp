...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  cEnumerator_lstringlist enumerator_5299 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_5299.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    GALGAS_ebType joker_5354_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_5299.current_mValue (HERE), joker_5354_0, var_declaration, inCompiler COMMA_SOURCE_FILE_AT_LINE (130)) ;
  ...
  cEnumerator_lstringlist enumerator_5993 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_5993.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    GALGAS_ebType joker_6048_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_5993.current_mValue (HERE), joker_6048_0, var_declaration, inCompiler COMMA_SOURCE_FILE_AT_LINE (153)) ;
  ...
  if (kBoolTrue == test_0) {
    cEnumerator_entityMap enumerator_6362 (var_contextAnalysisStruct.mAttribute_mEntityMap, kEnumeration_up) ;
    while (enumerator_6362.hasCurrentObject ()) {
      cEnumerator_relationshipMap enumerator_6403 (enumerator_6362.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
      while (enumerator_6403.hasCurrentObject ()) {
        GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
        GALGAS_string joker_6503_9 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6503_8 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6503_7 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6503_6 ; // Joker input parameter
        GALGAS_transientListForImplementation joker_6503_5 ; // Joker input parameter
        GALGAS_relationshipList joker_6503_4 ; // Joker input parameter
        GALGAS_relationshipList joker_6503_3 ; // Joker input parameter
        GALGAS_propertyMap joker_6503_2 ; // Joker input parameter
        GALGAS_relationshipMap joker_6503_1 ; // Joker input parameter
        GALGAS_fileInclusionSet joker_6578_2 ; // Joker input parameter
        GALGAS_signListForGeneration joker_6578_1 ; // Joker input parameter
        var_contextAnalysisStruct.mAttribute_mEntityMap.method_searchKey (enumerator_6403.current_mDestinationEntityName (HERE), joker_6503_9, joker_6503_8, joker_6503_7, joker_6503_6, joker_6503_5, joker_6503_4, joker_6503_3, joker_6503_2, joker_6503_1, var_destinationEntityRelationshipMap, joker_6578_2, joker_6578_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) ;
        ...
        GALGAS_lstring joker_6692_1 ; // Joker input parameter
        GALGAS_deleteRuleEnum joker_6792_0 ; // Joker input parameter
        var_destinationEntityRelationshipMap.method_searchKey (enumerator_6403.current_mInverseRelationshipName (HERE), joker_6692_2, joker_6692_1, var_inverseOfInverseRelationshipName, var_inverseIsToMany, joker_6792_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (174)) ;
        const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_6403.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_location location_2 (enumerator_6403.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_6403.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)) ;
        }
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_6403.current_mIsToMany (HERE).objectCompare (var_inverseIsToMany)).boolEnum () ;
        if (kBoolTrue == test_3) {
          ...
          GALGAS_location location_6 (enumerator_6403.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
  ...
  if (kBoolTrue == test_7) {
    cEnumerator_generationList enumerator_7340 (var_generationList, kEnumeration_up) ;
    while (enumerator_7340.hasCurrentObject ()) {
      callCategoryMethod_generate ((const cPtr_generation *) enumerator_7340.current_mGeneration (HERE).ptr (), var_outputDirectory, inCompiler COMMA_SOURCE_FILE_AT_LINE (193)) ;
  ...
  if (kBoolTrue == test_8) {
    ...
    GALGAS_bool joker_7884_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_7884_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (205)) ;
  }
  ...
  if (kBoolTrue == test_9) {
    ...
    if (kBoolTrue == test_10) {
      cEnumerator_stringlist enumerator_8302 (var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (212)), kEnumeration_up) ;
      while (enumerator_8302.hasCurrentObject ()) {
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_8302.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (213)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (213)) COMMA_SOURCE_FILE_AT_LINE (213)) ;
        enumerator_8302.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_10) {
      GALGAS_stringlist var_unsortedTransientList ;
      GALGAS_lstringlist joker_8533_0 ; // Joker input parameter
      GALGAS_lstringlist joker_8587_0 ; // Joker input parameter
      var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.method_topologicalSort (var_sortedTransientOrderedList, joker_8533_0, var_unsortedTransientList, joker_8587_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (216)) ;
      ...
      if (kBoolTrue == test_11) {
        ...
        cEnumerator_stringlist enumerator_8817 (var_unsortedTransientList, kEnumeration_up) ;
        while (enumerator_8817.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_8817.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (225)) COMMA_SOURCE_FILE_AT_LINE (225)) ;
  ...
  cEnumerator_stringlist enumerator_10181 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (262)), kEnumeration_up) ;
  while (enumerator_10181.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_10181.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (263)) ;
    ...
    if (kBoolTrue == test_14) {
      {
      GALGAS_string::class_method_generateFile (var_outputDirectory.operator_concat (enumerator_10181.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (266)) COMMA_SOURCE_FILE_AT_LINE (266)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_10181.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (268)), inCompiler COMMA_SOURCE_FILE_AT_LINE (265)) ;
      }
    }
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  {
  GALGAS_location joker_1538_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE_AT_LINE (45))), var_declarationList, var_cursorList, joker_1538_0 COMMA_SOURCE_FILE_AT_LINE (45)) ;
  }
  ...
  cEnumerator_astDeclarationList enumerator_3053 (var_declarationList, kEnumeration_up) ;
  while (enumerator_3053.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_3053.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (74)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bool joker_3391_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3391_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (79)) ;
  }
  GALGAS_lstringlist var_unsolvedProxyList = var_unifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE_AT_LINE (82)) ;
  cEnumerator_lstringlist enumerator_3588 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3588.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3588.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3588.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)).operator_concat (GALGAS_string (" is undefined") COMMA_SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)) ;
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_3) {
      ...
      cEnumerator_lstringlist enumerator_4035 (var_unsortedKeys, kEnumeration_up) ;
      while (enumerator_4035.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_4035.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (92)) COMMA_SOURCE_FILE_AT_LINE (92)) COMMA_SOURCE_FILE_AT_LINE (92)) ;
