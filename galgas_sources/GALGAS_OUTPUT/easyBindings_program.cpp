...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  GALGAS_classList var_classList = GALGAS_classList::constructor_emptyList (SOURCE_FILE_AT_LINE (34)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_entityList var_entityList = GALGAS_entityList::constructor_emptyList (SOURCE_FILE_AT_LINE (35)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_preferencesDeclarationList var_preferencesList = GALGAS_preferencesDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (36)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_outletClassList var_outletClassList = GALGAS_outletClassList::constructor_emptyList (SOURCE_FILE_AT_LINE (37)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_documentDeclarationList var_documentDeclarationList = GALGAS_documentDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (38)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_controllerClassList var_controllerClassList = GALGAS_controllerClassList::constructor_emptyList (SOURCE_FILE_AT_LINE (39)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_protocolList var_protocolList = GALGAS_protocolList::constructor_emptyList (SOURCE_FILE_AT_LINE (40)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_cursorList var_cursorList = GALGAS_cursorList::constructor_emptyList (SOURCE_FILE_AT_LINE (41)) ;
  { //---- @grammarInstructionWithSourceExpressionForGeneration
  GALGAS_location joker_1713_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE_AT_LINE (42))), var_classList, var_entityList, var_preferencesList, var_outletClassList, var_documentDeclarationList, var_controllerClassList, var_protocolList, var_cursorList, joker_1713_0 COMMA_SOURCE_FILE_AT_LINE (42)) ;
  ...
  //-------- @localVariableDeclarationForGeneration
  GALGAS_cursorMap var_cursorMap ;
  //-------- @localVariableDeclarationForGeneration
  ...
  routine_semanticAnalysis (var_cursorList, var_classList, var_entityList, var_preferencesList, var_outletClassList, var_documentDeclarationList, var_controllerClassList, var_protocolList, var_endOfSourceFile, constinArgument_inSourceFile.mAttribute_string, var_cursorMap, var_outletClassMap, var_controllerClassMap, var_classMap, var_entityMap, var_preferencesMap, var_documentMap, var_sortedTransientOrderedList, var_transientDependencyArcList, inCompiler COMMA_SOURCE_FILE_AT_LINE (66)) ;
  } //-------- @routineCallInstructionForGeneration
  ...
  { //-------- @routineCallInstructionForGeneration
  routine_generateCursorCode (var_cursorMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (94)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  ...
  cEnumerator_stringlist enumerator_3525 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (105)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_3525.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_sourceName = enumerator_3525.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (106)) ;
    ...
    if (kBoolTrue == test_0) {
      ...
      GALGAS_string::class_method_generateFile (var_sourceDirectoryPath.operator_concat (enumerator_3525.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (109)) COMMA_SOURCE_FILE_AT_LINE (109)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_3525.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (111)), inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) ;
      } //-------- @routineCallInstructionForGeneration
    }
