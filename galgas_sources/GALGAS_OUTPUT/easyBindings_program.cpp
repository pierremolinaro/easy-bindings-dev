...
const char * gWrapperFileContent_8_objective_5F_c_5F_sources = "#ifdef PM_COCOA_DEBUG\n"
  "\n"
  "//----------------------------------------------------------------------------*\n"
  "\n"
...
const char * gWrapperFileContent_9_objective_5F_c_5F_sources = "import Cocoa\n"
  "\n"
  "//-----------------------------------------------------------------------------*\n"
  "\n"
...
const char * gWrapperFileContent_10_objective_5F_c_5F_sources = "<\?xml version=\"1.0\" encoding=\"UTF-8\"\?>\n"
...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
                               ...
                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_outputDirectory = constinArgument_inSourceFile.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 116)) ;
  GALGAS_observablePropertyMapMap var_observablePropertyMapMap = GALGAS_observablePropertyMapMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 118)) ;
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE ("easyBindings_program.gProgram", 119)) ;
  cEnumerator_lstringlist enumerator_4902 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_4902.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    GALGAS_ebType joker_4959_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_4902.current_mValue (HERE), joker_4959_0, var_declaration, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 121)) ;
    callCategoryMethod_buildObservablePropertyMap ((const cPtr_astDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_observablePropertyMapMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 126)) ;
    enumerator_4902.gotoNextObject () ;
  }
  GALGAS_contextAnalysisStruct var_contextAnalysisStruct = GALGAS_contextAnalysisStruct::constructor_default (SOURCE_FILE ("easyBindings_program.gProgram", 132)) ;
  ...
  {
  routine_cursorAnalysis (constinArgument_inCursorList, var_contextAnalysisStruct, var_predefinedCursorList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 136)) ;
  }
  GALGAS_generationList var_generationList = GALGAS_generationList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 142)) ;
  cEnumerator_lstringlist enumerator_5596 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_5596.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    GALGAS_ebType joker_5653_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_5596.current_mValue (HERE), joker_5653_0, var_declaration, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 144)) ;
    callCategoryMethod_semanticAnalysis ((const cPtr_astDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_contextAnalysisStruct, var_generationList, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 149)) ;
    enumerator_5596.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 156)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_entityMap enumerator_5965 (var_contextAnalysisStruct.mAttribute_mEntityMap, kEnumeration_up) ;
    while (enumerator_5965.hasCurrentObject ()) {
      cEnumerator_relationshipMap enumerator_6006 (enumerator_5965.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
      while (enumerator_6006.hasCurrentObject ()) {
        GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
        GALGAS_string joker_6108_9 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6108_8 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6108_7 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6108_6 ; // Joker input parameter
        GALGAS_transientListForImplementation joker_6108_5 ; // Joker input parameter
        GALGAS_relationshipList joker_6108_4 ; // Joker input parameter
        GALGAS_relationshipList joker_6108_3 ; // Joker input parameter
        GALGAS_propertyMap joker_6108_2 ; // Joker input parameter
        GALGAS_relationshipMap joker_6108_1 ; // Joker input parameter
        GALGAS_fileInclusionSet joker_6183_2 ; // Joker input parameter
        GALGAS_signListForGeneration joker_6183_1 ; // Joker input parameter
        var_contextAnalysisStruct.mAttribute_mEntityMap.method_searchKey (enumerator_6006.current_mDestinationEntityName (HERE), joker_6108_9, joker_6108_8, joker_6108_7, joker_6108_6, joker_6108_5, joker_6108_4, joker_6108_3, joker_6108_2, joker_6108_1, var_destinationEntityRelationshipMap, joker_6183_2, joker_6183_1, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 159)) ;
        GALGAS_lstring var_inverseOfInverseRelationshipName ;
        GALGAS_bool var_inverseIsToMany ;
        GALGAS_bool joker_6297_2 ; // Joker input parameter
        GALGAS_lstring joker_6297_1 ; // Joker input parameter
        GALGAS_deleteRuleEnum joker_6397_0 ; // Joker input parameter
        var_destinationEntityRelationshipMap.method_searchKey (enumerator_6006.current_mInverseRelationshipName (HERE), joker_6297_2, joker_6297_1, var_inverseOfInverseRelationshipName, var_inverseIsToMany, joker_6397_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 165)) ;
        const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_6006.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_location location_2 (enumerator_6006.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_6006.current_lkey (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 173))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 173)).operator_concat (GALGAS_string ("' relationship as inverse")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 173))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 173)) ;
        }
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_6006.current_mIsToMany (HERE).objectCompare (var_inverseIsToMany)).boolEnum () ;
        if (kBoolTrue == test_3) {
          ...
          GALGAS_location location_6 (enumerator_6006.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_6, GALGAS_string ("the inverse relationship is ").operator_concat (temp_4  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 176))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 176)) ;
        }
  ...
  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 182)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_7) {
    cEnumerator_generationList enumerator_6943 (var_generationList, kEnumeration_up) ;
    while (enumerator_6943.hasCurrentObject ()) {
      callCategoryMethod_generate ((const cPtr_generation *) enumerator_6943.current_mGeneration (HERE).ptr (), var_outputDirectory, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 184)) ;
      enumerator_6943.gotoNextObject () ;
    }
    {
    routine_generateCursorCode (var_contextAnalysisStruct.mAttribute_mUserCursorMap, var_predefinedCursorList, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 186)) ;
    }
    {
    routine_generateEntityFactory (var_contextAnalysisStruct.mAttribute_mEntityMap, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 191)) ;
    }
  }
  const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 194)).objectCompare (GALGAS_uint ((uint32_t) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 194)).boolEnum () ;
  if (kBoolTrue == test_8) {
    GALGAS_string var_s = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_graphviz (SOURCE_FILE ("easyBindings_program.gProgram", 195)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.operator_concat (GALGAS_string (".transientDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 196)) ;
    GALGAS_bool joker_7569_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_7569_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 197)) ;
  }
  GALGAS__32_stringlist var_transientDependencyArcList = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_edges (SOURCE_FILE ("easyBindings_program.gProgram", 200)) ;
  GALGAS_stringlist var_sortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 201)) ;
  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 202)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_9) {
    const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE ("easyBindings_program.gProgram", 203)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_10) {
      cEnumerator_stringlist enumerator_7983 (var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE ("easyBindings_program.gProgram", 204)), kEnumeration_up) ;
      while (enumerator_7983.hasCurrentObject ()) {
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_7983.current_mValue (HERE)  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 205)).operator_concat (GALGAS_string ("' property is not defined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 205))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 205)) ;
        enumerator_7983.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_10) {
      GALGAS_stringlist var_unsortedTransientList ;
      GALGAS_lstringlist joker_8216_0 ; // Joker input parameter
      GALGAS_lstringlist joker_8270_0 ; // Joker input parameter
      var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.method_topologicalSort (var_sortedTransientOrderedList, joker_8216_0, var_unsortedTransientList, joker_8270_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 208)) ;
      const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 214)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_11) {
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 215)).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 215)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 215)) ;
        cEnumerator_stringlist enumerator_8498 (var_unsortedTransientList, kEnumeration_up) ;
        while (enumerator_8498.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_8498.current_mValue (HERE)  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 217))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 217)) ;
          enumerator_8498.gotoNextObject () ;
        }
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 219)) ;
      }
    }
  }
  {
  routine_generateTransientDependencyFiles (var_transientDependencyArcList, var_outputDirectory, var_sortedTransientOrderedList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 225)) ;
  }
  GALGAS_stringset var_extensionSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("xib") COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 231)) ;
  const enumGalgasBool test_12 = GALGAS_bool (gOption_easyBindings_5F_options_outputSwift.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("swift")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 233)) ;
  }else if (kBoolFalse == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("m")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 235)) ;
    var_extensionSet.addAssign_operation (GALGAS_string ("h")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 236)) ;
  }
  GALGAS_stringset var_generateSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("easyBindings_program.gProgram", 239)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("easy-bindings-utilities")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 240)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 241)) ;
  const enumGalgasBool test_13 = var_contextAnalysisStruct.mAttribute_mContainsDocument.boolEnum () ;
  if (kBoolTrue == test_13) {
    var_generateSet.addAssign_operation (GALGAS_string ("PMUndoManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 243)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedDocument")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 244)) ;
    ...
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 246)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+PMGZcompression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 247)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSMutableData+PMWrites")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 248)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 249)) ;
  }
  const enumGalgasBool test_14 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mEntityMap.reader_count (SOURCE_FILE ("easyBindings_program.gProgram", 251)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_14) {
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 252)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedObject")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 253)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMObjectManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 254)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMAttributeDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 255)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMRelationshipDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 256)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityArrayController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 257)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 258)) ;
  }
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  cEnumerator_stringlist enumerator_10090 (var_fw.reader_allTextFilePathes (SOURCE_FILE ("easyBindings_program.gProgram", 262)), kEnumeration_up) ;
  while (enumerator_10090.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_10090.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 263)) ;
    const enumGalgasBool test_15 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 264)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 264)).operator_and (var_extensionSet.reader_hasKey (var_sourceName.reader_pathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 264)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 264)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 264)).boolEnum () ;
    if (kBoolTrue == test_15) {
      {
      GALGAS_string::class_method_generateFile (var_outputDirectory.operator_concat (enumerator_10090.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 266))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 266)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_10090.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 268)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 265)) ;
      }
    }
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  GALGAS_location joker_1190_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 36))), var_declarationList, var_cursorList, joker_1190_0  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 36)) ;
  GALGAS_location var_endOfSourceFile ;
  var_endOfSourceFile.drop () ;
  cGrammar_easyBindings_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, var_declarationList, var_cursorList, var_endOfSourceFile  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 42)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSString"), GALGAS_typeKind::constructor_stringType (SOURCE_FILE ("easyBindings_program.gProgram", 48))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 48))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 48)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSColor"), GALGAS_typeKind::constructor_colorType (SOURCE_FILE ("easyBindings_program.gProgram", 49))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 49))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 49)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSData"), GALGAS_typeKind::constructor_dataType (SOURCE_FILE ("easyBindings_program.gProgram", 50))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 50))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 50)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSDate"), GALGAS_typeKind::constructor_dateType (SOURCE_FILE ("easyBindings_program.gProgram", 51))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 51))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 51)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSFont"), GALGAS_typeKind::constructor_fontType (SOURCE_FILE ("easyBindings_program.gProgram", 52))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 52))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 52)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSImage"), GALGAS_typeKind::constructor_imageType (SOURCE_FILE ("easyBindings_program.gProgram", 53))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 53))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 53)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSMenu"), GALGAS_typeKind::constructor_menuType (SOURCE_FILE ("easyBindings_program.gProgram", 54))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 54))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 54)) ;
  ...
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("Integer"), GALGAS_typeKind::constructor_integerType (SOURCE_FILE ("easyBindings_program.gProgram", 56))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 56))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 56)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("UInteger"), GALGAS_typeKind::constructor_uintegerType (SOURCE_FILE ("easyBindings_program.gProgram", 57))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 57))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 57)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("Bool"), GALGAS_typeKind::constructor_boolType (SOURCE_FILE ("easyBindings_program.gProgram", 58))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 58))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 58)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("Double"), GALGAS_typeKind::constructor_doubleType (SOURCE_FILE ("easyBindings_program.gProgram", 59))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 59))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 59)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("enum"), GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("easyBindings_program.gProgram", 60))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 60))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 60)) ;
  GALGAS_unifiedTypeMap var_unifiedTypeMap = GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 62)) ;
  cEnumerator_astDeclarationList enumerator_2703 (var_declarationList, kEnumeration_up) ;
  while (enumerator_2703.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_2703.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 65)) ;
  ...
  if (kBoolTrue == test_0) {
    GALGAS_string var_s = var_unifiedTypeMap.reader_edgeGraphvizRepresentation (SOURCE_FILE ("easyBindings_program.gProgram", 68)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".classDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 69)) ;
    GALGAS_bool joker_3027_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3027_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 70)) ;
  }
  GALGAS_lstringlist var_unsolvedProxyList = var_unifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE ("easyBindings_program.gProgram", 73)) ;
  cEnumerator_lstringlist enumerator_3209 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3209.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3209.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3209.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 75))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 75)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 75))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 75)) ;
    enumerator_3209.gotoNextObject () ;
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_unsolvedProxyList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 78)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_lstringlist var_sortedKeys ;
    GALGAS_lstringlist var_unsortedKeys ;
    var_unifiedTypeMap.method_topologicalSort (var_sortedKeys, var_unsortedKeys, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 79)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedKeys.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 80)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_s = GALGAS_string ("cannot sort types ; the following types are involved in circular dependence:") ;
      cEnumerator_lstringlist enumerator_3652 (var_unsortedKeys, kEnumeration_up) ;
      while (enumerator_3652.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_3652.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 83))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 83))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 83)) ;
        enumerator_3652.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (inCompiler->here (), var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 85)) ;
    }else if (kBoolFalse == test_3) {
      {
      routine_semanticAnalysis (var_unifiedTypeMap, var_sortedKeys, constinArgument_inSourceFile.mAttribute_string, var_cursorList, var_endOfSourceFile, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 92)) ;
      }
    }
  }
}
