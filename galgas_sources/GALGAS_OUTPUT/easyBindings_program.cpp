...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bool joker_3211 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3211, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 62)) ;
  }
