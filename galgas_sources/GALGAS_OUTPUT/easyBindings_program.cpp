...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  {
  routine_buildTransientDependencyGraph (constinArgument_inUnifiedTypeMap, constinArgument_inSourceFile, outArgument_outSortedTransientAndObservablePropertyNodes, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 189)) ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 195)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    {
    routine_typeAnalysis (constinArgument_inUnifiedTypeMap, outArgument_outTransientListForGeneration, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 196)) ;
    }
  }else if (kBoolFalse == test_0) {
    outArgument_outTransientListForGeneration = GALGAS_transientListForGeneration::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 201)) ;
  }
}
...
void routine_generateCode (const GALGAS_transientDependencyGraphNodeInfoList constinArgument_inSortedTransientAndObservablePropertyNodes,
                           ...
                           COMMA_UNUSED_LOCATION_ARGS) {
  {
  routine_generateTransients (constinArgument_inSourceFile, constinArgument_inSortedTransientAndObservablePropertyNodes, constinArgument_inTransientListForGeneration, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 216)) ;
  }
}
...
void routine_EXsemanticAnalysis (const GALGAS_EXunifiedTypeMap constinArgument_inUnifiedTypeMap,
                                 ...
                                 C_Compiler * inCompiler
                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_outputDirectory = constinArgument_inSourceFile.reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 236)) ;
  GALGAS_EXobservablePropertyMapMap var_observablePropertyMapMap = GALGAS_EXobservablePropertyMapMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 238)) ;
  GALGAS_EXtransientDependencyGraph var_transientDependencyGraph = GALGAS_EXtransientDependencyGraph::constructor_emptyGraph (SOURCE_FILE ("easyBindings_program.gProgram", 239)) ;
  cEnumerator_lstringlist enumerator_10492 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_10492.hasCurrentObject ()) {
    GALGAS_EXastDeclaration var_declaration ;
    GALGAS_EXebType joker_10549_0 ; // Joker input parameter
    GALGAS_EXentityRelationshipMap joker_10595_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_10492.current_mValue (HERE), joker_10549_0, var_declaration, joker_10595_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 241)) ;
    callCategoryMethod_buildObservablePropertyMap ((const cPtr_EXastDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_observablePropertyMapMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 247)) ;
    enumerator_10492.gotoNextObject () ;
  }
  GALGAS_EXcontextAnalysisStruct var_contextAnalysisStruct = GALGAS_EXcontextAnalysisStruct::constructor_default (SOURCE_FILE ("easyBindings_program.gProgram", 253)) ;
  ...
  {
  routine_cursorAnalysis (constinArgument_inCursorList, var_contextAnalysisStruct, var_predefinedCursorList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 257)) ;
  }
  GALGAS_generationList var_generationList = GALGAS_generationList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 263)) ;
  cEnumerator_lstringlist enumerator_11199 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_11199.hasCurrentObject ()) {
    GALGAS_EXastDeclaration var_declaration ;
    GALGAS_EXebType joker_11256_0 ; // Joker input parameter
    GALGAS_EXentityRelationshipMap joker_11302_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_11199.current_mValue (HERE), joker_11256_0, var_declaration, joker_11302_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 265)) ;
    callCategoryMethod_semanticAnalysis ((const cPtr_EXastDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_contextAnalysisStruct, var_generationList, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 271)) ;
    enumerator_11199.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 278)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_entityMap enumerator_11579 (var_contextAnalysisStruct.mAttribute_mEntityMap, kEnumeration_up) ;
    while (enumerator_11579.hasCurrentObject ()) {
      cEnumerator_relationshipMap enumerator_11620 (enumerator_11579.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
      while (enumerator_11620.hasCurrentObject ()) {
        GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
        GALGAS_string joker_11722_9 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_11722_8 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_11722_7 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_11722_6 ; // Joker input parameter
        GALGAS_transientListForImplementation joker_11722_5 ; // Joker input parameter
        GALGAS_relationshipList joker_11722_4 ; // Joker input parameter
        GALGAS_relationshipList joker_11722_3 ; // Joker input parameter
        GALGAS_propertyMap joker_11722_2 ; // Joker input parameter
        GALGAS_relationshipMap joker_11722_1 ; // Joker input parameter
        GALGAS_fileInclusionSet joker_11797_2 ; // Joker input parameter
        GALGAS_signListForGeneration joker_11797_1 ; // Joker input parameter
        var_contextAnalysisStruct.mAttribute_mEntityMap.method_searchKey (enumerator_11620.current_mDestinationEntityName (HERE), joker_11722_9, joker_11722_8, joker_11722_7, joker_11722_6, joker_11722_5, joker_11722_4, joker_11722_3, joker_11722_2, joker_11722_1, var_destinationEntityRelationshipMap, joker_11797_2, joker_11797_1, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 281)) ;
        GALGAS_lstring var_inverseOfInverseRelationshipName ;
        GALGAS_bool var_inverseIsToMany ;
        GALGAS_bool joker_11911_2 ; // Joker input parameter
        GALGAS_lstring joker_11911_1 ; // Joker input parameter
        GALGAS_deleteRuleEnum joker_12011_0 ; // Joker input parameter
        var_destinationEntityRelationshipMap.method_searchKey (enumerator_11620.current_mInverseRelationshipName (HERE), joker_11911_2, joker_11911_1, var_inverseOfInverseRelationshipName, var_inverseIsToMany, joker_12011_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 287)) ;
        const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_11620.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_location location_2 (enumerator_11620.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_11620.current_lkey (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 295))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 295)).operator_concat (GALGAS_string ("' relationship as inverse")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 295))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 295)) ;
        }
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_11620.current_mIsToMany (HERE).objectCompare (var_inverseIsToMany)).boolEnum () ;
        if (kBoolTrue == test_3) {
          ...
          GALGAS_location location_6 (enumerator_11620.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_6, GALGAS_string ("the inverse relationship is ").operator_concat (temp_4  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 298))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 298)) ;
        }
  ...
  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 304)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_7) {
    cEnumerator_generationList enumerator_12557 (var_generationList, kEnumeration_up) ;
    while (enumerator_12557.hasCurrentObject ()) {
      callCategoryMethod_generate ((const cPtr_generation *) enumerator_12557.current_mGeneration (HERE).ptr (), var_outputDirectory, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 306)) ;
      enumerator_12557.gotoNextObject () ;
    }
    {
    routine_generateCursorCode (var_contextAnalysisStruct.mAttribute_mUserCursorMap, var_predefinedCursorList, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 308)) ;
    }
    {
    routine_generateEntityFactory (var_contextAnalysisStruct.mAttribute_mEntityMap, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 313)) ;
    }
  }
  ...
  if (kBoolTrue == test_8) {
    GALGAS_string var_s = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_graphviz (SOURCE_FILE ("easyBindings_program.gProgram", 317)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.operator_concat (GALGAS_string (".EXtransientDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 318)) ;
    GALGAS_bool joker_13185_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_13185_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 319)) ;
  }
  GALGAS__32_stringlist var_transientDependencyArcList = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_edges (SOURCE_FILE ("easyBindings_program.gProgram", 322)) ;
  GALGAS_stringlist var_sortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 323)) ;
  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE ("easyBindings_program.gProgram", 324)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_9) {
    const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE ("easyBindings_program.gProgram", 325)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_10) {
      cEnumerator_stringlist enumerator_13599 (var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE ("easyBindings_program.gProgram", 326)), kEnumeration_up) ;
      while (enumerator_13599.hasCurrentObject ()) {
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_13599.current_mValue (HERE)  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 327)).operator_concat (GALGAS_string ("' property is not defined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 327))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 327)) ;
        enumerator_13599.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_10) {
      GALGAS_stringlist var_unsortedTransientList ;
      GALGAS_lstringlist joker_13832_0 ; // Joker input parameter
      GALGAS_lstringlist joker_13886_0 ; // Joker input parameter
      var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.method_topologicalSort (var_sortedTransientOrderedList, joker_13832_0, var_unsortedTransientList, joker_13886_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 330)) ;
      const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 336)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_11) {
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 337)).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 337)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 337)) ;
        cEnumerator_stringlist enumerator_14114 (var_unsortedTransientList, kEnumeration_up) ;
        while (enumerator_14114.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_14114.current_mValue (HERE)  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 339))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 339)) ;
          enumerator_14114.gotoNextObject () ;
        }
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 341)) ;
      }
    }
  }
  {
  routine_generateTransientTrigersAndApplication (var_transientDependencyArcList, var_outputDirectory, var_sortedTransientOrderedList, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 347)) ;
  }
  GALGAS_stringset var_extensionSet = GALGAS_stringset::constructor_setWithString (GALGAS_string ("xib") COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 353)) ;
  const enumGalgasBool test_12 = GALGAS_bool (gOption_easyBindings_5F_options_outputSwift.reader_value ()).boolEnum () ;
  if (kBoolTrue == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("swift")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 355)) ;
  }else if (kBoolFalse == test_12) {
    var_extensionSet.addAssign_operation (GALGAS_string ("m")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 357)) ;
    var_extensionSet.addAssign_operation (GALGAS_string ("h")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 358)) ;
  }
  GALGAS_stringset var_generateSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("easyBindings_program.gProgram", 361)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("easy-bindings-utilities")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 362)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 363)) ;
  const enumGalgasBool test_13 = var_contextAnalysisStruct.mAttribute_mContainsDocument.boolEnum () ;
  if (kBoolTrue == test_13) {
    var_generateSet.addAssign_operation (GALGAS_string ("PMUndoManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 365)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedDocument")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 366)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 367)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 368)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+PMGZcompression")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 369)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSMutableData+PMWrites")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 370)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 371)) ;
  }
  const enumGalgasBool test_14 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mEntityMap.reader_count (SOURCE_FILE ("easyBindings_program.gProgram", 373)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_14) {
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 374)) ;
    ...
    var_generateSet.addAssign_operation (GALGAS_string ("PMAttributeDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 377)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMRelationshipDescription")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 378)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityArrayController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 379)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityController")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 380)) ;
  }
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  cEnumerator_stringlist enumerator_15712 (var_fw.reader_allTextFilePathes (SOURCE_FILE ("easyBindings_program.gProgram", 384)), kEnumeration_up) ;
  while (enumerator_15712.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_15712.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 385)) ;
    const enumGalgasBool test_15 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 386)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 386)).operator_and (var_extensionSet.reader_hasKey (var_sourceName.reader_pathExtension (SOURCE_FILE ("easyBindings_program.gProgram", 386)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 386)) COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 386)).boolEnum () ;
    if (kBoolTrue == test_15) {
      {
      GALGAS_string::class_method_generateFile (var_outputDirectory.operator_concat (enumerator_15712.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE ("easyBindings_program.gProgram", 388))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 388)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_15712.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 390)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 387)) ;
      }
    }
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_astDeclarationList var_declarationList = GALGAS_astDeclarationList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 33)) ;
  GALGAS_EXastDeclarationList var_EXdeclarationList = GALGAS_EXastDeclarationList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 34)) ;
  GALGAS_cursorList var_cursorList = GALGAS_cursorList::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 36)) ;
  GALGAS_location joker_1291_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 37))), GALGAS_bool (false), var_declarationList, var_EXdeclarationList, var_cursorList, joker_1291_0  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 37)) ;
  GALGAS_location var_endOfSourceFile ;
  var_endOfSourceFile.drop () ;
  cGrammar_easyBindings_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, GALGAS_bool (true), var_declarationList, var_EXdeclarationList, var_cursorList, var_endOfSourceFile  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 45)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool (false), GALGAS_string ("NSString"), GALGAS_typeKind::constructor_stringType (SOURCE_FILE ("easyBindings_program.gProgram", 53))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 53))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 53)) ;
  ...
  GALGAS_unifiedTypeMap var_unifiedTypeMap = GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE ("easyBindings_program.gProgram", 67)) ;
  cEnumerator_astDeclarationList enumerator_2935 (var_declarationList, kEnumeration_up) ;
  while (enumerator_2935.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_2935.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 69)) ;
  ...
  if (kBoolTrue == test_0) {
    GALGAS_string var_s = var_unifiedTypeMap.reader_edgeGraphvizRepresentation (SOURCE_FILE ("easyBindings_program.gProgram", 72)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".classDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 73)) ;
    GALGAS_bool joker_3259_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3259_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 74)) ;
  }
  GALGAS_lstringlist var_unsolvedProxyList = var_unifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE ("easyBindings_program.gProgram", 77)) ;
  cEnumerator_lstringlist enumerator_3441 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3441.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3441.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3441.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 79))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 79)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 79))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 79)) ;
    enumerator_3441.gotoNextObject () ;
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_unsolvedProxyList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 82)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_lstringlist var_sortedTypeNames ;
    GALGAS_lstringlist var_unsortedTypeNames ;
    var_unifiedTypeMap.method_topologicalSort (var_sortedTypeNames, var_unsortedTypeNames, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 83)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTypeNames.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 87)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_s = GALGAS_string ("cannot sort types ; the following types are involved in circular dependence:") ;
      cEnumerator_lstringlist enumerator_3927 (var_unsortedTypeNames, kEnumeration_up) ;
      while (enumerator_3927.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_3927.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 90))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 90))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 90)) ;
        enumerator_3927.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (inCompiler->here (), var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 92)) ;
  ...
  if (kBoolTrue == test_5) {
    GALGAS_string var_s = var_EXunifiedTypeMap.reader_edgeGraphvizRepresentation (SOURCE_FILE ("easyBindings_program.gProgram", 136)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".EXclassDependancyGraph.dot")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 137)) ;
    GALGAS_bool joker_6716_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_6716_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 138)) ;
  }
  GALGAS_lstringlist var_EXunsolvedProxyList = var_EXunifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE ("easyBindings_program.gProgram", 141)) ;
  cEnumerator_lstringlist enumerator_6904 (var_EXunsolvedProxyList, kEnumeration_up) ;
  while (enumerator_6904.hasCurrentObject ()) {
    GALGAS_location location_6 (enumerator_6904.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_6, GALGAS_string ("type ").operator_concat (enumerator_6904.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 143))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 143)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 143))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 143)) ;
    enumerator_6904.gotoNextObject () ;
  }
  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, var_EXunsolvedProxyList.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 146)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_7) {
    GALGAS_lstringlist var_sortedTypeNames ;
    GALGAS_lstringlist var_unsortedTypeNames ;
    var_EXunifiedTypeMap.method_topologicalSort (var_sortedTypeNames, var_unsortedTypeNames, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 147)) ;
    const enumGalgasBool test_8 = GALGAS_bool (kIsStrictSup, var_unsortedTypeNames.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 151)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_8) {
      GALGAS_string var_s = GALGAS_string ("cannot sort types ; the following types are involved in circular dependence:") ;
      cEnumerator_lstringlist enumerator_7394 (var_unsortedTypeNames, kEnumeration_up) ;
      while (enumerator_7394.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_7394.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 154))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 154))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 154)) ;
        enumerator_7394.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (inCompiler->here (), var_s  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 156)) ;
    }else if (kBoolFalse == test_8) {
      {
      routine_EXsemanticAnalysis (var_EXunifiedTypeMap, var_sortedTypeNames, constinArgument_inSourceFile.mAttribute_string, var_cursorList, var_endOfSourceFile, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 163)) ;
      }
    }
  }
}
