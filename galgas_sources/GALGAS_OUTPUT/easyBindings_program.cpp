...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  GALGAS__32_stringlist var_transientDependencyArcList = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_arcs (SOURCE_FILE_AT_LINE (208)) ;
  ...
  if (kBoolTrue == test_9) {
    ...
    if (kBoolTrue == test_10) {
      cEnumerator_stringlist enumerator_8301 (var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (212)), kEnumeration_up) ;
      while (enumerator_8301.hasCurrentObject ()) {
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_8301.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (213)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (213)) COMMA_SOURCE_FILE_AT_LINE (213)) ;
      ...
      if (kBoolTrue == test_11) {
        ...
        cEnumerator_stringlist enumerator_8816 (var_unsortedTransientList, kEnumeration_up) ;
        while (enumerator_8816.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_8816.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (225)) COMMA_SOURCE_FILE_AT_LINE (225)) ;
  ...
  cEnumerator_stringlist enumerator_10180 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (262)), kEnumeration_up) ;
  while (enumerator_10180.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_10180.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (263)) ;
    ...
    if (kBoolTrue == test_14) {
      {
      GALGAS_string::class_method_generateFile (var_outputDirectory.operator_concat (enumerator_10180.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (266)) COMMA_SOURCE_FILE_AT_LINE (266)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_10180.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (268)), inCompiler COMMA_SOURCE_FILE_AT_LINE (265)) ;
      }
    }
