...
void routine_generateSwiftApplicationFiles (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  cEnumerator_stringlist enumerator_8263 (var_swiftFiles, kEnumeration_up) ;
  while (enumerator_8263.hasCurrentObject ()) {
    GALGAS_string var_contents = var_fw.reader_textFileContentsAtPath (enumerator_8263.current_mValue (HERE).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 220)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 220)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, enumerator_8263.current_mValue (HERE).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 223)), var_contents, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 221)) ;
    }
    enumerator_8263.gotoNextObject () ;
  }
  cEnumerator_stringlist enumerator_8469 (var_xibFiles, kEnumeration_up) ;
  while (enumerator_8469.hasCurrentObject ()) {
    GALGAS_string var_contents = var_fw.reader_textFileContentsAtPath (enumerator_8469.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 228)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 228)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, enumerator_8469.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 231)), var_contents, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 229)) ;
    }
