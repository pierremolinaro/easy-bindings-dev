...
void routine_generateSwiftApplicationFiles (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  cEnumerator_stringlist enumerator_8327 (var_swiftFiles, kEnumeration_up) ;
  while (enumerator_8327.hasCurrentObject ()) {
    GALGAS_string var_contents = var_fw.reader_textFileContentsAtPath (enumerator_8327.current_mValue (HERE).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 223)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 223)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, enumerator_8327.current_mValue (HERE).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 226)), var_contents, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 224)) ;
    }
    enumerator_8327.gotoNextObject () ;
  }
  cEnumerator_stringlist enumerator_8533 (var_xibFiles, kEnumeration_up) ;
  while (enumerator_8533.hasCurrentObject ()) {
    GALGAS_string var_contents = var_fw.reader_textFileContentsAtPath (enumerator_8533.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 231)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 231)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, enumerator_8533.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 234)), var_contents, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 232)) ;
    }
