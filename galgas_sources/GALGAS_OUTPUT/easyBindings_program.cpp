...
void routine_enterPredefinedType (GALGAS_unifiedTypeMap & ioArgument_ioUnifiedTypeMap,
                                  ...
                                  const GALGAS_easyBindingType constinArgument_inType,
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  {
  ioArgument_ioUnifiedTypeMap.modifier_insertKey (constinArgument_inTypeName.reader_nowhere (SOURCE_FILE_AT_LINE (52)), constinArgument_inType, inCompiler COMMA_SOURCE_FILE_AT_LINE (51)) ;
  }
}
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_classList var_classList = GALGAS_classList::constructor_emptyList (SOURCE_FILE_AT_LINE (63)) ;
  GALGAS_entityList var_entityList = GALGAS_entityList::constructor_emptyList (SOURCE_FILE_AT_LINE (64)) ;
  GALGAS_preferencesDeclarationList var_preferencesList = GALGAS_preferencesDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (65)) ;
  GALGAS_nibClassDeclarationList var_nibClassList = GALGAS_nibClassDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (66)) ;
  GALGAS_outletClassList var_outletClassList = GALGAS_outletClassList::constructor_emptyList (SOURCE_FILE_AT_LINE (67)) ;
  GALGAS_documentDeclarationList var_documentDeclarationList = GALGAS_documentDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (68)) ;
  GALGAS_controllerClassList var_controllerClassList = GALGAS_controllerClassList::constructor_emptyList (SOURCE_FILE_AT_LINE (69)) ;
  GALGAS_protocolList var_protocolList = GALGAS_protocolList::constructor_emptyList (SOURCE_FILE_AT_LINE (70)) ;
  GALGAS_cursorList var_cursorList = GALGAS_cursorList::constructor_emptyList (SOURCE_FILE_AT_LINE (71)) ;
  GALGAS_structTypeList var_structTypeList = GALGAS_structTypeList::constructor_emptyList (SOURCE_FILE_AT_LINE (72)) ;
  GALGAS_enumList var_enumList = GALGAS_enumList::constructor_emptyList (SOURCE_FILE_AT_LINE (73)) ;
  {
  GALGAS_location joker_2763_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE_AT_LINE (74))), var_classList, var_entityList, var_preferencesList, var_nibClassList, var_outletClassList, var_documentDeclarationList, var_controllerClassList, var_protocolList, var_cursorList, var_enumList, var_structTypeList, joker_2763_0 COMMA_SOURCE_FILE_AT_LINE (74)) ;
  }
  ...
  GALGAS_unifiedTypeMap var_unifiedTypeMap = GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (104)) ;
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSString"), GALGAS_stringType::constructor_new (SOURCE_FILE_AT_LINE (105)), inCompiler COMMA_SOURCE_FILE_AT_LINE (105)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSColor"), GALGAS_colorType::constructor_new (SOURCE_FILE_AT_LINE (106)), inCompiler COMMA_SOURCE_FILE_AT_LINE (106)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSData"), GALGAS_dataType::constructor_new (SOURCE_FILE_AT_LINE (107)), inCompiler COMMA_SOURCE_FILE_AT_LINE (107)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSDate"), GALGAS_dateType::constructor_new (SOURCE_FILE_AT_LINE (108)), inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSFont"), GALGAS_fontType::constructor_new (SOURCE_FILE_AT_LINE (109)), inCompiler COMMA_SOURCE_FILE_AT_LINE (109)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSImage"), GALGAS_imageType::constructor_new (SOURCE_FILE_AT_LINE (110)), inCompiler COMMA_SOURCE_FILE_AT_LINE (110)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSMenu"), GALGAS_menuType::constructor_new (SOURCE_FILE_AT_LINE (111)), inCompiler COMMA_SOURCE_FILE_AT_LINE (111)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("NSBezierPath"), GALGAS_bezierPathType::constructor_new (SOURCE_FILE_AT_LINE (112)), inCompiler COMMA_SOURCE_FILE_AT_LINE (112)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("Integer"), GALGAS_integerType::constructor_new (SOURCE_FILE_AT_LINE (113)), inCompiler COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("UInteger"), GALGAS_uintegerType::constructor_new (SOURCE_FILE_AT_LINE (114)), inCompiler COMMA_SOURCE_FILE_AT_LINE (114)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("Bool"), GALGAS_boolType::constructor_new (SOURCE_FILE_AT_LINE (115)), inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("Double"), GALGAS_doubleType::constructor_new (SOURCE_FILE_AT_LINE (116)), inCompiler COMMA_SOURCE_FILE_AT_LINE (116)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("AnyScalar"), GALGAS_anyScalarType::constructor_new (SOURCE_FILE_AT_LINE (117)), inCompiler COMMA_SOURCE_FILE_AT_LINE (117)) ;
  }
  {
  routine_enterPredefinedType (var_unifiedTypeMap, GALGAS_string ("AnyNumber"), GALGAS_anyNumberType::constructor_new (SOURCE_FILE_AT_LINE (118)), inCompiler COMMA_SOURCE_FILE_AT_LINE (118)) ;
  }
  {
  routine_enumEnterType (var_enumList, var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (120)) ;
  }
  {
  routine_structEnterType (var_structTypeList, var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (125)) ;
  }
  GALGAS_protocolMap var_protocolMap = GALGAS_protocolMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (130)) ;
  cEnumerator_protocolList enumerator_4458 (var_protocolList, kEnumeration_up) ;
  while (enumerator_4458.hasCurrentObject ()) {
    {
    var_unifiedTypeMap.modifier_insertKey (enumerator_4458.current_mProtocolName (HERE), GALGAS_protocolType::constructor_new (enumerator_4458.current_mIsPredefined (HERE) COMMA_SOURCE_FILE_AT_LINE (134)), inCompiler COMMA_SOURCE_FILE_AT_LINE (132)) ;
    }
    enumerator_4458.gotoNextObject () ;
  }
  {
  routine_outletClassesEnterType (var_outletClassList, var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (138)) ;
  }
  {
  routine_controllerClassesEnterType (var_controllerClassList, var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (143)) ;
  }
  {
  routine_classesEnterType (var_classList, var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }
  {
  routine_preferencesEnterTypes (var_preferencesList, var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (153)) ;
  }
  {
  routine_entitiesEnterTypes (var_entityList, var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) ;
  }
  {
  routine_nibClassesEnterTypes (var_nibClassList, var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (163)) ;
  }
  {
  routine_documentsEnterTypes (var_documentDeclarationList, var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) ;
  }
  cEnumerator_lstringlist enumerator_5262 (var_unifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE_AT_LINE (173)), kEnumeration_up) ;
  while (enumerator_5262.hasCurrentObject ()) {
    GALGAS_location location_0 (enumerator_5262.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_0, GALGAS_string ("type ").operator_concat (enumerator_5262.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (174)).operator_concat (GALGAS_string (" is undefined") COMMA_SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (174)) ;
    enumerator_5262.gotoNextObject () ;
  }
  GALGAS_contextAnalysisStruct var_contextAnalysisStruct = GALGAS_contextAnalysisStruct::constructor_default (SOURCE_FILE_AT_LINE (177)) ;
  GALGAS_stringlist var_predefinedCursorList ;
  {
  routine_cursorAnalysis (var_cursorList, var_contextAnalysisStruct, var_predefinedCursorList, inCompiler COMMA_SOURCE_FILE_AT_LINE (179)) ;
  }
}
