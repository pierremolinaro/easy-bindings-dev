...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                  ...
                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_classList var_classList = GALGAS_classList::constructor_emptyList (SOURCE_FILE_AT_LINE (47)) ;
  GALGAS_entityList var_entityList = GALGAS_entityList::constructor_emptyList (SOURCE_FILE_AT_LINE (48)) ;
  GALGAS_preferencesDeclarationList var_preferencesList = GALGAS_preferencesDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (49)) ;
  GALGAS_nibClassDeclarationList var_nibClassList = GALGAS_nibClassDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (50)) ;
  GALGAS_outletClassList var_outletClassList = GALGAS_outletClassList::constructor_emptyList (SOURCE_FILE_AT_LINE (51)) ;
  GALGAS_documentDeclarationList var_documentDeclarationList = GALGAS_documentDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (52)) ;
  GALGAS_controllerClassList var_controllerClassList = GALGAS_controllerClassList::constructor_emptyList (SOURCE_FILE_AT_LINE (53)) ;
  GALGAS_protocolList var_protocolList = GALGAS_protocolList::constructor_emptyList (SOURCE_FILE_AT_LINE (54)) ;
  GALGAS_cursorList var_cursorList = GALGAS_cursorList::constructor_emptyList (SOURCE_FILE_AT_LINE (55)) ;
  GALGAS_structTypeList var_structTypeList = GALGAS_structTypeList::constructor_emptyList (SOURCE_FILE_AT_LINE (56)) ;
  GALGAS_enumList var_enumList = GALGAS_enumList::constructor_emptyList (SOURCE_FILE_AT_LINE (57)) ;
  {
  GALGAS_location joker_2378_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE_AT_LINE (58))), var_classList, var_entityList, var_preferencesList, var_nibClassList, var_outletClassList, var_documentDeclarationList, var_controllerClassList, var_protocolList, var_cursorList, var_enumList, var_structTypeList, joker_2378_0 COMMA_SOURCE_FILE_AT_LINE (58)) ;
  }
  ...
  GALGAS_unifiedTypeMap var_unifiedTypeMap = GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (88)) ;
  {
  var_unifiedTypeMap.modifier_insertKey (GALGAS_string ("NSString").reader_nowhere (SOURCE_FILE_AT_LINE (89)), GALGAS_unifiedTypeKind::constructor_stringType (SOURCE_FILE_AT_LINE (89)), inCompiler COMMA_SOURCE_FILE_AT_LINE (89)) ;
  }
  {
  var_unifiedTypeMap.modifier_insertKey (GALGAS_string ("NSColor").reader_nowhere (SOURCE_FILE_AT_LINE (90)), GALGAS_unifiedTypeKind::constructor_colorType (SOURCE_FILE_AT_LINE (90)), inCompiler COMMA_SOURCE_FILE_AT_LINE (90)) ;
  }
  {
  var_unifiedTypeMap.modifier_insertKey (GALGAS_string ("NSData").reader_nowhere (SOURCE_FILE_AT_LINE (91)), GALGAS_unifiedTypeKind::constructor_dataType (SOURCE_FILE_AT_LINE (91)), inCompiler COMMA_SOURCE_FILE_AT_LINE (91)) ;
  }
  {
  var_unifiedTypeMap.modifier_insertKey (GALGAS_string ("NSDate").reader_nowhere (SOURCE_FILE_AT_LINE (92)), GALGAS_unifiedTypeKind::constructor_dateType (SOURCE_FILE_AT_LINE (92)), inCompiler COMMA_SOURCE_FILE_AT_LINE (92)) ;
  }
  {
  var_unifiedTypeMap.modifier_insertKey (GALGAS_string ("NSFont").reader_nowhere (SOURCE_FILE_AT_LINE (93)), GALGAS_unifiedTypeKind::constructor_fontType (SOURCE_FILE_AT_LINE (93)), inCompiler COMMA_SOURCE_FILE_AT_LINE (93)) ;
  }
  {
  var_unifiedTypeMap.modifier_insertKey (GALGAS_string ("NSImage").reader_nowhere (SOURCE_FILE_AT_LINE (94)), GALGAS_unifiedTypeKind::constructor_imageType (SOURCE_FILE_AT_LINE (94)), inCompiler COMMA_SOURCE_FILE_AT_LINE (94)) ;
  }
  {
  var_unifiedTypeMap.modifier_insertKey (GALGAS_string ("NSBezierPath").reader_nowhere (SOURCE_FILE_AT_LINE (95)), GALGAS_unifiedTypeKind::constructor_bezierPathType (SOURCE_FILE_AT_LINE (95)), inCompiler COMMA_SOURCE_FILE_AT_LINE (95)) ;
  }
  {
  var_unifiedTypeMap.modifier_insertKey (GALGAS_string ("integer").reader_nowhere (SOURCE_FILE_AT_LINE (96)), GALGAS_unifiedTypeKind::constructor_integerType (SOURCE_FILE_AT_LINE (96)), inCompiler COMMA_SOURCE_FILE_AT_LINE (96)) ;
  }
  {
  var_unifiedTypeMap.modifier_insertKey (GALGAS_string ("uinteger").reader_nowhere (SOURCE_FILE_AT_LINE (97)), GALGAS_unifiedTypeKind::constructor_uintegerType (SOURCE_FILE_AT_LINE (97)), inCompiler COMMA_SOURCE_FILE_AT_LINE (97)) ;
  }
  {
  var_unifiedTypeMap.modifier_insertKey (GALGAS_string ("decimal").reader_nowhere (SOURCE_FILE_AT_LINE (98)), GALGAS_unifiedTypeKind::constructor_decimalType (SOURCE_FILE_AT_LINE (98)), inCompiler COMMA_SOURCE_FILE_AT_LINE (98)) ;
  }
  {
  var_unifiedTypeMap.modifier_insertKey (GALGAS_string ("bool").reader_nowhere (SOURCE_FILE_AT_LINE (99)), GALGAS_unifiedTypeKind::constructor_boolType (SOURCE_FILE_AT_LINE (99)), inCompiler COMMA_SOURCE_FILE_AT_LINE (99)) ;
  }
  {
  var_unifiedTypeMap.modifier_insertKey (GALGAS_string ("double").reader_nowhere (SOURCE_FILE_AT_LINE (100)), GALGAS_unifiedTypeKind::constructor_doubleType (SOURCE_FILE_AT_LINE (100)), inCompiler COMMA_SOURCE_FILE_AT_LINE (100)) ;
  }
  GALGAS_contextAnalysisStruct var_contextAnalysisStruct = GALGAS_contextAnalysisStruct::constructor_default (SOURCE_FILE_AT_LINE (102)) ;
  GALGAS_stringlist var_predefinedCursorList ;
  {
  routine_cursorAnalysis (var_cursorList, var_contextAnalysisStruct, var_predefinedCursorList, inCompiler COMMA_SOURCE_FILE_AT_LINE (104)) ;
  }
  {
  routine_enumAnalysis (var_enumList, var_contextAnalysisStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (110)) ;
  }
  {
  routine_structAnalysis (var_structTypeList, var_contextAnalysisStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) ;
  }
  GALGAS_protocolMap var_protocolMap = GALGAS_protocolMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (120)) ;
  cEnumerator_protocolList enumerator_4359 (var_protocolList, kEnumeration_up) ;
  while (enumerator_4359.hasCurrentObject ()) {
    {
    var_protocolMap.modifier_insertKey (enumerator_4359.current_mProtocolName (HERE), enumerator_4359.current_mIsPredefined (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (122)) ;
    }
    enumerator_4359.gotoNextObject () ;
  }
  GALGAS_stringlist var_sortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (125)) ;
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (126)) ;
  GALGAS_outletClassMap var_outletClassMap ;
  {
  routine_analyzeOutletClasses (var_outletClassList, var_contextAnalysisStruct, var_protocolMap, var_outletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (127)) ;
  }
  GALGAS_controllerClassMap var_controllerClassMap ;
  {
  routine_analyzeControllerClasses (var_controllerClassList, var_contextAnalysisStruct, var_transientDependencyGraph, var_controllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (134)) ;
  }
  GALGAS_classMap var_classMap ;
  {
  routine_analyzeClasses (var_classList, var_contextAnalysisStruct, var_classMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (141)) ;
  }
  GALGAS_preferencesMap var_preferencesMap ;
  {
  routine_analyzePreferences (var_preferencesList, var_controllerClassMap, var_classMap, var_outletClassMap, var_contextAnalysisStruct, var_preferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (148)) ;
  }
  GALGAS_nibClassMap var_nibClassMap ;
  {
  routine_analyzeNibClasses (var_nibClassList, var_controllerClassMap, var_classMap, var_outletClassMap, var_contextAnalysisStruct, var_nibClassMap, var_preferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) ;
  }
  GALGAS_entityMap var_entityMap ;
  GALGAS_entityListForGeneration var_entityListForGeneration ;
  {
  routine_analyzeEntities (var_entityList, var_contextAnalysisStruct, var_entityMap, var_entityListForGeneration, var_preferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (169)) ;
  }
  GALGAS_documentMap var_documentMap ;
  {
  routine_analyzeDocuments (var_documentDeclarationList, var_outletClassMap, var_controllerClassMap, var_entityMap, var_preferencesMap, var_contextAnalysisStruct, var_documentMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (178)) ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (189)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (189)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_string var_s = var_transientDependencyGraph.reader_graphviz (SOURCE_FILE_AT_LINE (190)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".transientDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (191)) ;
    GALGAS_bool joker_6225_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_6225_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (192)) ;
  }
  GALGAS__32_stringlist var_transientDependencyArcList = var_transientDependencyGraph.reader_arcs (SOURCE_FILE_AT_LINE (195)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (196)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_transientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (197)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      cEnumerator_stringlist enumerator_6515 (var_transientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (198)), kEnumeration_up) ;
      while (enumerator_6515.hasCurrentObject ()) {
        inCompiler->emitSemanticError (var_endOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_6515.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (199)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (199)) COMMA_SOURCE_FILE_AT_LINE (199)) ;
        enumerator_6515.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_2) {
      GALGAS_stringlist var_unsortedTransientList ;
      GALGAS_lstringlist joker_6762_0 ; // Joker input parameter
      GALGAS_lstringlist joker_6804_0 ; // Joker input parameter
      var_transientDependencyGraph.method_topologicalSort (var_sortedTransientOrderedList, joker_6762_0, var_unsortedTransientList, joker_6804_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (203)) ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (209)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (210)).reader_string (SOURCE_FILE_AT_LINE (210)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:") COMMA_SOURCE_FILE_AT_LINE (210)) ;
        cEnumerator_stringlist enumerator_7034 (var_unsortedTransientList, kEnumeration_up) ;
        while (enumerator_7034.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_7034.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (212)) ;
          enumerator_7034.gotoNextObject () ;
        }
        inCompiler->emitSemanticError (var_endOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (214)) ;
      }
    }
  }
  GALGAS_string var_sourceDirectoryPath = constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (220)) ;
  {
  routine_generateEnumerations (var_contextAnalysisStruct.mAttribute_mEnumMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (221)) ;
  }
  {
  routine_generateStructures (var_contextAnalysisStruct.mAttribute_mStructTypeMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (222)) ;
  }
  {
  routine_generateOutletClassCode (var_outletClassMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (223)) ;
  }
  {
  routine_generateClassCode (var_transientDependencyArcList, var_classMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (224)) ;
  }
  {
  routine_generateEntityCode (var_transientDependencyArcList, var_entityListForGeneration, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (225)) ;
  }
  {
  routine_generatePreferencesCode (var_transientDependencyArcList, var_preferencesMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (226)) ;
  }
  {
  routine_generateNibClassCode (var_transientDependencyArcList, var_nibClassMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (227)) ;
  }
  {
  routine_generateDocumentCode (var_transientDependencyArcList, var_documentMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (228)) ;
  }
  {
  routine_generateCursorCode (var_contextAnalysisStruct.mAttribute_mUserCursorMap, var_predefinedCursorList, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (229)) ;
  }
  {
  routine_generateControllerCode (var_controllerClassMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (230)) ;
  }
  {
  routine_generateTransientDependencyFiles (var_transientDependencyArcList, var_sourceDirectoryPath, var_sortedTransientOrderedList, inCompiler COMMA_SOURCE_FILE_AT_LINE (232)) ;
  }
  GALGAS_stringset var_generateSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (238)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("easy-bindings-utilities") COMMA_SOURCE_FILE_AT_LINE (239)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("PMAllocationDebug") COMMA_SOURCE_FILE_AT_LINE (240)) ;
  const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, var_documentMap.reader_count (SOURCE_FILE_AT_LINE (241)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_4) {
    var_generateSet.addAssign_operation (GALGAS_string ("PMUndoManager") COMMA_SOURCE_FILE_AT_LINE (242)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedDocument") COMMA_SOURCE_FILE_AT_LINE (243)) ;
    ...
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+PMGZcompression") COMMA_SOURCE_FILE_AT_LINE (246)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSMutableData+PMWrites") COMMA_SOURCE_FILE_AT_LINE (247)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner") COMMA_SOURCE_FILE_AT_LINE (248)) ;
  }
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, var_entityListForGeneration.reader_length (SOURCE_FILE_AT_LINE (250)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions") COMMA_SOURCE_FILE_AT_LINE (251)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedEntity") COMMA_SOURCE_FILE_AT_LINE (252)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityManager") COMMA_SOURCE_FILE_AT_LINE (253)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMAttributeDescription") COMMA_SOURCE_FILE_AT_LINE (254)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMRelationshipDescription") COMMA_SOURCE_FILE_AT_LINE (255)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityArrayController") COMMA_SOURCE_FILE_AT_LINE (256)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityController") COMMA_SOURCE_FILE_AT_LINE (257)) ;
  }
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  cEnumerator_stringlist enumerator_9380 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (261)), kEnumeration_up) ;
  while (enumerator_9380.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_9380.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (262)) ;
    const enumGalgasBool test_6 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (263)) COMMA_SOURCE_FILE_AT_LINE (263)).boolEnum () ;
    if (kBoolTrue == test_6) {
      {
      GALGAS_string::class_method_generateFile (var_sourceDirectoryPath.operator_concat (enumerator_9380.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (265)) COMMA_SOURCE_FILE_AT_LINE (265)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_9380.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (267)), inCompiler COMMA_SOURCE_FILE_AT_LINE (264)) ;
      }
    }
