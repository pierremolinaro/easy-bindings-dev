...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
                               ...
                               COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string var_outputDirectory = constinArgument_inSourceFile.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (125)) ;
  GALGAS_observablePropertyMapMap var_observablePropertyMapMap = GALGAS_observablePropertyMapMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (127)) ;
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (128)) ;
  cEnumerator_lstringlist enumerator_5296 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_5296.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    GALGAS_ebType joker_5353_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_5296.current_mValue (HERE), joker_5353_0, var_declaration, inCompiler COMMA_SOURCE_FILE_AT_LINE (130)) ;
    callCategoryMethod_buildObservablePropertyMap ((const cPtr_astDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_observablePropertyMapMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) ;
    enumerator_5296.gotoNextObject () ;
  }
  GALGAS_contextAnalysisStruct var_contextAnalysisStruct = GALGAS_contextAnalysisStruct::constructor_default (SOURCE_FILE_AT_LINE (141)) ;
  ...
  {
  routine_cursorAnalysis (constinArgument_inCursorList, var_contextAnalysisStruct, var_predefinedCursorList, inCompiler COMMA_SOURCE_FILE_AT_LINE (145)) ;
  }
  GALGAS_generationList var_generationList = GALGAS_generationList::constructor_emptyList (SOURCE_FILE_AT_LINE (151)) ;
  cEnumerator_lstringlist enumerator_5990 (constinArgument_inSortedKeys, kEnumeration_up) ;
  while (enumerator_5990.hasCurrentObject ()) {
    GALGAS_astDeclaration var_declaration ;
    GALGAS_ebType joker_6047_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_5990.current_mValue (HERE), joker_6047_0, var_declaration, inCompiler COMMA_SOURCE_FILE_AT_LINE (153)) ;
    callCategoryMethod_semanticAnalysis ((const cPtr_astDeclaration *) var_declaration.ptr (), constinArgument_inUnifiedTypeMap, var_contextAnalysisStruct, var_generationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (158)) ;
    enumerator_5990.gotoNextObject () ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (165)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    cEnumerator_entityMap enumerator_6359 (var_contextAnalysisStruct.mAttribute_mEntityMap, kEnumeration_up) ;
    while (enumerator_6359.hasCurrentObject ()) {
      cEnumerator_relationshipMap enumerator_6400 (enumerator_6359.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
      while (enumerator_6400.hasCurrentObject ()) {
        GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
        GALGAS_string joker_6502_9 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6502_8 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6502_7 ; // Joker input parameter
        GALGAS_attributeListForImplementation joker_6502_6 ; // Joker input parameter
        GALGAS_transientListForImplementation joker_6502_5 ; // Joker input parameter
        GALGAS_relationshipList joker_6502_4 ; // Joker input parameter
        GALGAS_relationshipList joker_6502_3 ; // Joker input parameter
        GALGAS_propertyMap joker_6502_2 ; // Joker input parameter
        GALGAS_relationshipMap joker_6502_1 ; // Joker input parameter
        GALGAS_fileInclusionSet joker_6577_2 ; // Joker input parameter
        GALGAS_signListForGeneration joker_6577_1 ; // Joker input parameter
        var_contextAnalysisStruct.mAttribute_mEntityMap.method_searchKey (enumerator_6400.current_mDestinationEntityName (HERE), joker_6502_9, joker_6502_8, joker_6502_7, joker_6502_6, joker_6502_5, joker_6502_4, joker_6502_3, joker_6502_2, joker_6502_1, var_destinationEntityRelationshipMap, joker_6577_2, joker_6577_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (168)) ;
        GALGAS_lstring var_inverseOfInverseRelationshipName ;
        GALGAS_bool var_inverseIsToMany ;
        GALGAS_bool joker_6691_2 ; // Joker input parameter
        GALGAS_lstring joker_6691_1 ; // Joker input parameter
        GALGAS_deleteRuleEnum joker_6791_0 ; // Joker input parameter
        var_destinationEntityRelationshipMap.method_searchKey (enumerator_6400.current_mInverseRelationshipName (HERE), joker_6691_2, joker_6691_1, var_inverseOfInverseRelationshipName, var_inverseIsToMany, joker_6791_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (174)) ;
        const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_6400.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_1) {
          GALGAS_location location_2 (enumerator_6400.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_6400.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (182)) COMMA_SOURCE_FILE_AT_LINE (182)) ;
        }
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_6400.current_mIsToMany (HERE).objectCompare (var_inverseIsToMany)).boolEnum () ;
        if (kBoolTrue == test_3) {
          ...
          GALGAS_location location_6 (enumerator_6400.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_6, GALGAS_string ("the inverse relationship is ").operator_concat (temp_4 COMMA_SOURCE_FILE_AT_LINE (185)) COMMA_SOURCE_FILE_AT_LINE (185)) ;
        }
  ...
  const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (191)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_7) {
    cEnumerator_generationList enumerator_7337 (var_generationList, kEnumeration_up) ;
    while (enumerator_7337.hasCurrentObject ()) {
      callCategoryMethod_generate ((const cPtr_generation *) enumerator_7337.current_mGeneration (HERE).ptr (), var_outputDirectory, inCompiler COMMA_SOURCE_FILE_AT_LINE (193)) ;
      enumerator_7337.gotoNextObject () ;
    }
    {
    routine_generateCursorCode (var_contextAnalysisStruct.mAttribute_mUserCursorMap, var_predefinedCursorList, var_outputDirectory, inCompiler COMMA_SOURCE_FILE_AT_LINE (195)) ;
    }
  }
  const enumGalgasBool test_8 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (202)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (202)).boolEnum () ;
  if (kBoolTrue == test_8) {
    GALGAS_string var_s = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_graphviz (SOURCE_FILE_AT_LINE (203)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.operator_concat (GALGAS_string (".transientDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (204)) ;
    GALGAS_bool joker_7883_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_7883_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (205)) ;
  }
  GALGAS__32_stringlist var_transientDependencyArcList = var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_edges (SOURCE_FILE_AT_LINE (208)) ;
  GALGAS_stringlist var_sortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (209)) ;
  const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (210)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_9) {
    const enumGalgasBool test_10 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (211)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_10) {
      cEnumerator_stringlist enumerator_8299 (var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (212)), kEnumeration_up) ;
      while (enumerator_8299.hasCurrentObject ()) {
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_8299.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (213)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (213)) COMMA_SOURCE_FILE_AT_LINE (213)) ;
        enumerator_8299.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_10) {
      GALGAS_stringlist var_unsortedTransientList ;
      GALGAS_lstringlist joker_8532_0 ; // Joker input parameter
      GALGAS_lstringlist joker_8586_0 ; // Joker input parameter
      var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.method_topologicalSort (var_sortedTransientOrderedList, joker_8532_0, var_unsortedTransientList, joker_8586_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (216)) ;
      const enumGalgasBool test_11 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (222)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_11) {
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (223)).reader_string (SOURCE_FILE_AT_LINE (223)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:") COMMA_SOURCE_FILE_AT_LINE (223)) ;
        cEnumerator_stringlist enumerator_8814 (var_unsortedTransientList, kEnumeration_up) ;
        while (enumerator_8814.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_8814.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (225)) COMMA_SOURCE_FILE_AT_LINE (225)) ;
          enumerator_8814.gotoNextObject () ;
        }
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (227)) ;
      }
    }
  }
  {
  routine_generateTransientDependencyFiles (var_transientDependencyArcList, var_outputDirectory, var_sortedTransientOrderedList, inCompiler COMMA_SOURCE_FILE_AT_LINE (233)) ;
  }
  ...
  const enumGalgasBool test_12 = var_contextAnalysisStruct.mAttribute_mContainsDocument.boolEnum () ;
  ...
  const enumGalgasBool test_13 = GALGAS_bool (kIsStrictSup, var_contextAnalysisStruct.mAttribute_mEntityMap.reader_count (SOURCE_FILE_AT_LINE (251)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_13) {
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions") COMMA_SOURCE_FILE_AT_LINE (252)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedEntity") COMMA_SOURCE_FILE_AT_LINE (253)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityManager") COMMA_SOURCE_FILE_AT_LINE (254)) ;
  ...
  cEnumerator_stringlist enumerator_10178 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (262)), kEnumeration_up) ;
  while (enumerator_10178.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_10178.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (263)) ;
    const enumGalgasBool test_14 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (264)) COMMA_SOURCE_FILE_AT_LINE (264)).boolEnum () ;
    if (kBoolTrue == test_14) {
      {
      GALGAS_string::class_method_generateFile (var_outputDirectory.operator_concat (enumerator_10178.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (266)) COMMA_SOURCE_FILE_AT_LINE (266)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_10178.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (268)), inCompiler COMMA_SOURCE_FILE_AT_LINE (265)) ;
      }
    }
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_astDeclarationList var_declarationList = GALGAS_astDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (42)) ;
  GALGAS_cursorList var_cursorList = GALGAS_cursorList::constructor_emptyList (SOURCE_FILE_AT_LINE (44)) ;
  {
  GALGAS_location joker_1537_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE_AT_LINE (45))), var_declarationList, var_cursorList, joker_1537_0 COMMA_SOURCE_FILE_AT_LINE (45)) ;
  }
  GALGAS_location var_endOfSourceFile ;
  {
  cGrammar_easyBindings_5F_grammar::_performSourceFileParsing_ (inCompiler, constinArgument_inSourceFile, var_declarationList, var_cursorList, var_endOfSourceFile COMMA_SOURCE_FILE_AT_LINE (51)) ;
  }
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSString"), GALGAS_typeKind::constructor_stringType (SOURCE_FILE_AT_LINE (57)) COMMA_SOURCE_FILE_AT_LINE (57)) COMMA_SOURCE_FILE_AT_LINE (57)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSColor"), GALGAS_typeKind::constructor_colorType (SOURCE_FILE_AT_LINE (58)) COMMA_SOURCE_FILE_AT_LINE (58)) COMMA_SOURCE_FILE_AT_LINE (58)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSData"), GALGAS_typeKind::constructor_dataType (SOURCE_FILE_AT_LINE (59)) COMMA_SOURCE_FILE_AT_LINE (59)) COMMA_SOURCE_FILE_AT_LINE (59)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSDate"), GALGAS_typeKind::constructor_dateType (SOURCE_FILE_AT_LINE (60)) COMMA_SOURCE_FILE_AT_LINE (60)) COMMA_SOURCE_FILE_AT_LINE (60)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSFont"), GALGAS_typeKind::constructor_fontType (SOURCE_FILE_AT_LINE (61)) COMMA_SOURCE_FILE_AT_LINE (61)) COMMA_SOURCE_FILE_AT_LINE (61)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSImage"), GALGAS_typeKind::constructor_imageType (SOURCE_FILE_AT_LINE (62)) COMMA_SOURCE_FILE_AT_LINE (62)) COMMA_SOURCE_FILE_AT_LINE (62)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSMenu"), GALGAS_typeKind::constructor_menuType (SOURCE_FILE_AT_LINE (63)) COMMA_SOURCE_FILE_AT_LINE (63)) COMMA_SOURCE_FILE_AT_LINE (63)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("NSBezierPath"), GALGAS_typeKind::constructor_bezierPathType (SOURCE_FILE_AT_LINE (64)) COMMA_SOURCE_FILE_AT_LINE (64)) COMMA_SOURCE_FILE_AT_LINE (64)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("Integer"), GALGAS_typeKind::constructor_integerType (SOURCE_FILE_AT_LINE (65)) COMMA_SOURCE_FILE_AT_LINE (65)) COMMA_SOURCE_FILE_AT_LINE (65)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("UInteger"), GALGAS_typeKind::constructor_uintegerType (SOURCE_FILE_AT_LINE (66)) COMMA_SOURCE_FILE_AT_LINE (66)) COMMA_SOURCE_FILE_AT_LINE (66)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("Bool"), GALGAS_typeKind::constructor_boolType (SOURCE_FILE_AT_LINE (67)) COMMA_SOURCE_FILE_AT_LINE (67)) COMMA_SOURCE_FILE_AT_LINE (67)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("Double"), GALGAS_typeKind::constructor_doubleType (SOURCE_FILE_AT_LINE (68)) COMMA_SOURCE_FILE_AT_LINE (68)) COMMA_SOURCE_FILE_AT_LINE (68)) ;
  var_declarationList.addAssign_operation (GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string ("enum"), GALGAS_typeKind::constructor_enumType (SOURCE_FILE_AT_LINE (69)) COMMA_SOURCE_FILE_AT_LINE (69)) COMMA_SOURCE_FILE_AT_LINE (69)) ;
  GALGAS_unifiedTypeMap var_unifiedTypeMap = GALGAS_unifiedTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (71)) ;
  cEnumerator_astDeclarationList enumerator_3050 (var_declarationList, kEnumeration_up) ;
  while (enumerator_3050.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_3050.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (74)) ;
  ...
  if (kBoolTrue == test_0) {
    GALGAS_string var_s = var_unifiedTypeMap.reader_edgeGraphvizRepresentation (SOURCE_FILE_AT_LINE (77)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".classDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (78)) ;
    GALGAS_bool joker_3390_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3390_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (79)) ;
  }
  GALGAS_lstringlist var_unsolvedProxyList = var_unifiedTypeMap.reader_unsolvedProxyList (SOURCE_FILE_AT_LINE (82)) ;
  cEnumerator_lstringlist enumerator_3585 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3585.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3585.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3585.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)).operator_concat (GALGAS_string (" is undefined") COMMA_SOURCE_FILE_AT_LINE (84)) COMMA_SOURCE_FILE_AT_LINE (84)) ;
    enumerator_3585.gotoNextObject () ;
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_unsolvedProxyList.reader_length (SOURCE_FILE_AT_LINE (87)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_lstringlist var_sortedKeys ;
    GALGAS_lstringlist var_unsortedKeys ;
    var_unifiedTypeMap.method_topologicalSort (var_sortedKeys, var_unsortedKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (88)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedKeys.reader_length (SOURCE_FILE_AT_LINE (89)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_string var_s = GALGAS_string ("cannot sort types ; the following types are involved in circular dependence:") ;
      cEnumerator_lstringlist enumerator_4032 (var_unsortedKeys, kEnumeration_up) ;
      while (enumerator_4032.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_4032.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (92)) COMMA_SOURCE_FILE_AT_LINE (92)) COMMA_SOURCE_FILE_AT_LINE (92)) ;
        enumerator_4032.gotoNextObject () ;
      }
      inCompiler->emitSemanticError (inCompiler->here (), var_s COMMA_SOURCE_FILE_AT_LINE (94)) ;
    }else if (kBoolFalse == test_3) {
      {
      routine_semanticAnalysis (var_unifiedTypeMap, var_sortedKeys, constinArgument_inSourceFile.mAttribute_string, var_cursorList, var_endOfSourceFile, inCompiler COMMA_SOURCE_FILE_AT_LINE (101)) ;
      }
    }
  }
}
