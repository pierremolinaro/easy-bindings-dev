...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  while (enumerator_4902.hasCurrentObject ()) {
    ...
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_4902.current_mValue (HERE), joker_4959_0, var_declaration, inCompiler COMMA_SOURCE_FILE_AT_LINE (121)) ;
  ...
  while (enumerator_5596.hasCurrentObject ()) {
    ...
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_5596.current_mValue (HERE), joker_5653_0, var_declaration, inCompiler COMMA_SOURCE_FILE_AT_LINE (144)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    while (enumerator_5965.hasCurrentObject ()) {
      ...
      while (enumerator_6006.hasCurrentObject ()) {
        ...
        var_destinationEntityRelationshipMap.method_searchKey (enumerator_6006.current_mInverseRelationshipName (HERE), joker_6297_2, joker_6297_1, var_inverseOfInverseRelationshipName, var_inverseIsToMany, joker_6397_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (165)) ;
  ...
  if (kBoolTrue == test_7) {
    ...
    while (enumerator_6943.hasCurrentObject ()) {
      callCategoryMethod_generate ((const cPtr_generation *) enumerator_6943.current_mGeneration (HERE).ptr (), var_outputDirectory, inCompiler COMMA_SOURCE_FILE_AT_LINE (184)) ;
  ...
  if (kBoolTrue == test_8) {
    ...
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_7569_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (197)) ;
  }
  ...
  if (kBoolTrue == test_9) {
    ...
    if (kBoolTrue == test_10) {
      cEnumerator_stringlist enumerator_7983 (var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (204)), kEnumeration_up) ;
      while (enumerator_7983.hasCurrentObject ()) {
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_7983.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (205)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (205)) COMMA_SOURCE_FILE_AT_LINE (205)) ;
      ...
      var_contextAnalysisStruct.mAttribute_mTransientDependencyGraph.method_topologicalSort (var_sortedTransientOrderedList, joker_8216_0, var_unsortedTransientList, joker_8270_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (208)) ;
      ...
      if (kBoolTrue == test_11) {
        ...
        while (enumerator_8498.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_8498.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (217)) COMMA_SOURCE_FILE_AT_LINE (217)) ;
  ...
  cEnumerator_stringlist enumerator_10090 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (262)), kEnumeration_up) ;
  while (enumerator_10090.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_10090.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (263)) ;
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE_AT_LINE (36))), var_declarationList, var_cursorList, joker_1190_0 COMMA_SOURCE_FILE_AT_LINE (36)) ;
  ...
  while (enumerator_2703.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_2703.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (65)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3027_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (70)) ;
  }
  ...
  while (enumerator_3209.hasCurrentObject ()) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3209.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (75)) COMMA_SOURCE_FILE_AT_LINE (75)).operator_concat (GALGAS_string (" is undefined") COMMA_SOURCE_FILE_AT_LINE (75)) COMMA_SOURCE_FILE_AT_LINE (75)) ;
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_3) {
      ...
      while (enumerator_3652.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_3652.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (83)) COMMA_SOURCE_FILE_AT_LINE (83)) COMMA_SOURCE_FILE_AT_LINE (83)) ;
