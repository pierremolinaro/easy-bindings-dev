...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_7207 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (215)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_7207.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_sourceName = enumerator_7207.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (216)) ;
    //-------- @ifInstructionForGeneration
    ...
    if (kBoolTrue == test_6) {
      ...
      GALGAS_string::class_method_generateFile (var_sourceDirectoryPath.operator_concat (enumerator_7207.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (219)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_7207.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (221)), inCompiler COMMA_SOURCE_FILE_AT_LINE (218)) ;
      } //-------- @routineCallInstructionForGeneration
    }
