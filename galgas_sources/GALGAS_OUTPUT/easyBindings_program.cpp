...
static const char * gWrapperFileContent_24_objective_5F_c_5F_sources = "#import <Cocoa/Cocoa.h>\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
static const char * gWrapperFileContent_26_objective_5F_c_5F_sources = "#import <Cocoa/Cocoa.h>\n"
  "\n"
  "//---------------------------------------------------------------------------*\n"
  "\n"
...
static const cRegularFileWrapper * gWrapperAllFiles_objective_5F_c_5F_sources_0 [31] = {
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  if (kBoolTrue == test_4) {
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMAbstractPersistentDocument") COMMA_SOURCE_FILE_AT_LINE (199)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMBinaryFlatDocument") COMMA_SOURCE_FILE_AT_LINE (200)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMbz2DataCategory") COMMA_SOURCE_FILE_AT_LINE (201)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMzlibDataCategory") COMMA_SOURCE_FILE_AT_LINE (202)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner") COMMA_SOURCE_FILE_AT_LINE (203)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMEmbeddedEntityDatabase") COMMA_SOURCE_FILE_AT_LINE (204)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMEmbeddedObjectDatabase") COMMA_SOURCE_FILE_AT_LINE (205)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMLoadedEntityDatabase") COMMA_SOURCE_FILE_AT_LINE (206)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMLoadedEntityDescription") COMMA_SOURCE_FILE_AT_LINE (207)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMLoadedObjectDatabase") COMMA_SOURCE_FILE_AT_LINE (208)) ;
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMMutableDataWriteCategory") COMMA_SOURCE_FILE_AT_LINE (209)) ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, var_entityListForGeneration.reader_length (SOURCE_FILE_AT_LINE (211)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    //-------- @plusEqualnstructionForGeneration
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedObject") COMMA_SOURCE_FILE_AT_LINE (212)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_7279 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (216)), kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_7279.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_sourceName = enumerator_7279.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (217)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (218)) COMMA_SOURCE_FILE_AT_LINE (218)).boolEnum () ;
    if (kBoolTrue == test_6) {
      { //-------- @typeMethodInstructionForGeneration
      GALGAS_string::class_method_generateFile (var_sourceDirectoryPath.operator_concat (enumerator_7279.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (220)) COMMA_SOURCE_FILE_AT_LINE (220)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_7279.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (222)), inCompiler COMMA_SOURCE_FILE_AT_LINE (219)) ;
      } //-------- @routineCallInstructionForGeneration
    }
