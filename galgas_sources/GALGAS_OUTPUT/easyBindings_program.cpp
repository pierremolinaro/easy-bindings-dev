...
//                                         september 16th, 2014, at 22h45'14"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_predefinedOutletClasses_sourceFile (C_Compiler * /* inCompiler */
  ...
  result << "outletClass PMButton run ;\n"
    "controllerTemplate PMButton $enabled : transient Bool model ;\n"
    "\n"
...
void routine_semanticAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  cEnumerator_outletClassDeclarationList enumerator_5645 (constinArgument_inAstDeclarationStruct.mAttribute_mOutletClassDeclarationList, kEnumeration_up) ;
  while (enumerator_5645.hasCurrentObject ()) {
    {
    var_outletClassMap.modifier_insertKey (enumerator_5645.current_mOutletClassName (HERE), enumerator_5645.current_mHasRunAction (HERE), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 130)) ;
    }
...
void routine_generateCode (const GALGAS_transientDependencyGraphNodeInfoList constinArgument_inSortedTransientAndObservablePropertyNodes,
  ...
  {
  routine_generateEntities (constinArgument_inGeneration.mAttribute_mEntityListForGeneration, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 178)) ;
  }
  {
  routine_generateEnums (constinArgument_inGeneration.mAttribute_mEnumListForGeneration, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 182)) ;
  }
  {
  routine_generateDocuments (constinArgument_inGeneration.mAttribute_mDocumentListForGeneration, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 186)) ;
  }
  {
  routine_generateArrayControllers (constinArgument_inGeneration.mAttribute_mAllArrayControllerForGeneration, var_outputDirectory, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 190)) ;
  }
  {
  routine_generateSwiftApplicationFiles (var_outputDirectory, GALGAS_bool (kIsStrictSup, constinArgument_inGeneration.mAttribute_mEntityListForGeneration.reader_length (SOURCE_FILE ("easyBindings_program.gProgram", 196)).objectCompare (GALGAS_uint ((uint32_t) 0U))), inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 194)) ;
  }
  {
  routine_generateValidationRoutineStubs (var_outputDirectory, constinArgument_inGeneration.mAttribute_mValidationStubRoutineListForGeneration, inCompiler  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 198)) ;
  }
}
...
const char * gWrapperFileContent_1_swift_5F_sources = "<\?xml version=\"1.0\" encoding=\"UTF-8\"\?>\n"
  ...
  "\t\t<string key=\"IBDocument.InterfaceBuilderVersion\">6246</string>\n"
  ...
  "\t\t\t<string key=\"NS.object.0\">6246</string>\n"
  "\t\t</object>\n"
  ...
  "\t\t\t\t\t\t\t\t\t\t\t<reference key=\"NSNextKeyView\" ref=\"491184262\"/>\n"
  ...
  "\t\t\t\t\t\t<string key=\"minorKey\">../04-document-with-relationships-swift/PMAllocationDebug.swift</string>\n"
  "\t\t\t\t\t</object>\n"
  "\t\t\t\t</object>\n"
  "\t\t\t\t<object class=\"IBPartialClassDescription\">\n"
  ...
  "\t\t\t\t\t<object class=\"IBClassDescriptionSource\" key=\"sourceIdentifier\">\n"
  "\t\t\t\t\t\t<string key=\"majorKey\">IBProjectSource</string>\n"
  "\t\t\t\t\t\t<string key=\"minorKey\">../04-document-with-relationships-swift/PMApplication.swift</string>\n"
  "\t\t\t\t\t</object>\n"
  "\t\t\t\t</object>\n"
  "\t\t\t</array>\n"
  "\t\t</object>\n"
...
void routine_generateSwiftApplicationFiles (const GALGAS_string constinArgument_inOutputDirectory,
                                            ...
                                            C_Compiler * inCompiler
                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringlist temp_0 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 218)) ;
  temp_0.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 218)) ;
  temp_0.addAssign_operation (GALGAS_string ("easy-bindings-utilities")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 218)) ;
  GALGAS_stringlist var_swiftFiles = temp_0 ;
  const enumGalgasBool test_1 = constinArgument_inHasEntities.boolEnum () ;
  if (kBoolTrue == test_1) {
    var_swiftFiles.addAssign_operation (GALGAS_string ("PMManagedObject")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 220)) ;
    var_swiftFiles.addAssign_operation (GALGAS_string ("PMManagedDocument")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 221)) ;
    var_swiftFiles.addAssign_operation (GALGAS_string ("PMUndoManager")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 222)) ;
    var_swiftFiles.addAssign_operation (GALGAS_string ("PMDataScanner")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 223)) ;
  }
  GALGAS_stringlist temp_2 = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("easyBindings_program.gProgram", 225)) ;
  temp_2.addAssign_operation (GALGAS_string ("PMAllocationDebug")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 225)) ;
  GALGAS_stringlist var_xibFiles = temp_2 ;
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_swift_5F_sources) ;
  cEnumerator_stringlist enumerator_8513 (var_swiftFiles, kEnumeration_up) ;
  while (enumerator_8513.hasCurrentObject ()) {
    GALGAS_string var_contents = var_fw.reader_textFileContentsAtPath (enumerator_8513.current_mValue (HERE).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 228)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 228)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, enumerator_8513.current_mValue (HERE).add_operation (GALGAS_string (".swift"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 231)), var_contents, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 229)) ;
    }
    enumerator_8513.gotoNextObject () ;
  }
  cEnumerator_stringlist enumerator_8719 (var_xibFiles, kEnumeration_up) ;
  while (enumerator_8719.hasCurrentObject ()) {
    GALGAS_string var_contents = var_fw.reader_textFileContentsAtPath (enumerator_8719.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 236)), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 236)) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, enumerator_8719.current_mValue (HERE).add_operation (GALGAS_string (".xib"), inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 239)), var_contents, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 237)) ;
    }
...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cEnumerator_astDeclarationList enumerator_2887 (var_declarationStruct.mAttribute_mDeclarationList, kEnumeration_up) ;
  while (enumerator_2887.hasCurrentObject ()) {
    callCategoryMethod_typeInventory ((const cPtr_astDeclaration *) enumerator_2887.current_mDeclaration (HERE).ptr (), var_unifiedTypeMap, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 57)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_bool joker_3211_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_3211_0, inCompiler COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 62)) ;
  }
  ...
  cEnumerator_lstringlist enumerator_3393 (var_unsolvedProxyList, kEnumeration_up) ;
  while (enumerator_3393.hasCurrentObject ()) {
    GALGAS_location location_1 (enumerator_3393.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("type ").operator_concat (enumerator_3393.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 67))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 67)).operator_concat (GALGAS_string (" is undefined")  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 67))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 67)) ;
  ...
  if (kBoolTrue == test_2) {
    ...
    if (kBoolTrue == test_3) {
      ...
      cEnumerator_lstringlist enumerator_3879 (var_unsortedTypeNames, kEnumeration_up) ;
      while (enumerator_3879.hasCurrentObject ()) {
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "-- ").operator_concat (enumerator_3879.current_mValue (HERE).reader_string (SOURCE_FILE ("easyBindings_program.gProgram", 78))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 78))  COMMA_SOURCE_FILE ("easyBindings_program.gProgram", 78)) ;
