...
void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
                                  ...
                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_classList var_classList = GALGAS_classList::constructor_emptyList (SOURCE_FILE_AT_LINE (45)) ;
  GALGAS_entityList var_entityList = GALGAS_entityList::constructor_emptyList (SOURCE_FILE_AT_LINE (46)) ;
  GALGAS_preferencesDeclarationList var_preferencesList = GALGAS_preferencesDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (47)) ;
  GALGAS_outletClassList var_outletClassList = GALGAS_outletClassList::constructor_emptyList (SOURCE_FILE_AT_LINE (48)) ;
  GALGAS_documentDeclarationList var_documentDeclarationList = GALGAS_documentDeclarationList::constructor_emptyList (SOURCE_FILE_AT_LINE (49)) ;
  GALGAS_controllerClassList var_controllerClassList = GALGAS_controllerClassList::constructor_emptyList (SOURCE_FILE_AT_LINE (50)) ;
  GALGAS_protocolList var_protocolList = GALGAS_protocolList::constructor_emptyList (SOURCE_FILE_AT_LINE (51)) ;
  GALGAS_cursorList var_cursorList = GALGAS_cursorList::constructor_emptyList (SOURCE_FILE_AT_LINE (52)) ;
  GALGAS_structTypeList var_structTypeList = GALGAS_structTypeList::constructor_emptyList (SOURCE_FILE_AT_LINE (53)) ;
  GALGAS_enumList var_enumList = GALGAS_enumList::constructor_emptyList (SOURCE_FILE_AT_LINE (54)) ;
  {
  GALGAS_location joker_2225_0 ; // Joker input parameter
  cGrammar_easyBindings_5F_grammar::_performSourceStringParsing_ (inCompiler, GALGAS_string (filewrapperTemplate_predefinedOutletClasses_sourceFile (inCompiler COMMA_SOURCE_FILE_AT_LINE (55))), var_classList, var_entityList, var_preferencesList, var_outletClassList, var_documentDeclarationList, var_controllerClassList, var_protocolList, var_cursorList, var_enumList, var_structTypeList, joker_2225_0 COMMA_SOURCE_FILE_AT_LINE (55)) ;
  }
  ...
  GALGAS_contextAnalysisStruct var_contextAnalysisStruct = GALGAS_contextAnalysisStruct::constructor_new (GALGAS_structTypeMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (84)), GALGAS_enumMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (85)), GALGAS_globalEnumConstantMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (86)), GALGAS_userCursorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (87)) COMMA_SOURCE_FILE_AT_LINE (83)) ;
  GALGAS_stringlist var_predefinedCursorList ;
  {
  routine_cursorAnalysis (var_cursorList, var_contextAnalysisStruct, var_predefinedCursorList, inCompiler COMMA_SOURCE_FILE_AT_LINE (90)) ;
  }
  {
  routine_enumAnalysis (var_enumList, var_contextAnalysisStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (96)) ;
  }
  {
  routine_structAnalysis (var_structTypeList, var_contextAnalysisStruct, inCompiler COMMA_SOURCE_FILE_AT_LINE (101)) ;
  }
  GALGAS_protocolMap var_protocolMap = GALGAS_protocolMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (106)) ;
  cEnumerator_protocolList enumerator_3169 (var_protocolList, kEnumeration_up) ;
  while (enumerator_3169.hasCurrentObject ()) {
    {
    var_protocolMap.modifier_insertKey (enumerator_3169.current_mProtocolName (HERE), enumerator_3169.current_mIsPredefined (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (108)) ;
    }
    enumerator_3169.gotoNextObject () ;
  }
  GALGAS_stringlist var_sortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (111)) ;
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (112)) ;
  GALGAS_outletClassMap var_outletClassMap ;
  {
  routine_analyzeOutletClasses (var_outletClassList, var_contextAnalysisStruct, var_protocolMap, var_outletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (113)) ;
  }
  GALGAS_controllerClassMap var_controllerClassMap ;
  {
  routine_analyzeControllerClasses (var_controllerClassList, var_contextAnalysisStruct, var_transientDependencyGraph, var_controllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (120)) ;
  }
  GALGAS_classMap var_classMap ;
  {
  routine_analyzeClasses (var_classList, var_contextAnalysisStruct, var_classMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (127)) ;
  }
  GALGAS_preferencesMap var_preferencesMap ;
  {
  routine_analyzePreferences (var_preferencesList, var_controllerClassMap, var_classMap, var_outletClassMap, var_contextAnalysisStruct, var_preferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (134)) ;
  }
  GALGAS_entityMap var_entityMap ;
  GALGAS_entityListForGeneration var_entityListForGeneration ;
  {
  routine_analyzeEntities (var_entityList, var_contextAnalysisStruct, var_entityMap, var_entityListForGeneration, var_preferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (144)) ;
  }
  GALGAS_documentMap var_documentMap ;
  {
  routine_analyzeDocuments (var_documentDeclarationList, var_outletClassMap, var_controllerClassMap, var_entityMap, var_preferencesMap, var_contextAnalysisStruct, var_documentMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (153)) ;
  }
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (164)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (164)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_string var_s = var_transientDependencyGraph.reader_graphviz (SOURCE_FILE_AT_LINE (165)) ;
    GALGAS_string var_path = constinArgument_inSourceFile.mAttribute_string.operator_concat (GALGAS_string (".transientDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (166)) ;
    GALGAS_bool joker_4810_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_4810_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (167)) ;
  }
  GALGAS__32_stringlist var_transientDependencyArcList = var_transientDependencyGraph.reader_arcs (SOURCE_FILE_AT_LINE (170)) ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (171)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_transientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (172)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      cEnumerator_stringlist enumerator_5100 (var_transientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (173)), kEnumeration_up) ;
      while (enumerator_5100.hasCurrentObject ()) {
        inCompiler->emitSemanticError (var_endOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_5100.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (174)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (174)) COMMA_SOURCE_FILE_AT_LINE (174)) ;
        enumerator_5100.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_2) {
      GALGAS_stringlist var_unsortedTransientList ;
      GALGAS_lstringlist joker_5347_0 ; // Joker input parameter
      GALGAS_lstringlist joker_5389_0 ; // Joker input parameter
      var_transientDependencyGraph.method_topologicalSort (var_sortedTransientOrderedList, joker_5347_0, var_unsortedTransientList, joker_5389_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (178)) ;
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (184)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (185)).reader_string (SOURCE_FILE_AT_LINE (185)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:") COMMA_SOURCE_FILE_AT_LINE (185)) ;
        cEnumerator_stringlist enumerator_5619 (var_unsortedTransientList, kEnumeration_up) ;
        while (enumerator_5619.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_5619.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (187)) COMMA_SOURCE_FILE_AT_LINE (187)) ;
          enumerator_5619.gotoNextObject () ;
        }
        inCompiler->emitSemanticError (var_endOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (189)) ;
      }
    }
  }
  GALGAS_string var_sourceDirectoryPath = constinArgument_inSourceFile.mAttribute_string.reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (195)) ;
  {
  routine_generateEnumerations (var_contextAnalysisStruct.mAttribute_mEnumMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (196)) ;
  }
  {
  routine_generateStructures (var_contextAnalysisStruct.mAttribute_mStructTypeMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (197)) ;
  }
  {
  routine_generateOutletClassCode (var_outletClassMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (198)) ;
  }
  {
  routine_generateClassCode (var_transientDependencyArcList, var_classMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (199)) ;
  }
  {
  routine_generateEntityCode (var_transientDependencyArcList, var_entityListForGeneration, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (200)) ;
  }
  {
  routine_generatePreferencesCode (var_transientDependencyArcList, var_preferencesMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (201)) ;
  }
  {
  routine_generateDocumentCode (var_transientDependencyArcList, var_documentMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (202)) ;
  }
  {
  routine_generateCursorCode (var_contextAnalysisStruct.mAttribute_mUserCursorMap, var_predefinedCursorList, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (203)) ;
  }
  {
  routine_generateControllerCode (var_controllerClassMap, var_sourceDirectoryPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (204)) ;
  }
  {
  routine_generateTransientDependencyFiles (var_transientDependencyArcList, var_sourceDirectoryPath, var_sortedTransientOrderedList, inCompiler COMMA_SOURCE_FILE_AT_LINE (206)) ;
  }
  GALGAS_stringset var_generateSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (212)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("easy-bindings-utilities") COMMA_SOURCE_FILE_AT_LINE (213)) ;
  var_generateSet.addAssign_operation (GALGAS_string ("PMAllocationDebug") COMMA_SOURCE_FILE_AT_LINE (214)) ;
  const enumGalgasBool test_4 = GALGAS_bool (kIsStrictSup, var_documentMap.reader_count (SOURCE_FILE_AT_LINE (215)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_4) {
    var_generateSet.addAssign_operation (GALGAS_string ("PMUndoManager") COMMA_SOURCE_FILE_AT_LINE (216)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedDocument") COMMA_SOURCE_FILE_AT_LINE (217)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression") COMMA_SOURCE_FILE_AT_LINE (218)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+BZ2compression") COMMA_SOURCE_FILE_AT_LINE (219)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSData+PMGZcompression") COMMA_SOURCE_FILE_AT_LINE (220)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("NSMutableData+PMWrites") COMMA_SOURCE_FILE_AT_LINE (221)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMDataScanner") COMMA_SOURCE_FILE_AT_LINE (222)) ;
  }
  const enumGalgasBool test_5 = GALGAS_bool (kIsStrictSup, var_entityListForGeneration.reader_length (SOURCE_FILE_AT_LINE (224)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_5) {
    var_generateSet.addAssign_operation (GALGAS_string ("load-store-functions") COMMA_SOURCE_FILE_AT_LINE (225)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMManagedEntity") COMMA_SOURCE_FILE_AT_LINE (226)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityManager") COMMA_SOURCE_FILE_AT_LINE (227)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMAttributeDescription") COMMA_SOURCE_FILE_AT_LINE (228)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMRelationshipDescription") COMMA_SOURCE_FILE_AT_LINE (229)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityArrayController") COMMA_SOURCE_FILE_AT_LINE (230)) ;
    var_generateSet.addAssign_operation (GALGAS_string ("PMEntityController") COMMA_SOURCE_FILE_AT_LINE (231)) ;
  }
  GALGAS_filewrapper var_fw = GALGAS_filewrapper (gWrapperDirectory_0_objective_5F_c_5F_sources) ;
  cEnumerator_stringlist enumerator_7878 (var_fw.reader_allTextFilePathes (SOURCE_FILE_AT_LINE (235)), kEnumeration_up) ;
  while (enumerator_7878.hasCurrentObject ()) {
    GALGAS_string var_sourceName = enumerator_7878.current_mValue (HERE).reader_lastPathComponent (SOURCE_FILE_AT_LINE (236)) ;
    const enumGalgasBool test_6 = var_generateSet.reader_hasKey (var_sourceName.reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (237)) COMMA_SOURCE_FILE_AT_LINE (237)).boolEnum () ;
    if (kBoolTrue == test_6) {
      {
      GALGAS_string::class_method_generateFile (var_sourceDirectoryPath.operator_concat (enumerator_7878.current_mValue (HERE).reader_stringByDeletingLastPathComponent (SOURCE_FILE_AT_LINE (239)) COMMA_SOURCE_FILE_AT_LINE (239)), var_sourceName, var_fw.reader_textFileContentsAtPath (enumerator_7878.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (241)), inCompiler COMMA_SOURCE_FILE_AT_LINE (238)) ;
      }
    }
