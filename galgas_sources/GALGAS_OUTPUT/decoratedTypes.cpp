...
//                                         september 29th, 2014, at 20h15'58"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
static GALGAS_stringset onceFunction_predefinedColors (C_Compiler * /* inCompiler */
  ...
  result_outResult = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("decoratedTypes.gSemantics", 438)) ;
  result_outResult.addAssign_operation (GALGAS_string ("blackColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 439)) ;
  result_outResult.addAssign_operation (GALGAS_string ("blueColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 440)) ;
  result_outResult.addAssign_operation (GALGAS_string ("brownColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 441)) ;
  result_outResult.addAssign_operation (GALGAS_string ("clearColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 442)) ;
  result_outResult.addAssign_operation (GALGAS_string ("controlColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 443)) ;
  result_outResult.addAssign_operation (GALGAS_string ("controlDarkShadowColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 444)) ;
  result_outResult.addAssign_operation (GALGAS_string ("controlHighlightColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 445)) ;
  result_outResult.addAssign_operation (GALGAS_string ("controlLightHighlightColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 446)) ;
  result_outResult.addAssign_operation (GALGAS_string ("controlShadowColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 447)) ;
  result_outResult.addAssign_operation (GALGAS_string ("controlTextColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 448)) ;
  result_outResult.addAssign_operation (GALGAS_string ("cyanColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 449)) ;
  result_outResult.addAssign_operation (GALGAS_string ("darkGrayColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 450)) ;
  result_outResult.addAssign_operation (GALGAS_string ("disabledControlTextColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 451)) ;
  result_outResult.addAssign_operation (GALGAS_string ("grayColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 452)) ;
  result_outResult.addAssign_operation (GALGAS_string ("greenColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 453)) ;
  result_outResult.addAssign_operation (GALGAS_string ("gridColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 454)) ;
  result_outResult.addAssign_operation (GALGAS_string ("headerColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 455)) ;
  result_outResult.addAssign_operation (GALGAS_string ("headerTextColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 456)) ;
  result_outResult.addAssign_operation (GALGAS_string ("highlightColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 457)) ;
  result_outResult.addAssign_operation (GALGAS_string ("keyboardFocusIndicatorColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 458)) ;
  result_outResult.addAssign_operation (GALGAS_string ("knobColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 459)) ;
  result_outResult.addAssign_operation (GALGAS_string ("lightGrayColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 460)) ;
  result_outResult.addAssign_operation (GALGAS_string ("magentaColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 461)) ;
  result_outResult.addAssign_operation (GALGAS_string ("orangeColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 462)) ;
  result_outResult.addAssign_operation (GALGAS_string ("purpleColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 463)) ;
  result_outResult.addAssign_operation (GALGAS_string ("redColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 464)) ;
  result_outResult.addAssign_operation (GALGAS_string ("scrollBarColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 465)) ;
  result_outResult.addAssign_operation (GALGAS_string ("selectedControlColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 466)) ;
  result_outResult.addAssign_operation (GALGAS_string ("selectedControlTextColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 467)) ;
  result_outResult.addAssign_operation (GALGAS_string ("selectedKnobColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 468)) ;
  result_outResult.addAssign_operation (GALGAS_string ("selectedMenuItemColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 469)) ;
  result_outResult.addAssign_operation (GALGAS_string ("selectedMenuItemTextColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 470)) ;
  result_outResult.addAssign_operation (GALGAS_string ("selectedTextBackgroundColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 471)) ;
  result_outResult.addAssign_operation (GALGAS_string ("selectedTextColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 472)) ;
  result_outResult.addAssign_operation (GALGAS_string ("shadowColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 473)) ;
  result_outResult.addAssign_operation (GALGAS_string ("textBackgroundColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 474)) ;
  result_outResult.addAssign_operation (GALGAS_string ("textColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 475)) ;
  result_outResult.addAssign_operation (GALGAS_string ("whiteColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 476)) ;
  result_outResult.addAssign_operation (GALGAS_string ("windowBackgroundColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 477)) ;
  result_outResult.addAssign_operation (GALGAS_string ("windowFrameColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 478)) ;
  result_outResult.addAssign_operation (GALGAS_string ("windowFrameTextColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 479)) ;
  result_outResult.addAssign_operation (GALGAS_string ("yellowColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 480)) ;
//---
...
static GALGAS_stringset onceFunction_predefinedDates (C_Compiler * /* inCompiler */
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringset result_outResult ; // Returned variable
  result_outResult = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("decoratedTypes.gSemantics", 486)) ;
  result_outResult.addAssign_operation (GALGAS_string ("date")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 487)) ;
//---
  return result_outResult ;
}
...
static GALGAS_stringset onceFunction_predefinedFonts (C_Compiler * /* inCompiler */
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringset result_outResult ; // Returned variable
  result_outResult = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("decoratedTypes.gSemantics", 539)) ;
  result_outResult.addAssign_operation (GALGAS_string ("boldSystemFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 540)) ;
  result_outResult.addAssign_operation (GALGAS_string ("controlContentFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 541)) ;
  result_outResult.addAssign_operation (GALGAS_string ("labelFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 542)) ;
  result_outResult.addAssign_operation (GALGAS_string ("menuFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 543)) ;
  result_outResult.addAssign_operation (GALGAS_string ("menuBarFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 544)) ;
  result_outResult.addAssign_operation (GALGAS_string ("messageFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 545)) ;
  result_outResult.addAssign_operation (GALGAS_string ("paletteFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 546)) ;
  result_outResult.addAssign_operation (GALGAS_string ("systemFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 547)) ;
  result_outResult.addAssign_operation (GALGAS_string ("titleBarFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 548)) ;
  result_outResult.addAssign_operation (GALGAS_string ("toolTipsFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 549)) ;
//---
  return result_outResult ;
}
...
typeComparisonResult GALGAS_abstractEnableBindingExpressionForGeneration::objectCompare (const GALGAS_abstractEnableBindingExpressionForGeneration & inOperand) const {
...
GALGAS_abstractEnableBindingExpressionForGeneration::GALGAS_abstractEnableBindingExpressionForGeneration (void) :
AC_GALGAS_class () {
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_abstractEnableBindingExpressionForGeneration::GALGAS_abstractEnableBindingExpressionForGeneration (const cPtr_abstractEnableBindingExpressionForGeneration * inSourcePtr) :
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, cPtr_abstractEnableBindingExpressionForGeneration) ;
}

//---------------------------------------------------------------------------------------------------------------------*
//                        Pointer class for @abstractEnableBindingExpressionForGeneration class                        *
//---------------------------------------------------------------------------------------------------------------------*

cPtr_abstractEnableBindingExpressionForGeneration::cPtr_abstractEnableBindingExpressionForGeneration (LOCATION_ARGS) :
acPtr_class (THERE) {
}
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                 @abstractEnableBindingExpressionForGeneration type                                  *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_abstractEnableBindingExpressionForGeneration ("abstractEnableBindingExpressionForGeneration",
                                                                     NULL) ;

//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_abstractEnableBindingExpressionForGeneration::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_abstractEnableBindingExpressionForGeneration ;
}

//---------------------------------------------------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_abstractEnableBindingExpressionForGeneration::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_abstractEnableBindingExpressionForGeneration (*this)) ;
  }
  return result ;
}
...
GALGAS_abstractEnableBindingExpressionForGeneration GALGAS_abstractEnableBindingExpressionForGeneration::extractObject (const GALGAS_object & inObject,
                                                                                                                        C_Compiler * inCompiler
                                                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_abstractEnableBindingExpressionForGeneration result ;
  const GALGAS_abstractEnableBindingExpressionForGeneration * p = (const GALGAS_abstractEnableBindingExpressionForGeneration *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_abstractEnableBindingExpressionForGeneration *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("abstractEnableBindingExpressionForGeneration", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_abstractEnableBindingExpressionForGeneration () {
}
...
GALGAS_abstractEnableBindingExpressionForGeneration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, cPtr_andBooleanMultipleBindingExpressionForGeneration) ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_andBooleanMultipleBindingExpressionForGeneration GALGAS_andBooleanMultipleBindingExpressionForGeneration::constructor_new (const GALGAS_abstractEnableBindingExpressionForGeneration & inAttribute_mLeftBinding,
                                                                                                                                  const GALGAS_abstractEnableBindingExpressionForGeneration & inAttribute_mRightBinding
                                                                                                                                  COMMA_LOCATION_ARGS) {
...
void GALGAS_andBooleanMultipleBindingExpressionForGeneration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidSharedObject (p, cPtr_andBooleanMultipleBindingExpressionForGeneration) ;
    cPtr_andBooleanMultipleBindingExpressionForGeneration * r = NULL ;
    macroMyNew (r, cPtr_andBooleanMultipleBindingExpressionForGeneration (p->mAttribute_mLeftBinding, p->mAttribute_mRightBinding COMMA_THERE)) ;
...
GALGAS_abstractEnableBindingExpressionForGeneration GALGAS_andBooleanMultipleBindingExpressionForGeneration::reader_mLeftBinding (UNUSED_LOCATION_ARGS) const {
  GALGAS_abstractEnableBindingExpressionForGeneration result ;
  if (NULL != mObjectPtr) {
...
GALGAS_abstractEnableBindingExpressionForGeneration cPtr_andBooleanMultipleBindingExpressionForGeneration::reader_mLeftBinding (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLeftBinding ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_abstractEnableBindingExpressionForGeneration GALGAS_andBooleanMultipleBindingExpressionForGeneration::reader_mRightBinding (UNUSED_LOCATION_ARGS) const {
  GALGAS_abstractEnableBindingExpressionForGeneration result ;
  if (NULL != mObjectPtr) {
    const cPtr_andBooleanMultipleBindingExpressionForGeneration * p = (const cPtr_andBooleanMultipleBindingExpressionForGeneration *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_andBooleanMultipleBindingExpressionForGeneration) ;
...
GALGAS_abstractEnableBindingExpressionForGeneration cPtr_andBooleanMultipleBindingExpressionForGeneration::reader_mRightBinding (UNUSED_LOCATION_ARGS) const {
...
cPtr_andBooleanMultipleBindingExpressionForGeneration::cPtr_andBooleanMultipleBindingExpressionForGeneration (const GALGAS_abstractEnableBindingExpressionForGeneration & in_mLeftBinding,
                                                                                                              const GALGAS_abstractEnableBindingExpressionForGeneration & in_mRightBinding
                                                                                                              COMMA_LOCATION_ARGS) :
cPtr_abstractEnableBindingExpressionForGeneration (THERE),
...
kTypeDescriptor_GALGAS_andBooleanMultipleBindingExpressionForGeneration ("andBooleanMultipleBindingExpressionForGeneration",
                                                                         & kTypeDescriptor_GALGAS_abstractEnableBindingExpressionForGeneration) ;
...
GALGAS_negateBooleanMultipleBindingExpressionForGeneration GALGAS_negateBooleanMultipleBindingExpressionForGeneration::constructor_new (const GALGAS_abstractEnableBindingExpressionForGeneration & inAttribute_mBinding
                                                                                                                                        COMMA_LOCATION_ARGS) {
...
void GALGAS_negateBooleanMultipleBindingExpressionForGeneration::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroValidSharedObject (p, cPtr_negateBooleanMultipleBindingExpressionForGeneration) ;
    cPtr_negateBooleanMultipleBindingExpressionForGeneration * r = NULL ;
    macroMyNew (r, cPtr_negateBooleanMultipleBindingExpressionForGeneration (p->mAttribute_mBinding COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_abstractEnableBindingExpressionForGeneration GALGAS_negateBooleanMultipleBindingExpressionForGeneration::reader_mBinding (UNUSED_LOCATION_ARGS) const {
  GALGAS_abstractEnableBindingExpressionForGeneration result ;
  if (NULL != mObjectPtr) {
...
GALGAS_abstractEnableBindingExpressionForGeneration cPtr_negateBooleanMultipleBindingExpressionForGeneration::reader_mBinding (UNUSED_LOCATION_ARGS) const {
...
cPtr_negateBooleanMultipleBindingExpressionForGeneration::cPtr_negateBooleanMultipleBindingExpressionForGeneration (const GALGAS_abstractEnableBindingExpressionForGeneration & in_mBinding
                                                                                                                    COMMA_LOCATION_ARGS) :
cPtr_abstractEnableBindingExpressionForGeneration (THERE),
...
typeComparisonResult cPtr_observablePropertyAsEnableBindingExpressionForGeneration::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  typeComparisonResult result = kOperandEqual ;
  const cPtr_observablePropertyAsEnableBindingExpressionForGeneration * p = (const cPtr_observablePropertyAsEnableBindingExpressionForGeneration *) inOperandPtr ;
  macroValidSharedObject (p, cPtr_observablePropertyAsEnableBindingExpressionForGeneration) ;
  if (kOperandEqual == result) {
...
typeComparisonResult GALGAS_observablePropertyAsEnableBindingExpressionForGeneration::objectCompare (const GALGAS_observablePropertyAsEnableBindingExpressionForGeneration & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const int32_t mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const int32_t operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_observablePropertyAsEnableBindingExpressionForGeneration::GALGAS_observablePropertyAsEnableBindingExpressionForGeneration (void) :
GALGAS_abstractEnableBindingExpressionForGeneration () {
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_observablePropertyAsEnableBindingExpressionForGeneration GALGAS_observablePropertyAsEnableBindingExpressionForGeneration::constructor_default (LOCATION_ARGS) {
  return GALGAS_observablePropertyAsEnableBindingExpressionForGeneration::constructor_new (GALGAS_string::constructor_default (HERE),
...
GALGAS_observablePropertyAsEnableBindingExpressionForGeneration::GALGAS_observablePropertyAsEnableBindingExpressionForGeneration (const cPtr_observablePropertyAsEnableBindingExpressionForGeneration * inSourcePtr) :
GALGAS_abstractEnableBindingExpressionForGeneration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, cPtr_observablePropertyAsEnableBindingExpressionForGeneration) ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_observablePropertyAsEnableBindingExpressionForGeneration GALGAS_observablePropertyAsEnableBindingExpressionForGeneration::constructor_new (const GALGAS_string & inAttribute_mObservedObject,
                                                                                                                                                  ...
                                                                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_observablePropertyAsEnableBindingExpressionForGeneration result ;
  if (inAttribute_mObservedObject.isValid () && inAttribute_mObservedModel.isValid () && inAttribute_mObservedTypeName.isValid () && inAttribute_mIndex.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_observablePropertyAsEnableBindingExpressionForGeneration (inAttribute_mObservedObject, inAttribute_mObservedModel, inAttribute_mObservedTypeName, inAttribute_mIndex COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_observablePropertyAsEnableBindingExpressionForGeneration::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_observablePropertyAsEnableBindingExpressionForGeneration * p = (cPtr_observablePropertyAsEnableBindingExpressionForGeneration *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_observablePropertyAsEnableBindingExpressionForGeneration) ;
    cPtr_observablePropertyAsEnableBindingExpressionForGeneration * r = NULL ;
    macroMyNew (r, cPtr_observablePropertyAsEnableBindingExpressionForGeneration (p->mAttribute_mObservedObject, p->mAttribute_mObservedModel, p->mAttribute_mObservedTypeName, p->mAttribute_mIndex COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_string GALGAS_observablePropertyAsEnableBindingExpressionForGeneration::reader_mObservedObject (UNUSED_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    const cPtr_observablePropertyAsEnableBindingExpressionForGeneration * p = (const cPtr_observablePropertyAsEnableBindingExpressionForGeneration *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_observablePropertyAsEnableBindingExpressionForGeneration) ;
...
GALGAS_string cPtr_observablePropertyAsEnableBindingExpressionForGeneration::reader_mObservedObject (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mObservedObject ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_string GALGAS_observablePropertyAsEnableBindingExpressionForGeneration::reader_mObservedModel (UNUSED_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    const cPtr_observablePropertyAsEnableBindingExpressionForGeneration * p = (const cPtr_observablePropertyAsEnableBindingExpressionForGeneration *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_observablePropertyAsEnableBindingExpressionForGeneration) ;
...
GALGAS_string cPtr_observablePropertyAsEnableBindingExpressionForGeneration::reader_mObservedModel (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mObservedModel ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_string GALGAS_observablePropertyAsEnableBindingExpressionForGeneration::reader_mObservedTypeName (UNUSED_LOCATION_ARGS) const {
  GALGAS_string result ;
  if (NULL != mObjectPtr) {
    const cPtr_observablePropertyAsEnableBindingExpressionForGeneration * p = (const cPtr_observablePropertyAsEnableBindingExpressionForGeneration *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_observablePropertyAsEnableBindingExpressionForGeneration) ;
...
GALGAS_string cPtr_observablePropertyAsEnableBindingExpressionForGeneration::reader_mObservedTypeName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mObservedTypeName ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_uint GALGAS_observablePropertyAsEnableBindingExpressionForGeneration::reader_mIndex (UNUSED_LOCATION_ARGS) const {
  GALGAS_uint result ;
  if (NULL != mObjectPtr) {
    const cPtr_observablePropertyAsEnableBindingExpressionForGeneration * p = (const cPtr_observablePropertyAsEnableBindingExpressionForGeneration *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_observablePropertyAsEnableBindingExpressionForGeneration) ;
...
GALGAS_uint cPtr_observablePropertyAsEnableBindingExpressionForGeneration::reader_mIndex (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIndex ;
}

//---------------------------------------------------------------------------------------------------------------------*
//                  Pointer class for @observablePropertyAsEnableBindingExpressionForGeneration class                  *
//---------------------------------------------------------------------------------------------------------------------*

cPtr_observablePropertyAsEnableBindingExpressionForGeneration::cPtr_observablePropertyAsEnableBindingExpressionForGeneration (const GALGAS_string & in_mObservedObject,
...
const C_galgas_type_descriptor * cPtr_observablePropertyAsEnableBindingExpressionForGeneration::classDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_observablePropertyAsEnableBindingExpressionForGeneration ;
}

void cPtr_observablePropertyAsEnableBindingExpressionForGeneration::description (C_String & ioString,
                                                                                 const int32_t inIndentation) const {
  ioString << "[@observablePropertyAsEnableBindingExpressionForGeneration:" ;
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                           @observablePropertyAsEnableBindingExpressionForGeneration type                            *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_observablePropertyAsEnableBindingExpressionForGeneration ("observablePropertyAsEnableBindingExpressionForGeneration",
                                                                                 & kTypeDescriptor_GALGAS_abstractEnableBindingExpressionForGeneration) ;

//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_observablePropertyAsEnableBindingExpressionForGeneration::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_observablePropertyAsEnableBindingExpressionForGeneration ;
}

//---------------------------------------------------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_observablePropertyAsEnableBindingExpressionForGeneration::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_observablePropertyAsEnableBindingExpressionForGeneration (*this)) ;
  }
  return result ;
}
...
GALGAS_observablePropertyAsEnableBindingExpressionForGeneration GALGAS_observablePropertyAsEnableBindingExpressionForGeneration::extractObject (const GALGAS_object & inObject,
                                                                                                                                                C_Compiler * inCompiler
                                                                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_observablePropertyAsEnableBindingExpressionForGeneration result ;
  const GALGAS_observablePropertyAsEnableBindingExpressionForGeneration * p = (const GALGAS_observablePropertyAsEnableBindingExpressionForGeneration *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_observablePropertyAsEnableBindingExpressionForGeneration *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("observablePropertyAsEnableBindingExpressionForGeneration", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_orBooleanMultipleBindingExpressionForGeneration GALGAS_orBooleanMultipleBindingExpressionForGeneration::constructor_new (const GALGAS_abstractEnableBindingExpressionForGeneration & inAttribute_mLeftBinding,
                                                                                                                                const GALGAS_abstractEnableBindingExpressionForGeneration & inAttribute_mRightBinding
                                                                                                                                COMMA_LOCATION_ARGS) {
...
void GALGAS_orBooleanMultipleBindingExpressionForGeneration::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_orBooleanMultipleBindingExpressionForGeneration * p = (cPtr_orBooleanMultipleBindingExpressionForGeneration *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_orBooleanMultipleBindingExpressionForGeneration) ;
    cPtr_orBooleanMultipleBindingExpressionForGeneration * r = NULL ;
    macroMyNew (r, cPtr_orBooleanMultipleBindingExpressionForGeneration (p->mAttribute_mLeftBinding, p->mAttribute_mRightBinding COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_abstractEnableBindingExpressionForGeneration GALGAS_orBooleanMultipleBindingExpressionForGeneration::reader_mLeftBinding (UNUSED_LOCATION_ARGS) const {
  GALGAS_abstractEnableBindingExpressionForGeneration result ;
  if (NULL != mObjectPtr) {
...
GALGAS_abstractEnableBindingExpressionForGeneration cPtr_orBooleanMultipleBindingExpressionForGeneration::reader_mLeftBinding (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLeftBinding ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_abstractEnableBindingExpressionForGeneration GALGAS_orBooleanMultipleBindingExpressionForGeneration::reader_mRightBinding (UNUSED_LOCATION_ARGS) const {
  GALGAS_abstractEnableBindingExpressionForGeneration result ;
  if (NULL != mObjectPtr) {
    const cPtr_orBooleanMultipleBindingExpressionForGeneration * p = (const cPtr_orBooleanMultipleBindingExpressionForGeneration *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_orBooleanMultipleBindingExpressionForGeneration) ;
...
GALGAS_abstractEnableBindingExpressionForGeneration cPtr_orBooleanMultipleBindingExpressionForGeneration::reader_mRightBinding (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRightBinding ;
}
...
cPtr_orBooleanMultipleBindingExpressionForGeneration::cPtr_orBooleanMultipleBindingExpressionForGeneration (const GALGAS_abstractEnableBindingExpressionForGeneration & in_mLeftBinding,
                                                                                                            const GALGAS_abstractEnableBindingExpressionForGeneration & in_mRightBinding
                                                                                                            COMMA_LOCATION_ARGS) :
cPtr_abstractEnableBindingExpressionForGeneration (THERE),
mAttribute_mLeftBinding (in_mLeftBinding),
...
static void categoryMethod_boolAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  cEnumerator_unifiedTypeProxyList enumerator_11847 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 353)).isValidAndTrue () ;
  if (enumerator_11847.hasCurrentObject () && bool_0) {
    while (enumerator_11847.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_11847.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 354)).objectCompare (GALGAS_typeKind::constructor_boolType (SOURCE_FILE ("decoratedTypes.gSemantics", 354)))).boolEnum () ;
      if (kBoolTrue == test_1) {
      ...
      if (enumerator_11847.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 353)).isValidAndTrue () ;
      }
    }
  }
  const enumGalgasBool test_4 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 359)).boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_location location_5 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_5, GALGAS_string ("only a boolean attribute can be initialized by YES or NO")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 360)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_integerAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  outArgument_outSwiftDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  cEnumerator_unifiedTypeProxyList enumerator_12641 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 376)).isValidAndTrue () ;
  if (enumerator_12641.hasCurrentObject () && bool_0) {
    while (enumerator_12641.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_12641.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 377)).objectCompare (GALGAS_typeKind::constructor_integerType (SOURCE_FILE ("decoratedTypes.gSemantics", 377)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        outArgument_outSwiftDefaultValueAsString = object->mAttribute_mValue.mAttribute_uint.reader_string (SOURCE_FILE ("decoratedTypes.gSemantics", 378)) ;
        var_found = GALGAS_bool (true) ;
      }
      enumerator_12641.gotoNextObject () ;
      if (enumerator_12641.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 376)).isValidAndTrue () ;
      }
    }
  }
  const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 382)).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("only an integer attribute can be initialized by an integer constant")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 383)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_doubleAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  outArgument_outSwiftDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  cEnumerator_unifiedTypeProxyList enumerator_13426 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 399)).isValidAndTrue () ;
  if (enumerator_13426.hasCurrentObject () && bool_0) {
    while (enumerator_13426.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_13426.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 400)).objectCompare (GALGAS_typeKind::constructor_doubleType (SOURCE_FILE ("decoratedTypes.gSemantics", 400)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        outArgument_outSwiftDefaultValueAsString = object->mAttribute_mValue.mAttribute_double.reader_string (SOURCE_FILE ("decoratedTypes.gSemantics", 401)) ;
        var_found = GALGAS_bool (true) ;
      }
      enumerator_13426.gotoNextObject () ;
      if (enumerator_13426.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 399)).isValidAndTrue () ;
      }
    }
  }
  const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 405)).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("only a double attribute can be initialized by a floating point constant")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 406)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_stringAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  outArgument_outSwiftDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  cEnumerator_unifiedTypeProxyList enumerator_14215 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 422)).isValidAndTrue () ;
  if (enumerator_14215.hasCurrentObject () && bool_0) {
    while (enumerator_14215.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_14215.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 423)).objectCompare (GALGAS_typeKind::constructor_stringType (SOURCE_FILE ("decoratedTypes.gSemantics", 423)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        outArgument_outSwiftDefaultValueAsString = GALGAS_string ("\"").operator_concat (object->mAttribute_mValue.mAttribute_string  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 424)).operator_concat (GALGAS_string ("\"")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 424)) ;
        var_found = GALGAS_bool (true) ;
      }
      enumerator_14215.gotoNextObject () ;
      if (enumerator_14215.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 422)).isValidAndTrue () ;
      }
    }
  }
  const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 428)).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("only a string attribute can be initialized by a string constant")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 429)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_identifierAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  outArgument_outSwiftDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  cEnumerator_unifiedTypeProxyList enumerator_16800 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 498)).isValidAndTrue () ;
  if (enumerator_16800.hasCurrentObject () && bool_0) {
    while (enumerator_16800.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_16800.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 499)).objectCompare (GALGAS_typeKind::constructor_colorType (SOURCE_FILE ("decoratedTypes.gSemantics", 499)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_found = GALGAS_bool (true) ;
        const enumGalgasBool test_2 = function_predefinedColors (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 501)).reader_hasKey (object->mAttribute_mValue.mAttribute_string COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 501)).boolEnum () ;
        if (kBoolTrue == test_2) {
          outArgument_outSwiftDefaultValueAsString = GALGAS_string ("NSColor.").operator_concat (object->mAttribute_mValue.mAttribute_string  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 502)).operator_concat (GALGAS_string (" ()")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 502)) ;
        }else if (kBoolFalse == test_2) {
          GALGAS_location location_3 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("unknown predefined color")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 504)) ;
        }
      }else if (kBoolFalse == test_1) {
        const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_16800.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 508)).objectCompare (GALGAS_typeKind::constructor_dateType (SOURCE_FILE ("decoratedTypes.gSemantics", 508)))).boolEnum () ;
        if (kBoolTrue == test_4) {
          var_found = GALGAS_bool (true) ;
          const enumGalgasBool test_5 = function_predefinedDates (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 510)).reader_hasKey (object->mAttribute_mValue.mAttribute_string COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 510)).boolEnum () ;
          if (kBoolTrue == test_5) {
            ...
            inCompiler->emitSemanticError (location_6, GALGAS_string ("unknown predefined date")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 513)) ;
          }
        }else if (kBoolFalse == test_4) {
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_16800.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 517)).objectCompare (GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("decoratedTypes.gSemantics", 517)))).boolEnum () ;
          if (kBoolTrue == test_7) {
            var_found = GALGAS_bool (true) ;
            const enumGalgasBool test_8 = enumerator_16800.current_mType (HERE).reader_mEnumConstantMap (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 519)).reader_hasKey (object->mAttribute_mValue.mAttribute_string COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 519)).boolEnum () ;
            if (kBoolTrue == test_8) {
              outArgument_outSwiftDefaultValueAsString = enumerator_16800.current_mType (HERE).reader_lkey (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 520)).mAttribute_string.operator_concat (GALGAS_string (".")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 520)).operator_concat (object->mAttribute_mValue.mAttribute_string  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 520)) ;
            }else if (kBoolFalse == test_8) {
              GALGAS_location location_9 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_9, GALGAS_string ("the '").operator_concat (enumerator_16800.current_mType (HERE).reader_lkey (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 523)).reader_string (SOURCE_FILE ("decoratedTypes.gSemantics", 523))  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 523)).operator_concat (GALGAS_string ("' enumeration does not define '")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 523)).operator_concat (object->mAttribute_mValue.reader_string (SOURCE_FILE ("decoratedTypes.gSemantics", 523))  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 523)).operator_concat (GALGAS_string ("' constant")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 523))  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 522)) ;
      ...
      if (enumerator_16800.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 498)).isValidAndTrue () ;
      }
    }
  }
  const enumGalgasBool test_10 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 529)).boolEnum () ;
  if (kBoolTrue == test_10) {
    GALGAS_location location_11 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_11, GALGAS_string ("unknow type for this identifier")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 530)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_listAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  outArgument_outSwiftDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  const enumGalgasBool test_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 622)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mStartLocation, GALGAS_string ("invalid initialization value")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 623)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
