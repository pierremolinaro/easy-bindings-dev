...
GALGAS_unifiedTypeMap_2D_proxy GALGAS_unifiedTypeMap_2D_proxy::reader_mRootEntityType (C_Compiler * inCompiler
                                                                                       COMMA_LOCATION_ARGS) const {
  GALGAS_unifiedTypeMap_2D_proxy result ;
...
GALGAS_decoratedAttributeMap GALGAS_unifiedTypeMap_2D_proxy::reader_mDecoratedAttributeMap (C_Compiler * inCompiler
                                                                                            COMMA_LOCATION_ARGS) const {
  GALGAS_decoratedAttributeMap result ;
...
GALGAS_decoratedTransientMap GALGAS_unifiedTypeMap_2D_proxy::reader_mDecoratedTransientMap (C_Compiler * inCompiler
                                                                                            COMMA_LOCATION_ARGS) const {
  GALGAS_decoratedTransientMap result ;
...
GALGAS_decoratedOutletMap GALGAS_unifiedTypeMap_2D_proxy::reader_mDecoratedOutletMap (C_Compiler * inCompiler
                                                                                      COMMA_LOCATION_ARGS) const {
  GALGAS_decoratedOutletMap result ;
...
GALGAS_decoratedObservablePropertyMap GALGAS_unifiedTypeMap_2D_proxy::reader_mObservablePropertyMap (C_Compiler * inCompiler
                                                                                                     COMMA_LOCATION_ARGS) const {
  GALGAS_decoratedObservablePropertyMap result ;
...
GALGAS_decoratedEntityRelationshipMap GALGAS_unifiedTypeMap_2D_proxy::reader_mCurrentRelationshipMap (C_Compiler * inCompiler
                                                                                                      COMMA_LOCATION_ARGS) const {
  GALGAS_decoratedEntityRelationshipMap result ;
...
GALGAS_actionMap GALGAS_unifiedTypeMap_2D_proxy::reader_mActionMap (C_Compiler * inCompiler
                                                                    COMMA_LOCATION_ARGS) const {
  GALGAS_actionMap result ;
...
GALGAS_lstringlist GALGAS_unifiedTypeMap_2D_proxy::reader_mEnumConstantList (C_Compiler * inCompiler
                                                                             COMMA_LOCATION_ARGS) const {
  GALGAS_lstringlist result ;
...
GALGAS_enumConstantMap GALGAS_unifiedTypeMap_2D_proxy::reader_mEnumConstantMap (C_Compiler * inCompiler
                                                                                COMMA_LOCATION_ARGS) const {
  GALGAS_enumConstantMap result ;
...
GALGAS_arrayControllerMap GALGAS_unifiedTypeMap_2D_proxy::reader_mArrayControllerMap (C_Compiler * inCompiler
                                                                                      COMMA_LOCATION_ARGS) const {
  GALGAS_arrayControllerMap result ;
...
static void categoryMethod_boolAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  cEnumerator_unifiedTypeProxyList enumerator_11949 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 353)).isValidAndTrue () ;
  if (enumerator_11949.hasCurrentObject () && bool_0) {
    while (enumerator_11949.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_11949.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 354)).objectCompare (GALGAS_typeKind::constructor_boolType (SOURCE_FILE ("decoratedTypes.gSemantics", 354)))).boolEnum () ;
      if (kBoolTrue == test_1) {
      ...
      if (enumerator_11949.hasCurrentObject ()) {
...
static void categoryMethod_integerAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  outArgument_outSwiftDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  cEnumerator_unifiedTypeProxyList enumerator_12743 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 376)).isValidAndTrue () ;
  if (enumerator_12743.hasCurrentObject () && bool_0) {
    while (enumerator_12743.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_12743.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 377)).objectCompare (GALGAS_typeKind::constructor_integerType (SOURCE_FILE ("decoratedTypes.gSemantics", 377)))).boolEnum () ;
      if (kBoolTrue == test_1) {
      ...
      if (enumerator_12743.hasCurrentObject ()) {
...
static void categoryMethod_doubleAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  outArgument_outSwiftDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  cEnumerator_unifiedTypeProxyList enumerator_13528 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 399)).isValidAndTrue () ;
  if (enumerator_13528.hasCurrentObject () && bool_0) {
    while (enumerator_13528.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_13528.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 400)).objectCompare (GALGAS_typeKind::constructor_doubleType (SOURCE_FILE ("decoratedTypes.gSemantics", 400)))).boolEnum () ;
      if (kBoolTrue == test_1) {
      ...
      if (enumerator_13528.hasCurrentObject ()) {
...
static void categoryMethod_stringAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  outArgument_outSwiftDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  cEnumerator_unifiedTypeProxyList enumerator_14317 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 422)).isValidAndTrue () ;
  if (enumerator_14317.hasCurrentObject () && bool_0) {
    while (enumerator_14317.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_14317.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 423)).objectCompare (GALGAS_typeKind::constructor_stringType (SOURCE_FILE ("decoratedTypes.gSemantics", 423)))).boolEnum () ;
      if (kBoolTrue == test_1) {
      ...
      if (enumerator_14317.hasCurrentObject ()) {
...
static void categoryMethod_identifierAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  outArgument_outSwiftDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  cEnumerator_unifiedTypeProxyList enumerator_16902 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 498)).isValidAndTrue () ;
  if (enumerator_16902.hasCurrentObject () && bool_0) {
    while (enumerator_16902.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_16902.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 499)).objectCompare (GALGAS_typeKind::constructor_colorType (SOURCE_FILE ("decoratedTypes.gSemantics", 499)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_found = GALGAS_bool (true) ;
        ...
        const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_16902.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 508)).objectCompare (GALGAS_typeKind::constructor_dateType (SOURCE_FILE ("decoratedTypes.gSemantics", 508)))).boolEnum () ;
        if (kBoolTrue == test_4) {
          var_found = GALGAS_bool (true) ;
      ...
      if (enumerator_16902.hasCurrentObject ()) {
