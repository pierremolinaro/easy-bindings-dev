...
//                    december 16th, 2012, at 13h32'29"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void GALGAS_classMap::modifier_insertKey (GALGAS_lstring inKey,
                                          ...
                                          GALGAS_stringset inArgument7,
                                          C_Compiler * inCompiler
                                          COMMA_LOCATION_ARGS) {
  cMapElement_classMap * p = NULL ;
  macroMyNew (p, cMapElement_classMap (inKey, inArgument0, inArgument1, inArgument2, inArgument3, inArgument4, inArgument5, inArgument6, inArgument7 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
void GALGAS_classMap::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    outArgument7 = p->mAttribute_mHeaderFileInclusionSet ;
  }
}
...
GALGAS_stringset GALGAS_classMap::reader_mHeaderFileInclusionSetForKey (const GALGAS_string & inKey,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_classMap * p = (const cMapElement_classMap *) attributes ;
...
void GALGAS_classMap::modifier_setMHeaderFileInclusionSetForKey (GALGAS_stringset inAttributeValue,
                                                                 GALGAS_string inKey,
                                                                 C_Compiler * inCompiler
                                                                 COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
...
GALGAS_stringset cEnumerator_classMap::current_mHeaderFileInclusionSet (LOCATION_ARGS) const {
  const cMapElement_classMap * p = (const cMapElement_classMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_classMap) ;
...
void GALGAS_entityMap::modifier_insertKey (GALGAS_lstring inKey,
                                           ...
                                           GALGAS_stringset inArgument14,
                                           GALGAS__32_stringlist inArgument15,
                                           C_Compiler * inCompiler
                                           COMMA_LOCATION_ARGS) {
  cMapElement_entityMap * p = NULL ;
  macroMyNew (p, cMapElement_entityMap (inKey, inArgument0, inArgument1, inArgument2, inArgument3, inArgument4, inArgument5, inArgument6, inArgument7, inArgument8, inArgument9, inArgument10, inArgument11, inArgument12, inArgument13, inArgument14, inArgument15 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
void GALGAS_entityMap::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    outArgument13 = p->mAttribute_mHeaderFileInclusionSet ;
    outArgument14 = p->mAttribute_mImplementationFileInclusionSet ;
    outArgument15 = p->mAttribute_mToManyRelationshipList ;
  }
}
...
GALGAS_stringset GALGAS_entityMap::reader_mHeaderFileInclusionSetForKey (const GALGAS_string & inKey,
                                                                         C_Compiler * inCompiler
                                                                         COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_entityMap * p = (const cMapElement_entityMap *) attributes ;
...
void GALGAS_entityMap::modifier_setMHeaderFileInclusionSetForKey (GALGAS_stringset inAttributeValue,
                                                                  GALGAS_string inKey,
                                                                  C_Compiler * inCompiler
                                                                  COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
...
GALGAS_stringset cEnumerator_entityMap::current_mHeaderFileInclusionSet (LOCATION_ARGS) const {
  const cMapElement_entityMap * p = (const cMapElement_entityMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_entityMap) ;
  return p->mAttribute_mHeaderFileInclusionSet ;
}
...
bool cMapElement_controllerClassMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mGenerationKind.isValid () && mAttribute_mBindingMap.isValid () && mAttribute_mActionMap.isValid () && mAttribute_mObservablePropertyMap.isValid () ;
}
...
cMapElement * cMapElement_controllerClassMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_controllerClassMap (mAttribute_lkey, mAttribute_mGenerationKind, mAttribute_mBindingMap, mAttribute_mActionMap, mAttribute_mObservablePropertyMap COMMA_HERE)) ;
  return result ;
}
...
GALGAS_controllerClassMap_2E_element cEnumerator_controllerClassMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cMapElement_controllerClassMap) ;
  return GALGAS_controllerClassMap_2E_element (p->mAttribute_lkey, p->mAttribute_mGenerationKind, p->mAttribute_mBindingMap, p->mAttribute_mActionMap, p->mAttribute_mObservablePropertyMap) ;
}
...
bool cMapElement_preferencesMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mAttributeListForImplementation.isValid () && mAttribute_mTransientListForImplementation.isValid () && mAttribute_mOutletDeclarationList.isValid () && mAttribute_mActionList.isValid () && mAttribute_mObservablePropertyMap.isValid () && mAttribute_mHeaderFileInclusionSet.isValid () && mAttribute_mImplementationFileInclusionSet.isValid () && mAttribute_mControllerMap.isValid () && mAttribute_mArrayMap.isValid () ;
}
...
void GALGAS_preferencesMap::modifier_insertKey (GALGAS_lstring inKey,
                                                ...
                                                GALGAS_stringset inArgument6,
                                                GALGAS_controllerMap inArgument7,
                                                GALGAS_preferenceArrayMap inArgument8,
                                                C_Compiler * inCompiler
                                                COMMA_LOCATION_ARGS) {
  cMapElement_preferencesMap * p = NULL ;
  macroMyNew (p, cMapElement_preferencesMap (inKey, inArgument0, inArgument1, inArgument2, inArgument3, inArgument4, inArgument5, inArgument6, inArgument7, inArgument8 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
void GALGAS_preferencesMap::method_searchKey (GALGAS_lstring inKey,
                                              ...
                                              GALGAS_preferenceArrayMap & outArgument8,
                                              C_Compiler * inCompiler
                                              COMMA_LOCATION_ARGS) const {
  ...
  if (NULL == p) {
    ...
    outArgument5 = p->mAttribute_mHeaderFileInclusionSet ;
    outArgument6 = p->mAttribute_mImplementationFileInclusionSet ;
    outArgument7 = p->mAttribute_mControllerMap ;
    outArgument8 = p->mAttribute_mArrayMap ;
  }
}
...
GALGAS_stringset GALGAS_preferencesMap::reader_mHeaderFileInclusionSetForKey (const GALGAS_string & inKey,
                                                                              C_Compiler * inCompiler
                                                                              COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_preferencesMap * p = (const cMapElement_preferencesMap *) attributes ;
...
void GALGAS_preferencesMap::modifier_setMHeaderFileInclusionSetForKey (GALGAS_stringset inAttributeValue,
                                                                       GALGAS_string inKey,
                                                                       C_Compiler * inCompiler
                                                                       COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
...
GALGAS_preferencesMap_2E_element cEnumerator_preferencesMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cMapElement_preferencesMap) ;
  return GALGAS_preferencesMap_2E_element (p->mAttribute_lkey, p->mAttribute_mAttributeListForImplementation, p->mAttribute_mTransientListForImplementation, p->mAttribute_mOutletDeclarationList, p->mAttribute_mActionList, p->mAttribute_mObservablePropertyMap, p->mAttribute_mHeaderFileInclusionSet, p->mAttribute_mImplementationFileInclusionSet, p->mAttribute_mControllerMap, p->mAttribute_mArrayMap) ;
}
...
GALGAS_stringset cEnumerator_preferencesMap::current_mHeaderFileInclusionSet (LOCATION_ARGS) const {
  const cMapElement_preferencesMap * p = (const cMapElement_preferencesMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_preferencesMap) ;
  return p->mAttribute_mHeaderFileInclusionSet ;
}
...
GALGAS_globalEnumConstantMap GALGAS_globalEnumConstantMap::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_globalEnumConstantMap result ;
  getOverridenMap (result) ;
  return result ;
}
...
GALGAS_globalEnumConstantMap GALGAS_globalEnumConstantMap::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_globalEnumConstantMap *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "globalEnumConstantMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_enumConstantMap GALGAS_enumConstantMap::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_enumConstantMap result ;
  getOverridenMap (result) ;
  return result ;
}
...
GALGAS_enumConstantMap GALGAS_enumConstantMap::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_enumConstantMap *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "enumConstantMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_enumMap GALGAS_enumMap::reader_overriddenMap (UNUSED_LOCATION_ARGS) const {
  GALGAS_enumMap result ;
  getOverridenMap (result) ;
  return result ;
}
...
GALGAS_enumMap GALGAS_enumMap::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_enumMap *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "enumMap", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
static GALGAS_stringset onceFunction_predefinedColors (C_Compiler * /* inCompiler */
  ...
  result_outResult = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (507)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("blackColor") COMMA_SOURCE_FILE_AT_LINE (508)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("blueColor") COMMA_SOURCE_FILE_AT_LINE (509)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("brownColor") COMMA_SOURCE_FILE_AT_LINE (510)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("clearColor") COMMA_SOURCE_FILE_AT_LINE (511)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("controlColor") COMMA_SOURCE_FILE_AT_LINE (512)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("controlDarkShadowColor") COMMA_SOURCE_FILE_AT_LINE (513)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("controlHighlightColor") COMMA_SOURCE_FILE_AT_LINE (514)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("controlLightHighlightColor") COMMA_SOURCE_FILE_AT_LINE (515)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("controlShadowColor") COMMA_SOURCE_FILE_AT_LINE (516)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("controlTextColor") COMMA_SOURCE_FILE_AT_LINE (517)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("cyanColor") COMMA_SOURCE_FILE_AT_LINE (518)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("darkGrayColor") COMMA_SOURCE_FILE_AT_LINE (519)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("disabledControlTextColor") COMMA_SOURCE_FILE_AT_LINE (520)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("grayColor") COMMA_SOURCE_FILE_AT_LINE (521)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("greenColor") COMMA_SOURCE_FILE_AT_LINE (522)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("gridColor") COMMA_SOURCE_FILE_AT_LINE (523)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("headerColor") COMMA_SOURCE_FILE_AT_LINE (524)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("headerTextColor") COMMA_SOURCE_FILE_AT_LINE (525)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("highlightColor") COMMA_SOURCE_FILE_AT_LINE (526)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("keyboardFocusIndicatorColor") COMMA_SOURCE_FILE_AT_LINE (527)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("knobColor") COMMA_SOURCE_FILE_AT_LINE (528)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("lightGrayColor") COMMA_SOURCE_FILE_AT_LINE (529)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("magentaColor") COMMA_SOURCE_FILE_AT_LINE (530)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("orangeColor") COMMA_SOURCE_FILE_AT_LINE (531)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("purpleColor") COMMA_SOURCE_FILE_AT_LINE (532)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("redColor") COMMA_SOURCE_FILE_AT_LINE (533)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("scrollBarColor") COMMA_SOURCE_FILE_AT_LINE (534)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("selectedControlColor") COMMA_SOURCE_FILE_AT_LINE (535)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("selectedControlTextColor") COMMA_SOURCE_FILE_AT_LINE (536)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("selectedKnobColor") COMMA_SOURCE_FILE_AT_LINE (537)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("selectedMenuItemColor") COMMA_SOURCE_FILE_AT_LINE (538)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("selectedMenuItemTextColor") COMMA_SOURCE_FILE_AT_LINE (539)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("selectedTextBackgroundColor") COMMA_SOURCE_FILE_AT_LINE (540)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("selectedTextColor") COMMA_SOURCE_FILE_AT_LINE (541)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("shadowColor") COMMA_SOURCE_FILE_AT_LINE (542)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("textBackgroundColor") COMMA_SOURCE_FILE_AT_LINE (543)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("textColor") COMMA_SOURCE_FILE_AT_LINE (544)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("whiteColor") COMMA_SOURCE_FILE_AT_LINE (545)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("windowBackgroundColor") COMMA_SOURCE_FILE_AT_LINE (546)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("windowFrameColor") COMMA_SOURCE_FILE_AT_LINE (547)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("windowFrameTextColor") COMMA_SOURCE_FILE_AT_LINE (548)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("yellowColor") COMMA_SOURCE_FILE_AT_LINE (549)) ;
//---
...
static GALGAS_stringset onceFunction_predefinedDates (C_Compiler * /* inCompiler */
  ...
  GALGAS_stringset result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (555)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("date") COMMA_SOURCE_FILE_AT_LINE (556)) ;
//---
  return result_outResult ;
}
...
static GALGAS_stringset onceFunction_predefinedFonts (C_Compiler * /* inCompiler */
  ...
  GALGAS_stringset result_outResult ; // Returned variable
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (625)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("boldSystemFontOfSize") COMMA_SOURCE_FILE_AT_LINE (626)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("controlContentFontOfSize") COMMA_SOURCE_FILE_AT_LINE (627)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("labelFontOfSize") COMMA_SOURCE_FILE_AT_LINE (628)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("menuFontOfSize") COMMA_SOURCE_FILE_AT_LINE (629)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("menuBarFontOfSize") COMMA_SOURCE_FILE_AT_LINE (630)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("messageFontOfSize") COMMA_SOURCE_FILE_AT_LINE (631)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("paletteFontOfSize") COMMA_SOURCE_FILE_AT_LINE (632)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("systemFontOfSize") COMMA_SOURCE_FILE_AT_LINE (633)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("titleBarFontOfSize") COMMA_SOURCE_FILE_AT_LINE (634)) ;
  //-------- @plusEqualnstructionForGeneration
  result_outResult.addAssign_operation (GALGAS_string ("toolTipsFontOfSize") COMMA_SOURCE_FILE_AT_LINE (635)) ;
//---
  return result_outResult ;
}
...
//--- Find method
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inRootEntityObservableAttributeMap, constin_inSelfObservableAttributeMap, constin_inPreferencesMap, constin_inEntityMap, constin_inClassMap, constin_inBindingMap, constin_inControllerMap, constin_inActionMap, constin_inHasTableValueBinding, constin_inGlobalEnumConstantMap, io_ioOutletBindingListForGeneration, io_ioImplementationFileInclusionSet, inCompiler COMMA_THERE) ;
    }
  }
}
...
//--- Find method
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inAllRelationshipMap, constin_inPreferenceArrayMap, constin_inControllerClassBindingMap, constin_inControlledClassOrEntityName, constin_inAllObservablePropertyMap, constin_inGlobalEnumConstantMap, io_ioBindingListForGeneration, inCompiler COMMA_THERE) ;
    }
  }
}
...
//--- Find method
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inAttributeActualTypeList, constin_inGlobalEnumConstantMap, out_outDirectDefaultValueAsString, out_outObjectiveCDefaultValueAsString, inCompiler COMMA_THERE) ;
    }
  }
}
...
//---------------------------------------------------------------------------*
//                                                                           *
//  Overriding category method '@boolDefaultValue analyzeDefaultValueType'   *
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_boolDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
                                                                     ...
                                                                     C_Compiler * inCompiler
                                                                     COMMA_UNUSED_LOCATION_ARGS) {
  const cPtr_boolDefaultValue * object = (const cPtr_boolDefaultValue *) inObject ;
  macroValidSharedObject (object, const cPtr_boolDefaultValue) ;
  //-------- @assignmentInstructionForGeneration
  ...
  cEnumerator_easyBindingTypeList enumerator_15197 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (415)).isValidAndTrue () ;
  if (enumerator_15197.hasCurrentObject () && bool_0) {
    while (enumerator_15197.hasCurrentObject () && bool_0) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = callCategoryReader_isBoolType ((const cPtr_easyBindingType *) enumerator_15197.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (416)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @assignmentInstructionForGeneration
        ...
        //-------- @assignmentInstructionForGeneration
        outArgument_outObjectiveCDefaultValueAsString = GALGAS_string ("[NSNumber numberWithBool:").operator_concat (outArgument_outDirectDefaultValueAsString COMMA_SOURCE_FILE_AT_LINE (418)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (418)) ;
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (true) ;
      }
      enumerator_15197.gotoNextObject () ;
      if (enumerator_15197.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (415)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (422)).boolEnum () ;
  if (kBoolTrue == test_4) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_5 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_5, GALGAS_string ("only a boolean attribute can be initialized by YES or NO") COMMA_SOURCE_FILE_AT_LINE (423)) ;
  }
}
//---------------------------------------------------------------------------*

static void defineCategoryMethod_boolDefaultValue_analyzeDefaultValueType (void) {
  enterCategoryMethod_analyzeDefaultValueType (kTypeDescriptor_GALGAS_boolDefaultValue.mSlotID,
                                               categoryMethod_boolDefaultValue_analyzeDefaultValueType) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_boolDefaultValue_analyzeDefaultValueType (defineCategoryMethod_boolDefaultValue_analyzeDefaultValueType, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
// Overriding category method '@integerDefaultValue analyzeDefaultValueType' *
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_integerDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
                                                                        const GALGAS_easyBindingTypeList constinArgument_inAttributeActualTypeList,
                                                                        const GALGAS_globalEnumConstantMap /* constinArgument_inGlobalEnumConstantMap */,
                                                                        GALGAS_string & outArgument_outDirectDefaultValueAsString,
                                                                        GALGAS_string & outArgument_outObjectiveCDefaultValueAsString,
                                                                        C_Compiler * inCompiler
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  const cPtr_integerDefaultValue * object = (const cPtr_integerDefaultValue *) inObject ;
  macroValidSharedObject (object, const cPtr_integerDefaultValue) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outObjectiveCDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outDirectDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_16112 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (440)).isValidAndTrue () ;
  if (enumerator_16112.hasCurrentObject () && bool_0) {
    while (enumerator_16112.hasCurrentObject () && bool_0) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = callCategoryReader_isIntegerType ((const cPtr_easyBindingType *) enumerator_16112.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (441)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @assignmentInstructionForGeneration
        outArgument_outDirectDefaultValueAsString = object->mAttribute_mValue.mAttribute_uint.reader_string (SOURCE_FILE_AT_LINE (442)) ;
        //-------- @assignmentInstructionForGeneration
        outArgument_outObjectiveCDefaultValueAsString = GALGAS_string ("[NSNumber numberWithInteger:").operator_concat (outArgument_outDirectDefaultValueAsString COMMA_SOURCE_FILE_AT_LINE (443)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (443)) ;
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (true) ;
      }
      enumerator_16112.gotoNextObject () ;
      if (enumerator_16112.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (440)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (447)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_3 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("only an integer attribute can be initialized by an integer constant") COMMA_SOURCE_FILE_AT_LINE (448)) ;
  }
}
//---------------------------------------------------------------------------*

static void defineCategoryMethod_integerDefaultValue_analyzeDefaultValueType (void) {
  enterCategoryMethod_analyzeDefaultValueType (kTypeDescriptor_GALGAS_integerDefaultValue.mSlotID,
                                               categoryMethod_integerDefaultValue_analyzeDefaultValueType) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_integerDefaultValue_analyzeDefaultValueType (defineCategoryMethod_integerDefaultValue_analyzeDefaultValueType, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
// Overriding category method '@doubleDefaultValue analyzeDefaultValueType'  *
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_doubleDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
                                                                       const GALGAS_easyBindingTypeList constinArgument_inAttributeActualTypeList,
                                                                       const GALGAS_globalEnumConstantMap /* constinArgument_inGlobalEnumConstantMap */,
                                                                       GALGAS_string & outArgument_outDirectDefaultValueAsString,
                                                                       GALGAS_string & outArgument_outObjectiveCDefaultValueAsString,
                                                                       C_Compiler * inCompiler
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  const cPtr_doubleDefaultValue * object = (const cPtr_doubleDefaultValue *) inObject ;
  macroValidSharedObject (object, const cPtr_doubleDefaultValue) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outObjectiveCDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outDirectDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_17024 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (465)).isValidAndTrue () ;
  if (enumerator_17024.hasCurrentObject () && bool_0) {
    while (enumerator_17024.hasCurrentObject () && bool_0) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = callCategoryReader_isDoubleType ((const cPtr_easyBindingType *) enumerator_17024.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (466)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @assignmentInstructionForGeneration
        outArgument_outDirectDefaultValueAsString = object->mAttribute_mValue.mAttribute_double.reader_string (SOURCE_FILE_AT_LINE (467)) ;
        //-------- @assignmentInstructionForGeneration
        outArgument_outObjectiveCDefaultValueAsString = GALGAS_string ("[NSNumber numberWithDouble:").operator_concat (outArgument_outDirectDefaultValueAsString COMMA_SOURCE_FILE_AT_LINE (468)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (468)) ;
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (true) ;
      }
      enumerator_17024.gotoNextObject () ;
      if (enumerator_17024.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (465)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (472)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_3 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("only a double attribute can be initialized by a floating point constant") COMMA_SOURCE_FILE_AT_LINE (473)) ;
  }
}
//---------------------------------------------------------------------------*

static void defineCategoryMethod_doubleDefaultValue_analyzeDefaultValueType (void) {
  enterCategoryMethod_analyzeDefaultValueType (kTypeDescriptor_GALGAS_doubleDefaultValue.mSlotID,
                                               categoryMethod_doubleDefaultValue_analyzeDefaultValueType) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_doubleDefaultValue_analyzeDefaultValueType (defineCategoryMethod_doubleDefaultValue_analyzeDefaultValueType, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
// Overriding category method '@stringDefaultValue analyzeDefaultValueType'  *
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_stringDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
                                                                       const GALGAS_easyBindingTypeList constinArgument_inAttributeActualTypeList,
                                                                       const GALGAS_globalEnumConstantMap /* constinArgument_inGlobalEnumConstantMap */,
                                                                       GALGAS_string & outArgument_outDirectDefaultValueAsString,
                                                                       GALGAS_string & outArgument_outObjectiveCDefaultValueAsString,
                                                                       C_Compiler * inCompiler
                                                                       COMMA_UNUSED_LOCATION_ARGS) {
  const cPtr_stringDefaultValue * object = (const cPtr_stringDefaultValue *) inObject ;
  macroValidSharedObject (object, const cPtr_stringDefaultValue) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outObjectiveCDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outDirectDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_17940 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (490)).isValidAndTrue () ;
  if (enumerator_17940.hasCurrentObject () && bool_0) {
    while (enumerator_17940.hasCurrentObject () && bool_0) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = callCategoryReader_isStringType ((const cPtr_easyBindingType *) enumerator_17940.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (491)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @assignmentInstructionForGeneration
        outArgument_outDirectDefaultValueAsString = GALGAS_string ("@").operator_concat (object->mAttribute_mValue.mAttribute_string.reader_utf_38_Representation (SOURCE_FILE_AT_LINE (492)) COMMA_SOURCE_FILE_AT_LINE (492)) ;
        //-------- @assignmentInstructionForGeneration
        outArgument_outObjectiveCDefaultValueAsString = outArgument_outDirectDefaultValueAsString ;
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (true) ;
      }
      enumerator_17940.gotoNextObject () ;
      if (enumerator_17940.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (490)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (497)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_3 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("only a string attribute can be initialized by a string constant") COMMA_SOURCE_FILE_AT_LINE (498)) ;
  }
}
//---------------------------------------------------------------------------*

static void defineCategoryMethod_stringDefaultValue_analyzeDefaultValueType (void) {
  enterCategoryMethod_analyzeDefaultValueType (kTypeDescriptor_GALGAS_stringDefaultValue.mSlotID,
                                               categoryMethod_stringDefaultValue_analyzeDefaultValueType) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_stringDefaultValue_analyzeDefaultValueType (defineCategoryMethod_stringDefaultValue_analyzeDefaultValueType, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category method '@identifierDefaultValue analyzeDefaultValueType'*
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_identifierDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
                                                                           const GALGAS_easyBindingTypeList constinArgument_inAttributeActualTypeList,
                                                                           const GALGAS_globalEnumConstantMap constinArgument_inGlobalEnumConstantMap,
                                                                           GALGAS_string & outArgument_outDirectDefaultValueAsString,
                                                                           GALGAS_string & outArgument_outObjectiveCDefaultValueAsString,
                                                                           C_Compiler * inCompiler
                                                                           COMMA_UNUSED_LOCATION_ARGS) {
  const cPtr_identifierDefaultValue * object = (const cPtr_identifierDefaultValue *) inObject ;
  macroValidSharedObject (object, const cPtr_identifierDefaultValue) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outObjectiveCDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outDirectDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_20743 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (570)).isValidAndTrue () ;
  if (enumerator_20743.hasCurrentObject () && bool_0) {
    while (enumerator_20743.hasCurrentObject () && bool_0) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = callCategoryReader_isColorType ((const cPtr_easyBindingType *) enumerator_20743.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (571)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (true) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_2 = function_predefinedColors (inCompiler COMMA_SOURCE_FILE_AT_LINE (573)).reader_hasKey (object->mAttribute_mValue.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (573)).boolEnum () ;
        if (kBoolTrue == test_2) {
          //-------- @assignmentInstructionForGeneration
          outArgument_outDirectDefaultValueAsString = GALGAS_string ("[NSColor ").operator_concat (object->mAttribute_mValue.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (574)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (574)) ;
          //-------- @assignmentInstructionForGeneration
          outArgument_outObjectiveCDefaultValueAsString = outArgument_outDirectDefaultValueAsString ;
        }else if (kBoolFalse == test_2) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_3 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("unknown predefined color") COMMA_SOURCE_FILE_AT_LINE (577)) ;
        ...
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = callCategoryReader_isDateType ((const cPtr_easyBindingType *) enumerator_20743.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (582)).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @assignmentInstructionForGeneration
          var_found = GALGAS_bool (true) ;
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_5 = function_predefinedDates (inCompiler COMMA_SOURCE_FILE_AT_LINE (584)).reader_hasKey (object->mAttribute_mValue.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (584)).boolEnum () ;
          if (kBoolTrue == test_5) {
            //-------- @assignmentInstructionForGeneration
            outArgument_outDirectDefaultValueAsString = GALGAS_string ("[NSDate ").operator_concat (object->mAttribute_mValue.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (585)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (585)) ;
            //-------- @assignmentInstructionForGeneration
            outArgument_outObjectiveCDefaultValueAsString = outArgument_outDirectDefaultValueAsString ;
          }else if (kBoolFalse == test_5) {
            //-------- @errorInstructionForGeneration
            GALGAS_location location_6 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_6, GALGAS_string ("unknown predefined date") COMMA_SOURCE_FILE_AT_LINE (588)) ;
            outArgument_outDirectDefaultValueAsString.drop () ; // Release error dropped variable
            outArgument_outObjectiveCDefaultValueAsString.drop () ; // Release error dropped variable
          }
        }else if (kBoolFalse == test_4) {
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_7 = callCategoryReader_isEnumType ((const cPtr_easyBindingType *) enumerator_20743.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (593)).boolEnum () ;
          if (kBoolTrue == test_7) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (true) ;
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_8 = constinArgument_inGlobalEnumConstantMap.reader_hasKey (object->mAttribute_mValue.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (595)).boolEnum () ;
            if (kBoolTrue == test_8) {
              //-------- @localVariableDeclarationForGeneration
              GALGAS_lstring var_inEnumTypeName ;
              //-------- @methodCallInstructionForGeneration
              constinArgument_inGlobalEnumConstantMap.method_searchKey (object->mAttribute_mValue, var_inEnumTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (596)) ;
              //-------- END @methodCallInstructionForGeneration
              //-------- @ifInstructionForGeneration
              const enumGalgasBool test_9 = GALGAS_bool (kIsEqual, callCategoryReader_ebTypeIdentifier ((const cPtr_easyBindingType *) enumerator_20743.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (597)).objectCompare (callCategoryReader_ebTypeIdentifier ((const cPtr_enumType *) GALGAS_enumType::constructor_new (var_inEnumTypeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (597)).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (597)))).boolEnum () ;
              if (kBoolTrue == test_9) {
                //-------- @assignmentInstructionForGeneration
                outArgument_outDirectDefaultValueAsString = object->mAttribute_mValue.mAttribute_string ;
                //-------- @assignmentInstructionForGeneration
                outArgument_outObjectiveCDefaultValueAsString = GALGAS_string ("[NSNumber numberWithInteger:").operator_concat (object->mAttribute_mValue.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (599)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (599)) ;
              }else if (kBoolFalse == test_9) {
                //-------- @errorInstructionForGeneration
                GALGAS_location location_10 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
                inCompiler->emitSemanticError (location_10, GALGAS_string ("bad enum constant, belongs to the '").operator_concat (var_inEnumTypeName.reader_string (SOURCE_FILE_AT_LINE (602)) COMMA_SOURCE_FILE_AT_LINE (602)).operator_concat (GALGAS_string ("' enum type") COMMA_SOURCE_FILE_AT_LINE (602)) COMMA_SOURCE_FILE_AT_LINE (601)) ;
                outArgument_outDirectDefaultValueAsString.drop () ; // Release error dropped variable
                outArgument_outObjectiveCDefaultValueAsString.drop () ; // Release error dropped variable
              }
              ...
              inCompiler->emitSemanticError (location_11, GALGAS_string ("unknown predefined date") COMMA_SOURCE_FILE_AT_LINE (607)) ;
              outArgument_outDirectDefaultValueAsString.drop () ; // Release error dropped variable
              outArgument_outObjectiveCDefaultValueAsString.drop () ; // Release error dropped variable
            }
          }
      ...
      if (enumerator_20743.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (570)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_12 = var_found.operator_not (SOURCE_FILE_AT_LINE (614)).boolEnum () ;
  if (kBoolTrue == test_12) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_13 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_13, GALGAS_string ("unknow type for this identifier") COMMA_SOURCE_FILE_AT_LINE (615)) ;
    outArgument_outDirectDefaultValueAsString.drop () ; // Release error dropped variable
    outArgument_outObjectiveCDefaultValueAsString.drop () ; // Release error dropped variable
  }
}
...
static void defineCategoryMethod_identifierDefaultValue_analyzeDefaultValueType (void) {
  enterCategoryMethod_analyzeDefaultValueType (kTypeDescriptor_GALGAS_identifierDefaultValue.mSlotID,
                                               categoryMethod_identifierDefaultValue_analyzeDefaultValueType) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_identifierDefaultValue_analyzeDefaultValueType (defineCategoryMethod_identifierDefaultValue_analyzeDefaultValueType, NULL) ;

//---------------------------------------------------------------------------*
//                                                                           *
//Overriding category method '@identifierIntegerDefaultValue analyzeDefaultValueType'*
//                                                                           *
//---------------------------------------------------------------------------*

static void categoryMethod_identifierIntegerDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
                                                                                  const GALGAS_easyBindingTypeList constinArgument_inAttributeActualTypeList,
                                                                                  const GALGAS_globalEnumConstantMap /* constinArgument_inGlobalEnumConstantMap */,
                                                                                  GALGAS_string & outArgument_outDirectDefaultValueAsString,
                                                                                  GALGAS_string & outArgument_outObjectiveCDefaultValueAsString,
                                                                                  C_Compiler * inCompiler
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  const cPtr_identifierIntegerDefaultValue * object = (const cPtr_identifierIntegerDefaultValue *) inObject ;
  macroValidSharedObject (object, const cPtr_identifierIntegerDefaultValue) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outObjectiveCDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outDirectDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_23777 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (649)).isValidAndTrue () ;
  if (enumerator_23777.hasCurrentObject () && bool_0) {
    while (enumerator_23777.hasCurrentObject () && bool_0) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = callCategoryReader_isFontType ((const cPtr_easyBindingType *) enumerator_23777.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (650)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (true) ;
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_2 = function_predefinedFonts (inCompiler COMMA_SOURCE_FILE_AT_LINE (652)).reader_hasKey (object->mAttribute_mIdentifier.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (652)).boolEnum () ;
        if (kBoolTrue == test_2) {
          //-------- @assignmentInstructionForGeneration
          outArgument_outDirectDefaultValueAsString = GALGAS_string ("[NSFont ").operator_concat (object->mAttribute_mIdentifier.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (653)).operator_concat (GALGAS_string (":") COMMA_SOURCE_FILE_AT_LINE (653)).operator_concat (object->mAttribute_mInteger.mAttribute_uint.reader_string (SOURCE_FILE_AT_LINE (653)) COMMA_SOURCE_FILE_AT_LINE (653)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (653)) ;
          //-------- @assignmentInstructionForGeneration
          outArgument_outObjectiveCDefaultValueAsString = outArgument_outDirectDefaultValueAsString ;
        }else if (kBoolFalse == test_2) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_3 (object->mAttribute_mIdentifier.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("unknown predefined font name") COMMA_SOURCE_FILE_AT_LINE (656)) ;
          outArgument_outDirectDefaultValueAsString.drop () ; // Release error dropped variable
          outArgument_outObjectiveCDefaultValueAsString.drop () ; // Release error dropped variable
        }
      }
      enumerator_23777.gotoNextObject () ;
      if (enumerator_23777.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (649)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (663)).boolEnum () ;
  if (kBoolTrue == test_4) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_5 (object->mAttribute_mIdentifier.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_5, GALGAS_string ("only a font attribute can be initialized by an identifier followed by an integer constant") COMMA_SOURCE_FILE_AT_LINE (664)) ;
  }
}
//---------------------------------------------------------------------------*

static void defineCategoryMethod_identifierIntegerDefaultValue_analyzeDefaultValueType (void) {
  enterCategoryMethod_analyzeDefaultValueType (kTypeDescriptor_GALGAS_identifierIntegerDefaultValue.mSlotID,
                                               categoryMethod_identifierIntegerDefaultValue_analyzeDefaultValueType) ;
}

//---------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_identifierIntegerDefaultValue_analyzeDefaultValueType (defineCategoryMethod_identifierIntegerDefaultValue_analyzeDefaultValueType, NULL) ;
...
mAttribute_mHeaderFileInclusionSet (inOperand8) {
}
...
GALGAS_classMap_2E_element GALGAS_classMap_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid ()) {
    result = GALGAS_classMap_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8) ;
  }
  return result ;
}
...
GALGAS_stringset GALGAS_classMap_2E_element::reader_mHeaderFileInclusionSet (UNUSED_LOCATION_ARGS) const {
...
mAttribute_mHeaderFileInclusionSet (inOperand14),
mAttribute_mImplementationFileInclusionSet (inOperand15),
mAttribute_mToManyRelationshipList (inOperand16) {
}
...
GALGAS_entityMap_2E_element GALGAS_entityMap_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid () && inOperand10.isValid () && inOperand11.isValid () && inOperand12.isValid () && inOperand13.isValid () && inOperand14.isValid () && inOperand15.isValid () && inOperand16.isValid ()) {
    result = GALGAS_entityMap_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9, inOperand10, inOperand11, inOperand12, inOperand13, inOperand14, inOperand15, inOperand16) ;
  }
  return result ;
}
...
GALGAS_stringset GALGAS_entityMap_2E_element::reader_mHeaderFileInclusionSet (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mHeaderFileInclusionSet ;
}
...
mAttribute_mHeaderFileInclusionSet (inOperand6),
mAttribute_mImplementationFileInclusionSet (inOperand7),
mAttribute_mControllerMap (inOperand8),
mAttribute_mArrayMap (inOperand9) {
}
...
GALGAS_preferencesMap_2E_element GALGAS_preferencesMap_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid ()) {
    result = GALGAS_preferencesMap_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9) ;
  }
  return result ;
}
...
GALGAS_stringset GALGAS_preferencesMap_2E_element::reader_mHeaderFileInclusionSet (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mHeaderFileInclusionSet ;
}
...
GALGAS_globalEnumConstantMap_2E_element GALGAS_globalEnumConstantMap_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_globalEnumConstantMap_2E_element *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "globalEnumConstantMap.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_enumConstantMap_2E_element GALGAS_enumConstantMap_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_enumConstantMap_2E_element *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "enumConstantMap.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_enumMap_2E_element GALGAS_enumMap_2E_element::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_enumMap_2E_element *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "enumMap.element", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
