...
bool cMapElement_arrayControllerMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mBoundModel.isValid () && mAttribute_mTableViewOutletName.isValid () && mAttribute_mArrayControllerBoundColumnListAST.isValid () ;
}
...
cMapElement * cMapElement_arrayControllerMap::copy (void) {
  ...
  macroMyNew (result, cMapElement_arrayControllerMap (mAttribute_lkey, mAttribute_mBoundModel, mAttribute_mTableViewOutletName, mAttribute_mArrayControllerBoundColumnListAST COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_arrayControllerMap::addAssign_operation (const GALGAS_lstring & inKey,
  ...
  macroMyNew (p, cMapElement_arrayControllerMap (inKey, inArgument0, inArgument1, inArgument2 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
GALGAS_arrayControllerMap_2D_element cEnumerator_arrayControllerMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, cMapElement_arrayControllerMap) ;
  return GALGAS_arrayControllerMap_2D_element (p->mAttribute_lkey, p->mAttribute_mBoundModel, p->mAttribute_mTableViewOutletName, p->mAttribute_mArrayControllerBoundColumnListAST) ;
}
...
static GALGAS_stringset onceFunction_predefinedColors (C_Compiler * /* inCompiler */
  ...
  result_outResult = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("decoratedTypes.gSemantics", 739)) ;
  result_outResult.addAssign_operation (GALGAS_string ("blackColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 740)) ;
  result_outResult.addAssign_operation (GALGAS_string ("blueColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 741)) ;
  result_outResult.addAssign_operation (GALGAS_string ("brownColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 742)) ;
  result_outResult.addAssign_operation (GALGAS_string ("clearColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 743)) ;
  result_outResult.addAssign_operation (GALGAS_string ("controlColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 744)) ;
  result_outResult.addAssign_operation (GALGAS_string ("controlDarkShadowColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 745)) ;
  result_outResult.addAssign_operation (GALGAS_string ("controlHighlightColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 746)) ;
  result_outResult.addAssign_operation (GALGAS_string ("controlLightHighlightColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 747)) ;
  result_outResult.addAssign_operation (GALGAS_string ("controlShadowColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 748)) ;
  result_outResult.addAssign_operation (GALGAS_string ("controlTextColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 749)) ;
  result_outResult.addAssign_operation (GALGAS_string ("cyanColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 750)) ;
  result_outResult.addAssign_operation (GALGAS_string ("darkGrayColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 751)) ;
  result_outResult.addAssign_operation (GALGAS_string ("disabledControlTextColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 752)) ;
  result_outResult.addAssign_operation (GALGAS_string ("grayColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 753)) ;
  result_outResult.addAssign_operation (GALGAS_string ("greenColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 754)) ;
  result_outResult.addAssign_operation (GALGAS_string ("gridColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 755)) ;
  result_outResult.addAssign_operation (GALGAS_string ("headerColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 756)) ;
  result_outResult.addAssign_operation (GALGAS_string ("headerTextColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 757)) ;
  result_outResult.addAssign_operation (GALGAS_string ("highlightColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 758)) ;
  result_outResult.addAssign_operation (GALGAS_string ("keyboardFocusIndicatorColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 759)) ;
  result_outResult.addAssign_operation (GALGAS_string ("knobColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 760)) ;
  result_outResult.addAssign_operation (GALGAS_string ("lightGrayColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 761)) ;
  result_outResult.addAssign_operation (GALGAS_string ("magentaColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 762)) ;
  result_outResult.addAssign_operation (GALGAS_string ("orangeColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 763)) ;
  result_outResult.addAssign_operation (GALGAS_string ("purpleColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 764)) ;
  result_outResult.addAssign_operation (GALGAS_string ("redColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 765)) ;
  result_outResult.addAssign_operation (GALGAS_string ("scrollBarColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 766)) ;
  result_outResult.addAssign_operation (GALGAS_string ("selectedControlColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 767)) ;
  result_outResult.addAssign_operation (GALGAS_string ("selectedControlTextColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 768)) ;
  result_outResult.addAssign_operation (GALGAS_string ("selectedKnobColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 769)) ;
  result_outResult.addAssign_operation (GALGAS_string ("selectedMenuItemColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 770)) ;
  result_outResult.addAssign_operation (GALGAS_string ("selectedMenuItemTextColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 771)) ;
  result_outResult.addAssign_operation (GALGAS_string ("selectedTextBackgroundColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 772)) ;
  result_outResult.addAssign_operation (GALGAS_string ("selectedTextColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 773)) ;
  result_outResult.addAssign_operation (GALGAS_string ("shadowColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 774)) ;
  result_outResult.addAssign_operation (GALGAS_string ("textBackgroundColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 775)) ;
  result_outResult.addAssign_operation (GALGAS_string ("textColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 776)) ;
  result_outResult.addAssign_operation (GALGAS_string ("whiteColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 777)) ;
  result_outResult.addAssign_operation (GALGAS_string ("windowBackgroundColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 778)) ;
  result_outResult.addAssign_operation (GALGAS_string ("windowFrameColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 779)) ;
  result_outResult.addAssign_operation (GALGAS_string ("windowFrameTextColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 780)) ;
  result_outResult.addAssign_operation (GALGAS_string ("yellowColor")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 781)) ;
//---
...
static GALGAS_stringset onceFunction_predefinedDates (C_Compiler * /* inCompiler */
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringset result_outResult ; // Returned variable
  result_outResult = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("decoratedTypes.gSemantics", 787)) ;
  result_outResult.addAssign_operation (GALGAS_string ("date")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 788)) ;
//---
  return result_outResult ;
}
...
static GALGAS_stringset onceFunction_predefinedFonts (C_Compiler * /* inCompiler */
                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_stringset result_outResult ; // Returned variable
  result_outResult = GALGAS_stringset::constructor_emptySet (SOURCE_FILE ("decoratedTypes.gSemantics", 840)) ;
  result_outResult.addAssign_operation (GALGAS_string ("boldSystemFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 841)) ;
  result_outResult.addAssign_operation (GALGAS_string ("controlContentFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 842)) ;
  result_outResult.addAssign_operation (GALGAS_string ("labelFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 843)) ;
  result_outResult.addAssign_operation (GALGAS_string ("menuFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 844)) ;
  result_outResult.addAssign_operation (GALGAS_string ("menuBarFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 845)) ;
  result_outResult.addAssign_operation (GALGAS_string ("messageFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 846)) ;
  result_outResult.addAssign_operation (GALGAS_string ("paletteFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 847)) ;
  result_outResult.addAssign_operation (GALGAS_string ("systemFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 848)) ;
  result_outResult.addAssign_operation (GALGAS_string ("titleBarFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 849)) ;
  result_outResult.addAssign_operation (GALGAS_string ("toolTipsFontOfSize")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 850)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_boolAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  cEnumerator_unifiedTypeProxyList enumerator_22886 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 654)).isValidAndTrue () ;
  if (enumerator_22886.hasCurrentObject () && bool_0) {
    while (enumerator_22886.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_22886.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 655)).objectCompare (GALGAS_typeKind::constructor_boolType (SOURCE_FILE ("decoratedTypes.gSemantics", 655)))).boolEnum () ;
      if (kBoolTrue == test_1) {
      ...
      if (enumerator_22886.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 654)).isValidAndTrue () ;
      }
    }
  }
  const enumGalgasBool test_4 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 660)).boolEnum () ;
  if (kBoolTrue == test_4) {
    GALGAS_location location_5 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_5, GALGAS_string ("only a boolean attribute can be initialized by YES or NO")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 661)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_integerAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  outArgument_outSwiftDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  cEnumerator_unifiedTypeProxyList enumerator_23680 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 677)).isValidAndTrue () ;
  if (enumerator_23680.hasCurrentObject () && bool_0) {
    while (enumerator_23680.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_23680.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 678)).objectCompare (GALGAS_typeKind::constructor_integerType (SOURCE_FILE ("decoratedTypes.gSemantics", 678)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        outArgument_outSwiftDefaultValueAsString = object->mAttribute_mValue.mAttribute_uint.reader_string (SOURCE_FILE ("decoratedTypes.gSemantics", 679)) ;
        var_found = GALGAS_bool (true) ;
      }
      enumerator_23680.gotoNextObject () ;
      if (enumerator_23680.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 677)).isValidAndTrue () ;
      }
    }
  }
  const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 683)).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("only an integer attribute can be initialized by an integer constant")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 684)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_doubleAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  outArgument_outSwiftDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  cEnumerator_unifiedTypeProxyList enumerator_24465 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 700)).isValidAndTrue () ;
  if (enumerator_24465.hasCurrentObject () && bool_0) {
    while (enumerator_24465.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_24465.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 701)).objectCompare (GALGAS_typeKind::constructor_doubleType (SOURCE_FILE ("decoratedTypes.gSemantics", 701)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        outArgument_outSwiftDefaultValueAsString = object->mAttribute_mValue.mAttribute_double.reader_string (SOURCE_FILE ("decoratedTypes.gSemantics", 702)) ;
        var_found = GALGAS_bool (true) ;
      }
      enumerator_24465.gotoNextObject () ;
      if (enumerator_24465.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 700)).isValidAndTrue () ;
      }
    }
  }
  const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 706)).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("only a double attribute can be initialized by a floating point constant")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 707)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_stringAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  outArgument_outSwiftDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  cEnumerator_unifiedTypeProxyList enumerator_25254 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 723)).isValidAndTrue () ;
  if (enumerator_25254.hasCurrentObject () && bool_0) {
    while (enumerator_25254.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_25254.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 724)).objectCompare (GALGAS_typeKind::constructor_stringType (SOURCE_FILE ("decoratedTypes.gSemantics", 724)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        outArgument_outSwiftDefaultValueAsString = GALGAS_string ("\"").operator_concat (object->mAttribute_mValue.mAttribute_string  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 725)).operator_concat (GALGAS_string ("\"")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 725)) ;
        var_found = GALGAS_bool (true) ;
      }
      enumerator_25254.gotoNextObject () ;
      if (enumerator_25254.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 723)).isValidAndTrue () ;
      }
    }
  }
  const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 729)).boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("only a string attribute can be initialized by a string constant")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 730)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_identifierAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  outArgument_outSwiftDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  cEnumerator_unifiedTypeProxyList enumerator_27839 (constinArgument_inAttributeActualTypeList, kEnumeration_up) ;
  bool bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 799)).isValidAndTrue () ;
  if (enumerator_27839.hasCurrentObject () && bool_0) {
    while (enumerator_27839.hasCurrentObject () && bool_0) {
      const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, enumerator_27839.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 800)).objectCompare (GALGAS_typeKind::constructor_colorType (SOURCE_FILE ("decoratedTypes.gSemantics", 800)))).boolEnum () ;
      if (kBoolTrue == test_1) {
        var_found = GALGAS_bool (true) ;
        const enumGalgasBool test_2 = function_predefinedColors (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 802)).reader_hasKey (object->mAttribute_mValue.mAttribute_string COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 802)).boolEnum () ;
        if (kBoolTrue == test_2) {
          outArgument_outSwiftDefaultValueAsString = GALGAS_string ("NSColor.").operator_concat (object->mAttribute_mValue.mAttribute_string  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 803)).operator_concat (GALGAS_string (" ()")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 803)) ;
        }else if (kBoolFalse == test_2) {
          GALGAS_location location_3 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("unknown predefined color")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 805)) ;
        }
      }else if (kBoolFalse == test_1) {
        const enumGalgasBool test_4 = GALGAS_bool (kIsEqual, enumerator_27839.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 809)).objectCompare (GALGAS_typeKind::constructor_dateType (SOURCE_FILE ("decoratedTypes.gSemantics", 809)))).boolEnum () ;
        if (kBoolTrue == test_4) {
          var_found = GALGAS_bool (true) ;
          const enumGalgasBool test_5 = function_predefinedDates (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 811)).reader_hasKey (object->mAttribute_mValue.mAttribute_string COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 811)).boolEnum () ;
          if (kBoolTrue == test_5) {
            ...
            inCompiler->emitSemanticError (location_6, GALGAS_string ("unknown predefined date")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 814)) ;
          }
        }else if (kBoolFalse == test_4) {
          const enumGalgasBool test_7 = GALGAS_bool (kIsEqual, enumerator_27839.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 818)).objectCompare (GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("decoratedTypes.gSemantics", 818)))).boolEnum () ;
          if (kBoolTrue == test_7) {
            var_found = GALGAS_bool (true) ;
            const enumGalgasBool test_8 = enumerator_27839.current_mType (HERE).reader_mEnumConstantMap (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 820)).reader_hasKey (object->mAttribute_mValue.mAttribute_string COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 820)).boolEnum () ;
            if (kBoolTrue == test_8) {
              outArgument_outSwiftDefaultValueAsString = enumerator_27839.current_mType (HERE).reader_lkey (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 821)).mAttribute_string.operator_concat (GALGAS_string (".")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 821)).operator_concat (object->mAttribute_mValue.mAttribute_string  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 821)) ;
            }else if (kBoolFalse == test_8) {
              GALGAS_location location_9 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
              inCompiler->emitSemanticError (location_9, GALGAS_string ("the '").operator_concat (enumerator_27839.current_mType (HERE).reader_lkey (inCompiler COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 824)).reader_string (SOURCE_FILE ("decoratedTypes.gSemantics", 824))  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 824)).operator_concat (GALGAS_string ("' enumeration does not define '")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 824)).operator_concat (object->mAttribute_mValue.reader_string (SOURCE_FILE ("decoratedTypes.gSemantics", 824))  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 824)).operator_concat (GALGAS_string ("' constant")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 824))  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 823)) ;
      ...
      if (enumerator_27839.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 799)).isValidAndTrue () ;
      }
    }
  }
  const enumGalgasBool test_10 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 830)).boolEnum () ;
  if (kBoolTrue == test_10) {
    GALGAS_location location_11 (object->mAttribute_mValue.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_11, GALGAS_string ("unknow type for this identifier")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 831)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_listAsDefaultValue_analyzeDefaultValueType (const cPtr_abstractDefaultValue * inObject,
  ...
  outArgument_outSwiftDefaultValueAsString = GALGAS_string::makeEmptyString () ;
  GALGAS_bool var_found = GALGAS_bool (false) ;
  const enumGalgasBool test_0 = var_found.operator_not (SOURCE_FILE ("decoratedTypes.gSemantics", 923)).boolEnum () ;
  if (kBoolTrue == test_0) {
    inCompiler->emitSemanticError (object->mAttribute_mStartLocation, GALGAS_string ("invalid initialization value")  COMMA_SOURCE_FILE ("decoratedTypes.gSemantics", 924)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_arrayControllerMap_2D_element GALGAS_arrayControllerMap_2D_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_arrayControllerMap_2D_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
