...
static void categoryMethod_enumDeclaration_typeInventory (const cPtr_astDeclaration * inObject,
  ...
  ioArgument_ioUnifiedTypeMap.modifier_insertKey (object->mAttribute_mEnumTypeName, GALGAS_ebType::constructor_new (object->mAttribute_mEnumTypeName, GALGAS_typeKind::constructor_enumType (SOURCE_FILE_AT_LINE (23)) COMMA_SOURCE_FILE_AT_LINE (23)), temp_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (21)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_enumDeclaration_semanticAnalysis (const cPtr_astDeclaration * inObject,
  ...
  const cPtr_enumDeclaration * object = (const cPtr_enumDeclaration *) inObject ;
  macroValidSharedObject (object, const cPtr_enumDeclaration) ;
  GALGAS_enumConstantMap var_enumConstantMap = GALGAS_enumConstantMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (44)) ;
  cEnumerator_lstringlist enumerator_1442 (object->mAttribute_mEnumConstantNameList, kEnumeration_up) ;
  while (enumerator_1442.hasCurrentObject ()) {
    {
    var_enumConstantMap.modifier_insertKey (enumerator_1442.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (46)) ;
    }
    {
    ioArgument_ioContextAnalysisStruct.mAttribute_mGlobalEnumConstantMap.modifier_insertKey (enumerator_1442.current_mValue (HERE), object->mAttribute_mEnumTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (47)) ;
    }
    enumerator_1442.gotoNextObject () ;
  }
  {
  ioArgument_ioContextAnalysisStruct.mAttribute_mEnumMap.modifier_insertKey (object->mAttribute_mEnumTypeName, object->mAttribute_mEnumConstantNameList, var_enumConstantMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (50)) ;
  }
  ioArgument_ioGenerationList.addAssign_operation (GALGAS_enumTypeGeneration::constructor_new (object->mAttribute_mEnumTypeName.mAttribute_string, object->mAttribute_mEnumConstantNameList COMMA_SOURCE_FILE_AT_LINE (56)) COMMA_SOURCE_FILE_AT_LINE (56)) ;
}
//---------------------------------------------------------------------------*
