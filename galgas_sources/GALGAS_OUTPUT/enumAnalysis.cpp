...
static void categoryMethod_enumDeclaration_typeInventory (const cPtr_astDeclaration * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumDeclaration) ;
  {
...
static void categoryMethod_enumDeclaration_semanticAnalysis (const cPtr_astDeclaration * inObject,
  ...
  cEnumerator_lstringlist enumerator_1087 (object->mAttribute_mEnumConstantNameList, kEnumeration_up) ;
  while (enumerator_1087.hasCurrentObject ()) {
    {
    var_enumConstantMap.modifier_insertKey (enumerator_1087.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (35)) ;
    }
    {
    ioArgument_ioContextAnalysisStruct.mAttribute_mGlobalEnumConstantMap.modifier_insertKey (enumerator_1087.current_mValue (HERE), object->mAttribute_mEnumTypeName, inCompiler COMMA_SOURCE_FILE_AT_LINE (36)) ;
    }
