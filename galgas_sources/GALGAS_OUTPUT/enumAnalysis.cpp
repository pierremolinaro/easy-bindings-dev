...
//-----------------------------------------------------------------------------*
//                                                                             *
//        Overriding category method '@enumDeclaration EXTypeInventory'        *
//                                                                             *
//-----------------------------------------------------------------------------*

static void categoryMethod_enumDeclaration_EXTypeInventory (const cPtr_astDeclaration * inObject,
  ...
  ioArgument_ioUnifiedTypeMap.modifier_insertKey (object->mAttribute_mEnumTypeName, GALGAS_EXebType::constructor_new (object->mAttribute_mEnumTypeName, GALGAS_EXTypeKind::constructor_enumType (SOURCE_FILE ("enumAnalysis.gSemantics", 20))  COMMA_SOURCE_FILE ("enumAnalysis.gSemantics", 20)), temp_0, GALGAS_EXentityRelationshipMap::constructor_emptyMap (SOURCE_FILE ("enumAnalysis.gSemantics", 22)), inCompiler COMMA_SOURCE_FILE ("enumAnalysis.gSemantics", 18)) ;
  }
}
//-----------------------------------------------------------------------------*

static void defineCategoryMethod_enumDeclaration_EXTypeInventory (void) {
  enterCategoryMethod_EXTypeInventory (kTypeDescriptor_GALGAS_enumDeclaration.mSlotID,
                                       categoryMethod_enumDeclaration_EXTypeInventory) ;
}

//-----------------------------------------------------------------------------*

C_PrologueEpilogue gMethod_enumDeclaration_EXTypeInventory (defineCategoryMethod_enumDeclaration_EXTypeInventory, NULL) ;
...
static void categoryMethod_enumDeclaration_semanticAnalysis (const cPtr_astDeclaration * inObject,
  ...
  const cPtr_enumDeclaration * object = (const cPtr_enumDeclaration *) inObject ;
  macroValidSharedObject (object, cPtr_enumDeclaration) ;
  GALGAS_enumConstantMap var_enumConstantMap = GALGAS_enumConstantMap::constructor_emptyMap (SOURCE_FILE ("enumAnalysis.gSemantics", 42)) ;
  cEnumerator_lstringlist enumerator_1316 (object->mAttribute_mEnumConstantNameList, kEnumeration_up) ;
  while (enumerator_1316.hasCurrentObject ()) {
    {
    var_enumConstantMap.modifier_insertKey (enumerator_1316.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("enumAnalysis.gSemantics", 44)) ;
    }
    {
    ioArgument_ioContextAnalysisStruct.mAttribute_mGlobalEnumConstantMap.modifier_insertKey (enumerator_1316.current_mValue (HERE), object->mAttribute_mEnumTypeName, inCompiler COMMA_SOURCE_FILE ("enumAnalysis.gSemantics", 45)) ;
    }
    enumerator_1316.gotoNextObject () ;
  }
  {
  ioArgument_ioContextAnalysisStruct.mAttribute_mEnumMap.modifier_insertKey (object->mAttribute_mEnumTypeName, object->mAttribute_mEnumConstantNameList, var_enumConstantMap, inCompiler COMMA_SOURCE_FILE ("enumAnalysis.gSemantics", 48)) ;
  }
  ioArgument_ioGenerationList.addAssign_operation (GALGAS_enumTypeGeneration::constructor_new (object->mAttribute_mEnumTypeName.mAttribute_string, object->mAttribute_mEnumConstantNameList  COMMA_SOURCE_FILE ("enumAnalysis.gSemantics", 54))  COMMA_SOURCE_FILE ("enumAnalysis.gSemantics", 54)) ;
}
//-----------------------------------------------------------------------------*
