...
cEnumAssociatedValues_enabledBindingDescriptor_enabledBinding::cEnumAssociatedValues_enabledBindingDescriptor_enabledBinding (const GALGAS_abstractEnableBindingExpressionAST & inAssociatedValue0
                                                                                                                              COMMA_LOCATION_ARGS) :
cEnumAssociatedValues (THERE),
mAssociatedValue0 (inAssociatedValue0) {
} ;
...
GALGAS_enabledBindingDescriptor GALGAS_enabledBindingDescriptor::constructor_enabledBinding (const GALGAS_abstractEnableBindingExpressionAST & inAssociatedValue0
                                                                                             COMMA_LOCATION_ARGS) {
  GALGAS_enabledBindingDescriptor result ;
...
typeComparisonResult GALGAS_abstractEnableBindingExpressionAST::objectCompare (const GALGAS_abstractEnableBindingExpressionAST & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    const int32_t mySlot = mObjectPtr->classDescriptor ()->mSlotID ;
    const int32_t operandSlot = inOperand.mObjectPtr->classDescriptor ()->mSlotID ;
...
GALGAS_abstractEnableBindingExpressionAST::GALGAS_abstractEnableBindingExpressionAST (void) :
AC_GALGAS_class () {
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_abstractEnableBindingExpressionAST::GALGAS_abstractEnableBindingExpressionAST (const cPtr_abstractEnableBindingExpressionAST * inSourcePtr) :
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, cPtr_abstractEnableBindingExpressionAST) ;
}
...
cPtr_abstractEnableBindingExpressionAST::cPtr_abstractEnableBindingExpressionAST (LOCATION_ARGS) :
acPtr_class (THERE) {
}
...
//---------------------------------------------------------------------------------------------------------------------*
//                                                                                                                     *
//                                      @abstractEnableBindingExpressionAST type                                       *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_abstractEnableBindingExpressionAST ("abstractEnableBindingExpressionAST",
                                                           NULL) ;

//---------------------------------------------------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_abstractEnableBindingExpressionAST::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_abstractEnableBindingExpressionAST ;
}

//---------------------------------------------------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_abstractEnableBindingExpressionAST::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_abstractEnableBindingExpressionAST (*this)) ;
  }
  return result ;
}
...
GALGAS_abstractEnableBindingExpressionAST GALGAS_abstractEnableBindingExpressionAST::extractObject (const GALGAS_object & inObject,
                                                                                                    C_Compiler * inCompiler
                                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_abstractEnableBindingExpressionAST result ;
  const GALGAS_abstractEnableBindingExpressionAST * p = (const GALGAS_abstractEnableBindingExpressionAST *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_abstractEnableBindingExpressionAST *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("abstractEnableBindingExpressionAST", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
GALGAS_abstractEnableBindingExpressionAST () {
}
...
GALGAS_abstractEnableBindingExpressionAST (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, cPtr_andBooleanMultipleBindingExpressionAST) ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_andBooleanMultipleBindingExpressionAST GALGAS_andBooleanMultipleBindingExpressionAST::constructor_new (const GALGAS_abstractEnableBindingExpressionAST & inAttribute_mLeftBinding,
                                                                                                              const GALGAS_abstractEnableBindingExpressionAST & inAttribute_mRightBinding
                                                                                                              COMMA_LOCATION_ARGS) {
...
void GALGAS_andBooleanMultipleBindingExpressionAST::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_andBooleanMultipleBindingExpressionAST * p = (cPtr_andBooleanMultipleBindingExpressionAST *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_andBooleanMultipleBindingExpressionAST) ;
    cPtr_andBooleanMultipleBindingExpressionAST * r = NULL ;
    macroMyNew (r, cPtr_andBooleanMultipleBindingExpressionAST (p->mAttribute_mLeftBinding, p->mAttribute_mRightBinding COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_abstractEnableBindingExpressionAST GALGAS_andBooleanMultipleBindingExpressionAST::reader_mLeftBinding (UNUSED_LOCATION_ARGS) const {
  GALGAS_abstractEnableBindingExpressionAST result ;
  if (NULL != mObjectPtr) {
...
GALGAS_abstractEnableBindingExpressionAST cPtr_andBooleanMultipleBindingExpressionAST::reader_mLeftBinding (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLeftBinding ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_abstractEnableBindingExpressionAST GALGAS_andBooleanMultipleBindingExpressionAST::reader_mRightBinding (UNUSED_LOCATION_ARGS) const {
  GALGAS_abstractEnableBindingExpressionAST result ;
  if (NULL != mObjectPtr) {
    const cPtr_andBooleanMultipleBindingExpressionAST * p = (const cPtr_andBooleanMultipleBindingExpressionAST *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_andBooleanMultipleBindingExpressionAST) ;
...
GALGAS_abstractEnableBindingExpressionAST cPtr_andBooleanMultipleBindingExpressionAST::reader_mRightBinding (UNUSED_LOCATION_ARGS) const {
...
cPtr_andBooleanMultipleBindingExpressionAST::cPtr_andBooleanMultipleBindingExpressionAST (const GALGAS_abstractEnableBindingExpressionAST & in_mLeftBinding,
                                                                                          const GALGAS_abstractEnableBindingExpressionAST & in_mRightBinding
                                                                                          COMMA_LOCATION_ARGS) :
cPtr_abstractEnableBindingExpressionAST (THERE),
...
kTypeDescriptor_GALGAS_andBooleanMultipleBindingExpressionAST ("andBooleanMultipleBindingExpressionAST",
                                                               & kTypeDescriptor_GALGAS_abstractEnableBindingExpressionAST) ;
...
GALGAS_negateBooleanMultipleBindingExpressionAST GALGAS_negateBooleanMultipleBindingExpressionAST::constructor_new (const GALGAS_abstractEnableBindingExpressionAST & inAttribute_mBinding
                                                                                                                    COMMA_LOCATION_ARGS) {
...
void GALGAS_negateBooleanMultipleBindingExpressionAST::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_negateBooleanMultipleBindingExpressionAST * p = (cPtr_negateBooleanMultipleBindingExpressionAST *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_negateBooleanMultipleBindingExpressionAST) ;
    cPtr_negateBooleanMultipleBindingExpressionAST * r = NULL ;
    macroMyNew (r, cPtr_negateBooleanMultipleBindingExpressionAST (p->mAttribute_mBinding COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_abstractEnableBindingExpressionAST GALGAS_negateBooleanMultipleBindingExpressionAST::reader_mBinding (UNUSED_LOCATION_ARGS) const {
  GALGAS_abstractEnableBindingExpressionAST result ;
  if (NULL != mObjectPtr) {
...
GALGAS_abstractEnableBindingExpressionAST cPtr_negateBooleanMultipleBindingExpressionAST::reader_mBinding (UNUSED_LOCATION_ARGS) const {
...
cPtr_negateBooleanMultipleBindingExpressionAST::cPtr_negateBooleanMultipleBindingExpressionAST (const GALGAS_abstractEnableBindingExpressionAST & in_mBinding
                                                                                                COMMA_LOCATION_ARGS) :
cPtr_abstractEnableBindingExpressionAST (THERE),
...
void GALGAS_observablePropertyAsEnableBindingExpressionAST::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_observablePropertyAsEnableBindingExpressionAST * p = (cPtr_observablePropertyAsEnableBindingExpressionAST *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_observablePropertyAsEnableBindingExpressionAST) ;
    cPtr_observablePropertyAsEnableBindingExpressionAST * r = NULL ;
    macroMyNew (r, cPtr_observablePropertyAsEnableBindingExpressionAST (p->mAttribute_mProperty COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_orBooleanMultipleBindingExpressionAST GALGAS_orBooleanMultipleBindingExpressionAST::constructor_new (const GALGAS_abstractEnableBindingExpressionAST & inAttribute_mLeftBinding,
                                                                                                            const GALGAS_abstractEnableBindingExpressionAST & inAttribute_mRightBinding
                                                                                                            COMMA_LOCATION_ARGS) {
...
void GALGAS_orBooleanMultipleBindingExpressionAST::insulate (LOCATION_ARGS) {
  macroMutexLock (gInsulationMutex) ;
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    cPtr_orBooleanMultipleBindingExpressionAST * p = (cPtr_orBooleanMultipleBindingExpressionAST *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_orBooleanMultipleBindingExpressionAST) ;
    cPtr_orBooleanMultipleBindingExpressionAST * r = NULL ;
    macroMyNew (r, cPtr_orBooleanMultipleBindingExpressionAST (p->mAttribute_mLeftBinding, p->mAttribute_mRightBinding COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_abstractEnableBindingExpressionAST GALGAS_orBooleanMultipleBindingExpressionAST::reader_mLeftBinding (UNUSED_LOCATION_ARGS) const {
  GALGAS_abstractEnableBindingExpressionAST result ;
  if (NULL != mObjectPtr) {
...
GALGAS_abstractEnableBindingExpressionAST cPtr_orBooleanMultipleBindingExpressionAST::reader_mLeftBinding (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mLeftBinding ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_abstractEnableBindingExpressionAST GALGAS_orBooleanMultipleBindingExpressionAST::reader_mRightBinding (UNUSED_LOCATION_ARGS) const {
  GALGAS_abstractEnableBindingExpressionAST result ;
  if (NULL != mObjectPtr) {
    const cPtr_orBooleanMultipleBindingExpressionAST * p = (const cPtr_orBooleanMultipleBindingExpressionAST *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_orBooleanMultipleBindingExpressionAST) ;
...
GALGAS_abstractEnableBindingExpressionAST cPtr_orBooleanMultipleBindingExpressionAST::reader_mRightBinding (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRightBinding ;
}
...
cPtr_orBooleanMultipleBindingExpressionAST::cPtr_orBooleanMultipleBindingExpressionAST (const GALGAS_abstractEnableBindingExpressionAST & in_mLeftBinding,
                                                                                        const GALGAS_abstractEnableBindingExpressionAST & in_mRightBinding
                                                                                        COMMA_LOCATION_ARGS) :
cPtr_abstractEnableBindingExpressionAST (THERE),
mAttribute_mLeftBinding (in_mLeftBinding),
