...
cCollectionElement * cCollectionElement_controllerBindingOptionList::copy (void) {
  ...
  macroMyNew (result, cCollectionElement_controllerBindingOptionList (mObject.mAttribute_mOptionName, mObject.mAttribute_mOptionType COMMA_HERE)) ;
  return result ;
}
...
GALGAS_lstring GALGAS_controllerBindingOptionList::reader_mOptionTypeAtIndex (const GALGAS_uint & inIndex,
                                                                              C_Compiler * inCompiler
                                                                              COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_controllerBindingOptionList * p = (cCollectionElement_controllerBindingOptionList *) attributes.ptr () ;
...
GALGAS_lstring cEnumerator_controllerBindingOptionList::current_mOptionType (LOCATION_ARGS) const {
  const cCollectionElement_controllerBindingOptionList * p = (const cCollectionElement_controllerBindingOptionList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_controllerBindingOptionList) ;
...
cCollectionElement_controllerTemplateList::cCollectionElement_controllerTemplateList (const GALGAS_bool & in_mIsUserDefined,
                                                                                      ...
                                                                                      COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mIsUserDefined, in_mOutletClassName, in_mBindingName, in_mModelTypeName, in_mBindingOptionList) {
}
...
cCollectionElement * cCollectionElement_controllerTemplateList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_controllerTemplateList (mObject.mAttribute_mIsUserDefined, mObject.mAttribute_mOutletClassName, mObject.mAttribute_mBindingName, mObject.mAttribute_mModelTypeName, mObject.mAttribute_mBindingOptionList COMMA_HERE)) ;
  return result ;
}
...
GALGAS_controllerTemplateList GALGAS_controllerTemplateList::constructor_listWithValue (const GALGAS_bool & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_controllerTemplateList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3, inOperand4 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_controllerTemplateList::addAssign_operation (const GALGAS_bool & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_controllerTemplateList (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
cCollectionElement_bindingList::cCollectionElement_bindingList (const GALGAS_lstring & in_mObservablePropertyName,
                                                                ...
                                                                COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mObservablePropertyName, in_mOutletName, in_mBindingName, in_mBindingOptionList) {
}
...
cCollectionElement * cCollectionElement_bindingList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_bindingList (mObject.mAttribute_mObservablePropertyName, mObject.mAttribute_mOutletName, mObject.mAttribute_mBindingName, mObject.mAttribute_mBindingOptionList COMMA_HERE)) ;
  return result ;
}
...
GALGAS_lstring GALGAS_controllerBindingOptionList_2D_element::reader_mOptionType (UNUSED_LOCATION_ARGS) const {
...
GALGAS_controllerTemplateList_2D_element GALGAS_controllerTemplateList_2D_element::constructor_new (const GALGAS_bool & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_controllerTemplateList_2D_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
bool GALGAS_controllerTemplateList_2D_element::isValid (void) const {
  return mAttribute_mIsUserDefined.isValid () && mAttribute_mOutletClassName.isValid () && mAttribute_mBindingName.isValid () && mAttribute_mModelTypeName.isValid () && mAttribute_mBindingOptionList.isValid () ;
}
...
bool GALGAS_bindingList_2D_element::isValid (void) const {
  return mAttribute_mObservablePropertyName.isValid () && mAttribute_mOutletName.isValid () && mAttribute_mBindingName.isValid () && mAttribute_mBindingOptionList.isValid () ;
}
