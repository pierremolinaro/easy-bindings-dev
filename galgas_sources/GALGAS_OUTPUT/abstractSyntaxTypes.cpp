...
cCollectionElement_controllerClassList::cCollectionElement_controllerClassList (const GALGAS_lstring & in_mControllerClassName,
                                                                                ...
                                                                                COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mControllerClassName, in_mGenerationKind, in_mBindingList, in_mActionDeclarationList, in_mControllerObservablePropertyList) {
}
...
cCollectionElement * cCollectionElement_controllerClassList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_controllerClassList (mObject.mAttribute_mControllerClassName, mObject.mAttribute_mGenerationKind, mObject.mAttribute_mBindingList, mObject.mAttribute_mActionDeclarationList, mObject.mAttribute_mControllerObservablePropertyList COMMA_HERE)) ;
  return result ;
}
...
bool GALGAS_controllerClassList_2E_element::isValid (void) const {
  return mAttribute_mControllerClassName.isValid () && mAttribute_mGenerationKind.isValid () && mAttribute_mBindingList.isValid () && mAttribute_mActionDeclarationList.isValid () && mAttribute_mControllerObservablePropertyList.isValid () ;
}
