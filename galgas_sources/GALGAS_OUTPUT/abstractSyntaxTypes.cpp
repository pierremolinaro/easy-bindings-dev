...
GALGAS_EXTypeKind::GALGAS_EXTypeKind (void) :
mEnum (kNotBuilt) {
}

//-----------------------------------------------------------------------------*

GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_classType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_classType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_controllerClassType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_controllerClassType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_documentType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_documentType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_entityType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_entityType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_enumType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_enumType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_nibClassType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_nibClassType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_outletClassType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_outletClassType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_preferencesType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_preferencesType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_protocolType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_protocolType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_structType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_structType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_boolType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_boolType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_integerType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_integerType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_uintegerType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_uintegerType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_doubleType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_doubleType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_stringType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_stringType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_colorType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_colorType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_dataType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_dataType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_dateType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_dateType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_fontType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_fontType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_imageType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_imageType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_menuType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_menuType ;
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::constructor_bezierPathType (UNUSED_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  result.mEnum = kEnum_bezierPathType ;
  return result ;
}
...
static const char * gEnumNameArrayFor_EXTypeKind [23] = {
  "(not built)",
  "classType",
  "controllerClassType",
  "documentType",
...
void GALGAS_EXTypeKind::description (C_String & ioString,
                                     const int32_t /* inIndentation */) const {
  ioString << "<enum @EXTypeKind: " << gEnumNameArrayFor_EXTypeKind [mEnum] << ">" ;
}

//-----------------------------------------------------------------------------*

typeComparisonResult GALGAS_EXTypeKind::objectCompare (const GALGAS_EXTypeKind & inOperand) const {
  typeComparisonResult result = kOperandNotValid ;
  if (isValid () && inOperand.isValid ()) {
    if (mEnum < inOperand.mEnum) {
      result = kFirstOperandLowerThanSecond ;
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_EXTypeKind ("EXTypeKind",
                                   NULL) ;

//-----------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_EXTypeKind::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_EXTypeKind ;
}

//-----------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_EXTypeKind::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_EXTypeKind (*this)) ;
  }
  return result ;
}
...
GALGAS_EXTypeKind GALGAS_EXTypeKind::extractObject (const GALGAS_object & inObject,
                                                    C_Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) {
  GALGAS_EXTypeKind result ;
  const GALGAS_EXTypeKind * p = (const GALGAS_EXTypeKind *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_EXTypeKind *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("EXTypeKind", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
typeComparisonResult cPtr_predefinedTypeDeclaration::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  if (kOperandEqual == result) {
    result = mAttribute_mExKind.objectCompare (p->mAttribute_mExKind) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeDeclaration GALGAS_predefinedTypeDeclaration::constructor_default (LOCATION_ARGS) {
  return GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_bool::constructor_default (HERE),
                                                            ...
                                                            GALGAS_EXTypeKind::constructor_classType (HERE),
...
GALGAS_predefinedTypeDeclaration GALGAS_predefinedTypeDeclaration::constructor_new (const GALGAS_bool & inAttribute_mUserDefined,
                                                                                    ...
                                                                                    const GALGAS_EXTypeKind & inAttribute_mExKind,
                                                                                    const GALGAS_typeKind & inAttribute_mKind
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_predefinedTypeDeclaration result ;
  if (inAttribute_mUserDefined.isValid () && inAttribute_mTypeName.isValid () && inAttribute_mExKind.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_predefinedTypeDeclaration (inAttribute_mUserDefined, inAttribute_mTypeName, inAttribute_mExKind, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_predefinedTypeDeclaration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_predefinedTypeDeclaration (p->mAttribute_mUserDefined, p->mAttribute_mTypeName, p->mAttribute_mExKind, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_EXTypeKind GALGAS_predefinedTypeDeclaration::reader_mExKind (UNUSED_LOCATION_ARGS) const {
  GALGAS_EXTypeKind result ;
  if (NULL != mObjectPtr) {
    const cPtr_predefinedTypeDeclaration * p = (const cPtr_predefinedTypeDeclaration *) mObjectPtr ;
    macroValidSharedObject (p, cPtr_predefinedTypeDeclaration) ;
    result = p->mAttribute_mExKind ;
  }
  return result ;
}
...
GALGAS_EXTypeKind cPtr_predefinedTypeDeclaration::reader_mExKind (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mExKind ;
}
...
void cPtr_predefinedTypeDeclaration::description (C_String & ioString,
  ...
  ioString << ", " ;
  mAttribute_mExKind.description (ioString, inIndentation+1) ;
  ioString << ", " ;
...
GALGAS_string categoryReader_name (const GALGAS_EXTypeKind & inObject,
                                   C_Compiler * /* inCompiler */
                                   COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_string result_outResult ; // Returned variable
  const GALGAS_EXTypeKind temp_0 = inObject ;
  if (temp_0.isValid ()) {
    switch (temp_0.enumValue ()) {
    case GALGAS_EXTypeKind::kNotBuilt:
      break ;
    case GALGAS_EXTypeKind::kEnum_classType: {
      result_outResult = GALGAS_string ("classType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_controllerClassType: {
      result_outResult = GALGAS_string ("controllerClassType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_documentType: {
      result_outResult = GALGAS_string ("documentType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_entityType: {
      result_outResult = GALGAS_string ("entityType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_enumType: {
      result_outResult = GALGAS_string ("enumType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_nibClassType: {
      result_outResult = GALGAS_string ("nibClassType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_outletClassType: {
      result_outResult = GALGAS_string ("outletClassType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_preferencesType: {
      result_outResult = GALGAS_string ("preferencesType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_protocolType: {
    ...
    case GALGAS_EXTypeKind::kEnum_stringType: {
      result_outResult = GALGAS_string ("stringType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_colorType: {
      result_outResult = GALGAS_string ("colorType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_dataType: {
      result_outResult = GALGAS_string ("dataType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_dateType: {
      result_outResult = GALGAS_string ("dateType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_fontType: {
      result_outResult = GALGAS_string ("fontType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_imageType: {
      result_outResult = GALGAS_string ("imageType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_menuType: {
      result_outResult = GALGAS_string ("menuType") ;
      } break ;
    case GALGAS_EXTypeKind::kEnum_bezierPathType: {
