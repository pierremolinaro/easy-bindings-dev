...
void GALGAS_astDeclarationList::modifier_prependValue (GALGAS_astDeclaration inOperand0
                                                       COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_astDeclarationList (inOperand0 COMMA_THERE)) ;
...
void GALGAS_attributeList::modifier_prependValue (GALGAS_lstring inOperand0,
...
void GALGAS_transientList::modifier_prependValue (GALGAS_lstring inOperand0,
                                                  GALGAS_lstring inOperand1,
...
void GALGAS_attributeASTTypeAndFormatterList::modifier_prependValue (GALGAS_lstring inOperand0,
...
void GALGAS_controllerObservablePropertyList::modifier_prependValue (GALGAS_lstring inOperand0,
                                                                     GALGAS_lstring inOperand1
                                                                     COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid () && inOperand1.isValid ()) {
    cCollectionElement * p = NULL ;
...
void GALGAS_structFieldASTList::modifier_prependValue (GALGAS_lstring inOperand0,
                                                       GALGAS_lstring inOperand1
                                                       COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid () && inOperand1.isValid ()) {
    cCollectionElement * p = NULL ;
...
GALGAS_typeKind GALGAS_typeKind::constructor_anyScalarType (UNUSED_LOCATION_ARGS) {
  GALGAS_typeKind result ;
...
GALGAS_typeKind GALGAS_typeKind::constructor_anyNumberType (UNUSED_LOCATION_ARGS) {
  GALGAS_typeKind result ;
...
static const char * gEnumNameArrayFor_typeKind [25] = {
  "(not built)",
  "classType",
  "controllerClassType",
  "documentType",
...
typeComparisonResult cPtr_outletClassDeclaration::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  if (kOperandEqual == result) {
    result = mAttribute_mGeneration.objectCompare (p->mAttribute_mGeneration) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_outletClassDeclaration GALGAS_outletClassDeclaration::constructor_new (const GALGAS_lstring & inAttribute_mOutletClassName,
                                                                              ...
                                                                              const GALGAS_generationKind & inAttribute_mGeneration,
  ...
  if (inAttribute_mOutletClassName.isValid () && inAttribute_mSuperClassName.isValid () && inAttribute_mAdoptedProtocolList.isValid () && inAttribute_mGeneration.isValid () && inAttribute_mOutletClassBindingList.isValid () && inAttribute_mHasTableValueBinding.isValid () && inAttribute_mOptionList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_outletClassDeclaration (inAttribute_mOutletClassName, inAttribute_mSuperClassName, inAttribute_mAdoptedProtocolList, inAttribute_mGeneration, inAttribute_mOutletClassBindingList, inAttribute_mHasTableValueBinding, inAttribute_mOptionList COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_outletClassDeclaration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_outletClassDeclaration (p->mAttribute_mOutletClassName, p->mAttribute_mSuperClassName, p->mAttribute_mAdoptedProtocolList, p->mAttribute_mGeneration, p->mAttribute_mOutletClassBindingList, p->mAttribute_mHasTableValueBinding, p->mAttribute_mOptionList COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_generationKind GALGAS_outletClassDeclaration::reader_mGeneration (UNUSED_LOCATION_ARGS) const {
  GALGAS_generationKind result ;
  if (NULL != mObjectPtr) {
    const cPtr_outletClassDeclaration * p = (const cPtr_outletClassDeclaration *) mObjectPtr ;
    macroValidSharedObject (p, const cPtr_outletClassDeclaration) ;
    result = p->mAttribute_mGeneration ;
  }
  return result ;
}
...
GALGAS_generationKind cPtr_outletClassDeclaration::reader_mGeneration (UNUSED_LOCATION_ARGS) const {
...
mAttribute_mGeneration (in_mGeneration),
...
GALGAS_string categoryReader_name (const GALGAS_typeKind & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_typeKind::kEnum_anyScalarType: {
      result_outResult = GALGAS_string ("anyScalarType") ;
      } break ;
    case GALGAS_typeKind::kEnum_anyNumberType: {
      result_outResult = GALGAS_string ("anyNumberType") ;
      } break ;
