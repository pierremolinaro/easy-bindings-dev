...
class cCollectionElement_astDeclarationList : public cCollectionElement {
  public : GALGAS_astDeclarationList_2E_element mObject ;
...
void cCollectionElement_astDeclarationList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ioString << "\n" ;
...
GALGAS_astDeclarationList_2E_element cEnumerator_astDeclarationList::current (LOCATION_ARGS) const {
  const cCollectionElement_astDeclarationList * p = (const cCollectionElement_astDeclarationList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_astDeclarationList) ;
  return p->mObject ;
}
...
cCollectionElement_controllerList::cCollectionElement_controllerList (const GALGAS_controllerKind & in_mControllerKind,
                                                                      ...
                                                                      COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mControllerKind, in_mControllerClassName, in_mControllerName, in_mIsRootObject, in_mControlledObjectName, in_mControlledObjectBindingOptionList, in_mControllerBindingList, in_mChildRelationshipName, in_mIsLeafAttributeName) {
}
...
void cCollectionElement_controllerList::description (C_String & ioString, const PMSInt32 inIndentation) const {
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mIsLeafAttributeName" ":" ;
  mObject.mAttribute_mIsLeafAttributeName.description (ioString, inIndentation) ;
}
...
GALGAS_controllerList GALGAS_controllerList::constructor_listWithValue (const GALGAS_controllerKind & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_controllerList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_controllerList::makeAttributesFromObjects (capCollectionElement & outAttributes,
  ...
  macroMyNew (p, cCollectionElement_controllerList (in_mControllerKind,
                                                    ...
                                                    in_mChildRelationshipName,
                                                    in_mIsLeafAttributeName COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
}
...
void GALGAS_controllerList::addAssign_operation (const GALGAS_controllerKind & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_controllerList (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_controllerList::modifier_removeAtIndex (GALGAS_controllerKind & outOperand0,
  ...
  if (isValid () && inRemoveIndex.isValid ()) {
    ...
    if (NULL == p) {
      ...
      outOperand8 = p->mObject.mAttribute_mIsLeafAttributeName ;
    }
  }
}
...
GALGAS_lstring GALGAS_controllerList::reader_mIsLeafAttributeNameAtIndex (const GALGAS_uint & inIndex,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_controllerList * p = (cCollectionElement_controllerList *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_controllerList) ;
    result = p->mObject.mAttribute_mIsLeafAttributeName ;
  }
  return result ;
}
...
GALGAS_lstring cEnumerator_controllerList::current_mIsLeafAttributeName (LOCATION_ARGS) const {
  const cCollectionElement_controllerList * p = (const cCollectionElement_controllerList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_controllerList) ;
  return p->mObject.mAttribute_mIsLeafAttributeName ;
}
...
AC_GALGAS_class (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_astDeclaration) ;
}
...
cPtr_astDeclaration::cPtr_astDeclaration (LOCATION_ARGS) :
acPtr_class (THERE) {
}
...
typeComparisonResult cPtr_classDeclaration::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_classDeclaration) ;
  if (kOperandEqual == result) {
...
GALGAS_classDeclaration GALGAS_classDeclaration::constructor_default (LOCATION_ARGS) {
  return GALGAS_classDeclaration::constructor_new (GALGAS_lstring::constructor_default (HERE),
                                                   GALGAS_lstring::constructor_default (HERE),
...
GALGAS_astDeclaration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_classDeclaration) ;
}

//---------------------------------------------------------------------------*

GALGAS_classDeclaration GALGAS_classDeclaration::constructor_new (const GALGAS_lstring & inAttribute_mClassName,
  ...
  if (inAttribute_mClassName.isValid () && inAttribute_mSuperClassName.isValid () && inAttribute_mAttributeList.isValid () && inAttribute_mArrayList.isValid () && inAttribute_mTransientList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_classDeclaration (inAttribute_mClassName, inAttribute_mSuperClassName, inAttribute_mAttributeList, inAttribute_mArrayList, inAttribute_mTransientList COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_classDeclaration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_classDeclaration (p->mAttribute_mClassName, p->mAttribute_mSuperClassName, p->mAttribute_mAttributeList, p->mAttribute_mArrayList, p->mAttribute_mTransientList COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_classDeclaration::cPtr_classDeclaration (const GALGAS_lstring & in_mClassName,
...
typeComparisonResult cPtr_controllerClassDeclaration::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_controllerClassDeclaration) ;
  if (kOperandEqual == result) {
...
GALGAS_controllerClassDeclaration GALGAS_controllerClassDeclaration::constructor_default (LOCATION_ARGS) {
  return GALGAS_controllerClassDeclaration::constructor_new (GALGAS_controllerKind::constructor_simpleController (HERE),
                                                             GALGAS_lstring::constructor_default (HERE),
...
GALGAS_astDeclaration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_controllerClassDeclaration) ;
}

//---------------------------------------------------------------------------*

GALGAS_controllerClassDeclaration GALGAS_controllerClassDeclaration::constructor_new (const GALGAS_controllerKind & inAttribute_mControllerKind,
  ...
  if (inAttribute_mControllerKind.isValid () && inAttribute_mControllerClassName.isValid () && inAttribute_mControlledObjectBindingOptionList.isValid () && inAttribute_mGenerationKind.isValid () && inAttribute_mBindingList.isValid () && inAttribute_mActionDeclarationList.isValid () && inAttribute_mControllerObservablePropertyList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_controllerClassDeclaration (inAttribute_mControllerKind, inAttribute_mControllerClassName, inAttribute_mControlledObjectBindingOptionList, inAttribute_mGenerationKind, inAttribute_mBindingList, inAttribute_mActionDeclarationList, inAttribute_mControllerObservablePropertyList COMMA_THERE)) ;
  }
  return result ;
}
...
cPtr_controllerClassDeclaration::cPtr_controllerClassDeclaration (const GALGAS_controllerKind & in_mControllerKind,
                                                                  const GALGAS_lstring & in_mControllerClassName,
...
typeComparisonResult cPtr_documentDeclaration::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_documentDeclaration) ;
  if (kOperandEqual == result) {
...
GALGAS_documentDeclaration GALGAS_documentDeclaration::constructor_default (LOCATION_ARGS) {
  return GALGAS_documentDeclaration::constructor_new (GALGAS_lstring::constructor_default (HERE),
                                                      GALGAS_lstring::constructor_default (HERE),
...
GALGAS_astDeclaration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_documentDeclaration) ;
}

//---------------------------------------------------------------------------*

GALGAS_documentDeclaration GALGAS_documentDeclaration::constructor_new (const GALGAS_lstring & inAttribute_mDocumentName,
  ...
  if (inAttribute_mDocumentName.isValid () && inAttribute_mRootEntityName.isValid () && inAttribute_mOutletDeclarationList.isValid () && inAttribute_mControllerList.isValid () && inAttribute_mActionDeclarationList.isValid () && inAttribute_mTransientList.isValid () && inAttribute_mAttributeList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_documentDeclaration (inAttribute_mDocumentName, inAttribute_mRootEntityName, inAttribute_mOutletDeclarationList, inAttribute_mControllerList, inAttribute_mActionDeclarationList, inAttribute_mTransientList, inAttribute_mAttributeList COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_documentDeclaration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_documentDeclaration (p->mAttribute_mDocumentName, p->mAttribute_mRootEntityName, p->mAttribute_mOutletDeclarationList, p->mAttribute_mControllerList, p->mAttribute_mActionDeclarationList, p->mAttribute_mTransientList, p->mAttribute_mAttributeList COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_documentDeclaration::cPtr_documentDeclaration (const GALGAS_lstring & in_mDocumentName,
...
typeComparisonResult cPtr_entityDeclaration::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_entityDeclaration) ;
  if (kOperandEqual == result) {
...
GALGAS_entityDeclaration GALGAS_entityDeclaration::constructor_default (LOCATION_ARGS) {
  return GALGAS_entityDeclaration::constructor_new (GALGAS_lstring::constructor_default (HERE),
                                                    GALGAS_lstring::constructor_default (HERE),
                                                    GALGAS_attributeList::constructor_emptyList (HERE),
                                                    GALGAS_transientList::constructor_emptyList (HERE),
...
GALGAS_astDeclaration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_entityDeclaration) ;
}

//---------------------------------------------------------------------------*

GALGAS_entityDeclaration GALGAS_entityDeclaration::constructor_new (const GALGAS_lstring & inAttribute_mEntityName,
  ...
  if (inAttribute_mEntityName.isValid () && inAttribute_mSuperEntityName.isValid () && inAttribute_mAttributeList.isValid () && inAttribute_mTransientList.isValid () && inAttribute_mRelationshipList.isValid () && inAttribute_mSignList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_entityDeclaration (inAttribute_mEntityName, inAttribute_mSuperEntityName, inAttribute_mAttributeList, inAttribute_mTransientList, inAttribute_mRelationshipList, inAttribute_mSignList COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_entityDeclaration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_entityDeclaration (p->mAttribute_mEntityName, p->mAttribute_mSuperEntityName, p->mAttribute_mAttributeList, p->mAttribute_mTransientList, p->mAttribute_mRelationshipList, p->mAttribute_mSignList COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_entityDeclaration::cPtr_entityDeclaration (const GALGAS_lstring & in_mEntityName,
...
typeComparisonResult cPtr_enumDeclaration::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_enumDeclaration) ;
  if (kOperandEqual == result) {
...
GALGAS_enumDeclaration GALGAS_enumDeclaration::constructor_default (LOCATION_ARGS) {
  return GALGAS_enumDeclaration::constructor_new (GALGAS_lstring::constructor_default (HERE),
                                                  GALGAS_lstringlist::constructor_emptyList (HERE)
                                                  COMMA_THERE) ;
}
...
GALGAS_astDeclaration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_enumDeclaration) ;
}

//---------------------------------------------------------------------------*

GALGAS_enumDeclaration GALGAS_enumDeclaration::constructor_new (const GALGAS_lstring & inAttribute_mEnumTypeName,
                                                                const GALGAS_lstringlist & inAttribute_mEnumConstantNameList
                                                                COMMA_LOCATION_ARGS) {
  GALGAS_enumDeclaration result ;
  if (inAttribute_mEnumTypeName.isValid () && inAttribute_mEnumConstantNameList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_enumDeclaration (inAttribute_mEnumTypeName, inAttribute_mEnumConstantNameList COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_enumDeclaration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_enumDeclaration (p->mAttribute_mEnumTypeName, p->mAttribute_mEnumConstantNameList COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_enumDeclaration::cPtr_enumDeclaration (const GALGAS_lstring & in_mEnumTypeName,
...
typeComparisonResult cPtr_nibClassDeclaration::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_nibClassDeclaration) ;
  if (kOperandEqual == result) {
    result = mAttribute_mClassName.objectCompare (p->mAttribute_mClassName) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_nibClassDeclaration GALGAS_nibClassDeclaration::constructor_default (LOCATION_ARGS) {
  return GALGAS_nibClassDeclaration::constructor_new (GALGAS_lstring::constructor_default (HERE),
                                                      GALGAS_outletDeclarationList::constructor_emptyList (HERE),
                                                      GALGAS_attributeList::constructor_emptyList (HERE),
                                                      GALGAS_transientList::constructor_emptyList (HERE),
                                                      GALGAS_lstringlist::constructor_emptyList (HERE),
...
GALGAS_astDeclaration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_nibClassDeclaration) ;
}

//---------------------------------------------------------------------------*

GALGAS_nibClassDeclaration GALGAS_nibClassDeclaration::constructor_new (const GALGAS_lstring & inAttribute_mClassName,
                                                                        const GALGAS_outletDeclarationList & inAttribute_mOutletDeclarationList,
                                                                        const GALGAS_attributeList & inAttribute_mAttributeList,
                                                                        const GALGAS_transientList & inAttribute_mTransientList,
                                                                        const GALGAS_lstringlist & inAttribute_mActionDeclarationList,
  ...
  if (inAttribute_mClassName.isValid () && inAttribute_mOutletDeclarationList.isValid () && inAttribute_mAttributeList.isValid () && inAttribute_mTransientList.isValid () && inAttribute_mActionDeclarationList.isValid () && inAttribute_mControllerList.isValid () && inAttribute_mArrayList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_nibClassDeclaration (inAttribute_mClassName, inAttribute_mOutletDeclarationList, inAttribute_mAttributeList, inAttribute_mTransientList, inAttribute_mActionDeclarationList, inAttribute_mControllerList, inAttribute_mArrayList COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_nibClassDeclaration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_nibClassDeclaration (p->mAttribute_mClassName, p->mAttribute_mOutletDeclarationList, p->mAttribute_mAttributeList, p->mAttribute_mTransientList, p->mAttribute_mActionDeclarationList, p->mAttribute_mControllerList, p->mAttribute_mArrayList COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_nibClassDeclaration::cPtr_nibClassDeclaration (const GALGAS_lstring & in_mClassName,
                                                    const GALGAS_outletDeclarationList & in_mOutletDeclarationList,
                                                    const GALGAS_attributeList & in_mAttributeList,
                                                    const GALGAS_transientList & in_mTransientList,
                                                    const GALGAS_lstringlist & in_mActionDeclarationList,
...
typeComparisonResult cPtr_outletClassDeclaration::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_outletClassDeclaration) ;
  if (kOperandEqual == result) {
...
GALGAS_outletClassDeclaration GALGAS_outletClassDeclaration::constructor_default (LOCATION_ARGS) {
  return GALGAS_outletClassDeclaration::constructor_new (GALGAS_lstring::constructor_default (HERE),
                                                         GALGAS_lstring::constructor_default (HERE),
                                                         GALGAS_lstringlist::constructor_emptyList (HERE),
                                                         GALGAS_generationKind::constructor_fullGeneration (HERE),
                                                         GALGAS_outletClassBindingList::constructor_emptyList (HERE),
...
GALGAS_astDeclaration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_outletClassDeclaration) ;
}

//---------------------------------------------------------------------------*

GALGAS_outletClassDeclaration GALGAS_outletClassDeclaration::constructor_new (const GALGAS_lstring & inAttribute_mOutletClassName,
                                                                              const GALGAS_lstring & inAttribute_mSuperClassName,
  ...
  if (inAttribute_mOutletClassName.isValid () && inAttribute_mSuperClassName.isValid () && inAttribute_mAdoptedProtocolList.isValid () && inAttribute_mGenerationKind.isValid () && inAttribute_mOutletClassBindingList.isValid () && inAttribute_mHasTableValueBinding.isValid () && inAttribute_mOptionList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_outletClassDeclaration (inAttribute_mOutletClassName, inAttribute_mSuperClassName, inAttribute_mAdoptedProtocolList, inAttribute_mGenerationKind, inAttribute_mOutletClassBindingList, inAttribute_mHasTableValueBinding, inAttribute_mOptionList COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_outletClassDeclaration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_outletClassDeclaration (p->mAttribute_mOutletClassName, p->mAttribute_mSuperClassName, p->mAttribute_mAdoptedProtocolList, p->mAttribute_mGenerationKind, p->mAttribute_mOutletClassBindingList, p->mAttribute_mHasTableValueBinding, p->mAttribute_mOptionList COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_outletClassDeclaration::cPtr_outletClassDeclaration (const GALGAS_lstring & in_mOutletClassName,
                                                          const GALGAS_lstring & in_mSuperClassName,
...
typeComparisonResult cPtr_predefinedTypeDeclaration::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_predefinedTypeDeclaration) ;
  if (kOperandEqual == result) {
...
GALGAS_predefinedTypeDeclaration GALGAS_predefinedTypeDeclaration::constructor_default (LOCATION_ARGS) {
  return GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_string::constructor_default (HERE),
...
GALGAS_astDeclaration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_predefinedTypeDeclaration) ;
}

//---------------------------------------------------------------------------*

GALGAS_predefinedTypeDeclaration GALGAS_predefinedTypeDeclaration::constructor_new (const GALGAS_string & inAttribute_mTypeName,
                                                                                    const GALGAS_typeKind & inAttribute_mKind
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_predefinedTypeDeclaration result ;
  if (inAttribute_mTypeName.isValid () && inAttribute_mKind.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_predefinedTypeDeclaration (inAttribute_mTypeName, inAttribute_mKind COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_predefinedTypeDeclaration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_predefinedTypeDeclaration (p->mAttribute_mTypeName, p->mAttribute_mKind COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_predefinedTypeDeclaration::cPtr_predefinedTypeDeclaration (const GALGAS_string & in_mTypeName,
...
typeComparisonResult cPtr_preferencesDeclaration::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_preferencesDeclaration) ;
  if (kOperandEqual == result) {
    result = mAttribute_mPreferencesName.objectCompare (p->mAttribute_mPreferencesName) ;
  }
  if (kOperandEqual == result) {
...
GALGAS_preferencesDeclaration GALGAS_preferencesDeclaration::constructor_default (LOCATION_ARGS) {
  return GALGAS_preferencesDeclaration::constructor_new (GALGAS_lstring::constructor_default (HERE),
                                                         GALGAS_outletDeclarationList::constructor_emptyList (HERE),
                                                         GALGAS_attributeList::constructor_emptyList (HERE),
                                                         GALGAS_transientList::constructor_emptyList (HERE),
                                                         GALGAS_lstringlist::constructor_emptyList (HERE),
...
GALGAS_astDeclaration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_preferencesDeclaration) ;
}

//---------------------------------------------------------------------------*

GALGAS_preferencesDeclaration GALGAS_preferencesDeclaration::constructor_new (const GALGAS_lstring & inAttribute_mPreferencesName,
                                                                              const GALGAS_outletDeclarationList & inAttribute_mOutletDeclarationList,
                                                                              const GALGAS_attributeList & inAttribute_mAttributeList,
                                                                              const GALGAS_transientList & inAttribute_mTransientList,
                                                                              const GALGAS_lstringlist & inAttribute_mActionDeclarationList,
  ...
  if (inAttribute_mPreferencesName.isValid () && inAttribute_mOutletDeclarationList.isValid () && inAttribute_mAttributeList.isValid () && inAttribute_mTransientList.isValid () && inAttribute_mActionDeclarationList.isValid () && inAttribute_mControllerList.isValid () && inAttribute_mArrayList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_preferencesDeclaration (inAttribute_mPreferencesName, inAttribute_mOutletDeclarationList, inAttribute_mAttributeList, inAttribute_mTransientList, inAttribute_mActionDeclarationList, inAttribute_mControllerList, inAttribute_mArrayList COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_preferencesDeclaration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_preferencesDeclaration (p->mAttribute_mPreferencesName, p->mAttribute_mOutletDeclarationList, p->mAttribute_mAttributeList, p->mAttribute_mTransientList, p->mAttribute_mActionDeclarationList, p->mAttribute_mControllerList, p->mAttribute_mArrayList COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_preferencesDeclaration::cPtr_preferencesDeclaration (const GALGAS_lstring & in_mPreferencesName,
                                                          const GALGAS_outletDeclarationList & in_mOutletDeclarationList,
                                                          const GALGAS_attributeList & in_mAttributeList,
                                                          const GALGAS_transientList & in_mTransientList,
                                                          const GALGAS_lstringlist & in_mActionDeclarationList,
...
typeComparisonResult cPtr_protocolDeclaration::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_protocolDeclaration) ;
  if (kOperandEqual == result) {
...
GALGAS_astDeclaration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_protocolDeclaration) ;
}

//---------------------------------------------------------------------------*

GALGAS_protocolDeclaration GALGAS_protocolDeclaration::constructor_new (const GALGAS_bool & inAttribute_mIsPredefined,
                                                                        const GALGAS_lstring & inAttribute_mProtocolName
                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_protocolDeclaration result ;
  if (inAttribute_mIsPredefined.isValid () && inAttribute_mProtocolName.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_protocolDeclaration (inAttribute_mIsPredefined, inAttribute_mProtocolName COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_protocolDeclaration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_protocolDeclaration (p->mAttribute_mIsPredefined, p->mAttribute_mProtocolName COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_protocolDeclaration::cPtr_protocolDeclaration (const GALGAS_bool & in_mIsPredefined,
...
typeComparisonResult cPtr_structDeclaration::dynamicObjectCompare (const acPtr_class * inOperandPtr) const {
  ...
  macroValidSharedObject (p, const cPtr_structDeclaration) ;
  if (kOperandEqual == result) {
...
GALGAS_structDeclaration GALGAS_structDeclaration::constructor_default (LOCATION_ARGS) {
  return GALGAS_structDeclaration::constructor_new (GALGAS_lstring::constructor_default (HERE),
...
GALGAS_astDeclaration (inSourcePtr) {
  macroNullOrValidSharedObject (inSourcePtr, const cPtr_structDeclaration) ;
}

//---------------------------------------------------------------------------*

GALGAS_structDeclaration GALGAS_structDeclaration::constructor_new (const GALGAS_lstring & inAttribute_mStructTypeName,
  ...
  if (inAttribute_mStructTypeName.isValid () && inAttribute_mFieldList.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_structDeclaration (inAttribute_mStructTypeName, inAttribute_mFieldList COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_structDeclaration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_structDeclaration (p->mAttribute_mStructTypeName, p->mAttribute_mFieldList COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_structDeclaration::cPtr_structDeclaration (const GALGAS_lstring & in_mStructTypeName,
...
GALGAS_astDeclarationList_2E_element::GALGAS_astDeclarationList_2E_element (void) :
...
GALGAS_astDeclarationList_2E_element::GALGAS_astDeclarationList_2E_element (const GALGAS_astDeclaration & inOperand0) :
mAttribute_mDeclaration (inOperand0) {
}

//---------------------------------------------------------------------------*

GALGAS_astDeclarationList_2E_element GALGAS_astDeclarationList_2E_element::constructor_new (const GALGAS_astDeclaration & inOperand0 
                                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_astDeclarationList_2E_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_astDeclarationList_2E_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_astDeclarationList_2E_element::objectCompare (const GALGAS_astDeclarationList_2E_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
...
bool GALGAS_astDeclarationList_2E_element::isValid (void) const {
  return mAttribute_mDeclaration.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_astDeclarationList_2E_element::drop (void) {
  mAttribute_mDeclaration.drop () ;
}

//---------------------------------------------------------------------------*

void GALGAS_astDeclarationList_2E_element::description (C_String & ioString,
                                                        const PMSInt32 inIndentation) const {
...
GALGAS_astDeclaration GALGAS_astDeclarationList_2E_element::reader_mDeclaration (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_astDeclarationList_2E_element ("astDeclarationList.element",
                                                      NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_astDeclarationList_2E_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_astDeclarationList_2E_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_astDeclarationList_2E_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_astDeclarationList_2E_element (*this)) ;
  }
  return result ;
}
...
GALGAS_astDeclarationList_2E_element GALGAS_astDeclarationList_2E_element::extractObject (const GALGAS_object & inObject,
                                                                                          C_Compiler * inCompiler
                                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_astDeclarationList_2E_element result ;
  const GALGAS_astDeclarationList_2E_element * p = (const GALGAS_astDeclarationList_2E_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_astDeclarationList_2E_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_attributeList_2E_element::GALGAS_attributeList_2E_element (const GALGAS_lstring & inOperand0,
                                                                  const GALGAS_lstring & inOperand1,
                                                                  const GALGAS_abstractDefaultValue & inOperand2) :
...
GALGAS_attributeList_2E_element GALGAS_attributeList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                  const GALGAS_lstring & inOperand1,
                                                                                  const GALGAS_abstractDefaultValue & inOperand2 
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_transientList_2E_element::GALGAS_transientList_2E_element (const GALGAS_lstring & inOperand0,
                                                                  const GALGAS_lstring & inOperand1,
                                                                  const GALGAS_dependanceList & inOperand2) :
...
GALGAS_transientList_2E_element GALGAS_transientList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_transientList_2E_element (GALGAS_lstring::constructor_default (HERE),
                                          GALGAS_lstring::constructor_default (HERE),
...
GALGAS_transientList_2E_element GALGAS_transientList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                  const GALGAS_lstring & inOperand1,
                                                                                  const GALGAS_dependanceList & inOperand2 
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_lstring GALGAS_classArrayList_2E_element::reader_mElementClassName (UNUSED_LOCATION_ARGS) const {
...
mAttribute_mChildRelationshipName (),
mAttribute_mIsLeafAttributeName () {
}
...
mAttribute_mIsLeafAttributeName (inOperand8) {
}
...
GALGAS_controllerList_2E_element GALGAS_controllerList_2E_element::constructor_new (const GALGAS_controllerKind & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid ()) {
    result = GALGAS_controllerList_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_controllerList_2E_element::objectCompare (const GALGAS_controllerList_2E_element & inOperand) const {
  ...
  if (result == kOperandEqual) {
    result = mAttribute_mIsLeafAttributeName.objectCompare (inOperand.mAttribute_mIsLeafAttributeName) ;
  }
  return result ;
}
...
void GALGAS_controllerList_2E_element::drop (void) {
  ...
  mAttribute_mIsLeafAttributeName.drop () ;
}
...
void GALGAS_controllerList_2E_element::description (C_String & ioString,
  ...
  if (! isValid ()) {
    ...
    ioString << ", " ;
    mAttribute_mIsLeafAttributeName.description (ioString, inIndentation+1) ;
  }
  ioString << ">" ;
}
...
GALGAS_lstring GALGAS_controllerList_2E_element::reader_mChildRelationshipName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mChildRelationshipName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_controllerList_2E_element::reader_mIsLeafAttributeName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIsLeafAttributeName ;
}
...
GALGAS_attributeASTTypeAndFormatterList_2E_element::GALGAS_attributeASTTypeAndFormatterList_2E_element (const GALGAS_lstring & inOperand0,
                                                                                                        const GALGAS_formatterEnum & inOperand1) :
...
GALGAS_attributeASTTypeAndFormatterList_2E_element GALGAS_attributeASTTypeAndFormatterList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_attributeASTTypeAndFormatterList_2E_element (GALGAS_lstring::constructor_default (HERE),
                                                             GALGAS_formatterEnum::constructor_noFormatter (HERE)) ;
}

//---------------------------------------------------------------------------*

GALGAS_attributeASTTypeAndFormatterList_2E_element GALGAS_attributeASTTypeAndFormatterList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                                        const GALGAS_formatterEnum & inOperand1 
                                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_attributeASTTypeAndFormatterList_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_attributeASTTypeAndFormatterList_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
GALGAS_lstringlist GALGAS_bindingOptionList_2E_element::reader_mAcceptableTypeList (UNUSED_LOCATION_ARGS) const {
...
GALGAS_controllerObservablePropertyList_2E_element::GALGAS_controllerObservablePropertyList_2E_element (const GALGAS_lstring & inOperand0,
                                                                                                        const GALGAS_lstring & inOperand1) :
mAttribute_mTypeName (inOperand0),
...
GALGAS_controllerObservablePropertyList_2E_element GALGAS_controllerObservablePropertyList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_controllerObservablePropertyList_2E_element (GALGAS_lstring::constructor_default (HERE),
                                                             GALGAS_lstring::constructor_default (HERE)) ;
}

//---------------------------------------------------------------------------*

GALGAS_controllerObservablePropertyList_2E_element GALGAS_controllerObservablePropertyList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                                        const GALGAS_lstring & inOperand1 
                                                                                                                        COMMA_UNUSED_LOCATION_ARGS) {
...
GALGAS_structFieldASTList_2E_element::GALGAS_structFieldASTList_2E_element (const GALGAS_lstring & inOperand0,
                                                                            const GALGAS_lstring & inOperand1) :
...
GALGAS_structFieldASTList_2E_element GALGAS_structFieldASTList_2E_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_structFieldASTList_2E_element (GALGAS_lstring::constructor_default (HERE),
                                               GALGAS_lstring::constructor_default (HERE)) ;
}

//---------------------------------------------------------------------------*

GALGAS_structFieldASTList_2E_element GALGAS_structFieldASTList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                            const GALGAS_lstring & inOperand1 
                                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_structFieldASTList_2E_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_structFieldASTList_2E_element (inOperand0, inOperand1) ;
  }
  return result ;
}
