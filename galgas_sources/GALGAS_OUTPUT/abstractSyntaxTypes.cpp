...
cCollectionElement_controllerList::cCollectionElement_controllerList (const GALGAS_controllerKind & in_mControllerKind,
                                                                      ...
                                                                      COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mControllerKind, in_mControllerClassName, in_mControllerName, in_mControlledObjectName, in_mControlledObjectBindingOptionList, in_mControllerBindingList) {
}
...
GALGAS_controllerList GALGAS_controllerList::constructor_listWithValue (const GALGAS_controllerKind & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_controllerList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_controllerList::addAssign_operation (const GALGAS_controllerKind & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_controllerList (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_controllerList::modifier_prependValue (GALGAS_controllerKind inOperand0,
                                                   ...
                                                   GALGAS_lstring inOperand2,
                                                   GALGAS_lstring inOperand3,
                                                   GALGAS_outletBindingOptionList inOperand4,
                                                   GALGAS_bindingList inOperand5
                                                   COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_controllerList (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5 COMMA_THERE)) ;
...
void GALGAS_controllerList::modifier_popFirst (GALGAS_controllerKind & outOperand0,
                                               ...
                                               GALGAS_lstring & outOperand2,
                                               GALGAS_lstring & outOperand3,
                                               GALGAS_outletBindingOptionList & outOperand4,
                                               GALGAS_bindingList & outOperand5,
                                               C_Compiler * inCompiler
                                               COMMA_LOCATION_ARGS) {
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  ...
  if (NULL == p) {
    ...
    outOperand3 = p->mObject.mAttribute_mControlledObjectName ;
    outOperand4 = p->mObject.mAttribute_mControlledObjectBindingOptionList ;
    outOperand5 = p->mObject.mAttribute_mControllerBindingList ;
  }
}
...
cCollectionElement_controllerClassList::cCollectionElement_controllerClassList (const GALGAS_controllerKind & in_mControllerKind,
                                                                                ...
                                                                                COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mControllerKind, in_mControllerClassName, in_mGenerationKind, in_mBindingList, in_mActionDeclarationList, in_mControllerObservablePropertyList) {
}
...
GALGAS_controllerClassList GALGAS_controllerClassList::constructor_listWithValue (const GALGAS_controllerKind & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_controllerClassList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_controllerClassList::addAssign_operation (const GALGAS_controllerKind & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_controllerClassList (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_controllerClassList::modifier_prependValue (GALGAS_controllerKind inOperand0,
                                                        GALGAS_lstring inOperand1,
                                                        GALGAS_generationKind inOperand2,
                                                        GALGAS_outletClassBindingList inOperand3,
                                                        GALGAS_lstringlist inOperand4,
                                                        GALGAS_controllerObservablePropertyList inOperand5
                                                        COMMA_LOCATION_ARGS) {
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_controllerClassList (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5 COMMA_THERE)) ;
...
void GALGAS_controllerClassList::modifier_popFirst (GALGAS_controllerKind & outOperand0,
                                                    GALGAS_lstring & outOperand1,
                                                    GALGAS_generationKind & outOperand2,
                                                    GALGAS_outletClassBindingList & outOperand3,
                                                    GALGAS_lstringlist & outOperand4,
                                                    GALGAS_controllerObservablePropertyList & outOperand5,
                                                    C_Compiler * inCompiler
                                                    COMMA_LOCATION_ARGS) {
  capCollectionElement attributes ;
  removeFirstObject (attributes, inCompiler COMMA_THERE) ;
  ...
  if (NULL == p) {
    ...
    outOperand0 = p->mObject.mAttribute_mControllerKind ;
    outOperand1 = p->mObject.mAttribute_mControllerClassName ;
    outOperand2 = p->mObject.mAttribute_mGenerationKind ;
    outOperand3 = p->mObject.mAttribute_mBindingList ;
    outOperand4 = p->mObject.mAttribute_mActionDeclarationList ;
    outOperand5 = p->mObject.mAttribute_mControllerObservablePropertyList ;
  }
}
...
mAttribute_mControlledObjectName (inOperand3),
mAttribute_mControlledObjectBindingOptionList (inOperand4),
mAttribute_mControllerBindingList (inOperand5) {
}
...
GALGAS_controllerList_2E_element GALGAS_controllerList_2E_element::constructor_new (const GALGAS_controllerKind & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid ()) {
    result = GALGAS_controllerList_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5) ;
  }
  return result ;
}
...
bool GALGAS_controllerList_2E_element::isValid (void) const {
  return mAttribute_mControllerKind.isValid () && mAttribute_mControllerClassName.isValid () && mAttribute_mControllerName.isValid () && mAttribute_mControlledObjectName.isValid () && mAttribute_mControlledObjectBindingOptionList.isValid () && mAttribute_mControllerBindingList.isValid () ;
}
...
mAttribute_mBindingList (inOperand3),
mAttribute_mActionDeclarationList (inOperand4),
mAttribute_mControllerObservablePropertyList (inOperand5) {
}
...
GALGAS_controllerClassList_2E_element GALGAS_controllerClassList_2E_element::constructor_new (const GALGAS_controllerKind & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid ()) {
    result = GALGAS_controllerClassList_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5) ;
  }
  return result ;
}
...
bool GALGAS_controllerClassList_2E_element::isValid (void) const {
  return mAttribute_mControllerKind.isValid () && mAttribute_mControllerClassName.isValid () && mAttribute_mGenerationKind.isValid () && mAttribute_mBindingList.isValid () && mAttribute_mActionDeclarationList.isValid () && mAttribute_mControllerObservablePropertyList.isValid () ;
}
