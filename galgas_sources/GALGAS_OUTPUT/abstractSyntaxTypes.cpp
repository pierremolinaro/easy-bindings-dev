...
mObject (in_mIsUserDefined, in_mOutletClassName, in_mBindingName, in_mModelTypeName) {
}
...
cCollectionElement * cCollectionElement_controllerTemplateList::copy (void) {
  ...
  macroMyNew (result, cCollectionElement_controllerTemplateList (mObject.mAttribute_mIsUserDefined, mObject.mAttribute_mOutletClassName, mObject.mAttribute_mBindingName, mObject.mAttribute_mModelTypeName COMMA_HERE)) ;
  return result ;
}
...
GALGAS_controllerTemplateList GALGAS_controllerTemplateList::constructor_listWithValue (const GALGAS_bool & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    ...
    GALGAS_controllerTemplateList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3 COMMA_THERE) ;
...
void GALGAS_controllerTemplateList::addAssign_operation (const GALGAS_bool & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    ...
    macroMyNew (p, cCollectionElement_controllerTemplateList (inOperand0, inOperand1, inOperand2, inOperand3 COMMA_THERE)) ;
    capCollectionElement attributes ;
...
cCollectionElement_bindingList::cCollectionElement_bindingList (const GALGAS_lstring & in_mObservablePropertyName,
                                                                ...
                                                                COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mObservablePropertyName, in_mOutletName, in_mBindingName) {
}
...
cCollectionElement * cCollectionElement_bindingList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_bindingList (mObject.mAttribute_mObservablePropertyName, mObject.mAttribute_mOutletName, mObject.mAttribute_mBindingName COMMA_HERE)) ;
  return result ;
}
...
GALGAS_bindingList GALGAS_bindingList::constructor_listWithValue (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_bindingList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_bindingList::addAssign_operation (const GALGAS_lstring & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_bindingList (inOperand0, inOperand1, inOperand2 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
GALGAS_controllerTemplateList_2D_element GALGAS_controllerTemplateList_2D_element::constructor_new (const GALGAS_bool & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_controllerTemplateList_2D_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
bool GALGAS_controllerTemplateList_2D_element::isValid (void) const {
  return mAttribute_mIsUserDefined.isValid () && mAttribute_mOutletClassName.isValid () && mAttribute_mBindingName.isValid () && mAttribute_mModelTypeName.isValid () ;
}
...
GALGAS_bindingList_2D_element GALGAS_bindingList_2D_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_bindingList_2D_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
bool GALGAS_bindingList_2D_element::isValid (void) const {
  return mAttribute_mObservablePropertyName.isValid () && mAttribute_mOutletName.isValid () && mAttribute_mBindingName.isValid () ;
}
