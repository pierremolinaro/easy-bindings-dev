...
cCollectionElement_entityList::cCollectionElement_entityList (const GALGAS_lstring & in_mEntityName,
                                                              ...
                                                              COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mEntityName, in_mSuperEntityName, in_mImplementationClassName, in_mAttributeList, in_mTransientList, in_mRelationshipList, in_mSignList) {
}
...
cCollectionElement * cCollectionElement_entityList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_entityList (mObject.mAttribute_mEntityName, mObject.mAttribute_mSuperEntityName, mObject.mAttribute_mImplementationClassName, mObject.mAttribute_mAttributeList, mObject.mAttribute_mTransientList, mObject.mAttribute_mRelationshipList, mObject.mAttribute_mSignList COMMA_HERE)) ;
  return result ;
}
...
GALGAS_entityList GALGAS_entityList::constructor_listWithValue (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid ()) {
    result.createNewEmptyList (THERE) ;
    capCollectionElement attributes ;
    GALGAS_entityList::makeAttributesFromObjects (attributes, inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6 COMMA_THERE) ;
    result.addObject (attributes) ;
  }
  return result ;
}
...
void GALGAS_entityList::addAssign_operation (const GALGAS_lstring & inOperand0,
  ...
  if (isValid () && inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid ()) {
    cCollectionElement * p = NULL ;
    macroMyNew (p, cCollectionElement_entityList (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6 COMMA_THERE)) ;
    capCollectionElement attributes ;
    attributes.setPointer (p) ;
    macroDetachSharedObject (p) ;
    addObject (attributes) ;
...
void GALGAS_entityList::modifier_popFirst (GALGAS_lstring & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand6 = p->mObject.mAttribute_mSignList ;
  }
}
...
GALGAS_transientRootSignDependency GALGAS_transientRootSignDependency::extractObject (const GALGAS_object & inObject,
  ...
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_transientRootSignDependency *> (p)) {
      ...
      inCompiler->extractObjectError (inErrorLocation, "transientRootSignDependency", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
  }
  return result ;
}
...
mAttribute_mSignList (inOperand6) {
}
...
GALGAS_entityList_2E_element GALGAS_entityList_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid ()) {
    result = GALGAS_entityList_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6) ;
  }
  return result ;
}
...
bool GALGAS_entityList_2E_element::isValid (void) const {
  return mAttribute_mEntityName.isValid () && mAttribute_mSuperEntityName.isValid () && mAttribute_mImplementationClassName.isValid () && mAttribute_mAttributeList.isValid () && mAttribute_mTransientList.isValid () && mAttribute_mRelationshipList.isValid () && mAttribute_mSignList.isValid () ;
}
