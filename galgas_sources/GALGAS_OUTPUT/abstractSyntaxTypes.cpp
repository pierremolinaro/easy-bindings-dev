...
GALGAS_preferenceObservablePropertyAST GALGAS_preferenceObservablePropertyAST::constructor_new (const GALGAS_lstring & inAttribute_mSelectorName,
  ...
  if (inAttribute_mSelectorName.isValid () && inAttribute_mPreferenceName.isValid () && inAttribute_mPreferenceObservablePropertyName.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_preferenceObservablePropertyAST (inAttribute_mSelectorName, inAttribute_mPreferenceName, inAttribute_mPreferenceObservablePropertyName COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_preferenceObservablePropertyAST::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_preferenceObservablePropertyAST (p->mAttribute_mSelectorName, p->mAttribute_mPreferenceName, p->mAttribute_mPreferenceObservablePropertyName COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_preferenceObservablePropertyAST::cPtr_preferenceObservablePropertyAST (const GALGAS_lstring & in_mSelectorName,
...
GALGAS_rootObservablePropertyAST GALGAS_rootObservablePropertyAST::constructor_new (const GALGAS_lstring & inAttribute_mSelectorName,
                                                                                    const GALGAS_lstring & inAttribute_mRootObservablePropertyName
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_rootObservablePropertyAST result ;
  if (inAttribute_mSelectorName.isValid () && inAttribute_mRootObservablePropertyName.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_rootObservablePropertyAST (inAttribute_mSelectorName, inAttribute_mRootObservablePropertyName COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_rootObservablePropertyAST::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_rootObservablePropertyAST (p->mAttribute_mSelectorName, p->mAttribute_mRootObservablePropertyName COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
cPtr_rootObservablePropertyAST::cPtr_rootObservablePropertyAST (const GALGAS_lstring & in_mSelectorName,
