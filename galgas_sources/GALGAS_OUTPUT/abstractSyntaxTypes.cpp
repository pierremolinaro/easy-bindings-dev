...
GALGAS_predefinedTypeDeclaration GALGAS_predefinedTypeDeclaration::constructor_default (LOCATION_ARGS) {
  return GALGAS_predefinedTypeDeclaration::constructor_new (GALGAS_lstring::constructor_default (HERE)
                                                            COMMA_THERE) ;
}
...
GALGAS_predefinedTypeDeclaration GALGAS_predefinedTypeDeclaration::constructor_new (const GALGAS_lstring & inAttribute_mTypeName
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_predefinedTypeDeclaration result ;
  if (inAttribute_mTypeName.isValid ()) {
    macroMyNew (result.mObjectPtr, cPtr_predefinedTypeDeclaration (inAttribute_mTypeName COMMA_THERE)) ;
  }
  return result ;
}
...
void GALGAS_predefinedTypeDeclaration::insulate (LOCATION_ARGS) {
  ...
  if (isValid () && (mObjectPtr->retainCount () > 1)) {
    ...
    macroMyNew (r, cPtr_predefinedTypeDeclaration (p->mAttribute_mTypeName COMMA_THERE)) ;
    macroAssignSharedObject (mObjectPtr, r) ;
    macroDetachSharedObject (r) ;
  }
  macroMutexUnlock (gInsulationMutex) ;
...
GALGAS_lstring GALGAS_predefinedTypeDeclaration::reader_mTypeName (UNUSED_LOCATION_ARGS) const {
  GALGAS_lstring result ;
  if (NULL != mObjectPtr) {
...
GALGAS_lstring cPtr_predefinedTypeDeclaration::reader_mTypeName (UNUSED_LOCATION_ARGS) const {
...
cPtr_predefinedTypeDeclaration::cPtr_predefinedTypeDeclaration (const GALGAS_lstring & in_mTypeName
                                                                COMMA_LOCATION_ARGS) :
cPtr_astDeclaration (THERE),
