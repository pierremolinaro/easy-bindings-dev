...
//--- Constructor
  public : cCollectionElement_bindingList (const GALGAS_lstring & in_mObservablePropertyName,
...
cCollectionElement_bindingList::cCollectionElement_bindingList (const GALGAS_lstring & in_mObservablePropertyName,
                                                                const GALGAS_lstring & in_mModelSelectorName,
                                                                const GALGAS_lstring & in_mOutletName,
                                                                const GALGAS_lstring & in_mBindingName,
                                                                const GALGAS_bindingOptionList & in_mBindingOptionList
                                                                COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mObservablePropertyName, in_mModelSelectorName, in_mOutletName, in_mBindingName, in_mBindingOptionList) {
}
...
cCollectionElement * cCollectionElement_bindingList::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_bindingList (mObject.mAttribute_mObservablePropertyName, mObject.mAttribute_mModelSelectorName, mObject.mAttribute_mOutletName, mObject.mAttribute_mBindingName, mObject.mAttribute_mBindingOptionList COMMA_HERE)) ;
  return result ;
}
...
void cCollectionElement_bindingList::description (C_String & ioString, const int32_t inIndentation) const {
  ...
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
  ioString << "mModelSelectorName" ":" ;
  mObject.mAttribute_mModelSelectorName.description (ioString, inIndentation) ;
  ioString << "\n" ;
  ioString.writeStringMultiple ("| ", inIndentation) ;
...
void GALGAS_bindingList::makeAttributesFromObjects (capCollectionElement & outAttributes,
  ...
  macroMyNew (p, cCollectionElement_bindingList (in_mObservablePropertyName,
                                                 in_mModelSelectorName,
                                                 in_mOutletName,
                                                 in_mBindingName,
                                                 in_mBindingOptionList COMMA_THERE)) ;
  outAttributes.setPointer (p) ;
...
void GALGAS_bindingList::modifier_removeAtIndex (GALGAS_lstring & outOperand0,
  ...
  if (isValid () && inRemoveIndex.isValid ()) {
    ...
    if (NULL == p) {
      ...
      outOperand0 = p->mObject.mAttribute_mObservablePropertyName ;
      outOperand1 = p->mObject.mAttribute_mModelSelectorName ;
...
GALGAS_lstring GALGAS_bindingList::reader_mObservablePropertyNameAtIndex (const GALGAS_uint & inIndex,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_bindingList * p = (cCollectionElement_bindingList *) attributes.ptr () ;
...
GALGAS_lstring GALGAS_bindingList::reader_mModelSelectorNameAtIndex (const GALGAS_uint & inIndex,
                                                                     C_Compiler * inCompiler
                                                                     COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_bindingList * p = (cCollectionElement_bindingList *) attributes.ptr () ;
  ...
  if (NULL != p) {
    macroValidSharedObject (p, cCollectionElement_bindingList) ;
    result = p->mObject.mAttribute_mModelSelectorName ;
  }
  return result ;
}
...
GALGAS_lstring cEnumerator_bindingList::current_mObservablePropertyName (LOCATION_ARGS) const {
  const cCollectionElement_bindingList * p = (const cCollectionElement_bindingList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_bindingList) ;
...
GALGAS_lstring cEnumerator_bindingList::current_mModelSelectorName (LOCATION_ARGS) const {
  const cCollectionElement_bindingList * p = (const cCollectionElement_bindingList *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, cCollectionElement_bindingList) ;
  return p->mObject.mAttribute_mModelSelectorName ;
}
...
GALGAS_bindingList_2D_element::GALGAS_bindingList_2D_element (const GALGAS_lstring & inOperand0,
                                                              ...
                                                              const GALGAS_lstring & inOperand3,
                                                              const GALGAS_bindingOptionList & inOperand4) :
mAttribute_mObservablePropertyName (inOperand0),
mAttribute_mModelSelectorName (inOperand1),
...
GALGAS_bindingList_2D_element GALGAS_bindingList_2D_element::constructor_default (UNUSED_LOCATION_ARGS) {
  return GALGAS_bindingList_2D_element (GALGAS_lstring::constructor_default (HERE),
                                        GALGAS_lstring::constructor_default (HERE),
                                        GALGAS_lstring::constructor_default (HERE),
                                        GALGAS_lstring::constructor_default (HERE),
...
typeComparisonResult GALGAS_bindingList_2D_element::objectCompare (const GALGAS_bindingList_2D_element & inOperand) const {
  ...
  if (result == kOperandEqual) {
    result = mAttribute_mModelSelectorName.objectCompare (inOperand.mAttribute_mModelSelectorName) ;
  }
  if (result == kOperandEqual) {
...
bool GALGAS_bindingList_2D_element::isValid (void) const {
  return mAttribute_mObservablePropertyName.isValid () && mAttribute_mModelSelectorName.isValid () && mAttribute_mOutletName.isValid () && mAttribute_mBindingName.isValid () && mAttribute_mBindingOptionList.isValid () ;
}
...
void GALGAS_bindingList_2D_element::drop (void) {
  ...
  mAttribute_mModelSelectorName.drop () ;
...
void GALGAS_bindingList_2D_element::description (C_String & ioString,
  ...
  if (! isValid ()) {
    ...
    ioString << ", " ;
    mAttribute_mModelSelectorName.description (ioString, inIndentation+1) ;
    ioString << ", " ;
...
GALGAS_lstring GALGAS_bindingList_2D_element::reader_mObservablePropertyName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mObservablePropertyName ;
}

//---------------------------------------------------------------------------------------------------------------------*

GALGAS_lstring GALGAS_bindingList_2D_element::reader_mModelSelectorName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mModelSelectorName ;
}
