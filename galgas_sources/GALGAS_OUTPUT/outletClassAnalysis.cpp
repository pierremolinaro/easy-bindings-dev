...
static void categoryMethod_outletClassDeclaration_semanticAnalysis (const cPtr_astDeclaration * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_generationKind joker_2759_4 ; // Joker input parameter
    GALGAS_string joker_2759_3 ; // Joker input parameter
    GALGAS_protocolList joker_2759_2 ; // Joker input parameter
    GALGAS_bool joker_2759_1 ; // Joker input parameter
    GALGAS_outletClassBindingMap joker_2790_2 ; // Joker input parameter
    GALGAS_bool joker_2790_1 ; // Joker input parameter
    ioArgument_ioContextAnalysisStruct.mAttribute_mOutletClassMap.method_searchKey (object->mAttribute_mSuperClassName, joker_2759_4, joker_2759_3, joker_2759_2, joker_2759_1, var_allBindingMap, joker_2790_2, joker_2790_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (84)) ;
  }
  ...
  cEnumerator_lstringlist enumerator_2951 (object->mAttribute_mOptionList, kEnumeration_up) ;
  while (enumerator_2951.hasCurrentObject ()) {
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_2951.current_mValue (HERE).mAttribute_string.objectCompare (GALGAS_string ("PMWillDeallocProtocol"))).boolEnum () ;
    if (kBoolTrue == test_1) {
      GALGAS_location location_2 (enumerator_2951.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      if (kBoolTrue == test_3) {
        GALGAS_location location_4 (enumerator_2951.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        var_adoptedProtocolList.addAssign_operation (GALGAS_bool (false), enumerator_2951.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (101)) ;
      }
    }
  ...
  cEnumerator_outletClassBindingList enumerator_3431 (object->mAttribute_mOutletClassBindingList, kEnumeration_up) ;
  while (enumerator_3431.hasCurrentObject ()) {
    ...
    cEnumerator_bindingOptionList enumerator_3539 (enumerator_3431.current_mBindingOptionList (HERE), kEnumeration_up) ;
    while (enumerator_3539.hasCurrentObject ()) {
      ...
      cEnumerator_lstringlist enumerator_3627 (enumerator_3539.current_mAcceptableTypeList (HERE), kEnumeration_up) ;
      while (enumerator_3627.hasCurrentObject ()) {
        GALGAS_ebType var_type ;
        GALGAS_astDeclaration joker_3688_0 ; // Joker input parameter
        constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_3627.current_mValue (HERE), var_type, joker_3688_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (111)) ;
        var_acceptableTypeList.addAssign_operation (var_type COMMA_SOURCE_FILE_AT_LINE (112)) ;
        enumerator_3627.gotoNextObject () ;
      }
      {
      var_outletClassBindingOptionMap.modifier_insertKey (enumerator_3539.current_mBindingOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (114)) ;
      }
    ...
    cEnumerator_attributeASTTypeAndFormatterList enumerator_3971 (enumerator_3431.current_mAcceptableTypeFormatterList (HERE), kEnumeration_up) ;
    while (enumerator_3971.hasCurrentObject ()) {
      GALGAS_ebType var_type ;
      GALGAS_astDeclaration joker_4033_0 ; // Joker input parameter
      constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_3971.current_mTypeName (HERE), var_type, joker_4033_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (118)) ;
      var_acceptableTypeFormatterList.addAssign_operation (var_type, enumerator_3971.current_mRequiredFormatter (HERE) COMMA_SOURCE_FILE_AT_LINE (119)) ;
      enumerator_3971.gotoNextObject () ;
    }
    {
    var_allBindingMap.modifier_insertKey (enumerator_3431.current_mBindingName (HERE), var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (121)) ;
    }
    {
    var_currentBindingMap.modifier_insertKey (enumerator_3431.current_mBindingName (HERE), var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (122)) ;
    }
    enumerator_3431.gotoNextObject () ;
  }
  cEnumerator_lstringlist enumerator_4408 (object->mAttribute_mAdoptedProtocolList, kEnumeration_up) ;
  while (enumerator_4408.hasCurrentObject ()) {
    GALGAS_bool var_isPredefined ;
    ioArgument_ioContextAnalysisStruct.mAttribute_mProtocolMap.method_searchKey (enumerator_4408.current_mValue (HERE), var_isPredefined, inCompiler COMMA_SOURCE_FILE_AT_LINE (126)) ;
    var_adoptedProtocolList.addAssign_operation (var_isPredefined, enumerator_4408.current_mValue (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (127)) ;
