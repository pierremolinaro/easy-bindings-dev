...
//                                         september 13th, 2014, at 10h42'1"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_documentGenerationTemplate_documentImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (in_OUTLET_5F_GENERATION_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_6544 (in_OUTLET_5F_GENERATION_5F_MAP, kEnumeration_up) ;
    while (enumerator_6544.hasCurrentObject ()) {
      result << "    if nil == " ;
      result << enumerator_6544.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " {\n"
  ...
  GALGAS_uint index_6779_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_6779 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_6779.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6779.current_mControllerName (HERE).stringValue () ;
      result << " = ArrayController_" ;
      result << enumerator_6779.current_mObjectTypeName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_6779.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (\n"
        "      object:rootObject,\n"
        "      tableView:" ;
      result << enumerator_6779.current_mTableViewOutletName (HERE).stringValue () ;
      result << ",\n"
        "      file:__FILE__,\n"
        "      line:__LINE__\n"
        "    )\n" ;
      index_6779_.increment () ;
  ...
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_7091 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_7091.hasCurrentObject ()) {
      GALGAS_uint index_7120_ (0) ;
      if (enumerator_7091.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_7120 (enumerator_7091.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_7120.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_7120.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 149)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 149)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 149)).add_operation (enumerator_7091.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 149)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 149)).stringValue () ;
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_7393 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_7393.hasCurrentObject ()) {
      result << "    rootObject.addObserverOf_" ;
      result << enumerator_7393.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (triggerObjectFor_document_2E_PMDocument_2E_" ;
      result << enumerator_7393.current_mControllerName (HERE).stringValue () ;
      result << ", inTrigger:true)\n" ;
  ...
  GALGAS_uint index_7632_ (0) ;
  if (in_CONTROLLER_5F_INSTANCIATION_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_7632 (in_CONTROLLER_5F_INSTANCIATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7632.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_7632.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
      index_7632_.increment () ;
      enumerator_7632.gotoNextObject () ;
    }
  }
  result << "  //--------------------------- Set targets / actions\n" ;
  GALGAS_uint index_7771_ (0) ;
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_7771 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7771.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7771.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = " ;
      result << enumerator_7771.current_mTargetName (HERE).stringValue () ;
      result << "\n"
        "    " ;
      result << enumerator_7771.current_mOutletName (HERE).stringValue () ;
      result << "\?.action = \"" ;
      result << enumerator_7771.current_mActionName (HERE).stringValue () ;
      result << ":\"\n" ;
      index_7771_.increment () ;
  ...
  result << "  //--------------------------- Update display\n"
    ...
    "  //--------------------------- Remove controllers\n" ;
  GALGAS_uint index_8483_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_8483 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_8483.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8483.current_mControllerName (HERE).stringValue () ;
      result << "\?.unregister ()\n" ;
      index_8483_.increment () ;
  ...
  GALGAS_uint index_8844_ (0) ;
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_8844 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_8844.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8844.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = nil\n" ;
      index_8844_.increment () ;
  ...
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_9003 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_9003.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_9003.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 200)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 200)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_9003.current_mTransientName (HERE).stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  var " ;
      result << enumerator_9003.current_mTransientName (HERE).stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_9003.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 203)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_9003.current_mTransientName (HERE).stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_9003.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 204)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_9003.current_mTransientName (HERE).stringValue () ;
      ...
      if (enumerator_9003.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_9690 (enumerator_9003.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_9690.hasCurrentObject ()) {
          result << callCategoryReader_generateActualParameterForComputeFunction ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_9690.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 209)).stringValue () ;
          if (enumerator_9690.hasNextObject ()) {
            result << ", " ;
          }
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 218)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 218)).add_operation (enumerator_9003.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 218)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 218)).stringValue () ;
      result << "_noteDidChange () {\n"
        "    " ;
      result << enumerator_9003.current_mTransientName (HERE).stringValue () ;
      result << "_cache = nil\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 222)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 222)).add_operation (enumerator_9003.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 222)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 222)).stringValue () ;
      result << "_trigger () {\n"
        "    for anyObject in " ;
      result << enumerator_9003.current_mTransientName (HERE).stringValue () ;
      result << "_observers {\n"
      ...
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (enumerator_9003.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 243)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (enumerator_9003.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 243)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (enumerator_9003.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 244)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (enumerator_9003.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 244)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 245)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 245)).add_operation (enumerator_9003.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 245)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 245)).stringValue () ;
      result << "_cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (enumerator_9003.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 246)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (enumerator_9003.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 246)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 248)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 248)).add_operation (enumerator_9003.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 248)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 248)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
