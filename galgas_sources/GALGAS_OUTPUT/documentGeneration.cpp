...
//                                         september 12th, 2014, at 22h1'51"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_documentGenerationTemplate_documentImplementationInSwift (C_Compiler * inCompiler,
  ...
  GALGAS_uint index_6636_ (0) ;
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_6636 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_6636.hasCurrentObject ()) {
      GALGAS_uint index_6665_ (0) ;
      if (enumerator_6636.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_6665 (enumerator_6636.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_6665.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_6665.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 143)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 143)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 143)).add_operation (enumerator_6636.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 143)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 143)).stringValue () ;
          result << ", inTrigger:true)\n" ;
          index_6665_.increment () ;
          enumerator_6665.gotoNextObject () ;
        }
      }
      index_6636_.increment () ;
  ...
  if (in_CONTROLLER_5F_INSTANCIATION_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_7177 (in_CONTROLLER_5F_INSTANCIATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7177.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_7177.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
  ...
  GALGAS_uint index_7316_ (0) ;
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_7316 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7316.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7316.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = " ;
      result << enumerator_7316.current_mTargetName (HERE).stringValue () ;
      result << "\n"
        "    " ;
      result << enumerator_7316.current_mOutletName (HERE).stringValue () ;
      result << "\?.action = \"" ;
      result << enumerator_7316.current_mActionName (HERE).stringValue () ;
      result << ":\"\n" ;
      index_7316_.increment () ;
  ...
  result << "  //--------------------------- Update display\n"
    ...
    "  //--------------------------- Remove controllers\n" ;
  GALGAS_uint index_8028_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_8028 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_8028.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8028.current_mControllerName (HERE).stringValue () ;
      result << "\?.unregister ()\n" ;
      index_8028_.increment () ;
  ...
  GALGAS_uint index_8389_ (0) ;
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_8389 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_8389.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8389.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = nil\n" ;
      index_8389_.increment () ;
  ...
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_8548 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_8548.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_8548.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 194)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 194)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_8548.current_mTransientName (HERE).stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  var " ;
      result << enumerator_8548.current_mTransientName (HERE).stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_8548.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 197)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_8548.current_mTransientName (HERE).stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_8548.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 198)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_8548.current_mTransientName (HERE).stringValue () ;
      ...
      if (enumerator_8548.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_9235 (enumerator_8548.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_9235.hasCurrentObject ()) {
          result << callCategoryReader_generateActualParameterForComputeFunction ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_9235.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 203)).stringValue () ;
          if (enumerator_9235.hasNextObject ()) {
            result << ", " ;
          }
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).add_operation (enumerator_8548.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 212)).stringValue () ;
      result << "_noteDidChange () {\n"
        "    " ;
      result << enumerator_8548.current_mTransientName (HERE).stringValue () ;
      result << "_cache = nil\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 216)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 216)).add_operation (enumerator_8548.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 216)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 216)).stringValue () ;
      result << "_trigger () {\n"
        "    for anyObject in " ;
      result << enumerator_8548.current_mTransientName (HERE).stringValue () ;
      result << "_observers {\n"
      ...
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).add_operation (enumerator_8548.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 237)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).add_operation (enumerator_8548.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 237)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 238)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 238)).add_operation (enumerator_8548.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 238)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 238)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 238)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 238)).add_operation (enumerator_8548.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 238)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 238)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 239)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 239)).add_operation (enumerator_8548.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 239)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 239)).stringValue () ;
      result << "_cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 240)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 240)).add_operation (enumerator_8548.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 240)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 240)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 240)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 240)).add_operation (enumerator_8548.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 240)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 240)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 242)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 242)).add_operation (enumerator_8548.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 242)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 242)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
