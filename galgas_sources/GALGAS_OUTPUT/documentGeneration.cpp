...
//                                         september 22th, 2014, at 18h56'43"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_documentGenerationTemplate_documentImplementationInSwift (C_Compiler * inCompiler,
  ...
  result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
    ...
    "  //-------------------------------------------------------------------------------------------------------------------*\n"
    "\n" ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, in_CONTROLLER_5F_INSTANCIATION_5F_LIST.reader_length (SOURCE_FILE ("document.swift.gTemplate", 114)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
  ...
  result << "  override func windowControllerDidLoadNib (aController: NSWindowController) {\n"
    ...
    "  //--------------------------- Outlet checking\n" ;
  GALGAS_uint index_6099_ (0) ;
  if (in_OUTLET_5F_GENERATION_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_6099 (in_OUTLET_5F_GENERATION_5F_MAP, kEnumeration_up) ;
    while (enumerator_6099.hasCurrentObject ()) {
      result << "    if nil == " ;
      result << enumerator_6099.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " {\n"
        "      presentErrorWindow (__FILE__, __LINE__, \"the '" ;
      result << enumerator_6099.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "' outlet is nil\") ;\n"
        "    }\n" ;
      index_6099_.increment () ;
      enumerator_6099.gotoNextObject () ;
    }
  }
  result << "  //--------------------------- Array controller\n" ;
  GALGAS_uint index_6334_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_6334 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_6334.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6334.current_mControllerName (HERE).stringValue () ;
      result << " = ArrayController_" ;
      result << enumerator_6334.current_mObjectTypeName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_6334.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (\n"
        "      object:rootObject,\n"
        "      tableView:" ;
      result << enumerator_6334.current_mTableViewOutletName (HERE).stringValue () ;
      result << ",\n"
        "      file:__FILE__,\n"
        "      line:__LINE__\n"
        "    )\n" ;
      index_6334_.increment () ;
      enumerator_6334.gotoNextObject () ;
    }
  }
  result << "  //--------------------------- Transient observers\n" ;
  GALGAS_uint index_6646_ (0) ;
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_6646 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_6646.hasCurrentObject ()) {
      GALGAS_uint index_6675_ (0) ;
      if (enumerator_6646.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_6675 (enumerator_6646.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_6675.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_6675.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 142)).stringValue () ;
          result << " (event_" ;
          result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 142)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 142)).add_operation (enumerator_6646.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 142)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 142)).stringValue () ;
          result << ", inTrigger:true)\n" ;
          index_6675_.increment () ;
          enumerator_6675.gotoNextObject () ;
        }
      }
      index_6646_.increment () ;
      enumerator_6646.gotoNextObject () ;
    }
  }
  result << "  //--------------------------- Array controller as observers\n" ;
  GALGAS_uint index_6937_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_6937 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_6937.hasCurrentObject ()) {
      result << "    rootObject.addObserverOf_" ;
      result << enumerator_6937.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (PMEvent_document_2E_PMDocument_2E_" ;
      result << enumerator_6937.current_mControllerName (HERE).stringValue () ;
      result << " (object:self), inTrigger:false)\n" ;
      index_6937_.increment () ;
      enumerator_6937.gotoNextObject () ;
    }
  }
  result << "  //--------------------------- Simple controller\n" ;
  GALGAS_uint index_7182_ (0) ;
  if (in_CONTROLLER_5F_INSTANCIATION_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_7182 (in_CONTROLLER_5F_INSTANCIATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7182.hasCurrentObject ()) {
      result << "    mControllerArray.append (" ;
      result << enumerator_7182.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
      index_7182_.increment () ;
      enumerator_7182.gotoNextObject () ;
    }
  }
  result << "  //--------------------------- Set targets / actions\n" ;
  GALGAS_uint index_7318_ (0) ;
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_7318 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7318.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7318.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = " ;
      result << enumerator_7318.current_mTargetName (HERE).stringValue () ;
      result << "\n"
        "    " ;
      result << enumerator_7318.current_mOutletName (HERE).stringValue () ;
      result << "\?.action = \"" ;
      result << enumerator_7318.current_mActionName (HERE).stringValue () ;
      result << ":\"\n" ;
      index_7318_.increment () ;
  ...
  result << "  //--------------------------- Update display\n"
    ...
    "  //--------------------------- Remove controllers\n" ;
  GALGAS_uint index_8030_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_8030 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_8030.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8030.current_mControllerName (HERE).stringValue () ;
      result << "\?.unregister ()\n" ;
      index_8030_.increment () ;
      enumerator_8030.gotoNextObject () ;
    }
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, in_CONTROLLER_5F_INSTANCIATION_5F_LIST.reader_length (SOURCE_FILE ("document.swift.gTemplate", 173)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
  ...
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_8329 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_8329.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8329.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = nil\n" ;
  ...
  result << "  //---\n"
    ...
    "  }\n"
    "\n" ;
  GALGAS_uint index_8488_ (0) ;
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_8488 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_8488.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_8488.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 192)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 192)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_8488.current_mTransientName (HERE).stringValue () ;
      result << "_observers : [Int : PMTransientEventProtocol] = [:]\n"
        "  var " ;
      result << enumerator_8488.current_mTransientName (HERE).stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_8488.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 195)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_8488.current_mTransientName (HERE).stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_8488.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 196)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_8488.current_mTransientName (HERE).stringValue () ;
      ...
      result << enumerator_8488.current_mTransientName (HERE).stringValue () ;
      result << " (" ;
      GALGAS_uint index_9198_ (0) ;
      if (enumerator_8488.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_9198 (enumerator_8488.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_9198.hasCurrentObject ()) {
          result << callCategoryReader_generateActualParameterForComputeFunction ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_9198.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 201)).stringValue () ;
          if (enumerator_9198.hasNextObject ()) {
            result << ", " ;
          }
          index_9198_.increment () ;
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 210)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 210)).add_operation (enumerator_8488.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 210)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 210)).stringValue () ;
      result << "_noteDidChange () {\n"
        "    " ;
      result << enumerator_8488.current_mTransientName (HERE).stringValue () ;
      result << "_cache = nil\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 214)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 214)).add_operation (enumerator_8488.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 214)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 214)).stringValue () ;
      result << "_trigger () {\n"
        "    for object in " ;
      result << enumerator_8488.current_mTransientName (HERE).stringValue () ;
      ...
      result << "_observers [inObserver.uniqueIndex] = nil\n"
        ...
        "\n"
        "  var event_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 234)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 234)).add_operation (enumerator_8488.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 234)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 234)).stringValue () ;
      result << "_cache : PMEvent_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 234)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 234)).add_operation (enumerator_8488.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 234)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 234)).stringValue () ;
      result << "\? = nil\n"
        "  var event_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 235)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 235)).add_operation (enumerator_8488.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 235)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 235)).stringValue () ;
      result << " : PMEvent_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 235)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 235)).add_operation (enumerator_8488.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 235)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 235)).stringValue () ;
      result << " {\n"
        "    if event_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 236)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 236)).add_operation (enumerator_8488.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 236)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 236)).stringValue () ;
      result << "_cache == nil {\n"
        "      event_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).add_operation (enumerator_8488.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 237)).stringValue () ;
      result << "_cache = PMEvent_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).add_operation (enumerator_8488.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 237)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return event_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 239)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 239)).add_operation (enumerator_8488.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 239)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 239)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
      index_8488_.increment () ;
