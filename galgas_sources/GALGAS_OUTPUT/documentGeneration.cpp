...
//                                         september 8th, 2014, at 20h41'47"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_documentGenerationTemplate_documentImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_4901 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    const bool nonEmpty_enumerator_4901 = enumerator_4901.hasCurrentObject () ;
    while (enumerator_4901.hasCurrentObject ()) {
      result << "  var " ;
      result << enumerator_4901.current_mControllerName (HERE).stringValue () ;
      result << " : ArrayController_" ;
      result << enumerator_4901.current_mObjectTypeName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_4901.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_4901.current_mTableViewOutletName (HERE).stringValue () ;
      result << "\? = nil\n" ;
  ...
  result << "  override func windowControllerDidLoadNib (aController: NSWindowController) {\n"
    ...
    "  //--------------------------- Outlet checking\n" ;
  GALGAS_uint index_5381_ (0) ;
  if (in_OUTLET_5F_GENERATION_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_5381 (in_OUTLET_5F_GENERATION_5F_MAP, kEnumeration_up) ;
    while (enumerator_5381.hasCurrentObject ()) {
      result << "    if nil == " ;
      result << enumerator_5381.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " {\n"
        "      presentErrorWindow (__FILE__, __LINE__, \"the '" ;
      result << enumerator_5381.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "' outlet is nil\") ;\n"
        "    }\n" ;
      index_5381_.increment () ;
      enumerator_5381.gotoNextObject () ;
    }
  }
  result << "  //--------------------------- Transient observers\n" ;
  GALGAS_uint index_5630_ (0) ;
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_5630 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_5630.hasCurrentObject ()) {
      GALGAS_uint index_5659_ (0) ;
      if (enumerator_5630.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_5659 (enumerator_5630.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_5659.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependency *) enumerator_5659.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 117)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 117)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 117)).add_operation (enumerator_5630.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 117)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 117)).stringValue () ;
          result << ")\n" ;
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_5900 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_5900.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_5900.current_mControllerName (HERE).stringValue () ;
      result << " = ArrayController_" ;
      result << enumerator_5900.current_mObjectTypeName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_5900.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_5900.current_mTableViewOutletName (HERE).stringValue () ;
      result << " (\n"
        "      object:rootObject,\n"
        "      tableView:" ;
      result << enumerator_5900.current_mTableViewOutletName (HERE).stringValue () ;
  ...
  if (in_CONTROLLER_5F_INSTANCIATION_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_6229 (in_CONTROLLER_5F_INSTANCIATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_6229.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_6229.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
  ...
  GALGAS_uint index_6368_ (0) ;
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_6368 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_6368.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6368.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = " ;
      result << enumerator_6368.current_mTargetName (HERE).stringValue () ;
      result << "\n"
        "    " ;
      result << enumerator_6368.current_mOutletName (HERE).stringValue () ;
      result << "\?.action = \"" ;
      result << enumerator_6368.current_mActionName (HERE).stringValue () ;
      result << ":\"\n" ;
      index_6368_.increment () ;
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_7080 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_7080.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7080.current_mControllerName (HERE).stringValue () ;
      result << "\?.unregister ()\n" ;
      index_7080_.increment () ;
      enumerator_7080.gotoNextObject () ;
    }
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, in_CONTROLLER_5F_INSTANCIATION_5F_LIST.reader_length (SOURCE_FILE ("document.swift.gTemplate", 153)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
  ...
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_7441 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7441.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7441.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = nil\n" ;
  ...
  result << "  //---\n"
    ...
    "  }\n"
    "\n" ;
  GALGAS_uint index_7599_ (0) ;
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_7599 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_7599.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_7599.current_lkey (HERE).reader_string (SOURCE_FILE ("document.swift.gTemplate", 173)), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 173)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 173)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_7599.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  var " ;
      result << enumerator_7599.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_7599.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 176)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_7599.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_7599.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 177)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_7599.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      result << enumerator_7599.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " (" ;
      GALGAS_uint index_8258_ (0) ;
      if (enumerator_7599.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_8258 (enumerator_7599.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_8258.hasCurrentObject ()) {
          result << callCategoryReader_generateForComputeFunction ((const cPtr_abstractTransientDependency *) enumerator_8258.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 182)).stringValue () ;
          if (enumerator_8258.hasNextObject ()) {
            result << ", " ;
          }
          index_8258_.increment () ;
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 193)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 193)).add_operation (enumerator_7599.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 193)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 193)).stringValue () ;
      result << "_didChange () {\n"
        "    for anyObject in " ;
      result << enumerator_7599.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers {\n"
      ...
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 210)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 210)).add_operation (enumerator_7599.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 210)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 210)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 210)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 210)).add_operation (enumerator_7599.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 210)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 210)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 211)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 211)).add_operation (enumerator_7599.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 211)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 211)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 211)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 211)).add_operation (enumerator_7599.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 211)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 211)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).add_operation (enumerator_7599.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 212)).stringValue () ;
      result << "_cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 213)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 213)).add_operation (enumerator_7599.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 213)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 213)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 213)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 213)).add_operation (enumerator_7599.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 213)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 213)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 215)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 215)).add_operation (enumerator_7599.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 215)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 215)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
      index_7599_.increment () ;
