...
//                                         september 4th, 2014, at 17h55'59"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_documentGenerationTemplate_documentImplementationInSwift (C_Compiler * inCompiler,
  ...
  result << "\n"
    ...
    "  //-------------------------------------------------------------------------------------------------------------------*\n"
    "\n" ;
  GALGAS_uint index_1437_ (0) ;
  if (in_ATTRIBUTE_5F_LIST.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_1437 (in_ATTRIBUTE_5F_LIST, kEnumeration_up) ;
    while (enumerator_1437.hasCurrentObject ()) {
      result << "\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Attribute: ").add_operation (enumerator_1437.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 30)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 30)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_1437.current_mAttributeName (HERE).stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  var " ;
      result << enumerator_1437.current_mAttributeName (HERE).stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_1437.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 33)).stringValue () ;
      result << " = " ;
      result << enumerator_1437.current_mDefaultValueInSwift (HERE).stringValue () ;
      result << " {\n"
        "    didSet {\n"
        "      if " ;
      result << enumerator_1437.current_mAttributeName (HERE).stringValue () ;
  ...
  result << "\n"
    ...
    "  //--------------------------- Controller bindings\n"
    "  //--------------------------- Outlet checking\n" ;
  GALGAS_uint index_5177_ (0) ;
  if (in_OUTLET_5F_GENERATION_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_5177 (in_OUTLET_5F_GENERATION_5F_MAP, kEnumeration_up) ;
    while (enumerator_5177.hasCurrentObject ()) {
      result << "    if nil == " ;
      result << enumerator_5177.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " {\n"
        "      presentErrorWindow (__FILE__, __LINE__, \"the '" ;
      result << enumerator_5177.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "' outlet is nil\") ;\n"
        "    }\n" ;
      index_5177_.increment () ;
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_5432 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_5432.hasCurrentObject ()) {
      GALGAS_uint index_5461_ (0) ;
      if (enumerator_5432.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_5461 (enumerator_5432.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_5461.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependency *) enumerator_5461.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 116)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 116)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 116)).add_operation (enumerator_5432.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 116)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 116)).stringValue () ;
          result << ")\n" ;
          index_5461_.increment () ;
  ...
  if (in_CONTROLLER_5F_INSTANCIATION_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_5719 (in_CONTROLLER_5F_INSTANCIATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_5719.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_5719.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
  ...
  result << "  //---\n"
    ...
    "  }\n"
    "\n" ;
  GALGAS_uint index_6491_ (0) ;
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_6491 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_6491.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_6491.current_lkey (HERE).reader_string (SOURCE_FILE ("document.swift.gTemplate", 142)), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 142)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 142)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_6491.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  var " ;
      result << enumerator_6491.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_6491.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 145)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_6491.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_6491.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 146)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_6491.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      if (enumerator_6491.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_7156 (enumerator_6491.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_7156.hasCurrentObject ()) {
          result << callCategoryReader_generateForComputeFunction ((const cPtr_abstractTransientDependency *) enumerator_7156.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 151)).stringValue () ;
          if (enumerator_7156.hasNextObject ()) {
            result << ", " ;
          }
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 162)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 162)).add_operation (enumerator_6491.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 162)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 162)).stringValue () ;
      result << "_didChange () {\n"
        "    for anyObject in " ;
      result << enumerator_6491.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers {\n"
      ...
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 179)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 179)).add_operation (enumerator_6491.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 179)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 179)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 179)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 179)).add_operation (enumerator_6491.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 179)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 179)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 180)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 180)).add_operation (enumerator_6491.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 180)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 180)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 180)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 180)).add_operation (enumerator_6491.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 180)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 180)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 181)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 181)).add_operation (enumerator_6491.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 181)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 181)).stringValue () ;
      result << "_cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 182)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 182)).add_operation (enumerator_6491.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 182)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 182)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 182)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 182)).add_operation (enumerator_6491.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 182)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 182)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 184)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 184)).add_operation (enumerator_6491.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 184)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 184)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
