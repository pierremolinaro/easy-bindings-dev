...
//                                         september 16th, 2014, at 15h33'18"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_documentGenerationTemplate_documentImplementationInSwift (C_Compiler * inCompiler,
  ...
  result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
    ...
    "  //-------------------------------------------------------------------------------------------------------------------*\n"
    "\n" ;
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, in_CONTROLLER_5F_INSTANCIATION_5F_LIST.reader_length (SOURCE_FILE ("document.swift.gTemplate", 123)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
  ...
  if (in_OUTLET_5F_GENERATION_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_6676 (in_OUTLET_5F_GENERATION_5F_MAP, kEnumeration_up) ;
    while (enumerator_6676.hasCurrentObject ()) {
      result << "    if nil == " ;
      result << enumerator_6676.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " {\n"
  ...
  GALGAS_uint index_6911_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_6911 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_6911.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6911.current_mControllerName (HERE).stringValue () ;
      result << " = ArrayController_" ;
      result << enumerator_6911.current_mObjectTypeName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_6911.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (\n"
        "      object:rootObject,\n"
        "      tableView:" ;
      result << enumerator_6911.current_mTableViewOutletName (HERE).stringValue () ;
      result << ",\n"
        "      file:__FILE__,\n"
        "      line:__LINE__\n"
        "    )\n" ;
      index_6911_.increment () ;
  ...
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_7223 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_7223.hasCurrentObject ()) {
      GALGAS_uint index_7252_ (0) ;
      if (enumerator_7223.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_7252 (enumerator_7223.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_7252.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_7252.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 151)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 151)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 151)).add_operation (enumerator_7223.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 151)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 151)).stringValue () ;
  ...
  GALGAS_uint index_7525_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_7525 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_7525.hasCurrentObject ()) {
      result << "    rootObject.addObserverOf_" ;
      result << enumerator_7525.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (triggerObjectFor_document_2E_PMDocument_2E_" ;
      result << enumerator_7525.current_mControllerName (HERE).stringValue () ;
      result << ", inTrigger:false)\n" ;
      index_7525_.increment () ;
      enumerator_7525.gotoNextObject () ;
    }
  }
  result << "  //--------------------------- Simple controller\n" ;
  GALGAS_uint index_7765_ (0) ;
  if (in_CONTROLLER_5F_INSTANCIATION_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_7765 (in_CONTROLLER_5F_INSTANCIATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7765.hasCurrentObject ()) {
      result << "    mControllerArray.append (" ;
      result << enumerator_7765.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
      index_7765_.increment () ;
  ...
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_7901 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7901.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7901.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = " ;
      result << enumerator_7901.current_mTargetName (HERE).stringValue () ;
      result << "\n"
        "    " ;
      result << enumerator_7901.current_mOutletName (HERE).stringValue () ;
      result << "\?.action = \"" ;
      result << enumerator_7901.current_mActionName (HERE).stringValue () ;
      result << ":\"\n" ;
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_8613 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_8613.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8613.current_mControllerName (HERE).stringValue () ;
      result << "\?.unregister ()\n" ;
      index_8613_.increment () ;
      enumerator_8613.gotoNextObject () ;
    }
  }
  const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, in_CONTROLLER_5F_INSTANCIATION_5F_LIST.reader_length (SOURCE_FILE ("document.swift.gTemplate", 182)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
  ...
  GALGAS_uint index_8912_ (0) ;
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_8912 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_8912.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8912.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = nil\n" ;
      index_8912_.increment () ;
  ...
  result << "  //---\n"
    ...
    "  }\n"
    "\n" ;
  GALGAS_uint index_9071_ (0) ;
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_9071 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_9071.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_9071.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 201)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 201)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_9071.current_mTransientName (HERE).stringValue () ;
      result << "_observers : [Int : PMTriggerProtocol] = [:]\n"
        "  var " ;
      result << enumerator_9071.current_mTransientName (HERE).stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_9071.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 204)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_9071.current_mTransientName (HERE).stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_9071.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 205)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_9071.current_mTransientName (HERE).stringValue () ;
      ...
      if (enumerator_9071.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_9774 (enumerator_9071.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_9774.hasCurrentObject ()) {
          result << callCategoryReader_generateActualParameterForComputeFunction ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_9774.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 210)).stringValue () ;
          if (enumerator_9774.hasNextObject ()) {
            result << ", " ;
          }
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 219)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 219)).add_operation (enumerator_9071.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 219)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 219)).stringValue () ;
      result << "_noteDidChange () {\n"
        "    " ;
      result << enumerator_9071.current_mTransientName (HERE).stringValue () ;
      result << "_cache = nil\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 223)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 223)).add_operation (enumerator_9071.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 223)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 223)).stringValue () ;
      result << "_trigger () {\n"
        "    for object in " ;
      result << enumerator_9071.current_mTransientName (HERE).stringValue () ;
      ...
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (enumerator_9071.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 243)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (enumerator_9071.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 243)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (enumerator_9071.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 244)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (enumerator_9071.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 244)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 245)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 245)).add_operation (enumerator_9071.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 245)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 245)).stringValue () ;
      result << "_cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (enumerator_9071.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 246)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (enumerator_9071.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 246)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 248)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 248)).add_operation (enumerator_9071.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 248)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 248)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
      index_9071_.increment () ;
