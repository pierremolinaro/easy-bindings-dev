...
//                                         september 10th, 2014, at 19h41'47"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_documentGenerationTemplate_documentImplementationInSwift (C_Compiler * inCompiler,
  ...
  result << "  override func windowControllerDidLoadNib (aController: NSWindowController) {\n"
    ...
    "  //--------------------------- Outlet checking\n" ;
  GALGAS_uint index_6429_ (0) ;
  if (in_OUTLET_5F_GENERATION_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_6429 (in_OUTLET_5F_GENERATION_5F_MAP, kEnumeration_up) ;
    while (enumerator_6429.hasCurrentObject ()) {
      result << "    if nil == " ;
      result << enumerator_6429.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " {\n"
        "      presentErrorWindow (__FILE__, __LINE__, \"the '" ;
      result << enumerator_6429.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "' outlet is nil\") ;\n"
        "    }\n" ;
      index_6429_.increment () ;
      enumerator_6429.gotoNextObject () ;
    }
  }
  result << "  //--------------------------- Transient observers\n" ;
  GALGAS_uint index_6678_ (0) ;
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_6678 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_6678.hasCurrentObject ()) {
      GALGAS_uint index_6707_ (0) ;
      if (enumerator_6678.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_6707 (enumerator_6678.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_6707.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependency *) enumerator_6707.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 141)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 141)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 141)).add_operation (enumerator_6678.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 141)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 141)).stringValue () ;
          result << ")\n" ;
          index_6707_.increment () ;
          enumerator_6707.gotoNextObject () ;
        }
      }
      index_6678_.increment () ;
      enumerator_6678.gotoNextObject () ;
    }
  }
  result << "  //--------------------------- Array controller as observers\n" ;
  GALGAS_uint index_6961_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_6961 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_6961.hasCurrentObject ()) {
      result << "    rootObject.addObserverOf_" ;
      result << enumerator_6961.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (triggerObjectFor_document_2E_PMDocument_2E_" ;
      result << enumerator_6961.current_mControllerName (HERE).stringValue () ;
      result << ")\n" ;
  ...
  GALGAS_uint index_7176_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_7176 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_7176.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7176.current_mControllerName (HERE).stringValue () ;
      result << " = ArrayController_" ;
      result << enumerator_7176.current_mObjectTypeName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_7176.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (\n"
        "      object:rootObject,\n"
        "      tableView:" ;
      result << enumerator_7176.current_mTableViewOutletName (HERE).stringValue () ;
      result << ",\n"
        "      file:__FILE__,\n"
        "      line:__LINE__\n"
        "    )\n" ;
  ...
  if (in_CONTROLLER_5F_INSTANCIATION_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_7481 (in_CONTROLLER_5F_INSTANCIATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7481.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_7481.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
  ...
  GALGAS_uint index_7620_ (0) ;
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_7620 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7620.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7620.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = " ;
      result << enumerator_7620.current_mTargetName (HERE).stringValue () ;
      result << "\n"
        "    " ;
      result << enumerator_7620.current_mOutletName (HERE).stringValue () ;
      result << "\?.action = \"" ;
      result << enumerator_7620.current_mActionName (HERE).stringValue () ;
      result << ":\"\n" ;
      index_7620_.increment () ;
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_8332 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_8332.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8332.current_mControllerName (HERE).stringValue () ;
      result << "\?.unregister ()\n" ;
  ...
  GALGAS_uint index_8693_ (0) ;
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_8693 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_8693.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8693.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = nil\n" ;
      index_8693_.increment () ;
  ...
  result << "  //---\n"
    ...
    "  }\n"
    "\n" ;
  GALGAS_uint index_8851_ (0) ;
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_8851 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_8851.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_8851.current_lkey (HERE).reader_string (SOURCE_FILE ("document.swift.gTemplate", 202)), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 202)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 202)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_8851.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  var " ;
      result << enumerator_8851.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_8851.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 205)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_8851.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_8851.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 206)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_8851.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      result << enumerator_8851.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " (" ;
      GALGAS_uint index_9510_ (0) ;
      if (enumerator_8851.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_9510 (enumerator_8851.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_9510.hasCurrentObject ()) {
          result << callCategoryReader_generateForComputeFunction ((const cPtr_abstractTransientDependency *) enumerator_9510.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 211)).stringValue () ;
          if (enumerator_9510.hasNextObject ()) {
            result << ", " ;
          }
          index_9510_.increment () ;
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 222)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 222)).add_operation (enumerator_8851.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 222)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 222)).stringValue () ;
      result << "_noteDidChange () {\n"
        "    " ;
      result << enumerator_8851.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_cache = nil\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 226)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 226)).add_operation (enumerator_8851.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 226)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 226)).stringValue () ;
      result << "_trigger () {\n"
        "    for anyObject in " ;
      result << enumerator_8851.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers {\n"
      ...
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (enumerator_8851.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 243)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (enumerator_8851.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 243)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (enumerator_8851.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 244)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (enumerator_8851.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 244)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 245)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 245)).add_operation (enumerator_8851.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 245)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 245)).stringValue () ;
      result << "_cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (enumerator_8851.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 246)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (enumerator_8851.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 246)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 248)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 248)).add_operation (enumerator_8851.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 248)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 248)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
      index_8851_.increment () ;
