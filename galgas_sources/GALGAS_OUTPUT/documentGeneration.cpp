...
//                                         september 13th, 2014, at 12h25'37"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_documentGenerationTemplate_documentImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_4422 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_4422.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Array controller: ").add_operation (enumerator_4422.current_mControllerName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 92)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 92)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  \n"
        "  private var " ;
      result << enumerator_4422.current_mControllerName (HERE).stringValue () ;
      result << " : ArrayController_" ;
      result << enumerator_4422.current_mObjectTypeName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_4422.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << "\? = nil\n"
        "\n"
  ...
  result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
    ...
    "  //-------------------------------------------------------------------------------------------------------------------*\n"
    "\n" ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, in_CONTROLLER_5F_INSTANCIATION_5F_LIST.reader_length (SOURCE_FILE ("document.swift.gTemplate", 121)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  if (in_OUTLET_5F_GENERATION_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_6551 (in_OUTLET_5F_GENERATION_5F_MAP, kEnumeration_up) ;
    while (enumerator_6551.hasCurrentObject ()) {
      result << "    if nil == " ;
      result << enumerator_6551.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " {\n"
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_6786 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_6786.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6786.current_mControllerName (HERE).stringValue () ;
      result << " = ArrayController_" ;
      result << enumerator_6786.current_mObjectTypeName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_6786.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (\n"
        "      object:rootObject,\n"
        "      tableView:" ;
      result << enumerator_6786.current_mTableViewOutletName (HERE).stringValue () ;
      result << ",\n"
        "      file:__FILE__,\n"
        "      line:__LINE__\n"
        "    )\n" ;
  ...
  GALGAS_uint index_7098_ (0) ;
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_7098 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_7098.hasCurrentObject ()) {
      GALGAS_uint index_7127_ (0) ;
      if (enumerator_7098.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_7127 (enumerator_7098.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_7127.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_7127.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 149)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 149)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 149)).add_operation (enumerator_7098.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 149)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 149)).stringValue () ;
          result << ", inTrigger:true)\n" ;
          index_7127_.increment () ;
          enumerator_7127.gotoNextObject () ;
        }
      }
      index_7098_.increment () ;
      enumerator_7098.gotoNextObject () ;
    }
  }
  result << "  //--------------------------- Array controller as observers\n" ;
  GALGAS_uint index_7400_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_7400 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_7400.hasCurrentObject ()) {
      result << "    rootObject.addObserverOf_" ;
      result << enumerator_7400.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (triggerObjectFor_document_2E_PMDocument_2E_" ;
      result << enumerator_7400.current_mControllerName (HERE).stringValue () ;
      result << ", inTrigger:true)\n" ;
      index_7400_.increment () ;
      enumerator_7400.gotoNextObject () ;
    }
  }
  result << "  //--------------------------- Simple controller\n" ;
  GALGAS_uint index_7639_ (0) ;
  if (in_CONTROLLER_5F_INSTANCIATION_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_7639 (in_CONTROLLER_5F_INSTANCIATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7639.hasCurrentObject ()) {
      result << "    mControllerArray.append (" ;
      result << enumerator_7639.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
      index_7639_.increment () ;
      enumerator_7639.gotoNextObject () ;
    }
  }
  result << "  //--------------------------- Set targets / actions\n" ;
  GALGAS_uint index_7775_ (0) ;
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_7775 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7775.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7775.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = " ;
      result << enumerator_7775.current_mTargetName (HERE).stringValue () ;
      result << "\n"
        "    " ;
      result << enumerator_7775.current_mOutletName (HERE).stringValue () ;
      result << "\?.action = \"" ;
      result << enumerator_7775.current_mActionName (HERE).stringValue () ;
      result << ":\"\n" ;
      index_7775_.increment () ;
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_8487 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_8487.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8487.current_mControllerName (HERE).stringValue () ;
      result << "\?.unregister ()\n" ;
      index_8487_.increment () ;
      enumerator_8487.gotoNextObject () ;
    }
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, in_CONTROLLER_5F_INSTANCIATION_5F_LIST.reader_length (SOURCE_FILE ("document.swift.gTemplate", 180)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
  ...
  GALGAS_uint index_8786_ (0) ;
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_8786 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_8786.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8786.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = nil\n" ;
      index_8786_.increment () ;
  ...
  result << "  //---\n"
    ...
    "  }\n"
    "\n" ;
  GALGAS_uint index_8945_ (0) ;
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_8945 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_8945.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_8945.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 199)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 199)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_8945.current_mTransientName (HERE).stringValue () ;
      result << "_observers : [Int : PMTriggerProtocol] = [:]\n"
        "  var " ;
      result << enumerator_8945.current_mTransientName (HERE).stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_8945.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 202)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_8945.current_mTransientName (HERE).stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_8945.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 203)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_8945.current_mTransientName (HERE).stringValue () ;
      ...
      result << enumerator_8945.current_mTransientName (HERE).stringValue () ;
      result << " (" ;
      GALGAS_uint index_9648_ (0) ;
      if (enumerator_8945.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_9648 (enumerator_8945.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_9648.hasCurrentObject ()) {
          result << callCategoryReader_generateActualParameterForComputeFunction ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_9648.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 208)).stringValue () ;
          if (enumerator_9648.hasNextObject ()) {
            result << ", " ;
          }
          index_9648_.increment () ;
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 217)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 217)).add_operation (enumerator_8945.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 217)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 217)).stringValue () ;
      result << "_noteDidChange () {\n"
        "    " ;
      result << enumerator_8945.current_mTransientName (HERE).stringValue () ;
      result << "_cache = nil\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 221)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 221)).add_operation (enumerator_8945.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 221)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 221)).stringValue () ;
      result << "_trigger () {\n"
        "    for object in " ;
      result << enumerator_8945.current_mTransientName (HERE).stringValue () ;
      ...
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 241)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 241)).add_operation (enumerator_8945.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 241)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 241)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 241)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 241)).add_operation (enumerator_8945.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 241)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 241)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 242)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 242)).add_operation (enumerator_8945.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 242)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 242)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 242)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 242)).add_operation (enumerator_8945.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 242)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 242)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (enumerator_8945.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 243)).stringValue () ;
      result << "_cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (enumerator_8945.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 244)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (enumerator_8945.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 244)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (enumerator_8945.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 246)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
      index_8945_.increment () ;
