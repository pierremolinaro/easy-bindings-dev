...
GALGAS_string filewrapperTemplate_documentGenerationTemplate_documentImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (in_CONTROLLER_5F_INSTANCIATION_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_5909 (in_CONTROLLER_5F_INSTANCIATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_5909.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_5909.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
  ...
  GALGAS_uint index_6047_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_6047 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_6047.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6047.current_mControllerName (HERE).stringValue () ;
      result << " = ArrayController_" ;
      result << enumerator_6047.current_mObjectTypeName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_6047.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_6047.current_mTableViewOutletName (HERE).stringValue () ;
      result << " (\n"
        "      object:rootObject,\n"
        "      tableView:" ;
      result << enumerator_6047.current_mTableViewOutletName (HERE).stringValue () ;
  ...
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_6369 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_6369.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6369.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = " ;
      result << enumerator_6369.current_mTargetName (HERE).stringValue () ;
      result << "\n"
        "    " ;
      result << enumerator_6369.current_mOutletName (HERE).stringValue () ;
      result << "\?.action = \"" ;
      result << enumerator_6369.current_mActionName (HERE).stringValue () ;
      result << ":\"\n" ;
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_7081 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_7081.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7081.current_mControllerName (HERE).stringValue () ;
      result << "\?.unregister ()\n" ;
      index_7081_.increment () ;
      enumerator_7081.gotoNextObject () ;
    }
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, in_CONTROLLER_5F_INSTANCIATION_5F_LIST.reader_length (SOURCE_FILE ("document.swift.gTemplate", 154)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
  ...
  GALGAS_uint index_7442_ (0) ;
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_7442 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7442.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7442.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = nil\n" ;
      index_7442_.increment () ;
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_7600 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_7600.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_7600.current_lkey (HERE).reader_string (SOURCE_FILE ("document.swift.gTemplate", 174)), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 174)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 174)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_7600.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  var " ;
      result << enumerator_7600.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_7600.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 177)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_7600.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_7600.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 178)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_7600.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      result << enumerator_7600.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " (" ;
      GALGAS_uint index_8259_ (0) ;
      if (enumerator_7600.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_8259 (enumerator_7600.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_8259.hasCurrentObject ()) {
          result << callCategoryReader_generateForComputeFunction ((const cPtr_abstractTransientDependency *) enumerator_8259.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 183)).stringValue () ;
          if (enumerator_8259.hasNextObject ()) {
            result << ", " ;
          }
          index_8259_.increment () ;
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 194)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 194)).add_operation (enumerator_7600.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 194)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 194)).stringValue () ;
      result << "_didChange () {\n"
        "    for anyObject in " ;
      result << enumerator_7600.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers {\n"
      ...
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 211)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 211)).add_operation (enumerator_7600.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 211)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 211)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 211)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 211)).add_operation (enumerator_7600.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 211)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 211)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).add_operation (enumerator_7600.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 212)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).add_operation (enumerator_7600.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 212)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 213)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 213)).add_operation (enumerator_7600.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 213)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 213)).stringValue () ;
      result << "_cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 214)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 214)).add_operation (enumerator_7600.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 214)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 214)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 214)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 214)).add_operation (enumerator_7600.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 214)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 214)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 216)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 216)).add_operation (enumerator_7600.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 216)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 216)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
