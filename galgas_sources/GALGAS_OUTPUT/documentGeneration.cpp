...
//                                         september 12th, 2014, at 18h36'6"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_documentGenerationTemplate_documentImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_3967 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_3967.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Array controller: ").add_operation (enumerator_3967.current_mControllerName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 86)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 86)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  \n"
        "  private var " ;
      result << enumerator_3967.current_mControllerName (HERE).stringValue () ;
      result << " : ArrayController_" ;
      result << enumerator_3967.current_mObjectTypeName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_3967.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << "\? = nil\n"
        "\n"
  ...
  result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
    ...
    "  //-------------------------------------------------------------------------------------------------------------------*\n"
    "\n" ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, in_CONTROLLER_5F_INSTANCIATION_5F_LIST.reader_length (SOURCE_FILE ("document.swift.gTemplate", 115)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
  ...
  result << "  override func windowControllerDidLoadNib (aController: NSWindowController) {\n"
    ...
    "  //--------------------------- Outlet checking\n" ;
  GALGAS_uint index_6089_ (0) ;
  if (in_OUTLET_5F_GENERATION_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_6089 (in_OUTLET_5F_GENERATION_5F_MAP, kEnumeration_up) ;
    while (enumerator_6089.hasCurrentObject ()) {
      result << "    if nil == " ;
      result << enumerator_6089.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " {\n"
        "      presentErrorWindow (__FILE__, __LINE__, \"the '" ;
      result << enumerator_6089.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "' outlet is nil\") ;\n"
        "    }\n" ;
      index_6089_.increment () ;
      enumerator_6089.gotoNextObject () ;
    }
  }
  result << "  //--------------------------- Array controller\n" ;
  GALGAS_uint index_6324_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_6324 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_6324.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6324.current_mControllerName (HERE).stringValue () ;
      result << " = ArrayController_" ;
      result << enumerator_6324.current_mObjectTypeName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_6324.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (\n"
        "      object:rootObject,\n"
        "      tableView:" ;
      result << enumerator_6324.current_mTableViewOutletName (HERE).stringValue () ;
      result << ",\n"
        "      file:__FILE__,\n"
        "      line:__LINE__\n"
        "    )\n" ;
      index_6324_.increment () ;
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_6635 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_6635.hasCurrentObject ()) {
      GALGAS_uint index_6664_ (0) ;
      if (enumerator_6635.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_6664 (enumerator_6635.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_6664.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependency *) enumerator_6664.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 143)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 143)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 143)).add_operation (enumerator_6635.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 143)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 143)).stringValue () ;
  ...
  if (in_CONTROLLER_5F_INSTANCIATION_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_7173 (in_CONTROLLER_5F_INSTANCIATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7173.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_7173.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
  ...
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_7312 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7312.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7312.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = " ;
      result << enumerator_7312.current_mTargetName (HERE).stringValue () ;
      result << "\n"
        "    " ;
      result << enumerator_7312.current_mOutletName (HERE).stringValue () ;
      result << "\?.action = \"" ;
      result << enumerator_7312.current_mActionName (HERE).stringValue () ;
      result << ":\"\n" ;
  ...
  result << "  //--------------------------- Update display\n"
    ...
    "  //--------------------------- Remove controllers\n" ;
  GALGAS_uint index_8024_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_8024 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_8024.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8024.current_mControllerName (HERE).stringValue () ;
      result << "\?.unregister ()\n" ;
      index_8024_.increment () ;
      enumerator_8024.gotoNextObject () ;
    }
  }
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, in_CONTROLLER_5F_INSTANCIATION_5F_LIST.reader_length (SOURCE_FILE ("document.swift.gTemplate", 174)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
  ...
  GALGAS_uint index_8385_ (0) ;
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_8385 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_8385.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8385.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = nil\n" ;
  ...
  result << "  //---\n"
    ...
    "  }\n"
    "\n" ;
  GALGAS_uint index_8543_ (0) ;
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_8543 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_8543.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_8543.current_lkey (HERE).reader_string (SOURCE_FILE ("document.swift.gTemplate", 194)), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 194)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 194)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_8543.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  var " ;
      result << enumerator_8543.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_8543.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 197)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_8543.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_8543.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 198)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_8543.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      result << enumerator_8543.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " (" ;
      GALGAS_uint index_9202_ (0) ;
      if (enumerator_8543.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_9202 (enumerator_8543.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_9202.hasCurrentObject ()) {
          result << callCategoryReader_generateForComputeFunction ((const cPtr_abstractTransientDependency *) enumerator_9202.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 203)).stringValue () ;
          if (enumerator_9202.hasNextObject ()) {
            result << ", " ;
          }
          index_9202_.increment () ;
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).add_operation (enumerator_8543.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 212)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 212)).stringValue () ;
      result << "_noteDidChange () {\n"
        "    " ;
      result << enumerator_8543.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_cache = nil\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 216)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 216)).add_operation (enumerator_8543.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 216)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 216)).stringValue () ;
      result << "_trigger () {\n"
        "    for anyObject in " ;
      result << enumerator_8543.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers {\n"
      ...
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).add_operation (enumerator_8543.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 237)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).add_operation (enumerator_8543.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 237)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 237)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 238)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 238)).add_operation (enumerator_8543.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 238)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 238)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 238)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 238)).add_operation (enumerator_8543.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 238)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 238)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 239)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 239)).add_operation (enumerator_8543.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 239)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 239)).stringValue () ;
      result << "_cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 240)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 240)).add_operation (enumerator_8543.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 240)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 240)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 240)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 240)).add_operation (enumerator_8543.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 240)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 240)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 242)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 242)).add_operation (enumerator_8543.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 242)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 242)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
