...
GALGAS_string filewrapperTemplate_documentGenerationTemplate_documentImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_4607 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_4607.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Array controller: ").add_operation (enumerator_4607.current_mControllerName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 95)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 95)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  \n"
        "  private var " ;
      result << enumerator_4607.current_mControllerName (HERE).stringValue () ;
      result << " : ArrayController_" ;
      result << enumerator_4607.current_mObjectTypeName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_4607.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << "\? = nil\n"
        "\n"
      ...
      result << "\?.arrayModelSizeDidChange ()\n"
        "  }\n"
        "\n"
        "  private var event_document_2E_PMDocument_2E_" ;
      result << enumerator_4607.current_mControllerName (HERE).stringValue () ;
      result << "_cache : PMEvent_document_2E_PMDocument_2E_" ;
      result << enumerator_4607.current_mControllerName (HERE).stringValue () ;
      result << "\?\n"
        "  private var event_document_2E_PMDocument_2E_" ;
      result << enumerator_4607.current_mControllerName (HERE).stringValue () ;
      ...
      result << " {\n"
        "    get {\n"
        "      if event_document_2E_PMDocument_2E_" ;
      result << enumerator_4607.current_mControllerName (HERE).stringValue () ;
      result << "_cache == nil {\n"
        "        event_document_2E_PMDocument_2E_" ;
      result << enumerator_4607.current_mControllerName (HERE).stringValue () ;
      result << "_cache = PMEvent_document_2E_PMDocument_2E_" ;
      result << enumerator_4607.current_mControllerName (HERE).stringValue () ;
      result << " (object:self)\n"
        "      }\n"
        "      return event_document_2E_PMDocument_2E_" ;
      result << enumerator_4607.current_mControllerName (HERE).stringValue () ;
      result << "_cache!\n"
        "    }\n"
        "  }\n"
  ...
  result << "  override func windowControllerDidLoadNib (aController: NSWindowController) {\n"
    ...
    "  //--------------------------- Outlet checking\n" ;
  GALGAS_uint index_6631_ (0) ;
  if (in_OUTLET_5F_GENERATION_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_6631 (in_OUTLET_5F_GENERATION_5F_MAP, kEnumeration_up) ;
    while (enumerator_6631.hasCurrentObject ()) {
      result << "    if nil == " ;
      result << enumerator_6631.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " {\n"
        "      presentErrorWindow (__FILE__, __LINE__, \"the '" ;
      result << enumerator_6631.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "' outlet is nil\") ;\n"
        "    }\n" ;
      index_6631_.increment () ;
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_6866 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_6866.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6866.current_mControllerName (HERE).stringValue () ;
      result << " = ArrayController_" ;
      result << enumerator_6866.current_mObjectTypeName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_6866.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (\n"
        "      object:rootObject,\n"
        "      tableView:" ;
      result << enumerator_6866.current_mTableViewOutletName (HERE).stringValue () ;
      result << ",\n"
        "      file:__FILE__,\n"
        "      line:__LINE__\n"
        "    )\n" ;
  ...
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_7178 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_7178.hasCurrentObject ()) {
      GALGAS_uint index_7207_ (0) ;
      if (enumerator_7178.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_7207 (enumerator_7178.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_7207.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_7207.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 151)).stringValue () ;
          result << " (event_" ;
          result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 151)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 151)).add_operation (enumerator_7178.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 151)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 151)).stringValue () ;
          result << ", inTrigger:true)\n" ;
          index_7207_.increment () ;
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_7469 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_7469.hasCurrentObject ()) {
      result << "    rootObject.addObserverOf_" ;
      result << enumerator_7469.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (event_document_2E_PMDocument_2E_" ;
      result << enumerator_7469.current_mControllerName (HERE).stringValue () ;
  ...
  if (in_CONTROLLER_5F_INSTANCIATION_5F_LIST.isValid ()) {
    cEnumerator_stringlist enumerator_7698 (in_CONTROLLER_5F_INSTANCIATION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7698.hasCurrentObject ()) {
      result << "    mControllerArray.append (" ;
      result << enumerator_7698.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
  ...
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_7834 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_7834.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_7834.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = " ;
      result << enumerator_7834.current_mTargetName (HERE).stringValue () ;
      result << "\n"
        "    " ;
      result << enumerator_7834.current_mOutletName (HERE).stringValue () ;
      result << "\?.action = \"" ;
      result << enumerator_7834.current_mActionName (HERE).stringValue () ;
      result << ":\"\n" ;
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_8546 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_8546.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8546.current_mControllerName (HERE).stringValue () ;
      result << "\?.unregister ()\n" ;
  ...
  if (in_TARGET_5F_ACTION_5F_LIST.isValid ()) {
    cEnumerator_targetActionList enumerator_8845 (in_TARGET_5F_ACTION_5F_LIST, kEnumeration_up) ;
    while (enumerator_8845.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_8845.current_mOutletName (HERE).stringValue () ;
      result << "\?.target = nil\n" ;
  ...
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_9004 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_9004.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_9004.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 201)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("document.swift.gTemplate", 201)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_9004.current_mTransientName (HERE).stringValue () ;
      result << "_observers : [Int : PMTransientEventProtocol] = [:]\n"
        "  var " ;
      result << enumerator_9004.current_mTransientName (HERE).stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_9004.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 204)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_9004.current_mTransientName (HERE).stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_9004.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 205)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_9004.current_mTransientName (HERE).stringValue () ;
      ...
      result << enumerator_9004.current_mTransientName (HERE).stringValue () ;
      result << " (" ;
      GALGAS_uint index_9714_ (0) ;
      if (enumerator_9004.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_9714 (enumerator_9004.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_9714.hasCurrentObject ()) {
          result << callCategoryReader_generateActualParameterForComputeFunction ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_9714.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 210)).stringValue () ;
          if (enumerator_9714.hasNextObject ()) {
            result << ", " ;
          }
          index_9714_.increment () ;
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 219)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 219)).add_operation (enumerator_9004.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 219)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 219)).stringValue () ;
      result << "_noteDidChange () {\n"
        "    " ;
      result << enumerator_9004.current_mTransientName (HERE).stringValue () ;
      result << "_cache = nil\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 223)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 223)).add_operation (enumerator_9004.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 223)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 223)).stringValue () ;
      result << "_trigger () {\n"
        "    for object in " ;
      result << enumerator_9004.current_mTransientName (HERE).stringValue () ;
      ...
      result << "_observers [inObserver.uniqueIndex] = nil\n"
        ...
        "\n"
        "  var event_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (enumerator_9004.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 243)).stringValue () ;
      result << "_cache : PMEvent_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).add_operation (enumerator_9004.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 243)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 243)).stringValue () ;
      result << "\? = nil\n"
        "  var event_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (enumerator_9004.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 244)).stringValue () ;
      result << " : PMEvent_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).add_operation (enumerator_9004.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 244)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 244)).stringValue () ;
      result << " {\n"
        "    if event_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 245)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 245)).add_operation (enumerator_9004.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 245)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 245)).stringValue () ;
      result << "_cache == nil {\n"
        "      event_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (enumerator_9004.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 246)).stringValue () ;
      result << "_cache = PMEvent_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).add_operation (enumerator_9004.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 246)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 246)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return event_" ;
      result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 248)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 248)).add_operation (enumerator_9004.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 248)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 248)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
