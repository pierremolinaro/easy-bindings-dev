...
//                                         september 10th, 2014, at 20h22'21"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_documentGenerationTemplate_documentImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_6664 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_6664.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_6664.current_mControllerName (HERE).stringValue () ;
      result << " = ArrayController_" ;
      result << enumerator_6664.current_mObjectTypeName (HERE).stringValue () ;
      result << "_" ;
      result << enumerator_6664.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (\n"
        "      object:rootObject,\n"
        "      tableView:" ;
      result << enumerator_6664.current_mTableViewOutletName (HERE).stringValue () ;
      result << ",\n"
        "      file:__FILE__,\n"
        "      line:__LINE__\n"
        "    )\n" ;
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_6975 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_6975.hasCurrentObject ()) {
      GALGAS_uint index_7004_ (0) ;
      if (enumerator_6975.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_7004 (enumerator_6975.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_7004.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependency *) enumerator_7004.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 151)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("document.").add_operation (in_DOCUMENT_5F_NAME, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 151)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 151)).add_operation (enumerator_6975.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("document.swift.gTemplate", 151)).reader_identifierRepresentation (SOURCE_FILE ("document.swift.gTemplate", 151)).stringValue () ;
          result << ")\n" ;
  ...
  GALGAS_uint index_7258_ (0) ;
  if (in_ARRAY_5F_CONTROLLER_5F_LIST.isValid ()) {
    cEnumerator_arrayControllerForGeneration enumerator_7258 (in_ARRAY_5F_CONTROLLER_5F_LIST, kEnumeration_up) ;
    while (enumerator_7258.hasCurrentObject ()) {
      result << "    rootObject.addObserverOf_" ;
      result << enumerator_7258.current_mTomanyRelationshipName (HERE).stringValue () ;
      result << " (triggerObjectFor_document_2E_PMDocument_2E_" ;
      result << enumerator_7258.current_mControllerName (HERE).stringValue () ;
      result << ")\n" ;
      index_7258_.increment () ;
