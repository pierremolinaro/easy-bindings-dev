...
cCollectionElement * cCollectionElement_attributeListForImplementation::copy (void) {
  ...
  macroMyNew (result, cCollectionElement_attributeListForImplementation (mAttribute_mType, mAttribute_mPropertyName, mAttribute_mDefaultValueAsObjectiveCObject, mAttribute_mDirectDefaultValue COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_attributeListForImplementation::modifier_popFirst (GALGAS_easyBindingType & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand3 = p->mAttribute_mDirectDefaultValue ;
  }
}
...
cCollectionElement * cCollectionElement_outletBindingListForGeneration::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_outletBindingListForGeneration (mAttribute_mBindingName, mAttribute_mRequiredFormatter, mAttribute_mObservedObjectName, mAttribute_mObservableAttributeName, mAttribute_mOutletBindingOptionList COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_outletBindingListForGeneration::modifier_popFirst (GALGAS_string & outOperand0,
  ...
  if (NULL == p) {
    ...
    outOperand2 = p->mAttribute_mObservedObjectName ;
    outOperand3 = p->mAttribute_mObservableAttributeName ;
    outOperand4 = p->mAttribute_mOutletBindingOptionList ;
  }
}
