...
//                    december 11th, 2012, at 20h37'30"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_analyzePreference (const GALGAS_preferencesDeclarationList_2E_element constinArgument_inPreference,
  ...
  while (enumerator_44298.hasCurrentObject ()) {
    ...
    GALGAS_attributeListForImplementation joker_44417_5 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_44417_4 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_44417_3 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_44417_2 ; // Joker input parameter
    GALGAS_stringset joker_44417_1 ; // Joker input parameter
    constinArgument_inClassMap.method_searchKey (enumerator_44298.current_mClassName (HERE), joker_44351_0, var_classObservablePropertyMap, joker_44417_5, joker_44417_4, joker_44417_3, joker_44417_2, joker_44417_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1137)) ;
    //-------- END @methodCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_preferenceArrayMap.modifier_insertKey (enumerator_44298.current_mArrayName (HERE), enumerator_44298.current_mClassName (HERE).mAttribute_string, var_classObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1143)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_44298.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1150)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1151)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerList enumerator_44783 (constinArgument_inPreference.mAttribute_mControllerList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_44783.hasCurrentObject ()) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_44856_0 ; // Joker input parameter
    constinArgument_inControllerClassMap.method_searchKey (enumerator_44783.current_mControllerClassName (HERE), joker_44856_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1153)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_45079_7 ; // Joker input parameter
    GALGAS_observablePropertyMap joker_45079_6 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_45079_5 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_45079_4 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_45079_3 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_45079_2 ; // Joker input parameter
    GALGAS_stringset joker_45079_1 ; // Joker input parameter
    constinArgument_inClassMap.method_searchKey (enumerator_44783.current_mControlledClassOrEntityName (HERE), joker_45079_7, joker_45079_6, joker_45079_5, joker_45079_4, joker_45079_3, joker_45079_2, joker_45079_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1160)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1161)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_45196 (enumerator_44783.current_mControllerBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_45196.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_45196.current_mBinding (HERE).ptr (), GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1164)), var_preferenceArrayMap, var_controllerClassBindingMap, enumerator_44783.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1163)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_45196.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_controllerMap.modifier_insertKey (enumerator_44783.current_mControllerName (HERE), enumerator_44783.current_mControllerClassName (HERE).mAttribute_string, enumerator_44783.current_mControlledClassOrEntityName (HERE).mAttribute_string, GALGAS_bool (false), var_bindingListForGeneration, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1172)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1184)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeTransientProperties (GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1186)), GALGAS_string ("preference.").operator_concat (constinArgument_inPreference.mAttribute_mPreferencesName.reader_string (SOURCE_FILE_AT_LINE (1187)) COMMA_SOURCE_FILE_AT_LINE (1187)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1187)), constinArgument_inPreference.mAttribute_mTransientList, GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1189)), GALGAS_string::makeEmptyString (), GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1191)), var_observableAttributeMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1185)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1198)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletDeclarationList enumerator_46536 (constinArgument_inPreference.mAttribute_mOutletDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_46536.hasCurrentObject ()) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_46634_2 ; // Joker input parameter
    GALGAS_lstringlist joker_46634_1 ; // Joker input parameter
    constinArgument_inOutletClassMap.method_searchKey (enumerator_46536.current_mOutletType (HERE), var_generationKind, joker_46634_2, joker_46634_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1200)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_generationKind.objectCompare (GALGAS_generationKind::constructor_noGeneration (SOURCE_FILE_AT_LINE (1207)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @plusEqualnstructionForGeneration
      var_implementationFileInclusionSet.addAssign_operation (enumerator_46536.current_mOutletType (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1208)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1210)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_46957 (enumerator_46536.current_mOutletBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_46957.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_46957.current_mBinding (HERE).ptr (), GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1213)), var_observableAttributeMap, GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1215)), GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1216)), constinArgument_inClassMap, var_bindingMap, var_controllerMap, var_actionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1212)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_46957.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_outletGenerationList.addAssign_operation (enumerator_46536.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1226)), var_generationKind, enumerator_46536.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1226)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1226)) ;
    enumerator_46536.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1229)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
...
void routine_analyzePreferences (const GALGAS_preferencesDeclarationList constinArgument_inPreferencesList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1253)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_48381 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_48381.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzePreference (enumerator_48381.current (HERE), constinArgument_inControllerClassMap, constinArgument_inClassMap, constinArgument_inOutletClassMap, outArgument_outPreferencesMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1255)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_48381.gotoNextObject () ;
  }
}
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outBindingOptionListForGeneration = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1273)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_48966 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_48966.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_48966.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1276)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_49155 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1278)).isValidAndTrue () ;
    if (enumerator_49155.hasCurrentObject () && bool_0) {
      while (enumerator_49155.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_49219 (enumerator_48966.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1279)).isValidAndTrue () ;
        if (enumerator_49219.hasCurrentObject () && bool_1) {
          while (enumerator_49219.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_49155.current_mType (HERE).objectCompare (enumerator_49219.current_mType (HERE))) ;
            enumerator_49219.gotoNextObject () ;
            if (enumerator_49219.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1279)).isValidAndTrue () ;
            }
          }
        }
        enumerator_49155.gotoNextObject () ;
        if (enumerator_49155.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1278)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (1283)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_49458 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (1285)).isValidAndTrue () ;
      if (enumerator_49458.hasCurrentObject () && bool_3) {
        while (enumerator_49458.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_49458.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1286)) COMMA_SOURCE_FILE_AT_LINE (1286)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1286)) COMMA_SOURCE_FILE_AT_LINE (1286)) ;
          enumerator_49458.gotoNextObject () ;
          if (enumerator_49458.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (1285)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_48966.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (1288)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_48966.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (1290)), enumerator_48966.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (1290)) ;
...
void routine_analyzeDocument (const GALGAS_documentDeclarationList_2E_element constinArgument_inDocument,
  ...
  GALGAS_relationshipMap var_allRelationshipMap ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_58684_0 ; // Joker input parameter
  GALGAS_string joker_58738_0 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_58805_8 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_58805_7 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_58805_6 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_58805_5 ; // Joker input parameter
  GALGAS_relationshipList joker_58805_4 ; // Joker input parameter
  GALGAS_relationshipList joker_58805_3 ; // Joker input parameter
  GALGAS_propertyMap joker_58805_2 ; // Joker input parameter
  GALGAS_relationshipMap joker_58805_1 ; // Joker input parameter
  GALGAS_stringset joker_58854_2 ; // Joker input parameter
  GALGAS__32_stringlist joker_58854_1 ; // Joker input parameter
  constinArgument_inEntityMap.method_searchKey (constinArgument_inDocument.mAttribute_mRootEntityName, joker_58684_0, var_rootEntityImplementationClassName, joker_58738_0, var_rootObjectObservablePropertyMap, joker_58805_8, joker_58805_7, joker_58805_6, joker_58805_5, joker_58805_4, joker_58805_3, joker_58805_2, joker_58805_1, var_allRelationshipMap, joker_58854_2, joker_58854_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1501)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1512)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1513)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerList enumerator_59078 (constinArgument_inDocument.mAttribute_mControllerList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_59078.hasCurrentObject ()) {
    ...
    GALGAS_observablePropertyMap var_controllerObservablePropertyMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_59304_0 ; // Joker input parameter
    constinArgument_inControllerClassMap.method_searchKey (enumerator_59078.current_mControllerClassName (HERE), joker_59304_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1518)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_59472_15 ; // Joker input parameter
    GALGAS_string joker_59472_14 ; // Joker input parameter
    GALGAS_string joker_59472_13 ; // Joker input parameter
    GALGAS_observablePropertyMap joker_59472_12 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_59472_11 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_59472_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_59472_9 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_59472_8 ; // Joker input parameter
    GALGAS_relationshipList joker_59472_7 ; // Joker input parameter
    GALGAS_relationshipList joker_59472_6 ; // Joker input parameter
    GALGAS_propertyMap joker_59472_5 ; // Joker input parameter
    GALGAS_relationshipMap joker_59472_4 ; // Joker input parameter
    GALGAS_relationshipMap joker_59472_3 ; // Joker input parameter
    GALGAS_stringset joker_59472_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_59472_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_59078.current_mControlledClassOrEntityName (HERE), joker_59472_15, joker_59472_14, joker_59472_13, joker_59472_12, joker_59472_11, joker_59472_10, joker_59472_9, joker_59472_8, joker_59472_7, joker_59472_6, joker_59472_5, joker_59472_4, joker_59472_3, joker_59472_2, joker_59472_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1525)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1526)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_59589 (enumerator_59078.current_mControllerBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_59589.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_59589.current_mBinding (HERE).ptr (), var_allRelationshipMap, GALGAS_preferenceArrayMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1530)), var_controllerClassBindingMap, enumerator_59078.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1528)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_59589.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_controllerMap.modifier_insertKey (enumerator_59078.current_mControllerName (HERE), enumerator_59078.current_mControllerClassName (HERE).mAttribute_string, enumerator_59078.current_mControlledClassOrEntityName (HERE).mAttribute_string, GALGAS_bool (true), var_bindingListForGeneration, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1537)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1549)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeTransientProperties (constinArgument_inPreferencesMap, GALGAS_string ("document.").operator_concat (constinArgument_inDocument.mAttribute_mDocumentName.reader_string (SOURCE_FILE_AT_LINE (1552)) COMMA_SOURCE_FILE_AT_LINE (1552)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1552)), constinArgument_inDocument.mAttribute_mTransientList, var_rootObjectObservablePropertyMap, constinArgument_inDocument.mAttribute_mRootEntityName.mAttribute_string, var_controllerMap, var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1550)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_actionMap var_documentActionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1563)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_60893 (constinArgument_inDocument.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_60893.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_documentActionMap.modifier_insertKey (enumerator_60893.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1565)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_60893.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1568)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletDeclarationList enumerator_61152 (constinArgument_inDocument.mAttribute_mOutletDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_61152.hasCurrentObject ()) {
    ...
    GALGAS_bool var_hasTableValueBinding ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_61250_2 ; // Joker input parameter
    GALGAS_lstringlist joker_61250_1 ; // Joker input parameter
    constinArgument_inOutletClassMap.method_searchKey (enumerator_61152.current_mOutletType (HERE), var_generationKind, joker_61250_2, joker_61250_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1570)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1577)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_61436 (enumerator_61152.current_mOutletBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_61436.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_61436.current_mBinding (HERE).ptr (), var_rootObjectObservablePropertyMap, var_observablePropertyMap, constinArgument_inPreferencesMap, constinArgument_inEntityMap, GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1584)), var_bindingMap, var_controllerMap, var_documentActionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1579)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_61436.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_outletGenerationList.addAssign_operation (enumerator_61152.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1593)), var_generationKind, enumerator_61152.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1593)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1593)) ;
    enumerator_61152.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1596)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioDocumentMap.modifier_insertKey (constinArgument_inDocument.mAttribute_mDocumentName, constinArgument_inDocument.mAttribute_mRootEntityName.mAttribute_string, var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, constinArgument_inDocument.mAttribute_mActionDeclarationList, var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1597)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1620)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_62885 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_62885.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeDocument (enumerator_62885.current (HERE), constinArgument_inOutletClassMap, constinArgument_inControllerClassMap, constinArgument_inEntityMap, constinArgument_inPreferencesMap, outArgument_outDocumentMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1622)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_62885.gotoNextObject () ;
  }
}
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_63449 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1642)).isValidAndTrue () ;
  if (enumerator_63449.hasCurrentObject () && bool_0) {
    while (enumerator_63449.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_63449.current_mType (HERE))) ;
      enumerator_63449.gotoNextObject () ;
      if (enumerator_63449.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1642)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1645)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (1646)) ;
  }
}
...
void routine_analyzeClass (const GALGAS_classList_2E_element constinArgument_inClass,
  ...
  GALGAS_observablePropertyMap var_observablePropertyMap ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1659)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, constinArgument_inClass.mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (1660)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_64152_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_64211_4 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_64211_3 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_64211_2 ; // Joker input parameter
    GALGAS_stringset joker_64211_1 ; // Joker input parameter
    ioArgument_ioClassMap.method_searchKey (constinArgument_inClass.mAttribute_mSuperClassName, joker_64152_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_64211_4, joker_64211_3, joker_64211_2, joker_64211_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1661)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @assignmentInstructionForGeneration
    var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1663)) ;
    //-------- @assignmentInstructionForGeneration
    var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1664)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1667)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeList enumerator_64671 (constinArgument_inClass.mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_64671.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_checkDefaultValueType (enumerator_64671.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_64671.current_mType (HERE), enumerator_64671.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1670)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_attributeListForImplementation.addAssign_operation (enumerator_64671.current_mType (HERE), enumerator_64671.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1671)), enumerator_64671.current_mDefaultValueObjectiveCObject (HERE), enumerator_64671.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1671)) ;
    //-------- @plusEqualnstructionForGeneration
    var_propertyListForInitMethodHeader.addAssign_operation (enumerator_64671.current_mType (HERE), enumerator_64671.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1672)), enumerator_64671.current_mDefaultValueObjectiveCObject (HERE), enumerator_64671.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1672)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("class.").operator_concat (constinArgument_inClass.mAttribute_mClassName.reader_string (SOURCE_FILE_AT_LINE (1674)) COMMA_SOURCE_FILE_AT_LINE (1674)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1674)).operator_concat (enumerator_64671.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1674)) COMMA_SOURCE_FILE_AT_LINE (1674)), enumerator_64671.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1673)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_64671.current_mAttributeName (HERE), enumerator_64671.current_mType (HERE), GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1677)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1683)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_64671.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1690)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeTransientProperties (GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1692)), GALGAS_string ("class.").operator_concat (constinArgument_inClass.mAttribute_mClassName.reader_string (SOURCE_FILE_AT_LINE (1693)) COMMA_SOURCE_FILE_AT_LINE (1693)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1693)), constinArgument_inClass.mAttribute_mTransientList, GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1695)), GALGAS_string::makeEmptyString (), GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1697)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1691)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1704)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1724)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_66741 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_66741.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeClass (enumerator_66741.current (HERE), outArgument_outClassMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1726)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_66741.gotoNextObject () ;
  }
}
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1741)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_67167 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_67167.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1744)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_67264 (enumerator_67167.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_67264.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1746)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_67376 (enumerator_67264.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_67376.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_67376.current_mBindingOptionName (HERE), enumerator_67376.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1748)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_67376.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_67264.current_mBindingName (HERE), enumerator_67264.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1750)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_67264.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_67674 (enumerator_67167.current_mAdoptedProtocolList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_67674.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      constinArgument_inProtocolMap.method_searchKey (enumerator_67674.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1754)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_67674.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_67167.current_mOutletClassName (HERE), enumerator_67167.current_mGeneration (HERE), enumerator_67167.current_mSuperClassName (HERE).mAttribute_string, enumerator_67167.current_mAdoptedProtocolList (HERE), var_bindingMap, enumerator_67167.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1757)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeControllerClass (const GALGAS_controllerClassList_2E_element constinArgument_inController,
                                     ...
                                     COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1776)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_68348 (constinArgument_inController.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_68348.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_actionMap.modifier_insertKey (enumerator_68348.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1778)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_68348.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1781)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassBindingList enumerator_68504 (constinArgument_inController.mAttribute_mBindingList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_68504.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1783)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingOptionList enumerator_68612 (enumerator_68504.current_mBindingOptionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_68612.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_outletClassBindingOptionMap.modifier_insertKey (enumerator_68612.current_mBindingOptionName (HERE), enumerator_68612.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1785)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_68612.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_bindingMap.modifier_insertKey (enumerator_68504.current_mBindingName (HERE), enumerator_68504.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1791)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_68504.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1794)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerObservablePropertyList enumerator_69058 (constinArgument_inController.mAttribute_mControllerObservablePropertyList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_69058.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("controller.").operator_concat (constinArgument_inController.mAttribute_mControllerClassName.reader_string (SOURCE_FILE_AT_LINE (1797)) COMMA_SOURCE_FILE_AT_LINE (1797)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1797)).operator_concat (enumerator_69058.current (HERE).mAttribute_mPropertyName.reader_string (SOURCE_FILE_AT_LINE (1797)) COMMA_SOURCE_FILE_AT_LINE (1797)), enumerator_69058.current (HERE).mAttribute_mPropertyName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1796)) ;
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1800)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_69058.current (HERE).mAttribute_mPropertyName, enumerator_69058.current (HERE).mAttribute_mType, GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1804)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_69058.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioControllerClassMap.modifier_insertKey (constinArgument_inController.mAttribute_mControllerClassName, constinArgument_inController.mAttribute_mGenerateCode, var_bindingMap, var_actionMap, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1812)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1828)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_70121 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_70121.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeControllerClass (enumerator_70121.current (HERE), ioArgument_ioTransientDependencyGraph, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1830)) ;
    } //-------- @routineCallInstructionForGeneration
...
void routine_semanticAnalysis (const GALGAS_cursorList constinArgument_inCursorList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outCursorMap = GALGAS_userCursorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1863)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_cursorList enumerator_71197 (constinArgument_inCursorList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_71197.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outCursorMap.modifier_insertKey (enumerator_71197.current_mCursorName (HERE), enumerator_71197.current_mHotSpotX (HERE).mAttribute_double, enumerator_71197.current_mHotSpotY (HERE).mAttribute_double, inCompiler COMMA_SOURCE_FILE_AT_LINE (1865)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_71197.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outPredefinedCursorList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1867)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outPredefinedCursorList.addAssign_operation (GALGAS_string ("arrowCursor") COMMA_SOURCE_FILE_AT_LINE (1868)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outPredefinedCursorList.addAssign_operation (GALGAS_string ("IBeamCursor") COMMA_SOURCE_FILE_AT_LINE (1869)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outPredefinedCursorList.addAssign_operation (GALGAS_string ("crosshairCursor") COMMA_SOURCE_FILE_AT_LINE (1870)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outPredefinedCursorList.addAssign_operation (GALGAS_string ("closedHandCursor") COMMA_SOURCE_FILE_AT_LINE (1871)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outPredefinedCursorList.addAssign_operation (GALGAS_string ("openHandCursor") COMMA_SOURCE_FILE_AT_LINE (1872)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outPredefinedCursorList.addAssign_operation (GALGAS_string ("pointingHandCursor") COMMA_SOURCE_FILE_AT_LINE (1873)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outPredefinedCursorList.addAssign_operation (GALGAS_string ("resizeLeftCursor") COMMA_SOURCE_FILE_AT_LINE (1874)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outPredefinedCursorList.addAssign_operation (GALGAS_string ("resizeRightCursor") COMMA_SOURCE_FILE_AT_LINE (1875)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outPredefinedCursorList.addAssign_operation (GALGAS_string ("resizeLeftRightCursor") COMMA_SOURCE_FILE_AT_LINE (1876)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outPredefinedCursorList.addAssign_operation (GALGAS_string ("resizeUpCursor") COMMA_SOURCE_FILE_AT_LINE (1877)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outPredefinedCursorList.addAssign_operation (GALGAS_string ("resizeDownCursor") COMMA_SOURCE_FILE_AT_LINE (1878)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outPredefinedCursorList.addAssign_operation (GALGAS_string ("resizeUpDownCursor") COMMA_SOURCE_FILE_AT_LINE (1879)) ;
  //-------- @plusEqualnstructionForGeneration
  outArgument_outPredefinedCursorList.addAssign_operation (GALGAS_string ("disappearingItemCursor") COMMA_SOURCE_FILE_AT_LINE (1880)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_protocolMap var_protocolMap = GALGAS_protocolMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1882)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_protocolList enumerator_72108 (constinArgument_inProtocolList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_72108.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_protocolMap.modifier_insertKey (enumerator_72108.current_mProtocolName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1884)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_72108.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outSortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1887)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (1888)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inOutletClassList, var_protocolMap, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1889)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inControllerClassList, var_transientDependencyGraph, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1890)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inClassList, outArgument_outClassMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1891)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (constinArgument_inPreferencesList, outArgument_outControllerClassMap, outArgument_outClassMap, outArgument_outOutletClassMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1896)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inEntityList, outArgument_outEntityMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1904)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outPreferencesMap, outArgument_outDocumentMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1910)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1920)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (1920)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = var_transientDependencyGraph.reader_graphviz (SOURCE_FILE_AT_LINE (1921)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_path = inArgument_inSourceFilePath.operator_concat (GALGAS_string (".transientDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (1922)) ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_73369_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_73369_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1923)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outTransientDependencyArcList = var_transientDependencyGraph.reader_arcs (SOURCE_FILE_AT_LINE (1926)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1927)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_transientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (1928)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_73649 (var_transientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (1929)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_73649.hasCurrentObject ()) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_73649.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1930)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (1930)) COMMA_SOURCE_FILE_AT_LINE (1930)) ;
        enumerator_73649.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_2) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_stringlist var_unsortedTransientList ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstringlist joker_73901_0 ; // Joker input parameter
      GALGAS_lstringlist joker_73943_0 ; // Joker input parameter
      var_transientDependencyGraph.method_topologicalSort (outArgument_outSortedTransientOrderedList, joker_73901_0, var_unsortedTransientList, joker_73943_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1934)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1940)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1941)).reader_string (SOURCE_FILE_AT_LINE (1941)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:") COMMA_SOURCE_FILE_AT_LINE (1941)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_74173 (var_unsortedTransientList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_74173.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_74173.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1943)) COMMA_SOURCE_FILE_AT_LINE (1943)) ;
          enumerator_74173.gotoNextObject () ;
        }
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (1945)) ;
      }
    }
  }
}
...
static void categoryMethod_regularPreferenceBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a preference does not implement the $").operator_concat (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (1315)) COMMA_SOURCE_FILE_AT_LINE (1315)).operator_concat (GALGAS_string (" binding") COMMA_SOURCE_FILE_AT_LINE (1315)) COMMA_SOURCE_FILE_AT_LINE (1315)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_multiValuedBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @errorInstructionForGeneration
  GALGAS_location location_0 (object->mAttribute_mBindingName.reader_location (HERE)) ; // Implicit use of 'location' reader
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement the $").operator_concat (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (1328)) COMMA_SOURCE_FILE_AT_LINE (1328)).operator_concat (GALGAS_string (" binding") COMMA_SOURCE_FILE_AT_LINE (1328)) COMMA_SOURCE_FILE_AT_LINE (1328)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_tableValueBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (1341)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $run action") COMMA_SOURCE_FILE_AT_LINE (1354)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularControllerBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @errorInstructionForGeneration
  GALGAS_location location_0 (object->mAttribute_mBindingName.reader_location (HERE)) ; // Implicit use of 'location' reader
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $").operator_concat (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (1367)) COMMA_SOURCE_FILE_AT_LINE (1367)).operator_concat (GALGAS_string (" binding") COMMA_SOURCE_FILE_AT_LINE (1367)) COMMA_SOURCE_FILE_AT_LINE (1367)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularRootBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1381)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_53752_2 ; // Joker input parameter
    GALGAS_string joker_53752_1 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_53752_2, joker_53752_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1383)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1384)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1385)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_54049_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_54049_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_54049_2, joker_54049_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1388)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1390)) COMMA_SOURCE_FILE_AT_LINE (1390)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1390)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1392)) COMMA_SOURCE_FILE_AT_LINE (1392)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1392)) ;
      }
    }else if (kBoolFalse == test_1) {
      //-------- @errorInstructionForGeneration
      ...
      inCompiler->emitSemanticError (location_3, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (1395)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1401)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_54680 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1404)).isValidAndTrue () ;
  if (enumerator_54680.hasCurrentObject () && bool_4) {
    while (enumerator_54680.hasCurrentObject () && bool_4) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_54680.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1405)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (1406)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1406)) COMMA_SOURCE_FILE_AT_LINE (1406)) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, var_boundTypeIdentifierString.objectCompare (var_acceptableType)) ;
      enumerator_54680.gotoNextObject () ;
      if (enumerator_54680.hasCurrentObject ()) {
        bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1404)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (1409)).boolEnum () ;
  if (kBoolTrue == test_5) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_6 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_6, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (1411)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (1411)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (1411)) COMMA_SOURCE_FILE_AT_LINE (1410)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1414)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (1421)), GALGAS_string ("mRootObjectController"), GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (1423)) COMMA_SOURCE_FILE_AT_LINE (1423)), var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1419)) COMMA_SOURCE_FILE_AT_LINE (1419)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularSelfBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_string var_boundTypeIdentifierString ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1439)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_56181_2 ; // Joker input parameter
    GALGAS_string joker_56181_1 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_56181_2, joker_56181_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1441)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1442)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1443)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_bool var_isToMany ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_destinationEntityName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_56478_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_56478_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_56478_2, joker_56478_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1446)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1448)) COMMA_SOURCE_FILE_AT_LINE (1448)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1448)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1450)) COMMA_SOURCE_FILE_AT_LINE (1450)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1450)) ;
      }
    }else if (kBoolFalse == test_1) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_3 = constinArgument_inPreferenceArrayMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1452)).boolEnum () ;
      if (kBoolTrue == test_3) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_string var_className ;
        //-------- @methodCallInstructionForGeneration
        GALGAS_observablePropertyMap joker_56839_0 ; // Joker input parameter
        constinArgument_inPreferenceArrayMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_className, joker_56839_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1453)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("array[").operator_concat (var_className COMMA_SOURCE_FILE_AT_LINE (1454)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1454)) ;
      }else if (kBoolFalse == test_3) {
        //-------- @errorInstructionForGeneration
        ...
        inCompiler->emitSemanticError (location_4, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (1456)) ;
        var_boundTypeIdentifierString.drop () ; // Release error dropped variable
      }
    }
  }
  ...
  GALGAS_outletClassBindingOptionMap var_availableBindingOptionMap ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1462)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_acceptableTypesString = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_57335 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (1465)).isValidAndTrue () ;
  if (enumerator_57335.hasCurrentObject () && bool_5) {
    while (enumerator_57335.hasCurrentObject () && bool_5) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_57335.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1466)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (1467)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1467)) COMMA_SOURCE_FILE_AT_LINE (1467)) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, var_boundTypeIdentifierString.objectCompare (var_acceptableType)) ;
      enumerator_57335.gotoNextObject () ;
      if (enumerator_57335.hasCurrentObject ()) {
        bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (1465)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (1470)).boolEnum () ;
  if (kBoolTrue == test_6) {
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_7, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (1472)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (1472)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (1472)) COMMA_SOURCE_FILE_AT_LINE (1471)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1475)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (1482)), GALGAS_string ("self"), object->mAttribute_mObservableAttributeName.mAttribute_string, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1480)) COMMA_SOURCE_FILE_AT_LINE (1480)) ;
}
//---------------------------------------------------------------------------*
