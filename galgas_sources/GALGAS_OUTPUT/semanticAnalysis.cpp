...
GALGAS_controllerClassMap_2E_element cEnumerator_controllerClassMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cMapElement_controllerClassMap) ;
  return GALGAS_controllerClassMap_2E_element (p->mAttribute_lkey, p->mAttribute_mGenerateCode, p->mAttribute_mBindingMap) ;
}
...
GALGAS_controllerMap_2E_element cEnumerator_controllerMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cMapElement_controllerMap) ;
  return GALGAS_controllerMap_2E_element (p->mAttribute_lkey, p->mAttribute_mControllerClassName, p->mAttribute_mControlledClassOrEntityName, p->mAttribute_mControllerBindingList) ;
}
...
void GALGAS_actionMap::modifier_searchKey (GALGAS_lstring inKey,
                                           C_Compiler * inCompiler
                                           COMMA_LOCATION_ARGS) {
  cMapElement_actionMap * p = NULL ;
  macroMyNew (p, cMapElement_actionMap (inKey COMMA_HERE)) ;
  ...
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
  const char * kInsertErrorMessage = "the '%K' action is not defined" ;
  const char * kShadowErrorMessage = "" ;
  performInsert (attributes, inCompiler, kInsertErrorMessage, kShadowErrorMessage COMMA_THERE) ;
}
...
void routine_analyzeEntities (const GALGAS_entityList constinArgument_inEntityList,
  ...
  outArgument_outEntityMap = GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (242)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityList enumerator_8997 (constinArgument_inEntityList, kEnumeration_up) ;
  ...
  while (enumerator_8997.hasCurrentObject ()) {
    ...
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (245)) ;
    //-------- @localVariableDeclarationForGeneration
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_8997.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (250)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_9414_0 ; // Joker input parameter
      GALGAS_string joker_9463_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_9551_5 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_9551_4 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_9551_3 ; // Joker input parameter
      GALGAS_triggeredKeys joker_9551_2 ; // Joker input parameter
      GALGAS_relationshipList joker_9551_1 ; // Joker input parameter
      GALGAS_relationshipMap joker_9616_0 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_8997.current_mSuperEntityName (HERE), joker_9414_0, var_implementationSuperClassName, joker_9463_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_9551_5, joker_9551_4, joker_9551_3, joker_9551_2, joker_9551_1, var_allRelationshipList, var_allPropertyMap, joker_9616_0, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (251)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (265)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (266)) ;
      //-------- @assignmentInstructionForGeneration
      var_implementationSuperClassName = GALGAS_string::makeEmptyString () ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipList = GALGAS_relationshipList::constructor_emptyList (SOURCE_FILE_AT_LINE (268)) ;
      //-------- @assignmentInstructionForGeneration
      var_allPropertyMap = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (269)) ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (270)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (272)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (273)) ;
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_10389 (enumerator_8997.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_10389.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_10389.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_10389.current_mType (HERE), enumerator_10389.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (277)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_10389.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (278)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_10389.current_mType (HERE), enumerator_10389.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (279)), enumerator_10389.current_mDefaultValueObjectiveCObject (HERE), enumerator_10389.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (279)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_10389.current_mType (HERE), enumerator_10389.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (280)), enumerator_10389.current_mDefaultValueObjectiveCObject (HERE), enumerator_10389.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (280)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_10389.current_mAttributeName (HERE), enumerator_10389.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_10389.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (281)) COMMA_SOURCE_FILE_AT_LINE (281)), inCompiler COMMA_SOURCE_FILE_AT_LINE (281)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_10389.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_relationshipMap var_currentRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (284)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipList enumerator_11084 (enumerator_8997.current_mRelationshipList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_11084.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allRelationshipMap.modifier_insertKey (enumerator_11084.current_mRelationshipName (HERE), enumerator_11084.current_mIsToMany (HERE), enumerator_11084.current_mDestinationEntityName (HERE), enumerator_11084.current_mInverseRelationshipName (HERE), enumerator_11084.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (286)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_currentRelationshipMap.modifier_insertKey (enumerator_11084.current_mRelationshipName (HERE), enumerator_11084.current_mIsToMany (HERE), enumerator_11084.current_mDestinationEntityName (HERE), enumerator_11084.current_mInverseRelationshipName (HERE), enumerator_11084.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (293)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_11084.current_mRelationshipName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (300)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_11084.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (303)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_11636 (enumerator_8997.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_11636.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_11636.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (305)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (306)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_11843 (enumerator_11636.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_11843.hasCurrentObject ()) {
        ...
        //-------- @methodCallInstructionForGeneration
        var_classObservablePropertyMap.method_searchKey (enumerator_11843.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (311)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_11843.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (312)) COMMA_SOURCE_FILE_AT_LINE (312)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_12106 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_12106.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_12106.current_mValue (HERE), enumerator_11636.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (314)) ;
          enumerator_12106.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (316)) ;
        enumerator_11843.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_11636.current_mType (HERE), enumerator_11636.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (318)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (318)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_11636.current_mTransientName (HERE), enumerator_11636.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (319)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_11636.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outEntityMap.modifier_insertKey (enumerator_8997.current_mEntityName (HERE), enumerator_8997.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (324)), enumerator_8997.current_mImplementationClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (325)), var_implementationSuperClassName, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_triggeredKeys, enumerator_8997.current_mRelationshipList (HERE), var_allRelationshipList.operator_concat (enumerator_8997.current_mRelationshipList (HERE) COMMA_SOURCE_FILE_AT_LINE (334)), var_allPropertyMap, var_currentRelationshipMap, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (322)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_8997.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityMap enumerator_13098 (outArgument_outEntityMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_13098.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipMap enumerator_13137 (enumerator_13098.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_13137.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_13253_13 ; // Joker input parameter
      GALGAS_string joker_13253_12 ; // Joker input parameter
      GALGAS_string joker_13253_11 ; // Joker input parameter
      GALGAS_classObservablePropertyMap joker_13253_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_13253_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_13253_8 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_13253_7 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_13253_6 ; // Joker input parameter
      GALGAS_triggeredKeys joker_13253_5 ; // Joker input parameter
      GALGAS_relationshipList joker_13253_4 ; // Joker input parameter
      GALGAS_relationshipList joker_13253_3 ; // Joker input parameter
      GALGAS_propertyMap joker_13253_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_13253_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_13137.current_mDestinationEntityName (HERE), joker_13253_13, joker_13253_12, joker_13253_11, joker_13253_10, joker_13253_9, joker_13253_8, joker_13253_7, joker_13253_6, joker_13253_5, joker_13253_4, joker_13253_3, joker_13253_2, joker_13253_1, var_destinationEntityRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (344)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_inverseOfInverseRelationshipName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_13420_2 ; // Joker input parameter
      GALGAS_lstring joker_13420_1 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_13458_0 ; // Joker input parameter
      var_destinationEntityRelationshipMap.method_searchKey (enumerator_13137.current_mInverseRelationshipName (HERE), joker_13420_2, joker_13420_1, var_inverseOfInverseRelationshipName, joker_13458_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (346)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_13137.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_2 (enumerator_13137.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_13137.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (348)) COMMA_SOURCE_FILE_AT_LINE (348)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (348)) COMMA_SOURCE_FILE_AT_LINE (348)) ;
      }
...
void routine_analyzePreferences (const GALGAS_preferencesDeclarationList constinArgument_inPreferencesList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (444)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_17304 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17304.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservablePropertyMap var_observableAttributeMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (446)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (448)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_17481 (enumerator_17304.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_17481.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_17481.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (450)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_17765 (enumerator_17304.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_17765.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_17765.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_17765.current_mType (HERE), enumerator_17765.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (456)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_17765.current_mType (HERE), enumerator_17765.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (457)), enumerator_17765.current_mDefaultValueObjectiveCObject (HERE), enumerator_17765.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (457)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_17765.current_mAttributeName (HERE), enumerator_17765.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_17765.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (458)) COMMA_SOURCE_FILE_AT_LINE (458)), inCompiler COMMA_SOURCE_FILE_AT_LINE (458)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_17765.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (461)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_18238 (enumerator_17304.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_18238.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (463)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (464)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_18392 (enumerator_18238.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_18392.hasCurrentObject ()) {
        ...
        GALGAS_stringlist var_propertyDependancyList ;
        //-------- @methodCallInstructionForGeneration
        var_observableAttributeMap.method_searchKey (enumerator_18392.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (468)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_18392.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (469)) COMMA_SOURCE_FILE_AT_LINE (469)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_18651 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_18651.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_18651.current_mValue (HERE), enumerator_18238.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (471)) COMMA_SOURCE_FILE_AT_LINE (471)) ;
          enumerator_18651.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (473)) ;
        enumerator_18392.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_18238.current_mType (HERE), enumerator_18238.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (475)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (475)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_18238.current_mTransientName (HERE), enumerator_18238.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (476)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_18238.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (479)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_19153 (enumerator_17304.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_19153.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_19245_2 ; // Joker input parameter
      GALGAS_string joker_19245_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_19153.current_mOutletType (HERE), joker_19245_2, joker_19245_1, var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (482)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (483)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_19367 (enumerator_19153.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_19367.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_19367.current_mBinding (HERE).ptr (), var_observableAttributeMap, var_bindingMap, GALGAS_string::makeEmptyString (), GALGAS_string ("no prefix allowed here"), var_outletBindingList, inCompiler COMMA_SOURCE_FILE_AT_LINE (485)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_19367.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_19153.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (493)), enumerator_19153.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (493)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (493)) ;
      enumerator_19153.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outPreferencesMap.modifier_insertKey (enumerator_17304.current_mPreferencesName (HERE), var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, var_triggeredKeys, enumerator_17304.current_mActionDeclarationList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (496)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeBoundProperty (const GALGAS_lstring constinArgument_inObservedObjectName,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @assignmentInstructionForGeneration
    outArgument_outResultingObservedPropertyPath = GALGAS_string ("selection.").operator_concat (constinArgument_inObservedPropertyName.reader_string (SOURCE_FILE_AT_LINE (541)) COMMA_SOURCE_FILE_AT_LINE (541)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (constinArgument_inObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("observed object should be 'root'") COMMA_SOURCE_FILE_AT_LINE (543)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inAllObservablePropertyMap.reader_hasKey (constinArgument_inObservedPropertyName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (548)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_stringlist joker_21775_0 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (constinArgument_inObservedPropertyName, var_t, joker_21775_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (550)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    outArgument_outTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (551)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inAllRelationshipMap.reader_hasKey (constinArgument_inObservedPropertyName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (552)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_22065_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_22065_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (constinArgument_inObservedPropertyName, var_isToMany, var_destinationEntityName, joker_22065_2, joker_22065_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (555)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        outArgument_outTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (557)) COMMA_SOURCE_FILE_AT_LINE (557)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (557)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @assignmentInstructionForGeneration
        outArgument_outTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (559)) COMMA_SOURCE_FILE_AT_LINE (559)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (559)) ;
      }
      ...
      inCompiler->emitSemanticError (location_5, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (562)) ;
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outBindingOptionListForGeneration = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (575)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_22764 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_22764.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_22764.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (578)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_22953 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (580)).isValidAndTrue () ;
    if (enumerator_22953.hasCurrentObject () && bool_0) {
      while (enumerator_22953.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_23017 (enumerator_22764.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (581)).isValidAndTrue () ;
        if (enumerator_23017.hasCurrentObject () && bool_1) {
          while (enumerator_23017.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_22953.current_mType (HERE).objectCompare (enumerator_23017.current_mType (HERE))) ;
            enumerator_23017.gotoNextObject () ;
            if (enumerator_23017.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (581)).isValidAndTrue () ;
            }
          }
        }
        enumerator_22953.gotoNextObject () ;
        if (enumerator_22953.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (580)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (585)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_23256 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (587)).isValidAndTrue () ;
      if (enumerator_23256.hasCurrentObject () && bool_3) {
        while (enumerator_23256.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_23256.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (588)) COMMA_SOURCE_FILE_AT_LINE (588)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (588)) COMMA_SOURCE_FILE_AT_LINE (588)) ;
          enumerator_23256.gotoNextObject () ;
          if (enumerator_23256.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (587)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_22764.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (590)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_22764.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (592)), enumerator_22764.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (592)) ;
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (695)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_27487 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_27487.hasCurrentObject ()) {
    ...
    GALGAS_relationshipMap var_allRelationshipMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_27692_0 ; // Joker input parameter
    GALGAS_string joker_27742_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_27780_9 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_27780_8 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_27780_7 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_27780_6 ; // Joker input parameter
    GALGAS_triggeredKeys joker_27780_5 ; // Joker input parameter
    GALGAS_relationshipList joker_27780_4 ; // Joker input parameter
    GALGAS_relationshipList joker_27780_3 ; // Joker input parameter
    GALGAS_propertyMap joker_27780_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_27780_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_27487.current_mRootEntityName (HERE), joker_27692_0, var_rootEntityImplementationClassName, joker_27742_0, var_observablePropertyMap, joker_27780_9, joker_27780_8, joker_27780_7, joker_27780_6, joker_27780_5, joker_27780_4, joker_27780_3, joker_27780_2, joker_27780_1, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (700)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (710)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_27924 (enumerator_27487.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_27924.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_27924.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (712)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_27924.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (715)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerList enumerator_28094 (enumerator_27487.current_mControllerList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_28094.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_controllerClassBindingMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_28214_0 ; // Joker input parameter
      constinArgument_inControllerClassMap.method_searchKey (enumerator_28094.current_mControllerClassName (HERE), joker_28214_0, var_controllerClassBindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (718)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_28307_14 ; // Joker input parameter
      GALGAS_string joker_28307_13 ; // Joker input parameter
      GALGAS_string joker_28307_12 ; // Joker input parameter
      GALGAS_classObservablePropertyMap joker_28307_11 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_28307_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_28307_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_28307_8 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_28307_7 ; // Joker input parameter
      GALGAS_triggeredKeys joker_28307_6 ; // Joker input parameter
      GALGAS_relationshipList joker_28307_5 ; // Joker input parameter
      GALGAS_relationshipList joker_28307_4 ; // Joker input parameter
      GALGAS_propertyMap joker_28307_3 ; // Joker input parameter
      GALGAS_relationshipMap joker_28307_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_28307_1 ; // Joker input parameter
      constinArgument_inEntityMap.method_searchKey (enumerator_28094.current_mControlledClassOrEntityName (HERE), joker_28307_14, joker_28307_13, joker_28307_12, joker_28307_11, joker_28307_10, joker_28307_9, joker_28307_8, joker_28307_7, joker_28307_6, joker_28307_5, joker_28307_4, joker_28307_3, joker_28307_2, joker_28307_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (719)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (720)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_28428 (enumerator_28094.current_mControllerBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_28428.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_28428.current_mBinding (HERE).ptr (), var_allRelationshipMap, var_controllerClassBindingMap, enumerator_28094.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (722)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_28428.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_controllerMap.modifier_insertKey (enumerator_28094.current_mControllerName (HERE), enumerator_28094.current_mControllerClassName (HERE).mAttribute_string, enumerator_28094.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (730)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_28094.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (738)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_29006 (enumerator_27487.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_29006.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_29098_2 ; // Joker input parameter
      GALGAS_string joker_29098_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_29006.current_mOutletType (HERE), joker_29098_2, joker_29098_1, var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (741)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (742)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_29220 (enumerator_29006.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_29220.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_29220.current_mBinding (HERE).ptr (), var_observablePropertyMap, var_bindingMap, GALGAS_string ("root"), GALGAS_string ("'root' prefix is required here"), var_outletBindingList, inCompiler COMMA_SOURCE_FILE_AT_LINE (744)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_29220.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_29006.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (752)), enumerator_29006.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (752)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (752)) ;
      enumerator_29006.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outDocumentMap.modifier_insertKey (enumerator_27487.current_mDocumentName (HERE), enumerator_27487.current_mRootEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (757)), var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, enumerator_27487.current_mActionDeclarationList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (755)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_30144 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (774)).isValidAndTrue () ;
  if (enumerator_30144.hasCurrentObject () && bool_0) {
    while (enumerator_30144.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_30144.current_mType (HERE))) ;
      enumerator_30144.gotoNextObject () ;
      if (enumerator_30144.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (774)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (777)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (778)) ;
  }
}
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (788)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_30572 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_30572.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_classObservablePropertyMap var_classObservablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (791)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_30572.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (792)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_30807_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_30871_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_30871_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_30871_2 ; // Joker input parameter
      GALGAS_triggeredKeys joker_30871_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_30572.current_mSuperClassName (HERE), joker_30807_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_30871_4, joker_30871_3, joker_30871_2, joker_30871_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (793)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (795)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (796)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (798)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (799)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (801)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_31418 (enumerator_30572.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_31418.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_31418.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_31418.current_mType (HERE), enumerator_31418.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (803)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_31418.current_mType (HERE), enumerator_31418.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (804)), enumerator_31418.current_mDefaultValueObjectiveCObject (HERE), enumerator_31418.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (804)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_31418.current_mType (HERE), enumerator_31418.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (805)), enumerator_31418.current_mDefaultValueObjectiveCObject (HERE), enumerator_31418.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (805)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_31418.current_mAttributeName (HERE), enumerator_31418.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_31418.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (806)) COMMA_SOURCE_FILE_AT_LINE (806)), inCompiler COMMA_SOURCE_FILE_AT_LINE (806)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_31418.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_31980 (enumerator_30572.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_31980.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (810)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (811)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_32134 (enumerator_31980.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_32134.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_easyBindingType var_type ;
        //-------- @localVariableDeclarationForGeneration
        GALGAS_stringlist var_propertyDependancyList ;
        //-------- @methodCallInstructionForGeneration
        var_classObservablePropertyMap.method_searchKey (enumerator_32134.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (815)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_32134.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (816)) COMMA_SOURCE_FILE_AT_LINE (816)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_32397 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_32397.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_32397.current_mValue (HERE), enumerator_31980.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (818)) COMMA_SOURCE_FILE_AT_LINE (818)) ;
          enumerator_32397.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (820)) ;
        enumerator_32134.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_31980.current_mType (HERE), enumerator_31980.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (822)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (822)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_31980.current_mTransientName (HERE), enumerator_31980.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (823)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_31980.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_30572.current_mClassName (HERE), enumerator_30572.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (828)), var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_triggeredKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (826)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_30572.gotoNextObject () ;
  }
}
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (845)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_33399 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_33399.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (848)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_33496 (enumerator_33399.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_33496.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (850)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_33608 (enumerator_33496.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_33608.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_33608.current_mBindingOptionName (HERE), enumerator_33608.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (852)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_33608.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_33496.current_mBindingName (HERE), enumerator_33496.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (858)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_33496.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_33399.current_mOutletClassName (HERE), enumerator_33399.current_mGenerateCode (HERE), enumerator_33399.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (861)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_33399.gotoNextObject () ;
  }
}
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (876)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_34411 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_34411.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (879)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_34497 (enumerator_34411.current_mBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_34497.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (881)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_34609 (enumerator_34497.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_34609.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_34609.current_mBindingOptionName (HERE), enumerator_34609.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (883)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_34609.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_34497.current_mBindingName (HERE), enumerator_34497.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (889)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_34497.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outControllerClassMap.modifier_insertKey (enumerator_34411.current_mOutletClassName (HERE), enumerator_34411.current_mGenerateCode (HERE), var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (892)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  outArgument_outDocumentMap.drop () ; // Release 'out' argument
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (907)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (908)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (909)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (910)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (911)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outDocumentMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (912)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
//--- Find method
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inObservableAttributeMap, constin_inBindingMap, constin_inRequiredPrefix, constin_inRequiredPrefixErrorMessage, io_ioOutletBindingListForGeneration, inCompiler COMMA_THERE) ;
    }
  }
}
...
static void categoryMethod_regularBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (387)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, constinArgument_inRequiredPrefixErrorMessage COMMA_SOURCE_FILE_AT_LINE (390)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_observablePropertyType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_stringlist joker_15380_0 ; // Joker input parameter
  constinArgument_inObservableAttributeMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_15380_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (393)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (396)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_15550 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (397)).isValidAndTrue () ;
  if (enumerator_15550.hasCurrentObject () && bool_2) {
    while (enumerator_15550.hasCurrentObject () && bool_2) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_15550.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_15550.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_15550.gotoNextObject () ;
      if (enumerator_15550.hasCurrentObject ()) {
        bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (397)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (401)).boolEnum () ;
  if (kBoolTrue == test_3) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (402)) COMMA_SOURCE_FILE_AT_LINE (402)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (402)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_15854 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (403)).isValidAndTrue () ;
    if (enumerator_15854.hasCurrentObject () && bool_4) {
      while (enumerator_15854.hasCurrentObject () && bool_4) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_15854.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (404)) COMMA_SOURCE_FILE_AT_LINE (404)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (404)) COMMA_SOURCE_FILE_AT_LINE (404)) ;
        enumerator_15854.gotoNextObject () ;
        if (enumerator_15854.hasCurrentObject ()) {
          bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (403)).isValidAndTrue () ;
        }
      }
    }
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_5, var_s COMMA_SOURCE_FILE_AT_LINE (406)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (409)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_16089 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_16089.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_16089.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (412)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_16278 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (414)).isValidAndTrue () ;
    if (enumerator_16278.hasCurrentObject () && bool_6) {
      while (enumerator_16278.hasCurrentObject () && bool_6) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_16342 (enumerator_16089.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (415)).isValidAndTrue () ;
        if (enumerator_16342.hasCurrentObject () && bool_7) {
          while (enumerator_16342.hasCurrentObject () && bool_7) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_16278.current_mType (HERE).objectCompare (enumerator_16342.current_mType (HERE))) ;
            enumerator_16342.gotoNextObject () ;
            if (enumerator_16342.hasCurrentObject ()) {
              bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (415)).isValidAndTrue () ;
            }
          }
        }
        enumerator_16278.gotoNextObject () ;
        if (enumerator_16278.hasCurrentObject ()) {
          bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (414)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (419)).boolEnum () ;
    if (kBoolTrue == test_8) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_16581 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (421)).isValidAndTrue () ;
      if (enumerator_16581.hasCurrentObject () && bool_9) {
        while (enumerator_16581.hasCurrentObject () && bool_9) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_16581.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (422)) COMMA_SOURCE_FILE_AT_LINE (422)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (422)) COMMA_SOURCE_FILE_AT_LINE (422)) ;
          enumerator_16581.gotoNextObject () ;
          if (enumerator_16581.hasCurrentObject ()) {
            bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (421)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_10 (enumerator_16089.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_10, var_s COMMA_SOURCE_FILE_AT_LINE (424)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_16089.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (426)), enumerator_16089.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (426)) ;
    enumerator_16089.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (429)), var_requiredFormatter, GALGAS_string ("self"), object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (432)), var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (428)) ;
}
//---------------------------------------------------------------------------*
...
GALGAS_string categoryReader_ebTypeIdentifier (const GALGAS_easyBindingType & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inClassOrEntityName COMMA_SOURCE_FILE_AT_LINE (524)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (524)) ;
      } break ;
    }
  }
//---
...
static void categoryMethod_regularBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @assignmentInstructionForGeneration
    var_resultingObservedPropertyPath = GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (631)) COMMA_SOURCE_FILE_AT_LINE (631)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("observed object should be 'root'") COMMA_SOURCE_FILE_AT_LINE (633)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (639)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_stringlist joker_25371_0 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_25371_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (641)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (642)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (643)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_bool var_isToMany ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_destinationEntityName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_25667_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_25667_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_25667_2, joker_25667_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (646)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (648)) COMMA_SOURCE_FILE_AT_LINE (648)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (648)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (650)) COMMA_SOURCE_FILE_AT_LINE (650)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (650)) ;
      }
    }else if (kBoolFalse == test_3) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_5 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (653)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (659)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_26298 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (662)).isValidAndTrue () ;
  if (enumerator_26298.hasCurrentObject () && bool_6) {
    while (enumerator_26298.hasCurrentObject () && bool_6) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_26298.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (663)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (664)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (664)) COMMA_SOURCE_FILE_AT_LINE (664)) ;
      //-------- @assignmentInstructionForGeneration
      ...
      if (enumerator_26298.hasCurrentObject ()) {
        bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (662)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (667)).boolEnum () ;
  if (kBoolTrue == test_7) {
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_8, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (669)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (669)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (669)) COMMA_SOURCE_FILE_AT_LINE (668)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (672)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (679)), var_resultingObservedObjectName, var_resultingObservedPropertyPath, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (677)) ;
}
//---------------------------------------------------------------------------*
...
GALGAS_controllerClassMap_2E_element GALGAS_controllerClassMap_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_controllerClassMap_2E_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
GALGAS_controllerMap_2E_element GALGAS_controllerMap_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_controllerMap_2E_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
