...
void routine_analyzeEntities (const GALGAS_entityList constinArgument_inEntityList,
  ...
  outArgument_outEntityMap = GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (232)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityList enumerator_8675 (constinArgument_inEntityList, kEnumeration_up) ;
  ...
  while (enumerator_8675.hasCurrentObject ()) {
    ...
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (235)) ;
    //-------- @localVariableDeclarationForGeneration
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_8675.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (240)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_9092_0 ; // Joker input parameter
      GALGAS_string joker_9141_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_9229_5 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_9229_4 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_9229_3 ; // Joker input parameter
      GALGAS_triggeredKeys joker_9229_2 ; // Joker input parameter
      GALGAS_relationshipList joker_9229_1 ; // Joker input parameter
      GALGAS_relationshipMap joker_9294_0 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_8675.current_mSuperEntityName (HERE), joker_9092_0, var_implementationSuperClassName, joker_9141_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_9229_5, joker_9229_4, joker_9229_3, joker_9229_2, joker_9229_1, var_allRelationshipList, var_allPropertyMap, joker_9294_0, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (241)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (255)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (256)) ;
      //-------- @assignmentInstructionForGeneration
      var_implementationSuperClassName = GALGAS_string::makeEmptyString () ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipList = GALGAS_relationshipList::constructor_emptyList (SOURCE_FILE_AT_LINE (258)) ;
      //-------- @assignmentInstructionForGeneration
      var_allPropertyMap = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (259)) ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (260)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (262)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (263)) ;
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_10067 (enumerator_8675.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_10067.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_10067.current_mPropertyName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (267)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_10067.current_mType (HERE), enumerator_10067.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (268)), enumerator_10067.current_mDefaultValueObjectiveCObject (HERE), enumerator_10067.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (268)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_10067.current_mType (HERE), enumerator_10067.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (269)), enumerator_10067.current_mDefaultValueObjectiveCObject (HERE), enumerator_10067.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (269)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_10067.current_mPropertyName (HERE), enumerator_10067.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_10067.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (270)) COMMA_SOURCE_FILE_AT_LINE (270)), inCompiler COMMA_SOURCE_FILE_AT_LINE (270)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_10067.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_relationshipMap var_currentRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (273)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipList enumerator_10661 (enumerator_8675.current_mRelationshipList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_10661.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allRelationshipMap.modifier_insertKey (enumerator_10661.current_mRelationshipName (HERE), enumerator_10661.current_mIsToMany (HERE), enumerator_10661.current_mDestinationEntityName (HERE), enumerator_10661.current_mInverseRelationshipName (HERE), enumerator_10661.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (275)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_currentRelationshipMap.modifier_insertKey (enumerator_10661.current_mRelationshipName (HERE), enumerator_10661.current_mIsToMany (HERE), enumerator_10661.current_mDestinationEntityName (HERE), enumerator_10661.current_mInverseRelationshipName (HERE), enumerator_10661.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (282)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_10661.current_mRelationshipName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (289)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_10661.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (292)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_11213 (enumerator_8675.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_11213.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_11213.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (294)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (295)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (296)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_11420 (enumerator_11213.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_11420.hasCurrentObject ()) {
        ...
        //-------- @methodCallInstructionForGeneration
        var_classObservablePropertyMap.method_searchKey (enumerator_11420.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (300)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_11420.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (301)) COMMA_SOURCE_FILE_AT_LINE (301)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_11683 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_11683.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_11683.current_mValue (HERE), enumerator_11213.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (303)) COMMA_SOURCE_FILE_AT_LINE (303)) ;
          enumerator_11683.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (305)) ;
        enumerator_11420.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_11213.current_mType (HERE), enumerator_11213.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (307)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (307)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_11213.current_mTransientName (HERE), enumerator_11213.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (308)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_11213.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outEntityMap.modifier_insertKey (enumerator_8675.current_mEntityName (HERE), enumerator_8675.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (313)), enumerator_8675.current_mImplementationClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (314)), var_implementationSuperClassName, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_triggeredKeys, enumerator_8675.current_mRelationshipList (HERE), var_allRelationshipList.operator_concat (enumerator_8675.current_mRelationshipList (HERE) COMMA_SOURCE_FILE_AT_LINE (323)), var_allPropertyMap, var_currentRelationshipMap, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (311)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_8675.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityMap enumerator_12675 (outArgument_outEntityMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_12675.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipMap enumerator_12714 (enumerator_12675.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_12714.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_12830_13 ; // Joker input parameter
      GALGAS_string joker_12830_12 ; // Joker input parameter
      GALGAS_string joker_12830_11 ; // Joker input parameter
      GALGAS_classObservablePropertyMap joker_12830_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_12830_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_12830_8 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_12830_7 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_12830_6 ; // Joker input parameter
      GALGAS_triggeredKeys joker_12830_5 ; // Joker input parameter
      GALGAS_relationshipList joker_12830_4 ; // Joker input parameter
      GALGAS_relationshipList joker_12830_3 ; // Joker input parameter
      GALGAS_propertyMap joker_12830_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_12830_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_12714.current_mDestinationEntityName (HERE), joker_12830_13, joker_12830_12, joker_12830_11, joker_12830_10, joker_12830_9, joker_12830_8, joker_12830_7, joker_12830_6, joker_12830_5, joker_12830_4, joker_12830_3, joker_12830_2, joker_12830_1, var_destinationEntityRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (333)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_inverseOfInverseRelationshipName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_12997_2 ; // Joker input parameter
      GALGAS_lstring joker_12997_1 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_13035_0 ; // Joker input parameter
      var_destinationEntityRelationshipMap.method_searchKey (enumerator_12714.current_mInverseRelationshipName (HERE), joker_12997_2, joker_12997_1, var_inverseOfInverseRelationshipName, joker_13035_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (335)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_12714.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_2 (enumerator_12714.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_12714.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (337)) COMMA_SOURCE_FILE_AT_LINE (337)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (337)) COMMA_SOURCE_FILE_AT_LINE (337)) ;
      }
...
void routine_analyzePreferences (const GALGAS_preferencesDeclarationList constinArgument_inPreferencesList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (350)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_13618 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_13618.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservablePropertyMap var_observableAttributeMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (352)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (354)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (355)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_13904 (enumerator_13618.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_13904.hasCurrentObject ()) {
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_13904.current_mType (HERE), enumerator_13904.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (357)), enumerator_13904.current_mDefaultValueObjectiveCObject (HERE), enumerator_13904.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (357)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_13904.current_mPropertyName (HERE), enumerator_13904.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_13904.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (358)) COMMA_SOURCE_FILE_AT_LINE (358)), inCompiler COMMA_SOURCE_FILE_AT_LINE (358)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_13904.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (361)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_14278 (enumerator_13618.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_14278.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (363)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (364)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_14432 (enumerator_14278.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_14432.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_easyBindingType var_type ;
        //-------- @localVariableDeclarationForGeneration
        GALGAS_stringlist var_propertyDependancyList ;
        //-------- @methodCallInstructionForGeneration
        var_observableAttributeMap.method_searchKey (enumerator_14432.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (368)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_14432.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (369)) COMMA_SOURCE_FILE_AT_LINE (369)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_14691 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_14691.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_14691.current_mValue (HERE), enumerator_14278.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371)) ;
          enumerator_14691.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (373)) ;
        enumerator_14432.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_14278.current_mType (HERE), enumerator_14278.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (375)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (375)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_14278.current_mTransientName (HERE), enumerator_14278.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (376)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_14278.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (379)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_15193 (enumerator_13618.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_15193.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_15285_0 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_15193.current_mOutletType (HERE), joker_15285_0, var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (382)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (383)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_15406 (enumerator_15193.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_15406.hasCurrentObject ()) {
        ...
        //-------- @methodCallInstructionForGeneration
        var_bindingMap.method_searchKey (enumerator_15406.current_mBindingName (HERE), var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (387)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_15406.current_mObservedObjectName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_0) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_1 (enumerator_15406.current_mObservedObjectName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_1, GALGAS_string ("no prefix allowed here") COMMA_SOURCE_FILE_AT_LINE (390)) ;
        }
        //-------- @localVariableDeclarationForGeneration
        GALGAS_easyBindingType var_observablePropertyType ;
        //-------- @methodCallInstructionForGeneration
        GALGAS_stringlist joker_15972_0 ; // Joker input parameter
        var_observableAttributeMap.method_searchKey (enumerator_15406.current_mObservableAttributeName (HERE), var_observablePropertyType, joker_15972_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (393)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeAndFormatterList enumerator_16166 (var_acceptableTypeFormatterList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (397)).isValidAndTrue () ;
        if (enumerator_16166.hasCurrentObject () && bool_2) {
          while (enumerator_16166.hasCurrentObject () && bool_2) {
            //-------- @assignmentInstructionForGeneration
            var_requiredFormatter = enumerator_16166.current_mRequiredFormatter (HERE) ;
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_16166.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
            enumerator_16166.gotoNextObject () ;
            if (enumerator_16166.hasCurrentObject ()) {
        ...
        if (kBoolTrue == test_3) {
          ...
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeAndFormatterList enumerator_16506 (var_acceptableTypeFormatterList, kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (403)).isValidAndTrue () ;
          if (enumerator_16506.hasCurrentObject () && bool_4) {
            while (enumerator_16506.hasCurrentObject () && bool_4) {
              //-------- @concatInstructionForGeneration
              var_s.dotAssign_operation (GALGAS_string ("\n"
                "  - '").operator_concat (categoryReader_ebTypeName (enumerator_16506.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (404)) COMMA_SOURCE_FILE_AT_LINE (404)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (404)) COMMA_SOURCE_FILE_AT_LINE (404)) ;
              enumerator_16506.gotoNextObject () ;
              if (enumerator_16506.hasCurrentObject ()) {
                bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (403)).isValidAndTrue () ;
              }
            }
          }
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_15406.current_mObservableAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_outletBindingOptionList enumerator_16783 (enumerator_15406.current_mOutletBindingOptionList (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_16783.hasCurrentObject ()) {
          //-------- @localVariableDeclarationForGeneration
          GALGAS_easyBindingTypeList var_acceptableTypeList ;
          //-------- @methodCallInstructionForGeneration
          var_outletClassBindingOptionMap.method_searchKey (enumerator_16783.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (412)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
          GALGAS_bool var_found = GALGAS_bool (false) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeList enumerator_16996 (var_acceptableTypeList, kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (414)).isValidAndTrue () ;
          if (enumerator_16996.hasCurrentObject () && bool_6) {
            while (enumerator_16996.hasCurrentObject () && bool_6) {
              //-------- @foreachInstructionForGeneration
              cEnumerator_easyBindingTypeList enumerator_17066 (enumerator_16783.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
              //--- complex foreach instruction
              bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (415)).isValidAndTrue () ;
              if (enumerator_17066.hasCurrentObject () && bool_7) {
                while (enumerator_17066.hasCurrentObject () && bool_7) {
                  //-------- @assignmentInstructionForGeneration
                  var_found = GALGAS_bool (kIsEqual, enumerator_16996.current_mType (HERE).objectCompare (enumerator_17066.current_mType (HERE))) ;
                  enumerator_17066.gotoNextObject () ;
                  if (enumerator_17066.hasCurrentObject ()) {
                    bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (415)).isValidAndTrue () ;
                  }
                }
              }
              enumerator_16996.gotoNextObject () ;
              if (enumerator_16996.hasCurrentObject ()) {
          ...
          if (kBoolTrue == test_8) {
            ...
            //-------- @foreachInstructionForGeneration
            cEnumerator_easyBindingTypeList enumerator_17341 (var_acceptableTypeList, kEnumeration_up) ;
            //--- complex foreach instruction
            bool bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (421)).isValidAndTrue () ;
            if (enumerator_17341.hasCurrentObject () && bool_9) {
              while (enumerator_17341.hasCurrentObject () && bool_9) {
                //-------- @concatInstructionForGeneration
                var_s.dotAssign_operation (GALGAS_string ("\n"
                  "  - '").operator_concat (categoryReader_ebTypeName (enumerator_17341.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (422)) COMMA_SOURCE_FILE_AT_LINE (422)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (422)) COMMA_SOURCE_FILE_AT_LINE (422)) ;
            ...
            //-------- @errorInstructionForGeneration
            GALGAS_location location_10 (enumerator_16783.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_10, var_s COMMA_SOURCE_FILE_AT_LINE (424)) ;
          }
          //-------- @plusEqualnstructionForGeneration
          var_bindingOptionList.addAssign_operation (enumerator_16783.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (426)), enumerator_16783.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (426)) ;
          enumerator_16783.gotoNextObject () ;
        }
        //-------- @plusEqualnstructionForGeneration
        var_outletBindingList.addAssign_operation (enumerator_15406.current_mBindingName (HERE).reader_string (SOURCE_FILE_AT_LINE (428)), var_requiredFormatter, GALGAS_string ("self"), enumerator_15406.current_mObservableAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (428)), var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (428)) ;
        enumerator_15406.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_15193.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (430)), enumerator_15193.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (430)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (430)) ;
      enumerator_15193.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outPreferencesMap.modifier_insertKey (enumerator_13618.current_mPreferencesName (HERE), var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, var_triggeredKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (433)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeBoundProperty (const GALGAS_lstring constinArgument_inObservedObjectName,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @assignmentInstructionForGeneration
    outArgument_outResultingObservedPropertyPath = GALGAS_string ("selection.").operator_concat (constinArgument_inObservedPropertyName.reader_string (SOURCE_FILE_AT_LINE (477)) COMMA_SOURCE_FILE_AT_LINE (477)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (constinArgument_inObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("observed object should be 'root'") COMMA_SOURCE_FILE_AT_LINE (479)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inAllObservablePropertyMap.reader_hasKey (constinArgument_inObservedPropertyName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (484)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_stringlist joker_19924_0 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (constinArgument_inObservedPropertyName, var_t, joker_19924_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (486)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    outArgument_outTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (487)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inAllRelationshipMap.reader_hasKey (constinArgument_inObservedPropertyName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (488)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_20214_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_20214_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (constinArgument_inObservedPropertyName, var_isToMany, var_destinationEntityName, joker_20214_2, joker_20214_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (491)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        outArgument_outTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (493)) COMMA_SOURCE_FILE_AT_LINE (493)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (493)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @assignmentInstructionForGeneration
        outArgument_outTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (495)) COMMA_SOURCE_FILE_AT_LINE (495)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (495)) ;
      }
      ...
      inCompiler->emitSemanticError (location_5, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (498)) ;
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outBindingOptionListForGeneration = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (511)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_20913 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_20913.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_20913.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (514)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_21102 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (516)).isValidAndTrue () ;
    if (enumerator_21102.hasCurrentObject () && bool_0) {
      while (enumerator_21102.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_21166 (enumerator_20913.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (517)).isValidAndTrue () ;
        if (enumerator_21166.hasCurrentObject () && bool_1) {
          while (enumerator_21166.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_21102.current_mType (HERE).objectCompare (enumerator_21166.current_mType (HERE))) ;
            enumerator_21166.gotoNextObject () ;
            if (enumerator_21166.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (517)).isValidAndTrue () ;
            }
          }
        }
        enumerator_21102.gotoNextObject () ;
        if (enumerator_21102.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (516)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (521)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_21405 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (523)).isValidAndTrue () ;
      if (enumerator_21405.hasCurrentObject () && bool_3) {
        while (enumerator_21405.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_21405.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (524)) COMMA_SOURCE_FILE_AT_LINE (524)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (524)) COMMA_SOURCE_FILE_AT_LINE (524)) ;
          enumerator_21405.gotoNextObject () ;
          if (enumerator_21405.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (523)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_20913.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (526)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_20913.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (528)), enumerator_20913.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (528)) ;
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (541)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_22050 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_22050.hasCurrentObject ()) {
    ...
    GALGAS_relationshipMap var_allRelationshipMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_22255_0 ; // Joker input parameter
    GALGAS_string joker_22305_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_22343_9 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_22343_8 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_22343_7 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_22343_6 ; // Joker input parameter
    GALGAS_triggeredKeys joker_22343_5 ; // Joker input parameter
    GALGAS_relationshipList joker_22343_4 ; // Joker input parameter
    GALGAS_relationshipList joker_22343_3 ; // Joker input parameter
    GALGAS_propertyMap joker_22343_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_22343_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_22050.current_mRootEntityName (HERE), joker_22255_0, var_rootEntityImplementationClassName, joker_22305_0, var_observablePropertyMap, joker_22343_9, joker_22343_8, joker_22343_7, joker_22343_6, joker_22343_5, joker_22343_4, joker_22343_3, joker_22343_2, joker_22343_1, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (546)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (556)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerList enumerator_22481 (enumerator_22050.current_mControllerList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_22481.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_controllerClassBindingMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_22601_0 ; // Joker input parameter
      constinArgument_inControllerClassMap.method_searchKey (enumerator_22481.current_mControllerClassName (HERE), joker_22601_0, var_controllerClassBindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (559)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_22694_14 ; // Joker input parameter
      GALGAS_string joker_22694_13 ; // Joker input parameter
      GALGAS_string joker_22694_12 ; // Joker input parameter
      GALGAS_classObservablePropertyMap joker_22694_11 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_22694_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_22694_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_22694_8 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_22694_7 ; // Joker input parameter
      GALGAS_triggeredKeys joker_22694_6 ; // Joker input parameter
      GALGAS_relationshipList joker_22694_5 ; // Joker input parameter
      GALGAS_relationshipList joker_22694_4 ; // Joker input parameter
      GALGAS_propertyMap joker_22694_3 ; // Joker input parameter
      GALGAS_relationshipMap joker_22694_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_22694_1 ; // Joker input parameter
      constinArgument_inEntityMap.method_searchKey (enumerator_22481.current_mControlledClassOrEntityName (HERE), joker_22694_14, joker_22694_13, joker_22694_12, joker_22694_11, joker_22694_10, joker_22694_9, joker_22694_8, joker_22694_7, joker_22694_6, joker_22694_5, joker_22694_4, joker_22694_3, joker_22694_2, joker_22694_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (560)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (561)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_22815 (enumerator_22481.current_mControllerBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_22815.hasCurrentObject ()) {
        ...
        routine_analyzeBoundProperty (enumerator_22815.current_mObservedObjectName (HERE), enumerator_22815.current_mObservableAttributeName (HERE), var_allRelationshipMap, var_observablePropertyMap, var_boundPropertyTypeIdentifierString, var_resultingObservedObjectName, var_resultingObservedPropertyPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (563)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @localVariableDeclarationForGeneration
        ...
        //-------- @methodCallInstructionForGeneration
        var_controllerClassBindingMap.method_searchKey (enumerator_22815.current_mBindingName (HERE), var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (574)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_bool var_found = GALGAS_bool (false) ;
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeAndFormatterList enumerator_23487 (var_acceptableTypeList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (577)).isValidAndTrue () ;
        if (enumerator_23487.hasCurrentObject () && bool_0) {
          while (enumerator_23487.hasCurrentObject () && bool_0) {
            //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
            GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_23487.current_mType (HERE), enumerator_22481.current_mControlledClassOrEntityName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (578)) ;
            //-------- @concatInstructionForGeneration
            var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
              "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (579)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (579)) COMMA_SOURCE_FILE_AT_LINE (579)) ;
            //-------- @assignmentInstructionForGeneration
            ...
            if (enumerator_23487.hasCurrentObject ()) {
              bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (577)).isValidAndTrue () ;
            }
          }
        }
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (582)).boolEnum () ;
        if (kBoolTrue == test_1) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_2 (enumerator_22815.current_mObservableAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundPropertyTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (584)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (584)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (584)) COMMA_SOURCE_FILE_AT_LINE (583)) ;
        }
        //-------- @localVariableDeclarationForGeneration
        GALGAS__32_stringlist var_bindingOptionListForGeneration ;
        { //-------- @routineCallInstructionForGeneration
        routine_checkBindingOptions (enumerator_22815.current_mOutletBindingOptionList (HERE), var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (587)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_bindingListForGeneration.addAssign_operation (enumerator_22815.current_mBindingName (HERE).mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (594)), var_resultingObservedObjectName, var_resultingObservedPropertyPath, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (592)) ;
        enumerator_22815.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_controllerMap.modifier_insertKey (enumerator_22481.current_mControllerName (HERE), enumerator_22481.current_mControllerClassName (HERE).mAttribute_string, enumerator_22481.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_22481.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (608)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_24754 (enumerator_22050.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_24754.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_24846_0 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_24754.current_mOutletType (HERE), joker_24846_0, var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (611)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (612)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_24967 (enumerator_24754.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_24967.hasCurrentObject ()) {
        ...
        GALGAS_easyBindingTypeAndFormatterList var_acceptableTypeFormatterList ;
        //-------- @methodCallInstructionForGeneration
        var_bindingMap.method_searchKey (enumerator_24967.current_mBindingName (HERE), var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (616)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_24967.current_mObservedObjectName (HERE).mAttribute_string.objectCompare (GALGAS_string ("root"))).boolEnum () ;
        if (kBoolTrue == test_3) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_4 (enumerator_24967.current_mObservedObjectName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_4, GALGAS_string ("'root' missing") COMMA_SOURCE_FILE_AT_LINE (619)) ;
        }
        //-------- @localVariableDeclarationForGeneration
        GALGAS_easyBindingType var_observablePropertyType ;
        //-------- @methodCallInstructionForGeneration
        GALGAS_stringlist joker_25522_0 ; // Joker input parameter
        var_observablePropertyMap.method_searchKey (enumerator_24967.current_mObservableAttributeName (HERE), var_observablePropertyType, joker_25522_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (622)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_bool var_found = GALGAS_bool (false) ;
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (625)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeAndFormatterList enumerator_25716 (var_acceptableTypeFormatterList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (626)).isValidAndTrue () ;
        if (enumerator_25716.hasCurrentObject () && bool_5) {
          while (enumerator_25716.hasCurrentObject () && bool_5) {
            //-------- @assignmentInstructionForGeneration
            var_requiredFormatter = enumerator_25716.current_mRequiredFormatter (HERE) ;
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_25716.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
            enumerator_25716.gotoNextObject () ;
            if (enumerator_25716.hasCurrentObject ()) {
              bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (626)).isValidAndTrue () ;
            }
          }
        }
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (630)).boolEnum () ;
        if (kBoolTrue == test_6) {
          //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
          GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (631)) COMMA_SOURCE_FILE_AT_LINE (631)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (631)) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeAndFormatterList enumerator_26056 (var_acceptableTypeFormatterList, kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (632)).isValidAndTrue () ;
          if (enumerator_26056.hasCurrentObject () && bool_7) {
            while (enumerator_26056.hasCurrentObject () && bool_7) {
              //-------- @concatInstructionForGeneration
              var_s.dotAssign_operation (GALGAS_string ("\n"
                "  - '").operator_concat (categoryReader_ebTypeName (enumerator_26056.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (633)) COMMA_SOURCE_FILE_AT_LINE (633)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (633)) COMMA_SOURCE_FILE_AT_LINE (633)) ;
              enumerator_26056.gotoNextObject () ;
              if (enumerator_26056.hasCurrentObject ()) {
                bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (632)).isValidAndTrue () ;
              }
            }
          }
          //-------- @errorInstructionForGeneration
          GALGAS_location location_8 (enumerator_24967.current_mObservableAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_8, var_s COMMA_SOURCE_FILE_AT_LINE (635)) ;
        }
        //-------- @localVariableDeclarationForGeneration
        GALGAS__32_stringlist var_bindingOptionListForGeneration ;
        { //-------- @routineCallInstructionForGeneration
        routine_checkBindingOptions (enumerator_24967.current_mOutletBindingOptionList (HERE), var_outletClassBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (638)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_outletBindingList.addAssign_operation (enumerator_24967.current_mBindingName (HERE).reader_string (SOURCE_FILE_AT_LINE (644)), var_requiredFormatter, GALGAS_string ("mRootObject"), enumerator_24967.current_mObservableAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (647)), var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (643)) ;
        enumerator_24967.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_24754.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (651)), enumerator_24754.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (651)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (651)) ;
      enumerator_24754.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outDocumentMap.modifier_insertKey (enumerator_22050.current_mDocumentName (HERE), enumerator_22050.current_mRootEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (656)), var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (654)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (670)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_27207 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_27207.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_classObservablePropertyMap var_classObservablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (673)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_27207.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (674)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_27442_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_27506_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_27506_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_27506_2 ; // Joker input parameter
      GALGAS_triggeredKeys joker_27506_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_27207.current_mSuperClassName (HERE), joker_27442_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_27506_4, joker_27506_3, joker_27506_2, joker_27506_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (675)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (677)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (678)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (680)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (681)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (683)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_28053 (enumerator_27207.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_28053.hasCurrentObject ()) {
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_28053.current_mType (HERE), enumerator_28053.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (685)), enumerator_28053.current_mDefaultValueObjectiveCObject (HERE), enumerator_28053.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (685)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_28053.current_mType (HERE), enumerator_28053.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (686)), enumerator_28053.current_mDefaultValueObjectiveCObject (HERE), enumerator_28053.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (686)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_28053.current_mPropertyName (HERE), enumerator_28053.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_28053.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (687)) COMMA_SOURCE_FILE_AT_LINE (687)), inCompiler COMMA_SOURCE_FILE_AT_LINE (687)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_28053.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_28515 (enumerator_27207.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_28515.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (691)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (692)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_28669 (enumerator_28515.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_28669.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_easyBindingType var_type ;
        //-------- @localVariableDeclarationForGeneration
        GALGAS_stringlist var_propertyDependancyList ;
        //-------- @methodCallInstructionForGeneration
        var_classObservablePropertyMap.method_searchKey (enumerator_28669.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (696)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_28669.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (697)) COMMA_SOURCE_FILE_AT_LINE (697)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_28932 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_28932.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_28932.current_mValue (HERE), enumerator_28515.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (699)) COMMA_SOURCE_FILE_AT_LINE (699)) ;
          enumerator_28932.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (701)) ;
        enumerator_28669.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_28515.current_mType (HERE), enumerator_28515.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (703)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (703)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_28515.current_mTransientName (HERE), enumerator_28515.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (704)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_28515.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_27207.current_mClassName (HERE), enumerator_27207.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (709)), var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_triggeredKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (707)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (726)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_29934 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29934.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (729)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_30031 (enumerator_29934.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_30031.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (731)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_30143 (enumerator_30031.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_30143.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_30143.current_mBindingOptionName (HERE), enumerator_30143.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (733)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_30143.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_30031.current_mBindingName (HERE), enumerator_30031.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (739)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_30031.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_29934.current_mOutletClassName (HERE), enumerator_29934.current_mGenerateCode (HERE), var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (742)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_29934.gotoNextObject () ;
  }
}
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (752)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_30892 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_30892.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (755)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_30978 (enumerator_30892.current_mBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_30978.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (757)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_31090 (enumerator_30978.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_31090.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_31090.current_mBindingOptionName (HERE), enumerator_31090.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (759)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_31090.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_30978.current_mBindingName (HERE), enumerator_30978.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (765)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_30978.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outControllerClassMap.modifier_insertKey (enumerator_30892.current_mOutletClassName (HERE), enumerator_30892.current_mGenerateCode (HERE), var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (768)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  outArgument_outDocumentMap.drop () ; // Release 'out' argument
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (783)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (784)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (785)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (786)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (787)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outDocumentMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (788)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
GALGAS_string categoryReader_ebTypeIdentifier (const GALGAS_easyBindingType & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inClassOrEntityName COMMA_SOURCE_FILE_AT_LINE (460)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (460)) ;
      } break ;
    }
  }
//---
