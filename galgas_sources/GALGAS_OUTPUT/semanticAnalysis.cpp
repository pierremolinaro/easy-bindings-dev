...
void routine_analyzeEntity (const GALGAS_entityList_2E_element constinArgument_inEntity,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_string joker_12443_0 ; // Joker input parameter
    GALGAS_string joker_12488_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_12565_4 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_12565_3 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_12565_2 ; // Joker input parameter
    GALGAS_relationshipList joker_12565_1 ; // Joker input parameter
    GALGAS_relationshipMap joker_12624_0 ; // Joker input parameter
    GALGAS_stringset joker_12659_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_12659_1 ; // Joker input parameter
    ioArgument_ioEntityMap.method_searchKey (constinArgument_inEntity.mAttribute_mSuperEntityName, joker_12443_0, var_implementationSuperClassName, joker_12488_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_12565_4, joker_12565_3, joker_12565_2, joker_12565_1, var_allRelationshipList, var_allPropertyMap, joker_12624_0, var_allRelationshipMap, joker_12659_2, joker_12659_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (303)) ;
  ...
  cEnumerator_attributeList enumerator_13334 (constinArgument_inEntity.mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_13334.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_checkDefaultValueType (enumerator_13334.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_13334.current_mType (HERE), enumerator_13334.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (329)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_allPropertyMap.modifier_insertKey (enumerator_13334.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (330)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_attributeListForImplementation.addAssign_operation (enumerator_13334.current_mType (HERE), enumerator_13334.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (331)), enumerator_13334.current_mDefaultValueObjectiveCObject (HERE), enumerator_13334.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (331)) ;
    //-------- @plusEqualnstructionForGeneration
    var_propertyListForInitMethodHeader.addAssign_operation (enumerator_13334.current_mType (HERE), enumerator_13334.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (332)), enumerator_13334.current_mDefaultValueObjectiveCObject (HERE), enumerator_13334.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (332)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("entity.").operator_concat (constinArgument_inEntity.mAttribute_mEntityName.reader_string (SOURCE_FILE_AT_LINE (334)) COMMA_SOURCE_FILE_AT_LINE (334)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (334)).operator_concat (enumerator_13334.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (334)) COMMA_SOURCE_FILE_AT_LINE (334)), enumerator_13334.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (333)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_13334.current_mAttributeName (HERE), enumerator_13334.current_mType (HERE), GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (337)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_relationshipList enumerator_14360 (constinArgument_inEntity.mAttribute_mRelationshipList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_14360.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_allRelationshipMap.modifier_insertKey (enumerator_14360.current_mRelationshipName (HERE), enumerator_14360.current_mIsToMany (HERE), enumerator_14360.current_mDestinationEntityName (HERE), enumerator_14360.current_mInverseRelationshipName (HERE), enumerator_14360.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (351)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_currentRelationshipMap.modifier_insertKey (enumerator_14360.current_mRelationshipName (HERE), enumerator_14360.current_mIsToMany (HERE), enumerator_14360.current_mDestinationEntityName (HERE), enumerator_14360.current_mInverseRelationshipName (HERE), enumerator_14360.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (358)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_allPropertyMap.modifier_insertKey (enumerator_14360.current_mRelationshipName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (365)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("entity.").operator_concat (constinArgument_inEntity.mAttribute_mEntityName.reader_string (SOURCE_FILE_AT_LINE (367)) COMMA_SOURCE_FILE_AT_LINE (367)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (367)).operator_concat (enumerator_14360.current_mRelationshipName (HERE).reader_string (SOURCE_FILE_AT_LINE (367)) COMMA_SOURCE_FILE_AT_LINE (367)), enumerator_14360.current_mRelationshipName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (366)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_14360.current_mRelationshipName (HERE), GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (372)), GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (370)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_relationshipList enumerator_15988 (constinArgument_inEntity.mAttribute_mRelationshipList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_15988.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = enumerator_15988.current_mIsToMany (HERE).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @plusEqualnstructionForGeneration
      var_toManyRelationshipList.addAssign_operation (enumerator_15988.current_mRelationshipName (HERE).mAttribute_string, enumerator_15988.current_mDestinationEntityName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (400)) ;
    }
...
void routine_analyzeEntities (const GALGAS_entityList constinArgument_inEntityList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityList enumerator_17258 (constinArgument_inEntityList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17258.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeEntity (enumerator_17258.current (HERE), outArgument_outEntityMap, constinArgument_inPreferencesMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (438)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_17258.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityMap enumerator_17467 (outArgument_outEntityMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17467.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipMap enumerator_17506 (enumerator_17467.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_17506.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_17622_12 ; // Joker input parameter
      GALGAS_string joker_17622_11 ; // Joker input parameter
      GALGAS_string joker_17622_10 ; // Joker input parameter
      GALGAS_observablePropertyMap joker_17622_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_17622_8 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_17622_7 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_17622_6 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_17622_5 ; // Joker input parameter
      GALGAS_relationshipList joker_17622_4 ; // Joker input parameter
      GALGAS_relationshipList joker_17622_3 ; // Joker input parameter
      GALGAS_propertyMap joker_17622_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_17622_1 ; // Joker input parameter
      GALGAS_stringset joker_17660_2 ; // Joker input parameter
      GALGAS__32_stringlist joker_17660_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_17506.current_mDestinationEntityName (HERE), joker_17622_12, joker_17622_11, joker_17622_10, joker_17622_9, joker_17622_8, joker_17622_7, joker_17622_6, joker_17622_5, joker_17622_4, joker_17622_3, joker_17622_2, joker_17622_1, var_destinationEntityRelationshipMap, joker_17660_2, joker_17660_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (449)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_inverseOfInverseRelationshipName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_17793_2 ; // Joker input parameter
      GALGAS_lstring joker_17793_1 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_17831_0 ; // Joker input parameter
      var_destinationEntityRelationshipMap.method_searchKey (enumerator_17506.current_mInverseRelationshipName (HERE), joker_17793_2, joker_17793_1, var_inverseOfInverseRelationshipName, joker_17831_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (451)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_17506.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_1 (enumerator_17506.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_1, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_17506.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (453)) COMMA_SOURCE_FILE_AT_LINE (453)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (453)) COMMA_SOURCE_FILE_AT_LINE (453)) ;
      }
...
void routine_analyzePreference (const GALGAS_preferencesDeclarationList_2E_element constinArgument_inPreference,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_42360 (constinArgument_inPreference.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_42360.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_actionMap.modifier_insertKey (enumerator_42360.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1083)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_42360.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeList enumerator_42662 (constinArgument_inPreference.mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_42662.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_checkDefaultValueType (enumerator_42662.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_42662.current_mType (HERE), enumerator_42662.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1089)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_attributeListForImplementation.addAssign_operation (enumerator_42662.current_mType (HERE), enumerator_42662.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1090)), enumerator_42662.current_mDefaultValueObjectiveCObject (HERE), enumerator_42662.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1090)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("preference.").operator_concat (constinArgument_inPreference.mAttribute_mPreferencesName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1092)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1092)).operator_concat (enumerator_42662.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1092)) COMMA_SOURCE_FILE_AT_LINE (1092)), enumerator_42662.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1091)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableAttributeMap.modifier_insertKey (enumerator_42662.current_mAttributeName (HERE), enumerator_42662.current_mType (HERE), GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1095)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletDeclarationList enumerator_44110 (constinArgument_inPreference.mAttribute_mOutletDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_44110.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_44208_2 ; // Joker input parameter
    GALGAS_lstringlist joker_44208_1 ; // Joker input parameter
    constinArgument_inOutletClassMap.method_searchKey (enumerator_44110.current_mOutletType (HERE), var_generationKind, joker_44208_2, joker_44208_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1124)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_generationKind.objectCompare (GALGAS_generationKind::constructor_noGeneration (SOURCE_FILE_AT_LINE (1131)))).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @plusEqualnstructionForGeneration
      var_implementationFileInclusionSet.addAssign_operation (enumerator_44110.current_mOutletType (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1132)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1134)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_44531 (enumerator_44110.current_mOutletBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_44531.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_44531.current_mBinding (HERE).ptr (), GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1137)), var_observableAttributeMap, GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1139)), GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1140)), var_bindingMap, GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1142)), var_actionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1136)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_44531.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_outletGenerationList.addAssign_operation (enumerator_44110.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1149)), var_generationKind, enumerator_44110.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1149)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1149)) ;
    enumerator_44110.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1152)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioPreferencesMap.modifier_insertKey (constinArgument_inPreference.mAttribute_mPreferencesName, var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, constinArgument_inPreference.mAttribute_mActionDeclarationList, var_observableAttributeMap, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1153)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_analyzePreferences (const GALGAS_preferencesDeclarationList constinArgument_inPreferencesList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1172)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_45834 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_45834.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzePreference (enumerator_45834.current (HERE), constinArgument_inOutletClassMap, outArgument_outPreferencesMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1174)) ;
    } //-------- @routineCallInstructionForGeneration
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outBindingOptionListForGeneration = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1190)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_46373 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_46373.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_46373.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1193)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_46562 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1195)).isValidAndTrue () ;
    if (enumerator_46562.hasCurrentObject () && bool_0) {
      while (enumerator_46562.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_46626 (enumerator_46373.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1196)).isValidAndTrue () ;
        if (enumerator_46626.hasCurrentObject () && bool_1) {
          while (enumerator_46626.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_46562.current_mType (HERE).objectCompare (enumerator_46626.current_mType (HERE))) ;
            enumerator_46626.gotoNextObject () ;
            if (enumerator_46626.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1196)).isValidAndTrue () ;
            }
          }
        }
        enumerator_46562.gotoNextObject () ;
        if (enumerator_46562.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1195)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (1200)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_46865 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (1202)).isValidAndTrue () ;
      if (enumerator_46865.hasCurrentObject () && bool_3) {
        while (enumerator_46865.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_46865.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1203)) COMMA_SOURCE_FILE_AT_LINE (1203)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1203)) COMMA_SOURCE_FILE_AT_LINE (1203)) ;
          enumerator_46865.gotoNextObject () ;
          if (enumerator_46865.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (1202)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_46373.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (1205)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_46373.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (1207)), enumerator_46373.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (1207)) ;
    enumerator_46373.gotoNextObject () ;
  }
}
...
void routine_analyzeDocument (const GALGAS_documentDeclarationList_2E_element constinArgument_inDocument,
  ...
  GALGAS_relationshipMap var_allRelationshipMap ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_57914_0 ; // Joker input parameter
  GALGAS_string joker_57968_0 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_58035_8 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_58035_7 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_58035_6 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_58035_5 ; // Joker input parameter
  GALGAS_relationshipList joker_58035_4 ; // Joker input parameter
  GALGAS_relationshipList joker_58035_3 ; // Joker input parameter
  GALGAS_propertyMap joker_58035_2 ; // Joker input parameter
  GALGAS_relationshipMap joker_58035_1 ; // Joker input parameter
  GALGAS_stringset joker_58084_2 ; // Joker input parameter
  GALGAS__32_stringlist joker_58084_1 ; // Joker input parameter
  constinArgument_inEntityMap.method_searchKey (constinArgument_inDocument.mAttribute_mRootEntityName, joker_57914_0, var_rootEntityImplementationClassName, joker_57968_0, var_rootObjectObservablePropertyMap, joker_58035_8, joker_58035_7, joker_58035_6, joker_58035_5, joker_58035_4, joker_58035_3, joker_58035_2, joker_58035_1, var_allRelationshipMap, joker_58084_2, joker_58084_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1464)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1475)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1476)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerList enumerator_58308 (constinArgument_inDocument.mAttribute_mControllerList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_58308.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_58534_0 ; // Joker input parameter
    constinArgument_inControllerClassMap.method_searchKey (enumerator_58308.current_mControllerClassName (HERE), joker_58534_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1481)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_prefixedControllerObservablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1488)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_observablePropertyMap enumerator_58768 (var_controllerObservablePropertyMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_58768.hasCurrentObject ()) {
      enumerator_58768.gotoNextObject () ;
    }
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_59466_15 ; // Joker input parameter
    GALGAS_string joker_59466_14 ; // Joker input parameter
    GALGAS_string joker_59466_13 ; // Joker input parameter
    GALGAS_observablePropertyMap joker_59466_12 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_59466_11 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_59466_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_59466_9 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_59466_8 ; // Joker input parameter
    GALGAS_relationshipList joker_59466_7 ; // Joker input parameter
    GALGAS_relationshipList joker_59466_6 ; // Joker input parameter
    GALGAS_propertyMap joker_59466_5 ; // Joker input parameter
    GALGAS_relationshipMap joker_59466_4 ; // Joker input parameter
    GALGAS_relationshipMap joker_59466_3 ; // Joker input parameter
    GALGAS_stringset joker_59466_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_59466_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_58308.current_mControlledClassOrEntityName (HERE), joker_59466_15, joker_59466_14, joker_59466_13, joker_59466_12, joker_59466_11, joker_59466_10, joker_59466_9, joker_59466_8, joker_59466_7, joker_59466_6, joker_59466_5, joker_59466_4, joker_59466_3, joker_59466_2, joker_59466_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1511)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1512)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_59583 (enumerator_58308.current_mControllerBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_59583.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_59583.current_mBinding (HERE).ptr (), var_allRelationshipMap, var_controllerClassBindingMap, enumerator_58308.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1514)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_59583.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_controllerMap.modifier_insertKey (enumerator_58308.current_mControllerName (HERE), enumerator_58308.current_mControllerClassName (HERE).mAttribute_string, enumerator_58308.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1522)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_58308.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1533)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeTransientProperties (constinArgument_inPreferencesMap, GALGAS_string ("document.").operator_concat (constinArgument_inDocument.mAttribute_mDocumentName.reader_string (SOURCE_FILE_AT_LINE (1536)) COMMA_SOURCE_FILE_AT_LINE (1536)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1536)), constinArgument_inDocument.mAttribute_mTransientList, var_rootObjectObservablePropertyMap, constinArgument_inDocument.mAttribute_mRootEntityName.mAttribute_string, var_controllerMap, var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1534)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_actionMap var_documentActionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1547)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_60820 (constinArgument_inDocument.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_60820.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_documentActionMap.modifier_insertKey (enumerator_60820.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1549)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_60820.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1552)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletDeclarationList enumerator_61079 (constinArgument_inDocument.mAttribute_mOutletDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_61079.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_generationKind var_generationKind ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_outletClassBindingMap var_bindingMap ;
    ...
    GALGAS_bool var_hasTableValueBinding ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_61177_2 ; // Joker input parameter
    GALGAS_lstringlist joker_61177_1 ; // Joker input parameter
    constinArgument_inOutletClassMap.method_searchKey (enumerator_61079.current_mOutletType (HERE), var_generationKind, joker_61177_2, joker_61177_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1554)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1561)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_61363 (enumerator_61079.current_mOutletBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_61363.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_61363.current_mBinding (HERE).ptr (), var_rootObjectObservablePropertyMap, var_observablePropertyMap, constinArgument_inPreferencesMap, constinArgument_inEntityMap, var_bindingMap, var_controllerMap, var_documentActionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1563)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_61363.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_outletGenerationList.addAssign_operation (enumerator_61079.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1576)), var_generationKind, enumerator_61079.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1576)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1576)) ;
    enumerator_61079.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1579)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1603)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_62782 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_62782.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeDocument (enumerator_62782.current (HERE), constinArgument_inOutletClassMap, constinArgument_inControllerClassMap, constinArgument_inEntityMap, constinArgument_inPreferencesMap, outArgument_outDocumentMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1605)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_62782.gotoNextObject () ;
  }
}
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_63346 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1625)).isValidAndTrue () ;
  if (enumerator_63346.hasCurrentObject () && bool_0) {
    while (enumerator_63346.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_63346.current_mType (HERE))) ;
      enumerator_63346.gotoNextObject () ;
      if (enumerator_63346.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1625)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1628)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (1629)) ;
  }
}
...
void routine_analyzeClass (const GALGAS_classList_2E_element constinArgument_inClass,
  ...
  GALGAS_observablePropertyMap var_observablePropertyMap ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1642)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, constinArgument_inClass.mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (1643)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_64049_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_64108_4 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_64108_3 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_64108_2 ; // Joker input parameter
    GALGAS_stringset joker_64108_1 ; // Joker input parameter
    ioArgument_ioClassMap.method_searchKey (constinArgument_inClass.mAttribute_mSuperClassName, joker_64049_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_64108_4, joker_64108_3, joker_64108_2, joker_64108_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1644)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @assignmentInstructionForGeneration
    var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1646)) ;
    //-------- @assignmentInstructionForGeneration
    var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1647)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1650)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeList enumerator_64568 (constinArgument_inClass.mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_64568.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_checkDefaultValueType (enumerator_64568.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_64568.current_mType (HERE), enumerator_64568.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1653)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_attributeListForImplementation.addAssign_operation (enumerator_64568.current_mType (HERE), enumerator_64568.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1654)), enumerator_64568.current_mDefaultValueObjectiveCObject (HERE), enumerator_64568.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1654)) ;
    //-------- @plusEqualnstructionForGeneration
    var_propertyListForInitMethodHeader.addAssign_operation (enumerator_64568.current_mType (HERE), enumerator_64568.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1655)), enumerator_64568.current_mDefaultValueObjectiveCObject (HERE), enumerator_64568.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1655)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("class.").operator_concat (constinArgument_inClass.mAttribute_mClassName.reader_string (SOURCE_FILE_AT_LINE (1657)) COMMA_SOURCE_FILE_AT_LINE (1657)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1657)).operator_concat (enumerator_64568.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1657)) COMMA_SOURCE_FILE_AT_LINE (1657)), enumerator_64568.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1656)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_64568.current_mAttributeName (HERE), enumerator_64568.current_mType (HERE), GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1660)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1666)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_64568.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1673)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeTransientProperties (GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1675)), GALGAS_string ("class.").operator_concat (constinArgument_inClass.mAttribute_mClassName.reader_string (SOURCE_FILE_AT_LINE (1676)) COMMA_SOURCE_FILE_AT_LINE (1676)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1676)), constinArgument_inClass.mAttribute_mTransientList, GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1678)), GALGAS_string::makeEmptyString (), GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1680)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1674)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1687)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1707)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_66638 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_66638.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeClass (enumerator_66638.current (HERE), outArgument_outClassMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1709)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_66638.gotoNextObject () ;
  }
}
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1724)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_67064 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_67064.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1727)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_67161 (enumerator_67064.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_67161.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1729)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_67273 (enumerator_67161.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_67273.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_67273.current_mBindingOptionName (HERE), enumerator_67273.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1731)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_67273.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_67161.current_mBindingName (HERE), enumerator_67161.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1733)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_67161.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_67571 (enumerator_67064.current_mAdoptedProtocolList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_67571.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      constinArgument_inProtocolMap.method_searchKey (enumerator_67571.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1737)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_67571.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_67064.current_mOutletClassName (HERE), enumerator_67064.current_mGeneration (HERE), enumerator_67064.current_mSuperClassName (HERE).mAttribute_string, enumerator_67064.current_mAdoptedProtocolList (HERE), var_bindingMap, enumerator_67064.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1740)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_67064.gotoNextObject () ;
  }
}
...
void routine_analyzeControllerClass (const GALGAS_controllerClassList_2E_element constinArgument_inController,
                                     ...
                                     COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1759)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_68245 (constinArgument_inController.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_68245.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_actionMap.modifier_insertKey (enumerator_68245.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1761)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_68245.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1764)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassBindingList enumerator_68401 (constinArgument_inController.mAttribute_mBindingList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_68401.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1766)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingOptionList enumerator_68509 (enumerator_68401.current_mBindingOptionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_68509.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_outletClassBindingOptionMap.modifier_insertKey (enumerator_68509.current_mBindingOptionName (HERE), enumerator_68509.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1768)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_68509.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_bindingMap.modifier_insertKey (enumerator_68401.current_mBindingName (HERE), enumerator_68401.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1774)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_68401.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1777)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerObservablePropertyList enumerator_68955 (constinArgument_inController.mAttribute_mControllerObservablePropertyList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_68955.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("controller.").operator_concat (constinArgument_inController.mAttribute_mControllerClassName.reader_string (SOURCE_FILE_AT_LINE (1780)) COMMA_SOURCE_FILE_AT_LINE (1780)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1780)).operator_concat (enumerator_68955.current (HERE).mAttribute_mPropertyName.reader_string (SOURCE_FILE_AT_LINE (1780)) COMMA_SOURCE_FILE_AT_LINE (1780)), enumerator_68955.current (HERE).mAttribute_mPropertyName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1779)) ;
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1783)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_68955.current (HERE).mAttribute_mPropertyName, enumerator_68955.current (HERE).mAttribute_mType, GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1787)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_68955.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioControllerClassMap.modifier_insertKey (constinArgument_inController.mAttribute_mControllerClassName, constinArgument_inController.mAttribute_mGenerateCode, var_bindingMap, var_actionMap, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1795)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1811)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_70018 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_70018.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeControllerClass (enumerator_70018.current (HERE), ioArgument_ioTransientDependencyGraph, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1813)) ;
    } //-------- @routineCallInstructionForGeneration
...
void routine_semanticAnalysis (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_protocolMap var_protocolMap = GALGAS_protocolMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1843)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_protocolList enumerator_70993 (constinArgument_inProtocolList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_70993.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_protocolMap.modifier_insertKey (enumerator_70993.current_mProtocolName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1845)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_70993.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outSortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1848)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (1849)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inOutletClassList, var_protocolMap, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1850)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inControllerClassList, var_transientDependencyGraph, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1851)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (constinArgument_inPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1852)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inClassList, outArgument_outClassMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1858)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inEntityList, outArgument_outEntityMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1863)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outPreferencesMap, outArgument_outDocumentMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1869)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1879)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (1879)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = var_transientDependencyGraph.reader_graphviz (SOURCE_FILE_AT_LINE (1880)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_path = inArgument_inSourceFilePath.operator_concat (GALGAS_string (".transientDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (1881)) ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_72210_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_72210_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1882)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outTransientDependencyArcList = var_transientDependencyGraph.reader_arcs (SOURCE_FILE_AT_LINE (1885)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1886)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_transientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (1887)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_72490 (var_transientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (1888)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_72490.hasCurrentObject ()) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_72490.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1889)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (1889)) COMMA_SOURCE_FILE_AT_LINE (1889)) ;
        enumerator_72490.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_2) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_stringlist var_unsortedTransientList ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstringlist joker_72742_0 ; // Joker input parameter
      GALGAS_lstringlist joker_72784_0 ; // Joker input parameter
      var_transientDependencyGraph.method_topologicalSort (outArgument_outSortedTransientOrderedList, joker_72742_0, var_unsortedTransientList, joker_72784_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1893)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1899)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1900)).reader_string (SOURCE_FILE_AT_LINE (1900)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:") COMMA_SOURCE_FILE_AT_LINE (1900)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_73014 (var_unsortedTransientList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_73014.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_73014.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1902)) COMMA_SOURCE_FILE_AT_LINE (1902)) ;
          enumerator_73014.gotoNextObject () ;
        }
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (1904)) ;
      }
    }
  }
}
...
static void categoryMethod_tableValueBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_19566_0 ; // Joker input parameter
    GALGAS_actionMap joker_19639_0 ; // Joker input parameter
    GALGAS_observablePropertyMap joker_19648_0 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_19566_0, var_controlledClassOrEntityName, var_controllerBindingList, joker_19639_0, joker_19648_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (493)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_19749_3 ; // Joker input parameter
    GALGAS_string joker_19749_2 ; // Joker input parameter
    GALGAS_string joker_19749_1 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_19812_11 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_19812_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_19812_9 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_19812_8 ; // Joker input parameter
    GALGAS_relationshipList joker_19812_7 ; // Joker input parameter
    GALGAS_relationshipList joker_19812_6 ; // Joker input parameter
    GALGAS_propertyMap joker_19812_5 ; // Joker input parameter
    GALGAS_relationshipMap joker_19812_4 ; // Joker input parameter
    GALGAS_relationshipMap joker_19812_3 ; // Joker input parameter
    GALGAS_stringset joker_19812_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_19812_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (GALGAS_lstring::constructor_new (var_controlledClassOrEntityName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (502)), joker_19749_3, joker_19749_2, joker_19749_1, var_observablePropertyMap, joker_19812_11, joker_19812_10, joker_19812_9, joker_19812_8, joker_19812_7, joker_19812_6, joker_19812_5, joker_19812_4, joker_19812_3, joker_19812_2, joker_19812_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (501)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_tableValueColumnBinding enumerator_19980 (object->mAttribute_mTableValueColumnBinding, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_19980.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingType var_type ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_20097_0 ; // Joker input parameter
      GALGAS_string joker_20108_0 ; // Joker input parameter
      var_observablePropertyMap.method_searchKey (enumerator_19980.current (HERE).mAttribute_mBoundPropertyName, var_type, joker_20097_0, joker_20108_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (509)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      ...
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_19980.current (HERE).mAttribute_mBoundPropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_requiredCellTypeInTableColumnBinding.objectCompare (enumerator_19980.current (HERE).mAttribute_mCellTypeName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_19980.current (HERE).mAttribute_mCellTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      //-------- @plusEqualnstructionForGeneration
      var_columnBindingForTableValueBindingForGeneration.addAssign_operation (enumerator_19980.current (HERE).mAttribute_mColumnName.mAttribute_string, var_requiredCellTypeInTableColumnBinding, enumerator_19980.current (HERE).mAttribute_mBoundPropertyName.mAttribute_string, GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (525)) COMMA_SOURCE_FILE_AT_LINE (521)) ;
...
static void categoryMethod_runBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_21817_3 ; // Joker input parameter
    GALGAS_string joker_21817_2 ; // Joker input parameter
    GALGAS_outletBindingListForGeneration joker_21817_1 ; // Joker input parameter
    GALGAS_observablePropertyMap joker_21832_0 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mTargetName, joker_21817_3, joker_21817_2, joker_21817_1, var_actionMap, joker_21832_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (553)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
...
static void categoryMethod_regularControllerBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_23012_4 ; // Joker input parameter
  GALGAS_string joker_23012_3 ; // Joker input parameter
  GALGAS_outletBindingListForGeneration joker_23012_2 ; // Joker input parameter
  GALGAS_actionMap joker_23012_1 ; // Joker input parameter
  constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_23012_4, joker_23012_3, joker_23012_2, joker_23012_1, var_observableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (583)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_23906 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (607)).isValidAndTrue () ;
  if (enumerator_23906.hasCurrentObject () && bool_3) {
    while (enumerator_23906.hasCurrentObject () && bool_3) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_23906.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_23906.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_23906.gotoNextObject () ;
      if (enumerator_23906.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_4) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_24210 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (613)).isValidAndTrue () ;
    if (enumerator_24210.hasCurrentObject () && bool_5) {
      while (enumerator_24210.hasCurrentObject () && bool_5) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_24210.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (614)) COMMA_SOURCE_FILE_AT_LINE (614)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (614)) COMMA_SOURCE_FILE_AT_LINE (614)) ;
        enumerator_24210.gotoNextObject () ;
        if (enumerator_24210.hasCurrentObject ()) {
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_24445 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_24445.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_24445.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (622)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_24634 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (624)).isValidAndTrue () ;
    if (enumerator_24634.hasCurrentObject () && bool_7) {
      while (enumerator_24634.hasCurrentObject () && bool_7) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_24698 (enumerator_24445.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (625)).isValidAndTrue () ;
        if (enumerator_24698.hasCurrentObject () && bool_8) {
          while (enumerator_24698.hasCurrentObject () && bool_8) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_24634.current_mType (HERE).objectCompare (enumerator_24698.current_mType (HERE))) ;
            enumerator_24698.gotoNextObject () ;
            if (enumerator_24698.hasCurrentObject ()) {
              bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (625)).isValidAndTrue () ;
            }
          }
        }
        enumerator_24634.gotoNextObject () ;
        if (enumerator_24634.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_9) {
      ...
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_24937 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (631)).isValidAndTrue () ;
      if (enumerator_24937.hasCurrentObject () && bool_10) {
        while (enumerator_24937.hasCurrentObject () && bool_10) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_24937.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (632)) COMMA_SOURCE_FILE_AT_LINE (632)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (632)) COMMA_SOURCE_FILE_AT_LINE (632)) ;
          enumerator_24937.gotoNextObject () ;
          if (enumerator_24937.hasCurrentObject ()) {
            bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (631)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_11 (enumerator_24445.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_11, var_s COMMA_SOURCE_FILE_AT_LINE (634)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_24445.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (636)), enumerator_24445.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (636)) ;
...
static void categoryMethod_regularRootBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_easyBindingType var_observablePropertyType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_26494_0 ; // Joker input parameter
  GALGAS_string joker_26501_0 ; // Joker input parameter
  constinArgument_inRootEntityObservableAttributeMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_26494_0, joker_26501_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (668)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_27177 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (687)).isValidAndTrue () ;
  if (enumerator_27177.hasCurrentObject () && bool_3) {
    while (enumerator_27177.hasCurrentObject () && bool_3) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_27177.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_27177.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_27177.gotoNextObject () ;
      if (enumerator_27177.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_4) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_27481 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (693)).isValidAndTrue () ;
    if (enumerator_27481.hasCurrentObject () && bool_5) {
      while (enumerator_27481.hasCurrentObject () && bool_5) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_27481.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (694)) COMMA_SOURCE_FILE_AT_LINE (694)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (694)) COMMA_SOURCE_FILE_AT_LINE (694)) ;
        enumerator_27481.gotoNextObject () ;
        if (enumerator_27481.hasCurrentObject ()) {
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_27754 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_27754.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_27754.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (702)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_27943 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (704)).isValidAndTrue () ;
    if (enumerator_27943.hasCurrentObject () && bool_7) {
      while (enumerator_27943.hasCurrentObject () && bool_7) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_28007 (enumerator_27754.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (705)).isValidAndTrue () ;
        if (enumerator_28007.hasCurrentObject () && bool_8) {
          while (enumerator_28007.hasCurrentObject () && bool_8) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_27943.current_mType (HERE).objectCompare (enumerator_28007.current_mType (HERE))) ;
            enumerator_28007.gotoNextObject () ;
            if (enumerator_28007.hasCurrentObject ()) {
              bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (705)).isValidAndTrue () ;
            }
          }
        }
        enumerator_27943.gotoNextObject () ;
        if (enumerator_27943.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_9) {
      ...
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_28246 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (711)).isValidAndTrue () ;
      if (enumerator_28246.hasCurrentObject () && bool_10) {
        while (enumerator_28246.hasCurrentObject () && bool_10) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_28246.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (712)) COMMA_SOURCE_FILE_AT_LINE (712)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (712)) COMMA_SOURCE_FILE_AT_LINE (712)) ;
          enumerator_28246.gotoNextObject () ;
          if (enumerator_28246.hasCurrentObject ()) {
            bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (711)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_11 (enumerator_27754.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_11, var_s COMMA_SOURCE_FILE_AT_LINE (714)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_27754.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (716)), enumerator_27754.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (716)) ;
...
static void categoryMethod_regularSelfBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_easyBindingType var_observablePropertyType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_29843_0 ; // Joker input parameter
  GALGAS_string joker_29850_0 ; // Joker input parameter
  constinArgument_inSelfObservableAttributeMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_29843_0, joker_29850_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (749)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_observableKeyPath = object->mAttribute_mObservableAttributeName.mAttribute_string ;
  //-------- @ifInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_30526 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (768)).isValidAndTrue () ;
  if (enumerator_30526.hasCurrentObject () && bool_3) {
    while (enumerator_30526.hasCurrentObject () && bool_3) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_30526.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_30526.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_30526.gotoNextObject () ;
      if (enumerator_30526.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_4) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_30830 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (774)).isValidAndTrue () ;
    if (enumerator_30830.hasCurrentObject () && bool_5) {
      while (enumerator_30830.hasCurrentObject () && bool_5) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_30830.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (775)) COMMA_SOURCE_FILE_AT_LINE (775)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (775)) COMMA_SOURCE_FILE_AT_LINE (775)) ;
        enumerator_30830.gotoNextObject () ;
        if (enumerator_30830.hasCurrentObject ()) {
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_31103 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_31103.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_31103.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (783)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_31292 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (785)).isValidAndTrue () ;
    if (enumerator_31292.hasCurrentObject () && bool_7) {
      while (enumerator_31292.hasCurrentObject () && bool_7) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_31356 (enumerator_31103.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (786)).isValidAndTrue () ;
        if (enumerator_31356.hasCurrentObject () && bool_8) {
          while (enumerator_31356.hasCurrentObject () && bool_8) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_31292.current_mType (HERE).objectCompare (enumerator_31356.current_mType (HERE))) ;
            enumerator_31356.gotoNextObject () ;
            if (enumerator_31356.hasCurrentObject ()) {
              bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (786)).isValidAndTrue () ;
            }
          }
        }
        enumerator_31292.gotoNextObject () ;
        if (enumerator_31292.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_9) {
      ...
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_31595 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (792)).isValidAndTrue () ;
      if (enumerator_31595.hasCurrentObject () && bool_10) {
        while (enumerator_31595.hasCurrentObject () && bool_10) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_31595.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (793)) COMMA_SOURCE_FILE_AT_LINE (793)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (793)) COMMA_SOURCE_FILE_AT_LINE (793)) ;
          enumerator_31595.gotoNextObject () ;
          if (enumerator_31595.hasCurrentObject ()) {
            bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (792)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_11 (enumerator_31103.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_11, var_s COMMA_SOURCE_FILE_AT_LINE (795)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_31103.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (797)), enumerator_31103.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (797)) ;
...
static void categoryMethod_regularPreferenceBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_observablePropertyMap var_observablePropertyMap ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_attributeListForImplementation joker_33162_4 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_33162_3 ; // Joker input parameter
  GALGAS_outletGenerationList joker_33162_2 ; // Joker input parameter
  GALGAS_lstringlist joker_33162_1 ; // Joker input parameter
  GALGAS_stringset joker_33220_0 ; // Joker input parameter
  constinArgument_inPreferencesMap.method_searchKey (object->mAttribute_mPreferenceName, joker_33162_4, joker_33162_3, joker_33162_2, joker_33162_1, var_observablePropertyMap, joker_33220_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (831)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_observablePropertyType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_33443_0 ; // Joker input parameter
  GALGAS_string joker_33450_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceAttributeName, var_observablePropertyType, joker_33443_0, joker_33450_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (838)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_33661 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (847)).isValidAndTrue () ;
  if (enumerator_33661.hasCurrentObject () && bool_0) {
    while (enumerator_33661.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_33661.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_33661.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_33661.gotoNextObject () ;
      if (enumerator_33661.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_1) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_33965 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (853)).isValidAndTrue () ;
    if (enumerator_33965.hasCurrentObject () && bool_2) {
      while (enumerator_33965.hasCurrentObject () && bool_2) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_33965.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (854)) COMMA_SOURCE_FILE_AT_LINE (854)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (854)) COMMA_SOURCE_FILE_AT_LINE (854)) ;
        enumerator_33965.gotoNextObject () ;
        if (enumerator_33965.hasCurrentObject ()) {
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_34238 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_34238.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_34238.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (862)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_34427 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (864)).isValidAndTrue () ;
    if (enumerator_34427.hasCurrentObject () && bool_4) {
      while (enumerator_34427.hasCurrentObject () && bool_4) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_34491 (enumerator_34238.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (865)).isValidAndTrue () ;
        if (enumerator_34491.hasCurrentObject () && bool_5) {
          while (enumerator_34491.hasCurrentObject () && bool_5) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_34427.current_mType (HERE).objectCompare (enumerator_34491.current_mType (HERE))) ;
            enumerator_34491.gotoNextObject () ;
            if (enumerator_34491.hasCurrentObject ()) {
              bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (865)).isValidAndTrue () ;
            }
          }
        }
        enumerator_34427.gotoNextObject () ;
        if (enumerator_34427.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_6) {
      ...
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_34730 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (871)).isValidAndTrue () ;
      if (enumerator_34730.hasCurrentObject () && bool_7) {
        while (enumerator_34730.hasCurrentObject () && bool_7) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_34730.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (872)) COMMA_SOURCE_FILE_AT_LINE (872)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (872)) COMMA_SOURCE_FILE_AT_LINE (872)) ;
          enumerator_34730.gotoNextObject () ;
          if (enumerator_34730.hasCurrentObject ()) {
            bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (871)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_8 (enumerator_34238.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_8, var_s COMMA_SOURCE_FILE_AT_LINE (874)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_34238.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (876)), enumerator_34238.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (876)) ;
...
static void categoryMethod_multiValuedBindingBoundToRoot_analyzeModel (const cPtr_multiValuedBindingBoundModel * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_36294_0 ; // Joker input parameter
  GALGAS_string joker_36301_0 ; // Joker input parameter
  constinArgument_inRootEntityObservableAttributeMap.method_searchKey (object->mAttribute_mPropertyName, outArgument_outObservablePropertyType, joker_36294_0, joker_36301_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (911)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_multiValuedBindingBoundToSelf_analyzeModel (const cPtr_multiValuedBindingBoundModel * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_36950_0 ; // Joker input parameter
  GALGAS_string joker_36957_0 ; // Joker input parameter
  constinArgument_inSelfObservableAttributeMap.method_searchKey (object->mAttribute_mPropertyName, outArgument_outObservablePropertyType, joker_36950_0, joker_36957_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (931)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_multiValuedBindingBoundToPref_analyzeModel (const cPtr_multiValuedBindingBoundModel * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_attributeListForImplementation joker_37551_4 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_37551_3 ; // Joker input parameter
  GALGAS_outletGenerationList joker_37551_2 ; // Joker input parameter
  GALGAS_lstringlist joker_37551_1 ; // Joker input parameter
  GALGAS_stringset joker_37620_0 ; // Joker input parameter
  constinArgument_inPreferencesMap.method_searchKey (object->mAttribute_mPreferenceName, joker_37551_4, joker_37551_3, joker_37551_2, joker_37551_1, var_preferenceObservableAttributeMap, joker_37620_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (951)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_37729_0 ; // Joker input parameter
  GALGAS_string joker_37736_0 ; // Joker input parameter
  var_preferenceObservableAttributeMap.method_searchKey (object->mAttribute_mPropertyName, outArgument_outObservablePropertyType, joker_37729_0, joker_37736_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (957)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_multiValuedBindingBoundToController_analyzeModel (const cPtr_multiValuedBindingBoundModel * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_38423_4 ; // Joker input parameter
  GALGAS_string joker_38423_3 ; // Joker input parameter
  GALGAS_outletBindingListForGeneration joker_38423_2 ; // Joker input parameter
  GALGAS_actionMap joker_38423_1 ; // Joker input parameter
  constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_38423_4, joker_38423_3, joker_38423_2, joker_38423_1, var_controllerObservableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (978)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_38594_0 ; // Joker input parameter
  GALGAS_string joker_38601_0 ; // Joker input parameter
  var_controllerObservableAttributeMap.method_searchKey (object->mAttribute_mPropertyName, outArgument_outObservablePropertyType, joker_38594_0, joker_38601_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (983)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_multiValuedBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_multiValuedBindingList enumerator_39638 (object->mAttribute_mMultiValuedBindingList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_39638.hasCurrentObject ()) {
    ...
    GALGAS_easyBindingType var_observablePropertyType ;
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_analyzeModel ((const cPtr_multiValuedBindingBoundModel *) enumerator_39638.current_mBoundModel (HERE).ptr (), constinArgument_inRootEntityObservableAttributeMap, constinArgument_inSelfObservableAttributeMap, constinArgument_inPreferencesMap, constinArgument_inControllerMap, ioArgument_ioImplementationFileInclusionSet, var_observedObjectName, var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (1013)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_40136 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1025)).isValidAndTrue () ;
    if (enumerator_40136.hasCurrentObject () && bool_0) {
      while (enumerator_40136.hasCurrentObject () && bool_0) {
        //-------- @assignmentInstructionForGeneration
        var_requiredFormatter = enumerator_40136.current_mRequiredFormatter (HERE) ;
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (kIsEqual, enumerator_40136.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
        enumerator_40136.gotoNextObject () ;
        if (enumerator_40136.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_1) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeAndFormatterList enumerator_40452 (var_acceptableTypeFormatterList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (1031)).isValidAndTrue () ;
      if (enumerator_40452.hasCurrentObject () && bool_2) {
        while (enumerator_40452.hasCurrentObject () && bool_2) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_40452.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1032)) COMMA_SOURCE_FILE_AT_LINE (1032)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1032)) COMMA_SOURCE_FILE_AT_LINE (1032)) ;
          enumerator_40452.gotoNextObject () ;
          if (enumerator_40452.hasCurrentObject ()) {
            bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (1031)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (enumerator_39638.current_mBoundModel (HERE).reader_mPropertyName (SOURCE_FILE_AT_LINE (1034)).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_4 = enumerator_39638.current_mNegate (HERE).boolEnum () ;
    if (kBoolTrue == test_4) {
      //-------- @plusEqualnstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletBindingOptionList enumerator_40827 (enumerator_39638.current_mOutletBindingOptionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_40827.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingTypeList var_acceptableTypeList ;
      //-------- @methodCallInstructionForGeneration
      var_outletClassBindingOptionMap.method_searchKey (enumerator_40827.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1043)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_bool var_found = GALGAS_bool (false) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_41024 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (1045)).isValidAndTrue () ;
      if (enumerator_41024.hasCurrentObject () && bool_5) {
        while (enumerator_41024.hasCurrentObject () && bool_5) {
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeList enumerator_41090 (enumerator_40827.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (1046)).isValidAndTrue () ;
          if (enumerator_41090.hasCurrentObject () && bool_6) {
            while (enumerator_41090.hasCurrentObject () && bool_6) {
              //-------- @assignmentInstructionForGeneration
              var_found = GALGAS_bool (kIsEqual, enumerator_41024.current_mType (HERE).objectCompare (enumerator_41090.current_mType (HERE))) ;
              enumerator_41090.gotoNextObject () ;
              if (enumerator_41090.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_7) {
        ...
        GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_41341 (var_acceptableTypeList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (1052)).isValidAndTrue () ;
        if (enumerator_41341.hasCurrentObject () && bool_8) {
          while (enumerator_41341.hasCurrentObject () && bool_8) {
            //-------- @concatInstructionForGeneration
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  - '").operator_concat (categoryReader_ebTypeName (enumerator_41341.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1053)) COMMA_SOURCE_FILE_AT_LINE (1053)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1053)) COMMA_SOURCE_FILE_AT_LINE (1053)) ;
            enumerator_41341.gotoNextObject () ;
            if (enumerator_41341.hasCurrentObject ()) {
              bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (1052)).isValidAndTrue () ;
            }
          }
        }
        //-------- @errorInstructionForGeneration
        GALGAS_location location_9 (enumerator_40827.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_9, var_s COMMA_SOURCE_FILE_AT_LINE (1055)) ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_bindingOptionList.addAssign_operation (enumerator_40827.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (1057)), enumerator_40827.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (1057)) ;
      enumerator_40827.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (var_generatedBindingName, var_requiredFormatter, var_observedObjectName, enumerator_39638.current_mBoundModel (HERE).reader_mPropertyName (SOURCE_FILE_AT_LINE (1063)).mAttribute_string, var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (1059)) COMMA_SOURCE_FILE_AT_LINE (1059)) ;
...
static void categoryMethod_regularPreferenceBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a preference does not implement the $").operator_concat (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (1230)) COMMA_SOURCE_FILE_AT_LINE (1230)).operator_concat (GALGAS_string (" binding") COMMA_SOURCE_FILE_AT_LINE (1230)) COMMA_SOURCE_FILE_AT_LINE (1230)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_multiValuedBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @errorInstructionForGeneration
  GALGAS_location location_0 (object->mAttribute_mBindingName.reader_location (HERE)) ; // Implicit use of 'location' reader
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement the $").operator_concat (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (1242)) COMMA_SOURCE_FILE_AT_LINE (1242)).operator_concat (GALGAS_string (" binding") COMMA_SOURCE_FILE_AT_LINE (1242)) COMMA_SOURCE_FILE_AT_LINE (1242)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_tableValueBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (1254)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $run action") COMMA_SOURCE_FILE_AT_LINE (1266)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularControllerBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @errorInstructionForGeneration
  GALGAS_location location_0 (object->mAttribute_mBindingName.reader_location (HERE)) ; // Implicit use of 'location' reader
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $").operator_concat (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (1278)) COMMA_SOURCE_FILE_AT_LINE (1278)).operator_concat (GALGAS_string (" binding") COMMA_SOURCE_FILE_AT_LINE (1278)) COMMA_SOURCE_FILE_AT_LINE (1278)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularRootBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1348)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_53253_2 ; // Joker input parameter
    GALGAS_string joker_53253_1 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_53253_2, joker_53253_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1350)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1351)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1352)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_53550_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_53550_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_53550_2, joker_53550_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1355)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1357)) COMMA_SOURCE_FILE_AT_LINE (1357)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1357)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1359)) COMMA_SOURCE_FILE_AT_LINE (1359)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1359)) ;
      }
    }else if (kBoolFalse == test_1) {
      //-------- @errorInstructionForGeneration
      ...
      inCompiler->emitSemanticError (location_3, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (1362)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1368)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_54181 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1371)).isValidAndTrue () ;
  if (enumerator_54181.hasCurrentObject () && bool_4) {
    while (enumerator_54181.hasCurrentObject () && bool_4) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_54181.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1372)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (1373)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1373)) COMMA_SOURCE_FILE_AT_LINE (1373)) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, var_boundTypeIdentifierString.objectCompare (var_acceptableType)) ;
      enumerator_54181.gotoNextObject () ;
      if (enumerator_54181.hasCurrentObject ()) {
        bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1371)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (1376)).boolEnum () ;
  if (kBoolTrue == test_5) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_6 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_6, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (1378)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (1378)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (1378)) COMMA_SOURCE_FILE_AT_LINE (1377)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1381)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (1388)), GALGAS_string ("mRootObjectController"), GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (1390)) COMMA_SOURCE_FILE_AT_LINE (1390)), var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1386)) COMMA_SOURCE_FILE_AT_LINE (1386)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularSelfBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_string var_boundTypeIdentifierString ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1405)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_55637_2 ; // Joker input parameter
    GALGAS_string joker_55637_1 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_55637_2, joker_55637_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1407)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1408)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1409)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_bool var_isToMany ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_destinationEntityName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_55934_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_55934_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_55934_2, joker_55934_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1412)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1414)) COMMA_SOURCE_FILE_AT_LINE (1414)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1414)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1416)) COMMA_SOURCE_FILE_AT_LINE (1416)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1416)) ;
      }
    }else if (kBoolFalse == test_1) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (1419)) ;
      var_boundTypeIdentifierString.drop () ; // Release error dropped variable
    }
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  GALGAS_outletClassBindingOptionMap var_availableBindingOptionMap ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1425)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_acceptableTypesString = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_56565 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1428)).isValidAndTrue () ;
  if (enumerator_56565.hasCurrentObject () && bool_4) {
    while (enumerator_56565.hasCurrentObject () && bool_4) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_56565.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1429)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (1430)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1430)) COMMA_SOURCE_FILE_AT_LINE (1430)) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, var_boundTypeIdentifierString.objectCompare (var_acceptableType)) ;
      enumerator_56565.gotoNextObject () ;
      if (enumerator_56565.hasCurrentObject ()) {
        bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1428)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (1433)).boolEnum () ;
  if (kBoolTrue == test_5) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_6 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_6, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (1435)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (1435)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (1435)) COMMA_SOURCE_FILE_AT_LINE (1434)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1438)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (1445)), GALGAS_string ("self"), object->mAttribute_mObservableAttributeName.mAttribute_string, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1443)) COMMA_SOURCE_FILE_AT_LINE (1443)) ;
}
//---------------------------------------------------------------------------*
