...
void routine_analyzeEntities (const GALGAS_entityList constinArgument_inEntityList,
  ...
  outArgument_outEntityMap = GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (336)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityList enumerator_13753 (constinArgument_inEntityList, kEnumeration_up) ;
  ...
  while (enumerator_13753.hasCurrentObject ()) {
    ...
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (339)) ;
    //-------- @localVariableDeclarationForGeneration
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_13753.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (344)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_14160_0 ; // Joker input parameter
      GALGAS_string joker_14209_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_14292_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_14292_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_14292_2 ; // Joker input parameter
      GALGAS_relationshipList joker_14292_1 ; // Joker input parameter
      GALGAS_relationshipMap joker_14357_0 ; // Joker input parameter
      GALGAS_stringset joker_14396_2 ; // Joker input parameter
      GALGAS__32_stringlist joker_14396_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_13753.current_mSuperEntityName (HERE), joker_14160_0, var_implementationSuperClassName, joker_14209_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_14292_4, joker_14292_3, joker_14292_2, joker_14292_1, var_allRelationshipList, var_allPropertyMap, joker_14357_0, var_allRelationshipMap, joker_14396_2, joker_14396_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (345)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (360)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (361)) ;
      //-------- @assignmentInstructionForGeneration
      var_implementationSuperClassName = GALGAS_string::makeEmptyString () ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipList = GALGAS_relationshipList::constructor_emptyList (SOURCE_FILE_AT_LINE (363)) ;
      //-------- @assignmentInstructionForGeneration
      var_allPropertyMap = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (364)) ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (365)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (367)) ;
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_15051 (enumerator_13753.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_15051.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_15051.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_15051.current_mType (HERE), enumerator_15051.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (371)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_15051.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (372)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_15051.current_mType (HERE), enumerator_15051.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (373)), enumerator_15051.current_mDefaultValueObjectiveCObject (HERE), enumerator_15051.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (373)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_15051.current_mType (HERE), enumerator_15051.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (374)), enumerator_15051.current_mDefaultValueObjectiveCObject (HERE), enumerator_15051.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (374)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_15051.current_mAttributeName (HERE), enumerator_15051.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_15051.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (375)) COMMA_SOURCE_FILE_AT_LINE (375)), inCompiler COMMA_SOURCE_FILE_AT_LINE (375)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_15051.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_relationshipMap var_currentRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (378)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipList enumerator_15741 (enumerator_13753.current_mRelationshipList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_15741.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allRelationshipMap.modifier_insertKey (enumerator_15741.current_mRelationshipName (HERE), enumerator_15741.current_mIsToMany (HERE), enumerator_15741.current_mDestinationEntityName (HERE), enumerator_15741.current_mInverseRelationshipName (HERE), enumerator_15741.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (380)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_currentRelationshipMap.modifier_insertKey (enumerator_15741.current_mRelationshipName (HERE), enumerator_15741.current_mIsToMany (HERE), enumerator_15741.current_mDestinationEntityName (HERE), enumerator_15741.current_mInverseRelationshipName (HERE), enumerator_15741.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (387)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_15741.current_mRelationshipName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (394)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_15741.current_mRelationshipName (HERE), GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (395)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (395)), inCompiler COMMA_SOURCE_FILE_AT_LINE (395)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_13753.current_mTransientList (HERE), GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (402)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (400)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS__32_stringlist var_toManyRelationshipList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (408)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipList enumerator_16775 (enumerator_13753.current_mRelationshipList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_16775.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = enumerator_16775.current_mIsToMany (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @plusEqualnstructionForGeneration
        var_toManyRelationshipList.addAssign_operation (enumerator_16775.current_mRelationshipName (HERE).mAttribute_string, enumerator_16775.current_mDestinationEntityName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (411)) ;
      }
      enumerator_16775.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (416)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outEntityMap.modifier_insertKey (enumerator_13753.current_mEntityName (HERE), enumerator_13753.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (419)), enumerator_13753.current_mImplementationClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (420)), var_implementationSuperClassName, var_observablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, enumerator_13753.current_mRelationshipList (HERE), var_allRelationshipList.operator_concat (enumerator_13753.current_mRelationshipList (HERE) COMMA_SOURCE_FILE_AT_LINE (428)), var_allPropertyMap, var_currentRelationshipMap, var_allRelationshipMap, var_implementationFileInclusionSet, var_toManyRelationshipList, inCompiler COMMA_SOURCE_FILE_AT_LINE (417)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_13753.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityMap enumerator_17644 (outArgument_outEntityMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17644.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipMap enumerator_17683 (enumerator_17644.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_17683.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_17799_12 ; // Joker input parameter
      GALGAS_string joker_17799_11 ; // Joker input parameter
      GALGAS_string joker_17799_10 ; // Joker input parameter
      GALGAS_observablePropertyMap joker_17799_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_17799_8 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_17799_7 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_17799_6 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_17799_5 ; // Joker input parameter
      GALGAS_relationshipList joker_17799_4 ; // Joker input parameter
      GALGAS_relationshipList joker_17799_3 ; // Joker input parameter
      GALGAS_propertyMap joker_17799_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_17799_1 ; // Joker input parameter
      GALGAS_stringset joker_17837_2 ; // Joker input parameter
      GALGAS__32_stringlist joker_17837_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_17683.current_mDestinationEntityName (HERE), joker_17799_12, joker_17799_11, joker_17799_10, joker_17799_9, joker_17799_8, joker_17799_7, joker_17799_6, joker_17799_5, joker_17799_4, joker_17799_3, joker_17799_2, joker_17799_1, var_destinationEntityRelationshipMap, joker_17837_2, joker_17837_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (440)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_inverseOfInverseRelationshipName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_17970_2 ; // Joker input parameter
      GALGAS_lstring joker_17970_1 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_18008_0 ; // Joker input parameter
      var_destinationEntityRelationshipMap.method_searchKey (enumerator_17683.current_mInverseRelationshipName (HERE), joker_17970_2, joker_17970_1, var_inverseOfInverseRelationshipName, joker_18008_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (442)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_17683.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_17683.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_17683.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (444)) COMMA_SOURCE_FILE_AT_LINE (444)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (444)) COMMA_SOURCE_FILE_AT_LINE (444)) ;
      }
...
void routine_analyzePreferences (const GALGAS_entityMap constinArgument_inEntityMap,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (642)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_25722 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_25722.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_observableAttributeMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (644)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (646)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_25894 (enumerator_25722.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_25894.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_25894.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (648)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_25894.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (651)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_26097 (enumerator_25722.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_26097.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_26097.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_26097.current_mType (HERE), enumerator_26097.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (653)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_26097.current_mType (HERE), enumerator_26097.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (654)), enumerator_26097.current_mDefaultValueObjectiveCObject (HERE), enumerator_26097.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (654)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_26097.current_mAttributeName (HERE), enumerator_26097.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_26097.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (655)) COMMA_SOURCE_FILE_AT_LINE (655)), inCompiler COMMA_SOURCE_FILE_AT_LINE (655)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (659)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_25722.current_mTransientList (HERE), GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (662)), var_observableAttributeMap, var_implementationFileInclusionSet, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (660)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observableObjectMap var_observableObjectMap = GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (668)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (670)), GALGAS_string ("self"), GALGAS_string::makeEmptyString (), var_observableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (669)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (676)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_27187 (enumerator_25722.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_27187.hasCurrentObject ()) {
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_27314_2 ; // Joker input parameter
      GALGAS_string joker_27314_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_27187.current_mOutletType (HERE), joker_27314_2, joker_27314_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (680)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (681)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_27458 (enumerator_27187.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_27458.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_27458.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (687)), var_actionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (683)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_27458.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_27187.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (694)), enumerator_27187.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (694)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (694)) ;
      enumerator_27187.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (697)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outPreferencesMap.modifier_insertKey (enumerator_25722.current_mPreferencesName (HERE), var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, enumerator_25722.current_mActionDeclarationList (HERE), var_observableAttributeMap, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (698)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_29563 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29563.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_29563.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (742)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_29752 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (744)).isValidAndTrue () ;
    if (enumerator_29752.hasCurrentObject () && bool_0) {
      while (enumerator_29752.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_29816 (enumerator_29563.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (745)).isValidAndTrue () ;
        if (enumerator_29816.hasCurrentObject () && bool_1) {
          while (enumerator_29816.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_29752.current_mType (HERE).objectCompare (enumerator_29816.current_mType (HERE))) ;
            enumerator_29816.gotoNextObject () ;
            if (enumerator_29816.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (745)).isValidAndTrue () ;
            }
          }
        }
        enumerator_29752.gotoNextObject () ;
        if (enumerator_29752.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (744)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (749)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_30055 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (751)).isValidAndTrue () ;
      if (enumerator_30055.hasCurrentObject () && bool_3) {
        while (enumerator_30055.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_30055.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (752)) COMMA_SOURCE_FILE_AT_LINE (752)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (752)) COMMA_SOURCE_FILE_AT_LINE (752)) ;
          enumerator_30055.gotoNextObject () ;
          if (enumerator_30055.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (751)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_29563.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (754)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_29563.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (756)), enumerator_29563.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (756)) ;
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (872)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_34977 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_34977.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    ...
    GALGAS_relationshipMap var_allRelationshipMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_35187_0 ; // Joker input parameter
    GALGAS_string joker_35237_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_35285_8 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_35285_7 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_35285_6 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_35285_5 ; // Joker input parameter
    GALGAS_relationshipList joker_35285_4 ; // Joker input parameter
    GALGAS_relationshipList joker_35285_3 ; // Joker input parameter
    GALGAS_propertyMap joker_35285_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_35285_1 ; // Joker input parameter
    GALGAS_stringset joker_35321_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_35321_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_34977.current_mRootEntityName (HERE), joker_35187_0, var_rootEntityImplementationClassName, joker_35237_0, var_rootObjectObservablePropertyMap, joker_35285_8, joker_35285_7, joker_35285_6, joker_35285_5, joker_35285_4, joker_35285_3, joker_35285_2, joker_35285_1, var_allRelationshipMap, joker_35321_2, joker_35321_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (877)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observableObjectMap var_observableObjectMap = GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (888)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("root").reader_nowhere (SOURCE_FILE_AT_LINE (890)), GALGAS_string ("mRootObject"), GALGAS_string::makeEmptyString (), var_rootObjectObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (889)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_preferencesMap enumerator_35619 (constinArgument_inPreferencesMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_35619.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_35619.current (HERE).mAttribute_lkey, GALGAS_string ("g_").operator_concat (enumerator_35619.current (HERE).mAttribute_lkey.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (898)), enumerator_35619.current (HERE).mAttribute_lkey.mAttribute_string, enumerator_35619.current (HERE).mAttribute_mObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (896)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_35619.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (904)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (905)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerList enumerator_35969 (enumerator_34977.current_mControllerList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_35969.hasCurrentObject ()) {
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_36207_0 ; // Joker input parameter
      constinArgument_inControllerClassMap.method_searchKey (enumerator_35969.current_mControllerClassName (HERE), joker_36207_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (910)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_35969.current_mControllerName (HERE), enumerator_35969.current_mControllerName (HERE).mAttribute_string, GALGAS_string::makeEmptyString (), var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (917)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_36566_15 ; // Joker input parameter
      GALGAS_string joker_36566_14 ; // Joker input parameter
      GALGAS_string joker_36566_13 ; // Joker input parameter
      GALGAS_observablePropertyMap joker_36566_12 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_36566_11 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_36566_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_36566_9 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_36566_8 ; // Joker input parameter
      GALGAS_relationshipList joker_36566_7 ; // Joker input parameter
      GALGAS_relationshipList joker_36566_6 ; // Joker input parameter
      GALGAS_propertyMap joker_36566_5 ; // Joker input parameter
      GALGAS_relationshipMap joker_36566_4 ; // Joker input parameter
      GALGAS_relationshipMap joker_36566_3 ; // Joker input parameter
      GALGAS_stringset joker_36566_2 ; // Joker input parameter
      GALGAS__32_stringlist joker_36566_1 ; // Joker input parameter
      constinArgument_inEntityMap.method_searchKey (enumerator_35969.current_mControlledClassOrEntityName (HERE), joker_36566_15, joker_36566_14, joker_36566_13, joker_36566_12, joker_36566_11, joker_36566_10, joker_36566_9, joker_36566_8, joker_36566_7, joker_36566_6, joker_36566_5, joker_36566_4, joker_36566_3, joker_36566_2, joker_36566_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (923)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (924)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_36687 (enumerator_35969.current_mControllerBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_36687.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_36687.current_mBinding (HERE).ptr (), var_allRelationshipMap, var_controllerClassBindingMap, enumerator_35969.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (926)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_36687.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_controllerMap.modifier_insertKey (enumerator_35969.current_mControllerName (HERE), enumerator_35969.current_mControllerClassName (HERE).mAttribute_string, enumerator_35969.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, var_controllerActionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (934)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (944)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_34977.current_mTransientList (HERE), var_observableObjectMap, var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (945)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_documentActionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (953)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_37646 (enumerator_34977.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_37646.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_documentActionMap.modifier_insertKey (enumerator_37646.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (955)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_37646.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (959)), GALGAS_string ("self"), GALGAS_string::makeEmptyString (), var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (958)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (964)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_37985 (enumerator_34977.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_37985.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_bool var_hasTableValueBinding ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_38112_2 ; // Joker input parameter
      GALGAS_string joker_38112_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_37985.current_mOutletType (HERE), joker_38112_2, joker_38112_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (968)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (969)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_38256 (enumerator_37985.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_38256.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_38256.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, var_controllerMap, var_documentActionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (971)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_38256.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_37985.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (982)), enumerator_37985.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (982)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (982)) ;
      enumerator_37985.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (985)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outDocumentMap.modifier_insertKey (enumerator_34977.current_mDocumentName (HERE), enumerator_34977.current_mRootEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (988)), var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, enumerator_34977.current_mActionDeclarationList (HERE), var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (986)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_34977.gotoNextObject () ;
  }
}
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_39399 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1007)).isValidAndTrue () ;
  if (enumerator_39399.hasCurrentObject () && bool_0) {
    while (enumerator_39399.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_39399.current_mType (HERE))) ;
      enumerator_39399.gotoNextObject () ;
      if (enumerator_39399.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1007)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1010)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (1011)) ;
  }
}
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1021)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_39827 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_39827.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1024)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_39827.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1025)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_40052_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_40111_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_40111_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_40111_2 ; // Joker input parameter
      GALGAS_stringset joker_40111_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_39827.current_mSuperClassName (HERE), joker_40052_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_40111_4, joker_40111_3, joker_40111_2, joker_40111_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1026)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1028)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1029)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1031)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_40521 (enumerator_39827.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_40521.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_40521.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_40521.current_mType (HERE), enumerator_40521.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1034)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_40521.current_mType (HERE), enumerator_40521.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1035)), enumerator_40521.current_mDefaultValueObjectiveCObject (HERE), enumerator_40521.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1035)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_40521.current_mType (HERE), enumerator_40521.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1036)), enumerator_40521.current_mDefaultValueObjectiveCObject (HERE), enumerator_40521.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1036)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_40521.current_mAttributeName (HERE), enumerator_40521.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_40521.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1037)) COMMA_SOURCE_FILE_AT_LINE (1037)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1037)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1041)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_39827.current_mTransientList (HERE), GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1044)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (1042)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1050)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_39827.current_mClassName (HERE), enumerator_39827.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1053)), var_observablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1051)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_39827.gotoNextObject () ;
  }
}
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1070)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_42066 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_42066.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1073)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_42163 (enumerator_42066.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42163.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1075)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_42275 (enumerator_42163.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_42275.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_42275.current_mBindingOptionName (HERE), enumerator_42275.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1077)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_42275.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_42163.current_mBindingName (HERE), enumerator_42163.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1083)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_42163.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_42066.current_mOutletClassName (HERE), enumerator_42066.current_mGenerateCode (HERE), enumerator_42066.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, enumerator_42066.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1086)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_42066.gotoNextObject () ;
  }
}
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1102)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_43107 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_43107.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1105)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_43216 (enumerator_43107.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_43216.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_43216.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1107)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_43216.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1110)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_43368 (enumerator_43107.current_mBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_43368.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1112)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_43480 (enumerator_43368.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_43480.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_43480.current_mBindingOptionName (HERE), enumerator_43480.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1114)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_43480.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_43368.current_mBindingName (HERE), enumerator_43368.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1120)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_43368.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1123)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerObservablePropertyList enumerator_43926 (enumerator_43107.current_mControllerObservablePropertyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_43926.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_43926.current (HERE).mAttribute_mPropertyName, enumerator_43926.current (HERE).mAttribute_mType, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1125)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1125)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_43926.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outControllerClassMap.modifier_insertKey (enumerator_43107.current_mOutletClassName (HERE), enumerator_43107.current_mGenerateCode (HERE), var_bindingMap, var_actionMap, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1128)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_43107.gotoNextObject () ;
  }
}
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  outArgument_outDocumentMap.drop () ; // Release 'out' argument
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1149)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1150)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1151)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1152)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (outArgument_outEntityMap, constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1153)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outPreferencesMap, outArgument_outDocumentMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1154)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
static void categoryMethod_tableValueBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inHasTableValueBinding.operator_not (SOURCE_FILE_AT_LINE (475)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mControllerName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("this outlet does not support $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (476)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    ...
    GALGAS_actionMap joker_19586_0 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_19513_0, var_controlledClassOrEntityName, var_controllerBindingList, joker_19586_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (480)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_19687_3 ; // Joker input parameter
    GALGAS_string joker_19687_2 ; // Joker input parameter
    GALGAS_string joker_19687_1 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_19750_11 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_19750_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_19750_9 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_19750_8 ; // Joker input parameter
    GALGAS_relationshipList joker_19750_7 ; // Joker input parameter
    GALGAS_relationshipList joker_19750_6 ; // Joker input parameter
    GALGAS_propertyMap joker_19750_5 ; // Joker input parameter
    GALGAS_relationshipMap joker_19750_4 ; // Joker input parameter
    GALGAS_relationshipMap joker_19750_3 ; // Joker input parameter
    GALGAS_stringset joker_19750_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_19750_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (GALGAS_lstring::constructor_new (var_controlledClassOrEntityName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (488)), joker_19687_3, joker_19687_2, joker_19687_1, var_observablePropertyMap, joker_19750_11, joker_19750_10, joker_19750_9, joker_19750_8, joker_19750_7, joker_19750_6, joker_19750_5, joker_19750_4, joker_19750_3, joker_19750_2, joker_19750_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (487)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_columnBindingForTableValueBindingForGeneration var_columnBindingForTableValueBindingForGeneration = GALGAS_columnBindingForTableValueBindingForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (493)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_tableValueColumnBinding enumerator_19918 (object->mAttribute_mTableValueColumnBinding, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_19918.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingType var_type ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_stringlist joker_20048_0 ; // Joker input parameter
      var_observablePropertyMap.method_searchKey (enumerator_19918.current (HERE).mAttribute_mBoundPropertyName, var_type, joker_20048_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (496)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_requiredCellTypeInTableColumnBinding = categoryReader_requiredCellTypeInTableColumnBinding (var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (501)) ;
      //-------- @ifInstructionForGeneration
      ...
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_19918.current (HERE).mAttribute_mBoundPropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("this property cannot be named in a $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (503)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_requiredCellTypeInTableColumnBinding.objectCompare (enumerator_19918.current (HERE).mAttribute_mCellTypeName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_19918.current (HERE).mAttribute_mCellTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("this property requires a ").operator_concat (var_requiredCellTypeInTableColumnBinding COMMA_SOURCE_FILE_AT_LINE (505)).operator_concat (GALGAS_string (" cell class") COMMA_SOURCE_FILE_AT_LINE (505)) COMMA_SOURCE_FILE_AT_LINE (505)) ;
        }
      }
      //-------- @plusEqualnstructionForGeneration
      var_columnBindingForTableValueBindingForGeneration.addAssign_operation (enumerator_19918.current (HERE).mAttribute_mColumnName.mAttribute_string, var_requiredCellTypeInTableColumnBinding, enumerator_19918.current (HERE).mAttribute_mBoundPropertyName.mAttribute_string, GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (511)) COMMA_SOURCE_FILE_AT_LINE (507)) ;
      enumerator_19918.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_tableValueBindingForGeneration::constructor_new (object->mAttribute_mControllerName.mAttribute_string, var_columnBindingForTableValueBindingForGeneration COMMA_SOURCE_FILE_AT_LINE (514)) COMMA_SOURCE_FILE_AT_LINE (514)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_inActionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (534)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_actionMap var_actionMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_21635_3 ; // Joker input parameter
    GALGAS_string joker_21635_2 ; // Joker input parameter
    GALGAS_outletBindingListForGeneration joker_21635_1 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mTargetName, joker_21635_3, joker_21635_2, joker_21635_1, var_actionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (537)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
    var_actionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (538)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_runBindingForGeneration::constructor_new (object->mAttribute_mTargetName.mAttribute_string, object->mAttribute_mActionName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (540)) COMMA_SOURCE_FILE_AT_LINE (540)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (560)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  ...
  GALGAS_observablePropertyMap var_observablePropertyMap ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inObservableObjectMap.reader_hasKey (object->mAttribute_mObservedObjectName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (564)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_string var_includeFile ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inObservableObjectMap.method_searchKey (GALGAS_lstring::constructor_new (object->mAttribute_mObservedObjectName.mAttribute_string, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (567)), var_observedObjectOCName, var_includeFile, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (566)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioImplementationFileInclusionSet.addAssign_operation (var_includeFile COMMA_SOURCE_FILE_AT_LINE (572)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mObservedObjectName.reader_string (SOURCE_FILE_AT_LINE (575)) COMMA_SOURCE_FILE_AT_LINE (575)).operator_concat (GALGAS_string ("' object is not observable") COMMA_SOURCE_FILE_AT_LINE (575)) COMMA_SOURCE_FILE_AT_LINE (574)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_stringlist joker_23307_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_23307_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (580)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  if (kBoolTrue == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_observablePropertyType.objectCompare (GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (584)))).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @concatInstructionForGeneration
      var_observableKeyPath.dotAssign_operation (GALGAS_string (".@count") COMMA_SOURCE_FILE_AT_LINE (585)) ;
      //-------- @assignmentInstructionForGeneration
      var_observablePropertyType = GALGAS_easyBindingType::constructor_uintegerType (SOURCE_FILE_AT_LINE (586)) ;
      ...
      inCompiler->emitSemanticError (location_4, GALGAS_string ("the 'count' path is only allowed for to-many relationships") COMMA_SOURCE_FILE_AT_LINE (588)) ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (593)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_23906 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (594)).isValidAndTrue () ;
  if (enumerator_23906.hasCurrentObject () && bool_5) {
    while (enumerator_23906.hasCurrentObject () && bool_5) {
      //-------- @assignmentInstructionForGeneration
      ...
      if (enumerator_23906.hasCurrentObject ()) {
        bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (594)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (598)).boolEnum () ;
  if (kBoolTrue == test_6) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (599)) COMMA_SOURCE_FILE_AT_LINE (599)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (599)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_24210 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (600)).isValidAndTrue () ;
    if (enumerator_24210.hasCurrentObject () && bool_7) {
      while (enumerator_24210.hasCurrentObject () && bool_7) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_24210.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (601)) COMMA_SOURCE_FILE_AT_LINE (601)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (601)) COMMA_SOURCE_FILE_AT_LINE (601)) ;
        enumerator_24210.gotoNextObject () ;
        if (enumerator_24210.hasCurrentObject ()) {
          bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (600)).isValidAndTrue () ;
        }
      }
    }
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_8, var_s COMMA_SOURCE_FILE_AT_LINE (603)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (606)) ;
  //-------- @foreachInstructionForGeneration
  ...
  while (enumerator_24445.hasCurrentObject ()) {
    ...
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_24445.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (609)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    ...
    //--- complex foreach instruction
    bool bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (611)).isValidAndTrue () ;
    if (enumerator_24634.hasCurrentObject () && bool_9) {
      while (enumerator_24634.hasCurrentObject () && bool_9) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_24698 (enumerator_24445.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (612)).isValidAndTrue () ;
        if (enumerator_24698.hasCurrentObject () && bool_10) {
          while (enumerator_24698.hasCurrentObject () && bool_10) {
            //-------- @assignmentInstructionForGeneration
            ...
            if (enumerator_24698.hasCurrentObject ()) {
              bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (612)).isValidAndTrue () ;
            }
          }
        }
        enumerator_24634.gotoNextObject () ;
        if (enumerator_24634.hasCurrentObject ()) {
          bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (611)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_11 = var_found.operator_not (SOURCE_FILE_AT_LINE (616)).boolEnum () ;
    if (kBoolTrue == test_11) {
      ...
      //--- complex foreach instruction
      bool bool_12 = var_found.operator_not (SOURCE_FILE_AT_LINE (618)).isValidAndTrue () ;
      if (enumerator_24937.hasCurrentObject () && bool_12) {
        while (enumerator_24937.hasCurrentObject () && bool_12) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_24937.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (619)) COMMA_SOURCE_FILE_AT_LINE (619)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (619)) COMMA_SOURCE_FILE_AT_LINE (619)) ;
          enumerator_24937.gotoNextObject () ;
          if (enumerator_24937.hasCurrentObject ()) {
            bool_12 = var_found.operator_not (SOURCE_FILE_AT_LINE (618)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_13 (enumerator_24445.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_13, var_s COMMA_SOURCE_FILE_AT_LINE (621)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_24445.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (623)), enumerator_24445.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (623)) ;
    enumerator_24445.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (626)), var_requiredFormatter, var_observedObjectOCName, var_observableKeyPath, var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (625)) COMMA_SOURCE_FILE_AT_LINE (625)) ;
}
//---------------------------------------------------------------------------*
...
GALGAS_string categoryReader_ebTypeIdentifier (const GALGAS_easyBindingType & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inClassOrEntityName COMMA_SOURCE_FILE_AT_LINE (728)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (728)) ;
      } break ;
    }
  }
//---
...
static void categoryMethod_tableValueBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (779)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $run action") COMMA_SOURCE_FILE_AT_LINE (791)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @assignmentInstructionForGeneration
    var_resultingObservedPropertyPath = GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (807)) COMMA_SOURCE_FILE_AT_LINE (807)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("observed object should be 'root'") COMMA_SOURCE_FILE_AT_LINE (809)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (815)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_stringlist joker_32787_0 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_32787_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (817)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (818)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (819)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_33083_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_33083_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_33083_2, joker_33083_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (822)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (824)) COMMA_SOURCE_FILE_AT_LINE (824)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (824)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (826)) COMMA_SOURCE_FILE_AT_LINE (826)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (826)) ;
      }
    }else if (kBoolFalse == test_3) {
      //-------- @errorInstructionForGeneration
      ...
      inCompiler->emitSemanticError (location_5, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (829)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (835)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_33714 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (838)).isValidAndTrue () ;
  if (enumerator_33714.hasCurrentObject () && bool_6) {
    while (enumerator_33714.hasCurrentObject () && bool_6) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_33714.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (839)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (840)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (840)) COMMA_SOURCE_FILE_AT_LINE (840)) ;
      //-------- @assignmentInstructionForGeneration
      ...
      if (enumerator_33714.hasCurrentObject ()) {
        bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (838)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (843)).boolEnum () ;
  if (kBoolTrue == test_7) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_8 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_8, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (845)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (845)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (845)) COMMA_SOURCE_FILE_AT_LINE (844)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (848)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (855)), var_resultingObservedObjectName, var_resultingObservedPropertyPath, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (853)) COMMA_SOURCE_FILE_AT_LINE (853)) ;
}
//---------------------------------------------------------------------------*
