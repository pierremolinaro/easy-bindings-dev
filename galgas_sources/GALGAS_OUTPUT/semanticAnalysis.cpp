...
//                    november 17th, 2012, at 17h10'54"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_analyzePreference (const GALGAS_preferencesDeclarationList_2E_element constinArgument_inPreference,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (959)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_38458 (constinArgument_inPreference.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_38458.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_actionMap.modifier_insertKey (enumerator_38458.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (961)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_38458.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observablePropertyMap var_observableAttributeMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (964)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (965)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeList enumerator_38760 (constinArgument_inPreference.mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_38760.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_checkDefaultValueType (enumerator_38760.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_38760.current_mType (HERE), enumerator_38760.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (967)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_attributeListForImplementation.addAssign_operation (enumerator_38760.current_mType (HERE), enumerator_38760.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (968)), enumerator_38760.current_mDefaultValueObjectiveCObject (HERE), enumerator_38760.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (968)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("preference.").operator_concat (constinArgument_inPreference.mAttribute_mPreferencesName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (970)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (970)).operator_concat (enumerator_38760.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (970)) COMMA_SOURCE_FILE_AT_LINE (970)), enumerator_38760.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (969)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableAttributeMap.modifier_insertKey (enumerator_38760.current_mAttributeName (HERE), enumerator_38760.current_mType (HERE), GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (973)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (979)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_38760.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (986)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeTransientProperties (GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (988)), GALGAS_string ("preference.").operator_concat (constinArgument_inPreference.mAttribute_mPreferencesName.reader_string (SOURCE_FILE_AT_LINE (989)) COMMA_SOURCE_FILE_AT_LINE (989)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (989)), constinArgument_inPreference.mAttribute_mTransientList, GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (991)), GALGAS_string::makeEmptyString (), GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (993)), var_observableAttributeMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (987)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observableObjectMap var_observableObjectMap = GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1000)) ;
  { //-------- @modifierCallInstructionForGeneration
  var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (1002)), GALGAS_string ("self"), constinArgument_inPreference.mAttribute_mPreferencesName.mAttribute_string, GALGAS_string::makeEmptyString (), var_observableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1001)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1009)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletDeclarationList enumerator_40507 (constinArgument_inPreference.mAttribute_mOutletDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_40507.hasCurrentObject ()) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_40628_2 ; // Joker input parameter
    GALGAS_string joker_40628_1 ; // Joker input parameter
    constinArgument_inOutletClassMap.method_searchKey (enumerator_40507.current_mOutletType (HERE), joker_40628_2, joker_40628_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1013)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1014)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_40768 (enumerator_40507.current_mOutletBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_40768.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_40768.current_mBinding (HERE).ptr (), GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1017)), var_observableAttributeMap, GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1019)), var_observableObjectMap, var_bindingMap, GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1022)), var_actionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1016)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_40768.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_outletGenerationList.addAssign_operation (enumerator_40507.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1029)), enumerator_40507.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1029)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1029)) ;
    enumerator_40507.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1032)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioPreferencesMap.modifier_insertKey (constinArgument_inPreference.mAttribute_mPreferencesName, var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, constinArgument_inPreference.mAttribute_mActionDeclarationList, var_observableAttributeMap, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1033)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_analyzePreferences (const GALGAS_preferencesDeclarationList constinArgument_inPreferencesList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1052)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_42048 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_42048.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzePreference (enumerator_42048.current (HERE), constinArgument_inOutletClassMap, outArgument_outPreferencesMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1054)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_42048.gotoNextObject () ;
  }
}
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outBindingOptionListForGeneration = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1092)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_43526 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_43526.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_43526.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1095)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_43715 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1097)).isValidAndTrue () ;
    if (enumerator_43715.hasCurrentObject () && bool_0) {
      while (enumerator_43715.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_43779 (enumerator_43526.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1098)).isValidAndTrue () ;
        if (enumerator_43779.hasCurrentObject () && bool_1) {
          while (enumerator_43779.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_43715.current_mType (HERE).objectCompare (enumerator_43779.current_mType (HERE))) ;
            enumerator_43779.gotoNextObject () ;
            if (enumerator_43779.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1098)).isValidAndTrue () ;
            }
          }
        }
        enumerator_43715.gotoNextObject () ;
        if (enumerator_43715.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1097)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (1102)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_44018 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (1104)).isValidAndTrue () ;
      if (enumerator_44018.hasCurrentObject () && bool_3) {
        while (enumerator_44018.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_44018.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1105)) COMMA_SOURCE_FILE_AT_LINE (1105)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1105)) COMMA_SOURCE_FILE_AT_LINE (1105)) ;
          enumerator_44018.gotoNextObject () ;
          if (enumerator_44018.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (1104)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_43526.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (1107)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_43526.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (1109)), enumerator_43526.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (1109)) ;
    enumerator_43526.gotoNextObject () ;
  }
}
...
void routine_analyzeDocument (const GALGAS_documentDeclarationList_2E_element constinArgument_inDocument,
  ...
  GALGAS_relationshipMap var_allRelationshipMap ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_54330_0 ; // Joker input parameter
  GALGAS_string joker_54384_0 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_54451_8 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_54451_7 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_54451_6 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_54451_5 ; // Joker input parameter
  GALGAS_relationshipList joker_54451_4 ; // Joker input parameter
  GALGAS_relationshipList joker_54451_3 ; // Joker input parameter
  GALGAS_propertyMap joker_54451_2 ; // Joker input parameter
  GALGAS_relationshipMap joker_54451_1 ; // Joker input parameter
  GALGAS_stringset joker_54500_2 ; // Joker input parameter
  GALGAS__32_stringlist joker_54500_1 ; // Joker input parameter
  constinArgument_inEntityMap.method_searchKey (constinArgument_inDocument.mAttribute_mRootEntityName, joker_54330_0, var_rootEntityImplementationClassName, joker_54384_0, var_rootObjectObservablePropertyMap, joker_54451_8, joker_54451_7, joker_54451_6, joker_54451_5, joker_54451_4, joker_54451_3, joker_54451_2, joker_54451_1, var_allRelationshipMap, joker_54500_2, joker_54500_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1353)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1364)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1365)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerList enumerator_54724 (constinArgument_inDocument.mAttribute_mControllerList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_54724.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_54950_0 ; // Joker input parameter
    constinArgument_inControllerClassMap.method_searchKey (enumerator_54724.current_mControllerClassName (HERE), joker_54950_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1370)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_prefixedControllerObservablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1377)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_observablePropertyMap enumerator_55184 (var_controllerObservablePropertyMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_55184.hasCurrentObject ()) {
      enumerator_55184.gotoNextObject () ;
    }
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_55882_15 ; // Joker input parameter
    GALGAS_string joker_55882_14 ; // Joker input parameter
    GALGAS_string joker_55882_13 ; // Joker input parameter
    GALGAS_observablePropertyMap joker_55882_12 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_55882_11 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_55882_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_55882_9 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_55882_8 ; // Joker input parameter
    GALGAS_relationshipList joker_55882_7 ; // Joker input parameter
    GALGAS_relationshipList joker_55882_6 ; // Joker input parameter
    GALGAS_propertyMap joker_55882_5 ; // Joker input parameter
    GALGAS_relationshipMap joker_55882_4 ; // Joker input parameter
    GALGAS_relationshipMap joker_55882_3 ; // Joker input parameter
    GALGAS_stringset joker_55882_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_55882_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_54724.current_mControlledClassOrEntityName (HERE), joker_55882_15, joker_55882_14, joker_55882_13, joker_55882_12, joker_55882_11, joker_55882_10, joker_55882_9, joker_55882_8, joker_55882_7, joker_55882_6, joker_55882_5, joker_55882_4, joker_55882_3, joker_55882_2, joker_55882_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1400)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1401)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_55999 (enumerator_54724.current_mControllerBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_55999.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_55999.current_mBinding (HERE).ptr (), var_allRelationshipMap, var_controllerClassBindingMap, enumerator_54724.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1403)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_55999.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_controllerMap.modifier_insertKey (enumerator_54724.current_mControllerName (HERE), enumerator_54724.current_mControllerClassName (HERE).mAttribute_string, enumerator_54724.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1411)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_54724.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1422)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeTransientProperties (constinArgument_inPreferencesMap, GALGAS_string ("document.").operator_concat (constinArgument_inDocument.mAttribute_mDocumentName.reader_string (SOURCE_FILE_AT_LINE (1425)) COMMA_SOURCE_FILE_AT_LINE (1425)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1425)), constinArgument_inDocument.mAttribute_mTransientList, var_rootObjectObservablePropertyMap, constinArgument_inDocument.mAttribute_mRootEntityName.mAttribute_string, var_controllerMap, var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1423)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_actionMap var_documentActionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1436)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_57236 (constinArgument_inDocument.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_57236.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_documentActionMap.modifier_insertKey (enumerator_57236.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1438)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_57236.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1449)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletDeclarationList enumerator_57693 (constinArgument_inDocument.mAttribute_mOutletDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_57693.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_outletClassBindingMap var_bindingMap ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_bool var_hasTableValueBinding ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_57814_2 ; // Joker input parameter
    GALGAS_string joker_57814_1 ; // Joker input parameter
    constinArgument_inOutletClassMap.method_searchKey (enumerator_57693.current_mOutletType (HERE), joker_57814_2, joker_57814_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1453)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1454)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_57954 (enumerator_57693.current_mOutletBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_57954.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_57954.current_mBinding (HERE).ptr (), var_rootObjectObservablePropertyMap, var_observablePropertyMap, constinArgument_inEntityMap, GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1460)), var_bindingMap, var_controllerMap, var_documentActionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1456)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_57954.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_outletGenerationList.addAssign_operation (enumerator_57693.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1469)), enumerator_57693.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1469)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1469)) ;
    enumerator_57693.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1472)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioDocumentMap.modifier_insertKey (constinArgument_inDocument.mAttribute_mDocumentName, constinArgument_inDocument.mAttribute_mRootEntityName.mAttribute_string, var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, constinArgument_inDocument.mAttribute_mActionDeclarationList, var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1473)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1496)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_59372 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_59372.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeDocument (enumerator_59372.current (HERE), constinArgument_inOutletClassMap, constinArgument_inControllerClassMap, constinArgument_inEntityMap, constinArgument_inPreferencesMap, outArgument_outDocumentMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1498)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_59372.gotoNextObject () ;
  }
}
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_59936 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1518)).isValidAndTrue () ;
  if (enumerator_59936.hasCurrentObject () && bool_0) {
    while (enumerator_59936.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_59936.current_mType (HERE))) ;
      enumerator_59936.gotoNextObject () ;
      if (enumerator_59936.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1518)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1521)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (1522)) ;
  }
}
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1533)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_60421 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_60421.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1536)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_60421.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1537)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_60646_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_60705_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_60705_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_60705_2 ; // Joker input parameter
      GALGAS_stringset joker_60705_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_60421.current_mSuperClassName (HERE), joker_60646_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_60705_4, joker_60705_3, joker_60705_2, joker_60705_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1538)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1540)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1541)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1543)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_61115 (enumerator_60421.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_61115.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_61115.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_61115.current_mType (HERE), enumerator_61115.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1546)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_61115.current_mType (HERE), enumerator_61115.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1547)), enumerator_61115.current_mDefaultValueObjectiveCObject (HERE), enumerator_61115.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1547)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_61115.current_mType (HERE), enumerator_61115.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1548)), enumerator_61115.current_mDefaultValueObjectiveCObject (HERE), enumerator_61115.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1548)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("class/").operator_concat (enumerator_60421.current_mClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1550)) COMMA_SOURCE_FILE_AT_LINE (1550)).operator_concat (GALGAS_string ("/self.") COMMA_SOURCE_FILE_AT_LINE (1550)).operator_concat (enumerator_61115.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1550)) COMMA_SOURCE_FILE_AT_LINE (1550)), enumerator_61115.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1549)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_61115.current_mAttributeName (HERE), enumerator_61115.current_mType (HERE), GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1553)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1559)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_61115.gotoNextObject () ;
    }
    //-------- @localVariableDeclarationForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1566)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1568)), GALGAS_string ("class").operator_concat (enumerator_60421.current_mClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1569)) COMMA_SOURCE_FILE_AT_LINE (1569)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1569)), enumerator_60421.current_mTransientList (HERE), GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1571)), GALGAS_string::makeEmptyString (), GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1573)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1567)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1580)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_60421.current_mClassName (HERE), enumerator_60421.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1583)), var_observablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1581)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1600)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_63175 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_63175.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1603)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_63272 (enumerator_63175.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_63272.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1605)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_63384 (enumerator_63272.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_63384.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_63384.current_mBindingOptionName (HERE), enumerator_63384.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1607)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_63384.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_63272.current_mBindingName (HERE), enumerator_63272.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1613)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_63272.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_63175.current_mOutletClassName (HERE), enumerator_63175.current_mGenerateCode (HERE), enumerator_63175.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, enumerator_63175.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1616)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_63175.gotoNextObject () ;
  }
}
...
void routine_analyzeControllerClass (const GALGAS_controllerClassList_2E_element constinArgument_inController,
                                     ...
                                     COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1634)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_64292 (constinArgument_inController.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_64292.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_actionMap.modifier_insertKey (enumerator_64292.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1636)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_64292.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1639)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassBindingList enumerator_64448 (constinArgument_inController.mAttribute_mBindingList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_64448.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1641)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingOptionList enumerator_64556 (enumerator_64448.current_mBindingOptionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_64556.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_outletClassBindingOptionMap.modifier_insertKey (enumerator_64556.current_mBindingOptionName (HERE), enumerator_64556.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1643)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_64556.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_bindingMap.modifier_insertKey (enumerator_64448.current_mBindingName (HERE), enumerator_64448.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1649)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_64448.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1652)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerObservablePropertyList enumerator_65002 (constinArgument_inController.mAttribute_mControllerObservablePropertyList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_65002.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("controller.").operator_concat (constinArgument_inController.mAttribute_mControllerClassName.reader_string (SOURCE_FILE_AT_LINE (1655)) COMMA_SOURCE_FILE_AT_LINE (1655)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1655)).operator_concat (enumerator_65002.current (HERE).mAttribute_mPropertyName.reader_string (SOURCE_FILE_AT_LINE (1655)) COMMA_SOURCE_FILE_AT_LINE (1655)), enumerator_65002.current (HERE).mAttribute_mPropertyName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1654)) ;
    { //-------- @modifierCallInstructionForGeneration
    ...
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_65002.current (HERE).mAttribute_mPropertyName, enumerator_65002.current (HERE).mAttribute_mType, GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1662)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_65002.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioControllerClassMap.modifier_insertKey (constinArgument_inController.mAttribute_mControllerClassName, constinArgument_inController.mAttribute_mGenerateCode, var_bindingMap, var_actionMap, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1670)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1686)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_66065 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_66065.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeControllerClass (enumerator_66065.current (HERE), ioArgument_ioTransientDependencyGraph, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1688)) ;
    } //-------- @routineCallInstructionForGeneration
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outSortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1710)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (1711)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1712)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, var_transientDependencyGraph, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1713)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1714)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1720)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1725)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outPreferencesMap, outArgument_outDocumentMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1731)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1741)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (1741)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = var_transientDependencyGraph.reader_graphviz (SOURCE_FILE_AT_LINE (1742)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_path = inArgument_inSourceFilePath.operator_concat (GALGAS_string (".transientDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (1743)) ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_67829_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_67829_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1744)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outTransientDependencyArcList = var_transientDependencyGraph.reader_arcs (SOURCE_FILE_AT_LINE (1747)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1748)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_transientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (1749)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_68109 (var_transientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (1750)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_68109.hasCurrentObject ()) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inAST.mAttribute_mEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_68109.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1751)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (1751)) COMMA_SOURCE_FILE_AT_LINE (1751)) ;
        enumerator_68109.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_2) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_stringlist var_unsortedTransientList ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstringlist joker_68367_0 ; // Joker input parameter
      GALGAS_lstringlist joker_68409_0 ; // Joker input parameter
      var_transientDependencyGraph.method_topologicalSort (outArgument_outSortedTransientOrderedList, joker_68367_0, var_unsortedTransientList, joker_68409_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1755)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1761)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1762)).reader_string (SOURCE_FILE_AT_LINE (1762)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:") COMMA_SOURCE_FILE_AT_LINE (1762)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_68639 (var_unsortedTransientList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_68639.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_68639.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1764)) COMMA_SOURCE_FILE_AT_LINE (1764)) ;
          enumerator_68639.gotoNextObject () ;
        }
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inAST.mAttribute_mEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (1766)) ;
      }
    }
  }
}
...
static void categoryMethod_tableValueBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_21406_0 ; // Joker input parameter
    GALGAS_actionMap joker_21479_0 ; // Joker input parameter
    GALGAS_observablePropertyMap joker_21488_0 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_21406_0, var_controlledClassOrEntityName, var_controllerBindingList, joker_21479_0, joker_21488_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (536)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_21589_3 ; // Joker input parameter
    GALGAS_string joker_21589_2 ; // Joker input parameter
    GALGAS_string joker_21589_1 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21652_11 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21652_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21652_9 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_21652_8 ; // Joker input parameter
    GALGAS_relationshipList joker_21652_7 ; // Joker input parameter
    GALGAS_relationshipList joker_21652_6 ; // Joker input parameter
    GALGAS_propertyMap joker_21652_5 ; // Joker input parameter
    GALGAS_relationshipMap joker_21652_4 ; // Joker input parameter
    GALGAS_relationshipMap joker_21652_3 ; // Joker input parameter
    GALGAS_stringset joker_21652_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_21652_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (GALGAS_lstring::constructor_new (var_controlledClassOrEntityName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (545)), joker_21589_3, joker_21589_2, joker_21589_1, var_observablePropertyMap, joker_21652_11, joker_21652_10, joker_21652_9, joker_21652_8, joker_21652_7, joker_21652_6, joker_21652_5, joker_21652_4, joker_21652_3, joker_21652_2, joker_21652_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (544)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_tableValueColumnBinding enumerator_21820 (object->mAttribute_mTableValueColumnBinding, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_21820.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingType var_type ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_21937_0 ; // Joker input parameter
      GALGAS_string joker_21948_0 ; // Joker input parameter
      var_observablePropertyMap.method_searchKey (enumerator_21820.current (HERE).mAttribute_mBoundPropertyName, var_type, joker_21937_0, joker_21948_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (552)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      ...
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_21820.current (HERE).mAttribute_mBoundPropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_requiredCellTypeInTableColumnBinding.objectCompare (enumerator_21820.current (HERE).mAttribute_mCellTypeName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_21820.current (HERE).mAttribute_mCellTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      //-------- @plusEqualnstructionForGeneration
      var_columnBindingForTableValueBindingForGeneration.addAssign_operation (enumerator_21820.current (HERE).mAttribute_mColumnName.mAttribute_string, var_requiredCellTypeInTableColumnBinding, enumerator_21820.current (HERE).mAttribute_mBoundPropertyName.mAttribute_string, GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (568)) COMMA_SOURCE_FILE_AT_LINE (564)) ;
...
static void categoryMethod_runBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_23667_3 ; // Joker input parameter
    GALGAS_string joker_23667_2 ; // Joker input parameter
    GALGAS_outletBindingListForGeneration joker_23667_1 ; // Joker input parameter
    GALGAS_observablePropertyMap joker_23682_0 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mTargetName, joker_23667_3, joker_23667_2, joker_23667_1, var_actionMap, joker_23682_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (596)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
...
static void categoryMethod_regularBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (621)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  ...
  GALGAS_observablePropertyMap var_observablePropertyMap ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inObservableObjectMap.reader_hasKey (object->mAttribute_mObservedObjectName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (625)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_string var_includeFile ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_25063_0 ; // Joker input parameter
    constinArgument_inObservableObjectMap.method_searchKey (GALGAS_lstring::constructor_new (object->mAttribute_mObservedObjectName.mAttribute_string, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (628)), var_observedObjectOCName, joker_25063_0, var_includeFile, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (627)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioImplementationFileInclusionSet.addAssign_operation (var_includeFile COMMA_SOURCE_FILE_AT_LINE (634)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mObservedObjectName.reader_string (SOURCE_FILE_AT_LINE (637)) COMMA_SOURCE_FILE_AT_LINE (637)).operator_concat (GALGAS_string ("' object is not observable") COMMA_SOURCE_FILE_AT_LINE (637)) COMMA_SOURCE_FILE_AT_LINE (636)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_25483_2 ; // Joker input parameter
  GALGAS_string joker_25483_1 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_25483_2, joker_25483_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (642)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  if (kBoolTrue == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_observablePropertyType.objectCompare (GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (646)))).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @concatInstructionForGeneration
      var_observableKeyPath.dotAssign_operation (GALGAS_string (".@count") COMMA_SOURCE_FILE_AT_LINE (647)) ;
      //-------- @assignmentInstructionForGeneration
      var_observablePropertyType = GALGAS_easyBindingType::constructor_uintegerType (SOURCE_FILE_AT_LINE (648)) ;
      ...
      inCompiler->emitSemanticError (location_4, GALGAS_string ("the 'count' path is only allowed for to-many relationships") COMMA_SOURCE_FILE_AT_LINE (650)) ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (655)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_26083 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (656)).isValidAndTrue () ;
  if (enumerator_26083.hasCurrentObject () && bool_5) {
    while (enumerator_26083.hasCurrentObject () && bool_5) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_26083.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_26083.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_26083.gotoNextObject () ;
      if (enumerator_26083.hasCurrentObject ()) {
        bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (656)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (660)).boolEnum () ;
  if (kBoolTrue == test_6) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (661)) COMMA_SOURCE_FILE_AT_LINE (661)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (661)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_26387 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (662)).isValidAndTrue () ;
    if (enumerator_26387.hasCurrentObject () && bool_7) {
      while (enumerator_26387.hasCurrentObject () && bool_7) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_26387.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (663)) COMMA_SOURCE_FILE_AT_LINE (663)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (663)) COMMA_SOURCE_FILE_AT_LINE (663)) ;
        enumerator_26387.gotoNextObject () ;
        if (enumerator_26387.hasCurrentObject ()) {
          bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (662)).isValidAndTrue () ;
        }
      }
    }
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_8, var_s COMMA_SOURCE_FILE_AT_LINE (665)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (668)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_26622 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_26622.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_26622.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (671)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_26811 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (673)).isValidAndTrue () ;
    if (enumerator_26811.hasCurrentObject () && bool_9) {
      while (enumerator_26811.hasCurrentObject () && bool_9) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_26875 (enumerator_26622.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (674)).isValidAndTrue () ;
        if (enumerator_26875.hasCurrentObject () && bool_10) {
          while (enumerator_26875.hasCurrentObject () && bool_10) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_26811.current_mType (HERE).objectCompare (enumerator_26875.current_mType (HERE))) ;
            enumerator_26875.gotoNextObject () ;
            if (enumerator_26875.hasCurrentObject ()) {
              bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (674)).isValidAndTrue () ;
            }
          }
        }
        enumerator_26811.gotoNextObject () ;
        if (enumerator_26811.hasCurrentObject ()) {
          bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (673)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_11 = var_found.operator_not (SOURCE_FILE_AT_LINE (678)).boolEnum () ;
    if (kBoolTrue == test_11) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_27114 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_12 = var_found.operator_not (SOURCE_FILE_AT_LINE (680)).isValidAndTrue () ;
      if (enumerator_27114.hasCurrentObject () && bool_12) {
        while (enumerator_27114.hasCurrentObject () && bool_12) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_27114.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (681)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (681)) ;
          enumerator_27114.gotoNextObject () ;
          if (enumerator_27114.hasCurrentObject ()) {
            bool_12 = var_found.operator_not (SOURCE_FILE_AT_LINE (680)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_13 (enumerator_26622.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_13, var_s COMMA_SOURCE_FILE_AT_LINE (683)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_26622.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (685)), enumerator_26622.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (685)) ;
    enumerator_26622.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (688)), var_requiredFormatter, var_observedObjectOCName, var_observableKeyPath, var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (687)) COMMA_SOURCE_FILE_AT_LINE (687)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularRootBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (711)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_observablePropertyType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_28680_0 ; // Joker input parameter
  GALGAS_string joker_28687_0 ; // Joker input parameter
  constinArgument_inRootEntityObservableAttributeMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_28680_0, joker_28687_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (717)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_observableKeyPath = object->mAttribute_mObservableAttributeName.mAttribute_string ;
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_observablePropertyType.objectCompare (GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (726)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @concatInstructionForGeneration
      var_observableKeyPath.dotAssign_operation (GALGAS_string (".@count") COMMA_SOURCE_FILE_AT_LINE (727)) ;
      //-------- @assignmentInstructionForGeneration
      var_observablePropertyType = GALGAS_easyBindingType::constructor_uintegerType (SOURCE_FILE_AT_LINE (728)) ;
      ...
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the 'count' path is only allowed for to-many relationships") COMMA_SOURCE_FILE_AT_LINE (730)) ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (735)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_29363 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (736)).isValidAndTrue () ;
  if (enumerator_29363.hasCurrentObject () && bool_3) {
    while (enumerator_29363.hasCurrentObject () && bool_3) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_29363.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_29363.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_29363.gotoNextObject () ;
      if (enumerator_29363.hasCurrentObject ()) {
        bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (736)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (740)).boolEnum () ;
  if (kBoolTrue == test_4) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (741)) COMMA_SOURCE_FILE_AT_LINE (741)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (741)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_29667 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (742)).isValidAndTrue () ;
    if (enumerator_29667.hasCurrentObject () && bool_5) {
      while (enumerator_29667.hasCurrentObject () && bool_5) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_29667.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (743)) COMMA_SOURCE_FILE_AT_LINE (743)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (743)) COMMA_SOURCE_FILE_AT_LINE (743)) ;
        enumerator_29667.gotoNextObject () ;
        if (enumerator_29667.hasCurrentObject ()) {
          bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (742)).isValidAndTrue () ;
        }
      }
    }
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_6, var_s COMMA_SOURCE_FILE_AT_LINE (745)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (748)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_29940 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29940.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_29940.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (751)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_30129 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (753)).isValidAndTrue () ;
    if (enumerator_30129.hasCurrentObject () && bool_7) {
      while (enumerator_30129.hasCurrentObject () && bool_7) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_30193 (enumerator_29940.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (754)).isValidAndTrue () ;
        if (enumerator_30193.hasCurrentObject () && bool_8) {
          while (enumerator_30193.hasCurrentObject () && bool_8) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_30129.current_mType (HERE).objectCompare (enumerator_30193.current_mType (HERE))) ;
            enumerator_30193.gotoNextObject () ;
            if (enumerator_30193.hasCurrentObject ()) {
              bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (754)).isValidAndTrue () ;
            }
          }
        }
        enumerator_30129.gotoNextObject () ;
        if (enumerator_30129.hasCurrentObject ()) {
          bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (753)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (758)).boolEnum () ;
    if (kBoolTrue == test_9) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_30432 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (760)).isValidAndTrue () ;
      if (enumerator_30432.hasCurrentObject () && bool_10) {
        while (enumerator_30432.hasCurrentObject () && bool_10) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_30432.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (761)) COMMA_SOURCE_FILE_AT_LINE (761)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (761)) COMMA_SOURCE_FILE_AT_LINE (761)) ;
          enumerator_30432.gotoNextObject () ;
          if (enumerator_30432.hasCurrentObject ()) {
            bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (760)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_11 (enumerator_29940.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_11, var_s COMMA_SOURCE_FILE_AT_LINE (763)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_29940.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (765)), enumerator_29940.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (765)) ;
    enumerator_29940.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (769)), var_requiredFormatter, GALGAS_string ("mRootObject"), var_observableKeyPath, var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (768)) COMMA_SOURCE_FILE_AT_LINE (768)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularSelfBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (792)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_observablePropertyType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_32039_0 ; // Joker input parameter
  GALGAS_string joker_32046_0 ; // Joker input parameter
  constinArgument_inSelfObservableAttributeMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_32039_0, joker_32046_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (798)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_observableKeyPath = object->mAttribute_mObservableAttributeName.mAttribute_string ;
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_observablePropertyType.objectCompare (GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (807)))).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @concatInstructionForGeneration
      var_observableKeyPath.dotAssign_operation (GALGAS_string (".@count") COMMA_SOURCE_FILE_AT_LINE (808)) ;
      //-------- @assignmentInstructionForGeneration
      var_observablePropertyType = GALGAS_easyBindingType::constructor_uintegerType (SOURCE_FILE_AT_LINE (809)) ;
    }else if (kBoolFalse == test_1) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_2 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_2, GALGAS_string ("the 'count' path is only allowed for to-many relationships") COMMA_SOURCE_FILE_AT_LINE (811)) ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (816)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_32722 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (817)).isValidAndTrue () ;
  if (enumerator_32722.hasCurrentObject () && bool_3) {
    while (enumerator_32722.hasCurrentObject () && bool_3) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_32722.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_32722.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_32722.gotoNextObject () ;
      if (enumerator_32722.hasCurrentObject ()) {
        bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (817)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (821)).boolEnum () ;
  if (kBoolTrue == test_4) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (822)) COMMA_SOURCE_FILE_AT_LINE (822)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (822)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_33026 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (823)).isValidAndTrue () ;
    if (enumerator_33026.hasCurrentObject () && bool_5) {
      while (enumerator_33026.hasCurrentObject () && bool_5) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_33026.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (824)) COMMA_SOURCE_FILE_AT_LINE (824)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (824)) COMMA_SOURCE_FILE_AT_LINE (824)) ;
        enumerator_33026.gotoNextObject () ;
        if (enumerator_33026.hasCurrentObject ()) {
          bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (823)).isValidAndTrue () ;
        }
      }
    }
    //-------- @errorInstructionForGeneration
    GALGAS_location location_6 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_6, var_s COMMA_SOURCE_FILE_AT_LINE (826)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (829)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_33299 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_33299.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_33299.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (832)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_33488 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (834)).isValidAndTrue () ;
    if (enumerator_33488.hasCurrentObject () && bool_7) {
      while (enumerator_33488.hasCurrentObject () && bool_7) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_33552 (enumerator_33299.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (835)).isValidAndTrue () ;
        if (enumerator_33552.hasCurrentObject () && bool_8) {
          while (enumerator_33552.hasCurrentObject () && bool_8) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_33488.current_mType (HERE).objectCompare (enumerator_33552.current_mType (HERE))) ;
            enumerator_33552.gotoNextObject () ;
            if (enumerator_33552.hasCurrentObject ()) {
              bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (835)).isValidAndTrue () ;
            }
          }
        }
        enumerator_33488.gotoNextObject () ;
        if (enumerator_33488.hasCurrentObject ()) {
          bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (834)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (839)).boolEnum () ;
    if (kBoolTrue == test_9) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_33791 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (841)).isValidAndTrue () ;
      if (enumerator_33791.hasCurrentObject () && bool_10) {
        while (enumerator_33791.hasCurrentObject () && bool_10) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_33791.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (842)) COMMA_SOURCE_FILE_AT_LINE (842)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (842)) COMMA_SOURCE_FILE_AT_LINE (842)) ;
          enumerator_33791.gotoNextObject () ;
          if (enumerator_33791.hasCurrentObject ()) {
            bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (841)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_11 (enumerator_33299.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_11, var_s COMMA_SOURCE_FILE_AT_LINE (844)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_33299.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (846)), enumerator_33299.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (846)) ;
    enumerator_33299.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (850)), var_requiredFormatter, GALGAS_string ("self"), var_observableKeyPath, var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (849)) COMMA_SOURCE_FILE_AT_LINE (849)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_multiValuedBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_easyBindingTypeAndFormatterList var_acceptableTypeFormatterList ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (874)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_multiValuedBindingList enumerator_35268 (object->mAttribute_mMultiValuedBindingList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_35268.hasCurrentObject ()) {
    ...
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = constinArgument_inObservableObjectMap.reader_hasKey (enumerator_35268.current_mBoundObjectName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (881)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_string var_includeFile ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_35587_0 ; // Joker input parameter
      constinArgument_inObservableObjectMap.method_searchKey (GALGAS_lstring::constructor_new (enumerator_35268.current_mBoundObjectName (HERE).mAttribute_string, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (884)), var_observedObjectOCName, joker_35587_0, var_includeFile, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (883)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      ioArgument_ioImplementationFileInclusionSet.addAssign_operation (var_includeFile COMMA_SOURCE_FILE_AT_LINE (890)) ;
    }else if (kBoolFalse == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_35268.current_mBoundObjectName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_35268.current_mBoundObjectName (HERE).reader_string (SOURCE_FILE_AT_LINE (893)) COMMA_SOURCE_FILE_AT_LINE (893)).operator_concat (GALGAS_string ("' object is not observable") COMMA_SOURCE_FILE_AT_LINE (893)) COMMA_SOURCE_FILE_AT_LINE (892)) ;
      var_observedObjectOCName.drop () ; // Release error dropped variable
      var_observablePropertyMap.drop () ; // Release error dropped variable
    }
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_observablePropertyType ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_36019_2 ; // Joker input parameter
    GALGAS_string joker_36019_1 ; // Joker input parameter
    var_observablePropertyMap.method_searchKey (enumerator_35268.current_mBoundPropertyName (HERE), var_observablePropertyType, joker_36019_2, joker_36019_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (898)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_observableKeyPath = enumerator_35268.current_mBoundPropertyName (HERE).mAttribute_string ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (902)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_36260 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (903)).isValidAndTrue () ;
    if (enumerator_36260.hasCurrentObject () && bool_2) {
      while (enumerator_36260.hasCurrentObject () && bool_2) {
        //-------- @assignmentInstructionForGeneration
        var_requiredFormatter = enumerator_36260.current_mRequiredFormatter (HERE) ;
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (kIsEqual, enumerator_36260.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
        enumerator_36260.gotoNextObject () ;
        if (enumerator_36260.hasCurrentObject ()) {
          bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (903)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (907)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeAndFormatterList enumerator_36576 (var_acceptableTypeFormatterList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (909)).isValidAndTrue () ;
      if (enumerator_36576.hasCurrentObject () && bool_4) {
        while (enumerator_36576.hasCurrentObject () && bool_4) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_36576.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (910)) COMMA_SOURCE_FILE_AT_LINE (910)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (910)) COMMA_SOURCE_FILE_AT_LINE (910)) ;
          enumerator_36576.gotoNextObject () ;
          if (enumerator_36576.hasCurrentObject ()) {
            bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (909)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_5 (enumerator_35268.current_mBoundPropertyName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, var_s COMMA_SOURCE_FILE_AT_LINE (912)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (915)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = enumerator_35268.current_mNegate (HERE).boolEnum () ;
    if (kBoolTrue == test_6) {
      //-------- @plusEqualnstructionForGeneration
      var_bindingOptionList.addAssign_operation (GALGAS_string ("NSValueTransformerName"), GALGAS_string ("NSNegateBooleanTransformerName") COMMA_SOURCE_FILE_AT_LINE (917)) ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletBindingOptionList enumerator_36941 (enumerator_35268.current_mOutletBindingOptionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_36941.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingTypeList var_acceptableTypeList ;
      //-------- @methodCallInstructionForGeneration
      var_outletClassBindingOptionMap.method_searchKey (enumerator_36941.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (921)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_bool var_found = GALGAS_bool (false) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_37138 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (923)).isValidAndTrue () ;
      if (enumerator_37138.hasCurrentObject () && bool_7) {
        while (enumerator_37138.hasCurrentObject () && bool_7) {
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeList enumerator_37204 (enumerator_36941.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (924)).isValidAndTrue () ;
          if (enumerator_37204.hasCurrentObject () && bool_8) {
            while (enumerator_37204.hasCurrentObject () && bool_8) {
              //-------- @assignmentInstructionForGeneration
              var_found = GALGAS_bool (kIsEqual, enumerator_37138.current_mType (HERE).objectCompare (enumerator_37204.current_mType (HERE))) ;
              enumerator_37204.gotoNextObject () ;
              if (enumerator_37204.hasCurrentObject ()) {
                bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (924)).isValidAndTrue () ;
              }
            }
          }
          enumerator_37138.gotoNextObject () ;
          if (enumerator_37138.hasCurrentObject ()) {
            bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (923)).isValidAndTrue () ;
          }
        }
      }
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (928)).boolEnum () ;
      if (kBoolTrue == test_9) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_37455 (var_acceptableTypeList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (930)).isValidAndTrue () ;
        if (enumerator_37455.hasCurrentObject () && bool_10) {
          while (enumerator_37455.hasCurrentObject () && bool_10) {
            //-------- @concatInstructionForGeneration
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  - '").operator_concat (categoryReader_ebTypeName (enumerator_37455.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (931)) COMMA_SOURCE_FILE_AT_LINE (931)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (931)) COMMA_SOURCE_FILE_AT_LINE (931)) ;
            enumerator_37455.gotoNextObject () ;
            if (enumerator_37455.hasCurrentObject ()) {
              bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (930)).isValidAndTrue () ;
            }
          }
        }
        //-------- @errorInstructionForGeneration
        GALGAS_location location_11 (enumerator_36941.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_11, var_s COMMA_SOURCE_FILE_AT_LINE (933)) ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_bindingOptionList.addAssign_operation (enumerator_36941.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (935)), enumerator_36941.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (935)) ;
      enumerator_36941.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (var_generatedBindingName, var_requiredFormatter, var_observedObjectOCName, var_observableKeyPath, var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (937)) COMMA_SOURCE_FILE_AT_LINE (937)) ;
    //-------- @incrementInstructionForGeneration
    var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (945)) ;
    //-------- @assignmentInstructionForGeneration
    var_generatedBindingName = object->mAttribute_mBindingName.mAttribute_string.operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (946)) COMMA_SOURCE_FILE_AT_LINE (946)) ;
...
GALGAS_string categoryReader_ebTypeIdentifier (const GALGAS_easyBindingType & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inClassOrEntityName COMMA_SOURCE_FILE_AT_LINE (1081)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1081)) ;
      } break ;
    }
  }
//---
...
static void categoryMethod_multiValuedBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement the $").operator_concat (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (1132)) COMMA_SOURCE_FILE_AT_LINE (1132)).operator_concat (GALGAS_string (" binding") COMMA_SOURCE_FILE_AT_LINE (1132)) COMMA_SOURCE_FILE_AT_LINE (1132)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_tableValueBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (1144)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $run action") COMMA_SOURCE_FILE_AT_LINE (1156)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @assignmentInstructionForGeneration
    var_resultingObservedPropertyPath = GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (1172)) COMMA_SOURCE_FILE_AT_LINE (1172)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("observed object should be 'root'") COMMA_SOURCE_FILE_AT_LINE (1174)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1180)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_47291_2 ; // Joker input parameter
    GALGAS_string joker_47291_1 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_47291_2, joker_47291_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1182)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1183)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1184)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_47588_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_47588_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_47588_2, joker_47588_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1187)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1189)) COMMA_SOURCE_FILE_AT_LINE (1189)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1189)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1191)) COMMA_SOURCE_FILE_AT_LINE (1191)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1191)) ;
      }
    }else if (kBoolFalse == test_3) {
      //-------- @errorInstructionForGeneration
      ...
      inCompiler->emitSemanticError (location_5, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (1194)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1200)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_48219 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (1203)).isValidAndTrue () ;
  if (enumerator_48219.hasCurrentObject () && bool_6) {
    while (enumerator_48219.hasCurrentObject () && bool_6) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_48219.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1204)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (1205)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1205)) COMMA_SOURCE_FILE_AT_LINE (1205)) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, var_boundTypeIdentifierString.objectCompare (var_acceptableType)) ;
      enumerator_48219.gotoNextObject () ;
      if (enumerator_48219.hasCurrentObject ()) {
        bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (1203)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (1208)).boolEnum () ;
  if (kBoolTrue == test_7) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_8 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_8, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (1210)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (1210)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (1210)) COMMA_SOURCE_FILE_AT_LINE (1209)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1213)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (1220)), var_resultingObservedObjectName, var_resultingObservedPropertyPath, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1218)) COMMA_SOURCE_FILE_AT_LINE (1218)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularRootBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_string var_boundTypeIdentifierString ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1237)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_49669_2 ; // Joker input parameter
    GALGAS_string joker_49669_1 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_49669_2, joker_49669_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1239)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1240)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1241)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_bool var_isToMany ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_destinationEntityName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_49966_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_49966_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_49966_2, joker_49966_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1244)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1246)) COMMA_SOURCE_FILE_AT_LINE (1246)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1246)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1248)) COMMA_SOURCE_FILE_AT_LINE (1248)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1248)) ;
      }
    }else if (kBoolFalse == test_1) {
      //-------- @errorInstructionForGeneration
      ...
      inCompiler->emitSemanticError (location_3, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (1251)) ;
      var_boundTypeIdentifierString.drop () ; // Release error dropped variable
    }
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  GALGAS_outletClassBindingOptionMap var_availableBindingOptionMap ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1257)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_acceptableTypesString = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_50597 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1260)).isValidAndTrue () ;
  if (enumerator_50597.hasCurrentObject () && bool_4) {
    while (enumerator_50597.hasCurrentObject () && bool_4) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_50597.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1261)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (1262)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1262)) COMMA_SOURCE_FILE_AT_LINE (1262)) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, var_boundTypeIdentifierString.objectCompare (var_acceptableType)) ;
      enumerator_50597.gotoNextObject () ;
      if (enumerator_50597.hasCurrentObject ()) {
        bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1260)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (1265)).boolEnum () ;
  if (kBoolTrue == test_5) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_6 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_6, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (1267)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (1267)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (1267)) COMMA_SOURCE_FILE_AT_LINE (1266)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1270)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (1277)), GALGAS_string ("mRootObjectController"), GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (1279)) COMMA_SOURCE_FILE_AT_LINE (1279)), var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1275)) COMMA_SOURCE_FILE_AT_LINE (1275)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularSelfBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_string var_boundTypeIdentifierString ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1294)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_52053_2 ; // Joker input parameter
    GALGAS_string joker_52053_1 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_52053_2, joker_52053_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1296)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1297)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1298)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_bool var_isToMany ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_destinationEntityName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_52350_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_52350_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_52350_2, joker_52350_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1301)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1303)) COMMA_SOURCE_FILE_AT_LINE (1303)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1303)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1305)) COMMA_SOURCE_FILE_AT_LINE (1305)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1305)) ;
      }
    }else if (kBoolFalse == test_1) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (1308)) ;
      var_boundTypeIdentifierString.drop () ; // Release error dropped variable
    }
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  GALGAS_outletClassBindingOptionMap var_availableBindingOptionMap ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1314)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_acceptableTypesString = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_52981 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1317)).isValidAndTrue () ;
  if (enumerator_52981.hasCurrentObject () && bool_4) {
    while (enumerator_52981.hasCurrentObject () && bool_4) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_52981.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1318)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (1319)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1319)) COMMA_SOURCE_FILE_AT_LINE (1319)) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, var_boundTypeIdentifierString.objectCompare (var_acceptableType)) ;
      enumerator_52981.gotoNextObject () ;
      if (enumerator_52981.hasCurrentObject ()) {
        bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1317)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (1322)).boolEnum () ;
  if (kBoolTrue == test_5) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_6 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_6, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (1324)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (1324)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (1324)) COMMA_SOURCE_FILE_AT_LINE (1323)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1327)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (1334)), GALGAS_string ("self"), object->mAttribute_mObservableAttributeName.mAttribute_string, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1332)) COMMA_SOURCE_FILE_AT_LINE (1332)) ;
}
//---------------------------------------------------------------------------*
