...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  cEnumerator_outletClassList enumerator_6523 (constinArgument_inAST.mAttribute_mOutletClassList, kEnumeration_up) ;
  ...
  while (enumerator_6523.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_6620 (enumerator_6523.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_6620.hasCurrentObject ()) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_6732 (enumerator_6620.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_6732.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_6732.current_mBindingOptionName (HERE), enumerator_6732.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (180)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_6732.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_6620.current_mBindingName (HERE), enumerator_6620.current_mAcceptableTypeList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (186)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_6620.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_6523.current_mOutletClassName (HERE), enumerator_6523.current_mGenerateCode (HERE), var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (189)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_7300 (constinArgument_inAST.mAttribute_mClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_7300.hasCurrentObject ()) {
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_7300.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (196)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_7534_0 ; // Joker input parameter
      GALGAS_propertyListForImplementation joker_7598_4 ; // Joker input parameter
      GALGAS_propertyListForImplementation joker_7598_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_7598_2 ; // Joker input parameter
      GALGAS_triggeredKeys joker_7598_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_7300.current_mSuperClassName (HERE), joker_7534_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_7598_4, joker_7598_3, joker_7598_2, joker_7598_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (197)) ;
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_classPropertyList enumerator_8139 (enumerator_7300.current_mPropertyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_8139.hasCurrentObject ()) {
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForImplementation.addAssign_operation (enumerator_8139.current_mType (HERE), enumerator_8139.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (207)), enumerator_8139.current_mDefaultValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (207)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_8139.current_mType (HERE), enumerator_8139.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (208)), enumerator_8139.current_mDefaultValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (208)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_8139.current_mPropertyName (HERE), enumerator_8139.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_8139.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (209)) COMMA_SOURCE_FILE_AT_LINE (209)), inCompiler COMMA_SOURCE_FILE_AT_LINE (209)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_8139.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_classTransientList enumerator_8563 (enumerator_7300.current_mClassTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_8563.hasCurrentObject ()) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_8717 (enumerator_8563.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_8717.hasCurrentObject ()) {
        ...
        //-------- @methodCallInstructionForGeneration
        var_classObservablePropertyMap.method_searchKey (enumerator_8717.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (218)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_8717.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (219)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_8980 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_8980.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_8980.current_mValue (HERE), enumerator_8563.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (221)) COMMA_SOURCE_FILE_AT_LINE (221)) ;
      ...
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_8563.current_mType (HERE), enumerator_8563.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (225)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (225)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_8563.current_mTransientName (HERE), enumerator_8563.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (226)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_8563.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_7300.current_mClassName (HERE), enumerator_7300.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (231)), var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedPropertyListForImplementation, var_propertyListForImplementation, var_transientListForImplementation, var_triggeredKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (229)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityList enumerator_9844 (constinArgument_inAST.mAttribute_mEntityList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_9844.hasCurrentObject ()) {
    ...
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_9844.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (246)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_10124_0 ; // Joker input parameter
      GALGAS_string joker_10157_0 ; // Joker input parameter
      GALGAS_propertyListForImplementation joker_10221_4 ; // Joker input parameter
      GALGAS_propertyListForImplementation joker_10221_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_10221_2 ; // Joker input parameter
      GALGAS_triggeredKeys joker_10221_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_9844.current_mSuperEntityName (HERE), joker_10124_0, var_implementationSuperClassName, joker_10157_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_10221_4, joker_10221_3, joker_10221_2, joker_10221_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (247)) ;
      //-------- END @methodCallInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_classPropertyList enumerator_10805 (enumerator_9844.current_mPropertyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_10805.hasCurrentObject ()) {
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForImplementation.addAssign_operation (enumerator_10805.current_mType (HERE), enumerator_10805.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (258)), enumerator_10805.current_mDefaultValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (258)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_10805.current_mType (HERE), enumerator_10805.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (259)), enumerator_10805.current_mDefaultValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (259)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_10805.current_mPropertyName (HERE), enumerator_10805.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_10805.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (260)) COMMA_SOURCE_FILE_AT_LINE (260)), inCompiler COMMA_SOURCE_FILE_AT_LINE (260)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_10805.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_classTransientList enumerator_11229 (enumerator_9844.current_mClassTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_11229.hasCurrentObject ()) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_11383 (enumerator_11229.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_11383.hasCurrentObject ()) {
        ...
        GALGAS_stringlist var_propertyDependancyList ;
        //-------- @methodCallInstructionForGeneration
        var_classObservablePropertyMap.method_searchKey (enumerator_11383.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (269)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_11383.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (270)) COMMA_SOURCE_FILE_AT_LINE (270)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_11646 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_11646.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_11646.current_mValue (HERE), enumerator_11229.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (272)) COMMA_SOURCE_FILE_AT_LINE (272)) ;
      ...
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_11229.current_mType (HERE), enumerator_11229.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (276)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (276)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_11229.current_mTransientName (HERE), enumerator_11229.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (277)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_11229.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outEntityMap.modifier_insertKey (enumerator_9844.current_mEntityName (HERE), enumerator_9844.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (282)), enumerator_9844.current_mImplementationClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (283)), var_implementationSuperClassName, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedPropertyListForImplementation, var_propertyListForImplementation, var_transientListForImplementation, var_triggeredKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (280)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesList enumerator_12610 (constinArgument_inAST.mAttribute_mPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_12610.hasCurrentObject ()) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_12762_0 ; // Joker input parameter
    GALGAS_string joker_12801_0 ; // Joker input parameter
    GALGAS_propertyListForImplementation joker_12827_5 ; // Joker input parameter
    GALGAS_propertyListForImplementation joker_12827_4 ; // Joker input parameter
    GALGAS_propertyListForImplementation joker_12827_3 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_12827_2 ; // Joker input parameter
    GALGAS_triggeredKeys joker_12827_1 ; // Joker input parameter
    outArgument_outEntityMap.method_searchKey (enumerator_12610.current_mRootEntityName (HERE), joker_12762_0, var_rootEntityImplementationClassName, joker_12801_0, var_observablePropertyMap, joker_12827_5, joker_12827_4, joker_12827_3, joker_12827_2, joker_12827_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (298)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_12953 (enumerator_12610.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_12953.hasCurrentObject ()) {
      ...
      outArgument_outOutletClassMap.method_searchKey (enumerator_12953.current_mOutletType (HERE), joker_13046_0, var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (303)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_outletBindingList enumerator_13167 (enumerator_12953.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_13167.hasCurrentObject ()) {
        ...
        //-------- @methodCallInstructionForGeneration
        var_bindingMap.method_searchKey (enumerator_13167.current_mBindingName (HERE), var_acceptableTypeList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (308)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @localVariableDeclarationForGeneration
        GALGAS_easyBindingType var_observablePropertyType ;
        //-------- @methodCallInstructionForGeneration
        GALGAS_stringlist joker_13575_0 ; // Joker input parameter
        var_observablePropertyMap.method_searchKey (enumerator_13167.current_mRootObservablePropertyName (HERE), var_observablePropertyType, joker_13575_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (311)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_bool var_found = GALGAS_bool (false) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_13703 (var_acceptableTypeList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (314)).isValidAndTrue () ;
        if (enumerator_13703.hasCurrentObject () && bool_2) {
          while (enumerator_13703.hasCurrentObject () && bool_2) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_13703.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
            enumerator_13703.gotoNextObject () ;
            if (enumerator_13703.hasCurrentObject ()) {
        ...
        if (kBoolTrue == test_3) {
          ...
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeList enumerator_13982 (var_acceptableTypeList, kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (319)).isValidAndTrue () ;
          if (enumerator_13982.hasCurrentObject () && bool_4) {
            while (enumerator_13982.hasCurrentObject () && bool_4) {
              //-------- @concatInstructionForGeneration
              var_s.dotAssign_operation (GALGAS_string ("\n"
                "  - '").operator_concat (callCategoryReader_ebTypeName ((const cPtr_easyBindingType *) enumerator_13982.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (320)) COMMA_SOURCE_FILE_AT_LINE (320)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (320)) COMMA_SOURCE_FILE_AT_LINE (320)) ;
              enumerator_13982.gotoNextObject () ;
              if (enumerator_13982.hasCurrentObject ()) {
                bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (319)).isValidAndTrue () ;
              }
            }
          }
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_13167.current_mRootObservablePropertyName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_outletBindingOptionList enumerator_14262 (enumerator_13167.current_mOutletBindingOptionList (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_14262.hasCurrentObject ()) {
          //-------- @localVariableDeclarationForGeneration
          GALGAS_easyBindingTypeList var_acceptableTypeList ;
          //-------- @methodCallInstructionForGeneration
          var_outletClassBindingOptionMap.method_searchKey (enumerator_14262.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (328)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
          GALGAS_bool var_found = GALGAS_bool (false) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeList enumerator_14475 (var_acceptableTypeList, kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (330)).isValidAndTrue () ;
          if (enumerator_14475.hasCurrentObject () && bool_6) {
            while (enumerator_14475.hasCurrentObject () && bool_6) {
              //-------- @foreachInstructionForGeneration
              cEnumerator_easyBindingTypeList enumerator_14545 (enumerator_14262.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
              //--- complex foreach instruction
              bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (331)).isValidAndTrue () ;
              if (enumerator_14545.hasCurrentObject () && bool_7) {
                while (enumerator_14545.hasCurrentObject () && bool_7) {
                  //-------- @assignmentInstructionForGeneration
                  var_found = GALGAS_bool (kIsEqual, enumerator_14475.current_mType (HERE).objectCompare (enumerator_14545.current_mType (HERE))) ;
                  enumerator_14545.gotoNextObject () ;
                  if (enumerator_14545.hasCurrentObject ()) {
                    bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (331)).isValidAndTrue () ;
                  }
                }
              }
              enumerator_14475.gotoNextObject () ;
              if (enumerator_14475.hasCurrentObject ()) {
          ...
          if (kBoolTrue == test_8) {
            ...
            //-------- @foreachInstructionForGeneration
            cEnumerator_easyBindingTypeList enumerator_14820 (var_acceptableTypeList, kEnumeration_up) ;
            //--- complex foreach instruction
            bool bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (337)).isValidAndTrue () ;
            if (enumerator_14820.hasCurrentObject () && bool_9) {
              while (enumerator_14820.hasCurrentObject () && bool_9) {
                //-------- @concatInstructionForGeneration
                var_s.dotAssign_operation (GALGAS_string ("\n"
                  "  - '").operator_concat (callCategoryReader_ebTypeName ((const cPtr_easyBindingType *) enumerator_14820.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (338)) COMMA_SOURCE_FILE_AT_LINE (338)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (338)) COMMA_SOURCE_FILE_AT_LINE (338)) ;
                enumerator_14820.gotoNextObject () ;
                if (enumerator_14820.hasCurrentObject ()) {
                  bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (337)).isValidAndTrue () ;
                }
              }
            }
            //-------- @errorInstructionForGeneration
            GALGAS_location location_10 (enumerator_14262.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_10, var_s COMMA_SOURCE_FILE_AT_LINE (340)) ;
          }
          //-------- @plusEqualnstructionForGeneration
          var_bindingOptionList.addAssign_operation (enumerator_14262.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (342)), enumerator_14262.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (342)) ;
          enumerator_14262.gotoNextObject () ;
        }
        //-------- @plusEqualnstructionForGeneration
        var_outletBindingList.addAssign_operation (enumerator_13167.current_mBindingName (HERE).reader_string (SOURCE_FILE_AT_LINE (344)), enumerator_13167.current_mRootObservablePropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (344)), var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (344)) ;
        enumerator_13167.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_12953.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (346)), enumerator_12953.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (346)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (346)) ;
      enumerator_12953.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outPreferencesMap.modifier_insertKey (enumerator_12610.current_mPreferencesName (HERE), enumerator_12610.current_mRootEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (351)), var_rootEntityImplementationClassName, var_outletGenerationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (349)) ;
    } //-------- END @typeMethodInstructionForGeneration
