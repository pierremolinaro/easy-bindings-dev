...
//                    november 18th, 2012, at 11h49'26"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_analyzeEntity (const GALGAS_entityList_2E_element constinArgument_inEntity,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_string joker_14167_0 ; // Joker input parameter
    GALGAS_string joker_14212_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_14289_4 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_14289_3 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_14289_2 ; // Joker input parameter
    GALGAS_relationshipList joker_14289_1 ; // Joker input parameter
    GALGAS_relationshipMap joker_14348_0 ; // Joker input parameter
    GALGAS_stringset joker_14383_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_14383_1 ; // Joker input parameter
    ioArgument_ioEntityMap.method_searchKey (constinArgument_inEntity.mAttribute_mSuperEntityName, joker_14167_0, var_implementationSuperClassName, joker_14212_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_14289_4, joker_14289_3, joker_14289_2, joker_14289_1, var_allRelationshipList, var_allPropertyMap, joker_14348_0, var_allRelationshipMap, joker_14383_2, joker_14383_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (346)) ;
  ...
  cEnumerator_attributeList enumerator_15058 (constinArgument_inEntity.mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_15058.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_checkDefaultValueType (enumerator_15058.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_15058.current_mType (HERE), enumerator_15058.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (372)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_allPropertyMap.modifier_insertKey (enumerator_15058.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (373)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_attributeListForImplementation.addAssign_operation (enumerator_15058.current_mType (HERE), enumerator_15058.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (374)), enumerator_15058.current_mDefaultValueObjectiveCObject (HERE), enumerator_15058.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (374)) ;
    //-------- @plusEqualnstructionForGeneration
    var_propertyListForInitMethodHeader.addAssign_operation (enumerator_15058.current_mType (HERE), enumerator_15058.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (375)), enumerator_15058.current_mDefaultValueObjectiveCObject (HERE), enumerator_15058.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (375)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("entity.").operator_concat (constinArgument_inEntity.mAttribute_mEntityName.reader_string (SOURCE_FILE_AT_LINE (377)) COMMA_SOURCE_FILE_AT_LINE (377)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (377)).operator_concat (enumerator_15058.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (377)) COMMA_SOURCE_FILE_AT_LINE (377)), enumerator_15058.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (376)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_15058.current_mAttributeName (HERE), enumerator_15058.current_mType (HERE), GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (380)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_relationshipList enumerator_16084 (constinArgument_inEntity.mAttribute_mRelationshipList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_16084.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_allRelationshipMap.modifier_insertKey (enumerator_16084.current_mRelationshipName (HERE), enumerator_16084.current_mIsToMany (HERE), enumerator_16084.current_mDestinationEntityName (HERE), enumerator_16084.current_mInverseRelationshipName (HERE), enumerator_16084.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (394)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_currentRelationshipMap.modifier_insertKey (enumerator_16084.current_mRelationshipName (HERE), enumerator_16084.current_mIsToMany (HERE), enumerator_16084.current_mDestinationEntityName (HERE), enumerator_16084.current_mInverseRelationshipName (HERE), enumerator_16084.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (401)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_allPropertyMap.modifier_insertKey (enumerator_16084.current_mRelationshipName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (408)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("entity.").operator_concat (constinArgument_inEntity.mAttribute_mEntityName.reader_string (SOURCE_FILE_AT_LINE (410)) COMMA_SOURCE_FILE_AT_LINE (410)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (410)).operator_concat (enumerator_16084.current_mRelationshipName (HERE).reader_string (SOURCE_FILE_AT_LINE (410)) COMMA_SOURCE_FILE_AT_LINE (410)), enumerator_16084.current_mRelationshipName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (409)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_16084.current_mRelationshipName (HERE), GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (415)), GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (413)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ...
    enumerator_16084.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_relationshipList enumerator_17712 (constinArgument_inEntity.mAttribute_mRelationshipList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17712.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = enumerator_17712.current_mIsToMany (HERE).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @plusEqualnstructionForGeneration
      var_toManyRelationshipList.addAssign_operation (enumerator_17712.current_mRelationshipName (HERE).mAttribute_string, enumerator_17712.current_mDestinationEntityName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (443)) ;
    }
...
void routine_analyzeEntities (const GALGAS_entityList constinArgument_inEntityList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityList enumerator_18982 (constinArgument_inEntityList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_18982.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeEntity (enumerator_18982.current (HERE), outArgument_outEntityMap, constinArgument_inPreferencesMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (481)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_18982.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityMap enumerator_19191 (outArgument_outEntityMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_19191.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipMap enumerator_19230 (enumerator_19191.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_19230.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_19346_12 ; // Joker input parameter
      GALGAS_string joker_19346_11 ; // Joker input parameter
      GALGAS_string joker_19346_10 ; // Joker input parameter
      GALGAS_observablePropertyMap joker_19346_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_19346_8 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_19346_7 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_19346_6 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_19346_5 ; // Joker input parameter
      GALGAS_relationshipList joker_19346_4 ; // Joker input parameter
      GALGAS_relationshipList joker_19346_3 ; // Joker input parameter
      GALGAS_propertyMap joker_19346_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_19346_1 ; // Joker input parameter
      GALGAS_stringset joker_19384_2 ; // Joker input parameter
      GALGAS__32_stringlist joker_19384_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_19230.current_mDestinationEntityName (HERE), joker_19346_12, joker_19346_11, joker_19346_10, joker_19346_9, joker_19346_8, joker_19346_7, joker_19346_6, joker_19346_5, joker_19346_4, joker_19346_3, joker_19346_2, joker_19346_1, var_destinationEntityRelationshipMap, joker_19384_2, joker_19384_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (492)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_inverseOfInverseRelationshipName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_19517_2 ; // Joker input parameter
      GALGAS_lstring joker_19517_1 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_19555_0 ; // Joker input parameter
      var_destinationEntityRelationshipMap.method_searchKey (enumerator_19230.current_mInverseRelationshipName (HERE), joker_19517_2, joker_19517_1, var_inverseOfInverseRelationshipName, joker_19555_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (494)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_19230.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_1 (enumerator_19230.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_1, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_19230.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (496)) COMMA_SOURCE_FILE_AT_LINE (496)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (496)) COMMA_SOURCE_FILE_AT_LINE (496)) ;
      }
...
void routine_analyzePreference (const GALGAS_preferencesDeclarationList_2E_element constinArgument_inPreference,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1124)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_44084 (constinArgument_inPreference.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_44084.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_actionMap.modifier_insertKey (enumerator_44084.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1126)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_44084.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observablePropertyMap var_observableAttributeMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1129)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1130)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeList enumerator_44386 (constinArgument_inPreference.mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_44386.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_checkDefaultValueType (enumerator_44386.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_44386.current_mType (HERE), enumerator_44386.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1132)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_attributeListForImplementation.addAssign_operation (enumerator_44386.current_mType (HERE), enumerator_44386.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1133)), enumerator_44386.current_mDefaultValueObjectiveCObject (HERE), enumerator_44386.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1133)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("preference.").operator_concat (constinArgument_inPreference.mAttribute_mPreferencesName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1135)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1135)).operator_concat (enumerator_44386.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1135)) COMMA_SOURCE_FILE_AT_LINE (1135)), enumerator_44386.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1134)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableAttributeMap.modifier_insertKey (enumerator_44386.current_mAttributeName (HERE), enumerator_44386.current_mType (HERE), GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1138)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1144)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_44386.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1151)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeTransientProperties (GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1153)), GALGAS_string ("preference.").operator_concat (constinArgument_inPreference.mAttribute_mPreferencesName.reader_string (SOURCE_FILE_AT_LINE (1154)) COMMA_SOURCE_FILE_AT_LINE (1154)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1154)), constinArgument_inPreference.mAttribute_mTransientList, GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1156)), GALGAS_string::makeEmptyString (), GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1158)), var_observableAttributeMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1152)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1165)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletDeclarationList enumerator_45834 (constinArgument_inPreference.mAttribute_mOutletDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_45834.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_outletClassBindingMap var_bindingMap ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_bool var_hasTableValueBinding ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_45955_2 ; // Joker input parameter
    GALGAS_string joker_45955_1 ; // Joker input parameter
    constinArgument_inOutletClassMap.method_searchKey (enumerator_45834.current_mOutletType (HERE), joker_45955_2, joker_45955_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1169)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1170)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_46095 (enumerator_45834.current_mOutletBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_46095.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_46095.current_mBinding (HERE).ptr (), GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1173)), var_observableAttributeMap, GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1175)), GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1176)), var_bindingMap, GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1178)), var_actionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1172)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_46095.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_outletGenerationList.addAssign_operation (enumerator_45834.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1185)), enumerator_45834.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1185)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1185)) ;
    enumerator_45834.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1188)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioPreferencesMap.modifier_insertKey (constinArgument_inPreference.mAttribute_mPreferencesName, var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, constinArgument_inPreference.mAttribute_mActionDeclarationList, var_observableAttributeMap, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1189)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_analyzePreferences (const GALGAS_preferencesDeclarationList constinArgument_inPreferencesList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1208)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_47382 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_47382.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzePreference (enumerator_47382.current (HERE), constinArgument_inOutletClassMap, outArgument_outPreferencesMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1210)) ;
    } //-------- @routineCallInstructionForGeneration
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outBindingOptionListForGeneration = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1246)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_48756 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_48756.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_48756.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1249)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_48945 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1251)).isValidAndTrue () ;
    if (enumerator_48945.hasCurrentObject () && bool_0) {
      while (enumerator_48945.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_49009 (enumerator_48756.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1252)).isValidAndTrue () ;
        if (enumerator_49009.hasCurrentObject () && bool_1) {
          while (enumerator_49009.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_48945.current_mType (HERE).objectCompare (enumerator_49009.current_mType (HERE))) ;
            enumerator_49009.gotoNextObject () ;
            if (enumerator_49009.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1252)).isValidAndTrue () ;
            }
          }
        }
        enumerator_48945.gotoNextObject () ;
        if (enumerator_48945.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1251)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (1256)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_49248 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (1258)).isValidAndTrue () ;
      if (enumerator_49248.hasCurrentObject () && bool_3) {
        while (enumerator_49248.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_49248.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1259)) COMMA_SOURCE_FILE_AT_LINE (1259)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1259)) COMMA_SOURCE_FILE_AT_LINE (1259)) ;
          enumerator_49248.gotoNextObject () ;
          if (enumerator_49248.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (1258)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_48756.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (1261)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_48756.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (1263)), enumerator_48756.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (1263)) ;
...
void routine_analyzeDocument (const GALGAS_documentDeclarationList_2E_element constinArgument_inDocument,
  ...
  GALGAS_relationshipMap var_allRelationshipMap ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_60297_0 ; // Joker input parameter
  GALGAS_string joker_60351_0 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_60418_8 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_60418_7 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_60418_6 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_60418_5 ; // Joker input parameter
  GALGAS_relationshipList joker_60418_4 ; // Joker input parameter
  GALGAS_relationshipList joker_60418_3 ; // Joker input parameter
  GALGAS_propertyMap joker_60418_2 ; // Joker input parameter
  GALGAS_relationshipMap joker_60418_1 ; // Joker input parameter
  GALGAS_stringset joker_60467_2 ; // Joker input parameter
  GALGAS__32_stringlist joker_60467_1 ; // Joker input parameter
  constinArgument_inEntityMap.method_searchKey (constinArgument_inDocument.mAttribute_mRootEntityName, joker_60297_0, var_rootEntityImplementationClassName, joker_60351_0, var_rootObjectObservablePropertyMap, joker_60418_8, joker_60418_7, joker_60418_6, joker_60418_5, joker_60418_4, joker_60418_3, joker_60418_2, joker_60418_1, var_allRelationshipMap, joker_60467_2, joker_60467_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1520)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1531)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1532)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerList enumerator_60691 (constinArgument_inDocument.mAttribute_mControllerList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_60691.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_60917_0 ; // Joker input parameter
    constinArgument_inControllerClassMap.method_searchKey (enumerator_60691.current_mControllerClassName (HERE), joker_60917_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1537)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_prefixedControllerObservablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1544)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_observablePropertyMap enumerator_61151 (var_controllerObservablePropertyMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_61151.hasCurrentObject ()) {
      enumerator_61151.gotoNextObject () ;
    }
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_61849_15 ; // Joker input parameter
    GALGAS_string joker_61849_14 ; // Joker input parameter
    GALGAS_string joker_61849_13 ; // Joker input parameter
    GALGAS_observablePropertyMap joker_61849_12 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_61849_11 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_61849_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_61849_9 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_61849_8 ; // Joker input parameter
    GALGAS_relationshipList joker_61849_7 ; // Joker input parameter
    GALGAS_relationshipList joker_61849_6 ; // Joker input parameter
    GALGAS_propertyMap joker_61849_5 ; // Joker input parameter
    GALGAS_relationshipMap joker_61849_4 ; // Joker input parameter
    GALGAS_relationshipMap joker_61849_3 ; // Joker input parameter
    GALGAS_stringset joker_61849_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_61849_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_60691.current_mControlledClassOrEntityName (HERE), joker_61849_15, joker_61849_14, joker_61849_13, joker_61849_12, joker_61849_11, joker_61849_10, joker_61849_9, joker_61849_8, joker_61849_7, joker_61849_6, joker_61849_5, joker_61849_4, joker_61849_3, joker_61849_2, joker_61849_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1567)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1568)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_61966 (enumerator_60691.current_mControllerBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_61966.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_61966.current_mBinding (HERE).ptr (), var_allRelationshipMap, var_controllerClassBindingMap, enumerator_60691.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1570)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_61966.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_controllerMap.modifier_insertKey (enumerator_60691.current_mControllerName (HERE), enumerator_60691.current_mControllerClassName (HERE).mAttribute_string, enumerator_60691.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1578)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_60691.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1589)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeTransientProperties (constinArgument_inPreferencesMap, GALGAS_string ("document.").operator_concat (constinArgument_inDocument.mAttribute_mDocumentName.reader_string (SOURCE_FILE_AT_LINE (1592)) COMMA_SOURCE_FILE_AT_LINE (1592)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1592)), constinArgument_inDocument.mAttribute_mTransientList, var_rootObjectObservablePropertyMap, constinArgument_inDocument.mAttribute_mRootEntityName.mAttribute_string, var_controllerMap, var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1590)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_actionMap var_documentActionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1603)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_63203 (constinArgument_inDocument.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_63203.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_documentActionMap.modifier_insertKey (enumerator_63203.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1605)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_63203.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1608)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletDeclarationList enumerator_63462 (constinArgument_inDocument.mAttribute_mOutletDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_63462.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_outletClassBindingMap var_bindingMap ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_bool var_hasTableValueBinding ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_63583_2 ; // Joker input parameter
    GALGAS_string joker_63583_1 ; // Joker input parameter
    constinArgument_inOutletClassMap.method_searchKey (enumerator_63462.current_mOutletType (HERE), joker_63583_2, joker_63583_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1612)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1613)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_63723 (enumerator_63462.current_mOutletBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_63723.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_63723.current_mBinding (HERE).ptr (), var_rootObjectObservablePropertyMap, var_observablePropertyMap, constinArgument_inPreferencesMap, constinArgument_inEntityMap, var_bindingMap, var_controllerMap, var_documentActionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1615)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_63723.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_outletGenerationList.addAssign_operation (enumerator_63462.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1628)), enumerator_63462.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1628)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1628)) ;
    enumerator_63462.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1631)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioDocumentMap.modifier_insertKey (constinArgument_inDocument.mAttribute_mDocumentName, constinArgument_inDocument.mAttribute_mRootEntityName.mAttribute_string, var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, constinArgument_inDocument.mAttribute_mActionDeclarationList, var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1632)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1655)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_65126 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_65126.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeDocument (enumerator_65126.current (HERE), constinArgument_inOutletClassMap, constinArgument_inControllerClassMap, constinArgument_inEntityMap, constinArgument_inPreferencesMap, outArgument_outDocumentMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1657)) ;
    } //-------- @routineCallInstructionForGeneration
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_65690 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1677)).isValidAndTrue () ;
  if (enumerator_65690.hasCurrentObject () && bool_0) {
    while (enumerator_65690.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_65690.current_mType (HERE))) ;
      enumerator_65690.gotoNextObject () ;
      if (enumerator_65690.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1677)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1680)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (1681)) ;
  }
}
...
void routine_analyzeClass (const GALGAS_classList_2E_element constinArgument_inClass,
  ...
  GALGAS_observablePropertyMap var_observablePropertyMap ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1694)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, constinArgument_inClass.mAttribute_mSuperClassName.reader_string (SOURCE_FILE_AT_LINE (1695)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_66393_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_66452_4 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_66452_3 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_66452_2 ; // Joker input parameter
    GALGAS_stringset joker_66452_1 ; // Joker input parameter
    ioArgument_ioClassMap.method_searchKey (constinArgument_inClass.mAttribute_mSuperClassName, joker_66393_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_66452_4, joker_66452_3, joker_66452_2, joker_66452_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1696)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @assignmentInstructionForGeneration
    var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1698)) ;
    //-------- @assignmentInstructionForGeneration
    var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1699)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1702)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeList enumerator_66912 (constinArgument_inClass.mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_66912.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_checkDefaultValueType (enumerator_66912.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_66912.current_mType (HERE), enumerator_66912.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1705)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_attributeListForImplementation.addAssign_operation (enumerator_66912.current_mType (HERE), enumerator_66912.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1706)), enumerator_66912.current_mDefaultValueObjectiveCObject (HERE), enumerator_66912.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1706)) ;
    //-------- @plusEqualnstructionForGeneration
    var_propertyListForInitMethodHeader.addAssign_operation (enumerator_66912.current_mType (HERE), enumerator_66912.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1707)), enumerator_66912.current_mDefaultValueObjectiveCObject (HERE), enumerator_66912.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1707)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("class.").operator_concat (constinArgument_inClass.mAttribute_mClassName.reader_string (SOURCE_FILE_AT_LINE (1709)) COMMA_SOURCE_FILE_AT_LINE (1709)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1709)).operator_concat (enumerator_66912.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1709)) COMMA_SOURCE_FILE_AT_LINE (1709)), enumerator_66912.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1708)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_66912.current_mAttributeName (HERE), enumerator_66912.current_mType (HERE), GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1712)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1718)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_66912.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1725)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeTransientProperties (GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1727)), GALGAS_string ("class.").operator_concat (constinArgument_inClass.mAttribute_mClassName.reader_string (SOURCE_FILE_AT_LINE (1728)) COMMA_SOURCE_FILE_AT_LINE (1728)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1728)), constinArgument_inClass.mAttribute_mTransientList, GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1730)), GALGAS_string::makeEmptyString (), GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1732)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1726)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1739)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioClassMap.modifier_insertKey (constinArgument_inClass.mAttribute_mClassName, constinArgument_inClass.mAttribute_mSuperClassName.mAttribute_string, var_observablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1740)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1759)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_68982 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_68982.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeClass (enumerator_68982.current (HERE), outArgument_outClassMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1761)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_68982.gotoNextObject () ;
  }
}
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1775)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_69377 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_69377.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1778)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_69474 (enumerator_69377.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_69474.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1780)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_69586 (enumerator_69474.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_69586.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_69586.current_mBindingOptionName (HERE), enumerator_69586.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1782)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_69586.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_69474.current_mBindingName (HERE), enumerator_69474.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1788)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_69474.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_69377.current_mOutletClassName (HERE), enumerator_69377.current_mGenerateCode (HERE), enumerator_69377.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, enumerator_69377.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1791)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_69377.gotoNextObject () ;
  }
}
...
void routine_analyzeControllerClass (const GALGAS_controllerClassList_2E_element constinArgument_inController,
                                     ...
                                     COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1809)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_70494 (constinArgument_inController.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_70494.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_actionMap.modifier_insertKey (enumerator_70494.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1811)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_70494.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1814)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassBindingList enumerator_70650 (constinArgument_inController.mAttribute_mBindingList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_70650.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1816)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingOptionList enumerator_70758 (enumerator_70650.current_mBindingOptionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_70758.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_outletClassBindingOptionMap.modifier_insertKey (enumerator_70758.current_mBindingOptionName (HERE), enumerator_70758.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1818)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_70758.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_bindingMap.modifier_insertKey (enumerator_70650.current_mBindingName (HERE), enumerator_70650.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1824)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_70650.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1827)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerObservablePropertyList enumerator_71204 (constinArgument_inController.mAttribute_mControllerObservablePropertyList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_71204.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("controller.").operator_concat (constinArgument_inController.mAttribute_mControllerClassName.reader_string (SOURCE_FILE_AT_LINE (1830)) COMMA_SOURCE_FILE_AT_LINE (1830)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1830)).operator_concat (enumerator_71204.current (HERE).mAttribute_mPropertyName.reader_string (SOURCE_FILE_AT_LINE (1830)) COMMA_SOURCE_FILE_AT_LINE (1830)), enumerator_71204.current (HERE).mAttribute_mPropertyName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1829)) ;
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1833)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_71204.current (HERE).mAttribute_mPropertyName, enumerator_71204.current (HERE).mAttribute_mType, GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1837)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_71204.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioControllerClassMap.modifier_insertKey (constinArgument_inController.mAttribute_mControllerClassName, constinArgument_inController.mAttribute_mGenerateCode, var_bindingMap, var_actionMap, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1845)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1861)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_72267 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_72267.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeControllerClass (enumerator_72267.current (HERE), ioArgument_ioTransientDependencyGraph, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1863)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_72267.gotoNextObject () ;
  }
}
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outSortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1885)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (1886)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1887)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, var_transientDependencyGraph, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1888)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1889)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1895)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1900)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outPreferencesMap, outArgument_outDocumentMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1906)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1916)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (1916)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = var_transientDependencyGraph.reader_graphviz (SOURCE_FILE_AT_LINE (1917)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_path = inArgument_inSourceFilePath.operator_concat (GALGAS_string (".transientDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (1918)) ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_74031_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_74031_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1919)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outTransientDependencyArcList = var_transientDependencyGraph.reader_arcs (SOURCE_FILE_AT_LINE (1922)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1923)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_transientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (1924)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_74311 (var_transientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (1925)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_74311.hasCurrentObject ()) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inAST.mAttribute_mEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_74311.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1926)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (1926)) COMMA_SOURCE_FILE_AT_LINE (1926)) ;
        enumerator_74311.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_2) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_stringlist var_unsortedTransientList ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstringlist joker_74569_0 ; // Joker input parameter
      GALGAS_lstringlist joker_74611_0 ; // Joker input parameter
      var_transientDependencyGraph.method_topologicalSort (outArgument_outSortedTransientOrderedList, joker_74569_0, var_unsortedTransientList, joker_74611_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1930)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1936)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1937)).reader_string (SOURCE_FILE_AT_LINE (1937)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:") COMMA_SOURCE_FILE_AT_LINE (1937)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_74841 (var_unsortedTransientList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_74841.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_74841.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1939)) COMMA_SOURCE_FILE_AT_LINE (1939)) ;
          enumerator_74841.gotoNextObject () ;
        }
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inAST.mAttribute_mEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (1941)) ;
      }
    }
  }
}
...
static GALGAS_string categoryReader_tableValueBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_columnBindingForTableValueBindingForGeneration enumerator_5747 (object->mAttribute_mColumnBindingForTableValueBindingForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_5747.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("  if (nil == [").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (enumerator_5747.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (GALGAS_string ("\"]) {\n") COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (GALGAS_string ("' NSTableView outlet has no formatter has no column with the ") COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (enumerator_5747.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (GALGAS_string (" identifier\") ;\n") COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (GALGAS_string ("  }else{\n") COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (GALGAS_string ("    NSActionCell * cell = [") COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (enumerator_5747.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (GALGAS_string ("\"].dataCell ;\n") COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (GALGAS_string ("    if (! [cell isKindOfClass:[") COMMA_SOURCE_FILE_AT_LINE (155)).operator_concat (enumerator_5747.current (HERE).mAttribute_mRequiredCellClass COMMA_SOURCE_FILE_AT_LINE (155)).operator_concat (GALGAS_string (" class]]) {\n") COMMA_SOURCE_FILE_AT_LINE (155)).operator_concat (GALGAS_string ("      presentErrorWindow (__FILE__, __LINE__, @\"the dataCell is '") COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (enumerator_5747.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (GALGAS_string ("' column of the '") COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (GALGAS_string ("' should be an '") COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (enumerator_5747.current (HERE).mAttribute_mRequiredCellClass COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (GALGAS_string (" instance\") ;\n") COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (GALGAS_string ("    }\n") COMMA_SOURCE_FILE_AT_LINE (157)).operator_concat (GALGAS_string ("  }\n") COMMA_SOURCE_FILE_AT_LINE (158)).operator_concat (GALGAS_string ("  [[") COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (enumerator_5747.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (GALGAS_string ("\"]\n") COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (GALGAS_string ("    bind:@\"value\"\n") COMMA_SOURCE_FILE_AT_LINE (160)).operator_concat (GALGAS_string ("    toObject:") COMMA_SOURCE_FILE_AT_LINE (161)).operator_concat (object->mAttribute_mControllerName COMMA_SOURCE_FILE_AT_LINE (161)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (161)).operator_concat (GALGAS_string ("    withKeyPath:@\"arrangedObjects.") COMMA_SOURCE_FILE_AT_LINE (162)).operator_concat (enumerator_5747.current (HERE).mAttribute_mObservableAttributeName COMMA_SOURCE_FILE_AT_LINE (162)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (162)).operator_concat (GALGAS_string ("    options:") COMMA_SOURCE_FILE_AT_LINE (163)) COMMA_SOURCE_FILE_AT_LINE (151)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_5747.current (HERE).mAttribute_mOutletBindingOptionList.reader_length (SOURCE_FILE_AT_LINE (164)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_7071 (enumerator_5747.current (HERE).mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_7071.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("      ").operator_concat (enumerator_7071.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (169)).operator_concat (GALGAS_string (", @") COMMA_SOURCE_FILE_AT_LINE (169)).operator_concat (enumerator_7071.current_mValue_30_ (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (169)) COMMA_SOURCE_FILE_AT_LINE (169)).operator_concat (GALGAS_string (",\n") COMMA_SOURCE_FILE_AT_LINE (169)) COMMA_SOURCE_FILE_AT_LINE (169)) ;
...
static GALGAS_string categoryReader_regularBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator__32_stringlist enumerator_9198 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_9198.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("      ").operator_concat (enumerator_9198.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (GALGAS_string (", @") COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (enumerator_9198.current_mValue_30_ (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (210)) COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (GALGAS_string (",\n") COMMA_SOURCE_FILE_AT_LINE (210)) COMMA_SOURCE_FILE_AT_LINE (210)) ;
...
static GALGAS_string categoryReader_tableValueBindingForGeneration_generateRemoveBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_columnBindingForTableValueBindingForGeneration enumerator_10143 (object->mAttribute_mColumnBindingForTableValueBindingForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_10143.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("  [[").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (242)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (242)).operator_concat (enumerator_10143.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (242)).operator_concat (GALGAS_string ("\"]\n") COMMA_SOURCE_FILE_AT_LINE (242)).operator_concat (GALGAS_string ("    unbind:@\"value\"\n") COMMA_SOURCE_FILE_AT_LINE (243)).operator_concat (GALGAS_string ("  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (242)) ;
...
static void categoryMethod_tableValueBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_21290_0 ; // Joker input parameter
    GALGAS_actionMap joker_21363_0 ; // Joker input parameter
    GALGAS_observablePropertyMap joker_21372_0 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_21290_0, var_controlledClassOrEntityName, var_controllerBindingList, joker_21363_0, joker_21372_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (536)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_21473_3 ; // Joker input parameter
    GALGAS_string joker_21473_2 ; // Joker input parameter
    GALGAS_string joker_21473_1 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21536_11 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21536_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21536_9 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_21536_8 ; // Joker input parameter
    GALGAS_relationshipList joker_21536_7 ; // Joker input parameter
    GALGAS_relationshipList joker_21536_6 ; // Joker input parameter
    GALGAS_propertyMap joker_21536_5 ; // Joker input parameter
    GALGAS_relationshipMap joker_21536_4 ; // Joker input parameter
    GALGAS_relationshipMap joker_21536_3 ; // Joker input parameter
    GALGAS_stringset joker_21536_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_21536_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (GALGAS_lstring::constructor_new (var_controlledClassOrEntityName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (545)), joker_21473_3, joker_21473_2, joker_21473_1, var_observablePropertyMap, joker_21536_11, joker_21536_10, joker_21536_9, joker_21536_8, joker_21536_7, joker_21536_6, joker_21536_5, joker_21536_4, joker_21536_3, joker_21536_2, joker_21536_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (544)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_tableValueColumnBinding enumerator_21704 (object->mAttribute_mTableValueColumnBinding, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_21704.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingType var_type ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_21821_0 ; // Joker input parameter
      GALGAS_string joker_21832_0 ; // Joker input parameter
      var_observablePropertyMap.method_searchKey (enumerator_21704.current (HERE).mAttribute_mBoundPropertyName, var_type, joker_21821_0, joker_21832_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (552)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      ...
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_21704.current (HERE).mAttribute_mBoundPropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
        ...
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_requiredCellTypeInTableColumnBinding.objectCompare (enumerator_21704.current (HERE).mAttribute_mCellTypeName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_21704.current (HERE).mAttribute_mCellTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      //-------- @plusEqualnstructionForGeneration
      var_columnBindingForTableValueBindingForGeneration.addAssign_operation (enumerator_21704.current (HERE).mAttribute_mColumnName.mAttribute_string, var_requiredCellTypeInTableColumnBinding, enumerator_21704.current (HERE).mAttribute_mBoundPropertyName.mAttribute_string, GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (568)) COMMA_SOURCE_FILE_AT_LINE (564)) ;
...
static void categoryMethod_runBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_23541_3 ; // Joker input parameter
    GALGAS_string joker_23541_2 ; // Joker input parameter
    GALGAS_outletBindingListForGeneration joker_23541_1 ; // Joker input parameter
    GALGAS_observablePropertyMap joker_23556_0 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mTargetName, joker_23541_3, joker_23541_2, joker_23541_1, var_actionMap, joker_23556_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (596)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
...
static void categoryMethod_regularControllerBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_24736_4 ; // Joker input parameter
  GALGAS_string joker_24736_3 ; // Joker input parameter
  GALGAS_outletBindingListForGeneration joker_24736_2 ; // Joker input parameter
  GALGAS_actionMap joker_24736_1 ; // Joker input parameter
  constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_24736_4, joker_24736_3, joker_24736_2, joker_24736_1, var_observableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (626)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_25630 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (650)).isValidAndTrue () ;
  if (enumerator_25630.hasCurrentObject () && bool_3) {
    while (enumerator_25630.hasCurrentObject () && bool_3) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_25630.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_25630.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_25630.gotoNextObject () ;
      if (enumerator_25630.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_4) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_25934 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (656)).isValidAndTrue () ;
    if (enumerator_25934.hasCurrentObject () && bool_5) {
      while (enumerator_25934.hasCurrentObject () && bool_5) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_25934.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (657)) COMMA_SOURCE_FILE_AT_LINE (657)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (657)) COMMA_SOURCE_FILE_AT_LINE (657)) ;
        enumerator_25934.gotoNextObject () ;
        if (enumerator_25934.hasCurrentObject ()) {
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_26169 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_26169.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_26169.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (665)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_26358 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (667)).isValidAndTrue () ;
    if (enumerator_26358.hasCurrentObject () && bool_7) {
      while (enumerator_26358.hasCurrentObject () && bool_7) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_26422 (enumerator_26169.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (668)).isValidAndTrue () ;
        if (enumerator_26422.hasCurrentObject () && bool_8) {
          while (enumerator_26422.hasCurrentObject () && bool_8) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_26358.current_mType (HERE).objectCompare (enumerator_26422.current_mType (HERE))) ;
            enumerator_26422.gotoNextObject () ;
            if (enumerator_26422.hasCurrentObject ()) {
              bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (668)).isValidAndTrue () ;
            }
          }
        }
        enumerator_26358.gotoNextObject () ;
        if (enumerator_26358.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_9) {
      ...
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_26661 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (674)).isValidAndTrue () ;
      if (enumerator_26661.hasCurrentObject () && bool_10) {
        while (enumerator_26661.hasCurrentObject () && bool_10) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_26661.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (675)) COMMA_SOURCE_FILE_AT_LINE (675)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (675)) COMMA_SOURCE_FILE_AT_LINE (675)) ;
          enumerator_26661.gotoNextObject () ;
          if (enumerator_26661.hasCurrentObject ()) {
            bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (674)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_11 (enumerator_26169.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_11, var_s COMMA_SOURCE_FILE_AT_LINE (677)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_26169.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (679)), enumerator_26169.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (679)) ;
...
static void categoryMethod_regularRootBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_easyBindingType var_observablePropertyType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_28218_0 ; // Joker input parameter
  GALGAS_string joker_28225_0 ; // Joker input parameter
  constinArgument_inRootEntityObservableAttributeMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_28218_0, joker_28225_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (711)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_28901 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (730)).isValidAndTrue () ;
  if (enumerator_28901.hasCurrentObject () && bool_3) {
    while (enumerator_28901.hasCurrentObject () && bool_3) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_28901.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_28901.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_28901.gotoNextObject () ;
      if (enumerator_28901.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_4) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_29205 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (736)).isValidAndTrue () ;
    if (enumerator_29205.hasCurrentObject () && bool_5) {
      while (enumerator_29205.hasCurrentObject () && bool_5) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_29205.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (737)) COMMA_SOURCE_FILE_AT_LINE (737)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (737)) COMMA_SOURCE_FILE_AT_LINE (737)) ;
        enumerator_29205.gotoNextObject () ;
        if (enumerator_29205.hasCurrentObject ()) {
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_29478 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29478.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_29478.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (745)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_29667 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (747)).isValidAndTrue () ;
    if (enumerator_29667.hasCurrentObject () && bool_7) {
      while (enumerator_29667.hasCurrentObject () && bool_7) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_29731 (enumerator_29478.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (748)).isValidAndTrue () ;
        if (enumerator_29731.hasCurrentObject () && bool_8) {
          while (enumerator_29731.hasCurrentObject () && bool_8) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_29667.current_mType (HERE).objectCompare (enumerator_29731.current_mType (HERE))) ;
            enumerator_29731.gotoNextObject () ;
            if (enumerator_29731.hasCurrentObject ()) {
              bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (748)).isValidAndTrue () ;
            }
          }
        }
        enumerator_29667.gotoNextObject () ;
        if (enumerator_29667.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_9) {
      ...
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_29970 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (754)).isValidAndTrue () ;
      if (enumerator_29970.hasCurrentObject () && bool_10) {
        while (enumerator_29970.hasCurrentObject () && bool_10) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_29970.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (755)) COMMA_SOURCE_FILE_AT_LINE (755)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (755)) COMMA_SOURCE_FILE_AT_LINE (755)) ;
          enumerator_29970.gotoNextObject () ;
          if (enumerator_29970.hasCurrentObject ()) {
            bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (754)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_11 (enumerator_29478.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_11, var_s COMMA_SOURCE_FILE_AT_LINE (757)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_29478.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (759)), enumerator_29478.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (759)) ;
    enumerator_29478.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_regularSelfBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_easyBindingType var_observablePropertyType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_31567_0 ; // Joker input parameter
  GALGAS_string joker_31574_0 ; // Joker input parameter
  constinArgument_inSelfObservableAttributeMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_31567_0, joker_31574_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (792)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_observableKeyPath = object->mAttribute_mObservableAttributeName.mAttribute_string ;
  //-------- @ifInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_32250 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (811)).isValidAndTrue () ;
  if (enumerator_32250.hasCurrentObject () && bool_3) {
    while (enumerator_32250.hasCurrentObject () && bool_3) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_32250.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_32250.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_32250.gotoNextObject () ;
      if (enumerator_32250.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_4) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_32554 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (817)).isValidAndTrue () ;
    if (enumerator_32554.hasCurrentObject () && bool_5) {
      while (enumerator_32554.hasCurrentObject () && bool_5) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_32554.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (818)) COMMA_SOURCE_FILE_AT_LINE (818)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (818)) COMMA_SOURCE_FILE_AT_LINE (818)) ;
        enumerator_32554.gotoNextObject () ;
        if (enumerator_32554.hasCurrentObject ()) {
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_32827 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_32827.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_32827.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (826)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_33016 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (828)).isValidAndTrue () ;
    if (enumerator_33016.hasCurrentObject () && bool_7) {
      while (enumerator_33016.hasCurrentObject () && bool_7) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_33080 (enumerator_32827.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (829)).isValidAndTrue () ;
        if (enumerator_33080.hasCurrentObject () && bool_8) {
          while (enumerator_33080.hasCurrentObject () && bool_8) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_33016.current_mType (HERE).objectCompare (enumerator_33080.current_mType (HERE))) ;
            enumerator_33080.gotoNextObject () ;
            if (enumerator_33080.hasCurrentObject ()) {
              bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (829)).isValidAndTrue () ;
            }
          }
        }
        enumerator_33016.gotoNextObject () ;
        if (enumerator_33016.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_9) {
      ...
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_33319 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (835)).isValidAndTrue () ;
      if (enumerator_33319.hasCurrentObject () && bool_10) {
        while (enumerator_33319.hasCurrentObject () && bool_10) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_33319.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (836)) COMMA_SOURCE_FILE_AT_LINE (836)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (836)) COMMA_SOURCE_FILE_AT_LINE (836)) ;
          enumerator_33319.gotoNextObject () ;
          if (enumerator_33319.hasCurrentObject ()) {
            bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (835)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_11 (enumerator_32827.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_11, var_s COMMA_SOURCE_FILE_AT_LINE (838)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_32827.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (840)), enumerator_32827.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (840)) ;
    enumerator_32827.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_regularPreferenceBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_observablePropertyMap var_observablePropertyMap ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_attributeListForImplementation joker_34886_4 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_34886_3 ; // Joker input parameter
  GALGAS_outletGenerationList joker_34886_2 ; // Joker input parameter
  GALGAS_lstringlist joker_34886_1 ; // Joker input parameter
  GALGAS_stringset joker_34944_0 ; // Joker input parameter
  constinArgument_inPreferencesMap.method_searchKey (object->mAttribute_mPreferenceName, joker_34886_4, joker_34886_3, joker_34886_2, joker_34886_1, var_observablePropertyMap, joker_34944_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (874)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_observablePropertyType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_35167_0 ; // Joker input parameter
  GALGAS_string joker_35174_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceAttributeName, var_observablePropertyType, joker_35167_0, joker_35174_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (881)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_35385 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (890)).isValidAndTrue () ;
  if (enumerator_35385.hasCurrentObject () && bool_0) {
    while (enumerator_35385.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_35385.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_35385.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_35385.gotoNextObject () ;
      if (enumerator_35385.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_1) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_35689 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (896)).isValidAndTrue () ;
    if (enumerator_35689.hasCurrentObject () && bool_2) {
      while (enumerator_35689.hasCurrentObject () && bool_2) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_35689.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (897)) COMMA_SOURCE_FILE_AT_LINE (897)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (897)) COMMA_SOURCE_FILE_AT_LINE (897)) ;
        enumerator_35689.gotoNextObject () ;
        if (enumerator_35689.hasCurrentObject ()) {
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_35962 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_35962.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_35962.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (905)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_36151 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (907)).isValidAndTrue () ;
    if (enumerator_36151.hasCurrentObject () && bool_4) {
      while (enumerator_36151.hasCurrentObject () && bool_4) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_36215 (enumerator_35962.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (908)).isValidAndTrue () ;
        if (enumerator_36215.hasCurrentObject () && bool_5) {
          while (enumerator_36215.hasCurrentObject () && bool_5) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_36151.current_mType (HERE).objectCompare (enumerator_36215.current_mType (HERE))) ;
            enumerator_36215.gotoNextObject () ;
            if (enumerator_36215.hasCurrentObject ()) {
              bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (908)).isValidAndTrue () ;
            }
          }
        }
        enumerator_36151.gotoNextObject () ;
        if (enumerator_36151.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_6) {
      ...
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_36454 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (914)).isValidAndTrue () ;
      if (enumerator_36454.hasCurrentObject () && bool_7) {
        while (enumerator_36454.hasCurrentObject () && bool_7) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_36454.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (915)) COMMA_SOURCE_FILE_AT_LINE (915)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (915)) COMMA_SOURCE_FILE_AT_LINE (915)) ;
          enumerator_36454.gotoNextObject () ;
          if (enumerator_36454.hasCurrentObject ()) {
            bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (914)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_8 (enumerator_35962.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_8, var_s COMMA_SOURCE_FILE_AT_LINE (917)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_35962.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (919)), enumerator_35962.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (919)) ;
...
static void categoryMethod_multiValuedBindingBoundToRoot_analyzeModel (const cPtr_multiValuedBindingBoundModel * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_38018_0 ; // Joker input parameter
  GALGAS_string joker_38025_0 ; // Joker input parameter
  constinArgument_inRootEntityObservableAttributeMap.method_searchKey (object->mAttribute_mPropertyName, outArgument_outObservablePropertyType, joker_38018_0, joker_38025_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (954)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_multiValuedBindingBoundToSelf_analyzeModel (const cPtr_multiValuedBindingBoundModel * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_38674_0 ; // Joker input parameter
  GALGAS_string joker_38681_0 ; // Joker input parameter
  constinArgument_inSelfObservableAttributeMap.method_searchKey (object->mAttribute_mPropertyName, outArgument_outObservablePropertyType, joker_38674_0, joker_38681_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (974)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_multiValuedBindingBoundToPref_analyzeModel (const cPtr_multiValuedBindingBoundModel * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_attributeListForImplementation joker_39275_4 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_39275_3 ; // Joker input parameter
  GALGAS_outletGenerationList joker_39275_2 ; // Joker input parameter
  GALGAS_lstringlist joker_39275_1 ; // Joker input parameter
  GALGAS_stringset joker_39344_0 ; // Joker input parameter
  constinArgument_inPreferencesMap.method_searchKey (object->mAttribute_mPreferenceName, joker_39275_4, joker_39275_3, joker_39275_2, joker_39275_1, var_preferenceObservableAttributeMap, joker_39344_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (994)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_39453_0 ; // Joker input parameter
  GALGAS_string joker_39460_0 ; // Joker input parameter
  var_preferenceObservableAttributeMap.method_searchKey (object->mAttribute_mPropertyName, outArgument_outObservablePropertyType, joker_39453_0, joker_39460_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1000)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outObservedObjectName = GALGAS_string ("g_").operator_concat (object->mAttribute_mPreferenceName.reader_string (SOURCE_FILE_AT_LINE (1006)) COMMA_SOURCE_FILE_AT_LINE (1006)) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioImplementationFileInclusionSet.addAssign_operation (object->mAttribute_mPreferenceName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1007)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_multiValuedBindingBoundToController_analyzeModel (const cPtr_multiValuedBindingBoundModel * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_40147_4 ; // Joker input parameter
  GALGAS_string joker_40147_3 ; // Joker input parameter
  GALGAS_outletBindingListForGeneration joker_40147_2 ; // Joker input parameter
  GALGAS_actionMap joker_40147_1 ; // Joker input parameter
  constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_40147_4, joker_40147_3, joker_40147_2, joker_40147_1, var_controllerObservableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1021)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_40318_0 ; // Joker input parameter
  GALGAS_string joker_40325_0 ; // Joker input parameter
  var_controllerObservableAttributeMap.method_searchKey (object->mAttribute_mPropertyName, outArgument_outObservablePropertyType, joker_40318_0, joker_40325_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1026)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_multiValuedBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_easyBindingTypeAndFormatterList var_acceptableTypeFormatterList ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1051)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_multiValuedBindingList enumerator_41362 (object->mAttribute_mMultiValuedBindingList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_41362.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_string var_observedObjectName ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_observablePropertyType ;
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_analyzeModel ((const cPtr_multiValuedBindingBoundModel *) enumerator_41362.current_mBoundModel (HERE).ptr (), constinArgument_inRootEntityObservableAttributeMap, constinArgument_inSelfObservableAttributeMap, constinArgument_inPreferencesMap, constinArgument_inControllerMap, ioArgument_ioImplementationFileInclusionSet, var_observedObjectName, var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (1056)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (1067)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_41860 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1068)).isValidAndTrue () ;
    if (enumerator_41860.hasCurrentObject () && bool_0) {
      while (enumerator_41860.hasCurrentObject () && bool_0) {
        //-------- @assignmentInstructionForGeneration
        var_requiredFormatter = enumerator_41860.current_mRequiredFormatter (HERE) ;
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (kIsEqual, enumerator_41860.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
        enumerator_41860.gotoNextObject () ;
        if (enumerator_41860.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1068)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1072)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (1073)) COMMA_SOURCE_FILE_AT_LINE (1073)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (1073)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeAndFormatterList enumerator_42176 (var_acceptableTypeFormatterList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (1074)).isValidAndTrue () ;
      if (enumerator_42176.hasCurrentObject () && bool_2) {
        while (enumerator_42176.hasCurrentObject () && bool_2) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_42176.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1075)) COMMA_SOURCE_FILE_AT_LINE (1075)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1075)) COMMA_SOURCE_FILE_AT_LINE (1075)) ;
          enumerator_42176.gotoNextObject () ;
          if (enumerator_42176.hasCurrentObject ()) {
            bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (1074)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (enumerator_41362.current_mBoundModel (HERE).reader_mPropertyName (SOURCE_FILE_AT_LINE (1077)).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, var_s COMMA_SOURCE_FILE_AT_LINE (1077)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1080)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_4 = enumerator_41362.current_mNegate (HERE).boolEnum () ;
    if (kBoolTrue == test_4) {
      //-------- @plusEqualnstructionForGeneration
      var_bindingOptionList.addAssign_operation (GALGAS_string ("NSValueTransformerName"), GALGAS_string ("NSNegateBooleanTransformerName") COMMA_SOURCE_FILE_AT_LINE (1082)) ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletBindingOptionList enumerator_42551 (enumerator_41362.current_mOutletBindingOptionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42551.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingTypeList var_acceptableTypeList ;
      //-------- @methodCallInstructionForGeneration
      var_outletClassBindingOptionMap.method_searchKey (enumerator_42551.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1086)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_bool var_found = GALGAS_bool (false) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_42748 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (1088)).isValidAndTrue () ;
      if (enumerator_42748.hasCurrentObject () && bool_5) {
        while (enumerator_42748.hasCurrentObject () && bool_5) {
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeList enumerator_42814 (enumerator_42551.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (1089)).isValidAndTrue () ;
          if (enumerator_42814.hasCurrentObject () && bool_6) {
            while (enumerator_42814.hasCurrentObject () && bool_6) {
              //-------- @assignmentInstructionForGeneration
              var_found = GALGAS_bool (kIsEqual, enumerator_42748.current_mType (HERE).objectCompare (enumerator_42814.current_mType (HERE))) ;
              enumerator_42814.gotoNextObject () ;
              if (enumerator_42814.hasCurrentObject ()) {
                bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (1089)).isValidAndTrue () ;
              }
            }
          }
          enumerator_42748.gotoNextObject () ;
          if (enumerator_42748.hasCurrentObject ()) {
            bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (1088)).isValidAndTrue () ;
          }
        }
      }
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (1093)).boolEnum () ;
      if (kBoolTrue == test_7) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_43065 (var_acceptableTypeList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (1095)).isValidAndTrue () ;
        if (enumerator_43065.hasCurrentObject () && bool_8) {
          while (enumerator_43065.hasCurrentObject () && bool_8) {
            //-------- @concatInstructionForGeneration
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  - '").operator_concat (categoryReader_ebTypeName (enumerator_43065.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1096)) COMMA_SOURCE_FILE_AT_LINE (1096)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1096)) COMMA_SOURCE_FILE_AT_LINE (1096)) ;
            enumerator_43065.gotoNextObject () ;
            if (enumerator_43065.hasCurrentObject ()) {
              bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (1095)).isValidAndTrue () ;
            }
          }
        }
        //-------- @errorInstructionForGeneration
        GALGAS_location location_9 (enumerator_42551.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_9, var_s COMMA_SOURCE_FILE_AT_LINE (1098)) ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_bindingOptionList.addAssign_operation (enumerator_42551.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (1100)), enumerator_42551.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (1100)) ;
      enumerator_42551.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (var_generatedBindingName, var_requiredFormatter, var_observedObjectName, enumerator_41362.current_mBoundModel (HERE).reader_mPropertyName (SOURCE_FILE_AT_LINE (1106)).mAttribute_string, var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (1102)) COMMA_SOURCE_FILE_AT_LINE (1102)) ;
    //-------- @incrementInstructionForGeneration
    var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (1110)) ;
    //-------- @assignmentInstructionForGeneration
    var_generatedBindingName = object->mAttribute_mBindingName.mAttribute_string.operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (1111)) COMMA_SOURCE_FILE_AT_LINE (1111)) ;
    enumerator_41362.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
GALGAS_string categoryReader_ebTypeIdentifier (const GALGAS_easyBindingType & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inClassOrEntityName COMMA_SOURCE_FILE_AT_LINE (1235)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1235)) ;
      } break ;
    }
  }
//---
...
static void categoryMethod_regularPreferenceBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a preference does not implement the $").operator_concat (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (1286)) COMMA_SOURCE_FILE_AT_LINE (1286)).operator_concat (GALGAS_string (" binding") COMMA_SOURCE_FILE_AT_LINE (1286)) COMMA_SOURCE_FILE_AT_LINE (1286)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_multiValuedBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @errorInstructionForGeneration
  GALGAS_location location_0 (object->mAttribute_mBindingName.reader_location (HERE)) ; // Implicit use of 'location' reader
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement the $").operator_concat (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (1298)) COMMA_SOURCE_FILE_AT_LINE (1298)).operator_concat (GALGAS_string (" binding") COMMA_SOURCE_FILE_AT_LINE (1298)) COMMA_SOURCE_FILE_AT_LINE (1298)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_tableValueBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (1310)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $run action") COMMA_SOURCE_FILE_AT_LINE (1322)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularControllerBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @errorInstructionForGeneration
  GALGAS_location location_0 (object->mAttribute_mBindingName.reader_location (HERE)) ; // Implicit use of 'location' reader
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $").operator_concat (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (1334)) COMMA_SOURCE_FILE_AT_LINE (1334)).operator_concat (GALGAS_string (" binding") COMMA_SOURCE_FILE_AT_LINE (1334)) COMMA_SOURCE_FILE_AT_LINE (1334)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularRootBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1404)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_55636_2 ; // Joker input parameter
    GALGAS_string joker_55636_1 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_55636_2, joker_55636_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1406)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1407)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1408)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_55933_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_55933_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_55933_2, joker_55933_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1411)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1413)) COMMA_SOURCE_FILE_AT_LINE (1413)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1413)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1415)) COMMA_SOURCE_FILE_AT_LINE (1415)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1415)) ;
      }
    }else if (kBoolFalse == test_1) {
      //-------- @errorInstructionForGeneration
      ...
      inCompiler->emitSemanticError (location_3, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (1418)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1424)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_56564 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1427)).isValidAndTrue () ;
  if (enumerator_56564.hasCurrentObject () && bool_4) {
    while (enumerator_56564.hasCurrentObject () && bool_4) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_56564.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1428)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (1429)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1429)) COMMA_SOURCE_FILE_AT_LINE (1429)) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, var_boundTypeIdentifierString.objectCompare (var_acceptableType)) ;
      enumerator_56564.gotoNextObject () ;
      if (enumerator_56564.hasCurrentObject ()) {
        bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1427)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (1432)).boolEnum () ;
  if (kBoolTrue == test_5) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_6 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_6, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (1434)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (1434)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (1434)) COMMA_SOURCE_FILE_AT_LINE (1433)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1437)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (1444)), GALGAS_string ("mRootObjectController"), GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (1446)) COMMA_SOURCE_FILE_AT_LINE (1446)), var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1442)) COMMA_SOURCE_FILE_AT_LINE (1442)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularSelfBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_string var_boundTypeIdentifierString ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1461)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_58020_2 ; // Joker input parameter
    GALGAS_string joker_58020_1 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_58020_2, joker_58020_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1463)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1464)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1465)).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_bool var_isToMany ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_destinationEntityName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_58317_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_58317_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_58317_2, joker_58317_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1468)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1470)) COMMA_SOURCE_FILE_AT_LINE (1470)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1470)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1472)) COMMA_SOURCE_FILE_AT_LINE (1472)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1472)) ;
      }
    }else if (kBoolFalse == test_1) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_3, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (1475)) ;
      var_boundTypeIdentifierString.drop () ; // Release error dropped variable
    }
  }
  //-------- @localVariableDeclarationForGeneration
  ...
  GALGAS_outletClassBindingOptionMap var_availableBindingOptionMap ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1481)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_acceptableTypesString = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_58948 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1484)).isValidAndTrue () ;
  if (enumerator_58948.hasCurrentObject () && bool_4) {
    while (enumerator_58948.hasCurrentObject () && bool_4) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_58948.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1485)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (1486)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1486)) COMMA_SOURCE_FILE_AT_LINE (1486)) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, var_boundTypeIdentifierString.objectCompare (var_acceptableType)) ;
      enumerator_58948.gotoNextObject () ;
      if (enumerator_58948.hasCurrentObject ()) {
        bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1484)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (1489)).boolEnum () ;
  if (kBoolTrue == test_5) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_6 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_6, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (1491)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (1491)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (1491)) COMMA_SOURCE_FILE_AT_LINE (1490)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1494)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (1501)), GALGAS_string ("self"), object->mAttribute_mObservableAttributeName.mAttribute_string, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1499)) COMMA_SOURCE_FILE_AT_LINE (1499)) ;
}
//---------------------------------------------------------------------------*
