...
void routine_analyzeEntities (const GALGAS_entityList constinArgument_inEntityList,
  ...
  outArgument_outEntityMap = GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (337)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityList enumerator_13782 (constinArgument_inEntityList, kEnumeration_up) ;
  ...
  while (enumerator_13782.hasCurrentObject ()) {
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_13782.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (345)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_14199_0 ; // Joker input parameter
      GALGAS_string joker_14248_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_14336_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_14336_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_14336_2 ; // Joker input parameter
      GALGAS_relationshipList joker_14336_1 ; // Joker input parameter
      GALGAS_relationshipMap joker_14401_0 ; // Joker input parameter
      GALGAS_stringset joker_14440_0 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_13782.current_mSuperEntityName (HERE), joker_14199_0, var_implementationSuperClassName, joker_14248_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_14336_4, joker_14336_3, joker_14336_2, joker_14336_1, var_allRelationshipList, var_allPropertyMap, joker_14401_0, var_allRelationshipMap, joker_14440_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (346)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (361)) ;
      //-------- @assignmentInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_15104 (enumerator_13782.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_15104.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_15104.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_15104.current_mType (HERE), enumerator_15104.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (372)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_15104.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (373)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_15104.current_mType (HERE), enumerator_15104.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (374)), enumerator_15104.current_mDefaultValueObjectiveCObject (HERE), enumerator_15104.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (374)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_15104.current_mType (HERE), enumerator_15104.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (375)), enumerator_15104.current_mDefaultValueObjectiveCObject (HERE), enumerator_15104.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (375)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_15104.current_mAttributeName (HERE), enumerator_15104.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_15104.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (376)) COMMA_SOURCE_FILE_AT_LINE (376)), inCompiler COMMA_SOURCE_FILE_AT_LINE (376)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_15104.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_relationshipMap var_currentRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (379)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipList enumerator_15799 (enumerator_13782.current_mRelationshipList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_15799.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allRelationshipMap.modifier_insertKey (enumerator_15799.current_mRelationshipName (HERE), enumerator_15799.current_mIsToMany (HERE), enumerator_15799.current_mDestinationEntityName (HERE), enumerator_15799.current_mInverseRelationshipName (HERE), enumerator_15799.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (381)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_currentRelationshipMap.modifier_insertKey (enumerator_15799.current_mRelationshipName (HERE), enumerator_15799.current_mIsToMany (HERE), enumerator_15799.current_mDestinationEntityName (HERE), enumerator_15799.current_mInverseRelationshipName (HERE), enumerator_15799.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (388)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_15799.current_mRelationshipName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (395)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_15799.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (398)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_13782.current_mTransientList (HERE), GALGAS_classObservableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (402)), var_classObservablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (400)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (408)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outEntityMap.modifier_insertKey (enumerator_13782.current_mEntityName (HERE), enumerator_13782.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (411)), enumerator_13782.current_mImplementationClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (412)), var_implementationSuperClassName, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, enumerator_13782.current_mRelationshipList (HERE), var_allRelationshipList.operator_concat (enumerator_13782.current_mRelationshipList (HERE) COMMA_SOURCE_FILE_AT_LINE (420)), var_allPropertyMap, var_currentRelationshipMap, var_allRelationshipMap, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (409)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_13782.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityMap enumerator_17298 (outArgument_outEntityMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17298.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipMap enumerator_17337 (enumerator_17298.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_17337.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_17453_12 ; // Joker input parameter
      GALGAS_string joker_17453_11 ; // Joker input parameter
      GALGAS_string joker_17453_10 ; // Joker input parameter
      GALGAS_classObservablePropertyMap joker_17453_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_17453_8 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_17453_7 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_17453_6 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_17453_5 ; // Joker input parameter
      GALGAS_relationshipList joker_17453_4 ; // Joker input parameter
      GALGAS_relationshipList joker_17453_3 ; // Joker input parameter
      GALGAS_propertyMap joker_17453_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_17453_1 ; // Joker input parameter
      GALGAS_stringset joker_17491_0 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_17337.current_mDestinationEntityName (HERE), joker_17453_12, joker_17453_11, joker_17453_10, joker_17453_9, joker_17453_8, joker_17453_7, joker_17453_6, joker_17453_5, joker_17453_4, joker_17453_3, joker_17453_2, joker_17453_1, var_destinationEntityRelationshipMap, joker_17491_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (431)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_inverseOfInverseRelationshipName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_17623_2 ; // Joker input parameter
      GALGAS_lstring joker_17623_1 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_17661_0 ; // Joker input parameter
      var_destinationEntityRelationshipMap.method_searchKey (enumerator_17337.current_mInverseRelationshipName (HERE), joker_17623_2, joker_17623_1, var_inverseOfInverseRelationshipName, joker_17661_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (433)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_17337.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_2 (enumerator_17337.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_17337.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)) ;
      }
...
void routine_analyzePreferences (const GALGAS_entityMap constinArgument_inEntityMap,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (623)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_24992 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_24992.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservablePropertyMap var_observableAttributeMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (625)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (627)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_25169 (enumerator_24992.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_25169.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_25169.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (629)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_25169.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (632)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_25372 (enumerator_24992.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_25372.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_25372.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_25372.current_mType (HERE), enumerator_25372.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (634)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_25372.current_mType (HERE), enumerator_25372.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (635)), enumerator_25372.current_mDefaultValueObjectiveCObject (HERE), enumerator_25372.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (635)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_25372.current_mAttributeName (HERE), enumerator_25372.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_25372.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (636)) COMMA_SOURCE_FILE_AT_LINE (636)), inCompiler COMMA_SOURCE_FILE_AT_LINE (636)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_25372.gotoNextObject () ;
    }
    //-------- @localVariableDeclarationForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (640)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_24992.current_mTransientList (HERE), GALGAS_classObservableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (643)), var_observableAttributeMap, var_implementationFileInclusionSet, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (641)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservableObjectMap var_observableObjectMap = GALGAS_classObservableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (649)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (651)), GALGAS_string ("self"), GALGAS_string::makeEmptyString (), var_observableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (650)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (657)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_26472 (enumerator_24992.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_26472.hasCurrentObject ()) {
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_26599_2 ; // Joker input parameter
      GALGAS_string joker_26599_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_26472.current_mOutletType (HERE), joker_26599_2, joker_26599_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (661)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (662)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_26743 (enumerator_26472.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_26743.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_26743.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (668)), var_actionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (664)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_26743.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_26472.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (675)), enumerator_26472.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (675)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (675)) ;
      enumerator_26472.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (678)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outPreferencesMap.modifier_insertKey (enumerator_24992.current_mPreferencesName (HERE), var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, enumerator_24992.current_mActionDeclarationList (HERE), var_observableAttributeMap, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (679)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outBindingOptionListForGeneration = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (719)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_28793 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_28793.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_28793.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (722)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_28982 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (724)).isValidAndTrue () ;
    if (enumerator_28982.hasCurrentObject () && bool_0) {
      while (enumerator_28982.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_29046 (enumerator_28793.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (725)).isValidAndTrue () ;
        if (enumerator_29046.hasCurrentObject () && bool_1) {
          while (enumerator_29046.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_28982.current_mType (HERE).objectCompare (enumerator_29046.current_mType (HERE))) ;
            enumerator_29046.gotoNextObject () ;
            if (enumerator_29046.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (725)).isValidAndTrue () ;
            }
          }
        }
        enumerator_28982.gotoNextObject () ;
        if (enumerator_28982.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (724)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (729)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_29285 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (731)).isValidAndTrue () ;
      if (enumerator_29285.hasCurrentObject () && bool_3) {
        while (enumerator_29285.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_29285.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (732)) COMMA_SOURCE_FILE_AT_LINE (732)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (732)) COMMA_SOURCE_FILE_AT_LINE (732)) ;
          enumerator_29285.gotoNextObject () ;
          if (enumerator_29285.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (731)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_28793.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (734)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_28793.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (736)), enumerator_28793.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (736)) ;
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (852)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_34227 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_34227.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_string var_rootEntityImplementationClassName ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_classObservablePropertyMap var_rootObjectObservablePropertyMap ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_relationshipMap var_allRelationshipMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_34442_0 ; // Joker input parameter
    GALGAS_string joker_34492_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_34540_8 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_34540_7 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_34540_6 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_34540_5 ; // Joker input parameter
    GALGAS_relationshipList joker_34540_4 ; // Joker input parameter
    GALGAS_relationshipList joker_34540_3 ; // Joker input parameter
    GALGAS_propertyMap joker_34540_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_34540_1 ; // Joker input parameter
    GALGAS_stringset joker_34576_0 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_34227.current_mRootEntityName (HERE), joker_34442_0, var_rootEntityImplementationClassName, joker_34492_0, var_rootObjectObservablePropertyMap, joker_34540_8, joker_34540_7, joker_34540_6, joker_34540_5, joker_34540_4, joker_34540_3, joker_34540_2, joker_34540_1, var_allRelationshipMap, joker_34576_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (857)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservableObjectMap var_observableObjectMap = GALGAS_classObservableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (868)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("root").reader_nowhere (SOURCE_FILE_AT_LINE (870)), GALGAS_string ("mRootObject"), GALGAS_string::makeEmptyString (), var_rootObjectObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (869)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_preferencesMap enumerator_34878 (constinArgument_inPreferencesMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_34878.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_34878.current (HERE).mAttribute_lkey, GALGAS_string ("g_").operator_concat (enumerator_34878.current (HERE).mAttribute_lkey.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (878)), enumerator_34878.current (HERE).mAttribute_lkey.mAttribute_string, enumerator_34878.current (HERE).mAttribute_mObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (876)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_34878.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservablePropertyMap var_observablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (884)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (885)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerList enumerator_35233 (enumerator_34227.current_mControllerList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_35233.hasCurrentObject ()) {
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_35476_0 ; // Joker input parameter
      constinArgument_inControllerClassMap.method_searchKey (enumerator_35233.current_mControllerClassName (HERE), joker_35476_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (890)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_35233.current_mControllerName (HERE), enumerator_35233.current_mControllerName (HERE).mAttribute_string, GALGAS_string::makeEmptyString (), var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (897)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_35835_14 ; // Joker input parameter
      GALGAS_string joker_35835_13 ; // Joker input parameter
      GALGAS_string joker_35835_12 ; // Joker input parameter
      GALGAS_classObservablePropertyMap joker_35835_11 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_35835_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_35835_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_35835_8 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_35835_7 ; // Joker input parameter
      GALGAS_relationshipList joker_35835_6 ; // Joker input parameter
      GALGAS_relationshipList joker_35835_5 ; // Joker input parameter
      GALGAS_propertyMap joker_35835_4 ; // Joker input parameter
      GALGAS_relationshipMap joker_35835_3 ; // Joker input parameter
      GALGAS_relationshipMap joker_35835_2 ; // Joker input parameter
      GALGAS_stringset joker_35835_1 ; // Joker input parameter
      constinArgument_inEntityMap.method_searchKey (enumerator_35233.current_mControlledClassOrEntityName (HERE), joker_35835_14, joker_35835_13, joker_35835_12, joker_35835_11, joker_35835_10, joker_35835_9, joker_35835_8, joker_35835_7, joker_35835_6, joker_35835_5, joker_35835_4, joker_35835_3, joker_35835_2, joker_35835_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (903)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (904)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_35956 (enumerator_35233.current_mControllerBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_35956.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_35956.current_mBinding (HERE).ptr (), var_allRelationshipMap, var_controllerClassBindingMap, enumerator_35233.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (906)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_35956.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_controllerMap.modifier_insertKey (enumerator_35233.current_mControllerName (HERE), enumerator_35233.current_mControllerClassName (HERE).mAttribute_string, enumerator_35233.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, var_controllerActionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (914)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (924)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_34227.current_mTransientList (HERE), var_observableObjectMap, var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (925)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_documentActionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (933)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_36915 (enumerator_34227.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_36915.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_documentActionMap.modifier_insertKey (enumerator_36915.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (935)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_36915.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (939)), GALGAS_string ("self"), GALGAS_string::makeEmptyString (), var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (938)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (944)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_37254 (enumerator_34227.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_37254.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_bool var_hasTableValueBinding ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_37381_2 ; // Joker input parameter
      GALGAS_string joker_37381_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_37254.current_mOutletType (HERE), joker_37381_2, joker_37381_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (948)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (949)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_37525 (enumerator_37254.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_37525.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_37525.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, var_controllerMap, var_documentActionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (951)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_37525.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_37254.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (962)), enumerator_37254.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (962)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (962)) ;
      enumerator_37254.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (965)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outDocumentMap.modifier_insertKey (enumerator_34227.current_mDocumentName (HERE), enumerator_34227.current_mRootEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (968)), var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, enumerator_34227.current_mActionDeclarationList (HERE), var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (966)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_38668 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (987)).isValidAndTrue () ;
  if (enumerator_38668.hasCurrentObject () && bool_0) {
    while (enumerator_38668.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_38668.current_mType (HERE))) ;
      enumerator_38668.gotoNextObject () ;
      if (enumerator_38668.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (987)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (990)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (991)) ;
  }
}
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1001)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_39096 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_39096.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_classObservablePropertyMap var_classObservablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1004)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_39096.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1005)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_39331_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_39395_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_39395_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_39395_2 ; // Joker input parameter
      GALGAS_stringset joker_39395_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_39096.current_mSuperClassName (HERE), joker_39331_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_39395_4, joker_39395_3, joker_39395_2, joker_39395_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1006)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1008)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1009)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1011)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_39815 (enumerator_39096.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_39815.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_39815.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_39815.current_mType (HERE), enumerator_39815.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1014)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_39815.current_mType (HERE), enumerator_39815.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1015)), enumerator_39815.current_mDefaultValueObjectiveCObject (HERE), enumerator_39815.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1015)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_39815.current_mType (HERE), enumerator_39815.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1016)), enumerator_39815.current_mDefaultValueObjectiveCObject (HERE), enumerator_39815.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1016)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_39815.current_mAttributeName (HERE), enumerator_39815.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_39815.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1017)) COMMA_SOURCE_FILE_AT_LINE (1017)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1017)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1021)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_39096.current_mTransientList (HERE), GALGAS_classObservableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1024)), var_classObservablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (1022)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1030)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_39096.current_mClassName (HERE), enumerator_39096.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1033)), var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1031)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_39096.gotoNextObject () ;
  }
}
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1050)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_41380 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_41380.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_41477 (enumerator_41380.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_41477.hasCurrentObject ()) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_41589 (enumerator_41477.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_41589.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_41589.current_mBindingOptionName (HERE), enumerator_41589.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1057)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_41589.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_41477.current_mBindingName (HERE), enumerator_41477.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1063)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_41477.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_41380.current_mOutletClassName (HERE), enumerator_41380.current_mGenerateCode (HERE), enumerator_41380.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, enumerator_41380.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1066)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1082)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_42421 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_42421.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1085)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_42530 (enumerator_42421.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42530.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_42530.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1087)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_42530.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1090)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_42682 (enumerator_42421.current_mBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42682.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1092)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_42794 (enumerator_42682.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_42794.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_42794.current_mBindingOptionName (HERE), enumerator_42794.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1094)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_42794.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_42682.current_mBindingName (HERE), enumerator_42682.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1100)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_42682.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservablePropertyMap var_observablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1103)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerObservablePropertyList enumerator_43245 (enumerator_42421.current_mControllerObservablePropertyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_43245.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_43245.current (HERE).mAttribute_mPropertyName, enumerator_43245.current (HERE).mAttribute_mType, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1105)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1105)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_43245.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outControllerClassMap.modifier_insertKey (enumerator_42421.current_mOutletClassName (HERE), enumerator_42421.current_mGenerateCode (HERE), var_bindingMap, var_actionMap, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1108)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_42421.gotoNextObject () ;
  }
}
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  outArgument_outDocumentMap.drop () ; // Release 'out' argument
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1129)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1130)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1131)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1132)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (outArgument_outEntityMap, constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1133)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outPreferencesMap, outArgument_outDocumentMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1134)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
static GALGAS_string categoryReader_runBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("  ").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (141)).operator_concat (GALGAS_string (".target = ") COMMA_SOURCE_FILE_AT_LINE (141)).operator_concat (object->mAttribute_mTargetName COMMA_SOURCE_FILE_AT_LINE (141)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (141)) ;
  //-------- @concatInstructionForGeneration
  result_outResult.dotAssign_operation (GALGAS_string ("  ").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (142)).operator_concat (GALGAS_string (".action = @selector (") COMMA_SOURCE_FILE_AT_LINE (142)).operator_concat (object->mAttribute_mActionName COMMA_SOURCE_FILE_AT_LINE (142)).operator_concat (GALGAS_string (":) ;\n") COMMA_SOURCE_FILE_AT_LINE (142)) COMMA_SOURCE_FILE_AT_LINE (142)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_tableValueBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_columnBindingForTableValueBindingForGeneration enumerator_5643 (object->mAttribute_mColumnBindingForTableValueBindingForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_5643.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("  if (nil == [").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (enumerator_5643.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (GALGAS_string ("\"]) {\n") COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (GALGAS_string ("' NSTableView outlet has no formatter has no column with the ") COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (enumerator_5643.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (GALGAS_string (" identifier\") ;\n") COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (GALGAS_string ("  }else{\n") COMMA_SOURCE_FILE_AT_LINE (155)).operator_concat (GALGAS_string ("    NSActionCell * cell = [") COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (enumerator_5643.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (GALGAS_string ("\"].dataCell ;\n") COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (GALGAS_string ("    if (! [cell isKindOfClass:[") COMMA_SOURCE_FILE_AT_LINE (157)).operator_concat (enumerator_5643.current (HERE).mAttribute_mRequiredCellClass COMMA_SOURCE_FILE_AT_LINE (157)).operator_concat (GALGAS_string (" class]]) {\n") COMMA_SOURCE_FILE_AT_LINE (157)).operator_concat (GALGAS_string ("      presentErrorWindow (__FILE__, __LINE__, @\"the dataCell is '") COMMA_SOURCE_FILE_AT_LINE (158)).operator_concat (enumerator_5643.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (158)).operator_concat (GALGAS_string ("' column of the '") COMMA_SOURCE_FILE_AT_LINE (158)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (158)).operator_concat (GALGAS_string ("' should be an '") COMMA_SOURCE_FILE_AT_LINE (158)).operator_concat (enumerator_5643.current (HERE).mAttribute_mRequiredCellClass COMMA_SOURCE_FILE_AT_LINE (158)).operator_concat (GALGAS_string (" instance\") ;\n") COMMA_SOURCE_FILE_AT_LINE (158)).operator_concat (GALGAS_string ("    }\n") COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (GALGAS_string ("  }\n") COMMA_SOURCE_FILE_AT_LINE (160)).operator_concat (GALGAS_string ("  [[") COMMA_SOURCE_FILE_AT_LINE (161)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (161)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (161)).operator_concat (enumerator_5643.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (161)).operator_concat (GALGAS_string ("\"]\n") COMMA_SOURCE_FILE_AT_LINE (161)).operator_concat (GALGAS_string ("    bind:@\"value\"\n") COMMA_SOURCE_FILE_AT_LINE (162)).operator_concat (GALGAS_string ("    toObject:") COMMA_SOURCE_FILE_AT_LINE (163)).operator_concat (object->mAttribute_mControllerName COMMA_SOURCE_FILE_AT_LINE (163)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (163)).operator_concat (GALGAS_string ("    withKeyPath:@\"arrangedObjects.") COMMA_SOURCE_FILE_AT_LINE (164)).operator_concat (enumerator_5643.current (HERE).mAttribute_mObservableAttributeName COMMA_SOURCE_FILE_AT_LINE (164)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (164)).operator_concat (GALGAS_string ("    options:") COMMA_SOURCE_FILE_AT_LINE (165)) COMMA_SOURCE_FILE_AT_LINE (153)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_5643.current (HERE).mAttribute_mOutletBindingOptionList.reader_length (SOURCE_FILE_AT_LINE (166)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_6967 (enumerator_5643.current (HERE).mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_6967.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("      ").operator_concat (enumerator_6967.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (171)).operator_concat (GALGAS_string (", @") COMMA_SOURCE_FILE_AT_LINE (171)).operator_concat (enumerator_6967.current_mValue_30_ (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (171)) COMMA_SOURCE_FILE_AT_LINE (171)).operator_concat (GALGAS_string (",\n") COMMA_SOURCE_FILE_AT_LINE (171)) COMMA_SOURCE_FILE_AT_LINE (171)) ;
...
static GALGAS_string categoryReader_regularBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  if (object->mAttribute_mRequiredFormatter.isValid ()) {
    ...
    case GALGAS_formatterEnum::kEnum_numberFormatter: {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("if ((nil != ").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (GALGAS_string (") && (nil == ") COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (GALGAS_string (".formatter)) {\n") COMMA_SOURCE_FILE_AT_LINE (190)).operator_concat (GALGAS_string ("  presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (191)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (191)).operator_concat (GALGAS_string ("' outlet has no formatter, it should have an NSNumberFormatter\") ;\n") COMMA_SOURCE_FILE_AT_LINE (191)).operator_concat (GALGAS_string ("  }else if ((nil != ") COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (GALGAS_string (") && ![") COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (GALGAS_string (".formatter isKindOfClass:[NSNumberFormatter class]]) {\n") COMMA_SOURCE_FILE_AT_LINE (192)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (193)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (193)).operator_concat (GALGAS_string (" outlet has a formatter that is not kind of NSNumberFormatter class\") ;\n") COMMA_SOURCE_FILE_AT_LINE (193)).operator_concat (GALGAS_string ("  }\n") COMMA_SOURCE_FILE_AT_LINE (194)) COMMA_SOURCE_FILE_AT_LINE (190)) ;
      } break ;
    case GALGAS_formatterEnum::kEnum_dateFormatter: {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("  if ((nil != ").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (196)).operator_concat (GALGAS_string (") && (nil == ") COMMA_SOURCE_FILE_AT_LINE (196)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (196)).operator_concat (GALGAS_string (".formatter)) {\n") COMMA_SOURCE_FILE_AT_LINE (196)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (197)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (197)).operator_concat (GALGAS_string ("' outlet has no formatter, it should have an NSDateFormatter\") ;\n") COMMA_SOURCE_FILE_AT_LINE (197)).operator_concat (GALGAS_string ("  }else if ((nil != ") COMMA_SOURCE_FILE_AT_LINE (198)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (198)).operator_concat (GALGAS_string (") && ![") COMMA_SOURCE_FILE_AT_LINE (198)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (198)).operator_concat (GALGAS_string (".formatter isKindOfClass:[NSDateFormatter class]]) {\n") COMMA_SOURCE_FILE_AT_LINE (198)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (199)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (199)).operator_concat (GALGAS_string ("' outlet has a formatter that is not kind of NSDateFormatter class\") ;\n") COMMA_SOURCE_FILE_AT_LINE (199)).operator_concat (GALGAS_string ("  }\n") COMMA_SOURCE_FILE_AT_LINE (200)) COMMA_SOURCE_FILE_AT_LINE (196)) ;
      } break ;
    }
  }
  //-------- @concatInstructionForGeneration
  result_outResult.dotAssign_operation (GALGAS_string ("  [").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (202)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (202)).operator_concat (GALGAS_string ("    bind:@\"") COMMA_SOURCE_FILE_AT_LINE (203)).operator_concat (object->mAttribute_mBindingName COMMA_SOURCE_FILE_AT_LINE (203)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (203)).operator_concat (GALGAS_string ("    toObject:") COMMA_SOURCE_FILE_AT_LINE (204)).operator_concat (object->mAttribute_mObservedObjectName COMMA_SOURCE_FILE_AT_LINE (204)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (204)).operator_concat (GALGAS_string ("    withKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (205)).operator_concat (object->mAttribute_mObservableAttributeName COMMA_SOURCE_FILE_AT_LINE (205)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (205)).operator_concat (GALGAS_string ("    options:") COMMA_SOURCE_FILE_AT_LINE (206)) COMMA_SOURCE_FILE_AT_LINE (202)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mOutletBindingOptionList.reader_length (SOURCE_FILE_AT_LINE (207)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator__32_stringlist enumerator_9090 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_9090.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("      ").operator_concat (enumerator_9090.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (212)).operator_concat (GALGAS_string (", @") COMMA_SOURCE_FILE_AT_LINE (212)).operator_concat (enumerator_9090.current_mValue_30_ (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (212)).operator_concat (GALGAS_string (",\n") COMMA_SOURCE_FILE_AT_LINE (212)) COMMA_SOURCE_FILE_AT_LINE (212)) ;
...
static void categoryMethod_tableValueBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inHasTableValueBinding.operator_not (SOURCE_FILE_AT_LINE (466)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mControllerName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("this outlet does not support $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (467)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_19176_0 ; // Joker input parameter
    GALGAS_actionMap joker_19249_0 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_19176_0, var_controlledClassOrEntityName, var_controllerBindingList, joker_19249_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (471)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_classObservablePropertyMap var_observablePropertyMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_19350_3 ; // Joker input parameter
    GALGAS_string joker_19350_2 ; // Joker input parameter
    GALGAS_string joker_19350_1 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_19418_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_19418_9 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_19418_8 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_19418_7 ; // Joker input parameter
    GALGAS_relationshipList joker_19418_6 ; // Joker input parameter
    GALGAS_relationshipList joker_19418_5 ; // Joker input parameter
    GALGAS_propertyMap joker_19418_4 ; // Joker input parameter
    GALGAS_relationshipMap joker_19418_3 ; // Joker input parameter
    GALGAS_relationshipMap joker_19418_2 ; // Joker input parameter
    GALGAS_stringset joker_19418_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (GALGAS_lstring::constructor_new (var_controlledClassOrEntityName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (479)), joker_19350_3, joker_19350_2, joker_19350_1, var_observablePropertyMap, joker_19418_10, joker_19418_9, joker_19418_8, joker_19418_7, joker_19418_6, joker_19418_5, joker_19418_4, joker_19418_3, joker_19418_2, joker_19418_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (478)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_columnBindingForTableValueBindingForGeneration var_columnBindingForTableValueBindingForGeneration = GALGAS_columnBindingForTableValueBindingForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (484)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_tableValueColumnBinding enumerator_19586 (object->mAttribute_mTableValueColumnBinding, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_19586.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingType var_type ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_stringlist joker_19716_0 ; // Joker input parameter
      var_observablePropertyMap.method_searchKey (enumerator_19586.current (HERE).mAttribute_mBoundPropertyName, var_type, joker_19716_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (487)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_requiredCellTypeInTableColumnBinding = categoryReader_requiredCellTypeInTableColumnBinding (var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (492)) ;
      //-------- @ifInstructionForGeneration
      ...
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_19586.current (HERE).mAttribute_mBoundPropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("this property cannot be named in a $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (494)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_requiredCellTypeInTableColumnBinding.objectCompare (enumerator_19586.current (HERE).mAttribute_mCellTypeName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_19586.current (HERE).mAttribute_mCellTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("this property requires a ").operator_concat (var_requiredCellTypeInTableColumnBinding COMMA_SOURCE_FILE_AT_LINE (496)).operator_concat (GALGAS_string (" cell class") COMMA_SOURCE_FILE_AT_LINE (496)) COMMA_SOURCE_FILE_AT_LINE (496)) ;
        }
      }
      //-------- @plusEqualnstructionForGeneration
      var_columnBindingForTableValueBindingForGeneration.addAssign_operation (enumerator_19586.current (HERE).mAttribute_mColumnName.mAttribute_string, var_requiredCellTypeInTableColumnBinding, enumerator_19586.current (HERE).mAttribute_mBoundPropertyName.mAttribute_string, GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (502)) COMMA_SOURCE_FILE_AT_LINE (498)) ;
      enumerator_19586.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_tableValueBindingForGeneration::constructor_new (object->mAttribute_mControllerName.mAttribute_string, var_columnBindingForTableValueBindingForGeneration COMMA_SOURCE_FILE_AT_LINE (505)) COMMA_SOURCE_FILE_AT_LINE (505)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_inActionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (525)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_actionMap var_actionMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_21308_3 ; // Joker input parameter
    GALGAS_string joker_21308_2 ; // Joker input parameter
    GALGAS_outletBindingListForGeneration joker_21308_1 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mTargetName, joker_21308_3, joker_21308_2, joker_21308_1, var_actionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (528)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
    var_actionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (529)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_runBindingForGeneration::constructor_new (object->mAttribute_mTargetName.mAttribute_string, object->mAttribute_mActionName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (531)) COMMA_SOURCE_FILE_AT_LINE (531)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (551)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  ...
  GALGAS_classObservablePropertyMap var_observablePropertyMap ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inObservableObjectMap.reader_hasKey (object->mAttribute_mObservedObjectName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (555)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_string var_includeFile ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inObservableObjectMap.method_searchKey (GALGAS_lstring::constructor_new (object->mAttribute_mObservedObjectName.mAttribute_string, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (558)), var_observedObjectOCName, var_includeFile, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (557)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioImplementationFileInclusionSet.addAssign_operation (var_includeFile COMMA_SOURCE_FILE_AT_LINE (563)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mObservedObjectName.reader_string (SOURCE_FILE_AT_LINE (566)) COMMA_SOURCE_FILE_AT_LINE (566)).operator_concat (GALGAS_string ("' object is not observable") COMMA_SOURCE_FILE_AT_LINE (566)) COMMA_SOURCE_FILE_AT_LINE (565)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_stringlist joker_22990_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_22990_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (571)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (574)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_23160 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (575)).isValidAndTrue () ;
  if (enumerator_23160.hasCurrentObject () && bool_2) {
    while (enumerator_23160.hasCurrentObject () && bool_2) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_23160.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_23160.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_23160.gotoNextObject () ;
      if (enumerator_23160.hasCurrentObject ()) {
        bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (575)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (579)).boolEnum () ;
  if (kBoolTrue == test_3) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (580)) COMMA_SOURCE_FILE_AT_LINE (580)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (580)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_23464 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (581)).isValidAndTrue () ;
    if (enumerator_23464.hasCurrentObject () && bool_4) {
      while (enumerator_23464.hasCurrentObject () && bool_4) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_23464.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (582)) COMMA_SOURCE_FILE_AT_LINE (582)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (582)) COMMA_SOURCE_FILE_AT_LINE (582)) ;
        enumerator_23464.gotoNextObject () ;
        if (enumerator_23464.hasCurrentObject ()) {
          bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (581)).isValidAndTrue () ;
        }
      }
    }
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_5, var_s COMMA_SOURCE_FILE_AT_LINE (584)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (587)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_23699 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_23699.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_23699.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (590)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_23888 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (592)).isValidAndTrue () ;
    if (enumerator_23888.hasCurrentObject () && bool_6) {
      while (enumerator_23888.hasCurrentObject () && bool_6) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_23952 (enumerator_23699.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (593)).isValidAndTrue () ;
        if (enumerator_23952.hasCurrentObject () && bool_7) {
          while (enumerator_23952.hasCurrentObject () && bool_7) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_23888.current_mType (HERE).objectCompare (enumerator_23952.current_mType (HERE))) ;
            enumerator_23952.gotoNextObject () ;
            if (enumerator_23952.hasCurrentObject ()) {
              bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (593)).isValidAndTrue () ;
            }
          }
        }
        enumerator_23888.gotoNextObject () ;
        if (enumerator_23888.hasCurrentObject ()) {
          bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (592)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (597)).boolEnum () ;
    if (kBoolTrue == test_8) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_24191 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (599)).isValidAndTrue () ;
      if (enumerator_24191.hasCurrentObject () && bool_9) {
        while (enumerator_24191.hasCurrentObject () && bool_9) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_24191.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) COMMA_SOURCE_FILE_AT_LINE (600)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (600)) COMMA_SOURCE_FILE_AT_LINE (600)) ;
          enumerator_24191.gotoNextObject () ;
          if (enumerator_24191.hasCurrentObject ()) {
            bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (599)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_10 (enumerator_23699.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_10, var_s COMMA_SOURCE_FILE_AT_LINE (602)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_23699.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (604)), enumerator_23699.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (604)) ;
    enumerator_23699.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (607)), var_requiredFormatter, var_observedObjectOCName, object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (610)), var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (606)) COMMA_SOURCE_FILE_AT_LINE (606)) ;
}
//---------------------------------------------------------------------------*
...
GALGAS_string categoryReader_ebTypeIdentifier (const GALGAS_easyBindingType & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inClassOrEntityName COMMA_SOURCE_FILE_AT_LINE (708)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (708)) ;
      } break ;
    }
  }
//---
...
static void categoryMethod_tableValueBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (759)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $run action") COMMA_SOURCE_FILE_AT_LINE (771)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @assignmentInstructionForGeneration
    var_resultingObservedPropertyPath = GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (787)) COMMA_SOURCE_FILE_AT_LINE (787)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("observed object should be 'root'") COMMA_SOURCE_FILE_AT_LINE (789)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (795)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_stringlist joker_32037_0 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_32037_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (797)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (798)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (799)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_32333_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_32333_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_32333_2, joker_32333_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (802)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (804)) COMMA_SOURCE_FILE_AT_LINE (804)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (804)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (806)) COMMA_SOURCE_FILE_AT_LINE (806)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (806)) ;
      }
    }else if (kBoolFalse == test_3) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_5 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (809)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (815)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_32964 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (818)).isValidAndTrue () ;
  if (enumerator_32964.hasCurrentObject () && bool_6) {
    while (enumerator_32964.hasCurrentObject () && bool_6) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_32964.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (819)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (820)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (820)) COMMA_SOURCE_FILE_AT_LINE (820)) ;
      //-------- @assignmentInstructionForGeneration
      ...
      if (enumerator_32964.hasCurrentObject ()) {
        bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (818)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (823)).boolEnum () ;
  if (kBoolTrue == test_7) {
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_8, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (825)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (825)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (825)) COMMA_SOURCE_FILE_AT_LINE (824)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (828)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (835)), var_resultingObservedObjectName, var_resultingObservedPropertyPath, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (833)) COMMA_SOURCE_FILE_AT_LINE (833)) ;
}
//---------------------------------------------------------------------------*
