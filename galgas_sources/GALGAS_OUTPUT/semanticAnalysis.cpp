...
void routine_analyzePreferences (const GALGAS_entityMap constinArgument_inEntityMap,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (682)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_26932 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_26932.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_observableAttributeMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (684)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (686)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_27104 (enumerator_26932.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_27104.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_27104.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (688)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_27104.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (691)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_27307 (enumerator_26932.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_27307.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_27307.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_27307.current_mType (HERE), enumerator_27307.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (693)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_27307.current_mType (HERE), enumerator_27307.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (694)), enumerator_27307.current_mDefaultValueObjectiveCObject (HERE), enumerator_27307.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (694)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_27307.current_mAttributeName (HERE), enumerator_27307.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_27307.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (695)) COMMA_SOURCE_FILE_AT_LINE (695)), inCompiler COMMA_SOURCE_FILE_AT_LINE (695)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_27307.gotoNextObject () ;
    }
    //-------- @localVariableDeclarationForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (699)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_26932.current_mTransientList (HERE), GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (702)), var_observableAttributeMap, var_implementationFileInclusionSet, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (700)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observableObjectMap var_observableObjectMap = GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (708)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (710)), GALGAS_string ("self"), GALGAS_string::makeEmptyString (), var_observableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (709)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (716)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_28397 (enumerator_26932.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_28397.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_bool var_hasTableValueBinding ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_28524_2 ; // Joker input parameter
      GALGAS_string joker_28524_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_28397.current_mOutletType (HERE), joker_28524_2, joker_28524_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (720)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (721)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_28668 (enumerator_28397.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_28668.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_28668.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (727)), var_actionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (723)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_28668.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_28397.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (734)), enumerator_28397.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (734)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (734)) ;
      enumerator_28397.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (737)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outPreferencesMap.modifier_insertKey (enumerator_26932.current_mPreferencesName (HERE), var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, enumerator_26932.current_mActionDeclarationList (HERE), var_observableAttributeMap, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (738)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_26932.gotoNextObject () ;
  }
}
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outBindingOptionListForGeneration = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (779)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_30773 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_30773.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_30773.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (782)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_30962 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (784)).isValidAndTrue () ;
    if (enumerator_30962.hasCurrentObject () && bool_0) {
      while (enumerator_30962.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_31026 (enumerator_30773.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (785)).isValidAndTrue () ;
        if (enumerator_31026.hasCurrentObject () && bool_1) {
          while (enumerator_31026.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_30962.current_mType (HERE).objectCompare (enumerator_31026.current_mType (HERE))) ;
            enumerator_31026.gotoNextObject () ;
            if (enumerator_31026.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (785)).isValidAndTrue () ;
            }
          }
        }
        enumerator_30962.gotoNextObject () ;
        if (enumerator_30962.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (784)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (789)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_31265 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (791)).isValidAndTrue () ;
      if (enumerator_31265.hasCurrentObject () && bool_3) {
        while (enumerator_31265.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_31265.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (792)) COMMA_SOURCE_FILE_AT_LINE (792)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (792)) COMMA_SOURCE_FILE_AT_LINE (792)) ;
          enumerator_31265.gotoNextObject () ;
          if (enumerator_31265.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (791)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_30773.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (794)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_30773.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (796)), enumerator_30773.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (796)) ;
    enumerator_30773.gotoNextObject () ;
  }
}
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (912)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_36187 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_36187.hasCurrentObject ()) {
    ...
    GALGAS_relationshipMap var_allRelationshipMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_36397_0 ; // Joker input parameter
    GALGAS_string joker_36447_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_36495_8 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_36495_7 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_36495_6 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_36495_5 ; // Joker input parameter
    GALGAS_relationshipList joker_36495_4 ; // Joker input parameter
    GALGAS_relationshipList joker_36495_3 ; // Joker input parameter
    GALGAS_propertyMap joker_36495_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_36495_1 ; // Joker input parameter
    GALGAS_stringset joker_36531_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_36531_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_36187.current_mRootEntityName (HERE), joker_36397_0, var_rootEntityImplementationClassName, joker_36447_0, var_rootObjectObservablePropertyMap, joker_36495_8, joker_36495_7, joker_36495_6, joker_36495_5, joker_36495_4, joker_36495_3, joker_36495_2, joker_36495_1, var_allRelationshipMap, joker_36531_2, joker_36531_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (917)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observableObjectMap var_observableObjectMap = GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (928)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("root").reader_nowhere (SOURCE_FILE_AT_LINE (930)), GALGAS_string ("mRootObject"), GALGAS_string::makeEmptyString (), var_rootObjectObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (929)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_preferencesMap enumerator_36829 (constinArgument_inPreferencesMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_36829.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_36829.current (HERE).mAttribute_lkey, GALGAS_string ("g_").operator_concat (enumerator_36829.current (HERE).mAttribute_lkey.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (938)), enumerator_36829.current (HERE).mAttribute_lkey.mAttribute_string, enumerator_36829.current (HERE).mAttribute_mObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (936)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_36829.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (944)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (945)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerList enumerator_37179 (enumerator_36187.current_mControllerList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_37179.hasCurrentObject ()) {
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_37417_0 ; // Joker input parameter
      constinArgument_inControllerClassMap.method_searchKey (enumerator_37179.current_mControllerClassName (HERE), joker_37417_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (950)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_37179.current_mControllerName (HERE), enumerator_37179.current_mControllerName (HERE).mAttribute_string, GALGAS_string::makeEmptyString (), var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (957)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_37776_15 ; // Joker input parameter
      GALGAS_string joker_37776_14 ; // Joker input parameter
      GALGAS_string joker_37776_13 ; // Joker input parameter
      GALGAS_observablePropertyMap joker_37776_12 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_37776_11 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_37776_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_37776_9 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_37776_8 ; // Joker input parameter
      GALGAS_relationshipList joker_37776_7 ; // Joker input parameter
      GALGAS_relationshipList joker_37776_6 ; // Joker input parameter
      GALGAS_propertyMap joker_37776_5 ; // Joker input parameter
      GALGAS_relationshipMap joker_37776_4 ; // Joker input parameter
      GALGAS_relationshipMap joker_37776_3 ; // Joker input parameter
      GALGAS_stringset joker_37776_2 ; // Joker input parameter
      GALGAS__32_stringlist joker_37776_1 ; // Joker input parameter
      constinArgument_inEntityMap.method_searchKey (enumerator_37179.current_mControlledClassOrEntityName (HERE), joker_37776_15, joker_37776_14, joker_37776_13, joker_37776_12, joker_37776_11, joker_37776_10, joker_37776_9, joker_37776_8, joker_37776_7, joker_37776_6, joker_37776_5, joker_37776_4, joker_37776_3, joker_37776_2, joker_37776_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (963)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (964)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_37897 (enumerator_37179.current_mControllerBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_37897.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_37897.current_mBinding (HERE).ptr (), var_allRelationshipMap, var_controllerClassBindingMap, enumerator_37179.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (966)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_37897.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_controllerMap.modifier_insertKey (enumerator_37179.current_mControllerName (HERE), enumerator_37179.current_mControllerClassName (HERE).mAttribute_string, enumerator_37179.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, var_controllerActionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (974)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (984)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_36187.current_mTransientList (HERE), var_observableObjectMap, var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (985)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_documentActionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (993)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_38856 (enumerator_36187.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_38856.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_documentActionMap.modifier_insertKey (enumerator_38856.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (995)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_38856.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (999)), GALGAS_string ("self"), GALGAS_string::makeEmptyString (), var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (998)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1004)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_39195 (enumerator_36187.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_39195.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_bool var_hasTableValueBinding ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_39322_2 ; // Joker input parameter
      GALGAS_string joker_39322_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_39195.current_mOutletType (HERE), joker_39322_2, joker_39322_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1008)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1009)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_39466 (enumerator_39195.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_39466.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_39466.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, var_controllerMap, var_documentActionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1011)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_39466.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_39195.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1022)), enumerator_39195.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1022)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1022)) ;
      enumerator_39195.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1025)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outDocumentMap.modifier_insertKey (enumerator_36187.current_mDocumentName (HERE), enumerator_36187.current_mRootEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (1028)), var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, enumerator_36187.current_mActionDeclarationList (HERE), var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1026)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_40609 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1047)).isValidAndTrue () ;
  if (enumerator_40609.hasCurrentObject () && bool_0) {
    while (enumerator_40609.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_40609.current_mType (HERE))) ;
      enumerator_40609.gotoNextObject () ;
      if (enumerator_40609.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1047)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1050)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (1051)) ;
  }
}
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1061)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_41037 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_41037.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1064)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_41037.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1065)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_41262_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_41321_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_41321_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_41321_2 ; // Joker input parameter
      GALGAS_stringset joker_41321_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_41037.current_mSuperClassName (HERE), joker_41262_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_41321_4, joker_41321_3, joker_41321_2, joker_41321_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1066)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1068)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1069)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1071)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_41731 (enumerator_41037.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_41731.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_41731.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_41731.current_mType (HERE), enumerator_41731.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1074)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_41731.current_mType (HERE), enumerator_41731.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1075)), enumerator_41731.current_mDefaultValueObjectiveCObject (HERE), enumerator_41731.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1075)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_41731.current_mType (HERE), enumerator_41731.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1076)), enumerator_41731.current_mDefaultValueObjectiveCObject (HERE), enumerator_41731.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1076)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_41731.current_mAttributeName (HERE), enumerator_41731.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_41731.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1077)) COMMA_SOURCE_FILE_AT_LINE (1077)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1077)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_41731.gotoNextObject () ;
    }
    //-------- @localVariableDeclarationForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1081)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_41037.current_mTransientList (HERE), GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1084)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (1082)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1090)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_41037.current_mClassName (HERE), enumerator_41037.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1093)), var_observablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1091)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_41037.gotoNextObject () ;
  }
}
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1110)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_43276 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_43276.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1113)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_43373 (enumerator_43276.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_43373.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1115)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_43485 (enumerator_43373.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_43485.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_43485.current_mBindingOptionName (HERE), enumerator_43485.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1117)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_43485.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_43373.current_mBindingName (HERE), enumerator_43373.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1123)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_43373.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_43276.current_mOutletClassName (HERE), enumerator_43276.current_mGenerateCode (HERE), enumerator_43276.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, enumerator_43276.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1126)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1142)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_44317 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_44317.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1145)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_44426 (enumerator_44317.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_44426.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_44426.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1147)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_44426.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1150)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_44578 (enumerator_44317.current_mBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_44578.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1152)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_44690 (enumerator_44578.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_44690.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_44690.current_mBindingOptionName (HERE), enumerator_44690.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1154)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_44690.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_44578.current_mBindingName (HERE), enumerator_44578.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1160)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_44578.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1163)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerObservablePropertyList enumerator_45136 (enumerator_44317.current_mControllerObservablePropertyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_45136.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_45136.current (HERE).mAttribute_mPropertyName, enumerator_45136.current (HERE).mAttribute_mType, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1165)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1165)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_45136.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outControllerClassMap.modifier_insertKey (enumerator_44317.current_mOutletClassName (HERE), enumerator_44317.current_mGenerateCode (HERE), var_bindingMap, var_actionMap, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1168)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  outArgument_outDocumentMap.drop () ; // Release 'out' argument
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1189)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1190)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1191)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1192)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (outArgument_outEntityMap, constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1193)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outPreferencesMap, outArgument_outDocumentMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1194)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
GALGAS_string categoryReader_ebTypeIdentifier (const GALGAS_easyBindingType & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inClassOrEntityName COMMA_SOURCE_FILE_AT_LINE (768)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (768)) ;
      } break ;
    }
  }
//---
...
static void categoryMethod_tableValueBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (819)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $run action") COMMA_SOURCE_FILE_AT_LINE (831)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @assignmentInstructionForGeneration
    var_resultingObservedPropertyPath = GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (847)) COMMA_SOURCE_FILE_AT_LINE (847)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("observed object should be 'root'") COMMA_SOURCE_FILE_AT_LINE (849)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (855)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_stringlist joker_33997_0 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_33997_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (857)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (858)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (859)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_34293_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_34293_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_34293_2, joker_34293_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (862)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (864)) COMMA_SOURCE_FILE_AT_LINE (864)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (864)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (866)) COMMA_SOURCE_FILE_AT_LINE (866)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (866)) ;
      }
    }else if (kBoolFalse == test_3) {
      //-------- @errorInstructionForGeneration
      ...
      inCompiler->emitSemanticError (location_5, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (869)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (875)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_34924 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (878)).isValidAndTrue () ;
  if (enumerator_34924.hasCurrentObject () && bool_6) {
    while (enumerator_34924.hasCurrentObject () && bool_6) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_34924.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (879)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (880)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (880)) COMMA_SOURCE_FILE_AT_LINE (880)) ;
      //-------- @assignmentInstructionForGeneration
      ...
      if (enumerator_34924.hasCurrentObject ()) {
        bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (878)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (883)).boolEnum () ;
  if (kBoolTrue == test_7) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_8 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_8, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (885)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (885)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (885)) COMMA_SOURCE_FILE_AT_LINE (884)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (888)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (895)), var_resultingObservedObjectName, var_resultingObservedPropertyPath, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (893)) COMMA_SOURCE_FILE_AT_LINE (893)) ;
}
//---------------------------------------------------------------------------*
