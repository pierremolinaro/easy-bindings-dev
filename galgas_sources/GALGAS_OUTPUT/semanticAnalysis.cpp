...
cCollectionElement_columnBindingForTableValueBindingForGeneration::cCollectionElement_columnBindingForTableValueBindingForGeneration (const GALGAS_string & in_mColumnIdentifier,
                                                                                                                                      ...
                                                                                                                                      COMMA_LOCATION_ARGS) :
cCollectionElement (THERE),
mObject (in_mColumnIdentifier, in_mRequiredFormatter, in_mObservableAttributeName, in_mOutletBindingOptionList) {
}
...
cCollectionElement * cCollectionElement_columnBindingForTableValueBindingForGeneration::copy (void) {
  cCollectionElement * result = NULL ;
  macroMyNew (result, cCollectionElement_columnBindingForTableValueBindingForGeneration (mObject.mAttribute_mColumnIdentifier, mObject.mAttribute_mRequiredFormatter, mObject.mAttribute_mObservableAttributeName, mObject.mAttribute_mOutletBindingOptionList COMMA_HERE)) ;
  return result ;
}
...
GALGAS_formatterEnum GALGAS_columnBindingForTableValueBindingForGeneration::reader_mRequiredFormatterAtIndex (const GALGAS_uint & inIndex,
                                                                                                              C_Compiler * inCompiler
                                                                                                              COMMA_LOCATION_ARGS) const {
  capCollectionElement attributes = readObjectAtIndex (inIndex, inCompiler COMMA_THERE) ;
  cCollectionElement_columnBindingForTableValueBindingForGeneration * p = (cCollectionElement_columnBindingForTableValueBindingForGeneration *) attributes.ptr () ;
...
GALGAS_formatterEnum cEnumerator_columnBindingForTableValueBindingForGeneration::current_mRequiredFormatter (LOCATION_ARGS) const {
  const cCollectionElement_columnBindingForTableValueBindingForGeneration * p = (const cCollectionElement_columnBindingForTableValueBindingForGeneration *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cCollectionElement_columnBindingForTableValueBindingForGeneration) ;
...
void routine_analyzeEntities (const GALGAS_entityList constinArgument_inEntityList,
  ...
  outArgument_outEntityMap = GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (423)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityList enumerator_17680 (constinArgument_inEntityList, kEnumeration_up) ;
  ...
  while (enumerator_17680.hasCurrentObject ()) {
    ...
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (426)) ;
    //-------- @localVariableDeclarationForGeneration
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_17680.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (431)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_18097_0 ; // Joker input parameter
      GALGAS_string joker_18146_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_18234_5 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_18234_4 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_18234_3 ; // Joker input parameter
      GALGAS_triggeredKeys joker_18234_2 ; // Joker input parameter
      GALGAS_relationshipList joker_18234_1 ; // Joker input parameter
      GALGAS_relationshipMap joker_18299_0 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_17680.current_mSuperEntityName (HERE), joker_18097_0, var_implementationSuperClassName, joker_18146_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_18234_5, joker_18234_4, joker_18234_3, joker_18234_2, joker_18234_1, var_allRelationshipList, var_allPropertyMap, joker_18299_0, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (432)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (446)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (447)) ;
      //-------- @assignmentInstructionForGeneration
      var_implementationSuperClassName = GALGAS_string::makeEmptyString () ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipList = GALGAS_relationshipList::constructor_emptyList (SOURCE_FILE_AT_LINE (449)) ;
      //-------- @assignmentInstructionForGeneration
      var_allPropertyMap = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (450)) ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (451)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (453)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (454)) ;
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_19072 (enumerator_17680.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_19072.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_19072.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_19072.current_mType (HERE), enumerator_19072.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (458)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_19072.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (459)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_19072.current_mType (HERE), enumerator_19072.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (460)), enumerator_19072.current_mDefaultValueObjectiveCObject (HERE), enumerator_19072.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (460)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_19072.current_mType (HERE), enumerator_19072.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (461)), enumerator_19072.current_mDefaultValueObjectiveCObject (HERE), enumerator_19072.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (461)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_19072.current_mAttributeName (HERE), enumerator_19072.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_19072.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (462)) COMMA_SOURCE_FILE_AT_LINE (462)), inCompiler COMMA_SOURCE_FILE_AT_LINE (462)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_19072.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_relationshipMap var_currentRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (465)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipList enumerator_19767 (enumerator_17680.current_mRelationshipList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_19767.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allRelationshipMap.modifier_insertKey (enumerator_19767.current_mRelationshipName (HERE), enumerator_19767.current_mIsToMany (HERE), enumerator_19767.current_mDestinationEntityName (HERE), enumerator_19767.current_mInverseRelationshipName (HERE), enumerator_19767.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (467)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_currentRelationshipMap.modifier_insertKey (enumerator_19767.current_mRelationshipName (HERE), enumerator_19767.current_mIsToMany (HERE), enumerator_19767.current_mDestinationEntityName (HERE), enumerator_19767.current_mInverseRelationshipName (HERE), enumerator_19767.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (474)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_19767.current_mRelationshipName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (481)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_19767.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (484)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_20319 (enumerator_17680.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_20319.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_20319.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (486)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (487)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (488)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_20526 (enumerator_20319.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_20526.hasCurrentObject ()) {
        ...
        //-------- @methodCallInstructionForGeneration
        var_classObservablePropertyMap.method_searchKey (enumerator_20526.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (492)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_20526.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (493)) COMMA_SOURCE_FILE_AT_LINE (493)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_20789 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_20789.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_20789.current_mValue (HERE), enumerator_20319.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (495)) COMMA_SOURCE_FILE_AT_LINE (495)) ;
          enumerator_20789.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (497)) ;
        enumerator_20526.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_20319.current_mType (HERE), enumerator_20319.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (499)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (499)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_20319.current_mTransientName (HERE), enumerator_20319.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (500)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_20319.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outEntityMap.modifier_insertKey (enumerator_17680.current_mEntityName (HERE), enumerator_17680.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (505)), enumerator_17680.current_mImplementationClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (506)), var_implementationSuperClassName, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_triggeredKeys, enumerator_17680.current_mRelationshipList (HERE), var_allRelationshipList.operator_concat (enumerator_17680.current_mRelationshipList (HERE) COMMA_SOURCE_FILE_AT_LINE (515)), var_allPropertyMap, var_currentRelationshipMap, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (503)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_17680.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityMap enumerator_21781 (outArgument_outEntityMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_21781.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipMap enumerator_21820 (enumerator_21781.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_21820.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_21936_13 ; // Joker input parameter
      GALGAS_string joker_21936_12 ; // Joker input parameter
      GALGAS_string joker_21936_11 ; // Joker input parameter
      GALGAS_classObservablePropertyMap joker_21936_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_21936_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_21936_8 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_21936_7 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_21936_6 ; // Joker input parameter
      GALGAS_triggeredKeys joker_21936_5 ; // Joker input parameter
      GALGAS_relationshipList joker_21936_4 ; // Joker input parameter
      GALGAS_relationshipList joker_21936_3 ; // Joker input parameter
      GALGAS_propertyMap joker_21936_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_21936_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_21820.current_mDestinationEntityName (HERE), joker_21936_13, joker_21936_12, joker_21936_11, joker_21936_10, joker_21936_9, joker_21936_8, joker_21936_7, joker_21936_6, joker_21936_5, joker_21936_4, joker_21936_3, joker_21936_2, joker_21936_1, var_destinationEntityRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (525)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_inverseOfInverseRelationshipName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_22103_2 ; // Joker input parameter
      GALGAS_lstring joker_22103_1 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_22141_0 ; // Joker input parameter
      var_destinationEntityRelationshipMap.method_searchKey (enumerator_21820.current_mInverseRelationshipName (HERE), joker_22103_2, joker_22103_1, var_inverseOfInverseRelationshipName, joker_22141_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (527)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_21820.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_2 (enumerator_21820.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_21820.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (529)) COMMA_SOURCE_FILE_AT_LINE (529)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (529)) COMMA_SOURCE_FILE_AT_LINE (529)) ;
      }
...
void routine_analyzePreferences (const GALGAS_entityMap constinArgument_inEntityMap,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (708)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_29204 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29204.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservablePropertyMap var_observableAttributeMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (710)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (712)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_29381 (enumerator_29204.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_29381.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_29381.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (714)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_29381.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (717)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (718)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_29665 (enumerator_29204.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_29665.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_29665.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_29665.current_mType (HERE), enumerator_29665.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (720)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_29665.current_mType (HERE), enumerator_29665.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (721)), enumerator_29665.current_mDefaultValueObjectiveCObject (HERE), enumerator_29665.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (721)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_29665.current_mAttributeName (HERE), enumerator_29665.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_29665.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (722)) COMMA_SOURCE_FILE_AT_LINE (722)), inCompiler COMMA_SOURCE_FILE_AT_LINE (722)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_29665.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (725)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_30138 (enumerator_29204.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_30138.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (727)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (728)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_30292 (enumerator_30138.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_30292.hasCurrentObject ()) {
        ...
        GALGAS_stringlist var_propertyDependancyList ;
        //-------- @methodCallInstructionForGeneration
        var_observableAttributeMap.method_searchKey (enumerator_30292.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (732)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_30292.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (733)) COMMA_SOURCE_FILE_AT_LINE (733)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_30551 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_30551.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_30551.current_mValue (HERE), enumerator_30138.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (735)) COMMA_SOURCE_FILE_AT_LINE (735)) ;
          enumerator_30551.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (737)) ;
        enumerator_30292.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_30138.current_mType (HERE), enumerator_30138.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (739)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (739)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_30138.current_mTransientName (HERE), enumerator_30138.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (740)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_30138.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (743)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_31053 (enumerator_29204.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_31053.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_bool var_hasTableValueBinding ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_31180_2 ; // Joker input parameter
      GALGAS_string joker_31180_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_31053.current_mOutletType (HERE), joker_31180_2, joker_31180_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (747)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (748)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_31324 (enumerator_31053.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_31324.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_31324.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableAttributeMap, var_bindingMap, GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (754)), var_actionMap, var_hasTableValueBinding, GALGAS_string::makeEmptyString (), GALGAS_string ("no prefix allowed here"), var_outletBindingList, inCompiler COMMA_SOURCE_FILE_AT_LINE (750)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_31324.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_31053.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (762)), enumerator_31053.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (762)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (762)) ;
      enumerator_31053.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outPreferencesMap.modifier_insertKey (enumerator_29204.current_mPreferencesName (HERE), var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, var_triggeredKeys, enumerator_29204.current_mActionDeclarationList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (765)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_29204.gotoNextObject () ;
  }
}
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_33282 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_33282.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_33282.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (807)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_33471 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (809)).isValidAndTrue () ;
    if (enumerator_33471.hasCurrentObject () && bool_0) {
      while (enumerator_33471.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_33535 (enumerator_33282.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (810)).isValidAndTrue () ;
        if (enumerator_33535.hasCurrentObject () && bool_1) {
          while (enumerator_33535.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_33471.current_mType (HERE).objectCompare (enumerator_33535.current_mType (HERE))) ;
            enumerator_33535.gotoNextObject () ;
            if (enumerator_33535.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (810)).isValidAndTrue () ;
            }
          }
        }
        enumerator_33471.gotoNextObject () ;
        if (enumerator_33471.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (809)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (814)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_33774 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (816)).isValidAndTrue () ;
      if (enumerator_33774.hasCurrentObject () && bool_3) {
        while (enumerator_33774.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_33774.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (817)) COMMA_SOURCE_FILE_AT_LINE (817)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (817)) COMMA_SOURCE_FILE_AT_LINE (817)) ;
          enumerator_33774.gotoNextObject () ;
          if (enumerator_33774.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (816)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_33282.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (819)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_33282.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (821)), enumerator_33282.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (821)) ;
    enumerator_33282.gotoNextObject () ;
  }
}
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (936)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_38679 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_38679.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    ...
    GALGAS_relationshipMap var_allRelationshipMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_38884_0 ; // Joker input parameter
    GALGAS_string joker_38934_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_38972_9 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_38972_8 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_38972_7 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_38972_6 ; // Joker input parameter
    GALGAS_triggeredKeys joker_38972_5 ; // Joker input parameter
    GALGAS_relationshipList joker_38972_4 ; // Joker input parameter
    GALGAS_relationshipList joker_38972_3 ; // Joker input parameter
    GALGAS_propertyMap joker_38972_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_38972_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_38679.current_mRootEntityName (HERE), joker_38884_0, var_rootEntityImplementationClassName, joker_38934_0, var_observablePropertyMap, joker_38972_9, joker_38972_8, joker_38972_7, joker_38972_6, joker_38972_5, joker_38972_4, joker_38972_3, joker_38972_2, joker_38972_1, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (941)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_documentActionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (951)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_39124 (enumerator_38679.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_39124.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_documentActionMap.modifier_insertKey (enumerator_39124.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (953)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_39124.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (956)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerList enumerator_39302 (enumerator_38679.current_mControllerList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_39302.hasCurrentObject ()) {
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_39461_0 ; // Joker input parameter
      constinArgument_inControllerClassMap.method_searchKey (enumerator_39302.current_mControllerClassName (HERE), joker_39461_0, var_controllerClassBindingMap, var_controllerActionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (960)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_39575_14 ; // Joker input parameter
      GALGAS_string joker_39575_13 ; // Joker input parameter
      GALGAS_string joker_39575_12 ; // Joker input parameter
      GALGAS_classObservablePropertyMap joker_39575_11 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_39575_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_39575_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_39575_8 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_39575_7 ; // Joker input parameter
      GALGAS_triggeredKeys joker_39575_6 ; // Joker input parameter
      GALGAS_relationshipList joker_39575_5 ; // Joker input parameter
      GALGAS_relationshipList joker_39575_4 ; // Joker input parameter
      GALGAS_propertyMap joker_39575_3 ; // Joker input parameter
      GALGAS_relationshipMap joker_39575_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_39575_1 ; // Joker input parameter
      constinArgument_inEntityMap.method_searchKey (enumerator_39302.current_mControlledClassOrEntityName (HERE), joker_39575_14, joker_39575_13, joker_39575_12, joker_39575_11, joker_39575_10, joker_39575_9, joker_39575_8, joker_39575_7, joker_39575_6, joker_39575_5, joker_39575_4, joker_39575_3, joker_39575_2, joker_39575_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (961)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (962)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_39696 (enumerator_39302.current_mControllerBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_39696.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_39696.current_mBinding (HERE).ptr (), var_allRelationshipMap, var_controllerClassBindingMap, enumerator_39302.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (964)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_39696.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_controllerMap.modifier_insertKey (enumerator_39302.current_mControllerName (HERE), enumerator_39302.current_mControllerClassName (HERE).mAttribute_string, enumerator_39302.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, var_controllerActionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (972)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_39302.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (981)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_40303 (enumerator_38679.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_40303.hasCurrentObject ()) {
      ...
      GALGAS_bool var_hasTableValueBinding ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_40430_2 ; // Joker input parameter
      GALGAS_string joker_40430_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_40303.current_mOutletType (HERE), joker_40430_2, joker_40430_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (985)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (986)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_40574 (enumerator_40303.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_40574.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_40574.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observablePropertyMap, var_bindingMap, var_controllerMap, var_documentActionMap, var_hasTableValueBinding, GALGAS_string ("root"), GALGAS_string ("'root' prefix is required here"), var_outletBindingList, inCompiler COMMA_SOURCE_FILE_AT_LINE (988)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_40574.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_40303.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1000)), enumerator_40303.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1000)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1000)) ;
      enumerator_40303.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outDocumentMap.modifier_insertKey (enumerator_38679.current_mDocumentName (HERE), enumerator_38679.current_mRootEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (1005)), var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, enumerator_38679.current_mActionDeclarationList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1003)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_38679.gotoNextObject () ;
  }
}
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_41607 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1022)).isValidAndTrue () ;
  if (enumerator_41607.hasCurrentObject () && bool_0) {
    while (enumerator_41607.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_41607.current_mType (HERE))) ;
      enumerator_41607.gotoNextObject () ;
      if (enumerator_41607.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1022)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1025)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (1026)) ;
  }
}
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1036)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_42035 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_42035.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_classObservablePropertyMap var_classObservablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1039)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_42035.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1040)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_42270_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_42334_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_42334_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_42334_2 ; // Joker input parameter
      GALGAS_triggeredKeys joker_42334_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_42035.current_mSuperClassName (HERE), joker_42270_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_42334_4, joker_42334_3, joker_42334_2, joker_42334_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1041)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1043)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1044)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1046)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1047)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (1049)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_42881 (enumerator_42035.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42881.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_42881.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_42881.current_mType (HERE), enumerator_42881.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1051)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_42881.current_mType (HERE), enumerator_42881.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1052)), enumerator_42881.current_mDefaultValueObjectiveCObject (HERE), enumerator_42881.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1052)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_42881.current_mType (HERE), enumerator_42881.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1053)), enumerator_42881.current_mDefaultValueObjectiveCObject (HERE), enumerator_42881.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1053)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_42881.current_mAttributeName (HERE), enumerator_42881.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_42881.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1054)) COMMA_SOURCE_FILE_AT_LINE (1054)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1054)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_42881.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_43443 (enumerator_42035.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_43443.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1058)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1059)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_43597 (enumerator_43443.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_43597.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_easyBindingType var_type ;
        //-------- @localVariableDeclarationForGeneration
        GALGAS_stringlist var_propertyDependancyList ;
        //-------- @methodCallInstructionForGeneration
        var_classObservablePropertyMap.method_searchKey (enumerator_43597.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1063)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_43597.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1064)) COMMA_SOURCE_FILE_AT_LINE (1064)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_43860 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_43860.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_43860.current_mValue (HERE), enumerator_43443.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (1066)) COMMA_SOURCE_FILE_AT_LINE (1066)) ;
          enumerator_43860.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (1068)) ;
        enumerator_43597.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_43443.current_mType (HERE), enumerator_43443.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (1070)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (1070)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_43443.current_mTransientName (HERE), enumerator_43443.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1071)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_43443.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_42035.current_mClassName (HERE), enumerator_42035.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1076)), var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_triggeredKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (1074)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_42035.gotoNextObject () ;
  }
}
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1093)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_44862 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_44862.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1096)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_44959 (enumerator_44862.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_44959.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1098)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_45071 (enumerator_44959.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_45071.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_45071.current_mBindingOptionName (HERE), enumerator_45071.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1100)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_45071.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_44959.current_mBindingName (HERE), enumerator_44959.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1106)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_44959.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_44862.current_mOutletClassName (HERE), enumerator_44862.current_mGenerateCode (HERE), enumerator_44862.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, enumerator_44862.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1109)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_44862.gotoNextObject () ;
  }
}
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1125)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_45903 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_45903.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1128)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_46012 (enumerator_45903.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_46012.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_46012.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1130)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_46012.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1133)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_46164 (enumerator_45903.current_mBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_46164.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1135)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_46276 (enumerator_46164.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_46276.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_46276.current_mBindingOptionName (HERE), enumerator_46276.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1137)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_46276.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_46164.current_mBindingName (HERE), enumerator_46164.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1143)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_46164.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outControllerClassMap.modifier_insertKey (enumerator_45903.current_mOutletClassName (HERE), enumerator_45903.current_mGenerateCode (HERE), var_bindingMap, var_actionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1146)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_45903.gotoNextObject () ;
  }
}
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  outArgument_outDocumentMap.drop () ; // Release 'out' argument
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1166)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1167)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1168)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1169)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (outArgument_outEntityMap, constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1170)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outDocumentMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1171)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
GALGAS_formatterEnum categoryReader_requiredFormatterInTableColumnBinding (const GALGAS_easyBindingType & inObject,
                                                                           C_Compiler * /* inCompiler */
                                                                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_formatterEnum result_outResult ; // Returned variable
  //------- @switchInstructionForGeneration
  //--- @selfCopyInExpressionForGeneration
  const GALGAS_easyBindingType temp_0 = inObject ;
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_boolType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (75)) ;
      } break ;
    case GALGAS_easyBindingType::kEnum_integer_31__36_Type: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_formatterEnum::constructor_numberFormatter (SOURCE_FILE_AT_LINE (76)) ;
      } break ;
    case GALGAS_easyBindingType::kEnum_integer_33__32_Type: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_formatterEnum::constructor_numberFormatter (SOURCE_FILE_AT_LINE (77)) ;
      } break ;
    case GALGAS_easyBindingType::kEnum_integer_36__34_Type: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_formatterEnum::constructor_numberFormatter (SOURCE_FILE_AT_LINE (78)) ;
      } break ;
    case GALGAS_easyBindingType::kEnum_decimalType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_formatterEnum::constructor_numberFormatter (SOURCE_FILE_AT_LINE (79)) ;
      } break ;
    case GALGAS_easyBindingType::kEnum_floatType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_formatterEnum::constructor_numberFormatter (SOURCE_FILE_AT_LINE (80)) ;
      } break ;
    case GALGAS_easyBindingType::kEnum_doubleType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_formatterEnum::constructor_numberFormatter (SOURCE_FILE_AT_LINE (81)) ;
      } break ;
    case GALGAS_easyBindingType::kEnum_stringType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (82)) ;
      } break ;
    case GALGAS_easyBindingType::kEnum_dataType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (83)) ;
      } break ;
    case GALGAS_easyBindingType::kEnum_dateType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_formatterEnum::constructor_dateFormatter (SOURCE_FILE_AT_LINE (84)) ;
      } break ;
    case GALGAS_easyBindingType::kEnum_fontType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (85)) ;
      } break ;
    case GALGAS_easyBindingType::kEnum_imageType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (86)) ;
      } break ;
    case GALGAS_easyBindingType::kEnum_colorType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (87)) ;
      } break ;
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (88)) ;
      } break ;
    }
  }
//---
...
static GALGAS_string categoryReader_runBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("  ").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string (".target = ") COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (object->mAttribute_mTargetName COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (221)) ;
  //-------- @concatInstructionForGeneration
  result_outResult.dotAssign_operation (GALGAS_string ("  ").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (GALGAS_string (".action = @selector (") COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (object->mAttribute_mActionName COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (GALGAS_string (":) ;\n") COMMA_SOURCE_FILE_AT_LINE (222)) COMMA_SOURCE_FILE_AT_LINE (222)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_tableValueBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_columnBindingForTableValueBindingForGeneration enumerator_8888 (object->mAttribute_mColumnBindingForTableValueBindingForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_8888.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("  if (nil == [").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (enumerator_8888.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (GALGAS_string ("\"]) {\n") COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (234)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (234)).operator_concat (GALGAS_string ("' NSTableView outlet has no formatter has no column with the ") COMMA_SOURCE_FILE_AT_LINE (234)).operator_concat (enumerator_8888.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (234)).operator_concat (GALGAS_string (" identifier\") ;\n") COMMA_SOURCE_FILE_AT_LINE (234)).operator_concat (GALGAS_string ("  }\n") COMMA_SOURCE_FILE_AT_LINE (235)) COMMA_SOURCE_FILE_AT_LINE (233)) ;
    //------- @switchInstructionForGeneration
    if (enumerator_8888.current (HERE).mAttribute_mRequiredFormatter.isValid ()) {
      switch (enumerator_8888.current (HERE).mAttribute_mRequiredFormatter.enumValue ()) {
      ...
      case GALGAS_formatterEnum::kEnum_numberFormatter: {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("if ((nil != [").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (enumerator_8888.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (GALGAS_string ("\"]) && (nil == ") COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (GALGAS_string (".formatter)) {\n") COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (GALGAS_string ("  presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (240)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (240)).operator_concat (GALGAS_string ("' outlet has no formatter, it should have an NSNumberFormatter\") ;\n") COMMA_SOURCE_FILE_AT_LINE (240)).operator_concat (GALGAS_string ("  }else if ((nil != ") COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (GALGAS_string (") && ![") COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (GALGAS_string (".formatter isKindOfClass:[NSNumberFormatter class]]) {\n") COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (242)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (242)).operator_concat (GALGAS_string (" outlet has a formatter that is not kind of NSNumberFormatter class\") ;\n") COMMA_SOURCE_FILE_AT_LINE (242)).operator_concat (GALGAS_string ("  }\n") COMMA_SOURCE_FILE_AT_LINE (243)) COMMA_SOURCE_FILE_AT_LINE (239)) ;
        } break ;
      case GALGAS_formatterEnum::kEnum_dateFormatter: {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  if ((nil != ").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (245)).operator_concat (GALGAS_string (") && (nil == ") COMMA_SOURCE_FILE_AT_LINE (245)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (245)).operator_concat (GALGAS_string (".formatter)) {\n") COMMA_SOURCE_FILE_AT_LINE (245)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (246)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (246)).operator_concat (GALGAS_string ("' outlet has no formatter, it should have an NSDateFormatter\") ;\n") COMMA_SOURCE_FILE_AT_LINE (246)).operator_concat (GALGAS_string ("  }else if ((nil != ") COMMA_SOURCE_FILE_AT_LINE (247)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (247)).operator_concat (GALGAS_string (") && ![") COMMA_SOURCE_FILE_AT_LINE (247)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (247)).operator_concat (GALGAS_string (".formatter isKindOfClass:[NSDateFormatter class]]) {\n") COMMA_SOURCE_FILE_AT_LINE (247)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (248)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (248)).operator_concat (GALGAS_string ("' outlet has a formatter that is not kind of NSDateFormatter class\") ;\n") COMMA_SOURCE_FILE_AT_LINE (248)).operator_concat (GALGAS_string ("  }\n") COMMA_SOURCE_FILE_AT_LINE (249)) COMMA_SOURCE_FILE_AT_LINE (245)) ;
        } break ;
      }
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("  [[").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (enumerator_8888.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (GALGAS_string ("\"]\n") COMMA_SOURCE_FILE_AT_LINE (251)).operator_concat (GALGAS_string ("    bind:@\"value\"\n") COMMA_SOURCE_FILE_AT_LINE (252)).operator_concat (GALGAS_string ("    toObject:") COMMA_SOURCE_FILE_AT_LINE (253)).operator_concat (object->mAttribute_mControllerName COMMA_SOURCE_FILE_AT_LINE (253)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (253)).operator_concat (GALGAS_string ("    withKeyPath:@\"arrangedObjects.") COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (enumerator_8888.current (HERE).mAttribute_mObservableAttributeName COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (GALGAS_string ("    options:") COMMA_SOURCE_FILE_AT_LINE (255)) COMMA_SOURCE_FILE_AT_LINE (251)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_8888.current (HERE).mAttribute_mOutletBindingOptionList.reader_length (SOURCE_FILE_AT_LINE (256)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_11103 (enumerator_8888.current (HERE).mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_11103.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("      ").operator_concat (enumerator_11103.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (261)).operator_concat (GALGAS_string (", @") COMMA_SOURCE_FILE_AT_LINE (261)).operator_concat (enumerator_11103.current_mValue_30_ (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (261)) COMMA_SOURCE_FILE_AT_LINE (261)).operator_concat (GALGAS_string (",\n") COMMA_SOURCE_FILE_AT_LINE (261)) COMMA_SOURCE_FILE_AT_LINE (261)) ;
...
static GALGAS_string categoryReader_regularBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  if (object->mAttribute_mRequiredFormatter.isValid ()) {
    ...
    case GALGAS_formatterEnum::kEnum_numberFormatter: {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("if ((nil != ").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (280)).operator_concat (GALGAS_string (") && (nil == ") COMMA_SOURCE_FILE_AT_LINE (280)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (280)).operator_concat (GALGAS_string (".formatter)) {\n") COMMA_SOURCE_FILE_AT_LINE (280)).operator_concat (GALGAS_string ("  presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (281)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (281)).operator_concat (GALGAS_string ("' outlet has no formatter, it should have an NSNumberFormatter\") ;\n") COMMA_SOURCE_FILE_AT_LINE (281)).operator_concat (GALGAS_string ("  }else if ((nil != ") COMMA_SOURCE_FILE_AT_LINE (282)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (282)).operator_concat (GALGAS_string (") && ![") COMMA_SOURCE_FILE_AT_LINE (282)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (282)).operator_concat (GALGAS_string (".formatter isKindOfClass:[NSNumberFormatter class]]) {\n") COMMA_SOURCE_FILE_AT_LINE (282)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (283)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (283)).operator_concat (GALGAS_string (" outlet has a formatter that is not kind of NSNumberFormatter class\") ;\n") COMMA_SOURCE_FILE_AT_LINE (283)).operator_concat (GALGAS_string ("  }\n") COMMA_SOURCE_FILE_AT_LINE (284)) COMMA_SOURCE_FILE_AT_LINE (280)) ;
      } break ;
    case GALGAS_formatterEnum::kEnum_dateFormatter: {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("  if ((nil != ").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (286)).operator_concat (GALGAS_string (") && (nil == ") COMMA_SOURCE_FILE_AT_LINE (286)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (286)).operator_concat (GALGAS_string (".formatter)) {\n") COMMA_SOURCE_FILE_AT_LINE (286)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (287)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (287)).operator_concat (GALGAS_string ("' outlet has no formatter, it should have an NSDateFormatter\") ;\n") COMMA_SOURCE_FILE_AT_LINE (287)).operator_concat (GALGAS_string ("  }else if ((nil != ") COMMA_SOURCE_FILE_AT_LINE (288)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (288)).operator_concat (GALGAS_string (") && ![") COMMA_SOURCE_FILE_AT_LINE (288)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (288)).operator_concat (GALGAS_string (".formatter isKindOfClass:[NSDateFormatter class]]) {\n") COMMA_SOURCE_FILE_AT_LINE (288)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (289)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (289)).operator_concat (GALGAS_string ("' outlet has a formatter that is not kind of NSDateFormatter class\") ;\n") COMMA_SOURCE_FILE_AT_LINE (289)).operator_concat (GALGAS_string ("  }\n") COMMA_SOURCE_FILE_AT_LINE (290)) COMMA_SOURCE_FILE_AT_LINE (286)) ;
      } break ;
    }
  }
  //-------- @concatInstructionForGeneration
  result_outResult.dotAssign_operation (GALGAS_string ("  [").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (292)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (292)).operator_concat (GALGAS_string ("    bind:@\"") COMMA_SOURCE_FILE_AT_LINE (293)).operator_concat (object->mAttribute_mBindingName COMMA_SOURCE_FILE_AT_LINE (293)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (293)).operator_concat (GALGAS_string ("    toObject:") COMMA_SOURCE_FILE_AT_LINE (294)).operator_concat (object->mAttribute_mObservedObjectName COMMA_SOURCE_FILE_AT_LINE (294)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (294)).operator_concat (GALGAS_string ("    withKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (295)).operator_concat (object->mAttribute_mObservableAttributeName COMMA_SOURCE_FILE_AT_LINE (295)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (295)).operator_concat (GALGAS_string ("    options:") COMMA_SOURCE_FILE_AT_LINE (296)) COMMA_SOURCE_FILE_AT_LINE (292)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mOutletBindingOptionList.reader_length (SOURCE_FILE_AT_LINE (297)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator__32_stringlist enumerator_13226 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_13226.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("      ").operator_concat (enumerator_13226.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (302)).operator_concat (GALGAS_string (", @") COMMA_SOURCE_FILE_AT_LINE (302)).operator_concat (enumerator_13226.current_mValue_30_ (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (302)) COMMA_SOURCE_FILE_AT_LINE (302)).operator_concat (GALGAS_string (",\n") COMMA_SOURCE_FILE_AT_LINE (302)) COMMA_SOURCE_FILE_AT_LINE (302)) ;
...
static void categoryMethod_tableValueBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inHasTableValueBinding.operator_not (SOURCE_FILE_AT_LINE (562)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mControllerName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("this outlet does not support $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (563)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_23717_0 ; // Joker input parameter
    GALGAS_actionMap joker_23790_0 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_23717_0, var_controlledClassOrEntityName, var_controllerBindingList, joker_23790_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (567)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_classObservablePropertyMap var_observablePropertyMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_23891_3 ; // Joker input parameter
    GALGAS_string joker_23891_2 ; // Joker input parameter
    GALGAS_string joker_23891_1 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_23959_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_23959_9 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_23959_8 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_23959_7 ; // Joker input parameter
    GALGAS_triggeredKeys joker_23959_6 ; // Joker input parameter
    GALGAS_relationshipList joker_23959_5 ; // Joker input parameter
    GALGAS_relationshipList joker_23959_4 ; // Joker input parameter
    GALGAS_propertyMap joker_23959_3 ; // Joker input parameter
    GALGAS_relationshipMap joker_23959_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_23959_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (GALGAS_lstring::constructor_new (var_controlledClassOrEntityName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (575)), joker_23891_3, joker_23891_2, joker_23891_1, var_observablePropertyMap, joker_23959_10, joker_23959_9, joker_23959_8, joker_23959_7, joker_23959_6, joker_23959_5, joker_23959_4, joker_23959_3, joker_23959_2, joker_23959_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (574)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_columnBindingForTableValueBindingForGeneration var_columnBindingForTableValueBindingForGeneration = GALGAS_columnBindingForTableValueBindingForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (580)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_tableValueColumnBinding enumerator_24127 (object->mAttribute_mTableValueColumnBinding, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_24127.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingType var_type ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_stringlist joker_24257_0 ; // Joker input parameter
      var_observablePropertyMap.method_searchKey (enumerator_24127.current (HERE).mAttribute_mBoundPropertyName, var_type, joker_24257_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (583)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_allowedCellTypeInTableColumnBinding = categoryReader_allowedCellTypeInTableColumnBinding (var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (588)) ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_allowedCellTypeInTableColumnBinding.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_24127.current (HERE).mAttribute_mBoundPropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("this property cannot be named in a $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (590)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_allowedCellTypeInTableColumnBinding.objectCompare (enumerator_24127.current (HERE).mAttribute_mCellTypeName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_24127.current (HERE).mAttribute_mCellTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("this property requires a ").operator_concat (var_allowedCellTypeInTableColumnBinding COMMA_SOURCE_FILE_AT_LINE (592)).operator_concat (GALGAS_string (" cell class") COMMA_SOURCE_FILE_AT_LINE (592)) COMMA_SOURCE_FILE_AT_LINE (592)) ;
        }
      }
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_formatterEnum var_requiredFormatter = categoryReader_requiredFormatterInTableColumnBinding (var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (594)) ;
      //-------- @plusEqualnstructionForGeneration
      var_columnBindingForTableValueBindingForGeneration.addAssign_operation (enumerator_24127.current (HERE).mAttribute_mColumnName.mAttribute_string, var_requiredFormatter, enumerator_24127.current (HERE).mAttribute_mBoundPropertyName.mAttribute_string, GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (599)) COMMA_SOURCE_FILE_AT_LINE (595)) ;
      enumerator_24127.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_tableValueBindingForGeneration::constructor_new (object->mAttribute_mControllerName.mAttribute_string, var_columnBindingForTableValueBindingForGeneration COMMA_SOURCE_FILE_AT_LINE (602)) COMMA_SOURCE_FILE_AT_LINE (602)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_inActionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (623)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_actionMap var_actionMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_25954_3 ; // Joker input parameter
    GALGAS_string joker_25954_2 ; // Joker input parameter
    GALGAS_outletBindingListForGeneration joker_25954_1 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mTargetName, joker_25954_3, joker_25954_2, joker_25954_1, var_actionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (626)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
    var_actionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (627)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_runBindingForGeneration::constructor_new (object->mAttribute_mTargetName.mAttribute_string, object->mAttribute_mActionName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (629)) COMMA_SOURCE_FILE_AT_LINE (629)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (650)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, constinArgument_inRequiredPrefixErrorMessage COMMA_SOURCE_FILE_AT_LINE (653)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_observablePropertyType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_stringlist joker_27216_0 ; // Joker input parameter
  constinArgument_inObservableAttributeMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_27216_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (656)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_27386 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (660)).isValidAndTrue () ;
  if (enumerator_27386.hasCurrentObject () && bool_2) {
    while (enumerator_27386.hasCurrentObject () && bool_2) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_27386.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_27386.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_27386.gotoNextObject () ;
      if (enumerator_27386.hasCurrentObject ()) {
        bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (660)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (664)).boolEnum () ;
  if (kBoolTrue == test_3) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_27690 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (666)).isValidAndTrue () ;
    if (enumerator_27690.hasCurrentObject () && bool_4) {
      while (enumerator_27690.hasCurrentObject () && bool_4) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_27690.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (667)) COMMA_SOURCE_FILE_AT_LINE (667)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (667)) COMMA_SOURCE_FILE_AT_LINE (667)) ;
        enumerator_27690.gotoNextObject () ;
        if (enumerator_27690.hasCurrentObject ()) {
          bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (666)).isValidAndTrue () ;
        }
      }
    }
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_5, var_s COMMA_SOURCE_FILE_AT_LINE (669)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (672)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_27925 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_27925.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_27925.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (675)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_28114 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (677)).isValidAndTrue () ;
    if (enumerator_28114.hasCurrentObject () && bool_6) {
      while (enumerator_28114.hasCurrentObject () && bool_6) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_28178 (enumerator_27925.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (678)).isValidAndTrue () ;
        if (enumerator_28178.hasCurrentObject () && bool_7) {
          while (enumerator_28178.hasCurrentObject () && bool_7) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_28114.current_mType (HERE).objectCompare (enumerator_28178.current_mType (HERE))) ;
            enumerator_28178.gotoNextObject () ;
            if (enumerator_28178.hasCurrentObject ()) {
              bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (678)).isValidAndTrue () ;
            }
          }
        }
        enumerator_28114.gotoNextObject () ;
        if (enumerator_28114.hasCurrentObject ()) {
          bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (677)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (682)).boolEnum () ;
    if (kBoolTrue == test_8) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_28417 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (684)).isValidAndTrue () ;
      if (enumerator_28417.hasCurrentObject () && bool_9) {
        while (enumerator_28417.hasCurrentObject () && bool_9) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_28417.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (685)) COMMA_SOURCE_FILE_AT_LINE (685)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (685)) COMMA_SOURCE_FILE_AT_LINE (685)) ;
          enumerator_28417.gotoNextObject () ;
          if (enumerator_28417.hasCurrentObject ()) {
            bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (684)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_10 (enumerator_27925.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_10, var_s COMMA_SOURCE_FILE_AT_LINE (687)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_27925.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (689)), enumerator_27925.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (689)) ;
    enumerator_27925.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (692)), var_requiredFormatter, GALGAS_string ("self"), object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (695)), var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (691)) COMMA_SOURCE_FILE_AT_LINE (691)) ;
}
//---------------------------------------------------------------------------*
...
GALGAS_string categoryReader_ebTypeIdentifier (const GALGAS_easyBindingType & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inClassOrEntityName COMMA_SOURCE_FILE_AT_LINE (793)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (793)) ;
      } break ;
    }
  }
//---
...
static void categoryMethod_tableValueBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (844)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $run action") COMMA_SOURCE_FILE_AT_LINE (856)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @assignmentInstructionForGeneration
    var_resultingObservedPropertyPath = GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (872)) COMMA_SOURCE_FILE_AT_LINE (872)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("observed object should be 'root'") COMMA_SOURCE_FILE_AT_LINE (874)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (880)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_stringlist joker_36526_0 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_36526_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (882)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (883)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (884)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_36822_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_36822_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_36822_2, joker_36822_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (887)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (889)) COMMA_SOURCE_FILE_AT_LINE (889)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (889)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (891)) COMMA_SOURCE_FILE_AT_LINE (891)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (891)) ;
      }
    }else if (kBoolFalse == test_3) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_5 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (894)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (900)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_37453 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (903)).isValidAndTrue () ;
  if (enumerator_37453.hasCurrentObject () && bool_6) {
    while (enumerator_37453.hasCurrentObject () && bool_6) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_37453.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (904)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (905)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (905)) COMMA_SOURCE_FILE_AT_LINE (905)) ;
      //-------- @assignmentInstructionForGeneration
      ...
      if (enumerator_37453.hasCurrentObject ()) {
        bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (903)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (908)).boolEnum () ;
  if (kBoolTrue == test_7) {
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_8, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (910)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (910)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (910)) COMMA_SOURCE_FILE_AT_LINE (909)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (913)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (920)), var_resultingObservedObjectName, var_resultingObservedPropertyPath, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (918)) COMMA_SOURCE_FILE_AT_LINE (918)) ;
}
//---------------------------------------------------------------------------*
...
bool GALGAS_columnBindingForTableValueBindingForGeneration_2E_element::isValid (void) const {
  return mAttribute_mColumnIdentifier.isValid () && mAttribute_mRequiredFormatter.isValid () && mAttribute_mObservableAttributeName.isValid () && mAttribute_mOutletBindingOptionList.isValid () ;
}
...
GALGAS_formatterEnum GALGAS_columnBindingForTableValueBindingForGeneration_2E_element::reader_mRequiredFormatter (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRequiredFormatter ;
}
