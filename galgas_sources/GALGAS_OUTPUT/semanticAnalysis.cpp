...
void routine_analyzeEntities (const GALGAS_entityList constinArgument_inEntityList,
  ...
  outArgument_outEntityMap = GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (375)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityList enumerator_14874 (constinArgument_inEntityList, kEnumeration_up) ;
  ...
  while (enumerator_14874.hasCurrentObject ()) {
    ...
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (378)) ;
    //-------- @localVariableDeclarationForGeneration
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_14874.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (383)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_15281_0 ; // Joker input parameter
      GALGAS_string joker_15330_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_15413_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_15413_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_15413_2 ; // Joker input parameter
      GALGAS_relationshipList joker_15413_1 ; // Joker input parameter
      GALGAS_relationshipMap joker_15478_0 ; // Joker input parameter
      GALGAS_stringset joker_15517_2 ; // Joker input parameter
      GALGAS__32_stringlist joker_15517_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_14874.current_mSuperEntityName (HERE), joker_15281_0, var_implementationSuperClassName, joker_15330_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_15413_4, joker_15413_3, joker_15413_2, joker_15413_1, var_allRelationshipList, var_allPropertyMap, joker_15478_0, var_allRelationshipMap, joker_15517_2, joker_15517_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (384)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (399)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (400)) ;
      //-------- @assignmentInstructionForGeneration
      var_implementationSuperClassName = GALGAS_string::makeEmptyString () ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipList = GALGAS_relationshipList::constructor_emptyList (SOURCE_FILE_AT_LINE (402)) ;
      //-------- @assignmentInstructionForGeneration
      var_allPropertyMap = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (403)) ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (404)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (406)) ;
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_16172 (enumerator_14874.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_16172.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_16172.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_16172.current_mType (HERE), enumerator_16172.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (410)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_16172.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (411)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_16172.current_mType (HERE), enumerator_16172.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (412)), enumerator_16172.current_mDefaultValueObjectiveCObject (HERE), enumerator_16172.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (412)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_16172.current_mType (HERE), enumerator_16172.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (413)), enumerator_16172.current_mDefaultValueObjectiveCObject (HERE), enumerator_16172.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (413)) ;
      { //-------- @modifierCallInstructionForGeneration
      ioArgument_ioTransientDependencyGraph.modifier_addNode (GALGAS_lstring::constructor_new (GALGAS_string ("entity.").operator_concat (enumerator_14874.current_mEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (414)) COMMA_SOURCE_FILE_AT_LINE (414)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (414)).operator_concat (enumerator_16172.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (414)) COMMA_SOURCE_FILE_AT_LINE (414)), enumerator_16172.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (414)), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (414)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("entity/").operator_concat (enumerator_14874.current_mEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (416)) COMMA_SOURCE_FILE_AT_LINE (416)).operator_concat (GALGAS_string ("/self.") COMMA_SOURCE_FILE_AT_LINE (416)).operator_concat (enumerator_16172.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (416)) COMMA_SOURCE_FILE_AT_LINE (416)), enumerator_16172.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (415)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_16172.current_mAttributeName (HERE), enumerator_16172.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_16172.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (422)) COMMA_SOURCE_FILE_AT_LINE (422)), var_observationDependencyKey, inCompiler COMMA_SOURCE_FILE_AT_LINE (419)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (425)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_16172.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_relationshipMap var_currentRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (431)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipList enumerator_17350 (enumerator_14874.current_mRelationshipList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_17350.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allRelationshipMap.modifier_insertKey (enumerator_17350.current_mRelationshipName (HERE), enumerator_17350.current_mIsToMany (HERE), enumerator_17350.current_mDestinationEntityName (HERE), enumerator_17350.current_mInverseRelationshipName (HERE), enumerator_17350.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (433)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_currentRelationshipMap.modifier_insertKey (enumerator_17350.current_mRelationshipName (HERE), enumerator_17350.current_mIsToMany (HERE), enumerator_17350.current_mDestinationEntityName (HERE), enumerator_17350.current_mInverseRelationshipName (HERE), enumerator_17350.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (440)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_17350.current_mRelationshipName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (447)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("entity/").operator_concat (enumerator_14874.current_mEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (449)) COMMA_SOURCE_FILE_AT_LINE (449)).operator_concat (GALGAS_string ("/self.") COMMA_SOURCE_FILE_AT_LINE (449)).operator_concat (enumerator_17350.current_mRelationshipName (HERE).reader_string (SOURCE_FILE_AT_LINE (449)) COMMA_SOURCE_FILE_AT_LINE (449)), enumerator_17350.current_mRelationshipName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (448)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_17350.current_mRelationshipName (HERE), GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (454)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (455)), var_observationDependencyKey, inCompiler COMMA_SOURCE_FILE_AT_LINE (452)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (458)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_17350.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (464)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (GALGAS_string ("entity/").operator_concat (enumerator_14874.current_mEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (467)) COMMA_SOURCE_FILE_AT_LINE (467)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (467)), enumerator_14874.current_mTransientList (HERE), GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (469)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (466)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS__32_stringlist var_toManyRelationshipList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (476)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipList enumerator_18813 (enumerator_14874.current_mRelationshipList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_18813.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = enumerator_18813.current_mIsToMany (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @plusEqualnstructionForGeneration
        var_toManyRelationshipList.addAssign_operation (enumerator_18813.current_mRelationshipName (HERE).mAttribute_string, enumerator_18813.current_mDestinationEntityName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (479)) ;
      }
      enumerator_18813.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (484)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outEntityMap.modifier_insertKey (enumerator_14874.current_mEntityName (HERE), enumerator_14874.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (487)), enumerator_14874.current_mImplementationClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (488)), var_implementationSuperClassName, var_observablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, enumerator_14874.current_mRelationshipList (HERE), var_allRelationshipList.operator_concat (enumerator_14874.current_mRelationshipList (HERE) COMMA_SOURCE_FILE_AT_LINE (496)), var_allPropertyMap, var_currentRelationshipMap, var_allRelationshipMap, var_implementationFileInclusionSet, var_toManyRelationshipList, inCompiler COMMA_SOURCE_FILE_AT_LINE (485)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_14874.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityMap enumerator_19682 (outArgument_outEntityMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_19682.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipMap enumerator_19721 (enumerator_19682.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_19721.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_19837_12 ; // Joker input parameter
      GALGAS_string joker_19837_11 ; // Joker input parameter
      GALGAS_string joker_19837_10 ; // Joker input parameter
      GALGAS_observablePropertyMap joker_19837_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_19837_8 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_19837_7 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_19837_6 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_19837_5 ; // Joker input parameter
      GALGAS_relationshipList joker_19837_4 ; // Joker input parameter
      GALGAS_relationshipList joker_19837_3 ; // Joker input parameter
      GALGAS_propertyMap joker_19837_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_19837_1 ; // Joker input parameter
      GALGAS_stringset joker_19875_2 ; // Joker input parameter
      GALGAS__32_stringlist joker_19875_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_19721.current_mDestinationEntityName (HERE), joker_19837_12, joker_19837_11, joker_19837_10, joker_19837_9, joker_19837_8, joker_19837_7, joker_19837_6, joker_19837_5, joker_19837_4, joker_19837_3, joker_19837_2, joker_19837_1, var_destinationEntityRelationshipMap, joker_19875_2, joker_19875_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (508)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_inverseOfInverseRelationshipName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_20008_2 ; // Joker input parameter
      GALGAS_lstring joker_20008_1 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_20046_0 ; // Joker input parameter
      var_destinationEntityRelationshipMap.method_searchKey (enumerator_19721.current_mInverseRelationshipName (HERE), joker_20008_2, joker_20008_1, var_inverseOfInverseRelationshipName, joker_20046_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (510)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_19721.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_19721.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_19721.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (512)) COMMA_SOURCE_FILE_AT_LINE (512)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (512)) COMMA_SOURCE_FILE_AT_LINE (512)) ;
      }
...
void routine_analyzePreferences (const GALGAS_entityMap constinArgument_inEntityMap,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (800)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_31412 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_31412.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_observableAttributeMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (802)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (804)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_31584 (enumerator_31412.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_31584.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_31584.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (806)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_31584.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (809)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_31787 (enumerator_31412.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_31787.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_31787.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_31787.current_mType (HERE), enumerator_31787.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (811)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_31787.current_mType (HERE), enumerator_31787.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (812)), enumerator_31787.current_mDefaultValueObjectiveCObject (HERE), enumerator_31787.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (812)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_lstring var_observationDependancyKey = GALGAS_lstring::constructor_new (GALGAS_string ("preferences/").operator_concat (enumerator_31412.current_mPreferencesName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (814)).operator_concat (GALGAS_string ("/self.") COMMA_SOURCE_FILE_AT_LINE (814)).operator_concat (enumerator_31787.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (814)) COMMA_SOURCE_FILE_AT_LINE (814)), enumerator_31787.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (813)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_31787.current_mAttributeName (HERE), enumerator_31787.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_31787.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (820)) COMMA_SOURCE_FILE_AT_LINE (820)), var_observationDependancyKey, inCompiler COMMA_SOURCE_FILE_AT_LINE (817)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependancyKey, var_observationDependancyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (823)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (830)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (GALGAS_string ("preferences/").operator_concat (enumerator_31412.current_mPreferencesName (HERE).reader_string (SOURCE_FILE_AT_LINE (832)) COMMA_SOURCE_FILE_AT_LINE (832)).operator_concat (GALGAS_string ("/self.") COMMA_SOURCE_FILE_AT_LINE (832)), enumerator_31412.current_mTransientList (HERE), GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (834)), var_observableAttributeMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (831)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observableObjectMap var_observableObjectMap = GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (841)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (843)), GALGAS_string ("self"), GALGAS_string::makeEmptyString (), var_observableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (842)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (849)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_33333 (enumerator_31412.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_33333.hasCurrentObject ()) {
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_33460_2 ; // Joker input parameter
      GALGAS_string joker_33460_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_33333.current_mOutletType (HERE), joker_33460_2, joker_33460_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (853)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (854)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_33604 (enumerator_33333.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_33604.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_33604.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (860)), var_actionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (856)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_33604.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_33333.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (867)), enumerator_33333.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (867)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (867)) ;
      enumerator_33333.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (870)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outPreferencesMap.modifier_insertKey (enumerator_31412.current_mPreferencesName (HERE), var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, enumerator_31412.current_mActionDeclarationList (HERE), var_observableAttributeMap, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (871)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outBindingOptionListForGeneration = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (912)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_35709 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_35709.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_35709.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (915)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_35898 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (917)).isValidAndTrue () ;
    if (enumerator_35898.hasCurrentObject () && bool_0) {
      while (enumerator_35898.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_35962 (enumerator_35709.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (918)).isValidAndTrue () ;
        if (enumerator_35962.hasCurrentObject () && bool_1) {
          while (enumerator_35962.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_35898.current_mType (HERE).objectCompare (enumerator_35962.current_mType (HERE))) ;
            enumerator_35962.gotoNextObject () ;
            if (enumerator_35962.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (918)).isValidAndTrue () ;
            }
          }
        }
        enumerator_35898.gotoNextObject () ;
        if (enumerator_35898.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (917)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (922)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_36201 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (924)).isValidAndTrue () ;
      if (enumerator_36201.hasCurrentObject () && bool_3) {
        while (enumerator_36201.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_36201.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (925)) COMMA_SOURCE_FILE_AT_LINE (925)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (925)) COMMA_SOURCE_FILE_AT_LINE (925)) ;
          enumerator_36201.gotoNextObject () ;
          if (enumerator_36201.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (924)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_35709.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (927)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_35709.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (929)), enumerator_35709.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (929)) ;
    enumerator_35709.gotoNextObject () ;
  }
}
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1058)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_41722 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_41722.hasCurrentObject ()) {
    ...
    GALGAS_relationshipMap var_allRelationshipMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_41932_0 ; // Joker input parameter
    GALGAS_string joker_41982_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_42030_8 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_42030_7 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_42030_6 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_42030_5 ; // Joker input parameter
    GALGAS_relationshipList joker_42030_4 ; // Joker input parameter
    GALGAS_relationshipList joker_42030_3 ; // Joker input parameter
    GALGAS_propertyMap joker_42030_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_42030_1 ; // Joker input parameter
    GALGAS_stringset joker_42066_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_42066_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_41722.current_mRootEntityName (HERE), joker_41932_0, var_rootEntityImplementationClassName, joker_41982_0, var_rootObjectObservablePropertyMap, joker_42030_8, joker_42030_7, joker_42030_6, joker_42030_5, joker_42030_4, joker_42030_3, joker_42030_2, joker_42030_1, var_allRelationshipMap, joker_42066_2, joker_42066_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1063)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observableObjectMap var_observableObjectMap = GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1074)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("root").reader_nowhere (SOURCE_FILE_AT_LINE (1076)), GALGAS_string ("mRootObject"), GALGAS_string::makeEmptyString (), var_rootObjectObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1075)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_preferencesMap enumerator_42364 (constinArgument_inPreferencesMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42364.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_42364.current (HERE).mAttribute_lkey, GALGAS_string ("g_").operator_concat (enumerator_42364.current (HERE).mAttribute_lkey.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1084)), enumerator_42364.current (HERE).mAttribute_lkey.mAttribute_string, enumerator_42364.current (HERE).mAttribute_mObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1082)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_42364.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1090)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1091)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerList enumerator_42714 (enumerator_41722.current_mControllerList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42714.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_42952_0 ; // Joker input parameter
      constinArgument_inControllerClassMap.method_searchKey (enumerator_42714.current_mControllerClassName (HERE), joker_42952_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1096)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_observablePropertyMap var_prefixedControllerObservablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1103)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_observablePropertyMap enumerator_43198 (var_controllerObservablePropertyMap, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_43198.hasCurrentObject ()) {
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_lstring var_observedKey = GALGAS_lstring::constructor_new (GALGAS_string ("document/").operator_concat (enumerator_41722.current_mDocumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1106)) COMMA_SOURCE_FILE_AT_LINE (1106)).operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (1106)).operator_concat (enumerator_42714.current_mControllerName (HERE).reader_string (SOURCE_FILE_AT_LINE (1106)) COMMA_SOURCE_FILE_AT_LINE (1106)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1106)).operator_concat (enumerator_43198.current_mObservationDependancyKey (HERE).reader_string (SOURCE_FILE_AT_LINE (1106)) COMMA_SOURCE_FILE_AT_LINE (1106)), enumerator_43198.current_mObservationDependancyKey (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1105)) ;
        { //-------- @modifierCallInstructionForGeneration
        var_prefixedControllerObservablePropertyMap.modifier_insertKey (enumerator_43198.current_lkey (HERE), enumerator_43198.current_mType (HERE), enumerator_43198.current_mPropertyDependancyList (HERE), var_observedKey, inCompiler COMMA_SOURCE_FILE_AT_LINE (1109)) ;
        } //-------- END @typeMethodInstructionForGeneration
        { //-------- @modifierCallInstructionForGeneration
        ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observedKey, var_observedKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1115)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_43198.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_42714.current_mControllerName (HERE), enumerator_42714.current_mControllerName (HERE).mAttribute_string, GALGAS_string::makeEmptyString (), var_prefixedControllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1120)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_43942_15 ; // Joker input parameter
      GALGAS_string joker_43942_14 ; // Joker input parameter
      GALGAS_string joker_43942_13 ; // Joker input parameter
      GALGAS_observablePropertyMap joker_43942_12 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_43942_11 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_43942_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_43942_9 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_43942_8 ; // Joker input parameter
      GALGAS_relationshipList joker_43942_7 ; // Joker input parameter
      GALGAS_relationshipList joker_43942_6 ; // Joker input parameter
      GALGAS_propertyMap joker_43942_5 ; // Joker input parameter
      GALGAS_relationshipMap joker_43942_4 ; // Joker input parameter
      GALGAS_relationshipMap joker_43942_3 ; // Joker input parameter
      GALGAS_stringset joker_43942_2 ; // Joker input parameter
      GALGAS__32_stringlist joker_43942_1 ; // Joker input parameter
      constinArgument_inEntityMap.method_searchKey (enumerator_42714.current_mControlledClassOrEntityName (HERE), joker_43942_15, joker_43942_14, joker_43942_13, joker_43942_12, joker_43942_11, joker_43942_10, joker_43942_9, joker_43942_8, joker_43942_7, joker_43942_6, joker_43942_5, joker_43942_4, joker_43942_3, joker_43942_2, joker_43942_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1126)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1127)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_44063 (enumerator_42714.current_mControllerBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_44063.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_44063.current_mBinding (HERE).ptr (), var_allRelationshipMap, var_controllerClassBindingMap, enumerator_42714.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1129)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_44063.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_controllerMap.modifier_insertKey (enumerator_42714.current_mControllerName (HERE), enumerator_42714.current_mControllerClassName (HERE).mAttribute_string, enumerator_42714.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, var_controllerActionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1137)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_42714.gotoNextObject () ;
    }
    //-------- @localVariableDeclarationForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1147)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (GALGAS_string ("document/").operator_concat (enumerator_41722.current_mDocumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1149)) COMMA_SOURCE_FILE_AT_LINE (1149)).operator_concat (GALGAS_string ("/self.") COMMA_SOURCE_FILE_AT_LINE (1149)), enumerator_41722.current_mTransientList (HERE), var_observableObjectMap, var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1148)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_documentActionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1158)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_45103 (enumerator_41722.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_45103.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_documentActionMap.modifier_insertKey (enumerator_45103.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1160)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_45103.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (1164)), GALGAS_string ("self"), GALGAS_string::makeEmptyString (), var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1163)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1169)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_45442 (enumerator_41722.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_45442.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_bool var_hasTableValueBinding ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_45569_2 ; // Joker input parameter
      GALGAS_string joker_45569_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_45442.current_mOutletType (HERE), joker_45569_2, joker_45569_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1173)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1174)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_45713 (enumerator_45442.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_45713.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_45713.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, var_controllerMap, var_documentActionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1176)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_45713.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_45442.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1187)), enumerator_45442.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1187)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1187)) ;
      enumerator_45442.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1190)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outDocumentMap.modifier_insertKey (enumerator_41722.current_mDocumentName (HERE), enumerator_41722.current_mRootEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (1193)), var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, enumerator_41722.current_mActionDeclarationList (HERE), var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1191)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_46856 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1212)).isValidAndTrue () ;
  if (enumerator_46856.hasCurrentObject () && bool_0) {
    while (enumerator_46856.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_46856.current_mType (HERE))) ;
      enumerator_46856.gotoNextObject () ;
      if (enumerator_46856.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1212)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1215)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (1216)) ;
  }
}
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1227)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_47341 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_47341.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1230)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_47341.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1231)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_47566_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_47625_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_47625_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_47625_2 ; // Joker input parameter
      GALGAS_stringset joker_47625_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_47341.current_mSuperClassName (HERE), joker_47566_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_47625_4, joker_47625_3, joker_47625_2, joker_47625_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1232)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1234)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1235)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1237)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_48035 (enumerator_47341.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_48035.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_48035.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_48035.current_mType (HERE), enumerator_48035.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1240)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_48035.current_mType (HERE), enumerator_48035.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1241)), enumerator_48035.current_mDefaultValueObjectiveCObject (HERE), enumerator_48035.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1241)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_48035.current_mType (HERE), enumerator_48035.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1242)), enumerator_48035.current_mDefaultValueObjectiveCObject (HERE), enumerator_48035.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1242)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("class.").operator_concat (enumerator_47341.current_mClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1244)) COMMA_SOURCE_FILE_AT_LINE (1244)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1244)).operator_concat (enumerator_48035.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1244)) COMMA_SOURCE_FILE_AT_LINE (1244)), enumerator_48035.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1243)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_48035.current_mAttributeName (HERE), enumerator_48035.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_48035.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1250)) COMMA_SOURCE_FILE_AT_LINE (1250)), var_observationDependencyKey, inCompiler COMMA_SOURCE_FILE_AT_LINE (1247)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1256)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (GALGAS_string ("class/").operator_concat (enumerator_47341.current_mClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1258)) COMMA_SOURCE_FILE_AT_LINE (1258)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1258)), enumerator_47341.current_mTransientList (HERE), GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1260)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1257)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1267)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_47341.current_mClassName (HERE), enumerator_47341.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1270)), var_observablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1268)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_47341.gotoNextObject () ;
  }
}
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1287)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_49864 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_49864.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1290)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_49961 (enumerator_49864.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_49961.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1292)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_50073 (enumerator_49961.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_50073.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_50073.current_mBindingOptionName (HERE), enumerator_50073.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1294)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_50073.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_49961.current_mBindingName (HERE), enumerator_49961.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1300)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_49961.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_49864.current_mOutletClassName (HERE), enumerator_49864.current_mGenerateCode (HERE), enumerator_49864.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, enumerator_49864.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1303)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_49864.gotoNextObject () ;
  }
}
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1319)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_50905 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_50905.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1322)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_51014 (enumerator_50905.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_51014.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_51014.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1324)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_51014.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1327)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_51166 (enumerator_50905.current_mBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_51166.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1329)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_51278 (enumerator_51166.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_51278.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_51278.current_mBindingOptionName (HERE), enumerator_51278.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1331)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_51278.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_51166.current_mBindingName (HERE), enumerator_51166.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1337)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_51166.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1340)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerObservablePropertyList enumerator_51724 (enumerator_50905.current_mControllerObservablePropertyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_51724.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_51724.current (HERE).mAttribute_mPropertyName, enumerator_51724.current (HERE).mAttribute_mType, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1349)), enumerator_51724.current (HERE).mAttribute_mPropertyName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1346)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_51724.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outControllerClassMap.modifier_insertKey (enumerator_50905.current_mOutletClassName (HERE), enumerator_50905.current_mGenerateCode (HERE), var_bindingMap, var_actionMap, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1354)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_50905.gotoNextObject () ;
  }
}
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outSortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1378)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (1379)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1380)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1381)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1382)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1387)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (outArgument_outEntityMap, constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1392)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outPreferencesMap, outArgument_outDocumentMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1399)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1409)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (1409)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = var_transientDependencyGraph.reader_graphviz (SOURCE_FILE_AT_LINE (1410)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_path = inArgument_inSourceFilePath.operator_concat (GALGAS_string (".transientDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (1411)) ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_53878_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_53878_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1412)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outTransientDependencyArcList = var_transientDependencyGraph.reader_arcs (SOURCE_FILE_AT_LINE (1415)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1416)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_transientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (1417)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_54158 (var_transientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (1418)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_54158.hasCurrentObject ()) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inAST.mAttribute_mEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_54158.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1419)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (1419)) COMMA_SOURCE_FILE_AT_LINE (1419)) ;
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstringlist joker_54416_0 ; // Joker input parameter
      GALGAS_lstringlist joker_54458_0 ; // Joker input parameter
      var_transientDependencyGraph.method_topologicalSort (outArgument_outSortedTransientOrderedList, joker_54416_0, var_unsortedTransientList, joker_54458_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1423)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1429)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1430)).reader_string (SOURCE_FILE_AT_LINE (1430)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:") COMMA_SOURCE_FILE_AT_LINE (1430)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_54688 (var_unsortedTransientList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_54688.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_54688.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1432)) COMMA_SOURCE_FILE_AT_LINE (1432)) ;
          enumerator_54688.gotoNextObject () ;
        }
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inAST.mAttribute_mEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (1434)) ;
      }
    }
  }
}
...
static GALGAS_string categoryReader_tableValueBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  while (enumerator_5620.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_6903 (enumerator_5620.current (HERE).mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_6903.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("      @").operator_concat (enumerator_6903.current_mValue_30_ (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (170)) COMMA_SOURCE_FILE_AT_LINE (170)).operator_concat (GALGAS_string (" : ") COMMA_SOURCE_FILE_AT_LINE (170)).operator_concat (enumerator_6903.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (170)).operator_concat (GALGAS_string (",\n") COMMA_SOURCE_FILE_AT_LINE (170)) COMMA_SOURCE_FILE_AT_LINE (170)) ;
...
static GALGAS_string categoryReader_regularBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator__32_stringlist enumerator_8956 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_8956.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("      @").operator_concat (enumerator_8956.current_mValue_30_ (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (210)) COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (GALGAS_string (" : ") COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (enumerator_8956.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (GALGAS_string (",\n") COMMA_SOURCE_FILE_AT_LINE (210)) COMMA_SOURCE_FILE_AT_LINE (210)) ;
...
static GALGAS_string categoryReader_tableValueBindingForGeneration_generateRemoveBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_columnBindingForTableValueBindingForGeneration enumerator_9870 (object->mAttribute_mColumnBindingForTableValueBindingForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_9870.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("  [[").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (enumerator_9870.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (GALGAS_string ("\"]\n") COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (GALGAS_string ("    unbind:@\"value\"\n") COMMA_SOURCE_FILE_AT_LINE (242)).operator_concat (GALGAS_string ("  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (243)) COMMA_SOURCE_FILE_AT_LINE (241)) ;
...
static GALGAS_string categoryReader_regularBindingForGeneration_generateRemoveBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  macroValidSharedObject (object, const cPtr_regularBindingForGeneration) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("  [").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (GALGAS_string (" unbind:@\"") COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (object->mAttribute_mBindingName COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (GALGAS_string ("\"] ;\n") COMMA_SOURCE_FILE_AT_LINE (254)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_tableValueBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inHasTableValueBinding.operator_not (SOURCE_FILE_AT_LINE (543)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mControllerName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("this outlet does not support $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (544)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_21551_0 ; // Joker input parameter
    GALGAS_actionMap joker_21624_0 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_21551_0, var_controlledClassOrEntityName, var_controllerBindingList, joker_21624_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (548)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_21725_3 ; // Joker input parameter
    GALGAS_string joker_21725_2 ; // Joker input parameter
    GALGAS_string joker_21725_1 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21788_11 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21788_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21788_9 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_21788_8 ; // Joker input parameter
    GALGAS_relationshipList joker_21788_7 ; // Joker input parameter
    GALGAS_relationshipList joker_21788_6 ; // Joker input parameter
    GALGAS_propertyMap joker_21788_5 ; // Joker input parameter
    GALGAS_relationshipMap joker_21788_4 ; // Joker input parameter
    GALGAS_relationshipMap joker_21788_3 ; // Joker input parameter
    GALGAS_stringset joker_21788_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_21788_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (GALGAS_lstring::constructor_new (var_controlledClassOrEntityName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (556)), joker_21725_3, joker_21725_2, joker_21725_1, var_observablePropertyMap, joker_21788_11, joker_21788_10, joker_21788_9, joker_21788_8, joker_21788_7, joker_21788_6, joker_21788_5, joker_21788_4, joker_21788_3, joker_21788_2, joker_21788_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (555)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_columnBindingForTableValueBindingForGeneration var_columnBindingForTableValueBindingForGeneration = GALGAS_columnBindingForTableValueBindingForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (561)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_tableValueColumnBinding enumerator_21956 (object->mAttribute_mTableValueColumnBinding, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_21956.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingType var_type ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_stringlist joker_22086_2 ; // Joker input parameter
      GALGAS_lstring joker_22086_1 ; // Joker input parameter
      var_observablePropertyMap.method_searchKey (enumerator_21956.current (HERE).mAttribute_mBoundPropertyName, var_type, joker_22086_2, joker_22086_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (564)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_requiredCellTypeInTableColumnBinding = categoryReader_requiredCellTypeInTableColumnBinding (var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (569)) ;
      //-------- @ifInstructionForGeneration
      ...
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_21956.current (HERE).mAttribute_mBoundPropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("this property cannot be named in a $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (571)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_requiredCellTypeInTableColumnBinding.objectCompare (enumerator_21956.current (HERE).mAttribute_mCellTypeName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_21956.current (HERE).mAttribute_mCellTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("this property requires a ").operator_concat (var_requiredCellTypeInTableColumnBinding COMMA_SOURCE_FILE_AT_LINE (573)).operator_concat (GALGAS_string (" cell class") COMMA_SOURCE_FILE_AT_LINE (573)) COMMA_SOURCE_FILE_AT_LINE (573)) ;
        }
      }
      //-------- @plusEqualnstructionForGeneration
      var_columnBindingForTableValueBindingForGeneration.addAssign_operation (enumerator_21956.current (HERE).mAttribute_mColumnName.mAttribute_string, var_requiredCellTypeInTableColumnBinding, enumerator_21956.current (HERE).mAttribute_mBoundPropertyName.mAttribute_string, GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (579)) COMMA_SOURCE_FILE_AT_LINE (575)) ;
      enumerator_21956.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_tableValueBindingForGeneration::constructor_new (object->mAttribute_mControllerName.mAttribute_string, var_columnBindingForTableValueBindingForGeneration COMMA_SOURCE_FILE_AT_LINE (582)) COMMA_SOURCE_FILE_AT_LINE (582)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_inActionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (602)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_actionMap var_actionMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_23674_3 ; // Joker input parameter
    GALGAS_string joker_23674_2 ; // Joker input parameter
    GALGAS_outletBindingListForGeneration joker_23674_1 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mTargetName, joker_23674_3, joker_23674_2, joker_23674_1, var_actionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (605)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
    var_actionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (606)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_runBindingForGeneration::constructor_new (object->mAttribute_mTargetName.mAttribute_string, object->mAttribute_mActionName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (608)) COMMA_SOURCE_FILE_AT_LINE (608)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (628)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  ...
  GALGAS_observablePropertyMap var_observablePropertyMap ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inObservableObjectMap.reader_hasKey (object->mAttribute_mObservedObjectName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (632)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_string var_includeFile ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inObservableObjectMap.method_searchKey (GALGAS_lstring::constructor_new (object->mAttribute_mObservedObjectName.mAttribute_string, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (635)), var_observedObjectOCName, var_includeFile, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (634)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioImplementationFileInclusionSet.addAssign_operation (var_includeFile COMMA_SOURCE_FILE_AT_LINE (640)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mObservedObjectName.reader_string (SOURCE_FILE_AT_LINE (643)) COMMA_SOURCE_FILE_AT_LINE (643)).operator_concat (GALGAS_string ("' object is not observable") COMMA_SOURCE_FILE_AT_LINE (643)) COMMA_SOURCE_FILE_AT_LINE (642)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_stringlist joker_25346_2 ; // Joker input parameter
  GALGAS_lstring joker_25346_1 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_25346_2, joker_25346_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (648)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  if (kBoolTrue == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_observablePropertyType.objectCompare (GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (652)))).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @concatInstructionForGeneration
      var_observableKeyPath.dotAssign_operation (GALGAS_string (".@count") COMMA_SOURCE_FILE_AT_LINE (653)) ;
      //-------- @assignmentInstructionForGeneration
      var_observablePropertyType = GALGAS_easyBindingType::constructor_uintegerType (SOURCE_FILE_AT_LINE (654)) ;
      ...
      inCompiler->emitSemanticError (location_4, GALGAS_string ("the 'count' path is only allowed for to-many relationships") COMMA_SOURCE_FILE_AT_LINE (656)) ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (661)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_25946 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (662)).isValidAndTrue () ;
  if (enumerator_25946.hasCurrentObject () && bool_5) {
    while (enumerator_25946.hasCurrentObject () && bool_5) {
      ...
      if (enumerator_25946.hasCurrentObject ()) {
        bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (662)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (666)).boolEnum () ;
  if (kBoolTrue == test_6) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (667)) COMMA_SOURCE_FILE_AT_LINE (667)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (667)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_26250 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (668)).isValidAndTrue () ;
    if (enumerator_26250.hasCurrentObject () && bool_7) {
      while (enumerator_26250.hasCurrentObject () && bool_7) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_26250.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (669)) COMMA_SOURCE_FILE_AT_LINE (669)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (669)) COMMA_SOURCE_FILE_AT_LINE (669)) ;
        enumerator_26250.gotoNextObject () ;
        if (enumerator_26250.hasCurrentObject ()) {
          bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (668)).isValidAndTrue () ;
        }
      }
    }
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_8, var_s COMMA_SOURCE_FILE_AT_LINE (671)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (674)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_26485 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_26485.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_26485.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (677)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_26674 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (679)).isValidAndTrue () ;
    if (enumerator_26674.hasCurrentObject () && bool_9) {
      while (enumerator_26674.hasCurrentObject () && bool_9) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_26738 (enumerator_26485.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (680)).isValidAndTrue () ;
        if (enumerator_26738.hasCurrentObject () && bool_10) {
          while (enumerator_26738.hasCurrentObject () && bool_10) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_26674.current_mType (HERE).objectCompare (enumerator_26738.current_mType (HERE))) ;
            enumerator_26738.gotoNextObject () ;
            if (enumerator_26738.hasCurrentObject ()) {
              bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (680)).isValidAndTrue () ;
            }
          }
        }
        enumerator_26674.gotoNextObject () ;
        if (enumerator_26674.hasCurrentObject ()) {
          bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (679)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_11 = var_found.operator_not (SOURCE_FILE_AT_LINE (684)).boolEnum () ;
    if (kBoolTrue == test_11) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_26977 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_12 = var_found.operator_not (SOURCE_FILE_AT_LINE (686)).isValidAndTrue () ;
      if (enumerator_26977.hasCurrentObject () && bool_12) {
        while (enumerator_26977.hasCurrentObject () && bool_12) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_26977.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (687)) COMMA_SOURCE_FILE_AT_LINE (687)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (687)) COMMA_SOURCE_FILE_AT_LINE (687)) ;
          enumerator_26977.gotoNextObject () ;
          if (enumerator_26977.hasCurrentObject ()) {
            bool_12 = var_found.operator_not (SOURCE_FILE_AT_LINE (686)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_13 (enumerator_26485.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_13, var_s COMMA_SOURCE_FILE_AT_LINE (689)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_26485.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (691)), enumerator_26485.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (691)) ;
    enumerator_26485.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (694)), var_requiredFormatter, var_observedObjectOCName, var_observableKeyPath, var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (693)) COMMA_SOURCE_FILE_AT_LINE (693)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_multiValuedBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_multiValuedBindingList enumerator_28276 (object->mAttribute_mMultiValuedBindingList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_28276.hasCurrentObject ()) {
    ...
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = constinArgument_inObservableObjectMap.reader_hasKey (enumerator_28276.current_mBoundObjectName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (723)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_string var_includeFile ;
      //-------- @methodCallInstructionForGeneration
      constinArgument_inObservableObjectMap.method_searchKey (GALGAS_lstring::constructor_new (enumerator_28276.current_mBoundObjectName (HERE).mAttribute_string, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (726)), var_observedObjectOCName, var_includeFile, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (725)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      ioArgument_ioImplementationFileInclusionSet.addAssign_operation (var_includeFile COMMA_SOURCE_FILE_AT_LINE (731)) ;
    }else if (kBoolFalse == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_28276.current_mBoundObjectName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_28276.current_mBoundObjectName (HERE).reader_string (SOURCE_FILE_AT_LINE (734)) COMMA_SOURCE_FILE_AT_LINE (734)).operator_concat (GALGAS_string ("' object is not observable") COMMA_SOURCE_FILE_AT_LINE (734)) COMMA_SOURCE_FILE_AT_LINE (733)) ;
      var_observedObjectOCName.drop () ; // Release error dropped variable
      var_observablePropertyMap.drop () ; // Release error dropped variable
    }
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_observablePropertyType ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_stringlist joker_29016_2 ; // Joker input parameter
    GALGAS_lstring joker_29016_1 ; // Joker input parameter
    var_observablePropertyMap.method_searchKey (enumerator_28276.current_mBoundPropertyName (HERE), var_observablePropertyType, joker_29016_2, joker_29016_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (739)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_observableKeyPath = enumerator_28276.current_mBoundPropertyName (HERE).mAttribute_string ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (743)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_29257 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (744)).isValidAndTrue () ;
    if (enumerator_29257.hasCurrentObject () && bool_2) {
      while (enumerator_29257.hasCurrentObject () && bool_2) {
        //-------- @assignmentInstructionForGeneration
        var_requiredFormatter = enumerator_29257.current_mRequiredFormatter (HERE) ;
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (kIsEqual, enumerator_29257.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
        enumerator_29257.gotoNextObject () ;
        if (enumerator_29257.hasCurrentObject ()) {
          bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (744)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (748)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (749)) COMMA_SOURCE_FILE_AT_LINE (749)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (749)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeAndFormatterList enumerator_29573 (var_acceptableTypeFormatterList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (750)).isValidAndTrue () ;
      if (enumerator_29573.hasCurrentObject () && bool_4) {
        while (enumerator_29573.hasCurrentObject () && bool_4) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_29573.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (751)) COMMA_SOURCE_FILE_AT_LINE (751)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (751)) COMMA_SOURCE_FILE_AT_LINE (751)) ;
          enumerator_29573.gotoNextObject () ;
          if (enumerator_29573.hasCurrentObject ()) {
            bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (750)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_5 (enumerator_28276.current_mBoundPropertyName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, var_s COMMA_SOURCE_FILE_AT_LINE (753)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (756)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = enumerator_28276.current_mNegate (HERE).boolEnum () ;
    if (kBoolTrue == test_6) {
      //-------- @plusEqualnstructionForGeneration
      var_bindingOptionList.addAssign_operation (GALGAS_string ("NSValueTransformerName"), GALGAS_string ("NSNegateBooleanTransformerName") COMMA_SOURCE_FILE_AT_LINE (758)) ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletBindingOptionList enumerator_29938 (enumerator_28276.current_mOutletBindingOptionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_29938.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingTypeList var_acceptableTypeList ;
      //-------- @methodCallInstructionForGeneration
      var_outletClassBindingOptionMap.method_searchKey (enumerator_29938.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (762)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_bool var_found = GALGAS_bool (false) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_30135 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (764)).isValidAndTrue () ;
      if (enumerator_30135.hasCurrentObject () && bool_7) {
        while (enumerator_30135.hasCurrentObject () && bool_7) {
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeList enumerator_30201 (enumerator_29938.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (765)).isValidAndTrue () ;
          if (enumerator_30201.hasCurrentObject () && bool_8) {
            while (enumerator_30201.hasCurrentObject () && bool_8) {
              //-------- @assignmentInstructionForGeneration
              var_found = GALGAS_bool (kIsEqual, enumerator_30135.current_mType (HERE).objectCompare (enumerator_30201.current_mType (HERE))) ;
              enumerator_30201.gotoNextObject () ;
              if (enumerator_30201.hasCurrentObject ()) {
                bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (765)).isValidAndTrue () ;
              }
            }
          }
          enumerator_30135.gotoNextObject () ;
          if (enumerator_30135.hasCurrentObject ()) {
            bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (764)).isValidAndTrue () ;
          }
        }
      }
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (769)).boolEnum () ;
      if (kBoolTrue == test_9) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_30452 (var_acceptableTypeList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (771)).isValidAndTrue () ;
        if (enumerator_30452.hasCurrentObject () && bool_10) {
          while (enumerator_30452.hasCurrentObject () && bool_10) {
            //-------- @concatInstructionForGeneration
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  - '").operator_concat (categoryReader_ebTypeName (enumerator_30452.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (772)) COMMA_SOURCE_FILE_AT_LINE (772)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (772)) COMMA_SOURCE_FILE_AT_LINE (772)) ;
            enumerator_30452.gotoNextObject () ;
            if (enumerator_30452.hasCurrentObject ()) {
              bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (771)).isValidAndTrue () ;
            }
          }
        }
        //-------- @errorInstructionForGeneration
        GALGAS_location location_11 (enumerator_29938.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_11, var_s COMMA_SOURCE_FILE_AT_LINE (774)) ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_bindingOptionList.addAssign_operation (enumerator_29938.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (776)), enumerator_29938.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (776)) ;
      enumerator_29938.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (var_generatedBindingName, var_requiredFormatter, var_observedObjectOCName, var_observableKeyPath, var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (778)) COMMA_SOURCE_FILE_AT_LINE (778)) ;
    //-------- @incrementInstructionForGeneration
    var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (786)) ;
    //-------- @assignmentInstructionForGeneration
    var_generatedBindingName = object->mAttribute_mBindingName.mAttribute_string.operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (787)) COMMA_SOURCE_FILE_AT_LINE (787)) ;
...
GALGAS_string categoryReader_ebTypeIdentifier (const GALGAS_easyBindingType & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inClassOrEntityName COMMA_SOURCE_FILE_AT_LINE (901)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (901)) ;
      } break ;
    }
  }
//---
...
static void categoryMethod_multiValuedBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement the $").operator_concat (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (952)) COMMA_SOURCE_FILE_AT_LINE (952)).operator_concat (GALGAS_string (" binding") COMMA_SOURCE_FILE_AT_LINE (952)) COMMA_SOURCE_FILE_AT_LINE (952)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_tableValueBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (964)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $run action") COMMA_SOURCE_FILE_AT_LINE (976)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @assignmentInstructionForGeneration
    var_resultingObservedPropertyPath = GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (992)) COMMA_SOURCE_FILE_AT_LINE (992)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("observed object should be 'root'") COMMA_SOURCE_FILE_AT_LINE (994)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1000)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_stringlist joker_39474_2 ; // Joker input parameter
    GALGAS_lstring joker_39474_1 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_39474_2, joker_39474_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1002)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1003)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1004)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_39771_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_39771_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_39771_2, joker_39771_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1007)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1009)) COMMA_SOURCE_FILE_AT_LINE (1009)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1009)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1011)) COMMA_SOURCE_FILE_AT_LINE (1011)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1011)) ;
      }
    }else if (kBoolFalse == test_3) {
      //-------- @errorInstructionForGeneration
      ...
      inCompiler->emitSemanticError (location_5, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (1014)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1020)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_40402 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (1023)).isValidAndTrue () ;
  if (enumerator_40402.hasCurrentObject () && bool_6) {
    while (enumerator_40402.hasCurrentObject () && bool_6) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_40402.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1024)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (1025)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1025)) COMMA_SOURCE_FILE_AT_LINE (1025)) ;
      //-------- @assignmentInstructionForGeneration
      ...
      if (enumerator_40402.hasCurrentObject ()) {
        bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (1023)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (1028)).boolEnum () ;
  if (kBoolTrue == test_7) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_8 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_8, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (1030)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (1030)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (1030)) COMMA_SOURCE_FILE_AT_LINE (1029)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1033)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (1040)), var_resultingObservedObjectName, var_resultingObservedPropertyPath, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1038)) COMMA_SOURCE_FILE_AT_LINE (1038)) ;
}
//---------------------------------------------------------------------------*
