...
//                    november 16th, 2012, at 23h12'47"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_analyzeEntity (const GALGAS_entityList_2E_element constinArgument_inEntity,
  ...
  GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (358)) ;
  //-------- @localVariableDeclarationForGeneration
  ...
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, constinArgument_inEntity.mAttribute_mSuperEntityName.reader_string (SOURCE_FILE_AT_LINE (363)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_14912_0 ; // Joker input parameter
    GALGAS_string joker_14957_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_15034_4 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_15034_3 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_15034_2 ; // Joker input parameter
    GALGAS_relationshipList joker_15034_1 ; // Joker input parameter
    GALGAS_relationshipMap joker_15093_0 ; // Joker input parameter
    GALGAS_stringset joker_15128_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_15128_1 ; // Joker input parameter
    ioArgument_ioEntityMap.method_searchKey (constinArgument_inEntity.mAttribute_mSuperEntityName, joker_14912_0, var_implementationSuperClassName, joker_14957_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_15034_4, joker_15034_3, joker_15034_2, joker_15034_1, var_allRelationshipList, var_allPropertyMap, joker_15093_0, var_allRelationshipMap, joker_15128_2, joker_15128_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (364)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @assignmentInstructionForGeneration
    var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (379)) ;
    //-------- @assignmentInstructionForGeneration
    var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (380)) ;
    //-------- @assignmentInstructionForGeneration
    var_implementationSuperClassName = GALGAS_string::makeEmptyString () ;
    //-------- @assignmentInstructionForGeneration
    var_allRelationshipList = GALGAS_relationshipList::constructor_emptyList (SOURCE_FILE_AT_LINE (382)) ;
    //-------- @assignmentInstructionForGeneration
    var_allPropertyMap = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (383)) ;
    //-------- @assignmentInstructionForGeneration
    var_allRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (384)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (386)) ;
  ...
  cEnumerator_attributeList enumerator_15803 (constinArgument_inEntity.mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_15803.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_checkDefaultValueType (enumerator_15803.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_15803.current_mType (HERE), enumerator_15803.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (390)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_allPropertyMap.modifier_insertKey (enumerator_15803.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (391)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_attributeListForImplementation.addAssign_operation (enumerator_15803.current_mType (HERE), enumerator_15803.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (392)), enumerator_15803.current_mDefaultValueObjectiveCObject (HERE), enumerator_15803.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (392)) ;
    //-------- @plusEqualnstructionForGeneration
    var_propertyListForInitMethodHeader.addAssign_operation (enumerator_15803.current_mType (HERE), enumerator_15803.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (393)), enumerator_15803.current_mDefaultValueObjectiveCObject (HERE), enumerator_15803.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (393)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("entity.").operator_concat (constinArgument_inEntity.mAttribute_mEntityName.reader_string (SOURCE_FILE_AT_LINE (395)) COMMA_SOURCE_FILE_AT_LINE (395)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (395)).operator_concat (enumerator_15803.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (395)) COMMA_SOURCE_FILE_AT_LINE (395)), enumerator_15803.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (394)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_15803.current_mAttributeName (HERE), enumerator_15803.current_mType (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (398)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (403)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_15803.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_relationshipMap var_currentRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (409)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_relationshipList enumerator_16789 (constinArgument_inEntity.mAttribute_mRelationshipList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_16789.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_allRelationshipMap.modifier_insertKey (enumerator_16789.current_mRelationshipName (HERE), enumerator_16789.current_mIsToMany (HERE), enumerator_16789.current_mDestinationEntityName (HERE), enumerator_16789.current_mInverseRelationshipName (HERE), enumerator_16789.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (411)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_currentRelationshipMap.modifier_insertKey (enumerator_16789.current_mRelationshipName (HERE), enumerator_16789.current_mIsToMany (HERE), enumerator_16789.current_mDestinationEntityName (HERE), enumerator_16789.current_mInverseRelationshipName (HERE), enumerator_16789.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (418)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_allPropertyMap.modifier_insertKey (enumerator_16789.current_mRelationshipName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (425)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("entity.").operator_concat (constinArgument_inEntity.mAttribute_mEntityName.reader_string (SOURCE_FILE_AT_LINE (427)) COMMA_SOURCE_FILE_AT_LINE (427)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (427)).operator_concat (enumerator_16789.current_mRelationshipName (HERE).reader_string (SOURCE_FILE_AT_LINE (427)) COMMA_SOURCE_FILE_AT_LINE (427)), enumerator_16789.current_mRelationshipName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (426)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_16789.current_mRelationshipName (HERE), GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (432)), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (430)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (435)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_16789.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (441)) ;
  //-------- @localVariableDeclarationForGeneration
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeTransientProperties (constinArgument_inPreferencesMap, GALGAS_string ("entity.").operator_concat (constinArgument_inEntity.mAttribute_mEntityName.reader_string (SOURCE_FILE_AT_LINE (445)) COMMA_SOURCE_FILE_AT_LINE (445)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (445)), constinArgument_inEntity.mAttribute_mTransientList, GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (447)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (443)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS__32_stringlist var_toManyRelationshipList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (454)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_relationshipList enumerator_18299 (constinArgument_inEntity.mAttribute_mRelationshipList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_18299.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = enumerator_18299.current_mIsToMany (HERE).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @plusEqualnstructionForGeneration
      var_toManyRelationshipList.addAssign_operation (enumerator_18299.current_mRelationshipName (HERE).mAttribute_string, enumerator_18299.current_mDestinationEntityName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (457)) ;
    }
    enumerator_18299.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (463)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioEntityMap.modifier_insertKey (constinArgument_inEntity.mAttribute_mEntityName, constinArgument_inEntity.mAttribute_mSuperEntityName.mAttribute_string, constinArgument_inEntity.mAttribute_mImplementationClassName.mAttribute_string, var_implementationSuperClassName, var_observablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, constinArgument_inEntity.mAttribute_mRelationshipList, var_allRelationshipList.operator_concat (constinArgument_inEntity.mAttribute_mRelationshipList COMMA_SOURCE_FILE_AT_LINE (475)), var_allPropertyMap, var_currentRelationshipMap, var_allRelationshipMap, var_implementationFileInclusionSet, var_toManyRelationshipList, inCompiler COMMA_SOURCE_FILE_AT_LINE (464)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_analyzeEntities (const GALGAS_entityList constinArgument_inEntityList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outEntityMap = GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (493)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityList enumerator_19569 (constinArgument_inEntityList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_19569.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeEntity (enumerator_19569.current (HERE), outArgument_outEntityMap, constinArgument_inPreferencesMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (495)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_19569.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityMap enumerator_19778 (outArgument_outEntityMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_19778.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipMap enumerator_19817 (enumerator_19778.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_19817.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_19933_12 ; // Joker input parameter
      GALGAS_string joker_19933_11 ; // Joker input parameter
      GALGAS_string joker_19933_10 ; // Joker input parameter
      GALGAS_observablePropertyMap joker_19933_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_19933_8 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_19933_7 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_19933_6 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_19933_5 ; // Joker input parameter
      GALGAS_relationshipList joker_19933_4 ; // Joker input parameter
      GALGAS_relationshipList joker_19933_3 ; // Joker input parameter
      GALGAS_propertyMap joker_19933_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_19933_1 ; // Joker input parameter
      GALGAS_stringset joker_19971_2 ; // Joker input parameter
      GALGAS__32_stringlist joker_19971_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_19817.current_mDestinationEntityName (HERE), joker_19933_12, joker_19933_11, joker_19933_10, joker_19933_9, joker_19933_8, joker_19933_7, joker_19933_6, joker_19933_5, joker_19933_4, joker_19933_3, joker_19933_2, joker_19933_1, var_destinationEntityRelationshipMap, joker_19971_2, joker_19971_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (506)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_inverseOfInverseRelationshipName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_20104_2 ; // Joker input parameter
      GALGAS_lstring joker_20104_1 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_20142_0 ; // Joker input parameter
      var_destinationEntityRelationshipMap.method_searchKey (enumerator_19817.current_mInverseRelationshipName (HERE), joker_20104_2, joker_20104_1, var_inverseOfInverseRelationshipName, joker_20142_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (508)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_19817.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_1 (enumerator_19817.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_1, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_19817.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (510)) COMMA_SOURCE_FILE_AT_LINE (510)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (510)) COMMA_SOURCE_FILE_AT_LINE (510)) ;
      }
      enumerator_19817.gotoNextObject () ;
    }
    enumerator_19778.gotoNextObject () ;
  }
}
...
void routine_analyzePreference (const GALGAS_preferencesDeclarationList_2E_element constinArgument_inPreference,
                                ...
                                COMMA_UNUSED_LOCATION_ARGS) {
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (799)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_31555 (constinArgument_inPreference.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_31555.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_actionMap.modifier_insertKey (enumerator_31555.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (801)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_31555.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (805)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeList enumerator_31857 (constinArgument_inPreference.mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_31857.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_checkDefaultValueType (enumerator_31857.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_31857.current_mType (HERE), enumerator_31857.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (807)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_attributeListForImplementation.addAssign_operation (enumerator_31857.current_mType (HERE), enumerator_31857.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (808)), enumerator_31857.current_mDefaultValueObjectiveCObject (HERE), enumerator_31857.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (808)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependancyKey = GALGAS_lstring::constructor_new (GALGAS_string ("preference.").operator_concat (constinArgument_inPreference.mAttribute_mPreferencesName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (810)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (810)).operator_concat (enumerator_31857.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (810)) COMMA_SOURCE_FILE_AT_LINE (810)), enumerator_31857.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (809)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableAttributeMap.modifier_insertKey (enumerator_31857.current_mAttributeName (HERE), enumerator_31857.current_mType (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (813)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependancyKey, var_observationDependancyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (818)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_31857.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (825)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeTransientProperties (GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (827)), GALGAS_string ("preference.").operator_concat (constinArgument_inPreference.mAttribute_mPreferencesName.reader_string (SOURCE_FILE_AT_LINE (828)) COMMA_SOURCE_FILE_AT_LINE (828)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (828)), constinArgument_inPreference.mAttribute_mTransientList, GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (830)), var_observableAttributeMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (826)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observableObjectMap var_observableObjectMap = GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (837)) ;
  { //-------- @modifierCallInstructionForGeneration
  var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (839)), GALGAS_string ("self"), constinArgument_inPreference.mAttribute_mPreferencesName.mAttribute_string, GALGAS_string::makeEmptyString (), var_observableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (838)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (846)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletDeclarationList enumerator_33486 (constinArgument_inPreference.mAttribute_mOutletDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_33486.hasCurrentObject ()) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_33607_2 ; // Joker input parameter
    GALGAS_string joker_33607_1 ; // Joker input parameter
    constinArgument_inOutletClassMap.method_searchKey (enumerator_33486.current_mOutletType (HERE), joker_33607_2, joker_33607_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (850)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (851)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_33747 (enumerator_33486.current_mOutletBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_33747.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_33747.current_mBinding (HERE).ptr (), GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (854)), var_observableObjectMap, var_bindingMap, GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (857)), var_actionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (853)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_33747.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_outletGenerationList.addAssign_operation (enumerator_33486.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (864)), enumerator_33486.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (864)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (864)) ;
    enumerator_33486.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
  var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (867)) ;
  } //-------- END @typeMethodInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioPreferencesMap.modifier_insertKey (constinArgument_inPreference.mAttribute_mPreferencesName, var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, constinArgument_inPreference.mAttribute_mActionDeclarationList, var_observableAttributeMap, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (868)) ;
  } //-------- END @typeMethodInstructionForGeneration
}
...
void routine_analyzePreferences (const GALGAS_preferencesDeclarationList constinArgument_inPreferencesList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (887)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_34952 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_34952.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzePreference (enumerator_34952.current (HERE), constinArgument_inOutletClassMap, outArgument_outPreferencesMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (889)) ;
    } //-------- @routineCallInstructionForGeneration
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outBindingOptionListForGeneration = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (927)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_36430 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_36430.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_36430.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (930)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_36619 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (932)).isValidAndTrue () ;
    if (enumerator_36619.hasCurrentObject () && bool_0) {
      while (enumerator_36619.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_36683 (enumerator_36430.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (933)).isValidAndTrue () ;
        if (enumerator_36683.hasCurrentObject () && bool_1) {
          while (enumerator_36683.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_36619.current_mType (HERE).objectCompare (enumerator_36683.current_mType (HERE))) ;
            enumerator_36683.gotoNextObject () ;
            if (enumerator_36683.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (933)).isValidAndTrue () ;
            }
          }
        }
        enumerator_36619.gotoNextObject () ;
        if (enumerator_36619.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (932)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (937)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_36922 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (939)).isValidAndTrue () ;
      if (enumerator_36922.hasCurrentObject () && bool_3) {
        while (enumerator_36922.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_36922.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (940)) COMMA_SOURCE_FILE_AT_LINE (940)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (940)) COMMA_SOURCE_FILE_AT_LINE (940)) ;
          enumerator_36922.gotoNextObject () ;
          if (enumerator_36922.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (939)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_36430.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (942)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_36430.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (944)), enumerator_36430.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (944)) ;
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1073)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_42442 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_42442.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    ...
    GALGAS_relationshipMap var_allRelationshipMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_42652_0 ; // Joker input parameter
    GALGAS_string joker_42702_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_42750_8 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_42750_7 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_42750_6 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_42750_5 ; // Joker input parameter
    GALGAS_relationshipList joker_42750_4 ; // Joker input parameter
    GALGAS_relationshipList joker_42750_3 ; // Joker input parameter
    GALGAS_propertyMap joker_42750_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_42750_1 ; // Joker input parameter
    GALGAS_stringset joker_42786_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_42786_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_42442.current_mRootEntityName (HERE), joker_42652_0, var_rootEntityImplementationClassName, joker_42702_0, var_rootObjectObservablePropertyMap, joker_42750_8, joker_42750_7, joker_42750_6, joker_42750_5, joker_42750_4, joker_42750_3, joker_42750_2, joker_42750_1, var_allRelationshipMap, joker_42786_2, joker_42786_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1078)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observableObjectMap var_observableObjectMap = GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1089)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("root").reader_nowhere (SOURCE_FILE_AT_LINE (1091)), GALGAS_string ("mRootObject"), enumerator_42442.current_mRootEntityName (HERE).mAttribute_string, GALGAS_string::makeEmptyString (), var_rootObjectObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1090)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_preferencesMap enumerator_43115 (constinArgument_inPreferencesMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_43115.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_43115.current (HERE).mAttribute_lkey, GALGAS_string ("g_").operator_concat (enumerator_43115.current (HERE).mAttribute_lkey.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1100)), enumerator_43115.current (HERE).mAttribute_lkey.mAttribute_string, enumerator_43115.current (HERE).mAttribute_lkey.mAttribute_string, enumerator_43115.current (HERE).mAttribute_mObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1098)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_43115.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1107)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1108)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerList enumerator_43493 (enumerator_42442.current_mControllerList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_43493.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_43731_0 ; // Joker input parameter
      constinArgument_inControllerClassMap.method_searchKey (enumerator_43493.current_mControllerClassName (HERE), joker_43731_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1113)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_observablePropertyMap var_prefixedControllerObservablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1120)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_observablePropertyMap enumerator_43977 (var_controllerObservablePropertyMap, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_43977.hasCurrentObject ()) {
        enumerator_43977.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_43493.current_mControllerName (HERE), enumerator_43493.current_mControllerName (HERE).mAttribute_string, GALGAS_string ("\?"), GALGAS_string::makeEmptyString (), var_prefixedControllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1137)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_44748_15 ; // Joker input parameter
      GALGAS_string joker_44748_14 ; // Joker input parameter
      GALGAS_string joker_44748_13 ; // Joker input parameter
      GALGAS_observablePropertyMap joker_44748_12 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_44748_11 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_44748_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_44748_9 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_44748_8 ; // Joker input parameter
      GALGAS_relationshipList joker_44748_7 ; // Joker input parameter
      GALGAS_relationshipList joker_44748_6 ; // Joker input parameter
      GALGAS_propertyMap joker_44748_5 ; // Joker input parameter
      GALGAS_relationshipMap joker_44748_4 ; // Joker input parameter
      GALGAS_relationshipMap joker_44748_3 ; // Joker input parameter
      GALGAS_stringset joker_44748_2 ; // Joker input parameter
      GALGAS__32_stringlist joker_44748_1 ; // Joker input parameter
      constinArgument_inEntityMap.method_searchKey (enumerator_43493.current_mControlledClassOrEntityName (HERE), joker_44748_15, joker_44748_14, joker_44748_13, joker_44748_12, joker_44748_11, joker_44748_10, joker_44748_9, joker_44748_8, joker_44748_7, joker_44748_6, joker_44748_5, joker_44748_4, joker_44748_3, joker_44748_2, joker_44748_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1144)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1145)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_44869 (enumerator_43493.current_mControllerBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_44869.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_44869.current_mBinding (HERE).ptr (), var_allRelationshipMap, var_controllerClassBindingMap, enumerator_43493.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1147)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_44869.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_controllerMap.modifier_insertKey (enumerator_43493.current_mControllerName (HERE), enumerator_43493.current_mControllerClassName (HERE).mAttribute_string, enumerator_43493.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, var_controllerActionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1155)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_43493.gotoNextObject () ;
    }
    //-------- @localVariableDeclarationForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1167)), GALGAS_string ("document/").operator_concat (enumerator_42442.current_mDocumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1168)) COMMA_SOURCE_FILE_AT_LINE (1168)).operator_concat (GALGAS_string ("/self.") COMMA_SOURCE_FILE_AT_LINE (1168)), enumerator_42442.current_mTransientList (HERE), var_observableObjectMap, var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1166)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_documentActionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1177)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_45943 (enumerator_42442.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_45943.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_documentActionMap.modifier_insertKey (enumerator_45943.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1179)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_45943.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (1183)), GALGAS_string ("self"), enumerator_42442.current_mDocumentName (HERE).mAttribute_string, GALGAS_string::makeEmptyString (), var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1182)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1189)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_46311 (enumerator_42442.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_46311.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_bool var_hasTableValueBinding ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_46438_2 ; // Joker input parameter
      GALGAS_string joker_46438_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_46311.current_mOutletType (HERE), joker_46438_2, joker_46438_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1193)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1194)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_46582 (enumerator_46311.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_46582.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_46582.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, var_controllerMap, var_documentActionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1196)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_46582.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_46311.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1207)), enumerator_46311.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1207)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1207)) ;
      enumerator_46311.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1210)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outDocumentMap.modifier_insertKey (enumerator_42442.current_mDocumentName (HERE), enumerator_42442.current_mRootEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (1213)), var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, enumerator_42442.current_mActionDeclarationList (HERE), var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1211)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_42442.gotoNextObject () ;
  }
}
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_47725 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1232)).isValidAndTrue () ;
  if (enumerator_47725.hasCurrentObject () && bool_0) {
    while (enumerator_47725.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_47725.current_mType (HERE))) ;
      enumerator_47725.gotoNextObject () ;
      if (enumerator_47725.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1232)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1235)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (1236)) ;
  }
}
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1247)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_48210 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_48210.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1250)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_48210.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1251)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_48435_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_48494_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_48494_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_48494_2 ; // Joker input parameter
      GALGAS_stringset joker_48494_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_48210.current_mSuperClassName (HERE), joker_48435_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_48494_4, joker_48494_3, joker_48494_2, joker_48494_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1252)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1254)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1255)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1257)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_48904 (enumerator_48210.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_48904.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_48904.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_48904.current_mType (HERE), enumerator_48904.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1260)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_48904.current_mType (HERE), enumerator_48904.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1261)), enumerator_48904.current_mDefaultValueObjectiveCObject (HERE), enumerator_48904.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1261)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_48904.current_mType (HERE), enumerator_48904.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1262)), enumerator_48904.current_mDefaultValueObjectiveCObject (HERE), enumerator_48904.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1262)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("class/").operator_concat (enumerator_48210.current_mClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1264)) COMMA_SOURCE_FILE_AT_LINE (1264)).operator_concat (GALGAS_string ("/self.") COMMA_SOURCE_FILE_AT_LINE (1264)).operator_concat (enumerator_48904.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1264)) COMMA_SOURCE_FILE_AT_LINE (1264)), enumerator_48904.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1263)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_48904.current_mAttributeName (HERE), enumerator_48904.current_mType (HERE), GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1267)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1272)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_48904.gotoNextObject () ;
    }
    //-------- @localVariableDeclarationForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1279)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1281)), GALGAS_string ("class/").operator_concat (enumerator_48210.current_mClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1282)) COMMA_SOURCE_FILE_AT_LINE (1282)).operator_concat (GALGAS_string ("/self.") COMMA_SOURCE_FILE_AT_LINE (1282)), enumerator_48210.current_mTransientList (HERE), GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1284)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1280)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1291)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_48210.current_mClassName (HERE), enumerator_48210.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1294)), var_observablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1292)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1311)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_50846 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_50846.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1314)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_50943 (enumerator_50846.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_50943.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1316)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_51055 (enumerator_50943.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_51055.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_51055.current_mBindingOptionName (HERE), enumerator_51055.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1318)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_51055.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_50943.current_mBindingName (HERE), enumerator_50943.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1324)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_50943.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_50846.current_mOutletClassName (HERE), enumerator_50846.current_mGenerateCode (HERE), enumerator_50846.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, enumerator_50846.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1327)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_50846.gotoNextObject () ;
  }
}
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1343)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_51887 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_51887.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1346)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_51996 (enumerator_51887.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_51996.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_51996.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1348)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_51996.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1351)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_52148 (enumerator_51887.current_mBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_52148.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1353)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_52260 (enumerator_52148.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_52260.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_52260.current_mBindingOptionName (HERE), enumerator_52260.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1355)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_52260.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_52148.current_mBindingName (HERE), enumerator_52148.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1361)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_52148.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerObservablePropertyList enumerator_52706 (enumerator_51887.current_mControllerObservablePropertyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_52706.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_52706.current (HERE).mAttribute_mPropertyName, enumerator_52706.current (HERE).mAttribute_mType, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (1370)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_52706.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outControllerClassMap.modifier_insertKey (enumerator_51887.current_mOutletClassName (HERE), enumerator_51887.current_mGenerateCode (HERE), var_bindingMap, var_actionMap, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1377)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_51887.gotoNextObject () ;
  }
}
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outSortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1401)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (1402)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1403)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1404)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1405)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1411)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1416)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outPreferencesMap, outArgument_outDocumentMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1422)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1432)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (1432)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = var_transientDependencyGraph.reader_graphviz (SOURCE_FILE_AT_LINE (1433)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_path = inArgument_inSourceFilePath.operator_concat (GALGAS_string (".transientDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (1434)) ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_54833_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_54833_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1435)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outTransientDependencyArcList = var_transientDependencyGraph.reader_arcs (SOURCE_FILE_AT_LINE (1438)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1439)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_transientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (1440)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_55113 (var_transientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (1441)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_55113.hasCurrentObject ()) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inAST.mAttribute_mEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_55113.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1442)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (1442)) COMMA_SOURCE_FILE_AT_LINE (1442)) ;
        enumerator_55113.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_2) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_stringlist var_unsortedTransientList ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstringlist joker_55371_0 ; // Joker input parameter
      GALGAS_lstringlist joker_55413_0 ; // Joker input parameter
      var_transientDependencyGraph.method_topologicalSort (outArgument_outSortedTransientOrderedList, joker_55371_0, var_unsortedTransientList, joker_55413_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1446)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1452)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1453)).reader_string (SOURCE_FILE_AT_LINE (1453)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:") COMMA_SOURCE_FILE_AT_LINE (1453)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_55643 (var_unsortedTransientList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_55643.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_55643.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1455)) COMMA_SOURCE_FILE_AT_LINE (1455)) ;
          enumerator_55643.gotoNextObject () ;
        }
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inAST.mAttribute_mEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (1457)) ;
      }
    }
  }
}
...
static void categoryMethod_tableValueBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inHasTableValueBinding.operator_not (SOURCE_FILE_AT_LINE (541)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mControllerName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("this outlet does not support $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (542)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_21647_0 ; // Joker input parameter
    GALGAS_actionMap joker_21720_0 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_21647_0, var_controlledClassOrEntityName, var_controllerBindingList, joker_21720_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (546)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_21821_3 ; // Joker input parameter
    GALGAS_string joker_21821_2 ; // Joker input parameter
    GALGAS_string joker_21821_1 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21884_11 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21884_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21884_9 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_21884_8 ; // Joker input parameter
    GALGAS_relationshipList joker_21884_7 ; // Joker input parameter
    GALGAS_relationshipList joker_21884_6 ; // Joker input parameter
    GALGAS_propertyMap joker_21884_5 ; // Joker input parameter
    GALGAS_relationshipMap joker_21884_4 ; // Joker input parameter
    GALGAS_relationshipMap joker_21884_3 ; // Joker input parameter
    GALGAS_stringset joker_21884_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_21884_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (GALGAS_lstring::constructor_new (var_controlledClassOrEntityName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (554)), joker_21821_3, joker_21821_2, joker_21821_1, var_observablePropertyMap, joker_21884_11, joker_21884_10, joker_21884_9, joker_21884_8, joker_21884_7, joker_21884_6, joker_21884_5, joker_21884_4, joker_21884_3, joker_21884_2, joker_21884_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (553)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_columnBindingForTableValueBindingForGeneration var_columnBindingForTableValueBindingForGeneration = GALGAS_columnBindingForTableValueBindingForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (559)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_tableValueColumnBinding enumerator_22052 (object->mAttribute_mTableValueColumnBinding, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_22052.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingType var_type ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_22169_0 ; // Joker input parameter
      var_observablePropertyMap.method_searchKey (enumerator_22052.current (HERE).mAttribute_mBoundPropertyName, var_type, joker_22169_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (561)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_requiredCellTypeInTableColumnBinding = categoryReader_requiredCellTypeInTableColumnBinding (var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (566)) ;
      //-------- @ifInstructionForGeneration
      ...
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_22052.current (HERE).mAttribute_mBoundPropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("this property cannot be named in a $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (568)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_requiredCellTypeInTableColumnBinding.objectCompare (enumerator_22052.current (HERE).mAttribute_mCellTypeName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_22052.current (HERE).mAttribute_mCellTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("this property requires a ").operator_concat (var_requiredCellTypeInTableColumnBinding COMMA_SOURCE_FILE_AT_LINE (570)).operator_concat (GALGAS_string (" cell class") COMMA_SOURCE_FILE_AT_LINE (570)) COMMA_SOURCE_FILE_AT_LINE (570)) ;
        }
      }
      //-------- @plusEqualnstructionForGeneration
      var_columnBindingForTableValueBindingForGeneration.addAssign_operation (enumerator_22052.current (HERE).mAttribute_mColumnName.mAttribute_string, var_requiredCellTypeInTableColumnBinding, enumerator_22052.current (HERE).mAttribute_mBoundPropertyName.mAttribute_string, GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (576)) COMMA_SOURCE_FILE_AT_LINE (572)) ;
      enumerator_22052.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_tableValueBindingForGeneration::constructor_new (object->mAttribute_mControllerName.mAttribute_string, var_columnBindingForTableValueBindingForGeneration COMMA_SOURCE_FILE_AT_LINE (579)) COMMA_SOURCE_FILE_AT_LINE (579)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_inActionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (599)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_actionMap var_actionMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_23756_3 ; // Joker input parameter
    GALGAS_string joker_23756_2 ; // Joker input parameter
    GALGAS_outletBindingListForGeneration joker_23756_1 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mTargetName, joker_23756_3, joker_23756_2, joker_23756_1, var_actionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (602)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
    var_actionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (603)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_runBindingForGeneration::constructor_new (object->mAttribute_mTargetName.mAttribute_string, object->mAttribute_mActionName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (605)) COMMA_SOURCE_FILE_AT_LINE (605)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_25017_0 ; // Joker input parameter
    constinArgument_inObservableObjectMap.method_searchKey (GALGAS_lstring::constructor_new (object->mAttribute_mObservedObjectName.mAttribute_string, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (632)), var_observedObjectOCName, joker_25017_0, var_includeFile, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (631)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_25437_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_25437_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (646)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_26036 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (660)).isValidAndTrue () ;
  if (enumerator_26036.hasCurrentObject () && bool_5) {
    while (enumerator_26036.hasCurrentObject () && bool_5) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_26036.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_26036.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_26036.gotoNextObject () ;
      if (enumerator_26036.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_6) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_26340 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (666)).isValidAndTrue () ;
    if (enumerator_26340.hasCurrentObject () && bool_7) {
      while (enumerator_26340.hasCurrentObject () && bool_7) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_26340.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (667)) COMMA_SOURCE_FILE_AT_LINE (667)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (667)) COMMA_SOURCE_FILE_AT_LINE (667)) ;
        enumerator_26340.gotoNextObject () ;
        if (enumerator_26340.hasCurrentObject ()) {
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_26575 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_26575.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_26575.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (675)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_26764 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (677)).isValidAndTrue () ;
    if (enumerator_26764.hasCurrentObject () && bool_9) {
      while (enumerator_26764.hasCurrentObject () && bool_9) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_26828 (enumerator_26575.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (678)).isValidAndTrue () ;
        if (enumerator_26828.hasCurrentObject () && bool_10) {
          while (enumerator_26828.hasCurrentObject () && bool_10) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_26764.current_mType (HERE).objectCompare (enumerator_26828.current_mType (HERE))) ;
            enumerator_26828.gotoNextObject () ;
            if (enumerator_26828.hasCurrentObject ()) {
              bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (678)).isValidAndTrue () ;
            }
          }
        }
        enumerator_26764.gotoNextObject () ;
        if (enumerator_26764.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_11) {
      ...
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_27067 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_12 = var_found.operator_not (SOURCE_FILE_AT_LINE (684)).isValidAndTrue () ;
      if (enumerator_27067.hasCurrentObject () && bool_12) {
        while (enumerator_27067.hasCurrentObject () && bool_12) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_27067.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (685)) COMMA_SOURCE_FILE_AT_LINE (685)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (685)) COMMA_SOURCE_FILE_AT_LINE (685)) ;
          enumerator_27067.gotoNextObject () ;
          if (enumerator_27067.hasCurrentObject ()) {
            bool_12 = var_found.operator_not (SOURCE_FILE_AT_LINE (684)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_13 (enumerator_26575.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_13, var_s COMMA_SOURCE_FILE_AT_LINE (687)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_26575.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (689)), enumerator_26575.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (689)) ;
    enumerator_26575.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_multiValuedBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_easyBindingTypeAndFormatterList var_acceptableTypeFormatterList ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (714)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_multiValuedBindingList enumerator_28366 (object->mAttribute_mMultiValuedBindingList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_28366.hasCurrentObject ()) {
    ...
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = constinArgument_inObservableObjectMap.reader_hasKey (enumerator_28366.current_mBoundObjectName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (721)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_string var_includeFile ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_28685_0 ; // Joker input parameter
      constinArgument_inObservableObjectMap.method_searchKey (GALGAS_lstring::constructor_new (enumerator_28366.current_mBoundObjectName (HERE).mAttribute_string, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (724)), var_observedObjectOCName, joker_28685_0, var_includeFile, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (723)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      ioArgument_ioImplementationFileInclusionSet.addAssign_operation (var_includeFile COMMA_SOURCE_FILE_AT_LINE (730)) ;
    }else if (kBoolFalse == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_28366.current_mBoundObjectName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_28366.current_mBoundObjectName (HERE).reader_string (SOURCE_FILE_AT_LINE (733)) COMMA_SOURCE_FILE_AT_LINE (733)).operator_concat (GALGAS_string ("' object is not observable") COMMA_SOURCE_FILE_AT_LINE (733)) COMMA_SOURCE_FILE_AT_LINE (732)) ;
      var_observedObjectOCName.drop () ; // Release error dropped variable
      var_observablePropertyMap.drop () ; // Release error dropped variable
    }
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_observablePropertyType ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_29117_0 ; // Joker input parameter
    var_observablePropertyMap.method_searchKey (enumerator_28366.current_mBoundPropertyName (HERE), var_observablePropertyType, joker_29117_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (738)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_observableKeyPath = enumerator_28366.current_mBoundPropertyName (HERE).mAttribute_string ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (742)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_29357 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (743)).isValidAndTrue () ;
    if (enumerator_29357.hasCurrentObject () && bool_2) {
      while (enumerator_29357.hasCurrentObject () && bool_2) {
        //-------- @assignmentInstructionForGeneration
        var_requiredFormatter = enumerator_29357.current_mRequiredFormatter (HERE) ;
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (kIsEqual, enumerator_29357.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
        enumerator_29357.gotoNextObject () ;
        if (enumerator_29357.hasCurrentObject ()) {
          bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (743)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (747)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (748)) COMMA_SOURCE_FILE_AT_LINE (748)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (748)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeAndFormatterList enumerator_29673 (var_acceptableTypeFormatterList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (749)).isValidAndTrue () ;
      if (enumerator_29673.hasCurrentObject () && bool_4) {
        while (enumerator_29673.hasCurrentObject () && bool_4) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_29673.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (750)) COMMA_SOURCE_FILE_AT_LINE (750)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (750)) COMMA_SOURCE_FILE_AT_LINE (750)) ;
          enumerator_29673.gotoNextObject () ;
          if (enumerator_29673.hasCurrentObject ()) {
            bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (749)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_5 (enumerator_28366.current_mBoundPropertyName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, var_s COMMA_SOURCE_FILE_AT_LINE (752)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (755)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = enumerator_28366.current_mNegate (HERE).boolEnum () ;
    if (kBoolTrue == test_6) {
      //-------- @plusEqualnstructionForGeneration
      var_bindingOptionList.addAssign_operation (GALGAS_string ("NSValueTransformerName"), GALGAS_string ("NSNegateBooleanTransformerName") COMMA_SOURCE_FILE_AT_LINE (757)) ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletBindingOptionList enumerator_30038 (enumerator_28366.current_mOutletBindingOptionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_30038.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingTypeList var_acceptableTypeList ;
      //-------- @methodCallInstructionForGeneration
      var_outletClassBindingOptionMap.method_searchKey (enumerator_30038.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (761)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_bool var_found = GALGAS_bool (false) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_30235 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (763)).isValidAndTrue () ;
      if (enumerator_30235.hasCurrentObject () && bool_7) {
        while (enumerator_30235.hasCurrentObject () && bool_7) {
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeList enumerator_30301 (enumerator_30038.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (764)).isValidAndTrue () ;
          if (enumerator_30301.hasCurrentObject () && bool_8) {
            while (enumerator_30301.hasCurrentObject () && bool_8) {
              //-------- @assignmentInstructionForGeneration
              var_found = GALGAS_bool (kIsEqual, enumerator_30235.current_mType (HERE).objectCompare (enumerator_30301.current_mType (HERE))) ;
              enumerator_30301.gotoNextObject () ;
              if (enumerator_30301.hasCurrentObject ()) {
                bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (764)).isValidAndTrue () ;
              }
            }
          }
          enumerator_30235.gotoNextObject () ;
          if (enumerator_30235.hasCurrentObject ()) {
            bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (763)).isValidAndTrue () ;
          }
        }
      }
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (768)).boolEnum () ;
      if (kBoolTrue == test_9) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_30552 (var_acceptableTypeList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (770)).isValidAndTrue () ;
        if (enumerator_30552.hasCurrentObject () && bool_10) {
          while (enumerator_30552.hasCurrentObject () && bool_10) {
            //-------- @concatInstructionForGeneration
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  - '").operator_concat (categoryReader_ebTypeName (enumerator_30552.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (771)) COMMA_SOURCE_FILE_AT_LINE (771)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (771)) COMMA_SOURCE_FILE_AT_LINE (771)) ;
            enumerator_30552.gotoNextObject () ;
            if (enumerator_30552.hasCurrentObject ()) {
              bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (770)).isValidAndTrue () ;
            }
          }
        }
        //-------- @errorInstructionForGeneration
        GALGAS_location location_11 (enumerator_30038.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_11, var_s COMMA_SOURCE_FILE_AT_LINE (773)) ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_bindingOptionList.addAssign_operation (enumerator_30038.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (775)), enumerator_30038.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (775)) ;
      enumerator_30038.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (var_generatedBindingName, var_requiredFormatter, var_observedObjectOCName, var_observableKeyPath, var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (777)) COMMA_SOURCE_FILE_AT_LINE (777)) ;
    //-------- @incrementInstructionForGeneration
    var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (785)) ;
    //-------- @assignmentInstructionForGeneration
    var_generatedBindingName = object->mAttribute_mBindingName.mAttribute_string.operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (786)) COMMA_SOURCE_FILE_AT_LINE (786)) ;
...
GALGAS_string categoryReader_ebTypeIdentifier (const GALGAS_easyBindingType & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inClassOrEntityName COMMA_SOURCE_FILE_AT_LINE (916)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (916)) ;
      } break ;
    }
  }
//---
...
static void categoryMethod_multiValuedBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement the $").operator_concat (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (967)) COMMA_SOURCE_FILE_AT_LINE (967)).operator_concat (GALGAS_string (" binding") COMMA_SOURCE_FILE_AT_LINE (967)) COMMA_SOURCE_FILE_AT_LINE (967)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_tableValueBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (979)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $run action") COMMA_SOURCE_FILE_AT_LINE (991)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @assignmentInstructionForGeneration
    var_resultingObservedPropertyPath = GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (1007)) COMMA_SOURCE_FILE_AT_LINE (1007)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("observed object should be 'root'") COMMA_SOURCE_FILE_AT_LINE (1009)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1015)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_40195_0 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_40195_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1017)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (1018)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1019)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_40491_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_40491_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_40491_2, joker_40491_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1022)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1024)) COMMA_SOURCE_FILE_AT_LINE (1024)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1024)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1026)) COMMA_SOURCE_FILE_AT_LINE (1026)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1026)) ;
      }
    }else if (kBoolFalse == test_3) {
      //-------- @errorInstructionForGeneration
      ...
      inCompiler->emitSemanticError (location_5, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (1029)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1035)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_41122 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (1038)).isValidAndTrue () ;
  if (enumerator_41122.hasCurrentObject () && bool_6) {
    while (enumerator_41122.hasCurrentObject () && bool_6) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_41122.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1039)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (1040)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1040)) COMMA_SOURCE_FILE_AT_LINE (1040)) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, var_boundTypeIdentifierString.objectCompare (var_acceptableType)) ;
      enumerator_41122.gotoNextObject () ;
      if (enumerator_41122.hasCurrentObject ()) {
        bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (1038)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (1043)).boolEnum () ;
  if (kBoolTrue == test_7) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_8 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_8, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (1045)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (1045)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (1045)) COMMA_SOURCE_FILE_AT_LINE (1044)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1048)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (1055)), var_resultingObservedObjectName, var_resultingObservedPropertyPath, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1053)) COMMA_SOURCE_FILE_AT_LINE (1053)) ;
}
//---------------------------------------------------------------------------*
