...
void routine_analyzePreference (const GALGAS_preferencesDeclarationList_2E_element constinArgument_inPreference,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_42718 (constinArgument_inPreference.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_42718.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_actionMap.modifier_insertKey (enumerator_42718.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1094)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeList enumerator_43020 (constinArgument_inPreference.mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_43020.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_checkDefaultValueType (enumerator_43020.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_43020.current_mType (HERE), enumerator_43020.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1100)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_attributeListForImplementation.addAssign_operation (enumerator_43020.current_mType (HERE), enumerator_43020.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1101)), enumerator_43020.current_mDefaultValueObjectiveCObject (HERE), enumerator_43020.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1101)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("preference.").operator_concat (constinArgument_inPreference.mAttribute_mPreferencesName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1103)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1103)).operator_concat (enumerator_43020.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1103)) COMMA_SOURCE_FILE_AT_LINE (1103)), enumerator_43020.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1102)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableAttributeMap.modifier_insertKey (enumerator_43020.current_mAttributeName (HERE), enumerator_43020.current_mType (HERE), GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1106)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ...
    enumerator_43020.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_preferenceArrayMap var_preferenceArrayMap = GALGAS_preferenceArrayMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1118)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classArrayList enumerator_43857 (constinArgument_inPreference.mAttribute_mClassArrayList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_43857.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_observablePropertyMap var_classObservablePropertyMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_43910_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_43976_5 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_43976_4 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_43976_3 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_43976_2 ; // Joker input parameter
    GALGAS_stringset joker_43976_1 ; // Joker input parameter
    constinArgument_inClassMap.method_searchKey (enumerator_43857.current_mClassName (HERE), joker_43910_0, var_classObservablePropertyMap, joker_43976_5, joker_43976_4, joker_43976_3, joker_43976_2, joker_43976_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1120)) ;
    //-------- END @methodCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_preferenceArrayMap.modifier_insertKey (enumerator_43857.current_mArrayName (HERE), enumerator_43857.current_mClassName (HERE).mAttribute_string, var_classObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1126)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_43857.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerList enumerator_44342 (constinArgument_inPreference.mAttribute_mControllerList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_44342.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_44415_0 ; // Joker input parameter
    constinArgument_inControllerClassMap.method_searchKey (enumerator_44342.current_mControllerClassName (HERE), joker_44415_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1136)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_44638_7 ; // Joker input parameter
    GALGAS_observablePropertyMap joker_44638_6 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_44638_5 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_44638_4 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_44638_3 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_44638_2 ; // Joker input parameter
    GALGAS_stringset joker_44638_1 ; // Joker input parameter
    constinArgument_inClassMap.method_searchKey (enumerator_44342.current_mControlledClassOrEntityName (HERE), joker_44638_7, joker_44638_6, joker_44638_5, joker_44638_4, joker_44638_3, joker_44638_2, joker_44638_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1143)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_44755 (enumerator_44342.current_mControllerBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_44755.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_44755.current_mBinding (HERE).ptr (), GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1147)), var_controllerClassBindingMap, enumerator_44342.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1146)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_44755.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_controllerMap.modifier_insertKey (enumerator_44342.current_mControllerName (HERE), enumerator_44342.current_mControllerClassName (HERE).mAttribute_string, enumerator_44342.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1154)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_44342.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletDeclarationList enumerator_46019 (constinArgument_inPreference.mAttribute_mOutletDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_46019.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_46117_2 ; // Joker input parameter
    GALGAS_lstringlist joker_46117_1 ; // Joker input parameter
    constinArgument_inOutletClassMap.method_searchKey (enumerator_46019.current_mOutletType (HERE), var_generationKind, joker_46117_2, joker_46117_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1181)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @ifInstructionForGeneration
    ...
    if (kBoolTrue == test_0) {
      //-------- @plusEqualnstructionForGeneration
      var_implementationFileInclusionSet.addAssign_operation (enumerator_46019.current_mOutletType (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1189)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_46440 (enumerator_46019.current_mOutletBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_46440.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_46440.current_mBinding (HERE).ptr (), GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1194)), var_observableAttributeMap, GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1196)), GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1197)), var_bindingMap, GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1199)), var_actionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1193)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_46440.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_outletGenerationList.addAssign_operation (enumerator_46019.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1206)), var_generationKind, enumerator_46019.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1206)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1206)) ;
    enumerator_46019.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
void routine_analyzePreferences (const GALGAS_preferencesDeclarationList constinArgument_inPreferencesList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_47856 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_47856.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzePreference (enumerator_47856.current (HERE), constinArgument_inControllerClassMap, constinArgument_inClassMap, constinArgument_inOutletClassMap, outArgument_outPreferencesMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1235)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_47856.gotoNextObject () ;
  }
}
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_48441 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_48441.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_48441.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1256)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_48630 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1258)).isValidAndTrue () ;
    if (enumerator_48630.hasCurrentObject () && bool_0) {
      while (enumerator_48630.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_48694 (enumerator_48441.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1259)).isValidAndTrue () ;
        if (enumerator_48694.hasCurrentObject () && bool_1) {
          while (enumerator_48694.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_48630.current_mType (HERE).objectCompare (enumerator_48694.current_mType (HERE))) ;
            enumerator_48694.gotoNextObject () ;
            if (enumerator_48694.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1259)).isValidAndTrue () ;
            }
          }
        }
        enumerator_48630.gotoNextObject () ;
        if (enumerator_48630.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_2) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_48933 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (1265)).isValidAndTrue () ;
      if (enumerator_48933.hasCurrentObject () && bool_3) {
        while (enumerator_48933.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_48933.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1266)) COMMA_SOURCE_FILE_AT_LINE (1266)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1266)) COMMA_SOURCE_FILE_AT_LINE (1266)) ;
          enumerator_48933.gotoNextObject () ;
          if (enumerator_48933.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (1265)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_48441.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (1268)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_48441.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (1270)), enumerator_48441.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (1270)) ;
    enumerator_48441.gotoNextObject () ;
  }
}
...
void routine_analyzeDocument (const GALGAS_documentDeclarationList_2E_element constinArgument_inDocument,
  ...
  GALGAS_relationshipMap var_allRelationshipMap ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_59982_0 ; // Joker input parameter
  GALGAS_string joker_60036_0 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_60103_8 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_60103_7 ; // Joker input parameter
  GALGAS_attributeListForImplementation joker_60103_6 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_60103_5 ; // Joker input parameter
  GALGAS_relationshipList joker_60103_4 ; // Joker input parameter
  GALGAS_relationshipList joker_60103_3 ; // Joker input parameter
  GALGAS_propertyMap joker_60103_2 ; // Joker input parameter
  GALGAS_relationshipMap joker_60103_1 ; // Joker input parameter
  GALGAS_stringset joker_60152_2 ; // Joker input parameter
  GALGAS__32_stringlist joker_60152_1 ; // Joker input parameter
  constinArgument_inEntityMap.method_searchKey (constinArgument_inDocument.mAttribute_mRootEntityName, joker_59982_0, var_rootEntityImplementationClassName, joker_60036_0, var_rootObjectObservablePropertyMap, joker_60103_8, joker_60103_7, joker_60103_6, joker_60103_5, joker_60103_4, joker_60103_3, joker_60103_2, joker_60103_1, var_allRelationshipMap, joker_60152_2, joker_60152_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1527)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerList enumerator_60376 (constinArgument_inDocument.mAttribute_mControllerList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_60376.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_outletClassBindingMap var_controllerClassBindingMap ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_actionMap var_controllerActionMap ;
    ...
    GALGAS_observablePropertyMap var_controllerObservablePropertyMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_60602_0 ; // Joker input parameter
    constinArgument_inControllerClassMap.method_searchKey (enumerator_60376.current_mControllerClassName (HERE), joker_60602_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1544)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_60770_15 ; // Joker input parameter
    GALGAS_string joker_60770_14 ; // Joker input parameter
    GALGAS_string joker_60770_13 ; // Joker input parameter
    GALGAS_observablePropertyMap joker_60770_12 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_60770_11 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_60770_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_60770_9 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_60770_8 ; // Joker input parameter
    GALGAS_relationshipList joker_60770_7 ; // Joker input parameter
    GALGAS_relationshipList joker_60770_6 ; // Joker input parameter
    GALGAS_propertyMap joker_60770_5 ; // Joker input parameter
    GALGAS_relationshipMap joker_60770_4 ; // Joker input parameter
    GALGAS_relationshipMap joker_60770_3 ; // Joker input parameter
    GALGAS_stringset joker_60770_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_60770_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_60376.current_mControlledClassOrEntityName (HERE), joker_60770_15, joker_60770_14, joker_60770_13, joker_60770_12, joker_60770_11, joker_60770_10, joker_60770_9, joker_60770_8, joker_60770_7, joker_60770_6, joker_60770_5, joker_60770_4, joker_60770_3, joker_60770_2, joker_60770_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1551)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_60887 (enumerator_60376.current_mControllerBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_60887.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_60887.current_mBinding (HERE).ptr (), var_allRelationshipMap, var_controllerClassBindingMap, enumerator_60376.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1554)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_60887.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_controllerMap.modifier_insertKey (enumerator_60376.current_mControllerName (HERE), enumerator_60376.current_mControllerClassName (HERE).mAttribute_string, enumerator_60376.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1562)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_60376.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_62124 (constinArgument_inDocument.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_62124.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_documentActionMap.modifier_insertKey (enumerator_62124.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1589)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletDeclarationList enumerator_62383 (constinArgument_inDocument.mAttribute_mOutletDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_62383.hasCurrentObject ()) {
    ...
    GALGAS_bool var_hasTableValueBinding ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_62481_2 ; // Joker input parameter
    GALGAS_lstringlist joker_62481_1 ; // Joker input parameter
    constinArgument_inOutletClassMap.method_searchKey (enumerator_62383.current_mOutletType (HERE), var_generationKind, joker_62481_2, joker_62481_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1594)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingList enumerator_62667 (enumerator_62383.current_mOutletBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_62667.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_62667.current_mBinding (HERE).ptr (), var_rootObjectObservablePropertyMap, var_observablePropertyMap, constinArgument_inPreferencesMap, constinArgument_inEntityMap, var_bindingMap, var_controllerMap, var_documentActionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1603)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_62667.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_outletGenerationList.addAssign_operation (enumerator_62383.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1616)), var_generationKind, enumerator_62383.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1616)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1616)) ;
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_64086 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_64086.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeDocument (enumerator_64086.current (HERE), constinArgument_inOutletClassMap, constinArgument_inControllerClassMap, constinArgument_inEntityMap, constinArgument_inPreferencesMap, outArgument_outDocumentMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1645)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_64086.gotoNextObject () ;
  }
}
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_64650 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1665)).isValidAndTrue () ;
  if (enumerator_64650.hasCurrentObject () && bool_0) {
    while (enumerator_64650.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_64650.current_mType (HERE))) ;
      enumerator_64650.gotoNextObject () ;
      if (enumerator_64650.hasCurrentObject ()) {
...
void routine_analyzeClass (const GALGAS_classList_2E_element constinArgument_inClass,
  ...
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_65353_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_65412_4 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_65412_3 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_65412_2 ; // Joker input parameter
    GALGAS_stringset joker_65412_1 ; // Joker input parameter
    ioArgument_ioClassMap.method_searchKey (constinArgument_inClass.mAttribute_mSuperClassName, joker_65353_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_65412_4, joker_65412_3, joker_65412_2, joker_65412_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1684)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @assignmentInstructionForGeneration
  ...
  GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_attributeList enumerator_65872 (constinArgument_inClass.mAttribute_mAttributeList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_65872.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_checkDefaultValueType (enumerator_65872.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_65872.current_mType (HERE), enumerator_65872.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1693)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    var_attributeListForImplementation.addAssign_operation (enumerator_65872.current_mType (HERE), enumerator_65872.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1694)), enumerator_65872.current_mDefaultValueObjectiveCObject (HERE), enumerator_65872.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1694)) ;
    //-------- @plusEqualnstructionForGeneration
    var_propertyListForInitMethodHeader.addAssign_operation (enumerator_65872.current_mType (HERE), enumerator_65872.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1695)), enumerator_65872.current_mDefaultValueObjectiveCObject (HERE), enumerator_65872.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1695)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("class.").operator_concat (constinArgument_inClass.mAttribute_mClassName.reader_string (SOURCE_FILE_AT_LINE (1697)) COMMA_SOURCE_FILE_AT_LINE (1697)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1697)).operator_concat (enumerator_65872.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1697)) COMMA_SOURCE_FILE_AT_LINE (1697)), enumerator_65872.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1696)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_65872.current_mAttributeName (HERE), enumerator_65872.current_mType (HERE), GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1700)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    ...
    enumerator_65872.gotoNextObject () ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS_transientListForImplementation var_transientListForImplementation ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_67942 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_67942.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeClass (enumerator_67942.current (HERE), outArgument_outClassMap, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1749)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_67942.gotoNextObject () ;
  }
}
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_68368 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_68368.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1767)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_68465 (enumerator_68368.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_68465.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_68577 (enumerator_68465.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_68577.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_68577.current_mBindingOptionName (HERE), enumerator_68577.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1771)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_68577.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_68465.current_mBindingName (HERE), enumerator_68465.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1773)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_68465.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_68875 (enumerator_68368.current_mAdoptedProtocolList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_68875.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      constinArgument_inProtocolMap.method_searchKey (enumerator_68875.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1777)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_68875.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_68368.current_mOutletClassName (HERE), enumerator_68368.current_mGeneration (HERE), enumerator_68368.current_mSuperClassName (HERE).mAttribute_string, enumerator_68368.current_mAdoptedProtocolList (HERE), var_bindingMap, enumerator_68368.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1780)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_68368.gotoNextObject () ;
  }
}
...
void routine_analyzeControllerClass (const GALGAS_controllerClassList_2E_element constinArgument_inController,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_lstringlist enumerator_69549 (constinArgument_inController.mAttribute_mActionDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_69549.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_actionMap.modifier_insertKey (enumerator_69549.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1801)) ;
    } //-------- END @typeMethodInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassBindingList enumerator_69705 (constinArgument_inController.mAttribute_mBindingList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_69705.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_bindingOptionList enumerator_69813 (enumerator_69705.current_mBindingOptionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_69813.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_outletClassBindingOptionMap.modifier_insertKey (enumerator_69813.current_mBindingOptionName (HERE), enumerator_69813.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1808)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_69813.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_bindingMap.modifier_insertKey (enumerator_69705.current_mBindingName (HERE), enumerator_69705.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1814)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_69705.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerObservablePropertyList enumerator_70259 (constinArgument_inController.mAttribute_mControllerObservablePropertyList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_70259.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("controller.").operator_concat (constinArgument_inController.mAttribute_mControllerClassName.reader_string (SOURCE_FILE_AT_LINE (1820)) COMMA_SOURCE_FILE_AT_LINE (1820)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1820)).operator_concat (enumerator_70259.current (HERE).mAttribute_mPropertyName.reader_string (SOURCE_FILE_AT_LINE (1820)) COMMA_SOURCE_FILE_AT_LINE (1820)), enumerator_70259.current (HERE).mAttribute_mPropertyName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1819)) ;
    { //-------- @modifierCallInstructionForGeneration
    ...
    { //-------- @modifierCallInstructionForGeneration
    var_observablePropertyMap.modifier_insertKey (enumerator_70259.current (HERE).mAttribute_mPropertyName, enumerator_70259.current (HERE).mAttribute_mType, GALGAS_bool (false), var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1827)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_70259.gotoNextObject () ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_71322 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_71322.hasCurrentObject ()) {
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeControllerClass (enumerator_71322.current (HERE), ioArgument_ioTransientDependencyGraph, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1853)) ;
    } //-------- @routineCallInstructionForGeneration
    enumerator_71322.gotoNextObject () ;
  }
}
...
void routine_semanticAnalysis (const GALGAS_cursorList constinArgument_inCursorList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outCursorMap = GALGAS_cursorMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1885)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_cursorList enumerator_72351 (constinArgument_inCursorList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_72351.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outCursorMap.modifier_insertKey (enumerator_72351.current_mCursorName (HERE), enumerator_72351.current_mHotSpotX (HERE).mAttribute_double, enumerator_72351.current_mHotSpotY (HERE).mAttribute_double, inCompiler COMMA_SOURCE_FILE_AT_LINE (1887)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_72351.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_protocolMap var_protocolMap = GALGAS_protocolMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1890)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_protocolList enumerator_72543 (constinArgument_inProtocolList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_72543.hasCurrentObject ()) {
    { //-------- @modifierCallInstructionForGeneration
    var_protocolMap.modifier_insertKey (enumerator_72543.current_mProtocolName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1892)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_72543.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outSortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1895)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (1896)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inOutletClassList, var_protocolMap, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1897)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inControllerClassList, var_transientDependencyGraph, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1898)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inClassList, outArgument_outClassMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1899)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (constinArgument_inPreferencesList, outArgument_outControllerClassMap, outArgument_outClassMap, outArgument_outOutletClassMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1904)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inEntityList, outArgument_outEntityMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1912)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outPreferencesMap, outArgument_outDocumentMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1918)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1928)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (1928)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = var_transientDependencyGraph.reader_graphviz (SOURCE_FILE_AT_LINE (1929)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_path = inArgument_inSourceFilePath.operator_concat (GALGAS_string (".transientDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (1930)) ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_73804_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_73804_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1931)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outTransientDependencyArcList = var_transientDependencyGraph.reader_arcs (SOURCE_FILE_AT_LINE (1934)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1935)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_transientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (1936)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_74084 (var_transientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (1937)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_74084.hasCurrentObject ()) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_74084.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1938)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (1938)) COMMA_SOURCE_FILE_AT_LINE (1938)) ;
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstringlist joker_74336_0 ; // Joker input parameter
      GALGAS_lstringlist joker_74378_0 ; // Joker input parameter
      var_transientDependencyGraph.method_topologicalSort (outArgument_outSortedTransientOrderedList, joker_74336_0, var_unsortedTransientList, joker_74378_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1942)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1948)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1949)).reader_string (SOURCE_FILE_AT_LINE (1949)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:") COMMA_SOURCE_FILE_AT_LINE (1949)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_74608 (var_unsortedTransientList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_74608.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_74608.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1951)) COMMA_SOURCE_FILE_AT_LINE (1951)) ;
          enumerator_74608.gotoNextObject () ;
        }
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (1953)) ;
      }
    }
  }
}
...
static void categoryMethod_regularPreferenceBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_stringset joker_33506_3 ; // Joker input parameter
  GALGAS_controllerMap joker_33506_2 ; // Joker input parameter
  GALGAS_preferenceArrayMap joker_33506_1 ; // Joker input parameter
  constinArgument_inPreferencesMap.method_searchKey (object->mAttribute_mPreferenceName, joker_33448_4, joker_33448_3, joker_33448_2, joker_33448_1, var_observablePropertyMap, joker_33506_3, joker_33506_2, joker_33506_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (840)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_observablePropertyType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_33730_0 ; // Joker input parameter
  GALGAS_string joker_33737_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceAttributeName, var_observablePropertyType, joker_33730_0, joker_33737_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (847)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_33948 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (856)).isValidAndTrue () ;
  if (enumerator_33948.hasCurrentObject () && bool_0) {
    while (enumerator_33948.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_33948.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_33948.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_33948.gotoNextObject () ;
      if (enumerator_33948.hasCurrentObject ()) {
  ...
  if (kBoolTrue == test_1) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_34252 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (862)).isValidAndTrue () ;
    if (enumerator_34252.hasCurrentObject () && bool_2) {
      while (enumerator_34252.hasCurrentObject () && bool_2) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_34252.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (863)) COMMA_SOURCE_FILE_AT_LINE (863)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (863)) COMMA_SOURCE_FILE_AT_LINE (863)) ;
        enumerator_34252.gotoNextObject () ;
        if (enumerator_34252.hasCurrentObject ()) {
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_34525 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_34525.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_34525.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (871)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_34714 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (873)).isValidAndTrue () ;
    if (enumerator_34714.hasCurrentObject () && bool_4) {
      while (enumerator_34714.hasCurrentObject () && bool_4) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_34778 (enumerator_34525.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (874)).isValidAndTrue () ;
        if (enumerator_34778.hasCurrentObject () && bool_5) {
          while (enumerator_34778.hasCurrentObject () && bool_5) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_34714.current_mType (HERE).objectCompare (enumerator_34778.current_mType (HERE))) ;
            enumerator_34778.gotoNextObject () ;
            if (enumerator_34778.hasCurrentObject ()) {
              bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (874)).isValidAndTrue () ;
            }
          }
        }
        enumerator_34714.gotoNextObject () ;
        if (enumerator_34714.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_6) {
      ...
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_35017 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (880)).isValidAndTrue () ;
      if (enumerator_35017.hasCurrentObject () && bool_7) {
        while (enumerator_35017.hasCurrentObject () && bool_7) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_35017.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (881)) COMMA_SOURCE_FILE_AT_LINE (881)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (881)) COMMA_SOURCE_FILE_AT_LINE (881)) ;
          enumerator_35017.gotoNextObject () ;
          if (enumerator_35017.hasCurrentObject ()) {
            bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (880)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_8 (enumerator_34525.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_8, var_s COMMA_SOURCE_FILE_AT_LINE (883)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_34525.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (885)), enumerator_34525.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (885)) ;
    enumerator_34525.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
...
static void categoryMethod_multiValuedBindingBoundToRoot_analyzeModel (const cPtr_multiValuedBindingBoundModel * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_36581_0 ; // Joker input parameter
  GALGAS_string joker_36588_0 ; // Joker input parameter
  constinArgument_inRootEntityObservableAttributeMap.method_searchKey (object->mAttribute_mPropertyName, outArgument_outObservablePropertyType, joker_36581_0, joker_36588_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (920)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_multiValuedBindingBoundToSelf_analyzeModel (const cPtr_multiValuedBindingBoundModel * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_37237_0 ; // Joker input parameter
  GALGAS_string joker_37244_0 ; // Joker input parameter
  constinArgument_inSelfObservableAttributeMap.method_searchKey (object->mAttribute_mPropertyName, outArgument_outObservablePropertyType, joker_37237_0, joker_37244_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (940)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_multiValuedBindingBoundToPref_analyzeModel (const cPtr_multiValuedBindingBoundModel * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_attributeListForImplementation joker_37838_4 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_37838_3 ; // Joker input parameter
  GALGAS_outletGenerationList joker_37838_2 ; // Joker input parameter
  GALGAS_lstringlist joker_37838_1 ; // Joker input parameter
  GALGAS_stringset joker_37907_3 ; // Joker input parameter
  GALGAS_controllerMap joker_37907_2 ; // Joker input parameter
  GALGAS_preferenceArrayMap joker_37907_1 ; // Joker input parameter
  constinArgument_inPreferencesMap.method_searchKey (object->mAttribute_mPreferenceName, joker_37838_4, joker_37838_3, joker_37838_2, joker_37838_1, var_preferenceObservableAttributeMap, joker_37907_3, joker_37907_2, joker_37907_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (960)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_38017_0 ; // Joker input parameter
  GALGAS_string joker_38024_0 ; // Joker input parameter
  var_preferenceObservableAttributeMap.method_searchKey (object->mAttribute_mPropertyName, outArgument_outObservablePropertyType, joker_38017_0, joker_38024_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (966)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_multiValuedBindingBoundToController_analyzeModel (const cPtr_multiValuedBindingBoundModel * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_38711_4 ; // Joker input parameter
  GALGAS_string joker_38711_3 ; // Joker input parameter
  GALGAS_outletBindingListForGeneration joker_38711_2 ; // Joker input parameter
  GALGAS_actionMap joker_38711_1 ; // Joker input parameter
  constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_38711_4, joker_38711_3, joker_38711_2, joker_38711_1, var_controllerObservableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (987)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_38882_0 ; // Joker input parameter
  GALGAS_string joker_38889_0 ; // Joker input parameter
  var_controllerObservableAttributeMap.method_searchKey (object->mAttribute_mPropertyName, outArgument_outObservablePropertyType, joker_38882_0, joker_38889_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (992)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
...
static void categoryMethod_multiValuedBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_multiValuedBindingList enumerator_39926 (object->mAttribute_mMultiValuedBindingList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_39926.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_string var_observedObjectName ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_observablePropertyType ;
    //-------- @methodCallInstructionForGeneration
    callCategoryMethod_analyzeModel ((const cPtr_multiValuedBindingBoundModel *) enumerator_39926.current_mBoundModel (HERE).ptr (), constinArgument_inRootEntityObservableAttributeMap, constinArgument_inSelfObservableAttributeMap, constinArgument_inPreferencesMap, constinArgument_inControllerMap, ioArgument_ioImplementationFileInclusionSet, var_observedObjectName, var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (1022)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_40424 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1034)).isValidAndTrue () ;
    if (enumerator_40424.hasCurrentObject () && bool_0) {
      while (enumerator_40424.hasCurrentObject () && bool_0) {
        //-------- @assignmentInstructionForGeneration
        var_requiredFormatter = enumerator_40424.current_mRequiredFormatter (HERE) ;
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (kIsEqual, enumerator_40424.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
        enumerator_40424.gotoNextObject () ;
        if (enumerator_40424.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_1) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeAndFormatterList enumerator_40740 (var_acceptableTypeFormatterList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (1040)).isValidAndTrue () ;
      if (enumerator_40740.hasCurrentObject () && bool_2) {
        while (enumerator_40740.hasCurrentObject () && bool_2) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_40740.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1041)) COMMA_SOURCE_FILE_AT_LINE (1041)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1041)) COMMA_SOURCE_FILE_AT_LINE (1041)) ;
          enumerator_40740.gotoNextObject () ;
          if (enumerator_40740.hasCurrentObject ()) {
            bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (1040)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_3 (enumerator_39926.current_mBoundModel (HERE).reader_mPropertyName (SOURCE_FILE_AT_LINE (1043)).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_4 = enumerator_39926.current_mNegate (HERE).boolEnum () ;
    if (kBoolTrue == test_4) {
      //-------- @plusEqualnstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletBindingOptionList enumerator_41115 (enumerator_39926.current_mOutletBindingOptionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_41115.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingTypeList var_acceptableTypeList ;
      //-------- @methodCallInstructionForGeneration
      var_outletClassBindingOptionMap.method_searchKey (enumerator_41115.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1052)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_bool var_found = GALGAS_bool (false) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_41312 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (1054)).isValidAndTrue () ;
      if (enumerator_41312.hasCurrentObject () && bool_5) {
        while (enumerator_41312.hasCurrentObject () && bool_5) {
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeList enumerator_41378 (enumerator_41115.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (1055)).isValidAndTrue () ;
          if (enumerator_41378.hasCurrentObject () && bool_6) {
            while (enumerator_41378.hasCurrentObject () && bool_6) {
              //-------- @assignmentInstructionForGeneration
              var_found = GALGAS_bool (kIsEqual, enumerator_41312.current_mType (HERE).objectCompare (enumerator_41378.current_mType (HERE))) ;
              enumerator_41378.gotoNextObject () ;
              if (enumerator_41378.hasCurrentObject ()) {
                bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (1055)).isValidAndTrue () ;
              }
            }
          }
          enumerator_41312.gotoNextObject () ;
          if (enumerator_41312.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_7) {
        ...
        GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_41629 (var_acceptableTypeList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (1061)).isValidAndTrue () ;
        if (enumerator_41629.hasCurrentObject () && bool_8) {
          while (enumerator_41629.hasCurrentObject () && bool_8) {
            //-------- @concatInstructionForGeneration
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  - '").operator_concat (categoryReader_ebTypeName (enumerator_41629.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1062)) COMMA_SOURCE_FILE_AT_LINE (1062)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1062)) COMMA_SOURCE_FILE_AT_LINE (1062)) ;
            enumerator_41629.gotoNextObject () ;
            if (enumerator_41629.hasCurrentObject ()) {
              bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (1061)).isValidAndTrue () ;
            }
          }
        }
        //-------- @errorInstructionForGeneration
        GALGAS_location location_9 (enumerator_41115.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_9, var_s COMMA_SOURCE_FILE_AT_LINE (1064)) ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_bindingOptionList.addAssign_operation (enumerator_41115.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (1066)), enumerator_41115.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (1066)) ;
      enumerator_41115.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (var_generatedBindingName, var_requiredFormatter, var_observedObjectName, enumerator_39926.current_mBoundModel (HERE).reader_mPropertyName (SOURCE_FILE_AT_LINE (1072)).mAttribute_string, var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (1068)) COMMA_SOURCE_FILE_AT_LINE (1068)) ;
    ...
    enumerator_39926.gotoNextObject () ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularRootBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_55321_2 ; // Joker input parameter
    GALGAS_string joker_55321_1 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_55321_2, joker_55321_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1413)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    ...
    if (kBoolTrue == test_1) {
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_55618_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_55618_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_55618_2, joker_55618_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1418)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_56249 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1434)).isValidAndTrue () ;
  if (enumerator_56249.hasCurrentObject () && bool_4) {
    while (enumerator_56249.hasCurrentObject () && bool_4) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_56249.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1435)) ;
      //-------- @concatInstructionForGeneration
      ...
      enumerator_56249.gotoNextObject () ;
      if (enumerator_56249.hasCurrentObject ()) {
...
static void categoryMethod_regularSelfBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_57705_2 ; // Joker input parameter
    GALGAS_string joker_57705_1 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_57705_2, joker_57705_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1470)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    ...
    if (kBoolTrue == test_1) {
      ...
      GALGAS_lstring var_destinationEntityName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_58002_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_58002_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_58002_2, joker_58002_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1475)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_2) {
  ...
  GALGAS_string var_acceptableTypesString = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_58633 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (1491)).isValidAndTrue () ;
  if (enumerator_58633.hasCurrentObject () && bool_4) {
    while (enumerator_58633.hasCurrentObject () && bool_4) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_58633.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1492)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
      ...
      if (enumerator_58633.hasCurrentObject ()) {
