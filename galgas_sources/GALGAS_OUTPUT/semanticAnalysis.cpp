...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (189)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_7126 (constinArgument_inAST.mAttribute_mOutletClassList, kEnumeration_up) ;
  ...
  while (enumerator_7126.hasCurrentObject ()) {
    ...
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (192)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_7223 (enumerator_7126.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_7223.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (194)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_7335 (enumerator_7223.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_7335.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_7335.current_mBindingOptionName (HERE), enumerator_7335.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (196)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_7335.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_7223.current_mBindingName (HERE), enumerator_7223.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (202)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_7223.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_7126.current_mOutletClassName (HERE), enumerator_7126.current_mGenerateCode (HERE), var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (205)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_7126.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (208)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_7912 (constinArgument_inAST.mAttribute_mClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_7912.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_classObservablePropertyMap var_classObservablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (211)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_7912.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (212)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_8147_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_8211_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_8211_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_8211_2 ; // Joker input parameter
      GALGAS_triggeredKeys joker_8211_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_7912.current_mSuperClassName (HERE), joker_8147_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_8211_4, joker_8211_3, joker_8211_2, joker_8211_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (213)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (215)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (216)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (218)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (219)) ;
    ...
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (221)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_8755 (enumerator_7912.current_mPropertyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_8755.hasCurrentObject ()) {
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForImplementation.addAssign_operation (enumerator_8755.current_mType (HERE), enumerator_8755.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (223)), enumerator_8755.current_mDefaultValueObjectiveCObject (HERE), enumerator_8755.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (223)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_8755.current_mType (HERE), enumerator_8755.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (224)), enumerator_8755.current_mDefaultValueObjectiveCObject (HERE), enumerator_8755.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (224)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_8755.current_mPropertyName (HERE), enumerator_8755.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_8755.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (225)) COMMA_SOURCE_FILE_AT_LINE (225)), inCompiler COMMA_SOURCE_FILE_AT_LINE (225)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_8755.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_9221 (enumerator_7912.current_mClassTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_9221.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (229)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (230)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_9375 (enumerator_9221.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_9375.hasCurrentObject ()) {
        ...
        //-------- @methodCallInstructionForGeneration
        var_classObservablePropertyMap.method_searchKey (enumerator_9375.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (234)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_9375.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (235)) COMMA_SOURCE_FILE_AT_LINE (235)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_9638 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_9638.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_9638.current_mValue (HERE), enumerator_9221.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (237)) COMMA_SOURCE_FILE_AT_LINE (237)) ;
          enumerator_9638.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (239)) ;
        enumerator_9375.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_9221.current_mType (HERE), enumerator_9221.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (241)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (241)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_9221.current_mTransientName (HERE), enumerator_9221.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (242)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_9221.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_7912.current_mClassName (HERE), enumerator_7912.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (247)), var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedPropertyListForImplementation, var_propertyListForImplementation, var_transientListForImplementation, var_triggeredKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (245)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_7912.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outEntityMap = GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (257)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityList enumerator_10502 (constinArgument_inAST.mAttribute_mEntityList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_10502.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_classObservablePropertyMap var_classObservablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (260)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_string var_implementationSuperClassName ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_10502.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (263)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_10809_0 ; // Joker input parameter
      GALGAS_string joker_10842_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_10906_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_10906_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_10906_2 ; // Joker input parameter
      GALGAS_triggeredKeys joker_10906_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_10502.current_mSuperEntityName (HERE), joker_10809_0, var_implementationSuperClassName, joker_10842_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_10906_4, joker_10906_3, joker_10906_2, joker_10906_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (264)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_1) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (266)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (267)) ;
      //-------- @assignmentInstructionForGeneration
      var_implementationSuperClassName = GALGAS_string::makeEmptyString () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (270)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (271)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeListForImplementation var_inheritedPropertyListForImplementation = var_propertyListForInitMethodHeader ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_11473 (enumerator_10502.current_mPropertyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_11473.hasCurrentObject ()) {
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForImplementation.addAssign_operation (enumerator_11473.current_mType (HERE), enumerator_11473.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (275)), enumerator_11473.current_mDefaultValueObjectiveCObject (HERE), enumerator_11473.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (275)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_11473.current_mType (HERE), enumerator_11473.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (276)), enumerator_11473.current_mDefaultValueObjectiveCObject (HERE), enumerator_11473.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (276)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_11473.current_mPropertyName (HERE), enumerator_11473.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_11473.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (277)), inCompiler COMMA_SOURCE_FILE_AT_LINE (277)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_11473.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (280)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_11985 (enumerator_10502.current_mClassTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_11985.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (282)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (283)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_12139 (enumerator_11985.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_12139.hasCurrentObject ()) {
        ...
        GALGAS_stringlist var_propertyDependancyList ;
        //-------- @methodCallInstructionForGeneration
        var_classObservablePropertyMap.method_searchKey (enumerator_12139.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (287)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_12139.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (288)) COMMA_SOURCE_FILE_AT_LINE (288)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_12402 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_12402.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_12402.current_mValue (HERE), enumerator_11985.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (290)) COMMA_SOURCE_FILE_AT_LINE (290)) ;
          enumerator_12402.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (292)) ;
        enumerator_12139.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_11985.current_mType (HERE), enumerator_11985.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (294)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (294)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_11985.current_mTransientName (HERE), enumerator_11985.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (295)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_11985.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outEntityMap.modifier_insertKey (enumerator_10502.current_mEntityName (HERE), enumerator_10502.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (300)), enumerator_10502.current_mImplementationClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (301)), var_implementationSuperClassName, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedPropertyListForImplementation, var_propertyListForImplementation, var_transientListForImplementation, var_triggeredKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (298)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_10502.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (312)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_13366 (constinArgument_inAST.mAttribute_mPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_13366.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservablePropertyMap var_observableAttributeMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (314)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (316)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (317)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_13652 (enumerator_13366.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_13652.hasCurrentObject ()) {
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_13652.current_mType (HERE), enumerator_13652.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (319)), enumerator_13652.current_mDefaultValueObjectiveCObject (HERE), enumerator_13652.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (319)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_13652.current_mPropertyName (HERE), enumerator_13652.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_13652.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (320)) COMMA_SOURCE_FILE_AT_LINE (320)), inCompiler COMMA_SOURCE_FILE_AT_LINE (320)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_13652.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (323)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_14026 (enumerator_13366.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_14026.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (325)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (326)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_14180 (enumerator_14026.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_14180.hasCurrentObject ()) {
        ...
        GALGAS_stringlist var_propertyDependancyList ;
        //-------- @methodCallInstructionForGeneration
        var_observableAttributeMap.method_searchKey (enumerator_14180.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (330)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_14180.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (331)) COMMA_SOURCE_FILE_AT_LINE (331)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_14439 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_14439.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_14439.current_mValue (HERE), enumerator_14026.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (333)) COMMA_SOURCE_FILE_AT_LINE (333)) ;
          enumerator_14439.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (335)) ;
        enumerator_14180.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_14026.current_mType (HERE), enumerator_14026.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (337)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (337)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_14026.current_mTransientName (HERE), enumerator_14026.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (338)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_14026.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (341)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_14941 (enumerator_13366.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_14941.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_15034_0 ; // Joker input parameter
      outArgument_outOutletClassMap.method_searchKey (enumerator_14941.current_mOutletType (HERE), joker_15034_0, var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (344)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (345)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_outletBindingList enumerator_15155 (enumerator_14941.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_15155.hasCurrentObject ()) {
        ...
        //-------- @methodCallInstructionForGeneration
        var_bindingMap.method_searchKey (enumerator_15155.current_mBindingName (HERE), var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (349)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_15155.current_mObservedObjectName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_2) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_3 (enumerator_15155.current_mObservedObjectName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_3, GALGAS_string ("no prefix allowed here") COMMA_SOURCE_FILE_AT_LINE (352)) ;
        }
        //-------- @localVariableDeclarationForGeneration
        GALGAS_easyBindingType var_observablePropertyType ;
        //-------- @methodCallInstructionForGeneration
        GALGAS_stringlist joker_15721_0 ; // Joker input parameter
        var_observableAttributeMap.method_searchKey (enumerator_15155.current_mObservableAttributeName (HERE), var_observablePropertyType, joker_15721_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (355)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_bool var_found = GALGAS_bool (false) ;
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (358)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeAndFormatterList enumerator_15915 (var_acceptableTypeFormatterList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (359)).isValidAndTrue () ;
        if (enumerator_15915.hasCurrentObject () && bool_4) {
          while (enumerator_15915.hasCurrentObject () && bool_4) {
            //-------- @assignmentInstructionForGeneration
            var_requiredFormatter = enumerator_15915.current_mRequiredFormatter (HERE) ;
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_15915.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
            enumerator_15915.gotoNextObject () ;
            if (enumerator_15915.hasCurrentObject ()) {
              bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (359)).isValidAndTrue () ;
            }
          }
        }
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (363)).boolEnum () ;
        if (kBoolTrue == test_5) {
          //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
          GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (callCategoryReader_ebTypeName ((const cPtr_easyBindingType *) var_observablePropertyType.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (364)) COMMA_SOURCE_FILE_AT_LINE (364)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (364)) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeAndFormatterList enumerator_16255 (var_acceptableTypeFormatterList, kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (365)).isValidAndTrue () ;
          if (enumerator_16255.hasCurrentObject () && bool_6) {
            while (enumerator_16255.hasCurrentObject () && bool_6) {
              //-------- @concatInstructionForGeneration
              var_s.dotAssign_operation (GALGAS_string ("\n"
                "  - '").operator_concat (callCategoryReader_ebTypeName ((const cPtr_easyBindingType *) enumerator_16255.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (366)) COMMA_SOURCE_FILE_AT_LINE (366)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (366)) COMMA_SOURCE_FILE_AT_LINE (366)) ;
              enumerator_16255.gotoNextObject () ;
              if (enumerator_16255.hasCurrentObject ()) {
                bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (365)).isValidAndTrue () ;
              }
            }
          }
          //-------- @errorInstructionForGeneration
          GALGAS_location location_7 (enumerator_15155.current_mObservableAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_7, var_s COMMA_SOURCE_FILE_AT_LINE (368)) ;
        }
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (371)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_outletBindingOptionList enumerator_16532 (enumerator_15155.current_mOutletBindingOptionList (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_16532.hasCurrentObject ()) {
          //-------- @localVariableDeclarationForGeneration
          GALGAS_easyBindingTypeList var_acceptableTypeList ;
          //-------- @methodCallInstructionForGeneration
          var_outletClassBindingOptionMap.method_searchKey (enumerator_16532.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (374)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
          GALGAS_bool var_found = GALGAS_bool (false) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeList enumerator_16745 (var_acceptableTypeList, kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (376)).isValidAndTrue () ;
          if (enumerator_16745.hasCurrentObject () && bool_8) {
            while (enumerator_16745.hasCurrentObject () && bool_8) {
              //-------- @foreachInstructionForGeneration
              cEnumerator_easyBindingTypeList enumerator_16815 (enumerator_16532.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
              //--- complex foreach instruction
              bool bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (377)).isValidAndTrue () ;
              if (enumerator_16815.hasCurrentObject () && bool_9) {
                while (enumerator_16815.hasCurrentObject () && bool_9) {
                  //-------- @assignmentInstructionForGeneration
                  var_found = GALGAS_bool (kIsEqual, enumerator_16745.current_mType (HERE).objectCompare (enumerator_16815.current_mType (HERE))) ;
                  enumerator_16815.gotoNextObject () ;
                  if (enumerator_16815.hasCurrentObject ()) {
                    bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (377)).isValidAndTrue () ;
                  }
                }
              }
              enumerator_16745.gotoNextObject () ;
              if (enumerator_16745.hasCurrentObject ()) {
                bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (376)).isValidAndTrue () ;
              }
            }
          }
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (381)).boolEnum () ;
          if (kBoolTrue == test_10) {
            //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
            GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
            //-------- @foreachInstructionForGeneration
            cEnumerator_easyBindingTypeList enumerator_17090 (var_acceptableTypeList, kEnumeration_up) ;
            //--- complex foreach instruction
            bool bool_11 = var_found.operator_not (SOURCE_FILE_AT_LINE (383)).isValidAndTrue () ;
            if (enumerator_17090.hasCurrentObject () && bool_11) {
              while (enumerator_17090.hasCurrentObject () && bool_11) {
                //-------- @concatInstructionForGeneration
                var_s.dotAssign_operation (GALGAS_string ("\n"
                  "  - '").operator_concat (callCategoryReader_ebTypeName ((const cPtr_easyBindingType *) enumerator_17090.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (384)) COMMA_SOURCE_FILE_AT_LINE (384)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (384)) COMMA_SOURCE_FILE_AT_LINE (384)) ;
                enumerator_17090.gotoNextObject () ;
                if (enumerator_17090.hasCurrentObject ()) {
                  bool_11 = var_found.operator_not (SOURCE_FILE_AT_LINE (383)).isValidAndTrue () ;
                }
              }
            }
            //-------- @errorInstructionForGeneration
            GALGAS_location location_12 (enumerator_16532.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_12, var_s COMMA_SOURCE_FILE_AT_LINE (386)) ;
          }
          //-------- @plusEqualnstructionForGeneration
          var_bindingOptionList.addAssign_operation (enumerator_16532.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (388)), enumerator_16532.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (388)) ;
          enumerator_16532.gotoNextObject () ;
        }
        //-------- @plusEqualnstructionForGeneration
        var_outletBindingList.addAssign_operation (enumerator_15155.current_mBindingName (HERE).reader_string (SOURCE_FILE_AT_LINE (390)), var_requiredFormatter, GALGAS_string ("self"), enumerator_15155.current_mObservableAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (390)), var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (390)) ;
        enumerator_15155.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_14941.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (392)), enumerator_14941.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (392)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (392)) ;
      enumerator_14941.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outPreferencesMap.modifier_insertKey (enumerator_13366.current_mPreferencesName (HERE), var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, var_triggeredKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (395)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_13366.gotoNextObject () ;
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (404)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_18004 (constinArgument_inAST.mAttribute_mDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_18004.hasCurrentObject ()) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_18156_0 ; // Joker input parameter
    GALGAS_string joker_18195_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_18221_5 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_18221_4 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_18221_3 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_18221_2 ; // Joker input parameter
    GALGAS_triggeredKeys joker_18221_1 ; // Joker input parameter
    outArgument_outEntityMap.method_searchKey (enumerator_18004.current_mRootEntityName (HERE), joker_18156_0, var_rootEntityImplementationClassName, joker_18195_0, var_observablePropertyMap, joker_18221_5, joker_18221_4, joker_18221_3, joker_18221_2, joker_18221_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (408)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (410)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_18347 (enumerator_18004.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_18347.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_18440_0 ; // Joker input parameter
      outArgument_outOutletClassMap.method_searchKey (enumerator_18347.current_mOutletType (HERE), joker_18440_0, var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (413)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (414)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_outletBindingList enumerator_18561 (enumerator_18347.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_18561.hasCurrentObject ()) {
        ...
        GALGAS_easyBindingTypeAndFormatterList var_acceptableTypeFormatterList ;
        //-------- @methodCallInstructionForGeneration
        var_bindingMap.method_searchKey (enumerator_18561.current_mBindingName (HERE), var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (418)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_13 = GALGAS_bool (kIsNotEqual, enumerator_18561.current_mObservedObjectName (HERE).mAttribute_string.objectCompare (GALGAS_string ("root"))).boolEnum () ;
        if (kBoolTrue == test_13) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_14 (enumerator_18561.current_mObservedObjectName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_14, GALGAS_string ("'root' missing") COMMA_SOURCE_FILE_AT_LINE (421)) ;
        }
        //-------- @localVariableDeclarationForGeneration
        GALGAS_easyBindingType var_observablePropertyType ;
        //-------- @methodCallInstructionForGeneration
        GALGAS_stringlist joker_19116_0 ; // Joker input parameter
        var_observablePropertyMap.method_searchKey (enumerator_18561.current_mObservableAttributeName (HERE), var_observablePropertyType, joker_19116_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (424)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_bool var_found = GALGAS_bool (false) ;
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (427)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeAndFormatterList enumerator_19310 (var_acceptableTypeFormatterList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_15 = var_found.operator_not (SOURCE_FILE_AT_LINE (428)).isValidAndTrue () ;
        if (enumerator_19310.hasCurrentObject () && bool_15) {
          while (enumerator_19310.hasCurrentObject () && bool_15) {
            //-------- @assignmentInstructionForGeneration
            var_requiredFormatter = enumerator_19310.current_mRequiredFormatter (HERE) ;
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_19310.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
            enumerator_19310.gotoNextObject () ;
            if (enumerator_19310.hasCurrentObject ()) {
              bool_15 = var_found.operator_not (SOURCE_FILE_AT_LINE (428)).isValidAndTrue () ;
            }
          }
        }
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_16 = var_found.operator_not (SOURCE_FILE_AT_LINE (432)).boolEnum () ;
        if (kBoolTrue == test_16) {
          //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
          GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (callCategoryReader_ebTypeName ((const cPtr_easyBindingType *) var_observablePropertyType.ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (433)) COMMA_SOURCE_FILE_AT_LINE (433)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (433)) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeAndFormatterList enumerator_19650 (var_acceptableTypeFormatterList, kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_17 = var_found.operator_not (SOURCE_FILE_AT_LINE (434)).isValidAndTrue () ;
          if (enumerator_19650.hasCurrentObject () && bool_17) {
            while (enumerator_19650.hasCurrentObject () && bool_17) {
              //-------- @concatInstructionForGeneration
              var_s.dotAssign_operation (GALGAS_string ("\n"
                "  - '").operator_concat (callCategoryReader_ebTypeName ((const cPtr_easyBindingType *) enumerator_19650.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (435)) COMMA_SOURCE_FILE_AT_LINE (435)) ;
              enumerator_19650.gotoNextObject () ;
              if (enumerator_19650.hasCurrentObject ()) {
                bool_17 = var_found.operator_not (SOURCE_FILE_AT_LINE (434)).isValidAndTrue () ;
              }
            }
          }
          //-------- @errorInstructionForGeneration
          GALGAS_location location_18 (enumerator_18561.current_mObservableAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_18, var_s COMMA_SOURCE_FILE_AT_LINE (437)) ;
        }
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (440)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_outletBindingOptionList enumerator_19927 (enumerator_18561.current_mOutletBindingOptionList (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_19927.hasCurrentObject ()) {
          //-------- @localVariableDeclarationForGeneration
          GALGAS_easyBindingTypeList var_acceptableTypeList ;
          //-------- @methodCallInstructionForGeneration
          var_outletClassBindingOptionMap.method_searchKey (enumerator_19927.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (443)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
          GALGAS_bool var_found = GALGAS_bool (false) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeList enumerator_20140 (var_acceptableTypeList, kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_19 = var_found.operator_not (SOURCE_FILE_AT_LINE (445)).isValidAndTrue () ;
          if (enumerator_20140.hasCurrentObject () && bool_19) {
            while (enumerator_20140.hasCurrentObject () && bool_19) {
              //-------- @foreachInstructionForGeneration
              cEnumerator_easyBindingTypeList enumerator_20210 (enumerator_19927.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
              //--- complex foreach instruction
              bool bool_20 = var_found.operator_not (SOURCE_FILE_AT_LINE (446)).isValidAndTrue () ;
              if (enumerator_20210.hasCurrentObject () && bool_20) {
                while (enumerator_20210.hasCurrentObject () && bool_20) {
                  //-------- @assignmentInstructionForGeneration
                  var_found = GALGAS_bool (kIsEqual, enumerator_20140.current_mType (HERE).objectCompare (enumerator_20210.current_mType (HERE))) ;
                  enumerator_20210.gotoNextObject () ;
                  if (enumerator_20210.hasCurrentObject ()) {
                    bool_20 = var_found.operator_not (SOURCE_FILE_AT_LINE (446)).isValidAndTrue () ;
                  }
                }
              }
              enumerator_20140.gotoNextObject () ;
              if (enumerator_20140.hasCurrentObject ()) {
                bool_19 = var_found.operator_not (SOURCE_FILE_AT_LINE (445)).isValidAndTrue () ;
              }
            }
          }
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_21 = var_found.operator_not (SOURCE_FILE_AT_LINE (450)).boolEnum () ;
          if (kBoolTrue == test_21) {
            //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
            GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
            //-------- @foreachInstructionForGeneration
            cEnumerator_easyBindingTypeList enumerator_20485 (var_acceptableTypeList, kEnumeration_up) ;
            //--- complex foreach instruction
            bool bool_22 = var_found.operator_not (SOURCE_FILE_AT_LINE (452)).isValidAndTrue () ;
            if (enumerator_20485.hasCurrentObject () && bool_22) {
              while (enumerator_20485.hasCurrentObject () && bool_22) {
                //-------- @concatInstructionForGeneration
                var_s.dotAssign_operation (GALGAS_string ("\n"
                  "  - '").operator_concat (callCategoryReader_ebTypeName ((const cPtr_easyBindingType *) enumerator_20485.current_mType (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (453)) COMMA_SOURCE_FILE_AT_LINE (453)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (453)) COMMA_SOURCE_FILE_AT_LINE (453)) ;
                enumerator_20485.gotoNextObject () ;
                if (enumerator_20485.hasCurrentObject ()) {
                  bool_22 = var_found.operator_not (SOURCE_FILE_AT_LINE (452)).isValidAndTrue () ;
                }
              }
            }
            //-------- @errorInstructionForGeneration
            GALGAS_location location_23 (enumerator_19927.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_23, var_s COMMA_SOURCE_FILE_AT_LINE (455)) ;
          }
          //-------- @plusEqualnstructionForGeneration
          var_bindingOptionList.addAssign_operation (enumerator_19927.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (457)), enumerator_19927.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (457)) ;
          enumerator_19927.gotoNextObject () ;
        }
        //-------- @plusEqualnstructionForGeneration
        var_outletBindingList.addAssign_operation (enumerator_18561.current_mBindingName (HERE).reader_string (SOURCE_FILE_AT_LINE (459)), var_requiredFormatter, GALGAS_string ("mRootObject"), enumerator_18561.current_mObservableAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (459)), var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (459)) ;
        enumerator_18561.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_18347.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (461)), enumerator_18347.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (461)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (461)) ;
      enumerator_18347.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outDocumentMap.modifier_insertKey (enumerator_18004.current_mDocumentName (HERE), enumerator_18004.current_mRootEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (466)), var_rootEntityImplementationClassName, var_outletGenerationList, inCompiler COMMA_SOURCE_FILE_AT_LINE (464)) ;
    } //-------- END @typeMethodInstructionForGeneration
