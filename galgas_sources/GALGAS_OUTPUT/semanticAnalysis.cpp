...
//                    november 13th, 2012, at 21h24'52"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  while (enumerator_47487.hasCurrentObject ()) {
    ...
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (GALGAS_string ("class/").operator_concat (enumerator_47487.current_mClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1264)) COMMA_SOURCE_FILE_AT_LINE (1264)).operator_concat (GALGAS_string ("/self.") COMMA_SOURCE_FILE_AT_LINE (1264)), enumerator_47487.current_mTransientList (HERE), GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1266)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1263)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_50150 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_50150.hasCurrentObject ()) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_50247 (enumerator_50150.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_50247.hasCurrentObject ()) {
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_50359 (enumerator_50247.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_50359.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_50359.current_mBindingOptionName (HERE), enumerator_50359.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1300)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_50359.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_50247.current_mBindingName (HERE), enumerator_50247.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1306)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_50247.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_50150.current_mOutletClassName (HERE), enumerator_50150.current_mGenerateCode (HERE), enumerator_50150.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, enumerator_50150.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1309)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_51191 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_51191.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1328)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_51300 (enumerator_51191.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_51300.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_51300.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1330)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_51300.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1333)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_51452 (enumerator_51191.current_mBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_51452.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_51564 (enumerator_51452.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_51564.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_51564.current_mBindingOptionName (HERE), enumerator_51564.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1337)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_51564.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_51452.current_mBindingName (HERE), enumerator_51452.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1343)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_51452.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerObservablePropertyList enumerator_52010 (enumerator_51191.current_mControllerObservablePropertyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_52010.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_52010.current (HERE).mAttribute_mPropertyName, enumerator_52010.current (HERE).mAttribute_mType, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1355)), enumerator_52010.current (HERE).mAttribute_mPropertyName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1352)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_52010.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outControllerClassMap.modifier_insertKey (enumerator_51191.current_mOutletClassName (HERE), enumerator_51191.current_mGenerateCode (HERE), var_bindingMap, var_actionMap, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1360)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_51191.gotoNextObject () ;
  }
}
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_54164_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_54164_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1418)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @assignmentInstructionForGeneration
  ...
  if (kBoolTrue == test_1) {
    ...
    if (kBoolTrue == test_2) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_54444 (var_transientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (1424)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_54444.hasCurrentObject ()) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inAST.mAttribute_mEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_54444.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1425)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (1425)) COMMA_SOURCE_FILE_AT_LINE (1425)) ;
        enumerator_54444.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_2) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_stringlist var_unsortedTransientList ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstringlist joker_54702_0 ; // Joker input parameter
      GALGAS_lstringlist joker_54744_0 ; // Joker input parameter
      var_transientDependencyGraph.method_topologicalSort (outArgument_outSortedTransientOrderedList, joker_54702_0, var_unsortedTransientList, joker_54744_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1429)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      ...
      if (kBoolTrue == test_3) {
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_54974 (var_unsortedTransientList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_54974.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_54974.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1438)) COMMA_SOURCE_FILE_AT_LINE (1438)) ;
