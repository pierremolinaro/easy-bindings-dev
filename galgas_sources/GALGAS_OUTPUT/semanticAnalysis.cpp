...
//---------------------------------------------------------------------------*
//                                                                           *
//                      Routine 'analyzeBoundProperty'                       *
//                                                                           *
//---------------------------------------------------------------------------*

void routine_analyzeBoundProperty (const GALGAS_lstring constinArgument0,
                                   const GALGAS_lstring constinArgument1,
                                   const GALGAS_relationshipMap constinArgument2,
...
GALGAS_classObservablePropertyMap_3A_element cEnumerator_classObservablePropertyMap::current (LOCATION_ARGS) const {
  const cMapElement_classObservablePropertyMap * p = (const cMapElement_classObservablePropertyMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_classObservablePropertyMap) ;
  return GALGAS_classObservablePropertyMap_3A_element (p->mAttribute_lkey, p->mAttribute_mType, p->mAttribute_mPropertyDependancyList) ;
}
...
class cCollectionElement_attributeListForImplementation : public cCollectionElement {
  public : GALGAS_attributeListForImplementation_3A_element mObject ;
...
GALGAS_attributeListForImplementation_3A_element cEnumerator_attributeListForImplementation::current (LOCATION_ARGS) const {
...
class cCollectionElement_directDependancyList : public cCollectionElement {
  public : GALGAS_directDependancyList_3A_element mObject ;
...
GALGAS_directDependancyList_3A_element cEnumerator_directDependancyList::current (LOCATION_ARGS) const {
...
class cCollectionElement_transientListForImplementation : public cCollectionElement {
  public : GALGAS_transientListForImplementation_3A_element mObject ;
...
GALGAS_transientListForImplementation_3A_element cEnumerator_transientListForImplementation::current (LOCATION_ARGS) const {
...
GALGAS_triggeredKeys_3A_element cEnumerator_triggeredKeys::current (LOCATION_ARGS) const {
  const cListMapElement * p = (const cListMapElement *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cListMapElement) ;
  return GALGAS_triggeredKeys_3A_element (p->mKey, p->mSharedListMapList) ;
}
...
GALGAS_classMap_3A_element cEnumerator_classMap::current (LOCATION_ARGS) const {
  const cMapElement_classMap * p = (const cMapElement_classMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_classMap) ;
  return GALGAS_classMap_3A_element (p->mAttribute_lkey, p->mAttribute_mSuperClassName, p->mAttribute_mPropertyMap, p->mAttribute_mAttributeListForInitMethodHeader, p->mAttribute_mInheritedAttributeListForImplementation, p->mAttribute_mAttributeListForImplementation, p->mAttribute_mTransientListForImplementation, p->mAttribute_mTriggeredKeys) ;
}
...
class cCollectionElement_outletBindingListForGeneration : public cCollectionElement {
  public : GALGAS_outletBindingListForGeneration_3A_element mObject ;
...
GALGAS_outletBindingListForGeneration_3A_element cEnumerator_outletBindingListForGeneration::current (LOCATION_ARGS) const {
...
class cCollectionElement_outletGenerationList : public cCollectionElement {
  public : GALGAS_outletGenerationList_3A_element mObject ;
...
GALGAS_outletGenerationList_3A_element cEnumerator_outletGenerationList::current (LOCATION_ARGS) const {
...
GALGAS_preferencesMap_3A_element cEnumerator_preferencesMap::current (LOCATION_ARGS) const {
  const cMapElement_preferencesMap * p = (const cMapElement_preferencesMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_preferencesMap) ;
  return GALGAS_preferencesMap_3A_element (p->mAttribute_lkey, p->mAttribute_mAttributeListForImplementation, p->mAttribute_mTransientListForImplementation, p->mAttribute_mOutletDeclarationList, p->mAttribute_mTriggeredKeys) ;
}
...
bool cMapElement_documentMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mRootEntityName.isValid () && mAttribute_mRootEntityImplementationClassName.isValid () && mAttribute_mOutletDeclarationList.isValid () && mAttribute_mControllerMap.isValid () ;
}
...
cMapElement * cMapElement_documentMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_documentMap (mAttribute_lkey, mAttribute_mRootEntityName, mAttribute_mRootEntityImplementationClassName, mAttribute_mOutletDeclarationList, mAttribute_mControllerMap COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_documentMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  macroMyNew (p, cMapElement_documentMap (inKey, inArgument0, inArgument1, inArgument2, inArgument3 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
GALGAS_documentMap_3A_element cEnumerator_documentMap::current (LOCATION_ARGS) const {
  const cMapElement_documentMap * p = (const cMapElement_documentMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_documentMap) ;
  return GALGAS_documentMap_3A_element (p->mAttribute_lkey, p->mAttribute_mRootEntityName, p->mAttribute_mRootEntityImplementationClassName, p->mAttribute_mOutletDeclarationList, p->mAttribute_mControllerMap) ;
}
...
GALGAS_outletClassBindingOptionMap_3A_element cEnumerator_outletClassBindingOptionMap::current (LOCATION_ARGS) const {
  const cMapElement_outletClassBindingOptionMap * p = (const cMapElement_outletClassBindingOptionMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_outletClassBindingOptionMap) ;
  return GALGAS_outletClassBindingOptionMap_3A_element (p->mAttribute_lkey, p->mAttribute_mAcceptableTypeList) ;
}
...
GALGAS_outletClassBindingMap_3A_element cEnumerator_outletClassBindingMap::current (LOCATION_ARGS) const {
  const cMapElement_outletClassBindingMap * p = (const cMapElement_outletClassBindingMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_outletClassBindingMap) ;
  return GALGAS_outletClassBindingMap_3A_element (p->mAttribute_lkey, p->mAttribute_mAcceptableTypeList, p->mAttribute_mOutletClassBindingOptionMap) ;
}
...
GALGAS_outletClassMap_3A_element cEnumerator_outletClassMap::current (LOCATION_ARGS) const {
  const cMapElement_outletClassMap * p = (const cMapElement_outletClassMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_outletClassMap) ;
  return GALGAS_outletClassMap_3A_element (p->mAttribute_lkey, p->mAttribute_mGenerateCode, p->mAttribute_mSuperClassName, p->mAttribute_mBindingMap) ;
}
...
cMapElement * cMapElement_controllerClassMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_controllerClassMap (mAttribute_lkey, mAttribute_mGenerateCode, mAttribute_mBindingMap COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_controllerClassMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  macroMyNew (p, cMapElement_controllerClassMap (inKey, inArgument0, inArgument1 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
GALGAS_controllerClassMap_3A_element cEnumerator_controllerClassMap::current (LOCATION_ARGS) const {
  const cMapElement_controllerClassMap * p = (const cMapElement_controllerClassMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_controllerClassMap) ;
  return GALGAS_controllerClassMap_3A_element (p->mAttribute_lkey, p->mAttribute_mGenerateCode, p->mAttribute_mBindingMap) ;
}
...
bool cMapElement_controllerMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mControllerClassName.isValid () && mAttribute_mControlledClassOrEntityName.isValid () && mAttribute_mControllerBindingList.isValid () ;
}
...
cMapElement * cMapElement_controllerMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_controllerMap (mAttribute_lkey, mAttribute_mControllerClassName, mAttribute_mControlledClassOrEntityName, mAttribute_mControllerBindingList COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_controllerMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  macroMyNew (p, cMapElement_controllerMap (inKey, inArgument0, inArgument1, inArgument2 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
GALGAS_controllerMap_3A_element cEnumerator_controllerMap::current (LOCATION_ARGS) const {
  const cMapElement_controllerMap * p = (const cMapElement_controllerMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_controllerMap) ;
  return GALGAS_controllerMap_3A_element (p->mAttribute_lkey, p->mAttribute_mControllerClassName, p->mAttribute_mControlledClassOrEntityName, p->mAttribute_mControllerBindingList) ;
}
...
GALGAS_relationshipMap_3A_element cEnumerator_relationshipMap::current (LOCATION_ARGS) const {
  const cMapElement_relationshipMap * p = (const cMapElement_relationshipMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_relationshipMap) ;
  return GALGAS_relationshipMap_3A_element (p->mAttribute_lkey, p->mAttribute_mIsToMany, p->mAttribute_mDestinationEntityName, p->mAttribute_mInverseRelationshipName, p->mAttribute_mDeleteRule) ;
}
...
GALGAS_propertyMap_3A_element cEnumerator_propertyMap::current (LOCATION_ARGS) const {
  ...
  return GALGAS_propertyMap_3A_element (p->mAttribute_lkey) ;
}
...
void routine_analyzeEntities (const GALGAS_entityList constinArgument_inEntityList,
  ...
  outArgument_outEntityMap = GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (233)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityList enumerator_8703 (constinArgument_inEntityList, kEnumeration_up) ;
  ...
  while (enumerator_8703.hasCurrentObject ()) {
    ...
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (236)) ;
    //-------- @localVariableDeclarationForGeneration
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_8703.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (241)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_9120_0 ; // Joker input parameter
      GALGAS_string joker_9169_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_9257_5 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_9257_4 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_9257_3 ; // Joker input parameter
      GALGAS_triggeredKeys joker_9257_2 ; // Joker input parameter
      GALGAS_relationshipList joker_9257_1 ; // Joker input parameter
      GALGAS_relationshipMap joker_9322_0 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_8703.current_mSuperEntityName (HERE), joker_9120_0, var_implementationSuperClassName, joker_9169_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_9257_5, joker_9257_4, joker_9257_3, joker_9257_2, joker_9257_1, var_allRelationshipList, var_allPropertyMap, joker_9322_0, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (242)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (256)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (257)) ;
      //-------- @assignmentInstructionForGeneration
      var_implementationSuperClassName = GALGAS_string::makeEmptyString () ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipList = GALGAS_relationshipList::constructor_emptyList (SOURCE_FILE_AT_LINE (259)) ;
      //-------- @assignmentInstructionForGeneration
      var_allPropertyMap = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (260)) ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (261)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (263)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (264)) ;
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_10095 (enumerator_8703.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_10095.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_10095.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_10095.current_mType (HERE), enumerator_10095.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (268)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_10095.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (269)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_10095.current_mType (HERE), enumerator_10095.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (270)), enumerator_10095.current_mDefaultValueObjectiveCObject (HERE), enumerator_10095.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (270)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_10095.current_mType (HERE), enumerator_10095.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (271)), enumerator_10095.current_mDefaultValueObjectiveCObject (HERE), enumerator_10095.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (271)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_10095.current_mAttributeName (HERE), enumerator_10095.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_10095.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (272)) COMMA_SOURCE_FILE_AT_LINE (272)), inCompiler COMMA_SOURCE_FILE_AT_LINE (272)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_10095.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_relationshipMap var_currentRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (275)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipList enumerator_10790 (enumerator_8703.current_mRelationshipList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_10790.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allRelationshipMap.modifier_insertKey (enumerator_10790.current_mRelationshipName (HERE), enumerator_10790.current_mIsToMany (HERE), enumerator_10790.current_mDestinationEntityName (HERE), enumerator_10790.current_mInverseRelationshipName (HERE), enumerator_10790.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (277)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_currentRelationshipMap.modifier_insertKey (enumerator_10790.current_mRelationshipName (HERE), enumerator_10790.current_mIsToMany (HERE), enumerator_10790.current_mDestinationEntityName (HERE), enumerator_10790.current_mInverseRelationshipName (HERE), enumerator_10790.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (284)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_10790.current_mRelationshipName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (291)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_10790.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (294)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_11342 (enumerator_8703.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_11342.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_11342.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (296)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (297)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (298)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_11549 (enumerator_11342.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_11549.hasCurrentObject ()) {
        ...
        //-------- @methodCallInstructionForGeneration
        var_classObservablePropertyMap.method_searchKey (enumerator_11549.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (302)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_11549.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (303)) COMMA_SOURCE_FILE_AT_LINE (303)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_11812 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_11812.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_11812.current_mValue (HERE), enumerator_11342.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (305)) COMMA_SOURCE_FILE_AT_LINE (305)) ;
          enumerator_11812.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (307)) ;
        enumerator_11549.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_11342.current_mType (HERE), enumerator_11342.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (309)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (309)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_11342.current_mTransientName (HERE), enumerator_11342.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (310)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_11342.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outEntityMap.modifier_insertKey (enumerator_8703.current_mEntityName (HERE), enumerator_8703.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (315)), enumerator_8703.current_mImplementationClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (316)), var_implementationSuperClassName, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_triggeredKeys, enumerator_8703.current_mRelationshipList (HERE), var_allRelationshipList.operator_concat (enumerator_8703.current_mRelationshipList (HERE) COMMA_SOURCE_FILE_AT_LINE (325)), var_allPropertyMap, var_currentRelationshipMap, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (313)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_8703.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityMap enumerator_12804 (outArgument_outEntityMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_12804.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipMap enumerator_12843 (enumerator_12804.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_12843.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_12959_13 ; // Joker input parameter
      GALGAS_string joker_12959_12 ; // Joker input parameter
      GALGAS_string joker_12959_11 ; // Joker input parameter
      GALGAS_classObservablePropertyMap joker_12959_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_12959_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_12959_8 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_12959_7 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_12959_6 ; // Joker input parameter
      GALGAS_triggeredKeys joker_12959_5 ; // Joker input parameter
      GALGAS_relationshipList joker_12959_4 ; // Joker input parameter
      GALGAS_relationshipList joker_12959_3 ; // Joker input parameter
      GALGAS_propertyMap joker_12959_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_12959_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_12843.current_mDestinationEntityName (HERE), joker_12959_13, joker_12959_12, joker_12959_11, joker_12959_10, joker_12959_9, joker_12959_8, joker_12959_7, joker_12959_6, joker_12959_5, joker_12959_4, joker_12959_3, joker_12959_2, joker_12959_1, var_destinationEntityRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (335)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_inverseOfInverseRelationshipName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_13126_2 ; // Joker input parameter
      GALGAS_lstring joker_13126_1 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_13164_0 ; // Joker input parameter
      var_destinationEntityRelationshipMap.method_searchKey (enumerator_12843.current_mInverseRelationshipName (HERE), joker_13126_2, joker_13126_1, var_inverseOfInverseRelationshipName, joker_13164_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (337)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_12843.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_2 (enumerator_12843.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_12843.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (339)) COMMA_SOURCE_FILE_AT_LINE (339)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (339)) COMMA_SOURCE_FILE_AT_LINE (339)) ;
      }
...
void routine_analyzePreferences (const GALGAS_preferencesDeclarationList constinArgument_inPreferencesList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (352)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_13747 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_13747.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservablePropertyMap var_observableAttributeMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (354)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (356)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (357)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_14033 (enumerator_13747.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_14033.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_14033.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_14033.current_mType (HERE), enumerator_14033.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (359)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_14033.current_mType (HERE), enumerator_14033.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (360)), enumerator_14033.current_mDefaultValueObjectiveCObject (HERE), enumerator_14033.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (360)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_14033.current_mAttributeName (HERE), enumerator_14033.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_14033.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (361)) COMMA_SOURCE_FILE_AT_LINE (361)), inCompiler COMMA_SOURCE_FILE_AT_LINE (361)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_14033.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (364)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_14506 (enumerator_13747.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_14506.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (366)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (367)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_14660 (enumerator_14506.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_14660.hasCurrentObject ()) {
        ...
        GALGAS_stringlist var_propertyDependancyList ;
        //-------- @methodCallInstructionForGeneration
        var_observableAttributeMap.method_searchKey (enumerator_14660.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (371)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_14660.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (372)) COMMA_SOURCE_FILE_AT_LINE (372)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_14919 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_14919.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_14919.current_mValue (HERE), enumerator_14506.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (374)) COMMA_SOURCE_FILE_AT_LINE (374)) ;
          enumerator_14919.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (376)) ;
        enumerator_14660.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_14506.current_mType (HERE), enumerator_14506.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (378)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (378)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_14506.current_mTransientName (HERE), enumerator_14506.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (379)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_14506.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (382)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_15421 (enumerator_13747.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_15421.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_15513_2 ; // Joker input parameter
      GALGAS_string joker_15513_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_15421.current_mOutletType (HERE), joker_15513_2, joker_15513_1, var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (385)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (386)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_15635 (enumerator_15421.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_15635.hasCurrentObject ()) {
        ...
        //-------- @methodCallInstructionForGeneration
        var_bindingMap.method_searchKey (enumerator_15635.current_mBindingName (HERE), var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (390)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_15635.current_mObservedObjectName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
        if (kBoolTrue == test_0) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_1 (enumerator_15635.current_mObservedObjectName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_1, GALGAS_string ("no prefix allowed here") COMMA_SOURCE_FILE_AT_LINE (393)) ;
        }
        //-------- @localVariableDeclarationForGeneration
        GALGAS_easyBindingType var_observablePropertyType ;
        //-------- @methodCallInstructionForGeneration
        GALGAS_stringlist joker_16201_0 ; // Joker input parameter
        var_observableAttributeMap.method_searchKey (enumerator_15635.current_mObservableAttributeName (HERE), var_observablePropertyType, joker_16201_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (396)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_bool var_found = GALGAS_bool (false) ;
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (399)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeAndFormatterList enumerator_16395 (var_acceptableTypeFormatterList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (400)).isValidAndTrue () ;
        if (enumerator_16395.hasCurrentObject () && bool_2) {
          while (enumerator_16395.hasCurrentObject () && bool_2) {
            //-------- @assignmentInstructionForGeneration
            var_requiredFormatter = enumerator_16395.current_mRequiredFormatter (HERE) ;
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_16395.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
            enumerator_16395.gotoNextObject () ;
            if (enumerator_16395.hasCurrentObject ()) {
              bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (400)).isValidAndTrue () ;
            }
          }
        }
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (404)).boolEnum () ;
        if (kBoolTrue == test_3) {
          //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
          GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (405)) COMMA_SOURCE_FILE_AT_LINE (405)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (405)) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeAndFormatterList enumerator_16735 (var_acceptableTypeFormatterList, kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (406)).isValidAndTrue () ;
          if (enumerator_16735.hasCurrentObject () && bool_4) {
            while (enumerator_16735.hasCurrentObject () && bool_4) {
              //-------- @concatInstructionForGeneration
              var_s.dotAssign_operation (GALGAS_string ("\n"
                "  - '").operator_concat (categoryReader_ebTypeName (enumerator_16735.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (407)) COMMA_SOURCE_FILE_AT_LINE (407)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (407)) COMMA_SOURCE_FILE_AT_LINE (407)) ;
              enumerator_16735.gotoNextObject () ;
              if (enumerator_16735.hasCurrentObject ()) {
                bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (406)).isValidAndTrue () ;
              }
            }
          }
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_15635.current_mObservableAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, var_s COMMA_SOURCE_FILE_AT_LINE (409)) ;
        }
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (412)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_outletBindingOptionList enumerator_17012 (enumerator_15635.current_mOutletBindingOptionList (HERE), kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_17012.hasCurrentObject ()) {
          //-------- @localVariableDeclarationForGeneration
          GALGAS_easyBindingTypeList var_acceptableTypeList ;
          //-------- @methodCallInstructionForGeneration
          var_outletClassBindingOptionMap.method_searchKey (enumerator_17012.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (415)) ;
          //-------- END @methodCallInstructionForGeneration
          //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
          GALGAS_bool var_found = GALGAS_bool (false) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeList enumerator_17225 (var_acceptableTypeList, kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (417)).isValidAndTrue () ;
          if (enumerator_17225.hasCurrentObject () && bool_6) {
            while (enumerator_17225.hasCurrentObject () && bool_6) {
              //-------- @foreachInstructionForGeneration
              cEnumerator_easyBindingTypeList enumerator_17295 (enumerator_17012.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
              //--- complex foreach instruction
              bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (418)).isValidAndTrue () ;
              if (enumerator_17295.hasCurrentObject () && bool_7) {
                while (enumerator_17295.hasCurrentObject () && bool_7) {
                  //-------- @assignmentInstructionForGeneration
                  var_found = GALGAS_bool (kIsEqual, enumerator_17225.current_mType (HERE).objectCompare (enumerator_17295.current_mType (HERE))) ;
                  enumerator_17295.gotoNextObject () ;
                  if (enumerator_17295.hasCurrentObject ()) {
                    bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (418)).isValidAndTrue () ;
                  }
                }
              }
              enumerator_17225.gotoNextObject () ;
              if (enumerator_17225.hasCurrentObject ()) {
                bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (417)).isValidAndTrue () ;
              }
            }
          }
          //-------- @ifInstructionForGeneration
          const enumGalgasBool test_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (422)).boolEnum () ;
          if (kBoolTrue == test_8) {
            //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
            GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
            //-------- @foreachInstructionForGeneration
            cEnumerator_easyBindingTypeList enumerator_17570 (var_acceptableTypeList, kEnumeration_up) ;
            //--- complex foreach instruction
            bool bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (424)).isValidAndTrue () ;
            if (enumerator_17570.hasCurrentObject () && bool_9) {
              while (enumerator_17570.hasCurrentObject () && bool_9) {
                //-------- @concatInstructionForGeneration
                var_s.dotAssign_operation (GALGAS_string ("\n"
                  "  - '").operator_concat (categoryReader_ebTypeName (enumerator_17570.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (425)) COMMA_SOURCE_FILE_AT_LINE (425)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (425)) COMMA_SOURCE_FILE_AT_LINE (425)) ;
                enumerator_17570.gotoNextObject () ;
                if (enumerator_17570.hasCurrentObject ()) {
                  bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (424)).isValidAndTrue () ;
                }
              }
            }
            //-------- @errorInstructionForGeneration
            GALGAS_location location_10 (enumerator_17012.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_10, var_s COMMA_SOURCE_FILE_AT_LINE (427)) ;
          }
          //-------- @plusEqualnstructionForGeneration
          var_bindingOptionList.addAssign_operation (enumerator_17012.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (429)), enumerator_17012.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (429)) ;
          enumerator_17012.gotoNextObject () ;
        }
        //-------- @plusEqualnstructionForGeneration
        var_outletBindingList.addAssign_operation (enumerator_15635.current_mBindingName (HERE).reader_string (SOURCE_FILE_AT_LINE (431)), var_requiredFormatter, GALGAS_string ("self"), enumerator_15635.current_mObservableAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (431)), var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (431)) ;
        enumerator_15635.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_15421.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (433)), enumerator_15421.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (433)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (433)) ;
      enumerator_15421.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outPreferencesMap.modifier_insertKey (enumerator_13747.current_mPreferencesName (HERE), var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, var_triggeredKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (436)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeBoundProperty (const GALGAS_lstring constinArgument_inObservedObjectName,
                                   const GALGAS_lstring constinArgument_inObservedPropertyName,
                                   ...
                                   GALGAS_string & outArgument_outTypeIdentifierString,
                                   GALGAS_string & outArgument_outResultingObservedObjectName,
                                   GALGAS_string & outArgument_outResultingObservedPropertyPath,
                                   C_Compiler * inCompiler
                                   COMMA_UNUSED_LOCATION_ARGS) {
  outArgument_outTypeIdentifierString.drop () ; // Release 'out' argument
  outArgument_outResultingObservedObjectName.drop () ; // Release 'out' argument
  outArgument_outResultingObservedPropertyPath.drop () ; // Release 'out' argument
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, constinArgument_inObservedObjectName.mAttribute_string.objectCompare (GALGAS_string ("root"))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @assignmentInstructionForGeneration
    outArgument_outResultingObservedObjectName = GALGAS_string ("mRootObjectController") ;
    //-------- @assignmentInstructionForGeneration
    outArgument_outResultingObservedPropertyPath = GALGAS_string ("selection.").operator_concat (constinArgument_inObservedPropertyName.reader_string (SOURCE_FILE_AT_LINE (480)) COMMA_SOURCE_FILE_AT_LINE (480)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (constinArgument_inObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("observed object should be 'root'") COMMA_SOURCE_FILE_AT_LINE (482)) ;
    outArgument_outResultingObservedObjectName.drop () ; // Release error dropped variable
    outArgument_outResultingObservedPropertyPath.drop () ; // Release error dropped variable
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inAllObservablePropertyMap.reader_hasKey (constinArgument_inObservedPropertyName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (487)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_stringlist joker_20153_0 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (constinArgument_inObservedPropertyName, var_t, joker_20153_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (489)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    outArgument_outTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (490)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inAllRelationshipMap.reader_hasKey (constinArgument_inObservedPropertyName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (491)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_20443_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_20443_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (constinArgument_inObservedPropertyName, var_isToMany, var_destinationEntityName, joker_20443_2, joker_20443_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (494)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        outArgument_outTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (496)) COMMA_SOURCE_FILE_AT_LINE (496)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (496)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @assignmentInstructionForGeneration
        outArgument_outTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (498)) COMMA_SOURCE_FILE_AT_LINE (498)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (498)) ;
      }
    }else if (kBoolFalse == test_3) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_5 (constinArgument_inObservedPropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (501)) ;
      outArgument_outTypeIdentifierString.drop () ; // Release error dropped variable
    }
  }
}
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outBindingOptionListForGeneration = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (514)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_21142 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_21142.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_21142.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (517)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_21331 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (519)).isValidAndTrue () ;
    if (enumerator_21331.hasCurrentObject () && bool_0) {
      while (enumerator_21331.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_21395 (enumerator_21142.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (520)).isValidAndTrue () ;
        if (enumerator_21395.hasCurrentObject () && bool_1) {
          while (enumerator_21395.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_21331.current_mType (HERE).objectCompare (enumerator_21395.current_mType (HERE))) ;
            enumerator_21395.gotoNextObject () ;
            if (enumerator_21395.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (520)).isValidAndTrue () ;
            }
          }
        }
        enumerator_21331.gotoNextObject () ;
        if (enumerator_21331.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (519)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (524)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_21634 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (526)).isValidAndTrue () ;
      if (enumerator_21634.hasCurrentObject () && bool_3) {
        while (enumerator_21634.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_21634.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (527)) COMMA_SOURCE_FILE_AT_LINE (527)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (527)) COMMA_SOURCE_FILE_AT_LINE (527)) ;
          enumerator_21634.gotoNextObject () ;
          if (enumerator_21634.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (526)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_21142.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (529)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_21142.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (531)), enumerator_21142.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (531)) ;
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (544)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_22279 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_22279.hasCurrentObject ()) {
    ...
    GALGAS_relationshipMap var_allRelationshipMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_22484_0 ; // Joker input parameter
    GALGAS_string joker_22534_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_22572_9 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_22572_8 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_22572_7 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_22572_6 ; // Joker input parameter
    GALGAS_triggeredKeys joker_22572_5 ; // Joker input parameter
    GALGAS_relationshipList joker_22572_4 ; // Joker input parameter
    GALGAS_relationshipList joker_22572_3 ; // Joker input parameter
    GALGAS_propertyMap joker_22572_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_22572_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_22279.current_mRootEntityName (HERE), joker_22484_0, var_rootEntityImplementationClassName, joker_22534_0, var_observablePropertyMap, joker_22572_9, joker_22572_8, joker_22572_7, joker_22572_6, joker_22572_5, joker_22572_4, joker_22572_3, joker_22572_2, joker_22572_1, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (549)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (559)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerList enumerator_22710 (enumerator_22279.current_mControllerList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_22710.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_controllerClassBindingMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_22830_0 ; // Joker input parameter
      constinArgument_inControllerClassMap.method_searchKey (enumerator_22710.current_mControllerClassName (HERE), joker_22830_0, var_controllerClassBindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (562)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_22923_14 ; // Joker input parameter
      GALGAS_string joker_22923_13 ; // Joker input parameter
      GALGAS_string joker_22923_12 ; // Joker input parameter
      GALGAS_classObservablePropertyMap joker_22923_11 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_22923_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_22923_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_22923_8 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_22923_7 ; // Joker input parameter
      GALGAS_triggeredKeys joker_22923_6 ; // Joker input parameter
      GALGAS_relationshipList joker_22923_5 ; // Joker input parameter
      GALGAS_relationshipList joker_22923_4 ; // Joker input parameter
      GALGAS_propertyMap joker_22923_3 ; // Joker input parameter
      GALGAS_relationshipMap joker_22923_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_22923_1 ; // Joker input parameter
      constinArgument_inEntityMap.method_searchKey (enumerator_22710.current_mControlledClassOrEntityName (HERE), joker_22923_14, joker_22923_13, joker_22923_12, joker_22923_11, joker_22923_10, joker_22923_9, joker_22923_8, joker_22923_7, joker_22923_6, joker_22923_5, joker_22923_4, joker_22923_3, joker_22923_2, joker_22923_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (563)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (564)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_23044 (enumerator_22710.current_mControllerBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_23044.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_string var_boundPropertyTypeIdentifierString ;
        //-------- @localVariableDeclarationForGeneration
        GALGAS_string var_resultingObservedObjectName ;
        //-------- @localVariableDeclarationForGeneration
        GALGAS_string var_resultingObservedPropertyPath ;
        { //-------- @routineCallInstructionForGeneration
        routine_analyzeBoundProperty (enumerator_23044.current_mObservedObjectName (HERE), enumerator_23044.current_mObservableAttributeName (HERE), var_allRelationshipMap, var_observablePropertyMap, var_boundPropertyTypeIdentifierString, var_resultingObservedObjectName, var_resultingObservedPropertyPath, inCompiler COMMA_SOURCE_FILE_AT_LINE (566)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @localVariableDeclarationForGeneration
        ...
        //-------- @methodCallInstructionForGeneration
        var_controllerClassBindingMap.method_searchKey (enumerator_23044.current_mBindingName (HERE), var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (577)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_bool var_found = GALGAS_bool (false) ;
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeAndFormatterList enumerator_23716 (var_acceptableTypeList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (580)).isValidAndTrue () ;
        if (enumerator_23716.hasCurrentObject () && bool_0) {
          while (enumerator_23716.hasCurrentObject () && bool_0) {
            //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
            GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_23716.current_mType (HERE), enumerator_22710.current_mControlledClassOrEntityName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (581)) ;
            //-------- @concatInstructionForGeneration
            var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
              "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (582)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (582)) COMMA_SOURCE_FILE_AT_LINE (582)) ;
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, var_boundPropertyTypeIdentifierString.objectCompare (var_acceptableType)) ;
            enumerator_23716.gotoNextObject () ;
            if (enumerator_23716.hasCurrentObject ()) {
              bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (580)).isValidAndTrue () ;
            }
          }
        }
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (585)).boolEnum () ;
        if (kBoolTrue == test_1) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_2 (enumerator_23044.current_mObservableAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundPropertyTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (587)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (587)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (587)) COMMA_SOURCE_FILE_AT_LINE (586)) ;
        }
        //-------- @localVariableDeclarationForGeneration
        GALGAS__32_stringlist var_bindingOptionListForGeneration ;
        { //-------- @routineCallInstructionForGeneration
        routine_checkBindingOptions (enumerator_23044.current_mOutletBindingOptionList (HERE), var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (590)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_bindingListForGeneration.addAssign_operation (enumerator_23044.current_mBindingName (HERE).mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (597)), var_resultingObservedObjectName, var_resultingObservedPropertyPath, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (595)) ;
        enumerator_23044.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_controllerMap.modifier_insertKey (enumerator_22710.current_mControllerName (HERE), enumerator_22710.current_mControllerClassName (HERE).mAttribute_string, enumerator_22710.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (603)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_22710.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (611)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_24983 (enumerator_22279.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_24983.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_25075_2 ; // Joker input parameter
      GALGAS_string joker_25075_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_24983.current_mOutletType (HERE), joker_25075_2, joker_25075_1, var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (614)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (615)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_25197 (enumerator_24983.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_25197.hasCurrentObject ()) {
        ...
        GALGAS_easyBindingTypeAndFormatterList var_acceptableTypeFormatterList ;
        //-------- @methodCallInstructionForGeneration
        var_bindingMap.method_searchKey (enumerator_25197.current_mBindingName (HERE), var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (619)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, enumerator_25197.current_mObservedObjectName (HERE).mAttribute_string.objectCompare (GALGAS_string ("root"))).boolEnum () ;
        if (kBoolTrue == test_3) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_4 (enumerator_25197.current_mObservedObjectName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_4, GALGAS_string ("'root' missing") COMMA_SOURCE_FILE_AT_LINE (622)) ;
        }
        //-------- @localVariableDeclarationForGeneration
        GALGAS_easyBindingType var_observablePropertyType ;
        //-------- @methodCallInstructionForGeneration
        GALGAS_stringlist joker_25752_0 ; // Joker input parameter
        var_observablePropertyMap.method_searchKey (enumerator_25197.current_mObservableAttributeName (HERE), var_observablePropertyType, joker_25752_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (625)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_bool var_found = GALGAS_bool (false) ;
        //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
        GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (628)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeAndFormatterList enumerator_25946 (var_acceptableTypeFormatterList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (629)).isValidAndTrue () ;
        if (enumerator_25946.hasCurrentObject () && bool_5) {
          while (enumerator_25946.hasCurrentObject () && bool_5) {
            //-------- @assignmentInstructionForGeneration
            var_requiredFormatter = enumerator_25946.current_mRequiredFormatter (HERE) ;
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_25946.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
            enumerator_25946.gotoNextObject () ;
            if (enumerator_25946.hasCurrentObject ()) {
              bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (629)).isValidAndTrue () ;
            }
          }
        }
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (633)).boolEnum () ;
        if (kBoolTrue == test_6) {
          //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
          GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (634)) COMMA_SOURCE_FILE_AT_LINE (634)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (634)) ;
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeAndFormatterList enumerator_26286 (var_acceptableTypeFormatterList, kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (635)).isValidAndTrue () ;
          if (enumerator_26286.hasCurrentObject () && bool_7) {
            while (enumerator_26286.hasCurrentObject () && bool_7) {
              //-------- @concatInstructionForGeneration
              var_s.dotAssign_operation (GALGAS_string ("\n"
                "  - '").operator_concat (categoryReader_ebTypeName (enumerator_26286.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (636)) COMMA_SOURCE_FILE_AT_LINE (636)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (636)) COMMA_SOURCE_FILE_AT_LINE (636)) ;
              enumerator_26286.gotoNextObject () ;
              if (enumerator_26286.hasCurrentObject ()) {
                bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (635)).isValidAndTrue () ;
              }
            }
          }
          //-------- @errorInstructionForGeneration
          GALGAS_location location_8 (enumerator_25197.current_mObservableAttributeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_8, var_s COMMA_SOURCE_FILE_AT_LINE (638)) ;
        }
        //-------- @localVariableDeclarationForGeneration
        GALGAS__32_stringlist var_bindingOptionListForGeneration ;
        { //-------- @routineCallInstructionForGeneration
        routine_checkBindingOptions (enumerator_25197.current_mOutletBindingOptionList (HERE), var_outletClassBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (641)) ;
        } //-------- @routineCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_outletBindingList.addAssign_operation (enumerator_25197.current_mBindingName (HERE).reader_string (SOURCE_FILE_AT_LINE (647)), var_requiredFormatter, GALGAS_string ("mRootObject"), enumerator_25197.current_mObservableAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (650)), var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (646)) ;
        enumerator_25197.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_24983.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (654)), enumerator_24983.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (654)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (654)) ;
      enumerator_24983.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outDocumentMap.modifier_insertKey (enumerator_22279.current_mDocumentName (HERE), enumerator_22279.current_mRootEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (659)), var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (657)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_27551 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (675)).isValidAndTrue () ;
  if (enumerator_27551.hasCurrentObject () && bool_0) {
    while (enumerator_27551.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_27551.current_mType (HERE))) ;
      enumerator_27551.gotoNextObject () ;
      if (enumerator_27551.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (675)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (678)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (679)) ;
  }
}
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (689)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_27979 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_27979.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_classObservablePropertyMap var_classObservablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (692)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_27979.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (693)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_28214_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_28278_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_28278_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_28278_2 ; // Joker input parameter
      GALGAS_triggeredKeys joker_28278_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_27979.current_mSuperClassName (HERE), joker_28214_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_28278_4, joker_28278_3, joker_28278_2, joker_28278_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (694)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (696)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (697)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (699)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (700)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (702)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_28825 (enumerator_27979.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_28825.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_28825.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_28825.current_mType (HERE), enumerator_28825.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (704)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_28825.current_mType (HERE), enumerator_28825.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (705)), enumerator_28825.current_mDefaultValueObjectiveCObject (HERE), enumerator_28825.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (705)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_28825.current_mType (HERE), enumerator_28825.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (706)), enumerator_28825.current_mDefaultValueObjectiveCObject (HERE), enumerator_28825.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (706)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_28825.current_mAttributeName (HERE), enumerator_28825.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_28825.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (707)) COMMA_SOURCE_FILE_AT_LINE (707)), inCompiler COMMA_SOURCE_FILE_AT_LINE (707)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_28825.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_29387 (enumerator_27979.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_29387.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (711)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (712)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_29541 (enumerator_29387.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_29541.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_easyBindingType var_type ;
        //-------- @localVariableDeclarationForGeneration
        GALGAS_stringlist var_propertyDependancyList ;
        //-------- @methodCallInstructionForGeneration
        var_classObservablePropertyMap.method_searchKey (enumerator_29541.current_mValue (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (716)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_29541.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (717)) COMMA_SOURCE_FILE_AT_LINE (717)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_29804 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_29804.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_29804.current_mValue (HERE), enumerator_29387.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (719)) COMMA_SOURCE_FILE_AT_LINE (719)) ;
          enumerator_29804.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (721)) ;
        enumerator_29541.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_29387.current_mType (HERE), enumerator_29387.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (723)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (723)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_29387.current_mTransientName (HERE), enumerator_29387.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (724)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_29387.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_27979.current_mClassName (HERE), enumerator_27979.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (729)), var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_triggeredKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (727)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (746)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_30806 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_30806.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (749)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_30903 (enumerator_30806.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_30903.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (751)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_31015 (enumerator_30903.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_31015.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_31015.current_mBindingOptionName (HERE), enumerator_31015.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (753)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_31015.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_30903.current_mBindingName (HERE), enumerator_30903.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (759)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_30903.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_30806.current_mOutletClassName (HERE), enumerator_30806.current_mGenerateCode (HERE), enumerator_30806.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (762)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (777)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_31818 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_31818.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (780)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_31904 (enumerator_31818.current_mBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_31904.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (782)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_32016 (enumerator_31904.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_32016.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_32016.current_mBindingOptionName (HERE), enumerator_32016.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (784)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_32016.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_31904.current_mBindingName (HERE), enumerator_31904.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (790)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_31904.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outControllerClassMap.modifier_insertKey (enumerator_31818.current_mOutletClassName (HERE), enumerator_31818.current_mGenerateCode (HERE), var_bindingMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (793)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  outArgument_outDocumentMap.drop () ; // Release 'out' argument
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (808)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (809)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (810)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (811)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (812)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outDocumentMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (813)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
GALGAS_string categoryReader_ebTypeIdentifier (const GALGAS_easyBindingType & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inClassOrEntityName COMMA_SOURCE_FILE_AT_LINE (463)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (463)) ;
      } break ;
    }
  }
//---
...
GALGAS_classObservablePropertyMap_3A_element::GALGAS_classObservablePropertyMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mType (),
...
GALGAS_classObservablePropertyMap_3A_element::GALGAS_classObservablePropertyMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_classObservablePropertyMap_3A_element & GALGAS_classObservablePropertyMap_3A_element::operator = (const GALGAS_classObservablePropertyMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mType = inOperand.mAttribute_mType ;
  mAttribute_mPropertyDependancyList = inOperand.mAttribute_mPropertyDependancyList ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_classObservablePropertyMap_3A_element GALGAS_classObservablePropertyMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                            const GALGAS_easyBindingType & inOperand1,
                                                                                                            const GALGAS_stringlist & inOperand2 
                                                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_classObservablePropertyMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_classObservablePropertyMap_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_classObservablePropertyMap_3A_element::objectCompare (const GALGAS_classObservablePropertyMap_3A_element & inOperand) const {
...
bool GALGAS_classObservablePropertyMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mType.isValid () && mAttribute_mPropertyDependancyList.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_classObservablePropertyMap_3A_element::drop (void) {
...
void GALGAS_classObservablePropertyMap_3A_element::description (C_String & ioString,
...
GALGAS_lstring GALGAS_classObservablePropertyMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_easyBindingType GALGAS_classObservablePropertyMap_3A_element::reader_mType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mType ;
}

//---------------------------------------------------------------------------*

GALGAS_stringlist GALGAS_classObservablePropertyMap_3A_element::reader_mPropertyDependancyList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_classObservablePropertyMap_3A_element ("classObservablePropertyMap:element",
                                                              NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_classObservablePropertyMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_classObservablePropertyMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_classObservablePropertyMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_classObservablePropertyMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_classObservablePropertyMap_3A_element GALGAS_classObservablePropertyMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                          C_Compiler * inCompiler,
                                                                                                          const GALGAS_location & inErrorLocation
                                                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_classObservablePropertyMap_3A_element result ;
  const GALGAS_classObservablePropertyMap_3A_element * p = (const GALGAS_classObservablePropertyMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_classObservablePropertyMap_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_attributeListForImplementation_3A_element::GALGAS_attributeListForImplementation_3A_element (void) :
mAttribute_mType (),
...
GALGAS_attributeListForImplementation_3A_element::GALGAS_attributeListForImplementation_3A_element (const GALGAS_easyBindingType & inOperand0,
                                                                                                    const GALGAS_string & inOperand1,
                                                                                                    const GALGAS_string & inOperand2,
                                                                                                    const GALGAS_string & inOperand3) :
...
/* GALGAS_attributeListForImplementation_3A_element & GALGAS_attributeListForImplementation_3A_element::operator = (const GALGAS_attributeListForImplementation_3A_element & inOperand) {
  mAttribute_mType = inOperand.mAttribute_mType ;
  mAttribute_mPropertyName = inOperand.mAttribute_mPropertyName ;
  mAttribute_mDefaultValueAsObjectiveCObject = inOperand.mAttribute_mDefaultValueAsObjectiveCObject ;
  mAttribute_mDirectDefaultValue = inOperand.mAttribute_mDirectDefaultValue ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_attributeListForImplementation_3A_element GALGAS_attributeListForImplementation_3A_element::constructor_new (const GALGAS_easyBindingType & inOperand0,
                                                                                                                    const GALGAS_string & inOperand1,
                                                                                                                    const GALGAS_string & inOperand2,
                                                                                                                    const GALGAS_string & inOperand3 
                                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_attributeListForImplementation_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_attributeListForImplementation_3A_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_attributeListForImplementation_3A_element::objectCompare (const GALGAS_attributeListForImplementation_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mType.objectCompare (inOperand.mAttribute_mType) ;
  }
...
bool GALGAS_attributeListForImplementation_3A_element::isValid (void) const {
...
void GALGAS_attributeListForImplementation_3A_element::drop (void) {
  mAttribute_mType.drop () ;
...
void GALGAS_attributeListForImplementation_3A_element::description (C_String & ioString,
                                                                    const PMSInt32 inIndentation) const {
...
GALGAS_easyBindingType GALGAS_attributeListForImplementation_3A_element::reader_mType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mType ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_attributeListForImplementation_3A_element::reader_mPropertyName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPropertyName ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_attributeListForImplementation_3A_element::reader_mDefaultValueAsObjectiveCObject (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDefaultValueAsObjectiveCObject ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_attributeListForImplementation_3A_element::reader_mDirectDefaultValue (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_attributeListForImplementation_3A_element ("attributeListForImplementation:element",
                                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_attributeListForImplementation_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_attributeListForImplementation_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_attributeListForImplementation_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_attributeListForImplementation_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_attributeListForImplementation_3A_element GALGAS_attributeListForImplementation_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                                  C_Compiler * inCompiler,
                                                                                                                  const GALGAS_location & inErrorLocation
                                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_attributeListForImplementation_3A_element result ;
  const GALGAS_attributeListForImplementation_3A_element * p = (const GALGAS_attributeListForImplementation_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_attributeListForImplementation_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_directDependancyList_3A_element::GALGAS_directDependancyList_3A_element (void) :
...
GALGAS_directDependancyList_3A_element::GALGAS_directDependancyList_3A_element (const GALGAS_easyBindingType & inOperand0,
                                                                                const GALGAS_string & inOperand1) :
...
/* GALGAS_directDependancyList_3A_element & GALGAS_directDependancyList_3A_element::operator = (const GALGAS_directDependancyList_3A_element & inOperand) {
  mAttribute_mMasterType = inOperand.mAttribute_mMasterType ;
  mAttribute_mMasterName = inOperand.mAttribute_mMasterName ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_directDependancyList_3A_element GALGAS_directDependancyList_3A_element::constructor_new (const GALGAS_easyBindingType & inOperand0,
                                                                                                const GALGAS_string & inOperand1 
                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_directDependancyList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_directDependancyList_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_directDependancyList_3A_element::objectCompare (const GALGAS_directDependancyList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_directDependancyList_3A_element::isValid (void) const {
  return mAttribute_mMasterType.isValid () && mAttribute_mMasterName.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_directDependancyList_3A_element::drop (void) {
...
void GALGAS_directDependancyList_3A_element::description (C_String & ioString,
                                                          const PMSInt32 inIndentation) const {
...
GALGAS_easyBindingType GALGAS_directDependancyList_3A_element::reader_mMasterType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mMasterType ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_directDependancyList_3A_element::reader_mMasterName (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_directDependancyList_3A_element ("directDependancyList:element",
                                                        NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_directDependancyList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_directDependancyList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_directDependancyList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_directDependancyList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_directDependancyList_3A_element GALGAS_directDependancyList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                              C_Compiler * inCompiler,
                                                                                              const GALGAS_location & inErrorLocation
                                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_directDependancyList_3A_element result ;
  const GALGAS_directDependancyList_3A_element * p = (const GALGAS_directDependancyList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_directDependancyList_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_transientListForImplementation_3A_element::GALGAS_transientListForImplementation_3A_element (void) :
mAttribute_mType (),
...
GALGAS_transientListForImplementation_3A_element::GALGAS_transientListForImplementation_3A_element (const GALGAS_easyBindingType & inOperand0,
                                                                                                    const GALGAS_string & inOperand1,
                                                                                                    const GALGAS_directDependancyList & inOperand2) :
mAttribute_mType (inOperand0),
...
/* GALGAS_transientListForImplementation_3A_element & GALGAS_transientListForImplementation_3A_element::operator = (const GALGAS_transientListForImplementation_3A_element & inOperand) {
  mAttribute_mType = inOperand.mAttribute_mType ;
  mAttribute_mTransientName = inOperand.mAttribute_mTransientName ;
...
GALGAS_transientListForImplementation_3A_element GALGAS_transientListForImplementation_3A_element::constructor_new (const GALGAS_easyBindingType & inOperand0,
                                                                                                                    const GALGAS_string & inOperand1,
                                                                                                                    const GALGAS_directDependancyList & inOperand2 
                                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_transientListForImplementation_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_transientListForImplementation_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_transientListForImplementation_3A_element::objectCompare (const GALGAS_transientListForImplementation_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_mType.objectCompare (inOperand.mAttribute_mType) ;
  }
...
bool GALGAS_transientListForImplementation_3A_element::isValid (void) const {
  return mAttribute_mType.isValid () && mAttribute_mTransientName.isValid () && mAttribute_mDependencyList.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_transientListForImplementation_3A_element::drop (void) {
  mAttribute_mType.drop () ;
...
void GALGAS_transientListForImplementation_3A_element::description (C_String & ioString,
                                                                    const PMSInt32 inIndentation) const {
...
GALGAS_easyBindingType GALGAS_transientListForImplementation_3A_element::reader_mType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mType ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_transientListForImplementation_3A_element::reader_mTransientName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTransientName ;
}

//---------------------------------------------------------------------------*

GALGAS_directDependancyList GALGAS_transientListForImplementation_3A_element::reader_mDependencyList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_transientListForImplementation_3A_element ("transientListForImplementation:element",
                                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_transientListForImplementation_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_transientListForImplementation_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_transientListForImplementation_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_transientListForImplementation_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_transientListForImplementation_3A_element GALGAS_transientListForImplementation_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                                  C_Compiler * inCompiler,
                                                                                                                  const GALGAS_location & inErrorLocation
                                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_transientListForImplementation_3A_element result ;
  const GALGAS_transientListForImplementation_3A_element * p = (const GALGAS_transientListForImplementation_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_transientListForImplementation_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_triggeredKeys_3A_element::GALGAS_triggeredKeys_3A_element (void) :
mAttribute_key (),
mAttribute_mList () {
}
...
GALGAS_triggeredKeys_3A_element::GALGAS_triggeredKeys_3A_element (const GALGAS_string & inOperand0,
...
/* GALGAS_triggeredKeys_3A_element & GALGAS_triggeredKeys_3A_element::operator = (const GALGAS_triggeredKeys_3A_element & inOperand) {
...
GALGAS_triggeredKeys_3A_element GALGAS_triggeredKeys_3A_element::constructor_new (const GALGAS_string & inOperand0,
                                                                                  const GALGAS_stringlist & inOperand1 
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_triggeredKeys_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_triggeredKeys_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_triggeredKeys_3A_element::objectCompare (const GALGAS_triggeredKeys_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_triggeredKeys_3A_element::isValid (void) const {
  return mAttribute_key.isValid () && mAttribute_mList.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_triggeredKeys_3A_element::drop (void) {
  mAttribute_key.drop () ;
...
void GALGAS_triggeredKeys_3A_element::description (C_String & ioString,
                                                   const PMSInt32 inIndentation) const {
...
GALGAS_string GALGAS_triggeredKeys_3A_element::reader_key (UNUSED_LOCATION_ARGS) const {
  return mAttribute_key ;
}

//---------------------------------------------------------------------------*

GALGAS_stringlist GALGAS_triggeredKeys_3A_element::reader_mList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_triggeredKeys_3A_element ("triggeredKeys:element",
                                                 NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_triggeredKeys_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_triggeredKeys_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_triggeredKeys_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_triggeredKeys_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_triggeredKeys_3A_element GALGAS_triggeredKeys_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                C_Compiler * inCompiler,
                                                                                const GALGAS_location & inErrorLocation
                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_triggeredKeys_3A_element result ;
  const GALGAS_triggeredKeys_3A_element * p = (const GALGAS_triggeredKeys_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_triggeredKeys_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_classMap_3A_element::GALGAS_classMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_classMap_3A_element::GALGAS_classMap_3A_element (const GALGAS_lstring & inOperand0,
                                                        const GALGAS_string & inOperand1,
...
/* GALGAS_classMap_3A_element & GALGAS_classMap_3A_element::operator = (const GALGAS_classMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mSuperClassName = inOperand.mAttribute_mSuperClassName ;
  mAttribute_mPropertyMap = inOperand.mAttribute_mPropertyMap ;
  mAttribute_mAttributeListForInitMethodHeader = inOperand.mAttribute_mAttributeListForInitMethodHeader ;
  mAttribute_mInheritedAttributeListForImplementation = inOperand.mAttribute_mInheritedAttributeListForImplementation ;
  mAttribute_mAttributeListForImplementation = inOperand.mAttribute_mAttributeListForImplementation ;
  mAttribute_mTransientListForImplementation = inOperand.mAttribute_mTransientListForImplementation ;
  mAttribute_mTriggeredKeys = inOperand.mAttribute_mTriggeredKeys ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_classMap_3A_element GALGAS_classMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                        const GALGAS_string & inOperand1,
                                                                        const GALGAS_classObservablePropertyMap & inOperand2,
                                                                        const GALGAS_attributeListForImplementation & inOperand3,
                                                                        const GALGAS_attributeListForImplementation & inOperand4,
                                                                        ...
                                                                        const GALGAS_triggeredKeys & inOperand7 
                                                                        COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_classMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid ()) {
    result = GALGAS_classMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_classMap_3A_element::objectCompare (const GALGAS_classMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_classMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mSuperClassName.isValid () && mAttribute_mPropertyMap.isValid () && mAttribute_mAttributeListForInitMethodHeader.isValid () && mAttribute_mInheritedAttributeListForImplementation.isValid () && mAttribute_mAttributeListForImplementation.isValid () && mAttribute_mTransientListForImplementation.isValid () && mAttribute_mTriggeredKeys.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_classMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_classMap_3A_element::description (C_String & ioString,
                                              const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_classMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_classMap_3A_element::reader_mSuperClassName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSuperClassName ;
}

//---------------------------------------------------------------------------*

GALGAS_classObservablePropertyMap GALGAS_classMap_3A_element::reader_mPropertyMap (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPropertyMap ;
}

//---------------------------------------------------------------------------*

GALGAS_attributeListForImplementation GALGAS_classMap_3A_element::reader_mAttributeListForInitMethodHeader (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mAttributeListForInitMethodHeader ;
}

//---------------------------------------------------------------------------*

GALGAS_attributeListForImplementation GALGAS_classMap_3A_element::reader_mInheritedAttributeListForImplementation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mInheritedAttributeListForImplementation ;
}

//---------------------------------------------------------------------------*

GALGAS_attributeListForImplementation GALGAS_classMap_3A_element::reader_mAttributeListForImplementation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mAttributeListForImplementation ;
}

//---------------------------------------------------------------------------*

GALGAS_transientListForImplementation GALGAS_classMap_3A_element::reader_mTransientListForImplementation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTransientListForImplementation ;
}

//---------------------------------------------------------------------------*

GALGAS_triggeredKeys GALGAS_classMap_3A_element::reader_mTriggeredKeys (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_classMap_3A_element ("classMap:element",
                                            NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_classMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_classMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_classMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_classMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_classMap_3A_element GALGAS_classMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                      C_Compiler * inCompiler,
                                                                      const GALGAS_location & inErrorLocation
                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_classMap_3A_element result ;
  const GALGAS_classMap_3A_element * p = (const GALGAS_classMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_classMap_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_entityMap_3A_element::GALGAS_entityMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_entityMap_3A_element::GALGAS_entityMap_3A_element (const GALGAS_lstring & inOperand0,
                                                          const GALGAS_string & inOperand1,
                                                          const GALGAS_string & inOperand2,
                                                          const GALGAS_string & inOperand3,
...
/* GALGAS_entityMap_3A_element & GALGAS_entityMap_3A_element::operator = (const GALGAS_entityMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mSuperEntityName = inOperand.mAttribute_mSuperEntityName ;
  mAttribute_mImplementationClassName = inOperand.mAttribute_mImplementationClassName ;
  mAttribute_mSuperImplementationClassName = inOperand.mAttribute_mSuperImplementationClassName ;
  mAttribute_mPropertyMap = inOperand.mAttribute_mPropertyMap ;
  mAttribute_mAttributeListForInitMethodHeader = inOperand.mAttribute_mAttributeListForInitMethodHeader ;
  mAttribute_mInheritedAttributeListForImplementation = inOperand.mAttribute_mInheritedAttributeListForImplementation ;
  mAttribute_mAttributeListForImplementation = inOperand.mAttribute_mAttributeListForImplementation ;
  mAttribute_mTransientListForImplementation = inOperand.mAttribute_mTransientListForImplementation ;
  mAttribute_mTriggeredKeys = inOperand.mAttribute_mTriggeredKeys ;
  mAttribute_mCurrentRelationshipList = inOperand.mAttribute_mCurrentRelationshipList ;
  mAttribute_mAllRelationshipList = inOperand.mAttribute_mAllRelationshipList ;
  mAttribute_mAllPropertyMap = inOperand.mAttribute_mAllPropertyMap ;
  mAttribute_mCurrentRelationshipMap = inOperand.mAttribute_mCurrentRelationshipMap ;
  mAttribute_mAllRelationshipMap = inOperand.mAttribute_mAllRelationshipMap ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_entityMap_3A_element GALGAS_entityMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                          const GALGAS_string & inOperand1,
                                                                          const GALGAS_string & inOperand2,
                                                                          const GALGAS_string & inOperand3,
                                                                          const GALGAS_classObservablePropertyMap & inOperand4,
                                                                          ...
                                                                          const GALGAS_relationshipMap & inOperand14 
                                                                          COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_entityMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid () && inOperand7.isValid () && inOperand8.isValid () && inOperand9.isValid () && inOperand10.isValid () && inOperand11.isValid () && inOperand12.isValid () && inOperand13.isValid () && inOperand14.isValid ()) {
    result = GALGAS_entityMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6, inOperand7, inOperand8, inOperand9, inOperand10, inOperand11, inOperand12, inOperand13, inOperand14) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_entityMap_3A_element::objectCompare (const GALGAS_entityMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_entityMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mSuperEntityName.isValid () && mAttribute_mImplementationClassName.isValid () && mAttribute_mSuperImplementationClassName.isValid () && mAttribute_mPropertyMap.isValid () && mAttribute_mAttributeListForInitMethodHeader.isValid () && mAttribute_mInheritedAttributeListForImplementation.isValid () && mAttribute_mAttributeListForImplementation.isValid () && mAttribute_mTransientListForImplementation.isValid () && mAttribute_mTriggeredKeys.isValid () && mAttribute_mCurrentRelationshipList.isValid () && mAttribute_mAllRelationshipList.isValid () && mAttribute_mAllPropertyMap.isValid () && mAttribute_mCurrentRelationshipMap.isValid () && mAttribute_mAllRelationshipMap.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_entityMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_entityMap_3A_element::description (C_String & ioString,
                                               const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_entityMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_entityMap_3A_element::reader_mSuperEntityName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSuperEntityName ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_entityMap_3A_element::reader_mImplementationClassName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mImplementationClassName ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_entityMap_3A_element::reader_mSuperImplementationClassName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSuperImplementationClassName ;
}

//---------------------------------------------------------------------------*

GALGAS_classObservablePropertyMap GALGAS_entityMap_3A_element::reader_mPropertyMap (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mPropertyMap ;
}

//---------------------------------------------------------------------------*

GALGAS_attributeListForImplementation GALGAS_entityMap_3A_element::reader_mAttributeListForInitMethodHeader (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mAttributeListForInitMethodHeader ;
}

//---------------------------------------------------------------------------*

GALGAS_attributeListForImplementation GALGAS_entityMap_3A_element::reader_mInheritedAttributeListForImplementation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mInheritedAttributeListForImplementation ;
}

//---------------------------------------------------------------------------*

GALGAS_attributeListForImplementation GALGAS_entityMap_3A_element::reader_mAttributeListForImplementation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mAttributeListForImplementation ;
}

//---------------------------------------------------------------------------*

GALGAS_transientListForImplementation GALGAS_entityMap_3A_element::reader_mTransientListForImplementation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTransientListForImplementation ;
}

//---------------------------------------------------------------------------*

GALGAS_triggeredKeys GALGAS_entityMap_3A_element::reader_mTriggeredKeys (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTriggeredKeys ;
}

//---------------------------------------------------------------------------*

GALGAS_relationshipList GALGAS_entityMap_3A_element::reader_mCurrentRelationshipList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mCurrentRelationshipList ;
}

//---------------------------------------------------------------------------*

GALGAS_relationshipList GALGAS_entityMap_3A_element::reader_mAllRelationshipList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mAllRelationshipList ;
}

//---------------------------------------------------------------------------*

GALGAS_propertyMap GALGAS_entityMap_3A_element::reader_mAllPropertyMap (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mAllPropertyMap ;
}

//---------------------------------------------------------------------------*

GALGAS_relationshipMap GALGAS_entityMap_3A_element::reader_mCurrentRelationshipMap (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mCurrentRelationshipMap ;
}

//---------------------------------------------------------------------------*

GALGAS_relationshipMap GALGAS_entityMap_3A_element::reader_mAllRelationshipMap (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_entityMap_3A_element ("entityMap:element",
                                             NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_entityMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_entityMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_entityMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_entityMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_entityMap_3A_element GALGAS_entityMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                        C_Compiler * inCompiler,
                                                                        const GALGAS_location & inErrorLocation
                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_entityMap_3A_element result ;
  const GALGAS_entityMap_3A_element * p = (const GALGAS_entityMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_entityMap_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_outletBindingListForGeneration_3A_element::GALGAS_outletBindingListForGeneration_3A_element (void) :
...
GALGAS_outletBindingListForGeneration_3A_element::GALGAS_outletBindingListForGeneration_3A_element (const GALGAS_string & inOperand0,
                                                                                                    const GALGAS_formatterEnum & inOperand1,
                                                                                                    const GALGAS_string & inOperand2,
                                                                                                    const GALGAS_string & inOperand3,
                                                                                                    const GALGAS__32_stringlist & inOperand4) :
...
/* GALGAS_outletBindingListForGeneration_3A_element & GALGAS_outletBindingListForGeneration_3A_element::operator = (const GALGAS_outletBindingListForGeneration_3A_element & inOperand) {
  mAttribute_mBindingName = inOperand.mAttribute_mBindingName ;
  mAttribute_mRequiredFormatter = inOperand.mAttribute_mRequiredFormatter ;
  mAttribute_mObservedObjectName = inOperand.mAttribute_mObservedObjectName ;
  mAttribute_mObservableAttributeName = inOperand.mAttribute_mObservableAttributeName ;
  mAttribute_mOutletBindingOptionList = inOperand.mAttribute_mOutletBindingOptionList ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_outletBindingListForGeneration_3A_element GALGAS_outletBindingListForGeneration_3A_element::constructor_new (const GALGAS_string & inOperand0,
                                                                                                                    const GALGAS_formatterEnum & inOperand1,
                                                                                                                    const GALGAS_string & inOperand2,
                                                                                                                    const GALGAS_string & inOperand3,
                                                                                                                    const GALGAS__32_stringlist & inOperand4 
                                                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_outletBindingListForGeneration_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_outletBindingListForGeneration_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_outletBindingListForGeneration_3A_element::objectCompare (const GALGAS_outletBindingListForGeneration_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_outletBindingListForGeneration_3A_element::isValid (void) const {
...
void GALGAS_outletBindingListForGeneration_3A_element::drop (void) {
...
void GALGAS_outletBindingListForGeneration_3A_element::description (C_String & ioString,
                                                                    const PMSInt32 inIndentation) const {
...
GALGAS_string GALGAS_outletBindingListForGeneration_3A_element::reader_mBindingName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mBindingName ;
}

//---------------------------------------------------------------------------*

GALGAS_formatterEnum GALGAS_outletBindingListForGeneration_3A_element::reader_mRequiredFormatter (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRequiredFormatter ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_outletBindingListForGeneration_3A_element::reader_mObservedObjectName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mObservedObjectName ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_outletBindingListForGeneration_3A_element::reader_mObservableAttributeName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mObservableAttributeName ;
}

//---------------------------------------------------------------------------*

GALGAS__32_stringlist GALGAS_outletBindingListForGeneration_3A_element::reader_mOutletBindingOptionList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_outletBindingListForGeneration_3A_element ("outletBindingListForGeneration:element",
                                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_outletBindingListForGeneration_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_outletBindingListForGeneration_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_outletBindingListForGeneration_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_outletBindingListForGeneration_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_outletBindingListForGeneration_3A_element GALGAS_outletBindingListForGeneration_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                                  C_Compiler * inCompiler,
                                                                                                                  const GALGAS_location & inErrorLocation
                                                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_outletBindingListForGeneration_3A_element result ;
  const GALGAS_outletBindingListForGeneration_3A_element * p = (const GALGAS_outletBindingListForGeneration_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_outletBindingListForGeneration_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_outletGenerationList_3A_element::GALGAS_outletGenerationList_3A_element (void) :
...
GALGAS_outletGenerationList_3A_element::GALGAS_outletGenerationList_3A_element (const GALGAS_string & inOperand0,
                                                                                const GALGAS_string & inOperand1,
                                                                                const GALGAS_outletBindingListForGeneration & inOperand2) :
...
/* GALGAS_outletGenerationList_3A_element & GALGAS_outletGenerationList_3A_element::operator = (const GALGAS_outletGenerationList_3A_element & inOperand) {
  mAttribute_mOutletType = inOperand.mAttribute_mOutletType ;
  mAttribute_mOutletName = inOperand.mAttribute_mOutletName ;
  mAttribute_mOutletBindingList = inOperand.mAttribute_mOutletBindingList ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_outletGenerationList_3A_element GALGAS_outletGenerationList_3A_element::constructor_new (const GALGAS_string & inOperand0,
                                                                                                const GALGAS_string & inOperand1,
                                                                                                const GALGAS_outletBindingListForGeneration & inOperand2 
                                                                                                COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_outletGenerationList_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_outletGenerationList_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_outletGenerationList_3A_element::objectCompare (const GALGAS_outletGenerationList_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
...
bool GALGAS_outletGenerationList_3A_element::isValid (void) const {
  return mAttribute_mOutletType.isValid () && mAttribute_mOutletName.isValid () && mAttribute_mOutletBindingList.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_outletGenerationList_3A_element::drop (void) {
...
void GALGAS_outletGenerationList_3A_element::description (C_String & ioString,
                                                          const PMSInt32 inIndentation) const {
...
GALGAS_string GALGAS_outletGenerationList_3A_element::reader_mOutletType (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOutletType ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_outletGenerationList_3A_element::reader_mOutletName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOutletName ;
}

//---------------------------------------------------------------------------*

GALGAS_outletBindingListForGeneration GALGAS_outletGenerationList_3A_element::reader_mOutletBindingList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_outletGenerationList_3A_element ("outletGenerationList:element",
                                                        NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_outletGenerationList_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_outletGenerationList_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_outletGenerationList_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_outletGenerationList_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_outletGenerationList_3A_element GALGAS_outletGenerationList_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                              C_Compiler * inCompiler,
                                                                                              const GALGAS_location & inErrorLocation
                                                                                              COMMA_LOCATION_ARGS) {
  GALGAS_outletGenerationList_3A_element result ;
  const GALGAS_outletGenerationList_3A_element * p = (const GALGAS_outletGenerationList_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_outletGenerationList_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_preferencesMap_3A_element::GALGAS_preferencesMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mAttributeListForImplementation (),
mAttribute_mTransientListForImplementation (),
...
GALGAS_preferencesMap_3A_element::GALGAS_preferencesMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_preferencesMap_3A_element & GALGAS_preferencesMap_3A_element::operator = (const GALGAS_preferencesMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mAttributeListForImplementation = inOperand.mAttribute_mAttributeListForImplementation ;
  mAttribute_mTransientListForImplementation = inOperand.mAttribute_mTransientListForImplementation ;
  mAttribute_mOutletDeclarationList = inOperand.mAttribute_mOutletDeclarationList ;
  mAttribute_mTriggeredKeys = inOperand.mAttribute_mTriggeredKeys ;
  return *this ;
} */
...
GALGAS_preferencesMap_3A_element GALGAS_preferencesMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                    const GALGAS_attributeListForImplementation & inOperand1,
                                                                                    const GALGAS_transientListForImplementation & inOperand2,
                                                                                    const GALGAS_outletGenerationList & inOperand3,
                                                                                    const GALGAS_triggeredKeys & inOperand4 
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_preferencesMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_preferencesMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_preferencesMap_3A_element::objectCompare (const GALGAS_preferencesMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_preferencesMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mAttributeListForImplementation.isValid () && mAttribute_mTransientListForImplementation.isValid () && mAttribute_mOutletDeclarationList.isValid () && mAttribute_mTriggeredKeys.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_preferencesMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mAttributeListForImplementation.drop () ;
  mAttribute_mTransientListForImplementation.drop () ;
...
void GALGAS_preferencesMap_3A_element::description (C_String & ioString,
                                                    const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_preferencesMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_attributeListForImplementation GALGAS_preferencesMap_3A_element::reader_mAttributeListForImplementation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mAttributeListForImplementation ;
}

//---------------------------------------------------------------------------*

GALGAS_transientListForImplementation GALGAS_preferencesMap_3A_element::reader_mTransientListForImplementation (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTransientListForImplementation ;
}

//---------------------------------------------------------------------------*

GALGAS_outletGenerationList GALGAS_preferencesMap_3A_element::reader_mOutletDeclarationList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOutletDeclarationList ;
}

//---------------------------------------------------------------------------*

GALGAS_triggeredKeys GALGAS_preferencesMap_3A_element::reader_mTriggeredKeys (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTriggeredKeys ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_preferencesMap_3A_element ("preferencesMap:element",
                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_preferencesMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_preferencesMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_preferencesMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_preferencesMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_preferencesMap_3A_element GALGAS_preferencesMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                  C_Compiler * inCompiler,
                                                                                  const GALGAS_location & inErrorLocation
                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_preferencesMap_3A_element result ;
  const GALGAS_preferencesMap_3A_element * p = (const GALGAS_preferencesMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_preferencesMap_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_documentMap_3A_element::GALGAS_documentMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_documentMap_3A_element::GALGAS_documentMap_3A_element (const GALGAS_lstring & inOperand0,
                                                              const GALGAS_string & inOperand1,
                                                              const GALGAS_string & inOperand2,
                                                              const GALGAS_outletGenerationList & inOperand3,
...
/* GALGAS_documentMap_3A_element & GALGAS_documentMap_3A_element::operator = (const GALGAS_documentMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mRootEntityName = inOperand.mAttribute_mRootEntityName ;
  mAttribute_mRootEntityImplementationClassName = inOperand.mAttribute_mRootEntityImplementationClassName ;
  mAttribute_mOutletDeclarationList = inOperand.mAttribute_mOutletDeclarationList ;
  mAttribute_mControllerMap = inOperand.mAttribute_mControllerMap ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_documentMap_3A_element GALGAS_documentMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                              const GALGAS_string & inOperand1,
                                                                              const GALGAS_string & inOperand2,
                                                                              const GALGAS_outletGenerationList & inOperand3,
                                                                              const GALGAS_controllerMap & inOperand4 
                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_documentMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_documentMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_documentMap_3A_element::objectCompare (const GALGAS_documentMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_documentMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mRootEntityName.isValid () && mAttribute_mRootEntityImplementationClassName.isValid () && mAttribute_mOutletDeclarationList.isValid () && mAttribute_mControllerMap.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_documentMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_documentMap_3A_element::description (C_String & ioString,
                                                 const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_documentMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_documentMap_3A_element::reader_mRootEntityName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRootEntityName ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_documentMap_3A_element::reader_mRootEntityImplementationClassName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mRootEntityImplementationClassName ;
}

//---------------------------------------------------------------------------*

GALGAS_outletGenerationList GALGAS_documentMap_3A_element::reader_mOutletDeclarationList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mOutletDeclarationList ;
}

//---------------------------------------------------------------------------*

GALGAS_controllerMap GALGAS_documentMap_3A_element::reader_mControllerMap (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_documentMap_3A_element ("documentMap:element",
                                               NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_documentMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_documentMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_documentMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_documentMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_documentMap_3A_element GALGAS_documentMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                            C_Compiler * inCompiler,
                                                                            const GALGAS_location & inErrorLocation
                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_documentMap_3A_element result ;
  const GALGAS_documentMap_3A_element * p = (const GALGAS_documentMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_documentMap_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_outletClassBindingOptionMap_3A_element::GALGAS_outletClassBindingOptionMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_outletClassBindingOptionMap_3A_element::GALGAS_outletClassBindingOptionMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_outletClassBindingOptionMap_3A_element & GALGAS_outletClassBindingOptionMap_3A_element::operator = (const GALGAS_outletClassBindingOptionMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mAcceptableTypeList = inOperand.mAttribute_mAcceptableTypeList ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_outletClassBindingOptionMap_3A_element GALGAS_outletClassBindingOptionMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                              const GALGAS_easyBindingTypeList & inOperand1 
                                                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_outletClassBindingOptionMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid ()) {
    result = GALGAS_outletClassBindingOptionMap_3A_element (inOperand0, inOperand1) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_outletClassBindingOptionMap_3A_element::objectCompare (const GALGAS_outletClassBindingOptionMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_outletClassBindingOptionMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mAcceptableTypeList.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_outletClassBindingOptionMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_outletClassBindingOptionMap_3A_element::description (C_String & ioString,
                                                                 const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_outletClassBindingOptionMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_easyBindingTypeList GALGAS_outletClassBindingOptionMap_3A_element::reader_mAcceptableTypeList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_outletClassBindingOptionMap_3A_element ("outletClassBindingOptionMap:element",
                                                               NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_outletClassBindingOptionMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_outletClassBindingOptionMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_outletClassBindingOptionMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_outletClassBindingOptionMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_outletClassBindingOptionMap_3A_element GALGAS_outletClassBindingOptionMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                            C_Compiler * inCompiler,
                                                                                                            const GALGAS_location & inErrorLocation
                                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_outletClassBindingOptionMap_3A_element result ;
  const GALGAS_outletClassBindingOptionMap_3A_element * p = (const GALGAS_outletClassBindingOptionMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_outletClassBindingOptionMap_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_outletClassBindingMap_3A_element::GALGAS_outletClassBindingMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mAcceptableTypeList (),
...
GALGAS_outletClassBindingMap_3A_element::GALGAS_outletClassBindingMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_outletClassBindingMap_3A_element & GALGAS_outletClassBindingMap_3A_element::operator = (const GALGAS_outletClassBindingMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mAcceptableTypeList = inOperand.mAttribute_mAcceptableTypeList ;
  mAttribute_mOutletClassBindingOptionMap = inOperand.mAttribute_mOutletClassBindingOptionMap ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_outletClassBindingMap_3A_element GALGAS_outletClassBindingMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                                  const GALGAS_easyBindingTypeAndFormatterList & inOperand1,
                                                                                                  const GALGAS_outletClassBindingOptionMap & inOperand2 
                                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_outletClassBindingMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_outletClassBindingMap_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_outletClassBindingMap_3A_element::objectCompare (const GALGAS_outletClassBindingMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_outletClassBindingMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mAcceptableTypeList.isValid () && mAttribute_mOutletClassBindingOptionMap.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_outletClassBindingMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mAcceptableTypeList.drop () ;
...
void GALGAS_outletClassBindingMap_3A_element::description (C_String & ioString,
                                                           const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_outletClassBindingMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_easyBindingTypeAndFormatterList GALGAS_outletClassBindingMap_3A_element::reader_mAcceptableTypeList (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mAcceptableTypeList ;
}

//---------------------------------------------------------------------------*

GALGAS_outletClassBindingOptionMap GALGAS_outletClassBindingMap_3A_element::reader_mOutletClassBindingOptionMap (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_outletClassBindingMap_3A_element ("outletClassBindingMap:element",
                                                         NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_outletClassBindingMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_outletClassBindingMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_outletClassBindingMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_outletClassBindingMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_outletClassBindingMap_3A_element GALGAS_outletClassBindingMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                                C_Compiler * inCompiler,
                                                                                                const GALGAS_location & inErrorLocation
                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_outletClassBindingMap_3A_element result ;
  const GALGAS_outletClassBindingMap_3A_element * p = (const GALGAS_outletClassBindingMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_outletClassBindingMap_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_outletClassMap_3A_element::GALGAS_outletClassMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_outletClassMap_3A_element::GALGAS_outletClassMap_3A_element (const GALGAS_lstring & inOperand0,
...
/* GALGAS_outletClassMap_3A_element & GALGAS_outletClassMap_3A_element::operator = (const GALGAS_outletClassMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mGenerateCode = inOperand.mAttribute_mGenerateCode ;
  mAttribute_mSuperClassName = inOperand.mAttribute_mSuperClassName ;
  mAttribute_mBindingMap = inOperand.mAttribute_mBindingMap ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_outletClassMap_3A_element GALGAS_outletClassMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                    const GALGAS_bool & inOperand1,
                                                                                    const GALGAS_string & inOperand2,
                                                                                    const GALGAS_outletClassBindingMap & inOperand3 
                                                                                    COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_outletClassMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_outletClassMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_outletClassMap_3A_element::objectCompare (const GALGAS_outletClassMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_outletClassMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mGenerateCode.isValid () && mAttribute_mSuperClassName.isValid () && mAttribute_mBindingMap.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_outletClassMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_outletClassMap_3A_element::description (C_String & ioString,
                                                    const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_outletClassMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_outletClassMap_3A_element::reader_mGenerateCode (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mGenerateCode ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_outletClassMap_3A_element::reader_mSuperClassName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mSuperClassName ;
}

//---------------------------------------------------------------------------*

GALGAS_outletClassBindingMap GALGAS_outletClassMap_3A_element::reader_mBindingMap (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_outletClassMap_3A_element ("outletClassMap:element",
                                                  NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_outletClassMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_outletClassMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_outletClassMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_outletClassMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_outletClassMap_3A_element GALGAS_outletClassMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                  C_Compiler * inCompiler,
                                                                                  const GALGAS_location & inErrorLocation
                                                                                  COMMA_LOCATION_ARGS) {
  GALGAS_outletClassMap_3A_element result ;
  const GALGAS_outletClassMap_3A_element * p = (const GALGAS_outletClassMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_outletClassMap_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_controllerClassMap_3A_element::GALGAS_controllerClassMap_3A_element (void) :
mAttribute_lkey (),
mAttribute_mGenerateCode (),
mAttribute_mBindingMap () {
}
...
GALGAS_controllerClassMap_3A_element::GALGAS_controllerClassMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                            const GALGAS_bool & inOperand1,
...
/* GALGAS_controllerClassMap_3A_element & GALGAS_controllerClassMap_3A_element::operator = (const GALGAS_controllerClassMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mGenerateCode = inOperand.mAttribute_mGenerateCode ;
  mAttribute_mBindingMap = inOperand.mAttribute_mBindingMap ;
  return *this ;
...
GALGAS_controllerClassMap_3A_element GALGAS_controllerClassMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                            const GALGAS_bool & inOperand1,
                                                                                            const GALGAS_outletClassBindingMap & inOperand2 
                                                                                            COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_controllerClassMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_controllerClassMap_3A_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_controllerClassMap_3A_element::objectCompare (const GALGAS_controllerClassMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_controllerClassMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mGenerateCode.isValid () && mAttribute_mBindingMap.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_controllerClassMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
  mAttribute_mGenerateCode.drop () ;
  mAttribute_mBindingMap.drop () ;
}
...
void GALGAS_controllerClassMap_3A_element::description (C_String & ioString,
                                                        const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_controllerClassMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_controllerClassMap_3A_element::reader_mGenerateCode (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mGenerateCode ;
}

//---------------------------------------------------------------------------*

GALGAS_outletClassBindingMap GALGAS_controllerClassMap_3A_element::reader_mBindingMap (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mBindingMap ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_controllerClassMap_3A_element ("controllerClassMap:element",
                                                      NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_controllerClassMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_controllerClassMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_controllerClassMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_controllerClassMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_controllerClassMap_3A_element GALGAS_controllerClassMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                          C_Compiler * inCompiler,
                                                                                          const GALGAS_location & inErrorLocation
                                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_controllerClassMap_3A_element result ;
  const GALGAS_controllerClassMap_3A_element * p = (const GALGAS_controllerClassMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_controllerClassMap_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_controllerMap_3A_element::GALGAS_controllerMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_controllerMap_3A_element::GALGAS_controllerMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                  const GALGAS_string & inOperand1,
                                                                  const GALGAS_string & inOperand2,
...
/* GALGAS_controllerMap_3A_element & GALGAS_controllerMap_3A_element::operator = (const GALGAS_controllerMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mControllerClassName = inOperand.mAttribute_mControllerClassName ;
  mAttribute_mControlledClassOrEntityName = inOperand.mAttribute_mControlledClassOrEntityName ;
  mAttribute_mControllerBindingList = inOperand.mAttribute_mControllerBindingList ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_controllerMap_3A_element GALGAS_controllerMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                  const GALGAS_string & inOperand1,
                                                                                  const GALGAS_string & inOperand2,
                                                                                  const GALGAS_outletBindingListForGeneration & inOperand3 
                                                                                  COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_controllerMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid ()) {
    result = GALGAS_controllerMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_controllerMap_3A_element::objectCompare (const GALGAS_controllerMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_controllerMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mControllerClassName.isValid () && mAttribute_mControlledClassOrEntityName.isValid () && mAttribute_mControllerBindingList.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_controllerMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_controllerMap_3A_element::description (C_String & ioString,
                                                   const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_controllerMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_controllerMap_3A_element::reader_mControllerClassName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mControllerClassName ;
}

//---------------------------------------------------------------------------*

GALGAS_string GALGAS_controllerMap_3A_element::reader_mControlledClassOrEntityName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mControlledClassOrEntityName ;
}

//---------------------------------------------------------------------------*

GALGAS_outletBindingListForGeneration GALGAS_controllerMap_3A_element::reader_mControllerBindingList (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_controllerMap_3A_element ("controllerMap:element",
                                                 NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_controllerMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_controllerMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_controllerMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_controllerMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_controllerMap_3A_element GALGAS_controllerMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                C_Compiler * inCompiler,
                                                                                const GALGAS_location & inErrorLocation
                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_controllerMap_3A_element result ;
  const GALGAS_controllerMap_3A_element * p = (const GALGAS_controllerMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_controllerMap_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_relationshipMap_3A_element::GALGAS_relationshipMap_3A_element (void) :
mAttribute_lkey (),
...
GALGAS_relationshipMap_3A_element::GALGAS_relationshipMap_3A_element (const GALGAS_lstring & inOperand0,
                                                                      const GALGAS_bool & inOperand1,
...
/* GALGAS_relationshipMap_3A_element & GALGAS_relationshipMap_3A_element::operator = (const GALGAS_relationshipMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  mAttribute_mIsToMany = inOperand.mAttribute_mIsToMany ;
  mAttribute_mDestinationEntityName = inOperand.mAttribute_mDestinationEntityName ;
  mAttribute_mInverseRelationshipName = inOperand.mAttribute_mInverseRelationshipName ;
  mAttribute_mDeleteRule = inOperand.mAttribute_mDeleteRule ;
  return *this ;
} */

//---------------------------------------------------------------------------*

GALGAS_relationshipMap_3A_element GALGAS_relationshipMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0,
                                                                                      const GALGAS_bool & inOperand1,
                                                                                      const GALGAS_lstring & inOperand2,
                                                                                      const GALGAS_lstring & inOperand3,
                                                                                      const GALGAS_deleteRuleEnum & inOperand4 
                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_relationshipMap_3A_element result ;
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid ()) {
    result = GALGAS_relationshipMap_3A_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_relationshipMap_3A_element::objectCompare (const GALGAS_relationshipMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_relationshipMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mIsToMany.isValid () && mAttribute_mDestinationEntityName.isValid () && mAttribute_mInverseRelationshipName.isValid () && mAttribute_mDeleteRule.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_relationshipMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
...
void GALGAS_relationshipMap_3A_element::description (C_String & ioString,
                                                     const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_relationshipMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}

//---------------------------------------------------------------------------*

GALGAS_bool GALGAS_relationshipMap_3A_element::reader_mIsToMany (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mIsToMany ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_relationshipMap_3A_element::reader_mDestinationEntityName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mDestinationEntityName ;
}

//---------------------------------------------------------------------------*

GALGAS_lstring GALGAS_relationshipMap_3A_element::reader_mInverseRelationshipName (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mInverseRelationshipName ;
}

//---------------------------------------------------------------------------*

GALGAS_deleteRuleEnum GALGAS_relationshipMap_3A_element::reader_mDeleteRule (UNUSED_LOCATION_ARGS) const {
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_relationshipMap_3A_element ("relationshipMap:element",
                                                   NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_relationshipMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_relationshipMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_relationshipMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_relationshipMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_relationshipMap_3A_element GALGAS_relationshipMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                                    C_Compiler * inCompiler,
                                                                                    const GALGAS_location & inErrorLocation
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_relationshipMap_3A_element result ;
  const GALGAS_relationshipMap_3A_element * p = (const GALGAS_relationshipMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_relationshipMap_3A_element *> (p)) {
      result = *p ;
    }else{
...
GALGAS_propertyMap_3A_element::GALGAS_propertyMap_3A_element (void) :
mAttribute_lkey () {
}
...
GALGAS_propertyMap_3A_element::GALGAS_propertyMap_3A_element (const GALGAS_lstring & inOperand0) :
mAttribute_lkey (inOperand0) {
}

//---------------------------------------------------------------------------*

/* GALGAS_propertyMap_3A_element & GALGAS_propertyMap_3A_element::operator = (const GALGAS_propertyMap_3A_element & inOperand) {
  mAttribute_lkey = inOperand.mAttribute_lkey ;
  return *this ;
} */
...
GALGAS_propertyMap_3A_element GALGAS_propertyMap_3A_element::constructor_new (const GALGAS_lstring & inOperand0 
                                                                              COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_propertyMap_3A_element result ;
  if (inOperand0.isValid ()) {
    result = GALGAS_propertyMap_3A_element (inOperand0) ;
  }
  return result ;
}
...
typeComparisonResult GALGAS_propertyMap_3A_element::objectCompare (const GALGAS_propertyMap_3A_element & inOperand) const {
   typeComparisonResult result = kOperandEqual ;
  if (result == kOperandEqual) {
    result = mAttribute_lkey.objectCompare (inOperand.mAttribute_lkey) ;
  }
...
bool GALGAS_propertyMap_3A_element::isValid (void) const {
  return mAttribute_lkey.isValid () ;
}

//---------------------------------------------------------------------------*

void GALGAS_propertyMap_3A_element::drop (void) {
  mAttribute_lkey.drop () ;
}

//---------------------------------------------------------------------------*

void GALGAS_propertyMap_3A_element::description (C_String & ioString,
                                                 const PMSInt32 inIndentation) const {
...
GALGAS_lstring GALGAS_propertyMap_3A_element::reader_lkey (UNUSED_LOCATION_ARGS) const {
  return mAttribute_lkey ;
}
...
const C_galgas_type_descriptor
kTypeDescriptor_GALGAS_propertyMap_3A_element ("propertyMap:element",
                                               NULL) ;

//---------------------------------------------------------------------------*

const C_galgas_type_descriptor * GALGAS_propertyMap_3A_element::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_propertyMap_3A_element ;
}

//---------------------------------------------------------------------------*

AC_GALGAS_root * GALGAS_propertyMap_3A_element::clonedObject (void) const {
  AC_GALGAS_root * result = NULL ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_propertyMap_3A_element (*this)) ;
  }
  return result ;
}
...
GALGAS_propertyMap_3A_element GALGAS_propertyMap_3A_element::extractObject (const GALGAS_object & inObject,
                                                                            C_Compiler * inCompiler,
                                                                            const GALGAS_location & inErrorLocation
                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_propertyMap_3A_element result ;
  const GALGAS_propertyMap_3A_element * p = (const GALGAS_propertyMap_3A_element *) inObject.embeddedObject () ;
  if (NULL != p) {
    if (NULL != dynamic_cast <const GALGAS_propertyMap_3A_element *> (p)) {
      result = *p ;
    }else{
