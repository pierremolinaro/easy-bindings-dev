...
cMapElement * cMapElement_classMap::copy (void) {
  ...
  macroMyNew (result, cMapElement_classMap (mAttribute_lkey, mAttribute_mSuperClassName, mAttribute_mPropertyMap, mAttribute_mAttributeListForInitMethodHeader, mAttribute_mInheritedAttributeListForImplementation, mAttribute_mAttributeListForImplementation, mAttribute_mTransientListForImplementation COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_classMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  macroMyNew (p, cMapElement_classMap (inKey, inArgument0, inArgument1, inArgument2, inArgument3, inArgument4, inArgument5 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
GALGAS_classMap_2E_element cEnumerator_classMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cMapElement_classMap) ;
  return GALGAS_classMap_2E_element (p->mAttribute_lkey, p->mAttribute_mSuperClassName, p->mAttribute_mPropertyMap, p->mAttribute_mAttributeListForInitMethodHeader, p->mAttribute_mInheritedAttributeListForImplementation, p->mAttribute_mAttributeListForImplementation, p->mAttribute_mTransientListForImplementation) ;
}
...
bool cMapElement_preferencesMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mAttributeListForImplementation.isValid () && mAttribute_mTransientListForImplementation.isValid () && mAttribute_mOutletDeclarationList.isValid () && mAttribute_mActionList.isValid () && mAttribute_mObservablePropertyMap.isValid () ;
}
...
cMapElement * cMapElement_preferencesMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_preferencesMap (mAttribute_lkey, mAttribute_mAttributeListForImplementation, mAttribute_mTransientListForImplementation, mAttribute_mOutletDeclarationList, mAttribute_mActionList, mAttribute_mObservablePropertyMap COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_preferencesMap::modifier_insertKey (GALGAS_lstring inKey,
                                                ...
                                                GALGAS_classObservablePropertyMap inArgument4,
                                                C_Compiler * inCompiler
                                                COMMA_LOCATION_ARGS) {
...
GALGAS_classObservablePropertyMap GALGAS_preferencesMap::reader_mObservablePropertyMapForKey (const GALGAS_string & inKey,
                                                                                              C_Compiler * inCompiler
                                                                                              COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_preferencesMap * p = (const cMapElement_preferencesMap *) attributes ;
...
void GALGAS_preferencesMap::modifier_setMObservablePropertyMapForKey (GALGAS_classObservablePropertyMap inAttributeValue,
                                                                      GALGAS_string inKey,
                                                                      C_Compiler * inCompiler
                                                                      COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
...
GALGAS_preferencesMap_2E_element cEnumerator_preferencesMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cMapElement_preferencesMap) ;
  return GALGAS_preferencesMap_2E_element (p->mAttribute_lkey, p->mAttribute_mAttributeListForImplementation, p->mAttribute_mTransientListForImplementation, p->mAttribute_mOutletDeclarationList, p->mAttribute_mActionList, p->mAttribute_mObservablePropertyMap) ;
}
...
GALGAS_classObservablePropertyMap cEnumerator_preferencesMap::current_mObservablePropertyMap (LOCATION_ARGS) const {
  const cMapElement_preferencesMap * p = (const cMapElement_preferencesMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_preferencesMap) ;
  return p->mAttribute_mObservablePropertyMap ;
}
...
bool cMapElement_documentMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mRootEntityName.isValid () && mAttribute_mRootEntityImplementationClassName.isValid () && mAttribute_mOutletDeclarationList.isValid () && mAttribute_mControllerMap.isValid () && mAttribute_mActionList.isValid () && mAttribute_mTransientListForImplementation.isValid () ;
}
...
cMapElement * cMapElement_documentMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_documentMap (mAttribute_lkey, mAttribute_mRootEntityName, mAttribute_mRootEntityImplementationClassName, mAttribute_mOutletDeclarationList, mAttribute_mControllerMap, mAttribute_mActionList, mAttribute_mTransientListForImplementation COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_documentMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  macroMyNew (p, cMapElement_documentMap (inKey, inArgument0, inArgument1, inArgument2, inArgument3, inArgument4, inArgument5 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
GALGAS_documentMap_2E_element cEnumerator_documentMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cMapElement_documentMap) ;
  return GALGAS_documentMap_2E_element (p->mAttribute_lkey, p->mAttribute_mRootEntityName, p->mAttribute_mRootEntityImplementationClassName, p->mAttribute_mOutletDeclarationList, p->mAttribute_mControllerMap, p->mAttribute_mActionList, p->mAttribute_mTransientListForImplementation) ;
}
...
void routine_analyzeEntities (const GALGAS_entityList constinArgument_inEntityList,
  ...
  outArgument_outEntityMap = GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (333)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityList enumerator_13594 (constinArgument_inEntityList, kEnumeration_up) ;
  ...
  while (enumerator_13594.hasCurrentObject ()) {
    ...
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (336)) ;
    //-------- @localVariableDeclarationForGeneration
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_13594.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (341)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_14011_0 ; // Joker input parameter
      GALGAS_string joker_14060_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_14148_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_14148_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_14148_2 ; // Joker input parameter
      GALGAS_relationshipList joker_14148_1 ; // Joker input parameter
      GALGAS_relationshipMap joker_14213_0 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_13594.current_mSuperEntityName (HERE), joker_14011_0, var_implementationSuperClassName, joker_14060_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_14148_4, joker_14148_3, joker_14148_2, joker_14148_1, var_allRelationshipList, var_allPropertyMap, joker_14213_0, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (342)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (356)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (357)) ;
      //-------- @assignmentInstructionForGeneration
      var_implementationSuperClassName = GALGAS_string::makeEmptyString () ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipList = GALGAS_relationshipList::constructor_emptyList (SOURCE_FILE_AT_LINE (359)) ;
      //-------- @assignmentInstructionForGeneration
      var_allPropertyMap = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (360)) ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (361)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (363)) ;
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_14905 (enumerator_13594.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_14905.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_14905.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_14905.current_mType (HERE), enumerator_14905.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (367)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_14905.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (368)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_14905.current_mType (HERE), enumerator_14905.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (369)), enumerator_14905.current_mDefaultValueObjectiveCObject (HERE), enumerator_14905.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (369)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_14905.current_mType (HERE), enumerator_14905.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (370)), enumerator_14905.current_mDefaultValueObjectiveCObject (HERE), enumerator_14905.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (370)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_14905.current_mAttributeName (HERE), enumerator_14905.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_14905.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (371)) COMMA_SOURCE_FILE_AT_LINE (371)), inCompiler COMMA_SOURCE_FILE_AT_LINE (371)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_14905.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_relationshipMap var_currentRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (374)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipList enumerator_15600 (enumerator_13594.current_mRelationshipList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_15600.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allRelationshipMap.modifier_insertKey (enumerator_15600.current_mRelationshipName (HERE), enumerator_15600.current_mIsToMany (HERE), enumerator_15600.current_mDestinationEntityName (HERE), enumerator_15600.current_mInverseRelationshipName (HERE), enumerator_15600.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (376)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_currentRelationshipMap.modifier_insertKey (enumerator_15600.current_mRelationshipName (HERE), enumerator_15600.current_mIsToMany (HERE), enumerator_15600.current_mDestinationEntityName (HERE), enumerator_15600.current_mInverseRelationshipName (HERE), enumerator_15600.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (383)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_15600.current_mRelationshipName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (390)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_13594.current_mTransientList (HERE), GALGAS_classObservableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (396)), var_classObservablePropertyMap, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (394)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outEntityMap.modifier_insertKey (enumerator_13594.current_mEntityName (HERE), enumerator_13594.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (403)), enumerator_13594.current_mImplementationClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (404)), var_implementationSuperClassName, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, enumerator_13594.current_mRelationshipList (HERE), var_allRelationshipList.operator_concat (enumerator_13594.current_mRelationshipList (HERE) COMMA_SOURCE_FILE_AT_LINE (412)), var_allPropertyMap, var_currentRelationshipMap, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (401)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_13594.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityMap enumerator_16908 (outArgument_outEntityMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_16908.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipMap enumerator_16947 (enumerator_16908.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_16947.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_17063_12 ; // Joker input parameter
      GALGAS_string joker_17063_11 ; // Joker input parameter
      GALGAS_string joker_17063_10 ; // Joker input parameter
      GALGAS_classObservablePropertyMap joker_17063_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_17063_8 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_17063_7 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_17063_6 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_17063_5 ; // Joker input parameter
      GALGAS_relationshipList joker_17063_4 ; // Joker input parameter
      GALGAS_relationshipList joker_17063_3 ; // Joker input parameter
      GALGAS_propertyMap joker_17063_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_17063_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_16947.current_mDestinationEntityName (HERE), joker_17063_12, joker_17063_11, joker_17063_10, joker_17063_9, joker_17063_8, joker_17063_7, joker_17063_6, joker_17063_5, joker_17063_4, joker_17063_3, joker_17063_2, joker_17063_1, var_destinationEntityRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (422)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_inverseOfInverseRelationshipName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_17230_2 ; // Joker input parameter
      GALGAS_lstring joker_17230_1 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_17268_0 ; // Joker input parameter
      var_destinationEntityRelationshipMap.method_searchKey (enumerator_16947.current_mInverseRelationshipName (HERE), joker_17230_2, joker_17230_1, var_inverseOfInverseRelationshipName, joker_17268_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (424)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_16947.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_2 (enumerator_16947.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_16947.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (426)) COMMA_SOURCE_FILE_AT_LINE (426)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (426)) COMMA_SOURCE_FILE_AT_LINE (426)) ;
      }
...
void routine_analyzePreferences (const GALGAS_entityMap constinArgument_inEntityMap,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (607)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_24303 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_24303.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservablePropertyMap var_observableAttributeMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (609)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (611)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_24480 (enumerator_24303.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_24480.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_24480.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (613)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_24480.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (616)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_24683 (enumerator_24303.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_24683.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_24683.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_24683.current_mType (HERE), enumerator_24683.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (618)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_24683.current_mType (HERE), enumerator_24683.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (619)), enumerator_24683.current_mDefaultValueObjectiveCObject (HERE), enumerator_24683.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (619)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_24683.current_mAttributeName (HERE), enumerator_24683.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_24683.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (620)) COMMA_SOURCE_FILE_AT_LINE (620)), inCompiler COMMA_SOURCE_FILE_AT_LINE (620)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_24303.current_mTransientList (HERE), GALGAS_classObservableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (626)), var_observableAttributeMap, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (624)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservableObjectMap var_observableObjectMap = GALGAS_classObservableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (631)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (633)), GALGAS_string ("self"), var_observableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (632)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (638)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_25654 (enumerator_24303.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_25654.hasCurrentObject ()) {
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_25781_2 ; // Joker input parameter
      GALGAS_string joker_25781_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_25654.current_mOutletType (HERE), joker_25781_2, joker_25781_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (642)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (643)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_25925 (enumerator_25654.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_25925.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_25925.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (649)), var_actionMap, var_hasTableValueBinding, var_outletBindingList, inCompiler COMMA_SOURCE_FILE_AT_LINE (645)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_25925.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_25654.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (655)), enumerator_25654.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (655)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (655)) ;
      enumerator_25654.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outPreferencesMap.modifier_insertKey (enumerator_24303.current_mPreferencesName (HERE), var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, enumerator_24303.current_mActionDeclarationList (HERE), var_observableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (658)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outBindingOptionListForGeneration = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (697)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_27839 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_27839.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_27839.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (700)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_28028 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (702)).isValidAndTrue () ;
    if (enumerator_28028.hasCurrentObject () && bool_0) {
      while (enumerator_28028.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_28092 (enumerator_27839.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (703)).isValidAndTrue () ;
        if (enumerator_28092.hasCurrentObject () && bool_1) {
          while (enumerator_28092.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_28028.current_mType (HERE).objectCompare (enumerator_28092.current_mType (HERE))) ;
            enumerator_28092.gotoNextObject () ;
            if (enumerator_28092.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (703)).isValidAndTrue () ;
            }
          }
        }
        enumerator_28028.gotoNextObject () ;
        if (enumerator_28028.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (702)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (707)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_28331 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (709)).isValidAndTrue () ;
      if (enumerator_28331.hasCurrentObject () && bool_3) {
        while (enumerator_28331.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_28331.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (710)) COMMA_SOURCE_FILE_AT_LINE (710)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (710)) COMMA_SOURCE_FILE_AT_LINE (710)) ;
          enumerator_28331.gotoNextObject () ;
          if (enumerator_28331.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (709)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_27839.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (712)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_27839.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (714)), enumerator_27839.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (714)) ;
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (830)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_33273 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_33273.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    ...
    GALGAS_relationshipMap var_allRelationshipMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_33478_0 ; // Joker input parameter
    GALGAS_string joker_33528_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_33566_8 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_33566_7 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_33566_6 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_33566_5 ; // Joker input parameter
    GALGAS_relationshipList joker_33566_4 ; // Joker input parameter
    GALGAS_relationshipList joker_33566_3 ; // Joker input parameter
    GALGAS_propertyMap joker_33566_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_33566_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_33273.current_mRootEntityName (HERE), joker_33478_0, var_rootEntityImplementationClassName, joker_33528_0, var_observablePropertyMap, joker_33566_8, joker_33566_7, joker_33566_6, joker_33566_5, joker_33566_4, joker_33566_3, joker_33566_2, joker_33566_1, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (835)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservableObjectMap var_observableObjectMap = GALGAS_classObservableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (845)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("root").reader_nowhere (SOURCE_FILE_AT_LINE (847)), GALGAS_string ("mRootObject"), var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (846)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_preferencesMap enumerator_33854 (constinArgument_inPreferencesMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_33854.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_33854.current (HERE).mAttribute_lkey, enumerator_33854.current (HERE).mAttribute_lkey.mAttribute_string, enumerator_33854.current (HERE).mAttribute_mObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (852)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_33854.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (859)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerList enumerator_34107 (enumerator_33273.current_mControllerList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_34107.hasCurrentObject ()) {
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_34350_0 ; // Joker input parameter
      constinArgument_inControllerClassMap.method_searchKey (enumerator_34107.current_mControllerClassName (HERE), joker_34350_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (864)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_34107.current_mControllerName (HERE), enumerator_34107.current_mControllerName (HERE).mAttribute_string, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (871)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_34676_13 ; // Joker input parameter
      GALGAS_string joker_34676_12 ; // Joker input parameter
      GALGAS_string joker_34676_11 ; // Joker input parameter
      GALGAS_classObservablePropertyMap joker_34676_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_34676_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_34676_8 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_34676_7 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_34676_6 ; // Joker input parameter
      GALGAS_relationshipList joker_34676_5 ; // Joker input parameter
      GALGAS_relationshipList joker_34676_4 ; // Joker input parameter
      GALGAS_propertyMap joker_34676_3 ; // Joker input parameter
      GALGAS_relationshipMap joker_34676_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_34676_1 ; // Joker input parameter
      constinArgument_inEntityMap.method_searchKey (enumerator_34107.current_mControlledClassOrEntityName (HERE), joker_34676_13, joker_34676_12, joker_34676_11, joker_34676_10, joker_34676_9, joker_34676_8, joker_34676_7, joker_34676_6, joker_34676_5, joker_34676_4, joker_34676_3, joker_34676_2, joker_34676_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (876)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (877)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_34797 (enumerator_34107.current_mControllerBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_34797.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_34797.current_mBinding (HERE).ptr (), var_allRelationshipMap, var_controllerClassBindingMap, enumerator_34107.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (879)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_34797.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_controllerMap.modifier_insertKey (enumerator_34107.current_mControllerName (HERE), enumerator_34107.current_mControllerClassName (HERE).mAttribute_string, enumerator_34107.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, var_controllerActionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (887)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_33273.current_mTransientList (HERE), var_observableObjectMap, var_observablePropertyMap, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (897)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_documentActionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (904)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_35658 (enumerator_33273.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_35658.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_documentActionMap.modifier_insertKey (enumerator_35658.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (906)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_35658.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (910)), GALGAS_string ("self"), var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (909)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (914)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_35966 (enumerator_33273.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_35966.hasCurrentObject ()) {
      ...
      GALGAS_bool var_hasTableValueBinding ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_36093_2 ; // Joker input parameter
      GALGAS_string joker_36093_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_35966.current_mOutletType (HERE), joker_36093_2, joker_36093_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (918)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (919)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_36237 (enumerator_35966.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_36237.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_36237.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, var_controllerMap, var_documentActionMap, var_hasTableValueBinding, var_outletBindingList, inCompiler COMMA_SOURCE_FILE_AT_LINE (921)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_36237.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_35966.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (931)), enumerator_35966.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (931)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (931)) ;
      enumerator_35966.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outDocumentMap.modifier_insertKey (enumerator_33273.current_mDocumentName (HERE), enumerator_33273.current_mRootEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (936)), var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, enumerator_33273.current_mActionDeclarationList (HERE), var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (934)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_33273.gotoNextObject () ;
  }
}
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_37244 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (954)).isValidAndTrue () ;
  if (enumerator_37244.hasCurrentObject () && bool_0) {
    while (enumerator_37244.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_37244.current_mType (HERE))) ;
      enumerator_37244.gotoNextObject () ;
      if (enumerator_37244.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (954)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (957)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (958)) ;
  }
}
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (968)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_37672 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_37672.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_classObservablePropertyMap var_classObservablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (971)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_37672.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (972)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_37907_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_37971_3 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_37971_2 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_37971_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_37672.current_mSuperClassName (HERE), joker_37907_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_37971_3, joker_37971_2, joker_37971_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (973)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (975)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (976)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (978)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_38391 (enumerator_37672.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_38391.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_38391.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_38391.current_mType (HERE), enumerator_38391.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (981)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_38391.current_mType (HERE), enumerator_38391.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (982)), enumerator_38391.current_mDefaultValueObjectiveCObject (HERE), enumerator_38391.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (982)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_38391.current_mType (HERE), enumerator_38391.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (983)), enumerator_38391.current_mDefaultValueObjectiveCObject (HERE), enumerator_38391.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (983)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_38391.current_mAttributeName (HERE), enumerator_38391.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_38391.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (984)) COMMA_SOURCE_FILE_AT_LINE (984)), inCompiler COMMA_SOURCE_FILE_AT_LINE (984)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_38391.gotoNextObject () ;
    }
    //-------- @localVariableDeclarationForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (enumerator_37672.current_mTransientList (HERE), GALGAS_classObservableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (990)), var_classObservablePropertyMap, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (988)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_37672.current_mClassName (HERE), enumerator_37672.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (997)), var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (995)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1013)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_39765 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_39765.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1016)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_39862 (enumerator_39765.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_39862.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1018)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_39974 (enumerator_39862.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_39974.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_39974.current_mBindingOptionName (HERE), enumerator_39974.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1020)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_39974.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_39862.current_mBindingName (HERE), enumerator_39862.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1026)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_39862.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_39765.current_mOutletClassName (HERE), enumerator_39765.current_mGenerateCode (HERE), enumerator_39765.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, enumerator_39765.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1029)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1045)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_40806 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_40806.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1048)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_40915 (enumerator_40806.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_40915.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_40915.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1050)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_40915.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1053)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_41067 (enumerator_40806.current_mBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_41067.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1055)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_41179 (enumerator_41067.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_41179.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_41179.current_mBindingOptionName (HERE), enumerator_41179.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1057)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_41179.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_41067.current_mBindingName (HERE), enumerator_41067.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1063)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_41067.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservablePropertyMap var_observablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1066)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerObservablePropertyList enumerator_41630 (enumerator_40806.current_mControllerObservablePropertyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_41630.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_41630.current (HERE).mAttribute_mPropertyName, enumerator_41630.current (HERE).mAttribute_mType, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1068)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1068)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_41630.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outControllerClassMap.modifier_insertKey (enumerator_40806.current_mOutletClassName (HERE), enumerator_40806.current_mGenerateCode (HERE), var_bindingMap, var_actionMap, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1071)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  outArgument_outDocumentMap.drop () ; // Release 'out' argument
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1092)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1093)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1094)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1095)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (outArgument_outEntityMap, constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1096)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outPreferencesMap, outArgument_outDocumentMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1097)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
static GALGAS_string categoryReader_tableValueBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_columnBindingForTableValueBindingForGeneration enumerator_5549 (object->mAttribute_mColumnBindingForTableValueBindingForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_5549.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("  if (nil == [").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (enumerator_5549.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (GALGAS_string ("\"]) {\n") COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (GALGAS_string ("' NSTableView outlet has no formatter has no column with the ") COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (enumerator_5549.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (GALGAS_string (" identifier\") ;\n") COMMA_SOURCE_FILE_AT_LINE (152)).operator_concat (GALGAS_string ("  }else{\n") COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (GALGAS_string ("    NSActionCell * cell = [") COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (enumerator_5549.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (GALGAS_string ("\"].dataCell ;\n") COMMA_SOURCE_FILE_AT_LINE (154)).operator_concat (GALGAS_string ("    if (! [cell isKindOfClass:[") COMMA_SOURCE_FILE_AT_LINE (155)).operator_concat (enumerator_5549.current (HERE).mAttribute_mRequiredCellClass COMMA_SOURCE_FILE_AT_LINE (155)).operator_concat (GALGAS_string (" class]]) {\n") COMMA_SOURCE_FILE_AT_LINE (155)).operator_concat (GALGAS_string ("      presentErrorWindow (__FILE__, __LINE__, @\"the dataCell is '") COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (enumerator_5549.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (GALGAS_string ("' column of the '") COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (GALGAS_string ("' should be an '") COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (enumerator_5549.current (HERE).mAttribute_mRequiredCellClass COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (GALGAS_string (" instance\") ;\n") COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (GALGAS_string ("    }\n") COMMA_SOURCE_FILE_AT_LINE (157)).operator_concat (GALGAS_string ("  }\n") COMMA_SOURCE_FILE_AT_LINE (158)).operator_concat (GALGAS_string ("  [[") COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (enumerator_5549.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (GALGAS_string ("\"]\n") COMMA_SOURCE_FILE_AT_LINE (159)).operator_concat (GALGAS_string ("    bind:@\"value\"\n") COMMA_SOURCE_FILE_AT_LINE (160)).operator_concat (GALGAS_string ("    toObject:") COMMA_SOURCE_FILE_AT_LINE (161)).operator_concat (object->mAttribute_mControllerName COMMA_SOURCE_FILE_AT_LINE (161)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (161)).operator_concat (GALGAS_string ("    withKeyPath:@\"arrangedObjects.") COMMA_SOURCE_FILE_AT_LINE (162)).operator_concat (enumerator_5549.current (HERE).mAttribute_mObservableAttributeName COMMA_SOURCE_FILE_AT_LINE (162)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (162)).operator_concat (GALGAS_string ("    options:") COMMA_SOURCE_FILE_AT_LINE (163)) COMMA_SOURCE_FILE_AT_LINE (151)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_5549.current (HERE).mAttribute_mOutletBindingOptionList.reader_length (SOURCE_FILE_AT_LINE (164)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_6873 (enumerator_5549.current (HERE).mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_6873.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("      ").operator_concat (enumerator_6873.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (169)).operator_concat (GALGAS_string (", @") COMMA_SOURCE_FILE_AT_LINE (169)).operator_concat (enumerator_6873.current_mValue_30_ (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (169)) COMMA_SOURCE_FILE_AT_LINE (169)).operator_concat (GALGAS_string (",\n") COMMA_SOURCE_FILE_AT_LINE (169)) COMMA_SOURCE_FILE_AT_LINE (169)) ;
...
static GALGAS_string categoryReader_regularBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator__32_stringlist enumerator_8996 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_8996.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("      ").operator_concat (enumerator_8996.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (GALGAS_string (", @") COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (enumerator_8996.current_mValue_30_ (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (210)) COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (GALGAS_string (",\n") COMMA_SOURCE_FILE_AT_LINE (210)) COMMA_SOURCE_FILE_AT_LINE (210)) ;
...
static void categoryMethod_tableValueBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inHasTableValueBinding.operator_not (SOURCE_FILE_AT_LINE (455)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mControllerName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("this outlet does not support $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (456)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_18680_0 ; // Joker input parameter
    GALGAS_actionMap joker_18753_0 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_18680_0, var_controlledClassOrEntityName, var_controllerBindingList, joker_18753_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (460)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_classObservablePropertyMap var_observablePropertyMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_18854_3 ; // Joker input parameter
    GALGAS_string joker_18854_2 ; // Joker input parameter
    GALGAS_string joker_18854_1 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_18921_9 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_18921_8 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_18921_7 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_18921_6 ; // Joker input parameter
    GALGAS_relationshipList joker_18921_5 ; // Joker input parameter
    GALGAS_relationshipList joker_18921_4 ; // Joker input parameter
    GALGAS_propertyMap joker_18921_3 ; // Joker input parameter
    GALGAS_relationshipMap joker_18921_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_18921_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (GALGAS_lstring::constructor_new (var_controlledClassOrEntityName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (468)), joker_18854_3, joker_18854_2, joker_18854_1, var_observablePropertyMap, joker_18921_9, joker_18921_8, joker_18921_7, joker_18921_6, joker_18921_5, joker_18921_4, joker_18921_3, joker_18921_2, joker_18921_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (467)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_columnBindingForTableValueBindingForGeneration var_columnBindingForTableValueBindingForGeneration = GALGAS_columnBindingForTableValueBindingForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (473)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_tableValueColumnBinding enumerator_19089 (object->mAttribute_mTableValueColumnBinding, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_19089.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingType var_type ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_stringlist joker_19219_0 ; // Joker input parameter
      var_observablePropertyMap.method_searchKey (enumerator_19089.current (HERE).mAttribute_mBoundPropertyName, var_type, joker_19219_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (476)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_requiredCellTypeInTableColumnBinding = categoryReader_requiredCellTypeInTableColumnBinding (var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (481)) ;
      //-------- @ifInstructionForGeneration
      ...
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_19089.current (HERE).mAttribute_mBoundPropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("this property cannot be named in a $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (483)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_requiredCellTypeInTableColumnBinding.objectCompare (enumerator_19089.current (HERE).mAttribute_mCellTypeName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_19089.current (HERE).mAttribute_mCellTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("this property requires a ").operator_concat (var_requiredCellTypeInTableColumnBinding COMMA_SOURCE_FILE_AT_LINE (485)).operator_concat (GALGAS_string (" cell class") COMMA_SOURCE_FILE_AT_LINE (485)) COMMA_SOURCE_FILE_AT_LINE (485)) ;
        }
      }
      //-------- @plusEqualnstructionForGeneration
      var_columnBindingForTableValueBindingForGeneration.addAssign_operation (enumerator_19089.current (HERE).mAttribute_mColumnName.mAttribute_string, var_requiredCellTypeInTableColumnBinding, enumerator_19089.current (HERE).mAttribute_mBoundPropertyName.mAttribute_string, GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (491)) COMMA_SOURCE_FILE_AT_LINE (487)) ;
      enumerator_19089.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_tableValueBindingForGeneration::constructor_new (object->mAttribute_mControllerName.mAttribute_string, var_columnBindingForTableValueBindingForGeneration COMMA_SOURCE_FILE_AT_LINE (494)) COMMA_SOURCE_FILE_AT_LINE (494)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_inActionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (513)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_actionMap var_actionMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_20756_3 ; // Joker input parameter
    GALGAS_string joker_20756_2 ; // Joker input parameter
    GALGAS_outletBindingListForGeneration joker_20756_1 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mTargetName, joker_20756_3, joker_20756_2, joker_20756_1, var_actionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (516)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
    var_actionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (517)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_runBindingForGeneration::constructor_new (object->mAttribute_mTargetName.mAttribute_string, object->mAttribute_mActionName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (519)) COMMA_SOURCE_FILE_AT_LINE (519)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (538)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  ...
  GALGAS_classObservablePropertyMap var_observablePropertyMap ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inObservableObjectMap.reader_hasKey (object->mAttribute_mObservedObjectName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (542)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_inObservableObjectMap.method_searchKey (GALGAS_lstring::constructor_new (object->mAttribute_mObservedObjectName.mAttribute_string, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (544)), var_observedObjectOCName, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (543)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mObservedObjectName.reader_string (SOURCE_FILE_AT_LINE (550)) COMMA_SOURCE_FILE_AT_LINE (550)).operator_concat (GALGAS_string ("' object is not observable") COMMA_SOURCE_FILE_AT_LINE (550)) COMMA_SOURCE_FILE_AT_LINE (549)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_stringlist joker_22301_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_22301_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (555)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_22471 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (559)).isValidAndTrue () ;
  if (enumerator_22471.hasCurrentObject () && bool_2) {
    while (enumerator_22471.hasCurrentObject () && bool_2) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_22471.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_22471.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_22471.gotoNextObject () ;
      if (enumerator_22471.hasCurrentObject ()) {
        bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (559)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (563)).boolEnum () ;
  if (kBoolTrue == test_3) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_22775 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (565)).isValidAndTrue () ;
    if (enumerator_22775.hasCurrentObject () && bool_4) {
      while (enumerator_22775.hasCurrentObject () && bool_4) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_22775.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (566)) COMMA_SOURCE_FILE_AT_LINE (566)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (566)) COMMA_SOURCE_FILE_AT_LINE (566)) ;
        enumerator_22775.gotoNextObject () ;
        if (enumerator_22775.hasCurrentObject ()) {
          bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (565)).isValidAndTrue () ;
        }
      }
    }
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_5, var_s COMMA_SOURCE_FILE_AT_LINE (568)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (571)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_23010 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_23010.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_23010.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (574)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_23199 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (576)).isValidAndTrue () ;
    if (enumerator_23199.hasCurrentObject () && bool_6) {
      while (enumerator_23199.hasCurrentObject () && bool_6) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_23263 (enumerator_23010.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (577)).isValidAndTrue () ;
        if (enumerator_23263.hasCurrentObject () && bool_7) {
          while (enumerator_23263.hasCurrentObject () && bool_7) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_23199.current_mType (HERE).objectCompare (enumerator_23263.current_mType (HERE))) ;
            enumerator_23263.gotoNextObject () ;
            if (enumerator_23263.hasCurrentObject ()) {
              bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (577)).isValidAndTrue () ;
            }
          }
        }
        enumerator_23199.gotoNextObject () ;
        if (enumerator_23199.hasCurrentObject ()) {
          bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (576)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (581)).boolEnum () ;
    if (kBoolTrue == test_8) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_23502 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (583)).isValidAndTrue () ;
      if (enumerator_23502.hasCurrentObject () && bool_9) {
        while (enumerator_23502.hasCurrentObject () && bool_9) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_23502.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (584)) COMMA_SOURCE_FILE_AT_LINE (584)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (584)) COMMA_SOURCE_FILE_AT_LINE (584)) ;
          enumerator_23502.gotoNextObject () ;
          if (enumerator_23502.hasCurrentObject ()) {
            bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (583)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_10 (enumerator_23010.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_10, var_s COMMA_SOURCE_FILE_AT_LINE (586)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_23010.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (588)), enumerator_23010.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (588)) ;
    enumerator_23010.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (591)), var_requiredFormatter, var_observedObjectOCName, object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (594)), var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (590)) COMMA_SOURCE_FILE_AT_LINE (590)) ;
}
//---------------------------------------------------------------------------*
...
GALGAS_string categoryReader_ebTypeIdentifier (const GALGAS_easyBindingType & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inClassOrEntityName COMMA_SOURCE_FILE_AT_LINE (686)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (686)) ;
      } break ;
    }
  }
//---
...
static void categoryMethod_tableValueBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (737)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $run action") COMMA_SOURCE_FILE_AT_LINE (749)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @assignmentInstructionForGeneration
    var_resultingObservedPropertyPath = GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (765)) COMMA_SOURCE_FILE_AT_LINE (765)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("observed object should be 'root'") COMMA_SOURCE_FILE_AT_LINE (767)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (773)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_stringlist joker_31083_0 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_31083_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (775)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (776)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (777)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_31379_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_31379_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_31379_2, joker_31379_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (780)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (782)) COMMA_SOURCE_FILE_AT_LINE (782)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (782)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (784)) COMMA_SOURCE_FILE_AT_LINE (784)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (784)) ;
      }
    }else if (kBoolFalse == test_3) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_5 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (787)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (793)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_32010 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (796)).isValidAndTrue () ;
  if (enumerator_32010.hasCurrentObject () && bool_6) {
    while (enumerator_32010.hasCurrentObject () && bool_6) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_32010.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (797)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (798)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (798)) COMMA_SOURCE_FILE_AT_LINE (798)) ;
      //-------- @assignmentInstructionForGeneration
      ...
      if (enumerator_32010.hasCurrentObject ()) {
        bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (796)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (801)).boolEnum () ;
  if (kBoolTrue == test_7) {
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_8, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (803)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (803)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (803)) COMMA_SOURCE_FILE_AT_LINE (802)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (806)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (813)), var_resultingObservedObjectName, var_resultingObservedPropertyPath, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (811)) COMMA_SOURCE_FILE_AT_LINE (811)) ;
}
//---------------------------------------------------------------------------*
...
GALGAS_classMap_2E_element GALGAS_classMap_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid ()) {
    result = GALGAS_classMap_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6) ;
  }
  return result ;
}
...
GALGAS_preferencesMap_2E_element::GALGAS_preferencesMap_2E_element (const GALGAS_lstring & inOperand0,
                                                                    ...
                                                                    const GALGAS_classObservablePropertyMap & inOperand5) :
mAttribute_lkey (inOperand0),
...
GALGAS_classObservablePropertyMap GALGAS_preferencesMap_2E_element::reader_mObservablePropertyMap (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mObservablePropertyMap ;
}
...
GALGAS_documentMap_2E_element GALGAS_documentMap_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid () && inOperand3.isValid () && inOperand4.isValid () && inOperand5.isValid () && inOperand6.isValid ()) {
    result = GALGAS_documentMap_2E_element (inOperand0, inOperand1, inOperand2, inOperand3, inOperand4, inOperand5, inOperand6) ;
  }
  return result ;
}
