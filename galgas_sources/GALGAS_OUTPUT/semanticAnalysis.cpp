...
void routine_analyzeEntities (const GALGAS_entityList constinArgument_inEntityList,
  ...
  while (enumerator_15020.hasCurrentObject ()) {
    ...
    while (enumerator_16318.hasCurrentObject ()) {
      ...
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("entity.").operator_concat (enumerator_15020.current_mEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (417)) COMMA_SOURCE_FILE_AT_LINE (417)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (417)).operator_concat (enumerator_16318.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (417)) COMMA_SOURCE_FILE_AT_LINE (417)), enumerator_16318.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (416)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_16318.current_mAttributeName (HERE), enumerator_16318.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_16318.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (423)) COMMA_SOURCE_FILE_AT_LINE (423)), var_observationDependencyKey, inCompiler COMMA_SOURCE_FILE_AT_LINE (420)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_16318.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_relationshipMap var_currentRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (428)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipList enumerator_17224 (enumerator_15020.current_mRelationshipList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_17224.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allRelationshipMap.modifier_insertKey (enumerator_17224.current_mRelationshipName (HERE), enumerator_17224.current_mIsToMany (HERE), enumerator_17224.current_mDestinationEntityName (HERE), enumerator_17224.current_mInverseRelationshipName (HERE), enumerator_17224.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (430)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_currentRelationshipMap.modifier_insertKey (enumerator_17224.current_mRelationshipName (HERE), enumerator_17224.current_mIsToMany (HERE), enumerator_17224.current_mDestinationEntityName (HERE), enumerator_17224.current_mInverseRelationshipName (HERE), enumerator_17224.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (437)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_17224.current_mRelationshipName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (444)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("entity.").operator_concat (enumerator_15020.current_mEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (446)) COMMA_SOURCE_FILE_AT_LINE (446)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (446)).operator_concat (enumerator_17224.current_mRelationshipName (HERE).reader_string (SOURCE_FILE_AT_LINE (446)) COMMA_SOURCE_FILE_AT_LINE (446)), enumerator_17224.current_mRelationshipName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (445)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_17224.current_mRelationshipName (HERE), GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (451)), GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (452)), var_observationDependencyKey, inCompiler COMMA_SOURCE_FILE_AT_LINE (449)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_17224.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (457)) ;
    //-------- @localVariableDeclarationForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (GALGAS_string ("entity.").operator_concat (enumerator_15020.current_mEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (460)) COMMA_SOURCE_FILE_AT_LINE (460)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (460)), enumerator_15020.current_mTransientList (HERE), GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (462)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (459)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS__32_stringlist var_toManyRelationshipList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (469)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipList enumerator_18552 (enumerator_15020.current_mRelationshipList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_18552.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = enumerator_18552.current_mIsToMany (HERE).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @plusEqualnstructionForGeneration
        var_toManyRelationshipList.addAssign_operation (enumerator_18552.current_mRelationshipName (HERE).mAttribute_string, enumerator_18552.current_mDestinationEntityName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (472)) ;
      }
      enumerator_18552.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (477)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outEntityMap.modifier_insertKey (enumerator_15020.current_mEntityName (HERE), enumerator_15020.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (480)), enumerator_15020.current_mImplementationClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (481)), var_implementationSuperClassName, var_observablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, enumerator_15020.current_mRelationshipList (HERE), var_allRelationshipList.operator_concat (enumerator_15020.current_mRelationshipList (HERE) COMMA_SOURCE_FILE_AT_LINE (489)), var_allPropertyMap, var_currentRelationshipMap, var_allRelationshipMap, var_implementationFileInclusionSet, var_toManyRelationshipList, inCompiler COMMA_SOURCE_FILE_AT_LINE (478)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_15020.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityMap enumerator_19421 (outArgument_outEntityMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_19421.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipMap enumerator_19460 (enumerator_19421.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_19460.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_19576_12 ; // Joker input parameter
      GALGAS_string joker_19576_11 ; // Joker input parameter
      GALGAS_string joker_19576_10 ; // Joker input parameter
      GALGAS_observablePropertyMap joker_19576_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_19576_8 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_19576_7 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_19576_6 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_19576_5 ; // Joker input parameter
      GALGAS_relationshipList joker_19576_4 ; // Joker input parameter
      GALGAS_relationshipList joker_19576_3 ; // Joker input parameter
      GALGAS_propertyMap joker_19576_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_19576_1 ; // Joker input parameter
      GALGAS_stringset joker_19614_2 ; // Joker input parameter
      GALGAS__32_stringlist joker_19614_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_19460.current_mDestinationEntityName (HERE), joker_19576_12, joker_19576_11, joker_19576_10, joker_19576_9, joker_19576_8, joker_19576_7, joker_19576_6, joker_19576_5, joker_19576_4, joker_19576_3, joker_19576_2, joker_19576_1, var_destinationEntityRelationshipMap, joker_19614_2, joker_19614_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (501)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_inverseOfInverseRelationshipName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_19747_2 ; // Joker input parameter
      GALGAS_lstring joker_19747_1 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_19785_0 ; // Joker input parameter
      var_destinationEntityRelationshipMap.method_searchKey (enumerator_19460.current_mInverseRelationshipName (HERE), joker_19747_2, joker_19747_1, var_inverseOfInverseRelationshipName, joker_19785_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (503)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_2 = GALGAS_bool (kIsNotEqual, enumerator_19460.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_19460.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_19460.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (505)) COMMA_SOURCE_FILE_AT_LINE (505)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (505)) COMMA_SOURCE_FILE_AT_LINE (505)) ;
      }
      enumerator_19460.gotoNextObject () ;
    }
...
void routine_analyzePreferences (const GALGAS_entityMap constinArgument_inEntityMap,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (793)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_31151 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_31151.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_observableAttributeMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (795)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (797)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_31323 (enumerator_31151.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_31323.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_31323.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (799)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_31323.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (802)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_31526 (enumerator_31151.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_31526.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_31526.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_31526.current_mType (HERE), enumerator_31526.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (804)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_31526.current_mType (HERE), enumerator_31526.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (805)), enumerator_31526.current_mDefaultValueObjectiveCObject (HERE), enumerator_31526.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (805)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_lstring var_observationDependancyKey = GALGAS_lstring::constructor_new (GALGAS_string ("preferences.").operator_concat (enumerator_31151.current_mPreferencesName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (807)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (807)).operator_concat (enumerator_31526.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (807)) COMMA_SOURCE_FILE_AT_LINE (807)), enumerator_31526.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (806)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_31526.current_mAttributeName (HERE), enumerator_31526.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_31526.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (813)) COMMA_SOURCE_FILE_AT_LINE (813)), var_observationDependancyKey, inCompiler COMMA_SOURCE_FILE_AT_LINE (810)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependancyKey, var_observationDependancyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (816)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (823)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (GALGAS_string ("preferences.").operator_concat (enumerator_31151.current_mPreferencesName (HERE).reader_string (SOURCE_FILE_AT_LINE (825)) COMMA_SOURCE_FILE_AT_LINE (825)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (825)), enumerator_31151.current_mTransientList (HERE), GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (827)), var_observableAttributeMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (824)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observableObjectMap var_observableObjectMap = GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (834)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (836)), GALGAS_string ("self"), GALGAS_string::makeEmptyString (), var_observableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (835)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (842)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_33062 (enumerator_31151.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_33062.hasCurrentObject ()) {
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_33189_2 ; // Joker input parameter
      GALGAS_string joker_33189_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_33062.current_mOutletType (HERE), joker_33189_2, joker_33189_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (846)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (847)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_33333 (enumerator_33062.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_33333.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_33333.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (853)), var_actionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (849)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_33333.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_33062.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (860)), enumerator_33062.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (860)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (860)) ;
      enumerator_33062.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (863)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outPreferencesMap.modifier_insertKey (enumerator_31151.current_mPreferencesName (HERE), var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, enumerator_31151.current_mActionDeclarationList (HERE), var_observableAttributeMap, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (864)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_31151.gotoNextObject () ;
  }
}
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outBindingOptionListForGeneration = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (905)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_35438 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_35438.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_35438.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (908)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_35627 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (910)).isValidAndTrue () ;
    if (enumerator_35627.hasCurrentObject () && bool_0) {
      while (enumerator_35627.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_35691 (enumerator_35438.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (911)).isValidAndTrue () ;
        if (enumerator_35691.hasCurrentObject () && bool_1) {
          while (enumerator_35691.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_35627.current_mType (HERE).objectCompare (enumerator_35691.current_mType (HERE))) ;
            enumerator_35691.gotoNextObject () ;
            if (enumerator_35691.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (911)).isValidAndTrue () ;
            }
          }
        }
        enumerator_35627.gotoNextObject () ;
        if (enumerator_35627.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (910)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (915)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_35930 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (917)).isValidAndTrue () ;
      if (enumerator_35930.hasCurrentObject () && bool_3) {
        while (enumerator_35930.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_35930.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (918)) COMMA_SOURCE_FILE_AT_LINE (918)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (918)) COMMA_SOURCE_FILE_AT_LINE (918)) ;
          enumerator_35930.gotoNextObject () ;
          if (enumerator_35930.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (917)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_35438.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (920)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_35438.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (922)), enumerator_35438.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (922)) ;
    enumerator_35438.gotoNextObject () ;
  }
}
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1051)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_41451 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_41451.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    ...
    GALGAS_relationshipMap var_allRelationshipMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_41661_0 ; // Joker input parameter
    GALGAS_string joker_41711_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_41759_8 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_41759_7 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_41759_6 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_41759_5 ; // Joker input parameter
    GALGAS_relationshipList joker_41759_4 ; // Joker input parameter
    GALGAS_relationshipList joker_41759_3 ; // Joker input parameter
    GALGAS_propertyMap joker_41759_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_41759_1 ; // Joker input parameter
    GALGAS_stringset joker_41795_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_41795_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_41451.current_mRootEntityName (HERE), joker_41661_0, var_rootEntityImplementationClassName, joker_41711_0, var_rootObjectObservablePropertyMap, joker_41759_8, joker_41759_7, joker_41759_6, joker_41759_5, joker_41759_4, joker_41759_3, joker_41759_2, joker_41759_1, var_allRelationshipMap, joker_41795_2, joker_41795_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1056)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observableObjectMap var_observableObjectMap = GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1067)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("root").reader_nowhere (SOURCE_FILE_AT_LINE (1069)), GALGAS_string ("mRootObject"), GALGAS_string::makeEmptyString (), var_rootObjectObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1068)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @foreachInstructionForGeneration
    cEnumerator_preferencesMap enumerator_42093 (constinArgument_inPreferencesMap, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42093.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_42093.current (HERE).mAttribute_lkey, GALGAS_string ("g_").operator_concat (enumerator_42093.current (HERE).mAttribute_lkey.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1077)), enumerator_42093.current (HERE).mAttribute_lkey.mAttribute_string, enumerator_42093.current (HERE).mAttribute_mObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1075)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_42093.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1083)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1084)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerList enumerator_42443 (enumerator_41451.current_mControllerList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42443.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_42681_0 ; // Joker input parameter
      constinArgument_inControllerClassMap.method_searchKey (enumerator_42443.current_mControllerClassName (HERE), joker_42681_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1089)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_42443.current_mControllerName (HERE), enumerator_42443.current_mControllerName (HERE).mAttribute_string, GALGAS_string::makeEmptyString (), var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1096)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_43040_15 ; // Joker input parameter
      GALGAS_string joker_43040_14 ; // Joker input parameter
      GALGAS_string joker_43040_13 ; // Joker input parameter
      GALGAS_observablePropertyMap joker_43040_12 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_43040_11 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_43040_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_43040_9 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_43040_8 ; // Joker input parameter
      GALGAS_relationshipList joker_43040_7 ; // Joker input parameter
      GALGAS_relationshipList joker_43040_6 ; // Joker input parameter
      GALGAS_propertyMap joker_43040_5 ; // Joker input parameter
      GALGAS_relationshipMap joker_43040_4 ; // Joker input parameter
      GALGAS_relationshipMap joker_43040_3 ; // Joker input parameter
      GALGAS_stringset joker_43040_2 ; // Joker input parameter
      GALGAS__32_stringlist joker_43040_1 ; // Joker input parameter
      constinArgument_inEntityMap.method_searchKey (enumerator_42443.current_mControlledClassOrEntityName (HERE), joker_43040_15, joker_43040_14, joker_43040_13, joker_43040_12, joker_43040_11, joker_43040_10, joker_43040_9, joker_43040_8, joker_43040_7, joker_43040_6, joker_43040_5, joker_43040_4, joker_43040_3, joker_43040_2, joker_43040_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1102)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1103)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_43161 (enumerator_42443.current_mControllerBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_43161.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_43161.current_mBinding (HERE).ptr (), var_allRelationshipMap, var_controllerClassBindingMap, enumerator_42443.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1105)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_43161.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_controllerMap.modifier_insertKey (enumerator_42443.current_mControllerName (HERE), enumerator_42443.current_mControllerClassName (HERE).mAttribute_string, enumerator_42443.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, var_controllerActionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1113)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_42443.gotoNextObject () ;
    }
    //-------- @localVariableDeclarationForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1123)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (GALGAS_string ("document.").operator_concat (enumerator_41451.current_mDocumentName (HERE).reader_string (SOURCE_FILE_AT_LINE (1125)) COMMA_SOURCE_FILE_AT_LINE (1125)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1125)), enumerator_41451.current_mTransientList (HERE), var_observableObjectMap, var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1124)) ;
    } //-------- @routineCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_documentActionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1134)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_44196 (enumerator_41451.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_44196.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_documentActionMap.modifier_insertKey (enumerator_44196.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1136)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_44196.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (1140)), GALGAS_string ("self"), GALGAS_string::makeEmptyString (), var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1139)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1145)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_44535 (enumerator_41451.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_44535.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_bindingMap ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_bool var_hasTableValueBinding ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_44662_2 ; // Joker input parameter
      GALGAS_string joker_44662_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_44535.current_mOutletType (HERE), joker_44662_2, joker_44662_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1149)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1150)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_44806 (enumerator_44535.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_44806.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_44806.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, var_controllerMap, var_documentActionMap, var_hasTableValueBinding, var_outletBindingList, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1152)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_44806.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_44535.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1163)), enumerator_44535.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1163)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1163)) ;
      enumerator_44535.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1166)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outDocumentMap.modifier_insertKey (enumerator_41451.current_mDocumentName (HERE), enumerator_41451.current_mRootEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (1169)), var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, enumerator_41451.current_mActionDeclarationList (HERE), var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1167)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_41451.gotoNextObject () ;
  }
}
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_45949 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1188)).isValidAndTrue () ;
  if (enumerator_45949.hasCurrentObject () && bool_0) {
    while (enumerator_45949.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_45949.current_mType (HERE))) ;
      enumerator_45949.gotoNextObject () ;
      if (enumerator_45949.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1188)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1191)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (1192)) ;
  }
}
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1203)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_46434 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_46434.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1206)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_46434.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1207)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_46659_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_46718_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_46718_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_46718_2 ; // Joker input parameter
      GALGAS_stringset joker_46718_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_46434.current_mSuperClassName (HERE), joker_46659_0, var_observablePropertyMap, var_propertyListForInitMethodHeader, joker_46718_4, joker_46718_3, joker_46718_2, joker_46718_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1208)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1210)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1211)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1213)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_47128 (enumerator_46434.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_47128.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_47128.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_47128.current_mType (HERE), enumerator_47128.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1216)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_47128.current_mType (HERE), enumerator_47128.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1217)), enumerator_47128.current_mDefaultValueObjectiveCObject (HERE), enumerator_47128.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1217)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_47128.current_mType (HERE), enumerator_47128.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1218)), enumerator_47128.current_mDefaultValueObjectiveCObject (HERE), enumerator_47128.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1218)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("class.").operator_concat (enumerator_46434.current_mClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1220)) COMMA_SOURCE_FILE_AT_LINE (1220)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1220)).operator_concat (enumerator_47128.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1220)) COMMA_SOURCE_FILE_AT_LINE (1220)), enumerator_47128.current_mAttributeName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1219)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_47128.current_mAttributeName (HERE), enumerator_47128.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_47128.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1226)) COMMA_SOURCE_FILE_AT_LINE (1226)), var_observationDependencyKey, inCompiler COMMA_SOURCE_FILE_AT_LINE (1223)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1232)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (GALGAS_string ("class.").operator_concat (enumerator_46434.current_mClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1234)) COMMA_SOURCE_FILE_AT_LINE (1234)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1234)), enumerator_46434.current_mTransientList (HERE), GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1236)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1233)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1243)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_46434.current_mClassName (HERE), enumerator_46434.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1246)), var_observablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1244)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1263)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_48957 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_48957.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1266)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_49054 (enumerator_48957.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_49054.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1268)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_49166 (enumerator_49054.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_49166.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_49166.current_mBindingOptionName (HERE), enumerator_49166.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1270)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_49166.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_49054.current_mBindingName (HERE), enumerator_49054.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1276)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_49054.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_48957.current_mOutletClassName (HERE), enumerator_48957.current_mGenerateCode (HERE), enumerator_48957.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, enumerator_48957.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1279)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1295)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_49998 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_49998.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1298)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_50107 (enumerator_49998.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_50107.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_50107.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1300)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_50107.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1303)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_50259 (enumerator_49998.current_mBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_50259.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1305)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_50371 (enumerator_50259.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_50371.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_50371.current_mBindingOptionName (HERE), enumerator_50371.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1307)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_50371.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_50259.current_mBindingName (HERE), enumerator_50259.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1313)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_50259.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1316)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerObservablePropertyList enumerator_50817 (enumerator_49998.current_mControllerObservablePropertyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_50817.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (GALGAS_string ("controller.").operator_concat (enumerator_49998.current_mOutletClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1319)) COMMA_SOURCE_FILE_AT_LINE (1319)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1319)).operator_concat (enumerator_50817.current (HERE).mAttribute_mPropertyName.reader_string (SOURCE_FILE_AT_LINE (1319)) COMMA_SOURCE_FILE_AT_LINE (1319)), enumerator_50817.current (HERE).mAttribute_mPropertyName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (1318)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_50817.current (HERE).mAttribute_mPropertyName, enumerator_50817.current (HERE).mAttribute_mType, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1325)), var_observationDependencyKey, inCompiler COMMA_SOURCE_FILE_AT_LINE (1322)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_50817.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outControllerClassMap.modifier_insertKey (enumerator_49998.current_mOutletClassName (HERE), enumerator_49998.current_mGenerateCode (HERE), var_bindingMap, var_actionMap, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1330)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outSortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1352)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (1353)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1354)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1355)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1356)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1361)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (outArgument_outEntityMap, constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1366)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outPreferencesMap, outArgument_outDocumentMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1373)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1383)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, var_transientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (1384)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_1) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_lstringlist enumerator_52775 (var_transientDependencyGraph.reader_undefinedNodeReferenceList (SOURCE_FILE_AT_LINE (1385)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_52775.hasCurrentObject ()) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_2 (enumerator_52775.current_mValue (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (enumerator_52775.current_mValue (HERE).reader_string (SOURCE_FILE_AT_LINE (1386)) COMMA_SOURCE_FILE_AT_LINE (1386)).operator_concat (GALGAS_string ("' transient node is not defined") COMMA_SOURCE_FILE_AT_LINE (1386)) COMMA_SOURCE_FILE_AT_LINE (1386)) ;
        enumerator_52775.gotoNextObject () ;
      }
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstringlist joker_53063_0 ; // Joker input parameter
      var_transientDependencyGraph.method_topologicalSort (outArgument_outSortedTransientOrderedList, joker_53063_0, var_unsortedTransientList, var_unsortedNodeKeyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1391)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1397)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1398)).reader_string (SOURCE_FILE_AT_LINE (1398)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:") COMMA_SOURCE_FILE_AT_LINE (1398)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_53353 (var_unsortedTransientList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_53353.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_53353.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1400)) COMMA_SOURCE_FILE_AT_LINE (1400)) ;
          enumerator_53353.gotoNextObject () ;
        }
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inAST.mAttribute_mEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (1402)) ;
      }
    }
  }
}
...
static void categoryMethod_tableValueBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inHasTableValueBinding.operator_not (SOURCE_FILE_AT_LINE (536)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mControllerName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("this outlet does not support $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (537)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    ...
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_21290_0, var_controlledClassOrEntityName, var_controllerBindingList, joker_21363_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (541)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_21464_3 ; // Joker input parameter
    GALGAS_string joker_21464_2 ; // Joker input parameter
    GALGAS_string joker_21464_1 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21527_11 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21527_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_21527_9 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_21527_8 ; // Joker input parameter
    GALGAS_relationshipList joker_21527_7 ; // Joker input parameter
    GALGAS_relationshipList joker_21527_6 ; // Joker input parameter
    GALGAS_propertyMap joker_21527_5 ; // Joker input parameter
    GALGAS_relationshipMap joker_21527_4 ; // Joker input parameter
    GALGAS_relationshipMap joker_21527_3 ; // Joker input parameter
    GALGAS_stringset joker_21527_2 ; // Joker input parameter
    GALGAS__32_stringlist joker_21527_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (GALGAS_lstring::constructor_new (var_controlledClassOrEntityName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (549)), joker_21464_3, joker_21464_2, joker_21464_1, var_observablePropertyMap, joker_21527_11, joker_21527_10, joker_21527_9, joker_21527_8, joker_21527_7, joker_21527_6, joker_21527_5, joker_21527_4, joker_21527_3, joker_21527_2, joker_21527_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (548)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_columnBindingForTableValueBindingForGeneration var_columnBindingForTableValueBindingForGeneration = GALGAS_columnBindingForTableValueBindingForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (554)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_tableValueColumnBinding enumerator_21695 (object->mAttribute_mTableValueColumnBinding, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_21695.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingType var_type ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_stringlist joker_21825_2 ; // Joker input parameter
      GALGAS_lstring joker_21825_1 ; // Joker input parameter
      var_observablePropertyMap.method_searchKey (enumerator_21695.current (HERE).mAttribute_mBoundPropertyName, var_type, joker_21825_2, joker_21825_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (557)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_requiredCellTypeInTableColumnBinding = categoryReader_requiredCellTypeInTableColumnBinding (var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (562)) ;
      //-------- @ifInstructionForGeneration
      ...
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_21695.current (HERE).mAttribute_mBoundPropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("this property cannot be named in a $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (564)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_requiredCellTypeInTableColumnBinding.objectCompare (enumerator_21695.current (HERE).mAttribute_mCellTypeName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_21695.current (HERE).mAttribute_mCellTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("this property requires a ").operator_concat (var_requiredCellTypeInTableColumnBinding COMMA_SOURCE_FILE_AT_LINE (566)).operator_concat (GALGAS_string (" cell class") COMMA_SOURCE_FILE_AT_LINE (566)) COMMA_SOURCE_FILE_AT_LINE (566)) ;
        }
      }
      //-------- @plusEqualnstructionForGeneration
      var_columnBindingForTableValueBindingForGeneration.addAssign_operation (enumerator_21695.current (HERE).mAttribute_mColumnName.mAttribute_string, var_requiredCellTypeInTableColumnBinding, enumerator_21695.current (HERE).mAttribute_mBoundPropertyName.mAttribute_string, GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (572)) COMMA_SOURCE_FILE_AT_LINE (568)) ;
      enumerator_21695.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_tableValueBindingForGeneration::constructor_new (object->mAttribute_mControllerName.mAttribute_string, var_columnBindingForTableValueBindingForGeneration COMMA_SOURCE_FILE_AT_LINE (575)) COMMA_SOURCE_FILE_AT_LINE (575)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_inActionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (595)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_actionMap var_actionMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_23413_3 ; // Joker input parameter
    GALGAS_string joker_23413_2 ; // Joker input parameter
    GALGAS_outletBindingListForGeneration joker_23413_1 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mTargetName, joker_23413_3, joker_23413_2, joker_23413_1, var_actionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (598)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
    var_actionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (599)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_runBindingForGeneration::constructor_new (object->mAttribute_mTargetName.mAttribute_string, object->mAttribute_mActionName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (601)) COMMA_SOURCE_FILE_AT_LINE (601)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @methodCallInstructionForGeneration
    constinArgument_inObservableObjectMap.method_searchKey (GALGAS_lstring::constructor_new (object->mAttribute_mObservedObjectName.mAttribute_string, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (628)), var_observedObjectOCName, var_includeFile, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (627)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioImplementationFileInclusionSet.addAssign_operation (var_includeFile COMMA_SOURCE_FILE_AT_LINE (633)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mObservedObjectName.reader_string (SOURCE_FILE_AT_LINE (636)) COMMA_SOURCE_FILE_AT_LINE (636)).operator_concat (GALGAS_string ("' object is not observable") COMMA_SOURCE_FILE_AT_LINE (636)) COMMA_SOURCE_FILE_AT_LINE (635)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_stringlist joker_25085_2 ; // Joker input parameter
  GALGAS_lstring joker_25085_1 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_25085_2, joker_25085_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (641)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  if (kBoolTrue == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_observablePropertyType.objectCompare (GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (645)))).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @concatInstructionForGeneration
      var_observableKeyPath.dotAssign_operation (GALGAS_string (".@count") COMMA_SOURCE_FILE_AT_LINE (646)) ;
      //-------- @assignmentInstructionForGeneration
      var_observablePropertyType = GALGAS_easyBindingType::constructor_uintegerType (SOURCE_FILE_AT_LINE (647)) ;
      ...
      inCompiler->emitSemanticError (location_4, GALGAS_string ("the 'count' path is only allowed for to-many relationships") COMMA_SOURCE_FILE_AT_LINE (649)) ;
    }
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (654)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_25685 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (655)).isValidAndTrue () ;
  if (enumerator_25685.hasCurrentObject () && bool_5) {
    while (enumerator_25685.hasCurrentObject () && bool_5) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_25685.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_25685.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_25685.gotoNextObject () ;
      if (enumerator_25685.hasCurrentObject ()) {
        bool_5 = var_found.operator_not (SOURCE_FILE_AT_LINE (655)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (659)).boolEnum () ;
  if (kBoolTrue == test_6) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (660)) COMMA_SOURCE_FILE_AT_LINE (660)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (660)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_25989 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (661)).isValidAndTrue () ;
    if (enumerator_25989.hasCurrentObject () && bool_7) {
      while (enumerator_25989.hasCurrentObject () && bool_7) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_25989.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (662)) COMMA_SOURCE_FILE_AT_LINE (662)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (662)) COMMA_SOURCE_FILE_AT_LINE (662)) ;
        enumerator_25989.gotoNextObject () ;
        if (enumerator_25989.hasCurrentObject ()) {
    ...
    inCompiler->emitSemanticError (location_8, var_s COMMA_SOURCE_FILE_AT_LINE (664)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (667)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_26224 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_26224.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_26224.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (670)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_26413 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (672)).isValidAndTrue () ;
    if (enumerator_26413.hasCurrentObject () && bool_9) {
      while (enumerator_26413.hasCurrentObject () && bool_9) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_26477 (enumerator_26224.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (673)).isValidAndTrue () ;
        if (enumerator_26477.hasCurrentObject () && bool_10) {
          while (enumerator_26477.hasCurrentObject () && bool_10) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_26413.current_mType (HERE).objectCompare (enumerator_26477.current_mType (HERE))) ;
            enumerator_26477.gotoNextObject () ;
            if (enumerator_26477.hasCurrentObject ()) {
              bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (673)).isValidAndTrue () ;
            }
          }
        }
        enumerator_26413.gotoNextObject () ;
        if (enumerator_26413.hasCurrentObject ()) {
          bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (672)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_11 = var_found.operator_not (SOURCE_FILE_AT_LINE (677)).boolEnum () ;
    if (kBoolTrue == test_11) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_26716 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_12 = var_found.operator_not (SOURCE_FILE_AT_LINE (679)).isValidAndTrue () ;
      if (enumerator_26716.hasCurrentObject () && bool_12) {
        while (enumerator_26716.hasCurrentObject () && bool_12) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_26716.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (680)) COMMA_SOURCE_FILE_AT_LINE (680)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (680)) COMMA_SOURCE_FILE_AT_LINE (680)) ;
          enumerator_26716.gotoNextObject () ;
          if (enumerator_26716.hasCurrentObject ()) {
            bool_12 = var_found.operator_not (SOURCE_FILE_AT_LINE (679)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_13 (enumerator_26224.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_13, var_s COMMA_SOURCE_FILE_AT_LINE (682)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_26224.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (684)), enumerator_26224.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (684)) ;
    enumerator_26224.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (687)), var_requiredFormatter, var_observedObjectOCName, var_observableKeyPath, var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (686)) COMMA_SOURCE_FILE_AT_LINE (686)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_multiValuedBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  GALGAS_easyBindingTypeAndFormatterList var_acceptableTypeFormatterList ;
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (709)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_multiValuedBindingList enumerator_28015 (object->mAttribute_mMultiValuedBindingList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_28015.hasCurrentObject ()) {
    ...
    GALGAS_observablePropertyMap var_observablePropertyMap ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = constinArgument_inObservableObjectMap.reader_hasKey (enumerator_28015.current_mBoundObjectName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (716)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_string var_includeFile ;
      //-------- @methodCallInstructionForGeneration
      constinArgument_inObservableObjectMap.method_searchKey (GALGAS_lstring::constructor_new (enumerator_28015.current_mBoundObjectName (HERE).mAttribute_string, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (719)), var_observedObjectOCName, var_includeFile, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (718)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      ioArgument_ioImplementationFileInclusionSet.addAssign_operation (var_includeFile COMMA_SOURCE_FILE_AT_LINE (724)) ;
    }else if (kBoolFalse == test_0) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_1 (enumerator_28015.current_mBoundObjectName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (enumerator_28015.current_mBoundObjectName (HERE).reader_string (SOURCE_FILE_AT_LINE (727)) COMMA_SOURCE_FILE_AT_LINE (727)).operator_concat (GALGAS_string ("' object is not observable") COMMA_SOURCE_FILE_AT_LINE (727)) COMMA_SOURCE_FILE_AT_LINE (726)) ;
      var_observedObjectOCName.drop () ; // Release error dropped variable
      var_observablePropertyMap.drop () ; // Release error dropped variable
    }
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_observablePropertyType ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_stringlist joker_28755_2 ; // Joker input parameter
    GALGAS_lstring joker_28755_1 ; // Joker input parameter
    var_observablePropertyMap.method_searchKey (enumerator_28015.current_mBoundPropertyName (HERE), var_observablePropertyType, joker_28755_2, joker_28755_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (732)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_observableKeyPath = enumerator_28015.current_mBoundPropertyName (HERE).mAttribute_string ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (736)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_28996 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (737)).isValidAndTrue () ;
    if (enumerator_28996.hasCurrentObject () && bool_2) {
      while (enumerator_28996.hasCurrentObject () && bool_2) {
        //-------- @assignmentInstructionForGeneration
        var_requiredFormatter = enumerator_28996.current_mRequiredFormatter (HERE) ;
        //-------- @assignmentInstructionForGeneration
        var_found = GALGAS_bool (kIsEqual, enumerator_28996.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
        enumerator_28996.gotoNextObject () ;
        if (enumerator_28996.hasCurrentObject ()) {
          bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (737)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (741)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (742)) COMMA_SOURCE_FILE_AT_LINE (742)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (742)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeAndFormatterList enumerator_29312 (var_acceptableTypeFormatterList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (743)).isValidAndTrue () ;
      if (enumerator_29312.hasCurrentObject () && bool_4) {
        while (enumerator_29312.hasCurrentObject () && bool_4) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_29312.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (744)) COMMA_SOURCE_FILE_AT_LINE (744)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (744)) COMMA_SOURCE_FILE_AT_LINE (744)) ;
          enumerator_29312.gotoNextObject () ;
          if (enumerator_29312.hasCurrentObject ()) {
            bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (743)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_5 (enumerator_28015.current_mBoundPropertyName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, var_s COMMA_SOURCE_FILE_AT_LINE (746)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (749)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_6 = enumerator_28015.current_mNegate (HERE).boolEnum () ;
    if (kBoolTrue == test_6) {
      //-------- @plusEqualnstructionForGeneration
      var_bindingOptionList.addAssign_operation (GALGAS_string ("NSValueTransformerName"), GALGAS_string ("NSNegateBooleanTransformerName") COMMA_SOURCE_FILE_AT_LINE (751)) ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletBindingOptionList enumerator_29677 (enumerator_28015.current_mOutletBindingOptionList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_29677.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingTypeList var_acceptableTypeList ;
      //-------- @methodCallInstructionForGeneration
      var_outletClassBindingOptionMap.method_searchKey (enumerator_29677.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (755)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_bool var_found = GALGAS_bool (false) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_29874 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (757)).isValidAndTrue () ;
      if (enumerator_29874.hasCurrentObject () && bool_7) {
        while (enumerator_29874.hasCurrentObject () && bool_7) {
          //-------- @foreachInstructionForGeneration
          cEnumerator_easyBindingTypeList enumerator_29940 (enumerator_29677.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
          //--- complex foreach instruction
          bool bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (758)).isValidAndTrue () ;
          if (enumerator_29940.hasCurrentObject () && bool_8) {
            while (enumerator_29940.hasCurrentObject () && bool_8) {
              //-------- @assignmentInstructionForGeneration
              var_found = GALGAS_bool (kIsEqual, enumerator_29874.current_mType (HERE).objectCompare (enumerator_29940.current_mType (HERE))) ;
              enumerator_29940.gotoNextObject () ;
              if (enumerator_29940.hasCurrentObject ()) {
                bool_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (758)).isValidAndTrue () ;
              }
            }
          }
          enumerator_29874.gotoNextObject () ;
          if (enumerator_29874.hasCurrentObject ()) {
            bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (757)).isValidAndTrue () ;
          }
        }
      }
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (762)).boolEnum () ;
      if (kBoolTrue == test_9) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_30191 (var_acceptableTypeList, kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (764)).isValidAndTrue () ;
        if (enumerator_30191.hasCurrentObject () && bool_10) {
          while (enumerator_30191.hasCurrentObject () && bool_10) {
            //-------- @concatInstructionForGeneration
            var_s.dotAssign_operation (GALGAS_string ("\n"
              "  - '").operator_concat (categoryReader_ebTypeName (enumerator_30191.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (765)) COMMA_SOURCE_FILE_AT_LINE (765)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (765)) COMMA_SOURCE_FILE_AT_LINE (765)) ;
            enumerator_30191.gotoNextObject () ;
            if (enumerator_30191.hasCurrentObject ()) {
              bool_10 = var_found.operator_not (SOURCE_FILE_AT_LINE (764)).isValidAndTrue () ;
            }
          }
        }
        //-------- @errorInstructionForGeneration
        GALGAS_location location_11 (enumerator_29677.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_11, var_s COMMA_SOURCE_FILE_AT_LINE (767)) ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_bindingOptionList.addAssign_operation (enumerator_29677.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (769)), enumerator_29677.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (769)) ;
      enumerator_29677.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (var_generatedBindingName, var_requiredFormatter, var_observedObjectOCName, var_observableKeyPath, var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (771)) COMMA_SOURCE_FILE_AT_LINE (771)) ;
    //-------- @incrementInstructionForGeneration
    var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (779)) ;
    //-------- @assignmentInstructionForGeneration
    var_generatedBindingName = object->mAttribute_mBindingName.mAttribute_string.operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (780)) COMMA_SOURCE_FILE_AT_LINE (780)) ;
...
GALGAS_string categoryReader_ebTypeIdentifier (const GALGAS_easyBindingType & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inClassOrEntityName COMMA_SOURCE_FILE_AT_LINE (894)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (894)) ;
      } break ;
    }
  }
//---
...
static void categoryMethod_multiValuedBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement the $").operator_concat (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (945)) COMMA_SOURCE_FILE_AT_LINE (945)).operator_concat (GALGAS_string (" binding") COMMA_SOURCE_FILE_AT_LINE (945)) COMMA_SOURCE_FILE_AT_LINE (945)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_tableValueBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (957)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $run action") COMMA_SOURCE_FILE_AT_LINE (969)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @assignmentInstructionForGeneration
    var_resultingObservedPropertyPath = GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (985)) COMMA_SOURCE_FILE_AT_LINE (985)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("observed object should be 'root'") COMMA_SOURCE_FILE_AT_LINE (987)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (993)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_stringlist joker_39203_2 ; // Joker input parameter
    GALGAS_lstring joker_39203_1 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_39203_2, joker_39203_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (995)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (996)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (997)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_39500_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_39500_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_39500_2, joker_39500_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1000)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1002)) COMMA_SOURCE_FILE_AT_LINE (1002)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1002)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (1004)) COMMA_SOURCE_FILE_AT_LINE (1004)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (1004)) ;
      }
    }else if (kBoolFalse == test_3) {
      //-------- @errorInstructionForGeneration
      ...
      inCompiler->emitSemanticError (location_5, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (1007)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1013)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_40131 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (1016)).isValidAndTrue () ;
  if (enumerator_40131.hasCurrentObject () && bool_6) {
    while (enumerator_40131.hasCurrentObject () && bool_6) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_40131.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1017)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (1018)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (1018)) COMMA_SOURCE_FILE_AT_LINE (1018)) ;
      //-------- @assignmentInstructionForGeneration
      ...
      if (enumerator_40131.hasCurrentObject ()) {
        bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (1016)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (1021)).boolEnum () ;
  if (kBoolTrue == test_7) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_8 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_8, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (1023)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (1023)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (1023)) COMMA_SOURCE_FILE_AT_LINE (1022)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (1026)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (1033)), var_resultingObservedObjectName, var_resultingObservedPropertyPath, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (1031)) COMMA_SOURCE_FILE_AT_LINE (1031)) ;
}
//---------------------------------------------------------------------------*
