...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  while (enumerator_47487.hasCurrentObject ()) {
    ...
    while (enumerator_48181.hasCurrentObject ()) {
      ...
      { //-------- @modifierCallInstructionForGeneration
      ioArgument_ioTransientDependencyGraph.modifier_addNode (var_observationDependencyKey, var_observationDependencyKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (1255)) ;
      } //-------- END @typeMethodInstructionForGeneration
    ...
    GALGAS_transientListForImplementation var_transientListForImplementation ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_stringset var_implementationFileInclusionSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (1262)) ;
    { //-------- @routineCallInstructionForGeneration
    routine_analyzeTransientProperties (GALGAS_string ("class/").operator_concat (enumerator_47487.current_mClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1264)) COMMA_SOURCE_FILE_AT_LINE (1264)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (1264)), enumerator_47487.current_mTransientList (HERE), GALGAS_observableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1266)), var_observablePropertyMap, var_implementationFileInclusionSet, var_transientListForImplementation, ioArgument_ioTransientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1263)) ;
    } //-------- @routineCallInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    var_implementationFileInclusionSet.modifier_removeKey (GALGAS_string::makeEmptyString () COMMA_SOURCE_FILE_AT_LINE (1273)) ;
    } //-------- END @typeMethodInstructionForGeneration
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_47487.current_mClassName (HERE), enumerator_47487.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1276)), var_observablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_implementationFileInclusionSet, inCompiler COMMA_SOURCE_FILE_AT_LINE (1274)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1293)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_50145 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_50145.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1296)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_50242 (enumerator_50145.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_50242.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1298)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_50354 (enumerator_50242.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_50354.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_50354.current_mBindingOptionName (HERE), enumerator_50354.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1300)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_50354.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_50242.current_mBindingName (HERE), enumerator_50242.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1306)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_50242.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_50145.current_mOutletClassName (HERE), enumerator_50145.current_mGenerateCode (HERE), enumerator_50145.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, enumerator_50145.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1309)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_50145.gotoNextObject () ;
  }
}
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1325)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_51186 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_51186.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1328)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_51295 (enumerator_51186.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_51295.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_51295.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1330)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_51295.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1333)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_51447 (enumerator_51186.current_mBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_51447.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1335)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_51559 (enumerator_51447.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_51559.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_51559.current_mBindingOptionName (HERE), enumerator_51559.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1337)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_51559.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_51447.current_mBindingName (HERE), enumerator_51447.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1343)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_51447.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_observablePropertyMap var_observablePropertyMap = GALGAS_observablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1346)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerObservablePropertyList enumerator_52005 (enumerator_51186.current_mControllerObservablePropertyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_52005.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_52005.current (HERE).mAttribute_mPropertyName, enumerator_52005.current (HERE).mAttribute_mType, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1355)), enumerator_52005.current (HERE).mAttribute_mPropertyName, inCompiler COMMA_SOURCE_FILE_AT_LINE (1352)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_52005.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outControllerClassMap.modifier_insertKey (enumerator_51186.current_mOutletClassName (HERE), enumerator_51186.current_mGenerateCode (HERE), var_bindingMap, var_actionMap, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1360)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outSortedTransientOrderedList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1384)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_transientDependencyGraph var_transientDependencyGraph = GALGAS_transientDependencyGraph::constructor_emptyGraph (SOURCE_FILE_AT_LINE (1385)) ;
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1386)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1387)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1388)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1393)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (outArgument_outEntityMap, constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1398)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outPreferencesMap, outArgument_outDocumentMap, var_transientDependencyGraph, inCompiler COMMA_SOURCE_FILE_AT_LINE (1405)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1415)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).operator_and (GALGAS_bool (gOption_easyBindings_5F_options_outputTransientDependencyGraph.reader_value ()) COMMA_SOURCE_FILE_AT_LINE (1415)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = var_transientDependencyGraph.reader_graphviz (SOURCE_FILE_AT_LINE (1416)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_path = inArgument_inSourceFilePath.operator_concat (GALGAS_string (".transientDependancyGraph.dot") COMMA_SOURCE_FILE_AT_LINE (1417)) ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_bool joker_54159_0 ; // Joker input parameter
    var_s.method_writeToFileWhenDifferentContents (var_path, joker_54159_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1418)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @assignmentInstructionForGeneration
  outArgument_outTransientDependencyArcList = var_transientDependencyGraph.reader_arcs (SOURCE_FILE_AT_LINE (1421)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, GALGAS_uint::constructor_errorCount (SOURCE_FILE_AT_LINE (1422)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_transientDependencyGraph.reader_undefinedNodeCount (SOURCE_FILE_AT_LINE (1423)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_54439 (var_transientDependencyGraph.reader_undefinedNodeKeyList (SOURCE_FILE_AT_LINE (1424)), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_54439.hasCurrentObject ()) {
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inAST.mAttribute_mEndOfSourceFile, GALGAS_string ("the '").operator_concat (enumerator_54439.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1425)).operator_concat (GALGAS_string ("' property is not defined") COMMA_SOURCE_FILE_AT_LINE (1425)) COMMA_SOURCE_FILE_AT_LINE (1425)) ;
        enumerator_54439.gotoNextObject () ;
      }
    }else if (kBoolFalse == test_2) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_stringlist var_unsortedTransientList ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstringlist joker_54697_0 ; // Joker input parameter
      GALGAS_lstringlist joker_54739_0 ; // Joker input parameter
      var_transientDependencyGraph.method_topologicalSort (outArgument_outSortedTransientOrderedList, joker_54697_0, var_unsortedTransientList, joker_54739_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (1429)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1435)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
      if (kBoolTrue == test_3) {
        //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
        GALGAS_string var_s = var_unsortedTransientList.reader_length (SOURCE_FILE_AT_LINE (1436)).reader_string (SOURCE_FILE_AT_LINE (1436)).operator_concat (GALGAS_string (" transient declarations are involved in circular dependancies:") COMMA_SOURCE_FILE_AT_LINE (1436)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_54969 (var_unsortedTransientList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_54969.hasCurrentObject ()) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "-  ").operator_concat (enumerator_54969.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1438)) COMMA_SOURCE_FILE_AT_LINE (1438)) ;
          enumerator_54969.gotoNextObject () ;
        }
        //-------- @errorInstructionForGeneration
        inCompiler->emitSemanticError (constinArgument_inAST.mAttribute_mEndOfSourceFile, var_s COMMA_SOURCE_FILE_AT_LINE (1440)) ;
      }
    }
  }
}
