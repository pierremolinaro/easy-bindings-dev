...
bool cMapElement_classObservableObjectMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mObservableObjectOCName.isValid () && mAttribute_mObservableProperties.isValid () ;
}
...
cMapElement * cMapElement_classObservableObjectMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_classObservableObjectMap (mAttribute_lkey, mAttribute_mObservableObjectOCName, mAttribute_mObservableProperties COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_classObservableObjectMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  macroMyNew (p, cMapElement_classObservableObjectMap (inKey, inArgument0, inArgument1 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
void GALGAS_classObservableObjectMap::method_searchKey (GALGAS_lstring inKey,
  ...
  if (NULL == p) {
    ...
    outArgument1 = p->mAttribute_mObservableProperties ;
  }
}
...
GALGAS_classObservableObjectMap_2E_element cEnumerator_classObservableObjectMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cMapElement_classObservableObjectMap) ;
  return GALGAS_classObservableObjectMap_2E_element (p->mAttribute_lkey, p->mAttribute_mObservableObjectOCName, p->mAttribute_mObservableProperties) ;
}
...
bool cMapElement_documentMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mRootEntityName.isValid () && mAttribute_mRootEntityImplementationClassName.isValid () && mAttribute_mOutletDeclarationList.isValid () && mAttribute_mControllerMap.isValid () && mAttribute_mActionList.isValid () && mAttribute_mTransientListForImplementation.isValid () && mAttribute_mTriggeredKeys.isValid () ;
}
...
cMapElement * cMapElement_documentMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_documentMap (mAttribute_lkey, mAttribute_mRootEntityName, mAttribute_mRootEntityImplementationClassName, mAttribute_mOutletDeclarationList, mAttribute_mControllerMap, mAttribute_mActionList, mAttribute_mTransientListForImplementation, mAttribute_mTriggeredKeys COMMA_HERE)) ;
  return result ;
}
...
GALGAS_triggeredKeys GALGAS_documentMap::reader_mTriggeredKeysForKey (const GALGAS_string & inKey,
                                                                      C_Compiler * inCompiler
                                                                      COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_documentMap * p = (const cMapElement_documentMap *) attributes ;
...
void GALGAS_documentMap::modifier_setMTriggeredKeysForKey (GALGAS_triggeredKeys inAttributeValue,
                                                           GALGAS_string inKey,
                                                           C_Compiler * inCompiler
                                                           COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
...
GALGAS_documentMap_2E_element cEnumerator_documentMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cMapElement_documentMap) ;
  return GALGAS_documentMap_2E_element (p->mAttribute_lkey, p->mAttribute_mRootEntityName, p->mAttribute_mRootEntityImplementationClassName, p->mAttribute_mOutletDeclarationList, p->mAttribute_mControllerMap, p->mAttribute_mActionList, p->mAttribute_mTransientListForImplementation, p->mAttribute_mTriggeredKeys) ;
}
...
GALGAS_triggeredKeys cEnumerator_documentMap::current_mTriggeredKeys (LOCATION_ARGS) const {
  const cMapElement_documentMap * p = (const cMapElement_documentMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_documentMap) ;
  return p->mAttribute_mTriggeredKeys ;
}
...
GALGAS_classObservablePropertyMap GALGAS_controllerClassMap::reader_mObservablePropertyMapForKey (const GALGAS_string & inKey,
                                                                                                  C_Compiler * inCompiler
                                                                                                  COMMA_LOCATION_ARGS) const {
  const cCollectionElement * attributes = searchForReadingAttribute (inKey, inCompiler COMMA_THERE) ;
  const cMapElement_controllerClassMap * p = (const cMapElement_controllerClassMap *) attributes ;
...
void GALGAS_controllerClassMap::modifier_setMObservablePropertyMapForKey (GALGAS_classObservablePropertyMap inAttributeValue,
                                                                          GALGAS_string inKey,
                                                                          C_Compiler * inCompiler
                                                                          COMMA_LOCATION_ARGS) {
  cCollectionElement * attributes = searchForReadWriteAttribute (inKey, inCompiler COMMA_THERE) ;
...
GALGAS_classObservablePropertyMap cEnumerator_controllerClassMap::current_mObservablePropertyMap (LOCATION_ARGS) const {
  const cMapElement_controllerClassMap * p = (const cMapElement_controllerClassMap *) currentObjectPtr (THERE) ;
  macroValidSharedObject (p, const cMapElement_controllerClassMap) ;
  return p->mAttribute_mObservablePropertyMap ;
}
...
void routine_analyzeEntities (const GALGAS_entityList constinArgument_inEntityList,
  ...
  outArgument_outEntityMap = GALGAS_entityMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (404)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityList enumerator_16127 (constinArgument_inEntityList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_16127.hasCurrentObject ()) {
    ...
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (407)) ;
    //-------- @localVariableDeclarationForGeneration
    ...
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_16127.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (412)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_16544_0 ; // Joker input parameter
      GALGAS_string joker_16593_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_16681_5 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_16681_4 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_16681_3 ; // Joker input parameter
      GALGAS_triggeredKeys joker_16681_2 ; // Joker input parameter
      GALGAS_relationshipList joker_16681_1 ; // Joker input parameter
      GALGAS_relationshipMap joker_16746_0 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_16127.current_mSuperEntityName (HERE), joker_16544_0, var_implementationSuperClassName, joker_16593_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_16681_5, joker_16681_4, joker_16681_3, joker_16681_2, joker_16681_1, var_allRelationshipList, var_allPropertyMap, joker_16746_0, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (413)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (427)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (428)) ;
      //-------- @assignmentInstructionForGeneration
      var_implementationSuperClassName = GALGAS_string::makeEmptyString () ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipList = GALGAS_relationshipList::constructor_emptyList (SOURCE_FILE_AT_LINE (430)) ;
      //-------- @assignmentInstructionForGeneration
      var_allPropertyMap = GALGAS_propertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (431)) ;
      //-------- @assignmentInstructionForGeneration
      var_allRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (432)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (434)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (435)) ;
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_17519 (enumerator_16127.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_17519.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_17519.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_17519.current_mType (HERE), enumerator_17519.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (439)) ;
      } //-------- @routineCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_17519.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (440)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_17519.current_mType (HERE), enumerator_17519.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (441)), enumerator_17519.current_mDefaultValueObjectiveCObject (HERE), enumerator_17519.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (441)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_17519.current_mType (HERE), enumerator_17519.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (442)), enumerator_17519.current_mDefaultValueObjectiveCObject (HERE), enumerator_17519.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (442)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_17519.current_mAttributeName (HERE), enumerator_17519.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_17519.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (443)) COMMA_SOURCE_FILE_AT_LINE (443)), inCompiler COMMA_SOURCE_FILE_AT_LINE (443)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_17519.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_relationshipMap var_currentRelationshipMap = GALGAS_relationshipMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (446)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipList enumerator_18214 (enumerator_16127.current_mRelationshipList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_18214.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allRelationshipMap.modifier_insertKey (enumerator_18214.current_mRelationshipName (HERE), enumerator_18214.current_mIsToMany (HERE), enumerator_18214.current_mDestinationEntityName (HERE), enumerator_18214.current_mInverseRelationshipName (HERE), enumerator_18214.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (448)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_currentRelationshipMap.modifier_insertKey (enumerator_18214.current_mRelationshipName (HERE), enumerator_18214.current_mIsToMany (HERE), enumerator_18214.current_mDestinationEntityName (HERE), enumerator_18214.current_mInverseRelationshipName (HERE), enumerator_18214.current_mDeleteRule (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (455)) ;
      } //-------- END @typeMethodInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_18214.current_mRelationshipName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (462)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_18214.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (465)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_18766 (enumerator_16127.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_18766.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_allPropertyMap.modifier_insertKey (enumerator_18766.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (467)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (468)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (469)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_dependanceList enumerator_18973 (enumerator_18766.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_18973.hasCurrentObject ()) {
        ...
        //-------- @methodCallInstructionForGeneration
        var_classObservablePropertyMap.method_searchKey (enumerator_18973.current_mPropertyName (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (473)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_18973.current_mPropertyName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (474)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_19249 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_19249.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_19249.current_mValue (HERE), enumerator_18766.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (476)) COMMA_SOURCE_FILE_AT_LINE (476)) ;
          enumerator_19249.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (478)) ;
        enumerator_18973.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_18766.current_mType (HERE), enumerator_18766.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (480)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (480)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_18766.current_mTransientName (HERE), enumerator_18766.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (481)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_18766.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outEntityMap.modifier_insertKey (enumerator_16127.current_mEntityName (HERE), enumerator_16127.current_mSuperEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (486)), enumerator_16127.current_mImplementationClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (487)), var_implementationSuperClassName, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_triggeredKeys, enumerator_16127.current_mRelationshipList (HERE), var_allRelationshipList.operator_concat (enumerator_16127.current_mRelationshipList (HERE) COMMA_SOURCE_FILE_AT_LINE (496)), var_allPropertyMap, var_currentRelationshipMap, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (484)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_16127.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_entityMap enumerator_20241 (outArgument_outEntityMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_20241.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_relationshipMap enumerator_20280 (enumerator_20241.current_mCurrentRelationshipMap (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_20280.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_relationshipMap var_destinationEntityRelationshipMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_20396_13 ; // Joker input parameter
      GALGAS_string joker_20396_12 ; // Joker input parameter
      GALGAS_string joker_20396_11 ; // Joker input parameter
      GALGAS_classObservablePropertyMap joker_20396_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_20396_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_20396_8 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_20396_7 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_20396_6 ; // Joker input parameter
      GALGAS_triggeredKeys joker_20396_5 ; // Joker input parameter
      GALGAS_relationshipList joker_20396_4 ; // Joker input parameter
      GALGAS_relationshipList joker_20396_3 ; // Joker input parameter
      GALGAS_propertyMap joker_20396_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_20396_1 ; // Joker input parameter
      outArgument_outEntityMap.method_searchKey (enumerator_20280.current_mDestinationEntityName (HERE), joker_20396_13, joker_20396_12, joker_20396_11, joker_20396_10, joker_20396_9, joker_20396_8, joker_20396_7, joker_20396_6, joker_20396_5, joker_20396_4, joker_20396_3, joker_20396_2, joker_20396_1, var_destinationEntityRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (506)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableDeclarationForGeneration
      GALGAS_lstring var_inverseOfInverseRelationshipName ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_20563_2 ; // Joker input parameter
      GALGAS_lstring joker_20563_1 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_20601_0 ; // Joker input parameter
      var_destinationEntityRelationshipMap.method_searchKey (enumerator_20280.current_mInverseRelationshipName (HERE), joker_20563_2, joker_20563_1, var_inverseOfInverseRelationshipName, joker_20601_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (508)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_1 = GALGAS_bool (kIsNotEqual, enumerator_20280.current_lkey (HERE).mAttribute_string.objectCompare (var_inverseOfInverseRelationshipName.mAttribute_string)).boolEnum () ;
      if (kBoolTrue == test_1) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_2 (enumerator_20280.current_mInverseRelationshipName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the inverse relationship does not name '").operator_concat (enumerator_20280.current_lkey (HERE).reader_string (SOURCE_FILE_AT_LINE (510)) COMMA_SOURCE_FILE_AT_LINE (510)).operator_concat (GALGAS_string ("' relationship as inverse") COMMA_SOURCE_FILE_AT_LINE (510)) COMMA_SOURCE_FILE_AT_LINE (510)) ;
      }
...
void routine_analyzePreferences (const GALGAS_entityMap constinArgument_inEntityMap,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outPreferencesMap = GALGAS_preferencesMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (691)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_preferencesDeclarationList enumerator_27637 (constinArgument_inPreferencesList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_27637.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservablePropertyMap var_observableAttributeMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (693)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (695)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_27814 (enumerator_27637.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_27814.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_27814.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (697)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_27814.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (700)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (701)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_28098 (enumerator_27637.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_28098.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_28098.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_28098.current_mType (HERE), enumerator_28098.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (703)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_28098.current_mType (HERE), enumerator_28098.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (704)), enumerator_28098.current_mDefaultValueObjectiveCObject (HERE), enumerator_28098.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (704)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_28098.current_mAttributeName (HERE), enumerator_28098.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_28098.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (705)) COMMA_SOURCE_FILE_AT_LINE (705)), inCompiler COMMA_SOURCE_FILE_AT_LINE (705)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_28098.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (708)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_28571 (enumerator_27637.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_28571.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (710)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (711)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_dependanceList enumerator_28725 (enumerator_28571.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_28725.hasCurrentObject ()) {
        ...
        GALGAS_stringlist var_propertyDependancyList ;
        //-------- @methodCallInstructionForGeneration
        var_observableAttributeMap.method_searchKey (enumerator_28725.current_mPropertyName (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (715)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_28725.current_mPropertyName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (716)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_28997 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_28997.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_28997.current_mValue (HERE), enumerator_28571.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (718)) COMMA_SOURCE_FILE_AT_LINE (718)) ;
          enumerator_28997.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (720)) ;
        enumerator_28725.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_28571.current_mType (HERE), enumerator_28571.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (722)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (722)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observableAttributeMap.modifier_insertKey (enumerator_28571.current_mTransientName (HERE), enumerator_28571.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (723)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_28571.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservableObjectMap var_observableObjectMap = GALGAS_classObservableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (726)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (728)), GALGAS_string ("self"), var_observableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (727)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (733)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_29710 (enumerator_27637.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_29710.hasCurrentObject ()) {
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_29837_2 ; // Joker input parameter
      GALGAS_string joker_29837_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_29710.current_mOutletType (HERE), joker_29837_2, joker_29837_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (737)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (738)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_29981 (enumerator_29710.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_29981.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_29981.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (744)), var_actionMap, var_hasTableValueBinding, var_outletBindingList, inCompiler COMMA_SOURCE_FILE_AT_LINE (740)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_29981.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_29710.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (750)), enumerator_29710.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (750)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (750)) ;
      enumerator_29710.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outPreferencesMap.modifier_insertKey (enumerator_27637.current_mPreferencesName (HERE), var_attributeListForImplementation, var_transientListForImplementation, var_outletGenerationList, var_triggeredKeys, enumerator_27637.current_mActionDeclarationList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (753)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_checkBindingOptions (const GALGAS_outletBindingOptionList constinArgument_inBindingOptionListAST,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outBindingOptionListForGeneration = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (792)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_31886 (constinArgument_inBindingOptionListAST, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_31886.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    constinArgument_inAvailableBindingOptionMap.method_searchKey (enumerator_31886.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (795)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_32075 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (797)).isValidAndTrue () ;
    if (enumerator_32075.hasCurrentObject () && bool_0) {
      while (enumerator_32075.hasCurrentObject () && bool_0) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_32139 (enumerator_31886.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (798)).isValidAndTrue () ;
        if (enumerator_32139.hasCurrentObject () && bool_1) {
          while (enumerator_32139.hasCurrentObject () && bool_1) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_32075.current_mType (HERE).objectCompare (enumerator_32139.current_mType (HERE))) ;
            enumerator_32139.gotoNextObject () ;
            if (enumerator_32139.hasCurrentObject ()) {
              bool_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (798)).isValidAndTrue () ;
            }
          }
        }
        enumerator_32075.gotoNextObject () ;
        if (enumerator_32075.hasCurrentObject ()) {
          bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (797)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (802)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_32378 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (804)).isValidAndTrue () ;
      if (enumerator_32378.hasCurrentObject () && bool_3) {
        while (enumerator_32378.hasCurrentObject () && bool_3) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_32378.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (805)) COMMA_SOURCE_FILE_AT_LINE (805)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (805)) COMMA_SOURCE_FILE_AT_LINE (805)) ;
          enumerator_32378.gotoNextObject () ;
          if (enumerator_32378.hasCurrentObject ()) {
            bool_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (804)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_4 (enumerator_31886.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, var_s COMMA_SOURCE_FILE_AT_LINE (807)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outBindingOptionListForGeneration.addAssign_operation (enumerator_31886.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (809)), enumerator_31886.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (809)) ;
...
void routine_analyzeDocuments (const GALGAS_documentDeclarationList constinArgument_inDocumentDeclarationList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outDocumentMap = GALGAS_documentMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (924)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_documentDeclarationList enumerator_37283 (constinArgument_inDocumentDeclarationList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_37283.hasCurrentObject ()) {
    ...
    GALGAS_relationshipMap var_allRelationshipMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_37488_0 ; // Joker input parameter
    GALGAS_string joker_37538_0 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_37576_9 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_37576_8 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_37576_7 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_37576_6 ; // Joker input parameter
    GALGAS_triggeredKeys joker_37576_5 ; // Joker input parameter
    GALGAS_relationshipList joker_37576_4 ; // Joker input parameter
    GALGAS_relationshipList joker_37576_3 ; // Joker input parameter
    GALGAS_propertyMap joker_37576_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_37576_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (enumerator_37283.current_mRootEntityName (HERE), joker_37488_0, var_rootEntityImplementationClassName, joker_37538_0, var_observablePropertyMap, joker_37576_9, joker_37576_8, joker_37576_7, joker_37576_6, joker_37576_5, joker_37576_4, joker_37576_3, joker_37576_2, joker_37576_1, var_allRelationshipMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (929)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (939)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (940)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_37804 (enumerator_37283.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_37804.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (942)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (943)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_dependanceList enumerator_37958 (enumerator_37804.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_37958.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_easyBindingType var_type ;
        //-------- @localVariableDeclarationForGeneration
        GALGAS_stringlist var_propertyDependancyList ;
        //-------- @methodCallInstructionForGeneration
        var_observablePropertyMap.method_searchKey (enumerator_37958.current_mPropertyName (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (947)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_37958.current_mPropertyName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (948)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_38229 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_38229.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_38229.current_mValue (HERE), enumerator_37804.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (950)) COMMA_SOURCE_FILE_AT_LINE (950)) ;
          enumerator_38229.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (952)) ;
        enumerator_37958.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_37804.current_mType (HERE), enumerator_37804.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (954)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (954)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_37804.current_mTransientName (HERE), enumerator_37804.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (955)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_37804.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_documentActionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (958)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_38725 (enumerator_37283.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_38725.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_documentActionMap.modifier_insertKey (enumerator_38725.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (960)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_38725.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservableObjectMap var_observableObjectMap = GALGAS_classObservableObjectMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (963)) ;
    { //-------- @modifierCallInstructionForGeneration
    var_observableObjectMap.modifier_insertKey (GALGAS_string ("root").reader_nowhere (SOURCE_FILE_AT_LINE (965)), GALGAS_string ("mRootObject"), var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (964)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_controllerMap var_controllerMap = GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (970)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerList enumerator_39120 (enumerator_37283.current_mControllerList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_39120.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_outletClassBindingMap var_controllerClassBindingMap ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_actionMap var_controllerActionMap ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_classObservablePropertyMap var_controllerObservablePropertyMap ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_39363_0 ; // Joker input parameter
      constinArgument_inControllerClassMap.method_searchKey (enumerator_39120.current_mControllerClassName (HERE), joker_39363_0, var_controllerClassBindingMap, var_controllerActionMap, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (975)) ;
      //-------- END @methodCallInstructionForGeneration
      { //-------- @modifierCallInstructionForGeneration
      var_observableObjectMap.modifier_insertKey (enumerator_39120.current_mControllerClassName (HERE), enumerator_39120.current_mControllerClassName (HERE).mAttribute_string, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (982)) ;
      } //-------- END @typeMethodInstructionForGeneration
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_39699_14 ; // Joker input parameter
      GALGAS_string joker_39699_13 ; // Joker input parameter
      GALGAS_string joker_39699_12 ; // Joker input parameter
      GALGAS_classObservablePropertyMap joker_39699_11 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_39699_10 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_39699_9 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_39699_8 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_39699_7 ; // Joker input parameter
      GALGAS_triggeredKeys joker_39699_6 ; // Joker input parameter
      GALGAS_relationshipList joker_39699_5 ; // Joker input parameter
      GALGAS_relationshipList joker_39699_4 ; // Joker input parameter
      GALGAS_propertyMap joker_39699_3 ; // Joker input parameter
      GALGAS_relationshipMap joker_39699_2 ; // Joker input parameter
      GALGAS_relationshipMap joker_39699_1 ; // Joker input parameter
      constinArgument_inEntityMap.method_searchKey (enumerator_39120.current_mControlledClassOrEntityName (HERE), joker_39699_14, joker_39699_13, joker_39699_12, joker_39699_11, joker_39699_10, joker_39699_9, joker_39699_8, joker_39699_7, joker_39699_6, joker_39699_5, joker_39699_4, joker_39699_3, joker_39699_2, joker_39699_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (987)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_bindingListForGeneration = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (988)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_39820 (enumerator_39120.current_mControllerBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_39820.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeControllerBinding ((const cPtr_abstractBinding *) enumerator_39820.current_mBinding (HERE).ptr (), var_allRelationshipMap, var_controllerClassBindingMap, enumerator_39120.current_mControlledClassOrEntityName (HERE), var_observablePropertyMap, var_bindingListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (990)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_39820.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_controllerMap.modifier_insertKey (enumerator_39120.current_mControllerName (HERE), enumerator_39120.current_mControllerClassName (HERE).mAttribute_string, enumerator_39120.current_mControlledClassOrEntityName (HERE).mAttribute_string, var_bindingListForGeneration, var_controllerActionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (998)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_39120.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletGenerationList var_outletGenerationList = GALGAS_outletGenerationList::constructor_emptyList (SOURCE_FILE_AT_LINE (1007)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletDeclarationList enumerator_40427 (enumerator_37283.current_mOutletDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_40427.hasCurrentObject ()) {
      ...
      GALGAS_bool var_hasTableValueBinding ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_bool joker_40554_2 ; // Joker input parameter
      GALGAS_string joker_40554_1 ; // Joker input parameter
      constinArgument_inOutletClassMap.method_searchKey (enumerator_40427.current_mOutletType (HERE), joker_40554_2, joker_40554_1, var_bindingMap, var_hasTableValueBinding, inCompiler COMMA_SOURCE_FILE_AT_LINE (1011)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletBindingListForGeneration var_outletBindingList = GALGAS_outletBindingListForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (1012)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingList enumerator_40698 (enumerator_40427.current_mOutletBindingList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_40698.hasCurrentObject ()) {
        //-------- @methodCallInstructionForGeneration
        callCategoryMethod_analyzeOutletBinding ((const cPtr_abstractBinding *) enumerator_40698.current_mBinding (HERE).ptr (), constinArgument_inEntityMap, var_observableObjectMap, var_bindingMap, var_controllerMap, var_documentActionMap, var_hasTableValueBinding, var_outletBindingList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1014)) ;
        //-------- END @methodCallInstructionForGeneration
        enumerator_40698.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_outletGenerationList.addAssign_operation (enumerator_40427.current_mOutletType (HERE).reader_string (SOURCE_FILE_AT_LINE (1024)), enumerator_40427.current_mOutletName (HERE).reader_string (SOURCE_FILE_AT_LINE (1024)), var_outletBindingList COMMA_SOURCE_FILE_AT_LINE (1024)) ;
      enumerator_40427.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outDocumentMap.modifier_insertKey (enumerator_37283.current_mDocumentName (HERE), enumerator_37283.current_mRootEntityName (HERE).reader_string (SOURCE_FILE_AT_LINE (1029)), var_rootEntityImplementationClassName, var_outletGenerationList, var_controllerMap, enumerator_37283.current_mActionDeclarationList (HERE), var_transientListForImplementation, var_triggeredKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (1027)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_checkDefaultValueType (const GALGAS_easyBindingTypeList constinArgument_inDefaultValueCorrespondingAcceptableTypes,
  ...
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeList enumerator_41726 (constinArgument_inDefaultValueCorrespondingAcceptableTypes, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1048)).isValidAndTrue () ;
  if (enumerator_41726.hasCurrentObject () && bool_0) {
    while (enumerator_41726.hasCurrentObject () && bool_0) {
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, constinArgument_inAttributeActualType.objectCompare (enumerator_41726.current_mType (HERE))) ;
      enumerator_41726.gotoNextObject () ;
      if (enumerator_41726.hasCurrentObject ()) {
        bool_0 = var_found.operator_not (SOURCE_FILE_AT_LINE (1048)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = var_found.operator_not (SOURCE_FILE_AT_LINE (1051)).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_2 (constinArgument_inAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_2, GALGAS_string ("the default value is invalue for this attribute") COMMA_SOURCE_FILE_AT_LINE (1052)) ;
  }
}
...
void routine_analyzeClasses (const GALGAS_classList constinArgument_inClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outClassMap = GALGAS_classMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1062)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_classList enumerator_42154 (constinArgument_inClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_42154.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_classObservablePropertyMap var_classObservablePropertyMap ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1065)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_42154.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1066)).objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @methodCallInstructionForGeneration
      GALGAS_string joker_42389_0 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_42453_4 ; // Joker input parameter
      GALGAS_attributeListForImplementation joker_42453_3 ; // Joker input parameter
      GALGAS_transientListForImplementation joker_42453_2 ; // Joker input parameter
      GALGAS_triggeredKeys joker_42453_1 ; // Joker input parameter
      outArgument_outClassMap.method_searchKey (enumerator_42154.current_mSuperClassName (HERE), joker_42389_0, var_classObservablePropertyMap, var_propertyListForInitMethodHeader, joker_42453_4, joker_42453_3, joker_42453_2, joker_42453_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (1067)) ;
      //-------- END @methodCallInstructionForGeneration
    }else if (kBoolFalse == test_0) {
      //-------- @assignmentInstructionForGeneration
      var_classObservablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1069)) ;
      //-------- @assignmentInstructionForGeneration
      var_propertyListForInitMethodHeader = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1070)) ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_attributeListForImplementation var_attributeListForImplementation = GALGAS_attributeListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1072)) ;
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_attributeListForImplementation var_inheritedAttributeListForImplementation = var_propertyListForInitMethodHeader ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_attributeList enumerator_42873 (enumerator_42154.current_mAttributeList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_42873.hasCurrentObject ()) {
      { //-------- @routineCallInstructionForGeneration
      routine_checkDefaultValueType (enumerator_42873.current_mDefaultValueCorrespondingAcceptableTypes (HERE), enumerator_42873.current_mType (HERE), enumerator_42873.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1075)) ;
      } //-------- @routineCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_attributeListForImplementation.addAssign_operation (enumerator_42873.current_mType (HERE), enumerator_42873.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1076)), enumerator_42873.current_mDefaultValueObjectiveCObject (HERE), enumerator_42873.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1076)) ;
      //-------- @plusEqualnstructionForGeneration
      var_propertyListForInitMethodHeader.addAssign_operation (enumerator_42873.current_mType (HERE), enumerator_42873.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1077)), enumerator_42873.current_mDefaultValueObjectiveCObject (HERE), enumerator_42873.current_mDirectDefaultValue (HERE) COMMA_SOURCE_FILE_AT_LINE (1077)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_42873.current_mAttributeName (HERE), enumerator_42873.current_mType (HERE), GALGAS_stringlist::constructor_listWithValue (enumerator_42873.current_mAttributeName (HERE).reader_string (SOURCE_FILE_AT_LINE (1078)) COMMA_SOURCE_FILE_AT_LINE (1078)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1078)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_42873.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_transientListForImplementation var_transientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (1081)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_triggeredKeys var_triggeredKeys = GALGAS_triggeredKeys::constructor_emptyMap (SOURCE_FILE_AT_LINE (1082)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_transientList enumerator_43562 (enumerator_42154.current_mTransientList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_43562.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1084)) ;
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (1085)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_dependanceList enumerator_43716 (enumerator_43562.current_mDependencyList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_43716.hasCurrentObject ()) {
        //-------- @localVariableDeclarationForGeneration
        GALGAS_easyBindingType var_type ;
        //-------- @localVariableDeclarationForGeneration
        GALGAS_stringlist var_propertyDependancyList ;
        //-------- @methodCallInstructionForGeneration
        var_classObservablePropertyMap.method_searchKey (enumerator_43716.current_mPropertyName (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1089)) ;
        //-------- END @methodCallInstructionForGeneration
        //-------- @plusEqualnstructionForGeneration
        var_directDependancyList.addAssign_operation (var_type, enumerator_43716.current_mPropertyName (HERE).mAttribute_string COMMA_SOURCE_FILE_AT_LINE (1090)) ;
        //-------- @foreachInstructionForGeneration
        cEnumerator_stringlist enumerator_43992 (var_propertyDependancyList, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_43992.hasCurrentObject ()) {
          //-------- @plusEqualnstructionForGeneration
          var_triggeredKeys.addAssign_operation (enumerator_43992.current_mValue (HERE), enumerator_43562.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (1092)) COMMA_SOURCE_FILE_AT_LINE (1092)) ;
          enumerator_43992.gotoNextObject () ;
        }
        //-------- @concatInstructionForGeneration
        var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (1094)) ;
        enumerator_43716.gotoNextObject () ;
      }
      //-------- @plusEqualnstructionForGeneration
      var_transientListForImplementation.addAssign_operation (enumerator_43562.current_mType (HERE), enumerator_43562.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (1096)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (1096)) ;
      { //-------- @modifierCallInstructionForGeneration
      var_classObservablePropertyMap.modifier_insertKey (enumerator_43562.current_mTransientName (HERE), enumerator_43562.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (1097)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_43562.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outClassMap.modifier_insertKey (enumerator_42154.current_mClassName (HERE), enumerator_42154.current_mSuperClassName (HERE).reader_string (SOURCE_FILE_AT_LINE (1102)), var_classObservablePropertyMap, var_propertyListForInitMethodHeader, var_inheritedAttributeListForImplementation, var_attributeListForImplementation, var_transientListForImplementation, var_triggeredKeys, inCompiler COMMA_SOURCE_FILE_AT_LINE (1100)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_42154.gotoNextObject () ;
  }
}
...
void routine_analyzeOutletClasses (const GALGAS_outletClassList constinArgument_inOutletClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outOutletClassMap = GALGAS_outletClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1119)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletClassList enumerator_44994 (constinArgument_inOutletClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_44994.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1122)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_45091 (enumerator_44994.current_mOutletClassBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_45091.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1124)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_45203 (enumerator_45091.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_45203.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_45203.current_mBindingOptionName (HERE), enumerator_45203.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1126)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_45203.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_45091.current_mBindingName (HERE), enumerator_45091.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1132)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_45091.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outOutletClassMap.modifier_insertKey (enumerator_44994.current_mOutletClassName (HERE), enumerator_44994.current_mGenerateCode (HERE), enumerator_44994.current_mSuperClassName (HERE).mAttribute_string, var_bindingMap, enumerator_44994.current_mHasTableValueBinding (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1135)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
void routine_analyzeControllerClasses (const GALGAS_controllerClassList constinArgument_inControllerClassList,
  ...
  //-------- @assignmentInstructionForGeneration
  outArgument_outControllerClassMap = GALGAS_controllerClassMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1151)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_controllerClassList enumerator_46035 (constinArgument_inControllerClassList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_46035.hasCurrentObject ()) {
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_actionMap var_actionMap = GALGAS_actionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1154)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_lstringlist enumerator_46144 (enumerator_46035.current_mActionDeclarationList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_46144.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_actionMap.modifier_insertKey (enumerator_46144.current (HERE).mAttribute_mValue, inCompiler COMMA_SOURCE_FILE_AT_LINE (1156)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_46144.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_outletClassBindingMap var_bindingMap = GALGAS_outletClassBindingMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1159)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_outletClassBindingList enumerator_46296 (enumerator_46035.current_mBindingList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_46296.hasCurrentObject ()) {
      //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
      GALGAS_outletClassBindingOptionMap var_outletClassBindingOptionMap = GALGAS_outletClassBindingOptionMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1161)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_bindingOptionList enumerator_46408 (enumerator_46296.current_mBindingOptionList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_46408.hasCurrentObject ()) {
        { //-------- @modifierCallInstructionForGeneration
        var_outletClassBindingOptionMap.modifier_insertKey (enumerator_46408.current_mBindingOptionName (HERE), enumerator_46408.current_mAcceptableTypeList (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (1163)) ;
        } //-------- END @typeMethodInstructionForGeneration
        enumerator_46408.gotoNextObject () ;
      }
      { //-------- @modifierCallInstructionForGeneration
      var_bindingMap.modifier_insertKey (enumerator_46296.current_mBindingName (HERE), enumerator_46296.current_mAcceptableTypeFormatterList (HERE), var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1169)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_46296.gotoNextObject () ;
    }
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_classObservablePropertyMap var_observablePropertyMap = GALGAS_classObservablePropertyMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (1172)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_controllerObservablePropertyList enumerator_46859 (enumerator_46035.current_mControllerObservablePropertyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_46859.hasCurrentObject ()) {
      { //-------- @modifierCallInstructionForGeneration
      var_observablePropertyMap.modifier_insertKey (enumerator_46859.current (HERE).mAttribute_mPropertyName, enumerator_46859.current (HERE).mAttribute_mType, GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (1174)), inCompiler COMMA_SOURCE_FILE_AT_LINE (1174)) ;
      } //-------- END @typeMethodInstructionForGeneration
      enumerator_46859.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    outArgument_outControllerClassMap.modifier_insertKey (enumerator_46035.current_mOutletClassName (HERE), enumerator_46035.current_mGenerateCode (HERE), var_bindingMap, var_actionMap, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1177)) ;
    } //-------- END @typeMethodInstructionForGeneration
    enumerator_46035.gotoNextObject () ;
  }
}
...
void routine_semanticAnalysis (const GALGAS_ASTstruct constinArgument_inAST,
  ...
  outArgument_outDocumentMap.drop () ; // Release 'out' argument
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeOutletClasses (constinArgument_inAST.mAttribute_mOutletClassList, outArgument_outOutletClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1198)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeControllerClasses (constinArgument_inAST.mAttribute_mControllerClassList, outArgument_outControllerClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1199)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeClasses (constinArgument_inAST.mAttribute_mClassList, outArgument_outClassMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1200)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeEntities (constinArgument_inAST.mAttribute_mEntityList, outArgument_outEntityMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1201)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzePreferences (outArgument_outEntityMap, constinArgument_inAST.mAttribute_mPreferencesList, outArgument_outOutletClassMap, outArgument_outPreferencesMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1202)) ;
  } //-------- @routineCallInstructionForGeneration
  { //-------- @routineCallInstructionForGeneration
  routine_analyzeDocuments (constinArgument_inAST.mAttribute_mDocumentDeclarationList, outArgument_outOutletClassMap, outArgument_outControllerClassMap, outArgument_outEntityMap, outArgument_outDocumentMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (1203)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
static GALGAS_string categoryReader_runBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("  ").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (209)).operator_concat (GALGAS_string (".target = ") COMMA_SOURCE_FILE_AT_LINE (209)).operator_concat (object->mAttribute_mTargetName COMMA_SOURCE_FILE_AT_LINE (209)).operator_concat (GALGAS_string (" ;\n") COMMA_SOURCE_FILE_AT_LINE (209)) ;
  //-------- @concatInstructionForGeneration
  result_outResult.dotAssign_operation (GALGAS_string ("  ").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (GALGAS_string (".action = @selector (") COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (object->mAttribute_mActionName COMMA_SOURCE_FILE_AT_LINE (210)).operator_concat (GALGAS_string (":) ;\n") COMMA_SOURCE_FILE_AT_LINE (210)) COMMA_SOURCE_FILE_AT_LINE (210)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_tableValueBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_columnBindingForTableValueBindingForGeneration enumerator_8069 (object->mAttribute_mColumnBindingForTableValueBindingForGeneration, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_8069.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("  if (nil == [").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (enumerator_8069.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string ("\"]) {\n") COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (GALGAS_string ("' NSTableView outlet has no formatter has no column with the ") COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (enumerator_8069.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (GALGAS_string (" identifier\") ;\n") COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (GALGAS_string ("  }else{\n") COMMA_SOURCE_FILE_AT_LINE (223)).operator_concat (GALGAS_string ("    NSActionCell * cell = [") COMMA_SOURCE_FILE_AT_LINE (224)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (224)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (224)).operator_concat (enumerator_8069.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (224)).operator_concat (GALGAS_string ("\"].dataCell ;\n") COMMA_SOURCE_FILE_AT_LINE (224)).operator_concat (GALGAS_string ("    if (! [cell isKindOfClass:[") COMMA_SOURCE_FILE_AT_LINE (225)).operator_concat (enumerator_8069.current (HERE).mAttribute_mRequiredCellClass COMMA_SOURCE_FILE_AT_LINE (225)).operator_concat (GALGAS_string (" class]]) {\n") COMMA_SOURCE_FILE_AT_LINE (225)).operator_concat (GALGAS_string ("      presentErrorWindow (__FILE__, __LINE__, @\"the dataCell is '") COMMA_SOURCE_FILE_AT_LINE (226)).operator_concat (enumerator_8069.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (226)).operator_concat (GALGAS_string ("' column of the '") COMMA_SOURCE_FILE_AT_LINE (226)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (226)).operator_concat (GALGAS_string ("' should be an '") COMMA_SOURCE_FILE_AT_LINE (226)).operator_concat (enumerator_8069.current (HERE).mAttribute_mRequiredCellClass COMMA_SOURCE_FILE_AT_LINE (226)).operator_concat (GALGAS_string (" instance\") ;\n") COMMA_SOURCE_FILE_AT_LINE (226)).operator_concat (GALGAS_string ("    }\n") COMMA_SOURCE_FILE_AT_LINE (227)).operator_concat (GALGAS_string ("  }\n") COMMA_SOURCE_FILE_AT_LINE (228)).operator_concat (GALGAS_string ("  [[") COMMA_SOURCE_FILE_AT_LINE (229)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (229)).operator_concat (GALGAS_string (" tableColumnWithIdentifier:@\"") COMMA_SOURCE_FILE_AT_LINE (229)).operator_concat (enumerator_8069.current (HERE).mAttribute_mColumnIdentifier COMMA_SOURCE_FILE_AT_LINE (229)).operator_concat (GALGAS_string ("\"]\n") COMMA_SOURCE_FILE_AT_LINE (229)).operator_concat (GALGAS_string ("    bind:@\"value\"\n") COMMA_SOURCE_FILE_AT_LINE (230)).operator_concat (GALGAS_string ("    toObject:") COMMA_SOURCE_FILE_AT_LINE (231)).operator_concat (object->mAttribute_mControllerName COMMA_SOURCE_FILE_AT_LINE (231)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (231)).operator_concat (GALGAS_string ("    withKeyPath:@\"arrangedObjects.") COMMA_SOURCE_FILE_AT_LINE (232)).operator_concat (enumerator_8069.current (HERE).mAttribute_mObservableAttributeName COMMA_SOURCE_FILE_AT_LINE (232)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (232)).operator_concat (GALGAS_string ("    options:") COMMA_SOURCE_FILE_AT_LINE (233)) COMMA_SOURCE_FILE_AT_LINE (221)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_8069.current (HERE).mAttribute_mOutletBindingOptionList.reader_length (SOURCE_FILE_AT_LINE (234)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      ...
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_9393 (enumerator_8069.current (HERE).mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_9393.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("      ").operator_concat (enumerator_9393.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (GALGAS_string (", @") COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (enumerator_9393.current_mValue_30_ (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (239)) COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (GALGAS_string (",\n") COMMA_SOURCE_FILE_AT_LINE (239)) COMMA_SOURCE_FILE_AT_LINE (239)) ;
...
static GALGAS_string categoryReader_regularBindingForGeneration_generateBinding (const cPtr_abstractBindingForGeneration * inObject,
  ...
  if (object->mAttribute_mRequiredFormatter.isValid ()) {
    ...
    case GALGAS_formatterEnum::kEnum_numberFormatter: {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("if ((nil != ").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (258)).operator_concat (GALGAS_string (") && (nil == ") COMMA_SOURCE_FILE_AT_LINE (258)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (258)).operator_concat (GALGAS_string (".formatter)) {\n") COMMA_SOURCE_FILE_AT_LINE (258)).operator_concat (GALGAS_string ("  presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (259)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (259)).operator_concat (GALGAS_string ("' outlet has no formatter, it should have an NSNumberFormatter\") ;\n") COMMA_SOURCE_FILE_AT_LINE (259)).operator_concat (GALGAS_string ("  }else if ((nil != ") COMMA_SOURCE_FILE_AT_LINE (260)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (260)).operator_concat (GALGAS_string (") && ![") COMMA_SOURCE_FILE_AT_LINE (260)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (260)).operator_concat (GALGAS_string (".formatter isKindOfClass:[NSNumberFormatter class]]) {\n") COMMA_SOURCE_FILE_AT_LINE (260)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (261)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (261)).operator_concat (GALGAS_string (" outlet has a formatter that is not kind of NSNumberFormatter class\") ;\n") COMMA_SOURCE_FILE_AT_LINE (261)).operator_concat (GALGAS_string ("  }\n") COMMA_SOURCE_FILE_AT_LINE (262)) COMMA_SOURCE_FILE_AT_LINE (258)) ;
      } break ;
    case GALGAS_formatterEnum::kEnum_dateFormatter: {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("  if ((nil != ").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (264)).operator_concat (GALGAS_string (") && (nil == ") COMMA_SOURCE_FILE_AT_LINE (264)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (264)).operator_concat (GALGAS_string (".formatter)) {\n") COMMA_SOURCE_FILE_AT_LINE (264)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (265)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (265)).operator_concat (GALGAS_string ("' outlet has no formatter, it should have an NSDateFormatter\") ;\n") COMMA_SOURCE_FILE_AT_LINE (265)).operator_concat (GALGAS_string ("  }else if ((nil != ") COMMA_SOURCE_FILE_AT_LINE (266)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (266)).operator_concat (GALGAS_string (") && ![") COMMA_SOURCE_FILE_AT_LINE (266)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (266)).operator_concat (GALGAS_string (".formatter isKindOfClass:[NSDateFormatter class]]) {\n") COMMA_SOURCE_FILE_AT_LINE (266)).operator_concat (GALGAS_string ("    presentErrorWindow (__FILE__, __LINE__, @\"the '") COMMA_SOURCE_FILE_AT_LINE (267)).operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (267)).operator_concat (GALGAS_string ("' outlet has a formatter that is not kind of NSDateFormatter class\") ;\n") COMMA_SOURCE_FILE_AT_LINE (267)).operator_concat (GALGAS_string ("  }\n") COMMA_SOURCE_FILE_AT_LINE (268)) COMMA_SOURCE_FILE_AT_LINE (264)) ;
      } break ;
    }
  }
  //-------- @concatInstructionForGeneration
  result_outResult.dotAssign_operation (GALGAS_string ("  [").operator_concat (constinArgument_inOutletName COMMA_SOURCE_FILE_AT_LINE (270)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (270)).operator_concat (GALGAS_string ("    bind:@\"") COMMA_SOURCE_FILE_AT_LINE (271)).operator_concat (object->mAttribute_mBindingName COMMA_SOURCE_FILE_AT_LINE (271)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (271)).operator_concat (GALGAS_string ("    toObject:") COMMA_SOURCE_FILE_AT_LINE (272)).operator_concat (object->mAttribute_mObservedObjectName COMMA_SOURCE_FILE_AT_LINE (272)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (272)).operator_concat (GALGAS_string ("    withKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (273)).operator_concat (object->mAttribute_mObservableAttributeName COMMA_SOURCE_FILE_AT_LINE (273)).operator_concat (GALGAS_string ("\"\n") COMMA_SOURCE_FILE_AT_LINE (273)).operator_concat (GALGAS_string ("    options:") COMMA_SOURCE_FILE_AT_LINE (274)) COMMA_SOURCE_FILE_AT_LINE (270)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, object->mAttribute_mOutletBindingOptionList.reader_length (SOURCE_FILE_AT_LINE (275)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator__32_stringlist enumerator_11516 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_11516.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("      ").operator_concat (enumerator_11516.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (280)).operator_concat (GALGAS_string (", @") COMMA_SOURCE_FILE_AT_LINE (280)).operator_concat (enumerator_11516.current_mValue_30_ (HERE).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (280)) COMMA_SOURCE_FILE_AT_LINE (280)).operator_concat (GALGAS_string (",\n") COMMA_SOURCE_FILE_AT_LINE (280)) COMMA_SOURCE_FILE_AT_LINE (280)) ;
...
void callCategoryMethod_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
                                              ...
                                              const GALGAS_classObservableObjectMap constin_inObservableObjectMap,
...
//--- Find method
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inEntityMap, constin_inObservableObjectMap, constin_inBindingMap, constin_inControllerMap, constin_inActionMap, constin_inHasTableValueBinding, io_ioOutletBindingListForGeneration, inCompiler COMMA_THERE) ;
    }
  }
}
...
static void categoryMethod_tableValueBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inHasTableValueBinding.operator_not (SOURCE_FILE_AT_LINE (539)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mControllerName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("this outlet does not support $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (540)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    ...
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_22013_0 ; // Joker input parameter
    GALGAS_actionMap joker_22086_0 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, joker_22013_0, var_controlledClassOrEntityName, var_controllerBindingList, joker_22086_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (544)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableDeclarationForGeneration
    GALGAS_classObservablePropertyMap var_observablePropertyMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_22187_3 ; // Joker input parameter
    GALGAS_string joker_22187_2 ; // Joker input parameter
    GALGAS_string joker_22187_1 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_22255_10 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_22255_9 ; // Joker input parameter
    GALGAS_attributeListForImplementation joker_22255_8 ; // Joker input parameter
    GALGAS_transientListForImplementation joker_22255_7 ; // Joker input parameter
    GALGAS_triggeredKeys joker_22255_6 ; // Joker input parameter
    GALGAS_relationshipList joker_22255_5 ; // Joker input parameter
    GALGAS_relationshipList joker_22255_4 ; // Joker input parameter
    GALGAS_propertyMap joker_22255_3 ; // Joker input parameter
    GALGAS_relationshipMap joker_22255_2 ; // Joker input parameter
    GALGAS_relationshipMap joker_22255_1 ; // Joker input parameter
    constinArgument_inEntityMap.method_searchKey (GALGAS_lstring::constructor_new (var_controlledClassOrEntityName, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (552)), joker_22187_3, joker_22187_2, joker_22187_1, var_observablePropertyMap, joker_22255_10, joker_22255_9, joker_22255_8, joker_22255_7, joker_22255_6, joker_22255_5, joker_22255_4, joker_22255_3, joker_22255_2, joker_22255_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (551)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_columnBindingForTableValueBindingForGeneration var_columnBindingForTableValueBindingForGeneration = GALGAS_columnBindingForTableValueBindingForGeneration::constructor_emptyList (SOURCE_FILE_AT_LINE (557)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_tableValueColumnBinding enumerator_22423 (object->mAttribute_mTableValueColumnBinding, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_22423.hasCurrentObject ()) {
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingType var_type ;
      //-------- @methodCallInstructionForGeneration
      GALGAS_stringlist joker_22553_0 ; // Joker input parameter
      var_observablePropertyMap.method_searchKey (enumerator_22423.current (HERE).mAttribute_mBoundPropertyName, var_type, joker_22553_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (560)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_requiredCellTypeInTableColumnBinding = categoryReader_requiredCellTypeInTableColumnBinding (var_type, inCompiler COMMA_SOURCE_FILE_AT_LINE (565)) ;
      //-------- @ifInstructionForGeneration
      ...
      if (kBoolTrue == test_2) {
        //-------- @errorInstructionForGeneration
        GALGAS_location location_3 (enumerator_22423.current (HERE).mAttribute_mBoundPropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_3, GALGAS_string ("this property cannot be named in a $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (567)) ;
      }else if (kBoolFalse == test_2) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_requiredCellTypeInTableColumnBinding.objectCompare (enumerator_22423.current (HERE).mAttribute_mCellTypeName.mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_4) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_5 (enumerator_22423.current (HERE).mAttribute_mCellTypeName.reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_5, GALGAS_string ("this property requires a ").operator_concat (var_requiredCellTypeInTableColumnBinding COMMA_SOURCE_FILE_AT_LINE (569)).operator_concat (GALGAS_string (" cell class") COMMA_SOURCE_FILE_AT_LINE (569)) COMMA_SOURCE_FILE_AT_LINE (569)) ;
        }
      }
      //-------- @plusEqualnstructionForGeneration
      var_columnBindingForTableValueBindingForGeneration.addAssign_operation (enumerator_22423.current (HERE).mAttribute_mColumnName.mAttribute_string, var_requiredCellTypeInTableColumnBinding, enumerator_22423.current (HERE).mAttribute_mBoundPropertyName.mAttribute_string, GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (575)) COMMA_SOURCE_FILE_AT_LINE (571)) ;
      enumerator_22423.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_tableValueBindingForGeneration::constructor_new (object->mAttribute_mControllerName.mAttribute_string, var_columnBindingForTableValueBindingForGeneration COMMA_SOURCE_FILE_AT_LINE (578)) COMMA_SOURCE_FILE_AT_LINE (578)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_inActionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (597)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_actionMap var_actionMap ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_string joker_24090_3 ; // Joker input parameter
    GALGAS_string joker_24090_2 ; // Joker input parameter
    GALGAS_outletBindingListForGeneration joker_24090_1 ; // Joker input parameter
    constinArgument_inControllerMap.method_searchKey (object->mAttribute_mTargetName, joker_24090_3, joker_24090_2, joker_24090_1, var_actionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (600)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @methodCallInstructionForGeneration
    var_actionMap.method_searchKey (object->mAttribute_mActionName, inCompiler COMMA_SOURCE_FILE_AT_LINE (601)) ;
    //-------- END @methodCallInstructionForGeneration
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_runBindingForGeneration::constructor_new (object->mAttribute_mTargetName.mAttribute_string, object->mAttribute_mActionName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (603)) COMMA_SOURCE_FILE_AT_LINE (603)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeOutletBinding (const cPtr_abstractBinding * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeFormatterList, var_outletClassBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (622)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  ...
  GALGAS_classObservablePropertyMap var_observablePropertyMap ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = constinArgument_inObservableObjectMap.reader_hasKey (object->mAttribute_mObservedObjectName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (626)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @methodCallInstructionForGeneration
    constinArgument_inObservableObjectMap.method_searchKey (GALGAS_lstring::constructor_new (object->mAttribute_mObservedObjectName.mAttribute_string, inCompiler->here () COMMA_SOURCE_FILE_AT_LINE (628)), var_observedObjectOCName, var_observablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (627)) ;
    //-------- END @methodCallInstructionForGeneration
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the '").operator_concat (object->mAttribute_mObservedObjectName.reader_string (SOURCE_FILE_AT_LINE (634)) COMMA_SOURCE_FILE_AT_LINE (634)).operator_concat (GALGAS_string ("' object is not observable") COMMA_SOURCE_FILE_AT_LINE (634)) COMMA_SOURCE_FILE_AT_LINE (633)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_stringlist joker_25635_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_observablePropertyType, joker_25635_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (639)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_formatterEnum var_requiredFormatter = GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (642)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_25805 (var_acceptableTypeFormatterList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (643)).isValidAndTrue () ;
  if (enumerator_25805.hasCurrentObject () && bool_2) {
    while (enumerator_25805.hasCurrentObject () && bool_2) {
      //-------- @assignmentInstructionForGeneration
      var_requiredFormatter = enumerator_25805.current_mRequiredFormatter (HERE) ;
      //-------- @assignmentInstructionForGeneration
      var_found = GALGAS_bool (kIsEqual, enumerator_25805.current_mType (HERE).objectCompare (var_observablePropertyType)) ;
      enumerator_25805.gotoNextObject () ;
      if (enumerator_25805.hasCurrentObject ()) {
        bool_2 = var_found.operator_not (SOURCE_FILE_AT_LINE (643)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_3 = var_found.operator_not (SOURCE_FILE_AT_LINE (647)).boolEnum () ;
  if (kBoolTrue == test_3) {
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_string var_s = GALGAS_string ("the bound property has '").operator_concat (categoryReader_ebTypeName (var_observablePropertyType, inCompiler COMMA_SOURCE_FILE_AT_LINE (648)) COMMA_SOURCE_FILE_AT_LINE (648)).operator_concat (GALGAS_string ("' type, acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (648)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeAndFormatterList enumerator_26109 (var_acceptableTypeFormatterList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (649)).isValidAndTrue () ;
    if (enumerator_26109.hasCurrentObject () && bool_4) {
      while (enumerator_26109.hasCurrentObject () && bool_4) {
        //-------- @concatInstructionForGeneration
        var_s.dotAssign_operation (GALGAS_string ("\n"
          "  - '").operator_concat (categoryReader_ebTypeName (enumerator_26109.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (650)) COMMA_SOURCE_FILE_AT_LINE (650)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (650)) COMMA_SOURCE_FILE_AT_LINE (650)) ;
        enumerator_26109.gotoNextObject () ;
        if (enumerator_26109.hasCurrentObject ()) {
          bool_4 = var_found.operator_not (SOURCE_FILE_AT_LINE (649)).isValidAndTrue () ;
        }
      }
    }
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_5, var_s COMMA_SOURCE_FILE_AT_LINE (652)) ;
  }
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS__32_stringlist var_bindingOptionList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (655)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_outletBindingOptionList enumerator_26344 (object->mAttribute_mOutletBindingOptionList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_26344.hasCurrentObject ()) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingTypeList var_acceptableTypeList ;
    //-------- @methodCallInstructionForGeneration
    var_outletClassBindingOptionMap.method_searchKey (enumerator_26344.current_mOptionName (HERE), var_acceptableTypeList, inCompiler COMMA_SOURCE_FILE_AT_LINE (658)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
    GALGAS_bool var_found = GALGAS_bool (false) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_easyBindingTypeList enumerator_26533 (var_acceptableTypeList, kEnumeration_up) ;
    //--- complex foreach instruction
    bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (660)).isValidAndTrue () ;
    if (enumerator_26533.hasCurrentObject () && bool_6) {
      while (enumerator_26533.hasCurrentObject () && bool_6) {
        //-------- @foreachInstructionForGeneration
        cEnumerator_easyBindingTypeList enumerator_26597 (enumerator_26344.current_mOptionValuePossibleTypes (HERE), kEnumeration_up) ;
        //--- complex foreach instruction
        bool bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (661)).isValidAndTrue () ;
        if (enumerator_26597.hasCurrentObject () && bool_7) {
          while (enumerator_26597.hasCurrentObject () && bool_7) {
            //-------- @assignmentInstructionForGeneration
            var_found = GALGAS_bool (kIsEqual, enumerator_26533.current_mType (HERE).objectCompare (enumerator_26597.current_mType (HERE))) ;
            enumerator_26597.gotoNextObject () ;
            if (enumerator_26597.hasCurrentObject ()) {
              bool_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (661)).isValidAndTrue () ;
            }
          }
        }
        enumerator_26533.gotoNextObject () ;
        if (enumerator_26533.hasCurrentObject ()) {
          bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (660)).isValidAndTrue () ;
        }
      }
    }
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_8 = var_found.operator_not (SOURCE_FILE_AT_LINE (665)).boolEnum () ;
    if (kBoolTrue == test_8) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_s = GALGAS_string ("the option value acceptable types are:") ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_easyBindingTypeList enumerator_26836 (var_acceptableTypeList, kEnumeration_up) ;
      //--- complex foreach instruction
      bool bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (667)).isValidAndTrue () ;
      if (enumerator_26836.hasCurrentObject () && bool_9) {
        while (enumerator_26836.hasCurrentObject () && bool_9) {
          //-------- @concatInstructionForGeneration
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - '").operator_concat (categoryReader_ebTypeName (enumerator_26836.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (668)) COMMA_SOURCE_FILE_AT_LINE (668)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (668)) COMMA_SOURCE_FILE_AT_LINE (668)) ;
          enumerator_26836.gotoNextObject () ;
          if (enumerator_26836.hasCurrentObject ()) {
            bool_9 = var_found.operator_not (SOURCE_FILE_AT_LINE (667)).isValidAndTrue () ;
          }
        }
      }
      //-------- @errorInstructionForGeneration
      GALGAS_location location_10 (enumerator_26344.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_10, var_s COMMA_SOURCE_FILE_AT_LINE (670)) ;
    }
    //-------- @plusEqualnstructionForGeneration
    var_bindingOptionList.addAssign_operation (enumerator_26344.current_mOptionName (HERE).reader_string (SOURCE_FILE_AT_LINE (672)), enumerator_26344.current_mOptionValueObjectiveCObject (HERE) COMMA_SOURCE_FILE_AT_LINE (672)) ;
    enumerator_26344.gotoNextObject () ;
  }
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioOutletBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.reader_string (SOURCE_FILE_AT_LINE (675)), var_requiredFormatter, var_observedObjectOCName, object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (678)), var_bindingOptionList COMMA_SOURCE_FILE_AT_LINE (674)) COMMA_SOURCE_FILE_AT_LINE (674)) ;
}
//---------------------------------------------------------------------------*
...
GALGAS_string categoryReader_ebTypeIdentifier (const GALGAS_easyBindingType & inObject,
  ...
  if (temp_0.isValid ()) {
    ...
    case GALGAS_easyBindingType::kEnum_toManyEntitiesType: {
      //-------- @assignmentInstructionForGeneration
      result_outResult = GALGAS_string ("toMany[").operator_concat (constinArgument_inClassOrEntityName COMMA_SOURCE_FILE_AT_LINE (781)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (781)) ;
      } break ;
    }
  }
//---
...
static void categoryMethod_tableValueBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $tableValue binding") COMMA_SOURCE_FILE_AT_LINE (832)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_runBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("a controller does not implement $run action") COMMA_SOURCE_FILE_AT_LINE (844)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_regularBinding_analyzeControllerBinding (const cPtr_abstractBinding * inObject,
  ...
  if (kBoolTrue == test_0) {
    ...
    //-------- @assignmentInstructionForGeneration
    var_resultingObservedPropertyPath = GALGAS_string ("selection.").operator_concat (object->mAttribute_mObservableAttributeName.reader_string (SOURCE_FILE_AT_LINE (860)) COMMA_SOURCE_FILE_AT_LINE (860)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mObservedObjectName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("observed object should be 'root'") COMMA_SOURCE_FILE_AT_LINE (862)) ;
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = constinArgument_inAllObservablePropertyMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (868)).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @localVariableDeclarationForGeneration
    GALGAS_easyBindingType var_t ;
    //-------- @methodCallInstructionForGeneration
    GALGAS_stringlist joker_35130_0 ; // Joker input parameter
    constinArgument_inAllObservablePropertyMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_t, joker_35130_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (870)) ;
    //-------- END @methodCallInstructionForGeneration
    //-------- @assignmentInstructionForGeneration
    var_boundTypeIdentifierString = categoryReader_ebTypeIdentifier (var_t, GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (871)) ;
  }else if (kBoolFalse == test_2) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = constinArgument_inAllRelationshipMap.reader_hasKey (object->mAttribute_mObservableAttributeName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (872)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @localVariableDeclarationForGeneration
      ...
      //-------- @methodCallInstructionForGeneration
      GALGAS_lstring joker_35426_2 ; // Joker input parameter
      GALGAS_deleteRuleEnum joker_35426_1 ; // Joker input parameter
      constinArgument_inAllRelationshipMap.method_searchKey (object->mAttribute_mObservableAttributeName, var_isToMany, var_destinationEntityName, joker_35426_2, joker_35426_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (875)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_4 = var_isToMany.boolEnum () ;
      if (kBoolTrue == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toMany[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (877)) COMMA_SOURCE_FILE_AT_LINE (877)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (877)) ;
      }else if (kBoolFalse == test_4) {
        //-------- @assignmentInstructionForGeneration
        var_boundTypeIdentifierString = GALGAS_string ("toOne[").operator_concat (var_destinationEntityName.reader_string (SOURCE_FILE_AT_LINE (879)) COMMA_SOURCE_FILE_AT_LINE (879)).operator_concat (GALGAS_string ("]") COMMA_SOURCE_FILE_AT_LINE (879)) ;
      }
    }else if (kBoolFalse == test_3) {
      //-------- @errorInstructionForGeneration
      GALGAS_location location_5 (object->mAttribute_mObservableAttributeName.reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("unknown property") COMMA_SOURCE_FILE_AT_LINE (882)) ;
  ...
  //-------- @methodCallInstructionForGeneration
  constinArgument_inControllerClassBindingMap.method_searchKey (object->mAttribute_mBindingName, var_acceptableTypeList, var_availableBindingOptionMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (888)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_found = GALGAS_bool (false) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_easyBindingTypeAndFormatterList enumerator_36057 (var_acceptableTypeList, kEnumeration_up) ;
  //--- complex foreach instruction
  bool bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (891)).isValidAndTrue () ;
  if (enumerator_36057.hasCurrentObject () && bool_6) {
    while (enumerator_36057.hasCurrentObject () && bool_6) {
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_acceptableType = categoryReader_ebTypeIdentifier (enumerator_36057.current_mType (HERE), constinArgument_inControlledClassOrEntityName.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (892)) ;
      //-------- @concatInstructionForGeneration
      var_acceptableTypesString.dotAssign_operation (GALGAS_string ("\n"
        "-  '").operator_concat (var_acceptableType COMMA_SOURCE_FILE_AT_LINE (893)).operator_concat (GALGAS_string ("'") COMMA_SOURCE_FILE_AT_LINE (893)) COMMA_SOURCE_FILE_AT_LINE (893)) ;
      //-------- @assignmentInstructionForGeneration
      ...
      if (enumerator_36057.hasCurrentObject ()) {
        bool_6 = var_found.operator_not (SOURCE_FILE_AT_LINE (891)).isValidAndTrue () ;
      }
    }
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_7 = var_found.operator_not (SOURCE_FILE_AT_LINE (896)).boolEnum () ;
  if (kBoolTrue == test_7) {
    //-------- @errorInstructionForGeneration
    ...
    inCompiler->emitSemanticError (location_8, GALGAS_string ("cannot bind: property type is '").operator_concat (var_boundTypeIdentifierString COMMA_SOURCE_FILE_AT_LINE (898)).operator_concat (GALGAS_string ("', acceptable type(s):") COMMA_SOURCE_FILE_AT_LINE (898)).operator_concat (var_acceptableTypesString COMMA_SOURCE_FILE_AT_LINE (898)) COMMA_SOURCE_FILE_AT_LINE (897)) ;
  }
  //-------- @localVariableDeclarationForGeneration
  GALGAS__32_stringlist var_bindingOptionListForGeneration ;
  { //-------- @routineCallInstructionForGeneration
  routine_checkBindingOptions (object->mAttribute_mOutletBindingOptionList, var_availableBindingOptionMap, var_bindingOptionListForGeneration, inCompiler COMMA_SOURCE_FILE_AT_LINE (901)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioBindingListForGeneration.addAssign_operation (GALGAS_regularBindingForGeneration::constructor_new (object->mAttribute_mBindingName.mAttribute_string, GALGAS_formatterEnum::constructor_noFormatter (SOURCE_FILE_AT_LINE (908)), var_resultingObservedObjectName, var_resultingObservedPropertyPath, var_bindingOptionListForGeneration COMMA_SOURCE_FILE_AT_LINE (906)) COMMA_SOURCE_FILE_AT_LINE (906)) ;
}
//---------------------------------------------------------------------------*
...
mAttribute_mObservableProperties (inOperand2) {
}
...
GALGAS_classObservableObjectMap_2E_element GALGAS_classObservableObjectMap_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_classObservableObjectMap_2E_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
...
GALGAS_triggeredKeys GALGAS_documentMap_2E_element::reader_mTriggeredKeys (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mTriggeredKeys ;
}
...
GALGAS_classObservablePropertyMap GALGAS_controllerClassMap_2E_element::reader_mObservablePropertyMap (UNUSED_LOCATION_ARGS) const {
  return mAttribute_mObservablePropertyMap ;
}
