...
//                                         september 29th, 2014, at 19h36'27"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
typedef void (*categoryMethodSignature_abstractEnableBindingExpressionAST_analyzeExpressionForEnabledBinding) (const class cPtr_abstractEnableBindingExpressionAST * inObject,
                                                                                                               ...
                                                                                                               class GALGAS_abstractEnableBindingExpressionForGeneration & outArgument6,
                                                                                                               class C_Compiler * inCompiler
                                                                                                               COMMA_LOCATION_ARGS) ;
...
void callCategoryMethod_analyzeExpressionForEnabledBinding (const class cPtr_abstractEnableBindingExpressionAST * inObject,
...
typedef class GALGAS_stringlist (*categoryReaderSignature_abstractEnableBindingExpressionForGeneration_observedObjectList) (const class cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                                                                                            class C_Compiler * inCompiler
                                                                                                                            COMMA_LOCATION_ARGS) ;
...
void enterCategoryReader_observedObjectList (const int32_t inClassIndex,
                                             categoryReaderSignature_abstractEnableBindingExpressionForGeneration_observedObjectList inMethod) ;

//---------------------------------------------------------------------------------------------------------------------*

class GALGAS_stringlist callCategoryReader_observedObjectList (const class cPtr_abstractEnableBindingExpressionForGeneration * inObject,
                                                               C_Compiler * inCompiler
                                                               COMMA_LOCATION_ARGS) ;
