...
void routine_typeAnalysis (const class GALGAS_unifiedTypeMap constinArgument0,
                           ...
                           class GALGAS_structForGeneration & outArgument2,
...
void routine_unifiedTypeAnalysis (const class GALGAS_unifiedTypeMap constinArgument0,
                                  ...
                                  const class GALGAS_typeKind constinArgument3,
                                  const class GALGAS_unifiedTypeProxy constinArgument4,
                                  const class GALGAS_unifiedTypeProxy constinArgument5,
                                  const class GALGAS_decoratedAttributeMap constinArgument6,
                                  const class GALGAS_decoratedTransientMap constinArgument7,
                                  const class GALGAS_decoratedOutletMap constinArgument8,
                                  const class GALGAS_decoratedObservablePropertyMap constinArgument9,
                                  const class GALGAS_decoratedEntityRelationshipMap constinArgument10,
                                  const class GALGAS_decoratedObservablePropertyMap constinArgument11,
                                  const class GALGAS_actionMap constinArgument12,
                                  class GALGAS_structForGeneration & ioArgument13,
                                  class C_Compiler * inCompiler
                                  COMMA_LOCATION_ARGS) ;
