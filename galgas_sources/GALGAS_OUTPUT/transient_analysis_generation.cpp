...
cMapElement * cMapElement_observablePropertyMap::copy (void) {
  ...
  macroMyNew (result, cMapElement_observablePropertyMap (mAttribute_lkey, mAttribute_mType, mAttribute_mPropertyDependancyList COMMA_HERE)) ;
  return result ;
}
...
GALGAS_observablePropertyMap_2E_element cEnumerator_observablePropertyMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cMapElement_observablePropertyMap) ;
  return GALGAS_observablePropertyMap_2E_element (p->mAttribute_lkey, p->mAttribute_mType, p->mAttribute_mPropertyDependancyList) ;
}
...
void routine_analyzeTransientProperties (const GALGAS_transientList constinArgument_inTransientList,
  ...
  outArgument_outTransientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (81)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientList enumerator_3114 (constinArgument_inTransientList, kEnumeration_up) ;
  ...
  while (enumerator_3114.hasCurrentObject ()) {
    ...
    GALGAS_stringlist var_allPropertyDependancyList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE_AT_LINE (83)) ;
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (84)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_dependanceList enumerator_3262 (enumerator_3114.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_3262.hasCurrentObject ()) {
      ...
      var_observableObjectMap.modifier_insertKey (GALGAS_string ("self").reader_nowhere (SOURCE_FILE_AT_LINE (88)), GALGAS_string ("self"), GALGAS_string::makeEmptyString (), ioArgument_ioSelfObjectObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (87)) ;
      ...
      var_observableObjectMap.method_searchKey (enumerator_3262.current_mObjectName (HERE), var_observableObjectOCName, var_includeFileName, var_observableAttributeMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (96)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      ioArgument_ioImplementationFileInclusionSet.addAssign_operation (var_includeFileName COMMA_SOURCE_FILE_AT_LINE (97)) ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_easyBindingType var_type ;
      //-------- @localVariableDeclarationForGeneration
      GALGAS_stringlist var_propertyDependancyList ;
      //-------- @methodCallInstructionForGeneration
      var_observableAttributeMap.method_searchKey (enumerator_3262.current_mPropertyName (HERE), var_type, var_propertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (100)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
      GALGAS_string var_observableKeyPath = enumerator_3262.current_mPropertyName (HERE).mAttribute_string ;
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = enumerator_3262.current_mNamesCountOption (HERE).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @ifInstructionForGeneration
        const enumGalgasBool test_1 = GALGAS_bool (kIsEqual, var_type.objectCompare (GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (104)))).boolEnum () ;
        if (kBoolTrue == test_1) {
          //-------- @concatInstructionForGeneration
          var_observableKeyPath.dotAssign_operation (GALGAS_string (".@count") COMMA_SOURCE_FILE_AT_LINE (105)) ;
          //-------- @assignmentInstructionForGeneration
          var_type = GALGAS_easyBindingType::constructor_uintegerType (SOURCE_FILE_AT_LINE (106)) ;
        }else if (kBoolFalse == test_1) {
          //-------- @errorInstructionForGeneration
          GALGAS_location location_2 (enumerator_3262.current_mPropertyName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_2, GALGAS_string ("the 'count' path is only allowed for to-many relationships") COMMA_SOURCE_FILE_AT_LINE (108)) ;
        }
      }
      //-------- @plusEqualnstructionForGeneration
      var_directDependancyList.addAssign_operation (var_type, var_observableObjectOCName, var_observableKeyPath COMMA_SOURCE_FILE_AT_LINE (111)) ;
      //-------- @concatInstructionForGeneration
      var_allPropertyDependancyList.dotAssign_operation (var_propertyDependancyList COMMA_SOURCE_FILE_AT_LINE (112)) ;
      enumerator_3262.gotoNextObject () ;
    }
    //-------- @plusEqualnstructionForGeneration
    outArgument_outTransientListForImplementation.addAssign_operation (enumerator_3114.current_mType (HERE), enumerator_3114.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (114)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (114)) ;
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSelfObjectObservablePropertyMap.modifier_insertKey (enumerator_3114.current_mTransientName (HERE), enumerator_3114.current_mType (HERE), var_allPropertyDependancyList, inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) ;
    } //-------- END @typeMethodInstructionForGeneration
...
GALGAS_string function_generateTransientFunctionDeclarations (const GALGAS_string & constinArgument_inKindName,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_5347 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_5347.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (categoryReader_ocTypeName (enumerator_5347.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (132)).operator_concat (GALGAS_string (" compute_") COMMA_SOURCE_FILE_AT_LINE (132)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (132)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (132)).operator_concat (enumerator_5347.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (132)).operator_concat (GALGAS_string (" (\n") COMMA_SOURCE_FILE_AT_LINE (132)) COMMA_SOURCE_FILE_AT_LINE (132)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_5479 (enumerator_5347.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_5479.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("    ").operator_concat (categoryReader_ocTypeName (enumerator_5479.current_mMasterType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (135)) COMMA_SOURCE_FILE_AT_LINE (135)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (136)).operator_concat (enumerator_5479.current_mMasterPropertyName (HERE).reader_stringByReplacingStringByString (GALGAS_string (".@"), GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE_AT_LINE (136)).reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (135)) ;
      if (enumerator_5479.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
...
GALGAS_string function_generateTransientImplementation (const GALGAS_string & constinArgument_inKindName,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_triggeredKeysForSelfObject var_triggeredKeys = GALGAS_triggeredKeysForSelfObject::constructor_emptyMap (SOURCE_FILE_AT_LINE (160)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_triggeredKeysForOtherObjects var_triggeredKeysFromOtherObjects = GALGAS_triggeredKeysForOtherObjects::constructor_emptyMap (SOURCE_FILE_AT_LINE (161)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_6519 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_6519.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_6550 (enumerator_6519.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_6550.hasCurrentObject ()) {
      //-------- @ifInstructionForGeneration
      const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_6550.current_mMasterObjectName (HERE).objectCompare (GALGAS_string ("self"))).boolEnum () ;
      if (kBoolTrue == test_0) {
        //-------- @plusEqualnstructionForGeneration
        var_triggeredKeys.addAssign_operation (enumerator_6550.current_mMasterPropertyName (HERE), enumerator_6519.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (165)) ;
      }else if (kBoolFalse == test_0) {
        //-------- @plusEqualnstructionForGeneration
        var_triggeredKeysFromOtherObjects.addAssign_operation (enumerator_6550.current_mMasterObjectName (HERE), enumerator_6550.current_mMasterPropertyName (HERE), enumerator_6519.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (167)) ;
      }
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, var_triggeredKeysFromOtherObjects.reader_count (SOURCE_FILE_AT_LINE (176)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "\n"
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForOtherObjects enumerator_7334 (var_triggeredKeysFromOtherObjects, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_7334.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_7370 (enumerator_7334.current (HERE).mAttribute_mList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_7370.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  [").operator_concat (enumerator_7334.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (184)).operator_concat (GALGAS_string ("\n"
          "    addObserver:self\n"
          "    forKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (184)).operator_concat (enumerator_7370.current (HERE).mAttribute_mValue_30_ COMMA_SOURCE_FILE_AT_LINE (186)).operator_concat (GALGAS_string ("\"\n"
          "    options:0\n"
          "    context:NULL\n"
          "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (183)) ;
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForOtherObjects enumerator_7897 (var_triggeredKeysFromOtherObjects, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_7897.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_7933 (enumerator_7897.current (HERE).mAttribute_mList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_7933.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  [").operator_concat (enumerator_7897.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (200)).operator_concat (GALGAS_string ("\n"
          "    removeObserver:self\n"
          "    forKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (200)).operator_concat (enumerator_7933.current (HERE).mAttribute_mValue_30_ COMMA_SOURCE_FILE_AT_LINE (202)).operator_concat (GALGAS_string ("\"\n"
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForOtherObjects enumerator_8581 (var_triggeredKeysFromOtherObjects, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_8581.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (" if (inObject == ").operator_concat (enumerator_8581.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (217)).operator_concat (GALGAS_string (") {\n") COMMA_SOURCE_FILE_AT_LINE (217)) COMMA_SOURCE_FILE_AT_LINE (217)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_8689 (enumerator_8581.current (HERE).mAttribute_mList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_8689.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("    if ([inKeyPath isEqualToString:@\"").operator_concat (enumerator_8689.current (HERE).mAttribute_mValue_30_ COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (GALGAS_string ("\"]) {\n"
          "      [self pmNotifyChangeForTransientProperty:@\"") COMMA_SOURCE_FILE_AT_LINE (221)).operator_concat (enumerator_8689.current (HERE).mAttribute_mValue_31_ COMMA_SOURCE_FILE_AT_LINE (222)).operator_concat (GALGAS_string ("\"] ;\n"
          "    }\n") COMMA_SOURCE_FILE_AT_LINE (222)) COMMA_SOURCE_FILE_AT_LINE (220)) ;
        enumerator_8689.gotoNextObject () ;
      }
      if (enumerator_8581.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  }else") COMMA_SOURCE_FILE_AT_LINE (226)) ;
      }
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_triggeredKeys.reader_count (SOURCE_FILE_AT_LINE (232)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "\n"
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForSelfObject enumerator_9391 (var_triggeredKeys, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_9391.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (" if ([inKey isEqualToString:@\"").operator_concat (enumerator_9391.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (GALGAS_string ("\"]) {\n") COMMA_SOURCE_FILE_AT_LINE (241)) COMMA_SOURCE_FILE_AT_LINE (241)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_9510 (enumerator_9391.current (HERE).mAttribute_mList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_9510.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("    [self pmNotifyChangeForTransientProperty:@\"").operator_concat (enumerator_9510.current (HERE).mAttribute_mValue COMMA_SOURCE_FILE_AT_LINE (243)).operator_concat (GALGAS_string ("\"] ;\n") COMMA_SOURCE_FILE_AT_LINE (243)) COMMA_SOURCE_FILE_AT_LINE (243)) ;
        enumerator_9510.gotoNextObject () ;
      }
      if (enumerator_9391.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  }else") COMMA_SOURCE_FILE_AT_LINE (246)) ;
      }
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_9785 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_9785.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "\n"
      "- (").operator_concat (categoryReader_ocTypeName (enumerator_9785.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (255)) COMMA_SOURCE_FILE_AT_LINE (255)).operator_concat (GALGAS_string (") ") COMMA_SOURCE_FILE_AT_LINE (255)).operator_concat (enumerator_9785.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (255)).operator_concat (GALGAS_string (" {\n"
      "  return compute_") COMMA_SOURCE_FILE_AT_LINE (255)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (256)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (256)).operator_concat (enumerator_9785.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (256)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (256)) COMMA_SOURCE_FILE_AT_LINE (253)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_10063 (enumerator_9785.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_10063.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (enumerator_10063.current_mMasterObjectName (HERE).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (258)).operator_concat (enumerator_10063.current_mMasterPropertyName (HERE).reader_stringByReplacingStringByString (GALGAS_string ("@"), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (258)) COMMA_SOURCE_FILE_AT_LINE (258)) COMMA_SOURCE_FILE_AT_LINE (258)) ;
      if (enumerator_10063.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (259)) ;
      }
      enumerator_10063.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (261)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = categoryReader_copyOnAssign (enumerator_9785.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (262)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (".copy") COMMA_SOURCE_FILE_AT_LINE (262)) ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (" ;\n"
      "}\n"
