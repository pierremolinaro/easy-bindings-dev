...
void routine_analyzeTransientProperties (const GALGAS_preferencesMap constinArgument_inPreferencesMap,
  ...
  outArgument_outTransientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (429)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientList enumerator_15892 (constinArgument_inTransientList, kEnumeration_up) ;
  ...
  while (enumerator_15892.hasCurrentObject ()) {
    ...
    GALGAS_lstring var_transientObservationKey = GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (enumerator_15892.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (433)) COMMA_SOURCE_FILE_AT_LINE (433)), enumerator_15892.current_mTransientName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (432)) ;
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_transientObservationKey, var_transientObservationKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (436)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (438)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_dependanceList enumerator_16314 (enumerator_15892.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_16314.hasCurrentObject ()) {
      ...
      callCategoryMethod_analyze ((const cPtr_abstractTransientDependency *) enumerator_16314.current_mDependency (HERE).ptr (), enumerator_15892.current_mTransientName (HERE), ioArgument_ioSelfObjectObservablePropertyMap, constinArgument_inPreferencesMap, constinArgument_inControllerMap, constinArgument_inRootObjectObservablePropertyMap, constinArgument_inRootEntityName, constinArgument_inObervationDependencyPrefix, ioArgument_ioImplementationFileInclusionSet, ioArgument_ioTransientDependencyGraph, var_implementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (440)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_directDependancyList.addAssign_operation (var_implementation COMMA_SOURCE_FILE_AT_LINE (452)) ;
      enumerator_16314.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSelfObjectObservablePropertyMap.modifier_insertKey (enumerator_15892.current_mTransientName (HERE), enumerator_15892.current_mType (HERE), GALGAS_bool (true), var_transientObservationKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (455)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    outArgument_outTransientListForImplementation.addAssign_operation (enumerator_15892.current_mType (HERE), enumerator_15892.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (462)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (462)) ;
...
GALGAS_string function_generateTransientFunctionDeclarations (const GALGAS_string & constinArgument_inKindName,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("//----------------------------------------------------------------------------*\n").operator_concat (GALGAS_string ("//   T R A N S I E N T    P R O P E R T I E S                                 *\n") COMMA_SOURCE_FILE_AT_LINE (475)).operator_concat (GALGAS_string ("//----------------------------------------------------------------------------*\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (476)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_17738 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17738.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (categoryReader_ocTypeName (enumerator_17738.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (479)).operator_concat (GALGAS_string (" compute_") COMMA_SOURCE_FILE_AT_LINE (479)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (479)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (479)).operator_concat (enumerator_17738.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (479)).operator_concat (GALGAS_string (" (\n") COMMA_SOURCE_FILE_AT_LINE (479)) COMMA_SOURCE_FILE_AT_LINE (479)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_17879 (enumerator_17738.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_17879.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("    ").operator_concat (callCategoryReader_generateFormalArgument ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_17879.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (482)) COMMA_SOURCE_FILE_AT_LINE (482)) COMMA_SOURCE_FILE_AT_LINE (482)) ;
      if (enumerator_17879.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
...
GALGAS_string function_generateTransientCacheRoutine (const GALGAS_string & constinArgument_inKindName,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_18366 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_18366.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "// Cache routine of '").operator_concat (enumerator_18366.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (501)).operator_concat (GALGAS_string ("' transient     *\n"
      "//----------------------------------------------------------------------------*\n"
      "\n"
      "- (") COMMA_SOURCE_FILE_AT_LINE (501)).operator_concat (categoryReader_ocTypeName (enumerator_18366.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (503)) COMMA_SOURCE_FILE_AT_LINE (503)).operator_concat (GALGAS_string (") ") COMMA_SOURCE_FILE_AT_LINE (503)).operator_concat (enumerator_18366.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (503)).operator_concat (GALGAS_string (" {\n"
      "  if (! ") COMMA_SOURCE_FILE_AT_LINE (503)).operator_concat (enumerator_18366.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (504)).operator_concat (GALGAS_string ("__computed) {\n"
      "    ") COMMA_SOURCE_FILE_AT_LINE (504)).operator_concat (enumerator_18366.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (505)).operator_concat (GALGAS_string ("__cache = compute_") COMMA_SOURCE_FILE_AT_LINE (505)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (505)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (505)).operator_concat (enumerator_18366.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (505)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (505)) COMMA_SOURCE_FILE_AT_LINE (499)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_18889 (enumerator_18366.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_18889.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (callCategoryReader_generateMasterAttributeCall ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_18889.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (507)) COMMA_SOURCE_FILE_AT_LINE (507)) ;
      if (enumerator_18889.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (508)) ;
      }
      enumerator_18889.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (") ;\n"
      "    ").operator_concat (enumerator_18366.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (511)).operator_concat (GALGAS_string ("__computed = YES ;\n"
      "  }\n"
      "  return ") COMMA_SOURCE_FILE_AT_LINE (511)).operator_concat (enumerator_18366.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (513)).operator_concat (GALGAS_string ("__cache") COMMA_SOURCE_FILE_AT_LINE (513)) COMMA_SOURCE_FILE_AT_LINE (510)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = categoryReader_copyOnAssign (enumerator_18366.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (514)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (".copy") COMMA_SOURCE_FILE_AT_LINE (514)) ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (" ;\n"
      "}\n"
...
GALGAS_string function_generateTransientTriggering (const GALGAS_string & constinArgument_inPropertyName,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_masterSet = GALGAS_stringset::constructor_setWithString (constinArgument_inPropertyName COMMA_SOURCE_FILE_AT_LINE (631)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_registeredTransientSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (632)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_looping = GALGAS_bool (true) ;
  //-------- @loopInstructionForGeneration
  if (constinArgument_inTransientListForImplementation.reader_length (SOURCE_FILE_AT_LINE (634)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (634)).isValid ()) {
    PMUInt32 variant_23455 = constinArgument_inTransientListForImplementation.reader_length (SOURCE_FILE_AT_LINE (634)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (634)).uintValue () ;
    bool loop_23455 = true ;
    while (loop_23455) {
      loop_23455 = var_looping.isValid () ;
      if (loop_23455) {
        loop_23455 = var_looping.boolValue () ;
      }
      if (loop_23455 && (0 == variant_23455)) {
        loop_23455 = false ;
        inCompiler->loopRunTimeVariantError (SOURCE_FILE_AT_LINE (634)) ;
      }
      if (loop_23455) {
        variant_23455 -- ;
        //-------- @assignmentInstructionForGeneration
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_transientListForImplementation enumerator_23587 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_23587.hasCurrentObject ()) {
          //-------- @foreachInstructionForGeneration
          cEnumerator_directDependancyList enumerator_23620 (enumerator_23587.current_mDependencyList (HERE), kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_23620.hasCurrentObject ()) {
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_0 = var_registeredTransientSet.reader_hasKey (enumerator_23587.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (638)).operator_not (SOURCE_FILE_AT_LINE (638)).boolEnum () ;
            if (kBoolTrue == test_0) {
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_generateTransientTriggerFromSelfAttribute ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_23620.current_mDependency (HERE).ptr (), constinArgument_inPrefix, constinArgument_inClassName, enumerator_23587.current_mTransientName (HERE), var_masterSet, var_registeredTransientSet, var_looping, result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (639)) ;
              //-------- END @methodCallInstructionForGeneration
            }
...
GALGAS_string function_generateAddObserverForTransients (const GALGAS_transientListForImplementation & constinArgument_inTransientListForImplementation,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_26024 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_26024.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_26055 (enumerator_26024.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_26055.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateAddObserverForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_26055.current_mDependency (HERE).ptr (), constinArgument_inLeadingSpaces, result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (714)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_26055.gotoNextObject () ;
    }
    enumerator_26024.gotoNextObject () ;
  }
//---
  return result_outResult ;
}
...
GALGAS_string function_generateRemoveObserverForTransients (const GALGAS_transientListForImplementation & constinArgument_inTransientListForImplementation,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_27955 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_27955.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_27986 (enumerator_27955.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_27986.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateRemoveObserverForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_27986.current_mDependency (HERE).ptr (), result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (774)) ;
      //-------- END @methodCallInstructionForGeneration
...
GALGAS_string function_generateObserverRoutinesForTransient (const GALGAS_string & constinArgument_inKindName,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observerListMap var_didChangeTriggeredRoutineListMap = GALGAS_observerListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (843)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observerListMap var_observeForKeyPathRoutineElementListMap = GALGAS_observerListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (844)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_30848 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_30848.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_30879 (enumerator_30848.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_30879.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateObserverRoutineForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_30879.current_mDependency (HERE).ptr (), enumerator_30848.current_mTransientName (HERE), var_didChangeTriggeredRoutineListMap, var_observeForKeyPathRoutineElementListMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (847)) ;
      //-------- END @methodCallInstructionForGeneration
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_fullPrefix = constinArgument_inPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (855)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (855)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (855)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_observerListMap enumerator_31267 (var_didChangeTriggeredRoutineListMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_31267.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "//  ").operator_concat (enumerator_31267.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (859)).operator_concat (GALGAS_string ("_didChange   *\n"
      "//----------------------------------------------------------------------------*\n"
      "\n"
      "- (void) ") COMMA_SOURCE_FILE_AT_LINE (859)).operator_concat (enumerator_31267.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (861)).operator_concat (GALGAS_string ("_didChange {\n") COMMA_SOURCE_FILE_AT_LINE (861)) COMMA_SOURCE_FILE_AT_LINE (857)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringlist enumerator_31564 (enumerator_31267.current_mList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_31564.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (enumerator_31564.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (864)).operator_concat (GALGAS_string (" transient'\n"
        "  if (") COMMA_SOURCE_FILE_AT_LINE (864)).operator_concat (enumerator_31564.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (865)).operator_concat (GALGAS_string ("__computed) {\n"
        "    ") COMMA_SOURCE_FILE_AT_LINE (865)).operator_concat (enumerator_31564.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (866)).operator_concat (GALGAS_string ("__computed = NO ;\n"
        "    [PMTransientDependancyManager\n"
        "      enterTriggerForObject:self\n"
        "      transientIndex:") COMMA_SOURCE_FILE_AT_LINE (866)).operator_concat (var_fullPrefix.operator_concat (enumerator_31564.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (869)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)).operator_concat (GALGAS_string ("\n"
        "    ] ;\n"
        "  }\n") COMMA_SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (863)) ;
      enumerator_31564.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("}\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (873)) ;
    enumerator_31267.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_observerListMap enumerator_32115 (var_observeForKeyPathRoutineElementListMap, kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_0 = true ;
  if (enumerator_32115.hasCurrentObject () && bool_0) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
    ...
    while (enumerator_32115.hasCurrentObject () && bool_0) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (" if ((inObject == ").operator_concat (enumerator_32115.current_key (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (889)) COMMA_SOURCE_FILE_AT_LINE (889)).operator_concat (GALGAS_string (") && [inKeyPath isEqualToString:@\"") COMMA_SOURCE_FILE_AT_LINE (889)).operator_concat (enumerator_32115.current_key (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (889)) COMMA_SOURCE_FILE_AT_LINE (889)).operator_concat (GALGAS_string ("\"]) {\n") COMMA_SOURCE_FILE_AT_LINE (889)) COMMA_SOURCE_FILE_AT_LINE (888)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_32793 (enumerator_32115.current_mList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_32793.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (enumerator_32793.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (892)).operator_concat (GALGAS_string (" transient'\n"
          "    if (") COMMA_SOURCE_FILE_AT_LINE (892)).operator_concat (enumerator_32793.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (893)).operator_concat (GALGAS_string ("__computed) {\n"
          "      ") COMMA_SOURCE_FILE_AT_LINE (893)).operator_concat (enumerator_32793.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (894)).operator_concat (GALGAS_string ("__computed = NO ;\n"
          "      [PMTransientDependancyManager\n"
          "        enterTriggerForObject:self\n"
          "        transientIndex:") COMMA_SOURCE_FILE_AT_LINE (894)).operator_concat (var_fullPrefix.operator_concat (enumerator_32793.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (897)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (897)) COMMA_SOURCE_FILE_AT_LINE (897)).operator_concat (GALGAS_string ("\n"
          "      ] ;\n"
          "    }\n") COMMA_SOURCE_FILE_AT_LINE (897)) COMMA_SOURCE_FILE_AT_LINE (891)) ;
        enumerator_32793.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("  }else") COMMA_SOURCE_FILE_AT_LINE (901)) ;
...
void routine_generateTransientDependencyFiles (const GALGAS__32_stringlist constinArgument_inTransientDependencyArcList,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_dependentSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (942)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator__32_stringlist enumerator_34383 (constinArgument_inTransientDependencyArcList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_34383.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_graphString.dotAssign_operation (GALGAS_string ("// ").operator_concat (enumerator_34383.current_mValue_30_ (HERE) COMMA_SOURCE_FILE_AT_LINE (944)).operator_concat (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (944)).operator_concat (enumerator_34383.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (944)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (944)) COMMA_SOURCE_FILE_AT_LINE (944)) ;
    //-------- @plusEqualnstructionForGeneration
    var_dependentSet.addAssign_operation (enumerator_34383.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (945)) ;
    enumerator_34383.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_transientOrderedList = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_34580 (constinArgument_inSortedTransientOrderedList, kEnumeration_down) ;
  //--- simple foreach instruction
  while (enumerator_34580.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_transientOrderedList.dotAssign_operation (GALGAS_string ("// ").operator_concat (enumerator_34580.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (949)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (949)) COMMA_SOURCE_FILE_AT_LINE (949)) ;
    enumerator_34580.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_34788 (constinArgument_inSortedTransientOrderedList, kEnumeration_down) ;
  //--- simple foreach instruction
  while (enumerator_34788.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_dependentSet.reader_hasKey (enumerator_34788.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (955)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      var_transientIndexesString.dotAssign_operation (GALGAS_string ("#define ").operator_concat (enumerator_34788.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (956)) COMMA_SOURCE_FILE_AT_LINE (956)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (956)).operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (956)) COMMA_SOURCE_FILE_AT_LINE (956)).operator_concat (GALGAS_string (")\n") COMMA_SOURCE_FILE_AT_LINE (956)) COMMA_SOURCE_FILE_AT_LINE (956)) ;
      //-------- @concatInstructionForGeneration
      var_transientList.dotAssign_operation (GALGAS_string ("      @").operator_concat (enumerator_34788.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (957)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (957)) COMMA_SOURCE_FILE_AT_LINE (957)).operator_concat (GALGAS_string (", // ") COMMA_SOURCE_FILE_AT_LINE (957)).operator_concat (enumerator_34788.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (957)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (957)) COMMA_SOURCE_FILE_AT_LINE (957)) ;
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_s = GALGAS_string (filewrapperTemplate_transientManager_managerDeclaration (inCompiler, var_graphString, var_transientOrderedList, var_transientIndexesString, var_transientCount COMMA_SOURCE_FILE_AT_LINE (963))) ;
  ...
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inSourceDirectoryPath, GALGAS_string ("PMTransientDependancyManager.h"), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_s, GALGAS_string ("\n"
    "\n"), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (969)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_s = GALGAS_string (filewrapperTemplate_transientManager_managerImplementation (inCompiler, var_transientList COMMA_SOURCE_FILE_AT_LINE (979))) ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inSourceDirectoryPath, GALGAS_string ("PMTransientDependancyManager.m"), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_s, GALGAS_string ("\n"
    "\n"), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (982)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
static GALGAS_string categoryReader_transientDependencyFromRootForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @assignmentInstructionForGeneration
    result_outResult = GALGAS_string ("const NSUInteger in").operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (184)) COMMA_SOURCE_FILE_AT_LINE (184)).operator_concat (GALGAS_string ("_count") COMMA_SOURCE_FILE_AT_LINE (184)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @assignmentInstructionForGeneration
    result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (186)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (186)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (186)) COMMA_SOURCE_FILE_AT_LINE (186)) ;
  }
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromPreferenceForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (195)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (195)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (195)) COMMA_SOURCE_FILE_AT_LINE (195)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromSelfForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromSelfForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("self.").operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (209)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromRootForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("mRootObject.").operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (217)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mNamesCountOption.boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (".count") COMMA_SOURCE_FILE_AT_LINE (219)) ;
  }
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromControllerForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = object->mAttribute_mControllerName.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (228)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (228)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromPreferenceForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("g_").operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (236)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (236)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (236)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_transientLocalDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_10545_0 ; // Joker input parameter
  GALGAS_string joker_10552_0 ; // Joker input parameter
  constinArgument_inLocalObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_10545_0, joker_10552_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (288)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (object->mAttribute_mMasterName.reader_string (SOURCE_FILE_AT_LINE (296)) COMMA_SOURCE_FILE_AT_LINE (296)), object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (296)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (297)) COMMA_SOURCE_FILE_AT_LINE (297)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (297)) COMMA_SOURCE_FILE_AT_LINE (295)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromSelfForImplementation::constructor_new (object->mAttribute_mMasterName.mAttribute_string, var_masterType COMMA_SOURCE_FILE_AT_LINE (300)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientControllerDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_11701_3 ; // Joker input parameter
  GALGAS_outletBindingListForGeneration joker_11701_2 ; // Joker input parameter
  GALGAS_actionMap joker_11701_1 ; // Joker input parameter
  constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, var_controllerClassName, joker_11701_3, joker_11701_2, joker_11701_1, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (318)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_masterType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_11912_0 ; // Joker input parameter
  GALGAS_string joker_11919_0 ; // Joker input parameter
  var_controllerObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_11912_0, joker_11919_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (325)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (GALGAS_string ("controller.").operator_concat (var_controllerClassName COMMA_SOURCE_FILE_AT_LINE (333)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (333)).operator_concat (object->mAttribute_mMasterName.reader_string (SOURCE_FILE_AT_LINE (333)) COMMA_SOURCE_FILE_AT_LINE (333)), object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (333)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (334)) COMMA_SOURCE_FILE_AT_LINE (334)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (334)) COMMA_SOURCE_FILE_AT_LINE (332)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromControllerForImplementation::constructor_new (object->mAttribute_mControllerName.mAttribute_string, object->mAttribute_mMasterName.mAttribute_string, var_masterType COMMA_SOURCE_FILE_AT_LINE (337)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientRootDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_13072_0 ; // Joker input parameter
  constinArgument_inRootObjectObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_13072_0, var_masterDependencyKey, inCompiler COMMA_SOURCE_FILE_AT_LINE (354)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mNamesCountOption.operator_and (GALGAS_bool (kIsNotEqual, var_masterType.objectCompare (GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (361)))) COMMA_SOURCE_FILE_AT_LINE (361)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mMasterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the 'count' option is only allowed for to-many relationships") COMMA_SOURCE_FILE_AT_LINE (362)) ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (GALGAS_string ("entity.").operator_concat (constinArgument_inRootEntityName COMMA_SOURCE_FILE_AT_LINE (366)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (366)).operator_concat (object->mAttribute_mMasterName.reader_string (SOURCE_FILE_AT_LINE (366)) COMMA_SOURCE_FILE_AT_LINE (366)), object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (366)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (367)) COMMA_SOURCE_FILE_AT_LINE (367)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (367)) COMMA_SOURCE_FILE_AT_LINE (365)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromRootForImplementation::constructor_new (object->mAttribute_mMasterName.mAttribute_string, var_masterType, object->mAttribute_mNamesCountOption, var_masterDependencyKey.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (374)) COMMA_SOURCE_FILE_AT_LINE (370)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientPreferenceDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_attributeListForImplementation joker_14467_4 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_14467_3 ; // Joker input parameter
  GALGAS_outletGenerationList joker_14467_2 ; // Joker input parameter
  GALGAS_lstringlist joker_14467_1 ; // Joker input parameter
  GALGAS_stringset joker_14517_0 ; // Joker input parameter
  constinArgument_inPreferencesMap.method_searchKey (object->mAttribute_mPreferencesName, joker_14467_4, joker_14467_3, joker_14467_2, joker_14467_1, var_observablePropertyMap, joker_14517_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (392)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_masterType ;
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_14635_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, var_isTransient, joker_14635_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (393)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (GALGAS_string ("preference.").operator_concat (object->mAttribute_mPreferencesName.reader_string (SOURCE_FILE_AT_LINE (401)) COMMA_SOURCE_FILE_AT_LINE (401)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (401)).operator_concat (object->mAttribute_mMasterName.reader_string (SOURCE_FILE_AT_LINE (401)) COMMA_SOURCE_FILE_AT_LINE (401)), object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (401)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (402)) COMMA_SOURCE_FILE_AT_LINE (402)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (402)) COMMA_SOURCE_FILE_AT_LINE (400)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioImplementationFileInclusionSet.addAssign_operation (object->mAttribute_mPreferencesName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (405)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromPreferenceForImplementation::constructor_new (object->mAttribute_mPreferencesName.mAttribute_string, object->mAttribute_mMasterName.mAttribute_string, var_isTransient, var_masterType COMMA_SOURCE_FILE_AT_LINE (407)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromSelfForImplementation_generateTransientTriggerFromSelfAttribute (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromSelfForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = ioArgument_ioMasterAttributeSet.reader_hasKey (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (551)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioMasterAttributeSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (552)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioRegisteredTransientSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (553)) ;
    //-------- @assignmentInstructionForGeneration
    ioArgument_ioContinue = GALGAS_bool (true) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (556)).operator_concat (GALGAS_string (" transient'\n"
      "    if (") COMMA_SOURCE_FILE_AT_LINE (556)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (557)).operator_concat (GALGAS_string ("__computed) {\n"
      "      ") COMMA_SOURCE_FILE_AT_LINE (557)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (558)).operator_concat (GALGAS_string ("__computed = NO ;\n"
      "      [PMTransientDependancyManager\n"
      "        enterTriggerForObject:self\n"
      "        transientIndex:") COMMA_SOURCE_FILE_AT_LINE (558)).operator_concat (constinArgument_inPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (561)).operator_concat (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (561)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (561)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (561)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (561)) COMMA_SOURCE_FILE_AT_LINE (561)).operator_concat (GALGAS_string ("\n"
      "      ] ;\n"
      "    }\n") COMMA_SOURCE_FILE_AT_LINE (561)) COMMA_SOURCE_FILE_AT_LINE (555)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateTransientTriggerFromSelfAttribute (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = ioArgument_ioMasterAttributeSet.reader_hasKey (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (578)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioMasterAttributeSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (579)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioRegisteredTransientSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (580)) ;
    //-------- @assignmentInstructionForGeneration
    ioArgument_ioContinue = GALGAS_bool (true) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (583)).operator_concat (GALGAS_string (" transient'\n"
      "    if (") COMMA_SOURCE_FILE_AT_LINE (583)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (584)).operator_concat (GALGAS_string ("__computed) {\n"
      "      ") COMMA_SOURCE_FILE_AT_LINE (584)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (585)).operator_concat (GALGAS_string ("__computed = NO ;\n"
      "      [PMTransientDependancyManager\n"
      "        enterTriggerForObject:self\n"
      "        transientIndex:") COMMA_SOURCE_FILE_AT_LINE (585)).operator_concat (constinArgument_inPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (588)).operator_concat (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (588)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (588)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (588)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (588)) COMMA_SOURCE_FILE_AT_LINE (588)).operator_concat (GALGAS_string ("\n"
      "      ] ;\n"
      "    }\n") COMMA_SOURCE_FILE_AT_LINE (588)) COMMA_SOURCE_FILE_AT_LINE (582)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromControllerForImplementation_generateAddObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (constinArgument_inLeadingSpaces.operator_concat (GALGAS_string ("  [") COMMA_SOURCE_FILE_AT_LINE (675)).operator_concat (object->mAttribute_mControllerName COMMA_SOURCE_FILE_AT_LINE (676)).operator_concat (GALGAS_string ("\n"
    "    addObserver:self\n"
    "    forKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (676)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (678)).operator_concat (GALGAS_string ("\"\n"
    "    options:0\n"
    "    context:NULL\n"
    "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (678)) COMMA_SOURCE_FILE_AT_LINE (675)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateAddObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mMasterIsTransient.operator_not (SOURCE_FILE_AT_LINE (690)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (constinArgument_inLeadingSpaces.operator_concat (GALGAS_string ("  [g_") COMMA_SOURCE_FILE_AT_LINE (691)).operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (691)).operator_concat (GALGAS_string (" addObserverOf_") COMMA_SOURCE_FILE_AT_LINE (691)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (691)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (691)) COMMA_SOURCE_FILE_AT_LINE (691)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateAddObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (constinArgument_inLeadingSpaces.operator_concat (GALGAS_string ("  [mRootObject addObserverOf_") COMMA_SOURCE_FILE_AT_LINE (701)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (701)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (701)) COMMA_SOURCE_FILE_AT_LINE (701)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromControllerForImplementation_generateRemoveObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  [").operator_concat (object->mAttribute_mControllerName COMMA_SOURCE_FILE_AT_LINE (741)).operator_concat (GALGAS_string ("\n"
    "    removeObserver:self\n"
    "    forKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (741)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (743)).operator_concat (GALGAS_string ("\"\n"
    "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (743)) COMMA_SOURCE_FILE_AT_LINE (740)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateRemoveObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mMasterIsTransient.operator_not (SOURCE_FILE_AT_LINE (752)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  [g_").operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (753)).operator_concat (GALGAS_string (" removeObserverOf_") COMMA_SOURCE_FILE_AT_LINE (753)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (753)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (753)) COMMA_SOURCE_FILE_AT_LINE (753)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateRemoveObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  [mRootObject removeObserverOf_").operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (762)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (762)) COMMA_SOURCE_FILE_AT_LINE (762)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromControllerForImplementation_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioObserveForKeyPathRoutineElementListMap.addAssign_operation (object->mAttribute_mControllerName.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (809)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (809)), constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (809)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mMasterIsTransient.operator_not (SOURCE_FILE_AT_LINE (819)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_didChangeTriggeredRoutineListMap.addAssign_operation (GALGAS_string ("preference.").operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (820)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (820)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (820)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (820)), constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (820)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_didChangeTriggeredRoutineListMap.addAssign_operation (object->mAttribute_mTriggerRoutineName, constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (831)) ;
}
//---------------------------------------------------------------------------*
