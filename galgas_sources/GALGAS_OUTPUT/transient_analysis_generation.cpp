...
//                    december 11th, 2012, at 20h31'52"                      *
//                                                                           *
//---------------------------------------------------------------------------*
...
void routine_analyzeTransientProperties (const GALGAS_preferencesMap constinArgument_inPreferencesMap,
  ...
  outArgument_outTransientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (409)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientList enumerator_15019 (constinArgument_inTransientList, kEnumeration_up) ;
  ...
  while (enumerator_15019.hasCurrentObject ()) {
    ...
    GALGAS_lstring var_transientObservationKey = GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (enumerator_15019.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (413)) COMMA_SOURCE_FILE_AT_LINE (413)), enumerator_15019.current_mTransientName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (412)) ;
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_transientObservationKey, var_transientObservationKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (416)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (418)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_dependanceList enumerator_15441 (enumerator_15019.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_15441.hasCurrentObject ()) {
      ...
      callCategoryMethod_analyze ((const cPtr_abstractTransientDependency *) enumerator_15441.current_mDependency (HERE).ptr (), enumerator_15019.current_mTransientName (HERE), ioArgument_ioSelfObjectObservablePropertyMap, constinArgument_inPreferencesMap, constinArgument_inControllerMap, constinArgument_inRootObjectObservablePropertyMap, constinArgument_inRootEntityName, constinArgument_inObervationDependencyPrefix, ioArgument_ioImplementationFileInclusionSet, ioArgument_ioTransientDependencyGraph, var_implementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (420)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_directDependancyList.addAssign_operation (var_implementation COMMA_SOURCE_FILE_AT_LINE (432)) ;
      enumerator_15441.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSelfObjectObservablePropertyMap.modifier_insertKey (enumerator_15019.current_mTransientName (HERE), enumerator_15019.current_mType (HERE), GALGAS_bool (true), var_transientObservationKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (435)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    outArgument_outTransientListForImplementation.addAssign_operation (enumerator_15019.current_mType (HERE), enumerator_15019.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (442)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (442)) ;
...
GALGAS_string function_generateTransientFunctionDeclarations (const GALGAS_string & constinArgument_inKindName,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("//----------------------------------------------------------------------------*\n").operator_concat (GALGAS_string ("//   T R A N S I E N T    P R O P E R T I E S                                 *\n") COMMA_SOURCE_FILE_AT_LINE (455)).operator_concat (GALGAS_string ("//----------------------------------------------------------------------------*\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (456)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_16865 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_16865.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (categoryReader_ocTypeName (enumerator_16865.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (459)).operator_concat (GALGAS_string (" compute_") COMMA_SOURCE_FILE_AT_LINE (459)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (459)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (459)).operator_concat (enumerator_16865.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (459)).operator_concat (GALGAS_string (" (\n") COMMA_SOURCE_FILE_AT_LINE (459)) COMMA_SOURCE_FILE_AT_LINE (459)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_17006 (enumerator_16865.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_17006.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("    ").operator_concat (callCategoryReader_generateFormalArgument ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_17006.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (462)) COMMA_SOURCE_FILE_AT_LINE (462)) COMMA_SOURCE_FILE_AT_LINE (462)) ;
      if (enumerator_17006.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
...
GALGAS_string function_generateTransientCacheRoutine (const GALGAS_string & constinArgument_inKindName,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_17493 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17493.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "// Cache routine of '").operator_concat (enumerator_17493.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (481)).operator_concat (GALGAS_string ("' transient     *\n"
      "//----------------------------------------------------------------------------*\n"
      "\n"
      "- (") COMMA_SOURCE_FILE_AT_LINE (481)).operator_concat (categoryReader_ocTypeName (enumerator_17493.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (483)) COMMA_SOURCE_FILE_AT_LINE (483)).operator_concat (GALGAS_string (") ") COMMA_SOURCE_FILE_AT_LINE (483)).operator_concat (enumerator_17493.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (483)).operator_concat (GALGAS_string (" {\n"
      "  if (! ") COMMA_SOURCE_FILE_AT_LINE (483)).operator_concat (enumerator_17493.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (484)).operator_concat (GALGAS_string ("__computed) {\n"
      "    ") COMMA_SOURCE_FILE_AT_LINE (484)).operator_concat (enumerator_17493.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (485)).operator_concat (GALGAS_string ("__cache = compute_") COMMA_SOURCE_FILE_AT_LINE (485)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (485)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (485)).operator_concat (enumerator_17493.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (485)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (485)) COMMA_SOURCE_FILE_AT_LINE (479)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_18016 (enumerator_17493.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_18016.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (callCategoryReader_generateMasterAttributeCall ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_18016.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (487)) COMMA_SOURCE_FILE_AT_LINE (487)) ;
      if (enumerator_18016.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (488)) ;
      }
      enumerator_18016.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (") ;\n"
      "    ").operator_concat (enumerator_17493.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (491)).operator_concat (GALGAS_string ("__computed = YES ;\n"
      "  }\n"
      "  return ") COMMA_SOURCE_FILE_AT_LINE (491)).operator_concat (enumerator_17493.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (493)).operator_concat (GALGAS_string ("__cache") COMMA_SOURCE_FILE_AT_LINE (493)) COMMA_SOURCE_FILE_AT_LINE (490)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = categoryReader_copyOnAssign (enumerator_17493.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (494)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (".copy") COMMA_SOURCE_FILE_AT_LINE (494)) ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (" ;\n"
      "}\n"
...
GALGAS_string function_generateTransientTriggering (const GALGAS_string & constinArgument_inPropertyName,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_masterSet = GALGAS_stringset::constructor_setWithString (constinArgument_inPropertyName COMMA_SOURCE_FILE_AT_LINE (611)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_registeredTransientSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (612)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_looping = GALGAS_bool (true) ;
  //-------- @loopInstructionForGeneration
  if (constinArgument_inTransientListForImplementation.reader_length (SOURCE_FILE_AT_LINE (614)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (614)).isValid ()) {
    PMUInt32 variant_22582 = constinArgument_inTransientListForImplementation.reader_length (SOURCE_FILE_AT_LINE (614)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (614)).uintValue () ;
    bool loop_22582 = true ;
    while (loop_22582) {
      loop_22582 = var_looping.isValid () ;
      if (loop_22582) {
        loop_22582 = var_looping.boolValue () ;
      }
      if (loop_22582 && (0 == variant_22582)) {
        loop_22582 = false ;
      ...
      if (loop_22582) {
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_transientListForImplementation enumerator_22714 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_22714.hasCurrentObject ()) {
          //-------- @foreachInstructionForGeneration
          cEnumerator_directDependancyList enumerator_22747 (enumerator_22714.current_mDependencyList (HERE), kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_22747.hasCurrentObject ()) {
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_0 = var_registeredTransientSet.reader_hasKey (enumerator_22714.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (618)).operator_not (SOURCE_FILE_AT_LINE (618)).boolEnum () ;
            if (kBoolTrue == test_0) {
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_generateTransientTriggerFromSelfAttribute ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_22747.current_mDependency (HERE).ptr (), constinArgument_inPrefix, constinArgument_inClassName, enumerator_22714.current_mTransientName (HERE), var_masterSet, var_registeredTransientSet, var_looping, result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (619)) ;
              //-------- END @methodCallInstructionForGeneration
            }
...
GALGAS_string function_generateAddObserverForTransients (const GALGAS_transientListForImplementation & constinArgument_inTransientListForImplementation,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_25151 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_25151.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_25182 (enumerator_25151.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_25182.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateAddObserverForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_25182.current_mDependency (HERE).ptr (), constinArgument_inLeadingSpaces, result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (694)) ;
      //-------- END @methodCallInstructionForGeneration
...
GALGAS_string function_generateRemoveObserverForTransients (const GALGAS_transientListForImplementation & constinArgument_inTransientListForImplementation,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_27082 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_27082.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_27113 (enumerator_27082.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_27113.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateRemoveObserverForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_27113.current_mDependency (HERE).ptr (), result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (754)) ;
      //-------- END @methodCallInstructionForGeneration
...
GALGAS_string function_generateObserverRoutinesForTransient (const GALGAS_string & constinArgument_inKindName,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observerListMap var_didChangeTriggeredRoutineListMap = GALGAS_observerListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (823)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observerListMap var_observeForKeyPathRoutineElementListMap = GALGAS_observerListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (824)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_29975 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29975.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_30006 (enumerator_29975.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_30006.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateObserverRoutineForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_30006.current_mDependency (HERE).ptr (), enumerator_29975.current_mTransientName (HERE), var_didChangeTriggeredRoutineListMap, var_observeForKeyPathRoutineElementListMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (827)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_30006.gotoNextObject () ;
    }
    enumerator_29975.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_fullPrefix = constinArgument_inPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (835)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (835)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (835)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_observerListMap enumerator_30394 (var_didChangeTriggeredRoutineListMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_30394.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "//  ").operator_concat (enumerator_30394.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (839)).operator_concat (GALGAS_string ("_didChange   *\n"
      "//----------------------------------------------------------------------------*\n"
      "\n"
      "- (void) ") COMMA_SOURCE_FILE_AT_LINE (839)).operator_concat (enumerator_30394.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (841)).operator_concat (GALGAS_string ("_didChange {\n") COMMA_SOURCE_FILE_AT_LINE (841)) COMMA_SOURCE_FILE_AT_LINE (837)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringlist enumerator_30691 (enumerator_30394.current_mList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_30691.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (enumerator_30691.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (844)).operator_concat (GALGAS_string (" transient'\n"
        "  if (") COMMA_SOURCE_FILE_AT_LINE (844)).operator_concat (enumerator_30691.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (845)).operator_concat (GALGAS_string ("__computed) {\n"
        "    ") COMMA_SOURCE_FILE_AT_LINE (845)).operator_concat (enumerator_30691.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (846)).operator_concat (GALGAS_string ("__computed = NO ;\n"
        "    [PMTransientDependancyManager\n"
        "      enterTriggerForObject:self\n"
        "      transientIndex:") COMMA_SOURCE_FILE_AT_LINE (846)).operator_concat (var_fullPrefix.operator_concat (enumerator_30691.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (849)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (849)) COMMA_SOURCE_FILE_AT_LINE (849)).operator_concat (GALGAS_string ("\n"
        "    ] ;\n"
        "  }\n") COMMA_SOURCE_FILE_AT_LINE (849)) COMMA_SOURCE_FILE_AT_LINE (843)) ;
      enumerator_30691.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("}\n"
      "\n") COMMA_SOURCE_FILE_AT_LINE (853)) ;
    enumerator_30394.gotoNextObject () ;
  }
  //-------- @foreachInstructionForGeneration
  cEnumerator_observerListMap enumerator_31242 (var_observeForKeyPathRoutineElementListMap, kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_0 = true ;
  if (enumerator_31242.hasCurrentObject () && bool_0) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
    ...
    while (enumerator_31242.hasCurrentObject () && bool_0) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (" if ((inObject == ").operator_concat (enumerator_31242.current_key (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)).operator_concat (GALGAS_string (") && [inKeyPath isEqualToString:@\"") COMMA_SOURCE_FILE_AT_LINE (869)).operator_concat (enumerator_31242.current_key (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (869)).operator_concat (GALGAS_string ("\"]) {\n") COMMA_SOURCE_FILE_AT_LINE (869)) COMMA_SOURCE_FILE_AT_LINE (868)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_31920 (enumerator_31242.current_mList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_31920.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (enumerator_31920.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (872)).operator_concat (GALGAS_string (" transient'\n"
          "    if (") COMMA_SOURCE_FILE_AT_LINE (872)).operator_concat (enumerator_31920.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (873)).operator_concat (GALGAS_string ("__computed) {\n"
          "      ") COMMA_SOURCE_FILE_AT_LINE (873)).operator_concat (enumerator_31920.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (874)).operator_concat (GALGAS_string ("__computed = NO ;\n"
          "      [PMTransientDependancyManager\n"
          "        enterTriggerForObject:self\n"
          "        transientIndex:") COMMA_SOURCE_FILE_AT_LINE (874)).operator_concat (var_fullPrefix.operator_concat (enumerator_31920.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (877)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (877)) COMMA_SOURCE_FILE_AT_LINE (877)).operator_concat (GALGAS_string ("\n"
          "      ] ;\n"
          "    }\n") COMMA_SOURCE_FILE_AT_LINE (877)) COMMA_SOURCE_FILE_AT_LINE (871)) ;
        enumerator_31920.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("  }else") COMMA_SOURCE_FILE_AT_LINE (881)) ;
...
void routine_generateTransientDependencyFiles (const GALGAS__32_stringlist constinArgument_inTransientDependencyArcList,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_dependentSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (922)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator__32_stringlist enumerator_33510 (constinArgument_inTransientDependencyArcList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_33510.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_graphString.dotAssign_operation (GALGAS_string ("// ").operator_concat (enumerator_33510.current_mValue_30_ (HERE) COMMA_SOURCE_FILE_AT_LINE (924)).operator_concat (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (924)).operator_concat (enumerator_33510.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (924)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (924)) COMMA_SOURCE_FILE_AT_LINE (924)) ;
    //-------- @plusEqualnstructionForGeneration
    var_dependentSet.addAssign_operation (enumerator_33510.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (925)) ;
    enumerator_33510.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_transientOrderedList = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_33707 (constinArgument_inSortedTransientOrderedList, kEnumeration_down) ;
  //--- simple foreach instruction
  while (enumerator_33707.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_transientOrderedList.dotAssign_operation (GALGAS_string ("// ").operator_concat (enumerator_33707.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (929)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (929)) COMMA_SOURCE_FILE_AT_LINE (929)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_33915 (constinArgument_inSortedTransientOrderedList, kEnumeration_down) ;
  //--- simple foreach instruction
  while (enumerator_33915.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_dependentSet.reader_hasKey (enumerator_33915.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (935)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      var_transientIndexesString.dotAssign_operation (GALGAS_string ("#define ").operator_concat (enumerator_33915.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (936)) COMMA_SOURCE_FILE_AT_LINE (936)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (936)).operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (936)) COMMA_SOURCE_FILE_AT_LINE (936)).operator_concat (GALGAS_string (")\n") COMMA_SOURCE_FILE_AT_LINE (936)) COMMA_SOURCE_FILE_AT_LINE (936)) ;
      //-------- @concatInstructionForGeneration
      var_transientList.dotAssign_operation (GALGAS_string ("      @").operator_concat (enumerator_33915.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (937)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (937)) COMMA_SOURCE_FILE_AT_LINE (937)).operator_concat (GALGAS_string (", // ") COMMA_SOURCE_FILE_AT_LINE (937)).operator_concat (enumerator_33915.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (937)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (937)) COMMA_SOURCE_FILE_AT_LINE (937)) ;
      //-------- @incrementInstructionForGeneration
      var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (938)) ;
    }
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_s = GALGAS_string (filewrapperTemplate_transientManager_managerDeclaration (inCompiler, var_graphString, var_transientOrderedList, var_transientIndexesString, var_transientCount COMMA_SOURCE_FILE_AT_LINE (943))) ;
  ...
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inSourceDirectoryPath, GALGAS_string ("PMTransientDependancyManager.h"), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_s, GALGAS_string ("\n"
    "\n"), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (949)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_s = GALGAS_string (filewrapperTemplate_transientManager_managerImplementation (inCompiler, var_transientList COMMA_SOURCE_FILE_AT_LINE (959))) ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inSourceDirectoryPath, GALGAS_string ("PMTransientDependancyManager.m"), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_s, GALGAS_string ("\n"
    "\n"), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (962)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
static GALGAS_string categoryReader_transientDependencyFromSelfForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (147)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (147)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (147)) COMMA_SOURCE_FILE_AT_LINE (147)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromControllerForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (155)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (155)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (155)) COMMA_SOURCE_FILE_AT_LINE (155)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromRootForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @assignmentInstructionForGeneration
    result_outResult = GALGAS_string ("const NSUInteger in").operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (164)) COMMA_SOURCE_FILE_AT_LINE (164)).operator_concat (GALGAS_string ("_count") COMMA_SOURCE_FILE_AT_LINE (164)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @assignmentInstructionForGeneration
    result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (166)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (166)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (166)) COMMA_SOURCE_FILE_AT_LINE (166)) ;
  }
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromPreferenceForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (175)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (175)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (175)) COMMA_SOURCE_FILE_AT_LINE (175)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromSelfForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromSelfForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("self.").operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (189)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromRootForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("mRootObject.").operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (197)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mNamesCountOption.boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (".count") COMMA_SOURCE_FILE_AT_LINE (199)) ;
  }
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromControllerForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = object->mAttribute_mControllerName.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (208)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (208)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromPreferenceForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("g_").operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (216)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (216)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (216)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_transientLocalDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_9660_0 ; // Joker input parameter
  constinArgument_inLocalObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_9660_0, var_masterPropertySignature, inCompiler COMMA_SOURCE_FILE_AT_LINE (268)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (var_masterPropertySignature, object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (276)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (277)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (277)) COMMA_SOURCE_FILE_AT_LINE (275)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromSelfForImplementation::constructor_new (object->mAttribute_mMasterName.mAttribute_string, var_masterType COMMA_SOURCE_FILE_AT_LINE (280)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientControllerDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_10827_4 ; // Joker input parameter
  GALGAS_bool joker_10827_3 ; // Joker input parameter
  GALGAS_outletBindingListForGeneration joker_10827_2 ; // Joker input parameter
  GALGAS_actionMap joker_10827_1 ; // Joker input parameter
  constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, var_controllerClassName, joker_10827_4, joker_10827_3, joker_10827_2, joker_10827_1, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (298)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_masterType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_11038_0 ; // Joker input parameter
  GALGAS_string joker_11045_0 ; // Joker input parameter
  var_controllerObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_11038_0, joker_11045_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (305)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (GALGAS_string ("controller.").operator_concat (var_controllerClassName COMMA_SOURCE_FILE_AT_LINE (313)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (313)).operator_concat (object->mAttribute_mMasterName.reader_string (SOURCE_FILE_AT_LINE (313)) COMMA_SOURCE_FILE_AT_LINE (313)), object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (313)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (314)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (312)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromControllerForImplementation::constructor_new (object->mAttribute_mControllerName.mAttribute_string, object->mAttribute_mMasterName.mAttribute_string, var_masterType COMMA_SOURCE_FILE_AT_LINE (317)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientRootDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_12198_0 ; // Joker input parameter
  constinArgument_inRootObjectObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_12198_0, var_masterDependencyKey, inCompiler COMMA_SOURCE_FILE_AT_LINE (334)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mNamesCountOption.operator_and (GALGAS_bool (kIsNotEqual, var_masterType.objectCompare (GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (341)))) COMMA_SOURCE_FILE_AT_LINE (341)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mMasterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the 'count' option is only allowed for to-many relationships") COMMA_SOURCE_FILE_AT_LINE (342)) ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (GALGAS_string ("entity.").operator_concat (constinArgument_inRootEntityName COMMA_SOURCE_FILE_AT_LINE (346)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (346)).operator_concat (object->mAttribute_mMasterName.reader_string (SOURCE_FILE_AT_LINE (346)) COMMA_SOURCE_FILE_AT_LINE (346)), object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (346)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (347)) COMMA_SOURCE_FILE_AT_LINE (347)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (347)) COMMA_SOURCE_FILE_AT_LINE (345)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromRootForImplementation::constructor_new (object->mAttribute_mMasterName.mAttribute_string, var_masterType, object->mAttribute_mNamesCountOption, var_masterDependencyKey.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (354)) COMMA_SOURCE_FILE_AT_LINE (350)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientPreferenceDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_attributeListForImplementation joker_13593_4 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_13593_3 ; // Joker input parameter
  GALGAS_outletGenerationList joker_13593_2 ; // Joker input parameter
  GALGAS_lstringlist joker_13593_1 ; // Joker input parameter
  GALGAS_stringset joker_13643_3 ; // Joker input parameter
  GALGAS_controllerMap joker_13643_2 ; // Joker input parameter
  GALGAS_preferenceArrayMap joker_13643_1 ; // Joker input parameter
  constinArgument_inPreferencesMap.method_searchKey (object->mAttribute_mPreferencesName, joker_13593_4, joker_13593_3, joker_13593_2, joker_13593_1, var_observablePropertyMap, joker_13643_3, joker_13643_2, joker_13643_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (372)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_masterType ;
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_13762_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, var_isTransient, joker_13762_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (373)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (GALGAS_string ("preference.").operator_concat (object->mAttribute_mPreferencesName.reader_string (SOURCE_FILE_AT_LINE (381)) COMMA_SOURCE_FILE_AT_LINE (381)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (381)).operator_concat (object->mAttribute_mMasterName.reader_string (SOURCE_FILE_AT_LINE (381)) COMMA_SOURCE_FILE_AT_LINE (381)), object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (381)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (382)) COMMA_SOURCE_FILE_AT_LINE (382)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (382)) COMMA_SOURCE_FILE_AT_LINE (380)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioImplementationFileInclusionSet.addAssign_operation (object->mAttribute_mPreferencesName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (385)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromPreferenceForImplementation::constructor_new (object->mAttribute_mPreferencesName.mAttribute_string, object->mAttribute_mMasterName.mAttribute_string, var_isTransient, var_masterType COMMA_SOURCE_FILE_AT_LINE (387)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromSelfForImplementation_generateTransientTriggerFromSelfAttribute (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromSelfForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = ioArgument_ioMasterAttributeSet.reader_hasKey (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (531)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioMasterAttributeSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (532)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioRegisteredTransientSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (533)) ;
    //-------- @assignmentInstructionForGeneration
    ioArgument_ioContinue = GALGAS_bool (true) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (536)).operator_concat (GALGAS_string (" transient'\n"
      "    if (") COMMA_SOURCE_FILE_AT_LINE (536)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (537)).operator_concat (GALGAS_string ("__computed) {\n"
      "      ") COMMA_SOURCE_FILE_AT_LINE (537)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (538)).operator_concat (GALGAS_string ("__computed = NO ;\n"
      "      [PMTransientDependancyManager\n"
      "        enterTriggerForObject:self\n"
      "        transientIndex:") COMMA_SOURCE_FILE_AT_LINE (538)).operator_concat (constinArgument_inPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (541)).operator_concat (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (541)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (541)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (541)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (541)) COMMA_SOURCE_FILE_AT_LINE (541)).operator_concat (GALGAS_string ("\n"
      "      ] ;\n"
      "    }\n") COMMA_SOURCE_FILE_AT_LINE (541)) COMMA_SOURCE_FILE_AT_LINE (535)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateTransientTriggerFromSelfAttribute (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = ioArgument_ioMasterAttributeSet.reader_hasKey (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (558)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioMasterAttributeSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (559)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioRegisteredTransientSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (560)) ;
    //-------- @assignmentInstructionForGeneration
    ioArgument_ioContinue = GALGAS_bool (true) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (563)).operator_concat (GALGAS_string (" transient'\n"
      "    if (") COMMA_SOURCE_FILE_AT_LINE (563)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (564)).operator_concat (GALGAS_string ("__computed) {\n"
      "      ") COMMA_SOURCE_FILE_AT_LINE (564)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (565)).operator_concat (GALGAS_string ("__computed = NO ;\n"
      "      [PMTransientDependancyManager\n"
      "        enterTriggerForObject:self\n"
      "        transientIndex:") COMMA_SOURCE_FILE_AT_LINE (565)).operator_concat (constinArgument_inPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (568)).operator_concat (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (568)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (568)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (568)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (568)) COMMA_SOURCE_FILE_AT_LINE (568)).operator_concat (GALGAS_string ("\n"
      "      ] ;\n"
      "    }\n") COMMA_SOURCE_FILE_AT_LINE (568)) COMMA_SOURCE_FILE_AT_LINE (562)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromControllerForImplementation_generateAddObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (constinArgument_inLeadingSpaces.operator_concat (GALGAS_string ("  [") COMMA_SOURCE_FILE_AT_LINE (655)).operator_concat (object->mAttribute_mControllerName COMMA_SOURCE_FILE_AT_LINE (656)).operator_concat (GALGAS_string ("\n"
    "    addObserver:self\n"
    "    forKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (656)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (658)).operator_concat (GALGAS_string ("\"\n"
    "    options:0\n"
    "    context:NULL\n"
    "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (658)) COMMA_SOURCE_FILE_AT_LINE (655)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateAddObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mMasterIsTransient.operator_not (SOURCE_FILE_AT_LINE (670)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (constinArgument_inLeadingSpaces.operator_concat (GALGAS_string ("  [g_") COMMA_SOURCE_FILE_AT_LINE (671)).operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (671)).operator_concat (GALGAS_string (" addObserverOf_") COMMA_SOURCE_FILE_AT_LINE (671)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (671)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (671)) COMMA_SOURCE_FILE_AT_LINE (671)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateAddObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (constinArgument_inLeadingSpaces.operator_concat (GALGAS_string ("  [mRootObject addObserverOf_") COMMA_SOURCE_FILE_AT_LINE (681)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (681)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (681)) COMMA_SOURCE_FILE_AT_LINE (681)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromControllerForImplementation_generateRemoveObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  [").operator_concat (object->mAttribute_mControllerName COMMA_SOURCE_FILE_AT_LINE (721)).operator_concat (GALGAS_string ("\n"
    "    removeObserver:self\n"
    "    forKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (721)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (723)).operator_concat (GALGAS_string ("\"\n"
    "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (723)) COMMA_SOURCE_FILE_AT_LINE (720)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateRemoveObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mMasterIsTransient.operator_not (SOURCE_FILE_AT_LINE (732)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  [g_").operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (733)).operator_concat (GALGAS_string (" removeObserverOf_") COMMA_SOURCE_FILE_AT_LINE (733)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (733)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (733)) COMMA_SOURCE_FILE_AT_LINE (733)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateRemoveObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  [mRootObject removeObserverOf_").operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (742)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (742)) COMMA_SOURCE_FILE_AT_LINE (742)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromControllerForImplementation_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioObserveForKeyPathRoutineElementListMap.addAssign_operation (object->mAttribute_mControllerName.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (789)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (789)), constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (789)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mMasterIsTransient.operator_not (SOURCE_FILE_AT_LINE (799)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_didChangeTriggeredRoutineListMap.addAssign_operation (GALGAS_string ("preference.").operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (800)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (800)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (800)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (800)), constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (800)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_didChangeTriggeredRoutineListMap.addAssign_operation (object->mAttribute_mTriggerRoutineName, constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (811)) ;
}
//---------------------------------------------------------------------------*
