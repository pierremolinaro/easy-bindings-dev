...
GALGAS_string function_generateTransientImplementation (const GALGAS_string & constinArgument_inKindName,
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, var_triggeredKeysFromOtherObjects.reader_count (SOURCE_FILE_AT_LINE (209)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "\n"
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForOtherObjects enumerator_8487 (var_triggeredKeysFromOtherObjects, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_8487.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_8523 (enumerator_8487.current (HERE).mAttribute_mList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_8523.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  [").operator_concat (enumerator_8487.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (217)).operator_concat (GALGAS_string ("\n"
          "    addObserver:self\n"
          "    forKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (217)).operator_concat (enumerator_8523.current (HERE).mAttribute_mValue_30_ COMMA_SOURCE_FILE_AT_LINE (219)).operator_concat (GALGAS_string ("\"\n"
          "    options:0\n"
          "    context:NULL\n"
          "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (219)) COMMA_SOURCE_FILE_AT_LINE (216)) ;
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForOtherObjects enumerator_9050 (var_triggeredKeysFromOtherObjects, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_9050.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_9086 (enumerator_9050.current (HERE).mAttribute_mList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_9086.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  [").operator_concat (enumerator_9050.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (GALGAS_string ("\n"
          "    removeObserver:self\n"
          "    forKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (233)).operator_concat (enumerator_9086.current (HERE).mAttribute_mValue_30_ COMMA_SOURCE_FILE_AT_LINE (235)).operator_concat (GALGAS_string ("\"\n"
          "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (235)) COMMA_SOURCE_FILE_AT_LINE (232)) ;
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForOtherObjects enumerator_9738 (var_triggeredKeysFromOtherObjects, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_9738.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (" if (inObject == ").operator_concat (enumerator_9738.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (250)).operator_concat (GALGAS_string (") {\n") COMMA_SOURCE_FILE_AT_LINE (250)) COMMA_SOURCE_FILE_AT_LINE (250)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_9846 (enumerator_9738.current (HERE).mAttribute_mList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_9846.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("    if ([inKeyPath isEqualToString:@\"").operator_concat (enumerator_9846.current (HERE).mAttribute_mValue_30_ COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (GALGAS_string ("\"]) {\n"
          "      ") COMMA_SOURCE_FILE_AT_LINE (254)).operator_concat (enumerator_9846.current (HERE).mAttribute_mValue_31_ COMMA_SOURCE_FILE_AT_LINE (255)).operator_concat (GALGAS_string ("__computed = NO ;\n"
          "      [PMTransientDependancyManager\n"
          "        enterTriggerForObject:self\n"
          "        transientIndex:") COMMA_SOURCE_FILE_AT_LINE (255)).operator_concat (var_fullPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (258)).operator_concat (enumerator_9846.current (HERE).mAttribute_mValue_31_ COMMA_SOURCE_FILE_AT_LINE (258)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (258)) COMMA_SOURCE_FILE_AT_LINE (258)).operator_concat (GALGAS_string ("\n"
          "      ] ;\n"
          "    }\n") COMMA_SOURCE_FILE_AT_LINE (258)) COMMA_SOURCE_FILE_AT_LINE (253)) ;
        enumerator_9846.gotoNextObject () ;
      }
      if (enumerator_9738.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  }else") COMMA_SOURCE_FILE_AT_LINE (263)) ;
      }
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_triggeredKeysForSelfObject var_triggeredKeysForSelfObject = GALGAS_triggeredKeysForSelfObject::constructor_emptyMap (SOURCE_FILE_AT_LINE (270)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator__32_stringlist enumerator_10552 (constinArgument_inTransientDependencyArcList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_10552.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, enumerator_10552.current_mValue_30_ (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (272)).objectCompare (var_fullPrefix)).operator_and (GALGAS_bool (kIsEqual, enumerator_10552.current_mValue_31_ (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (272)).objectCompare (var_fullPrefix)) COMMA_SOURCE_FILE_AT_LINE (272)).boolEnum () ;
    if (kBoolTrue == test_2) {
      //-------- @plusEqualnstructionForGeneration
      var_triggeredKeysForSelfObject.addAssign_operation (enumerator_10552.current_mValue_30_ (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (273)), enumerator_10552.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (273)) ;
    }
    enumerator_10552.gotoNextObject () ;
  }
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_3 = GALGAS_bool (kIsStrictSup, var_triggeredKeysForSelfObject.reader_count (SOURCE_FILE_AT_LINE (279)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_3) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "\n"
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForSelfObject enumerator_11334 (var_triggeredKeysForSelfObject, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_11334.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (" if ([inKey isEqualToString:@\"").operator_concat (enumerator_11334.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (288)).operator_concat (GALGAS_string ("\"]) {\n") COMMA_SOURCE_FILE_AT_LINE (288)) COMMA_SOURCE_FILE_AT_LINE (288)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_11453 (enumerator_11334.current (HERE).mAttribute_mList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_11453.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("    ").operator_concat (enumerator_11453.current (HERE).mAttribute_mValue.reader_pathExtension (SOURCE_FILE_AT_LINE (290)) COMMA_SOURCE_FILE_AT_LINE (290)).operator_concat (GALGAS_string ("__computed = NO ;\n"
          "    [PMTransientDependancyManager\n"
          "      enterTriggerForObject:self\n"
          "      transientIndex:") COMMA_SOURCE_FILE_AT_LINE (290)).operator_concat (enumerator_11453.current (HERE).mAttribute_mValue.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (293)) COMMA_SOURCE_FILE_AT_LINE (293)).operator_concat (GALGAS_string ("\n"
          "    ] ;\n") COMMA_SOURCE_FILE_AT_LINE (293)) COMMA_SOURCE_FILE_AT_LINE (290)) ;
        enumerator_11453.gotoNextObject () ;
      }
      if (enumerator_11334.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  }else") COMMA_SOURCE_FILE_AT_LINE (297)) ;
      }
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_11956 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_11956.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "\n"
      "- (").operator_concat (categoryReader_ocTypeName (enumerator_11956.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (306)) COMMA_SOURCE_FILE_AT_LINE (306)).operator_concat (GALGAS_string (") ") COMMA_SOURCE_FILE_AT_LINE (306)).operator_concat (enumerator_11956.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (306)).operator_concat (GALGAS_string (" {\n"
      "  if (! ") COMMA_SOURCE_FILE_AT_LINE (306)).operator_concat (enumerator_11956.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (307)).operator_concat (GALGAS_string ("__computed) {\n"
      "    ") COMMA_SOURCE_FILE_AT_LINE (307)).operator_concat (enumerator_11956.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (308)).operator_concat (GALGAS_string ("__cache = compute_") COMMA_SOURCE_FILE_AT_LINE (308)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (308)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (308)).operator_concat (enumerator_11956.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (308)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (308)) COMMA_SOURCE_FILE_AT_LINE (304)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_12313 (enumerator_11956.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_12313.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (enumerator_12313.current_mMasterObjectName (HERE).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (310)).operator_concat (enumerator_12313.current_mMasterPropertyName (HERE).reader_stringByReplacingStringByString (GALGAS_string ("@"), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (310)) COMMA_SOURCE_FILE_AT_LINE (310)) COMMA_SOURCE_FILE_AT_LINE (310)) ;
      if (enumerator_12313.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (311)) ;
      }
      enumerator_12313.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (") ;\n"
      "    ").operator_concat (enumerator_11956.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (314)).operator_concat (GALGAS_string ("__computed = YES ;\n"
      "  }\n"
      "  return ") COMMA_SOURCE_FILE_AT_LINE (314)).operator_concat (enumerator_11956.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (316)).operator_concat (GALGAS_string ("__cache") COMMA_SOURCE_FILE_AT_LINE (316)) COMMA_SOURCE_FILE_AT_LINE (313)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_4 = categoryReader_copyOnAssign (enumerator_11956.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (317)).boolEnum () ;
    if (kBoolTrue == test_4) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (".copy") COMMA_SOURCE_FILE_AT_LINE (317)) ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (" ;\n"
      "}\n"
...
void routine_generateTransientDependencyFiles (const GALGAS__32_stringlist constinArgument_inTransientDependencyArcList,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_dependentSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (349)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator__32_stringlist enumerator_13634 (constinArgument_inTransientDependencyArcList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_13634.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_graphString.dotAssign_operation (GALGAS_string ("// ").operator_concat (enumerator_13634.current_mValue_30_ (HERE) COMMA_SOURCE_FILE_AT_LINE (351)).operator_concat (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (351)).operator_concat (enumerator_13634.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (351)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (351)) COMMA_SOURCE_FILE_AT_LINE (351)) ;
    //-------- @plusEqualnstructionForGeneration
    var_dependentSet.addAssign_operation (enumerator_13634.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (352)) ;
    enumerator_13634.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_transientOrderedList = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_13831 (constinArgument_inSortedTransientOrderedList, kEnumeration_down) ;
  //--- simple foreach instruction
  while (enumerator_13831.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_transientOrderedList.dotAssign_operation (GALGAS_string ("// ").operator_concat (enumerator_13831.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (356)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (356)) COMMA_SOURCE_FILE_AT_LINE (356)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_14039 (constinArgument_inSortedTransientOrderedList, kEnumeration_down) ;
  //--- simple foreach instruction
  while (enumerator_14039.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_dependentSet.reader_hasKey (enumerator_14039.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (362)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      var_transientIndexesString.dotAssign_operation (GALGAS_string ("#define ").operator_concat (enumerator_14039.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (363)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (363)).operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (363)).operator_concat (GALGAS_string (")\n") COMMA_SOURCE_FILE_AT_LINE (363)) COMMA_SOURCE_FILE_AT_LINE (363)) ;
      //-------- @concatInstructionForGeneration
      var_transientList.dotAssign_operation (GALGAS_string ("      @").operator_concat (enumerator_14039.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (364)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (364)) COMMA_SOURCE_FILE_AT_LINE (364)).operator_concat (GALGAS_string (", // ") COMMA_SOURCE_FILE_AT_LINE (364)).operator_concat (enumerator_14039.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (364)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (364)) COMMA_SOURCE_FILE_AT_LINE (364)) ;
      //-------- @incrementInstructionForGeneration
      var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (365)) ;
    }
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_s = GALGAS_string (filewrapperTemplate_transientManager_managerDeclaration (inCompiler, var_graphString, var_transientOrderedList, var_transientIndexesString, var_transientCount COMMA_SOURCE_FILE_AT_LINE (370))) ;
  ...
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inSourceDirectoryPath, GALGAS_string ("PMTransientDependancyManager.h"), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_s, GALGAS_string ("\n"
    "\n"), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (376)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_s = GALGAS_string (filewrapperTemplate_transientManager_managerImplementation (inCompiler, var_transientList COMMA_SOURCE_FILE_AT_LINE (386))) ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inSourceDirectoryPath, GALGAS_string ("PMTransientDependancyManager.m"), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_s, GALGAS_string ("\n"
    "\n"), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (389)) ;
  } //-------- @routineCallInstructionForGeneration
}
