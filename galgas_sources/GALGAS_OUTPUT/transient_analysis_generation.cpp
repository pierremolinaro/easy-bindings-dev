...
GALGAS_string function_generateTransientImplementation (const GALGAS_string & constinArgument_inKindName,
  ...
  if (kBoolTrue == test_1) {
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForOtherObjects enumerator_8070 (var_triggeredKeysFromOtherObjects, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_8070.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (" if (inObject == ").operator_concat (enumerator_8070.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (203)).operator_concat (GALGAS_string (") {\n") COMMA_SOURCE_FILE_AT_LINE (203)) COMMA_SOURCE_FILE_AT_LINE (203)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_8178 (enumerator_8070.current (HERE).mAttribute_mList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_8178.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("    if ([inKeyPath isEqualToString:@\"").operator_concat (enumerator_8178.current (HERE).mAttribute_mValue_30_ COMMA_SOURCE_FILE_AT_LINE (207)).operator_concat (GALGAS_string ("\"]) {\n"
          "      [self pmNotifyChangeForTransientProperty:@\"") COMMA_SOURCE_FILE_AT_LINE (207)).operator_concat (enumerator_8178.current (HERE).mAttribute_mValue_31_ COMMA_SOURCE_FILE_AT_LINE (208)).operator_concat (GALGAS_string ("\"] ;\n"
          "    }\n") COMMA_SOURCE_FILE_AT_LINE (208)) COMMA_SOURCE_FILE_AT_LINE (206)) ;
        enumerator_8178.gotoNextObject () ;
      }
      if (enumerator_8070.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  }else") COMMA_SOURCE_FILE_AT_LINE (212)) ;
      }
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_2 = GALGAS_bool (kIsStrictSup, var_triggeredKeys.reader_count (SOURCE_FILE_AT_LINE (218)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_2) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "\n"
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForSelfObject enumerator_8880 (var_triggeredKeys, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_8880.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (" if ([inKey isEqualToString:@\"").operator_concat (enumerator_8880.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (227)).operator_concat (GALGAS_string ("\"]) {\n") COMMA_SOURCE_FILE_AT_LINE (227)) COMMA_SOURCE_FILE_AT_LINE (227)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_8999 (enumerator_8880.current (HERE).mAttribute_mList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_8999.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("    [self pmNotifyChangeForTransientProperty:@\"").operator_concat (enumerator_8999.current (HERE).mAttribute_mValue COMMA_SOURCE_FILE_AT_LINE (229)).operator_concat (GALGAS_string ("\"] ;\n") COMMA_SOURCE_FILE_AT_LINE (229)) COMMA_SOURCE_FILE_AT_LINE (229)) ;
        enumerator_8999.gotoNextObject () ;
      }
      if (enumerator_8880.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  }else") COMMA_SOURCE_FILE_AT_LINE (232)) ;
      }
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_9274 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_9274.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "\n"
      "- (").operator_concat (categoryReader_ocTypeName (enumerator_9274.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (241)) COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (GALGAS_string (") ") COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (enumerator_9274.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (GALGAS_string (" {\n"
      "  return compute_") COMMA_SOURCE_FILE_AT_LINE (241)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (242)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (242)).operator_concat (enumerator_9274.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (242)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (242)) COMMA_SOURCE_FILE_AT_LINE (239)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_9552 (enumerator_9274.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_9552.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (enumerator_9552.current_mMasterObjectName (HERE).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (244)).operator_concat (enumerator_9552.current_mMasterPropertyName (HERE).reader_stringByReplacingStringByString (GALGAS_string ("@"), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (244)) COMMA_SOURCE_FILE_AT_LINE (244)) ;
      if (enumerator_9552.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (245)) ;
      }
      enumerator_9552.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (")") COMMA_SOURCE_FILE_AT_LINE (247)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_3 = categoryReader_copyOnAssign (enumerator_9274.current_mType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (248)).boolEnum () ;
    if (kBoolTrue == test_3) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (".copy") COMMA_SOURCE_FILE_AT_LINE (248)) ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (" ;\n"
      "}\n"
