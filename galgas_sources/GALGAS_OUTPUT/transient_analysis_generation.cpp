...
void routine_analyzeTransientProperties (const GALGAS_preferencesMap constinArgument_inPreferencesMap,
  ...
  outArgument_outTransientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (410)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientList enumerator_15087 (constinArgument_inTransientList, kEnumeration_up) ;
  ...
  while (enumerator_15087.hasCurrentObject ()) {
    ...
    GALGAS_lstring var_transientObservationKey = GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (enumerator_15087.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (414)) COMMA_SOURCE_FILE_AT_LINE (414)), enumerator_15087.current_mTransientName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (413)) ;
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_transientObservationKey, var_transientObservationKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (417)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (419)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_dependanceList enumerator_15509 (enumerator_15087.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_15509.hasCurrentObject ()) {
      ...
      callCategoryMethod_analyze ((const cPtr_abstractTransientDependency *) enumerator_15509.current_mDependency (HERE).ptr (), enumerator_15087.current_mTransientName (HERE), ioArgument_ioSelfObjectObservablePropertyMap, constinArgument_inPreferencesMap, constinArgument_inControllerMap, constinArgument_inRootObjectObservablePropertyMap, constinArgument_inRootEntityName, constinArgument_inObervationDependencyPrefix, ioArgument_ioImplementationFileInclusionSet, ioArgument_ioTransientDependencyGraph, var_implementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (421)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_directDependancyList.addAssign_operation (var_implementation COMMA_SOURCE_FILE_AT_LINE (433)) ;
      enumerator_15509.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSelfObjectObservablePropertyMap.modifier_insertKey (enumerator_15087.current_mTransientName (HERE), enumerator_15087.current_mType (HERE), GALGAS_bool (true), var_transientObservationKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (436)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    outArgument_outTransientListForImplementation.addAssign_operation (enumerator_15087.current_mType (HERE), enumerator_15087.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (443)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (443)) ;
...
GALGAS_string function_generateTransientFunctionDeclarations (const GALGAS_string & constinArgument_inKindName,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("//----------------------------------------------------------------------------*\n").operator_concat (GALGAS_string ("//   T R A N S I E N T    P R O P E R T I E S                                 *\n") COMMA_SOURCE_FILE_AT_LINE (456)).operator_concat (GALGAS_string ("//----------------------------------------------------------------------------*\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (457)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_16933 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_16933.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (categoryReader_ocTypeName (enumerator_16933.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (460)).operator_concat (GALGAS_string (" compute_") COMMA_SOURCE_FILE_AT_LINE (460)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (460)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (460)).operator_concat (enumerator_16933.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (460)).operator_concat (GALGAS_string (" (\n") COMMA_SOURCE_FILE_AT_LINE (460)) COMMA_SOURCE_FILE_AT_LINE (460)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_17074 (enumerator_16933.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_17074.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("    ").operator_concat (callCategoryReader_generateFormalArgument ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_17074.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (463)) COMMA_SOURCE_FILE_AT_LINE (463)) COMMA_SOURCE_FILE_AT_LINE (463)) ;
      if (enumerator_17074.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
...
GALGAS_string function_generateTransientCacheRoutine (const GALGAS_string & constinArgument_inKindName,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_17561 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17561.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "// Cache routine of '").operator_concat (enumerator_17561.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (482)).operator_concat (GALGAS_string ("' transient     *\n"
      "//----------------------------------------------------------------------------*\n"
      "\n"
      "- (") COMMA_SOURCE_FILE_AT_LINE (482)).operator_concat (categoryReader_ocTypeName (enumerator_17561.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (484)) COMMA_SOURCE_FILE_AT_LINE (484)).operator_concat (GALGAS_string (") ") COMMA_SOURCE_FILE_AT_LINE (484)).operator_concat (enumerator_17561.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (484)).operator_concat (GALGAS_string (" {\n"
      "  if (! ") COMMA_SOURCE_FILE_AT_LINE (484)).operator_concat (enumerator_17561.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (485)).operator_concat (GALGAS_string ("__computed) {\n"
      "    ") COMMA_SOURCE_FILE_AT_LINE (485)).operator_concat (enumerator_17561.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (486)).operator_concat (GALGAS_string ("__cache = compute_") COMMA_SOURCE_FILE_AT_LINE (486)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (486)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (486)).operator_concat (enumerator_17561.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (486)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (486)) COMMA_SOURCE_FILE_AT_LINE (480)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_18084 (enumerator_17561.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_18084.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (callCategoryReader_generateMasterAttributeCall ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_18084.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (488)) COMMA_SOURCE_FILE_AT_LINE (488)) ;
      if (enumerator_18084.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (489)) ;
      }
      enumerator_18084.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (") ;\n"
      "    ").operator_concat (enumerator_17561.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (492)).operator_concat (GALGAS_string ("__computed = YES ;\n"
      "  }\n"
      "  return ") COMMA_SOURCE_FILE_AT_LINE (492)).operator_concat (enumerator_17561.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (494)).operator_concat (GALGAS_string ("__cache") COMMA_SOURCE_FILE_AT_LINE (494)) COMMA_SOURCE_FILE_AT_LINE (491)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = categoryReader_copyOnAssign (enumerator_17561.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (495)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (".copy") COMMA_SOURCE_FILE_AT_LINE (495)) ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (" ;\n"
      "}\n"
...
GALGAS_string function_generateTransientTriggering (const GALGAS_string & constinArgument_inPropertyName,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_masterSet = GALGAS_stringset::constructor_setWithString (constinArgument_inPropertyName COMMA_SOURCE_FILE_AT_LINE (612)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_registeredTransientSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (613)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_looping = GALGAS_bool (true) ;
  //-------- @loopInstructionForGeneration
  if (constinArgument_inTransientListForImplementation.reader_length (SOURCE_FILE_AT_LINE (615)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (615)).isValid ()) {
    PMUInt32 variant_22650 = constinArgument_inTransientListForImplementation.reader_length (SOURCE_FILE_AT_LINE (615)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (615)).uintValue () ;
    bool loop_22650 = true ;
    while (loop_22650) {
      loop_22650 = var_looping.isValid () ;
      if (loop_22650) {
        loop_22650 = var_looping.boolValue () ;
      }
      if (loop_22650 && (0 == variant_22650)) {
        loop_22650 = false ;
      ...
      if (loop_22650) {
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_transientListForImplementation enumerator_22782 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_22782.hasCurrentObject ()) {
          //-------- @foreachInstructionForGeneration
          cEnumerator_directDependancyList enumerator_22815 (enumerator_22782.current_mDependencyList (HERE), kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_22815.hasCurrentObject ()) {
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_0 = var_registeredTransientSet.reader_hasKey (enumerator_22782.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (619)).operator_not (SOURCE_FILE_AT_LINE (619)).boolEnum () ;
            if (kBoolTrue == test_0) {
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_generateTransientTriggerFromSelfAttribute ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_22815.current_mDependency (HERE).ptr (), constinArgument_inPrefix, constinArgument_inClassName, enumerator_22782.current_mTransientName (HERE), var_masterSet, var_registeredTransientSet, var_looping, result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (620)) ;
              //-------- END @methodCallInstructionForGeneration
            }
            enumerator_22815.gotoNextObject () ;
          }
          enumerator_22782.gotoNextObject () ;
        }
      }
    }
  }
...
GALGAS_string function_generateAddObserverForTransients (const GALGAS_transientListForImplementation & constinArgument_inTransientListForImplementation,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_25219 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_25219.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_25250 (enumerator_25219.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_25250.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateAddObserverForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_25250.current_mDependency (HERE).ptr (), constinArgument_inLeadingSpaces, result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (695)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_25250.gotoNextObject () ;
    }
...
GALGAS_string function_generateRemoveObserverForTransients (const GALGAS_transientListForImplementation & constinArgument_inTransientListForImplementation,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_27150 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_27150.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_27181 (enumerator_27150.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_27181.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateRemoveObserverForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_27181.current_mDependency (HERE).ptr (), result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (755)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_27181.gotoNextObject () ;
    }
    enumerator_27150.gotoNextObject () ;
  }
//---
  return result_outResult ;
}
...
GALGAS_string function_generateObserverRoutinesForTransient (const GALGAS_string & constinArgument_inKindName,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observerListMap var_didChangeTriggeredRoutineListMap = GALGAS_observerListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (824)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observerListMap var_observeForKeyPathRoutineElementListMap = GALGAS_observerListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (825)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_30043 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_30043.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_30074 (enumerator_30043.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_30074.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateObserverRoutineForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_30074.current_mDependency (HERE).ptr (), enumerator_30043.current_mTransientName (HERE), var_didChangeTriggeredRoutineListMap, var_observeForKeyPathRoutineElementListMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (828)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_30074.gotoNextObject () ;
    }
    enumerator_30043.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_fullPrefix = constinArgument_inPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (836)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (836)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (836)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_observerListMap enumerator_30462 (var_didChangeTriggeredRoutineListMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_30462.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "//  ").operator_concat (enumerator_30462.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (840)).operator_concat (GALGAS_string ("_didChange   *\n"
      "//----------------------------------------------------------------------------*\n"
      "\n"
      "- (void) ") COMMA_SOURCE_FILE_AT_LINE (840)).operator_concat (enumerator_30462.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (842)).operator_concat (GALGAS_string ("_didChange {\n") COMMA_SOURCE_FILE_AT_LINE (842)) COMMA_SOURCE_FILE_AT_LINE (838)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringlist enumerator_30759 (enumerator_30462.current_mList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_30759.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (enumerator_30759.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (845)).operator_concat (GALGAS_string (" transient'\n"
        "  if (") COMMA_SOURCE_FILE_AT_LINE (845)).operator_concat (enumerator_30759.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (846)).operator_concat (GALGAS_string ("__computed) {\n"
        "    ") COMMA_SOURCE_FILE_AT_LINE (846)).operator_concat (enumerator_30759.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (847)).operator_concat (GALGAS_string ("__computed = NO ;\n"
        "    [PMTransientDependancyManager\n"
        "      enterTriggerForObject:self\n"
        "      transientIndex:") COMMA_SOURCE_FILE_AT_LINE (847)).operator_concat (var_fullPrefix.operator_concat (enumerator_30759.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (850)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (850)) COMMA_SOURCE_FILE_AT_LINE (850)).operator_concat (GALGAS_string ("\n"
        "    ] ;\n"
        "  }\n") COMMA_SOURCE_FILE_AT_LINE (850)) COMMA_SOURCE_FILE_AT_LINE (844)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_observerListMap enumerator_31310 (var_observeForKeyPathRoutineElementListMap, kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_0 = true ;
  if (enumerator_31310.hasCurrentObject () && bool_0) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
    ...
    while (enumerator_31310.hasCurrentObject () && bool_0) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (" if ((inObject == ").operator_concat (enumerator_31310.current_key (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (870)) COMMA_SOURCE_FILE_AT_LINE (870)).operator_concat (GALGAS_string (") && [inKeyPath isEqualToString:@\"") COMMA_SOURCE_FILE_AT_LINE (870)).operator_concat (enumerator_31310.current_key (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (870)) COMMA_SOURCE_FILE_AT_LINE (870)).operator_concat (GALGAS_string ("\"]) {\n") COMMA_SOURCE_FILE_AT_LINE (870)) COMMA_SOURCE_FILE_AT_LINE (869)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_31988 (enumerator_31310.current_mList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_31988.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (enumerator_31988.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (873)).operator_concat (GALGAS_string (" transient'\n"
          "    if (") COMMA_SOURCE_FILE_AT_LINE (873)).operator_concat (enumerator_31988.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (874)).operator_concat (GALGAS_string ("__computed) {\n"
          "      ") COMMA_SOURCE_FILE_AT_LINE (874)).operator_concat (enumerator_31988.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (875)).operator_concat (GALGAS_string ("__computed = NO ;\n"
          "      [PMTransientDependancyManager\n"
          "        enterTriggerForObject:self\n"
          "        transientIndex:") COMMA_SOURCE_FILE_AT_LINE (875)).operator_concat (var_fullPrefix.operator_concat (enumerator_31988.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (878)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (878)).operator_concat (GALGAS_string ("\n"
          "      ] ;\n"
          "    }\n") COMMA_SOURCE_FILE_AT_LINE (878)) COMMA_SOURCE_FILE_AT_LINE (872)) ;
        enumerator_31988.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("  }else") COMMA_SOURCE_FILE_AT_LINE (882)) ;
      enumerator_31310.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("{\n"
      "    [super\n"
...
void routine_generateTransientDependencyFiles (const GALGAS__32_stringlist constinArgument_inTransientDependencyArcList,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_dependentSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (923)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator__32_stringlist enumerator_33578 (constinArgument_inTransientDependencyArcList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_33578.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_graphString.dotAssign_operation (GALGAS_string ("// ").operator_concat (enumerator_33578.current_mValue_30_ (HERE) COMMA_SOURCE_FILE_AT_LINE (925)).operator_concat (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (925)).operator_concat (enumerator_33578.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (925)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (925)) COMMA_SOURCE_FILE_AT_LINE (925)) ;
    //-------- @plusEqualnstructionForGeneration
    var_dependentSet.addAssign_operation (enumerator_33578.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (926)) ;
    enumerator_33578.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_transientOrderedList = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_33775 (constinArgument_inSortedTransientOrderedList, kEnumeration_down) ;
  //--- simple foreach instruction
  while (enumerator_33775.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_transientOrderedList.dotAssign_operation (GALGAS_string ("// ").operator_concat (enumerator_33775.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (930)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (930)) COMMA_SOURCE_FILE_AT_LINE (930)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_33983 (constinArgument_inSortedTransientOrderedList, kEnumeration_down) ;
  //--- simple foreach instruction
  while (enumerator_33983.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_dependentSet.reader_hasKey (enumerator_33983.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (936)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      var_transientIndexesString.dotAssign_operation (GALGAS_string ("#define ").operator_concat (enumerator_33983.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (937)) COMMA_SOURCE_FILE_AT_LINE (937)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (937)).operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (937)) COMMA_SOURCE_FILE_AT_LINE (937)).operator_concat (GALGAS_string (")\n") COMMA_SOURCE_FILE_AT_LINE (937)) COMMA_SOURCE_FILE_AT_LINE (937)) ;
      //-------- @concatInstructionForGeneration
      var_transientList.dotAssign_operation (GALGAS_string ("      @").operator_concat (enumerator_33983.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (938)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (938)) COMMA_SOURCE_FILE_AT_LINE (938)).operator_concat (GALGAS_string (", // ") COMMA_SOURCE_FILE_AT_LINE (938)).operator_concat (enumerator_33983.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (938)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (938)) COMMA_SOURCE_FILE_AT_LINE (938)) ;
      //-------- @incrementInstructionForGeneration
      var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (939)) ;
    }
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_s = GALGAS_string (filewrapperTemplate_transientManager_managerDeclaration (inCompiler, var_graphString, var_transientOrderedList, var_transientIndexesString, var_transientCount COMMA_SOURCE_FILE_AT_LINE (944))) ;
  ...
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inSourceDirectoryPath, GALGAS_string ("PMTransientDependancyManager.h"), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_s, GALGAS_string ("\n"
    "\n"), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (950)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_s = GALGAS_string (filewrapperTemplate_transientManager_managerImplementation (inCompiler, var_transientList COMMA_SOURCE_FILE_AT_LINE (960))) ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inSourceDirectoryPath, GALGAS_string ("PMTransientDependancyManager.m"), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_s, GALGAS_string ("\n"
    "\n"), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (963)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
static GALGAS_string categoryReader_transientDependencyFromSelfForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (148)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (148)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (148)) COMMA_SOURCE_FILE_AT_LINE (148)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromControllerForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (156)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (156)) COMMA_SOURCE_FILE_AT_LINE (156)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromRootForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @assignmentInstructionForGeneration
    result_outResult = GALGAS_string ("const NSUInteger in").operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (165)) COMMA_SOURCE_FILE_AT_LINE (165)).operator_concat (GALGAS_string ("_count") COMMA_SOURCE_FILE_AT_LINE (165)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @assignmentInstructionForGeneration
    result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (167)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (167)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (167)) COMMA_SOURCE_FILE_AT_LINE (167)) ;
  }
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromPreferenceForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (176)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (176)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (176)) COMMA_SOURCE_FILE_AT_LINE (176)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromSelfForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromSelfForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("self.").operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (190)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromRootForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("mRootObject.").operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (198)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mNamesCountOption.boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (".count") COMMA_SOURCE_FILE_AT_LINE (200)) ;
  }
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromControllerForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = object->mAttribute_mControllerName.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (209)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (209)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromPreferenceForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("g_").operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (217)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (217)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (217)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_transientLocalDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_9728_0 ; // Joker input parameter
  constinArgument_inLocalObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_9728_0, var_masterPropertySignature, inCompiler COMMA_SOURCE_FILE_AT_LINE (269)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (var_masterPropertySignature, object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (277)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (278)) COMMA_SOURCE_FILE_AT_LINE (278)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (278)) COMMA_SOURCE_FILE_AT_LINE (276)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromSelfForImplementation::constructor_new (object->mAttribute_mMasterName.mAttribute_string, var_masterType COMMA_SOURCE_FILE_AT_LINE (281)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientControllerDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_10895_4 ; // Joker input parameter
  GALGAS_bool joker_10895_3 ; // Joker input parameter
  GALGAS_outletBindingListForGeneration joker_10895_2 ; // Joker input parameter
  GALGAS_actionMap joker_10895_1 ; // Joker input parameter
  constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, var_controllerClassName, joker_10895_4, joker_10895_3, joker_10895_2, joker_10895_1, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (299)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_masterType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_11106_0 ; // Joker input parameter
  GALGAS_string joker_11113_0 ; // Joker input parameter
  var_controllerObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_11106_0, joker_11113_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (306)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (GALGAS_string ("controller.").operator_concat (var_controllerClassName COMMA_SOURCE_FILE_AT_LINE (314)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (314)).operator_concat (object->mAttribute_mMasterName.reader_string (SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (314)), object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (314)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (315)) COMMA_SOURCE_FILE_AT_LINE (315)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (315)) COMMA_SOURCE_FILE_AT_LINE (313)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromControllerForImplementation::constructor_new (object->mAttribute_mControllerName.mAttribute_string, object->mAttribute_mMasterName.mAttribute_string, var_masterType COMMA_SOURCE_FILE_AT_LINE (318)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientRootDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_12266_0 ; // Joker input parameter
  constinArgument_inRootObjectObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_12266_0, var_masterDependencyKey, inCompiler COMMA_SOURCE_FILE_AT_LINE (335)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mNamesCountOption.operator_and (GALGAS_bool (kIsNotEqual, var_masterType.objectCompare (GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (342)))) COMMA_SOURCE_FILE_AT_LINE (342)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mMasterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the 'count' option is only allowed for to-many relationships") COMMA_SOURCE_FILE_AT_LINE (343)) ;
  }
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (GALGAS_string ("entity.").operator_concat (constinArgument_inRootEntityName COMMA_SOURCE_FILE_AT_LINE (347)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (347)).operator_concat (object->mAttribute_mMasterName.reader_string (SOURCE_FILE_AT_LINE (347)) COMMA_SOURCE_FILE_AT_LINE (347)), object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (347)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (348)) COMMA_SOURCE_FILE_AT_LINE (348)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (348)) COMMA_SOURCE_FILE_AT_LINE (346)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromRootForImplementation::constructor_new (object->mAttribute_mMasterName.mAttribute_string, var_masterType, object->mAttribute_mNamesCountOption, var_masterDependencyKey.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (355)) COMMA_SOURCE_FILE_AT_LINE (351)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientPreferenceDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_attributeListForImplementation joker_13661_4 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_13661_3 ; // Joker input parameter
  GALGAS_outletGenerationList joker_13661_2 ; // Joker input parameter
  GALGAS_lstringlist joker_13661_1 ; // Joker input parameter
  GALGAS_stringset joker_13711_3 ; // Joker input parameter
  GALGAS_controllerMap joker_13711_2 ; // Joker input parameter
  GALGAS_preferenceArrayMap joker_13711_1 ; // Joker input parameter
  constinArgument_inPreferencesMap.method_searchKey (object->mAttribute_mPreferencesName, joker_13661_4, joker_13661_3, joker_13661_2, joker_13661_1, var_observablePropertyMap, joker_13711_3, joker_13711_2, joker_13711_1, inCompiler COMMA_SOURCE_FILE_AT_LINE (373)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_masterType ;
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_13830_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, var_isTransient, joker_13830_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (374)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (GALGAS_string ("preference.").operator_concat (object->mAttribute_mPreferencesName.reader_string (SOURCE_FILE_AT_LINE (382)) COMMA_SOURCE_FILE_AT_LINE (382)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (382)).operator_concat (object->mAttribute_mMasterName.reader_string (SOURCE_FILE_AT_LINE (382)) COMMA_SOURCE_FILE_AT_LINE (382)), object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (382)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (383)) COMMA_SOURCE_FILE_AT_LINE (383)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (383)) COMMA_SOURCE_FILE_AT_LINE (381)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioImplementationFileInclusionSet.addAssign_operation (object->mAttribute_mPreferencesName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (386)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromPreferenceForImplementation::constructor_new (object->mAttribute_mPreferencesName.mAttribute_string, object->mAttribute_mMasterName.mAttribute_string, var_isTransient, var_masterType COMMA_SOURCE_FILE_AT_LINE (388)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromSelfForImplementation_generateTransientTriggerFromSelfAttribute (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromSelfForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = ioArgument_ioMasterAttributeSet.reader_hasKey (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (532)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioMasterAttributeSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (533)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioRegisteredTransientSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (534)) ;
    //-------- @assignmentInstructionForGeneration
    ioArgument_ioContinue = GALGAS_bool (true) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (537)).operator_concat (GALGAS_string (" transient'\n"
      "    if (") COMMA_SOURCE_FILE_AT_LINE (537)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (538)).operator_concat (GALGAS_string ("__computed) {\n"
      "      ") COMMA_SOURCE_FILE_AT_LINE (538)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (539)).operator_concat (GALGAS_string ("__computed = NO ;\n"
      "      [PMTransientDependancyManager\n"
      "        enterTriggerForObject:self\n"
      "        transientIndex:") COMMA_SOURCE_FILE_AT_LINE (539)).operator_concat (constinArgument_inPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (542)).operator_concat (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (542)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (542)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (542)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (542)) COMMA_SOURCE_FILE_AT_LINE (542)).operator_concat (GALGAS_string ("\n"
      "      ] ;\n"
      "    }\n") COMMA_SOURCE_FILE_AT_LINE (542)) COMMA_SOURCE_FILE_AT_LINE (536)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateTransientTriggerFromSelfAttribute (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = ioArgument_ioMasterAttributeSet.reader_hasKey (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (559)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioMasterAttributeSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (560)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioRegisteredTransientSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (561)) ;
    //-------- @assignmentInstructionForGeneration
    ioArgument_ioContinue = GALGAS_bool (true) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (564)).operator_concat (GALGAS_string (" transient'\n"
      "    if (") COMMA_SOURCE_FILE_AT_LINE (564)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (565)).operator_concat (GALGAS_string ("__computed) {\n"
      "      ") COMMA_SOURCE_FILE_AT_LINE (565)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (566)).operator_concat (GALGAS_string ("__computed = NO ;\n"
      "      [PMTransientDependancyManager\n"
      "        enterTriggerForObject:self\n"
      "        transientIndex:") COMMA_SOURCE_FILE_AT_LINE (566)).operator_concat (constinArgument_inPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (569)).operator_concat (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (569)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (569)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (569)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (569)) COMMA_SOURCE_FILE_AT_LINE (569)).operator_concat (GALGAS_string ("\n"
      "      ] ;\n"
      "    }\n") COMMA_SOURCE_FILE_AT_LINE (569)) COMMA_SOURCE_FILE_AT_LINE (563)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromControllerForImplementation_generateAddObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (constinArgument_inLeadingSpaces.operator_concat (GALGAS_string ("  [") COMMA_SOURCE_FILE_AT_LINE (656)).operator_concat (object->mAttribute_mControllerName COMMA_SOURCE_FILE_AT_LINE (657)).operator_concat (GALGAS_string ("\n"
    "    addObserver:self\n"
    "    forKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (657)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (659)).operator_concat (GALGAS_string ("\"\n"
    "    options:0\n"
    "    context:NULL\n"
    "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (659)) COMMA_SOURCE_FILE_AT_LINE (656)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateAddObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mMasterIsTransient.operator_not (SOURCE_FILE_AT_LINE (671)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (constinArgument_inLeadingSpaces.operator_concat (GALGAS_string ("  [g_") COMMA_SOURCE_FILE_AT_LINE (672)).operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (672)).operator_concat (GALGAS_string (" addObserverOf_") COMMA_SOURCE_FILE_AT_LINE (672)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (672)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (672)) COMMA_SOURCE_FILE_AT_LINE (672)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateAddObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (constinArgument_inLeadingSpaces.operator_concat (GALGAS_string ("  [mRootObject addObserverOf_") COMMA_SOURCE_FILE_AT_LINE (682)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (682)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (682)) COMMA_SOURCE_FILE_AT_LINE (682)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromControllerForImplementation_generateRemoveObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  [").operator_concat (object->mAttribute_mControllerName COMMA_SOURCE_FILE_AT_LINE (722)).operator_concat (GALGAS_string ("\n"
    "    removeObserver:self\n"
    "    forKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (722)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (724)).operator_concat (GALGAS_string ("\"\n"
    "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (724)) COMMA_SOURCE_FILE_AT_LINE (721)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateRemoveObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mMasterIsTransient.operator_not (SOURCE_FILE_AT_LINE (733)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  [g_").operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (734)).operator_concat (GALGAS_string (" removeObserverOf_") COMMA_SOURCE_FILE_AT_LINE (734)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (734)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (734)) COMMA_SOURCE_FILE_AT_LINE (734)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateRemoveObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  [mRootObject removeObserverOf_").operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (743)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (743)) COMMA_SOURCE_FILE_AT_LINE (743)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromControllerForImplementation_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioObserveForKeyPathRoutineElementListMap.addAssign_operation (object->mAttribute_mControllerName.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (790)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (790)), constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (790)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mMasterIsTransient.operator_not (SOURCE_FILE_AT_LINE (800)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_didChangeTriggeredRoutineListMap.addAssign_operation (GALGAS_string ("preference.").operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (801)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (801)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (801)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (801)), constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (801)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_didChangeTriggeredRoutineListMap.addAssign_operation (object->mAttribute_mTriggerRoutineName, constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (812)) ;
}
//---------------------------------------------------------------------------*
