...
void routine_analyzeTransientProperties (const GALGAS_preferencesMap constinArgument_inPreferencesMap,
  ...
  outArgument_outTransientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (396)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientList enumerator_14566 (constinArgument_inTransientList, kEnumeration_up) ;
  ...
  while (enumerator_14566.hasCurrentObject ()) {
    ...
    GALGAS_lstring var_transientObservationKey = GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (enumerator_14566.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (400)) COMMA_SOURCE_FILE_AT_LINE (400)), enumerator_14566.current_mTransientName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (399)) ;
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_transientObservationKey, var_transientObservationKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (403)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (405)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_dependanceList enumerator_14988 (enumerator_14566.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_14988.hasCurrentObject ()) {
      ...
      callCategoryMethod_analyze ((const cPtr_abstractTransientDependency *) enumerator_14988.current_mDependency (HERE).ptr (), enumerator_14566.current_mTransientName (HERE), ioArgument_ioSelfObjectObservablePropertyMap, constinArgument_inPreferencesMap, constinArgument_inControllerMap, constinArgument_inRootObjectObservablePropertyMap, constinArgument_inRootEntityName, constinArgument_inObervationDependencyPrefix, ioArgument_ioImplementationFileInclusionSet, ioArgument_ioTransientDependencyGraph, var_implementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (407)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_directDependancyList.addAssign_operation (var_implementation COMMA_SOURCE_FILE_AT_LINE (419)) ;
      enumerator_14988.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSelfObjectObservablePropertyMap.modifier_insertKey (enumerator_14566.current_mTransientName (HERE), enumerator_14566.current_mType (HERE), GALGAS_bool (true), var_transientObservationKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (422)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    outArgument_outTransientListForImplementation.addAssign_operation (enumerator_14566.current_mType (HERE), enumerator_14566.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (429)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (429)) ;
...
GALGAS_string function_generateTransientFunctionDeclarations (const GALGAS_string & constinArgument_inKindName,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("//----------------------------------------------------------------------------*\n").operator_concat (GALGAS_string ("//   T R A N S I E N T    P R O P E R T I E S                                 *\n") COMMA_SOURCE_FILE_AT_LINE (442)).operator_concat (GALGAS_string ("//----------------------------------------------------------------------------*\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (443)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_16412 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_16412.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (categoryReader_ocTypeName (enumerator_16412.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (446)).operator_concat (GALGAS_string (" compute_") COMMA_SOURCE_FILE_AT_LINE (446)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (446)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (446)).operator_concat (enumerator_16412.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (446)).operator_concat (GALGAS_string (" (\n") COMMA_SOURCE_FILE_AT_LINE (446)) COMMA_SOURCE_FILE_AT_LINE (446)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_16553 (enumerator_16412.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_16553.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("    ").operator_concat (callCategoryReader_generateFormalArgument ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_16553.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (449)) COMMA_SOURCE_FILE_AT_LINE (449)) COMMA_SOURCE_FILE_AT_LINE (449)) ;
      if (enumerator_16553.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
...
GALGAS_string function_generateTransientCacheRoutine (const GALGAS_string & constinArgument_inKindName,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_17040 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_17040.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "// Cache routine of '").operator_concat (enumerator_17040.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (468)).operator_concat (GALGAS_string ("' transient     *\n"
      "//----------------------------------------------------------------------------*\n"
      "\n"
      "- (") COMMA_SOURCE_FILE_AT_LINE (468)).operator_concat (categoryReader_ocTypeName (enumerator_17040.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (470)) COMMA_SOURCE_FILE_AT_LINE (470)).operator_concat (GALGAS_string (") ") COMMA_SOURCE_FILE_AT_LINE (470)).operator_concat (enumerator_17040.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (470)).operator_concat (GALGAS_string (" {\n"
      "  if (! ") COMMA_SOURCE_FILE_AT_LINE (470)).operator_concat (enumerator_17040.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (471)).operator_concat (GALGAS_string ("__computed) {\n"
      "    ") COMMA_SOURCE_FILE_AT_LINE (471)).operator_concat (enumerator_17040.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (472)).operator_concat (GALGAS_string ("__cache = compute_") COMMA_SOURCE_FILE_AT_LINE (472)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (472)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (472)).operator_concat (enumerator_17040.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (472)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (472)) COMMA_SOURCE_FILE_AT_LINE (466)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_17563 (enumerator_17040.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_17563.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (callCategoryReader_generateMasterAttributeCall ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_17563.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (474)) COMMA_SOURCE_FILE_AT_LINE (474)) ;
      if (enumerator_17563.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (475)) ;
      }
      enumerator_17563.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (") ;\n"
      "    ").operator_concat (enumerator_17040.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (478)).operator_concat (GALGAS_string ("__computed = YES ;\n"
      "  }\n"
      "  return ") COMMA_SOURCE_FILE_AT_LINE (478)).operator_concat (enumerator_17040.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (480)).operator_concat (GALGAS_string ("__cache") COMMA_SOURCE_FILE_AT_LINE (480)) COMMA_SOURCE_FILE_AT_LINE (477)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = categoryReader_copyOnAssign (enumerator_17040.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (481)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (".copy") COMMA_SOURCE_FILE_AT_LINE (481)) ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (" ;\n"
      "}\n"
...
GALGAS_string function_generateTransientTriggering (const GALGAS_string & constinArgument_inPropertyName,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_masterSet = GALGAS_stringset::constructor_setWithString (constinArgument_inPropertyName COMMA_SOURCE_FILE_AT_LINE (598)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_registeredTransientSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (599)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_bool var_looping = GALGAS_bool (true) ;
  //-------- @loopInstructionForGeneration
  if (constinArgument_inTransientListForImplementation.reader_length (SOURCE_FILE_AT_LINE (601)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (601)).isValid ()) {
    PMUInt32 variant_22129 = constinArgument_inTransientListForImplementation.reader_length (SOURCE_FILE_AT_LINE (601)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (601)).uintValue () ;
    bool loop_22129 = true ;
    while (loop_22129) {
      loop_22129 = var_looping.isValid () ;
      if (loop_22129) {
        loop_22129 = var_looping.boolValue () ;
      }
      if (loop_22129 && (0 == variant_22129)) {
        loop_22129 = false ;
      ...
      if (loop_22129) {
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_transientListForImplementation enumerator_22261 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_22261.hasCurrentObject ()) {
          //-------- @foreachInstructionForGeneration
          cEnumerator_directDependancyList enumerator_22294 (enumerator_22261.current_mDependencyList (HERE), kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_22294.hasCurrentObject ()) {
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_0 = var_registeredTransientSet.reader_hasKey (enumerator_22261.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (605)).operator_not (SOURCE_FILE_AT_LINE (605)).boolEnum () ;
            if (kBoolTrue == test_0) {
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_generateTransientTriggerFromSelfAttribute ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_22294.current_mDependency (HERE).ptr (), constinArgument_inPrefix, constinArgument_inClassName, enumerator_22261.current_mTransientName (HERE), var_masterSet, var_registeredTransientSet, var_looping, result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (606)) ;
              //-------- END @methodCallInstructionForGeneration
            }
...
GALGAS_string function_generateAddObserverForTransients (const GALGAS_transientListForImplementation & constinArgument_inTransientListForImplementation,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_24698 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_24698.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_24729 (enumerator_24698.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_24729.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateAddObserverForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_24729.current_mDependency (HERE).ptr (), constinArgument_inLeadingSpaces, result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (681)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_24729.gotoNextObject () ;
    }
...
GALGAS_string function_generateRemoveObserverForTransients (const GALGAS_transientListForImplementation & constinArgument_inTransientListForImplementation,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_26629 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_26629.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_26660 (enumerator_26629.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_26660.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateRemoveObserverForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_26660.current_mDependency (HERE).ptr (), result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (741)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_26660.gotoNextObject () ;
    }
    enumerator_26629.gotoNextObject () ;
  }
//---
  return result_outResult ;
}
...
GALGAS_string function_generateObserverRoutinesForTransient (const GALGAS_string & constinArgument_inKindName,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observerListMap var_didChangeTriggeredRoutineListMap = GALGAS_observerListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (810)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observerListMap var_observeForKeyPathRoutineElementListMap = GALGAS_observerListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (811)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_29522 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29522.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_29553 (enumerator_29522.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_29553.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateObserverRoutineForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_29553.current_mDependency (HERE).ptr (), enumerator_29522.current_mTransientName (HERE), var_didChangeTriggeredRoutineListMap, var_observeForKeyPathRoutineElementListMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (814)) ;
      //-------- END @methodCallInstructionForGeneration
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_fullPrefix = constinArgument_inPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (822)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (822)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (822)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_observerListMap enumerator_29941 (var_didChangeTriggeredRoutineListMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_29941.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "//  ").operator_concat (enumerator_29941.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (826)).operator_concat (GALGAS_string ("_didChange   *\n"
      "//----------------------------------------------------------------------------*\n"
      "\n"
      "- (void) ") COMMA_SOURCE_FILE_AT_LINE (826)).operator_concat (enumerator_29941.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (828)).operator_concat (GALGAS_string ("_didChange {\n") COMMA_SOURCE_FILE_AT_LINE (828)) COMMA_SOURCE_FILE_AT_LINE (824)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringlist enumerator_30238 (enumerator_29941.current_mList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_30238.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (enumerator_30238.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (831)).operator_concat (GALGAS_string (" transient'\n"
        "  if (") COMMA_SOURCE_FILE_AT_LINE (831)).operator_concat (enumerator_30238.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (832)).operator_concat (GALGAS_string ("__computed) {\n"
        "    ") COMMA_SOURCE_FILE_AT_LINE (832)).operator_concat (enumerator_30238.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (833)).operator_concat (GALGAS_string ("__computed = NO ;\n"
        "    [PMTransientDependancyManager\n"
        "      enterTriggerForObject:self\n"
        "      transientIndex:") COMMA_SOURCE_FILE_AT_LINE (833)).operator_concat (var_fullPrefix.operator_concat (enumerator_30238.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (836)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (836)) COMMA_SOURCE_FILE_AT_LINE (836)).operator_concat (GALGAS_string ("\n"
        "    ] ;\n"
        "  }\n") COMMA_SOURCE_FILE_AT_LINE (836)) COMMA_SOURCE_FILE_AT_LINE (830)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_observerListMap enumerator_30789 (var_observeForKeyPathRoutineElementListMap, kEnumeration_up) ;
  //--- complex foreach instruction
  const bool bool_0 = true ;
  if (enumerator_30789.hasCurrentObject () && bool_0) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
    ...
    while (enumerator_30789.hasCurrentObject () && bool_0) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (" if ((inObject == ").operator_concat (enumerator_30789.current_key (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (856)) COMMA_SOURCE_FILE_AT_LINE (856)).operator_concat (GALGAS_string (") && [inKeyPath isEqualToString:@\"") COMMA_SOURCE_FILE_AT_LINE (856)).operator_concat (enumerator_30789.current_key (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (856)) COMMA_SOURCE_FILE_AT_LINE (856)).operator_concat (GALGAS_string ("\"]) {\n") COMMA_SOURCE_FILE_AT_LINE (856)) COMMA_SOURCE_FILE_AT_LINE (855)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_31467 (enumerator_30789.current_mList (HERE), kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_31467.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (enumerator_31467.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (859)).operator_concat (GALGAS_string (" transient'\n"
          "    if (") COMMA_SOURCE_FILE_AT_LINE (859)).operator_concat (enumerator_31467.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (860)).operator_concat (GALGAS_string ("__computed) {\n"
          "      ") COMMA_SOURCE_FILE_AT_LINE (860)).operator_concat (enumerator_31467.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (861)).operator_concat (GALGAS_string ("__computed = NO ;\n"
          "      [PMTransientDependancyManager\n"
          "        enterTriggerForObject:self\n"
          "        transientIndex:") COMMA_SOURCE_FILE_AT_LINE (861)).operator_concat (var_fullPrefix.operator_concat (enumerator_31467.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (864)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (864)) COMMA_SOURCE_FILE_AT_LINE (864)).operator_concat (GALGAS_string ("\n"
          "      ] ;\n"
          "    }\n") COMMA_SOURCE_FILE_AT_LINE (864)) COMMA_SOURCE_FILE_AT_LINE (858)) ;
        enumerator_31467.gotoNextObject () ;
      }
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("  }else") COMMA_SOURCE_FILE_AT_LINE (868)) ;
...
void routine_generateTransientDependencyFiles (const GALGAS__32_stringlist constinArgument_inTransientDependencyArcList,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_dependentSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (909)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator__32_stringlist enumerator_33057 (constinArgument_inTransientDependencyArcList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_33057.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_graphString.dotAssign_operation (GALGAS_string ("// ").operator_concat (enumerator_33057.current_mValue_30_ (HERE) COMMA_SOURCE_FILE_AT_LINE (911)).operator_concat (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (911)).operator_concat (enumerator_33057.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (911)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (911)) COMMA_SOURCE_FILE_AT_LINE (911)) ;
    //-------- @plusEqualnstructionForGeneration
    var_dependentSet.addAssign_operation (enumerator_33057.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (912)) ;
    enumerator_33057.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_transientOrderedList = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_33254 (constinArgument_inSortedTransientOrderedList, kEnumeration_down) ;
  //--- simple foreach instruction
  while (enumerator_33254.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_transientOrderedList.dotAssign_operation (GALGAS_string ("// ").operator_concat (enumerator_33254.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (916)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (916)) COMMA_SOURCE_FILE_AT_LINE (916)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_33462 (constinArgument_inSortedTransientOrderedList, kEnumeration_down) ;
  //--- simple foreach instruction
  while (enumerator_33462.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_dependentSet.reader_hasKey (enumerator_33462.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (922)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      var_transientIndexesString.dotAssign_operation (GALGAS_string ("#define ").operator_concat (enumerator_33462.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (923)) COMMA_SOURCE_FILE_AT_LINE (923)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (923)).operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (923)) COMMA_SOURCE_FILE_AT_LINE (923)).operator_concat (GALGAS_string (")\n") COMMA_SOURCE_FILE_AT_LINE (923)) COMMA_SOURCE_FILE_AT_LINE (923)) ;
      //-------- @concatInstructionForGeneration
      var_transientList.dotAssign_operation (GALGAS_string ("      @").operator_concat (enumerator_33462.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (924)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (924)) COMMA_SOURCE_FILE_AT_LINE (924)).operator_concat (GALGAS_string (", // ") COMMA_SOURCE_FILE_AT_LINE (924)).operator_concat (enumerator_33462.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (924)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (924)) COMMA_SOURCE_FILE_AT_LINE (924)) ;
      //-------- @incrementInstructionForGeneration
      var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (925)) ;
    }
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_s = GALGAS_string (filewrapperTemplate_transientManager_managerDeclaration (inCompiler, var_graphString, var_transientOrderedList, var_transientIndexesString, var_transientCount COMMA_SOURCE_FILE_AT_LINE (930))) ;
  ...
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inSourceDirectoryPath, GALGAS_string ("PMTransientDependancyManager.h"), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_s, GALGAS_string ("\n"
    "\n"), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (936)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_s = GALGAS_string (filewrapperTemplate_transientManager_managerImplementation (inCompiler, var_transientList COMMA_SOURCE_FILE_AT_LINE (946))) ;
  { //-------- @typeMethodInstructionForGeneration
...
static GALGAS_string categoryReader_transientDependencyFromSelfForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (134)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (134)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (134)) COMMA_SOURCE_FILE_AT_LINE (134)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromControllerForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (142)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (142)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (142)) COMMA_SOURCE_FILE_AT_LINE (142)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromRootForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @assignmentInstructionForGeneration
    result_outResult = GALGAS_string ("const NSUInteger in").operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (151)) COMMA_SOURCE_FILE_AT_LINE (151)).operator_concat (GALGAS_string ("_count") COMMA_SOURCE_FILE_AT_LINE (151)) ;
  }else if (kBoolFalse == test_0) {
    //-------- @assignmentInstructionForGeneration
    result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (153)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (153)) COMMA_SOURCE_FILE_AT_LINE (153)) ;
  }
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromPreferenceForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (162)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (162)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (162)) COMMA_SOURCE_FILE_AT_LINE (162)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromSelfForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromSelfForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("self.").operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (176)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromRootForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("mRootObject.").operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (184)) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mNamesCountOption.boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (".count") COMMA_SOURCE_FILE_AT_LINE (186)) ;
  }
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromControllerForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = object->mAttribute_mControllerName.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (195)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (195)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromPreferenceForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("g_").operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (203)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (203)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (203)) ;
//---
  return result_outResult ;
}
...
static void categoryMethod_transientLocalDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_9208_0 ; // Joker input parameter
  constinArgument_inLocalObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_9208_0, var_masterPropertySignature, inCompiler COMMA_SOURCE_FILE_AT_LINE (255)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (var_masterPropertySignature, object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (263)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (264)) COMMA_SOURCE_FILE_AT_LINE (264)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (264)) COMMA_SOURCE_FILE_AT_LINE (262)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromSelfForImplementation::constructor_new (object->mAttribute_mMasterName.mAttribute_string, var_masterType COMMA_SOURCE_FILE_AT_LINE (267)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientControllerDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_10375_3 ; // Joker input parameter
  GALGAS_outletBindingListForGeneration joker_10375_2 ; // Joker input parameter
  GALGAS_actionMap joker_10375_1 ; // Joker input parameter
  constinArgument_inControllerMap.method_searchKey (object->mAttribute_mControllerName, var_controllerClassName, joker_10375_3, joker_10375_2, joker_10375_1, var_controllerObservablePropertyMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (285)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_masterType ;
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_10586_0 ; // Joker input parameter
  GALGAS_string joker_10593_0 ; // Joker input parameter
  var_controllerObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_10586_0, joker_10593_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (292)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (GALGAS_string ("controller.").operator_concat (var_controllerClassName COMMA_SOURCE_FILE_AT_LINE (300)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (300)).operator_concat (object->mAttribute_mMasterName.reader_string (SOURCE_FILE_AT_LINE (300)) COMMA_SOURCE_FILE_AT_LINE (300)), object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (300)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (301)) COMMA_SOURCE_FILE_AT_LINE (301)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (301)) COMMA_SOURCE_FILE_AT_LINE (299)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromControllerForImplementation::constructor_new (object->mAttribute_mControllerName.mAttribute_string, object->mAttribute_mMasterName.mAttribute_string, var_masterType COMMA_SOURCE_FILE_AT_LINE (304)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientRootDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_11746_0 ; // Joker input parameter
  constinArgument_inRootObjectObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_11746_0, var_masterDependencyKey, inCompiler COMMA_SOURCE_FILE_AT_LINE (321)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mNamesCountOption.operator_and (GALGAS_bool (kIsNotEqual, var_masterType.objectCompare (GALGAS_easyBindingType::constructor_toManyEntitiesType (SOURCE_FILE_AT_LINE (328)))) COMMA_SOURCE_FILE_AT_LINE (328)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @errorInstructionForGeneration
    GALGAS_location location_1 (object->mAttribute_mMasterName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the 'count' option is only allowed for to-many relationships") COMMA_SOURCE_FILE_AT_LINE (329)) ;
  }
  { //-------- @modifierCallInstructionForGeneration
...
static void categoryMethod_transientPreferenceDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_attributeListForImplementation joker_13141_4 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_13141_3 ; // Joker input parameter
  GALGAS_outletGenerationList joker_13141_2 ; // Joker input parameter
  GALGAS_lstringlist joker_13141_1 ; // Joker input parameter
  GALGAS_stringset joker_13191_0 ; // Joker input parameter
  constinArgument_inPreferencesMap.method_searchKey (object->mAttribute_mPreferencesName, joker_13141_4, joker_13141_3, joker_13141_2, joker_13141_1, var_observablePropertyMap, joker_13191_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (359)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_masterType ;
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_string joker_13309_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, var_isTransient, joker_13309_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (360)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (GALGAS_string ("preference.").operator_concat (object->mAttribute_mPreferencesName.reader_string (SOURCE_FILE_AT_LINE (368)) COMMA_SOURCE_FILE_AT_LINE (368)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (368)).operator_concat (object->mAttribute_mMasterName.reader_string (SOURCE_FILE_AT_LINE (368)) COMMA_SOURCE_FILE_AT_LINE (368)), object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (368)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (369)) COMMA_SOURCE_FILE_AT_LINE (369)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (369)) COMMA_SOURCE_FILE_AT_LINE (367)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioImplementationFileInclusionSet.addAssign_operation (object->mAttribute_mPreferencesName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (372)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromPreferenceForImplementation::constructor_new (object->mAttribute_mPreferencesName.mAttribute_string, object->mAttribute_mMasterName.mAttribute_string, var_isTransient, var_masterType COMMA_SOURCE_FILE_AT_LINE (374)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromSelfForImplementation_generateTransientTriggerFromSelfAttribute (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromSelfForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = ioArgument_ioMasterAttributeSet.reader_hasKey (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (518)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioMasterAttributeSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (519)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioRegisteredTransientSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (520)) ;
    //-------- @assignmentInstructionForGeneration
    ioArgument_ioContinue = GALGAS_bool (true) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (523)).operator_concat (GALGAS_string (" transient'\n"
      "    if (") COMMA_SOURCE_FILE_AT_LINE (523)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (524)).operator_concat (GALGAS_string ("__computed) {\n"
      "      ") COMMA_SOURCE_FILE_AT_LINE (524)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (525)).operator_concat (GALGAS_string ("__computed = NO ;\n"
      "      [PMTransientDependancyManager\n"
      "        enterTriggerForObject:self\n"
      "        transientIndex:") COMMA_SOURCE_FILE_AT_LINE (525)).operator_concat (constinArgument_inPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (528)).operator_concat (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (528)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (528)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (528)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (528)) COMMA_SOURCE_FILE_AT_LINE (528)).operator_concat (GALGAS_string ("\n"
      "      ] ;\n"
      "    }\n") COMMA_SOURCE_FILE_AT_LINE (528)) COMMA_SOURCE_FILE_AT_LINE (522)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateTransientTriggerFromSelfAttribute (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = ioArgument_ioMasterAttributeSet.reader_hasKey (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (545)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioMasterAttributeSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (546)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioRegisteredTransientSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (547)) ;
    //-------- @assignmentInstructionForGeneration
    ioArgument_ioContinue = GALGAS_bool (true) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (550)).operator_concat (GALGAS_string (" transient'\n"
      "    if (") COMMA_SOURCE_FILE_AT_LINE (550)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (551)).operator_concat (GALGAS_string ("__computed) {\n"
      "      ") COMMA_SOURCE_FILE_AT_LINE (551)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (552)).operator_concat (GALGAS_string ("__computed = NO ;\n"
      "      [PMTransientDependancyManager\n"
      "        enterTriggerForObject:self\n"
      "        transientIndex:") COMMA_SOURCE_FILE_AT_LINE (552)).operator_concat (constinArgument_inPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (555)).operator_concat (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (555)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (555)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (555)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (555)) COMMA_SOURCE_FILE_AT_LINE (555)).operator_concat (GALGAS_string ("\n"
      "      ] ;\n"
      "    }\n") COMMA_SOURCE_FILE_AT_LINE (555)) COMMA_SOURCE_FILE_AT_LINE (549)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromControllerForImplementation_generateAddObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (constinArgument_inLeadingSpaces.operator_concat (GALGAS_string ("  [") COMMA_SOURCE_FILE_AT_LINE (642)).operator_concat (object->mAttribute_mControllerName COMMA_SOURCE_FILE_AT_LINE (643)).operator_concat (GALGAS_string ("\n"
    "    addObserver:self\n"
    "    forKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (643)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (645)).operator_concat (GALGAS_string ("\"\n"
    "    options:0\n"
    "    context:NULL\n"
    "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (645)) COMMA_SOURCE_FILE_AT_LINE (642)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateAddObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mMasterIsTransient.operator_not (SOURCE_FILE_AT_LINE (657)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (constinArgument_inLeadingSpaces.operator_concat (GALGAS_string ("  [g_") COMMA_SOURCE_FILE_AT_LINE (658)).operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (658)).operator_concat (GALGAS_string (" addObserverOf_") COMMA_SOURCE_FILE_AT_LINE (658)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (658)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (658)) COMMA_SOURCE_FILE_AT_LINE (658)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateAddObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (constinArgument_inLeadingSpaces.operator_concat (GALGAS_string ("  [mRootObject addObserverOf_") COMMA_SOURCE_FILE_AT_LINE (668)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (668)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (668)) COMMA_SOURCE_FILE_AT_LINE (668)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromControllerForImplementation_generateRemoveObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  [").operator_concat (object->mAttribute_mControllerName COMMA_SOURCE_FILE_AT_LINE (708)).operator_concat (GALGAS_string ("\n"
    "    removeObserver:self\n"
    "    forKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (708)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (710)).operator_concat (GALGAS_string ("\"\n"
    "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (710)) COMMA_SOURCE_FILE_AT_LINE (707)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateRemoveObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mMasterIsTransient.operator_not (SOURCE_FILE_AT_LINE (719)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  [g_").operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (720)).operator_concat (GALGAS_string (" removeObserverOf_") COMMA_SOURCE_FILE_AT_LINE (720)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (720)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (720)) COMMA_SOURCE_FILE_AT_LINE (720)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateRemoveObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @concatInstructionForGeneration
  ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  [mRootObject removeObserverOf_").operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (729)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (729)) COMMA_SOURCE_FILE_AT_LINE (729)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromControllerForImplementation_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromControllerForImplementation) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioObserveForKeyPathRoutineElementListMap.addAssign_operation (object->mAttribute_mControllerName.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (776)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (776)), constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (776)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mMasterIsTransient.operator_not (SOURCE_FILE_AT_LINE (786)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_didChangeTriggeredRoutineListMap.addAssign_operation (GALGAS_string ("preference.").operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (787)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (787)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (787)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (787)), constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (787)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromRootForImplementation_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromRootForImplementation) ;
  //-------- @plusEqualnstructionForGeneration
  ioArgument_didChangeTriggeredRoutineListMap.addAssign_operation (object->mAttribute_mTriggerRoutineName, constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (798)) ;
}
//---------------------------------------------------------------------------*
