...
bool cMapElement_observablePropertyMap::isValid (void) const {
  return mAttribute_lkey.isValid () && mAttribute_mType.isValid () && mAttribute_mIsTransient.isValid () ;
}
...
cMapElement * cMapElement_observablePropertyMap::copy (void) {
  cMapElement * result = NULL ;
  macroMyNew (result, cMapElement_observablePropertyMap (mAttribute_lkey, mAttribute_mType, mAttribute_mIsTransient COMMA_HERE)) ;
  return result ;
}
...
void GALGAS_observablePropertyMap::modifier_insertKey (GALGAS_lstring inKey,
  ...
  macroMyNew (p, cMapElement_observablePropertyMap (inKey, inArgument0, inArgument1 COMMA_HERE)) ;
  capCollectionElement attributes ;
  attributes.setPointer (p) ;
  macroDetachSharedObject (p) ;
...
GALGAS_observablePropertyMap_2E_element cEnumerator_observablePropertyMap::current (LOCATION_ARGS) const {
  ...
  macroValidSharedObject (p, const cMapElement_observablePropertyMap) ;
  return GALGAS_observablePropertyMap_2E_element (p->mAttribute_lkey, p->mAttribute_mType, p->mAttribute_mIsTransient) ;
}
...
void routine_analyzeTransientProperties (const GALGAS_preferencesMap constinArgument_inPreferencesMap,
  ...
  outArgument_outTransientListForImplementation = GALGAS_transientListForImplementation::constructor_emptyList (SOURCE_FILE_AT_LINE (265)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientList enumerator_9764 (constinArgument_inTransientList, kEnumeration_up) ;
  ...
  while (enumerator_9764.hasCurrentObject ()) {
    ...
    GALGAS_lstring var_transientObservationKey = GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (enumerator_9764.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (269)) COMMA_SOURCE_FILE_AT_LINE (269)), enumerator_9764.current_mTransientName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (268)) ;
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioTransientDependencyGraph.modifier_addNode (var_transientObservationKey, var_transientObservationKey.mAttribute_string, inCompiler COMMA_SOURCE_FILE_AT_LINE (272)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
    GALGAS_directDependancyList var_directDependancyList = GALGAS_directDependancyList::constructor_emptyList (SOURCE_FILE_AT_LINE (274)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_dependanceList enumerator_10186 (enumerator_9764.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_10186.hasCurrentObject ()) {
      ...
      callCategoryMethod_analyze ((const cPtr_abstractTransientDependency *) enumerator_10186.current_mDependency (HERE).ptr (), enumerator_9764.current_mTransientName (HERE), ioArgument_ioSelfObjectObservablePropertyMap, constinArgument_inPreferencesMap, constinArgument_inObervationDependencyPrefix, ioArgument_ioImplementationFileInclusionSet, ioArgument_ioTransientDependencyGraph, var_implementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (276)) ;
      //-------- END @methodCallInstructionForGeneration
      //-------- @plusEqualnstructionForGeneration
      var_directDependancyList.addAssign_operation (var_implementation COMMA_SOURCE_FILE_AT_LINE (285)) ;
      enumerator_10186.gotoNextObject () ;
    }
    { //-------- @modifierCallInstructionForGeneration
    ioArgument_ioSelfObjectObservablePropertyMap.modifier_insertKey (enumerator_9764.current_mTransientName (HERE), enumerator_9764.current_mType (HERE), GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (288)) ;
    } //-------- END @typeMethodInstructionForGeneration
    //-------- @plusEqualnstructionForGeneration
    outArgument_outTransientListForImplementation.addAssign_operation (enumerator_9764.current_mType (HERE), enumerator_9764.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (294)), var_directDependancyList COMMA_SOURCE_FILE_AT_LINE (294)) ;
...
GALGAS_string function_generateTransientFunctionDeclarations (const GALGAS_string & constinArgument_inKindName,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("//----------------------------------------------------------------------------*\n").operator_concat (GALGAS_string ("//   T R A N S I E N T    P R O P E R T I E S                                 *\n") COMMA_SOURCE_FILE_AT_LINE (307)).operator_concat (GALGAS_string ("//----------------------------------------------------------------------------*\n"
    "\n") COMMA_SOURCE_FILE_AT_LINE (308)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_11477 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_11477.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (categoryReader_ocTypeName (enumerator_11477.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (311)).operator_concat (GALGAS_string (" compute_") COMMA_SOURCE_FILE_AT_LINE (311)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (311)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (311)).operator_concat (enumerator_11477.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (311)).operator_concat (GALGAS_string (" (\n") COMMA_SOURCE_FILE_AT_LINE (311)) COMMA_SOURCE_FILE_AT_LINE (311)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_11618 (enumerator_11477.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_11618.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("    ").operator_concat (callCategoryReader_generateFormalArgument ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_11618.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (314)) COMMA_SOURCE_FILE_AT_LINE (314)) ;
      if (enumerator_11618.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
...
GALGAS_string function_generateTransientCacheRoutine (const GALGAS_string & constinArgument_inKindName,
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_12105 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_12105.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "// Cache routine of '").operator_concat (enumerator_12105.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (333)).operator_concat (GALGAS_string ("' transient     *\n"
      "//----------------------------------------------------------------------------*\n"
      "\n"
      "- (") COMMA_SOURCE_FILE_AT_LINE (333)).operator_concat (categoryReader_ocTypeName (enumerator_12105.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (335)) COMMA_SOURCE_FILE_AT_LINE (335)).operator_concat (GALGAS_string (") ") COMMA_SOURCE_FILE_AT_LINE (335)).operator_concat (enumerator_12105.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (335)).operator_concat (GALGAS_string (" {\n"
      "  if (! ") COMMA_SOURCE_FILE_AT_LINE (335)).operator_concat (enumerator_12105.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (336)).operator_concat (GALGAS_string ("__computed) {\n"
      "    ") COMMA_SOURCE_FILE_AT_LINE (336)).operator_concat (enumerator_12105.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (337)).operator_concat (GALGAS_string ("__cache = compute_") COMMA_SOURCE_FILE_AT_LINE (337)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (337)).operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (337)).operator_concat (enumerator_12105.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (337)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (337)) COMMA_SOURCE_FILE_AT_LINE (331)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_12628 (enumerator_12105.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_12628.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (callCategoryReader_generateMasterAttributeCall ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_12628.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE_AT_LINE (339)) COMMA_SOURCE_FILE_AT_LINE (339)) ;
      if (enumerator_12628.hasNextObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string (", ") COMMA_SOURCE_FILE_AT_LINE (340)) ;
      }
      enumerator_12628.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (") ;\n"
      "    ").operator_concat (enumerator_12105.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (343)).operator_concat (GALGAS_string ("__computed = YES ;\n"
      "  }\n"
      "  return ") COMMA_SOURCE_FILE_AT_LINE (343)).operator_concat (enumerator_12105.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (345)).operator_concat (GALGAS_string ("__cache") COMMA_SOURCE_FILE_AT_LINE (345)) COMMA_SOURCE_FILE_AT_LINE (342)) ;
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = categoryReader_copyOnAssign (enumerator_12105.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE_AT_LINE (346)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (".copy") COMMA_SOURCE_FILE_AT_LINE (346)) ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (" ;\n"
      "}\n"
...
GALGAS_string function_generateTransientImplementation (const GALGAS_string & constinArgument_inKindName,
  ...
  GALGAS_string result_outResult ; // Returned variable
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_triggeredKeysForSelfObject var_triggeredKeys = GALGAS_triggeredKeysForSelfObject::constructor_emptyMap (SOURCE_FILE_AT_LINE (370)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_triggeredKeysForOtherObjects var_triggeredKeysFromOtherObjects = GALGAS_triggeredKeysForOtherObjects::constructor_emptyMap (SOURCE_FILE_AT_LINE (371)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_13862 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_13862.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_13893 (enumerator_13862.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
  ...
  GALGAS_string var_partialPrefix = constinArgument_inPrefix.operator_concat (GALGAS_string ("/") COMMA_SOURCE_FILE_AT_LINE (381)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (381)) ;
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_fullPrefix = var_partialPrefix.operator_concat (GALGAS_string ("/self") COMMA_SOURCE_FILE_AT_LINE (382)) ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_triggeredKeysForSelfObject var_triggeredKeysForSelfObject = GALGAS_triggeredKeysForSelfObject::constructor_emptyMap (SOURCE_FILE_AT_LINE (384)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator__32_stringlist enumerator_14399 (constinArgument_inTransientDependencyArcList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_14399.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = GALGAS_bool (kIsEqual, enumerator_14399.current_mValue_30_ (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (386)).objectCompare (var_fullPrefix)).operator_and (GALGAS_bool (kIsEqual, enumerator_14399.current_mValue_31_ (HERE).reader_stringByDeletingPathExtension (SOURCE_FILE_AT_LINE (386)).objectCompare (var_fullPrefix)) COMMA_SOURCE_FILE_AT_LINE (386)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @plusEqualnstructionForGeneration
      var_triggeredKeysForSelfObject.addAssign_operation (enumerator_14399.current_mValue_30_ (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (387)), enumerator_14399.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (387)) ;
    }
  ...
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, var_triggeredKeysFromOtherObjects.reader_count (SOURCE_FILE_AT_LINE (395)).add_operation (var_triggeredKeysForSelfObject.reader_count (SOURCE_FILE_AT_LINE (395)), inCompiler COMMA_SOURCE_FILE_AT_LINE (395)).objectCompare (GALGAS_uint ((PMUInt32) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "\n"
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForOtherObjects enumerator_15240 (var_triggeredKeysFromOtherObjects, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_15240.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_15276 (enumerator_15240.current (HERE).mAttribute_mList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_15276.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  [").operator_concat (enumerator_15240.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (404)).operator_concat (GALGAS_string ("\n"
          "    addObserver:self\n"
          "    forKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (404)).operator_concat (enumerator_15276.current (HERE).mAttribute_mValue_30_ COMMA_SOURCE_FILE_AT_LINE (406)).operator_concat (GALGAS_string ("\"\n"
          "    options:0\n"
          "    context:NULL\n"
          "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (406)) COMMA_SOURCE_FILE_AT_LINE (403)) ;
        enumerator_15276.gotoNextObject () ;
      }
      enumerator_15240.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForSelfObject enumerator_15574 (var_triggeredKeysForSelfObject, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_15574.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("  [self\n"
        "    addObserver:self\n"
        "    forKeyPath:@\"").operator_concat (enumerator_15574.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (416)).operator_concat (GALGAS_string ("\"\n"
        "    options:0\n"
        "    context:NULL\n"
        "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (416)) COMMA_SOURCE_FILE_AT_LINE (413)) ;
    ...
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForOtherObjects enumerator_16110 (var_triggeredKeysFromOtherObjects, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_16110.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_16146 (enumerator_16110.current (HERE).mAttribute_mList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_16146.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("  [").operator_concat (enumerator_16110.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (430)).operator_concat (GALGAS_string ("\n"
          "    removeObserver:self\n"
          "    forKeyPath:@\"") COMMA_SOURCE_FILE_AT_LINE (430)).operator_concat (enumerator_16146.current (HERE).mAttribute_mValue_30_ COMMA_SOURCE_FILE_AT_LINE (432)).operator_concat (GALGAS_string ("\"\n"
          "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (432)) COMMA_SOURCE_FILE_AT_LINE (429)) ;
        enumerator_16146.gotoNextObject () ;
      }
      enumerator_16110.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForSelfObject enumerator_16392 (var_triggeredKeysForSelfObject, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_16392.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("  [self\n"
        "    removeObserver:self\n"
        "    forKeyPath:@\"").operator_concat (enumerator_16392.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (440)).operator_concat (GALGAS_string ("\"\n"
        "  ] ;\n") COMMA_SOURCE_FILE_AT_LINE (440)) COMMA_SOURCE_FILE_AT_LINE (437)) ;
      enumerator_16392.gotoNextObject () ;
    }
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("}\n"
      "\n"
    ...
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string (" ") COMMA_SOURCE_FILE_AT_LINE (451)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForOtherObjects enumerator_17016 (var_triggeredKeysFromOtherObjects, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_17016.hasCurrentObject ()) {
      //-------- @foreachInstructionForGeneration
      cEnumerator__32_stringlist enumerator_17058 (enumerator_17016.current (HERE).mAttribute_mList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_17058.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string (" if ((inObject == ").operator_concat (enumerator_17016.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (457)).operator_concat (GALGAS_string (") && [inKeyPath isEqualToString:@\"") COMMA_SOURCE_FILE_AT_LINE (457)).operator_concat (enumerator_17058.current (HERE).mAttribute_mValue_30_ COMMA_SOURCE_FILE_AT_LINE (457)).operator_concat (GALGAS_string ("\"]) {\n"
          "    ") COMMA_SOURCE_FILE_AT_LINE (457)).operator_concat (enumerator_17058.current (HERE).mAttribute_mValue_31_ COMMA_SOURCE_FILE_AT_LINE (458)).operator_concat (GALGAS_string ("__computed = NO ;\n"
          "    [PMTransientDependancyManager\n"
          "      enterTriggerForObject:self\n"
          "      transientIndex:") COMMA_SOURCE_FILE_AT_LINE (458)).operator_concat (var_fullPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (461)).operator_concat (enumerator_17058.current (HERE).mAttribute_mValue_31_ COMMA_SOURCE_FILE_AT_LINE (461)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (461)) COMMA_SOURCE_FILE_AT_LINE (461)).operator_concat (GALGAS_string ("\n"
          "    ] ;\n"
          "  }else") COMMA_SOURCE_FILE_AT_LINE (461)) COMMA_SOURCE_FILE_AT_LINE (456)) ;
        enumerator_17058.gotoNextObject () ;
      }
      enumerator_17016.gotoNextObject () ;
    }
    //-------- @foreachInstructionForGeneration
    cEnumerator_triggeredKeysForSelfObject enumerator_17561 (var_triggeredKeysForSelfObject, kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_17561.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string (" if ([inKeyPath isEqualToString:@\"").operator_concat (enumerator_17561.current (HERE).mAttribute_key COMMA_SOURCE_FILE_AT_LINE (468)).operator_concat (GALGAS_string ("\"]) {\n") COMMA_SOURCE_FILE_AT_LINE (468)) COMMA_SOURCE_FILE_AT_LINE (468)) ;
      //-------- @foreachInstructionForGeneration
      cEnumerator_stringlist enumerator_17684 (enumerator_17561.current (HERE).mAttribute_mList, kEnumeration_up) ;
      //--- simple foreach instruction
      while (enumerator_17684.hasCurrentObject ()) {
        //-------- @concatInstructionForGeneration
        result_outResult.dotAssign_operation (GALGAS_string ("    ").operator_concat (enumerator_17684.current (HERE).mAttribute_mValue.reader_pathExtension (SOURCE_FILE_AT_LINE (471)) COMMA_SOURCE_FILE_AT_LINE (471)).operator_concat (GALGAS_string ("__computed = NO ;\n"
          "    [PMTransientDependancyManager\n"
          "      enterTriggerForObject:self\n"
          "      transientIndex:") COMMA_SOURCE_FILE_AT_LINE (471)).operator_concat (enumerator_17684.current (HERE).mAttribute_mValue.reader_identifierRepresentation (SOURCE_FILE_AT_LINE (474)) COMMA_SOURCE_FILE_AT_LINE (474)).operator_concat (GALGAS_string ("\n"
          "    ] ;\n"
          "  }else") COMMA_SOURCE_FILE_AT_LINE (474)) COMMA_SOURCE_FILE_AT_LINE (470)) ;
  ...
  //-------- @concatInstructionForGeneration
  result_outResult.dotAssign_operation (function_generateTransientCacheRoutine (constinArgument_inKindName, constinArgument_inTransientListForImplementation, inCompiler COMMA_SOURCE_FILE_AT_LINE (491)) COMMA_SOURCE_FILE_AT_LINE (491)) ;
//---
  return result_outResult ;
}
...
GALGAS_string function_generateTransientTriggering (const GALGAS_string & constinArgument_inPropertyName,
  ...
  if (constinArgument_inTransientListForImplementation.reader_length (SOURCE_FILE_AT_LINE (560)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (560)).isValid ()) {
    PMUInt32 variant_20769 = constinArgument_inTransientListForImplementation.reader_length (SOURCE_FILE_AT_LINE (560)).add_operation (GALGAS_uint ((PMUInt32) 1U), inCompiler COMMA_SOURCE_FILE_AT_LINE (560)).uintValue () ;
    bool loop_20769 = true ;
    while (loop_20769) {
      loop_20769 = var_looping.isValid () ;
      if (loop_20769) {
        loop_20769 = var_looping.boolValue () ;
      }
      if (loop_20769 && (0 == variant_20769)) {
        loop_20769 = false ;
      ...
      if (loop_20769) {
        ...
        //-------- @foreachInstructionForGeneration
        cEnumerator_transientListForImplementation enumerator_20901 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
        //--- simple foreach instruction
        while (enumerator_20901.hasCurrentObject ()) {
          //-------- @foreachInstructionForGeneration
          cEnumerator_directDependancyList enumerator_20934 (enumerator_20901.current_mDependencyList (HERE), kEnumeration_up) ;
          //--- simple foreach instruction
          while (enumerator_20934.hasCurrentObject ()) {
            //-------- @ifInstructionForGeneration
            const enumGalgasBool test_0 = var_registeredTransientSet.reader_hasKey (enumerator_20901.current_mTransientName (HERE) COMMA_SOURCE_FILE_AT_LINE (564)).operator_not (SOURCE_FILE_AT_LINE (564)).boolEnum () ;
            if (kBoolTrue == test_0) {
              //-------- @methodCallInstructionForGeneration
              callCategoryMethod_generateTransientTriggerFromSelfAttribute ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_20934.current_mDependency (HERE).ptr (), constinArgument_inPrefix, constinArgument_inClassName, enumerator_20901.current_mTransientName (HERE), var_masterSet, var_registeredTransientSet, var_looping, result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (565)) ;
              //-------- END @methodCallInstructionForGeneration
            }
...
GALGAS_string function_generateAddObserverForTransients (const GALGAS_transientListForImplementation & constinArgument_inTransientListForImplementation,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_22546 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_22546.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_22577 (enumerator_22546.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_22577.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateAddObserverForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_22577.current_mDependency (HERE).ptr (), constinArgument_inLeadingSpaces, result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (616)) ;
      //-------- END @methodCallInstructionForGeneration
...
GALGAS_string function_generateRemoveObserverForTransients (const GALGAS_transientListForImplementation & constinArgument_inTransientListForImplementation,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_23808 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_23808.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_23839 (enumerator_23808.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_23839.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateRemoveObserverForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_23839.current_mDependency (HERE).ptr (), result_outResult, inCompiler COMMA_SOURCE_FILE_AT_LINE (656)) ;
      //-------- END @methodCallInstructionForGeneration
...
GALGAS_string function_generateObserverRoutinesForTransient (const GALGAS_string & constinArgument_inKindName,
  ...
  result_outResult = GALGAS_string::makeEmptyString () ;
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_observerListMap var_observerListMap = GALGAS_observerListMap::constructor_emptyMap (SOURCE_FILE_AT_LINE (702)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_transientListForImplementation enumerator_25425 (constinArgument_inTransientListForImplementation, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_25425.hasCurrentObject ()) {
    //-------- @foreachInstructionForGeneration
    cEnumerator_directDependancyList enumerator_25456 (enumerator_25425.current_mDependencyList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_25456.hasCurrentObject ()) {
      //-------- @methodCallInstructionForGeneration
      callCategoryMethod_generateObserverRoutineForTransient ((const cPtr_abstractTransientDependencyForImplementation *) enumerator_25456.current_mDependency (HERE).ptr (), enumerator_25425.current_mTransientName (HERE), var_observerListMap, inCompiler COMMA_SOURCE_FILE_AT_LINE (705)) ;
      //-------- END @methodCallInstructionForGeneration
      enumerator_25456.gotoNextObject () ;
    }
    enumerator_25425.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_fullPrefix = constinArgument_inPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (712)).operator_concat (constinArgument_inKindName COMMA_SOURCE_FILE_AT_LINE (712)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (712)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_observerListMap enumerator_25705 (var_observerListMap, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_25705.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    result_outResult.dotAssign_operation (GALGAS_string ("//----------------------------------------------------------------------------*\n"
      "//  ").operator_concat (enumerator_25705.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (716)).operator_concat (GALGAS_string ("_didChange   *\n"
      "//----------------------------------------------------------------------------*\n"
      "\n"
      "- (void) ") COMMA_SOURCE_FILE_AT_LINE (716)).operator_concat (enumerator_25705.current_key (HERE) COMMA_SOURCE_FILE_AT_LINE (718)).operator_concat (GALGAS_string ("_didChange {\n") COMMA_SOURCE_FILE_AT_LINE (718)) COMMA_SOURCE_FILE_AT_LINE (714)) ;
    //-------- @foreachInstructionForGeneration
    cEnumerator_stringlist enumerator_26002 (enumerator_25705.current_mList (HERE), kEnumeration_up) ;
    //--- simple foreach instruction
    while (enumerator_26002.hasCurrentObject ()) {
      //-------- @concatInstructionForGeneration
      result_outResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (enumerator_26002.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (721)).operator_concat (GALGAS_string (" transient'\n"
        "  if (") COMMA_SOURCE_FILE_AT_LINE (721)).operator_concat (enumerator_26002.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (722)).operator_concat (GALGAS_string ("__computed) {\n"
        "    ") COMMA_SOURCE_FILE_AT_LINE (722)).operator_concat (enumerator_26002.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (723)).operator_concat (GALGAS_string ("__computed = NO ;\n"
        "    [PMTransientDependancyManager\n"
        "      enterTriggerForObject:self\n"
        "      transientIndex:") COMMA_SOURCE_FILE_AT_LINE (723)).operator_concat (var_fullPrefix.operator_concat (enumerator_26002.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (726)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (726)) COMMA_SOURCE_FILE_AT_LINE (726)).operator_concat (GALGAS_string ("\n"
        "    ] ;\n"
        "  }\n") COMMA_SOURCE_FILE_AT_LINE (726)) COMMA_SOURCE_FILE_AT_LINE (720)) ;
...
void routine_generateTransientDependencyFiles (const GALGAS__32_stringlist constinArgument_inTransientDependencyArcList,
  ...
  //-------- @localVariableOrConstantDeclarationWithConstructorCallForGeneration
  GALGAS_stringset var_dependentSet = GALGAS_stringset::constructor_emptySet (SOURCE_FILE_AT_LINE (760)) ;
  //-------- @foreachInstructionForGeneration
  cEnumerator__32_stringlist enumerator_27341 (constinArgument_inTransientDependencyArcList, kEnumeration_up) ;
  //--- simple foreach instruction
  while (enumerator_27341.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_graphString.dotAssign_operation (GALGAS_string ("// ").operator_concat (enumerator_27341.current_mValue_30_ (HERE) COMMA_SOURCE_FILE_AT_LINE (762)).operator_concat (GALGAS_string (" -> ") COMMA_SOURCE_FILE_AT_LINE (762)).operator_concat (enumerator_27341.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (762)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (762)) COMMA_SOURCE_FILE_AT_LINE (762)) ;
    //-------- @plusEqualnstructionForGeneration
    var_dependentSet.addAssign_operation (enumerator_27341.current_mValue_31_ (HERE) COMMA_SOURCE_FILE_AT_LINE (763)) ;
    enumerator_27341.gotoNextObject () ;
  }
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_transientOrderedList = GALGAS_string::makeEmptyString () ;
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_27538 (constinArgument_inSortedTransientOrderedList, kEnumeration_down) ;
  //--- simple foreach instruction
  while (enumerator_27538.hasCurrentObject ()) {
    //-------- @concatInstructionForGeneration
    var_transientOrderedList.dotAssign_operation (GALGAS_string ("// ").operator_concat (enumerator_27538.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (767)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (767)) COMMA_SOURCE_FILE_AT_LINE (767)) ;
  ...
  //-------- @foreachInstructionForGeneration
  cEnumerator_stringlist enumerator_27746 (constinArgument_inSortedTransientOrderedList, kEnumeration_down) ;
  //--- simple foreach instruction
  while (enumerator_27746.hasCurrentObject ()) {
    //-------- @ifInstructionForGeneration
    const enumGalgasBool test_0 = var_dependentSet.reader_hasKey (enumerator_27746.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (773)).boolEnum () ;
    if (kBoolTrue == test_0) {
      //-------- @concatInstructionForGeneration
      var_transientIndexesString.dotAssign_operation (GALGAS_string ("#define ").operator_concat (enumerator_27746.current_mValue (HERE).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (774)) COMMA_SOURCE_FILE_AT_LINE (774)).operator_concat (GALGAS_string (" (") COMMA_SOURCE_FILE_AT_LINE (774)).operator_concat (var_idx.reader_string (SOURCE_FILE_AT_LINE (774)) COMMA_SOURCE_FILE_AT_LINE (774)).operator_concat (GALGAS_string (")\n") COMMA_SOURCE_FILE_AT_LINE (774)) COMMA_SOURCE_FILE_AT_LINE (774)) ;
      //-------- @concatInstructionForGeneration
      var_transientList.dotAssign_operation (GALGAS_string ("      @").operator_concat (enumerator_27746.current_mValue (HERE).reader_pathExtension (SOURCE_FILE_AT_LINE (775)).reader_utf_38_Representation (SOURCE_FILE_AT_LINE (775)) COMMA_SOURCE_FILE_AT_LINE (775)).operator_concat (GALGAS_string (", // ") COMMA_SOURCE_FILE_AT_LINE (775)).operator_concat (enumerator_27746.current_mValue (HERE) COMMA_SOURCE_FILE_AT_LINE (775)).operator_concat (GALGAS_string ("\n") COMMA_SOURCE_FILE_AT_LINE (775)) COMMA_SOURCE_FILE_AT_LINE (775)) ;
      //-------- @incrementInstructionForGeneration
      var_idx.increment_operation (inCompiler COMMA_SOURCE_FILE_AT_LINE (776)) ;
    }
  ...
  //-------- @localVariableOrConstantDeclarationWithSourceExpressionForGeneration
  GALGAS_string var_s = GALGAS_string (filewrapperTemplate_transientManager_managerDeclaration (inCompiler, var_graphString, var_transientOrderedList, var_transientIndexesString, var_transientCount COMMA_SOURCE_FILE_AT_LINE (781))) ;
  ...
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inSourceDirectoryPath, GALGAS_string ("PMTransientDependancyManager.h"), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_s, GALGAS_string ("\n"
    "\n"), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (787)) ;
  } //-------- @routineCallInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  var_s = GALGAS_string (filewrapperTemplate_transientManager_managerImplementation (inCompiler, var_transientList COMMA_SOURCE_FILE_AT_LINE (797))) ;
  { //-------- @typeMethodInstructionForGeneration
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inSourceDirectoryPath, GALGAS_string ("PMTransientDependancyManager.m"), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_s, GALGAS_string ("\n"
    "\n"), GALGAS_string::makeEmptyString (), inCompiler COMMA_SOURCE_FILE_AT_LINE (800)) ;
  } //-------- @routineCallInstructionForGeneration
}
...
static GALGAS_string categoryReader_transientDependencyFromSelfForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (130)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (130)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (130)) COMMA_SOURCE_FILE_AT_LINE (130)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromPreferenceForImplementation_generateFormalArgument (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  //-------- @assignmentInstructionForGeneration
  result_outResult = categoryReader_ocTypeName (object->mAttribute_mMasterAttributeType, inCompiler COMMA_SOURCE_FILE_AT_LINE (138)).operator_concat (GALGAS_string (" in") COMMA_SOURCE_FILE_AT_LINE (138)).operator_concat (object->mAttribute_mMasterAttributeName.reader_stringByCapitalizingFirstCharacter (SOURCE_FILE_AT_LINE (138)) COMMA_SOURCE_FILE_AT_LINE (138)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromSelfForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromSelfForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("self.").operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (152)) ;
//---
  return result_outResult ;
}
...
static GALGAS_string categoryReader_transientDependencyFromPreferenceForImplementation_generateMasterAttributeCall (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @assignmentInstructionForGeneration
  result_outResult = GALGAS_string ("g_").operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (160)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (160)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (160)) ;
//---
  return result_outResult ;
}
...
//--- Find method
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inTransientName, constin_inLocalObservablePropertyMap, constin_inPreferencesMap, constin_inObervationDependencyPrefix, io_ioImplementationFileInclusionSet, io_ioTransientDependencyGraph, out_outImplementation, inCompiler COMMA_THERE) ;
    }
  }
}
...
static void categoryMethod_transientLocalDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_bool joker_7501_0 ; // Joker input parameter
  constinArgument_inLocalObservablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, joker_7501_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (206)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (object->mAttribute_mMasterName.reader_string (SOURCE_FILE_AT_LINE (213)) COMMA_SOURCE_FILE_AT_LINE (213)), object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (213)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (214)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (214)) COMMA_SOURCE_FILE_AT_LINE (212)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromSelfForImplementation::constructor_new (object->mAttribute_mMasterName.mAttribute_string, var_masterType COMMA_SOURCE_FILE_AT_LINE (217)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientPreferenceDependency_analyze (const cPtr_abstractTransientDependency * inObject,
  ...
  //-------- @methodCallInstructionForGeneration
  GALGAS_attributeListForImplementation joker_8417_4 ; // Joker input parameter
  GALGAS_transientListForImplementation joker_8417_3 ; // Joker input parameter
  GALGAS_outletGenerationList joker_8417_2 ; // Joker input parameter
  GALGAS_lstringlist joker_8417_1 ; // Joker input parameter
  GALGAS_stringset joker_8467_0 ; // Joker input parameter
  constinArgument_inPreferencesMap.method_searchKey (object->mAttribute_mPreferencesName, joker_8417_4, joker_8417_3, joker_8417_2, joker_8417_1, var_observablePropertyMap, joker_8467_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (231)) ;
  //-------- END @methodCallInstructionForGeneration
  //-------- @localVariableDeclarationForGeneration
  GALGAS_easyBindingType var_masterType ;
  //-------- @localVariableDeclarationForGeneration
  ...
  //-------- @methodCallInstructionForGeneration
  var_observablePropertyMap.method_searchKey (object->mAttribute_mMasterName, var_masterType, var_isTransient, inCompiler COMMA_SOURCE_FILE_AT_LINE (232)) ;
  //-------- END @methodCallInstructionForGeneration
  { //-------- @modifierCallInstructionForGeneration
  ioArgument_ioTransientDependencyGraph.modifier_addArc (GALGAS_lstring::constructor_new (GALGAS_string ("preference.").operator_concat (object->mAttribute_mPreferencesName.reader_string (SOURCE_FILE_AT_LINE (239)) COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (239)).operator_concat (object->mAttribute_mMasterName.reader_string (SOURCE_FILE_AT_LINE (239)) COMMA_SOURCE_FILE_AT_LINE (239)), object->mAttribute_mMasterName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (239)), GALGAS_lstring::constructor_new (constinArgument_inObervationDependencyPrefix.operator_concat (constinArgument_inTransientName.reader_string (SOURCE_FILE_AT_LINE (240)) COMMA_SOURCE_FILE_AT_LINE (240)), constinArgument_inTransientName.mAttribute_location COMMA_SOURCE_FILE_AT_LINE (240)) COMMA_SOURCE_FILE_AT_LINE (238)) ;
  } //-------- END @typeMethodInstructionForGeneration
  //-------- @plusEqualnstructionForGeneration
  ioArgument_ioImplementationFileInclusionSet.addAssign_operation (object->mAttribute_mPreferencesName.mAttribute_string COMMA_SOURCE_FILE_AT_LINE (243)) ;
  //-------- @assignmentInstructionForGeneration
  outArgument_outImplementation = GALGAS_transientDependencyFromPreferenceForImplementation::constructor_new (object->mAttribute_mPreferencesName.mAttribute_string, object->mAttribute_mMasterName.mAttribute_string, var_isTransient, var_masterType COMMA_SOURCE_FILE_AT_LINE (245)) ;
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromSelfForImplementation_generateTransientTriggerFromSelfAttribute (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromSelfForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = ioArgument_ioMasterAttributeSet.reader_hasKey (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (517)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioMasterAttributeSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (518)) ;
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioRegisteredTransientSet.addAssign_operation (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (519)) ;
    //-------- @assignmentInstructionForGeneration
    ioArgument_ioContinue = GALGAS_bool (true) ;
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  //--- Trigger '").operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (522)).operator_concat (GALGAS_string (" transient'\n"
      "    if (") COMMA_SOURCE_FILE_AT_LINE (522)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (523)).operator_concat (GALGAS_string ("__computed) {\n"
      "      ") COMMA_SOURCE_FILE_AT_LINE (523)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (524)).operator_concat (GALGAS_string ("__computed = NO ;\n"
      "      [PMTransientDependancyManager\n"
      "        enterTriggerForObject:self\n"
      "        transientIndex:") COMMA_SOURCE_FILE_AT_LINE (524)).operator_concat (constinArgument_inPrefix.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (527)).operator_concat (constinArgument_inClassName COMMA_SOURCE_FILE_AT_LINE (527)).operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (527)).operator_concat (constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (527)).reader_identifierRepresentation (SOURCE_FILE_AT_LINE (527)) COMMA_SOURCE_FILE_AT_LINE (527)).operator_concat (GALGAS_string ("\n"
      "      ] ;\n"
      "    }\n") COMMA_SOURCE_FILE_AT_LINE (527)) COMMA_SOURCE_FILE_AT_LINE (521)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateAddObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mMasterIsTransient.operator_not (SOURCE_FILE_AT_LINE (601)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (constinArgument_inLeadingSpaces.operator_concat (GALGAS_string ("  [g_") COMMA_SOURCE_FILE_AT_LINE (602)).operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (602)).operator_concat (GALGAS_string (" addObserverOf_") COMMA_SOURCE_FILE_AT_LINE (602)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (602)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (602)) COMMA_SOURCE_FILE_AT_LINE (602)) ;
  }
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateRemoveObserverForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_transientDependencyFromPreferenceForImplementation) ;
  //-------- @ifInstructionForGeneration
  const enumGalgasBool test_0 = object->mAttribute_mMasterIsTransient.operator_not (SOURCE_FILE_AT_LINE (642)).boolEnum () ;
  if (kBoolTrue == test_0) {
    //-------- @concatInstructionForGeneration
    ioArgument_ioResult.dotAssign_operation (GALGAS_string ("  [g_").operator_concat (object->mAttribute_mPreferenceName COMMA_SOURCE_FILE_AT_LINE (643)).operator_concat (GALGAS_string (" removeObserverOf_") COMMA_SOURCE_FILE_AT_LINE (643)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (643)).operator_concat (GALGAS_string (":self] ;\n") COMMA_SOURCE_FILE_AT_LINE (643)) COMMA_SOURCE_FILE_AT_LINE (643)) ;
  }
}
//---------------------------------------------------------------------------*
...
void callCategoryMethod_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
                                                             const GALGAS_string constin_inTransientName,
                                                             GALGAS_observerListMap & io_ioObserverListMap,
                                                             C_Compiler * inCompiler
                                                             COMMA_LOCATION_ARGS) {
//--- Drop output arguments
//--- Find method
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inTransientName, io_ioObserverListMap, inCompiler COMMA_THERE) ;
    }
  }
}
...
static void categoryMethod_transientDependencyFromSelfForImplementation_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * /* inObject */,
                                                                                                             const GALGAS_string /* constinArgument_inTransientName */,
                                                                                                             GALGAS_observerListMap & /* ioArgument_ioObserverListMap */,
                                                                                                             C_Compiler * /* inCompiler */
                                                                                                             COMMA_UNUSED_LOCATION_ARGS) {
}
//---------------------------------------------------------------------------*
...
static void categoryMethod_transientDependencyFromPreferenceForImplementation_generateObserverRoutineForTransient (const cPtr_abstractTransientDependencyForImplementation * inObject,
  ...
  if (kBoolTrue == test_0) {
    //-------- @plusEqualnstructionForGeneration
    ioArgument_ioObserverListMap.addAssign_operation (object->mAttribute_mPreferenceName.operator_concat (GALGAS_string ("_") COMMA_SOURCE_FILE_AT_LINE (689)).operator_concat (object->mAttribute_mMasterAttributeName COMMA_SOURCE_FILE_AT_LINE (689)), constinArgument_inTransientName COMMA_SOURCE_FILE_AT_LINE (689)) ;
  }
}
//---------------------------------------------------------------------------*
...
GALGAS_observablePropertyMap_2E_element GALGAS_observablePropertyMap_2E_element::constructor_new (const GALGAS_lstring & inOperand0,
  ...
  if (inOperand0.isValid () && inOperand1.isValid () && inOperand2.isValid ()) {
    result = GALGAS_observablePropertyMap_2E_element (inOperand0, inOperand1, inOperand2) ;
  }
  return result ;
}
