...
//                                         september 16th, 2014, at 11h18'44"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
void routine_generateEnums (const GALGAS_enumListForGeneration constinArgument_inEnumListForGeneration,
  ...
  while (enumerator_787.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_0) {
      ...
      {
      GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, enumerator_787.current_mEnumName (HERE).operator_concat (GALGAS_string (".swift")  COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 37)), var_s, inCompiler COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 35)) ;
      }
    }
