...
//                                         september 4th, 2014, at 18h16'14"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_enumGenerationTemplate_enumGenerationInSwift (C_Compiler * inCompiler,
  ...
  result << in_ENUM_5F_TYPE_5F_NAME.stringValue () ;
  result << "." ;
  result << in_CONSTANT_5F_ORDERED_5F_LIST.reader_mValueAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE ("enum.swift.gTemplate", 44)).mAttribute_string.stringValue () ;
  result << "\n"
    "    if v != nil {\n"
    "      let e : " ;
  result << in_ENUM_5F_TYPE_5F_NAME.stringValue () ;
...
void routine_generateEnums (const GALGAS_enumListForGeneration constinArgument_inEnumListForGeneration,
  ...
  while (enumerator_787.hasCurrentObject ()) {
    const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, enumerator_787.current_mEnumConstantList (HERE).reader_length (SOURCE_FILE ("enumGeneration.gSemantics", 30)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
    if (kBoolTrue == test_0) {
      GALGAS_string var_s = GALGAS_string (filewrapperTemplate_enumGenerationTemplate_enumGenerationInSwift (inCompiler, enumerator_787.current_mEnumName (HERE), enumerator_787.current_mEnumConstantList (HERE) COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 31))) ;
      {
      GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, enumerator_787.current_mEnumName (HERE).operator_concat (GALGAS_string (".swift")  COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 37)), GALGAS_string ("//"), GALGAS_string ("\n"
        "\n"), var_s, GALGAS_string ("\n"
        "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 35)) ;
      }
    }
