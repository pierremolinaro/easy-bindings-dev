...
GALGAS_string filewrapperTemplate_enumGenerationTemplate_enumGenerationInSwift (C_Compiler * inCompiler,
  ...
  if (in_CONSTANT_5F_ORDERED_5F_LIST.isValid ()) {
    ...
    while (enumerator_175.hasCurrentObject ()) {
      ...
      result << enumerator_175.current_mValue (HERE).mAttribute_string.stringValue () ;
      result << " = " ;
      result << index_175_idx.reader_string (SOURCE_FILE ("enum.swift.gTemplate", 9)).stringValue () ;
      result << "\n" ;
  ...
  if (in_CONSTANT_5F_ORDERED_5F_LIST.isValid ()) {
    ...
    while (enumerator_326.hasCurrentObject ()) {
      ...
      result << enumerator_326.current_mValue (HERE).mAttribute_string.stringValue () ;
      result << "\" // " ;
      result << index_326_idx.reader_string (SOURCE_FILE ("enum.swift.gTemplate", 17)).stringValue () ;
      result << "\n" ;
...
static void categoryMethod_enumTypeGeneration_generate (const cPtr_generation * inObject,
  ...
  if (kBoolTrue == test_0) {
    GALGAS_string var_s = GALGAS_string (filewrapperTemplate_enumGenerationTemplate_enumGenerationInSwift (inCompiler, object->mAttribute_mGenerationName, object->mAttribute_mConstantOrderedList COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 30))) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, object->mAttribute_mGenerationName.operator_concat (GALGAS_string (".swift")  COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 36)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_s, GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 34)) ;
    }
  }else if (kBoolFalse == test_0) {
    GALGAS_string var_s = GALGAS_string (filewrapperTemplate_enumGenerationTemplate_enumDeclaration (inCompiler, object->mAttribute_mGenerationName, object->mAttribute_mConstantOrderedList COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 44))) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, object->mAttribute_mGenerationName.operator_concat (GALGAS_string (".h")  COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 50)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_s, GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 48)) ;
    }
    var_s = GALGAS_string (filewrapperTemplate_enumGenerationTemplate_enumGeneration (inCompiler, object->mAttribute_mGenerationName, object->mAttribute_mConstantOrderedList COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 57))) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, object->mAttribute_mGenerationName.operator_concat (GALGAS_string (".m")  COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 63)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_s, GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 61)) ;
    }
  }
}
//-----------------------------------------------------------------------------*
