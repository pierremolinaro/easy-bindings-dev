...
static void categoryMethod_enumTypeGeneration_generate (const cPtr_generation * inObject,
  ...
  GALGAS_string var_s = GALGAS_string (filewrapperTemplate_enumGenerationTemplate_enumGenerationInSwift (inCompiler, object->mAttribute_mGenerationName, object->mAttribute_mConstantOrderedList COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 21))) ;
  {
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, object->mAttribute_mGenerationName.operator_concat (GALGAS_string (".swift")  COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 27)), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_s, GALGAS_string ("\n"
    "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("enumGeneration.gSemantics", 25)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
