...
GALGAS_string filewrapperTemplate_enumGenerationTemplate_enumGenerationInSwift (C_Compiler * inCompiler,
  ...
  result << "\n"
    ...
    "  func string () -> String {\n"
    "    switch self {\n" ;
  GALGAS_uint index_334_idx (0) ;
  if (in_CONSTANT_5F_ORDERED_5F_LIST.isValid ()) {
    cEnumerator_lstringlist enumerator_334 (in_CONSTANT_5F_ORDERED_5F_LIST, kEnumeration_up) ;
    while (enumerator_334.hasCurrentObject ()) {
      result << "      case " ;
      result << enumerator_334.current_mValue (HERE).mAttribute_string.stringValue () ;
      result << " : return \"" ;
      result << enumerator_334.current_mValue (HERE).mAttribute_string.stringValue () ;
      result << "\" // " ;
      result << index_334_idx.reader_string (SOURCE_FILE_AT_LINE (17)).stringValue () ;
      result << "\n" ;
      index_334_idx.increment () ;
  ...
  result << "    }\n"
    ...
    "                                 inDictionary : NSMutableDictionary) -> " ;
  result << in_ENUM_5F_TYPE_5F_NAME.stringValue () ;
  result << " {\n"
  ...
  result << in_ENUM_5F_TYPE_5F_NAME.stringValue () ;
  result << "." ;
  result << in_CONSTANT_5F_ORDERED_5F_LIST.reader_mValueAtIndex (GALGAS_uint ((uint32_t) 0U), inCompiler COMMA_SOURCE_FILE_AT_LINE (38)).mAttribute_string.stringValue () ;
  result << "\n"
    "    }\n"
    "  }\n"
    "}\n"
