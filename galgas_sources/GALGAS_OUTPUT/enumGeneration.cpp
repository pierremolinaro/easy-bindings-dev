...
static void categoryMethod_enumTypeGeneration_generate (const cPtr_generation * inObject,
  ...
  macroValidSharedObject (object, const cPtr_enumTypeGeneration) ;
  GALGAS_string var_s = GALGAS_string (filewrapperTemplate_enumGenerationTemplate_enumDeclaration (inCompiler, object->mAttribute_mGenerationName, object->mAttribute_mConstantOrderedList COMMA_SOURCE_FILE_AT_LINE (25))) ;
  {
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, object->mAttribute_mGenerationName.operator_concat (GALGAS_string (".h") COMMA_SOURCE_FILE_AT_LINE (31)), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_s, GALGAS_string ("\n"
    "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE_AT_LINE (29)) ;
  }
  var_s = GALGAS_string (filewrapperTemplate_enumGenerationTemplate_enumGeneration (inCompiler, object->mAttribute_mGenerationName, object->mAttribute_mConstantOrderedList COMMA_SOURCE_FILE_AT_LINE (38))) ;
  {
  GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, object->mAttribute_mGenerationName.operator_concat (GALGAS_string (".m") COMMA_SOURCE_FILE_AT_LINE (44)), GALGAS_string ("//"), GALGAS_string ("\n"
    "\n"), var_s, GALGAS_string ("\n"
