...
static const BOOL kEndOfScriptInTemplateArray_easyBindings_5F_lexique [62] = {
  NO /* identifier */,
  NO /* Identifier */,
  NO /* binding */,
  NO /* literal_integer */,
...
static const C_cocoa_lexique_table_entry ktable_for_easyBindings_5F_lexique_bindingKeyWordList [4] = {
...
static SInt32 search_into_easyBindings_5F_lexique_bindingKeyWordList (NSString * inSearchedString) {
  return searchStringInTable (inSearchedString, ktable_for_easyBindings_5F_lexique_bindingKeyWordList, 4) ;
}
...
- (UInt32) styleIndexForTerminal: (SInt32) inTerminal {
  static const UInt32 kTerminalSymbolStyles [63] = {0,
