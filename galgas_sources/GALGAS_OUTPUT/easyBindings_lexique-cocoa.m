...
static const BOOL kEndOfScriptInTemplateArray_easyBindings_5F_lexique [72] = {
  NO /* identifier */,
  NO /* Identifier */,
  NO /* binding */,
  NO /* literal_integer */,
...
- (NSUInteger) styleIndexForTerminal: (NSInteger) inTerminal {
  static const NSUInteger kTerminalSymbolStyles [73] = {0,
...
- (BOOL) atomicSelectionForToken: (NSUInteger) inTokenIndex {
  static const BOOL kTerminalAtomicSelection [73] = {NO,
