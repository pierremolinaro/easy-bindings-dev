...
//                                         september 5th, 2014, at 13h33'55"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_entityGenerationTemplate_entityImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_2367 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_2367.hasCurrentObject ()) {
      GALGAS_uint index_2396_ (0) ;
      if (enumerator_2367.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_2396 (enumerator_2367.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_2396.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependency *) enumerator_2396.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 55)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 55)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 55)).add_operation (enumerator_2367.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 55)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 55)).stringValue () ;
          result << ")\n" ;
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_3010 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_3010.hasCurrentObject ()) {
      GALGAS_uint index_3039_ (0) ;
      if (enumerator_3010.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_3039 (enumerator_3010.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_3039.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateRemoveObserverCall ((const cPtr_abstractTransientDependency *) enumerator_3039.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 69)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 69)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 69)).add_operation (enumerator_3010.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 69)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 69)).stringValue () ;
          result << ")\n" ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_3694 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_3694.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_3694.current_mAttributeName (HERE).stringValue () ;
      ...
      result << categoryReader_valueAccessorForExplorerWindow (enumerator_3694.current_mAttributeType (HERE), enumerator_3694.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 82)).stringValue () ;
      result << "\n"
        "    }\n" ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_4433 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_4433.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_4433.current_mAttributeName (HERE).stringValue () ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_5043 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_5043.hasCurrentObject ()) {
      result << "    ioDictionary.setValue (" ;
      result << categoryReader_transformForSavingInDictionary (enumerator_5043.current_mAttributeType (HERE), enumerator_5043.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 105)).stringValue () ;
      result << ", forKey: \"" ;
      result << enumerator_5043.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
  ...
  GALGAS_uint index_5808_ (0) ;
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_5808 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_5808.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_5808.current_mAttributeName (HERE).stringValue () ;
      result << " = inDictionary.read" ;
      result << categoryReader_swiftTypeName (enumerator_5808.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 117)).stringValue () ;
      result << " (\"" ;
      result << enumerator_5808.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
      index_5808_.increment () ;
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_5967 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_5967.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_5967.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 124)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("entity.swift.gTemplate", 124)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_5967.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  var " ;
      result << enumerator_5967.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_5967.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 127)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_5967.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_5967.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 128)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_5967.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      if (enumerator_5967.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_6631 (enumerator_5967.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_6631.hasCurrentObject ()) {
          result << callCategoryReader_generateForComputeFunction ((const cPtr_abstractTransientDependency *) enumerator_6631.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 133)).stringValue () ;
          if (enumerator_6631.hasNextObject ()) {
            result << ", " ;
          }
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 144)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 144)).add_operation (enumerator_5967.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 144)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 144)).stringValue () ;
      result << "_didChange () {\n"
        "    for anyObject in " ;
      result << enumerator_5967.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers {\n"
      ...
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 161)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 161)).add_operation (enumerator_5967.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 161)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 161)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 161)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 161)).add_operation (enumerator_5967.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 161)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 161)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 162)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 162)).add_operation (enumerator_5967.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 162)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 162)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 162)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 162)).add_operation (enumerator_5967.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 162)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 162)).stringValue () ;
      result << " {\n"
        "    if nil == triggerObjectFor_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 163)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 163)).add_operation (enumerator_5967.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 163)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 163)).stringValue () ;
      result << "_cache {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 164)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 164)).add_operation (enumerator_5967.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 164)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 164)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 164)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 164)).add_operation (enumerator_5967.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 164)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 164)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 166)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 166)).add_operation (enumerator_5967.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 166)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 166)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        " \n" ;
...
void routine_generateEntities (const GALGAS_entityListForGeneration constinArgument_inEntityListForGeneration,
                               ...
                               C_Compiler * inCompiler
                               COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_entityListForGeneration enumerator_1389 (constinArgument_inEntityListForGeneration, kEnumeration_up) ;
  while (enumerator_1389.hasCurrentObject ()) {
    GALGAS_string var_s = GALGAS_string (filewrapperTemplate_entityGenerationTemplate_entityImplementationInSwift (inCompiler, enumerator_1389.current_mEntityName (HERE), enumerator_1389.current_mAttributeListForGeneration (HERE), enumerator_1389.current_mDecoratedTransientMapForGeneration (HERE) COMMA_SOURCE_FILE ("entityGeneration.gSemantics", 43))) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, enumerator_1389.current_mEntityName (HERE).operator_concat (GALGAS_string (".swift")  COMMA_SOURCE_FILE ("entityGeneration.gSemantics", 60)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_s, GALGAS_string ("\n"
  ...
  if (kBoolTrue == test_0) {
    ...
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, GALGAS_string ("PMManagedDocument+extension+factory.swift"), var_s, inCompiler COMMA_SOURCE_FILE ("entityGeneration.gSemantics", 73)) ;
    }
  }
}
