...
//                                         september 3rd, 2014, at 22h10'31"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
static const cRegularFileWrapper * gWrapperAllFiles_entityGenerationTemplate_12 [1] = {
  NULL
} ;

//--- All sub-directories of 'swift-sources' directory

static const cDirectoryWrapper * gWrapperAllDirectories_entityGenerationTemplate_12 [1] = {
  NULL
} ;

//--- Directory 'swift-sources'

const cDirectoryWrapper gWrapperDirectory_12_entityGenerationTemplate (
  "swift-sources",
  0,
  gWrapperAllFiles_entityGenerationTemplate_12,
  0,
  gWrapperAllDirectories_entityGenerationTemplate_12
) ;
...
static const cDirectoryWrapper * gWrapperAllDirectories_entityGenerationTemplate_0 [13] = {
  ...
  & gWrapperDirectory_12_entityGenerationTemplate,
  NULL
} ;
...
GALGAS_string filewrapperTemplate_entityGenerationTemplate_entityImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    ...
    while (enumerator_242.hasCurrentObject ()) {
      ...
      result << enumerator_242.current_mAttributeName (HERE).stringValue () ;
      result << " (value : " ;
      result << categoryReader_swiftTypeName (enumerator_242.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 26)).stringValue () ;
      result << ") {\n"
        "    " ;
      result << enumerator_242.current_mAttributeName (HERE).stringValue () ;
      result << " = value\n"
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_2162 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_2162.hasCurrentObject ()) {
      GALGAS_uint index_2191_ (0) ;
      if (enumerator_2162.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_2191 (enumerator_2162.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_2191.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependency *) enumerator_2191.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 54)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 54)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 54)).add_operation (enumerator_2162.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 54)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 54)).stringValue () ;
          result << ")\n" ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_3369 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_3369.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_3369.current_mAttributeName (HERE).stringValue () ;
      ...
      result << categoryReader_valueAccessorForExplorerWindow (enumerator_3369.current_mAttributeType (HERE), enumerator_3369.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 77)).stringValue () ;
      result << "\n"
        "    }\n" ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_4108 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_4108.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_4108.current_mAttributeName (HERE).stringValue () ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_4718 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_4718.hasCurrentObject ()) {
      result << "    ioDictionary.setValue (" ;
      result << categoryReader_transformForSavingInDictionary (enumerator_4718.current_mAttributeType (HERE), enumerator_4718.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 100)).stringValue () ;
      result << ", forKey: \"" ;
      result << enumerator_4718.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_5483 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_5483.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_5483.current_mAttributeName (HERE).stringValue () ;
      result << " = inDictionary.read" ;
      result << categoryReader_swiftTypeName (enumerator_5483.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 112)).stringValue () ;
      result << " (\"" ;
      result << enumerator_5483.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_5642 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_5642.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_5642.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 119)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("entity.swift.gTemplate", 119)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_5642.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  var " ;
      result << enumerator_5642.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_5642.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 122)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_5642.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_5642.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 123)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_5642.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      result << enumerator_5642.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " (" ;
      GALGAS_uint index_6313_ (0) ;
      if (enumerator_5642.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_6313 (enumerator_5642.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_6313.hasCurrentObject ()) {
          result << callCategoryReader_generateForComputeFunction ((const cPtr_abstractTransientDependency *) enumerator_6313.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 128)).stringValue () ;
          if (enumerator_6313.hasNextObject ()) {
            result << ", " ;
          }
          index_6313_.increment () ;
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 139)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 139)).add_operation (enumerator_5642.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 139)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 139)).stringValue () ;
      result << "_didChange () {\n"
        "    for anyObject in " ;
      result << enumerator_5642.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers {\n"
      ...
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 156)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 156)).add_operation (enumerator_5642.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 156)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 156)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 156)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 156)).add_operation (enumerator_5642.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 156)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 156)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 157)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 157)).add_operation (enumerator_5642.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 157)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 157)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 157)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 157)).add_operation (enumerator_5642.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 157)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 157)).stringValue () ;
      result << " {\n"
        "    if nil == triggerObjectFor_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 158)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 158)).add_operation (enumerator_5642.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 158)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 158)).stringValue () ;
      result << "_cache {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 159)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 159)).add_operation (enumerator_5642.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 159)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 159)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 159)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 159)).add_operation (enumerator_5642.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 159)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 159)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 161)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 161)).add_operation (enumerator_5642.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 161)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 161)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        " \n" ;
