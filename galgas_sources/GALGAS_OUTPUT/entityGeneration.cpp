...
//                                         september 4th, 2014, at 11h31'24"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_entityGenerationTemplate_entityImplementationInSwift (C_Compiler * inCompiler,
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    ...
    while (enumerator_242.hasCurrentObject ()) {
      ...
      result << enumerator_242.current_mAttributeName (HERE).stringValue () ;
      result << " (value : " ;
      result << categoryReader_swiftTypeUndoArgument (enumerator_242.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 26)).stringValue () ;
      result << ") {\n"
        "    " ;
      result << enumerator_242.current_mAttributeName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_transformerForUndo (enumerator_242.current_mAttributeType (HERE), GALGAS_string ("value"), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 27)).stringValue () ;
      result << "\n"
        "  }\n"
        "\n"
        "  func addObserverOf_" ;
  ...
  GALGAS_uint index_2272_ (0) ;
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_2272 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_2272.hasCurrentObject ()) {
      GALGAS_uint index_2301_ (0) ;
      if (enumerator_2272.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_2301 (enumerator_2272.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_2301.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependency *) enumerator_2301.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 54)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 54)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 54)).add_operation (enumerator_2272.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 54)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 54)).stringValue () ;
          result << ")\n" ;
          index_2301_.increment () ;
          enumerator_2301.gotoNextObject () ;
        }
      }
      index_2272_.increment () ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_3479 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_3479.hasCurrentObject ()) {
      ...
      result << categoryReader_valueAccessorForExplorerWindow (enumerator_3479.current_mAttributeType (HERE), enumerator_3479.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 77)).stringValue () ;
      result << "\n"
        "    }\n" ;
  ...
  GALGAS_uint index_4218_ (0) ;
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_4218 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_4218.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_4218.current_mAttributeName (HERE).stringValue () ;
      result << "_explorer = nil\n" ;
      index_4218_.increment () ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_4828 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_4828.hasCurrentObject ()) {
      result << "    ioDictionary.setValue (" ;
      result << categoryReader_transformForSavingInDictionary (enumerator_4828.current_mAttributeType (HERE), enumerator_4828.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 100)).stringValue () ;
      result << ", forKey: \"" ;
      result << enumerator_4828.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
  ...
  GALGAS_uint index_5593_ (0) ;
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_5593 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_5593.hasCurrentObject ()) {
      result << "    " ;
      result << enumerator_5593.current_mAttributeName (HERE).stringValue () ;
      result << " = inDictionary.read" ;
      result << categoryReader_swiftTypeName (enumerator_5593.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 112)).stringValue () ;
      result << " (\"" ;
      result << enumerator_5593.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
      index_5593_.increment () ;
      enumerator_5593.gotoNextObject () ;
    }
  }
  result << "  }\n"
    "\n" ;
  GALGAS_uint index_5752_ (0) ;
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_5752 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_5752.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_5752.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 119)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("entity.swift.gTemplate", 119)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_5752.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  var " ;
      result << enumerator_5752.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_5752.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 122)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_5752.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_5752.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 123)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_5752.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      if (enumerator_5752.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_6423 (enumerator_5752.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_6423.hasCurrentObject ()) {
          result << callCategoryReader_generateForComputeFunction ((const cPtr_abstractTransientDependency *) enumerator_6423.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 128)).stringValue () ;
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 139)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 139)).add_operation (enumerator_5752.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 139)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 139)).stringValue () ;
      result << "_didChange () {\n"
        "    for anyObject in " ;
      result << enumerator_5752.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers {\n"
      ...
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 156)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 156)).add_operation (enumerator_5752.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 156)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 156)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 156)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 156)).add_operation (enumerator_5752.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 156)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 156)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 157)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 157)).add_operation (enumerator_5752.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 157)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 157)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 157)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 157)).add_operation (enumerator_5752.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 157)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 157)).stringValue () ;
      result << " {\n"
        "    if nil == triggerObjectFor_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 158)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 158)).add_operation (enumerator_5752.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 158)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 158)).stringValue () ;
      result << "_cache {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 159)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 159)).add_operation (enumerator_5752.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 159)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 159)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 159)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 159)).add_operation (enumerator_5752.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 159)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 159)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("entity.").add_operation (in_ENTITY_5F_NAME, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 161)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 161)).add_operation (enumerator_5752.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("entity.swift.gTemplate", 161)).reader_identifierRepresentation (SOURCE_FILE ("entity.swift.gTemplate", 161)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        " \n" ;
      index_5752_.increment () ;
...
void routine_generateEntities (const GALGAS_entityListForGeneration constinArgument_inEntityListForGeneration,
                               ...
                               C_Compiler * inCompiler
                               COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_entityListForGeneration enumerator_1238 (constinArgument_inEntityListForGeneration, kEnumeration_up) ;
  while (enumerator_1238.hasCurrentObject ()) {
    GALGAS_string var_s = GALGAS_string (filewrapperTemplate_entityGenerationTemplate_entityImplementationInSwift (inCompiler, enumerator_1238.current_mEntityName (HERE), enumerator_1238.current_mAttributeListForGeneration (HERE), enumerator_1238.current_mDecoratedTransientMapForGeneration (HERE) COMMA_SOURCE_FILE ("entityGeneration.gSemantics", 39))) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, enumerator_1238.current_mEntityName (HERE).operator_concat (GALGAS_string (".swift")  COMMA_SOURCE_FILE ("entityGeneration.gSemantics", 56)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_s, GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"), inCompiler COMMA_SOURCE_FILE ("entityGeneration.gSemantics", 54)) ;
    }
