...
static const cDirectoryWrapper * gWrapperAllDirectories_prefsGenerationTemplate_0 [13] = {
...
GALGAS_string filewrapperTemplate_prefsGenerationTemplate_preferencesInSwift (C_Compiler * inCompiler,
  ...
  if (in_CONTROLLER_5F_MAP.isValid ()) {
    cEnumerator_controllerMap enumerator_7539 (in_CONTROLLER_5F_MAP, kEnumeration_up) ;
    while (enumerator_7539.hasCurrentObject ()) {
      result << "//--- '" ;
      result << enumerator_7539.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "' controller\n" ;
      index_7539_.increment () ;
      enumerator_7539.gotoNextObject () ;
    }
  }
  GALGAS_uint index_7890_ (0) ;
  if (in_OUTLET_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_7890 (in_OUTLET_5F_MAP, kEnumeration_up) ;
    while (enumerator_7890.hasCurrentObject ()) {
      result << "  //--- Check " ;
      result << enumerator_7890.current_lkey (HERE).mAttribute_string.stringValue () ;
  ...
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.reader_length (SOURCE_FILE ("preferences.swift.gTemplate", 201)).add_operation (in_ARRAY_5F_MAP.reader_count (SOURCE_FILE ("preferences.swift.gTemplate", 201)), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 201)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    result << "    var ud = NSUserDefaults.standardUserDefaults ()\n" ;
  }else if (kBoolFalse == test_1) {
  }
  GALGAS_uint index_9209_ (0) ;
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_9209 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_9209.hasCurrentObject ()) {
      result << "    ud.setObject (" ;
      result << categoryReader_preferencesSwiftSetter (enumerator_9209.current_mAttributeType (HERE), enumerator_9209.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 205)).stringValue () ;
      result << ", forKey:\"" ;
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_9209.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
      index_9209_.increment () ;
      enumerator_9209.gotoNextObject () ;
    }
  }
  GALGAS_uint index_9366_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_9366 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_9366.hasCurrentObject ()) {
      result << "  { NSMutableArray * array = [NSMutableArray new] ;\n"
        "    for ( * object in self." ;
      result << enumerator_9366.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << ") {\n"
