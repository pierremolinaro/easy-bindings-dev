...
GALGAS_string filewrapperTemplate_prefsGenerationTemplate_preferencesInSwift (C_Compiler * inCompiler,
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    ...
    while (enumerator_2522.hasCurrentObject ()) {
      ...
      result << enumerator_2522.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " (" ;
      GALGAS_uint index_3184_ (0) ;
      if (enumerator_2522.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_3184 (enumerator_2522.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_3184.hasCurrentObject ()) {
          result << callCategoryReader_generateForComputeFunction ((const cPtr_abstractTransientDependency *) enumerator_3184.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 70)).stringValue () ;
          if (enumerator_3184.hasNextObject ()) {
            result << ", " ;
          }
      ...
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 98)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 98)).add_operation (enumerator_2522.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 98)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 98)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 98)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 98)).add_operation (enumerator_2522.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 98)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 98)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 99)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 99)).add_operation (enumerator_2522.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 99)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 99)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 99)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 99)).add_operation (enumerator_2522.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 99)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 99)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 100)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 100)).add_operation (enumerator_2522.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 100)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 100)).stringValue () ;
      result << "_cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (enumerator_2522.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 101)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (enumerator_2522.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 101)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
  ...
  result << "\n"
    ...
    "  //    Arraies                                                                                                        *\n"
    "  //-------------------------------------------------------------------------------------------------------------------*\n" ;
  GALGAS_uint index_5210_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_5210 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_5210.hasCurrentObject ()) {
      result << "  var " ;
      result << enumerator_5210.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " = NSMutableArray ()\n" ;
      index_5210_.increment () ;
  ...
  GALGAS_uint index_5975_ (0) ;
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_5975 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    const bool nonEmpty_enumerator_5975 = enumerator_5975.hasCurrentObject () ;
    if (nonEmpty_enumerator_5975) {
    ...
    while (enumerator_5975.hasCurrentObject ()) {
      ...
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_5975.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n"
        "    if value != nil {\n"
        "      " ;
      result << enumerator_5975.current_mAttributeName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_preferencesSwiftGetter (enumerator_5975.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 135)).stringValue () ;
      result << "\n"
        "    }\n" ;
      index_5975_.increment () ;
      enumerator_5975.gotoNextObject () ;
    }
  }
  GALGAS_uint index_6203_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_6203 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_6203.hasCurrentObject ()) {
      ...
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_6203.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "\"]) {\n"
        "         * object = [[ alloc]\n"
        "        ] ;\n"
  ...
  if (in_CONTROLLER_5F_MAP.isValid ()) {
    cEnumerator_controllerMap enumerator_7757 (in_CONTROLLER_5F_MAP, kEnumeration_up) ;
    while (enumerator_7757.hasCurrentObject ()) {
      result << "//--- '" ;
      result << enumerator_7757.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "' controller\n" ;
      index_7757_.increment () ;
      enumerator_7757.gotoNextObject () ;
    }
  }
  GALGAS_uint index_8109_ (0) ;
  if (in_OUTLET_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_8109 (in_OUTLET_5F_MAP, kEnumeration_up) ;
    while (enumerator_8109.hasCurrentObject ()) {
      result << "  //--- Check " ;
      result << enumerator_8109.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      result << "' outlet is nil\")\n"
        "    }\n" ;
      index_8109_.increment () ;
      enumerator_8109.gotoNextObject () ;
    }
  }
  GALGAS_uint index_8446_ (0) ;
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_8446 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_8446.hasCurrentObject ()) {
      GALGAS_uint index_8475_ (0) ;
      if (enumerator_8446.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_8475 (enumerator_8446.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_8475.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependency *) enumerator_8475.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 201)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 201)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 201)).add_operation (enumerator_8446.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 201)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 201)).stringValue () ;
          result << ")\n" ;
  ...
  if (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST.isValid ()) {
    cEnumerator_stringlist enumerator_8683 (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST, kEnumeration_up) ;
    while (enumerator_8683.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_8683.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_9761 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_9761.hasCurrentObject ()) {
      result << "    ud.setObject (" ;
      result << categoryReader_preferencesSwiftSetter (enumerator_9761.current_mAttributeType (HERE), enumerator_9761.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 227)).stringValue () ;
      result << ", forKey:\"" ;
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_9761.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
  ...
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_9920 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_9920.hasCurrentObject ()) {
      result << "  { NSMutableArray * array = [NSMutableArray new] ;\n"
        "    for ( * object in self." ;
      result << enumerator_9920.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << ") {\n"
