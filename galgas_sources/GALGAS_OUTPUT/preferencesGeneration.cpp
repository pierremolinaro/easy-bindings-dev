...
//                                         september 12th, 2014, at 18h38'21"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_prefsGenerationTemplate_preferencesInSwift (C_Compiler * inCompiler,
  ...
  if (in_CONTROLLER_5F_MAP.isValid ()) {
    cEnumerator_controllerMap enumerator_2191 (in_CONTROLLER_5F_MAP, kEnumeration_up) ;
    while (enumerator_2191.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Controller: ").add_operation (enumerator_2191.current_lkey (HERE).reader_string (SOURCE_FILE ("preferences.swift.gTemplate", 57)), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 57)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 57)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  \n"
        "  var " ;
      result << enumerator_2191.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " = " ;
      result << enumerator_2191.current_mControllerClassName (HERE).stringValue () ;
      result << " ()\n" ;
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_2608 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_2608.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_2608.current_lkey (HERE).reader_string (SOURCE_FILE ("preferences.swift.gTemplate", 65)), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 65)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 65)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  private var " ;
      result << enumerator_2608.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  private var " ;
      result << enumerator_2608.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_2608.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 68)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_2608.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_2608.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 69)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_2608.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      if (enumerator_2608.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_3286 (enumerator_2608.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_3286.hasCurrentObject ()) {
          result << callCategoryReader_generateForComputeFunction ((const cPtr_abstractTransientDependency *) enumerator_3286.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 74)).stringValue () ;
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 83)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 83)).add_operation (enumerator_2608.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 83)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 83)).stringValue () ;
      ...
      result << "_cache = nil\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 88)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 88)).add_operation (enumerator_2608.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 88)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 88)).stringValue () ;
      result << "_trigger () {\n"
        "    for anyObject in " ;
      result << enumerator_2608.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers {\n"
      ...
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 109)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 109)).add_operation (enumerator_2608.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 109)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 109)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 109)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 109)).add_operation (enumerator_2608.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 109)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 109)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 110)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 110)).add_operation (enumerator_2608.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 110)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 110)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 110)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 110)).add_operation (enumerator_2608.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 110)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 110)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 111)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 111)).add_operation (enumerator_2608.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 111)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 111)).stringValue () ;
      result << "_cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 112)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 112)).add_operation (enumerator_2608.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 112)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 112)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 112)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 112)).add_operation (enumerator_2608.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 112)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 112)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 114)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 114)).add_operation (enumerator_2608.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 114)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 114)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
  ...
  result << "\n"
    ...
    "  //    Arraies                                                                                                        *\n"
    "  //-------------------------------------------------------------------------------------------------------------------*\n" ;
  GALGAS_uint index_5528_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_5528 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_5528.hasCurrentObject ()) {
      result << "  var " ;
      result << enumerator_5528.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " = NSMutableArray ()\n" ;
      index_5528_.increment () ;
  ...
  result << " = self ;\n"
    " " ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.reader_length (SOURCE_FILE ("preferences.swift.gTemplate", 136)).add_operation (in_ARRAY_5F_MAP.reader_count (SOURCE_FILE ("preferences.swift.gTemplate", 136)), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 136)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    result << "    var ud = NSUserDefaults.standardUserDefaults ()\n"
      "  //---\n" ;
  }else if (kBoolFalse == test_0) {
  }
  GALGAS_uint index_6293_ (0) ;
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_6293 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    const bool nonEmpty_enumerator_6293 = enumerator_6293.hasCurrentObject () ;
    if (nonEmpty_enumerator_6293) {
    ...
    while (enumerator_6293.hasCurrentObject ()) {
      ...
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_6293.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n"
        "    if value != nil {\n"
        "      " ;
      result << enumerator_6293.current_mAttributeName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_preferencesSwiftGetter (enumerator_6293.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 146)).stringValue () ;
      result << "\n"
        "    }\n" ;
      index_6293_.increment () ;
      enumerator_6293.gotoNextObject () ;
    }
  }
  GALGAS_uint index_6521_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_6521 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_6521.hasCurrentObject ()) {
      ...
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_6521.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "\"]) {\n"
        "         * object = [[ alloc]\n"
        "        ] ;\n"
  ...
  GALGAS_uint index_8075_ (0) ;
  if (in_CONTROLLER_5F_MAP.isValid ()) {
    cEnumerator_controllerMap enumerator_8075 (in_CONTROLLER_5F_MAP, kEnumeration_up) ;
    while (enumerator_8075.hasCurrentObject ()) {
      result << "//--- '" ;
      result << enumerator_8075.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "' controller\n" ;
      index_8075_.increment () ;
      enumerator_8075.gotoNextObject () ;
    }
  }
  GALGAS_uint index_8427_ (0) ;
  if (in_OUTLET_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_8427 (in_OUTLET_5F_MAP, kEnumeration_up) ;
    while (enumerator_8427.hasCurrentObject ()) {
      result << "  //--- Check " ;
      result << enumerator_8427.current_lkey (HERE).mAttribute_string.stringValue () ;
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_8764 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_8764.hasCurrentObject ()) {
      GALGAS_uint index_8793_ (0) ;
      if (enumerator_8764.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_8793 (enumerator_8764.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_8793.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependency *) enumerator_8793.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 212)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 212)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 212)).add_operation (enumerator_8764.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 212)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 212)).stringValue () ;
          result << ", inTrigger:true)\n" ;
          index_8793_.increment () ;
          enumerator_8793.gotoNextObject () ;
        }
      }
  ...
  if (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST.isValid ()) {
    cEnumerator_stringlist enumerator_9017 (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST, kEnumeration_up) ;
  ...
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.reader_length (SOURCE_FILE ("preferences.swift.gTemplate", 234)).add_operation (in_ARRAY_5F_MAP.reader_count (SOURCE_FILE ("preferences.swift.gTemplate", 234)), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 234)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    result << "    var ud = NSUserDefaults.standardUserDefaults ()\n" ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_10095 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_10095.hasCurrentObject ()) {
      result << "    ud.setObject (" ;
      result << categoryReader_preferencesSwiftSetter (enumerator_10095.current_mAttributeType (HERE), enumerator_10095.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 238)).stringValue () ;
      result << ", forKey:\"" ;
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_10095.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
      index_10095_.increment () ;
      enumerator_10095.gotoNextObject () ;
    }
  }
  GALGAS_uint index_10254_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_10254 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_10254.hasCurrentObject ()) {
      result << "  { NSMutableArray * array = [NSMutableArray new] ;\n"
        "    for ( * object in self." ;
      result << enumerator_10254.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << ") {\n"
