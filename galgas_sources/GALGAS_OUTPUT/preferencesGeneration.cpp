...
GALGAS_string filewrapperTemplate_prefsGenerationTemplate_preferencesInSwift (C_Compiler * inCompiler,
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    ...
    while (enumerator_2521.hasCurrentObject ()) {
      ...
      if (enumerator_2521.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_3187 (enumerator_2521.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_3187.hasCurrentObject ()) {
          result << callCategoryReader_generateForComputeFunction ((const cPtr_abstractTransientDependency *) enumerator_3187.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 70)).stringValue () ;
          if (enumerator_3187.hasNextObject ()) {
            result << ", " ;
          }
      ...
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (enumerator_2521.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 101)).stringValue () ;
      result << "__cache : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (enumerator_2521.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 101)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).add_operation (enumerator_2521.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 102)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).add_operation (enumerator_2521.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 102)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 103)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 103)).add_operation (enumerator_2521.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 103)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 103)).stringValue () ;
      result << "__cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 104)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 104)).add_operation (enumerator_2521.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 104)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 104)).stringValue () ;
      result << "__cache = PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 104)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 104)).add_operation (enumerator_2521.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 104)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 104)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 106)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 106)).add_operation (enumerator_2521.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 106)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 106)).stringValue () ;
      result << "__cache!\n"
        "  }\n"
        "\n" ;
  ...
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_5373 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_5373.hasCurrentObject ()) {
      result << "  var " ;
      result << enumerator_5373.current_lkey (HERE).mAttribute_string.stringValue () ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    ...
    while (enumerator_6137.hasCurrentObject ()) {
      ...
      result << enumerator_6137.current_mAttributeName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_preferencesSwiftGetter (enumerator_6137.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 138)).stringValue () ;
      result << "\n"
        "    }\n" ;
  ...
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_6363 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_6363.hasCurrentObject ()) {
      ...
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_6363.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "\"]) {\n"
        "         * object = [[ alloc]\n"
        "        ] ;\n"
  ...
  if (in_OUTLET_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_8270 (in_OUTLET_5F_MAP, kEnumeration_up) ;
    while (enumerator_8270.hasCurrentObject ()) {
      result << "  //--- Check " ;
      result << enumerator_8270.current_lkey (HERE).mAttribute_string.stringValue () ;
  ...
  GALGAS_uint index_8606_ (0) ;
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_8606 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_8606.hasCurrentObject ()) {
      GALGAS_uint index_8633_ (0) ;
      if (enumerator_8606.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_8633 (enumerator_8606.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_8633.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependency *) enumerator_8633.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 204)).stringValue () ;
          result << " (PMTrigger_" ;
          result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 204)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 204)).add_operation (enumerator_8606.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 204)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 204)).stringValue () ;
          result << " (object:self))\n" ;
          index_8633_.increment () ;
          enumerator_8633.gotoNextObject () ;
        }
      }
      index_8606_.increment () ;
      enumerator_8606.gotoNextObject () ;
    }
  }
  GALGAS_uint index_8847_ (0) ;
  if (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST.isValid ()) {
    cEnumerator_stringlist enumerator_8847 (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST, kEnumeration_up) ;
    while (enumerator_8847.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_8847.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    ...
    while (enumerator_9923.hasCurrentObject ()) {
      result << "    ud.setObject (" ;
      result << categoryReader_preferencesSwiftSetter (enumerator_9923.current_mAttributeType (HERE), enumerator_9923.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 230)).stringValue () ;
      result << ", forKey:\"" ;
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
  ...
  GALGAS_uint index_10080_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_10080 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_10080.hasCurrentObject ()) {
      result << "  { NSMutableArray * array = [NSMutableArray new] ;\n"
        "    for ( * object in self." ;
      result << enumerator_10080.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << ") {\n"
