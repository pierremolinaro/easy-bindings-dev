...
//                                         september 3rd, 2014, at 11h53'25"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_prefsGenerationTemplate_preferencesInSwift (C_Compiler * inCompiler,
  ...
  GALGAS_uint index_1013_ (0) ;
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_1013 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_1013.hasCurrentObject ()) {
      result << "\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Attribute: ").add_operation (enumerator_1013.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 24)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 24)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_1013.current_mAttributeName (HERE).stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  var " ;
      result << enumerator_1013.current_mAttributeName (HERE).stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_1013.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 27)).stringValue () ;
      result << " = " ;
      result << enumerator_1013.current_mDefaultValueInSwift (HERE).stringValue () ;
      result << " {\n"
        "    didSet {\n"
        "      if " ;
      result << enumerator_1013.current_mAttributeName (HERE).stringValue () ;
      ...
      result << "_observers.removeObject (inObserver)\n"
        ...
        "  }\n"
        "\n" ;
      index_1013_.increment () ;
      enumerator_1013.gotoNextObject () ;
    }
  }
  GALGAS_uint index_2111_ (0) ;
  if (in_CONTROLLER_5F_MAP.isValid ()) {
    cEnumerator_controllerMap enumerator_2111 (in_CONTROLLER_5F_MAP, kEnumeration_up) ;
    while (enumerator_2111.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Controller: ").add_operation (enumerator_2111.current_lkey (HERE).reader_string (SOURCE_FILE ("preferences.swift.gTemplate", 53)), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 53)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 53)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  \n"
        "  var " ;
      result << enumerator_2111.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " = " ;
      result << enumerator_2111.current_mControllerClassName (HERE).stringValue () ;
      result << " ()\n" ;
      index_2111_.increment () ;
      enumerator_2111.gotoNextObject () ;
    }
  }
  GALGAS_uint index_2529_ (0) ;
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_2529 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_2529.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_2529.current_lkey (HERE).reader_string (SOURCE_FILE ("preferences.swift.gTemplate", 61)), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 61)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 61)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_2529.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  var " ;
      result << enumerator_2529.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_2529.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 64)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_2529.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_2529.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 65)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_2529.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      result << enumerator_2529.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " (" ;
      GALGAS_uint index_3197_ (0) ;
      if (enumerator_2529.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_3197 (enumerator_2529.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_3197.hasCurrentObject ()) {
          result << callCategoryReader_generateForComputeFunction ((const cPtr_abstractTransientDependency *) enumerator_3197.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 70)).stringValue () ;
          if (enumerator_3197.hasNextObject ()) {
            result << ", " ;
          }
          index_3197_.increment () ;
      ...
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (enumerator_2529.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 101)).stringValue () ;
      result << "__cache : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (enumerator_2529.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 101)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).add_operation (enumerator_2529.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 102)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).add_operation (enumerator_2529.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 102)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 103)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 103)).add_operation (enumerator_2529.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 103)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 103)).stringValue () ;
      result << "__cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 104)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 104)).add_operation (enumerator_2529.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 104)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 104)).stringValue () ;
      result << "__cache = PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 104)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 104)).add_operation (enumerator_2529.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 104)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 104)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 106)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 106)).add_operation (enumerator_2529.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 106)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 106)).stringValue () ;
      result << "__cache!\n"
        "  }\n"
        "\n" ;
      index_2529_.increment () ;
  ...
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_5385 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_5385.hasCurrentObject ()) {
      result << "  var " ;
      result << enumerator_5385.current_lkey (HERE).mAttribute_string.stringValue () ;
  ...
  result << " = self ;\n"
    " " ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsStrictSup, in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.reader_length (SOURCE_FILE ("preferences.swift.gTemplate", 128)).add_operation (in_ARRAY_5F_MAP.reader_count (SOURCE_FILE ("preferences.swift.gTemplate", 128)), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 128)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_0) {
    result << "    var ud = NSUserDefaults.standardUserDefaults ()\n"
      "  //---\n" ;
  }else if (kBoolFalse == test_0) {
  }
  GALGAS_uint index_6151_ (0) ;
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_6151 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    const bool nonEmpty_enumerator_6151 = enumerator_6151.hasCurrentObject () ;
    if (nonEmpty_enumerator_6151) {
    ...
    while (enumerator_6151.hasCurrentObject ()) {
      ...
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_6151.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n"
        "    if value != nil {\n"
        "      " ;
      result << enumerator_6151.current_mAttributeName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_preferencesSwiftGetter (enumerator_6151.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 138)).stringValue () ;
      result << "\n"
        "    }\n" ;
      index_6151_.increment () ;
      enumerator_6151.gotoNextObject () ;
    }
  }
  GALGAS_uint index_6379_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_6379 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_6379.hasCurrentObject ()) {
      ...
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_6379.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "\"]) {\n"
        "         * object = [[ alloc]\n"
        "        ] ;\n"
  ...
  GALGAS_uint index_7939_ (0) ;
  if (in_CONTROLLER_5F_MAP.isValid ()) {
    cEnumerator_controllerMap enumerator_7939 (in_CONTROLLER_5F_MAP, kEnumeration_up) ;
    while (enumerator_7939.hasCurrentObject ()) {
      result << "//--- '" ;
      result << enumerator_7939.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "' controller\n" ;
      index_7939_.increment () ;
      enumerator_7939.gotoNextObject () ;
    }
  }
  GALGAS_uint index_8296_ (0) ;
  if (in_OUTLET_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_8296 (in_OUTLET_5F_MAP, kEnumeration_up) ;
    while (enumerator_8296.hasCurrentObject ()) {
      result << "  //--- Check " ;
      result << enumerator_8296.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      result << "' outlet is nil\")\n"
        "    }\n" ;
      index_8296_.increment () ;
      enumerator_8296.gotoNextObject () ;
    }
  }
  GALGAS_uint index_8636_ (0) ;
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_8636 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_8636.hasCurrentObject ()) {
      GALGAS_uint index_8665_ (0) ;
      if (enumerator_8636.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_8665 (enumerator_8636.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_8665.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependency *) enumerator_8665.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 204)).stringValue () ;
          result << " (PMTrigger_" ;
          result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 204)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 204)).add_operation (enumerator_8636.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 204)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 204)).stringValue () ;
          result << " (object:self))\n" ;
  ...
  GALGAS_uint index_8881_ (0) ;
  if (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST.isValid ()) {
    cEnumerator_stringlist enumerator_8881 (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST, kEnumeration_up) ;
    while (enumerator_8881.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_8881.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
      index_8881_.increment () ;
  ...
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.reader_length (SOURCE_FILE ("preferences.swift.gTemplate", 226)).add_operation (in_ARRAY_5F_MAP.reader_count (SOURCE_FILE ("preferences.swift.gTemplate", 226)), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 226)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    result << "    var ud = NSUserDefaults.standardUserDefaults ()\n" ;
  }else if (kBoolFalse == test_1) {
  }
  GALGAS_uint index_9959_ (0) ;
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_9959 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_9959.hasCurrentObject ()) {
      result << "    ud.setObject (" ;
      result << categoryReader_preferencesSwiftSetter (enumerator_9959.current_mAttributeType (HERE), enumerator_9959.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 230)).stringValue () ;
      result << ", forKey:\"" ;
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_9959.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
      index_9959_.increment () ;
      enumerator_9959.gotoNextObject () ;
    }
  }
  GALGAS_uint index_10118_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_10118 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_10118.hasCurrentObject ()) {
      result << "  { NSMutableArray * array = [NSMutableArray new] ;\n"
        "    for ( * object in self." ;
      result << enumerator_10118.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << ") {\n"
...
void routine_generatePreferences (const GALGAS_preferenceListForGeneration constinArgument_inPreferenceListForGeneration,
                                  ...
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_preferenceListForGeneration enumerator_5452 (constinArgument_inPreferenceListForGeneration, kEnumeration_up) ;
  while (enumerator_5452.hasCurrentObject ()) {
    GALGAS_string var_s = GALGAS_string (filewrapperTemplate_prefsGenerationTemplate_preferencesInSwift (inCompiler, enumerator_5452.current_mPreferenceName (HERE), enumerator_5452.current_mAttributeListForGeneration (HERE), enumerator_5452.current_mDecoratedTransientMapForGeneration (HERE), enumerator_5452.current_mOutletMap (HERE), GALGAS_preferencesPropertyArrayMap::constructor_emptyMap (SOURCE_FILE ("preferencesGeneration.gSemantics", 142)), GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE ("preferencesGeneration.gSemantics", 143)), enumerator_5452.current_mControllerInstanciationStringList (HERE) COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 137))) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, enumerator_5452.current_mPreferenceName (HERE).operator_concat (GALGAS_string (".swift")  COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 148)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_s, GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 146)) ;
    }
...
GALGAS_string categoryReader_swiftTypeName (const GALGAS_unifiedTypeProxy & inObject,
  ...
  if (temp_0.reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 42)).isValid ()) {
    switch (temp_0.reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 42)).enumValue ()) {
    ...
    case GALGAS_typeKind::kEnum_structType: case GALGAS_typeKind::kEnum_enumType: {
      ...
      result_outResult = temp_1.reader_key (inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 55)) ;
      } break ;
    case GALGAS_typeKind::kEnum_classType: case GALGAS_typeKind::kEnum_controllerClassType: case GALGAS_typeKind::kEnum_documentType: case GALGAS_typeKind::kEnum_entityType: case GALGAS_typeKind::kEnum_preferencesType: case GALGAS_typeKind::kEnum_nibClassType: case GALGAS_typeKind::kEnum_outletClassType: case GALGAS_typeKind::kEnum_protocolType: {
      ...
      result_outResult = GALGAS_string ("<invalid return type '").add_operation (temp_2.reader_key (inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 58)), inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 58)).add_operation (GALGAS_string ("' >"), inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 58)) ;
      } break ;
    }
  }
//---
...
GALGAS_string categoryReader_preferencesSwiftGetter (const GALGAS_unifiedTypeProxy & inObject,
  ...
  GALGAS_string result_outResult ; // Returned variable
  const GALGAS_unifiedTypeProxy temp_0 = inObject ;
  if (temp_0.reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 67)).isValid ()) {
    switch (temp_0.reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 67)).enumValue ()) {
    case GALGAS_typeKind::kNotBuilt:
      break ;
    case GALGAS_typeKind::kEnum_boolType: {
    ...
    case GALGAS_typeKind::kEnum_classType: case GALGAS_typeKind::kEnum_controllerClassType: case GALGAS_typeKind::kEnum_documentType: case GALGAS_typeKind::kEnum_entityType: case GALGAS_typeKind::kEnum_preferencesType: case GALGAS_typeKind::kEnum_nibClassType: case GALGAS_typeKind::kEnum_outletClassType: case GALGAS_typeKind::kEnum_protocolType: {
      const GALGAS_unifiedTypeProxy temp_1 = inObject ;
      result_outResult = GALGAS_string ("<invalid type '").add_operation (temp_1.reader_key (inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 83)), inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 83)).add_operation (GALGAS_string ("' >"), inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 83)) ;
      } break ;
    }
  }
//---
...
GALGAS_string categoryReader_preferencesSwiftSetter (const GALGAS_unifiedTypeProxy & inObject,
  ...
  GALGAS_string result_outResult ; // Returned variable
  const GALGAS_unifiedTypeProxy temp_0 = inObject ;
  if (temp_0.reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 93)).isValid ()) {
    switch (temp_0.reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 93)).enumValue ()) {
    case GALGAS_typeKind::kNotBuilt:
      break ;
    case GALGAS_typeKind::kEnum_boolType: {
    ...
    case GALGAS_typeKind::kEnum_integerType: {
      result_outResult = GALGAS_string ("NSNumber.numberWithLongLong (").add_operation (constinArgument_inPropertyName, inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 96)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 96)) ;
      } break ;
    case GALGAS_typeKind::kEnum_doubleType: {
      result_outResult = GALGAS_string ("\xC3""\xA0"" compl\xC3""\xA9""ter preferencesSwiftSetter") ;
      } break ;
    ...
    case GALGAS_typeKind::kEnum_colorType: {
      result_outResult = GALGAS_string ("NSArchiver.archivedDataWithRootObject (").add_operation (constinArgument_inPropertyName, inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 99)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 99)) ;
      } break ;
    case GALGAS_typeKind::kEnum_dataType: {
      result_outResult = GALGAS_string ("\xC3""\xA0"" compl\xC3""\xA9""ter preferencesSwiftSetter") ;
      } break ;
    ...
    case GALGAS_typeKind::kEnum_classType: case GALGAS_typeKind::kEnum_controllerClassType: case GALGAS_typeKind::kEnum_documentType: case GALGAS_typeKind::kEnum_entityType: case GALGAS_typeKind::kEnum_preferencesType: case GALGAS_typeKind::kEnum_nibClassType: case GALGAS_typeKind::kEnum_outletClassType: case GALGAS_typeKind::kEnum_protocolType: {
      const GALGAS_unifiedTypeProxy temp_1 = inObject ;
      result_outResult = GALGAS_string ("<invalid type '").add_operation (temp_1.reader_key (inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 109)), inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 109)).add_operation (GALGAS_string ("' >"), inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 109)) ;
      } break ;
    }
  }
//---
