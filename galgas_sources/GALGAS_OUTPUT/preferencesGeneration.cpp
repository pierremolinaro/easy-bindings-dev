...
GALGAS_string filewrapperTemplate_prefsGenerationTemplate_preferencesInSwift (C_Compiler * inCompiler,
  ...
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_2609 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_2609.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_2609.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 65)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 65)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  private var " ;
      result << enumerator_2609.current_mTransientName (HERE).stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  private var " ;
      result << enumerator_2609.current_mTransientName (HERE).stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_2609.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 68)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_2609.current_mTransientName (HERE).stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_2609.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 69)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_2609.current_mTransientName (HERE).stringValue () ;
      ...
      if (enumerator_2609.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_3315 (enumerator_2609.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_3315.hasCurrentObject ()) {
          result << callCategoryReader_generateActualParameterForComputeFunction ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_3315.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 74)).stringValue () ;
          if (enumerator_3315.hasNextObject ()) {
            result << ", " ;
          }
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 83)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 83)).add_operation (enumerator_2609.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 83)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 83)).stringValue () ;
      ...
      result << "_cache = nil\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 88)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 88)).add_operation (enumerator_2609.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 88)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 88)).stringValue () ;
      result << "_trigger () {\n"
        "    for anyObject in " ;
      result << enumerator_2609.current_mTransientName (HERE).stringValue () ;
      result << "_observers {\n"
      ...
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 109)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 109)).add_operation (enumerator_2609.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 109)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 109)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 109)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 109)).add_operation (enumerator_2609.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 109)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 109)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 110)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 110)).add_operation (enumerator_2609.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 110)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 110)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 110)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 110)).add_operation (enumerator_2609.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 110)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 110)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 111)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 111)).add_operation (enumerator_2609.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 111)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 111)).stringValue () ;
      result << "_cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 112)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 112)).add_operation (enumerator_2609.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 112)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 112)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 112)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 112)).add_operation (enumerator_2609.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 112)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 112)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 114)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 114)).add_operation (enumerator_2609.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 114)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 114)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
  ...
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_5623 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_5623.hasCurrentObject ()) {
      result << "  var " ;
      result << enumerator_5623.current_lkey (HERE).mAttribute_string.stringValue () ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_6388 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    const bool nonEmpty_enumerator_6388 = enumerator_6388.hasCurrentObject () ;
    if (nonEmpty_enumerator_6388) {
    ...
    while (enumerator_6388.hasCurrentObject ()) {
      ...
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_6388.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n"
        "    if value != nil {\n"
        "      " ;
      result << enumerator_6388.current_mAttributeName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_preferencesSwiftGetter (enumerator_6388.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 146)).stringValue () ;
      result << "\n"
        "    }\n" ;
  ...
  GALGAS_uint index_6616_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_6616 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_6616.hasCurrentObject ()) {
      ...
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_6616.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "\"]) {\n"
        "         * object = [[ alloc]\n"
        "        ] ;\n"
  ...
  if (in_CONTROLLER_5F_MAP.isValid ()) {
    cEnumerator_controllerMap enumerator_8170 (in_CONTROLLER_5F_MAP, kEnumeration_up) ;
    while (enumerator_8170.hasCurrentObject ()) {
      result << "//--- '" ;
      result << enumerator_8170.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "' controller\n" ;
      index_8170_.increment () ;
      enumerator_8170.gotoNextObject () ;
    }
  }
  GALGAS_uint index_8522_ (0) ;
  if (in_OUTLET_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_8522 (in_OUTLET_5F_MAP, kEnumeration_up) ;
    while (enumerator_8522.hasCurrentObject ()) {
      result << "  //--- Check " ;
      result << enumerator_8522.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      result << "' outlet is nil\")\n"
        "    }\n" ;
      index_8522_.increment () ;
      enumerator_8522.gotoNextObject () ;
    }
  }
  GALGAS_uint index_8860_ (0) ;
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_8860 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_8860.hasCurrentObject ()) {
      GALGAS_uint index_8889_ (0) ;
      if (enumerator_8860.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_8889 (enumerator_8860.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_8889.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_8889.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 212)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 212)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 212)).add_operation (enumerator_8860.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 212)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 212)).stringValue () ;
          result << ", inTrigger:true)\n" ;
          index_8889_.increment () ;
          enumerator_8889.gotoNextObject () ;
        }
      }
      index_8860_.increment () ;
      enumerator_8860.gotoNextObject () ;
    }
  }
  GALGAS_uint index_9116_ (0) ;
  if (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST.isValid ()) {
    cEnumerator_stringlist enumerator_9116 (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST, kEnumeration_up) ;
    while (enumerator_9116.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_9116.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
      index_9116_.increment () ;
  ...
  GALGAS_uint index_10194_ (0) ;
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_10194 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_10194.hasCurrentObject ()) {
      result << "    ud.setObject (" ;
      result << categoryReader_preferencesSwiftSetter (enumerator_10194.current_mAttributeType (HERE), enumerator_10194.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 238)).stringValue () ;
      result << ", forKey:\"" ;
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_10194.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
      index_10194_.increment () ;
      enumerator_10194.gotoNextObject () ;
    }
  }
  GALGAS_uint index_10353_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_10353 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_10353.hasCurrentObject ()) {
      result << "  { NSMutableArray * array = [NSMutableArray new] ;\n"
        "    for ( * object in self." ;
      result << enumerator_10353.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << ") {\n"
