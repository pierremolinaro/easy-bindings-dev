...
//                                         september 3rd, 2014, at 21h24'29"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_prefsGenerationTemplate_preferencesInSwift (C_Compiler * inCompiler,
  ...
  GALGAS_uint index_2107_ (0) ;
  if (in_CONTROLLER_5F_MAP.isValid ()) {
    cEnumerator_controllerMap enumerator_2107 (in_CONTROLLER_5F_MAP, kEnumeration_up) ;
    while (enumerator_2107.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Controller: ").add_operation (enumerator_2107.current_lkey (HERE).reader_string (SOURCE_FILE ("preferences.swift.gTemplate", 53)), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 53)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 53)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  \n"
        "  var " ;
      result << enumerator_2107.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " = " ;
      result << enumerator_2107.current_mControllerClassName (HERE).stringValue () ;
      result << " ()\n" ;
      index_2107_.increment () ;
      enumerator_2107.gotoNextObject () ;
    }
  }
  GALGAS_uint index_2525_ (0) ;
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_2525 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_2525.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_2525.current_lkey (HERE).reader_string (SOURCE_FILE ("preferences.swift.gTemplate", 61)), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 61)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 61)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  var " ;
      result << enumerator_2525.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  var " ;
      result << enumerator_2525.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_2525.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 64)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_2525.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_2525.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 65)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_2525.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      result << enumerator_2525.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " (" ;
      GALGAS_uint index_3193_ (0) ;
      if (enumerator_2525.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_3193 (enumerator_2525.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_3193.hasCurrentObject ()) {
          result << callCategoryReader_generateForComputeFunction ((const cPtr_abstractTransientDependency *) enumerator_3193.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 70)).stringValue () ;
          if (enumerator_3193.hasNextObject ()) {
            result << ", " ;
          }
          index_3193_.increment () ;
      ...
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 98)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 98)).add_operation (enumerator_2525.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 98)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 98)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 98)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 98)).add_operation (enumerator_2525.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 98)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 98)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 99)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 99)).add_operation (enumerator_2525.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 99)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 99)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 99)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 99)).add_operation (enumerator_2525.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 99)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 99)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 100)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 100)).add_operation (enumerator_2525.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 100)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 100)).stringValue () ;
      result << "_cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (enumerator_2525.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 101)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).add_operation (enumerator_2525.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 101)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 101)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 103)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 103)).add_operation (enumerator_2525.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 103)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 103)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
  ...
  result << "\n"
    ...
    "  //    Arraies                                                                                                        *\n"
    "  //-------------------------------------------------------------------------------------------------------------------*\n" ;
  GALGAS_uint index_5234_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_5234 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_5234.hasCurrentObject ()) {
      result << "  var " ;
      result << enumerator_5234.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " = NSMutableArray ()\n" ;
      index_5234_.increment () ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_6000 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    const bool nonEmpty_enumerator_6000 = enumerator_6000.hasCurrentObject () ;
    if (nonEmpty_enumerator_6000) {
    ...
    while (enumerator_6000.hasCurrentObject ()) {
      ...
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_6000.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n"
        "    if value != nil {\n"
        "      " ;
      result << enumerator_6000.current_mAttributeName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_preferencesSwiftGetter (enumerator_6000.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 135)).stringValue () ;
      result << "\n"
        "    }\n" ;
  ...
  GALGAS_uint index_6228_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_6228 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_6228.hasCurrentObject ()) {
      result << "    { NSMutableArray * array = [NSMutableArray new] ;\n"
        "      for (NSDictionary * dict in [ud objectForKey:@\"" ;
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_6228.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "\"]) {\n"
        "         * object = [[ alloc]\n"
        "        ] ;\n"
      ...
      result << " = array ;\n"
        "    }\n" ;
      index_6228_.increment () ;
      enumerator_6228.gotoNextObject () ;
    }
  }
  result << "  //---\n"
  ...
  GALGAS_uint index_7788_ (0) ;
  if (in_CONTROLLER_5F_MAP.isValid ()) {
    cEnumerator_controllerMap enumerator_7788 (in_CONTROLLER_5F_MAP, kEnumeration_up) ;
    while (enumerator_7788.hasCurrentObject ()) {
      result << "//--- '" ;
      result << enumerator_7788.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "' controller\n" ;
      index_7788_.increment () ;
      enumerator_7788.gotoNextObject () ;
    }
  }
  GALGAS_uint index_8145_ (0) ;
  if (in_OUTLET_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_8145 (in_OUTLET_5F_MAP, kEnumeration_up) ;
    while (enumerator_8145.hasCurrentObject ()) {
      result << "  //--- Check " ;
      result << enumerator_8145.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      result << "' outlet is nil\")\n"
        "    }\n" ;
      index_8145_.increment () ;
      enumerator_8145.gotoNextObject () ;
    }
  }
  GALGAS_uint index_8485_ (0) ;
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_8485 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_8485.hasCurrentObject ()) {
      GALGAS_uint index_8514_ (0) ;
      if (enumerator_8485.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_8514 (enumerator_8485.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_8514.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependency *) enumerator_8514.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 201)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 201)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 201)).add_operation (enumerator_8485.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 201)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 201)).stringValue () ;
          result << ")\n" ;
          index_8514_.increment () ;
  ...
  if (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST.isValid ()) {
    cEnumerator_stringlist enumerator_8723 (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST, kEnumeration_up) ;
    while (enumerator_8723.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_8723.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_9801 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_9801.hasCurrentObject ()) {
      result << "    ud.setObject (" ;
      result << categoryReader_preferencesSwiftSetter (enumerator_9801.current_mAttributeType (HERE), enumerator_9801.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 227)).stringValue () ;
      result << ", forKey:\"" ;
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_9801.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
      index_9801_.increment () ;
      enumerator_9801.gotoNextObject () ;
    }
  }
  GALGAS_uint index_9960_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_9960 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_9960.hasCurrentObject ()) {
      result << "  { NSMutableArray * array = [NSMutableArray new] ;\n"
        "    for ( * object in self." ;
      result << enumerator_9960.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << ") {\n"
...
void routine_generatePreferences (const GALGAS_preferenceListForGeneration constinArgument_inPreferenceListForGeneration,
                                  ...
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_preferenceListForGeneration enumerator_4457 (constinArgument_inPreferenceListForGeneration, kEnumeration_up) ;
  while (enumerator_4457.hasCurrentObject ()) {
    GALGAS_string var_s = GALGAS_string (filewrapperTemplate_prefsGenerationTemplate_preferencesInSwift (inCompiler, enumerator_4457.current_mPreferenceName (HERE), enumerator_4457.current_mAttributeListForGeneration (HERE), enumerator_4457.current_mDecoratedTransientMapForGeneration (HERE), enumerator_4457.current_mOutletMap (HERE), GALGAS_preferencesPropertyArrayMap::constructor_emptyMap (SOURCE_FILE ("preferencesGeneration.gSemantics", 115)), GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE ("preferencesGeneration.gSemantics", 116)), enumerator_4457.current_mControllerInstanciationStringList (HERE) COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 110))) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, enumerator_4457.current_mPreferenceName (HERE).operator_concat (GALGAS_string (".swift")  COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 121)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_s, GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"
...
GALGAS_string categoryReader_preferencesSwiftSetter (const GALGAS_unifiedTypeProxy & inObject,
  ...
  if (temp_0.reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 66)).isValid ()) {
    ...
    case GALGAS_typeKind::kEnum_integerType: {
      result_outResult = GALGAS_string ("NSNumber.numberWithLongLong (").add_operation (constinArgument_inPropertyName, inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 69)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 69)) ;
      } break ;
    case GALGAS_typeKind::kEnum_doubleType: {
      result_outResult = GALGAS_string ("\xC3""\xA0"" compl\xC3""\xA9""ter preferencesSwiftSetter") ;
      } break ;
