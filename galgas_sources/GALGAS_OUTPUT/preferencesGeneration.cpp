...
void routine_generatePreferences (const GALGAS_preferenceListForGeneration constinArgument_inPreferenceListForGeneration,
                                  ...
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_preferenceListForGeneration enumerator_4477 (constinArgument_inPreferenceListForGeneration, kEnumeration_up) ;
  while (enumerator_4477.hasCurrentObject ()) {
    GALGAS_string var_s = GALGAS_string (filewrapperTemplate_prefsGenerationTemplate_preferencesInSwift (inCompiler, enumerator_4477.current_mPreferenceName (HERE), enumerator_4477.current_mAttributeListForGeneration (HERE), enumerator_4477.current_mDecoratedTransientListForGeneration (HERE), enumerator_4477.current_mOutletMap (HERE), GALGAS_preferencesPropertyArrayMap::constructor_emptyMap (SOURCE_FILE ("preferencesGeneration.gSemantics", 115)), GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE ("preferencesGeneration.gSemantics", 116)), enumerator_4477.current_mControllerInstanciationStringList (HERE) COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 110))) ;
    {
    GALGAS_string::class_method_generateFile (constinArgument_inOutputDirectory, enumerator_4477.current_mPreferenceName (HERE).operator_concat (GALGAS_string (".swift")  COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 121)), var_s, inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 119)) ;
    }
