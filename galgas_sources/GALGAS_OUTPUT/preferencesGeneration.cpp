...
//                                         september 13th, 2014, at 10h35'59"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_prefsGenerationTemplate_preferencesInSwift (C_Compiler * inCompiler,
  ...
  if (in_CONTROLLER_5F_MAP.isValid ()) {
    cEnumerator_controllerMap enumerator_2399 (in_CONTROLLER_5F_MAP, kEnumeration_up) ;
    while (enumerator_2399.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Controller: ").add_operation (enumerator_2399.current_lkey (HERE).reader_string (SOURCE_FILE ("preferences.swift.gTemplate", 61)), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 61)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 61)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  \n"
        "  var " ;
      result << enumerator_2399.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << " = " ;
      result << enumerator_2399.current_mControllerClassName (HERE).stringValue () ;
      result << " ()\n" ;
  ...
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_2817 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_2817.hasCurrentObject ()) {
      result << "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "  //    " ;
      result << GALGAS_string ("Transient: ").add_operation (enumerator_2817.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 69)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 111U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 69)).stringValue () ;
      result << "*\n"
        "  //-------------------------------------------------------------------------------------------------------------------*\n"
        "\n"
        "  private var " ;
      result << enumerator_2817.current_mTransientName (HERE).stringValue () ;
      result << "_observers = NSMutableSet ()\n"
        "  private var " ;
      result << enumerator_2817.current_mTransientName (HERE).stringValue () ;
      result << "_cache : " ;
      result << categoryReader_swiftTypeName (enumerator_2817.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 72)).stringValue () ;
      result << "\?\n"
        "  var " ;
      result << enumerator_2817.current_mTransientName (HERE).stringValue () ;
      result << " : " ;
      result << categoryReader_swiftTypeName (enumerator_2817.current_mTransientType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 73)).stringValue () ;
      result << " {\n"
        "    get {\n"
        "      if " ;
      result << enumerator_2817.current_mTransientName (HERE).stringValue () ;
      ...
      if (enumerator_2817.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_3523 (enumerator_2817.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_3523.hasCurrentObject ()) {
          result << callCategoryReader_generateActualParameterForComputeFunction ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_3523.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 78)).stringValue () ;
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 87)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 87)).add_operation (enumerator_2817.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 87)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 87)).stringValue () ;
      ...
      result << "_cache = nil\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 92)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 92)).add_operation (enumerator_2817.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 92)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 92)).stringValue () ;
      result << "_trigger () {\n"
        "    for anyObject in " ;
      result << enumerator_2817.current_mTransientName (HERE).stringValue () ;
      result << "_observers {\n"
      ...
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 113)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 113)).add_operation (enumerator_2817.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 113)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 113)).stringValue () ;
      result << "_cache : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 113)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 113)).add_operation (enumerator_2817.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 113)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 113)).stringValue () ;
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 114)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 114)).add_operation (enumerator_2817.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 114)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 114)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 114)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 114)).add_operation (enumerator_2817.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 114)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 114)).stringValue () ;
      result << " {\n"
        "    if triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 115)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 115)).add_operation (enumerator_2817.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 115)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 115)).stringValue () ;
      result << "_cache == nil {\n"
        "      triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 116)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 116)).add_operation (enumerator_2817.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 116)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 116)).stringValue () ;
      result << "_cache = PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 116)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 116)).add_operation (enumerator_2817.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 116)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 116)).stringValue () ;
      result << " (object:self)\n"
        "    }\n"
        "    return triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 118)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 118)).add_operation (enumerator_2817.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 118)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 118)).stringValue () ;
      result << "_cache!\n"
        "  }\n"
        "\n" ;
  ...
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_5831 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_5831.hasCurrentObject ()) {
      result << "  var " ;
      result << enumerator_5831.current_lkey (HERE).mAttribute_string.stringValue () ;
  ...
  GALGAS_uint index_6596_ (0) ;
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_6596 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    const bool nonEmpty_enumerator_6596 = enumerator_6596.hasCurrentObject () ;
    if (nonEmpty_enumerator_6596) {
    ...
    while (enumerator_6596.hasCurrentObject ()) {
      ...
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_6596.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n"
        "    if value != nil {\n"
        "      " ;
      result << enumerator_6596.current_mAttributeName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_preferencesSwiftGetter (enumerator_6596.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 150)).stringValue () ;
      result << "\n"
        "    }\n" ;
      index_6596_.increment () ;
      enumerator_6596.gotoNextObject () ;
    }
  }
  GALGAS_uint index_6824_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_6824 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_6824.hasCurrentObject ()) {
      ...
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_6824.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "\"]) {\n"
        "         * object = [[ alloc]\n"
        "        ] ;\n"
  ...
  if (in_CONTROLLER_5F_MAP.isValid ()) {
    cEnumerator_controllerMap enumerator_8378 (in_CONTROLLER_5F_MAP, kEnumeration_up) ;
    while (enumerator_8378.hasCurrentObject ()) {
      result << "//--- '" ;
      result << enumerator_8378.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "' controller\n" ;
      index_8378_.increment () ;
      enumerator_8378.gotoNextObject () ;
    }
  }
  GALGAS_uint index_8730_ (0) ;
  if (in_OUTLET_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_8730 (in_OUTLET_5F_MAP, kEnumeration_up) ;
    while (enumerator_8730.hasCurrentObject ()) {
      result << "  //--- Check " ;
      result << enumerator_8730.current_lkey (HERE).mAttribute_string.stringValue () ;
      ...
      result << "' outlet is nil\")\n"
        "    }\n" ;
      index_8730_.increment () ;
      enumerator_8730.gotoNextObject () ;
    }
  }
  GALGAS_uint index_9068_ (0) ;
  if (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_transientDefinitionListForGeneration enumerator_9068 (in_TRANSIENT_5F_LIST_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_9068.hasCurrentObject ()) {
      GALGAS_uint index_9097_ (0) ;
      if (enumerator_9068.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceListForGeneration enumerator_9097 (enumerator_9068.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_9097.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependencyForGeneration *) enumerator_9097.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 216)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 216)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 216)).add_operation (enumerator_9068.current_mTransientName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 216)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 216)).stringValue () ;
  ...
  GALGAS_uint index_9324_ (0) ;
  if (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST.isValid ()) {
    cEnumerator_stringlist enumerator_9324 (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST, kEnumeration_up) ;
    while (enumerator_9324.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_9324.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
      index_9324_.increment () ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_10402 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_10402.hasCurrentObject ()) {
      result << "    ud.setObject (" ;
      result << categoryReader_preferencesSwiftSetter (enumerator_10402.current_mAttributeType (HERE), enumerator_10402.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 242)).stringValue () ;
      result << ", forKey:\"" ;
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_10402.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
      index_10402_.increment () ;
      enumerator_10402.gotoNextObject () ;
    }
  }
  GALGAS_uint index_10561_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_10561 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_10561.hasCurrentObject ()) {
      result << "  { NSMutableArray * array = [NSMutableArray new] ;\n"
        "    for ( * object in self." ;
      result << enumerator_10561.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << ") {\n"
