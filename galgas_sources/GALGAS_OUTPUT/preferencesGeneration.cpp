...
GALGAS_string filewrapperTemplate_prefsGenerationTemplate_preferencesInSwift (C_Compiler * inCompiler,
  ...
  if (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST.isValid ()) {
    cEnumerator_stringlist enumerator_8395 (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST, kEnumeration_up) ;
    while (enumerator_8395.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_8395.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
  ...
  const enumGalgasBool test_1 = GALGAS_bool (kIsStrictSup, in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.reader_length (SOURCE_FILE ("preferences.swift.gTemplate", 208)).add_operation (in_ARRAY_5F_MAP.reader_count (SOURCE_FILE ("preferences.swift.gTemplate", 208)), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 208)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
  if (kBoolTrue == test_1) {
    result << "    var ud = NSUserDefaults.standardUserDefaults ()\n" ;
  ...
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_9471 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_9471.hasCurrentObject ()) {
      result << "    ud.setObject (" ;
      result << categoryReader_preferencesSwiftSetter (enumerator_9471.current_mAttributeType (HERE), enumerator_9471.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 212)).stringValue () ;
      result << ", forKey:\"" ;
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_9471.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
      index_9471_.increment () ;
      enumerator_9471.gotoNextObject () ;
    }
  }
  GALGAS_uint index_9628_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_9628 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_9628.hasCurrentObject ()) {
      result << "  { NSMutableArray * array = [NSMutableArray new] ;\n"
        "    for ( * object in self." ;
      result << enumerator_9628.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << ") {\n"
