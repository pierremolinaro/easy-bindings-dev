...
//                                         september 12th, 2014, at 16h24'58"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
GALGAS_string filewrapperTemplate_prefsGenerationTemplate_preferencesInSwift (C_Compiler * inCompiler,
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    ...
    while (enumerator_2522.hasCurrentObject ()) {
      ...
      result << "_cache!\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 79)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 79)).add_operation (enumerator_2522.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 79)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 79)).stringValue () ;
      ...
      result << "_cache = nil\n"
        ...
        "\n"
        "  func " ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 84)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 84)).add_operation (enumerator_2522.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 84)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 84)).stringValue () ;
      result << "_trigger () {\n"
        "    for anyObject in " ;
      result << enumerator_2522.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "_observers {\n"
      ...
      result << "\? = nil\n"
        "  var triggerObjectFor_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).add_operation (enumerator_2522.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 102)).stringValue () ;
      result << " : PMTrigger_" ;
      result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).add_operation (enumerator_2522.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 102)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 102)).stringValue () ;
      result << " {\n"
  ...
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_5356 (in_ARRAY_5F_MAP, kEnumeration_up) ;
  ...
  GALGAS_uint index_6121_ (0) ;
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_6121 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    const bool nonEmpty_enumerator_6121 = enumerator_6121.hasCurrentObject () ;
    if (nonEmpty_enumerator_6121) {
    ...
    while (enumerator_6121.hasCurrentObject ()) {
      ...
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_6121.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n"
        "    if value != nil {\n"
        "      " ;
      result << enumerator_6121.current_mAttributeName (HERE).stringValue () ;
      result << " = " ;
      result << categoryReader_preferencesSwiftGetter (enumerator_6121.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 138)).stringValue () ;
      result << "\n"
        "    }\n" ;
      index_6121_.increment () ;
      enumerator_6121.gotoNextObject () ;
    }
  }
  GALGAS_uint index_6349_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_6349 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_6349.hasCurrentObject ()) {
      result << "    { NSMutableArray * array = [NSMutableArray new] ;\n"
        "      for (NSDictionary * dict in [ud objectForKey:@\"" ;
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_6349.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "\"]) {\n"
        "         * object = [[ alloc]\n"
        "        ] ;\n"
  ...
  GALGAS_uint index_7903_ (0) ;
  if (in_CONTROLLER_5F_MAP.isValid ()) {
    cEnumerator_controllerMap enumerator_7903 (in_CONTROLLER_5F_MAP, kEnumeration_up) ;
    while (enumerator_7903.hasCurrentObject ()) {
      result << "//--- '" ;
      result << enumerator_7903.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << "' controller\n" ;
      index_7903_.increment () ;
      enumerator_7903.gotoNextObject () ;
    }
  }
  GALGAS_uint index_8255_ (0) ;
  if (in_OUTLET_5F_MAP.isValid ()) {
    cEnumerator_decoratedOutletMap enumerator_8255 (in_OUTLET_5F_MAP, kEnumeration_up) ;
    while (enumerator_8255.hasCurrentObject ()) {
      result << "  //--- Check " ;
      result << enumerator_8255.current_lkey (HERE).mAttribute_string.stringValue () ;
  ...
  if (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION.isValid ()) {
    cEnumerator_decoratedTransientMap enumerator_8592 (in_TRANSIENT_5F_MAP_5F_FOR_5F_IMPLEMENTATION, kEnumeration_up) ;
    while (enumerator_8592.hasCurrentObject ()) {
      GALGAS_uint index_8621_ (0) ;
      if (enumerator_8592.current_mDependencyList (HERE).isValid ()) {
        cEnumerator_dependanceList enumerator_8621 (enumerator_8592.current_mDependencyList (HERE), kEnumeration_up) ;
        while (enumerator_8621.hasCurrentObject ()) {
          result << "    " ;
          result << callCategoryReader_generateAddObserverCall ((const cPtr_abstractTransientDependency *) enumerator_8621.current_mDependency (HERE).ptr (), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 204)).stringValue () ;
          result << " (triggerObjectFor_" ;
          result << GALGAS_string ("preference.").add_operation (in_PREFERENCES_5F_NAME, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 204)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 204)).add_operation (enumerator_8592.current_lkey (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 204)).reader_identifierRepresentation (SOURCE_FILE ("preferences.swift.gTemplate", 204)).stringValue () ;
          result << ")\n" ;
  ...
  GALGAS_uint index_8829_ (0) ;
  if (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST.isValid ()) {
    cEnumerator_stringlist enumerator_8829 (in_CONTROLLER_5F_INSTANCIATION_5F_STRINGLIST, kEnumeration_up) ;
    while (enumerator_8829.hasCurrentObject ()) {
      result << "    mControllerArray.addObject (" ;
      result << enumerator_8829.current_mValue (HERE).stringValue () ;
      result << ")\n" ;
      index_8829_.increment () ;
  ...
  GALGAS_uint index_9907_ (0) ;
  if (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION.isValid ()) {
    cEnumerator_attributeListForGeneration enumerator_9907 (in_ATTRIBUTE_5F_LIST_5F_FOR_5F_GENERATION, kEnumeration_up) ;
    while (enumerator_9907.hasCurrentObject ()) {
      result << "    ud.setObject (" ;
      result << categoryReader_preferencesSwiftSetter (enumerator_9907.current_mAttributeType (HERE), enumerator_9907.current_mAttributeName (HERE), inCompiler COMMA_SOURCE_FILE ("preferences.swift.gTemplate", 230)).stringValue () ;
      result << ", forKey:\"" ;
      result << in_PREFERENCES_5F_NAME.stringValue () ;
      result << ":" ;
      result << enumerator_9907.current_mAttributeName (HERE).stringValue () ;
      result << "\")\n" ;
      index_9907_.increment () ;
      enumerator_9907.gotoNextObject () ;
    }
  }
  GALGAS_uint index_10066_ (0) ;
  if (in_ARRAY_5F_MAP.isValid ()) {
    cEnumerator_preferencesPropertyArrayMap enumerator_10066 (in_ARRAY_5F_MAP, kEnumeration_up) ;
    while (enumerator_10066.hasCurrentObject ()) {
      result << "  { NSMutableArray * array = [NSMutableArray new] ;\n"
        "    for ( * object in self." ;
      result << enumerator_10066.current_lkey (HERE).mAttribute_string.stringValue () ;
      result << ") {\n"
...
void routine_generatePreferences (const GALGAS_preferenceListForGeneration constinArgument_inPreferenceListForGeneration,
                                  ...
                                  C_Compiler * inCompiler
                                  COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_preferenceListForGeneration enumerator_4445 (constinArgument_inPreferenceListForGeneration, kEnumeration_up) ;
  while (enumerator_4445.hasCurrentObject ()) {
    GALGAS_string var_s = GALGAS_string (filewrapperTemplate_prefsGenerationTemplate_preferencesInSwift (inCompiler, enumerator_4445.current_mPreferenceName (HERE), enumerator_4445.current_mAttributeListForGeneration (HERE), enumerator_4445.current_mDecoratedTransientMapForGeneration (HERE), enumerator_4445.current_mOutletMap (HERE), GALGAS_preferencesPropertyArrayMap::constructor_emptyMap (SOURCE_FILE ("preferencesGeneration.gSemantics", 115)), GALGAS_controllerMap::constructor_emptyMap (SOURCE_FILE ("preferencesGeneration.gSemantics", 116)), enumerator_4445.current_mControllerInstanciationStringList (HERE) COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 110))) ;
    {
    GALGAS_string::class_method_generateFileWithPattern (constinArgument_inOutputDirectory, enumerator_4445.current_mPreferenceName (HERE).operator_concat (GALGAS_string (".swift")  COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 121)), GALGAS_string ("//"), GALGAS_string ("\n"
      "\n"), var_s, GALGAS_string ("\n"
      "\n"), GALGAS_string ("\n"
...
GALGAS_string categoryReader_preferencesSwiftSetter (const GALGAS_unifiedTypeProxy & inObject,
  ...
  if (temp_0.reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 66)).isValid ()) {
    ...
    case GALGAS_typeKind::kEnum_integerType: {
      result_outResult = GALGAS_string ("NSNumber (integer:").add_operation (constinArgument_inPropertyName, inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 69)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("preferencesGeneration.gSemantics", 69)) ;
      } break ;
    case GALGAS_typeKind::kEnum_doubleType: {
      result_outResult = GALGAS_string ("\xC3""\xA0"" compl\xC3""\xA9""ter preferencesSwiftSetter") ;
      } break ;
