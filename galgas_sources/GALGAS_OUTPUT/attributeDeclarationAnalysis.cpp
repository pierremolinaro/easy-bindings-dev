...
void routine_buildObservablePropertyMap (const GALGAS_attributeList constinArgument_inAttributeList,
  ...
  cEnumerator_classArrayList enumerator_2585 (constinArgument_inArrayList, kEnumeration_up) ;
  while (enumerator_2585.hasCurrentObject ()) {
    GALGAS_ebType var_type ;
    GALGAS_astDeclaration joker_2655_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_2585.current_mElementClassName (HERE), var_type, joker_2655_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (77)) ;
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (constinArgument_inObjectName.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (79)).operator_concat (enumerator_2585.current_mArrayName (HERE).reader_string (SOURCE_FILE_AT_LINE (79)) COMMA_SOURCE_FILE_AT_LINE (79)), enumerator_2585.current_mArrayName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (78)) ;
    {
    ioArgument_ioSelfObservableAttributeMap.modifier_insertKey (enumerator_2585.current_mArrayName (HERE), var_type, GALGAS_bool (false), var_observationDependencyKey, GALGAS_bool (true), inCompiler COMMA_SOURCE_FILE_AT_LINE (82)) ;
    }
    {
  ...
  cEnumerator_transientList enumerator_3141 (constinArgument_inTransientList, kEnumeration_up) ;
  while (enumerator_3141.hasCurrentObject ()) {
    GALGAS_ebType var_type ;
    GALGAS_astDeclaration joker_3212_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_3141.current_mTransientTypeName (HERE), var_type, joker_3212_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (96)) ;
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (constinArgument_inObjectName.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (98)).operator_concat (enumerator_3141.current_mTransientName (HERE).reader_string (SOURCE_FILE_AT_LINE (98)) COMMA_SOURCE_FILE_AT_LINE (98)), enumerator_3141.current_mTransientName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (97)) ;
    {
    ioArgument_ioSelfObservableAttributeMap.modifier_insertKey (enumerator_3141.current_mTransientName (HERE), var_type, GALGAS_bool (true), var_observationDependencyKey, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (101)) ;
    }
    {
  ...
  cEnumerator_controllerList enumerator_3710 (constinArgument_inControllerList, kEnumeration_up) ;
  while (enumerator_3710.hasCurrentObject ()) {
    GALGAS_ebType var_type ;
    GALGAS_astDeclaration joker_3783_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_3710.current_mControllerClassName (HERE), var_type, joker_3783_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (115)) ;
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (constinArgument_inObjectName.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (117)).operator_concat (enumerator_3710.current_mControllerName (HERE).reader_string (SOURCE_FILE_AT_LINE (117)) COMMA_SOURCE_FILE_AT_LINE (117)), enumerator_3710.current_mControllerName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (116)) ;
    {
    ioArgument_ioSelfObservableAttributeMap.modifier_insertKey (enumerator_3710.current_mControllerName (HERE), var_type, GALGAS_bool (false), var_observationDependencyKey, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (120)) ;
    }
    {
  ...
  cEnumerator_controllerObservablePropertyList enumerator_4317 (constinArgument_inControllerObservablePropertyList, kEnumeration_up) ;
  while (enumerator_4317.hasCurrentObject ()) {
    GALGAS_ebType var_type ;
    GALGAS_astDeclaration joker_4379_0 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_4317.current_mTypeName (HERE), var_type, joker_4379_0, inCompiler COMMA_SOURCE_FILE_AT_LINE (134)) ;
    GALGAS_lstring var_observationDependencyKey = GALGAS_lstring::constructor_new (constinArgument_inObjectName.operator_concat (GALGAS_string (".") COMMA_SOURCE_FILE_AT_LINE (136)).operator_concat (enumerator_4317.current_mPropertyName (HERE).reader_string (SOURCE_FILE_AT_LINE (136)) COMMA_SOURCE_FILE_AT_LINE (136)), enumerator_4317.current_mPropertyName (HERE).mAttribute_location COMMA_SOURCE_FILE_AT_LINE (135)) ;
    {
    ioArgument_ioSelfObservableAttributeMap.modifier_insertKey (enumerator_4317.current_mPropertyName (HERE), var_type, GALGAS_bool (false), var_observationDependencyKey, GALGAS_bool (false), inCompiler COMMA_SOURCE_FILE_AT_LINE (139)) ;
    }
    {
