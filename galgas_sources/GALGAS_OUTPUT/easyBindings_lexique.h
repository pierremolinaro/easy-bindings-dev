...
//--- Terminal symbols enumeration
  public : enum {kToken_,
   ...
   kToken_extern,
   kToken_default,
   kToken_toManyEntities,
   kToken_column,
   kToken_NSNumberFormatter,
   kToken_NSDateFormatter,
   kToken_NSFont,
   kToken_NSData,
   kToken_NSDate,
   kToken_NSColor,
...
//--- Get terminal count
  public : virtual PMSInt16 terminalVocabularyCount (void) const { return 58 ; }
