...
static void categoryMethod_structDeclaration_semanticAnalysis (const cPtr_astDeclaration * inObject,
  ...
  cEnumerator_structFieldASTList enumerator_1244 (object->mAttribute_mFieldList, kEnumeration_up) ;
  while (enumerator_1244.hasCurrentObject ()) {
    GALGAS_ebType var_type ;
    GALGAS_astDeclaration joker_1311_2 ; // Joker input parameter
    GALGAS_entityRelationshipMap joker_1311_1 ; // Joker input parameter
    constinArgument_inUnifiedTypeMap.method_searchKey (enumerator_1244.current_mFieldTypeName (HERE), var_type, joker_1311_2, joker_1311_1, inCompiler COMMA_SOURCE_FILE ("structAnalysis.gSemantics", 42)) ;
    ...
    if (kBoolTrue == test_0) {
      GALGAS_location location_1 (enumerator_1244.current_mFieldName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    const enumGalgasBool test_2 = GALGAS_bool (kIsEqual, var_type.reader_mKind (SOURCE_FILE ("structAnalysis.gSemantics", 46)).objectCompare (GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("structAnalysis.gSemantics", 46)))).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, var_type.reader_mKind (SOURCE_FILE ("structAnalysis.gSemantics", 48)).objectCompare (GALGAS_typeKind::constructor_structType (SOURCE_FILE ("structAnalysis.gSemantics", 48)))).boolEnum () ;
      if (kBoolTrue == test_3) {
    ...
    var_structFieldList.addAssign_operation (var_type, enumerator_1244.current_mFieldName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("structAnalysis.gSemantics", 51)) ;
    enumerator_1244.gotoNextObject () ;
  }
  {
