...
//--- Syntax error message for terminal '$sign$' :
static const utf32 gSyntaxErrorMessage_sign [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
//--- Unicode string for '$sign$'
static const utf32 kUnicodeString_sign [] = {
  TO_UNICODE ('s'),
  TO_UNICODE ('i'),
  TO_UNICODE ('g'),
  TO_UNICODE ('n'),
...
static const PMSInt32 ktable_size_lowerCaseKeyWordList = 43 ;
...
static const C_unicode_lexique_table_entry ktable_for_lowerCaseKeyWordList [ktable_size_lowerCaseKeyWordList] = {
  ...
  C_unicode_lexique_table_entry (kUnicodeString_sign, 4, C_Lexique_easyBindings_5F_lexique::kToken_sign),
...
GALGAS_stringlist C_Lexique_easyBindings_5F_lexique::symbols (LOCATION_ARGS) {
  ...
  result.addAssign_operation (GALGAS_string ("sign") COMMA_THERE) ;
