...
//--- Syntax error message for terminal '$plainOldData$' :
static const utf32 gSyntaxErrorMessage_plainOldData [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
void C_Lexique_easyBindings_5F_lexique::appendTerminalMessageToSyntaxErrorMessage (const PMSInt16 inTerminalIndex,
  ...
  static const utf32 * syntaxErrorMessageArray [86] = {kEndOfSourceLexicalErrorMessage,
    ...
    gSyntaxErrorMessage_plainOldData,
...
//--- Unicode string for '$plainOldData$'
static const utf32 kUnicodeString_plainOldData [] = {
  TO_UNICODE ('p'),
  TO_UNICODE ('l'),
  TO_UNICODE ('a'),
  TO_UNICODE ('i'),
...
static const PMSInt32 ktable_size_lowerCaseKeyWordList = 44 ;
...
static const C_unicode_lexique_table_entry ktable_for_lowerCaseKeyWordList [ktable_size_lowerCaseKeyWordList] = {
  ...
  C_unicode_lexique_table_entry (kUnicodeString_plainOldData, 12, C_Lexique_easyBindings_5F_lexique::kToken_plainOldData),
...
C_String C_Lexique_easyBindings_5F_lexique::getCurrentTokenString (const cToken * inTokenPtr) const {
  ...
  if (ptr == NULL) {
    ...
    case kToken_entityController:
      ...
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      break ;
    case kToken_plainOldData:
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      s.appendCString ("plainOldData") ;
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      break ;
...
static const bool kEndOfScriptInTemplateArray [85] = {
  false /* identifier */,
  false /* Identifier */,
  false /* binding */,
...
GALGAS_stringlist C_Lexique_easyBindings_5F_lexique::symbols (LOCATION_ARGS) {
  ...
  result.addAssign_operation (GALGAS_string ("plainOldData") COMMA_THERE) ;
