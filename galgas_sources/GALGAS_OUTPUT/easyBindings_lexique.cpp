...
//--- Syntax error message for terminal '$treeController$' :
static const utf32 gSyntaxErrorMessage_treeController [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
static const utf32 gSyntaxErrorMessage_objectController [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
//--- Syntax error message for terminal '$entityArrayController$' :
static const utf32 gSyntaxErrorMessage_entityArrayController [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
//--- Syntax error message for terminal '$entityController$' :
static const utf32 gSyntaxErrorMessage_entityController [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
//--- Syntax error message for terminal '$selection$' :
static const utf32 gSyntaxErrorMessage_selection [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
//--- Syntax error message for terminal '$AnyNumber$' :
static const utf32 gSyntaxErrorMessage_AnyNumber [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
//--- Syntax error message for terminal '$AnyScalar$' :
static const utf32 gSyntaxErrorMessage_AnyScalar [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('h'),
  TO_UNICODE ('e'),
  TO_UNICODE (' '),
...
C_String C_Lexique_easyBindings_5F_lexique::getMessageForTerminal (const int16_t inTerminalIndex) const {
  static const utf32 * syntaxErrorMessageArray [75] = {kEndOfSourceLexicalErrorMessage,
    ...
    gSyntaxErrorMessage_treeController,
    gSyntaxErrorMessage_arrayController,
    gSyntaxErrorMessage_objectController,
    gSyntaxErrorMessage_entityArrayController,
    gSyntaxErrorMessage_entityController,
    ...
    gSyntaxErrorMessage_AnyNumber,
    gSyntaxErrorMessage_AnyScalar,
...
//--- Unicode string for '$AnyNumber$'
static const utf32 kUnicodeString_AnyNumber [] = {
  TO_UNICODE ('A'),
  TO_UNICODE ('n'),
  TO_UNICODE ('y'),
  TO_UNICODE ('N'),
...
//--- Unicode string for '$AnyScalar$'
static const utf32 kUnicodeString_AnyScalar [] = {
  TO_UNICODE ('A'),
  TO_UNICODE ('n'),
  TO_UNICODE ('y'),
  TO_UNICODE ('S'),
...
//--- Unicode string for '$entityArrayController$'
static const utf32 kUnicodeString_entityArrayController [] = {
  TO_UNICODE ('e'),
  TO_UNICODE ('n'),
  TO_UNICODE ('t'),
  TO_UNICODE ('i'),
...
//--- Unicode string for '$entityController$'
static const utf32 kUnicodeString_entityController [] = {
  TO_UNICODE ('e'),
  TO_UNICODE ('n'),
  TO_UNICODE ('t'),
  TO_UNICODE ('i'),
...
static const utf32 kUnicodeString_objectController [] = {
  TO_UNICODE ('o'),
  TO_UNICODE ('b'),
  TO_UNICODE ('j'),
  TO_UNICODE ('e'),
...
//--- Unicode string for '$selection$'
static const utf32 kUnicodeString_selection [] = {
  TO_UNICODE ('s'),
  TO_UNICODE ('e'),
  TO_UNICODE ('l'),
  TO_UNICODE ('e'),
...
//--- Unicode string for '$treeController$'
static const utf32 kUnicodeString_treeController [] = {
  TO_UNICODE ('t'),
  TO_UNICODE ('r'),
  TO_UNICODE ('e'),
  TO_UNICODE ('e'),
...
static const int32_t ktable_size_bindingKeyWordList = 5 ;
...
int16_t C_Lexique_easyBindings_5F_lexique::search_into_bindingKeyWordList (const C_String & inSearchedString) {
...
static const int32_t ktable_size_lowerCaseKeyWordList = 41 ;
...
static const C_unicode_lexique_table_entry ktable_for_lowerCaseKeyWordList [ktable_size_lowerCaseKeyWordList] = {
  ...
  C_unicode_lexique_table_entry (kUnicodeString_option, 6, C_Lexique_easyBindings_5F_lexique::kToken_option),
  ...
  C_unicode_lexique_table_entry (kUnicodeString_selection, 9, C_Lexique_easyBindings_5F_lexique::kToken_selection),
  ...
  C_unicode_lexique_table_entry (kUnicodeString_treeController, 14, C_Lexique_easyBindings_5F_lexique::kToken_treeController),
  C_unicode_lexique_table_entry (kUnicodeString_arrayController, 15, C_Lexique_easyBindings_5F_lexique::kToken_arrayController),
  C_unicode_lexique_table_entry (kUnicodeString_entityController, 16, C_Lexique_easyBindings_5F_lexique::kToken_entityController),
  C_unicode_lexique_table_entry (kUnicodeString_objectController, 16, C_Lexique_easyBindings_5F_lexique::kToken_objectController),
  ...
  C_unicode_lexique_table_entry (kUnicodeString_entityArrayController, 21, C_Lexique_easyBindings_5F_lexique::kToken_entityArrayController)
} ;
...
static const int32_t ktable_size_upperCaseKeyWordList = 6 ;
...
static const C_unicode_lexique_table_entry ktable_for_upperCaseKeyWordList [ktable_size_upperCaseKeyWordList] = {
  ...
  C_unicode_lexique_table_entry (kUnicodeString_AnyNumber, 9, C_Lexique_easyBindings_5F_lexique::kToken_AnyNumber),
  C_unicode_lexique_table_entry (kUnicodeString_AnyScalar, 9, C_Lexique_easyBindings_5F_lexique::kToken_AnyScalar),
...
int16_t C_Lexique_easyBindings_5F_lexique::search_into_upperCaseKeyWordList (const C_String & inSearchedString) {
...
C_String C_Lexique_easyBindings_5F_lexique::getCurrentTokenString (const cToken * inTokenPtr) const {
  ...
  if (ptr == NULL) {
    ...
    case kToken_controllerTemplate:
      ...
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      break ;
    case kToken_treeController:
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      s.appendCString ("treeController") ;
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      break ;
    ...
    case kToken_objectController:
      ...
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      break ;
    case kToken_entityArrayController:
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      s.appendCString ("entityArrayController") ;
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      break ;
    case kToken_entityController:
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      s.appendCString ("entityController") ;
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      break ;
    case kToken_struct:
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
    ...
    case kToken_class:
      ...
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      break ;
    case kToken_selection:
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      s.appendCString ("selection") ;
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      break ;
    case kToken_end:
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
    ...
    case kToken_NSDateFormatter:
      ...
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      break ;
    case kToken_AnyNumber:
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      s.appendCString ("AnyNumber") ;
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      break ;
    case kToken_AnyScalar:
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      s.appendCString ("AnyScalar") ;
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
      break ;
    case kToken_YES:
      s.appendUnicodeCharacter (TO_UNICODE ('$') COMMA_HERE) ;
...
GALGAS_stringlist C_Lexique_easyBindings_5F_lexique::symbols (LOCATION_ARGS) {
  ...
  result.addAssign_operation (GALGAS_string ("treeController") COMMA_THERE) ;
  ...
  result.addAssign_operation (GALGAS_string ("entityArrayController") COMMA_THERE) ;
  result.addAssign_operation (GALGAS_string ("entityController") COMMA_THERE) ;
  ...
  result.addAssign_operation (GALGAS_string ("selection") COMMA_THERE) ;
  ...
  result.addAssign_operation (GALGAS_string ("AnyNumber") COMMA_THERE) ;
  result.addAssign_operation (GALGAS_string ("AnyScalar") COMMA_THERE) ;
