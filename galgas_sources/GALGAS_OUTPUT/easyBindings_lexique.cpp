...
void C_Lexique_easyBindings_5F_lexique::appendTerminalMessageToSyntaxErrorMessage (const PMSInt16 inTerminalIndex,
  ...
  static const utf32 * syntaxErrorMessageArray [63] = {kEndOfSourceLexicalErrorMessage,
...
static const PMSInt32 ktable_size_bindingKeyWordList = 4 ;
...
static const PMSInt32 ktable_size_lowerCaseKeyWordList = 35 ;
...
static const bool kEndOfScriptInTemplateArray [62] = {
  false /* identifier */,
  false /* Identifier */,
  false /* binding */,
...
GALGAS_stringlist C_Lexique_easyBindings_5F_lexique::symbols (LOCATION_ARGS) {
  ...
  result.addAssign_operation (GALGAS_string ("integer16") COMMA_THERE) ;
  result.addAssign_operation (GALGAS_string ("integer32") COMMA_THERE) ;
  result.addAssign_operation (GALGAS_string ("integer64") COMMA_THERE) ;
