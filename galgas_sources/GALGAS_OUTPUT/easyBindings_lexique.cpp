...
static const int32_t ktable_size_lowerCaseKeyWordList = 31 ;
...
static const int32_t ktable_size_reservedBindingNameKeyWordList = 2 ;

static const C_unicode_lexique_table_entry ktable_for_reservedBindingNameKeyWordList [ktable_size_reservedBindingNameKeyWordList] = {
...
int16_t C_Lexique_easyBindings_5F_lexique::search_into_reservedBindingNameKeyWordList (const C_String & inSearchedString) {
  return searchInList (inSearchedString, ktable_for_reservedBindingNameKeyWordList, ktable_size_reservedBindingNameKeyWordList) ;
}
