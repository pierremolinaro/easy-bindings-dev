...
void routine_unifiedTypeAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  while (enumerator_11471.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_16) {
      GALGAS_location location_17 (enumerator_11471.current_mSelectorName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (kBoolTrue == test_18) {
      GALGAS_location location_19 (enumerator_11471.current_mOutletName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_19, GALGAS_string ("internal error")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 324)) ;
    }else if (kBoolFalse == test_18) {
      cEnumerator_unifiedTypeProxySelectorList enumerator_13185 (var_modelPropertyTypeList, kEnumeration_up) ;
      cEnumerator_unifiedTypeProxySelectorList enumerator_13221 (var_boundPropertyTypeList, kEnumeration_up) ;
      while (enumerator_13185.hasCurrentObject () && enumerator_13221.hasCurrentObject ()) {
        const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_13185.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 327)).objectCompare (GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("typeAnalysis.gSemantics", 327)))).operator_and (GALGAS_bool (kIsEqual, enumerator_13221.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 327)).objectCompare (GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("typeAnalysis.gSemantics", 327)))) COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 327)).boolEnum () ;
        if (kBoolTrue == test_20) {
        }else if (kBoolFalse == test_20) {
          const enumGalgasBool test_21 = GALGAS_bool (kIsNotEqual, enumerator_13185.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 329)).objectCompare (enumerator_13221.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 329)))).boolEnum () ;
          if (kBoolTrue == test_21) {
            GALGAS_location location_22 (enumerator_13221.current_mSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_22, GALGAS_string ("the type of the observable property is '").add_operation (enumerator_13221.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 330)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 330)).add_operation (GALGAS_string ("', but this binding requires the '"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 330)).add_operation (enumerator_13185.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 331)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 331)).add_operation (GALGAS_string ("' type"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 331))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 330)) ;
          }
        }
        const enumGalgasBool test_23 = GALGAS_bool (kIsNotEqual, enumerator_13185.current_mSelector (HERE).mAttribute_string.objectCompare (enumerator_13221.current_mSelector (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_23) {
          GALGAS_location location_24 (enumerator_13221.current_mSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_24, GALGAS_string ("the selector of the observable property should be '").add_operation (enumerator_13185.current_mSelector (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 335)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 335)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 335))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 335)) ;
        }
    ...
    const enumGalgasBool test_25 = GALGAS_bool (kIsNotEqual, var_controllerBindingOptionDecoratedList.reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 341)).objectCompare (enumerator_11471.current_mBindingOptionList (HERE).reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 341)))).boolEnum () ;
    if (kBoolTrue == test_25) {
      ...
      if (kBoolTrue == test_26) {
        ...
        cEnumerator_controllerBindingOptionDecoratedList enumerator_14284 (var_controllerBindingOptionDecoratedList, kEnumeration_up) ;
        while (enumerator_14284.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").add_operation (enumerator_14284.current_mOptionName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 348)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 348)).add_operation (GALGAS_string (" : "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 348)).add_operation (enumerator_14284.current_mOptionType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 348)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 348))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 348)) ;
          enumerator_14284.gotoNextObject () ;
        }
      }
      GALGAS_location location_27 (enumerator_11471.current_mBindingName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_27, var_s  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 351)) ;
    }else if (kBoolFalse == test_25) {
      cEnumerator_controllerBindingOptionDecoratedList enumerator_14493 (var_controllerBindingOptionDecoratedList, kEnumeration_up) ;
      cEnumerator_bindingOptionList enumerator_14528 (enumerator_11471.current_mBindingOptionList (HERE), kEnumeration_up) ;
      while (enumerator_14493.hasCurrentObject () && enumerator_14528.hasCurrentObject ()) {
        const enumGalgasBool test_28 = GALGAS_bool (kIsNotEqual, enumerator_14493.current_mOptionName (HERE).mAttribute_string.objectCompare (enumerator_14528.current_mOptionName (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_28) {
          GALGAS_location location_29 (enumerator_14528.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_29, GALGAS_string ("the option name should be '").add_operation (enumerator_14493.current_mOptionName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 355)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 355)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 355))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 355)) ;
        }
        ...
        temp_30.addAssign_operation (enumerator_14493.current_mOptionType (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 358)) ;
        callCategoryMethod_analyzeDefaultValueType ((const cPtr_abstractDefaultValue *) enumerator_14528.current_mOptionValue (HERE).ptr (), temp_30, var_optionValueAsString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 357)) ;
        var_bindingOptionString.dotAssign_operation (GALGAS_string (", ").add_operation (enumerator_14493.current_mOptionName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 361)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 361)).add_operation (var_optionValueAsString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 361))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 361)) ;
        enumerator_14493.gotoNextObject () ;
        enumerator_14528.gotoNextObject () ;
      }
    }
    GALGAS_string var_title = GALGAS_string::makeEmptyString () ;
    cEnumerator__32_stringlist enumerator_15087 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_15087.hasCurrentObject ()) {
      var_title.dotAssign_operation (enumerator_15087.current_mValue_30_ (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 367)).add_operation (enumerator_15087.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 367))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 367)) ;
    ...
    cEnumerator__32_stringlist enumerator_15574 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_15574.hasCurrentObject ()) {
      var_templateStringWithReplacements = var_templateStringWithReplacements.reader_stringByReplacingStringByString (GALGAS_string ("$OBJECTCLASS$"), enumerator_15574.current_mValue_30_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 374)) ;
      var_templateStringWithReplacements = var_templateStringWithReplacements.reader_stringByReplacingStringByString (GALGAS_string ("$MODEL$"), enumerator_15574.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 375)) ;
    ...
    cEnumerator__32_stringlist enumerator_16120 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_16120.hasCurrentObject ()) {
      var_controllerInstanciationString.dotAssign_operation (GALGAS_string ("_").add_operation (enumerator_16120.current_mValue_30_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 382)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 382)).add_operation (enumerator_16120.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 382))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 382)) ;
      enumerator_16120.gotoNextObject () ;
    }
    ...
    cEnumerator_stringlist enumerator_16364 (var_boundObjectNameList, kEnumeration_up) ;
    GALGAS_uint index_16337 ((uint32_t) 0) ;
    while (enumerator_16364.hasCurrentObject ()) {
      var_controllerInstanciationString.dotAssign_operation (var_prefix.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 387)).add_operation (enumerator_16364.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 387)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 387))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 387)) ;
      var_prefix = GALGAS_string ("object").add_operation (index_16337.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 388)).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 388)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 388)) ;
      enumerator_16364.gotoNextObject () ;
      index_16337.increment_operation (inCompiler  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 386)) ;
    }
  ...
  cEnumerator_actionMap enumerator_16762 (constinArgument_inActionMap, kEnumeration_up) ;
  while (enumerator_16762.hasCurrentObject ()) {
    ioArgument_ioGeneration.mAttribute_mActionListForGeneration.addAssign_operation (constinArgument_inTypeName.mAttribute_string, enumerator_16762.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 395)) ;
...
static void categoryMethod_selfObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_bool joker_26477_0 ; // Joker input parameter
  GALGAS_lstring joker_26505_0 ; // Joker input parameter
  constinArgument_inObservablePropertyMap.method_searchKey (object->mAttribute_mSelfObservablePropertyName, var_propertyType, joker_26477_0, joker_26505_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 650)) ;
...
static void categoryMethod_rootObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool joker_27812_0 ; // Joker input parameter
  GALGAS_lstring joker_27840_0 ; // Joker input parameter
  GALGAS_bool joker_27876_0 ; // Joker input parameter
  constinArgument_inRootEntityType.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 685)).method_searchKey (object->mAttribute_mRootObservablePropertyName, var_propertyType, joker_27812_0, joker_27840_0, joker_27876_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 685)) ;
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeProxy joker_29179_5 ; // Joker input parameter
  GALGAS_unifiedTypeProxy joker_29179_4 ; // Joker input parameter
  GALGAS_decoratedAttributeMap joker_29179_3 ; // Joker input parameter
  GALGAS_decoratedTransientMap joker_29179_2 ; // Joker input parameter
  GALGAS_decoratedOutletMap joker_29179_1 ; // Joker input parameter
  GALGAS_decoratedEntityRelationshipMap joker_29247_6 ; // Joker input parameter
  GALGAS_actionMap joker_29247_5 ; // Joker input parameter
  GALGAS_bindingList joker_29247_4 ; // Joker input parameter
  GALGAS_lstringlist joker_29247_3 ; // Joker input parameter
  GALGAS_enumConstantMap joker_29247_2 ; // Joker input parameter
  GALGAS_arrayControllerMap joker_29247_1 ; // Joker input parameter
  constinArgument_inUnifiedTypeMap.method_searchKey (object->mAttribute_mPreferenceName, var_typeKind, joker_29179_5, joker_29179_4, joker_29179_3, joker_29179_2, joker_29179_1, var_observablePropertyMap, joker_29247_6, joker_29247_5, joker_29247_4, joker_29247_3, joker_29247_2, joker_29247_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 721)) ;
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_29524_0 ; // Joker input parameter
  GALGAS_lstring joker_29552_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceObservablePropertyName, var_propertyType, joker_29524_0, joker_29552_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 732)) ;
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_abstractObservablePropertyAST joker_30736_0 ; // Joker input parameter
  GALGAS_lstring joker_30788_3 ; // Joker input parameter
  GALGAS_arrayControllerBoundColumnListAST joker_30788_2 ; // Joker input parameter
  GALGAS_actionMap joker_30788_1 ; // Joker input parameter
  GALGAS_lstring joker_30871_0 ; // Joker input parameter
  constinArgument_inArrayControllerMap.method_searchKey (object->mAttribute_mArrayControllerName, joker_30736_0, joker_30788_3, joker_30788_2, joker_30788_1, var_arrayControllerObservablePropertyMap, joker_30871_0, var_observedTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 766)) ;
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_31055_0 ; // Joker input parameter
  GALGAS_lstring joker_31084_0 ; // Joker input parameter
  var_arrayControllerObservablePropertyMap.method_searchKey (object->mAttribute_mArrayControllerObservablePropertyName, var_propertyType, joker_31055_0, joker_31084_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 775)) ;
...
static void categoryMethod_selfObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_33354_0 ; // Joker input parameter
  constinArgument_inObservablePropertyMap.method_searchKey (object->mAttribute_mSelfObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_33354_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 834)) ;
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_typeKind var_typeKind ;
  GALGAS_decoratedObservablePropertyMap var_observablePropertyMap ;
  GALGAS_unifiedTypeProxy joker_36397_5 ; // Joker input parameter
  GALGAS_unifiedTypeProxy joker_36397_4 ; // Joker input parameter
  GALGAS_decoratedAttributeMap joker_36397_3 ; // Joker input parameter
  GALGAS_decoratedTransientMap joker_36397_2 ; // Joker input parameter
  GALGAS_decoratedOutletMap joker_36397_1 ; // Joker input parameter
  GALGAS_decoratedEntityRelationshipMap joker_36465_6 ; // Joker input parameter
  GALGAS_actionMap joker_36465_5 ; // Joker input parameter
  GALGAS_bindingList joker_36465_4 ; // Joker input parameter
  GALGAS_lstringlist joker_36465_3 ; // Joker input parameter
  GALGAS_enumConstantMap joker_36465_2 ; // Joker input parameter
  GALGAS_arrayControllerMap joker_36465_1 ; // Joker input parameter
  constinArgument_inUnifiedTypeMap.method_searchKey (object->mAttribute_mPreferenceName, var_typeKind, joker_36397_5, joker_36397_4, joker_36397_3, joker_36397_2, joker_36397_1, var_observablePropertyMap, joker_36465_6, joker_36465_5, joker_36465_4, joker_36465_3, joker_36465_2, joker_36465_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 905)) ;
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_36767_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_36767_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 916)) ;
  const enumGalgasBool test_2 = var_isCollection.boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mPreferenceObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_decoratedObservablePropertyMap var_arrayControllerObservablePropertyMap ;
  GALGAS_lstring joker_38070_3 ; // Joker input parameter
  GALGAS_arrayControllerBoundColumnListAST joker_38070_2 ; // Joker input parameter
  GALGAS_actionMap joker_38070_1 ; // Joker input parameter
  GALGAS_lstring joker_38153_2 ; // Joker input parameter
  GALGAS_string joker_38153_1 ; // Joker input parameter
  constinArgument_inArrayControllerMap.method_searchKey (object->mAttribute_mArrayControllerName, var_boundModel, joker_38070_3, joker_38070_2, joker_38070_1, var_arrayControllerObservablePropertyMap, joker_38153_2, joker_38153_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 948)) ;
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_38332_0 ; // Joker input parameter
  var_arrayControllerObservablePropertyMap.method_searchKey (object->mAttribute_mArrayControllerObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_38332_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 956)) ;
  const enumGalgasBool test_0 = var_isCollection.boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mArrayControllerObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
...
static void categoryMethod_rootObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_lstring joker_40586_0 ; // Joker input parameter
  constinArgument_inCurrentRelationshipMap.method_searchKey (object->mAttribute_mRootObservablePropertyName, var_mIsToMany, outArgument_outRelationshipTypeProxy, joker_40586_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1009)) ;
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientRootRelationshipDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  GALGAS_bool joker_49891_0 ; // Joker input parameter
  GALGAS_lstring joker_49934_0 ; // Joker input parameter
  constinArgument_inRootEntityType.reader_mCurrentRelationshipMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1268)).method_searchKey (object->mAttribute_mRelationshipName, joker_49891_0, var_elementType, joker_49934_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1268)) ;
