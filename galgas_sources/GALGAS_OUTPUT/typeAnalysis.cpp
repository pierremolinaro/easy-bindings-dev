...
//                                         september 29th, 2014, at 20h28'59"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
void routine_unifiedTypeAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  while (enumerator_4333.hasCurrentObject ()) {
    ...
    if (enumerator_4333.current_mEnabledBindingDescriptor (HERE).isValid ()) {
      ...
      case GALGAS_enabledBindingDescriptor::kEnum_enabledBinding: {
        const cEnumAssociatedValues_enabledBindingDescriptor_enabledBinding * extractPtr_6454 = dynamic_cast<const cEnumAssociatedValues_enabledBindingDescriptor_enabledBinding *> (enumerator_4333.current_mEnabledBindingDescriptor (HERE).unsafePointer ()) ;
        const GALGAS_abstractBooleanMultipleBindingExpressionAST extractedValue_expression = extractPtr_6454->mAssociatedValue0 ;
        ...
        cEnumerator_stringlist enumerator_5984 (callCategoryReader_observedObjectList ((const cPtr_abstractBooleanMultipleBindingExpressionForGeneration *) var_enableExpression.ptr (), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 157)), kEnumeration_up) ;
        GALGAS_uint index_5939 ((uint32_t) 0) ;
        while (enumerator_5984.hasCurrentObject ()) {
          var_controllerInstanciation.dotAssign_operation (GALGAS_string ("object").add_operation (index_5939.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 158)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 158)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 158)).add_operation (enumerator_5984.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 158)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 158))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 158)) ;
          enumerator_5984.gotoNextObject () ;
          index_5939.increment_operation (inCompiler  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 157)) ;
        }
  ...
  cEnumerator_decoratedEntityRelationshipMap enumerator_6630 (constinArgument_inCurrentRelationshipMap, kEnumeration_up) ;
  while (enumerator_6630.hasCurrentObject ()) {
    ...
    enumerator_6630.current_mRelationshipType (HERE).reader_mCurrentRelationshipMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 172)).method_searchKey (enumerator_6630.current_mOppositeRelationshipName (HERE), var_oppositeRelationIsToMany, var_oppositeRelationshipType, var_oppositeOfOppositeRelationshipName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 172)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_oppositeOfOppositeRelationshipName.mAttribute_string.objectCompare (enumerator_6630.current_lkey (HERE).mAttribute_string)).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_location location_4 (enumerator_6630.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, GALGAS_string ("the opposite relationship is '").operator_concat (enumerator_6630.current_mOppositeRelationshipName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 179))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 179)).operator_concat (GALGAS_string ("' and names '")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 179)).operator_concat (var_oppositeOfOppositeRelationshipName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 180))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 180)).operator_concat (GALGAS_string ("' as opposite, instead of '")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 180)).operator_concat (enumerator_6630.current_lkey (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 180))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 180)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 180))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 179)) ;
    }
    ...
    if (kBoolTrue == test_5) {
      GALGAS_location location_6 (enumerator_6630.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_6, GALGAS_string ("the opposite relationship type is '").operator_concat (var_oppositeRelationshipType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 183))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 183)).operator_concat (GALGAS_string ("', instead of '")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 183)).operator_concat (enumerator_6630.current_lkey (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 183))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 183)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 183))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 183)) ;
    }
    var_entityRelationshipListForGeneration.addAssign_operation (enumerator_6630.current_lkey (HERE).mAttribute_string, enumerator_6630.current_mIsToMany (HERE), enumerator_6630.current_mRelationshipType (HERE), enumerator_6630.current_mOppositeRelationshipName (HERE).mAttribute_string, var_oppositeRelationIsToMany  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 185)) ;
  ...
  cEnumerator_arrayControllerMap enumerator_7732 (constinArgument_inArrayControllerMap, kEnumeration_up) ;
  while (enumerator_7732.hasCurrentObject ()) {
    ...
    callCategoryMethod_analyzeBoundObservablePropertyForArrayControllerBinding ((const cPtr_abstractObservablePropertyAST *) enumerator_7732.current_mBoundModel (HERE).ptr (), constinArgument_inRootEntityType.reader_mCurrentRelationshipMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 198)), var_outElementTypeProxy, var_outBoundRootTomanyRelationshipName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 197)) ;
    GALGAS_lstring var_outletTypeName ;
    GALGAS_runActionDescriptor joker_8120_2 ; // Joker input parameter
    GALGAS_enabledBindingDescriptor joker_8120_1 ; // Joker input parameter
    constinArgument_decoratedOutletMap.method_searchKey (enumerator_7732.current_mTableViewOutletName (HERE), var_outletTypeName, joker_8120_2, joker_8120_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 203)) ;
    ...
    if (kBoolTrue == test_7) {
      GALGAS_location location_8 (enumerator_7732.current_mTableViewOutletName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    cEnumerator_arrayControllerBoundColumnListAST enumerator_8457 (enumerator_7732.current_mArrayControllerBoundColumnListAST (HERE), kEnumeration_up) ;
    while (enumerator_8457.hasCurrentObject ()) {
      GALGAS_unifiedTypeProxy var_propertyType ;
      GALGAS_bool var_mIsCollection ;
      GALGAS_bool joker_8606_0 ; // Joker input parameter
      GALGAS_lstring joker_8647_0 ; // Joker input parameter
      var_outElementTypeProxy.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 210)).method_searchKey (enumerator_8457.current_mObservablePropertyName (HERE), var_propertyType, joker_8606_0, joker_8647_0, var_mIsCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 210)) ;
      const enumGalgasBool test_9 = var_mIsCollection.boolEnum () ;
      if (kBoolTrue == test_9) {
        GALGAS_location location_10 (enumerator_8457.current_mObservablePropertyName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      ...
      var_arrayControllerBoundColumnListForGeneration.addAssign_operation (enumerator_8457.current_mColumnName (HERE).mAttribute_string, enumerator_8457.current_mColumnOutletTypeName (HERE).mAttribute_string, enumerator_8457.current_mObservablePropertyName (HERE).mAttribute_string, var_propertyType, enumerator_8457.current_mBindingOptionList (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 220)) ;
      enumerator_8457.gotoNextObject () ;
    }
    var_documentArrayControllerForGeneration.addAssign_operation (enumerator_7732.current_lkey (HERE).mAttribute_string, constinArgument_inRootEntityType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 230)), var_outBoundRootTomanyRelationshipName.mAttribute_string, var_outElementTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 232)), enumerator_7732.current_mTableViewOutletName (HERE).mAttribute_string, var_arrayControllerBoundColumnListForGeneration  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 228)) ;
  ...
  cEnumerator_decoratedTransientMap enumerator_9659 (constinArgument_decoratedTransientMap, kEnumeration_up) ;
  while (enumerator_9659.hasCurrentObject ()) {
    ...
    cEnumerator_dependanceList enumerator_9779 (enumerator_9659.current_mDependencyList (HERE), kEnumeration_up) ;
    while (enumerator_9779.hasCurrentObject ()) {
      const enumGalgasBool test_11 = categoryReader_suitableForObservableProperty (enumerator_9659.current_mTransientType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 243)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 243)).operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 243)).boolEnum () ;
      if (kBoolTrue == test_11) {
        GALGAS_location location_12 (enumerator_9659.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_9659.current_mTransientType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 244))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 244)).operator_concat (GALGAS_string ("' type is not acceptable for transient")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 244))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 244)) ;
      }
      callCategoryMethod_transientDependencySemanticAnalysis ((const cPtr_abstractTransientDependencyAST *) enumerator_9779.current_mDependency (HERE).ptr (), constinArgument_inUnifiedTypeMap, enumerator_9659.current_lkey (HERE), constinArgument_inAllObservablePropertyMap, constinArgument_inArrayControllerMap, constinArgument_inRootEntityType, enumerator_9659.current_mTransientSignature (HERE), var_transientDependencyListForGeneration, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 246)) ;
    ...
    cEnumerator_dependanceList enumerator_10357 (enumerator_9659.current_mDependencyList (HERE), kEnumeration_up) ;
    while (enumerator_10357.hasCurrentObject ()) {
      var_dependencyListForGeneration.addAssign_operation (callCategoryReader_buildDecoratedRepresentation ((const cPtr_abstractTransientDependencyAST *) enumerator_10357.current_mDependency (HERE).ptr (), constinArgument_inRootEntityType, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 258))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 258)) ;
      enumerator_10357.gotoNextObject () ;
    }
    var_transientDefinitionListForGeneration.addAssign_operation (enumerator_9659.current_lkey (HERE).mAttribute_string, enumerator_9659.current_mTransientType (HERE), enumerator_9659.current_mTransientSignature (HERE), var_dependencyListForGeneration  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 260)) ;
    ioArgument_ioGeneration.mAttribute_mTransientListForGeneration.addAssign_operation (enumerator_9659.current_mTransientSignature (HERE).mAttribute_string, enumerator_9659.current_mTransientType (HERE), var_transientDependencyListForGeneration  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 266)) ;
  ...
  cEnumerator_decoratedAttributeMap enumerator_10914 (constinArgument_decoratedAttributeMap, kEnumeration_up) ;
  while (enumerator_10914.hasCurrentObject ()) {
    ...
    temp_13.addAssign_operation (enumerator_10914.current_mAttributeType (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 272)) ;
    callCategoryMethod_analyzeDefaultValueType ((const cPtr_abstractDefaultValue *) enumerator_10914.current_mDefaultValue (HERE).ptr (), temp_13, var_swiftDefaultValueAsString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 271)) ;
    var_attributeListForGeneration.addAssign_operation (enumerator_10914.current_mAttributeType (HERE), enumerator_10914.current_lkey (HERE).mAttribute_string, var_swiftDefaultValueAsString, enumerator_10914.current_mNeedsValidation (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 275)) ;
    const enumGalgasBool test_14 = enumerator_10914.current_mNeedsValidation (HERE).boolEnum () ;
    if (kBoolTrue == test_14) {
      ioArgument_ioGeneration.mAttribute_mValidationStubRoutineListForGeneration.addAssign_operation (constinArgument_inTypeName.mAttribute_string, enumerator_10914.current_lkey (HERE).mAttribute_string, categoryReader_swiftTypeName (enumerator_10914.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 280))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 277)) ;
    }
    enumerator_10914.gotoNextObject () ;
  }
  cEnumerator_bindingList enumerator_11471 (constinArgument_inBindingList, kEnumeration_up) ;
  while (enumerator_11471.hasCurrentObject ()) {
    ...
    callCategoryMethod_analyzeBoundObservablePropertyForSimpleBinding ((const cPtr_abstractObservablePropertyAST *) enumerator_11471.current_mObservableProperty (HERE).ptr (), constinArgument_inUnifiedTypeMap, constinArgument_inArrayControllerMap, enumerator_11471.current_mSelectorName (HERE), constinArgument_inTypeName.mAttribute_string, constinArgument_inCurrentObservablePropertyMap, constinArgument_inRootEntityType, var_controllerSignature, var_boundPropertyTypeList, var_typePropertyNameList, var_boundObjectNameList, var_modelIsTransient, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 290)) ;
    GALGAS_lstring var_outletTypeName ;
    GALGAS_runActionDescriptor joker_12138_2 ; // Joker input parameter
    GALGAS_enabledBindingDescriptor joker_12138_1 ; // Joker input parameter
    constinArgument_decoratedOutletMap.method_searchKey (enumerator_11471.current_mOutletName (HERE), var_outletTypeName, joker_12138_2, joker_12138_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 303)) ;
    var_controllerSignature = var_outletTypeName.mAttribute_string.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 304)).add_operation (enumerator_11471.current_mBindingName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 304)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 304)).add_operation (var_controllerSignature, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 304)) ;
    GALGAS_lstring var_controllerTemplateName = GALGAS_lstring::constructor_new (var_controllerSignature, enumerator_11471.current_mBindingName (HERE).mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 305)) ;
    ...
    if (kBoolTrue == test_15) {
      GALGAS_location location_16 (enumerator_11471.current_mSelectorName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
    ...
    if (kBoolTrue == test_17) {
      GALGAS_location location_18 (enumerator_11471.current_mOutletName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_18, GALGAS_string ("internal error")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 324)) ;
    }else if (kBoolFalse == test_17) {
      cEnumerator_unifiedTypeProxySelectorList enumerator_13184 (var_modelPropertyTypeList, kEnumeration_up) ;
      cEnumerator_unifiedTypeProxySelectorList enumerator_13220 (var_boundPropertyTypeList, kEnumeration_up) ;
      while (enumerator_13184.hasCurrentObject () && enumerator_13220.hasCurrentObject ()) {
        const enumGalgasBool test_19 = GALGAS_bool (kIsEqual, enumerator_13184.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 327)).objectCompare (GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("typeAnalysis.gSemantics", 327)))).operator_and (GALGAS_bool (kIsEqual, enumerator_13220.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 327)).objectCompare (GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("typeAnalysis.gSemantics", 327)))) COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 327)).boolEnum () ;
        if (kBoolTrue == test_19) {
        }else if (kBoolFalse == test_19) {
          const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_13184.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 329)).objectCompare (enumerator_13220.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 329)))).boolEnum () ;
          if (kBoolTrue == test_20) {
            GALGAS_location location_21 (enumerator_13220.current_mSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_21, GALGAS_string ("the type of the observable property is '").add_operation (enumerator_13220.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 330)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 330)).add_operation (GALGAS_string ("', but this binding requires the '"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 330)).add_operation (enumerator_13184.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 331)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 331)).add_operation (GALGAS_string ("' type"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 331))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 330)) ;
          }
        }
        const enumGalgasBool test_22 = GALGAS_bool (kIsNotEqual, enumerator_13184.current_mSelector (HERE).mAttribute_string.objectCompare (enumerator_13220.current_mSelector (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_22) {
          GALGAS_location location_23 (enumerator_13220.current_mSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_23, GALGAS_string ("the selector of the observable property should be '").add_operation (enumerator_13184.current_mSelector (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 335)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 335)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 335))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 335)) ;
        }
    ...
    const enumGalgasBool test_24 = GALGAS_bool (kIsNotEqual, var_controllerBindingOptionDecoratedList.reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 341)).objectCompare (enumerator_11471.current_mBindingOptionList (HERE).reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 341)))).boolEnum () ;
    if (kBoolTrue == test_24) {
      ...
      if (kBoolTrue == test_25) {
        ...
        cEnumerator_controllerBindingOptionDecoratedList enumerator_14283 (var_controllerBindingOptionDecoratedList, kEnumeration_up) ;
        while (enumerator_14283.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").add_operation (enumerator_14283.current_mOptionName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 348)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 348)).add_operation (GALGAS_string (" : "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 348)).add_operation (enumerator_14283.current_mOptionType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 348)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 348))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 348)) ;
          enumerator_14283.gotoNextObject () ;
        }
      }
      GALGAS_location location_26 (enumerator_11471.current_mBindingName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_26, var_s  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 351)) ;
    }else if (kBoolFalse == test_24) {
      cEnumerator_controllerBindingOptionDecoratedList enumerator_14492 (var_controllerBindingOptionDecoratedList, kEnumeration_up) ;
      cEnumerator_bindingOptionList enumerator_14527 (enumerator_11471.current_mBindingOptionList (HERE), kEnumeration_up) ;
      while (enumerator_14492.hasCurrentObject () && enumerator_14527.hasCurrentObject ()) {
        const enumGalgasBool test_27 = GALGAS_bool (kIsNotEqual, enumerator_14492.current_mOptionName (HERE).mAttribute_string.objectCompare (enumerator_14527.current_mOptionName (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_27) {
          GALGAS_location location_28 (enumerator_14527.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_28, GALGAS_string ("the option name should be '").add_operation (enumerator_14492.current_mOptionName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 355)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 355)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 355))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 355)) ;
        }
        ...
        temp_29.addAssign_operation (enumerator_14492.current_mOptionType (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 358)) ;
        callCategoryMethod_analyzeDefaultValueType ((const cPtr_abstractDefaultValue *) enumerator_14527.current_mOptionValue (HERE).ptr (), temp_29, var_optionValueAsString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 357)) ;
        var_bindingOptionString.dotAssign_operation (GALGAS_string (", ").add_operation (enumerator_14492.current_mOptionName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 361)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 361)).add_operation (var_optionValueAsString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 361))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 361)) ;
        enumerator_14492.gotoNextObject () ;
        enumerator_14527.gotoNextObject () ;
      }
    }
    GALGAS_string var_title = GALGAS_string::makeEmptyString () ;
    cEnumerator__32_stringlist enumerator_15086 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_15086.hasCurrentObject ()) {
      var_title.dotAssign_operation (enumerator_15086.current_mValue_30_ (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 367)).add_operation (enumerator_15086.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 367))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 367)) ;
    ...
    cEnumerator__32_stringlist enumerator_15573 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_15573.hasCurrentObject ()) {
      var_templateStringWithReplacements = var_templateStringWithReplacements.reader_stringByReplacingStringByString (GALGAS_string ("$OBJECTCLASS$"), enumerator_15573.current_mValue_30_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 374)) ;
      var_templateStringWithReplacements = var_templateStringWithReplacements.reader_stringByReplacingStringByString (GALGAS_string ("$MODEL$"), enumerator_15573.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 375)) ;
    ...
    cEnumerator__32_stringlist enumerator_16119 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_16119.hasCurrentObject ()) {
      var_controllerInstanciationString.dotAssign_operation (GALGAS_string ("_").add_operation (enumerator_16119.current_mValue_30_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 382)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 382)).add_operation (enumerator_16119.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 382))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 382)) ;
      enumerator_16119.gotoNextObject () ;
    }
    var_controllerInstanciationString.dotAssign_operation (GALGAS_string ("_").add_operation (var_outletTypeName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 384)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 384)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 384)).add_operation (enumerator_11471.current_mBindingName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 384)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 384)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 384))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 384)) ;
    GALGAS_string var_prefix = GALGAS_string ("object") ;
    cEnumerator_stringlist enumerator_16363 (var_boundObjectNameList, kEnumeration_up) ;
    GALGAS_uint index_16336 ((uint32_t) 0) ;
    while (enumerator_16363.hasCurrentObject ()) {
      var_controllerInstanciationString.dotAssign_operation (var_prefix.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 387)).add_operation (enumerator_16363.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 387)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 387))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 387)) ;
      var_prefix = GALGAS_string ("object").add_operation (index_16336.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 388)).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 388)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 388)) ;
      enumerator_16363.gotoNextObject () ;
      index_16336.increment_operation (inCompiler  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 386)) ;
    }
    var_controllerInstanciationString.dotAssign_operation (GALGAS_string ("outlet:").add_operation (enumerator_11471.current_mOutletName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 390)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 390)).add_operation (GALGAS_string (", file:__FILE__, line:__LINE__"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 390)).add_operation (var_bindingOptionString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 390)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 390))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 390)) ;
  ...
  cEnumerator_actionMap enumerator_16761 (constinArgument_inActionMap, kEnumeration_up) ;
  while (enumerator_16761.hasCurrentObject ()) {
    ioArgument_ioGeneration.mAttribute_mActionListForGeneration.addAssign_operation (constinArgument_inTypeName.mAttribute_string, enumerator_16761.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 395)) ;
...
static void categoryMethod_selfObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_bool joker_26476_0 ; // Joker input parameter
  GALGAS_lstring joker_26504_0 ; // Joker input parameter
  constinArgument_inObservablePropertyMap.method_searchKey (object->mAttribute_mSelfObservablePropertyName, var_propertyType, joker_26476_0, joker_26504_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 650)) ;
...
static void categoryMethod_rootObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool joker_27811_0 ; // Joker input parameter
  GALGAS_lstring joker_27839_0 ; // Joker input parameter
  GALGAS_bool joker_27875_0 ; // Joker input parameter
  constinArgument_inRootEntityType.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 685)).method_searchKey (object->mAttribute_mRootObservablePropertyName, var_propertyType, joker_27811_0, joker_27839_0, joker_27875_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 685)) ;
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeProxy joker_29330_5 ; // Joker input parameter
  GALGAS_unifiedTypeProxy joker_29330_4 ; // Joker input parameter
  GALGAS_decoratedAttributeMap joker_29330_3 ; // Joker input parameter
  GALGAS_decoratedTransientMap joker_29330_2 ; // Joker input parameter
  GALGAS_decoratedOutletMap joker_29330_1 ; // Joker input parameter
  GALGAS_decoratedEntityRelationshipMap joker_29398_6 ; // Joker input parameter
  GALGAS_actionMap joker_29398_5 ; // Joker input parameter
  GALGAS_bindingList joker_29398_4 ; // Joker input parameter
  GALGAS_lstringlist joker_29398_3 ; // Joker input parameter
  GALGAS_enumConstantMap joker_29398_2 ; // Joker input parameter
  GALGAS_arrayControllerMap joker_29398_1 ; // Joker input parameter
  constinArgument_inUnifiedTypeMap.method_searchKey (object->mAttribute_mPreferenceName, var_typeKind, joker_29330_5, joker_29330_4, joker_29330_3, joker_29330_2, joker_29330_1, var_observablePropertyMap, joker_29398_6, joker_29398_5, joker_29398_4, joker_29398_3, joker_29398_2, joker_29398_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 724)) ;
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_29675_0 ; // Joker input parameter
  GALGAS_lstring joker_29703_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceObservablePropertyName, var_propertyType, joker_29675_0, joker_29703_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 735)) ;
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_abstractObservablePropertyAST joker_31003_0 ; // Joker input parameter
  GALGAS_lstring joker_31055_3 ; // Joker input parameter
  GALGAS_arrayControllerBoundColumnListAST joker_31055_2 ; // Joker input parameter
  GALGAS_actionMap joker_31055_1 ; // Joker input parameter
  GALGAS_lstring joker_31138_0 ; // Joker input parameter
  constinArgument_inArrayControllerMap.method_searchKey (object->mAttribute_mArrayControllerName, joker_31003_0, joker_31055_3, joker_31055_2, joker_31055_1, var_arrayControllerObservablePropertyMap, joker_31138_0, var_observedTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 771)) ;
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_31322_0 ; // Joker input parameter
  GALGAS_lstring joker_31351_0 ; // Joker input parameter
  var_arrayControllerObservablePropertyMap.method_searchKey (object->mAttribute_mArrayControllerObservablePropertyName, var_propertyType, joker_31322_0, joker_31351_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 780)) ;
...
static void categoryMethod_selfObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_33748_0 ; // Joker input parameter
  constinArgument_inObservablePropertyMap.method_searchKey (object->mAttribute_mSelfObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_33748_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 841)) ;
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_typeKind var_typeKind ;
  GALGAS_decoratedObservablePropertyMap var_observablePropertyMap ;
  GALGAS_unifiedTypeProxy joker_36791_5 ; // Joker input parameter
  GALGAS_unifiedTypeProxy joker_36791_4 ; // Joker input parameter
  GALGAS_decoratedAttributeMap joker_36791_3 ; // Joker input parameter
  GALGAS_decoratedTransientMap joker_36791_2 ; // Joker input parameter
  GALGAS_decoratedOutletMap joker_36791_1 ; // Joker input parameter
  GALGAS_decoratedEntityRelationshipMap joker_36859_6 ; // Joker input parameter
  GALGAS_actionMap joker_36859_5 ; // Joker input parameter
  GALGAS_bindingList joker_36859_4 ; // Joker input parameter
  GALGAS_lstringlist joker_36859_3 ; // Joker input parameter
  GALGAS_enumConstantMap joker_36859_2 ; // Joker input parameter
  GALGAS_arrayControllerMap joker_36859_1 ; // Joker input parameter
  constinArgument_inUnifiedTypeMap.method_searchKey (object->mAttribute_mPreferenceName, var_typeKind, joker_36791_5, joker_36791_4, joker_36791_3, joker_36791_2, joker_36791_1, var_observablePropertyMap, joker_36859_6, joker_36859_5, joker_36859_4, joker_36859_3, joker_36859_2, joker_36859_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 912)) ;
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_37161_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_37161_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 923)) ;
  const enumGalgasBool test_2 = var_isCollection.boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mPreferenceObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_decoratedObservablePropertyMap var_arrayControllerObservablePropertyMap ;
  GALGAS_lstring joker_38464_3 ; // Joker input parameter
  GALGAS_arrayControllerBoundColumnListAST joker_38464_2 ; // Joker input parameter
  GALGAS_actionMap joker_38464_1 ; // Joker input parameter
  GALGAS_lstring joker_38547_2 ; // Joker input parameter
  GALGAS_string joker_38547_1 ; // Joker input parameter
  constinArgument_inArrayControllerMap.method_searchKey (object->mAttribute_mArrayControllerName, var_boundModel, joker_38464_3, joker_38464_2, joker_38464_1, var_arrayControllerObservablePropertyMap, joker_38547_2, joker_38547_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 955)) ;
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_38726_0 ; // Joker input parameter
  var_arrayControllerObservablePropertyMap.method_searchKey (object->mAttribute_mArrayControllerObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_38726_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 963)) ;
  const enumGalgasBool test_0 = var_isCollection.boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mArrayControllerObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
...
static void categoryMethod_rootObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_lstring joker_40980_0 ; // Joker input parameter
  constinArgument_inCurrentRelationshipMap.method_searchKey (object->mAttribute_mRootObservablePropertyName, var_mIsToMany, outArgument_outRelationshipTypeProxy, joker_40980_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1016)) ;
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientRootRelationshipDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  GALGAS_bool joker_50285_0 ; // Joker input parameter
  GALGAS_lstring joker_50328_0 ; // Joker input parameter
  constinArgument_inRootEntityType.reader_mCurrentRelationshipMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1275)).method_searchKey (object->mAttribute_mRelationshipName, joker_50285_0, var_elementType, joker_50328_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1275)) ;
