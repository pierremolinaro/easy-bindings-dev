...
void routine_unifiedTypeAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  while (enumerator_7752.hasCurrentObject ()) {
    ...
    while (enumerator_8481.hasCurrentObject ()) {
      ...
      GALGAS_bool joker_8634 ; // Joker input parameter
      GALGAS_lstring joker_8675 ; // Joker input parameter
      var_outElementTypeProxy.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 210)).method_searchKey (enumerator_8481.current_mObservablePropertyName (HERE), var_propertyType, joker_8634, joker_8675, var_mIsCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 210)) ;
...
static void categoryMethod_selfObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_bool joker_26545 ; // Joker input parameter
  GALGAS_lstring joker_26573 ; // Joker input parameter
  constinArgument_inObservablePropertyMap.method_searchKey (object->mAttribute_mSelfObservablePropertyName, var_propertyType, joker_26545, joker_26573, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 650)) ;
...
static void categoryMethod_rootObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_propertyType ;
  GALGAS_bool joker_27888 ; // Joker input parameter
  GALGAS_lstring joker_27916 ; // Joker input parameter
  GALGAS_bool joker_27952 ; // Joker input parameter
  constinArgument_inRootEntityType.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 685)).method_searchKey (object->mAttribute_mRootObservablePropertyName, var_propertyType, joker_27888, joker_27916, joker_27952, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 685)) ;
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_29608 ; // Joker input parameter
  GALGAS_lstring joker_29636 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceObservablePropertyName, var_propertyType, joker_29608, joker_29636, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 732)) ;
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_abstractObservablePropertyAST joker_30824 ; // Joker input parameter
  ...
  GALGAS_lstring joker_30959 ; // Joker input parameter
  constinArgument_inArrayControllerMap.method_searchKey (object->mAttribute_mArrayControllerName, joker_30824, joker_30876_3, joker_30876_2, joker_30876_1, var_arrayControllerObservablePropertyMap, joker_30959, var_observedTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 766)) ;
  GALGAS_unifiedTypeMap_2D_proxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_31147 ; // Joker input parameter
  GALGAS_lstring joker_31176 ; // Joker input parameter
  var_arrayControllerObservablePropertyMap.method_searchKey (object->mAttribute_mArrayControllerObservablePropertyName, var_propertyType, joker_31147, joker_31176, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 775)) ;
...
static void categoryMethod_selfObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_33458 ; // Joker input parameter
  constinArgument_inObservablePropertyMap.method_searchKey (object->mAttribute_mSelfObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_33458, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 834)) ;
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_36891 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_36891, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 916)) ;
  const enumGalgasBool test_2 = var_isCollection.boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mPreferenceObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeMap_2D_proxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_38464 ; // Joker input parameter
  var_arrayControllerObservablePropertyMap.method_searchKey (object->mAttribute_mArrayControllerObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_38464, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 956)) ;
  const enumGalgasBool test_0 = var_isCollection.boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mArrayControllerObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
...
static void categoryMethod_rootObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_lstring joker_40730 ; // Joker input parameter
  constinArgument_inCurrentRelationshipMap.method_searchKey (object->mAttribute_mRootObservablePropertyName, var_mIsToMany, outArgument_outRelationshipTypeProxy, joker_40730, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1009)) ;
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientRootRelationshipDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  GALGAS_bool joker_50123 ; // Joker input parameter
  GALGAS_lstring joker_50170 ; // Joker input parameter
  constinArgument_inRootEntityType.reader_mCurrentRelationshipMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1268)).method_searchKey (object->mAttribute_mRelationshipName, joker_50123, var_elementType, joker_50170, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1268)) ;
