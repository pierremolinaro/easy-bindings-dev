...
//                                         september 29th, 2014, at 21h41'11"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeProxy joker_29178_5 ; // Joker input parameter
  GALGAS_unifiedTypeProxy joker_29178_4 ; // Joker input parameter
  GALGAS_decoratedAttributeMap joker_29178_3 ; // Joker input parameter
  GALGAS_decoratedTransientMap joker_29178_2 ; // Joker input parameter
  GALGAS_decoratedOutletMap joker_29178_1 ; // Joker input parameter
  GALGAS_decoratedEntityRelationshipMap joker_29246_6 ; // Joker input parameter
  GALGAS_actionMap joker_29246_5 ; // Joker input parameter
  GALGAS_bindingList joker_29246_4 ; // Joker input parameter
  GALGAS_lstringlist joker_29246_3 ; // Joker input parameter
  GALGAS_enumConstantMap joker_29246_2 ; // Joker input parameter
  GALGAS_arrayControllerMap joker_29246_1 ; // Joker input parameter
  constinArgument_inUnifiedTypeMap.method_searchKey (object->mAttribute_mPreferenceName, var_typeKind, joker_29178_5, joker_29178_4, joker_29178_3, joker_29178_2, joker_29178_1, var_observablePropertyMap, joker_29246_6, joker_29246_5, joker_29246_4, joker_29246_3, joker_29246_2, joker_29246_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 721)) ;
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_29523_0 ; // Joker input parameter
  GALGAS_lstring joker_29551_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceObservablePropertyName, var_propertyType, joker_29523_0, joker_29551_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 732)) ;
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_abstractObservablePropertyAST joker_30735_0 ; // Joker input parameter
  GALGAS_lstring joker_30787_3 ; // Joker input parameter
  GALGAS_arrayControllerBoundColumnListAST joker_30787_2 ; // Joker input parameter
  GALGAS_actionMap joker_30787_1 ; // Joker input parameter
  GALGAS_lstring joker_30870_0 ; // Joker input parameter
  constinArgument_inArrayControllerMap.method_searchKey (object->mAttribute_mArrayControllerName, joker_30735_0, joker_30787_3, joker_30787_2, joker_30787_1, var_arrayControllerObservablePropertyMap, joker_30870_0, var_observedTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 766)) ;
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_31054_0 ; // Joker input parameter
  GALGAS_lstring joker_31083_0 ; // Joker input parameter
  var_arrayControllerObservablePropertyMap.method_searchKey (object->mAttribute_mArrayControllerObservablePropertyName, var_propertyType, joker_31054_0, joker_31083_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 775)) ;
...
static void categoryMethod_selfObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_33353_0 ; // Joker input parameter
  constinArgument_inObservablePropertyMap.method_searchKey (object->mAttribute_mSelfObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_33353_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 834)) ;
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_typeKind var_typeKind ;
  GALGAS_decoratedObservablePropertyMap var_observablePropertyMap ;
  GALGAS_unifiedTypeProxy joker_36396_5 ; // Joker input parameter
  GALGAS_unifiedTypeProxy joker_36396_4 ; // Joker input parameter
  GALGAS_decoratedAttributeMap joker_36396_3 ; // Joker input parameter
  GALGAS_decoratedTransientMap joker_36396_2 ; // Joker input parameter
  GALGAS_decoratedOutletMap joker_36396_1 ; // Joker input parameter
  GALGAS_decoratedEntityRelationshipMap joker_36464_6 ; // Joker input parameter
  GALGAS_actionMap joker_36464_5 ; // Joker input parameter
  GALGAS_bindingList joker_36464_4 ; // Joker input parameter
  GALGAS_lstringlist joker_36464_3 ; // Joker input parameter
  GALGAS_enumConstantMap joker_36464_2 ; // Joker input parameter
  GALGAS_arrayControllerMap joker_36464_1 ; // Joker input parameter
  constinArgument_inUnifiedTypeMap.method_searchKey (object->mAttribute_mPreferenceName, var_typeKind, joker_36396_5, joker_36396_4, joker_36396_3, joker_36396_2, joker_36396_1, var_observablePropertyMap, joker_36464_6, joker_36464_5, joker_36464_4, joker_36464_3, joker_36464_2, joker_36464_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 905)) ;
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_36766_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_36766_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 916)) ;
  const enumGalgasBool test_2 = var_isCollection.boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mPreferenceObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_decoratedObservablePropertyMap var_arrayControllerObservablePropertyMap ;
  GALGAS_lstring joker_38069_3 ; // Joker input parameter
  GALGAS_arrayControllerBoundColumnListAST joker_38069_2 ; // Joker input parameter
  GALGAS_actionMap joker_38069_1 ; // Joker input parameter
  GALGAS_lstring joker_38152_2 ; // Joker input parameter
  GALGAS_string joker_38152_1 ; // Joker input parameter
  constinArgument_inArrayControllerMap.method_searchKey (object->mAttribute_mArrayControllerName, var_boundModel, joker_38069_3, joker_38069_2, joker_38069_1, var_arrayControllerObservablePropertyMap, joker_38152_2, joker_38152_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 948)) ;
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_38331_0 ; // Joker input parameter
  var_arrayControllerObservablePropertyMap.method_searchKey (object->mAttribute_mArrayControllerObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_38331_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 956)) ;
  const enumGalgasBool test_0 = var_isCollection.boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mArrayControllerObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
...
static void categoryMethod_rootObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_lstring joker_40585_0 ; // Joker input parameter
  constinArgument_inCurrentRelationshipMap.method_searchKey (object->mAttribute_mRootObservablePropertyName, var_mIsToMany, outArgument_outRelationshipTypeProxy, joker_40585_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1009)) ;
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientRootRelationshipDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  GALGAS_bool joker_49890_0 ; // Joker input parameter
  GALGAS_lstring joker_49933_0 ; // Joker input parameter
  constinArgument_inRootEntityType.reader_mCurrentRelationshipMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1268)).method_searchKey (object->mAttribute_mRelationshipName, joker_49890_0, var_elementType, joker_49933_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1268)) ;
