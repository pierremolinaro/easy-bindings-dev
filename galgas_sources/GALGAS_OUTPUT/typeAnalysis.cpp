...
//                                         september 15th, 2014, at 18h48'39"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
void routine_unifiedTypeAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  cEnumerator_decoratedOutletMap enumerator_4266 (constinArgument_decoratedOutletMap, kEnumeration_up) ;
  while (enumerator_4266.hasCurrentObject ()) {
    GALGAS_bool var_handlesRunAction ;
    constinArgument_inOutletClassMap.method_searchKey (enumerator_4266.current_mOutletTypeName (HERE), var_handlesRunAction, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 121)) ;
    ioArgument_ioGeneration.mAttribute_mNeededOutletClasses.addAssign_operation (enumerator_4266.current_mOutletTypeName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 122)) ;
    const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, enumerator_4266.current_mRunTargetName (HERE).mAttribute_string.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
    if (kBoolTrue == test_0) {
      const enumGalgasBool test_1 = var_handlesRunAction.operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 124)).boolEnum () ;
      if (kBoolTrue == test_1) {
        GALGAS_location location_2 (enumerator_4266.current_mOutletTypeName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_2, GALGAS_string ("the '").operator_concat (enumerator_4266.current_mOutletTypeName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 125))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 125)).operator_concat (GALGAS_string ("' type does not handle run action")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 125))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 125)) ;
      }else if (kBoolFalse == test_1) {
        const enumGalgasBool test_3 = GALGAS_bool (kIsEqual, enumerator_4266.current_mRunTargetName (HERE).mAttribute_string.objectCompare (GALGAS_string ("self"))).boolEnum () ;
        if (kBoolTrue == test_3) {
          constinArgument_inActionMap.method_searchKey (enumerator_4266.current_mRunActionName (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 127)) ;
          var_targetActionList.addAssign_operation (enumerator_4266.current_lkey (HERE).mAttribute_string, GALGAS_string ("self"), enumerator_4266.current_mRunActionName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 128)) ;
        }else if (kBoolFalse == test_3) {
          GALGAS_actionMap var_arrayControllerActionMap ;
          GALGAS_abstractObservablePropertyAST joker_4857_3 ; // Joker input parameter
          GALGAS_lstring joker_4857_2 ; // Joker input parameter
          GALGAS_arrayControllerBoundColumnListAST joker_4857_1 ; // Joker input parameter
          GALGAS_decoratedObservablePropertyMap joker_4899_2 ; // Joker input parameter
          GALGAS_lstring joker_4899_1 ; // Joker input parameter
          constinArgument_inArrayControllerMap.method_searchKey (enumerator_4266.current_mRunTargetName (HERE), joker_4857_3, joker_4857_2, joker_4857_1, var_arrayControllerActionMap, joker_4899_2, joker_4899_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 130)) ;
          var_arrayControllerActionMap.method_searchKey (enumerator_4266.current_mRunActionName (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 131)) ;
          var_targetActionList.addAssign_operation (enumerator_4266.current_lkey (HERE).mAttribute_string, enumerator_4266.current_mRunTargetName (HERE).mAttribute_string, enumerator_4266.current_mRunActionName (HERE).mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 132)) ;
        }
      }
    }
    enumerator_4266.gotoNextObject () ;
  }
  GALGAS_entityRelationshipListForGeneration var_entityRelationshipListForGeneration = GALGAS_entityRelationshipListForGeneration::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 137)) ;
  cEnumerator_decoratedEntityRelationshipMap enumerator_5246 (constinArgument_inCurrentRelationshipMap, kEnumeration_up) ;
  while (enumerator_5246.hasCurrentObject ()) {
    ...
    enumerator_5246.current_mRelationshipType (HERE).reader_mCurrentRelationshipMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 139)).method_searchKey (enumerator_5246.current_mOppositeRelationshipName (HERE), var_oppositeRelationIsToMany, var_oppositeRelationshipType, var_oppositeOfOppositeRelationshipName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 139)) ;
    const enumGalgasBool test_4 = GALGAS_bool (kIsNotEqual, var_oppositeOfOppositeRelationshipName.mAttribute_string.objectCompare (enumerator_5246.current_lkey (HERE).mAttribute_string)).boolEnum () ;
    if (kBoolTrue == test_4) {
      GALGAS_location location_5 (enumerator_5246.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_5, GALGAS_string ("the opposite relationship is '").operator_concat (enumerator_5246.current_mOppositeRelationshipName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 146))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 146)).operator_concat (GALGAS_string ("' and names '")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 146)).operator_concat (var_oppositeOfOppositeRelationshipName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 147))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 147)).operator_concat (GALGAS_string ("' as opposite, instead of '")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 147)).operator_concat (enumerator_5246.current_lkey (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 147))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 147)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 147))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 146)) ;
    }
    const enumGalgasBool test_6 = GALGAS_bool (kIsNotEqual, var_oppositeRelationshipType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 149)).objectCompare (constinArgument_inTypeName.mAttribute_string)).boolEnum () ;
    if (kBoolTrue == test_6) {
      GALGAS_location location_7 (enumerator_5246.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_7, GALGAS_string ("the opposite relationship type is '").operator_concat (var_oppositeRelationshipType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 150))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 150)).operator_concat (GALGAS_string ("', instead of '")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 150)).operator_concat (enumerator_5246.current_lkey (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 150))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 150)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 150))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 150)) ;
    }
    var_entityRelationshipListForGeneration.addAssign_operation (enumerator_5246.current_lkey (HERE).mAttribute_string, enumerator_5246.current_mIsToMany (HERE), enumerator_5246.current_mRelationshipType (HERE), enumerator_5246.current_mOppositeRelationshipName (HERE).mAttribute_string, var_oppositeRelationIsToMany  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 152)) ;
    enumerator_5246.gotoNextObject () ;
  }
  GALGAS_arrayControllerForGeneration var_documentArrayControllerForGeneration = GALGAS_arrayControllerForGeneration::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 161)) ;
  cEnumerator_arrayControllerMap enumerator_6348 (constinArgument_inArrayControllerMap, kEnumeration_up) ;
  while (enumerator_6348.hasCurrentObject ()) {
    ...
    callCategoryMethod_analyzeBoundObservablePropertyForArrayControllerBinding ((const cPtr_abstractObservablePropertyAST *) enumerator_6348.current_mBoundModel (HERE).ptr (), constinArgument_inRootEntityType.reader_mCurrentRelationshipMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 165)), var_outElementTypeProxy, var_outBoundRootTomanyRelationshipName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 164)) ;
    GALGAS_lstring var_outletTypeName ;
    GALGAS_lstring joker_6736_2 ; // Joker input parameter
    GALGAS_lstring joker_6736_1 ; // Joker input parameter
    constinArgument_decoratedOutletMap.method_searchKey (enumerator_6348.current_mTableViewOutletName (HERE), var_outletTypeName, joker_6736_2, joker_6736_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 170)) ;
    ...
    if (kBoolTrue == test_8) {
      GALGAS_location location_9 (enumerator_6348.current_mTableViewOutletName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_9, GALGAS_string ("this outlet is not an instance of PMTableView")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 172)) ;
    }
    GALGAS_arrayControllerBoundColumnListForGeneration var_arrayControllerBoundColumnListForGeneration = GALGAS_arrayControllerBoundColumnListForGeneration::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 175)) ;
    cEnumerator_arrayControllerBoundColumnListAST enumerator_7073 (enumerator_6348.current_mArrayControllerBoundColumnListAST (HERE), kEnumeration_up) ;
    while (enumerator_7073.hasCurrentObject ()) {
      GALGAS_unifiedTypeProxy var_propertyType ;
      GALGAS_bool var_mIsCollection ;
      GALGAS_bool joker_7222_0 ; // Joker input parameter
      GALGAS_lstring joker_7263_0 ; // Joker input parameter
      var_outElementTypeProxy.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 177)).method_searchKey (enumerator_7073.current_mObservablePropertyName (HERE), var_propertyType, joker_7222_0, joker_7263_0, var_mIsCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 177)) ;
      const enumGalgasBool test_10 = var_mIsCollection.boolEnum () ;
      if (kBoolTrue == test_10) {
        GALGAS_location location_11 (enumerator_7073.current_mObservablePropertyName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_11, GALGAS_string ("the bound property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 185)) ;
      }
      var_arrayControllerBoundColumnListForGeneration.addAssign_operation (enumerator_7073.current_mColumnName (HERE).mAttribute_string, enumerator_7073.current_mColumnOutletTypeName (HERE).mAttribute_string, enumerator_7073.current_mObservablePropertyName (HERE).mAttribute_string, var_propertyType, enumerator_7073.current_mBindingOptionList (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 187)) ;
      enumerator_7073.gotoNextObject () ;
    }
    var_documentArrayControllerForGeneration.addAssign_operation (enumerator_6348.current_lkey (HERE).mAttribute_string, constinArgument_inRootEntityType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 197)), var_outBoundRootTomanyRelationshipName.mAttribute_string, var_outElementTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 199)), enumerator_6348.current_mTableViewOutletName (HERE).mAttribute_string, var_arrayControllerBoundColumnListForGeneration  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 195)) ;
    enumerator_6348.gotoNextObject () ;
  }
  ioArgument_ioGeneration.mAttribute_mAllArrayControllerForGeneration.dotAssign_operation (var_documentArrayControllerForGeneration  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 204)) ;
  GALGAS_transientDefinitionListForGeneration var_transientDefinitionListForGeneration = GALGAS_transientDefinitionListForGeneration::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 206)) ;
  cEnumerator_decoratedTransientMap enumerator_8275 (constinArgument_decoratedTransientMap, kEnumeration_up) ;
  while (enumerator_8275.hasCurrentObject ()) {
    GALGAS_transientDependencyListForGeneration var_transientDependencyListForGeneration = GALGAS_transientDependencyListForGeneration::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 208)) ;
    cEnumerator_dependanceList enumerator_8395 (enumerator_8275.current_mDependencyList (HERE), kEnumeration_up) ;
    while (enumerator_8395.hasCurrentObject ()) {
      const enumGalgasBool test_12 = categoryReader_suitableForObservableProperty (enumerator_8275.current_mTransientType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 210)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 210)).operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 210)).boolEnum () ;
      if (kBoolTrue == test_12) {
        GALGAS_location location_13 (enumerator_8275.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_13, GALGAS_string ("the '").operator_concat (enumerator_8275.current_mTransientType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 211))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 211)).operator_concat (GALGAS_string ("' type is not acceptable for transient")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 211))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 211)) ;
      }
      callCategoryMethod_transientDependencySemanticAnalysis ((const cPtr_abstractTransientDependencyAST *) enumerator_8395.current_mDependency (HERE).ptr (), constinArgument_inUnifiedTypeMap, enumerator_8275.current_lkey (HERE), constinArgument_inAllObservablePropertyMap, constinArgument_inArrayControllerMap, constinArgument_inRootEntityType, enumerator_8275.current_mTransientSignature (HERE), var_transientDependencyListForGeneration, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 213)) ;
      enumerator_8395.gotoNextObject () ;
    }
    GALGAS_dependanceListForGeneration var_dependencyListForGeneration = GALGAS_dependanceListForGeneration::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 223)) ;
    cEnumerator_dependanceList enumerator_8973 (enumerator_8275.current_mDependencyList (HERE), kEnumeration_up) ;
    while (enumerator_8973.hasCurrentObject ()) {
      var_dependencyListForGeneration.addAssign_operation (callCategoryReader_buildDecoratedRepresentation ((const cPtr_abstractTransientDependencyAST *) enumerator_8973.current_mDependency (HERE).ptr (), constinArgument_inRootEntityType, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 225))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 225)) ;
      enumerator_8973.gotoNextObject () ;
    }
    var_transientDefinitionListForGeneration.addAssign_operation (enumerator_8275.current_lkey (HERE).mAttribute_string, enumerator_8275.current_mTransientType (HERE), enumerator_8275.current_mTransientSignature (HERE), var_dependencyListForGeneration  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 227)) ;
    ioArgument_ioGeneration.mAttribute_mTransientListForGeneration.addAssign_operation (enumerator_8275.current_mTransientSignature (HERE).mAttribute_string, enumerator_8275.current_mTransientType (HERE), var_transientDependencyListForGeneration  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 233)) ;
    enumerator_8275.gotoNextObject () ;
  }
  GALGAS_attributeListForGeneration var_attributeListForGeneration = GALGAS_attributeListForGeneration::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 236)) ;
  cEnumerator_decoratedAttributeMap enumerator_9530 (constinArgument_decoratedAttributeMap, kEnumeration_up) ;
  while (enumerator_9530.hasCurrentObject ()) {
    GALGAS_string var_swiftDefaultValueAsString ;
    GALGAS_unifiedTypeProxyList temp_14 = GALGAS_unifiedTypeProxyList::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 239)) ;
    temp_14.addAssign_operation (enumerator_9530.current_mAttributeType (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 239)) ;
    callCategoryMethod_analyzeDefaultValueType ((const cPtr_abstractDefaultValue *) enumerator_9530.current_mDefaultValue (HERE).ptr (), temp_14, var_swiftDefaultValueAsString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 238)) ;
    var_attributeListForGeneration.addAssign_operation (enumerator_9530.current_mAttributeType (HERE), enumerator_9530.current_lkey (HERE).mAttribute_string, var_swiftDefaultValueAsString, enumerator_9530.current_mNeedsValidation (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 242)) ;
    const enumGalgasBool test_15 = enumerator_9530.current_mNeedsValidation (HERE).boolEnum () ;
    if (kBoolTrue == test_15) {
      ioArgument_ioGeneration.mAttribute_mValidationStubRoutineListForGeneration.addAssign_operation (constinArgument_inTypeName.mAttribute_string, enumerator_9530.current_lkey (HERE).mAttribute_string, categoryReader_swiftTypeName (enumerator_9530.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 247))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 244)) ;
    }
    enumerator_9530.gotoNextObject () ;
  }
  GALGAS_stringlist var_controllerInstanciationStringList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 252)) ;
  cEnumerator_bindingList enumerator_10143 (constinArgument_inBindingList, kEnumeration_up) ;
  while (enumerator_10143.hasCurrentObject ()) {
    GALGAS_string var_controllerSignature = GALGAS_string::makeEmptyString () ;
    GALGAS_unifiedTypeProxySelectorList var_boundPropertyTypeList = GALGAS_unifiedTypeProxySelectorList::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 255)) ;
    GALGAS__32_stringlist var_typePropertyNameList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 256)) ;
    GALGAS_stringlist var_boundObjectNameList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 257)) ;
    GALGAS_bool var_modelIsTransient ;
    callCategoryMethod_analyzeBoundObservablePropertyForSimpleBinding ((const cPtr_abstractObservablePropertyAST *) enumerator_10143.current_mObservableProperty (HERE).ptr (), constinArgument_inUnifiedTypeMap, constinArgument_inArrayControllerMap, enumerator_10143.current_mSelectorName (HERE), constinArgument_inTypeName.mAttribute_string, constinArgument_inCurrentObservablePropertyMap, constinArgument_inRootEntityType, var_controllerSignature, var_boundPropertyTypeList, var_typePropertyNameList, var_boundObjectNameList, var_modelIsTransient, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 258)) ;
    GALGAS_lstring var_outletTypeName ;
    GALGAS_lstring joker_10810_2 ; // Joker input parameter
    GALGAS_lstring joker_10810_1 ; // Joker input parameter
    constinArgument_decoratedOutletMap.method_searchKey (enumerator_10143.current_mOutletName (HERE), var_outletTypeName, joker_10810_2, joker_10810_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 271)) ;
    var_controllerSignature = var_outletTypeName.mAttribute_string.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 272)).add_operation (enumerator_10143.current_mBindingName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 272)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 272)).add_operation (var_controllerSignature, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 272)) ;
    GALGAS_lstring var_controllerTemplateName = GALGAS_lstring::constructor_new (var_controllerSignature, enumerator_10143.current_mBindingName (HERE).mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 273)) ;
    ...
    constinArgument_inTemplateControllerMap.method_searchKey (var_controllerTemplateName, var_templateString, var_modelTypeProxy, var_modelSelector, var_modelShouldBeWritableProperty, var_controllerBindingOptionDecoratedList, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 277)) ;
    const enumGalgasBool test_16 = var_modelShouldBeWritableProperty.operator_and (var_modelIsTransient COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 285)).boolEnum () ;
    if (kBoolTrue == test_16) {
      GALGAS_location location_17 (enumerator_10143.current_mSelectorName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_17, GALGAS_string ("the model is transient and the binding requires an writable model")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 286)) ;
    }
    GALGAS_unifiedTypeProxySelectorList var_modelPropertyTypeList = GALGAS_unifiedTypeProxySelectorList::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 288)) ;
    var_modelPropertyTypeList.addAssign_operation (var_modelTypeProxy, var_modelSelector  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 289)) ;
    const enumGalgasBool test_18 = GALGAS_bool (kIsNotEqual, var_boundPropertyTypeList.reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 291)).objectCompare (var_modelPropertyTypeList.reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 291)))).boolEnum () ;
    if (kBoolTrue == test_18) {
      GALGAS_location location_19 (enumerator_10143.current_mOutletName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_19, GALGAS_string ("internal error")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 292)) ;
    }else if (kBoolFalse == test_18) {
      cEnumerator_unifiedTypeProxySelectorList enumerator_11856 (var_modelPropertyTypeList, kEnumeration_up) ;
      cEnumerator_unifiedTypeProxySelectorList enumerator_11892 (var_boundPropertyTypeList, kEnumeration_up) ;
      while (enumerator_11856.hasCurrentObject () && enumerator_11892.hasCurrentObject ()) {
        const enumGalgasBool test_20 = GALGAS_bool (kIsEqual, enumerator_11856.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 295)).objectCompare (GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("typeAnalysis.gSemantics", 295)))).operator_and (GALGAS_bool (kIsEqual, enumerator_11892.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 295)).objectCompare (GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("typeAnalysis.gSemantics", 295)))) COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 295)).boolEnum () ;
        if (kBoolTrue == test_20) {
        }else if (kBoolFalse == test_20) {
          const enumGalgasBool test_21 = GALGAS_bool (kIsNotEqual, enumerator_11856.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 297)).objectCompare (enumerator_11892.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 297)))).boolEnum () ;
          if (kBoolTrue == test_21) {
            GALGAS_location location_22 (enumerator_11892.current_mSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_22, GALGAS_string ("the type of the observable property is '").add_operation (enumerator_11892.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 298)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 298)).add_operation (GALGAS_string ("', but this binding requires the '"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 298)).add_operation (enumerator_11856.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 299)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 299)).add_operation (GALGAS_string ("' type"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 299))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 298)) ;
          }
        }
        const enumGalgasBool test_23 = GALGAS_bool (kIsNotEqual, enumerator_11856.current_mSelector (HERE).mAttribute_string.objectCompare (enumerator_11892.current_mSelector (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_23) {
          GALGAS_location location_24 (enumerator_11892.current_mSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_24, GALGAS_string ("the selector of the observable property should be '").add_operation (enumerator_11856.current_mSelector (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 303)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 303)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 303))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 303)) ;
        }
    ...
    const enumGalgasBool test_25 = GALGAS_bool (kIsNotEqual, var_controllerBindingOptionDecoratedList.reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 309)).objectCompare (enumerator_10143.current_mBindingOptionList (HERE).reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 309)))).boolEnum () ;
    if (kBoolTrue == test_25) {
      GALGAS_string var_s ;
      const enumGalgasBool test_26 = GALGAS_bool (kIsEqual, var_controllerBindingOptionDecoratedList.reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 311)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_26) {
        var_s = GALGAS_string ("this binding has no option") ;
      }else if (kBoolFalse == test_26) {
        var_s = GALGAS_string ("this binding requires the following options:") ;
        cEnumerator_controllerBindingOptionDecoratedList enumerator_12955 (var_controllerBindingOptionDecoratedList, kEnumeration_up) ;
        while (enumerator_12955.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").add_operation (enumerator_12955.current_mOptionName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 316)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 316)).add_operation (GALGAS_string (" : "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 316)).add_operation (enumerator_12955.current_mOptionType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 316)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 316))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 316)) ;
          enumerator_12955.gotoNextObject () ;
        }
      }
      GALGAS_location location_27 (enumerator_10143.current_mBindingName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_27, var_s  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 319)) ;
    }else if (kBoolFalse == test_25) {
      cEnumerator_controllerBindingOptionDecoratedList enumerator_13164 (var_controllerBindingOptionDecoratedList, kEnumeration_up) ;
      cEnumerator_bindingOptionList enumerator_13199 (enumerator_10143.current_mBindingOptionList (HERE), kEnumeration_up) ;
      while (enumerator_13164.hasCurrentObject () && enumerator_13199.hasCurrentObject ()) {
        const enumGalgasBool test_28 = GALGAS_bool (kIsNotEqual, enumerator_13164.current_mOptionName (HERE).mAttribute_string.objectCompare (enumerator_13199.current_mOptionName (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_28) {
          GALGAS_location location_29 (enumerator_13199.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_29, GALGAS_string ("the option name should be '").add_operation (enumerator_13164.current_mOptionName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 323)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 323)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 323))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 323)) ;
        }
        GALGAS_string var_optionValueAsString ;
        GALGAS_unifiedTypeProxyList temp_30 = GALGAS_unifiedTypeProxyList::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 326)) ;
        temp_30.addAssign_operation (enumerator_13164.current_mOptionType (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 326)) ;
        callCategoryMethod_analyzeDefaultValueType ((const cPtr_abstractDefaultValue *) enumerator_13199.current_mOptionValue (HERE).ptr (), temp_30, var_optionValueAsString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 325)) ;
        var_bindingOptionString.dotAssign_operation (GALGAS_string (", ").add_operation (enumerator_13164.current_mOptionName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 329)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 329)).add_operation (var_optionValueAsString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 329))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 329)) ;
        enumerator_13164.gotoNextObject () ;
        enumerator_13199.gotoNextObject () ;
      }
    }
    GALGAS_string var_title = GALGAS_string::makeEmptyString () ;
    cEnumerator__32_stringlist enumerator_13758 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_13758.hasCurrentObject ()) {
      var_title.dotAssign_operation (enumerator_13758.current_mValue_30_ (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 335)).add_operation (enumerator_13758.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 335))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 335)) ;
      enumerator_13758.gotoNextObject () ;
    }
    GALGAS_string var_controllerString = GALGAS_string ("//").add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (8212)), GALGAS_uint ((uint32_t) 117U)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 337)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 337)).add_operation (GALGAS_string ("*\n"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 337)) ;
    var_controllerString.dotAssign_operation (GALGAS_string ("//   Controller ").add_operation (var_title.add_operation (GALGAS_string (" - "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 338)).add_operation (var_outletTypeName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 338)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 338)).add_operation (GALGAS_string (" $"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 338)).add_operation (enumerator_10143.current_mBindingName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 338)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 338)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 103U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 338)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 338)).add_operation (GALGAS_string ("*\n"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 338))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 338)) ;
    var_controllerString.dotAssign_operation (GALGAS_string ("//").add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (8212)), GALGAS_uint ((uint32_t) 117U)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 339)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 339)).add_operation (GALGAS_string ("*\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 339))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 339)) ;
    GALGAS_string var_templateStringWithReplacements = var_templateString ;
    cEnumerator__32_stringlist enumerator_14245 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_14245.hasCurrentObject ()) {
      var_templateStringWithReplacements = var_templateStringWithReplacements.reader_stringByReplacingStringByString (GALGAS_string ("$OBJECTCLASS$"), enumerator_14245.current_mValue_30_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 342)) ;
      var_templateStringWithReplacements = var_templateStringWithReplacements.reader_stringByReplacingStringByString (GALGAS_string ("$MODEL$"), enumerator_14245.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 343)) ;
      enumerator_14245.gotoNextObject () ;
    }
    var_controllerString.dotAssign_operation (var_templateStringWithReplacements  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 345)) ;
    ioArgument_ioGeneration.mAttribute_mControllerGenerationStringSet.addAssign_operation (var_controllerString  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 346)) ;
    GALGAS_string var_controllerInstanciationString = GALGAS_string ("Controller") ;
    cEnumerator__32_stringlist enumerator_14791 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_14791.hasCurrentObject ()) {
      var_controllerInstanciationString.dotAssign_operation (GALGAS_string ("_").add_operation (enumerator_14791.current_mValue_30_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 350)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 350)).add_operation (enumerator_14791.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 350))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 350)) ;
      enumerator_14791.gotoNextObject () ;
    }
    var_controllerInstanciationString.dotAssign_operation (GALGAS_string ("_").add_operation (var_outletTypeName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 352)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 352)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 352)).add_operation (enumerator_10143.current_mBindingName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 352)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 352)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 352))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 352)) ;
    GALGAS_string var_prefix = GALGAS_string ("object") ;
    cEnumerator_stringlist enumerator_15035 (var_boundObjectNameList, kEnumeration_up) ;
    GALGAS_uint index_15008 ((uint32_t) 0) ;
    while (enumerator_15035.hasCurrentObject ()) {
      var_controllerInstanciationString.dotAssign_operation (var_prefix.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 355)).add_operation (enumerator_15035.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 355)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 355))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 355)) ;
      var_prefix = GALGAS_string ("object").add_operation (index_15008.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 356)).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 356)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 356)) ;
      enumerator_15035.gotoNextObject () ;
      index_15008.increment_operation (inCompiler  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 354)) ;
    }
    var_controllerInstanciationString.dotAssign_operation (GALGAS_string ("outlet:").add_operation (enumerator_10143.current_mOutletName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 358)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 358)).add_operation (GALGAS_string (", file:__FILE__, line:__LINE__"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 358)).add_operation (var_bindingOptionString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 358)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 358))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 358)) ;
    var_controllerInstanciationStringList.addAssign_operation (var_controllerInstanciationString  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 359)) ;
    enumerator_10143.gotoNextObject () ;
  }
  cEnumerator_actionMap enumerator_15433 (constinArgument_inActionMap, kEnumeration_up) ;
  while (enumerator_15433.hasCurrentObject ()) {
    ioArgument_ioGeneration.mAttribute_mActionListForGeneration.addAssign_operation (constinArgument_inTypeName.mAttribute_string, enumerator_15433.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 363)) ;
  ...
  if (constinArgument_inTypeKind.isValid ()) {
    ...
    case GALGAS_typeKind::kEnum_enumType: {
      ioArgument_ioGeneration.mAttribute_mEnumListForGeneration.addAssign_operation (constinArgument_inTypeName.mAttribute_string, constinArgument_inEnumConstantList  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 368)) ;
      } break ;
    case GALGAS_typeKind::kEnum_entityType: {
      GALGAS_string temp_31 ;
      const enumGalgasBool test_32 = constinArgument_inSuperType.reader_isNull (SOURCE_FILE ("typeAnalysis.gSemantics", 375)).boolEnum () ;
      if (kBoolTrue == test_32) {
        temp_31 = GALGAS_string::makeEmptyString () ;
      }else if (kBoolFalse == test_32) {
        temp_31 = constinArgument_inSuperType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 375)) ;
      }
      ioArgument_ioGeneration.mAttribute_mEntityListForGeneration.addAssign_operation (constinArgument_inTypeName.mAttribute_string, temp_31, var_attributeListForGeneration, var_transientDefinitionListForGeneration, var_entityRelationshipListForGeneration  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 373)) ;
      } break ;
    case GALGAS_typeKind::kEnum_documentType: {
      ioArgument_ioGeneration.mAttribute_mDocumentListForGeneration.addAssign_operation (constinArgument_inTypeName.mAttribute_string, constinArgument_inRootEntityType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 383)), var_attributeListForGeneration, var_transientDefinitionListForGeneration, constinArgument_decoratedOutletMap, var_controllerInstanciationStringList, var_documentArrayControllerForGeneration, var_targetActionList  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 381)) ;
      } break ;
...
static void categoryMethod_selfObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_lstring joker_19042_0 ; // Joker input parameter
  constinArgument_inObservablePropertyMap.method_searchKey (object->mAttribute_mSelfObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_19042_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 454)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 462)) ;
  }
  ioArgument_ioControllerSignature.dotAssign_operation (GALGAS_string (".").add_operation (categoryReader_typeNameForControllerTemplateName (var_propertyType, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 464)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 464)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 464)).add_operation (constinArgument_inSelectorName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 464)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 464))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 464)) ;
  ioArgument_ioBoundPropertyTypeList.addAssign_operation (var_propertyType, constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 465)) ;
  ioArgument_ioTypePropertyNameList.addAssign_operation (constinArgument_inCurrentTypeName, object->mAttribute_mSelfObservablePropertyName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 466)) ;
  ioArgument_ioBoundObjectNameList.addAssign_operation (GALGAS_string ("self")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 467)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_rootObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_20324_0 ; // Joker input parameter
  constinArgument_inRootEntityType.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 485)).method_searchKey (object->mAttribute_mRootObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_20324_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 485)) ;
  const enumGalgasBool test_0 = var_isCollection.operator_and (object->mAttribute_mNamesCountOption.operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 492)) COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 492)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 493)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = object->mAttribute_mNamesCountOption.operator_and (var_isCollection.operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 494)) COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 494)).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the observable property should be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 495)) ;
    }
  }
  ioArgument_ioBoundObjectNameList.addAssign_operation (GALGAS_string ("rootObject")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 497)) ;
  const enumGalgasBool test_4 = object->mAttribute_mNamesCountOption.boolEnum () ;
  if (kBoolTrue == test_4) {
    ioArgument_ioControllerSignature.dotAssign_operation (GALGAS_string (".Integer.").add_operation (constinArgument_inSelectorName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 499)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 499))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 499)) ;
    ioArgument_ioTypePropertyNameList.addAssign_operation (constinArgument_inRootEntityType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 500)), object->mAttribute_mRootObservablePropertyName.mAttribute_string.add_operation (GALGAS_string ("_count"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 500))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 500)) ;
    ioArgument_ioBoundPropertyTypeList.addAssign_operation (GALGAS_unifiedTypeProxy::constructor_searchKey (constinArgument_inUnifiedTypeMap, GALGAS_string ("Integer").reader_nowhere (SOURCE_FILE ("typeAnalysis.gSemantics", 501)), inCompiler  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 501)), constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 501)) ;
  }else if (kBoolFalse == test_4) {
    ioArgument_ioControllerSignature.dotAssign_operation (GALGAS_string (".").add_operation (categoryReader_typeNameForControllerTemplateName (var_propertyType, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 503)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 503)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 503)).add_operation (constinArgument_inSelectorName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 503)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 503))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 503)) ;
    ioArgument_ioTypePropertyNameList.addAssign_operation (constinArgument_inRootEntityType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 504)), object->mAttribute_mRootObservablePropertyName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 504)) ;
    ioArgument_ioBoundPropertyTypeList.addAssign_operation (var_propertyType, constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 505)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeProxy joker_22085_5 ; // Joker input parameter
  GALGAS_unifiedTypeProxy joker_22085_4 ; // Joker input parameter
  GALGAS_decoratedAttributeMap joker_22085_3 ; // Joker input parameter
  GALGAS_decoratedTransientMap joker_22085_2 ; // Joker input parameter
  GALGAS_decoratedOutletMap joker_22085_1 ; // Joker input parameter
  GALGAS_decoratedEntityRelationshipMap joker_22153_6 ; // Joker input parameter
  GALGAS_actionMap joker_22153_5 ; // Joker input parameter
  GALGAS_bindingList joker_22153_4 ; // Joker input parameter
  GALGAS_lstringlist joker_22153_3 ; // Joker input parameter
  GALGAS_enumConstantMap joker_22153_2 ; // Joker input parameter
  GALGAS_arrayControllerMap joker_22153_1 ; // Joker input parameter
  constinArgument_inUnifiedTypeMap.method_searchKey (object->mAttribute_mPreferenceName, var_typeKind, joker_22085_5, joker_22085_4, joker_22085_3, joker_22085_2, joker_22085_1, var_observablePropertyMap, joker_22153_6, joker_22153_5, joker_22153_4, joker_22153_3, joker_22153_2, joker_22153_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 525)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKind.objectCompare (GALGAS_typeKind::constructor_preferencesType (SOURCE_FILE ("typeAnalysis.gSemantics", 532)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mPreferenceName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("there is no '").operator_concat (object->mAttribute_mPreferenceName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 533))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 533)).operator_concat (GALGAS_string ("' preferences")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 533))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 533)) ;
  }
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_22455_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_22455_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 536)) ;
  ...
  if (kBoolTrue == test_2) {
    ...
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 544)) ;
  }
  ioArgument_ioControllerSignature.dotAssign_operation (GALGAS_string (".").add_operation (categoryReader_typeNameForControllerTemplateName (var_propertyType, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 546)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 546)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 546)).add_operation (constinArgument_inSelectorName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 546)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 546))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 546)) ;
  ioArgument_ioBoundPropertyTypeList.addAssign_operation (var_propertyType, constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 547)) ;
  ioArgument_ioTypePropertyNameList.addAssign_operation (object->mAttribute_mPreferenceName.mAttribute_string, object->mAttribute_mPreferenceObservablePropertyName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 548)) ;
  ioArgument_ioBoundObjectNameList.addAssign_operation (GALGAS_string ("g_").add_operation (object->mAttribute_mPreferenceName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 549)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 549))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 549)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_lstring joker_23758_3 ; // Joker input parameter
  GALGAS_arrayControllerBoundColumnListAST joker_23758_2 ; // Joker input parameter
  GALGAS_actionMap joker_23758_1 ; // Joker input parameter
  GALGAS_lstring joker_23841_0 ; // Joker input parameter
  constinArgument_inArrayControllerMap.method_searchKey (object->mAttribute_mArrayControllerName, var_boundModel, joker_23758_3, joker_23758_2, joker_23758_1, var_arrayControllerObservablePropertyMap, joker_23841_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 568)) ;
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_24019_0 ; // Joker input parameter
  var_arrayControllerObservablePropertyMap.method_searchKey (object->mAttribute_mArrayControllerObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_24019_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 576)) ;
  const enumGalgasBool test_0 = var_isCollection.boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 584)) ;
  }
  ioArgument_ioControllerSignature.dotAssign_operation (GALGAS_string (".").add_operation (categoryReader_typeNameForControllerTemplateName (var_propertyType, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 586)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 586)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 586)).add_operation (constinArgument_inSelectorName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 586)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 586))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 586)) ;
  ioArgument_ioBoundPropertyTypeList.addAssign_operation (var_propertyType, constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 587)) ;
  ioArgument_ioBoundObjectNameList.addAssign_operation (object->mAttribute_mArrayControllerName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 588)) ;
  ioArgument_ioTypePropertyNameList.addAssign_operation (GALGAS_string ("ArrayController_").add_operation (callCategoryReader_modelSignatureForArrayController ((const cPtr_abstractObservablePropertyAST *) var_boundModel.ptr (), constinArgument_inRootEntityType, constinArgument_inCurrentTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 590)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 590)), object->mAttribute_mArrayControllerObservablePropertyName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 589)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_selfObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("the bound array should be a root object model")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 616)) ;
...
static void categoryMethod_rootObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_lstring joker_26273_0 ; // Joker input parameter
  constinArgument_inCurrentRelationshipMap.method_searchKey (object->mAttribute_mRootObservablePropertyName, var_mIsToMany, outArgument_outRelationshipTypeProxy, joker_26273_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 629)) ;
  const enumGalgasBool test_0 = var_mIsToMany.operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 635)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mRootObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the observable property should be a tomany relationship")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 636)) ;
  }
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("the bound array should be a root object model")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 648)) ;
  outArgument_outBoundRootTomanyRelationshipName.drop () ; // Release error dropped variable
  outArgument_outRelationshipTypeProxy.drop () ; // Release error dropped variable
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("the bound array should be a root object model")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 661)) ;
  outArgument_outBoundRootTomanyRelationshipName.drop () ; // Release error dropped variable
  outArgument_outRelationshipTypeProxy.drop () ; // Release error dropped variable
}
//---------------------------------------------------------------------------------------------------------------------*
...
static GALGAS_lstring categoryReader_selfObservablePropertyAST_propertySignature (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_selfObservablePropertyAST * object = (const cPtr_selfObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_selfObservablePropertyAST) ;
  result_outSignature = GALGAS_lstring::constructor_new (constinArgument_inKind.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 691)).add_operation (constinArgument_inSelfTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 691)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 691)).add_operation (object->mAttribute_mSelfObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 691)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 691)), object->mAttribute_mSelfObservablePropertyName.mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 690)) ;
//---
...
static GALGAS_lstring categoryReader_rootObservablePropertyAST_propertySignature (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_rootObservablePropertyAST * object = (const cPtr_rootObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_rootObservablePropertyAST) ;
  result_outSignature = GALGAS_lstring::constructor_new (GALGAS_string ("entity.").add_operation (constinArgument_inRootypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 705)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 705)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 705)).add_operation (object->mAttribute_mRootObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 705)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 705)), object->mAttribute_mRootObservablePropertyName.mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 704)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_lstring categoryReader_preferenceObservablePropertyAST_propertySignature (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_preferenceObservablePropertyAST * object = (const cPtr_preferenceObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_preferenceObservablePropertyAST) ;
  result_outSignature = GALGAS_lstring::constructor_new (GALGAS_string ("preferences.").add_operation (object->mAttribute_mPreferenceName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 719)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 719)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 719)).add_operation (object->mAttribute_mPreferenceObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 719)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 719)), object->mAttribute_mPreferenceObservablePropertyName.mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 718)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_lstring categoryReader_arrayControllerObservablePropertyAST_propertySignature (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_arrayControllerObservablePropertyAST * object = (const cPtr_arrayControllerObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayControllerObservablePropertyAST) ;
  result_outSignature = GALGAS_lstring::constructor_new (constinArgument_inKind.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 733)).add_operation (constinArgument_inSelfTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 733)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 733)).add_operation (object->mAttribute_mArrayControllerObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 733)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 733)), object->mAttribute_mArrayControllerObservablePropertyName.mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 732)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_string categoryReader_rootObservablePropertyAST_modelSignatureForArrayController (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_rootObservablePropertyAST * object = (const cPtr_rootObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_rootObservablePropertyAST) ;
  result_outSignature = constinArgument_inRootypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 769)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 769)).add_operation (object->mAttribute_mRootObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 769)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 769)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_string categoryReader_arrayControllerObservablePropertyAST_modelSignatureForArrayController (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_arrayControllerObservablePropertyAST * object = (const cPtr_arrayControllerObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayControllerObservablePropertyAST) ;
  result_outSignature = constinArgument_inSelfTypeName.add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 789)).add_operation (object->mAttribute_mArrayControllerObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 789)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 789)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientRootSignDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  result_outResult = GALGAS_transientRootSignDependencyForGeneration::constructor_new (object->mAttribute_mDeclarationLocation  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 807)) ;
//---
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientLocalDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  result_outResult = GALGAS_transientLocalDependencyForGeneration::constructor_new (object->mAttribute_mMasterName, object->mAttribute_mNamesCountOption  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 816)) ;
//---
  return result_outResult ;
}
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientRootDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  result_outResult = GALGAS_transientRootDependencyForGeneration::constructor_new (object->mAttribute_mMasterName, object->mAttribute_mNamesCountOption  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 825)) ;
//---
  return result_outResult ;
}
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientRootRelationshipDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  GALGAS_bool joker_33621_0 ; // Joker input parameter
  GALGAS_lstring joker_33664_0 ; // Joker input parameter
  constinArgument_inRootEntityType.reader_mCurrentRelationshipMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 834)).method_searchKey (object->mAttribute_mRelationshipName, joker_33621_0, var_elementType, joker_33664_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 834)) ;
  result_outResult = GALGAS_transientRootRelationshipDependencyForGeneration::constructor_new (var_elementType, object->mAttribute_mRelationshipName, object->mAttribute_mMasterName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 840)) ;
//---
  return result_outResult ;
}
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientControllerDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  result_outResult = GALGAS_transientControllerDependencyForGeneration::constructor_new (object->mAttribute_mControllerName, object->mAttribute_mMasterName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 849)) ;
//---
  return result_outResult ;
}
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientPreferenceDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  result_outResult = GALGAS_transientPreferenceDependencyForGeneration::constructor_new (object->mAttribute_mPreferencesName, object->mAttribute_mMasterName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 858)) ;
//---
  return result_outResult ;
}
