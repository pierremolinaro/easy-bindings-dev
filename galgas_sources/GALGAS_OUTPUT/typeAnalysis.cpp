...
//                                         september 10th, 2014, at 20h19'5"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
void routine_unifiedTypeAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  while (enumerator_6056.hasCurrentObject ()) {
    ...
    while (enumerator_6781.hasCurrentObject ()) {
      ...
      GALGAS_lstring joker_6963_0 ; // Joker input parameter
      var_outElementTypeProxy.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 168)).method_searchKey (enumerator_6781.current_mObservablePropertyName (HERE), var_propertyType, joker_6930_0, joker_6963_0, var_mIsCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 168)) ;
  ...
  cEnumerator_decoratedTransientMap enumerator_7844 (constinArgument_decoratedTransientMap, kEnumeration_up) ;
  while (enumerator_7844.hasCurrentObject ()) {
    ...
    cEnumerator_dependanceList enumerator_7964 (enumerator_7844.current_mDependencyList (HERE), kEnumeration_up) ;
    while (enumerator_7964.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_12) {
        GALGAS_location location_13 (enumerator_7844.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_13, GALGAS_string ("the '").operator_concat (enumerator_7844.current_mTransientType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 201))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 201)).operator_concat (GALGAS_string ("' type is not acceptable for transient")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 201))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 201)) ;
      }
      callCategoryMethod_transientDependencySemanticAnalysis ((const cPtr_abstractTransientDependency *) enumerator_7964.current_mDependency (HERE).ptr (), constinArgument_inUnifiedTypeMap, enumerator_7844.current_lkey (HERE), constinArgument_inAllObservablePropertyMap, constinArgument_inArrayControllerMap, constinArgument_inRootEntityType, enumerator_7844.current_mTransientSignature (HERE), var_transientDependencyListForGeneration, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 203)) ;
      enumerator_7964.gotoNextObject () ;
    }
    ioArgument_ioGeneration.mAttribute_mTransientListForGeneration.addAssign_operation (enumerator_7844.current_mTransientSignature (HERE).mAttribute_string, enumerator_7844.current_mTransientType (HERE), var_transientDependencyListForGeneration  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 213)) ;
  ...
  cEnumerator_decoratedAttributeMap enumerator_8727 (constinArgument_decoratedAttributeMap, kEnumeration_up) ;
  while (enumerator_8727.hasCurrentObject ()) {
    ...
    temp_14.addAssign_operation (enumerator_8727.current_mAttributeType (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 219)) ;
    callCategoryMethod_analyzeDefaultValueType ((const cPtr_abstractDefaultValue *) enumerator_8727.current_mDefaultValue (HERE).ptr (), temp_14, var_swiftDefaultValueAsString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 218)) ;
    var_attributeListForGeneration.addAssign_operation (enumerator_8727.current_mAttributeType (HERE), enumerator_8727.current_lkey (HERE).mAttribute_string, var_swiftDefaultValueAsString  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 222)) ;
  ...
  cEnumerator_bindingList enumerator_9058 (constinArgument_inBindingList, kEnumeration_up) ;
  while (enumerator_9058.hasCurrentObject ()) {
    ...
    callCategoryMethod_analyzeBoundObservablePropertyForSimpleBinding ((const cPtr_abstractObservablePropertyAST *) enumerator_9058.current_mObservableProperty (HERE).ptr (), constinArgument_inUnifiedTypeMap, constinArgument_inArrayControllerMap, enumerator_9058.current_mSelectorName (HERE), constinArgument_inTypeName.mAttribute_string, constinArgument_inCurrentObservablePropertyMap, constinArgument_inRootEntityType, var_controllerSignature, var_boundPropertyTypeList, var_typePropertyNameList, var_boundObjectNameList, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 231)) ;
    GALGAS_lstring var_outletTypeName ;
    GALGAS_lstring joker_9694_2 ; // Joker input parameter
    GALGAS_lstring joker_9694_1 ; // Joker input parameter
    constinArgument_decoratedOutletMap.method_searchKey (enumerator_9058.current_mOutletName (HERE), var_outletTypeName, joker_9694_2, joker_9694_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 243)) ;
    var_controllerSignature = var_outletTypeName.mAttribute_string.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 244)).add_operation (enumerator_9058.current_mBindingName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 244)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 244)).add_operation (var_controllerSignature, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 244)) ;
    GALGAS_lstring var_controllerTemplateName = GALGAS_lstring::constructor_new (var_controllerSignature, enumerator_9058.current_mBindingName (HERE).mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 245)) ;
    ...
    if (kBoolTrue == test_15) {
      GALGAS_location location_16 (enumerator_9058.current_mOutletName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_16, GALGAS_string ("internal error")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 260)) ;
    }else if (kBoolFalse == test_15) {
      cEnumerator_unifiedTypeProxySelectorList enumerator_10524 (var_modelPropertyTypeList, kEnumeration_up) ;
      cEnumerator_unifiedTypeProxySelectorList enumerator_10560 (var_boundPropertyTypeList, kEnumeration_up) ;
      while (enumerator_10524.hasCurrentObject () && enumerator_10560.hasCurrentObject ()) {
        const enumGalgasBool test_17 = GALGAS_bool (kIsEqual, enumerator_10524.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 263)).objectCompare (GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("typeAnalysis.gSemantics", 263)))).operator_and (GALGAS_bool (kIsEqual, enumerator_10560.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 263)).objectCompare (GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("typeAnalysis.gSemantics", 263)))) COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 263)).boolEnum () ;
        if (kBoolTrue == test_17) {
        }else if (kBoolFalse == test_17) {
          const enumGalgasBool test_18 = GALGAS_bool (kIsNotEqual, enumerator_10524.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 265)).objectCompare (enumerator_10560.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 265)))).boolEnum () ;
          if (kBoolTrue == test_18) {
            GALGAS_location location_19 (enumerator_10560.current_mSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_19, GALGAS_string ("the type of the observable property is '").add_operation (enumerator_10560.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 266)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 266)).add_operation (GALGAS_string ("', but this binding requires the '"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 266)).add_operation (enumerator_10524.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 267)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 267)).add_operation (GALGAS_string ("' type"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 267))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 266)) ;
          }
        }
        const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_10524.current_mSelector (HERE).mAttribute_string.objectCompare (enumerator_10560.current_mSelector (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_20) {
          GALGAS_location location_21 (enumerator_10560.current_mSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_21, GALGAS_string ("the selector of the observable property should be '").add_operation (enumerator_10524.current_mSelector (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 271)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 271)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 271))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 271)) ;
        }
    ...
    const enumGalgasBool test_22 = GALGAS_bool (kIsNotEqual, var_controllerBindingOptionDecoratedList.reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 277)).objectCompare (enumerator_9058.current_mBindingOptionList (HERE).reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 277)))).boolEnum () ;
    if (kBoolTrue == test_22) {
      ...
      if (kBoolTrue == test_23) {
        ...
        cEnumerator_controllerBindingOptionDecoratedList enumerator_11623 (var_controllerBindingOptionDecoratedList, kEnumeration_up) ;
        while (enumerator_11623.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").add_operation (enumerator_11623.current_mOptionName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 284)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 284)).add_operation (GALGAS_string (" : "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 284)).add_operation (enumerator_11623.current_mOptionType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 284)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 284))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 284)) ;
          enumerator_11623.gotoNextObject () ;
        }
      }
      GALGAS_location location_24 (enumerator_9058.current_mBindingName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_24, var_s  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 287)) ;
    }else if (kBoolFalse == test_22) {
      cEnumerator_controllerBindingOptionDecoratedList enumerator_11832 (var_controllerBindingOptionDecoratedList, kEnumeration_up) ;
      cEnumerator_bindingOptionList enumerator_11867 (enumerator_9058.current_mBindingOptionList (HERE), kEnumeration_up) ;
      while (enumerator_11832.hasCurrentObject () && enumerator_11867.hasCurrentObject ()) {
        const enumGalgasBool test_25 = GALGAS_bool (kIsNotEqual, enumerator_11832.current_mOptionName (HERE).mAttribute_string.objectCompare (enumerator_11867.current_mOptionName (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_25) {
          GALGAS_location location_26 (enumerator_11867.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_26, GALGAS_string ("the option name should be '").add_operation (enumerator_11832.current_mOptionName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 291)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 291)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 291))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 291)) ;
        }
        ...
        temp_27.addAssign_operation (enumerator_11832.current_mOptionType (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 294)) ;
        callCategoryMethod_analyzeDefaultValueType ((const cPtr_abstractDefaultValue *) enumerator_11867.current_mOptionValue (HERE).ptr (), temp_27, var_optionValueAsString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 293)) ;
        var_bindingOptionString.dotAssign_operation (GALGAS_string (", ").add_operation (enumerator_11832.current_mOptionName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 297)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 297)).add_operation (var_optionValueAsString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 297))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 297)) ;
        enumerator_11832.gotoNextObject () ;
        enumerator_11867.gotoNextObject () ;
      }
    }
    GALGAS_string var_title = GALGAS_string::makeEmptyString () ;
    cEnumerator__32_stringlist enumerator_12426 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_12426.hasCurrentObject ()) {
      var_title.dotAssign_operation (enumerator_12426.current_mValue_30_ (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 303)).add_operation (enumerator_12426.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 303))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 303)) ;
    ...
    cEnumerator__32_stringlist enumerator_12913 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_12913.hasCurrentObject ()) {
      var_templateStringWithReplacements = var_templateStringWithReplacements.reader_stringByReplacingStringByString (GALGAS_string ("$OBJECTCLASS$"), enumerator_12913.current_mValue_30_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 310)) ;
      var_templateStringWithReplacements = var_templateStringWithReplacements.reader_stringByReplacingStringByString (GALGAS_string ("$MODEL$"), enumerator_12913.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 311)) ;
    ...
    cEnumerator__32_stringlist enumerator_13459 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_13459.hasCurrentObject ()) {
      var_controllerInstanciationString.dotAssign_operation (GALGAS_string ("_").add_operation (enumerator_13459.current_mValue_30_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 318)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 318)).add_operation (enumerator_13459.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 318))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 318)) ;
      enumerator_13459.gotoNextObject () ;
    }
    var_controllerInstanciationString.dotAssign_operation (GALGAS_string ("_").add_operation (var_outletTypeName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 320)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 320)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 320)).add_operation (enumerator_9058.current_mBindingName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 320)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 320)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 320))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 320)) ;
    GALGAS_string var_prefix = GALGAS_string ("object") ;
    cEnumerator_stringlist enumerator_13703 (var_boundObjectNameList, kEnumeration_up) ;
    GALGAS_uint index_13676 ((uint32_t) 0) ;
    while (enumerator_13703.hasCurrentObject ()) {
      var_controllerInstanciationString.dotAssign_operation (var_prefix.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 323)).add_operation (enumerator_13703.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 323)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 323))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 323)) ;
      var_prefix = GALGAS_string ("object").add_operation (index_13676.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 324)).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 324)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 324)) ;
      enumerator_13703.gotoNextObject () ;
      index_13676.increment_operation (inCompiler  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 322)) ;
    }
    var_controllerInstanciationString.dotAssign_operation (GALGAS_string ("outlet:").add_operation (enumerator_9058.current_mOutletName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 326)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 326)).add_operation (GALGAS_string (", file:__FILE__, line:__LINE__"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 326)).add_operation (var_bindingOptionString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 326)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 326))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 326)) ;
  ...
  cEnumerator_actionMap enumerator_14101 (constinArgument_inActionMap, kEnumeration_up) ;
  while (enumerator_14101.hasCurrentObject ()) {
    ioArgument_ioGeneration.mAttribute_mActionListForGeneration.addAssign_operation (constinArgument_inTypeName.mAttribute_string, enumerator_14101.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 331)) ;
...
static void categoryMethod_selfObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_bool joker_17579_0 ; // Joker input parameter
  GALGAS_lstring joker_17607_0 ; // Joker input parameter
  constinArgument_inObservablePropertyMap.method_searchKey (object->mAttribute_mSelfObservablePropertyName, var_propertyType, joker_17579_0, joker_17607_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 420)) ;
  ...
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 428)) ;
  }
  ioArgument_ioControllerSignature.dotAssign_operation (GALGAS_string (".").add_operation (categoryReader_typeNameForControllerTemplateName (var_propertyType, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 430)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 430)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 430)).add_operation (constinArgument_inSelectorName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 430)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 430))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 430)) ;
  ioArgument_ioBoundPropertyTypeList.addAssign_operation (var_propertyType, constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 431)) ;
  ioArgument_ioTypePropertyNameList.addAssign_operation (constinArgument_inCurrentTypeName, object->mAttribute_mSelfObservablePropertyName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 432)) ;
  ioArgument_ioBoundObjectNameList.addAssign_operation (GALGAS_string ("self")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 433)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_rootObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_18835_0 ; // Joker input parameter
  GALGAS_lstring joker_18863_0 ; // Joker input parameter
  constinArgument_inRootEntityType.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 450)).method_searchKey (object->mAttribute_mRootObservablePropertyName, var_propertyType, joker_18835_0, joker_18863_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 450)) ;
  const enumGalgasBool test_0 = var_isCollection.operator_and (object->mAttribute_mNamesCountOption.operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 457)) COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 457)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 458)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = object->mAttribute_mNamesCountOption.operator_and (var_isCollection.operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 459)) COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 459)).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the observable property should be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 460)) ;
    }
  }
  ioArgument_ioBoundObjectNameList.addAssign_operation (GALGAS_string ("rootObject")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 462)) ;
  const enumGalgasBool test_4 = object->mAttribute_mNamesCountOption.boolEnum () ;
  if (kBoolTrue == test_4) {
    ioArgument_ioControllerSignature.dotAssign_operation (GALGAS_string (".Integer.").add_operation (constinArgument_inSelectorName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 464)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 464))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 464)) ;
    ioArgument_ioTypePropertyNameList.addAssign_operation (constinArgument_inRootEntityType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 465)), object->mAttribute_mRootObservablePropertyName.mAttribute_string.add_operation (GALGAS_string ("_count"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 465))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 465)) ;
    ioArgument_ioBoundPropertyTypeList.addAssign_operation (GALGAS_unifiedTypeProxy::constructor_searchKey (constinArgument_inUnifiedTypeMap, GALGAS_string ("Integer").reader_nowhere (SOURCE_FILE ("typeAnalysis.gSemantics", 466)), inCompiler  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 466)), constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 466)) ;
  }else if (kBoolFalse == test_4) {
    ioArgument_ioControllerSignature.dotAssign_operation (GALGAS_string (".").add_operation (categoryReader_typeNameForControllerTemplateName (var_propertyType, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 468)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 468)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 468)).add_operation (constinArgument_inSelectorName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 468)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 468))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 468)) ;
    ioArgument_ioTypePropertyNameList.addAssign_operation (constinArgument_inRootEntityType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 469)), object->mAttribute_mRootObservablePropertyName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 469)) ;
    ioArgument_ioBoundPropertyTypeList.addAssign_operation (var_propertyType, constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 470)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeProxy joker_20595_5 ; // Joker input parameter
  GALGAS_unifiedTypeProxy joker_20595_4 ; // Joker input parameter
  GALGAS_decoratedAttributeMap joker_20595_3 ; // Joker input parameter
  GALGAS_decoratedTransientMap joker_20595_2 ; // Joker input parameter
  GALGAS_decoratedOutletMap joker_20595_1 ; // Joker input parameter
  GALGAS_decoratedEntityRelationshipMap joker_20663_6 ; // Joker input parameter
  GALGAS_actionMap joker_20663_5 ; // Joker input parameter
  GALGAS_bindingList joker_20663_4 ; // Joker input parameter
  GALGAS_lstringlist joker_20663_3 ; // Joker input parameter
  GALGAS_enumConstantMap joker_20663_2 ; // Joker input parameter
  GALGAS_arrayControllerMap joker_20663_1 ; // Joker input parameter
  constinArgument_inUnifiedTypeMap.method_searchKey (object->mAttribute_mPreferenceName, var_typeKind, joker_20595_5, joker_20595_4, joker_20595_3, joker_20595_2, joker_20595_1, var_observablePropertyMap, joker_20663_6, joker_20663_5, joker_20663_4, joker_20663_3, joker_20663_2, joker_20663_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 489)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKind.objectCompare (GALGAS_typeKind::constructor_preferencesType (SOURCE_FILE ("typeAnalysis.gSemantics", 496)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mPreferenceName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("there is no '").operator_concat (object->mAttribute_mPreferenceName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 497))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 497)).operator_concat (GALGAS_string ("' preferences")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 497))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 497)) ;
  }
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_20940_0 ; // Joker input parameter
  GALGAS_lstring joker_20968_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceObservablePropertyName, var_propertyType, joker_20940_0, joker_20968_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 500)) ;
  ...
  if (kBoolTrue == test_2) {
    ...
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 508)) ;
  }
  ioArgument_ioControllerSignature.dotAssign_operation (GALGAS_string (".").add_operation (categoryReader_typeNameForControllerTemplateName (var_propertyType, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 510)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 510)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 510)).add_operation (constinArgument_inSelectorName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 510)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 510))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 510)) ;
  ioArgument_ioBoundPropertyTypeList.addAssign_operation (var_propertyType, constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 511)) ;
  ioArgument_ioTypePropertyNameList.addAssign_operation (object->mAttribute_mPreferenceName.mAttribute_string, object->mAttribute_mPreferenceObservablePropertyName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 512)) ;
  ioArgument_ioBoundObjectNameList.addAssign_operation (GALGAS_string ("g_").add_operation (object->mAttribute_mPreferenceName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 513)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 513))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 513)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_lstring joker_22242_3 ; // Joker input parameter
  GALGAS_arrayControllerBoundColumnListAST joker_22242_2 ; // Joker input parameter
  GALGAS_actionMap joker_22242_1 ; // Joker input parameter
  GALGAS_lstring joker_22325_0 ; // Joker input parameter
  constinArgument_inArrayControllerMap.method_searchKey (object->mAttribute_mArrayControllerName, var_boundModel, joker_22242_3, joker_22242_2, joker_22242_1, var_arrayControllerObservablePropertyMap, joker_22325_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 531)) ;
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_22478_0 ; // Joker input parameter
  GALGAS_lstring joker_22506_0 ; // Joker input parameter
  var_arrayControllerObservablePropertyMap.method_searchKey (object->mAttribute_mArrayControllerObservablePropertyName, var_propertyType, joker_22478_0, joker_22506_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 539)) ;
  const enumGalgasBool test_0 = var_isCollection.boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 547)) ;
  }
  ioArgument_ioControllerSignature.dotAssign_operation (GALGAS_string (".").add_operation (categoryReader_typeNameForControllerTemplateName (var_propertyType, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 549)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 549)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 549)).add_operation (constinArgument_inSelectorName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 549)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 549))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 549)) ;
  ioArgument_ioBoundPropertyTypeList.addAssign_operation (var_propertyType, constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 550)) ;
  ioArgument_ioBoundObjectNameList.addAssign_operation (object->mAttribute_mArrayControllerName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 551)) ;
  ioArgument_ioTypePropertyNameList.addAssign_operation (GALGAS_string ("ArrayController_").add_operation (callCategoryReader_modelSignatureForArrayController ((const cPtr_abstractObservablePropertyAST *) var_boundModel.ptr (), constinArgument_inRootEntityType, constinArgument_inCurrentTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 553)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 553)), object->mAttribute_mArrayControllerObservablePropertyName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 552)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_selfObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("the bound array should be a root object model")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 579)) ;
...
static void categoryMethod_rootObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_lstring joker_24760_0 ; // Joker input parameter
  constinArgument_inCurrentRelationshipMap.method_searchKey (object->mAttribute_mRootObservablePropertyName, var_mIsToMany, outArgument_outRelationshipTypeProxy, joker_24760_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 592)) ;
  const enumGalgasBool test_0 = var_mIsToMany.operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 598)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mRootObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the observable property should be a tomany relationship")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 599)) ;
  }
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("the bound array should be a root object model")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 611)) ;
  outArgument_outBoundRootTomanyRelationshipName.drop () ; // Release error dropped variable
  outArgument_outRelationshipTypeProxy.drop () ; // Release error dropped variable
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("the bound array should be a root object model")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 624)) ;
  outArgument_outBoundRootTomanyRelationshipName.drop () ; // Release error dropped variable
  outArgument_outRelationshipTypeProxy.drop () ; // Release error dropped variable
}
//---------------------------------------------------------------------------------------------------------------------*
...
static GALGAS_lstring categoryReader_selfObservablePropertyAST_propertySignature (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_selfObservablePropertyAST * object = (const cPtr_selfObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_selfObservablePropertyAST) ;
  result_outSignature = GALGAS_lstring::constructor_new (constinArgument_inKind.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 654)).add_operation (constinArgument_inSelfTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 654)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 654)).add_operation (object->mAttribute_mSelfObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 654)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 654)), object->mAttribute_mSelfObservablePropertyName.mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 653)) ;
//---
...
static GALGAS_lstring categoryReader_rootObservablePropertyAST_propertySignature (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_rootObservablePropertyAST * object = (const cPtr_rootObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_rootObservablePropertyAST) ;
  result_outSignature = GALGAS_lstring::constructor_new (GALGAS_string ("entity.").add_operation (constinArgument_inRootypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 668)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 668)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 668)).add_operation (object->mAttribute_mRootObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 668)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 668)), object->mAttribute_mRootObservablePropertyName.mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 667)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_lstring categoryReader_preferenceObservablePropertyAST_propertySignature (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_preferenceObservablePropertyAST * object = (const cPtr_preferenceObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_preferenceObservablePropertyAST) ;
  result_outSignature = GALGAS_lstring::constructor_new (GALGAS_string ("preferences.").add_operation (object->mAttribute_mPreferenceName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 682)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 682)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 682)).add_operation (object->mAttribute_mPreferenceObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 682)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 682)), object->mAttribute_mPreferenceObservablePropertyName.mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 681)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_lstring categoryReader_arrayControllerObservablePropertyAST_propertySignature (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_arrayControllerObservablePropertyAST * object = (const cPtr_arrayControllerObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayControllerObservablePropertyAST) ;
  result_outSignature = GALGAS_lstring::constructor_new (constinArgument_inKind.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 696)).add_operation (constinArgument_inSelfTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 696)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 696)).add_operation (object->mAttribute_mArrayControllerObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 696)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 696)), object->mAttribute_mArrayControllerObservablePropertyName.mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 695)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_string categoryReader_rootObservablePropertyAST_modelSignatureForArrayController (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_rootObservablePropertyAST * object = (const cPtr_rootObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_rootObservablePropertyAST) ;
  result_outSignature = constinArgument_inRootypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 732)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 732)).add_operation (object->mAttribute_mRootObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 732)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 732)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_string categoryReader_arrayControllerObservablePropertyAST_modelSignatureForArrayController (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_arrayControllerObservablePropertyAST * object = (const cPtr_arrayControllerObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayControllerObservablePropertyAST) ;
  result_outSignature = constinArgument_inSelfTypeName.add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 752)).add_operation (object->mAttribute_mArrayControllerObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 752)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 752)) ;
//---
  return result_outSignature ;
}
