...
//                                         september 29th, 2014, at 18h7'51"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
void routine_unifiedTypeAnalysis (const GALGAS_unifiedTypeMap constinArgument_inUnifiedTypeMap,
  ...
  while (enumerator_4333.hasCurrentObject ()) {
    ...
    if (enumerator_4333.current_mEnabledBindingDescriptor (HERE).isValid ()) {
      ...
      case GALGAS_enabledBindingDescriptor::kEnum_enabledBinding: {
        const cEnumAssociatedValues_enabledBindingDescriptor_enabledBinding * extractPtr_6126 = dynamic_cast<const cEnumAssociatedValues_enabledBindingDescriptor_enabledBinding *> (enumerator_4333.current_mEnabledBindingDescriptor (HERE).unsafePointer ()) ;
        const GALGAS_abstractObservablePropertyAST extractedValue_property = extractPtr_6126->mAssociatedValue0 ;
        GALGAS_string var_observedObject ;
        GALGAS_string var_observedModel ;
        GALGAS_string var_observedTypeName ;
        callCategoryMethod_analyzeBoundObservablePropertyForEnabledBinding ((const cPtr_abstractObservablePropertyAST *) extractedValue_property.ptr (), constinArgument_inTypeName.mAttribute_string, constinArgument_inUnifiedTypeMap, constinArgument_inArrayControllerMap, constinArgument_inCurrentObservablePropertyMap, constinArgument_inRootEntityType, var_observedObject, var_observedModel, var_observedTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 143)) ;
        var_controllerInstanciationStringList.addAssign_operation (GALGAS_string ("EnableController_").add_operation (constinArgument_inTypeName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 153)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 153)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 153)).add_operation (enumerator_4333.current_lkey (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 153)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 153)).add_operation (GALGAS_string (" (object:"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 153)).add_operation (var_observedObject, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 153)).add_operation (GALGAS_string (", outlet:"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 153)).add_operation (enumerator_4333.current_lkey (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 153)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 153)).add_operation (GALGAS_string (", file:__FILE__, line:__LINE__)"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 153))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 153)) ;
        ioArgument_ioGeneration.mAttribute_mControllerGenerationStringSet.addAssign_operation (GALGAS_string (filewrapperTemplate_controllerTemplates_enabledBindingGeneration (inCompiler, constinArgument_inTypeName.mAttribute_string, enumerator_4333.current_lkey (HERE).mAttribute_string, var_observedTypeName, var_observedModel COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 154)))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 154)) ;
        } break ;
      }
    }
    enumerator_4333.gotoNextObject () ;
  }
  GALGAS_entityRelationshipListForGeneration var_entityRelationshipListForGeneration = GALGAS_entityRelationshipListForGeneration::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 163)) ;
  cEnumerator_decoratedEntityRelationshipMap enumerator_6302 (constinArgument_inCurrentRelationshipMap, kEnumeration_up) ;
  while (enumerator_6302.hasCurrentObject ()) {
    ...
    enumerator_6302.current_mRelationshipType (HERE).reader_mCurrentRelationshipMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 165)).method_searchKey (enumerator_6302.current_mOppositeRelationshipName (HERE), var_oppositeRelationIsToMany, var_oppositeRelationshipType, var_oppositeOfOppositeRelationshipName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 165)) ;
    const enumGalgasBool test_3 = GALGAS_bool (kIsNotEqual, var_oppositeOfOppositeRelationshipName.mAttribute_string.objectCompare (enumerator_6302.current_lkey (HERE).mAttribute_string)).boolEnum () ;
    if (kBoolTrue == test_3) {
      GALGAS_location location_4 (enumerator_6302.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_4, GALGAS_string ("the opposite relationship is '").operator_concat (enumerator_6302.current_mOppositeRelationshipName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 172))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 172)).operator_concat (GALGAS_string ("' and names '")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 172)).operator_concat (var_oppositeOfOppositeRelationshipName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 173))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 173)).operator_concat (GALGAS_string ("' as opposite, instead of '")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 173)).operator_concat (enumerator_6302.current_lkey (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 173))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 173)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 173))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 172)) ;
    }
    const enumGalgasBool test_5 = GALGAS_bool (kIsNotEqual, var_oppositeRelationshipType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 175)).objectCompare (constinArgument_inTypeName.mAttribute_string)).boolEnum () ;
    if (kBoolTrue == test_5) {
      GALGAS_location location_6 (enumerator_6302.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_6, GALGAS_string ("the opposite relationship type is '").operator_concat (var_oppositeRelationshipType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 176))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 176)).operator_concat (GALGAS_string ("', instead of '")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 176)).operator_concat (enumerator_6302.current_lkey (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 176))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 176)).operator_concat (GALGAS_string ("'")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 176))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 176)) ;
    }
    var_entityRelationshipListForGeneration.addAssign_operation (enumerator_6302.current_lkey (HERE).mAttribute_string, enumerator_6302.current_mIsToMany (HERE), enumerator_6302.current_mRelationshipType (HERE), enumerator_6302.current_mOppositeRelationshipName (HERE).mAttribute_string, var_oppositeRelationIsToMany  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 178)) ;
    enumerator_6302.gotoNextObject () ;
  }
  GALGAS_arrayControllerForGeneration var_documentArrayControllerForGeneration = GALGAS_arrayControllerForGeneration::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 187)) ;
  cEnumerator_arrayControllerMap enumerator_7404 (constinArgument_inArrayControllerMap, kEnumeration_up) ;
  while (enumerator_7404.hasCurrentObject ()) {
    ...
    callCategoryMethod_analyzeBoundObservablePropertyForArrayControllerBinding ((const cPtr_abstractObservablePropertyAST *) enumerator_7404.current_mBoundModel (HERE).ptr (), constinArgument_inRootEntityType.reader_mCurrentRelationshipMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 191)), var_outElementTypeProxy, var_outBoundRootTomanyRelationshipName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 190)) ;
    GALGAS_lstring var_outletTypeName ;
    GALGAS_runActionDescriptor joker_7792_2 ; // Joker input parameter
    GALGAS_enabledBindingDescriptor joker_7792_1 ; // Joker input parameter
    constinArgument_decoratedOutletMap.method_searchKey (enumerator_7404.current_mTableViewOutletName (HERE), var_outletTypeName, joker_7792_2, joker_7792_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 196)) ;
    ...
    if (kBoolTrue == test_7) {
      GALGAS_location location_8 (enumerator_7404.current_mTableViewOutletName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_8, GALGAS_string ("this outlet is not an instance of PMTableView")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 198)) ;
    }
    GALGAS_arrayControllerBoundColumnListForGeneration var_arrayControllerBoundColumnListForGeneration = GALGAS_arrayControllerBoundColumnListForGeneration::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 201)) ;
    cEnumerator_arrayControllerBoundColumnListAST enumerator_8129 (enumerator_7404.current_mArrayControllerBoundColumnListAST (HERE), kEnumeration_up) ;
    while (enumerator_8129.hasCurrentObject ()) {
      GALGAS_unifiedTypeProxy var_propertyType ;
      GALGAS_bool var_mIsCollection ;
      GALGAS_bool joker_8278_0 ; // Joker input parameter
      GALGAS_lstring joker_8319_0 ; // Joker input parameter
      var_outElementTypeProxy.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 203)).method_searchKey (enumerator_8129.current_mObservablePropertyName (HERE), var_propertyType, joker_8278_0, joker_8319_0, var_mIsCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 203)) ;
      const enumGalgasBool test_9 = var_mIsCollection.boolEnum () ;
      if (kBoolTrue == test_9) {
        GALGAS_location location_10 (enumerator_8129.current_mObservablePropertyName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_10, GALGAS_string ("the bound property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 211)) ;
      }
      var_arrayControllerBoundColumnListForGeneration.addAssign_operation (enumerator_8129.current_mColumnName (HERE).mAttribute_string, enumerator_8129.current_mColumnOutletTypeName (HERE).mAttribute_string, enumerator_8129.current_mObservablePropertyName (HERE).mAttribute_string, var_propertyType, enumerator_8129.current_mBindingOptionList (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 213)) ;
      enumerator_8129.gotoNextObject () ;
    }
    var_documentArrayControllerForGeneration.addAssign_operation (enumerator_7404.current_lkey (HERE).mAttribute_string, constinArgument_inRootEntityType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 223)), var_outBoundRootTomanyRelationshipName.mAttribute_string, var_outElementTypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 225)), enumerator_7404.current_mTableViewOutletName (HERE).mAttribute_string, var_arrayControllerBoundColumnListForGeneration  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 221)) ;
    enumerator_7404.gotoNextObject () ;
  }
  ioArgument_ioGeneration.mAttribute_mAllArrayControllerForGeneration.dotAssign_operation (var_documentArrayControllerForGeneration  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 230)) ;
  GALGAS_transientDefinitionListForGeneration var_transientDefinitionListForGeneration = GALGAS_transientDefinitionListForGeneration::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 232)) ;
  cEnumerator_decoratedTransientMap enumerator_9331 (constinArgument_decoratedTransientMap, kEnumeration_up) ;
  while (enumerator_9331.hasCurrentObject ()) {
    GALGAS_transientDependencyListForGeneration var_transientDependencyListForGeneration = GALGAS_transientDependencyListForGeneration::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 234)) ;
    cEnumerator_dependanceList enumerator_9451 (enumerator_9331.current_mDependencyList (HERE), kEnumeration_up) ;
    while (enumerator_9451.hasCurrentObject ()) {
      const enumGalgasBool test_11 = categoryReader_suitableForObservableProperty (enumerator_9331.current_mTransientType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 236)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 236)).operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 236)).boolEnum () ;
      if (kBoolTrue == test_11) {
        GALGAS_location location_12 (enumerator_9331.current_lkey (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
        inCompiler->emitSemanticError (location_12, GALGAS_string ("the '").operator_concat (enumerator_9331.current_mTransientType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 237))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 237)).operator_concat (GALGAS_string ("' type is not acceptable for transient")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 237))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 237)) ;
      }
      callCategoryMethod_transientDependencySemanticAnalysis ((const cPtr_abstractTransientDependencyAST *) enumerator_9451.current_mDependency (HERE).ptr (), constinArgument_inUnifiedTypeMap, enumerator_9331.current_lkey (HERE), constinArgument_inAllObservablePropertyMap, constinArgument_inArrayControllerMap, constinArgument_inRootEntityType, enumerator_9331.current_mTransientSignature (HERE), var_transientDependencyListForGeneration, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 239)) ;
      enumerator_9451.gotoNextObject () ;
    }
    GALGAS_dependanceListForGeneration var_dependencyListForGeneration = GALGAS_dependanceListForGeneration::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 249)) ;
    cEnumerator_dependanceList enumerator_10029 (enumerator_9331.current_mDependencyList (HERE), kEnumeration_up) ;
    while (enumerator_10029.hasCurrentObject ()) {
      var_dependencyListForGeneration.addAssign_operation (callCategoryReader_buildDecoratedRepresentation ((const cPtr_abstractTransientDependencyAST *) enumerator_10029.current_mDependency (HERE).ptr (), constinArgument_inRootEntityType, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 251))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 251)) ;
      enumerator_10029.gotoNextObject () ;
    }
    var_transientDefinitionListForGeneration.addAssign_operation (enumerator_9331.current_lkey (HERE).mAttribute_string, enumerator_9331.current_mTransientType (HERE), enumerator_9331.current_mTransientSignature (HERE), var_dependencyListForGeneration  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 253)) ;
    ioArgument_ioGeneration.mAttribute_mTransientListForGeneration.addAssign_operation (enumerator_9331.current_mTransientSignature (HERE).mAttribute_string, enumerator_9331.current_mTransientType (HERE), var_transientDependencyListForGeneration  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 259)) ;
    enumerator_9331.gotoNextObject () ;
  }
  GALGAS_attributeListForGeneration var_attributeListForGeneration = GALGAS_attributeListForGeneration::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 262)) ;
  cEnumerator_decoratedAttributeMap enumerator_10586 (constinArgument_decoratedAttributeMap, kEnumeration_up) ;
  while (enumerator_10586.hasCurrentObject ()) {
    GALGAS_string var_swiftDefaultValueAsString ;
    GALGAS_unifiedTypeProxyList temp_13 = GALGAS_unifiedTypeProxyList::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 265)) ;
    temp_13.addAssign_operation (enumerator_10586.current_mAttributeType (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 265)) ;
    callCategoryMethod_analyzeDefaultValueType ((const cPtr_abstractDefaultValue *) enumerator_10586.current_mDefaultValue (HERE).ptr (), temp_13, var_swiftDefaultValueAsString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 264)) ;
    var_attributeListForGeneration.addAssign_operation (enumerator_10586.current_mAttributeType (HERE), enumerator_10586.current_lkey (HERE).mAttribute_string, var_swiftDefaultValueAsString, enumerator_10586.current_mNeedsValidation (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 268)) ;
    const enumGalgasBool test_14 = enumerator_10586.current_mNeedsValidation (HERE).boolEnum () ;
    if (kBoolTrue == test_14) {
      ioArgument_ioGeneration.mAttribute_mValidationStubRoutineListForGeneration.addAssign_operation (constinArgument_inTypeName.mAttribute_string, enumerator_10586.current_lkey (HERE).mAttribute_string, categoryReader_swiftTypeName (enumerator_10586.current_mAttributeType (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 273))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 270)) ;
    }
    enumerator_10586.gotoNextObject () ;
  }
  cEnumerator_bindingList enumerator_11143 (constinArgument_inBindingList, kEnumeration_up) ;
  while (enumerator_11143.hasCurrentObject ()) {
    GALGAS_string var_controllerSignature = GALGAS_string::makeEmptyString () ;
    GALGAS_unifiedTypeProxySelectorList var_boundPropertyTypeList = GALGAS_unifiedTypeProxySelectorList::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 280)) ;
    GALGAS__32_stringlist var_typePropertyNameList = GALGAS__32_stringlist::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 281)) ;
    GALGAS_stringlist var_boundObjectNameList = GALGAS_stringlist::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 282)) ;
    GALGAS_bool var_modelIsTransient ;
    callCategoryMethod_analyzeBoundObservablePropertyForSimpleBinding ((const cPtr_abstractObservablePropertyAST *) enumerator_11143.current_mObservableProperty (HERE).ptr (), constinArgument_inUnifiedTypeMap, constinArgument_inArrayControllerMap, enumerator_11143.current_mSelectorName (HERE), constinArgument_inTypeName.mAttribute_string, constinArgument_inCurrentObservablePropertyMap, constinArgument_inRootEntityType, var_controllerSignature, var_boundPropertyTypeList, var_typePropertyNameList, var_boundObjectNameList, var_modelIsTransient, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 283)) ;
    GALGAS_lstring var_outletTypeName ;
    GALGAS_runActionDescriptor joker_11810_2 ; // Joker input parameter
    GALGAS_enabledBindingDescriptor joker_11810_1 ; // Joker input parameter
    constinArgument_decoratedOutletMap.method_searchKey (enumerator_11143.current_mOutletName (HERE), var_outletTypeName, joker_11810_2, joker_11810_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 296)) ;
    var_controllerSignature = var_outletTypeName.mAttribute_string.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 297)).add_operation (enumerator_11143.current_mBindingName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 297)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 297)).add_operation (var_controllerSignature, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 297)) ;
    GALGAS_lstring var_controllerTemplateName = GALGAS_lstring::constructor_new (var_controllerSignature, enumerator_11143.current_mBindingName (HERE).mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 298)) ;
    ...
    constinArgument_inTemplateControllerMap.method_searchKey (var_controllerTemplateName, var_templateString, var_modelTypeProxy, var_modelSelector, var_modelShouldBeWritableProperty, var_controllerBindingOptionDecoratedList, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 302)) ;
    const enumGalgasBool test_15 = var_modelShouldBeWritableProperty.operator_and (var_modelIsTransient COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 310)).boolEnum () ;
    if (kBoolTrue == test_15) {
      GALGAS_location location_16 (enumerator_11143.current_mSelectorName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_16, GALGAS_string ("the model is transient and the binding requires an writable model")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 311)) ;
    }
    GALGAS_unifiedTypeProxySelectorList var_modelPropertyTypeList = GALGAS_unifiedTypeProxySelectorList::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 313)) ;
    var_modelPropertyTypeList.addAssign_operation (var_modelTypeProxy, var_modelSelector  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 314)) ;
    const enumGalgasBool test_17 = GALGAS_bool (kIsNotEqual, var_boundPropertyTypeList.reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 316)).objectCompare (var_modelPropertyTypeList.reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 316)))).boolEnum () ;
    if (kBoolTrue == test_17) {
      GALGAS_location location_18 (enumerator_11143.current_mOutletName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_18, GALGAS_string ("internal error")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 317)) ;
    }else if (kBoolFalse == test_17) {
      cEnumerator_unifiedTypeProxySelectorList enumerator_12856 (var_modelPropertyTypeList, kEnumeration_up) ;
      cEnumerator_unifiedTypeProxySelectorList enumerator_12892 (var_boundPropertyTypeList, kEnumeration_up) ;
      while (enumerator_12856.hasCurrentObject () && enumerator_12892.hasCurrentObject ()) {
        const enumGalgasBool test_19 = GALGAS_bool (kIsEqual, enumerator_12856.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 320)).objectCompare (GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("typeAnalysis.gSemantics", 320)))).operator_and (GALGAS_bool (kIsEqual, enumerator_12892.current_mType (HERE).reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 320)).objectCompare (GALGAS_typeKind::constructor_enumType (SOURCE_FILE ("typeAnalysis.gSemantics", 320)))) COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 320)).boolEnum () ;
        if (kBoolTrue == test_19) {
        }else if (kBoolFalse == test_19) {
          const enumGalgasBool test_20 = GALGAS_bool (kIsNotEqual, enumerator_12856.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 322)).objectCompare (enumerator_12892.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 322)))).boolEnum () ;
          if (kBoolTrue == test_20) {
            GALGAS_location location_21 (enumerator_12892.current_mSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
            inCompiler->emitSemanticError (location_21, GALGAS_string ("the type of the observable property is '").add_operation (enumerator_12892.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 323)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 323)).add_operation (GALGAS_string ("', but this binding requires the '"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 323)).add_operation (enumerator_12856.current_mType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 324)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 324)).add_operation (GALGAS_string ("' type"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 324))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 323)) ;
          }
        }
        const enumGalgasBool test_22 = GALGAS_bool (kIsNotEqual, enumerator_12856.current_mSelector (HERE).mAttribute_string.objectCompare (enumerator_12892.current_mSelector (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_22) {
          GALGAS_location location_23 (enumerator_12892.current_mSelector (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_23, GALGAS_string ("the selector of the observable property should be '").add_operation (enumerator_12856.current_mSelector (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 328)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 328)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 328))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 328)) ;
        }
    ...
    const enumGalgasBool test_24 = GALGAS_bool (kIsNotEqual, var_controllerBindingOptionDecoratedList.reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 334)).objectCompare (enumerator_11143.current_mBindingOptionList (HERE).reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 334)))).boolEnum () ;
    if (kBoolTrue == test_24) {
      GALGAS_string var_s ;
      const enumGalgasBool test_25 = GALGAS_bool (kIsEqual, var_controllerBindingOptionDecoratedList.reader_length (SOURCE_FILE ("typeAnalysis.gSemantics", 336)).objectCompare (GALGAS_uint ((uint32_t) 0U))).boolEnum () ;
      if (kBoolTrue == test_25) {
        var_s = GALGAS_string ("this binding has no option") ;
      }else if (kBoolFalse == test_25) {
        var_s = GALGAS_string ("this binding requires the following options:") ;
        cEnumerator_controllerBindingOptionDecoratedList enumerator_13955 (var_controllerBindingOptionDecoratedList, kEnumeration_up) ;
        while (enumerator_13955.hasCurrentObject ()) {
          var_s.dotAssign_operation (GALGAS_string ("\n"
            "  - ").add_operation (enumerator_13955.current_mOptionName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 341)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 341)).add_operation (GALGAS_string (" : "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 341)).add_operation (enumerator_13955.current_mOptionType (HERE).reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 341)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 341))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 341)) ;
          enumerator_13955.gotoNextObject () ;
        }
      }
      GALGAS_location location_26 (enumerator_11143.current_mBindingName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
      inCompiler->emitSemanticError (location_26, var_s  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 344)) ;
    }else if (kBoolFalse == test_24) {
      cEnumerator_controllerBindingOptionDecoratedList enumerator_14164 (var_controllerBindingOptionDecoratedList, kEnumeration_up) ;
      cEnumerator_bindingOptionList enumerator_14199 (enumerator_11143.current_mBindingOptionList (HERE), kEnumeration_up) ;
      while (enumerator_14164.hasCurrentObject () && enumerator_14199.hasCurrentObject ()) {
        const enumGalgasBool test_27 = GALGAS_bool (kIsNotEqual, enumerator_14164.current_mOptionName (HERE).mAttribute_string.objectCompare (enumerator_14199.current_mOptionName (HERE).mAttribute_string)).boolEnum () ;
        if (kBoolTrue == test_27) {
          GALGAS_location location_28 (enumerator_14199.current_mOptionName (HERE).reader_location (HERE)) ; // Implicit use of 'location' reader
          inCompiler->emitSemanticError (location_28, GALGAS_string ("the option name should be '").add_operation (enumerator_14164.current_mOptionName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 348)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 348)).add_operation (GALGAS_string ("'"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 348))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 348)) ;
        }
        GALGAS_string var_optionValueAsString ;
        GALGAS_unifiedTypeProxyList temp_29 = GALGAS_unifiedTypeProxyList::constructor_emptyList (SOURCE_FILE ("typeAnalysis.gSemantics", 351)) ;
        temp_29.addAssign_operation (enumerator_14164.current_mOptionType (HERE)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 351)) ;
        callCategoryMethod_analyzeDefaultValueType ((const cPtr_abstractDefaultValue *) enumerator_14199.current_mOptionValue (HERE).ptr (), temp_29, var_optionValueAsString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 350)) ;
        var_bindingOptionString.dotAssign_operation (GALGAS_string (", ").add_operation (enumerator_14164.current_mOptionName (HERE).mAttribute_string, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 354)).add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 354)).add_operation (var_optionValueAsString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 354))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 354)) ;
        enumerator_14164.gotoNextObject () ;
        enumerator_14199.gotoNextObject () ;
      }
    }
    GALGAS_string var_title = GALGAS_string::makeEmptyString () ;
    cEnumerator__32_stringlist enumerator_14758 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_14758.hasCurrentObject ()) {
      var_title.dotAssign_operation (enumerator_14758.current_mValue_30_ (HERE).add_operation (GALGAS_string (" "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 360)).add_operation (enumerator_14758.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 360))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 360)) ;
      enumerator_14758.gotoNextObject () ;
    }
    GALGAS_string var_controllerString = GALGAS_string ("//").add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (8212)), GALGAS_uint ((uint32_t) 117U)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 362)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 362)).add_operation (GALGAS_string ("*\n"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 362)) ;
    var_controllerString.dotAssign_operation (GALGAS_string ("//   Controller ").add_operation (var_title.add_operation (GALGAS_string (" - "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 363)).add_operation (var_outletTypeName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 363)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 363)).add_operation (GALGAS_string (" $"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 363)).add_operation (enumerator_11143.current_mBindingName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 363)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 363)).reader_stringByRightPadding (GALGAS_uint ((uint32_t) 103U), GALGAS_char (TO_UNICODE (32)) COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 363)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 363)).add_operation (GALGAS_string ("*\n"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 363))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 363)) ;
    var_controllerString.dotAssign_operation (GALGAS_string ("//").add_operation (GALGAS_string::constructor_stringWithSequenceOfCharacters (GALGAS_char (TO_UNICODE (8212)), GALGAS_uint ((uint32_t) 117U)  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 364)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 364)).add_operation (GALGAS_string ("*\n"
      "\n"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 364))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 364)) ;
    GALGAS_string var_templateStringWithReplacements = var_templateString ;
    cEnumerator__32_stringlist enumerator_15245 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_15245.hasCurrentObject ()) {
      var_templateStringWithReplacements = var_templateStringWithReplacements.reader_stringByReplacingStringByString (GALGAS_string ("$OBJECTCLASS$"), enumerator_15245.current_mValue_30_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 367)) ;
      var_templateStringWithReplacements = var_templateStringWithReplacements.reader_stringByReplacingStringByString (GALGAS_string ("$MODEL$"), enumerator_15245.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 368)) ;
      enumerator_15245.gotoNextObject () ;
    }
    var_controllerString.dotAssign_operation (var_templateStringWithReplacements  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 370)) ;
    ioArgument_ioGeneration.mAttribute_mControllerGenerationStringSet.addAssign_operation (var_controllerString  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 371)) ;
    GALGAS_string var_controllerInstanciationString = GALGAS_string ("Controller") ;
    cEnumerator__32_stringlist enumerator_15791 (var_typePropertyNameList, kEnumeration_up) ;
    while (enumerator_15791.hasCurrentObject ()) {
      var_controllerInstanciationString.dotAssign_operation (GALGAS_string ("_").add_operation (enumerator_15791.current_mValue_30_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 375)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 375)).add_operation (enumerator_15791.current_mValue_31_ (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 375))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 375)) ;
      enumerator_15791.gotoNextObject () ;
    }
    var_controllerInstanciationString.dotAssign_operation (GALGAS_string ("_").add_operation (var_outletTypeName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 377)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 377)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 377)).add_operation (enumerator_11143.current_mBindingName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 377)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 377)).add_operation (GALGAS_string (" ("), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 377))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 377)) ;
    GALGAS_string var_prefix = GALGAS_string ("object") ;
    cEnumerator_stringlist enumerator_16035 (var_boundObjectNameList, kEnumeration_up) ;
    GALGAS_uint index_16008 ((uint32_t) 0) ;
    while (enumerator_16035.hasCurrentObject ()) {
      var_controllerInstanciationString.dotAssign_operation (var_prefix.add_operation (GALGAS_string (":"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 380)).add_operation (enumerator_16035.current_mValue (HERE), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 380)).add_operation (GALGAS_string (", "), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 380))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 380)) ;
      var_prefix = GALGAS_string ("object").add_operation (index_16008.add_operation (GALGAS_uint ((uint32_t) 1U), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 381)).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 381)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 381)) ;
      enumerator_16035.gotoNextObject () ;
      index_16008.increment_operation (inCompiler  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 379)) ;
    }
    var_controllerInstanciationString.dotAssign_operation (GALGAS_string ("outlet:").add_operation (enumerator_11143.current_mOutletName (HERE).reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 383)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 383)).add_operation (GALGAS_string (", file:__FILE__, line:__LINE__"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 383)).add_operation (var_bindingOptionString, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 383)).add_operation (GALGAS_string (")"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 383))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 383)) ;
    var_controllerInstanciationStringList.addAssign_operation (var_controllerInstanciationString  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 384)) ;
    enumerator_11143.gotoNextObject () ;
  }
  cEnumerator_actionMap enumerator_16433 (constinArgument_inActionMap, kEnumeration_up) ;
  while (enumerator_16433.hasCurrentObject ()) {
    ioArgument_ioGeneration.mAttribute_mActionListForGeneration.addAssign_operation (constinArgument_inTypeName.mAttribute_string, enumerator_16433.current_lkey (HERE).mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 388)) ;
  ...
  if (constinArgument_inTypeKind.isValid ()) {
    ...
    case GALGAS_typeKind::kEnum_enumType: {
      ioArgument_ioGeneration.mAttribute_mEnumListForGeneration.addAssign_operation (constinArgument_inTypeName.mAttribute_string, constinArgument_inEnumConstantList  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 393)) ;
      } break ;
    case GALGAS_typeKind::kEnum_entityType: {
      GALGAS_string temp_30 ;
      const enumGalgasBool test_31 = constinArgument_inSuperType.reader_isNull (SOURCE_FILE ("typeAnalysis.gSemantics", 400)).boolEnum () ;
      if (kBoolTrue == test_31) {
        temp_30 = GALGAS_string::makeEmptyString () ;
      }else if (kBoolFalse == test_31) {
        temp_30 = constinArgument_inSuperType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 400)) ;
      }
      ioArgument_ioGeneration.mAttribute_mEntityListForGeneration.addAssign_operation (constinArgument_inTypeName.mAttribute_string, temp_30, var_attributeListForGeneration, var_transientDefinitionListForGeneration, var_entityRelationshipListForGeneration  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 398)) ;
      } break ;
    case GALGAS_typeKind::kEnum_documentType: {
      ioArgument_ioGeneration.mAttribute_mDocumentListForGeneration.addAssign_operation (constinArgument_inTypeName.mAttribute_string, constinArgument_inRootEntityType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 408)), var_attributeListForGeneration, var_transientDefinitionListForGeneration, constinArgument_decoratedOutletMap, var_controllerInstanciationStringList, var_documentArrayControllerForGeneration, var_targetActionList  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 406)) ;
      } break ;
...
void callCategoryMethod_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
                                                                         ...
                                                                         GALGAS_string & out_outObservedTypeName,
                                                                         C_Compiler * inCompiler
                                                                         COMMA_LOCATION_ARGS) {
//--- Drop output arguments
  out_outObservedObject.drop () ;
  out_outObservedModel.drop () ;
  out_outObservedTypeName.drop () ;
//--- Find method
  if (NULL != inObject) {
    ...
    if (NULL == f) {
      ...
      f (inObject, constin_inSelfTypeName, constin_inUnifiedTypeMap, constin_inArrayControllerMap, constin_inObservablePropertyMap, constin_inRootEntityType, out_outObservedObject, out_outObservedModel, out_outObservedTypeName, inCompiler COMMA_THERE) ;
    }
  }
}
...
static void categoryMethod_selfObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
                                                                                                      ...
                                                                                                      GALGAS_string & outArgument_outObservedTypeName,
                                                                                                      C_Compiler * inCompiler
                                                                                                      COMMA_UNUSED_LOCATION_ARGS) {
  ...
  outArgument_outObservedTypeName = constinArgument_inSelfTypeName ;
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_19778_0 ; // Joker input parameter
  GALGAS_lstring joker_19806_0 ; // Joker input parameter
  constinArgument_inObservablePropertyMap.method_searchKey (object->mAttribute_mSelfObservablePropertyName, var_propertyType, joker_19778_0, joker_19806_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 474)) ;
  const enumGalgasBool test_0 = var_propertyType.reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 481)).reader_isBoolType (SOURCE_FILE ("typeAnalysis.gSemantics", 481)).operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 481)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("this property should be boolean")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 482)) ;
  }else if (kBoolFalse == test_0) {
    ...
    if (kBoolTrue == test_2) {
      ...
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 484)) ;
    }
  }
...
static void categoryMethod_rootObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  outArgument_outObservedTypeName = constinArgument_inRootEntityType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 502)) ;
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool joker_20910_0 ; // Joker input parameter
  GALGAS_lstring joker_20938_0 ; // Joker input parameter
  GALGAS_bool joker_20974_0 ; // Joker input parameter
  constinArgument_inRootEntityType.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 503)).method_searchKey (object->mAttribute_mRootObservablePropertyName, var_propertyType, joker_20910_0, joker_20938_0, joker_20974_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 503)) ;
  const enumGalgasBool test_0 = var_propertyType.reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 510)).reader_isBoolType (SOURCE_FILE ("typeAnalysis.gSemantics", 510)).operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 510)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("this property should be boolean")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 511)) ;
  }
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  outArgument_outObservedTypeName = object->mAttribute_mPreferenceName.mAttribute_string ;
  GALGAS_typeKind var_typeKind ;
  GALGAS_decoratedObservablePropertyMap var_observablePropertyMap ;
  GALGAS_unifiedTypeProxy joker_22212_5 ; // Joker input parameter
  GALGAS_unifiedTypeProxy joker_22212_4 ; // Joker input parameter
  GALGAS_decoratedAttributeMap joker_22212_3 ; // Joker input parameter
  GALGAS_decoratedTransientMap joker_22212_2 ; // Joker input parameter
  GALGAS_decoratedOutletMap joker_22212_1 ; // Joker input parameter
  GALGAS_decoratedEntityRelationshipMap joker_22280_6 ; // Joker input parameter
  GALGAS_actionMap joker_22280_5 ; // Joker input parameter
  GALGAS_bindingList joker_22280_4 ; // Joker input parameter
  GALGAS_lstringlist joker_22280_3 ; // Joker input parameter
  GALGAS_enumConstantMap joker_22280_2 ; // Joker input parameter
  GALGAS_arrayControllerMap joker_22280_1 ; // Joker input parameter
  constinArgument_inUnifiedTypeMap.method_searchKey (object->mAttribute_mPreferenceName, var_typeKind, joker_22212_5, joker_22212_4, joker_22212_3, joker_22212_2, joker_22212_1, var_observablePropertyMap, joker_22280_6, joker_22280_5, joker_22280_4, joker_22280_3, joker_22280_2, joker_22280_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 536)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKind.objectCompare (GALGAS_typeKind::constructor_preferencesType (SOURCE_FILE ("typeAnalysis.gSemantics", 543)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mPreferenceName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("there is no '").operator_concat (object->mAttribute_mPreferenceName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 544))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 544)).operator_concat (GALGAS_string ("' preferences")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 544))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 544)) ;
  }
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_22557_0 ; // Joker input parameter
  GALGAS_lstring joker_22585_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceObservablePropertyName, var_propertyType, joker_22557_0, joker_22585_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 547)) ;
  const enumGalgasBool test_2 = var_propertyType.reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 554)).reader_isBoolType (SOURCE_FILE ("typeAnalysis.gSemantics", 554)).operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 554)).boolEnum () ;
  if (kBoolTrue == test_2) {
    ...
    inCompiler->emitSemanticError (location_3, GALGAS_string ("this property should be boolean")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 555)) ;
  }
  ...
  if (kBoolTrue == test_4) {
    ...
    inCompiler->emitSemanticError (location_5, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 558)) ;
  }
  outArgument_outObservedObject = GALGAS_string ("g_").add_operation (object->mAttribute_mPreferenceName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 560)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 560)) ;
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForEnabledBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_abstractObservablePropertyAST joker_23652_0 ; // Joker input parameter
  GALGAS_lstring joker_23704_3 ; // Joker input parameter
  GALGAS_arrayControllerBoundColumnListAST joker_23704_2 ; // Joker input parameter
  GALGAS_actionMap joker_23704_1 ; // Joker input parameter
  GALGAS_lstring joker_23787_0 ; // Joker input parameter
  constinArgument_inArrayControllerMap.method_searchKey (object->mAttribute_mArrayControllerName, joker_23652_0, joker_23704_3, joker_23704_2, joker_23704_1, var_arrayControllerObservablePropertyMap, joker_23787_0, outArgument_outObservedTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 577)) ;
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_bool joker_23965_0 ; // Joker input parameter
  GALGAS_lstring joker_23994_0 ; // Joker input parameter
  var_arrayControllerObservablePropertyMap.method_searchKey (object->mAttribute_mArrayControllerObservablePropertyName, var_propertyType, joker_23965_0, joker_23994_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 586)) ;
  const enumGalgasBool test_0 = var_propertyType.reader_mTypeKind (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 593)).reader_isBoolType (SOURCE_FILE ("typeAnalysis.gSemantics", 593)).operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 593)).boolEnum () ;
  if (kBoolTrue == test_0) {
    ...
    inCompiler->emitSemanticError (location_1, GALGAS_string ("this property should be boolean")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 594)) ;
  }
  const enumGalgasBool test_2 = var_isCollection.boolEnum () ;
  if (kBoolTrue == test_2) {
    ...
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 597)) ;
  }
...
static void categoryMethod_selfObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_26156_0 ; // Joker input parameter
  constinArgument_inObservablePropertyMap.method_searchKey (object->mAttribute_mSelfObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_26156_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 640)) ;
  const enumGalgasBool test_0 = var_isCollection.boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mSelfObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 648)) ;
  }
  ...
  ioArgument_ioBoundPropertyTypeList.addAssign_operation (var_propertyType, constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 651)) ;
  ioArgument_ioTypePropertyNameList.addAssign_operation (constinArgument_inCurrentTypeName, object->mAttribute_mSelfObservablePropertyName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 652)) ;
  ioArgument_ioBoundObjectNameList.addAssign_operation (GALGAS_string ("self")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 653)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_rootObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_27438_0 ; // Joker input parameter
  constinArgument_inRootEntityType.reader_mObservablePropertyMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 671)).method_searchKey (object->mAttribute_mRootObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_27438_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 671)) ;
  const enumGalgasBool test_0 = var_isCollection.operator_and (object->mAttribute_mNamesCountOption.operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 678)) COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 678)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mRootObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 679)) ;
  }else if (kBoolFalse == test_0) {
    const enumGalgasBool test_2 = object->mAttribute_mNamesCountOption.operator_and (var_isCollection.operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 680)) COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 680)).boolEnum () ;
    if (kBoolTrue == test_2) {
      ...
      inCompiler->emitSemanticError (location_3, GALGAS_string ("the observable property should be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 681)) ;
    }
  }
  ioArgument_ioBoundObjectNameList.addAssign_operation (GALGAS_string ("rootObject")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 683)) ;
  const enumGalgasBool test_4 = object->mAttribute_mNamesCountOption.boolEnum () ;
  if (kBoolTrue == test_4) {
    ioArgument_ioControllerSignature.dotAssign_operation (GALGAS_string (".Integer.").add_operation (constinArgument_inSelectorName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 685)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 685))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 685)) ;
    ioArgument_ioTypePropertyNameList.addAssign_operation (constinArgument_inRootEntityType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 686)), object->mAttribute_mRootObservablePropertyName.mAttribute_string.add_operation (GALGAS_string ("_count"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 686))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 686)) ;
    ioArgument_ioBoundPropertyTypeList.addAssign_operation (GALGAS_unifiedTypeProxy::constructor_searchKey (constinArgument_inUnifiedTypeMap, GALGAS_string ("Integer").reader_nowhere (SOURCE_FILE ("typeAnalysis.gSemantics", 687)), inCompiler  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 687)), constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 687)) ;
  }else if (kBoolFalse == test_4) {
    ioArgument_ioControllerSignature.dotAssign_operation (GALGAS_string (".").add_operation (categoryReader_typeNameForControllerTemplateName (var_propertyType, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 689)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 689)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 689)).add_operation (constinArgument_inSelectorName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 689)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 689))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 689)) ;
    ioArgument_ioTypePropertyNameList.addAssign_operation (constinArgument_inRootEntityType.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 690)), object->mAttribute_mRootObservablePropertyName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 690)) ;
    ioArgument_ioBoundPropertyTypeList.addAssign_operation (var_propertyType, constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 691)) ;
  }
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_typeKind var_typeKind ;
  GALGAS_decoratedObservablePropertyMap var_observablePropertyMap ;
  GALGAS_unifiedTypeProxy joker_29199_5 ; // Joker input parameter
  GALGAS_unifiedTypeProxy joker_29199_4 ; // Joker input parameter
  GALGAS_decoratedAttributeMap joker_29199_3 ; // Joker input parameter
  GALGAS_decoratedTransientMap joker_29199_2 ; // Joker input parameter
  GALGAS_decoratedOutletMap joker_29199_1 ; // Joker input parameter
  GALGAS_decoratedEntityRelationshipMap joker_29267_6 ; // Joker input parameter
  GALGAS_actionMap joker_29267_5 ; // Joker input parameter
  GALGAS_bindingList joker_29267_4 ; // Joker input parameter
  GALGAS_lstringlist joker_29267_3 ; // Joker input parameter
  GALGAS_enumConstantMap joker_29267_2 ; // Joker input parameter
  GALGAS_arrayControllerMap joker_29267_1 ; // Joker input parameter
  constinArgument_inUnifiedTypeMap.method_searchKey (object->mAttribute_mPreferenceName, var_typeKind, joker_29199_5, joker_29199_4, joker_29199_3, joker_29199_2, joker_29199_1, var_observablePropertyMap, joker_29267_6, joker_29267_5, joker_29267_4, joker_29267_3, joker_29267_2, joker_29267_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 711)) ;
  const enumGalgasBool test_0 = GALGAS_bool (kIsNotEqual, var_typeKind.objectCompare (GALGAS_typeKind::constructor_preferencesType (SOURCE_FILE ("typeAnalysis.gSemantics", 718)))).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mPreferenceName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("there is no '").operator_concat (object->mAttribute_mPreferenceName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 719))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 719)).operator_concat (GALGAS_string ("' preferences")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 719))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 719)) ;
  }
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_29569_0 ; // Joker input parameter
  var_observablePropertyMap.method_searchKey (object->mAttribute_mPreferenceObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_29569_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 722)) ;
  const enumGalgasBool test_2 = var_isCollection.boolEnum () ;
  if (kBoolTrue == test_2) {
    GALGAS_location location_3 (object->mAttribute_mPreferenceObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_3, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 730)) ;
  }
  ioArgument_ioControllerSignature.dotAssign_operation (GALGAS_string (".").add_operation (categoryReader_typeNameForControllerTemplateName (var_propertyType, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 732)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 732)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 732)).add_operation (constinArgument_inSelectorName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 732)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 732))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 732)) ;
  ioArgument_ioBoundPropertyTypeList.addAssign_operation (var_propertyType, constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 733)) ;
  ioArgument_ioTypePropertyNameList.addAssign_operation (object->mAttribute_mPreferenceName.mAttribute_string, object->mAttribute_mPreferenceObservablePropertyName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 734)) ;
  ioArgument_ioBoundObjectNameList.addAssign_operation (GALGAS_string ("g_").add_operation (object->mAttribute_mPreferenceName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 735)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 735))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 735)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForSimpleBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_decoratedObservablePropertyMap var_arrayControllerObservablePropertyMap ;
  GALGAS_lstring joker_30872_3 ; // Joker input parameter
  GALGAS_arrayControllerBoundColumnListAST joker_30872_2 ; // Joker input parameter
  GALGAS_actionMap joker_30872_1 ; // Joker input parameter
  GALGAS_lstring joker_30955_2 ; // Joker input parameter
  GALGAS_string joker_30955_1 ; // Joker input parameter
  constinArgument_inArrayControllerMap.method_searchKey (object->mAttribute_mArrayControllerName, var_boundModel, joker_30872_3, joker_30872_2, joker_30872_1, var_arrayControllerObservablePropertyMap, joker_30955_2, joker_30955_1, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 754)) ;
  GALGAS_unifiedTypeProxy var_propertyType ;
  GALGAS_bool var_isCollection ;
  GALGAS_lstring joker_31134_0 ; // Joker input parameter
  var_arrayControllerObservablePropertyMap.method_searchKey (object->mAttribute_mArrayControllerObservablePropertyName, var_propertyType, outArgument_outModelIsTransient, joker_31134_0, var_isCollection, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 762)) ;
  const enumGalgasBool test_0 = var_isCollection.boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mArrayControllerObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the observable property should not be a collection")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 770)) ;
  }
  ioArgument_ioControllerSignature.dotAssign_operation (GALGAS_string (".").add_operation (categoryReader_typeNameForControllerTemplateName (var_propertyType, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 772)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 772)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 772)).add_operation (constinArgument_inSelectorName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 772)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 772))  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 772)) ;
  ioArgument_ioBoundPropertyTypeList.addAssign_operation (var_propertyType, constinArgument_inSelectorName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 773)) ;
  ioArgument_ioBoundObjectNameList.addAssign_operation (object->mAttribute_mArrayControllerName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 774)) ;
  ioArgument_ioTypePropertyNameList.addAssign_operation (GALGAS_string ("ArrayController_").add_operation (callCategoryReader_modelSignatureForArrayController ((const cPtr_abstractObservablePropertyAST *) var_boundModel.ptr (), constinArgument_inRootEntityType, constinArgument_inCurrentTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 776)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 776)), object->mAttribute_mArrayControllerObservablePropertyName.mAttribute_string  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 775)) ;
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_selfObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("the bound array should be a root object model")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 802)) ;
...
static void categoryMethod_rootObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  GALGAS_lstring joker_33388_0 ; // Joker input parameter
  constinArgument_inCurrentRelationshipMap.method_searchKey (object->mAttribute_mRootObservablePropertyName, var_mIsToMany, outArgument_outRelationshipTypeProxy, joker_33388_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 815)) ;
  const enumGalgasBool test_0 = var_mIsToMany.operator_not (SOURCE_FILE ("typeAnalysis.gSemantics", 821)).boolEnum () ;
  if (kBoolTrue == test_0) {
    GALGAS_location location_1 (object->mAttribute_mRootObservablePropertyName.reader_location (HERE)) ; // Implicit use of 'location' reader
    inCompiler->emitSemanticError (location_1, GALGAS_string ("the observable property should be a tomany relationship")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 822)) ;
  }
...
static void categoryMethod_preferenceObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("the bound array should be a root object model")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 834)) ;
  outArgument_outBoundRootTomanyRelationshipName.drop () ; // Release error dropped variable
  outArgument_outRelationshipTypeProxy.drop () ; // Release error dropped variable
}
//---------------------------------------------------------------------------------------------------------------------*
...
static void categoryMethod_arrayControllerObservablePropertyAST_analyzeBoundObservablePropertyForArrayControllerBinding (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  inCompiler->emitSemanticError (location_0, GALGAS_string ("the bound array should be a root object model")  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 847)) ;
  outArgument_outBoundRootTomanyRelationshipName.drop () ; // Release error dropped variable
  outArgument_outRelationshipTypeProxy.drop () ; // Release error dropped variable
}
//---------------------------------------------------------------------------------------------------------------------*
...
static GALGAS_lstring categoryReader_selfObservablePropertyAST_propertySignature (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_selfObservablePropertyAST * object = (const cPtr_selfObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_selfObservablePropertyAST) ;
  result_outSignature = GALGAS_lstring::constructor_new (constinArgument_inKind.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 877)).add_operation (constinArgument_inSelfTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 877)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 877)).add_operation (object->mAttribute_mSelfObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 877)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 877)), object->mAttribute_mSelfObservablePropertyName.mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 876)) ;
//---
...
static GALGAS_lstring categoryReader_rootObservablePropertyAST_propertySignature (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_rootObservablePropertyAST * object = (const cPtr_rootObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_rootObservablePropertyAST) ;
  result_outSignature = GALGAS_lstring::constructor_new (GALGAS_string ("entity.").add_operation (constinArgument_inRootypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 891)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 891)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 891)).add_operation (object->mAttribute_mRootObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 891)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 891)), object->mAttribute_mRootObservablePropertyName.mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 890)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_lstring categoryReader_preferenceObservablePropertyAST_propertySignature (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_preferenceObservablePropertyAST * object = (const cPtr_preferenceObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_preferenceObservablePropertyAST) ;
  result_outSignature = GALGAS_lstring::constructor_new (GALGAS_string ("preferences.").add_operation (object->mAttribute_mPreferenceName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 905)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 905)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 905)).add_operation (object->mAttribute_mPreferenceObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 905)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 905)), object->mAttribute_mPreferenceObservablePropertyName.mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 904)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_lstring categoryReader_arrayControllerObservablePropertyAST_propertySignature (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_arrayControllerObservablePropertyAST * object = (const cPtr_arrayControllerObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayControllerObservablePropertyAST) ;
  result_outSignature = GALGAS_lstring::constructor_new (constinArgument_inKind.add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 919)).add_operation (constinArgument_inSelfTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 919)).add_operation (GALGAS_string ("."), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 919)).add_operation (object->mAttribute_mArrayControllerObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 919)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 919)), object->mAttribute_mArrayControllerObservablePropertyName.mAttribute_location  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 918)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_string categoryReader_selfObservablePropertyAST_arrayControllerTypeName (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_selfObservablePropertyAST * object = (const cPtr_selfObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_selfObservablePropertyAST) ;
  result_outTypeName = GALGAS_string ("ArrayController_").add_operation (constinArgument_inSelfTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 945)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 945)).add_operation (object->mAttribute_mSelfObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 945)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 945)) ;
//---
...
static GALGAS_string categoryReader_rootObservablePropertyAST_arrayControllerTypeName (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_rootObservablePropertyAST * object = (const cPtr_rootObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_rootObservablePropertyAST) ;
  result_outTypeName = GALGAS_string ("ArrayController_").add_operation (constinArgument_inRootypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 955)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 955)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 955)).add_operation (object->mAttribute_mRootObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 955)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 955)) ;
//---
  return result_outTypeName ;
}
...
static GALGAS_string categoryReader_preferenceObservablePropertyAST_arrayControllerTypeName (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_preferenceObservablePropertyAST * object = (const cPtr_preferenceObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_preferenceObservablePropertyAST) ;
  result_outTypeName = GALGAS_string ("ArrayController_").add_operation (object->mAttribute_mPreferenceName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 965)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 965)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 965)).add_operation (object->mAttribute_mPreferenceObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 965)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 965)) ;
//---
  return result_outTypeName ;
}
...
static GALGAS_string categoryReader_arrayControllerObservablePropertyAST_arrayControllerTypeName (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_arrayControllerObservablePropertyAST * object = (const cPtr_arrayControllerObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayControllerObservablePropertyAST) ;
  result_outTypeName = GALGAS_string ("ArrayController_").add_operation (constinArgument_inSelfTypeName, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 975)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 975)).add_operation (object->mAttribute_mArrayControllerObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 975)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 975)) ;
//---
  return result_outTypeName ;
}
...
static GALGAS_string categoryReader_selfObservablePropertyAST_modelSignatureForArrayController (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_selfObservablePropertyAST * object = (const cPtr_selfObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_selfObservablePropertyAST) ;
  result_outSignature = constinArgument_inSelfTypeName.add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 999)).add_operation (object->mAttribute_mSelfObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 999)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 999)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_string categoryReader_rootObservablePropertyAST_modelSignatureForArrayController (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_rootObservablePropertyAST * object = (const cPtr_rootObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_rootObservablePropertyAST) ;
  result_outSignature = constinArgument_inRootypeProxy.reader_key (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1009)).add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1009)).add_operation (object->mAttribute_mRootObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 1009)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1009)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_string categoryReader_arrayControllerObservablePropertyAST_modelSignatureForArrayController (const cPtr_abstractObservablePropertyAST * inObject,
  ...
  const cPtr_arrayControllerObservablePropertyAST * object = (const cPtr_arrayControllerObservablePropertyAST *) inObject ;
  macroValidSharedObject (object, cPtr_arrayControllerObservablePropertyAST) ;
  result_outSignature = constinArgument_inSelfTypeName.add_operation (GALGAS_string ("_"), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1029)).add_operation (object->mAttribute_mArrayControllerObservablePropertyName.reader_string (SOURCE_FILE ("typeAnalysis.gSemantics", 1029)), inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1029)) ;
//---
  return result_outSignature ;
}
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientRootSignDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  result_outResult = GALGAS_transientRootSignDependencyForGeneration::constructor_new (object->mAttribute_mDeclarationLocation  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1047)) ;
//---
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientLocalDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  result_outResult = GALGAS_transientLocalDependencyForGeneration::constructor_new (object->mAttribute_mMasterName, object->mAttribute_mNamesCountOption  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1056)) ;
//---
  return result_outResult ;
}
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientRootDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  result_outResult = GALGAS_transientRootDependencyForGeneration::constructor_new (object->mAttribute_mMasterName, object->mAttribute_mNamesCountOption  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1065)) ;
//---
  return result_outResult ;
}
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientRootRelationshipDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  GALGAS_bool joker_42693_0 ; // Joker input parameter
  GALGAS_lstring joker_42736_0 ; // Joker input parameter
  constinArgument_inRootEntityType.reader_mCurrentRelationshipMap (inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1074)).method_searchKey (object->mAttribute_mRelationshipName, joker_42693_0, var_elementType, joker_42736_0, inCompiler COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1074)) ;
  result_outResult = GALGAS_transientRootRelationshipDependencyForGeneration::constructor_new (var_elementType, object->mAttribute_mRelationshipName, object->mAttribute_mMasterName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1080)) ;
//---
  return result_outResult ;
}
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientControllerDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  result_outResult = GALGAS_transientControllerDependencyForGeneration::constructor_new (object->mAttribute_mControllerName, object->mAttribute_mMasterName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1089)) ;
//---
  return result_outResult ;
}
...
static GALGAS_abstractTransientDependencyForGeneration categoryReader_transientPreferenceDependencyAST_buildDecoratedRepresentation (const cPtr_abstractTransientDependencyAST * inObject,
  ...
  result_outResult = GALGAS_transientPreferenceDependencyForGeneration::constructor_new (object->mAttribute_mPreferencesName, object->mAttribute_mMasterName  COMMA_SOURCE_FILE ("typeAnalysis.gSemantics", 1098)) ;
//---
  return result_outResult ;
}
