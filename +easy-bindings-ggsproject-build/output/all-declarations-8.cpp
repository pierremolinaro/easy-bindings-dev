    ...
    case GALGAS_classKind::kEnum_atomic:
      {
        ...
        objectArray_4991->mProperty_mPropertyGenerationList.setter_append (GALGAS_atomicPropertyGeneration::class_func_new (temp_7.readProperty_mPropertyName ().readProperty_string (), temp_8.readProperty_mGenerateResetMethod (), temp_9.readProperty_mGenerateDirectRead (), temp_10.readProperty_mGenerateDirectAccess (), extractedValue_5442_kind, GALGAS_bool (false), var_swiftDefaultValueAsString_5689, GALGAS_bool (ComparisonKind::equal, temp_11.readProperty_mClassName ().readProperty_string ().objectCompare (function_preferencesName (inCompiler COMMA_SOURCE_FILE ("simple-stored-property.ggs", 152))))  COMMA_SOURCE_FILE ("simple-stored-property.ggs", 144)), inCompiler COMMA_SOURCE_FILE ("simple-stored-property.ggs", 144)) ;
        }
      }
      break ;
    case GALGAS_classKind::kEnum_document:
...
void cPtr_comparisonMultipleBindingExpressionAST::method_analyzeExpressionForMultipleBinding (const GALGAS_bool constinArgument_inPreferences,
  ...
  if (kBoolTrue == test_5) {
    test_5 = GALGAS_bool (ComparisonKind::notEqual, var_outRightType_21515.objectCompare (var_outLeftType_21166)).boolEnum () ;
    if (kBoolTrue == test_5) {
      TC_Array <FixItDescription> fixItArray6 ;
...
void cPtr_autoLayoutTableViewControllerDeclarationAST::method_thirdAnalysisPhase (GALGAS_semanticContext & ioArgument_ioSemanticContext,
  ...
  const GALGAS_autoLayoutTableViewControllerDeclarationAST temp_2 = this ;
  cEnumerator_autoLayoutTableViewControllerAttributListAST enumerator_8720 (temp_2.readProperty_mTableViewControllerAttributListAST (), EnumerationOrder::up) ;
  ...
  cEnumerator_stringset enumerator_9206 (var_attributes_8492, EnumerationOrder::up) ;
  ...
  const GALGAS_autoLayoutTableViewControllerDeclarationAST temp_25 = this ;
  cEnumerator_autoLayoutTableViewControllerBoundColumnListAST enumerator_11426 (temp_25.readProperty_mTableViewControllerBoundColumnListAST (), EnumerationOrder::up) ;
  while (enumerator_11426.hasCurrentObject ()) {
    ...
    if (kBoolTrue == test_26) {
      test_26 = GALGAS_bool (ComparisonKind::notEqual, var_formalArgumentList_12288.getter_count (SOURCE_FILE ("auto-layout-table-view-controller.ggs", 325)).objectCompare (enumerator_11426.current_mColumnParameterListAST (HERE).getter_count (SOURCE_FILE ("auto-layout-table-view-controller.ggs", 325)))).boolEnum () ;
      if (kBoolTrue == test_26) {
    ...
    if (kBoolFalse == test_26) {
      cEnumerator_autoLayoutClassParameterList enumerator_13011 (var_formalArgumentList_12288, EnumerationOrder::up) ;
      cEnumerator_astAutoLayoutViewInstructionParameterList enumerator_13071 (enumerator_11426.current_mColumnParameterListAST (HERE), EnumerationOrder::up) ;
      while (enumerator_13011.hasCurrentObject () && enumerator_13071.hasCurrentObject ()) {
        enumGalgasBool test_28 = kBoolTrue ;
        if (kBoolTrue == test_28) {
          test_28 = GALGAS_bool (ComparisonKind::notEqual, enumerator_13011.current_mParameterName (HERE).readProperty_string ().objectCompare (enumerator_13071.current_mParameterName (HERE).readProperty_string ())).boolEnum () ;
          if (kBoolTrue == test_28) {
            TC_Array <FixItDescription> fixItArray29 ;
        ...
        if (kBoolFalse == test_30) {
          ...
          if (kBoolTrue == test_33) {
            test_33 = GALGAS_bool (ComparisonKind::notEqual, enumerator_13071.current_mParameterType (HERE).objectCompare (enumerator_13011.current_mParameterType (HERE))).boolEnum () ;
            if (kBoolTrue == test_33) {
              TC_Array <FixItDescription> fixItArray34 ;
    ...
    enumGalgasBool test_37 = kBoolTrue ;
    if (kBoolTrue == test_37) {
      test_37 = GALGAS_bool (ComparisonKind::notEqual, enumerator_11426.current_mSortPropertyName (HERE).readProperty_string ().objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
      if (kBoolTrue == test_37) {
...
void cPtr_autoLayoutTableViewControllerGeneration::method_generateCode (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  cEnumerator_autoLayoutTableViewControllerSortedColumnListForGeneration enumerator_22084 (temp_0.readProperty_mTableViewControllerSortedColumnListForGeneration (), EnumerationOrder::up) ;
  ...
  case GALGAS_propertyKind::kEnum_arrayController:
    {
      ...
      if (kBoolTrue == test_8) {
        ...
        test_8 = GALGAS_bool (ComparisonKind::notEqual, extractedValue_5094_typeName.readProperty_string ().objectCompare (temp_9.readProperty_mSelectionEntityName ().readProperty_string ())).boolEnum () ;
        if (kBoolTrue == test_8) {
          {
      ...
      if (GALGAS_uint::class_func_max (SOURCE_FILE ("selection-controller.ggs", 135)).isValid ()) {
        ...
        bool loop_6079 = true ;
        while (loop_6079) {
          loop_6079 = GALGAS_bool (ComparisonKind::notEqual, extractedValue_5094_typeName.readProperty_string ().objectCompare (var_testedTypeName_6024)).operator_and (GALGAS_bool (ComparisonKind::notEqual, var_testedTypeName_6024.objectCompare (GALGAS_string::makeEmptyString ())) COMMA_SOURCE_FILE ("selection-controller.ggs", 135)).isValid () ;
          if (loop_6079) {
          ...
          if (loop_6079) {
            ...
            if (kBoolTrue == test_13) {
              const GALGAS_selectionControllerDeclarationAST temp_14 = this ;
              test_13 = GALGAS_bool (ComparisonKind::notEqual, extractedValue_5094_typeName.readProperty_string ().objectCompare (temp_14.readProperty_mSelectionEntityName ().readProperty_string ())).boolEnum () ;
              if (kBoolTrue == test_13) {
                ...
                case GALGAS_classKind::kEnum_entity:
                  {
                    ...
                    enumGalgasBool test_15 = kBoolTrue ;
                    if (kBoolTrue == test_15) {
                      test_15 = GALGAS_bool (ComparisonKind::equal, var_testedTypeName_6024.objectCompare (GALGAS_string::makeEmptyString ())).boolEnum () ;
                      if (kBoolTrue == test_15) {
                        const GALGAS_selectionControllerDeclarationAST temp_16 = this ;
                        TC_Array <FixItDescription> fixItArray17 ;
...
void routine_generateSelectionControllers_3F__3F__26_ (const GALGAS_selectionControllerForGeneration constinArgument_inArrayControllerListForGeneration,
                                                       ...
                                                       Compiler * inCompiler
                                                       COMMA_UNUSED_LOCATION_ARGS) {
  cEnumerator_selectionControllerForGeneration enumerator_11183 (constinArgument_inArrayControllerListForGeneration, EnumerationOrder::up) ;
  while (enumerator_11183.hasCurrentObject ()) {
    enumGalgasBool test_0 = kBoolTrue ;
    if (kBoolTrue == test_0) {
      test_0 = GALGAS_bool (ComparisonKind::equal, enumerator_11183.current_mBaseTypeName (HERE).objectCompare (enumerator_11183.current_mSelectionTypeName (HERE))).boolEnum () ;
      if (kBoolTrue == test_0) {
    ...
    if (kBoolFalse == test_0) {
      ...
      cEnumerator_propertyGenerationList enumerator_11820 (enumerator_11183.current_mPropertyGenerationList (HERE), EnumerationOrder::up) ;
...
void cPtr_boolAsDefaultValue::method_analyzeDefaultValueType (const GALGAS_typeKindList constinArgument_inAttributeActualTypeList,
  ...
  cEnumerator_typeKindList enumerator_4253 (constinArgument_inAttributeActualTypeList, EnumerationOrder::up) ;
...
void cPtr_integerAsDefaultValue::method_analyzeDefaultValueType (const GALGAS_typeKindList constinArgument_inAttributeActualTypeList,
  ...
  cEnumerator_typeKindList enumerator_5247 (constinArgument_inAttributeActualTypeList, EnumerationOrder::up) ;
...
void cPtr_doubleAsDefaultValue::method_analyzeDefaultValueType (const GALGAS_typeKindList constinArgument_inAttributeActualTypeList,
  ...
  cEnumerator_typeKindList enumerator_6573 (constinArgument_inAttributeActualTypeList, EnumerationOrder::up) ;
...
void cPtr_stringAsDefaultValue::method_analyzeDefaultValueType (const GALGAS_typeKindList constinArgument_inAttributeActualTypeList,
  ...
  cEnumerator_typeKindList enumerator_7561 (constinArgument_inAttributeActualTypeList, EnumerationOrder::up) ;
...
void cPtr_identifierAsDefaultValue::method_analyzeDefaultValueType (const GALGAS_typeKindList constinArgument_inAttributeActualTypeList,
  ...
  cEnumerator_typeKindList enumerator_10347 (constinArgument_inAttributeActualTypeList, EnumerationOrder::up) ;
  ...
  case GALGAS_propertyKind::kEnum_property:
    {
      ...
      cEnumerator_typeKindList enumerator_13564 (constinArgument_inAttributeActualTypeList, EnumerationOrder::up) ;
      ...
      if (enumerator_13564.hasCurrentObject () && bool_1) {
        while (enumerator_13564.hasCurrentObject () && bool_1) {
          var_found_13541 = GALGAS_bool (ComparisonKind::equal, extractedValue_13522_type.objectCompare (enumerator_13564.current_mType (HERE))) ;
...
void routine_generateCode_3F__3F__3F_ (const GALGAS_string constinArgument_inXcodeProjectString,
  ...
  cEnumerator_fileGenerationList enumerator_2958 (constinArgument_inGeneration.readProperty_mFileGenerationList (), EnumerationOrder::up) ;
...
void routine_generateStandardProperties_3F__3F__3F__26_ (const GALGAS_string constinArgument_inOutputDirectory,
  ...
  cEnumerator_stringlist enumerator_5790 (constinArgument_inPropertyClassList, EnumerationOrder::up) ;
  ...
  cEnumerator_transientExternTypeList enumerator_5960 (constinArgument_inTransientPropertyExternTypeList, EnumerationOrder::up) ;
...
void routine_generateTestFile_3F__3F__3F__3F_ (const GALGAS_string constinArgument_inBundleIdentifier,
  ...
  if (kBoolTrue == test_0) {
    ...
    if (kBoolTrue == test_0) {
      ...
      cEnumerator_mainXibDescriptorList enumerator_5386 (constinArgument_inMainXibDescriptorList, EnumerationOrder::up) ;
      while (enumerator_5386.hasCurrentObject ()) {
        cEnumerator_mainXibLineDescriptorList enumerator_5434 (enumerator_5386.current_mLine (HERE), EnumerationOrder::up) ;
...
static void routine_programRule_5F__30_ (const GALGAS_lstring constinArgument_inSourceFile,
  ...
  cEnumerator_declarationListAST enumerator_2529 (var_sortedDeclarationListAST_2052, EnumerationOrder::up) ;
  ...
  cEnumerator_declarationListAST enumerator_3164 (var_sortedDeclarationListAST_2052, EnumerationOrder::up) ;
  ...
  cEnumerator_declarationListAST enumerator_3393 (var_sortedDeclarationListAST_2052, EnumerationOrder::up) ;
  ...
  cEnumerator_declarationListAST enumerator_3622 (var_sortedDeclarationListAST_2052, EnumerationOrder::up) ;
  ...
  if (kBoolTrue == test_6) {
    ...
    if (kBoolTrue == test_6) {
      cEnumerator_enumerationFunctionListAST enumerator_3921 (var_semanticContext_2158.readProperty_mEnumerationFunctionListAST (), EnumerationOrder::up) ;
