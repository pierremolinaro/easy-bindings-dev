...
GALGAS_string filewrapperTemplate_arrayControllerGenerationTemplate_arrayControllerImplementationInSwift (C_Compiler * inCompiler,
  ...
  result << " : EBReadOnlyAbstractGenericRelationshipProperty" ;
...
GALGAS_string filewrapperTemplate_autoLayoutTableViewControllerGenerationTemplate_autoLayoutTableViewControllerImplementation (C_Compiler * /* inCompiler */,
  ...
  if (in_OBSERVED_5F_PROPERTIES_5F_FOR_5F_SORTING.isValid ()) {
    ...
    while (enumerator_3330.hasCurrentObject ()) {
      ...
      result << "_StartsBeingObserved (by: observer)\n" ;
  ...
  if (in_OBSERVED_5F_PROPERTIES_5F_FOR_5F_SORTING.isValid ()) {
    ...
    while (enumerator_3514.hasCurrentObject ()) {
      result << "        inModel.toMany_" ;
      result << enumerator_3514.current_key (HERE).stringValue () ;
  ...
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    ...
    while (enumerator_6982.hasCurrentObject ()) {
      result << "  //--- Observe '" ;
      result << enumerator_6982.current_mDisplayedPropertyName (HERE).stringValue () ;
      result << "' column\n    self.sortedArray_property.toMany_" ;
      result << enumerator_6982.current_mDisplayedPropertyName (HERE).stringValue () ;
      result << "_StartsBeingObserved (by: self.mSortedArrayValuesObserver)\n" ;
      ...
      if (kBoolTrue == test_2) {
        ...
        result << enumerator_6982.current_mSortPropertyName (HERE).stringValue () ;
        result << "_StartsBeingObserved (by: self.mSortedArrayValuesObserver)\n" ;
      }else if (kBoolFalse == test_2) {
      }
  ...
  if (in_BOUND_5F_COLUMNS.isValid ()) {
    ...
    while (enumerator_8662.hasCurrentObject ()) {
      result << "  //--- Configure '" ;
      result << enumerator_8662.current_mDisplayedPropertyName (HERE).stringValue () ;
      result << "' column\n    inTableView.addColumn_" ;
      result << enumerator_8662.current_mColumnObjectTypeName (HERE).stringValue () ;
      ...
      if (kBoolTrue == test_4) {
        ...
        result << enumerator_8662.current_mSortPropertyName (HERE).stringValue () ;
      ...
      if (enumerator_8662.current_mActualParameterList (HERE).isValid ()) {
        ...
        while (enumerator_9517.hasCurrentObject ()) {
          result << "      " ;
          result << enumerator_9517.current_mValue_30_ (HERE).stringValue () ;
          result << ": " ;
          result << enumerator_9517.current_mValue_31_ (HERE).stringValue () ;
  ...
  if (in_SELECTION_5F_OBSERVABLE_5F_PROPERTY_5F_MAP.isValid ()) {
    ...
    while (enumerator_3403.hasCurrentObject ()) {
      ...
      if (kBoolTrue == test_5) {
        ...
        result << ") {\n    model.toMany_" ;
        result << enumerator_3403.current_lkey (HERE).readProperty_string ().stringValue () ;
        result << "_StartsBeingObserved (by: self." ;
        result << enumerator_3403.current_lkey (HERE).readProperty_string ().stringValue () ;
        result << "_property)\n    self." ;
        result << enumerator_3403.current_lkey (HERE).readProperty_string ().stringValue () ;
