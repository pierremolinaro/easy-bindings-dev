...
//--------------------------------------------------------------------------------------------------
//
//Optional @externFunctionMap_2D_element_3F_
//
//--------------------------------------------------------------------------------------------------

GALGAS_externFunctionMap_2D_element_3F_::GALGAS_externFunctionMap_2D_element_3F_ (void) :
AC_GALGAS_root (),
mValue (),
...
GALGAS_externFunctionMap_2D_element_3F_::GALGAS_externFunctionMap_2D_element_3F_ (const GALGAS_externFunctionMap_2D_element & inSource) :
AC_GALGAS_root (),
mValue (inSource),
...
GALGAS_externFunctionMap_2D_element_3F_ GALGAS_externFunctionMap_2D_element_3F_::init_nil (void) {
...
bool GALGAS_externFunctionMap_2D_element_3F_::isValid (void) const {
  bool result = false ;
  switch (mState) {
...
bool GALGAS_externFunctionMap_2D_element_3F_::isValuated (void) const {
  return (mState == OptionalState::valuated) && mValue.isValid () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_externFunctionMap_2D_element_3F_::drop (void) {
  mState = OptionalState::invalid ;
  mValue = GALGAS_externFunctionMap_2D_element () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_externFunctionMap_2D_element_3F_::description (String & ioString,
                                                           const int32_t inIndentation) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GALGAS_externFunctionMap_2D_element_3F_ ("externFunctionMap-element?",
                                                                                        nullptr) ;

//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor * GALGAS_externFunctionMap_2D_element_3F_::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_externFunctionMap_2D_element_3F_ ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GALGAS_externFunctionMap_2D_element_3F_::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_externFunctionMap_2D_element_3F_ (*this)) ;
  }
  return result ;
}
...
GALGAS_externFunctionMap_2D_element_3F_ GALGAS_externFunctionMap_2D_element_3F_::extractObject (const GALGAS_object & inObject,
                                                                                                Compiler * inCompiler
                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_externFunctionMap_2D_element_3F_ result ;
  const GALGAS_externFunctionMap_2D_element_3F_ * p = (const GALGAS_externFunctionMap_2D_element_3F_ *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GALGAS_externFunctionMap_2D_element_3F_ *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("externFunctionMap-element?", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
...
//--------------------------------------------------------------------------------------------------
//
//Optional @enumConstantMap_2D_element_3F_
//
//--------------------------------------------------------------------------------------------------

GALGAS_enumConstantMap_2D_element_3F_::GALGAS_enumConstantMap_2D_element_3F_ (void) :
AC_GALGAS_root (),
mValue (),
mState (OptionalState::invalid) {
}
...
GALGAS_enumConstantMap_2D_element_3F_::GALGAS_enumConstantMap_2D_element_3F_ (const GALGAS_enumConstantMap_2D_element & inSource) :
AC_GALGAS_root (),
mValue (inSource),
mState (OptionalState::valuated) {
}
...
GALGAS_enumConstantMap_2D_element_3F_ GALGAS_enumConstantMap_2D_element_3F_::init_nil (void) {
...
bool GALGAS_enumConstantMap_2D_element_3F_::isValid (void) const {
  bool result = false ;
  switch (mState) {
  case OptionalState::invalid :
    break ;
...
bool GALGAS_enumConstantMap_2D_element_3F_::isValuated (void) const {
  return (mState == OptionalState::valuated) && mValue.isValid () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_enumConstantMap_2D_element_3F_::drop (void) {
  mState = OptionalState::invalid ;
  mValue = GALGAS_enumConstantMap_2D_element () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_enumConstantMap_2D_element_3F_::description (String & ioString,
                                                         const int32_t inIndentation) const {
  ioString.appendCString ("<optional @") ;
  ioString.appendString (staticTypeDescriptor ()->mGalgasTypeName) ;
  ioString.appendCString (": ") ;
...
const C_galgas_type_descriptor kTypeDescriptor_GALGAS_enumConstantMap_2D_element_3F_ ("enumConstantMap-element?",
                                                                                      nullptr) ;

//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor * GALGAS_enumConstantMap_2D_element_3F_::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_enumConstantMap_2D_element_3F_ ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GALGAS_enumConstantMap_2D_element_3F_::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_enumConstantMap_2D_element_3F_ (*this)) ;
  }
  return result ;
}
...
GALGAS_enumConstantMap_2D_element_3F_ GALGAS_enumConstantMap_2D_element_3F_::extractObject (const GALGAS_object & inObject,
                                                                                            Compiler * inCompiler
                                                                                            COMMA_LOCATION_ARGS) {
  GALGAS_enumConstantMap_2D_element_3F_ result ;
  const GALGAS_enumConstantMap_2D_element_3F_ * p = (const GALGAS_enumConstantMap_2D_element_3F_ *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GALGAS_enumConstantMap_2D_element_3F_ *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("enumConstantMap-element?", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
...
//--------------------------------------------------------------------------------------------------
//
//Optional @enumFuncMap_2D_element_3F_
//
//--------------------------------------------------------------------------------------------------

GALGAS_enumFuncMap_2D_element_3F_::GALGAS_enumFuncMap_2D_element_3F_ (void) :
AC_GALGAS_root (),
mValue (),
mState (OptionalState::invalid) {
}
...
GALGAS_enumFuncMap_2D_element_3F_::GALGAS_enumFuncMap_2D_element_3F_ (const GALGAS_enumFuncMap_2D_element & inSource) :
AC_GALGAS_root (),
mValue (inSource),
mState (OptionalState::valuated) {
}
...
GALGAS_enumFuncMap_2D_element_3F_ GALGAS_enumFuncMap_2D_element_3F_::init_nil (void) {
...
bool GALGAS_enumFuncMap_2D_element_3F_::isValid (void) const {
  bool result = false ;
  switch (mState) {
  case OptionalState::invalid :
    break ;
...
bool GALGAS_enumFuncMap_2D_element_3F_::isValuated (void) const {
  return (mState == OptionalState::valuated) && mValue.isValid () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_enumFuncMap_2D_element_3F_::drop (void) {
  mState = OptionalState::invalid ;
  mValue = GALGAS_enumFuncMap_2D_element () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_enumFuncMap_2D_element_3F_::description (String & ioString,
                                                     const int32_t inIndentation) const {
  ioString.appendCString ("<optional @") ;
  ioString.appendString (staticTypeDescriptor ()->mGalgasTypeName) ;
  ioString.appendCString (": ") ;
...
const C_galgas_type_descriptor kTypeDescriptor_GALGAS_enumFuncMap_2D_element_3F_ ("enumFuncMap-element?",
                                                                                  nullptr) ;

//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor * GALGAS_enumFuncMap_2D_element_3F_::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_enumFuncMap_2D_element_3F_ ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GALGAS_enumFuncMap_2D_element_3F_::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_enumFuncMap_2D_element_3F_ (*this)) ;
  }
  return result ;
}
...
GALGAS_enumFuncMap_2D_element_3F_ GALGAS_enumFuncMap_2D_element_3F_::extractObject (const GALGAS_object & inObject,
                                                                                    Compiler * inCompiler
                                                                                    COMMA_LOCATION_ARGS) {
  GALGAS_enumFuncMap_2D_element_3F_ result ;
  const GALGAS_enumFuncMap_2D_element_3F_ * p = (const GALGAS_enumFuncMap_2D_element_3F_ *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GALGAS_enumFuncMap_2D_element_3F_ *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("enumFuncMap-element?", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
...
GALGAS_autoLayoutClassParameterType_2D_typeEnum::GALGAS_autoLayoutClassParameterType_2D_typeEnum (void) :
mProperty_name () {
}
...
GALGAS_autoLayoutClassParameterType_2D_typeEnum GALGAS_autoLayoutClassParameterType_2D_typeEnum::init_21_ (const GALGAS_lstring & in_name,
                                                                                                           Compiler * inCompiler
                                                                                                           COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_autoLayoutClassParameterType_2D_typeEnum result ;
  result.setInitializedProperties (inCompiler) ;
...
void GALGAS_autoLayoutClassParameterType_2D_typeEnum::setInitializedProperties (Compiler * /* inCompiler */) {
}

//--------------------------------------------------------------------------------------------------

GALGAS_autoLayoutClassParameterType_2D_typeEnum::GALGAS_autoLayoutClassParameterType_2D_typeEnum (const GALGAS_lstring & inOperand0) :
mProperty_name (inOperand0) {
}

//--------------------------------------------------------------------------------------------------

GALGAS_autoLayoutClassParameterType_2D_typeEnum GALGAS_autoLayoutClassParameterType_2D_typeEnum::class_func_new (const GALGAS_lstring & in_name,
                                                                                                                 Compiler * inCompiler
                                                                                                                 COMMA_UNUSED_LOCATION_ARGS) {
  GALGAS_autoLayoutClassParameterType_2D_typeEnum result ;
  result.setInitializedProperties (inCompiler) ;
...
ComparisonResult GALGAS_autoLayoutClassParameterType_2D_typeEnum::objectCompare (const GALGAS_autoLayoutClassParameterType_2D_typeEnum & inOperand) const {
   ComparisonResult result = ComparisonResult::operandEqual ;
  if (result == ComparisonResult::operandEqual) {
...
bool GALGAS_autoLayoutClassParameterType_2D_typeEnum::isValid (void) const {
  return mProperty_name.isValid () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_autoLayoutClassParameterType_2D_typeEnum::drop (void) {
  mProperty_name.drop () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_autoLayoutClassParameterType_2D_typeEnum::description (String & ioString,
                                                                   const int32_t inIndentation) const {
...
const C_galgas_type_descriptor kTypeDescriptor_GALGAS_autoLayoutClassParameterType_2D_typeEnum ("autoLayoutClassParameterType-typeEnum",
                                                                                                nullptr) ;

//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor * GALGAS_autoLayoutClassParameterType_2D_typeEnum::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_autoLayoutClassParameterType_2D_typeEnum ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GALGAS_autoLayoutClassParameterType_2D_typeEnum::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_autoLayoutClassParameterType_2D_typeEnum (*this)) ;
  }
  return result ;
}
...
GALGAS_autoLayoutClassParameterType_2D_typeEnum GALGAS_autoLayoutClassParameterType_2D_typeEnum::extractObject (const GALGAS_object & inObject,
                                                                                                                Compiler * inCompiler
                                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_autoLayoutClassParameterType_2D_typeEnum result ;
  const GALGAS_autoLayoutClassParameterType_2D_typeEnum * p = (const GALGAS_autoLayoutClassParameterType_2D_typeEnum *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GALGAS_autoLayoutClassParameterType_2D_typeEnum *> (p)) {
      result = *p ;
    }else{
...
//--------------------------------------------------------------------------------------------------
//
//Optional @autoLayoutClassParameterType_2D_typeEnum_3F_
//
//--------------------------------------------------------------------------------------------------

GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_::GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_ (void) :
AC_GALGAS_root (),
mValue (),
mState (OptionalState::invalid) {
}
...
GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_::GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_ (const GALGAS_autoLayoutClassParameterType_2D_typeEnum & inSource) :
AC_GALGAS_root (),
mValue (inSource),
mState (OptionalState::valuated) {
}
...
GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_ GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_::init_nil (void) {
...
bool GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_::isValid (void) const {
  bool result = false ;
  switch (mState) {
  case OptionalState::invalid :
    break ;
...
bool GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_::isValuated (void) const {
  return (mState == OptionalState::valuated) && mValue.isValid () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_::drop (void) {
  mState = OptionalState::invalid ;
  mValue = GALGAS_autoLayoutClassParameterType_2D_typeEnum () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_::description (String & ioString,
                                                                       const int32_t inIndentation) const {
  ioString.appendCString ("<optional @") ;
  ioString.appendString (staticTypeDescriptor ()->mGalgasTypeName) ;
  ioString.appendCString (": ") ;
...
const C_galgas_type_descriptor kTypeDescriptor_GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_ ("autoLayoutClassParameterType-typeEnum?",
                                                                                                    nullptr) ;

//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor * GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_ ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_ (*this)) ;
  }
  return result ;
}
...
GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_ GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_::extractObject (const GALGAS_object & inObject,
                                                                                                                        Compiler * inCompiler
                                                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_ result ;
  const GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_ * p = (const GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_ *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GALGAS_autoLayoutClassParameterType_2D_typeEnum_3F_ *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("autoLayoutClassParameterType-typeEnum?", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
...
//--------------------------------------------------------------------------------------------------
//
//Optional @astAutoLayoutViewFunctionMap_2D_element_3F_
//
//--------------------------------------------------------------------------------------------------

GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_::GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_ (void) :
AC_GALGAS_root (),
mValue (),
mState (OptionalState::invalid) {
}
...
GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_::GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_ (const GALGAS_astAutoLayoutViewFunctionMap_2D_element & inSource) :
AC_GALGAS_root (),
mValue (inSource),
mState (OptionalState::valuated) {
}
...
GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_ GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_::init_nil (void) {
...
bool GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_::isValid (void) const {
  bool result = false ;
  switch (mState) {
  case OptionalState::invalid :
    break ;
...
bool GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_::isValuated (void) const {
  return (mState == OptionalState::valuated) && mValue.isValid () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_::drop (void) {
  mState = OptionalState::invalid ;
  mValue = GALGAS_astAutoLayoutViewFunctionMap_2D_element () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_::description (String & ioString,
                                                                      const int32_t inIndentation) const {
  ioString.appendCString ("<optional @") ;
  ioString.appendString (staticTypeDescriptor ()->mGalgasTypeName) ;
  ioString.appendCString (": ") ;
...
const C_galgas_type_descriptor kTypeDescriptor_GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_ ("astAutoLayoutViewFunctionMap-element?",
                                                                                                   nullptr) ;

//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor * GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_ ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_ (*this)) ;
  }
  return result ;
}
...
GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_ GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_::extractObject (const GALGAS_object & inObject,
                                                                                                                      Compiler * inCompiler
                                                                                                                      COMMA_LOCATION_ARGS) {
  GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_ result ;
  const GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_ * p = (const GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_ *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GALGAS_astAutoLayoutViewFunctionMap_2D_element_3F_ *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("astAutoLayoutViewFunctionMap-element?", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
...
//--------------------------------------------------------------------------------------------------
//
//Optional @autolayoutViewClassMap_2D_element_3F_
//
//--------------------------------------------------------------------------------------------------

GALGAS_autolayoutViewClassMap_2D_element_3F_::GALGAS_autolayoutViewClassMap_2D_element_3F_ (void) :
AC_GALGAS_root (),
mValue (),
mState (OptionalState::invalid) {
}
...
GALGAS_autolayoutViewClassMap_2D_element_3F_::GALGAS_autolayoutViewClassMap_2D_element_3F_ (const GALGAS_autolayoutViewClassMap_2D_element & inSource) :
AC_GALGAS_root (),
mValue (inSource),
mState (OptionalState::valuated) {
}
...
GALGAS_autolayoutViewClassMap_2D_element_3F_ GALGAS_autolayoutViewClassMap_2D_element_3F_::init_nil (void) {
...
bool GALGAS_autolayoutViewClassMap_2D_element_3F_::isValid (void) const {
  bool result = false ;
  switch (mState) {
  case OptionalState::invalid :
    break ;
...
bool GALGAS_autolayoutViewClassMap_2D_element_3F_::isValuated (void) const {
  return (mState == OptionalState::valuated) && mValue.isValid () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_autolayoutViewClassMap_2D_element_3F_::drop (void) {
  mState = OptionalState::invalid ;
  mValue = GALGAS_autolayoutViewClassMap_2D_element () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_autolayoutViewClassMap_2D_element_3F_::description (String & ioString,
                                                                const int32_t inIndentation) const {
  ioString.appendCString ("<optional @") ;
  ioString.appendString (staticTypeDescriptor ()->mGalgasTypeName) ;
  ioString.appendCString (": ") ;
...
const C_galgas_type_descriptor kTypeDescriptor_GALGAS_autolayoutViewClassMap_2D_element_3F_ ("autolayoutViewClassMap-element?",
                                                                                             nullptr) ;

//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor * GALGAS_autolayoutViewClassMap_2D_element_3F_::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_autolayoutViewClassMap_2D_element_3F_ ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GALGAS_autolayoutViewClassMap_2D_element_3F_::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_autolayoutViewClassMap_2D_element_3F_ (*this)) ;
  }
  return result ;
}
...
GALGAS_autolayoutViewClassMap_2D_element_3F_ GALGAS_autolayoutViewClassMap_2D_element_3F_::extractObject (const GALGAS_object & inObject,
                                                                                                          Compiler * inCompiler
                                                                                                          COMMA_LOCATION_ARGS) {
  GALGAS_autolayoutViewClassMap_2D_element_3F_ result ;
  const GALGAS_autolayoutViewClassMap_2D_element_3F_ * p = (const GALGAS_autolayoutViewClassMap_2D_element_3F_ *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GALGAS_autolayoutViewClassMap_2D_element_3F_ *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("autolayoutViewClassMap-element?", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
...
//--------------------------------------------------------------------------------------------------
//
//Optional @autoLayoutBindingSpecificationMap_2D_element_3F_
//
//--------------------------------------------------------------------------------------------------

GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_::GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_ (void) :
AC_GALGAS_root (),
mValue (),
mState (OptionalState::invalid) {
}
...
GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_::GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_ (const GALGAS_autoLayoutBindingSpecificationMap_2D_element & inSource) :
AC_GALGAS_root (),
mValue (inSource),
mState (OptionalState::valuated) {
}
...
GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_ GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_::init_nil (void) {
...
bool GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_::isValid (void) const {
  bool result = false ;
  switch (mState) {
  case OptionalState::invalid :
    break ;
...
bool GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_::isValuated (void) const {
  return (mState == OptionalState::valuated) && mValue.isValid () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_::drop (void) {
  mState = OptionalState::invalid ;
  mValue = GALGAS_autoLayoutBindingSpecificationMap_2D_element () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_::description (String & ioString,
                                                                           const int32_t inIndentation) const {
  ioString.appendCString ("<optional @") ;
  ioString.appendString (staticTypeDescriptor ()->mGalgasTypeName) ;
  ioString.appendCString (": ") ;
...
const C_galgas_type_descriptor kTypeDescriptor_GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_ ("autoLayoutBindingSpecificationMap-element?",
                                                                                                        nullptr) ;

//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor * GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_ ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_ (*this)) ;
  }
  return result ;
}
...
GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_ GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_::extractObject (const GALGAS_object & inObject,
                                                                                                                                Compiler * inCompiler
                                                                                                                                COMMA_LOCATION_ARGS) {
  GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_ result ;
  const GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_ * p = (const GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_ *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GALGAS_autoLayoutBindingSpecificationMap_2D_element_3F_ *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("autoLayoutBindingSpecificationMap-element?", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
...
//--------------------------------------------------------------------------------------------------
//
//Optional @autoLayoutViewBindingSpecificationMap_2D_element_3F_
//
//--------------------------------------------------------------------------------------------------

GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_::GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_ (void) :
AC_GALGAS_root (),
mValue (),
mState (OptionalState::invalid) {
}
...
GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_::GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_ (const GALGAS_autoLayoutViewBindingSpecificationMap_2D_element & inSource) :
AC_GALGAS_root (),
mValue (inSource),
mState (OptionalState::valuated) {
}
...
GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_ GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_::init_nil (void) {
...
bool GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_::isValid (void) const {
  bool result = false ;
  switch (mState) {
  case OptionalState::invalid :
    break ;
...
bool GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_::isValuated (void) const {
  return (mState == OptionalState::valuated) && mValue.isValid () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_::drop (void) {
  mState = OptionalState::invalid ;
  mValue = GALGAS_autoLayoutViewBindingSpecificationMap_2D_element () ;
}

//--------------------------------------------------------------------------------------------------

void GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_::description (String & ioString,
                                                                               const int32_t inIndentation) const {
  ioString.appendCString ("<optional @") ;
  ioString.appendString (staticTypeDescriptor ()->mGalgasTypeName) ;
  ioString.appendCString (": ") ;
...
const C_galgas_type_descriptor kTypeDescriptor_GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_ ("autoLayoutViewBindingSpecificationMap-element?",
                                                                                                            nullptr) ;

//--------------------------------------------------------------------------------------------------

const C_galgas_type_descriptor * GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_::staticTypeDescriptor (void) const {
  return & kTypeDescriptor_GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_ ;
}

//--------------------------------------------------------------------------------------------------

AC_GALGAS_root * GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_::clonedObject (void) const {
  AC_GALGAS_root * result = nullptr ;
  if (isValid ()) {
    macroMyNew (result, GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_ (*this)) ;
  }
  return result ;
}
...
GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_ GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_::extractObject (const GALGAS_object & inObject,
                                                                                                                                        Compiler * inCompiler
                                                                                                                                        COMMA_LOCATION_ARGS) {
  GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_ result ;
  const GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_ * p = (const GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_ *) inObject.embeddedObject () ;
  if (nullptr != p) {
    if (nullptr != dynamic_cast <const GALGAS_autoLayoutViewBindingSpecificationMap_2D_element_3F_ *> (p)) {
      result = *p ;
    }else{
      inCompiler->castError ("autoLayoutViewBindingSpecificationMap-element?", p->dynamicTypeDescriptor () COMMA_THERE) ;
    }  
