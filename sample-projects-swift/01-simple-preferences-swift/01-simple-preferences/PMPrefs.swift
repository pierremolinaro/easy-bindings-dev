...
@objc (PMPrefs) class PMPrefs : NSObject {
  ...
  //--- Check myTextField' outlet not nil
    ...
    mControllerArray.addObject (Controller_PMPrefs_mIntegerValue_PMTextField_value (object:self, outlet:mInteger32TextField, file:__FILE__, line:__LINE__))
  }
