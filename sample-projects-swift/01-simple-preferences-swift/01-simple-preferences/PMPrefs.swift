...
@objc (PMPrefs) class PMPrefs : NSObject {
  ...
  //--- Check myTextField' outlet not nil
    ...
    mControllerArray.addObject (Controller_PMPrefs_myString_PMTextField_string (object:self, outlet:myTextField, file:__FILE__, line:__LINE__, sendContinously:false))
    mControllerArray.addObject (Controller_PMPrefs_myString_PMTextField_string (object:self, outlet:myOtherTextField, file:__FILE__, line:__LINE__, sendContinously:true))
    mControllerArray.addObject (Controller_PMPrefs_myString_PMTextField_string (object:self, outlet:myObserverTextField, file:__FILE__, line:__LINE__, sendContinously:false))
    ...
    mControllerArray.addObject (Controller_PMPrefs_mIntegerValue_PMTextField_int (object:self, outlet:mInteger32TextField, file:__FILE__, line:__LINE__))
  }
