...
let k_preference_2E_Prefs_2E_mFullName = 0
...
@objc(PMApplication) class PMApplication : NSApplication {
  ...
  var mTriggerSet_preference_2E_Prefs_2E_mFullName = NSMutableSet () // 0
  var mTriggerSet_preference_2E_Prefs_2E_mUpperCaseFullName = NSMutableSet () // 1
  //-------------------------------------------------------------------------------------------------------------------*
  ...
  func triggerChange () {
    if mTriggerSet_preference_2E_Prefs_2E_mFullName.count > 0 { // 0
