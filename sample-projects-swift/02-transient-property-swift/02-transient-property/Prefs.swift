...
@objc (Prefs) class Prefs : NSObject {
  ...
  var triggerObjectFor_preference_2E_Prefs_2E_mFullName : PMTrigger_preference_2E_Prefs_2E_mFullName {
    if triggerObjectFor_preference_2E_Prefs_2E_mFullName__cache == nil {
  ...
  var mUpperCaseFullName_cache : String?
  ...
  var triggerObjectFor_preference_2E_Prefs_2E_mUpperCaseFullName : PMTrigger_preference_2E_Prefs_2E_mUpperCaseFullName {
    if triggerObjectFor_preference_2E_Prefs_2E_mUpperCaseFullName__cache == nil {
  ...
  //--- Check mUpperCaseFullNameTextField' outlet not nil
    ...
    addObserverOf_mName (PMTrigger_preference_2E_Prefs_2E_mFullName (object:self))
    addObserverOf_mFirstName (PMTrigger_preference_2E_Prefs_2E_mFullName (object:self))
    addObserverOf_mFullName (PMTrigger_preference_2E_Prefs_2E_mUpperCaseFullName (object:self))
