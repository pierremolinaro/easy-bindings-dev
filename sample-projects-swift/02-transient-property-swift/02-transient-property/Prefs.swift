...
@objc(protocol_preference_2E_Prefs_2E_mName) protocol protocol_preference_2E_Prefs_2E_mName {
  func preference_2E_Prefs_2E_mName_didChange ()
}
...
@objc(protocol_preference_2E_Prefs_2E_mFirstName) protocol protocol_preference_2E_Prefs_2E_mFirstName {
  func preference_2E_Prefs_2E_mFirstName_didChange ()
}
...
@objc (Prefs) class Prefs : NSObject,
  ...
  var mName_observers = PMSet<protocol_preference_2E_Prefs_2E_mName> ()
  ...
  var mFirstName_observers = PMSet<protocol_preference_2E_Prefs_2E_mFirstName> ()
