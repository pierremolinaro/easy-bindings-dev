...
@objc (Prefs) class Prefs : NSObject, PMUserClassName {
  ...
  var mFirstName = PMProperty<String> ("Schmurtz")
  var mName = PMProperty<String> ("Amédée")
  ...
  //--- Outlet triggers
    mControllerArray.append (Controller_Prefs_mName_PMTextField_value (object:self, outlet:mNameTextField, file:__FILE__, line:__LINE__, sendContinously:false))
    mControllerArray.append (Controller_Prefs_mFirstName_PMTextField_value (object:self, outlet:mFirstNameTextField, file:__FILE__, line:__LINE__, sendContinously:false))
    mControllerArray.append (Controller_Prefs_mFullName_PMTextField_rvalue (object:self, outlet:mFullNameTextField, file:__FILE__, line:__LINE__))
    mControllerArray.append (Controller_Prefs_mUpperCaseFullName_PMTextField_rvalue (object:self, outlet:mUpperCaseFullNameTextField, file:__FILE__, line:__LINE__))
  }
