...
//                                         september 12th, 2014, at 22h11'51"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
@objc(MyRootEntity_myColor) protocol MyRootEntity_myColor : NSObjectProtocol {
  var myColor : NSColor { get }
}

//---------------------------------------------------------------------------------------------------------------------*

@objc(MyRootEntity_myString) protocol MyRootEntity_myString : NSObjectProtocol {
  var myString : String { get }
}

//---------------------------------------------------------------------------------------------------------------------*

@objc(MyRootEntity) class MyRootEntity : PMManagedObject, MyRootEntity_myColor, MyRootEntity_myString {
  ...
  private var myStringConcat_observers = NSMutableSet ()
  ...
  private var myStringMaj_observers = NSMutableSet ()
  ...
  private var myStringMin_observers = NSMutableSet ()
