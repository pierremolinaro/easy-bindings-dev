...
@objc(protocol_entity_2E_MyRootEntity_2E_myString) protocol protocol_entity_2E_MyRootEntity_2E_myString {
  func entity_2E_MyRootEntity_2E_myString_didChange ()
}
@objc(protocol_entity_2E_MyRootEntity_2E_myEnumeration) protocol protocol_entity_2E_MyRootEntity_2E_myEnumeration {
  func entity_2E_MyRootEntity_2E_myEnumeration_didChange ()
}
@objc(protocol_entity_2E_MyRootEntity_2E_myColor) protocol protocol_entity_2E_MyRootEntity_2E_myColor {
  func entity_2E_MyRootEntity_2E_myColor_didChange ()
}
...
@objc(MyRootEntity) class MyRootEntity : PMManagedObject,
                                   protocol_entity_2E_MyRootEntity_2E_myStringMaj,
                                   protocol_entity_2E_MyRootEntity_2E_myStringMin,
                                   protocol_entity_2E_MyRootEntity_2E_myStringConcat {
  ...
  var myString : String =  "Hello" {
    ...
    //--- Notify observers
      for anyObject in myString_observers.allObjects {
        let object = anyObject as protocol_entity_2E_MyRootEntity_2E_myString
        object.entity_2E_MyRootEntity_2E_myString_didChange ()
      }
  ...
  func addObserverOf_myString (inObserver : protocol_entity_2E_MyRootEntity_2E_myString) {
    myString_observers.addObject (inObserver)
    inObserver.entity_2E_MyRootEntity_2E_myString_didChange ()
  }

  func removeObserverOf_myString (inObserver : protocol_entity_2E_MyRootEntity_2E_myString) {
  ...
  var myEnumeration__as__number : NSNumber {
    ...
    //--- Notify observers
      for anyObject in myEnumeration_observers.allObjects {
        let object = anyObject as protocol_entity_2E_MyRootEntity_2E_myEnumeration
        object.entity_2E_MyRootEntity_2E_myEnumeration_didChange ()
      }
    }
  }

  func addObserverOf_myEnumeration (inObserver : protocol_entity_2E_MyRootEntity_2E_myEnumeration) {
    myEnumeration_observers.addObject (inObserver)
    inObserver.entity_2E_MyRootEntity_2E_myEnumeration_didChange ()
  }

  func removeObserverOf_myEnumeration (inObserver : protocol_entity_2E_MyRootEntity_2E_myEnumeration) {
  ...
  var myColor : NSColor =  NSColor.yellowColor () {
    ...
    //--- Notify observers
      for anyObject in myColor_observers.allObjects {
        let object = anyObject as protocol_entity_2E_MyRootEntity_2E_myColor
        object.entity_2E_MyRootEntity_2E_myColor_didChange ()
      }
    }
  }

  func addObserverOf_myColor (inObserver : protocol_entity_2E_MyRootEntity_2E_myColor) {
    myColor_observers.addObject (inObserver)
    inObserver.entity_2E_MyRootEntity_2E_myColor_didChange ()
  }

  func removeObserverOf_myColor (inObserver : protocol_entity_2E_MyRootEntity_2E_myColor) {
