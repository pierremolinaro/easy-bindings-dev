...
// controller.NSArrayController.canAdd = 5
// controller.NSArrayController.canRemove = 6
// controller.NSObjectController.canAdd = 7
// controller.NSObjectController.canRemove = 8
// controller.NSTreeController.canAdd = 9
// controller.NSTreeController.canRemove = 10
// controller.PMEntityArrayController.canAdd = 11
// controller.PMEntityArrayController.canRemove = 12
// controller.PMEntityController.canAdd = 13
// controller.PMEntityController.canRemove = 14
// entity.MyRootEntity.myString = 15
...
let k_entity_2E_MyRootEntity_2E_myStringConcat = 0
let k_entity_2E_MyRootEntity_2E_myStringMaj = 1
let k_entity_2E_MyRootEntity_2E_myStringMin = 2
...
@objc(PMApplication) class PMApplication : NSApplication {
  ...
  func triggerChange () {
    if mTriggerSet_entity_2E_MyRootEntity_2E_myStringConcat.count > 0 { // 0
    ...
    if mTriggerSet_entity_2E_MyRootEntity_2E_myStringMin.count > 0 { // 2
