...
//                                         september 5th, 2014, at 21h29'23"                                           *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
@objc(NameEntity) class NameEntity : PMManagedObject {
  ...
  var aValue : Int64 = 123 {
    didSet {
      if aValue != oldValue {
        mUndoManager?.registerUndoWithTarget (self, selector:"undoFor_aValue:", object:NSNumber (longLong:oldValue))
