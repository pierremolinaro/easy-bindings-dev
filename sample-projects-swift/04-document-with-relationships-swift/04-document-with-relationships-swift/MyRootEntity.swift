...
@objc(protocol_entity_2E_MyRootEntity_2E_mNames) protocol protocol_entity_2E_MyRootEntity_2E_mNames {
...
//      if (oldValue != mNames) {
      ...
      //--- Notify observers object count did change
        for anyObject in mNames_observers {
          let object = anyObject as protocol_entity_2E_MyRootEntity_2E_mNames
          object.entity_2E_MyRootEntity_2E_mNames_didChange ()
        }
      }
 //   }
  }
  ...
  func addObserverOf_mNames (inObserver : protocol_entity_2E_MyRootEntity_2E_mNames) {
    mNames_observers.addObject (inObserver)
    inObserver.entity_2E_MyRootEntity_2E_mNames_didChange ()
  }

  func removeObserverOf_mNames (inObserver : protocol_entity_2E_MyRootEntity_2E_mNames) {
