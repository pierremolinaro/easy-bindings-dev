...
let k_document_2E_PMDocument_2E_nameController = 2
...
@objc(PMApplication) class PMApplication : NSApplication {
  ...
  private var mTriggerSet_document_2E_PMDocument_2E_countItemMessage = NSMutableSet () // 0
  private var mTriggerSet_document_2E_PMDocument_2E_nameController = NSMutableSet () // 1
  ...
  private func runTriggers () {
    if mTriggerSet_document_2E_PMDocument_2E_nameController.count > 0 { // 2
