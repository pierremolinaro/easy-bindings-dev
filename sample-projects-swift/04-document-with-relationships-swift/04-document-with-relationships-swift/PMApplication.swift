...
//                                         september 10th, 2014, at 20h20'47"                                          *
//                                                                                                                     *
//---------------------------------------------------------------------------------------------------------------------*
...
let k_document_2E_PMDocument_2E_nameController = 3
...
@objc(PMApplication) class PMApplication : NSApplication {
  ...
  private var mTriggerSet_document_2E_PMDocument_2E_canRemoveString = NSMutableSet () // 0
  private var mTriggerSet_document_2E_PMDocument_2E_countItemMessage = NSMutableSet () // 1
  private var mTriggerSet_document_2E_PMDocument_2E_nameController = NSMutableSet () // 2
  ...
  private func runTriggers () {
    if mTriggerSet_document_2E_PMDocument_2E_nameController.count > 0 { // 3
