...
class PMTrigger_document_2E_PMDocument_2E_nameController : NSObject, PMTriggerProtocol {
  ...
  var mTransientIndex : Int {
    get {
      return k_document_2E_PMDocument_2E_nameController
    }
  }
  ...
  func noteTransientChanged () {
    if mTriggerObject != nil {
      mTriggerObject!.nameController_cache = nil
    }
  }
  
  func trigger () {
    mTriggerObject?.document_2E_PMDocument_2E_nameController_didChange ()
  }
}
