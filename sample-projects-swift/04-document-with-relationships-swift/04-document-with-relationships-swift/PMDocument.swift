...
//--- 'nameController' controller bindings
  ...
  //--- Outlet namesTableView
    ...
    if !(namesTableView?.tableColumnWithIdentifier ("name")) {
    ...
    if !(namesTableView?.tableColumnWithIdentifier ("int")) {
  ...
  //--- Outlet countItemTextField
    ...
    if (nil != countItemTextField) && !countItemTextField?.formatter {
  ...
  //--- Outlet totalTextField
    ...
    if (nil != totalTextField) && !totalTextField?.formatter {
  ...
  var triggerObjectFor_document_2E_PMDocument_2E_canRemoveString : PMTrigger_document_2E_PMDocument_2E_canRemoveString {
    if !triggerObjectFor_document_2E_PMDocument_2E_canRemoveString__cache {
  ...
  var triggerObjectFor_document_2E_PMDocument_2E_countItemMessage : PMTrigger_document_2E_PMDocument_2E_countItemMessage {
    if !triggerObjectFor_document_2E_PMDocument_2E_countItemMessage__cache {
  ...
  var total : Int64 {
    if total__cache == nil {
      ...
      total__cache = compute_PMDocument_total (rootObject.mNames.count) ;
    }
    return total__cache!
  }
  ...
  var triggerObjectFor_document_2E_PMDocument_2E_total : PMTrigger_document_2E_PMDocument_2E_total {
    if !triggerObjectFor_document_2E_PMDocument_2E_total__cache {
