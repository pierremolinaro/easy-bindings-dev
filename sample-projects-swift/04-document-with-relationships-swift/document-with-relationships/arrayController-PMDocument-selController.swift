...
//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*
//    DataSourceDidChangeEvent_PMDocument_selController
//—————————————————————————————————————————————————————————————————————————————————————————————————————————————————————*

@objc(DataSourceDidChangeEvent_PMDocument_selController)
final class DataSourceDidChangeEvent_PMDocument_selController : EBOutletEvent {

  private var mModel      : ReadOnlyArrayOf_NameEntity?
  private var mController : ArrayController_PMDocument_selController?

  //····················································································································

  init (controller: ArrayController_PMDocument_selController,
...
final class Delegate_PMDocument_selController : EBObject, EBTableViewDelegate {
  private var mSet = Set<NameEntity> ()
...
final class ArrayController_PMDocument_selController : EBObject {
  ...
  private var mDataSourceController : DataSourceDidChangeEvent_PMDocument_selController?
  ...
  func bind_modelAndView (model:ReadOnlyArrayOf_NameEntity, tableViewArray:[EBTableView], file:String, line:Int) {
    ...
    mDataSourceController = DataSourceDidChangeEvent_PMDocument_selController (
      controller: self,
      model: model,
      file: file,
      line: line
