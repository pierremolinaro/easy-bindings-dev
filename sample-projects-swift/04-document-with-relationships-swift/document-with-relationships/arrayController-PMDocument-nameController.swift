...
final class DataSource_PMDocument_nameController : ReadOnlyArrayOf_NameEntity, EBTableViewDataSource {
  ...
  override func postEvent () {
    if DEBUG_EVENT {
      NSLog ("DataSource_PMDocument_nameController:" + __FUNCTION__ + " prop_cache \(prop_cache != nil)")
    }
    if prop_cache != nil {
      prop_cache = nil
      count.postEvent ()
...
final class Delegate_PMDocument_nameController : EBAbstractProperty, EBTableViewDelegate {
  private var mSet = Set<NameEntity> ()
...
final class ArrayController_PMDocument_nameController : EBObject {
  ...
  private func bind_tableView (tableView:EBTableView,
                               selectedSet:Delegate_PMDocument_nameController,
                               file:String,
                               line:Int) {
    if DEBUG_EVENT {
      NSLog ("\(__FUNCTION__)")
